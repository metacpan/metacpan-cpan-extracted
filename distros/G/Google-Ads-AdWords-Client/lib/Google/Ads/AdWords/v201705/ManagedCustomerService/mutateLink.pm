...
package Google::Ads::AdWords::v201705::ManagedCustomerService::mutateLink;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201705::LinkOperation',
    },
    {
...
mutateLink from the namespace https://adwords.google.com/api/adwords/mcm/v201705.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::ManagedCustomerService::mutateLink->new($data);

Constructor. The following data structure may be passed to new():

 {
   operations =>  $a_reference_to, # see Google::Ads::AdWords::v201705::LinkOperation
 },
