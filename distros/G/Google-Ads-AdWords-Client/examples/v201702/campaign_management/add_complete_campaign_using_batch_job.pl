...
use Google::Ads::AdWords::v201702::BatchJob;
use Google::Ads::AdWords::v201702::BatchJobOperation;
...
use Google::Ads::AdWords::v201702::NegativeCampaignCriterion;
...
sub add_complete_campaign_using_batch_job {
  ...
  my $operation = Google::Ads::AdWords::v201702::BatchJobOperation->new({
      operator => 'ADD',
      operand  => Google::Ads::AdWords::v201702::BatchJob->new({})});
...
sub _create_campaign_operations {
  ...
  for (my $i = 1 ; $i < NUMBER_OF_CAMPAIGNS_TO_ADD ; $i++) {
    my $campaign = Google::Ads::AdWords::v201702::Campaign->new({
        ...
        budget => Google::Ads::AdWords::v201702::Budget->new(
...
sub _create_campaign_criterion_operations() {
  ...
  for my $campaign_operation (@campaign_operations) {
    ...
    my $negative_criterion =
      Google::Ads::AdWords::v201702::NegativeCampaignCriterion->new({
