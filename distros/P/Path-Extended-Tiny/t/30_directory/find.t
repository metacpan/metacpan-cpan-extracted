...
subtest 'find' => sub {
  ...
  ok((grep { defined $_ and $_->isa('Path::Extended::Tiny') } @files),
    'files are Path::Extended::Tiny objects');
...
subtest 'find_dir' => sub {
  ...
  ok((grep { defined $_ and $_->isa('Path::Extended::Tiny') } @dirs),
    'directories are Path::Extended::Tiny objects');
