...
use Google::Ads::AdWords::v201806::AdCustomizerFeed;
use Google::Ads::AdWords::v201806::AdCustomizerFeedAttribute;
use Google::Ads::AdWords::v201806::AdCustomizerFeedOperation;
...
use Google::Ads::AdWords::v201806::FeedItemAdGroupTargeting;
...
use Google::Ads::AdWords::v201806::FunctionOperand;
use Google::Ads::AdWords::v201806::RequestContextOperand;
...
sub create_customizer_feed {
  ...
  my $name_attribute =
    Google::Ads::AdWords::v201806::AdCustomizerFeedAttribute->new({
      type => "STRING",
      name => "Name"
    });
  my $price_attribute =
  ...
  my $ad_customizer_feed = Google::Ads::AdWords::v201806::AdCustomizerFeed->new(
    {
      feedName       => $feed_name,
      feedAttributes => [$name_attribute, $price_attribute, $date_attribute]});

  my $operation = Google::Ads::AdWords::v201806::AdCustomizerFeedOperation->new(
    {
      operator => "ADD",
  ...
  foreach my $ad_group_id (@{$ad_group_ids}) {
    push @operations,
      Google::Ads::AdWords::v201806::AdGroupAdOperation->new({
        operator => "ADD",
        operand  => Google::Ads::AdWords::v201806::AdGroupAd->new({
            adGroupId => $ad_group_id,
            ad        => $text_ad
          })});
  }
