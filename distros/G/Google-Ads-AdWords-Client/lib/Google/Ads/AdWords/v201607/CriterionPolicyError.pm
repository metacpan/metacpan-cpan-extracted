package Google::Ads::AdWords::v201607::CriterionPolicyError;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201607::PolicyViolationError);
# Variety: sequence
...
CriterionPolicyError from the namespace https://adwords.google.com/api/adwords/cm/v201607.
