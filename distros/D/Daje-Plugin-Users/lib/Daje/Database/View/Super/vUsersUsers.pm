...
has 'fields' => '"users_users_pkey", "editnum", "insby", "insdatetime", "modby", "moddatetime","users_workflow_fkey","avatar","password","active","mail","name","comment","position","biography","authorities_role_fkey","phone","department","employed","languages_lan_fkey","verified","country","city","zipcode","addressline1","region","addressline2","officelocation"';
