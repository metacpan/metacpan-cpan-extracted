package Chart::Plotly::Trace::Splom::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Splom::Legendgrouptitle::Font - This attribute is one of the possible options for the trace splom.
