...
This document describes version 0.049 of Sah::Schema::perl::pod_or_pm_filename (from Perl distribution Sah-Schemas-Perl), released on 2023-10-26.
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::pod_or_pm_filename", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::pod_or_pm_filename", {return_type=>'str_errmsg+val'});
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::pod_or_pm_filename*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::pod_or_pm_filename*', name=>'PerlPodOrPmFilename')
     );
 }

 use My::Types qw(PerlPodOrPmFilename);
 PerlPodOrPmFilename->assert_valid($data);
