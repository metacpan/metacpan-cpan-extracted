...
=head1 NAME
 ...
 perfSONAR_PS::Datatypes::v2_0::median::Message::Metadata::Parameters  - A base class, implements  'parameters'  element from the perfSONAR_PS RelaxNG schema
...
=head1 SYNOPSIS
              ...
              use perfSONAR_PS::Datatypes::v2_0::median::Message::Metadata::Parameters;
	      
	      my $el =  perfSONAR_PS::Datatypes::v2_0::median::Message::Metadata::Parameters->new($DOM_Obj);
