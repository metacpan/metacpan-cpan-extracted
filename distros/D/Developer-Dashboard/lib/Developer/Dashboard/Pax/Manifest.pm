package Developer::Dashboard::Pax::Manifest;
...
sub to_hash {
    ...
    my $compatibility = Developer::Dashboard::Pax::Compatibility->new(
        capture => $capture,
...
Developer::Dashboard::Pax::Manifest - capture manifest serializer

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::Manifest;

  my $obj = Developer::Dashboard::Pax::Manifest->new(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::Manifest -e 1
