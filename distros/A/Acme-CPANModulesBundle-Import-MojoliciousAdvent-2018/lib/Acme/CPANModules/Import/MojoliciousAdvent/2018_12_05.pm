...
our $LIST = {description=>"This list is generated by extracting module names mentioned in [https://mojolicious.io/blog/2018/12/05/compound-selectors/] (retrieved on 2018-12-30). Visit the URL for the full contents.",entries=>[{module=>"Mojo::Collection"},{module=>"Mojo::DOM"},{module=>"Mojo::DOM::CSS"},{module=>"Mojo::UserAgent"}],summary=>"Modules mentioned in Mojolicious Advent Calendar 2018 (day 05)"};
