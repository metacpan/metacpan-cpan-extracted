...
Perinci::Sub::ArgEntity::unix_gid - Data and code related to function arguments of entity type 'unix_gid'

=head1 VERSION

This document describes version 0.02 of Perinci::Sub::ArgEntity::unix_gid (from Perl distribution Perinci-Sub-ArgEntity-unix_user), released on 2015-09-06.
