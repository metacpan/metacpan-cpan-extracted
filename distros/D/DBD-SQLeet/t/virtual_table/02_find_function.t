...
$DBD::SQLeet::VirtualTable::T::funcs{abs}{overloaded}
  = sub {my $val = shift; return "fake_abs($val)" };
$DBD::SQLeet::VirtualTable::T::funcs{substr}{overloaded}
...
is $DBD::SQLeet::VirtualTable::T::funcs{abs}{calls},    1, "abs called";
is $DBD::SQLeet::VirtualTable::T::funcs{substr}{calls}, 1, "substr called";
is $DBD::SQLeet::VirtualTable::T::funcs{trim}{calls},   1, "trim called";
...
is $DBD::SQLeet::VirtualTable::T::funcs{abs}{calls},    1, "abs still 1";
is $DBD::SQLeet::VirtualTable::T::funcs{substr}{calls}, 1, "substr still 1";
is $DBD::SQLeet::VirtualTable::T::funcs{trim}{calls},   1, "trim still 1";
...
is $DBD::SQLeet::VirtualTable::T::funcs{abs}{calls},    2, "abs now 2";
is $DBD::SQLeet::VirtualTable::T::funcs{substr}{calls}, 2, "substr now 2";
is $DBD::SQLeet::VirtualTable::T::funcs{trim}{calls},   2, "trim now 2";
...
sub NEW {
  ...
  my $self = $class->DBD::SQLeet::VirtualTable::Cursor::NEW(@_);
  $self->{row_count} = 5;
