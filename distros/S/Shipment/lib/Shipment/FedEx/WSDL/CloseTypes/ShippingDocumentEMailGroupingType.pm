...
$Shipment::FedEx::WSDL::CloseTypes::ShippingDocumentEMailGroupingType::VERSION = '3.11';
use strict;
use warnings;
...
ShippingDocumentEMailGroupingType from the namespace http://fedex.com/ws/close/v2.
