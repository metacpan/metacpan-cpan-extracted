package Chart::Plotly::Trace::Scattergeo::Transform;
use Moose;
...
Chart::Plotly::Trace::Scattergeo::Transform - This attribute is one of the possible options for the trace scattergeo.
