package Chart::Plotly::Trace::Violin::Unselected::Marker;
use Moose;
...
Chart::Plotly::Trace::Violin::Unselected::Marker - This attribute is one of the possible options for the trace violin.
