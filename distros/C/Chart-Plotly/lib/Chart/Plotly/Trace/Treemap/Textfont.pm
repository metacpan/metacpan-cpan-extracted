package Chart::Plotly::Trace::Treemap::Textfont;
use Moose;
...
has description => ( is      => "ro",
                     default => "Sets the font used for `textinfo`.", );
...
Chart::Plotly::Trace::Treemap::Textfont - This attribute is one of the possible options for the trace treemap.
