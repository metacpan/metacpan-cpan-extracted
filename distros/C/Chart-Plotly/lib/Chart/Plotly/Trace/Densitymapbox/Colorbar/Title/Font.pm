package Chart::Plotly::Trace::Densitymapbox::Colorbar::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Densitymapbox::Colorbar::Title::Font - This attribute is one of the possible options for the trace densitymapbox.
