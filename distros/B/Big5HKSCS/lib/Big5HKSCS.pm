...
END
            ...
            if ($list !~ /\A (?>\s*) \z/oxms) {
                ...
                for (@list) {
                    ...
                    $Ebig5hkscs::function_ord     = $Ebig5hkscs::function_ord;
                    $Ebig5hkscs::function_ord_    = $Ebig5hkscs::function_ord_;
                    $Ebig5hkscs::function_reverse = $Ebig5hkscs::function_reverse;
                    $Ebig5hkscs::function_getc    = $Ebig5hkscs::function_getc;
                }
            }
        }
    }
