package Google::Cloud::Kms::KeyManagementServiceClient;
...
1; # End of Google::Cloud::Kms::KeyManagementServiceClient

__END__

=head1 NAME

Google::Cloud::Kms::KeyManagementServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Kms::KeyManagementServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Kms::KeyManagementServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Kms::KeyManagementServiceClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Kms::KeyManagementServiceClient->new(
