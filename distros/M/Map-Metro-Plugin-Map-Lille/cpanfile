# This file was auto-generated from iller.yaml by Dist::Iller on 2019-09-29 18:14:11 UTC.

on runtime => sub {
    requires 'Map::Metro' => '0.2300';
...
on develop => sub {
    ...
    requires 'Dist::Zilla::Plugin::MapMetro::MakeGraphViz' => '0';
    requires 'Dist::Zilla::Plugin::MapMetro::MakeLinePod' => '0';
...
on develop => sub {
    ...
    suggests 'Dist::Iller::Config::Author::CSSON::MapMetro' => '0.0323';
};
