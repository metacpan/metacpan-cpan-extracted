...
subtest 'custom Search object' => sub {
    ...
    my $chart = WebService::OurWorldInData::Search->new( ua => $ua,
        countries => $countries,
        topics    => 'Health',
    );
    is $chart, object {
    ...
    my $results_check = hash {
            ...
            field availableTabs => bag {
                all_items match qr/ LineChart
                    ...
                    | Dumbbell # undocumented addition
                    /x;
            };
            field publishedAt => E();
            field updatedAt => E();
...
subtest 'Page Search' => sub {
    my $pages = WebService::OurWorldInData::Search->new( ua => $ua,
        type        => 'pages',
        page        => 1,
        hitsPerPage => 10,
        pageTypes   => 'article',
