package ODO::RDFS::Properties::predicate;
...
sub new {
	...
	$self->propertyContainerName( 'ODO::RDFS::Properties::predicate::PropertiesContainer' );
	$self->properties(bless {}, 'ODO::RDFS::Properties::predicate::PropertiesContainer');
