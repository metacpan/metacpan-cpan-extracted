package Google::Ads::AdWords::v201708::PriceFeedItem;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'priceExtensionType' => 'Google::Ads::AdWords::v201708::PriceExtensionType',
        'priceQualifier' => 'Google::Ads::AdWords::v201708::PriceExtensionPriceQualifier',
        'trackingUrlTemplate' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'language' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'tableRows' => 'Google::Ads::AdWords::v201708::PriceTableRow',
    },
    {
...
Google::Ads::AdWords::v201708::PriceFeedItem

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PriceFeedItem from the namespace https://adwords.google.com/api/adwords/cm/v201708.
