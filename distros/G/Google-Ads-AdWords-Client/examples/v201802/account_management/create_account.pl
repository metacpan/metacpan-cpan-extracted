...
use Google::Ads::AdWords::v201802::ManagedCustomer;
use Google::Ads::AdWords::v201802::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201802::ManagedCustomer->new({
