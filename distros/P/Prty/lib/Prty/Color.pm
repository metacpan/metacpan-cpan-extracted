...
Prty::Color - Eine Farbe des RGB-Farbraums
...
=head1 SYNOPSIS
    ...
    $col = Prty::Color->new(255,0,0); # aus dez. RGB-Tripel
    $col = Prty::Color->new('ff0000'); # aus hex. RGB-String
...
=head4 Example
    ...
    $col = Prty::Color->new(255,255,255);
    $hexStr = Prty::Color->hexString;
    -> 'ffffff'
