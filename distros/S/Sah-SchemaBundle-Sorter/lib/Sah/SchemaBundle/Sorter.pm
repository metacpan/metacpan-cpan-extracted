package Sah::SchemaBundle::Sorter;
...
1;
# ABSTRACT: Sah schemas related to Sorter
...
This document describes version 0.002 of Sah::SchemaBundle::Sorter (from Perl distribution Sah-SchemaBundle-Sorter), released on 2024-03-07.
...
=item * L<perl::sorter::modname|Sah::Schema::perl::sorter::modname>
...
=item * L<perl::sorter::modname_with_optional_args|Sah::Schema::perl::sorter::modname_with_optional_args>

Perl Sorter::* module name without the prefix (e.g. Foo::bar) with optional arguments (e.g. Foo::baz,qux,quux).
...
=item * L<perl::sorter::modnames|Sah::Schema::perl::sorter::modnames>

Array of Perl Sorter::* module names without the prefix, e.g. ["Foo::bar", "Foo::baz"].

Array of Perl Sorter::* module names, where each element is of
C<perl::sorter::modname> schema, e.g. C<Foo::bar>, C<Foo::baz>.
...
=item * L<perl::sorter::modnames_with_optional_args|Sah::Schema::perl::sorter::modnames_with_optional_args>

Array of Perl Sorter::* module names without the prefix, with optional args, e.g. ["Foo::bar", "Foo::baz=qux,quux"].
