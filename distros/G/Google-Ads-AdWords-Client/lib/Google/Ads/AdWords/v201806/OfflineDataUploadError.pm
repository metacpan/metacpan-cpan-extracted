package Google::Ads::AdWords::v201806::OfflineDataUploadError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201806::OfflineDataUploadError::Reason',
    },
    {
...
Google::Ads::AdWords::v201806::OfflineDataUploadError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OfflineDataUploadError from the namespace https://adwords.google.com/api/adwords/rm/v201806.

Represents possible error codes from {@code OfflineDataUploadService#mutate}. 
