...
asn_dec_rval_t
CCBS_RequestState_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
CCBS_RequestState_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_CCBS_RequestState_constr_1 = {
	{ APC_CONSTRAINED,	 3,  3,  0,  6 }	/* (0..6) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_CCBS_RequestState_value2enum_1[] = {
	{ 0,	7,	"request" },
	{ 1,	6,	"recall" },
	{ 2,	6,	"active" },
	{ 3,	9,	"completed" },
...
static unsigned int asn_MAP_CCBS_RequestState_enum2value_1[] = {
	2,	/* active(2) */
	3,	/* completed(3) */
	6,	/* deleted(6) */
	5,	/* frozen(5) */
...
static asn_INTEGER_specifics_t asn_SPC_CCBS_RequestState_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_CCBS_RequestState_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_CCBS_RequestState = {
	...
	CCBS_RequestState_decode_uper,
	CCBS_RequestState_encode_uper,
	...
	sizeof(asn_DEF_CCBS_RequestState_tags_1)
		/sizeof(asn_DEF_CCBS_RequestState_tags_1[0]), /* 1 */
	&asn_PER_type_CCBS_RequestState_constr_1,
