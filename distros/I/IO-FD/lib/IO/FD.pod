...
top of B<file descriptors> instead of Perl B<file handles>. Functions include
...
want a 'drop in replacement' please look at L<IO::FD::DWIM> which is part of
