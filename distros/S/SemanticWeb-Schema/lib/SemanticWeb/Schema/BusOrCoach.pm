...
SemanticWeb::Schema::BusOrCoach - A bus (also omnibus or autobus) is a road vehicle designed to carry passengers
...
=for html <p>The permitted total weight of cargo and installations (e.g. a roof rack)
