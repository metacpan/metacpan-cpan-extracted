...
use Google::Ads::AdWords::v201702::ManagedCustomer;
use Google::Ads::AdWords::v201702::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201702::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201702::ManagedCustomerOperation->new({
      operator => "ADD",
      operand  => $account
  });
