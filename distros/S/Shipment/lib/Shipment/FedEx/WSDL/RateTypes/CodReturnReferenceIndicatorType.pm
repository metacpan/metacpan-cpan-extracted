...
$Shipment::FedEx::WSDL::RateTypes::CodReturnReferenceIndicatorType::VERSION = '3.01';
use strict;
use warnings;
...
CodReturnReferenceIndicatorType from the namespace http://fedex.com/ws/rate/v9.
