...
App::rsync::new2old - Rsync wrapper to make sure we sync new data to old, not otherwise

=head1 VERSION

This document describes version 0.007 of App::rsync::new2old (from Perl distribution App-rsync-new2old), released on 2018-01-24.

=head1 SYNOPSIS

See included script L<rsync-new2old>.
