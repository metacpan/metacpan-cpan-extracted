...
Read Template::Config about what they mean.  Extension options are
all in lower-case.
...
This module is part of Log-Report-Template distribution version 0.12,
built on July 05, 2017. Website: F<http://perl.overmeer.net/log-report/>
