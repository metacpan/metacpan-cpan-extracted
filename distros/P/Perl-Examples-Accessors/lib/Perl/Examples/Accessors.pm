...
Perl::Examples::Accessors - A collection of example classes using various accessor generators

=head1 VERSION

This document describes version 0.133 of Perl::Examples::Accessors (from Perl distribution Perl-Examples-Accessors), released on 2024-05-06.
