...
1;
# ABSTRACT: Calculate the cwalitees of scripts' Abstracts
...
App::lcpan::Cmd::cwalitees_of_scripts_abstracts - Calculate the cwalitees of scripts' Abstracts

=head1 VERSION

This document describes version 0.002 of App::lcpan::Cmd::cwalitees_of_scripts_abstracts (from Perl distribution App-lcpan-CmdBundle-cwalitee), released on 2019-07-11.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<cwalitees-of-scripts-abstracts>.
...
Calculate the cwalitees of scripts' Abstracts.
