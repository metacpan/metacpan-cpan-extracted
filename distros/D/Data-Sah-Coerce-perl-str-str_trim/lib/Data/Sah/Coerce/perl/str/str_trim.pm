...
Data::Sah::Coerce::perl::str::str_trim - Trim whitespaces at the beginning and end of string

=head1 VERSION

This document describes version 0.004 of Data::Sah::Coerce::perl::str::str_trim (from Perl distribution Data-Sah-Coerce-perl-str-str_trim), released on 2019-07-26.
