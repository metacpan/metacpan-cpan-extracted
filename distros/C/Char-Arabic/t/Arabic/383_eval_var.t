...
# eval $var has eval "..."
$var = <<'END';
eval Arabic::escape " if (Arabic::length(q{¦±²²³´´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ}) == 47) { return 1 } else { return 0 } "
END
if (eval Arabic::escape $var) {
...
$var = <<'END';
eval Arabic::escape qq{ if (Arabic::length(q{¦±²²³´´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ}) == 47) { return 1 } else { return 0 } }
END
if (eval Arabic::escape $var) {
...
# eval $var has eval q{...}
$var = <<'END';
eval Arabic::escape q{ if (Arabic::length(q{¦±²²³´´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ}) == 47) { return 1 } else { return 0 } }
END
if (eval Arabic::escape $var) {
...
# eval $var has eval {...}
$var = <<'END';
eval { if (Arabic::length(q{¦±²²³´´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ}) == 47) { return 1 } else { return 0 } }
END
if (eval Arabic::escape $var) {
