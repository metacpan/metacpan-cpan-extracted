...
sub _is_application_sub {
    ...
    return 1 if $name =~ /^Developer::Dashboard::Pax::Fixture::/;
...
Developer::Dashboard::Pax::RegionSelector - candidate region selector

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::RegionSelector;

  my $obj = Developer::Dashboard::Pax::RegionSelector->new(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::RegionSelector -e 1
