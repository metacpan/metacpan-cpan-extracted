...
=item Fault: couldn't remove lockfile $file: $!

Cast by C<unlock()>

=item Warning: folder $name already locked over NFS.
...
A lock C<$file> was found which was older than the expiration period as
specified with L<new(timeout)|Mail::Box::Locker/"METHODS">.  The lock file was successfully
removed.
Cast by C<lock()>

=item Fault: unable to remove expired lockfile $file: $!
