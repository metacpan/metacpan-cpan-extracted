...
use chrome to parse dom: (飘灯-青春期妖怪.html)

    get_novel.pl -u "https://www.aliwx.com.cn/chapter?bid=7964189" --use_chrome --writer_path "//div[@class='chapterbox']//span" --book_regex "<title>(.+?)-阿里文学网" --content_path "//div[@class='chapter-content']"
