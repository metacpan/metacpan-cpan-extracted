...
This is a test suite for the XML::DOM::ValParser package.
Currently it will just validate a single xml file from the baseline.
...
Meta::Baseline::Aegis(3), Meta::Baseline::Test(3), Meta::Utils::Opts::Opts(3), Meta::Utils::System(3), XML::Checker::Parser(3), XML::DOM::ValParser(3), strict(3)
