...
Sah::Schema::hash_of_posint - Hash of positive integers

=head1 VERSION

This document describes version 0.007 of Sah::Schema::hash_of_posint (from Perl distribution Sah-Schemas-Examples), released on 2021-07-30.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("hash_of_posint*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("hash_of_posint*");
     $validator->(\@args);
     ...
 }
