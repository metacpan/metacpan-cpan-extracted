...
package Google::Ads::AdWords::v201705::ConstantDataService::getOperatingSystemVersionCriterion;
use strict;
use warnings;
...
getOperatingSystemVersionCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201705.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::ConstantDataService::getOperatingSystemVersionCriterion->new($data);
