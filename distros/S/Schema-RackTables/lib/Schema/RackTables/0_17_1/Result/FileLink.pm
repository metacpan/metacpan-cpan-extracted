use utf8;
package Schema::RackTables::0_17_1::Result::FileLink;
...
__PACKAGE__->add_columns(
  ...
  "entity_type",
  {
    ...
    default_value => "object",
    extra => {
      list => ["ipv4net", "ipv4rspool", "ipv4vs", "object", "rack", "user"],
    },
    is_nullable => 0,
  },
  "entity_id",
...
Related object: L<Schema::RackTables::0_17_1::Result::File>

=cut

__PACKAGE__->belongs_to(
  "file",
  "Schema::RackTables::0_17_1::Result::File",
  { id => "file_id" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TzH5Eb1YPxOiKjGHeax1lw
