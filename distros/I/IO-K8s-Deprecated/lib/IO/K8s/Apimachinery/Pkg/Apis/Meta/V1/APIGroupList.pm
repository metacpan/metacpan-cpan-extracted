...
IO::K8s::Apimachinery::Pkg::Apis::Meta::V1::APIGroupList - REMOVED -- superseded by the generic IO::K8s::List, see IO::K8s::Deprecated
...
back in the C<1.00> Moose-to-Moo rewrite; C<IO::K8s::Apimachinery::Pkg::Apis::Meta::V1::APIGroupList> itself was never a real
...
that C<cpanm IO::K8s::Apimachinery::Pkg::Apis::Meta::V1::APIGroupList> -- or a cpanfile / code that still references the old
...
IO::K8s::Apimachinery::Pkg::Apis::Meta::V1::APIGroupList - REMOVED, superseded by IO::K8s::List
