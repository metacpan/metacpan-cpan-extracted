...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::DeleteGlobalOrganizationOperationResponse Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::OperationList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::GlobalOrganizationOperationsClient->new( credentials => 'dummy' );
