...
our $rschema = ["str",[{description=>"\nCryptocurrency code that is listed in <pm:CryptoCurrency::Catalog>, e.g. BTC,\nltc, ETH.\n\nCode will be converted to uppercase.\n\n",examples=>[{valid=>0,value=>""},{valid=>1,validated_value=>"BTC",value=>"btc"},{valid=>1,validated_value=>"BTC",value=>"bitcoin"},{valid=>1,validated_value=>"BCH",value=>"bitCOIN caSh"},{valid=>0,value=>"notbtc"}],summary=>"Cryptocurrency code","x.completion"=>"cryptocurrency_code","x.perl.coerce_rules"=>["From_str::to_cryptocurrency_code"]}],["str"]];
...
This document describes version 0.015 of Sah::SchemaR::cryptocurrency::code (from Perl distribution Sah-Schemas-CryptoCurrency), released on 2020-03-08.
