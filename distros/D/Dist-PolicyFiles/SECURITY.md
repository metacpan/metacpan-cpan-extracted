# Security Policy for the Dist::PolicyFiles distribution.
...
Note that the Dist::PolicyFiles project only supports major versions of Perl
released in the past 10 years, even though Dist::PolicyFiles will run on
