...
$string->set_text("mark veltzer");
$string->print(Meta::Utils::Output::get_file());

my($string_a)=Meta::Ds::String->new();
$string_a->set_text("a");
my($string_b)=Meta::Ds::String->new();
$string_b->set_text("b");
Meta::Utils::Output::print("cmp is [".$string_a->cmp($string_b)."]\n");
...
string.pl - testing program for the Meta::Ds::String.pm module.
...
This will test the Meta::Ds::String.pm module.
Currently it creates an object, inserts text and prints it.
...
Meta::Baseline::Test(3), Meta::Ds::String(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), strict(3)
