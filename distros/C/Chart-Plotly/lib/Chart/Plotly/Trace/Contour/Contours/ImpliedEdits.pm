package Chart::Plotly::Trace::Contour::Contours::ImpliedEdits;
use Moose;
...
Chart::Plotly::Trace::Contour::Contours::ImpliedEdits - This attribute is one of the possible options for the trace contour.
