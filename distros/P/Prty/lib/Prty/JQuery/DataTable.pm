...
Prty::JQuery::DataTable - Erzeuge eine HTML/JavaScript DataTables-Tabelle
...
<p class="sdoc-fig-p">
  <img class="sdoc-fig-img" src="https://raw.github.com/s31tz/Prty/master/img/prty_jquery_datatable_example01.png" width="757" height="170" alt="" />
</p>
...
(siehe Prty::Html::Table::List). Default:
...
Das Programm
    ...
    my $html = Prty::JQuery::DataTable->html($h,
        id=>'personTable',
...
<p class="sdoc-fig-p">
  <img class="sdoc-fig-img" src="https://raw.github.com/s31tz/Prty/master/img/prty_jquery_datatable_example02.png" width="757" height="117" alt="" />
</p>
...
sub instantiate {
    ...
    $arguments = Prty::Unindent->string($arguments);
    $arguments .= Prty::Unindent->string($json);
...
Hash-Objekte (vom Typ Prty::Hash).
