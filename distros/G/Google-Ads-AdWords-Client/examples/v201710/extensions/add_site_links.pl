...
use Google::Ads::AdWords::v201710::CampaignExtensionSetting;
use Google::Ads::AdWords::v201710::CampaignExtensionSettingOperation;
use Google::Ads::AdWords::v201710::FeedItemGeoRestriction;
use Google::Ads::AdWords::v201710::Keyword;
use Google::Ads::AdWords::v201710::Location;
use Google::Ads::AdWords::v201710::SitelinkFeedItem;
...
sub add_site_links {
  ...
  my $site_link_1 = Google::Ads::AdWords::v201710::SitelinkFeedItem->new({
      sitelinkText      => 'Store Hours',
      sitelinkFinalUrls => Google::Ads::AdWords::v201710::UrlList->new(
        {urls => ['http://www.example.com/storehours']})});

  # Set the startTime and endTime to show the Thanksgiving specials link only
  # from 20 - 27 Nov.
  my $site_link_2 = Google::Ads::AdWords::v201710::SitelinkFeedItem->new({
  ...
  my $geo_targeting_restriction =
    Google::Ads::AdWords::v201710::FeedItemGeoRestriction->new({
  ...
  my $keyword = Google::Ads::AdWords::v201710::Keyword->new({
    text      => "free wifi",
    matchType => "BROAD"
  });
  my $site_link_3 = Google::Ads::AdWords::v201710::SitelinkFeedItem->new({
      ...
      devicePreference =>
        Google::Ads::AdWords::v201710::FeedItemDevicePreference->new({
  ...
  # 6PM to 9PM.
  my $site_link_4 = Google::Ads::AdWords::v201710::SitelinkFeedItem->new({
  ...
  $site_link_4->set_scheduling(
    Google::Ads::AdWords::v201710::FeedItemScheduling->new(
      {feedItemSchedules => \@schedules}));

  my $campaign_extension_setting =
    Google::Ads::AdWords::v201710::CampaignExtensionSetting->new({
  ...
  my $mutate_result = $client->CampaignExtensionSettingService()->mutate({
      operations => [
        Google::Ads::AdWords::v201710::CampaignExtensionSettingOperation->new({
