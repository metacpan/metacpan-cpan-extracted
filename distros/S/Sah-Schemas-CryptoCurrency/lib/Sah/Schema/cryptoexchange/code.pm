...
This document describes version 0.015 of Sah::Schema::cryptoexchange::code (from Perl distribution Sah-Schemas-CryptoCurrency), released on 2020-03-08.
...
Using with L<Data::Sah>:
 ...
 my $vdr = gen_validator("cryptoexchange::code*");
