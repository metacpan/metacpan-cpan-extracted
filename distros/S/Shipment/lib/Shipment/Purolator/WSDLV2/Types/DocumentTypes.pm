package Shipment::Purolator::WSDLV2::Types::DocumentTypes;
$Shipment::Purolator::WSDLV2::Types::DocumentTypes::VERSION = '3.07';
use strict;
use warnings;
...
DocumentTypes from the namespace http://purolator.com/pws/datatypes/v2.
