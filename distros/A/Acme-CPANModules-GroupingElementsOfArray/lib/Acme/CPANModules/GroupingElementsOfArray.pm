...
Please visit the project's homepage at L<https://metacpan.org/release/Acme-CPANModules-GroupingElementsOfArray>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Acme-CPANModules-GroupingElementsOfArray>.

=head1 SEE ALSO

Somewhat related lists pertaining to list/array:
L<Acme::CPANModules::RemovingElementsFromArray>.
