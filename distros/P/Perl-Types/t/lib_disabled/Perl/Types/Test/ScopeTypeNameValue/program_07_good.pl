...
# [[[ PREPROCESSOR ]]]
# <<< EXECUTE_SUCCESS: "$VAR1 = {'hashref::number' => {'a' => 'number'}};" >>>
# <<< EXECUTE_SUCCESS: "$VAR1 = {'hashref::number' => {'a' => 'number','b' => 'number'}};" >>>
# <<< EXECUTE_SUCCESS: "$VAR1 = {'hashref' => {'a' => 'number','b' => 'integer'}};" >>>
# <<< EXECUTE_SUCCESS: "$VAR1 = {'hashref::number' => {'a' => 'number','b' => 'number','c' => 'number','d' => 'number','e' => 'number'}};" >>>
