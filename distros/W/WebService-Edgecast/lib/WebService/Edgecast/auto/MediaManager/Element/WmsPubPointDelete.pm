...
package WebService::Edgecast::auto::MediaManager::Element::WmsPubPointDelete;
BEGIN {
  $WebService::Edgecast::auto::MediaManager::Element::WmsPubPointDelete::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('WmsPubPointDelete');
...
WebService::Edgecast::auto::MediaManager::Element::WmsPubPointDelete
...
WmsPubPointDelete from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::MediaManager::Element::WmsPubPointDelete->new($data);
