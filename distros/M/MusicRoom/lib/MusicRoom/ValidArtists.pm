package MusicRoom::ValidArtists;

=head1 NAME

MusicRoom::ValidArtist - Find the nearest artist

=head1 DESCRIPTION

Identify artists from the list
...
sub nearest
  {
    ...
    _init();
    $from = "ValidArtists Module" if(!defined $from || $from eq "");
