...
Algorithm::Easing::Quartinion - Calculate eased translations between two positive whole integer values over time
...
=head1 SYNOPSIS
        ...
        # this example produces traditional 'quartinion' output;

        my $translation = Algorithm::Easing::Quartinion->new;
...
This method is used to ease in between two positive real whole integers using a positive real integer as the parameter for time in quartinion fashion.
...
This method is used to ease both in then out between two positive real whole integers using a positive real integer as the parameter for time in quartinion fashion.
