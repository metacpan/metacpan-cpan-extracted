package Data::Sah::Coerce::perl::To_date::From_float::epoch_local;
...
sub meta {
    +{
        v => 4,
        summary => 'Coerce date from number (assumed to be epoch) (local time zone)',
        prio => 50,
...
1;
# ABSTRACT: Coerce date from number (assumed to be epoch) (local time zone)
...
Data::Sah::Coerce::perl::To_date::From_float::epoch_local - Coerce date from number (assumed to be epoch) (local time zone)

=head1 VERSION

This document describes version 0.053 of Data::Sah::Coerce::perl::To_date::From_float::epoch_local (from Perl distribution Data-Sah-Coerce), released on 2022-09-22.

=head1 SYNOPSIS

To use in a Sah schema:

 ["date",{"x.perl.coerce_rules"=>["From_float::epoch_local"]}]
