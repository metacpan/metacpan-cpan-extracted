package Lemonldap::NG::Portal::Plugins::OIDC::OfflineTokens;
...
extends qw(Lemonldap::NG::Portal::Lib::OIDCPlugin
...
our @ISA = ('Lemonldap::NG::Portal::Plugins::OIDC::OfflineTokens');
