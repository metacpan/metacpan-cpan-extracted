...
use Google::Ads::AdWords::v201607::CrmBasedUserList;
use Google::Ads::AdWords::v201607::MutateMembersOperand;
use Google::Ads::AdWords::v201607::MutateMembersOperation;
...
sub add_crm_based_user_list {
  ...
  # Create a user list.
  my $user_list = Google::Ads::AdWords::v201607::CrmBasedUserList->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201607::UserListOperation->new({
      operator => "ADD",
      operand  => $user_list
  });
  ...
  if ($result->get_value()) {
    ...
    my $operand     = Google::Ads::AdWords::v201607::MutateMembersOperand->new({
        userListId => $userlist_id,
        members    => \@email_list
    });

    my $member_operation =
      Google::Ads::AdWords::v201607::MutateMembersOperation->new({
        operator => "ADD",
        operand  => $operand
      });
