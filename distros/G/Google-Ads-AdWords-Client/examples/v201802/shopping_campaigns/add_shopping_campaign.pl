...
use Google::Ads::AdWords::v201802::ProductAd;
...
sub add_shopping_campaign {
  ...
  # Create operation
  $operation = Google::Ads::AdWords::v201802::AdGroupOperation->new({
    operand  => $ad_group,
    operator => "ADD"
  });
  ...
  # Create product ad
  my $product_ad = Google::Ads::AdWords::v201802::ProductAd->new();
  ...
  # Create operation
  $operation = Google::Ads::AdWords::v201802::AdGroupAdOperation->new({
    operand  => $ad_group_ad,
    operator => "ADD"
  });
  ...
  if ($create_default_partition) {
    ...
    my $product_partition =
      Google::Ads::AdWords::v201802::ProductPartition->new({
        partitionType => 'UNIT',
    ...
    # Create operation.
    $operation = Google::Ads::AdWords::v201802::AdGroupCriterionOperation->new({
      operator => "ADD",
