...
my @test_psk = ( [ undef, undef ], [ 'test_psk', 0 ], [ 'test_psk', 1 ], [ 'test_psk', 2 ] );
...
for my $pattern_name ( qw/NN NK KK IK IX KN NX KX IN NK1/ ) {
  ...
  my ( $b_msg, $b_c1, $b_c2 ) = write_message( $noise_conf, $b_hs, [], $b_msg_src );
...
###   $b_c2
  ...
  ### a recv msg from b
  my ( $a_recv_b_msg_r, $a_c1, $a_c2 ) = read_message( $noise_conf, $a_hs, [], $b_msg );
  ### $a_recv_b_msg_r->[0]
###   $a_hs
###  $a_c1
###  $a_c2
