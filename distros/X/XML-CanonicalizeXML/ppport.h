...
----------------------------------------------------------------------
    ...
    Devel::PPPort -- Perl/Pollution/Portability Version 3.32
    ...
    Use 'perldoc Devel::PPPort' to view the documentation below.
...
=head1 SYNOPSIS
  ...
  perl Devel::PPPort [options] [source files]
...
This version of F<Devel::PPPort> is designed to support operation with Perl
...
Display the version of F<Devel::PPPort>.
...
Tell F<Devel::PPPort> to check for compatibility with the given
Perl version. The default is to check for compatibility with Perl
version 5.003. You can use this option to reduce the output
of F<Devel::PPPort> if you intend to be backward compatible only
down to a certain Perl version.

=head2 --cplusplus

Usually, F<Devel::PPPort> will detect C++ style comments and
replace them with C style comments for portability reasons.
Using this option instructs F<Devel::PPPort> to leave C++
comments untouched.
...
Strip all script and documentation functionality from F<Devel::PPPort>.
This reduces the size of F<Devel::PPPort> dramatically and may be useful
if you want to include F<Devel::PPPort> in smaller modules without
increasing their distribution size too much.

The stripped F<Devel::PPPort> will have a C<--unstrip> option that allows
...
F<Devel::PPPort>. Also lists if it must be explicitly requested,
if it has dependencies, and if there are hints or warnings for it.

=head2 --list-unsupported

Lists the API elements that are known not to be supported by
F<Devel::PPPort> and below which version of Perl they probably
...
earlier Perl releases. Use
    ...
    perl Devel::PPPort --list-provided

to see which API elements are provided by Devel::PPPort.
...
also deprecated. You can safely use the supported API, as F<Devel::PPPort>
...
more C<#define>s in your source code before the inclusion of F<Devel::PPPort>.
...
macro. Just C<#define> the macro before including C<Devel::PPPort>:

    #define DPPP_NAMESPACE MyOwnNamespace_
    #include "Devel::PPPort"
...
F<Devel::PPPort> on your source code. See the next section for
details.

=head1 EXAMPLES

To verify whether F<Devel::PPPort> is needed for your module, whether you
should make any changes to your code, and whether any special defines
should be used, F<Devel::PPPort> can be run as a Perl script to check your
...
use something like this:
    ...
    perl Devel::PPPort --compat-version=5.6.0 --cplusplus --patch=test.diff

If you only want your code to be scanned without any suggestions
for changes, use:

    perl Devel::PPPort --nochanges

You can specify a different C<diff> program or options, using
the C<--diff> option:

    perl Devel::PPPort --diff='diff -C 10'

This would output context diffs with 10 lines of context.

If you want to create patched copies of your files instead, use:

    perl Devel::PPPort --copy=.new

To display portability information for the C<newSVpvn> function,
use:

    perl Devel::PPPort --api-info=newSVpvn

Since the argument to C<--api-info> can be a regular expression,
you can use

    perl Devel::PPPort --api-info=/_nomg$/

to display portability information for all C<_nomg> functions or

    perl Devel::PPPort --api-info=/./

to display information for all known API elements.

=head1 BUGS

If this version of F<Devel::PPPort> is causing failure during
the compilation of this module, please check if newer versions
of either this module or C<Devel::PPPort> are available on CPAN
before sending a bug report.

If F<Devel::PPPort> was generated using the latest version of
 ...
 */
#if PERL_REVISION != 5
#  error Devel::PPPort only works with Perl version 5
 ...
 * 5.005 perls, you can use aTHXR (supplied by Devel::PPPort), which will
...
/* Hint: SvPVbyte
 * Does not work in perl-5.6.1, Devel::PPPort implements a version
