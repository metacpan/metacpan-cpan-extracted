package OWL::DirectSemantics::Element::DataPropertyRange;

BEGIN {
	$OWL::DirectSemantics::Element::DataPropertyRange::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::DataPropertyRange::VERSION   = '0.001';
};
...
OWL::DirectSemantics::Element::DataPropertyRange - represents an OWL DataPropertyRange

=head1 DESCRIPTION

This class represents the DataPropertyRange element in OWL Direct Semantics.
