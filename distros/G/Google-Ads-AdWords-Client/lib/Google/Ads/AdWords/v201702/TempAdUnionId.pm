package Google::Ads::AdWords::v201702::TempAdUnionId;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201702::AdUnionId);
# Variety: sequence
...
TempAdUnionId from the namespace https://adwords.google.com/api/adwords/cm/v201702.
