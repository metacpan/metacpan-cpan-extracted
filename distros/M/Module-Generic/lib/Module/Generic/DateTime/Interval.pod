...
=head1 SYNOPSIS
    ...
    my $dt2 = DateTime::Lite->now->add( days => 10 );
...
L<Module::Generic::DateTime::Interval> is a thin wrapper around L<DateTime::Lite::Duration> to provide enhance features. All other regular method calls of L<DateTime::Lite::Duration> are passed through to it via C<AUTOLOAD>.
...
L<Module::Generic>, L<Module::Generic::DateTime>, L<DateTime::Lite>, L<DateTime::Format::Lite>, L<DateTime::Lite::TimeZone>
