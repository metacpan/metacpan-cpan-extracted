package WordLists::PersonName::PopularBabyNames::US::SSA;
...
1;
# ABSTRACT: Popular baby names in the USA (from Social Security Administration)
...
WordLists::PersonName::PopularBabyNames::US::SSA - Popular baby names in the USA (from Social Security Administration)

=head1 VERSION

This document describes version 0.001 of WordLists::PersonName::PopularBabyNames::US::SSA (from Perl distribution WordLists-PersonName-PopularBabyNames-US-SSA), released on 2020-05-01.
...
L<https://www.ssa.gov/oact/babynames/>
