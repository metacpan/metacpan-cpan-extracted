...
#
# created on Mon Feb  5 21:24:01 2001 by /home/jasons/work/GeneX-Server/Genex/scripts/create_genex_class.pl --dir=/home/jasons/work/GeneX-Server/Genex --target=TL_FactorValues
#
# cvs id: $Id: TL_FactorValues.pm,v 1.13 2001/02/06 18:58:52 jes Exp $ 
#
##############################
...
sub get_all_objects {
    ...
    unless ref($_[0]) eq 'HASH' && exists $_[0]->{pkey_link};
  {
    ...
    die "Bio::Genex::TL_FactorValues::get_all_objects: Must define both 'column' and 'value'" 
  ...
  my $sth = $dbh->prepare($sql) 
    or die "Bio::Genex::TL_FactorValues::get_all_objects:\nSQL=<$sql>,\nDBI=<$DBI::errstr>";
  $sth->execute() 
    or die "Bio::Genex::TL_FactorValues::get_all_objects:\nSQL=<$sql>,\nDBI=<$DBI::errstr>";
  ...
  die "Bio::Genex::TL_FactorValues::get_all_objects:\nSQL=<$sql>,\nDBI=<$DBI::errstr>" 
    if $sth->err;
...
sub get_objects {
  ...
  if (ref($_[0]) eq 'HASH' || scalar @_ == 0) {
    croak("Bio::Genex::TL_FactorValues::get_objects called with no ID's, perhaps you meant to use Bio::Genex::TL_FactorValues::get_all_objects
");
  } 
  my @ids = @_;
  my $obj;
...
=head1 SYNOPSIS
  ...
  my @objects = Bio::Genex::TL_FactorValues->get_all_objects();
...
on Mon Feb  5 21:24:01 2001 by /home/jasons/work/GeneX-Server/Genex/scripts/create_genex_class.pl --dir=/home/jasons/work/GeneX-Server/Genex --target=TL_FactorValues
