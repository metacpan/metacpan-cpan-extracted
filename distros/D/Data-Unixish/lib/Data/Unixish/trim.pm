...
This document describes version 1.573 of Data::Unixish::trim (from Perl distribution Data-Unixish), released on 2023-09-23.
...
Usage:
 ...
 trim(%args) -> [$status_code, $reason, $payload, \%result_meta]
