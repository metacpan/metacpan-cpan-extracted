...
#define SWIG_init    boot_Math__GSL__Diff

#define SWIG_name   "Math::GSL::Diffc::boot_Math__GSL__Diff"
#define SWIG_prefix "Math::GSL::Diffc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_Math__GSL__Diff_var::
class _wrap_Math__GSL__Diff_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_gsl_diff_central) {
  {
    ...
    arg4 = &temp4;
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: gsl_diff_central(f,x);");
    }
    {
      SV * function = 0;
      SV * params = 0;
    ...
    if (!SWIG_IsOK(ecode2)) {
      SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "gsl_diff_central" "', argument " "2"" of type '" "double""'");
    } 
    arg2 = (double)(val2);
    result = (int)gsl_diff_central((gsl_function const *)arg1,arg2,arg3,arg4);
...
XS(_wrap_gsl_diff_backward) {
  {
    ...
    arg4 = &temp4;
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: gsl_diff_backward(f,x);");
    }
    {
      SV * function = 0;
      SV * params = 0;
    ...
    ecode2 = SWIG_AsVal_double SWIG_PERL_CALL_ARGS_2(ST(1), &val2);
    if (!SWIG_IsOK(ecode2)) {
      SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "gsl_diff_backward" "', argument " "2"" of type '" "double""'");
    } 
    arg2 = (double)(val2);
    result = (int)gsl_diff_backward((gsl_function const *)arg1,arg2,arg3,arg4);
    ST(argvi) = SWIG_From_int  SWIG_PERL_CALL_ARGS_1((int)(result)); argvi++ ;
    if (SWIG_IsTmpObj(res3)) {
      if (argvi >= items) EXTEND(sp, argvi+1);  ST(argvi) = SWIG_From_double  SWIG_PERL_CALL_ARGS_1((*arg3)); argvi++  ;
    } else {
...
XS(_wrap_gsl_diff_forward) {
  {
    ...
    arg4 = &temp4;
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: gsl_diff_forward(f,x);");
    }
    {
      SV * function = 0;
      SV * params = 0;
    ...
    ecode2 = SWIG_AsVal_double SWIG_PERL_CALL_ARGS_2(ST(1), &val2);
    if (!SWIG_IsOK(ecode2)) {
      SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "gsl_diff_forward" "', argument " "2"" of type '" "double""'");
    } 
    arg2 = (double)(val2);
    result = (int)gsl_diff_forward((gsl_function const *)arg1,arg2,arg3,arg4);
    ST(argvi) = SWIG_From_int  SWIG_PERL_CALL_ARGS_1((int)(result)); argvi++ ;
    if (SWIG_IsTmpObj(res3)) {
      if (argvi >= items) EXTEND(sp, argvi+1);  ST(argvi) = SWIG_From_double  SWIG_PERL_CALL_ARGS_1((*arg3)); argvi++  ;
    } else {
...
{"Math::GSL::Diffc::gsl_error", _wrap_gsl_error},
{"Math::GSL::Diffc::gsl_stream_printf", _wrap_gsl_stream_printf},
{"Math::GSL::Diffc::gsl_strerror", _wrap_gsl_strerror},
{"Math::GSL::Diffc::gsl_set_error_handler", _wrap_gsl_set_error_handler},
{"Math::GSL::Diffc::gsl_set_error_handler_off", _wrap_gsl_set_error_handler_off},
{"Math::GSL::Diffc::gsl_set_stream_handler", _wrap_gsl_set_stream_handler},
{"Math::GSL::Diffc::gsl_set_stream", _wrap_gsl_set_stream},
{"Math::GSL::Diffc::gsl_diff_central", _wrap_gsl_diff_central},
{"Math::GSL::Diffc::gsl_diff_backward", _wrap_gsl_diff_backward},
{"Math::GSL::Diffc::gsl_diff_forward", _wrap_gsl_diff_forward},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
