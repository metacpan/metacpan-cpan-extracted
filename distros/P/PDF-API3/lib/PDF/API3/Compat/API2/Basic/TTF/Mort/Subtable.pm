...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::TTF::Mort::Subtable;

=head1 NAME

PDF::API3::Compat::API2::Basic::TTF::Mort::Subtable
...
require PDF::API3::Compat::API2::Basic::TTF::Mort::Rearrangement;
require PDF::API3::Compat::API2::Basic::TTF::Mort::Contextual;
require PDF::API3::Compat::API2::Basic::TTF::Mort::Ligature;
require PDF::API3::Compat::API2::Basic::TTF::Mort::Noncontextual;
require PDF::API3::Compat::API2::Basic::TTF::Mort::Insertion;
...
sub create
{
    ...
    my $subclass;
    if ($type == 0) {
        $subclass = 'PDF::API3::Compat::API2::Basic::TTF::Mort::Rearrangement';
    }
    elsif ($type == 1) {
        $subclass = 'PDF::API3::Compat::API2::Basic::TTF::Mort::Contextual';
    }
    elsif ($type == 2) {
        $subclass = 'PDF::API3::Compat::API2::Basic::TTF::Mort::Ligature';
    }
    elsif ($type == 4) {
        $subclass = 'PDF::API3::Compat::API2::Basic::TTF::Mort::Noncontextual';
    }
    elsif ($type == 5) {
        $subclass = 'PDF::API3::Compat::API2::Basic::TTF::Mort::Insertion';
    }
