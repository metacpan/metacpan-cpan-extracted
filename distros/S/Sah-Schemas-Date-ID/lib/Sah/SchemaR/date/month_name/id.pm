...
Sah::SchemaR::date::month_name::id - Month name (abbreviated or full, in Indonesian), e.g. "Mar" or "JUNI"

=head1 VERSION

This document describes version 0.008 of Sah::SchemaR::date::month_name::id (from Perl distribution Sah-Schemas-Date-ID), released on 2022-10-20.
