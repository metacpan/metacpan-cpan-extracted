...
local ($::_g0 = do {$mark->{pm_path}}, $::_e0 = "X.pm"); ::ok $::_g0 eq $::_e0, '$mark->{pm_path}  # => X.pm' or ::diag ::_string_diff($::_g0, $::_e0); undef $::_g0; undef $::_e0;
local ($::_g0 = do {$mark->{md_path}}, $::_e0 = "X.md"); ::ok $::_g0 eq $::_e0, '$mark->{md_path}  # => X.md' or ::diag ::_string_diff($::_g0, $::_e0); undef $::_g0; undef $::_e0;

local ($::_g0 = do {$mark->as_markdown}, $::_e0 = "hi!"); ::ok $::_g0 eq $::_e0, '$mark->as_markdown  # => hi!' or ::diag ::_string_diff($::_g0, $::_e0); undef $::_g0; undef $::_e0;
