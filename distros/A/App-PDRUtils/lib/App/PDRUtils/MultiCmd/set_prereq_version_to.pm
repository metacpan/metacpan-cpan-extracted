package App::PDRUtils::MultiCmd::set_prereq_version_to;
...
App::PDRUtils::MultiCmd::create_cmd_from_dist_ini_cmd(
    dist_ini_cmd => 'set_prereq_version_to',
);

1;
# ABSTRACT: Set prereq version to a specified version
...
App::PDRUtils::MultiCmd::set_prereq_version_to - Set prereq version to a specified version

=head1 VERSION

This document describes version 0.120 of App::PDRUtils::MultiCmd::set_prereq_version_to (from Perl distribution App-PDRUtils), released on 2018-04-03.
