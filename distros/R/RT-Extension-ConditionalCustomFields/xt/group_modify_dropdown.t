...
$cf_condition->Create(Name => 'Condition', LookupType => 'RT::Group', Type => 'Select', MaxValues => 1, RenderType => 'Dropdown');
...
my $group_cf_condition = $mjs->by_id('Object-RT::Group-' . $group->id . '-CustomField-' . $cf_condition->id . '-Values', single => 1);
$mjs->field($group_cf_condition, $cf_values->[0]->Name);
$mjs->eval_in_page("jQuery('#Object-RT\\\\:\\\\:Group-" . $group->id . "-CustomField-" . $cf_condition->id . "-Values').trigger('change');");
...
$mjs->field($group_cf_condition, $cf_values->[1]->Name);
$mjs->eval_in_page("jQuery('#Object-RT\\\\:\\\\:Group-" . $group->id . "-CustomField-" . $cf_condition->id . "-Values').trigger('change');");
...
$group_cf_condition = $mjs->by_id('Object-RT::Group-' . $group->id . '-CustomField-' . $cf_condition->id . '-Values', single => 1);
$mjs->field($group_cf_condition, $cf_values->[1]->Name);
$mjs->eval_in_page("jQuery('#Object-RT\\\\:\\\\:Group-" . $group->id . "-CustomField-" . $cf_condition->id . "-Values').trigger('change');");
...
$group_cf_condition = $mjs->by_id('Object-RT::Group-' . $group->id . '-CustomField-' . $cf_condition->id . '-Values', single => 1);
$mjs->field($group_cf_condition, $cf_values->[2]->Name);
$mjs->eval_in_page("jQuery('#Object-RT\\\\:\\\\:Group-" . $group->id . "-CustomField-" . $cf_condition->id . "-Values').trigger('change');");
