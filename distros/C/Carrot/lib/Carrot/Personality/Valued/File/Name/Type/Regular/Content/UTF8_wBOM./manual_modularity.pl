...
Carrot::Meta::Greenhouse::Shared_Subroutines::add_package(
	'::Personality::Valued::File::Name::Type::Regular::Content::Raw',
	'::Personality::Valued::File::Name::Type::Regular');
package main_ {
        *Carrot::Personality::Valued::File::Name::Type::Regular::Content::UTF8_wBOM::EVAL_ERROR = *@;
        *Carrot::Personality::Valued::File::Name::Type::Regular::Content::UTF8_wBOM::OS_ERROR = *!;
        *Carrot::Personality::Valued::File::Name::Type::Regular::Content::UTF8_wBOM::ARGUMENTS = *_;
}
