package Chart::Plotly::Trace::Bar::Unselected::Textfont;
use Moose;
...
Chart::Plotly::Trace::Bar::Unselected::Textfont - This attribute is one of the possible options for the trace bar.
