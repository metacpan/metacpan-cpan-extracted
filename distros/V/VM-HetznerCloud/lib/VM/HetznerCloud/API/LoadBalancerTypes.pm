...
sub list ($self, %params) {
    ...
    return $self->_request( '', \%params, $request_params, { type => 'get', oid => '/load_balancer_types#get' } );
}
...
sub get ($self, %params) {
    ...
    return $self->_request( '/:id', \%params, $request_params, { type => 'get', oid => '/load_balancer_types/{id}#get' } );
}
...
VM::HetznerCloud::API::LoadBalancerTypes - LoadBalancerTypes
