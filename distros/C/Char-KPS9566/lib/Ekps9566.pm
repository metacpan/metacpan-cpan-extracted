...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                                                2   3                                  4   5
                q<CORE::eval{local $Ekps9566::re_t=%s; local $Ekps9566::re_a=''; while($Ekps9566::re_t =~ %s){%s local $^W=0; local $Ekps9566::re_r=%s; %s$Ekps9566::re_t="$Ekps9566::re_a${1}$Ekps9566::re_r$'"; pos($Ekps9566::re_t)=length "$Ekps9566::re_a${1}$Ekps9566::re_r"; $Ekps9566::re_a=substr($Ekps9566::re_t,0,pos($Ekps9566::re_t)); } return $Ekps9566::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Ekps9566::re_r=CORE::eval $Ekps9566::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Ekps9566::re_t=%s; while($Ekps9566::re_t =~ %s){%s local $^W=0; local $Ekps9566::re_r=%s; %s$Ekps9566::re_t="$`$Ekps9566::re_r$'"; pos($Ekps9566::re_t)=length "$`$Ekps9566::re_r"; } return $Ekps9566::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Ekps9566::re_r=%s; %s"%s$Ekps9566::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Ekps9566::re_n=0; local $Ekps9566::re_a=''; while(%s =~ %s){%s local $^W=0; local $Ekps9566::re_r=%s; %s%s="$Ekps9566::re_a${1}$Ekps9566::re_r$'"; pos(%s)=length "$Ekps9566::re_a${1}$Ekps9566::re_r"; $Ekps9566::re_a=substr(%s,0,pos(%s)); $Ekps9566::re_n++} return %s$Ekps9566::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Ekps9566::re_n=0; while(%s =~ %s){%s local $^W=0; local $Ekps9566::re_r=%s; %s%s="$`$Ekps9566::re_r$'"; pos(%s)=length "$`$Ekps9566::re_r"; $Ekps9566::re_n++} return %s$Ekps9566::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Ekps9566::re_r=%s; %s%s="%s$Ekps9566::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Ekps9566::re_r=%s; %s%s="%s$Ekps9566::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Ekps9566::re_r=CORE::eval $Ekps9566::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
