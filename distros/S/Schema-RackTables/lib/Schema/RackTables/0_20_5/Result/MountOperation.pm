use utf8;
package Schema::RackTables::0_20_5::Result::MountOperation;
...
Related object: L<Schema::RackTables::0_20_5::Result::Molecule>

=cut

__PACKAGE__->belongs_to(
  "new_molecule",
  "Schema::RackTables::0_20_5::Result::Molecule",
  { id => "new_molecule_id" },
  {
    is_deferrable => 1,
    join_type     => "LEFT",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ispZ30+YjDnIk0RuHJULKw
