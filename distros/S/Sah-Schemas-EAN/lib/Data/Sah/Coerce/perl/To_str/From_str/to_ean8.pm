...
Data::Sah::Coerce::perl::To_str::From_str::to_ean8 - Check and format EAN-8 number from string

=head1 VERSION

This document describes version 0.009 of Data::Sah::Coerce::perl::To_str::From_str::to_ean8 (from Perl distribution Sah-Schemas-EAN), released on 2023-01-27.

=head1 SYNOPSIS

To use in a Sah schema:

 ["str",{"x.perl.coerce_rules"=>["From_str::to_ean8"]}]
