# This Makefile is for the DataFax::StudyDB extension to perl.
#
...
#     ABSTRACT => q[DataFax DFstudies.db parser]
#     AUTHOR => q[geotiger2001@yahoo.com]
#     DISTNAME => q[DataFax-StudyDB-0.11.tar.gz]
#     NAME => q[DataFax::StudyDB]
#     PREREQ_PM => { Test::More=>q[0.45], Test::Harness=>q[0.1] }
#     VERSION => q[0.11]
#     test => { TESTS=>q[t/StudyDB.t] }
...
AR_STATIC_ARGS = cr
DIRFILESEP = /
NAME = DataFax::StudyDB
NAME_SYM = DataFax_StudyDB
VERSION = 0.11
...
INST_LIBDIR      = $(INST_LIB)/DataFax
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/DataFax
...
DISTNAME = DataFax-StudyDB-0.11.tar.gz
DISTVNAME = DataFax-StudyDB-0.11.tar.gz-0.11
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         DataFax-StudyDB-0.11.tar.gz' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>DataFax DFstudies.db parser</ABSTRACT>' >> $(DISTNAME).ppd
