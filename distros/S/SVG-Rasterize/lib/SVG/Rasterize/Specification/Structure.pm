package SVG::Rasterize::Specification::Structure;
use strict;
use warnings;
...
C<SVG::Rasterize::Specification::Structure> - specification for class Structure
...
our %ATTR_VAL = ('defs'   => {'alignment-baseline'           => {'optional' => 1,
                                                                 'type'     => SCALAR,
...
our %ATTR_HINTS = ('defs'   => {'color'        => {'color'  => 1},
                                'fill'         => {'color'  => 1},
                                'stroke'       => {'color'  => 1},
