...
1;
# ABSTRACT: List of filesystem file names
...
Sah::Schema::filenames - List of filesystem file names

=head1 VERSION

This document describes version 0.031 of Sah::Schema::filenames (from Perl distribution Sah-SchemaBundle-Path), released on 2024-02-16.
...
=head1 SAH SCHEMA DEFINITION
 ...
 [
   "array",
   {
     ...
     "of" => ["filename", { req => 1 }],
     "x.element_completion" => ["filename"],
     "x.perl.coerce_rules" => ["From_str::expand_glob"],
   },
 ]
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("filenames*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("filenames", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("filenames", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("filenames*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"filenames*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('filenames*', name=>'Filenames')
     );
 }

 use My::Types qw(Filenames);
 Filenames->assert_valid($data);
