# HTML::Inspect
  ...
  * Development via GitHub: <https://github.com/markov2/perl5-HTML-Inspect>
  * Download from CPAN: <ftp://ftp.cpan.org/pub/CPAN/authors/id/M/MA/MARKOV/>
  * Indexed from CPAN: <https://metacpan.org/release/HTML-Inspect>
...
better source is CPAN. First, install the IDN2 development package for
your OS (Linux distribution).  For instance:

```sh
   zypper install libidn2-devel      # SUSE
   apt-get install libidn2-dev       # Debian
   rpm --install libidn2-devel       # Redhat/CentOS
```
