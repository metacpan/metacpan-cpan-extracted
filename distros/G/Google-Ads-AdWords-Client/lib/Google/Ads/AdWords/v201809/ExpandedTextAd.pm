package Google::Ads::AdWords::v201809::ExpandedTextAd;
use strict;
use warnings;
...
my %headlinePart3_of :ATTR(:get<headlinePart3>);
...
__PACKAGE__->_factory(
    ...
    ) ],
    {
        ...
        'headlinePart3' => \%headlinePart3_of,
    ...
    },
    {
        ...
        'headlinePart3' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
...
Google::Ads::AdWords::v201809::ExpandedTextAd

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ExpandedTextAd from the namespace https://adwords.google.com/api/adwords/cm/v201809.
