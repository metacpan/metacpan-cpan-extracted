...
package ZCS::Admin::Elements::GetDistributionListResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetDistributionListResponse');
...
GetDistributionListResponse from the namespace urn:zimbraAdmin.
