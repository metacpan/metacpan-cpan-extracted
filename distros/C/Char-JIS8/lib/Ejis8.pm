...
#
# http://search.cpan.org/dist/Char-JIS8/
#
...
#
# JIS8 character range per length
#
my %range_tr = ();

#
# JIS8 case conversion
#
my %lc = ();
...
sub import {
    ...
    *Char::ord           = \&JIS8::ord;
    *Char::ord_          = \&JIS8::ord_;
    *Char::reverse       = \&JIS8::reverse;
    *Char::getc          = \&JIS8::getc;
    *Char::length        = \&JIS8::length;
    *Char::substr        = \&JIS8::substr;
    *Char::index         = \&JIS8::index;
    *Char::rindex        = \&JIS8::rindex;
    *Char::eval          = \&JIS8::eval;
    *Char::escape        = \&JIS8::escape;
    *Char::escape_token  = \&JIS8::escape_token;
    *Char::escape_script = \&JIS8::escape_script;
}
...
sub Ejis8::fc(@);
sub Ejis8::fc_();
sub Ejis8::ignorecase;
sub Ejis8::classic_character_class;
sub Ejis8::capture;
sub Ejis8::chr(;$);
sub Ejis8::chr_();
sub Ejis8::glob($);
...
# ${Ejis8::eS}          = qr{(?>[^\x09\x0A    \x0C\x0D\x20])};
# ${Ejis8::eS}          = qr{(?>[^\x09\x0A\x0B\x0C\x0D\x20])};
${Ejis8::eS}            = qr{(?>[^\s])};

${Ejis8::eW}            = qr{(?>[^0-9A-Z_a-z])};
${Ejis8::eH}            = qr{(?>[^\x09\x20])};
${Ejis8::eV}            = qr{(?>[^\x0A\x0B\x0C\x0D])};
${Ejis8::eR}            = qr{(?>\x0D\x0A|[\x0A\x0D])};
${Ejis8::eN}            = qr{(?>[^\x0A])};
${Ejis8::not_alnum}     = qr{(?>[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Ejis8::not_alpha}     = qr{(?>[^\x41-\x5A\x61-\x7A])};
${Ejis8::not_ascii}     = qr{(?>[^\x00-\x7F])};
${Ejis8::not_blank}     = qr{(?>[^\x09\x20])};
${Ejis8::not_cntrl}     = qr{(?>[^\x00-\x1F\x7F])};
${Ejis8::not_digit}     = qr{(?>[^\x30-\x39])};
${Ejis8::not_graph}     = qr{(?>[^\x21-\x7F])};
${Ejis8::not_lower}     = qr{(?>[^\x61-\x7A])};
${Ejis8::not_lower_i}   = qr{(?>[^\x41-\x5A\x61-\x7A])}; # Perl 5.16 compatible
# ${Ejis8::not_lower_i} = qr{(?>[\x00-\xFF])};                   # older Perl compatible
${Ejis8::not_print}     = qr{(?>[^\x20-\x7F])};
${Ejis8::not_punct}     = qr{(?>[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Ejis8::not_space}     = qr{(?>[^\s\x0B])};
${Ejis8::not_upper}     = qr{(?>[^\x41-\x5A])};
${Ejis8::not_upper_i}   = qr{(?>[^\x41-\x5A\x61-\x7A])}; # Perl 5.16 compatible
# ${Ejis8::not_upper_i} = qr{(?>[\x00-\xFF])};                   # older Perl compatible
${Ejis8::not_word}      = qr{(?>[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Ejis8::not_xdigit}    = qr{(?>[^\x30-\x39\x41-\x46\x61-\x66])};
${Ejis8::eb}            = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Ejis8::eB}            = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Ejis8::foo" used only once: possible typo at here.
${Ejis8::dot}         = ${Ejis8::dot};
${Ejis8::dot_s}       = ${Ejis8::dot_s};
${Ejis8::eD}          = ${Ejis8::eD};
${Ejis8::eS}          = ${Ejis8::eS};
${Ejis8::eW}          = ${Ejis8::eW};
${Ejis8::eH}          = ${Ejis8::eH};
...
${Ejis8::eR}          = ${Ejis8::eR};
${Ejis8::eN}          = ${Ejis8::eN};
${Ejis8::not_alnum}   = ${Ejis8::not_alnum};
${Ejis8::not_alpha}   = ${Ejis8::not_alpha};
${Ejis8::not_ascii}   = ${Ejis8::not_ascii};
${Ejis8::not_blank}   = ${Ejis8::not_blank};
${Ejis8::not_cntrl}   = ${Ejis8::not_cntrl};
${Ejis8::not_digit}   = ${Ejis8::not_digit};
${Ejis8::not_graph}   = ${Ejis8::not_graph};
${Ejis8::not_lower}   = ${Ejis8::not_lower};
${Ejis8::not_lower_i} = ${Ejis8::not_lower_i};
${Ejis8::not_print}   = ${Ejis8::not_print};
${Ejis8::not_punct}   = ${Ejis8::not_punct};
${Ejis8::not_space}   = ${Ejis8::not_space};
${Ejis8::not_upper}   = ${Ejis8::not_upper};
${Ejis8::not_upper_i} = ${Ejis8::not_upper_i};
${Ejis8::not_word}    = ${Ejis8::not_word};
${Ejis8::not_xdigit}  = ${Ejis8::not_xdigit};
${Ejis8::eb}          = ${Ejis8::eb};
${Ejis8::eB}          = ${Ejis8::eB};
...
#
# JIS8 lower case first with parameter
#
sub Ejis8::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Ejis8::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Ejis8::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Ejis8::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# JIS8 lower case first without parameter
#
sub Ejis8::lcfirst_() {
    return Ejis8::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# JIS8 lower case with parameter
#
sub Ejis8::lc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# JIS8 lower case without parameter
#
sub Ejis8::lc_() {
    my $s = $_;
    return join '', map {defined($lc{$_}) ? $lc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# JIS8 upper case first with parameter
#
sub Ejis8::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Ejis8::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Ejis8::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Ejis8::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# JIS8 upper case first without parameter
#
sub Ejis8::ucfirst_() {
    return Ejis8::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# JIS8 upper case with parameter
#
sub Ejis8::uc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# JIS8 upper case without parameter
#
sub Ejis8::uc_() {
    my $s = $_;
    return join '', map {defined($uc{$_}) ? $uc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# JIS8 fold case without parameter
#
sub Ejis8::fc_() {
    my $s = $_;
    return join '', map {defined($fc{$_}) ? $fc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# JIS8 regexp ignore case modifier
#
sub Ejis8::ignorecase {
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Ejis8::uc($char[$i]);
                my $fc = Ejis8::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
#
# prepare JIS8 characters per length
#
...
#
# JIS8 open character list for tr
#
sub _charlist_tr {
...
#
# JIS8 open character list for qr and not qr
#
sub _charlist {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Ejis8::not_lower_i}',
                '[:^upper:]'  => '${Ejis8::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Ejis8::not_alnum}',
                '[:^alpha:]'  => '${Ejis8::not_alpha}',
                '[:^ascii:]'  => '${Ejis8::not_ascii}',
                '[:^blank:]'  => '${Ejis8::not_blank}',
                '[:^cntrl:]'  => '${Ejis8::not_cntrl}',
                '[:^digit:]'  => '${Ejis8::not_digit}',
                '[:^graph:]'  => '${Ejis8::not_graph}',
                '[:^lower:]'  => '${Ejis8::not_lower}',
                '[:^print:]'  => '${Ejis8::not_print}',
                '[:^punct:]'  => '${Ejis8::not_punct}',
                '[:^space:]'  => '${Ejis8::not_space}',
                '[:^upper:]'  => '${Ejis8::not_upper}',
                '[:^word:]'   => '${Ejis8::not_word}',
                '[:^xdigit:]' => '${Ejis8::not_xdigit}',
...
#
# JIS8 hexadecimal escape sequence
#
sub hexchr {
    my($hexdigit) = @_;
...
#
# JIS8 open character list for qr
#
sub charlist_qr {
...
#
# JIS8 open character list for not qr
#
sub charlist_not_qr {
...
#
# JIS8 order to character (with parameter)
#
sub Ejis8::chr(;$) {
...
#
# JIS8 order to character (without parameter)
#
sub Ejis8::chr_() {
...
#
# JIS8 path globbing (with parameter)
#
sub Ejis8::glob($) {
...
#
# JIS8 path globbing (without parameter)
#
sub Ejis8::glob_() {
...
#
# JIS8 path globbing via File::DosGlob 1.10
#
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Ejis8::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Ejis8::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Ejis8::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Ejis8::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
#
# JIS8 character to order (with parameter)
#
sub JIS8::ord(;$) {
...
#
# JIS8 character to order (without parameter)
#
sub JIS8::ord_() {
...
#
# JIS8 getc (with parameter, without parameter)
#
sub JIS8::getc(;*@) {

    my($package) = caller;
    my $fh = @_ ? qualify_to_ref(shift,$package) : \*STDIN;
    croak 'Too many arguments for JIS8::getc' if @_ and not wantarray;
...
#
# JIS8 index by character
#
sub JIS8::index($$;$) {

    my $index;
    if (@_ == 3) {
        $index = Ejis8::index($_[0], $_[1], CORE::length(JIS8::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Ejis8::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return JIS8::length(CORE::substr $_[0], 0, $index);
    }
}

#
# JIS8 rindex by character
#
sub JIS8::rindex($$;$) {

    my $rindex;
    if (@_ == 3) {
        $rindex = Ejis8::rindex($_[0], $_[1], CORE::length(JIS8::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Ejis8::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return JIS8::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
# ord() to ord() or JIS8::ord()
my $function_ord = 'ord';

# ord to ord or JIS8::ord_
my $function_ord_ = 'ord';

# reverse to reverse or JIS8::reverse
my $function_reverse = 'reverse';

# getc to getc or JIS8::getc
...
my $qq_substr  = qr{(?> Char::substr | JIS8::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
#
# escape JIS8 token of script
#
sub JIS8::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Ejis8::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ (?>\s*) PREMATCH  \b | \$ (?>\s*) \{ (?>\s*) PREMATCH  (?>\s*) \} | \$ (?>\s*) \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Ejis8::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Ejis8::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Ejis8::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Ejis8::POSTMATCH()
    elsif (/\G (                 \$ (?>\s*) POSTMATCH \b | \$ (?>\s*) \{ (?>\s*) POSTMATCH (?>\s*) \} | \$ (?>\s*) \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Ejis8::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Ejis8::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob (?>\s*) \) /oxgc) {
        return 'while ($_ = Ejis8::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob \b /oxgc) {
        return 'while ($_ = Ejis8::glob';
    }
...
# subroutines of package Ejis8
    elsif (/\G \b (CORE:: | ->(>?\s*) (?: atan2 | [a-z]{2,})) \b       /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b JIS8::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Char::escape'; }
    elsif (/\G \b JIS8::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval JIS8::escape'; }
    elsif (/\G \b bytes::substr \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Ejis8::chop';       }
    elsif (/\G \b bytes::index \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::index';       }
    elsif (/\G \b JIS8::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'JIS8::index';       }
    elsif (/\G \b index \b         (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Ejis8::index';      }
    elsif (/\G \b bytes::rindex \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::rindex';      }
    elsif (/\G \b JIS8::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'JIS8::rindex';      }
    elsif (/\G \b rindex \b        (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Ejis8::rindex';     }
    elsif (/\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ejis8::lc';         }
    elsif (/\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ejis8::lcfirst';    }
    elsif (/\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ejis8::uc';         }
    elsif (/\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ejis8::ucfirst';    }
    elsif (/\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ejis8::fc';         }
    ...
    elsif (/\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ejis8::chr';               }
    elsif (/\G \b bytes::ord    (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ejis8::glob';              }
    elsif (/\G \b lc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ejis8::lc_';               }
    elsif (/\G \b lcfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ejis8::lcfirst_';          }
    elsif (/\G \b uc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ejis8::uc_';               }
    elsif (/\G \b ucfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ejis8::ucfirst_';          }
    elsif (/\G \b fc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ejis8::fc_';               }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Ejis8::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Ejis8::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq           (\#) [ ] (\#) /oxgc) { return 'Ejis8::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Ejis8::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Ejis8::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Ejis8::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Ejis8::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Ejis8::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q            (\#) [ ] (\#) /oxgc) { return 'Ejis8::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Ejis8::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Ejis8::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Ejis8::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Ejis8::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Ejis8::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                    ' [ ] '    /oxgc) { return 'Ejis8::split' . $e . qq     {' '};  }
        elsif (/\G                    " [ ] "    /oxgc) { return 'Ejis8::split' . $e . qq     {" "};  }
...
# subroutines of package Ejis8
        ...
        elsif ($string =~ /\G \b JIS8::eval       (?= (?>\s*) \{ )                    /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::eval \b                                        /oxgc) { $e_string .= 'eval Char::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b JIS8::eval \b                                        /oxgc) { $e_string .= 'eval JIS8::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                                     /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                              /oxgc) { $e_string .= 'Ejis8::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                                      /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::index \b                                       /oxgc) { $e_string .= 'Char::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b JIS8::index \b                                       /oxgc) { $e_string .= 'JIS8::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                             /oxgc) { $e_string .= 'Ejis8::index';      $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b JIS8::rindex \b                                      /oxgc) { $e_string .= 'JIS8::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                            /oxgc) { $e_string .= 'Ejis8::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Ejis8::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Ejis8::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Ejis8::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Ejis8::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Ejis8::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Ejis8::chr';           $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Ejis8::glob';          $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                                      /oxgc) { $e_string .= 'Ejis8::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                                 /oxgc) { $e_string .= 'Ejis8::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                                      /oxgc) { $e_string .= 'Ejis8::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                                 /oxgc) { $e_string .= 'Ejis8::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                                      /oxgc) { $e_string .= 'Ejis8::fc_';               $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Ejis8::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Ejis8::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq           (\#) [ ] (\#) /oxgc) { $e_string .= 'Ejis8::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { $e_string .= 'Ejis8::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { $e_string .= 'Ejis8::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { $e_string .= 'Ejis8::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { $e_string .= 'Ejis8::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { $e_string .= 'Ejis8::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q            (\#) [ ] (\#) /oxgc) { $e_string .= 'Ejis8::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { $e_string .= 'Ejis8::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { $e_string .= 'Ejis8::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { $e_string .= 'Ejis8::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { $e_string .= 'Ejis8::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { $e_string .= 'Ejis8::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                    ' [ ] '    /oxgc) { $e_string .= 'Ejis8::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                    " [ ] "    /oxgc) { $e_string .= 'Ejis8::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        ...
        return Ejis8::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Ejis8::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Ejis8::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Ejis8::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Ejis8::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Ejis8::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Ejis8::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Ejis8::uc qq<';
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Ejis8::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Ejis8::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Ejis8::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Ejis8::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Ejis8::uc($char[$i]) ne Ejis8::fc($char[$i]))) {
            if (CORE::length(Ejis8::fc($char[$i])) == 1) {
                $char[$i] = '['   . Ejis8::uc($char[$i])       . Ejis8::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Ejis8::uc($char[$i]) . '|' . Ejis8::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ejis8::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ (?>\s*) 0 (?>\s*) \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Ejis8::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ejis8::ignorecase(Ejis8::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Ejis8::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Ejis8::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ejis8::ignorecase(Ejis8::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Ejis8::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Ejis8::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ejis8::ignorecase(Ejis8::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Ejis8::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Ejis8::re_t=%s; while($Ejis8::re_t =~ %s){%s local $^W=0; local $Ejis8::re_r=%s; %s$Ejis8::re_t="$`$Ejis8::re_r$'"; pos($Ejis8::re_t)=length "$`$Ejis8::re_r"; } return $Ejis8::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Ejis8::re_r=CORE::eval $Ejis8::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Ejis8::re_r=%s; %s"%s$Ejis8::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Ejis8::re_n=0; while(%s =~ %s){%s local $^W=0; local $Ejis8::re_r=%s; %s%s="$`$Ejis8::re_r$'"; pos(%s)=length "$`$Ejis8::re_r"; $Ejis8::re_n++} return %s$Ejis8::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Ejis8::re_r=%s; %s%s="%s$Ejis8::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Ejis8::re_r=%s; %s%s="%s$Ejis8::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Ejis8::re_r=CORE::eval $Ejis8::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Ejis8::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Ejis8::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
This Ejis8 module first appeared in ActivePerl Build 522 Built under
...
=item * Split string
  ...
  @split = Ejis8::split(/pattern/,$string,$limit);
  @split = Ejis8::split(/pattern/,$string);
  @split = Ejis8::split(/pattern/);
  @split = Ejis8::split('',$string,$limit);
  @split = Ejis8::split('',$string);
  @split = Ejis8::split('');
  @split = Ejis8::split();
  @split = Ejis8::split;
  ...
  at all, Ejis8::split returns the original string as a single substring, If it
  ...
  @chars  = Ejis8::split(//,  $word);
  @fields = Ejis8::split(/:/, $line);
  @words  = Ejis8::split(" ", $paragraph);
  @lines  = Ejis8::split(/^/, $buffer);
  ...
  print join(":" => Ejis8::split(/ */, "hi there"));
  ...
  Ejis8::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Ejis8::split(/:/, $_, 3);
  ...
  splits on whitespace just as Ejis8::split with no arguments does. Thus,
  Ejis8::split(" ") can be used to emulate awk's default behavior. In contrast,
  Ejis8::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Ejis8::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Ejis8::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Ejis8::split()) {
          $count{$word}++;
      }
  }

  The inverse of Ejis8::split is join, except that join can only join with the
...
=item * Transliteration
  ...
  $tr = Ejis8::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Ejis8::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  This subroutine scans a JIS8 string character by character and replaces all
  occurrences of the characters found in $searchlist with the corresponding character
  in $replacementlist. It returns the number of characters replaced or deleted.
  If no JIS8 string is specified via =~ operator, the $_ variable is translated.
  $modifier are:
  ...
  print Ejis8::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item * Chop string

  $chop = Ejis8::chop(@list);
  $chop = Ejis8::chop();
  $chop = Ejis8::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Ejis8::chop subroutine is used primary to remove the newline
  ...
  since Ejis8::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Ejis8::chop a literal, only a variable. If you Ejis8::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Ejis8::chop(@lines);

  You can Ejis8::chop anything that is an lvalue, including an assignment:

  Ejis8::chop($cwd = `pwd`);
  Ejis8::chop($answer = <STDIN>);

  This is different from:

  $answer = Ejis8::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Ejis8::chop returns the character
  ...
  In the most general case, Ejis8::chop can be expressed using substr:

  $last_code = Ejis8::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Ejis8::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Ejis8::chop;
...
=item * Index string
  ...
  $byte_pos = Ejis8::index($string,$substr,$byte_offset);
  $byte_pos = Ejis8::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Ejis8::index($string, $lookfor, $byte_pos)) > -1) {
...
=item * Reverse index string
  ...
  $byte_pos = Ejis8::rindex($string,$substr,$byte_offset);
  $byte_pos = Ejis8::rindex($string,$substr);

  This subroutine works just like Ejis8::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Ejis8::index).
  ...
  while (($byte_pos = JIS8::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item * Lower case string
  ...
  This subroutine returns a lowercased version of JIS8 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Ejis8::fc subroutine for case-insensitive comparisons via JIS8
  software.

=item * Lower case first character of string

  $lcfirst = Ejis8::lcfirst($string);
  $lcfirst = Ejis8::lcfirst_;

  This subroutine returns a version of JIS8 $string with the first character
...
=item * Upper case string
  ...
  This subroutine returns an uppercased version of JIS8 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Ejis8::ucfirst instead.
...
=item * Upper case first character of string
  ...
  $ucfirst = Ejis8::ucfirst($string);
  $ucfirst = Ejis8::ucfirst_;
  ...
  $titlecase = Ejis8::ucfirst(substr($word,0,1)) . Ejis8::lc(substr($word,1));
  ...
  $do_not_use = Ejis8::ucfirst(Ejis8::lc($word));
...
=item * Fold case string
  ...
  New to JIS8 software, this subroutine returns the full Unicode-like casefold of
  JIS8 $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Ejis8::fc($a) eq Ejis8::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because JIS8 software has always used casefolding semantics for
...
=item * Make ignore case string
  ...
  @ignorecase = Ejis8::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item * Make capture number

  $capturenumber = Ejis8::capture($string);
...
=item * Make character
  ...
  that $code in the character set. For example, Ejis8::chr(65) is "A" in either
  ASCII or JIS8, not Unicode. For the reverse of Ejis8::chr, use JIS8::ord.

=item * Filename expansion (globbing)

  @glob = Ejis8::glob($string);
  @glob = Ejis8::glob_;
  ...
  The Ejis8::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Ejis8::glob('"*e f*"');
  @spacies = Ejis8::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Ejis8::glob("'*${var}e f*'");
  @spacies = Ejis8::glob(qq("*${var}e f*"));
