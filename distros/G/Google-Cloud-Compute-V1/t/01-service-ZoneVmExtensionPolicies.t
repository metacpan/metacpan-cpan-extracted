...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::VmExtensionPolicy Google::Cloud::Compute::V1::Compute::VmExtensionPolicyList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::ZoneVmExtensionPoliciesClient->new( credentials => 'dummy' );
