...
Quoting from L<jQuery documentation|https://api.jquery.com/each/>:
...
Return a L<DateTime::Lite object|DateTime::Lite> representing the current time and that stringifies to the number of seconds since epoch, resulting into the equivalent of L<perlfunc/time>

The new L<DateTime::Lite> object stringifies to the 10-digits epoch time.
...
=item * C<date> for L<DateTime::Lite>, L<DateTime> or L<Module::Generic::DateTime> objects
