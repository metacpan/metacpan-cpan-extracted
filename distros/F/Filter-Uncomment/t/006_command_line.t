...
my $multi_single = '-MFilter::Uncomment=multi -MFilter::Uncomment=single' ;
my $multi = '-MFilter::Uncomment=multi' ;
...
$test->run(interpreter => "perl -Mblib $multi_single $filename",)	;
...
$test->run(interpreter => "perl -Mblib $multi $filename",)	;
