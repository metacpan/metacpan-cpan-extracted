package Firewall::Config::Element::Rule::Neteye;
...
#------------------------------------------------------------------------------
# Firewall::Config::Element::Rule::Neteye 通用属性
#------------------------------------------------------------------------------
has policyId => (
  is       => 'ro',
  isa      => 'Str',
...
sub _buildSrcAddressGroup {
  my $self = shift;
  return Firewall::Config::Element::AddressGroup::Neteye->new( addrGroupName => '^' );
}
...
sub _buildServiceGroup {
  my $self = shift;
  return Firewall::Config::Element::ServiceGroup::Neteye->new( srvGroupName => '^' );
}
