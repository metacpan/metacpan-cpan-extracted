...
Perl::Examples::Accessors::ObjectSimple

=head1 VERSION

This document describes version 0.133 of Perl::Examples::Accessors::ObjectSimple (from Perl distribution Perl-Examples-Accessors), released on 2024-05-06.

=head1 DESCRIPTION

This is an example of a class which uses L<Object::Simple>.
