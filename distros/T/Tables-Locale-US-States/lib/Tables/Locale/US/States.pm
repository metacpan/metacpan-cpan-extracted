...
our $DIST = 'Tables-Locale-US-States'; # DIST
our $VERSION = '20200531.0.0'; # VERSION
...
Tables::Locale::US::States - US states

=head1 VERSION

This document describes version 20200531.0.0 of Tables::Locale::US::States (from Perl distribution Tables-Locale-US-States), released on 2020-06-01.

=head1 HOMEPAGE

Please visit the project's homepage at L<https://metacpan.org/release/Tables-Locale-US-States>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Tables-Locale-US-States>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=Tables-Locale-US-States>
