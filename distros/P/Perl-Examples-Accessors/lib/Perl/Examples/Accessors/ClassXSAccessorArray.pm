...
Perl::Examples::Accessors::ClassXSAccessorArray

=head1 VERSION

This document describes version 0.130 of Perl::Examples::Accessors::ClassXSAccessorArray (from Perl distribution Perl-Examples-Accessors), released on 2017-09-01.
