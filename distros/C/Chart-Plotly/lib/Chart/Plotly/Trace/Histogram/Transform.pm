package Chart::Plotly::Trace::Histogram::Transform;
use Moose;
...
Chart::Plotly::Trace::Histogram::Transform - This attribute is one of the possible options for the trace histogram.
