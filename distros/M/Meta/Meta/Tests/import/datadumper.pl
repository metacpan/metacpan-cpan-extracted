...
my($obje)=Meta::Ds::Hash->new();
Meta::Utils::Output::print(Data::DumpXML::dump_xml($obje));
...
datadumper.pl - test the Data::DumpXML module.
...
This is a test suite for the Data::DumpXML package.
...
Data::DumpXML(3), Meta::Baseline::Test(3), Meta::Ds::Hash(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), strict(3)
