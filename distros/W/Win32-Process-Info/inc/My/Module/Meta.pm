...
My::Module::Meta - Information needed to build Win32::Process::Info
...
C<Win32::Process::Info>. It is private to the C<Win32::Process::Info>
...
modules required to build the C<Win32::Process::Info> package, suitable
...
This method computes and returns a reference to a hash describing the
modules required to run the C<Win32::Process::Info> package, suitable
