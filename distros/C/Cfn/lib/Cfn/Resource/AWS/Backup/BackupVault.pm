# AWS::Backup::BackupVault generated from spec 34.0.0
...
package Cfn::Resource::Properties::AWS::Backup::BackupVault {
  ...
  has BackupVaultTags => (isa => 'Cfn::Value::Hash|Cfn::DynamicValue', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
