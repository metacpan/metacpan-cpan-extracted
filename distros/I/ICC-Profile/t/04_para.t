...
# ICC::Profile::para test module / 2014-05-26
#
...
# does module load
BEGIN { use_ok('ICC::Profile::para') };

# test class methods
can_ok('ICC::Profile::para', qw(new new_fh write_fh size inverse derivative transform array sdump));

# make empty para object
$tag = ICC::Profile::para->new;

# test object class
isa_ok($tag, 'ICC::Profile::para');

# read eciRGB_v2_ICCv4 profile
$profile = t::lib::Boot->new(File::Spec->catfile('t', 'data', 'eciRGB_v2_ICCv4.icc'));

# read 'rTRC' tag
$tag = ICC::Profile::para->new_fh($profile, $profile->fh, $profile->tag_table->[3]);
