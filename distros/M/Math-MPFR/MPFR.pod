   ...
   OPERATOR OVERLOADING
    ...
    The following operators are overloaded:
     ...
     << >> <<= >>= (These just increase/decrease the exponent by the
                    value of the given "shift" argument. Negative
                    values for the 'shift' argument are allowed - in
                    which case the shift value is multiplied by -1
    ...
    Each operation is conducted using default Math::MPFR rounding
    mode and default Math::MPFR precision.
    ...
    $Math::GMPz::RETYPE == 1), but not for Math::GMPf :
    ...
    returned as a Math::MPFR object, calculated using Math::MPFR
    default precision and Math::MPFR default rounding mode.
