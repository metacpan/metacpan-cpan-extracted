package Biblio::ILL::ISO::Message;

=head1 NAME

Biblio::ILL::ISO::Message - Perl extension for handling ISO 10161 interlibrary loan Message messages
...
Biblio::ILL::ISO::Message is a derivation of the abstract 
Biblio::ILL::ISO::ISO object, and handles the Message message type.
...
Message message from a file (followed by a call to
...
For any example code, assume the following:
    my $msg = new Biblio::ILL::ISO::Message;
...
To read a message from a file, use the following:
    ...
    my $href = $msg->read("msg_17.message.ber");
