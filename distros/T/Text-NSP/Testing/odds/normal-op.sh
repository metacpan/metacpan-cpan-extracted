...
# shell program to test odds.pm's output during normal operation (that
...
# now the test!
echo "Test:   statistic.pl odds test-1.out $TESTFILE" 
statistic.pl odds test-1.out $TESTFILE 
...
statistic.pl --set_freq_combo $FREQCOMBFILE odds test-2.out $TESTFILE
