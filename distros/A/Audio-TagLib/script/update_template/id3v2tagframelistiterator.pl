...
sysopen my $target, "xs/id3v2tagframelistiterator.xs", O_CREAT | O_WRONLY | O_TRUNC or die "sysopen: $!";
...
while(<$source>) {
	...
	s/_NAMESPACE_/TagLib::ID3v2::FrameList::Iterator/mg;
	s/_T_/TagLib::ID3v2::Frame/mg;
	print $target $_;
}
