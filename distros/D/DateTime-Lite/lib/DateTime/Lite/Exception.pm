##----------------------------------------------------------------------------
## Lightweight DateTime Alternative - ~/lib/DateTime/Lite/Exception.pm
## Version v0.1.0
...
##----------------------------------------------------------------------------
package DateTime::Lite::Exception;
BEGIN
{
    use v5.10.1;
    use strict;
...
DateTime::Lite::Exception - Exception object for DateTime::Lite
...
=head1 SYNOPSIS
    ...
    if( !defined( $dt ) )
    {
        my $err = DateTime::Lite->error;  # DateTime::Lite::Exception object
...
C<DateTime::Lite::Exception> is a lightweight exception class used internally by L<DateTime::Lite>. It is created automatically by the C<error()> method and stored both on the object and in a package-level C<$ERROR> variable.
