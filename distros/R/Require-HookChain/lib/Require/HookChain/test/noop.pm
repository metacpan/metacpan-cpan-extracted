...
Require::HookChain::test::noop - Do nothing when a module is loaded

=head1 VERSION

This document describes version 0.016 of Require::HookChain::test::noop (from Perl distribution Require-HookChain), released on 2023-12-05.
