# This Makefile is for the Devel::Scooby extension to perl.
#
...
AR_STATIC_ARGS = cr
NAME = Devel::Scooby
DISTNAME = Devel-Scooby
NAME_SYM = Devel_Scooby
VERSION = 4.12
VERSION_SYM = 4_12
XS_VERSION = 4.12
INST_BIN = blib/bin
...
TO_INST_PM = Scooby.pm

PM_TO_BLIB = Scooby.pm \
	$(INST_LIBDIR)/Scooby.pm
