...
sub test_readableNumber : Test(12) {
    my $self = shift;

    my @arg =  ( 1,  12, 123,  12345,    -12345678,    1234.5678);
    my @val1 = ('1','12','123','12.345','-12.345.678','1.234,5678');
    my @val2 = ('1','12','123','12,345','-12,345,678','1,234.5678');
