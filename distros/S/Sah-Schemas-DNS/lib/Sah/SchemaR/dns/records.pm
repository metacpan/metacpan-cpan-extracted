...
our $rschema = ["array",[{of=>["dns::record",{req=>1},{}],summary=>"Array of DNS records"}],["array"]];
...
This document describes version 0.002 of Sah::SchemaR::dns::records (from Perl distribution Sah-Schemas-DNS), released on 2019-07-25.
