...
#pod
#pod This is C<Hook::Init> plugin implementation. Nothing interesting, just using few roles.
#pod
...
package Dist::Zilla::Plugin::Hook::Init;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::Init> plugin implementation
...
Dist::Zilla::Plugin::Hook::Init - C<Hook::Init> plugin implementation
...
This is C<Hook::Init> plugin implementation. Nothing interesting, just using few roles.
