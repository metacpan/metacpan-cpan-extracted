...
my $color  = Latin8::substr $s, 4, 5;   # black
my $middle = Latin8::substr $s, 4, -11; # black cat climbed the
my $end    = Latin8::substr $s, 14;     # climebed the green tree
my $tail   = Latin8::substr $s, -4;     # tree
my $z      = Latin8::substr $s, -4, 2;  # tr
