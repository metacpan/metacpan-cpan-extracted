# This Makefile is for the Ham::Device::FT817COMM extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Ham/Device/FT817COMM.pm]
...
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Device::SerialPort=>q[0], Digest::MD5=>q[0] }
...
NAME_SYM = Ham_Device_FT817COMM
VERSION = 0.9.0_05
VERSION_MACRO = VERSION
VERSION_SYM = 0_9_0_05
...
MAKE = make
FULLEXT = Ham/Device/FT817COMM
BASEEXT = FT817COMM
PARENT_NAME = Ham::Device
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Ham/Device/FT817COMM.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Ham/Device
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Ham/Device
...
TO_INST_PM = lib/Ham/Device/FT817COMM.pm

PM_TO_BLIB = lib/Ham/Device/FT817COMM.pm \
...
DISTNAME = Ham-Device-FT817COMM
DISTVNAME = Ham-Device-FT817COMM-0.9.0_05
...
manifypods : pure_all  \
	lib/Ham/Device/FT817COMM.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Ham/Device/FT817COMM.pm $(INST_MAN3DIR)/Ham::Device::FT817COMM.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Ham-Device-FT817COMM' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.9.0_05' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Library to control the Yaesu FT817 Ham Radio' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Jordan Rubin <jrubin@cpan.org>' >> META_new.yml
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.9.0_05">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Library to control the Yaesu FT817 Ham Radio</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Ham/Device/FT817COMM.pm blib/lib/Ham/Device/FT817COMM.pm 
