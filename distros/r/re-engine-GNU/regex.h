...
extern reg_syntax_t re_set_syntax (pTHX_ reg_syntax_t __syntax);
...
/* Compile a fastmap for the compiled pattern in BUFFER; used to
   ...
   internal error.  */
extern int re_compile_fastmap (pTHX_ struct re_pattern_buffer *__buffer);
...
extern void re_set_registers (pTHX_ struct re_pattern_buffer *__buffer,
			      struct re_registers *__regs,
...
extern size_t regerror (pTHX_ int __errcode, const regex_t *_Restrict_ __preg,
			char *_Restrict_ __errbuf, size_t __errbuf_size);

extern void regfree (pTHX_ regex_t *__preg);
