  ...
  { dist_root => 'does-not-exist' },
  {
    add_files => {
      path('source', 'dist.ini') => simple_ini({},
        ['@Starter' => { revision => 2, installer => 'MakeMaker::Awesome', 'MakeMaker::Awesome.header[0]' => 'TEST STRING PLEASE IGNORE' }],
        [Prereqs => { 'perl' => '5.006' }],
      ),
...
my $makefile_pl = $tzil->slurp_file('build/Makefile.PL');
like $makefile_pl, qr/TEST STRING PLEASE IGNORE/, 'Makefile.PL contains string';
