...
Acme::CPANModules::PERLANCAR::Assert - Assertion

=head1 VERSION

This document describes version 0.002 of Acme::CPANModules::PERLANCAR::Assert (from Perl distribution Acme-CPANModulesBundle-PERLANCAR), released on 2018-06-11.
