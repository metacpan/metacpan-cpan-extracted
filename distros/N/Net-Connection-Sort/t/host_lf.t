...
ok( $worked == 1, 'sorter init') or die ('Net::Connection::Sort::host_lf->new resulted in... '.$@);
...
ok( $worked == 1, 'sort') or die ('Net::Connection::Sort::host_lf->sorter(@objects) resulted in... '.$@);
