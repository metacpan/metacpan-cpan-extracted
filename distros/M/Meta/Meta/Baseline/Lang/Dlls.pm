...
package Meta::Baseline::Lang::Dlls;
...
Meta::Baseline::Lang::Dlls - language for dll files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Dlls::env();

=head1 DESCRIPTION

This package contains stuff specific to Dlls in the baseline:
Its mainly here to authorize entries of shared library files to the baseline.
