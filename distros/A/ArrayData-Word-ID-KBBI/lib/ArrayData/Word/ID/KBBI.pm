...
ArrayData::Word::ID::KBBI - Indonesian words from Kamus Besar Bahasa Indonesia
...
Please visit the project's homepage at L<https://metacpan.org/release/ArrayData-Word-ID-KBBI>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-ArrayData-Word-ID-KBBI>.
