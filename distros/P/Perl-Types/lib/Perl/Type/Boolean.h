...
#ifndef __CPP__INCLUDED__Perl__Type__Boolean_h
#define __CPP__INCLUDED__Perl__Type__Boolean_h 0.004_000

// [[[ TYPEDEFS ]]]
// DEV NOTE: must use "boolean" typedef because "bool" is already defined by Inline's default typemap, even if we put our own boolean entry into typemap.perl;
...
# ifdef __PERL__TYPES
SV* Perl__Type__Boolean__MODE_ID() { return(newSViv(1)); }  // CPPOPS_PERLTYPES is 1
# elif defined __CPP__TYPES
int Perl__Type__Boolean__MODE_ID() { return 2; }  // CPPOPS_CPPTYPES is 2
# else
...
// [[[ UNSIGNED INTEGERIFY ]]]
# ifdef __PERL__TYPES
SV* boolean_to_nonsigned_integer(SV* input_boolean);
# elif defined __CPP__TYPES
nonsigned_integer boolean_to_nonsigned_integer(boolean input_boolean);
# endif
