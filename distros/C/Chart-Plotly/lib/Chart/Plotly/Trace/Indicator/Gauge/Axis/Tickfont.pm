package Chart::Plotly::Trace::Indicator::Gauge::Axis::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Indicator::Gauge::Axis::Tickfont - This attribute is one of the possible options for the trace indicator.
