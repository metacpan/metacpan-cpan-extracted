...
package UMMF::UML_1_5::OCL::Expressions::SendAction;
...
L<UMMF::UML_1_5::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction|UMMF::UML_1_5::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction>
...
=head2 C<sendSignal> : I<THIS> C<1> E<lt>----  C<> : UMMF::UML_1_5::OCL::Expressions::OclMessageExp C<1>
...
=head2 C<__validate_type>
  ...
  UMMF::UML_1_5::OCL::Expressions::SendAction->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::OCL::Expressions::SendAction|UMMF::UML_1_5::OCL::Expressions::SendAction>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::OCL::Expressions::SendAction')  ;
}


=head2 C<__typecheck>

  UMMF::UML_1_5::OCL::Expressions::SendAction->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::OCL::Expressions::SendAction->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::OCL::Expressions::SendAction' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML_1_5::OCL::Expressions::SendAction|UMMF::UML_1_5::OCL::Expressions::SendAction>.
  ...
  $__tangram_schema ||=
  {
   ...
   [
	 ...
	 # Associations
       ...
       'bases' => [  'UMMF::UML_1_5::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction',  ],
       'sql' => {
...
sub __initialize
{
  ...
  unless ( ! $__initialize_use ) {
    ...
    $self->__use('UMMF::UML_1_5::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction');
  }

  $self->UMMF::UML_1_5::OCL::Expressions::SendAction::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::OCL::Expressions::SendAction::___create(@args);
  ...
  $self->UMMF::UML_1_5::Behavioral_Elements::Actions::Messaging_Actions::SendSignalAction::___create();
