...
# Data sources:
# <https://web.archive.org/web/20150715025823/http://spdx.org:80/licenses>
# <https://web.archive.org/web/20150717181518/http://spdx.org:80/licenses/exceptions-index.html>

like(
	license_org_metadata( 'spdx', { date => '20150730', rev => '2_1' } ),
	hash {
...
# TODO		field 'FLTK exception 2.0'                => 'FLTK-exception-2.0';
...
# TODO		field 'U-Boot exception 2.0'            => 'u-boot-exception-2.0';
	...
	'coverage of SPDX 2.1, released 2015-07-30'
);
