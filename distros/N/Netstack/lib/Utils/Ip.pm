...
has rangeRegex => (
  ...
  default => sub {
    my $self = shift;
    return qr/^(?:(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})\.){3}(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})-(?:(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})\.){3}(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})$/;
  },
);
...
has subRangeRegex => (
  ...
  default => sub {
    my $self = shift;
    return qr/^(?:(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})\.){3}(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})-(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})$/;
  },
);
...
has ipMask => (
  ...
  default => sub {
    my $self = shift;
    return qr/^(?:(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})\.){3}(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})\/(?:[1-9]|[12][0-9]|3[0-2])$/;
  },
);
...
has ipRange => (
  ...
  default => sub {
    my $self = shift;
    return qr/(^(?:(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})\.){3}(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})-(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})$)|(^(?:(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})\.){3}(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})-(?:(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})\.){3}(?:25[0-5]|2[0-4][0-9]|[0-1]?[0-9]{1,2})$)/;
  },
);

#------------------------------------------------------------------------------
# 定义 Firewall::Utils::Ip 方法属性
#------------------------------------------------------------------------------
sub getRangeFromIpRange {
  ...
  return wantarray
    ? ( $min, $max )
    : Firewall::Utils::Set->new( $min, $max );
}
...
sub getRangeFromService {
  ...
  if ( $proto eq '0' or $proto =~ /any/i ) {
    return wantarray
      ? ( 0, 16777215 )
      : Firewall::Utils::Set->new( 0, 16777215 );
  }
