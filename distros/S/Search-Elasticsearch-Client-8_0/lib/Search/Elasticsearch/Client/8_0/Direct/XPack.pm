...
$Search::Elasticsearch::Client::8_0::Direct::XPack::VERSION = '8.00';
use Moo;
...
Search::Elasticsearch::Client::8_0::Direct::XPack - Plugin providing XPack APIs for Search::Elasticsearch v8.x
