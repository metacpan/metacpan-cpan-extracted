package OWL::DirectSemantics::Element::ObjectAllValuesFrom;

BEGIN {
	$OWL::DirectSemantics::Element::ObjectAllValuesFrom::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::ObjectAllValuesFrom::VERSION   = '0.001';
};
...
OWL::DirectSemantics::Element::ObjectAllValuesFrom - represents an OWL ObjectAllValuesFrom

=head1 DESCRIPTION

This class represents the ObjectAllValuesFrom element in OWL Direct Semantics.
