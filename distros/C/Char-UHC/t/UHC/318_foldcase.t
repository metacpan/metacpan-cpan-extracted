...
if (fc('귺귽긂긄긆') eq '귺귽긂긄긆') {
    print qq{ok - 2 fc('귺귽긂긄긆') eq '귺귽긂긄긆'\n};
}
else {
    print qq{not ok - 2 fc('귺귽긂긄긆') eq '귺귽긂긄긆'\n};
}
...
if ("\F귺귽긂긄긆\E" eq "귺귽긂긄긆") {
    print qq{ok - 4 "\\F귺귽긂긄긆\\E" eq "귺귽긂긄긆"\n};
}
else {
    print qq{not ok - 4 "\\F귺귽긂긄긆\\E" eq "귺귽긂긄긆"\n};
}
...
if ("귺귽긂긄긆" =~ /\F귺귽긂긄긆\E/) {
    print qq{ok - 11 "귺귽긂긄긆" =~ /\\F귺귽긂긄긆\\E/\n};
}
else {
    print qq{not ok - 11 "귺귽긂긄긆" =~ /\\F귺귽긂긄긆\\E/\n};
}

if ("귺귽긂긄긆" =~ /\F귺귽긂긄긆\E/i) {
    print qq{ok - 12 "귺귽긂긄긆" =~ /\\F귺귽긂긄긆\\E/i\n};
}
else {
    print qq{not ok - 12 "귺귽긂긄긆" =~ /\\F귺귽긂긄긆\\E/i\n};
}

$var = '귺귽긂긄긆';
if ("귺귽긂긄긆" =~ /\F$var\E/i) {
    print qq{ok - 13 "귺귽긂긄긆" =~ /\\F\$var\\E/i\n};
}
else {
    print qq{not ok - 13 "귺귽긂긄긆" =~ /\\F\$var\\E/i\n};
}
