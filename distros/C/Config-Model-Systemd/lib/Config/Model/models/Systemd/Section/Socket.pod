# PODNAME: Config::Model::models::Systemd::Section::Socket
# ABSTRACT:  Configuration class Systemd::Section::Socket
...
Defaults to 0666. I< Optional. Type uniline.  > 
...
notation. Defaults to 0755. I< Optional. Type uniline.  > 
...
cleaned up and released from memory, and do not accumulate. I< Optional. Type boolean.  > 
...
false, in read-only mode. Defaults to false. I< Optional. Type boolean.  > 
...
with C<Accept=no> or datagram sockets. Defaults to 64. I< Optional. Type uniline.  > 
...
L<tcp(7)>).
Defaults to C<false>. I< Optional. Type boolean.  > 
...
Disabled by default. I< Optional. Type integer.  > 
...
C<reliability> or C<low-cost> may be specified. I< Optional. Type integer.  > 
...
understood to the base of 1024. I< Optional. Type uniline.  > 

=head2 MessageQueueMaxMessages
...
address. Defaults to C<false>. I< Optional. Type boolean.  > 
...
Takes a boolean value. This controls the C<SO_PASSPIDFD> socket
...
Takes a boolean value. This controls the C<IP_PKTINFO>,
...
=head2 AcceptFileDescriptors

Takes a boolean value. This controls the C<SO_PASSRIGHTS> socket
...
Takes one of C<off>, C<us> (alias:
C<usec>, C<μs>) or C<ns> (alias:
...
carry timestamping metadata. Defaults to C<off>. I< Optional. Type enum. choice: 'ns', 'nsec', 'off', 'us', 'usec', 'μs'.  > 
...
stack. This setting applies only to stream sockets. I< Optional. Type uniline.  > 
...
files. I< Optional. Type list of uniline.  > 
...
list. I< Optional. Type uniline.  > 

=head2 FileDescriptorName
...
C<connection> otherwise. I< Optional. Type uniline.  > 

=head2 TriggerLimitIntervalSec
...
C<s>, C<min>, C<h>, … and defaults to 2s (See
...
C<TriggerLimitIntervalSec>/C<TriggerLimitBurst> results in. I< Optional. Type uniline.  > 

=head2 TriggerLimitBurst
...
unless one of them is reconfigured or disabled. I< Optional. Type uniline.  > 

=head2 PollLimitBurst
...
Takes a boolean argument, or C<patient>. May only be used when C<Accept=no>.
...
operations while the triggered service is stopped. I< Optional. Type enum. choice: 'no', 'patient', 'yes'.  > 
...
=head2 DeferTriggerMaxSec

Configures the maximum time to defer the triggering when C<DeferTrigger>
...
=head2 PassFileDescriptorsToExec
...
C<ExecStartPre> command cannot access socket file descriptors. I< Optional. Type boolean.  > 
