# AWS::ServiceCatalog::LaunchNotificationConstraint generated from spec 2.22.0
...
package Cfn::Resource::Properties::AWS::ServiceCatalog::LaunchNotificationConstraint {
  ...
  has NotificationArns => (isa => 'Cfn::Value::Array|Cfn::Value::Function|Cfn::DynamicValue', is => 'rw', coerce => 1, required => 1, traits => [ 'CfnMutability' ], mutability => 'Immutable');
