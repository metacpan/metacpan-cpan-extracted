...
package Google::Ads::AdWords::v201809::TrialService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::TrialService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201809::TrialService::query->new($data);
