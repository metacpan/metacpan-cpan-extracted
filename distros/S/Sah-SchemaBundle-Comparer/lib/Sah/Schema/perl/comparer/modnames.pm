...
Sah::Schema::perl::comparer::modnames - Array of Perl Comparer::* module names without the prefix, e.g. ["Foo::bar", "Foo::baz"]

=head1 VERSION

This document describes version 0.002 of Sah::Schema::perl::comparer::modnames (from Perl distribution Sah-SchemaBundle-Comparer), released on 2024-03-07.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::comparer::modnames*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::comparer::modnames", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::comparer::modnames", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::comparer::modnames*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::comparer::modnames*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::comparer::modnames*', name=>'PerlComparerModnames')
     );
 }

 use My::Types qw(PerlComparerModnames);
 PerlComparerModnames->assert_valid($data);
