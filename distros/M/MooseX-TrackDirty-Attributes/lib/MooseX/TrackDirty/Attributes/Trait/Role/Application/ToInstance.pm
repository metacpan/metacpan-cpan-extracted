...
BEGIN {
  $MooseX::TrackDirty::Attributes::Trait::Role::Application::ToInstance::AUTHORITY = 'cpan:RSRCHBOY';
}
$MooseX::TrackDirty::Attributes::Trait::Role::Application::ToInstance::VERSION = '2.003';
...
This document describes version 2.003 of MooseX::TrackDirty::Attributes::Trait::Role::Application::ToInstance - released December 23, 2014 as part of MooseX-TrackDirty-Attributes.
