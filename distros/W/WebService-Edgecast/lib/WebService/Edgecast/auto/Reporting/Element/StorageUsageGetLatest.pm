...
package WebService::Edgecast::auto::Reporting::Element::StorageUsageGetLatest;
BEGIN {
  $WebService::Edgecast::auto::Reporting::Element::StorageUsageGetLatest::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('StorageUsageGetLatest');
...
WebService::Edgecast::auto::Reporting::Element::StorageUsageGetLatest
...
StorageUsageGetLatest from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Reporting::Element::StorageUsageGetLatest->new($data);
