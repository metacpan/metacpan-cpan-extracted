...
package WebService::Edgecast::auto::Administration::Element::CustomerOriginsGet;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerOriginsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerOriginsGet');
...
WebService::Edgecast::auto::Administration::Element::CustomerOriginsGet
...
CustomerOriginsGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerOriginsGet->new($data);
