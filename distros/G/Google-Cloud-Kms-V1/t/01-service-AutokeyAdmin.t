...
BEGIN {
    for my $pkg (qw( Google::Cloud::Kms::V1::AutokeyAdmin::AutokeyConfig Google::Cloud::Kms::V1::AutokeyAdmin::ShowEffectiveAutokeyConfigResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Kms::AutokeyAdminClient->new( credentials => 'dummy' );
