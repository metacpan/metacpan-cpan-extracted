...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::Policy Google::Cloud::Compute::V1::Compute::StoragePool Google::Cloud::Compute::V1::Compute::StoragePoolAggregatedList Google::Cloud::Compute::V1::Compute::StoragePoolList Google::Cloud::Compute::V1::Compute::StoragePoolListDisks Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::StoragePoolsClient->new( credentials => 'dummy' );
