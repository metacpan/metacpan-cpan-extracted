...
pc.pl - testing program for the Meta::Utils::Pc.pm module.
...
This is a test suite for the Meta::Utils::Pc.pm package.
...
Meta::Baseline::Test(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Pc(3), Meta::Utils::System(3), strict(3)
