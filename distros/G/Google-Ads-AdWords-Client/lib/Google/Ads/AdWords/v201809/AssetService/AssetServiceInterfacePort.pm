package Google::Ads::AdWords::v201809::AssetService::AssetServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201809::TypeMaps::AssetService
    if not Google::Ads::AdWords::v201809::TypeMaps::AssetService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201809/AssetService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201809::TypeMaps::AssetService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::AssetService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201809::AssetService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::AssetService::mutate )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201809/AssetService.
...
Returns a L<Google::Ads::AdWords::v201809::AssetService::getResponse|Google::Ads::AdWords::v201809::AssetService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::AssetService::mutateResponse|Google::Ads::AdWords::v201809::AssetService::mutateResponse> object.
