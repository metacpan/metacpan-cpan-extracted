...
#
# WSDL File: t/authority01.wsdl
#
my $wsdlData = &readWSDL('t/authority01.wsdl');
ok($wsdlData, 'WSDL file: t/authority01.wsdl');

my $wsdl = LS::Authority::WSDL::Simple->from_xml($wsdlData);
isa_ok($wsdl, 'LS::Authority::WSDL::Simple');

my $metaLoc = $wsdl->getMetadataLocations();
...
cmp_ok($specificLoc->parentName(), 'eq', 'NCBI', 'Verify the parent service\'s name');
