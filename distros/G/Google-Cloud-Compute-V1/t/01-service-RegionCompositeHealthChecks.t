...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::CompositeHealthCheck Google::Cloud::Compute::V1::Compute::CompositeHealthCheckAggregatedList Google::Cloud::Compute::V1::Compute::CompositeHealthCheckHealth Google::Cloud::Compute::V1::Compute::CompositeHealthCheckList Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::RegionCompositeHealthChecksClient->new( credentials => 'dummy' );
