...
App::findsort - Unix find wrapper to add sorting

=head1 VERSION

This document describes version 0.001 of App::findsort (from Perl distribution App-findsort), released on 2024-09-19.

=head1 SYNOPSIS

See included script L<findsort>.
