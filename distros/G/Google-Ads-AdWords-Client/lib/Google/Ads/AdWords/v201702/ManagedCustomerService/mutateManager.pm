...
package Google::Ads::AdWords::v201702::ManagedCustomerService::mutateManager;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201702::MoveOperation',
    },
    {
...
mutateManager from the namespace https://adwords.google.com/api/adwords/mcm/v201702.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::ManagedCustomerService::mutateManager->new($data);
