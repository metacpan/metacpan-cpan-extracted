...
Sah::Schema::uint_range - Unsigned integer range (sequence of uints/simple ranges), e.g. 1 / 5-7 / 1,10 / 1,5-7,10

=head1 VERSION

This document describes version 0.004 of Sah::Schema::uint_range (from Perl distribution Sah-Schemas-IntRange), released on 2021-07-17.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("uint_range*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("uint_range*");
     $validator->(\@args);
     ...
 }
