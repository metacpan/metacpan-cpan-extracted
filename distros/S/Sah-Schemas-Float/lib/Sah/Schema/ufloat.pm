...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("ufloat", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("ufloat", {return_type=>'str_errmsg+val'});
 ...
 # a sample invalid data
 $data = -0.1;
 my $res = $validator->($data); # => ["Must be at least 0",-0.1]
