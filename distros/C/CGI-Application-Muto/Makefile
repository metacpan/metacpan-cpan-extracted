# This Makefile is for the CGI::Application::Muto extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/CGI/Application/Muto.pm]
#     AUTHOR => q[Uriel Lizama <uriel@baboonsoftware.com>]
#     BUILD_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[CGI::Application::Muto]
#     PL_FILES => {  }
#     PREREQ_PM => { CGI::Application::Plugin::ConfigAuto=>q[0], CGI::Application::Plugin::Redirect=>q[0], Data::Dumper=>q[0], CGI::Application::Plugin::DBH=>q[0], Test::More=>q[0], CGI::Application=>q[4], CGI::Application::Plugin::LogDispatch=>q[0], Module::Load=>q[0], Class::Inspector=>q[0], CGI::Application::Plugin::Session=>q[0] }
#     VERSION_FROM => q[lib/CGI/Application/Muto.pm]
#     clean => { FILES=>q[CGI-Application-Muto-*] }
...
MAKE = nmake
FULLEXT = CGI\Application\Muto
BASEEXT = Muto
PARENT_NAME = CGI::Application
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/CGI/Application/Muto.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)\CGI\Application
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\CGI\Application
...
TO_INST_PM = lib/CGI/Application/Muto.pm \
	lib/CGI/Application/Muto/MethodAttributes.pm

PM_TO_BLIB = lib/CGI/Application/Muto/MethodAttributes.pm \
	blib\lib\CGI\Application\Muto\MethodAttributes.pm \
	lib/CGI/Application/Muto.pm \
...
DISTNAME = CGI-Application-Muto
DISTVNAME = CGI-Application-Muto-0.02
...
Muto.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"CGI::Application::Muto\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/CGI/Application/Muto.pm $(INST_MAN3DIR)\CGI.Application.Muto.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name:               CGI-Application-Muto" >> META_new.yml
	$(NOECHO) $(ECHO) "version:            0.02" >> META_new.yml
	$(NOECHO) $(ECHO) "abstract:           A wrapper for CGI::App with some cool features" >> META_new.yml
	$(NOECHO) $(ECHO) "author:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - Uriel Lizama <uriel@baboonsoftware.com>" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "    CGI::Application::Plugin::ConfigAuto:  0" >> META_new.yml
	$(NOECHO) $(ECHO) "    CGI::Application::Plugin::DBH:  0" >> META_new.yml
	$(NOECHO) $(ECHO) "    CGI::Application::Plugin::LogDispatch:  0" >> META_new.yml
	$(NOECHO) $(ECHO) "    CGI::Application::Plugin::Redirect:  0" >> META_new.yml
	$(NOECHO) $(ECHO) "    CGI::Application::Plugin::Session:  0" >> META_new.yml
	$(NOECHO) $(ECHO) "    Class::Inspector:     0" >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <ABSTRACT>A wrapper for CGI::App with some cool features</ABSTRACT>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>Uriel Lizama &lt;uriel@baboonsoftware.com&gt;</AUTHOR>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <IMPLEMENTATION>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"CGI::Application\" VERSION=\"4\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"CGI::Application::Plugin::ConfigAuto\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"CGI::Application::Plugin::DBH\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"CGI::Application::Plugin::LogDispatch\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"CGI::Application::Plugin::Redirect\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"CGI::Application::Plugin::Session\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Class::Inspector\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Data::Dumper\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Module::Load\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Test::More\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <ARCHITECTURE NAME=\"MSWin32-x64-multi-thread-5.10\" />" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/CGI/Application/Muto/MethodAttributes.pm blib\lib\CGI\Application\Muto\MethodAttributes.pm \
	  lib/CGI/Application/Muto.pm blib\lib\CGI\Application\Muto.pm 
