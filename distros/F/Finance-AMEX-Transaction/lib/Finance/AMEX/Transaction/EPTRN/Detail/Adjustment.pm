package Finance::AMEX::Transaction::EPTRN::Detail::Adjustment;
$Finance::AMEX::Transaction::EPTRN::Detail::Adjustment::VERSION = '0.002';
use strict;
use warnings;

# ABSTRACT: Parse AMEX Transaction/Invoice Level Reconciliation (EPTRN) Adjustment Detail Rows
...
Finance::AMEX::Transaction::EPTRN::Detail::Adjustment - Parse AMEX Transaction/Invoice Level Reconciliation (EPTRN) Adjustment Detail Rows
