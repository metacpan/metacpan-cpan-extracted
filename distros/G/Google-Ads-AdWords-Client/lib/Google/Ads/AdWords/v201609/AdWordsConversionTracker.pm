package Google::Ads::AdWords::v201609::AdWordsConversionTracker;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201609::ConversionTracker);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'textFormat' => 'Google::Ads::AdWords::v201609::AdWordsConversionTracker::TextFormat',
        'conversionPageLanguage' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'backgroundColor' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'trackingCodeType' => 'Google::Ads::AdWords::v201609::AdWordsConversionTracker::TrackingCodeType',
    },
    {
...
AdWordsConversionTracker from the namespace https://adwords.google.com/api/adwords/cm/v201609.
