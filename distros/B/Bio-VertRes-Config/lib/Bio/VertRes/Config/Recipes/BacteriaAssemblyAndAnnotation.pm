...
Bio::VertRes::Config::Recipes::BacteriaAssemblyAndAnnotation - Create the assembly and anntation files only, so no reference required, but for it to run you need to have done QC first
