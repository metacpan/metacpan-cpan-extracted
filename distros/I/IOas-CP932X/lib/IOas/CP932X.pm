...
=head1 SYNOPSIS
  ...
  use IOas::CP932X;
    ...
    $result = IOas::CP932X::substr($utf8expr, $offset_as_cp932x, $length_as_cp932x);
    $result = IOas::CP932X::substr($utf8expr, $offset_as_cp932x);
    ...
    $scalar = IOas::CP932X::readline(FILEHANDLE);
    @list   = IOas::CP932X::readline(FILEHANDLE);
