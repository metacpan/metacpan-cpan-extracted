...
This document describes version 0.077 of Sah::Schema::uint32 (from Perl distribution Sah-Schemas-Int), released on 2022-10-19.
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("uint32", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("uint32", {return_type=>'str_errmsg+val'});
...
To create a type constraint and type library from a schema:
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('$sch_name*', name=>'Uint32')
     );
 }

 use My::Types qw(Uint32);
 Uint32->assert_valid($data);
...
L<Types::CLike> - Equivalent Type::Tiny constraints: UInt, UnsignedInt, UInt32, Unsigned32

L<Types::XSD> - Equivalent Type::Tiny constraints: UnsignedInt
