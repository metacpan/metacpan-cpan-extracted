#########1 Test File for Spreadsheet::Reader::ExcelXML::XMLReader::WorkbookProps #######9
#!/usr/bin/env perl
my ( $lib, $test_file );
BEGIN{
...
lives_ok{
			...
			$file_handle = $extractor_instance->extract_file( qw( DocumentProperties ) );
...
}										"Prep an XML based WorkbookPropsInterface instance";# exit 1;
#~ map{ 
#~ has_attribute_ok
			#~ $test_instance, $_,
