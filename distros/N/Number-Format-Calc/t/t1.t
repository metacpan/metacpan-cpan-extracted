...
$n = new Number::Format::Calc ( '1.111,5'  , -thousands_sep=>".", -decimal_point=>",", decimal_digits=>8 );
$m = new Number::Format::Calc ( '2.222,45' , -thousands_sep=>".", -decimal_point=>",", decimal_digits=>8 );
...
ok ( $n / $m eq '0,50012374');                            # 17
ok ( $n / 10.1 eq '110,04950495');                           # 18

$n = new Number::Format::Calc ( '1.111,5'  , -thousands_sep=>".", -decimal_point=>",", decimal_digits => 3 );

#print "power/precision 999/no trailing zeroes:\n";
ok ( $n ** 2 eq $n * $n);                                        # 19
ok ( $n ** 3 eq $n * $n  * $n);                                  # 20
ok ( $n ** 0.5 eq '33,339' );                          # 21
