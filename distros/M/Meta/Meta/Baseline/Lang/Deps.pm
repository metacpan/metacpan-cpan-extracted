...
package Meta::Baseline::Lang::Deps;
...
Meta::Baseline::Lang::Deps - language for deps files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Deps::env();

=head1 DESCRIPTION

This package contains stuff specific to Deps in the baseline:
Its mainly here to authorize entries of deps files to the baseline.
