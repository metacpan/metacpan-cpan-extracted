package Net::RRP::Response::n501;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n501::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n501::VERSION = '0.1';
...
Net::RRP::Response::n501 - the 501 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
