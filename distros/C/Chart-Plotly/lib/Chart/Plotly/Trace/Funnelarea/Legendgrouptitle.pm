package Chart::Plotly::Trace::Funnelarea::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Funnelarea::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Funnelarea::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Funnelarea::Legendgrouptitle - This attribute is one of the possible options for the trace funnelarea.
