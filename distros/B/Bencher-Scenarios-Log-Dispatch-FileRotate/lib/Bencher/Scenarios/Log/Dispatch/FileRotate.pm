package Bencher::Scenarios::Log::Dispatch::FileRotate;
...
1;
# ABSTRACT: Scenarios to benchmark Log::Dispatch::FileRotate
...
Bencher::Scenarios::Log::Dispatch::FileRotate - Scenarios to benchmark Log::Dispatch::FileRotate

=head1 VERSION

This document describes version 0.003 of Bencher::Scenarios::Log::Dispatch::FileRotate (from Perl distribution Bencher-Scenarios-Log-Dispatch-FileRotate), released on 2023-10-29.
...
=item * L<Bencher::Scenario::Log::Dispatch::FileRotate::Writing>
...
L<Bencher::Scenarios::FileWriteRotate>
