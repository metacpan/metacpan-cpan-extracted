...
our @ISA = qw(Exporter EcoreFdHandlerPtr);
...
require XSLoader;
XSLoader::load('pEFL::Ecore::FdHandler');

sub add {
     my ($class,$fd, $flags,$func,$data) = @_;
     my $id = pEFL::PLSide::register_ecore_task_cb($func, $data);
     my $widget = _ecore_main_fd_handler_add($fd, $func, $flags, $id);
     return $widget;
}
 
*new = \&add;

package EcoreFdHandlerPtr;
