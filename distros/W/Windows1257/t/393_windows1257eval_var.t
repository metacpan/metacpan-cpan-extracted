...
# Windows1257::eval $var has Windows1257::eval "..."
$var = <<'END';
Windows1257::eval " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } "
END
if (Windows1257::eval $var) {
...
# Windows1257::eval $var has Windows1257::eval qq{...}
$var = <<'END';
...
# Windows1257::eval $var has Windows1257::eval q{...}
$var = <<'END';
...
# Windows1257::eval $var has Windows1257::eval $var
$var = <<'END';
...
# Windows1257::eval $var has Windows1257::eval (omit)
$var = <<'END';
Windows1257::eval
END
