...
package TeX::Hyphen::Pattern::Hu v1.1.5;
use strict;
use warnings;
use 5.014000;
use utf8;
...
sub version {
    return $TeX::Hyphen::Pattern::Hu::VERSION;
}
...
=for stopwords CTAN Ipenburg Hu

=head1 NAME

TeX::Hyphen::Pattern::Hu - class for hyphenation in locale Hu
