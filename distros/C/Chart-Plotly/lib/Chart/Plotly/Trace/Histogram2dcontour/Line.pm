package Chart::Plotly::Trace::Histogram2dcontour::Line;
use Moose;
...
Chart::Plotly::Trace::Histogram2dcontour::Line - This attribute is one of the possible options for the trace histogram2dcontour.
