...
$RDF::Cowl::AnnotPropDomainAxiom::VERSION = '1.0.0';
...
RDF::Cowl::AnnotPropDomainAxiom - Represents an AnnotationPropertyDomain axiom in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::AnnotPropDomainAxiom>
