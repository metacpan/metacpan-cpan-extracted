...
BEGIN {
    for my $pkg (qw( Google::Cloud::Networkservices::V1::EndpointPolicy::ListEndpointPoliciesResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Networkservices::V1::NetworkservicesClient->new( credentials => 'dummy' );
ok($client, 'Instantiated generated client');
isa_ok($client->transport, 'Google::gRPC::Client', 'Client transport');

subtest 'list_endpoint_policies method' => sub {
