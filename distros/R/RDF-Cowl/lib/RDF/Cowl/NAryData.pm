...
$RDF::Cowl::NAryData::VERSION = '1.0.0';
# CowlNAryData
use strict;
use warnings;
...
RDF::Cowl::NAryData - Represents DataIntersectionOf and DataUnionOf in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::NAryData>
