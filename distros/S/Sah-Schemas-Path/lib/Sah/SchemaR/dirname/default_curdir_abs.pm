...
Sah::SchemaR::dirname::default_curdir_abs - Directory name, default to current directory (absolutified)

=head1 VERSION

This document describes version 0.030 of Sah::SchemaR::dirname::default_curdir_abs (from Perl distribution Sah-Schemas-Path), released on 2024-01-08.
