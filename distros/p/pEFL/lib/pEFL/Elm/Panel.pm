...
package pEFL::Elm::PanelScrollInfo;
...
=head1 SYNOPSIS
  ...
  use pEFL::Elm;
  [...]
  my $widget = pEFL::Elm::Panel->add($parent);
  $widget->hidden_set(1);
  [...]
...
For instructions, how to use pEFL::Elm::Panel, please study this API reference for now. A perl-specific documentation will perhaps come in later versions. But applying the C documentation should be no problem. pEFL::Elm::Panel gives you a nice object-oriented interface that is kept close to the C API. Please note, that the perl method names remove the "elm_panel_" at the beginning of the c functions.
