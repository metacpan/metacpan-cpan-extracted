package Chart::Plotly::Trace::Scatterternary::Transform;
use Moose;
...
Chart::Plotly::Trace::Scatterternary::Transform - This attribute is one of the possible options for the trace scatterternary.
