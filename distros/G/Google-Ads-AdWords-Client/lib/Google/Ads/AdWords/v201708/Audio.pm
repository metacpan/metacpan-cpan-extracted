package Google::Ads::AdWords::v201708::Audio;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201708::Media);
# Variety: sequence
...
Google::Ads::AdWords::v201708::Audio

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Audio from the namespace https://adwords.google.com/api/adwords/cm/v201708.
