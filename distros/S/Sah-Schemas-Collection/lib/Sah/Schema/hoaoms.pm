...
Sah::Schema::hoaoms - Hash of (defined-)array-of-(maybe-)strings

=head1 VERSION

This document describes version 0.008 of Sah::Schema::hoaoms (from Perl distribution Sah-Schemas-Collection), released on 2020-05-08.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("hoaoms*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("hoaoms*");
     $validator->(\@args);
     ...
 }
