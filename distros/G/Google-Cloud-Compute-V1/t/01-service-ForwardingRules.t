...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::ForwardingRule Google::Cloud::Compute::V1::Compute::ForwardingRuleAggregatedList Google::Cloud::Compute::V1::Compute::ForwardingRuleList Google::Cloud::Compute::V1::Compute::Operation )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::ForwardingRulesClient->new( credentials => 'dummy' );
