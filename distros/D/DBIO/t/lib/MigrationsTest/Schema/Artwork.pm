...
__PACKAGE__->belongs_to('cd', 'MigrationsTest::Schema::CD', 'cd_id');
__PACKAGE__->has_many('images', 'MigrationsTest::Schema::Image', 'artwork_id');

__PACKAGE__->has_many('artwork_to_artist', 'MigrationsTest::Schema::Artwork_to_Artist', 'artwork_cd_id');
...
__PACKAGE__->has_many('artwork_to_artist_test_m2m', 'MigrationsTest::Schema::Artwork_to_Artist',
  sub {
