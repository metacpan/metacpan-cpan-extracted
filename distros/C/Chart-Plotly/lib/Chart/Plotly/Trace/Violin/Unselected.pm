package Chart::Plotly::Trace::Violin::Unselected;
use Moose;
...
use Chart::Plotly::Trace::Violin::Unselected::Marker;
...
has marker => ( is  => "rw",
                isa => "Maybe[HashRef]|Chart::Plotly::Trace::Violin::Unselected::Marker", );
...
Chart::Plotly::Trace::Violin::Unselected - This attribute is one of the possible options for the trace violin.
