...
use Google::Ads::AdWords::v201607::ManagedCustomer;
use Google::Ads::AdWords::v201607::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201607::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201607::ManagedCustomerOperation->new({
      operator => "ADD",
      operand  => $account
  });
