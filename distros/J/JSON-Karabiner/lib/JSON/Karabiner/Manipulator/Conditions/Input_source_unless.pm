...
$JSON::Karabiner::Manipulator::Conditions::Input_source_unless::VERSION = '0.017';
use strict;
use warnings;
use JSON;
use Carp;
...
JSON::Karabiner::Manipulator::Conditions::Input_source_unless - definition for input_source_if condition
