package Google::Ads::AdWords::v201705::AdParamPage;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'entries' => 'Google::Ads::AdWords::v201705::AdParam',
...
AdParamPage from the namespace https://adwords.google.com/api/adwords/cm/v201705.
