...
my $color  = Windows1258::substr $s, 4, 5;   # black
my $middle = Windows1258::substr $s, 4, -11; # black cat climbed the
my $end    = Windows1258::substr $s, 14;     # climebed the green tree
my $tail   = Windows1258::substr $s, -4;     # tree
my $z      = Windows1258::substr $s, -4, 2;  # tr
