package Google::Cloud::Networksecurity::V1::FirewallActivationClient;
...
1; # End of Google::Cloud::Networksecurity::V1::FirewallActivationClient

__END__

=head1 NAME

Google::Cloud::Networksecurity::V1::FirewallActivationClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Networksecurity::V1::FirewallActivationClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Networksecurity::V1::FirewallActivationClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Networksecurity::V1::FirewallActivationClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Networksecurity::V1::FirewallActivationClient->new(
