package Chart::Plotly::Trace::Parcoords::Line::Colorbar::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Parcoords::Line::Colorbar::Title::Font - This attribute is one of the possible options for the trace parcoords.
