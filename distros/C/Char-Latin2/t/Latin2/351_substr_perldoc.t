...
my $color  = Latin2::substr $s, 4, 5;   # black
my $middle = Latin2::substr $s, 4, -11; # black cat climbed the
my $end    = Latin2::substr $s, 14;     # climebed the green tree
my $tail   = Latin2::substr $s, -4;     # tree
my $z      = Latin2::substr $s, -4, 2;  # tr
