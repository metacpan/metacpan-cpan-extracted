...
namespace databb_boost {} namespace boost = databb_boost; namespace databb_boost {
...
{
   BOOST_STATIC_CONSTANT(bool, value = (::databb_boost::detail::is_unsigned_values<T>::minus_one > ::databb_boost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned
{
   typedef ::databb_boost::detail::is_unsigned_select_helper< ::databb_boost::is_integral<T>::value || ::databb_boost::is_enum<T>::value > selector;
...
template <class T> struct is_unsigned : public integral_constant<bool, databb_boost::detail::is_unsigned<T>::value> {};
...
template <> struct is_unsigned< ::databb_boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const ::databb_boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<volatile ::databb_boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const volatile ::databb_boost::ulong_long_type> : public true_type{};

template <> struct is_unsigned< ::databb_boost::long_long_type> : public false_type{};
template <> struct is_unsigned<const ::databb_boost::long_long_type> : public false_type{};
template <> struct is_unsigned<volatile ::databb_boost::long_long_type> : public false_type{};
template <> struct is_unsigned<const volatile ::databb_boost::long_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN == 0
