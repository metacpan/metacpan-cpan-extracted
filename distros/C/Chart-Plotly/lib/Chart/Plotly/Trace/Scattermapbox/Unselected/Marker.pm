package Chart::Plotly::Trace::Scattermapbox::Unselected::Marker;
use Moose;
...
Chart::Plotly::Trace::Scattermapbox::Unselected::Marker - This attribute is one of the possible options for the trace scattermapbox.
