...
package Shipment::FedEx::WSDL::ShipElements::CreatePendingShipmentRequest;
$Shipment::FedEx::WSDL::ShipElements::CreatePendingShipmentRequest::VERSION = '3.10';
use strict;
use warnings;
...
__PACKAGE__->__set_name('CreatePendingShipmentRequest');
...
use base qw(
    ...
    Shipment::FedEx::WSDL::ShipTypes::CreatePendingShipmentRequest
);
...
CreatePendingShipmentRequest from the namespace http://fedex.com/ws/ship/v9.
...
=head2 new
 ...
 my $element = Shipment::FedEx::WSDL::ShipElements::CreatePendingShipmentRequest->new($data);
