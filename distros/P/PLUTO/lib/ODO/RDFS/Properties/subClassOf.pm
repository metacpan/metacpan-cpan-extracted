package ODO::RDFS::Properties::subClassOf;
...
sub new {
	...
	$self->propertyContainerName( 'ODO::RDFS::Properties::subClassOf::PropertiesContainer' );
	$self->properties(bless {}, 'ODO::RDFS::Properties::subClassOf::PropertiesContainer');
