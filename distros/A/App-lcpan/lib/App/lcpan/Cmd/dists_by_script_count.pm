...
1;
# ABSTRACT: List distributions ranked by number of included scripts
...
App::lcpan::Cmd::dists_by_script_count - List distributions ranked by number of included scripts

=head1 VERSION

This document describes version 1.071 of App::lcpan::Cmd::dists_by_script_count (from Perl distribution App-lcpan), released on 2022-09-19.
