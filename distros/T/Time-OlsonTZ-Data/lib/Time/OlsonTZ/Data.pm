...
use constant olson_version => "2026d";
...
use constant olson_code_version => "2026d";
...
use constant olson_data_version => "2026d";
...
my $cn = q(+{ map { ($_ => undef) } qw(
	...
	Australia/Melbourne Australia/Perth Australia/Sydney CST6CDT EST5EDT
	...
	Etc/UTC Europe/Andorra Europe/Astrakhan Europe/Athens Europe/Belgrade
	...
	Europe/Lisbon Europe/London Europe/Madrid Europe/Malta Europe/Minsk
	Europe/Moscow Europe/Paris Europe/Prague Europe/Riga Europe/Rome
	Europe/Samara Europe/Saratov Europe/Simferopol Europe/Sofia
	Europe/Tallinn Europe/Tirane Europe/Ulyanovsk Europe/Vienna
	Europe/Vilnius Europe/Volgograd Europe/Warsaw Europe/Zurich Factory
	Indian/Chagos Indian/Maldives Indian/Mauritius MST7MDT PST8PDT
