#======================================================================
package DBD::SQLeet::VirtualTable;
#======================================================================
use strict;
use warnings;
...
#======================================================================
package DBD::SQLeet::VirtualTable::Cursor;
#======================================================================
use strict;
use warnings;
...
DBD::SQLeet::VirtualTable -- SQLite virtual tables implemented in Perl

=head1 SYNOPSIS

  # register the virtual table module within sqlite
  $dbh->sqlite_create_module(mod_name => "DBD::SQLeet::VirtualTable::Subclass");
