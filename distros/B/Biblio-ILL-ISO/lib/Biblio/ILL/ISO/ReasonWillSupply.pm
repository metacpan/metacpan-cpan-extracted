package Biblio::ILL::ISO::ReasonWillSupply;
...
Biblio::ILL::ISO::ReasonWillSupply is a derivation of Biblio::ILL::ISO::ENUMERATED.
...
=head2 new( $s )
 ...
 Creates a new ReasonWillSupply object. 
...
sub new {
	...
	if ( exists $self->{"ENUM_LIST"}->{$s} ) {
	    ...
	    croak "invalid ReasonWillSupply type: [$s]";
	}
    }
