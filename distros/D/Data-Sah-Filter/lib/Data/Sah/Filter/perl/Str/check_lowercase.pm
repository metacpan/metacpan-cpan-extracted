...
1;
# ABSTRACT: Check that string is in lowercase
...
Data::Sah::Filter::perl::Str::check_lowercase - Check that string is in lowercase

=head1 VERSION

This document describes version 0.021 of Data::Sah::Filter::perl::Str::check_lowercase (from Perl distribution Data-Sah-Filter), released on 2023-06-21.

=head1 SYNOPSIS

=head2 Using in Sah schema's C<prefilters> (or C<postfilters>) clause

 ["str","prefilters",[["Str::check_lowercase"]]]

=head2 Using with L<Data::Sah>:

 use Data::Sah qw(gen_validator);
 
 my $schema = ["str","prefilters",[["Str::check_lowercase"]]];
...
=head2 Using with L<Data::Sah:Filter> directly:
 ...
 my $filter = gen_filter([["Str::check_lowercase"]]);
...
=head2 Sample data and filtering results
 ...
 "foo" # valid, unchanged
 "Foo" # INVALID (String is not in lowercase), becomes undef
 "FOO" # INVALID (String is not in lowercase), becomes undef
