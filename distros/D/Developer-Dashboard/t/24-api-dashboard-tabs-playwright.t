...
Test file in the Developer Dashboard codebase. This file tests the api-dashboard tab layout and tab-driven interactions in the browser.
...
Run it directly with C<prove -lv t/24-api-dashboard-tabs-playwright.t> while iterating, then keep it green under C<prove -lr t> before release. Add or update assertions here before changing the implementation that it covers.
