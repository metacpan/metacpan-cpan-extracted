...
has 'units' => (
	...
	default		=> sub { {
				'long' => {
					...
					'arc-second' => {
						'name' => q(आर्क सेकेण्ड),
						'one' => q({0}आर्क सेकेण्ड),
						'other' => q({0}आर्क सेकेण्ड),
					},
					'astronomical-unit' => {
						'name' => q(खगोल एकाइ),
						'one' => q({0}खगोल एकाइ),
					...
					'microsecond' => {
						'name' => q(माइक्रोसेकेण्ड),
						'one' => q({0}माइक्रोसेकेण्ड),
						'other' => q({0}माइक्रोसेकेण्ड),
					},
					'mile' => {
						'name' => q(माइल),
						'one' => q(माइल),
					...
					'mile-per-gallon' => {
						'name' => q(माइल प्रति गालोन),
						'one' => q({0}माइल प्रति गालोन),
						'other' => q({0}माइल प्रति गालोन),
					},
					'mile-per-hour' => {
					...
					'nanosecond' => {
						'name' => q(न्यानोसेकेण्ड),
						'one' => q({0}न्यानोसेकेण्ड),
						'other' => q({0}न्यानोसेकेण्ड),
					},
					'nautical-mile' => {
						'name' => q(नउटिकल माइल),
						'one' => q({0}नउटिकल माइल),
	...
	default	=> sub { {
		...
		'Greenland_Eastern' => {
			long => {
				...
				'standard' => q(पूर्वी ग्रीनल्याण्ड मानक समय),
			},
		},
		'Greenland_Western' => {
			long => {
				'daylight' => q(पश्चिमी ग्रीनल्याण्ड ग्रीष्मकालीन समय),
				'generic' => q(पश्चिमी ग्रीनल्याण्ड समय),
				'standard' => q(पश्चिमी ग्रीनल्याण्ड मानक समय),
			},
		},
		'Gulf' => {
			long => {
		...
		'Mexico_Northwest' => {
			long => {
				'daylight' => q(उत्तर पश्चिम दिवा समय),
				'generic' => q(उत्तर पश्चिम मेक्सिको समय),
				'standard' => q(उत्तर पश्चिम मेक्सिको मानक समय),
			},
		},
		'Mexico_Pacific' => {
			long => {
		...
		'Newfoundland' => {
			long => {
				'daylight' => q(न्यूफाउन्ल्याण्ड दिवा समय),
				'generic' => q(न्यूफाउन्डल्याण्ड समय),
				'standard' => q(न्यूफाउन्डल्याण्ड मानक समय),
			},
		},
		'Niue' => {
			long => {
		...
		'Pierre_Miquelon' => {
			long => {
				'daylight' => q(साय्ट पेईरि र मिक्यूलोन दिवा समय),
				'generic' => q(साय्ट पेईरि र मिक्यूलोन समय),
				'standard' => q(साय्ट पेईरि र मिक्यूलोन मानक समय),
			},
		},
		'Pitcairn' => {
			long => {
