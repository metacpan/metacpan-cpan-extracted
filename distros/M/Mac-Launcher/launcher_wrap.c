...
#define SWIG_init    boot_Mac__Launcher

#define SWIG_name   "Mac::Launcherc::boot_Mac__Launcher"
#define SWIG_prefix "Mac::Launcherc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_Mac__Launcher_var::
class _wrap_Mac__Launcher_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_launchurl) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: launchurl(url);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "launchurl" "', argument " "1"" of type '" "char *""'");
    }
    arg1 = (char *)(buf1);
    launchurl(arg1);
...
XS(_wrap_launchfile) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: launchfile(filepath);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "launchfile" "', argument " "1"" of type '" "char *""'");
    }
    arg1 = (char *)(buf1);
    launchfile(arg1);
    ST(argvi) = sv_newmortal();
...
{"Mac::Launcherc::launchurl", _wrap_launchurl},
{"Mac::Launcherc::launchfile", _wrap_launchfile},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
