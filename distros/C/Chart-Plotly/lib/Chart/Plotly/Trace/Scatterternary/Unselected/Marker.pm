package Chart::Plotly::Trace::Scatterternary::Unselected::Marker;
use Moose;
...
Chart::Plotly::Trace::Scatterternary::Unselected::Marker - This attribute is one of the possible options for the trace scatterternary.
