...
Sah::Schema::dns::records_of_known_types - Array of DNS records (restricted to known types only)

=head1 VERSION

This document describes version 0.003 of Sah::Schema::dns::records_of_known_types (from Perl distribution Sah-SchemaBundle-DNS), released on 2024-06-26.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("dns::records_of_known_types*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("dns::records_of_known_types", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("dns::records_of_known_types", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("dns::records_of_known_types*");
     $validator->(\@args);
     ...
 }
 ...
 $SPEC{myfunc} = {
     ...
     args => {
         arg1 => {
             ...
             schema => ['dns::records_of_known_types*'],
         },
         ...
     },
 };
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"dns::records_of_known_types*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('dns::records_of_known_types*', name=>'DnsRecordsOfKnownTypes')
     );
 }

 use My::Types qw(DnsRecordsOfKnownTypes);
 DnsRecordsOfKnownTypes->assert_valid($data);
