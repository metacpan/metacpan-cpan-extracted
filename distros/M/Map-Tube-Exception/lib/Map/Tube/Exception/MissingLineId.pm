...
$Map::Tube::Exception::MissingLineId::VERSION = '3.17';
=head1 NAME
...
has status => (is => 'ro', default => sub { 120 });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Map::Tube::Exception::MissingLineId
...
1; # End of Map::Tube::Exception::MissingLineId
