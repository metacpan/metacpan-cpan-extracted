...
package WebService::Edgecast::auto::Administration::Element::HttpInfo;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::HttpInfo::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('HttpInfo');
