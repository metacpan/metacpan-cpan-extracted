package Bencher::ScenarioR::Example::NameAndSeq;
  ...
  [
    ...
    ],
    {
      "func.bencher_args"              => {
                                            ...
                                            scenario_module => "Example::NameAndSeq",
                                          },
      ...
      "func.elapsed_time"              => 0.10655403137207,
      "func.module_startup"            => undef,
      "func.module_versions"           => {
                                            "__PACKAGE__" => 1.034,
                                            "Bencher::Scenario::Example::NameAndSeq" => undef,
                                            "Benchmark::Dumb" => "0.10",
      ...
      "func.precision"                 => 0,
      "func.scenario_module"           => "Bencher::Scenario::Example::NameAndSeq",
      "func.scenario_module_md5sum"    => "f6afcf60b7115c3514ae2bc2bd17decb",
      "func.scenario_module_mtime"     => 1460765616,
      "func.scenario_module_sha1sum"   => "78358c18e477d8c2df6be88044e42df0eb519206",
      "func.scenario_module_sha256sum" => "22395904e40b5798252342f8a77a5ab5c9a9897ed4ffd4f93f3e8c84620bb0cd",
      "func.time_end"                  => 1485329799.36716,
      "func.time_factor"               => 1000000,
      "func.time_start"                => 1485329799.26061,
