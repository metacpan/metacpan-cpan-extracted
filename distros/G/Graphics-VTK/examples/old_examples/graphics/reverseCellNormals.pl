...
$cellNormals = Graphics::VTK::PolyDataNormals->new;
$cellNormals->SetInput($skinClipper->GetOutput);
$cellNormals->ComputePointNormalsOff;
...
$skinReflect->SetInput($cellNormals->GetOutput);
...
$renWin->SetFileName("reverseCellNormals.tcl.ppm");
