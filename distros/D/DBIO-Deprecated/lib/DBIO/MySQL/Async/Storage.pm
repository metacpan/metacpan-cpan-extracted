...
# ABSTRACT: RENAMED -- see DBIO::MySQL::EV::Storage (dist DBIO-MySQL-EV)
...
die __PACKAGE__ . " has been renamed to DBIO::MySQL::EV::Storage and this module is"
  . " retired. Install DBIO-MySQL-EV instead:\n"
  . "  cpanm DBIO::MySQL::EV::Storage\n"
...
DBIO::MySQL::Async::Storage - RENAMED -- see DBIO::MySQL::EV::Storage (dist DBIO-MySQL-EV)
...
Install and C<use> L<DBIO::MySQL::EV::Storage> instead.

=head1 NAME

DBIO::MySQL::Async::Storage - DEPRECATED, renamed to DBIO::MySQL::EV::Storage

=head1 SEE ALSO

L<DBIO::MySQL::EV::Storage>, L<DBIO::MySQL::Async>, L<DBIO::Deprecated>
