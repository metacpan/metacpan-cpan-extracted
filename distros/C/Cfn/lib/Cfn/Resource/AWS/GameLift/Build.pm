# AWS::GameLift::Build generated from spec 18.4.0
  ...
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       ...
       return Cfn::Resource::Properties::Object::AWS::GameLift::Build::S3Location->new( %$_ );
     }
   };

package Cfn::Resource::Properties::Object::AWS::GameLift::Build::S3Location {
  use Moose;
...
Cfn::Resource::AWS::GameLift::Build - Cfn resource for AWS::GameLift::Build

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::GameLift::Build.
