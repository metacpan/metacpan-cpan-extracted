...
our $rschema = ["array",[{of=>["date::month_num::id",{},{}],summary=>"Array of month numbers","x.perl.coerce_rules"=>["From_str::comma_sep"]}],["array"]];
...
This document describes version 0.003 of Sah::SchemaR::date::month_nums::id (from Perl distribution Sah-Schemas-Date-ID), released on 2019-11-28.
