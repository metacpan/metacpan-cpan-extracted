# distribution XML-Compile-WSS

  * My extended documentation: <http://perl.overmeer.net/CPAN/>
  * Development via GitHub: <https://github.com/markov2/perl5-XML-Compile-WSS-Signature>
  * Download from CPAN: <ftp://ftp.cpan.org/pub/CPAN/authors/id/M/MA/MARKOV/>
  * Indexed from CPAN: <https://metacpan.org/release/XML-Compile-WSS-Signature>

The XML-Compile suite is a large set of modules for various XML related
standards.  This optional component implements the Web Security Standard,
both as stand-alone components in XML as in the header of SOAP messages.
...
```sh
   cpan -i XML::Compile::WSS::Signature
```
