...
IO::K8s::ExternalSecrets::V1::BeyondtrustWorkloadCredentialsAuth - Auth configures how the Operator authenticates with the BeyondTrust Workload Credentials API.
