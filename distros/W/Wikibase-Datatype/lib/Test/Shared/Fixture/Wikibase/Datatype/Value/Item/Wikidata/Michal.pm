package Test::Shared::Fixture::Wikibase::Datatype::Value::Item::Wikidata::Michal;
...
Test::Shared::Fixture::Wikibase::Datatype::Value::Item::Wikidata::Michal - Test instance for Wikidata item value.
...
=for comment filename=fixture_create_and_print_value_item_wd_douglas.pl
