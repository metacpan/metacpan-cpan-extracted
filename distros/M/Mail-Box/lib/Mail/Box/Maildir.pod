...
=item Info: Appended Maildir message in $new
...
=item Error: Cannot create directory $tmpdir: $!
...
=item Error: Cannot create file $newtmp: $!

Cast by C<writeMessages()>

=item Error: Cannot move $newtmp to $filename: $
