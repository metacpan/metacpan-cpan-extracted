...
Locale::CLDR::Locales::Pt::Latn::Pt - Package for language Portuguese
	...
	default		=> sub {
		{
			'calendar' => {
 				...
 				'islamic-civil' => q{Calendário hegírico (civil)},
 			...
 			'numbers' => {
 				...
 				'mtei' => q{Algarismos de meetei mayek},
 				'mymr' => q{Algarismos birmaneses},
 				'olck' => q{Algarismos de ol chiki},
