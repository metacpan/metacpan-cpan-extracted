package Chart::Plotly::Trace::Funnelarea::Transform;
use Moose;
...
Chart::Plotly::Trace::Funnelarea::Transform - This attribute is one of the possible options for the trace funnelarea.
