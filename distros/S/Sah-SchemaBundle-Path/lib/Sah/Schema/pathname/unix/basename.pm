...
1;
# ABSTRACT: Filesystem base path name on a Unix system
...
Sah::Schema::pathname::unix::basename - Filesystem base path name on a Unix system

=head1 VERSION

This document describes version 0.031 of Sah::Schema::pathname::unix::basename (from Perl distribution Sah-SchemaBundle-Path), released on 2024-02-16.
...
Used completion: L<pathname_curdir|Perinci::Sub::XCompletion::pathname_curdir>
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("pathname::unix::basename*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("pathname::unix::basename", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("pathname::unix::basename", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("pathname::unix::basename*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"pathname::unix::basename*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('pathname::unix::basename*', name=>'PathnameUnixBasename')
     );
 }

 use My::Types qw(PathnameUnixBasename);
 PathnameUnixBasename->assert_valid($data);
