# This Makefile is for the Data::Rebuilder extension to perl.
#
...
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { PadWalker=>q[0], Scalar::Util=>q[0], UNIVERSAL=>q[0], B::Deparse=>q[0], Lexical::Alias=>q[0], IO::String=>q[0], ExtUtils::MakeMaker=>q[6.44], Data::Polymorph=>q[0], Sub::Name=>q[0], B=>q[0], Carp=>q[0], Test::More=>q[0], Path::Class=>q[0] }
#     VERSION => q[0.01]
...
PERL = /usr/bin/perl.exe "-Iinc"
FULLPERL = /usr/bin/perl.exe "-Iinc"
ABSPERL = $(PERL)
PERLRUN = $(PERL)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Data/Rebuilder.pm
...
TO_INST_PM = lib/Data/Rebuilder.pm

PM_TO_BLIB = lib/Data/Rebuilder.pm \
...
DISTNAME = Data-Rebuilder
DISTVNAME = Data-Rebuilder-0.01
...
manifypods : pure_all  \
	lib/Data/Rebuilder.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Data/Rebuilder.pm $(INST_MAN3DIR)/Data.Rebuilder.$(MAN3EXT) 
...
TEST_FILE = test.pl
TEST_FILES = t/00-load.t t/10-simple.t t/20-object.t t/30-cycle.t t/40-weak.t t/50-tied.t t/60-sleep.t t/boilerplate.t t/dependencies.t t/perlcritic.t t/pod-coverage.t t/pod.t
TESTDB_SW = -d
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Data/Rebuilder.pm blib/lib/Data/Rebuilder.pm 
