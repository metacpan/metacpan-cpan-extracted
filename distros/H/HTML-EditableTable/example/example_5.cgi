...
# EditableTable Example 5
# demonstrates the Horizontal table with a hash-of-hashes dataset
...
sub cbPartId {
  ...
  return "<a href=example_5.cgi?context=view&uid=$row->{part_id}>" . $row->{part_id} . "</a>";
