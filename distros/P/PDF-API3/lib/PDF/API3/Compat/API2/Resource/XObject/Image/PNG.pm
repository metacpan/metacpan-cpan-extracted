...
#
#=======================================================================
package PDF::API3::Compat::API2::Resource::XObject::Image::PNG;
...
=item $res = PDF::API3::Compat::API2::Resource::XObject::Image::PNG->new $pdf, $file [, $name]
...
=item $res = PDF::API3::Compat::API2::Resource::XObject::Image::PNG->new_api $api, $file [, $name]
