...
package UMMF::MOF_1_4_1::Model::StructureType;
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_4_1::Model::StructureType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_4_1::Model::StructureType|UMMF::MOF_1_4_1::Model::StructureType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_4_1::Model::StructureType')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_4_1::Model::StructureType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_4_1::Model::StructureType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_4_1::Model::StructureType' . ": value '$x'")
    unless __validate_type($self, $x);
}


=head2 C<isaStructureType>


Returns true if receiver is a L<UMMF::MOF_1_4_1::Model::StructureType|UMMF::MOF_1_4_1::Model::StructureType>.
Other receivers will return false.

=cut
sub isaStructureType { 1 }


=head2 C<isaModel__StructureType>


Returns true if receiver is a L<UMMF::MOF_1_4_1::Model::StructureType|UMMF::MOF_1_4_1::Model::StructureType>.
Other receivers will return false.
This is the fully qualified version of the C<isaStructureType> method.

=cut
sub isaModel__StructureType { 1 }
...
Returns the UML Model name (C<'Model::StructureType'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Model::StructureType' }
...
sub __initialize
{
  ...
  $self->UMMF::MOF_1_4_1::Model::StructureType::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_4_1::Model::StructureType::___create(@args);
