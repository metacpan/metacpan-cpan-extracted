...
use Google::Ads::AdWords::v201806::ProductAd;
use Google::Ads::AdWords::v201806::ProductPartition;
use Google::Ads::AdWords::v201806::ShoppingSetting;
...
sub add_shopping_campaign {
  ...
  my $campaign = Google::Ads::AdWords::v201806::Campaign->new({
      ...
      # Set budget (required)
      budget =>
        Google::Ads::AdWords::v201806::Budget->new({budgetId => $budget_id}),
      ...
      settings => [
        ...
        Google::Ads::AdWords::v201806::ShoppingSetting->new({
            salesCountry     => "US",
            campaignPriority => 0,
  ...
  # Create operation
  my $operation = Google::Ads::AdWords::v201806::CampaignOperation->new({
    operand  => $campaign,
    operator => "ADD"
  });
  ...
  # Create operation
  $operation = Google::Ads::AdWords::v201806::AdGroupOperation->new({
    operand  => $ad_group,
    operator => "ADD"
  });
  ...
  # Create product ad
  my $product_ad = Google::Ads::AdWords::v201806::ProductAd->new();
  ...
  # Create operation
  $operation = Google::Ads::AdWords::v201806::AdGroupAdOperation->new({
    operand  => $ad_group_ad,
    operator => "ADD"
  });
  ...
  if ($create_default_partition) {
    ...
    my $product_partition =
      Google::Ads::AdWords::v201806::ProductPartition->new({
        partitionType => 'UNIT',
    ...
    # Create operation.
    $operation = Google::Ads::AdWords::v201806::AdGroupCriterionOperation->new({
      operator => "ADD",
