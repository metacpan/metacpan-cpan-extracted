...
SemanticWeb::Schema::AnalysisNewsArticle - An AnalysisNewsArticle is a <a class="localLink" href="http://schema
...
=for html An AnalysisNewsArticle is a <a class="localLink"
