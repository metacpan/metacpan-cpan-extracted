...
https://metacpan.org/release/Devel-Cover-Report-Codecovbash

You can use [`cpanminus`](https://metacpan.org/pod/App::cpanminus) to do this
without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Devel::Cover::Report::Codecovbash
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Devel::Cover::Report::Codecovbash
...
The code for this distribution is [hosted on GitHub](https://github.com/houseabsolute/Devel-Cover-Report-Codecovbash).
...
can submit an issue report [via the web](https://github.com/houseabsolute/Devel-Cover-Report-Codecovbash/issues).
