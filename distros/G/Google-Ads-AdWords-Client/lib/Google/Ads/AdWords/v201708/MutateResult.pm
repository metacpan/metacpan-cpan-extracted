package Google::Ads::AdWords::v201708::MutateResult;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'result' => 'Google::Ads::AdWords::v201708::Operand',
        'errorList' => 'Google::Ads::AdWords::v201708::ErrorList',
...
Google::Ads::AdWords::v201708::MutateResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MutateResult from the namespace https://adwords.google.com/api/adwords/cm/v201708.
