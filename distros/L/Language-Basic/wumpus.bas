1 REM EXCEPT FOR THESE TWO LINES, I BELIEVE THIS IS 
2 REM GREGORY YOB'S ORIGINAL, 1970 (?) VERSION OF WUMPUS
...
510 PRINT " EACH ARROW CAN GO FROM 1 TO 5 ROOMS. YOU AIM BY "
515 PRINT " THE COMPUTER THE ROOM#S YOU WANT THE ARROW TO GO TO." 
520 PRINT " IF THE ARROW CAN'T GO THAT WAY (IF NO TUNNEL) IT "
