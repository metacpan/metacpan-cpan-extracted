...
L</Lab::Moose> is the recommended API, it is based on B<Modern Perl>
techniques.

=item *

The hisorical API, consisting of the Lab::Instrument virtual
...
=head1 Old Lab::Measurement API

=over

=item * L<Lab::Measurement::OldTutorial>
