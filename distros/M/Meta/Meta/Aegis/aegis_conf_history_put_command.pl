...
my($scod)=Meta::Tool::Fhist::put($input,$history);
...
aegis_conf_history_put_command.pl - store history for a file.
...
=head1 DETAILS
	...
	MANIFEST: aegis_conf_history_put_command.pl
	PROJECT: meta
	VERSION: 0.01

=head1 SYNOPSIS

	aegis_conf_history_put_command.pl

=head1 DESCRIPTION

This command will store a historical version of a file.
