package Chart::Plotly::Trace::Contourcarpet::Contours::Labelfont;
use Moose;
...
Chart::Plotly::Trace::Contourcarpet::Contours::Labelfont - This attribute is one of the possible options for the trace contourcarpet.
