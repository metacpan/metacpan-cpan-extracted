package Graph::Layout::Aesthetic::Force::MinEdgeLength;
use 5.006001;
use strict;
use warnings;
...
The aesthetic force is that connected nodes attract each other with a force
that's quadratic in their distance.
