...
our $rschema = ["int",[{max=>4294967295,min=>0,summary=>"32-bit unsigned integer"}],["int"]];
...
This document describes version 0.071 of Sah::SchemaR::uint32 (from Perl distribution Sah-Schemas-Int), released on 2018-04-03.
