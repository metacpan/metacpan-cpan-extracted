...
package Shipment::Purolator::WSDL::Elements::ReturnShipment;
$Shipment::Purolator::WSDL::Elements::ReturnShipment::VERSION = '3.04';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    __PACKAGE__->__set_name('ReturnShipment');
