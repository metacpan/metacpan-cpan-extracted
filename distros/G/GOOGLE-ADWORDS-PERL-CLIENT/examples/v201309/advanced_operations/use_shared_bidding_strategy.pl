...
use Google::Ads::AdWords::v201309::SharedBiddingStrategy;
use Google::Ads::AdWords::v201309::TargetSpendBiddingScheme;
use Google::Ads::AdWords::v201309::Money;
use Google::Ads::AdWords::v201309::BiddingStrategyOperation;
use Google::Ads::AdWords::v201309::BudgetOperation;
use Google::Ads::AdWords::v201309::KeywordMatchSetting;
use Google::Ads::AdWords::v201309::NetworkSetting;
...
sub create_bidding_strategy {
  ...
  my $bidding_strategy =
      Google::Ads::AdWords::v201309::SharedBiddingStrategy->new({
        name => "Maximize Clicks " . uniqid(),
        type => "TARGET_SPEND",

        # Create the bidding scheme.
        biddingScheme =>
            Google::Ads::AdWords::v201309::TargetSpendBiddingScheme->new({
              # Optionally set additional bidding scheme parameters.
              bidCeiling => Google::Ads::AdWords::v201309::Money->new({
                microAmount => 2000000,
              }),
              spendTarget => Google::Ads::AdWords::v201309::Money->new({
  ...
  # Create operation.
  my $operation =
      Google::Ads::AdWords::v201309::BiddingStrategyOperation->new({
        operator => "ADD",
...
sub create_shared_budget {
  ...
  my $operation = Google::Ads::AdWords::v201309::BudgetOperation->new({
    operator => 'ADD',
    operand => Google::Ads::AdWords::v201309::Budget->new({
      period => 'DAILY',
      amount => Google::Ads::AdWords::v201309::Money->new({
