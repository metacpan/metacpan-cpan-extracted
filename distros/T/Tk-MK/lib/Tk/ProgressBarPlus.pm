...
sub _arrange {
    ...
    # Addon to display the percentage as a text
    if ($c->cget('-showvalue')) {
       my ($min, $max);
...
Tk::ProgressBarPlus - A graphical progress bar
...
=head1 SYNOPSIS
    ...
    $progress = $parent->ProgressBarPlus(
	-width => 200,
	-length => 20,
        -anchor => 's',
	-from => 0,
...
B<Tk::ProgressBarPlus> provides a widget which will show a graphical representation
...
ValueText-Add-On 02.2004 by M. Krause, E<lt>F<KrauseM_AT_gmx_DOT_net>E<gt>
