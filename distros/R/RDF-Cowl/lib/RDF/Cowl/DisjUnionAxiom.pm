...
$RDF::Cowl::DisjUnionAxiom::VERSION = '1.0.0';
# CowlDisjUnionAxiom
use strict;
use warnings;
...
RDF::Cowl::DisjUnionAxiom - Represents a DisjointUnion axiom in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::DisjUnionAxiom>
