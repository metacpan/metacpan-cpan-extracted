...
package WebService::Edgecast::auto::Administration::Element::HttpSmallInfo;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::HttpSmallInfo::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('HttpSmallInfo');
