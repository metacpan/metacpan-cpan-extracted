...
use Google::Ads::AdWords::v201607::AdGroupExperimentData;
use Google::Ads::AdWords::v201607::AdGroupOperation;
use Google::Ads::AdWords::v201607::BidMultiplier;
use Google::Ads::AdWords::v201607::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201607::BiddableAdGroupCriterionExperimentData;
use Google::Ads::AdWords::v201607::Criterion;
...
use Google::Ads::AdWords::v201607::ManualCPCAdGroupExperimentBidMultipliers;
...
sub add_experiment {
  ...
  my $ad_group =
    Google::Ads::AdWords::v201607::AdGroup->new({id => $ad_group_id});
  ...
  my $bid_multiplier =
    ...
    new({
      maxCpcMultiplier =>
        Google::Ads::AdWords::v201607::BidMultiplier->new({multiplier => 1.5})}
    );

  # Set experiment data to the ad group.
  my $experiment_data =
    Google::Ads::AdWords::v201607::AdGroupExperimentData->new({
  ...
  my $criterion =
    Google::Ads::AdWords::v201607::Criterion->new({id => $criterion_id,});
  ...
  $experiment_data =
    Google::Ads::AdWords::v201607::BiddableAdGroupCriterionExperimentData->new({
      experimentId            => $experiment_id,
      experimentDeltaStatus   => "MODIFIED",
  ...
  # Create operation.
  $operation = Google::Ads::AdWords::v201607::AdGroupCriterionOperation->new({
