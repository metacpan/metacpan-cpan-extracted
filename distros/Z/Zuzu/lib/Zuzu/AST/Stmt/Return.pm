...
sub evaluate { $_[1]->eval_return($_[0]) }

=pod

=head1 NAME

Zuzu::AST::Stmt::Return - AST node for return statements
...
B<< Zuzu::AST::Stmt::Return >> is copyright Toby Inkster.
