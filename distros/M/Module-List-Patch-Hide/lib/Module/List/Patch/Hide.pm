package Module::List::Patch::Hide;
...
1;
# ABSTRACT: Hide some modules from Module::List
...
This document describes version 0.001 of Module::List::Patch::Hide (from Perl distribution Module-List-Patch-Hide), released on 2019-01-10.
...
works if the application uses L<Module::List>'s C<list_modules()> to
...
Please visit the project's homepage at L<https://metacpan.org/release/Module-List-Patch-Hide>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Module-List-Patch-Hide>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=Module-List-Patch-Hide>
