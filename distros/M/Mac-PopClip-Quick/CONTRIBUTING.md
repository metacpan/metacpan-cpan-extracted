...
https://metacpan.org/release/Mac-PopClip-Quick

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Mac::PopClip::Quick
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Mac::PopClip::Quick
...
The code for this distribution is [hosted at GitHub](https://github.com/2shortplanks/Mac-PopClip-Quick).
...
can submit an issue report [via the web](https://github.com/2shortplanks/Mac-PopClip-Quick/issues)
).
