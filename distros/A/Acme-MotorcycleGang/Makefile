...
#     ABSTRACT_FROM => q[lib/Acme/MotorcycleGang.pm]
#     AUTHOR => [q[yuichi tsunoda <yuichi.tsunoda@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Acme::MotorcycleGang]
#     PL_FILES => {  }
...
MAKE = make
FULLEXT = Acme/MotorcycleGang
BASEEXT = MotorcycleGang
PARENT_NAME = Acme
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Acme/MotorcycleGang.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Acme/MotorcycleGang.pm
...
TO_INST_PM = lib/Acme/MotorcycleGang.pm
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''yuichi tsunoda <yuichi.tsunoda@gmail.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Acme-MotorcycleGang' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Translate Japanese MotorcycleGang Language",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "yuichi tsunoda <yuichi.tsunoda@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Acme-MotorcycleGang",' >> META_new.json
