package Data::Sah::Value::perl::Date::last_year_utc;
...
sub meta {
    +{
        v => 1,
        summary => 'Last year, from UTC time',
        prio => 50,
        args => {
        },
    };
...
Data::Sah::Value::perl::Date::last_year_utc

=head1 VERSION

This document describes version 0.002 of Data::Sah::Value::perl::Date::last_year_utc (from Perl distribution Data-Sah-ValueBundle-Date), released on 2023-03-30.
