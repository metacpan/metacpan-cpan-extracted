...
package UMMF::UML_1_5::OCL::Expressions::NavigationCallExp;
...
=head2 C<> : I<THIS> C<1> ----E<gt>  C<navigationSource> : UMMF::UML_1_5::Foundation::Core::AssociationEnd C<1>
...
=head2 C<navigationCallExp> : I<THIS> C<0..1> E<lt>---E<gt>  C<qualifiers> : UMMF::UML_1_5::OCL::Expressions::OclExpression C<0..*>
...
Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::OCL::Expressions::NavigationCallExp|UMMF::UML_1_5::OCL::Expressions::NavigationCallExp>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::OCL::Expressions::NavigationCallExp')  ;
}
...
Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::OCL::Expressions::NavigationCallExp->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::OCL::Expressions::NavigationCallExp' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML_1_5::OCL::Expressions::NavigationCallExp|UMMF::UML_1_5::OCL::Expressions::NavigationCallExp>.
...
sub ___initialize
{
  ...
  #   1
  #  <--> 
  #  navigationSource 1 UMMF::UML_1_5::Foundation::Core::AssociationEnd.
  ...
  #  <--> 
  #  qualifiers 0..* UMMF::UML_1_5::OCL::Expressions::OclExpression.
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::OCL::Expressions::NavigationCallExp::___create(@args);
...
Returns the AssociationEnd C<navigationSource> value of type L<UMMF::UML_1_5::Foundation::Core::AssociationEnd|UMMF::UML_1_5::Foundation::Core::AssociationEnd>.
...
sub set_navigationSource ($$)
{
  ...
  if ( ($old = $self->{'navigationSource'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML_1_5::Foundation::Core::AssociationEnd')->__typecheck($val, "UMMF::UML_1_5::OCL::Expressions::NavigationCallExp.navigationSource") }
...
sub add_navigationSource ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'navigationSource'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML_1_5::Foundation::Core::AssociationEnd')->__typecheck($val, "UMMF::UML_1_5::OCL::Expressions::NavigationCallExp.navigationSource");
      
    # confess("UMMF::UML_1_5::OCL::Expressions::NavigationCallExp::navigationSource: too many")
    # if defined $self->{'navigationSource'};
...
Clears the AssociationEnd C<navigationSource> links to L<UMMF::UML_1_5::Foundation::Core::AssociationEnd|UMMF::UML_1_5::Foundation::Core::AssociationEnd>.
Returns C<$obj>.
...
Returns the number of elements of type L<UMMF::UML_1_5::Foundation::Core::AssociationEnd|UMMF::UML_1_5::Foundation::Core::AssociationEnd> associated with C<navigationSource>.
...
Returns the AssociationEnd C<qualifiers> values of type L<UMMF::UML_1_5::OCL::Expressions::OclExpression|UMMF::UML_1_5::OCL::Expressions::OclExpression>.
...
sub add_qualifiers ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        ...
        $self->__use('UMMF::UML_1_5::OCL::Expressions::OclExpression')->__typecheck($val, "UMMF::UML_1_5::OCL::Expressions::NavigationCallExp.qualifiers");
...
Clears the AssociationEnd C<qualifiers> links to L<UMMF::UML_1_5::OCL::Expressions::OclExpression|UMMF::UML_1_5::OCL::Expressions::OclExpression>.
Returns C<$obj>.
