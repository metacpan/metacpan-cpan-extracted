...
The code for this distribution is [hosted on GitHub](https://github.com/houseabsolute/HTML-Mason).
...
can submit an issue report [via the web](https://github.com/houseabsolute/HTML-Mason/issues).


## Continuous Integration

All pull requests for this distribution will be automatically tested
on Linux by [Travis](https://travis-ci.org/houseabsolute/HTML-Mason).
