...
ok( my $payment_response = $sgb->get_payment_method_list(), 'Get payment method list response object' );
isa_ok($payment_response, 'SilverGoldBull::API::Response');
can_ok($payment_response, qw(is_success data));
