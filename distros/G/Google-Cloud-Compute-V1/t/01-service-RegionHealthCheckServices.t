...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::HealthCheckService Google::Cloud::Compute::V1::Compute::HealthCheckServiceAggregatedList Google::Cloud::Compute::V1::Compute::HealthCheckServicesList Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::RegionHealthCheckServicesClient->new( credentials => 'dummy' );
