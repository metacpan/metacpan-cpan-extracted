...
our $rschema = ["int",[{max=>1.70141183460469e+38,min=>-1.70141183460469e+38,summary=>"32-bit signed integer"}],["int"]];
...
This document describes version 0.071 of Sah::SchemaR::int128 (from Perl distribution Sah-Schemas-Int), released on 2018-04-03.
