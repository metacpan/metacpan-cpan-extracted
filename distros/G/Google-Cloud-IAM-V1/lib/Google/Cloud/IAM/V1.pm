...
Google::Cloud::IAM::V1 - Google Cloud Identity and Access Management (IAM) V1 API Client

=head1 SYNOPSIS

    use Google::Cloud::IAM::V1;
    use Google::Auth;

    my $auth = Google::Auth->default();
    my $client = Google::Cloud::IAM::V1->new(credentials => $auth);

=head1 DESCRIPTION

Google Cloud Identity and Access Management (IAM) V1 API Client over high-performance gRPC transport.
