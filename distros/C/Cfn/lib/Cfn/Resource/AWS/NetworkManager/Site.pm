# AWS::NetworkManager::Site generated from spec 20.1.0
  ...
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       ...
       return Cfn::Resource::Properties::Object::AWS::NetworkManager::Site::Location->new( %$_ );
     }
   };

package Cfn::Resource::Properties::Object::AWS::NetworkManager::Site::Location {
  use Moose;
...
Cfn::Resource::AWS::NetworkManager::Site - Cfn resource for AWS::NetworkManager::Site

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::NetworkManager::Site.
