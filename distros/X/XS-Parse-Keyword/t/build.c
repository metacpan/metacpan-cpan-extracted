 ...
 * contents of build.xs. Do not edit this file, edit build.xs instead.
 *
...
extern "C"
#endif
XS_EXTERNAL(boot_t__build); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_t__build)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
