package OWL::DirectSemantics::Element::DataProperty;
...
OWL::DirectSemantics::Element::DataProperty - represents an OWL DataProperty

=head1 DESCRIPTION

This class represents the DataProperty element in OWL Direct Semantics.
