package Net::RRP::Response::n505;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n505::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n505::VERSION = '0.1';
...
Net::RRP::Response::n505 - the 505 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
