# This Makefile is for the URI::http::Dump extension to perl.
#
...
#     ABSTRACT => q[A module to assist in the reverse engineering of URL parameters.]
#     AUTHOR => q[Evan Carroll <me@evancarroll.com>]
#     DIR => []
#     DISTNAME => q[URI-http-Dump]
...
MAKE = make
FULLEXT = URI/http/Dump
BASEEXT = Dump
PARENT_NAME = URI::http
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/URI/http/Dump.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/URI/http
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/URI/http
...
TO_INST_PM = lib/URI/http/Dump.pm

PM_TO_BLIB = lib/URI/http/Dump.pm \
	blib/lib/URI/http/Dump.pm
...
manifypods : pure_all  \
	lib/URI/http/Dump.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/URI/http/Dump.pm $(INST_MAN3DIR)/URI::http::Dump.$(MAN3EXT) 
...
TEST_FILE = test.pl
TEST_FILES = t/00-load.t t/01-YAMLDump.t t/02-YAMLLoad.t t/boilerplate.t t/pod-coverage.t t/pod.t
TESTDB_SW = -d
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="MooseX-InsideOut" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/URI/http/Dump.pm blib/lib/URI/http/Dump.pm 
...
# End.
# Postamble by Module::Install 0.74
