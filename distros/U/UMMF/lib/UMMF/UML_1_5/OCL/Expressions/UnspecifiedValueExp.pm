...
package UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp;
...
=head2 C<unspecified> : I<THIS> C<0..1> E<lt>----  C<> : UMMF::UML_1_5::OCL::Expressions::OclMessageArg C<1>
...
=head2 C<__validate_type>
  ...
  UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp|UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp')  ;
}


=head2 C<__typecheck>

  UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp|UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp>.
...
sub __initialize
{
  ...
  $self->UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp::___create(@args);
...
sub set_type ($$)
{
  ...
  if ( ($old = $self->{'type'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML_1_5::Foundation::Core::Classifier')->__typecheck($val, "UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp.type") }
...
sub add_type ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'type'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML_1_5::Foundation::Core::Classifier')->__typecheck($val, "UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp.type");
      
    # confess("UMMF::UML_1_5::OCL::Expressions::UnspecifiedValueExp::type: too many")
    # if defined $self->{'type'};
