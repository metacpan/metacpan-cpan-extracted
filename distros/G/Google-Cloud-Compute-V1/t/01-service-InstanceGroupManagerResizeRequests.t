...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::InstanceGroupManagerResizeRequest Google::Cloud::Compute::V1::Compute::InstanceGroupManagerResizeRequestsListResponse Google::Cloud::Compute::V1::Compute::Operation )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::InstanceGroupManagerResizeRequestsClient->new( credentials => 'dummy' );
