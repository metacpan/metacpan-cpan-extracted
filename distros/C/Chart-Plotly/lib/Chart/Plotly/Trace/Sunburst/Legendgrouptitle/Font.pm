package Chart::Plotly::Trace::Sunburst::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Sunburst::Legendgrouptitle::Font - This attribute is one of the possible options for the trace sunburst.
