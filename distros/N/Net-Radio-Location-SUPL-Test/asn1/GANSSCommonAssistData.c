...
static int asn_MAP_GANSSCommonAssistData_oms_1[] = { 0, 1, 2, 3, 4, 5 };
...
static asn_TYPE_tag2member_t asn_MAP_GANSSCommonAssistData_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ganssReferenceTime at 1085 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ganssRefLocation at 1086 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* ganssIonosphericModel at 1087 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* ganssAddIonosphericModel at 1089 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* ganssEarthOrientParam at 1090 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* ganssReferenceTime-R10-Ext at 1092 */
};
