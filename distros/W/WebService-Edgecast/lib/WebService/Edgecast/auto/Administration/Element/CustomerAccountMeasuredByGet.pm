...
package WebService::Edgecast::auto::Administration::Element::CustomerAccountMeasuredByGet;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerAccountMeasuredByGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
WebService::Edgecast::auto::Administration::Element::CustomerAccountMeasuredByGet
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerAccountMeasuredByGet->new($data);
