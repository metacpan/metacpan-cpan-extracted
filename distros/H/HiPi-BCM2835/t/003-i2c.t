...
SKIP: {
        skip 'not in dist testing', 45 unless $ENV{HIPI_BCM2835_DIST_TEST_I2C};
        ...
        my $mpl = HiPi::Interface::MPL3115A2->new( address => $mpladdress, backend => 'bcm2835' );
        is( $mpl->who_am_i, 196, 'mpl who am i');
        
        for my $busmode ( qw( bcm2835 ) ) {
