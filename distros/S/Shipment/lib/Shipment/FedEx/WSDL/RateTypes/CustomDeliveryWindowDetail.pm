...
$Shipment::FedEx::WSDL::RateTypes::CustomDeliveryWindowDetail::VERSION = '3.09';
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'Type' => 'Shipment::FedEx::WSDL::RateTypes::CustomDeliveryWindowType',
...
CustomDeliveryWindowDetail from the namespace http://fedex.com/ws/rate/v9.
