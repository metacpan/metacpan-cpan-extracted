...
1;
# ABSTRACT: List distributions ranked by number of included modules
...
App::lcpan::Cmd::dists_by_mod_count - List distributions ranked by number of included modules

=head1 VERSION

This document describes version 1.074 of App::lcpan::Cmd::dists_by_mod_count (from Perl distribution App-lcpan), released on 2023-09-26.
