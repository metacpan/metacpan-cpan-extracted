use utf8;
package Schema::RackTables::0_18_5::Result::Config;
...
Schema::RackTables::0_18_5::Result::Config
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:MFYu5xMOpTriqEiSjP8QXQ
