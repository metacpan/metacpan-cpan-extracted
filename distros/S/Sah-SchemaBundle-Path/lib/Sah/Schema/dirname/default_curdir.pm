...
1;
# ABSTRACT: Directory name, default to current directory
...
Sah::Schema::dirname::default_curdir - Directory name, default to current directory

=head1 VERSION

This document describes version 0.031 of Sah::Schema::dirname::default_curdir (from Perl distribution Sah-SchemaBundle-Path), released on 2024-02-16.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("dirname::default_curdir*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("dirname::default_curdir", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("dirname::default_curdir", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("dirname::default_curdir*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"dirname::default_curdir*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('dirname::default_curdir*', name=>'DirnameDefaultCurdir')
     );
 }

 use My::Types qw(DirnameDefaultCurdir);
 DirnameDefaultCurdir->assert_valid($data);
