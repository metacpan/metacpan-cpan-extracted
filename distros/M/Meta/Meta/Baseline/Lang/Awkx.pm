...
package Meta::Baseline::Lang::Awkx;
...
Meta::Baseline::Lang::Awkx - language for XML files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Awkx::env();

=head1 DESCRIPTION

This package contains stuff specific to Awkx in the baseline:
