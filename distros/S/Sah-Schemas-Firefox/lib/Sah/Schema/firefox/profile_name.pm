...
This document describes version 0.008 of Sah::Schema::firefox::profile_name (from Perl distribution Sah-Schemas-Firefox), released on 2023-06-14.
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("firefox::profile_name", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("firefox::profile_name", {return_type=>'str_errmsg+val'});
 my $res = $validator->($data); # [$errmsg, $validated_val]
 
 # a sample valid data
 $data = "standard";
 my $res = $validator->($data); # => ["","standard"]
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"firefox::profile_name*"' '"data..."'
...
To create a type constraint and type library from a schema:
 ...
 use My::Types qw(FirefoxProfileName);
 FirefoxProfileName->assert_valid($data);
