...
$repeated_errmsg = qr{^Your password may only contain alphanumeric characters};
...
@tests = (
	...
	# this should fail, all non-alnum
	{
		'password'		=> ' !#*',
		'expect_error'	=> 1,
...
foreach my $test (@tests) {
	...
	$pwcheck = Data::Password::Check->check({
		...
		'tests'			=> [ 'alphanumeric_only' ],			# don't want to run any other tests
	});
