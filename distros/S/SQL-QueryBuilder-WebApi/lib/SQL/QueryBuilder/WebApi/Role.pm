...
#
package SQL::QueryBuilder::WebApi::Role;
use utf8;
...
has api_factory => ( is => 'ro',
                     isa => 'SQL::QueryBuilder::WebApi::ApiFactory',
                     builder => '_build_af', 
                     lazy => 1,
...
has _cfg => ( is => 'ro',
              isa => 'Str',
              default => 'SQL::QueryBuilder::WebApi::Configuration',
              );

has version_info => ( is => 'ro', 
                      isa => 'HashRef', 
                      default => sub { {
                          app_name => 'QueryBuilderApi',
                          app_version => '1.1.8',
                          generated_date => '2016-11-29T18:45:19.605+06:00',
...
sub _build_af {
	...
	return SQL::QueryBuilder::WebApi::ApiFactory->new(%args);
}
...
=head2 QueryBuilderApi version: 1.1.8
...
=item Build date: 2016-11-29T18:45:19.605+06:00
...
role. 
	...
	package MyApp;
	use Moose;
	with 'SQL::QueryBuilder::WebApi::Role';
...
The tokens will be placed in the C<SQL::QueryBuilder::WebApi::Configuration> namespace
as follows, but you don't need to know about this. 

=over 4

=item C<$SQL::QueryBuilder::WebApi::Configuration::username>

String. The username for basic auth.

=item C<$SQL::QueryBuilder::WebApi::Configuration::password>

String. The password for basic auth.

=item C<$SQL::QueryBuilder::WebApi::Configuration::api_key>

Hashref. Keyed on the name of each key (there can be multiple tokens).

	$SQL::QueryBuilder::WebApi::Configuration::api_key = {
		secretKey => 'aaaabbbbccccdddd',
		anotherKey => '1111222233334444',
		};

=item C<$SQL::QueryBuilder::WebApi::Configuration::api_key_prefix>

Hashref. Keyed on the name of each key (there can be multiple tokens). Note not
all api keys require a prefix.

	$SQL::QueryBuilder::WebApi::Configuration::api_key_prefix = {
		secretKey => 'string',
		anotherKey => 'same or some other string',
		};

=item C<$SQL::QueryBuilder::WebApi::Configuration::access_token>
