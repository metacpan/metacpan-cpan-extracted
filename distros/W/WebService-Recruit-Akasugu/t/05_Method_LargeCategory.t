#
# Test case for WebService::Recruit::Akasugu::LargeCategory
#
...
my $service = new WebService::Recruit::Akasugu::LargeCategory();

ok( ref $service, 'new WebService::Recruit::Akasugu::LargeCategory()' );
...
# Test[0]
{
    ...
    my $res = new WebService::Recruit::Akasugu::LargeCategory();
