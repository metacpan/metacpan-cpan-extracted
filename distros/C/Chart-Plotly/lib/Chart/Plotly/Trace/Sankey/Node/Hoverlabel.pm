package Chart::Plotly::Trace::Sankey::Node::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Sankey::Node::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Sankey::Node::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Sankey::Node::Hoverlabel - This attribute is one of the possible options for the trace sankey.
