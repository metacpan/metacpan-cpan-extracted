...
This document describes version 0.049 of Sah::Schema::perl::identifier::qualified_ascii (from Perl distribution Sah-Schemas-Perl), released on 2023-10-26.
...
(set-as-default, coerced, prefiltered) value:
 ...
 # a sample invalid data
 $data = "";
 my $res = $validator->($data); # => ["Must match regex pattern qr(\\A[A-Za-z_][A-Za-z_0-9]*(?:::[A-Za-z_0-9]+)+\\z)",""]
