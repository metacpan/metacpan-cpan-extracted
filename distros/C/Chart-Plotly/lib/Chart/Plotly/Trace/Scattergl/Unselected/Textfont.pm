package Chart::Plotly::Trace::Scattergl::Unselected::Textfont;
use Moose;
...
Chart::Plotly::Trace::Scattergl::Unselected::Textfont - This attribute is one of the possible options for the trace scattergl.
