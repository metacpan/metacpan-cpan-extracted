...
Faker::Plugin::JaJp::AddressNumber
...
$test->for('synopsis', sub {
  ...
  ok $result->isa('Faker::Plugin::JaJp::AddressNumber');
...
$test->for('example', 1, 'execute', sub {
  ...
  is $result->execute, 104;
  ok $result->faker->random->pick; # reset randomizer
  is $result->execute, 105;
  ok $result->faker->random->pick; # reset randomizer
  is $result->execute, 109;
...
$test->render('lib/Faker/Plugin/JaJp/AddressNumber.pod') if $ENV{RENDER};
