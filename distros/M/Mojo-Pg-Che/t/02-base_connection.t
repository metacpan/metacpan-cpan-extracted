...
$pg = Mojo::Pg::Che->new('postgresql:///test1');
...
$pg = Mojo::Pg::Che->new('postgres://?service=foo&PrintError=1&PrintWarn=1');
...
$pg = Mojo::Pg::Che->new('postgres://?service=foo&search_path=test_schema');
is $pg->dsn,      'dbi:Pg:service=foo', 'right data source';
is $pg->username, '',                   'no username';
is $pg->password, '',                   'no password';
#~ $options = {
...
$pg = Mojo::Pg::Che->new('postgres://a:b@/c?search_path=test1&search_path=test2');
...
$pg = Mojo::Pg::Che->new('postgresql://127.0.0.1:8080/test2');
...
$pg = Mojo::Pg::Che->new('postgres://postgres@/test3');
...
$pg = Mojo::Pg::Che->new('postgresql://0:0@/0?RaiseError=0');
...
eval { Mojo::Pg::Che->new('http://localhost:3000/test') };
