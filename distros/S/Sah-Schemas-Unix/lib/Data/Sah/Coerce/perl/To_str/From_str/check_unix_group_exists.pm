...
Data::Sah::Coerce::perl::To_str::From_str::check_unix_group_exists - Check that Unix group exists on the system

=head1 VERSION

This document describes version 0.009 of Data::Sah::Coerce::perl::To_str::From_str::check_unix_group_exists (from Perl distribution Sah-Schemas-Unix), released on 2019-12-09.

=head1 SYNOPSIS

To use in a Sah schema:

 ["str",{"x.perl.coerce_rules"=>["From_str::check_unix_group_exists"]}]
