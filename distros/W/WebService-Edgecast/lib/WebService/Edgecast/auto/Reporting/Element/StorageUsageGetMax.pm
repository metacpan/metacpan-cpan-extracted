...
package WebService::Edgecast::auto::Reporting::Element::StorageUsageGetMax;
BEGIN {
  $WebService::Edgecast::auto::Reporting::Element::StorageUsageGetMax::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('StorageUsageGetMax');
...
WebService::Edgecast::auto::Reporting::Element::StorageUsageGetMax
...
StorageUsageGetMax from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Reporting::Element::StorageUsageGetMax->new($data);
