...
use PDLA::Transform;
 ...
 my $t = new PDLA::Transform::<type>(<opt>)
...
L<inplace|PDLA::Core/inplace> operation to save memory when the data are flagged
...
and L<unmap|/unmap> methods are also exported to the C<PDLA> package: they
...
functionality of L<rescale2d|PDLA::Image2D/rescale2d>, but with more
...
passed verbatim to L<range|PDLA::Slices/range> or
L<interpND|PDLA::Primitive/interpND> in the sampling or interpolating
...
L<interpND|PDLA::Primitive/interpnd> for interpolation.  Possible
...
L<PDLA::Transform::Cartography>) -- pixels along the 180th meridian get
...
Lookup is done using L<interpND|PDLA::Primitive/interpnd>, so the boundary conditions
...
Boundary condition to be fed to L<interpND|PDLA::Primitive/interpND>

=item m, method, Method

Interpolation method to be fed to L<interpND|PDLA::Primitive/interpND>
...
L<t_unit_sphere|PDLA::Transform::Cartography/t_unit_sphere>.
