...
use Storable::Improved qw(retrieve store nstore freeze nfreeze thaw dclone);
use Safe;
...
@obj =
    ([\&code,                   # code reference
      ...
      sub ($$;$) { 0 },         # prototypes
      sub { print "test\n" },
      \&Storable::Improved::_store,       # large scalar
     ],
...
$Storable::Improved::Deparse = 1;
$Storable::Improved::Eval    = 1;
...
######################################################################
# Security with
#   $Storable::Improved::Eval
#   $Storable::Improved::Deparse
...

{
    ...
    my $safe = new MySafe;
    local $Storable::Improved::Eval = sub { $safe->reval($_[0]) };
...

{
    ...
    local $Storable::Improved::Deparse = 1;
    local $Storable::Improved::Eval    = 1;
