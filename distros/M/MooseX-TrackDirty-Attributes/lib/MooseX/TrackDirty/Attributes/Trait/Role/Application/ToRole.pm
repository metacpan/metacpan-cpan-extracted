...
BEGIN {
  $MooseX::TrackDirty::Attributes::Trait::Role::Application::ToRole::AUTHORITY = 'cpan:RSRCHBOY';
}
$MooseX::TrackDirty::Attributes::Trait::Role::Application::ToRole::VERSION = '2.003';
...
This document describes version 2.003 of MooseX::TrackDirty::Attributes::Trait::Role::Application::ToRole - released December 23, 2014 as part of MooseX-TrackDirty-Attributes.
