		 ...
		 sub {
			 my %languages = (
				'ab' => 'Абхазча',
 				...
 				'el' => 'Грекча',
 				'en' => 'Инглизча',
 				'en_GB@alt=short' => 'Бирлашган Қироллик',
 				'eo' => 'Эсперанто',
 				'es' => 'Испанча',
	...
	default		=> sub { 
		{
			'001' => 'Дунё',
 			...
 			'FK@alt=variant' => 'Фолькленд ороллари (Мальвин ороллари)',
 			'FM' => 'Микронезия',
 			'FO' => 'Фарер ороллари',
 			'FR' => 'Франция',
 			'GA' => 'Габон',
 			'GB' => 'Бирлашган Қироллик',
 			'GB@alt=short' => 'Бирлашган Қироллик',
 			'GD' => 'Гренада',
 			'GE' => 'Грузия',
 			'GF' => 'Француз Гвианаси',
 			'GG' => 'Гернси',
