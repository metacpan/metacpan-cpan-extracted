...
for my $level (4, 5) {
  ...
  ok($xh[1] =~ $uneval_lhs
     ...
     "level $level unevaluated source") or do {
         ++$keep;
         diag $xh[1], $xh[1] =~ $uneval_lhs;
         diag $xh[5], $xh[5] =~ $uneval_lhs;
         diag $xh[9]; $xh[9] =~ $uneval_lhs;
         diag $xh[14], $xh[14] =~ $uneval_lhs;
         diag $xh[15], $xh[15] =~ $uneval_lhs;
 };
