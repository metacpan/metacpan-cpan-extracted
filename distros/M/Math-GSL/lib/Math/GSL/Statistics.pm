...
*gsl_error = *Math::GSL::Statisticsc::gsl_error;
*gsl_stream_printf = *Math::GSL::Statisticsc::gsl_stream_printf;
*gsl_strerror = *Math::GSL::Statisticsc::gsl_strerror;
*gsl_set_error_handler = *Math::GSL::Statisticsc::gsl_set_error_handler;
*gsl_set_error_handler_off = *Math::GSL::Statisticsc::gsl_set_error_handler_off;
*gsl_set_stream_handler = *Math::GSL::Statisticsc::gsl_set_stream_handler;
*gsl_set_stream = *Math::GSL::Statisticsc::gsl_set_stream;
...
*gsl_stats_spearman = *Math::GSL::Statisticsc::gsl_stats_spearman;
...
*gsl_stats_select = *Math::GSL::Statisticsc::gsl_stats_select;
*gsl_stats_median_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_median_from_sorted_data;
*gsl_stats_median = *Math::GSL::Statisticsc::gsl_stats_median;
*gsl_stats_quantile_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_quantile_from_sorted_data;
*gsl_stats_trmean_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_trmean_from_sorted_data;
*gsl_stats_gastwirth_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_gastwirth_from_sorted_data;
*gsl_stats_mad0 = *Math::GSL::Statisticsc::gsl_stats_mad0;
*gsl_stats_mad = *Math::GSL::Statisticsc::gsl_stats_mad;
*gsl_stats_Sn0_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_Sn0_from_sorted_data;
*gsl_stats_Sn_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_Sn_from_sorted_data;
*gsl_stats_Qn0_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_Qn0_from_sorted_data;
*gsl_stats_Qn_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_Qn_from_sorted_data;
...
*gsl_stats_int_select = *Math::GSL::Statisticsc::gsl_stats_int_select;
*gsl_stats_int_median_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_int_median_from_sorted_data;
*gsl_stats_int_median = *Math::GSL::Statisticsc::gsl_stats_int_median;
*gsl_stats_int_quantile_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_int_quantile_from_sorted_data;
*gsl_stats_int_trmean_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_int_trmean_from_sorted_data;
*gsl_stats_int_gastwirth_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_int_gastwirth_from_sorted_data;
*gsl_stats_int_mad0 = *Math::GSL::Statisticsc::gsl_stats_int_mad0;
*gsl_stats_int_mad = *Math::GSL::Statisticsc::gsl_stats_int_mad;
*gsl_stats_int_Sn0_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_int_Sn0_from_sorted_data;
*gsl_stats_int_Sn_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_int_Sn_from_sorted_data;
*gsl_stats_int_Qn0_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_int_Qn0_from_sorted_data;
*gsl_stats_int_Qn_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_int_Qn_from_sorted_data;
...
*gsl_stats_char_select = *Math::GSL::Statisticsc::gsl_stats_char_select;
*gsl_stats_char_median_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_char_median_from_sorted_data;
*gsl_stats_char_median = *Math::GSL::Statisticsc::gsl_stats_char_median;
*gsl_stats_char_quantile_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_char_quantile_from_sorted_data;
*gsl_stats_char_trmean_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_char_trmean_from_sorted_data;
*gsl_stats_char_gastwirth_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_char_gastwirth_from_sorted_data;
*gsl_stats_char_mad0 = *Math::GSL::Statisticsc::gsl_stats_char_mad0;
*gsl_stats_char_mad = *Math::GSL::Statisticsc::gsl_stats_char_mad;
*gsl_stats_char_Sn0_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_char_Sn0_from_sorted_data;
*gsl_stats_char_Sn_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_char_Sn_from_sorted_data;
*gsl_stats_char_Qn0_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_char_Qn0_from_sorted_data;
*gsl_stats_char_Qn_from_sorted_data = *Math::GSL::Statisticsc::gsl_stats_char_Qn_from_sorted_data;

# ------- VARIABLE STUBS --------

package Math::GSL::Statistics;

*GSL_VERSION = *Math::GSL::Statisticsc::GSL_VERSION;
...
*GSL_SUCCESS = *Math::GSL::Statisticsc::GSL_SUCCESS;
*GSL_FAILURE = *Math::GSL::Statisticsc::GSL_FAILURE;
*GSL_CONTINUE = *Math::GSL::Statisticsc::GSL_CONTINUE;
*GSL_EDOM = *Math::GSL::Statisticsc::GSL_EDOM;
*GSL_ERANGE = *Math::GSL::Statisticsc::GSL_ERANGE;
*GSL_EFAULT = *Math::GSL::Statisticsc::GSL_EFAULT;
*GSL_EINVAL = *Math::GSL::Statisticsc::GSL_EINVAL;
*GSL_EFAILED = *Math::GSL::Statisticsc::GSL_EFAILED;
*GSL_EFACTOR = *Math::GSL::Statisticsc::GSL_EFACTOR;
*GSL_ESANITY = *Math::GSL::Statisticsc::GSL_ESANITY;
*GSL_ENOMEM = *Math::GSL::Statisticsc::GSL_ENOMEM;
*GSL_EBADFUNC = *Math::GSL::Statisticsc::GSL_EBADFUNC;
*GSL_ERUNAWAY = *Math::GSL::Statisticsc::GSL_ERUNAWAY;
*GSL_EMAXITER = *Math::GSL::Statisticsc::GSL_EMAXITER;
*GSL_EZERODIV = *Math::GSL::Statisticsc::GSL_EZERODIV;
*GSL_EBADTOL = *Math::GSL::Statisticsc::GSL_EBADTOL;
*GSL_ETOL = *Math::GSL::Statisticsc::GSL_ETOL;
*GSL_EUNDRFLW = *Math::GSL::Statisticsc::GSL_EUNDRFLW;
*GSL_EOVRFLW = *Math::GSL::Statisticsc::GSL_EOVRFLW;
*GSL_ELOSS = *Math::GSL::Statisticsc::GSL_ELOSS;
*GSL_EROUND = *Math::GSL::Statisticsc::GSL_EROUND;
*GSL_EBADLEN = *Math::GSL::Statisticsc::GSL_EBADLEN;
*GSL_ENOTSQR = *Math::GSL::Statisticsc::GSL_ENOTSQR;
*GSL_ESING = *Math::GSL::Statisticsc::GSL_ESING;
*GSL_EDIVERGE = *Math::GSL::Statisticsc::GSL_EDIVERGE;
*GSL_EUNSUP = *Math::GSL::Statisticsc::GSL_EUNSUP;
*GSL_EUNIMPL = *Math::GSL::Statisticsc::GSL_EUNIMPL;
*GSL_ECACHE = *Math::GSL::Statisticsc::GSL_ECACHE;
*GSL_ETABLE = *Math::GSL::Statisticsc::GSL_ETABLE;
*GSL_ENOPROG = *Math::GSL::Statisticsc::GSL_ENOPROG;
*GSL_ENOPROGJ = *Math::GSL::Statisticsc::GSL_ENOPROGJ;
*GSL_ETOLF = *Math::GSL::Statisticsc::GSL_ETOLF;
*GSL_ETOLX = *Math::GSL::Statisticsc::GSL_ETOLX;
*GSL_ETOLG = *Math::GSL::Statisticsc::GSL_ETOLG;
*GSL_EOF = *Math::GSL::Statisticsc::GSL_EOF;
