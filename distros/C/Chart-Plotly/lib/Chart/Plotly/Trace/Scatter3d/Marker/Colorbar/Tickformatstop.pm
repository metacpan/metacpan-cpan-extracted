package Chart::Plotly::Trace::Scatter3d::Marker::Colorbar::Tickformatstop;
use Moose;
...
Chart::Plotly::Trace::Scatter3d::Marker::Colorbar::Tickformatstop - This attribute is one of the possible options for the trace scatter3d.
