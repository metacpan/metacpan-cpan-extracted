package Bio::VertRes::Config::Recipes::VirusSnpCallingUsingSmalt;
...
Bio::VertRes::Config::Recipes::VirusSnpCallingUsingSmalt - Standard snp calling pipeline for virus
...
Standard snp calling pipeline for virus. Register study, QC, map with bwa, snp call
   ...
   my $obj = Bio::VertRes::Config::Recipes::VirusSnpCallingUsingSmalt->new( 
     database => 'abc', 
