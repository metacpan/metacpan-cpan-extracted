package Acme::CPANAuthors::CPAN::Streaks::WeeklyNewDistributions::AllTime;
...
1;
# ABSTRACT: Authors with all-time weekly new distributions streak (release a new distribution every week)
...
Acme::CPANAuthors::CPAN::Streaks::WeeklyNewDistributions::AllTime - Authors with all-time weekly new distributions streak (release a new distribution every week)

=head1 VERSION

This document describes version 20240612.0 of Acme::CPANAuthors::CPAN::Streaks::WeeklyNewDistributions::AllTime (from Perl distribution Acme-CPANAuthorsBundle-CPAN-Streaks), released on 2024-06-12.
...
Current standings (as of 2024-06-12, produced by L<cpan-streaks>, only streaks with length of at least 6 are included):
  ...
  | SKIM      |   6 | 2024-02-04 | 2024-03-10 | broken  |
  +-----------+-----+------------+------------+---------+
