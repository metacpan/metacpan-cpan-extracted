...
our %STATS = ("num_columns",2,"num_rows",1679); # STATS
...
This document describes version 20220831.0.0 of TableDataRole::Business::ID::DGIP::Class::20 (from Perl distribution TableDataBundle-Business-ID-DGIP), released on 2022-09-01.
