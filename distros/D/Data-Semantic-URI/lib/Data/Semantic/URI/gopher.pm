...
package Data::Semantic::URI::gopher;
our $VERSION = '1.100850';
# ABSTRACT: Semantic data class for gopher URIs
use parent qw(Data::Semantic::URI);
use constant REGEXP_KEYS => qw(URI gopher);
1;
...
Data::Semantic::URI::gopher - Semantic data class for gopher URIs
...
=head1 SYNOPSIS
    ...
    my $obj = Data::Semantic::URI::gopher->new;
    if ($obj->is_valid('...')) {
       #  ...
    }
