...
Data::Sah::Coerce::perl::int::str_convert_en_or_id_month_name_to_num - Convert English/Indonesian month name (e.g. Des, april) to number (1-12)

=head1 VERSION

This document describes version 0.002 of Data::Sah::Coerce::perl::int::str_convert_en_or_id_month_name_to_num (from Perl distribution Sah-Schemas-Date-ID), released on 2019-07-21.
