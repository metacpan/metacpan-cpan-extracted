package Google::Ads::AdWords::v201809::StoreSalesUploadCommonMetadata;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::StoreSalesUploadCommonMetadata

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
StoreSalesUploadCommonMetadata from the namespace https://adwords.google.com/api/adwords/rm/v201809.
