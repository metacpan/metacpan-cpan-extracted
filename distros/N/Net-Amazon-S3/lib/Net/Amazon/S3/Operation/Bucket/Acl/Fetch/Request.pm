...
$Net::Amazon::S3::Operation::Bucket::Acl::Fetch::Request::VERSION = '0.992';
use Moose 0.85;
...
Net::Amazon::S3::Operation::Bucket::Acl::Fetch::Request - An internal class to get a bucket's access control
