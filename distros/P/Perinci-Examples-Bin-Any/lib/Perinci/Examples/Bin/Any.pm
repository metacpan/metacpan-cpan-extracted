...
1;
# ABSTRACT: Perinci example scripts (using Perinci::CmdLine::Any)
...
This document describes version 0.072 of Perinci::Examples::Bin::Any (from Perl distribution Perinci-Examples-Bin-Any), released on 2022-03-08.
