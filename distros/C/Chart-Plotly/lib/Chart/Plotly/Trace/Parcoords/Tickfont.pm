package Chart::Plotly::Trace::Parcoords::Tickfont;
use Moose;
...
has description => ( is      => "ro",
                     default => "Sets the font for the `dimension` tick values.", );
...
Chart::Plotly::Trace::Parcoords::Tickfont - This attribute is one of the possible options for the trace parcoords.
