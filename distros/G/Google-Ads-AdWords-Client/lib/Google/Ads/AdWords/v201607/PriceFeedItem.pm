package Google::Ads::AdWords::v201607::PriceFeedItem;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'priceExtensionType' => 'Google::Ads::AdWords::v201607::PriceExtensionType',
        'priceQualifier' => 'Google::Ads::AdWords::v201607::PriceExtensionPriceQualifier',
        'trackingUrlTemplate' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'language' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'tableRows' => 'Google::Ads::AdWords::v201607::PriceTableRow',
    },
    {
...
PriceFeedItem from the namespace https://adwords.google.com/api/adwords/cm/v201607.
