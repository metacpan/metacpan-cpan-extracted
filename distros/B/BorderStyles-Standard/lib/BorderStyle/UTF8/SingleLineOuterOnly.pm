...
1;
# ABSTRACT: Single line border with UTF8 characters, outer borders only
...
BorderStyle::UTF8::SingleLineOuterOnly - Single line border with UTF8 characters, outer borders only

=head1 VERSION

This document describes version 0.007 of BorderStyle::UTF8::SingleLineOuterOnly (from Perl distribution BorderStyles-Standard), released on 2021-05-12.
...
To use with L<Text::ANSITable>:
 ...
 $t->border_style("UTF8::SingleLineOuterOnly");
 $t->columns($rows->[0]);
...
To use with L<Text::Table::More>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"UTF8::SingleLineOuterOnly");
...
To use with L<Text::Table::TinyBorderStyle>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"BorderStyle::UTF8::SingleLineOuterOnly");
