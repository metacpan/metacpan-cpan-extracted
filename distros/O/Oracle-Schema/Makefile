# This Makefile is for the Oracle::Schema extension to perl.
#
...
TO_INST_PM = Schema.pm

PM_TO_BLIB = Schema.pm \
	$(INST_LIBDIR)/Schema.pm
...
manifypods : pure_all Schema.pm
	@$(POD2MAN) \
	Schema.pm \
	$(INST_MAN3DIR)/Oracle::Schema.$(MAN3EXT)
