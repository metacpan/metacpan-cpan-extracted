package Net::RRP::Response::n546;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n546::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n546::VERSION = '0.1';
...
Net::RRP::Response::n546 - the 546 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
