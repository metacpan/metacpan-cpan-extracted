...
BorderStyle::Text::ANSITable::OldCompat::Default::singlev_utf8 - UTF8::SingleLineVerticalOnly border style (with old name)

=head1 VERSION

This document describes version 0.609 of BorderStyle::Text::ANSITable::OldCompat::Default::singlev_utf8 (from Perl distribution Text-ANSITable), released on 2023-07-14.
