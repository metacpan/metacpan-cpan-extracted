...
package TableDataBundle::Business::ID::BBIA;
...
1;
# ABSTRACT: Collection of TableData:: modules related to BBIA (Balai Besar Industri Agro)
...
TableDataBundle::Business::ID::BBIA - Collection of TableData:: modules related to BBIA (Balai Besar Industri Agro)

=head1 VERSION

This document describes version 20230220.0 of TableDataBundle::Business::ID::BBIA (from Perl distribution TableDataBundle-Business-ID-BBIA), released on 2023-02-20.
...
=item * L<TableData::Business::ID::BBIA::ParameterCatalog>
