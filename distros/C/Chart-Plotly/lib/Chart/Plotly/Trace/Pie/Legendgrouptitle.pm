package Chart::Plotly::Trace::Pie::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Pie::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Pie::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Pie::Legendgrouptitle - This attribute is one of the possible options for the trace pie.
