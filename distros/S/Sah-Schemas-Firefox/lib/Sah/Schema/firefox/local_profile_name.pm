...
This document describes version 0.008 of Sah::Schema::firefox::local_profile_name (from Perl distribution Sah-Schemas-Firefox), released on 2023-06-14.
...
=head2 Sample data and validation results against this schema
 ...
 "default"  # valid (Assuming the profile named "default" exists in local Firefox installation)
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("firefox::local_profile_name", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("firefox::local_profile_name", {return_type=>'str_errmsg+val'});
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"firefox::local_profile_name*"' '"data..."'
...
To create a type constraint and type library from a schema:
 ...
 use My::Types qw(FirefoxLocalProfileName);
 FirefoxLocalProfileName->assert_valid($data);
