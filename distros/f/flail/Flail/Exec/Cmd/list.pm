...
Flail::Exec::Cmd::list - Flail "list" command

=head1 VERSION

  Time-stamp: <2006-12-03 11:04:37 attila@stalphonsos.com>

=head1 SYNOPSIS

  use Flail::Exec::Cmd::list;
  blah;
...
package Flail::Exec::Cmd::list;
use strict;
use Carp;
use Flail::Utils;
use base qw(Exporter);
use vars qw(@EXPORT @EXPORT_OK %EXPORT_TAGS);
@EXPORT_OK = qw(flail_list);
@EXPORT = ();
