package DesktopWorkspaceRoles::Standard;
...
1;
# ABSTRACT: Standard set of roles for DesktopWorkspace
...
DesktopWorkspaceRoles::Standard - Standard set of roles for DesktopWorkspace

=head1 VERSION

This document describes version 0.001 of DesktopWorkspaceRoles::Standard (from Perl distribution DesktopWorkspaceRoles-Standard), released on 2026-03-29.
