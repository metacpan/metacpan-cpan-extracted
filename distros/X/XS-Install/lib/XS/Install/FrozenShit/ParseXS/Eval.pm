package
  XS::Install::FrozenShit::ParseXS::Eval;
use strict;
use warnings;
...
XS::Install::FrozenShit::ParseXS::Eval - Clean package to evaluate code in

=head1 SYNOPSIS

  use XS::Install::FrozenShit::ParseXS::Eval;
  my $rv = XS::Install::FrozenShit::ParseXS::Eval::eval_typemap_code(
...
(formerly XS::Install::FrozenShit::ParseXS package variables)
...
typemaps, so beware. Variables set up from the XS::Install::FrozenShit::ParseXS object:
