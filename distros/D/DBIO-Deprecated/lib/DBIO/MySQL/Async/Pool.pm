...
# ABSTRACT: RENAMED -- see DBIO::MySQL::EV::Pool (dist DBIO-MySQL-EV)
...
die __PACKAGE__ . " has been renamed to DBIO::MySQL::EV::Pool and this module is"
  . " retired. Install DBIO-MySQL-EV instead:\n"
  . "  cpanm DBIO::MySQL::EV::Pool\n"
...
DBIO::MySQL::Async::Pool - RENAMED -- see DBIO::MySQL::EV::Pool (dist DBIO-MySQL-EV)
...
Install and C<use> L<DBIO::MySQL::EV::Pool> instead.

=head1 NAME

DBIO::MySQL::Async::Pool - DEPRECATED, renamed to DBIO::MySQL::EV::Pool

=head1 SEE ALSO

L<DBIO::MySQL::EV::Pool>, L<DBIO::MySQL::Async>, L<DBIO::Deprecated>
