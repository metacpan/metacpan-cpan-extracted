package Chart::Plotly::Trace::Scattersmith::Unselected::Marker;
use Moose;
...
Chart::Plotly::Trace::Scattersmith::Unselected::Marker - This attribute is one of the possible options for the trace scattersmith.
