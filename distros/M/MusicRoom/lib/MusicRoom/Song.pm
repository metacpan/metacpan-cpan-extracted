package MusicRoom::Song;

=head1 NAME

MusicRoom::Song - Manage the songs in a database
...
use constant TABLE_NAME => "song";
use constant USER_CLASS => "Song";
...
sub name_valid
  {
    ...
    my $nearest = MusicRoom::ValidSongs::nearest($arg,"Song module");
    return 1 if(lc($nearest) eq lc($arg));
    return undef;
  }
...
sub map_to_valid
  {
    ...
    my $nearest = MusicRoom::ValidSongs::nearest($val,"Song module");
