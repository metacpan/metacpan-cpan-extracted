...
# ABSTRACT: Perl API for HashiCorp's Vault (MSSQL)
...
package WebService::HashiCorp::Vault::Secret::MSSQL;
...
WebService::HashiCorp::Vault::Secret::MSSQL - Perl API for HashiCorp's Vault (MSSQL)
...
=head1 SYNOPSIS
 ...
 # Grab the MSSQL secret backend object
 my $mssql = $vault->secret( backend => 'mssql' );
...
The MSSQL Secret Backend handling for HashiCorps Vault server software.
