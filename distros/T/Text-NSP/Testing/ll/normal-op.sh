...
# shell program to test ll.pm's output during normal operation (that
...
# now the test!
echo "Test:   statistic.pl ll test-2.out $TESTFILE" 
statistic.pl ll test-2.out $TESTFILE 
...
# now the test!
echo "Test:   statistic.pl --set_freq_combo $FREQCOMBFILE ll test-2.out $TESTFILE" 
statistic.pl --set_freq_combo $FREQCOMBFILE ll test-2.out $TESTFILE
