...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TargetHttpsProxy Google::Cloud::Compute::V1::Compute::TargetHttpsProxyList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::RegionTargetHttpsProxiesClient->new( credentials => 'dummy' );
