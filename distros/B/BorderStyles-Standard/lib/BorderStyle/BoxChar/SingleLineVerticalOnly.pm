...
This document describes version 0.006 of BorderStyle::BoxChar::SingleLineVerticalOnly (from Perl distribution BorderStyles-Standard), released on 2021-02-19.
...
To use with L<Text::ANSITable>:
 ...
 $t->border_style("BoxChar::SingleLineVerticalOnly");
 $t->columns($rows->[0]);
...
To use with L<Text::Table::Span>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"BoxChar::SingleLineVerticalOnly");
