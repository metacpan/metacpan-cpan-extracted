...
$s = HTML::Scrubber::StripScripts->new( Allow_href => 1, Allow_a_mailto => 1 );
...
test( '<a href="mailto:foo@example.com">', '<a href="mailto:foo@example.com">', 'a mailto' );
