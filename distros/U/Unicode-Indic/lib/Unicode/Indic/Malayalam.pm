...
my $Map = {
  ...
  Ri	=>	chr(U+0x43),
  Ru	=>	chr(U+0x43),
  #RR	=>	chr(U+0x44), # This is reserved.
  RR   =>	chr(U+0x4d).chr(U+0x30).chr(U+0x42), #chr(U+0x44)
  RI   =>	chr(U+0x4d).chr(U+0x30).chr(U+0x40), #chr(U+0x44)
  RU   =>	chr(U+0x4d).chr(U+0x30).chr(U+0x42), #chr(U+0x44)
  S	=>	chr(U+0x36),
  T	=>	chr(U+0x1f),
  Th	=>	chr(U+0x20),
  U	=>	chr(U+0x42),
...
=head1	NAME
	...
	Unicode::Indic::Malayalam -Perl module for the Malayalam language.

=head1	SYNOPSIS

	use Unicode::Indic::Malayalam;

=head1	DESCRIPTION

	This perl module is used for transliteration of text from qwerty keyboard characters to Unicode Malayalam font characters and versa.
