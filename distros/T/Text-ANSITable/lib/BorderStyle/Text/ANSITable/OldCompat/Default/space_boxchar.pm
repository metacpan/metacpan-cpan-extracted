...
package BorderStyle::Text::ANSITable::OldCompat::Default::space_boxchar;
...
use alias::module 'BorderStyle::BoxChar::Space';

1;
# ABSTRACT: BoxChar::Space border style (with old name)
...
BorderStyle::Text::ANSITable::OldCompat::Default::space_boxchar - BoxChar::Space border style (with old name)

=head1 VERSION

This document describes version 0.607 of BorderStyle::Text::ANSITable::OldCompat::Default::space_boxchar (from Perl distribution Text-ANSITable), released on 2021-08-27.
