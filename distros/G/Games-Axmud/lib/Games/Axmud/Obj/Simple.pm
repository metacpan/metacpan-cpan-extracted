...
#
#
# Games::Axmud::Obj::Simple::List, a copy of Gtk2::Ex::Simple::List by muppet, Ross McFarland and
#   Gavin Brown
...
package Games::Axmud::Obj::Simple::List;
...
# use Games::Axmud::Obj::Simple::TiedList;
...
our %column_types;
*column_types = \%Games::Axmud::Obj::Simple::TiedCommon::column_types;
*add_column_type = \&Games::Axmud::Obj::Simple::TiedCommon::add_column_type;
...
sub new_from_treeview {
    ...
    my @a;
    tie @a, 'Games::Axmud::Obj::Simple::TiedList', $model;
...
package Games::Axmud::Obj::Simple::TiedCommon;
...
package Games::Axmud::Obj::Simple::TiedRow;
...
package Games::Axmud::Obj::Simple::TiedList;

use strict;
use Gtk2;
use Carp;

# use Games::Axmud::Obj::Simple::TiedCommon;
...
sub FETCH { # this, index
    ...
    my @row;
    tie @row, 'Games::Axmud::Obj::Simple::TiedRow', $_[0]->{model}, $iter;
    return \@row;
}
...
sub PUSH { # this, list
    ...
    foreach (@_)
    {
        $iter = $model->append;
        my @row;
        tie @row, 'Games::Axmud::Obj::Simple::TiedRow', $model, $iter;
        if ('ARRAY' eq ref $_) {
            @row = @$_;
        } else {
            $row[0] = $_;
