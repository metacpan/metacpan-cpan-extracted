#
# Test case for WebService::Recruit::AkasuguUchiiwai::Feature
#
...
my $service = new WebService::Recruit::AkasuguUchiiwai::Feature();

ok( ref $service, 'new WebService::Recruit::AkasuguUchiiwai::Feature()' );
...
# Test[0]
{
    ...
    my $res = new WebService::Recruit::AkasuguUchiiwai::Feature();
    ...
    can_ok( $data, 'feature' );
    ok( eval { $data->feature }, 'Test[0]: feature' );
    ok( eval { ref $data->feature } eq 'ARRAY', 'Test[0]: feature' );
    can_ok( $data->feature->[0], 'code' );
    ok( eval { $data->feature->[0]->code }, 'Test[0]: code' );
    can_ok( $data->feature->[0], 'name' );
    ok( eval { $data->feature->[0]->name }, 'Test[0]: name' );
}
