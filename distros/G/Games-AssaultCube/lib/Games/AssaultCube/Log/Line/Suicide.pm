# Declare our package
package Games::AssaultCube::Log::Line::Suicide;
...
Describes the Suicide event in a log line

=head1 DESCRIPTION

This module holds the "Suicide" event data from a log line. Normally, you would not use this class directly
but via the L<Games::AssaultCube::Log::Line> class.

This line is emitted when a client suicides.
...
The nick of the client who suicided
