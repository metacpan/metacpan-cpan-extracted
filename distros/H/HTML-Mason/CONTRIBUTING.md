...
If you use cpanminus, you can do it without downloading the tarball first:
    ...
    $ cpanm --reinstall --installdeps --with-recommends HTML::Mason
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends HTML::Mason
...
The code for this distribution is [hosted at GitHub](https://github.com/houseabsolute/HTML-Mason).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=HTML-Mason)
or [via email](bug-html-mason@rt.cpan.org.
