...
IO::K8s::ExternalSecrets::V1::BarbicanProviderUsernameRef - BarbicanProviderUsernameRef defines a reference to a secret containing username for the Barbican provider.
