package Chart::Plotly::Trace::Surface::Colorbar::Titlefont;
use Moose;
...
Chart::Plotly::Trace::Surface::Colorbar::Titlefont - This attribute is one of the possible options for the trace surface.
