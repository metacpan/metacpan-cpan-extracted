...
$Geoffrey::Exception::Template::VERSION = '0.000206';
...
Geoffrey::Exception::Template - # Exception classes for if a ordered is not existing
...
=head2 throw_template_not_found
