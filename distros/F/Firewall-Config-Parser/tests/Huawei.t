...
my $predefinedService = {
  'HTTP' => Firewall::Config::Element::Service::Huawei->new(
    srvName  => 'http',
    protocol => 'tcp',
    srcPort  => '1-65535',
    dstPort  => '80'
  ),
  'any' => Firewall::Config::Element::Service::Huawei->new(
    srvName  => 'any',
    protocol => 'any',
    srcPort  => '1-65535',
    dstPort  => '1-65535'
...
=pod
use Firewall::DBI::Pg;
my $dbi = Firewall::DBI::Pg->new( host => 'dbhost', port => 5432, dbname  => 'firewall', user => 'postgres', password => 'postgres'  );
my $predefinedService;
