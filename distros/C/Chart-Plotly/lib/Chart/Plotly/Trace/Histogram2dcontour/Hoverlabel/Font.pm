package Chart::Plotly::Trace::Histogram2dcontour::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Histogram2dcontour::Hoverlabel::Font - This attribute is one of the possible options for the trace histogram2dcontour.
