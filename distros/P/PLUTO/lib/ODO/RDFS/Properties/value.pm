package ODO::RDFS::Properties::value;
...
sub new {
	...
	$self->propertyContainerName( 'ODO::RDFS::Properties::value::PropertiesContainer' );
	$self->properties(bless {}, 'ODO::RDFS::Properties::value::PropertiesContainer');
