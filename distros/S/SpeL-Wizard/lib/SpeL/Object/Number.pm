# -*- cperl -*-
# ABSTRACT: LaTeX Number object


use strict;
use warnings;
package SpeL::Object::Number;
...
sub read {
  ...
  return ( exists $self->{imag} ? ' ' . $self->{imag} : '' )
      . $self->{Realnumber}->read( $level + 1 );
}
...
SpeL::Object::Number - LaTeX Number object
