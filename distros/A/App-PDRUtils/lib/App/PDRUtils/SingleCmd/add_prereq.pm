package App::PDRUtils::SingleCmd::add_prereq;
...
App::PDRUtils::SingleCmd::add_prereq - Add a prereq

=head1 VERSION

This document describes version 0.121 of App::PDRUtils::SingleCmd::add_prereq (from Perl distribution App-PDRUtils), released on 2019-07-25.
