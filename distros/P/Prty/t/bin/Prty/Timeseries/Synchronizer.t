...
package Prty::Timeseries::Synchronizer::Test;
...
sub test_loadClass : Init(1) {
    shift->useOk('Prty::Timeseries::Synchronizer');
}
...
sub test_new_1 : Test(7) {
    ...
    my $obj = Prty::Timeseries::Synchronizer->new(600,
        qw/Latitude Longitude WindSpeed/,
    );
    $self->is(ref($obj),'Prty::Timeseries::Synchronizer');
...
sub test_add : Test(10) {
    ...
    my $tsy = Prty::Timeseries::Synchronizer->new(10,'P1');
    my $param1 = 'P1';
    for (my $i = 0; $i < 60; $i += 1) {
        $tsy->add($i,$param1=>$i);
    }
...
sub test_addParameter : Test(2) {
    ...
    my $tsy = Prty::Timeseries::Synchronizer->new(10);
...
sub test_rows : Test(2) {
    ...
    my $tsy = Prty::Timeseries::Synchronizer->new(10,$param);
    for (my $i = 0; $i < 60; $i += 1) {
        $tsy->add($i,$param=>$i);
    }
...
package main;
Prty::Timeseries::Synchronizer::Test->runTests;
