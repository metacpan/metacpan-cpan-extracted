...
sub keys_of_EBCDIC_FUJITSU_by_JIS8 {
    return keys %EBCDIC_FUJITSU_by_JIS8;
}

sub values_of_EBCDIC_FUJITSU_by_JIS8 {
    return values %EBCDIC_FUJITSU_by_JIS8;
}
