...
BorderStyle::Text::ANSITable::OldCompat::Default::bricko - UTF8::BrickOuterOnly border style (with old name)

=head1 VERSION

This document describes version 0.607 of BorderStyle::Text::ANSITable::OldCompat::Default::bricko (from Perl distribution Text-ANSITable), released on 2021-08-27.
