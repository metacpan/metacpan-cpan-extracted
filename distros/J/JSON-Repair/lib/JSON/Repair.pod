...
(This example is included as L<F<synopsis.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Repair-0.07/examples/synopsis.pl> in the distribution.)


=head1 VERSION

This documents version 0.07 of JSON::Repair corresponding to
git commit L<33380f296af9a5b7a6276d894dada27bbd2a3903|https://github.com/benkasminbullock/json-repair/commit/33380f296af9a5b7a6276d894dada27bbd2a3903> released on Fri Oct 5 10:03:54 2018 +0900.
...
(This example is included as L<F<trailing-commas.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Repair-0.07/examples/trailing-commas.pl> in the distribution.)
...
(This example is included as L<F<single-quotes.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Repair-0.07/examples/single-quotes.pl> in the distribution.)
...
(This example is included as L<F<missing-ends.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Repair-0.07/examples/missing-ends.pl> in the distribution.)
...
(This example is included as L<F<unquoted-keys.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Repair-0.07/examples/unquoted-keys.pl> in the distribution.)
...
(This example is included as L<F<missing-commas.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Repair-0.07/examples/missing-commas.pl> in the distribution.)
...
(This example is included as L<F<comments.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Repair-0.07/examples/comments.pl> in the distribution.)
...
(This example is included as L<F<hash-comments.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Repair-0.07/examples/hash-comments.pl> in the distribution.)
...
(This example is included as L<F<numbers.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Repair-0.07/examples/numbers.pl> in the distribution.)
...
(This example is included as L<F<strings.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Repair-0.07/examples/strings.pl> in the distribution.)
...
(This example is included as L<F<synopsis-verbose.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Repair-0.07/examples/synopsis-verbose.pl> in the distribution.)
