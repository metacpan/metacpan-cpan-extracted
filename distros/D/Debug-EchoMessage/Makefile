# This Makefile is for the Debug::EchoMessage extension to perl.
#
...
#	DISTNAME => q[Debug-EchoMessage-1.03.tar.gz]
#	NAME => q[Debug::EchoMessage]
#	PREREQ_PM => { Test::Harness=>q[0.1], Test::More=>q[0.45] }
#	VERSION => q[1.03]
#	test => { TESTS=>q[t/EchoMessage.t] }
...
AR_STATIC_ARGS = cr
NAME = Debug::EchoMessage
DISTNAME = Debug-EchoMessage-1.03.tar.gz
NAME_SYM = Debug_EchoMessage
VERSION = 1.03
VERSION_SYM = 1_03
XS_VERSION = 1.03
INST_BIN = blib/bin
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Debug
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Debug
...
TO_INST_PM = EchoMessage.pm

PM_TO_BLIB = EchoMessage.pm \
	$(INST_LIBDIR)/EchoMessage.pm
...
realclean purge ::  clean
	...
	rm -f  $(INST_LIBDIR)/EchoMessage.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Debug-EchoMessage-1.03.tar.gz\" VERSION=\"1,03,0,0\">\n}. qq{\t<TITLE>Debug-EchoMessage-1.03.tar.gz</TITLE>\n}. qq{\t<ABSTRACT>Display debug messages based on levels</ABSTRACT>\n}. qq{\t<AUTHOR>geotiger2001\@yahoo.com</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"Test-Harness\" VERSION=\"0,1,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Test-More\" VERSION=\"0,45,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"sun4-solaris-64int\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Debug-EchoMessage-1.03.tar.gz.ppd
