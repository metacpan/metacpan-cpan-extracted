...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::TTF::AATKern;

=head1 NAME

PDF::API3::Compat::API2::Basic::TTF::AATKern
...
use PDF::API3::Compat::API2::Basic::TTF::Kern::Subtable;
...
sub read
{
    ...
    foreach (1 .. $numSubtables) {
        ...
        my $subtable = PDF::API3::Compat::API2::Basic::TTF::Kern::Subtable->create($type, $coverage, $length);
        $subtable->read($fh);
...
Jonathan Kew L<Jonathan_Kew@sil.org>. See L<PDF::API3::Compat::API2::Basic::TTF::Font> for copyright and
licensing.
