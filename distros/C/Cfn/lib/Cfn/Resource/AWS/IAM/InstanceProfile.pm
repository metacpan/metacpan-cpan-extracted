...
Cfn::Resource::AWS::IAM::InstanceProfile - Cfn resource for AWS::IAM::InstanceProfile

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::IAM::InstanceProfile.
