...
$Search::Elasticsearch::Client::5_0::Role::Scroll::VERSION = '6.80';
use Moo::Role;
requires 'finish';
...
Search::Elasticsearch::Client::5_0::Role::Scroll - Provides common functionality to L<Search::Elasticsearch::Client::5_0::Scroll> and L<Search::Elasticsearch::Client::5_0::Async::Scroll>
