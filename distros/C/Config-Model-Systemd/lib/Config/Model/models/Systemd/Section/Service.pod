...
in L<systemd-system.conf(5)>. I< Optional. Type boolean.  > 
...
=head2 CPUSetPartition

Sets the C<cpuset> partition type for the executed processes. Takes one
...
This setting requires C<AllowedCPUs> to also be set. I< Optional. Type enum. choice: 'isolated', 'member', 'root'.  > 
...
cgroups via C<OOMRules> may have a measurable performance impact. I< Optional. Type uniline.  > 
...
details. I< Optional. Type enum. choice: 'batch', 'ext', 'fifo', 'idle', 'other', 'rr'.  > 
...
location, i.e. outside of the hierarchies listed above. I< Optional. Type enum. choice: 'no', 'read-only', 'tmpfs', 'yes'.  > 
...
perspective of the host and from inside the unit, the relevant directories hence always appear
directly below C</run/>. I< Optional. Type enum. choice: 'no', 'restart', 'yes'.  > 
...
This option is only available for system services. I< Optional. Type uniline.  > 
...
L<prctl(2)>. I< Optional. Type uniline.  > 
...
Takes a boolean argument or one of C<self>,
...
unit-level C<Condition…=> or C<Assert…=> check failing. Because
...
honored. By contrast, C<Condition…=> directives in the C<[Unit]> section
...
configured commands the same way. Defaults to false. I< Optional. Type boolean.  > 
...
explicitly. I< Optional. Type enum. choice: 'no', 'on-success', 'restart', 'yes'.  > 
