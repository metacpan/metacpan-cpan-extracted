...
1;
# ABSTRACT: List modules of an author sorted by their number of reverse dependencies
...
App::lcpan::Cmd::author_mods_by_rdep_count - List modules of an author sorted by their number of reverse dependencies

=head1 VERSION

This document describes version 1.071 of App::lcpan::Cmd::author_mods_by_rdep_count (from Perl distribution App-lcpan), released on 2022-09-19.
