package Chart::Plotly::Trace::Treemap::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Treemap::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Treemap::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Treemap::Legendgrouptitle - This attribute is one of the possible options for the trace treemap.
