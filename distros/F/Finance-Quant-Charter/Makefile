# This Makefile is for the Finance::Quant::Charter extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Finance/Quant/Charter.pm]
#     AUTHOR => [q[sante zero <hagen@>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Finance::Quant::Charter]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Finance/Quant/Charter.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Finance::Quant::Charter
NAME_SYM = Finance_Quant_Charter
VERSION = 0.01
...
MAKE = make
FULLEXT = Finance/Quant/Charter
BASEEXT = Charter
PARENT_NAME = Finance::Quant
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Finance/Quant/Charter.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
INST_LIBDIR      = $(INST_LIB)/Finance/Quant
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Finance/Quant
...
TO_INST_PM = lib/Finance/Quant/Charter.pm

PM_TO_BLIB = lib/Finance/Quant/Charter.pm \
...
DISTNAME = Finance-Quant-Charter
DISTVNAME = Finance-Quant-Charter-0.01
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Finance-Quant-Charter' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "sante zero <hagen@>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Finance-Quant-Charter",' >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Finance/Quant/Charter.pm blib/lib/Finance/Quant/Charter.pm 
