package blx::xsdsql::generator::sql::oracle::handle::addpk;
use strict;  # use strict is for PBP
use Filter::Include;
include blx::xsdsql::include;
#line 6
use base qw(blx::xsdsql::generator::sql::generic::handle::addpk);
...
use blx::xsdsql::generator::sql::oracle::handle::addpk
