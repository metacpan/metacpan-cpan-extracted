...
BorderStyle::Text::ANSITable::OldCompat::Default::single_boxchar - BoxChar::SingleLine border style (with old name)

=head1 VERSION

This document describes version 0.608 of BorderStyle::Text::ANSITable::OldCompat::Default::single_boxchar (from Perl distribution Text-ANSITable), released on 2022-02-14.
