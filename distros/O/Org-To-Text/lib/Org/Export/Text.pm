...
Org::Export::Text - Export Org document to text

=head1 VERSION

This document describes version 0.04 of Org::Export::Text (from Perl distribution Org-To-Text), released on 2017-07-10.
