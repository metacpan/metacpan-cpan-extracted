# AWS::ElastiCache::ReplicationGroup generated from spec 22.0.0
...
package Cfn::Resource::AWS::ElastiCache::ReplicationGroup {
  ...
  sub AttributeList {
    [ 'ConfigurationEndPoint.Address','ConfigurationEndPoint.Port','PrimaryEndPoint.Address','PrimaryEndPoint.Port','ReadEndPoint.Addresses','ReadEndPoint.Addresses.List','ReadEndPoint.Ports','ReadEndPoint.Ports.List','ReaderEndPoint.Address','ReaderEndPoint.Port' ]
  }
...
package Cfn::Resource::Properties::AWS::ElastiCache::ReplicationGroup {
  ...
  has GlobalReplicationGroupId => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Immutable');
  has KmsKeyId => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Immutable');
  has MultiAZEnabled => (isa => 'Cfn::Value::Boolean', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
  ...
  has UserGroupIds => (isa => 'Cfn::Value::Array|Cfn::Value::Function|Cfn::DynamicValue', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
}
...
Cfn::Resource::AWS::ElastiCache::ReplicationGroup - Cfn resource for AWS::ElastiCache::ReplicationGroup

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::ElastiCache::ReplicationGroup.
