...
The code for this distribution is [hosted on GitHub](https://github.com/moose/Dist-Zilla-Plugin-Conflicts).
...
can submit an issue report [via the web](https://github.com/moose/Dist-Zilla-Plugin-Conflicts/issues).
