package Chart::ECharts::Candlestick;
...
Chart::ECharts::Candlestick - Candlestick chart
...
L<Chart::ECharts::Candlestick> inherits all methods from L<Chart::ECharts::Base>.
