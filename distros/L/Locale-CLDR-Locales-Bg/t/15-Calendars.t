...
is_deeply ($am_pm, { evening1 => 'вечерта', morning1 => 'сутринта', morning2 => 'на обед', afternoon1 => 'следобед', midnight => 'полунощ', night1 => 'през нощта', am => 'пр.об.', pm => 'сл.об.' }, 'AM PM format abbreviated');
$am_pm = $locale->am_pm_format_narrow();
is_deeply ($am_pm, { evening1 => 'вечерта', morning1 => 'сутринта', morning2 => 'на обед', afternoon1 => 'следобед', midnight => 'полунощ', night1 => 'през нощта', am => 'пр.об.', pm => 'сл.об.' }, 'AM PM format narrow');
$am_pm = $locale->am_pm_stand_alone_wide();
is_deeply ($am_pm, { evening1 => 'вечерта', morning1 => 'сутринта', morning2 => 'на обед', afternoon1 => 'следобед', midnight => 'полунощ', night1 => 'нощ', am => 'пр.об.', pm => 'сл.об.' }, 'AM PM stand alone wide');
$am_pm = $locale->am_pm_stand_alone_abbreviated();
is_deeply ($am_pm, { evening1 => 'вечер', morning1 => 'сутрин', morning2 => 'на обед', afternoon1 => 'следобед', midnight => 'полунощ', night1 => 'нощ', am => 'пр.об.', pm => 'сл.об.' }, 'AM PM stand alone abbreviated');
$am_pm = $locale->am_pm_stand_alone_narrow();
is_deeply ($am_pm, { evening1 => 'вечер', morning1 => 'сутрин', morning2 => 'на обед', afternoon1 => 'следобед', midnight => 'полунощ', night1 => 'нощ', am => 'пр.об.', pm => 'сл.об.' }, 'AM PM stand alone narrow');
