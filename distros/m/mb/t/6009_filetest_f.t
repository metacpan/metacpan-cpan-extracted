...
# 1
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -f "6009.0B.A"          }) xor mb::eval(q{ -f "6009.0B.ソ"          }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -f "6009.1B.binary.A"   }) xor mb::eval(q{ -f "6009.1B.binary.ソ"   }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -f "6009.1B.text.A"     }) xor mb::eval(q{ -f "6009.1B.text.ソ"     }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -f "6009.512B.binary.A" }) xor mb::eval(q{ -f "6009.512B.binary.ソ" }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -f "6009.512B.text.A"   }) xor mb::eval(q{ -f "6009.512B.text.ソ"   }) },
    sub {1},
    sub {1},
# 11
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ (-f "6009.0B.A"         ) xor (-f "6009.0B.ソ"         ) }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ (-f "6009.1B.binary.A"  ) xor (-f "6009.1B.binary.ソ"  ) }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ (-f "6009.1B.text.A"    ) xor (-f "6009.1B.text.ソ"    ) }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ (-f "6009.512B.binary.A") xor (-f "6009.512B.binary.ソ") }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ (-f "6009.512B.text.A"  ) xor (-f "6009.512B.text.ソ"  ) }) },
    sub {1},
    sub {1},
# 21
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ open(FH1,"6009.0B.A"         ); my $r = -f FH1; close FH1;    $r }) xor mb::eval(q{ -f "6009.0B.ソ"          }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ open(FH1,"6009.1B.binary.A"  ); my $r = -f FH1; close FH1;    $r }) xor mb::eval(q{ -f "6009.1B.binary.ソ"   }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ open(FH1,"6009.1B.text.A"    ); my $r = -f FH1; close FH1;    $r }) xor mb::eval(q{ -f "6009.1B.text.ソ"     }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ open(FH1,"6009.512B.binary.A"); my $r = -f FH1; close FH1;    $r }) xor mb::eval(q{ -f "6009.512B.binary.ソ" }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ open(FH1,"6009.512B.text.A"  ); my $r = -f FH1; close FH1;    $r }) xor mb::eval(q{ -f "6009.512B.text.ソ"   }) },
    sub {1},
    sub {1},
# 31
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -f "6009.0B.A"          }) xor mb::eval(q{ open(FH2,"6009.0B.ソ"         ); -f FH2 }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -f "6009.1B.binary.A"   }) xor mb::eval(q{ open(FH2,"6009.1B.binary.ソ"  ); -f FH2 }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -f "6009.1B.text.A"     }) xor mb::eval(q{ open(FH2,"6009.1B.text.ソ"    ); -f FH2 }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -f "6009.512B.binary.A" }) xor mb::eval(q{ open(FH2,"6009.512B.binary.ソ"); -f FH2 }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -f "6009.512B.text.A"   }) xor mb::eval(q{ open(FH2,"6009.512B.text.ソ"  ); -f FH2 }) },
    sub {1},
    sub {1},
# 41
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ open(FH1,"6009.0B.A"         ); open(FH2,"6009.0B.ソ"         ); (-f FH1) xor (-f FH2) }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ open(FH1,"6009.1B.binary.A"  ); open(FH2,"6009.1B.binary.ソ"  ); (-f FH1) xor (-f FH2) }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ open(FH1,"6009.1B.text.A"    ); open(FH2,"6009.1B.text.ソ"    ); (-f FH1) xor (-f FH2) }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ open(FH1,"6009.512B.binary.A"); open(FH2,"6009.512B.binary.ソ"); (-f FH1) xor (-f FH2) }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ open(FH1,"6009.512B.text.A"  ); open(FH2,"6009.512B.text.ソ"  ); (-f FH1) xor (-f FH2) }) },
    sub {1},
    sub {1},
# 51
