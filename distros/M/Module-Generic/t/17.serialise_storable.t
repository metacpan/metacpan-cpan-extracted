...
plan( skip_all => "Storable::Improved v0.1.2 required for testing serialisation with Storable" ) if( $@ );
...
my $serialised = Storable::Improved::freeze( $gen );
my $gen2 = Storable::Improved::thaw( $serialised );
...
$serialised = Storable::Improved::freeze( $a );
my $a2 = Storable::Improved::thaw( $serialised );
...
$serialised = Storable::Improved::freeze( $b );
my $b2 = Storable::Improved::thaw( $serialised );
...
$serialised = Storable::Improved::freeze( $d );
...
$serialised = Storable::Improved::freeze( $dyn );
my $dyn2 = Storable::Improved::thaw( $serialised );
...
$serialised = Storable::Improved::freeze( $ex );
my $ex2 = Storable::Improved::thaw( $serialised );
...
$serialised = Storable::Improved::freeze( $cache );
my $cache2 = Storable::Improved::thaw( $serialised );
...
$serialised = Storable::Improved::freeze( $io );
my $io2 = Storable::Improved::thaw( $serialised );
...
$serialised = Storable::Improved::freeze( $f );
my $f2 = Storable::Improved::thaw( $serialised );
...
$serialised = Storable::Improved::freeze( $finfo );
my $finfo2 = Storable::Improved::thaw( $serialised );
...
$serialised = Storable::Improved::freeze( $h );
my $h2 = Storable::Improved::thaw( $serialised );
...
$hv->param( 'bar' => 2 );
$serialised = Storable::Improved::freeze( $hv );
my $hv2 = Storable::Improved::thaw( $serialised );
...
$serialised = Storable::Improved::freeze( $null );
my $null2 = Storable::Improved::thaw( $serialised );
...
$serialised = Storable::Improved::freeze( $n );
my $n2 = Storable::Improved::thaw( $serialised );
...
$serialised = Storable::Improved::freeze( $s );
my $s2 = Storable::Improved::thaw( $serialised );
...
$serialised = Storable::Improved::freeze( $sm );
my $sm2 = Storable::Improved::thaw( $serialised );
