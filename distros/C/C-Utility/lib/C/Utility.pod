...
(This example is included as L<F<fox.pl>|https://api.metacpan.org/source/BKB/C-Utility-0.006/examples/fox.pl> in the distribution.)
...
(This example is included as L<F<fox-pc.pl>|https://api.metacpan.org/source/BKB/C-Utility-0.006/examples/fox-pc.pl> in the distribution.)
...
(This example is included as L<F<michael-caine.pl>|https://api.metacpan.org/source/BKB/C-Utility-0.006/examples/michael-caine.pl> in the distribution.)
...
writes out the text to F<$outfile>, replacing C<#lineout> with an
appropriate line directive.
...
(This example is included as L<F<lineout.pl>|https://api.metacpan.org/source/BKB/C-Utility-0.006/examples/lineout.pl> in the distribution.)
...
(This example is included as L<F<line-directive.pl>|https://api.metacpan.org/source/BKB/C-Utility-0.006/examples/line-directive.pl> in the distribution.)
