...
########################################################################
# perl's recursive cleanups is no longer an issue after 5.16.
...
sub clone
{
    ...
    $rootz{ refaddr $clone } = $rootz{ refaddr $listh };
...
# A: Better leaving the reset to the caller, who knows
#    what to expect in that case.
