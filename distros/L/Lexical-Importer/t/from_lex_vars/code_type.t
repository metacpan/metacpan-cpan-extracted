...
eval q{BEGIN { require Lexical::Importer; Lexical::Importer->_import_lex_var('&foo' => sub{}) } &foo if 0;};
is $@, "";
eval q{BEGIN { require Lexical::Importer; Lexical::Importer->_import_lex_var('&foo' => bless(sub{})) } &foo if 0;};
is $@, "";
