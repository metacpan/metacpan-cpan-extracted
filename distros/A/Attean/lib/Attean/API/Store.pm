...
This document describes Attean::Store version 0.039
...
package Attean::API::Store 0.039 {
	use Moo::Role;
}

package Attean::API::TripleStore 0.039 {
...
package Attean::API::MutableTripleStore 0.039 {
	use Moo::Role;
...
package Attean::API::ETagCacheableTripleStore 0.039 {
	use Moo::Role;
	with 'Attean::API::TripleStore';
...
package Attean::API::TimeCacheableTripleStore 0.039 {
	use Moo::Role;
	with 'Attean::API::TripleStore';
...
package Attean::API::QuadStore 0.039 {
	use Scalar::Util qw(blessed);
...
package Attean::API::MutableQuadStore 0.039 {
	use Role::Tiny ();
	use Moo::Role;
	use Type::Tiny::Role;
...
package Attean::API::ETagCacheableQuadStore 0.039 {
	use Moo::Role;
...
package Attean::API::TimeCacheableQuadStore 0.039 {
	use Moo::Role;
...
package Attean::API::BulkUpdatableStore 0.039 {
	use Moo::Role;
...
package Attean::API::RDFStarStore 0.039 {
	use Moo::Role;
