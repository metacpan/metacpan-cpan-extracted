package Chart::Plotly::Trace::Waterfall::Outsidetextfont;
use Moose;
...
Chart::Plotly::Trace::Waterfall::Outsidetextfont - This attribute is one of the possible options for the trace waterfall.
