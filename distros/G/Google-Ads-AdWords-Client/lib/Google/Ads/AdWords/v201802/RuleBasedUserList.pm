package Google::Ads::AdWords::v201802::RuleBasedUserList;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201802::UserList);
# Variety: sequence
...
Google::Ads::AdWords::v201802::RuleBasedUserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RuleBasedUserList from the namespace https://adwords.google.com/api/adwords/rm/v201802.
