...
Tabellenklasse bei Objekt-Datensätzen: C<< Prty::Database::ResultSet::Object >>

=item *

Tabellenklasse bei Array-Datensätzen: C<< Prty::Database::ResultSet::Array >>
...
sub tableClass {
    ...
    if (!$cache{$class}) {
        no strict 'refs';
        my $found = 0;
        for ($class,Prty::Perl->baseClassesISA($class)) {
...
Instanttierung über anonyme Datensatz-Klasse:
    ...
    $tab = Prty::Database::Row::Object->makeTable(
        [qw/per_id per_vorname per_nachname per_geburtsdatum/],
        qw/1 Rudi Ratlos 1971-04-23/,
        qw/2 Erika Mustermann 1955-03-16/,
        qw/3 Harry Hirsch 1948-07-22/,
