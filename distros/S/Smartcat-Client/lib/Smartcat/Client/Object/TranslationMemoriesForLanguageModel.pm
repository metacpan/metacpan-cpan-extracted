...
#
package Smartcat::Client::Object::TranslationMemoriesForLanguageModel;
...
__PACKAGE__->method_documentation(
    {
        ...
        'translation_memories' => {
            datatype    => 'ARRAY[TranslationMemoryForProjectModel]',
            base_name   => 'translationMemories',
            description => '',
            format      => '',
            read_only   => '',
        },
...
__PACKAGE__->swagger_types(
    {
        'language'             => 'string',
        'translation_memories' => 'ARRAY[TranslationMemoryForProjectModel]'
    }
);
