package Google::Ads::AdWords::v201806::OfflineConversionAdjustmentFeed;
use strict;
use warnings;
...
Google::Ads::AdWords::v201806::OfflineConversionAdjustmentFeed

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OfflineConversionAdjustmentFeed from the namespace https://adwords.google.com/api/adwords/cm/v201806.
