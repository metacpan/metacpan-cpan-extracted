package Chart::Plotly::Trace::Scattermapbox::Selected;
use Moose;
...
has marker => ( is  => "rw",
                isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattermapbox::Selected::Marker", );
...
Chart::Plotly::Trace::Scattermapbox::Selected - This attribute is one of the possible options for the trace scattermapbox.
