...
Log::ger::Layout::YAML - Layout log message as a YAML

=head1 VERSION

This document describes version 0.001 of Log::ger::Layout::YAML (from Perl distribution Log-ger-Layout-YAML), released on 2017-06-28.
...
Please visit the project's homepage at L<https://metacpan.org/release/Log-ger-Layout-YAML>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Log-ger-Layout-YAML>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=Log-ger-Layout-YAML>
