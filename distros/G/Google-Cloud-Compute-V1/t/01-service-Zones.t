...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Zone Google::Cloud::Compute::V1::Compute::ZoneList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::ZonesClient->new( credentials => 'dummy' );
