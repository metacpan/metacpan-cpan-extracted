...
=head1 ARITHMETIC
 ...
 by either IVs, NVs, PVs, Math::Bfloat16 objects or other
 Math::Float32 objects.
 The IV/NV/PV operands will first be converted to a single
 precision float value (rounded to nearest, ties to even).
 Operations involving Math::Bfloat16 objects will be handled by
 Math::Bfloat16's overloading subs & will return a Math::Bfoat16
 object. (See the Math::Bfloat16 pod for further information.)
