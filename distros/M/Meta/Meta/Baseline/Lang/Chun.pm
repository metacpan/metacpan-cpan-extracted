...
package Meta::Baseline::Lang::Chun;
...
Meta::Baseline::Lang::Chun - language for SGML chunk files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Chun::env();

=head1 DESCRIPTION

This package contains stuff specific to Chun in the baseline:
Its mainly here to authorize entries of SGML Chunk files to the baseline.
