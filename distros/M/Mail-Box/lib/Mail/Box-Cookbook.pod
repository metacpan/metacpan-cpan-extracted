...
The L<Mail::Box|Mail::Box> package is a suite of classes for accessing and managing
...
L<Mail::Box|Mail::Box> suite you have to read L<Mail::Box-Overview|Mail::Box-Overview>.  But you
do not need to know much if you want to use the L<Mail::Box|Mail::Box> suite.
...
although the number of packages included in the L<Mail::Box|Mail::Box> module
