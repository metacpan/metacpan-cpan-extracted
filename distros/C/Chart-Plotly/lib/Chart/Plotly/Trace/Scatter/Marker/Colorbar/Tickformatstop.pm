package Chart::Plotly::Trace::Scatter::Marker::Colorbar::Tickformatstop;
use Moose;
...
Chart::Plotly::Trace::Scatter::Marker::Colorbar::Tickformatstop - This attribute is one of the possible options for the trace scatter.
