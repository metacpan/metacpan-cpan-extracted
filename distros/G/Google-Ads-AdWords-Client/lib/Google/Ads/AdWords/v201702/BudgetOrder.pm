package Google::Ads::AdWords::v201702::BudgetOrder;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'spendingLimit' => 'Google::Ads::AdWords::v201702::Money',
        'totalAdjustments' => 'Google::Ads::AdWords::v201702::Money',
        'startDateTime' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'endDateTime' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'lastRequest' => 'Google::Ads::AdWords::v201702::BudgetOrderRequest',
    },
    {
...
BudgetOrder from the namespace https://adwords.google.com/api/adwords/billing/v201702.
