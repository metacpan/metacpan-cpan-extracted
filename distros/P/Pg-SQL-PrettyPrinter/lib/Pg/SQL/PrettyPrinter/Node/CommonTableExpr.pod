...
Pg::SQL::PrettyPrinter::Node::CommonTableExpr - Class representing single CTE
...
First line of CTE - it's name, optionally column aliases, MATERIALIZED marker
and opening C<(>.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Pg::SQL::PrettyPrinter::Node::CommonTableExpr
