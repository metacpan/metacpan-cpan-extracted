...
Cfn::Resource::AWS::EC2::SecurityGroupIngress - Cfn resource for AWS::EC2::SecurityGroupIngress

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::EC2::SecurityGroupIngress.
