...
Prty::ClassLoader - Lade Perl-Klassen automatisch
...
Klassen-Modul und wird von I<< Prty::ClassLoader >> automatisch beim ersten
Methodenzugriff geladen.

=head2 Wie funktioniert das?

I<< Prty::ClassLoader >> installiert sich als Basisklasse von I<UNIVERSAL> und
...
Die AUTOLOAD-Methode, die I<< Prty::ClassLoader >> definiert, ist recht einfach
...
Ja, denn die AUTOLOAD-Methode von I<< Prty::ClassLoader >> wird I<vor> dem Laden
...
unshift @UNIVERSAL::ISA,'Prty::ClassLoader';
...
Moduls Prty::ClassLoader. Sie wird nicht direkt, sondern vom
...
sind, werden von I<< Prty::ClassLoader >> nicht behandelt. Diese sollten
