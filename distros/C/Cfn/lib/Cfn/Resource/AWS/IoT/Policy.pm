# AWS::IoT::Policy generated from spec 14.3.0
...
Cfn::Resource::AWS::IoT::Policy - Cfn resource for AWS::IoT::Policy

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::IoT::Policy.
