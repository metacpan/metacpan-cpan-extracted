...
Flail::Exec::Cmd::reset - Flail "reset" command

=head1 VERSION

  Time-stamp: <2006-12-03 11:04:29 attila@stalphonsos.com>

=head1 SYNOPSIS

  use Flail::Exec::Cmd::reset;
  blah;
...
package Flail::Exec::Cmd::reset;
use strict;
use Carp;
use Flail::Utils;
use base qw(Exporter);
use vars qw(@EXPORT @EXPORT_OK %EXPORT_TAGS);
@EXPORT_OK = qw(flail_reset);
@EXPORT = ();
