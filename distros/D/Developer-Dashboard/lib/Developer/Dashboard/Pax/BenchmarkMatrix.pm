...
sub _run_fixture {
    ...
    my $benchmark = Developer::Dashboard::Pax::Benchmark->new(
...
Developer::Dashboard::Pax::BenchmarkMatrix - benchmark matrix runner for repeatable performance comparisons

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::BenchmarkMatrix;

  my $obj = Developer::Dashboard::Pax::BenchmarkMatrix->new(...);
  my $result = $obj->run(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::BenchmarkMatrix -e 1
