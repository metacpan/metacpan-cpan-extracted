...
subtest 'test the default function' => sub {
  is_deeply [Data::Object::Syntax::default(undef)], [default => undef,];
  is_deeply [Data::Object::Syntax::default('foobarbaz')],
    [default => 'foobarbaz',];
};

subtest 'test the defaulter function' => sub {
  is_deeply [Data::Object::Syntax::defaulter], [defaulter => 1,];
};
...
subtest 'test the is function' => sub {
  is_deeply [Data::Object::Syntax::is(1 .. 9)], [1 .. 9,];
};

subtest 'test the isa function' => sub {
  my $code = sub {1};
  is_deeply [Data::Object::Syntax::isa($code)], [isa => $code,];
};

subtest 'test the lazy function' => sub {
  is_deeply [Data::Object::Syntax::lazy()], [lazy => 1,];
};

subtest 'test the opt function' => sub {
  is_deeply [Data::Object::Syntax::opt('attr')], ['+attr', required => 0,];
  my $code = sub {1};
...
subtest 'test the required function' => sub {
  is_deeply [Data::Object::Syntax::required()], [required => 1,];
};

subtest 'test the ro function' => sub {
  is_deeply [Data::Object::Syntax::ro()], [is => 'ro',];
};

subtest 'test the rw function' => sub {
  is_deeply [Data::Object::Syntax::rw()], [is => 'rw',];
};

subtest 'test the trigger function' => sub {
  is_deeply [Data::Object::Syntax::trigger()], [trigger => 1,];
  is_deeply [Data::Object::Syntax::trigger('_trigger_attr')],
    [trigger => '_trigger_attr',];
};

subtest 'test the weak_ref function' => sub {
  is_deeply [Data::Object::Syntax::weak_ref()], [weak_ref => 1,];
};

subtest 'test the writer function' => sub {
  is_deeply [Data::Object::Syntax::writer()], [writer => 1,];
