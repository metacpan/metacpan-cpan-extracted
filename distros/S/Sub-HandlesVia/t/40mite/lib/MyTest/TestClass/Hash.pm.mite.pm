...
# Mite keywords
BEGIN {
    my ( $SHIM, $CALLER ) = ( "MyTest::Mite", "MyTest::TestClass::Hash" );
...
sub new {
    ...
    # has declaration, file lib/MyTest/TestClass/Hash.pm, line 42
...
sub _set_attr { @_ == 2 or MyTest::Mite::croak( 'Writer "_set_attr" usage: $self->_set_attr( $newvalue )' ); (ref($_[1]) eq 'HASH') or MyTest::Mite::croak( "Type check failed in %s: value should be %s", "writer", "HashRef" ); $_[0]{"attr"} = $_[1]; $_[0]; }
