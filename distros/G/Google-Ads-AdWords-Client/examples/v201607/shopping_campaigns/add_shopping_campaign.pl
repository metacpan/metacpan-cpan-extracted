...
use Google::Ads::AdWords::v201607::ProductAd;
use Google::Ads::AdWords::v201607::ShoppingSetting;
...
sub add_shopping_campaign {
  ...
  my $campaign = Google::Ads::AdWords::v201607::Campaign->new({
      ...
      # Set budget (required)
      budget =>
        Google::Ads::AdWords::v201607::Budget->new({budgetId => $budget_id}),
      ...
      settings => [
        ...
        Google::Ads::AdWords::v201607::ShoppingSetting->new({
            salesCountry     => "US",
            campaignPriority => 0,
  ...
  # Create operation
  my $operation = Google::Ads::AdWords::v201607::CampaignOperation->new({
      operand  => $campaign,
      operator => "ADD"
  });
  ...
  # Create operation
  $operation = Google::Ads::AdWords::v201607::AdGroupOperation->new({
      operand  => $ad_group,
      operator => "ADD"
  });
  ...
  # Create product ad
  my $product_ad = Google::Ads::AdWords::v201607::ProductAd->new();
  ...
  # Create operation
  $operation = Google::Ads::AdWords::v201607::AdGroupAdOperation->new({
      operand  => $ad_group_ad,
      operator => "ADD"
  });
