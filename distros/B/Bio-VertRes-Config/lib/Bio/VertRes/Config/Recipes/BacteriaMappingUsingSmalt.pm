package Bio::VertRes::Config::Recipes::BacteriaMappingUsingSmalt;
...
override '_pipeline_configs' => sub {
    ...
    $self->add_bacteria_smalt_mapping_config(\@pipeline_configs);
...
Bio::VertRes::Config::Recipes::BacteriaMappingUsingSmalt - Standard snp calling pipeline for bacteria
