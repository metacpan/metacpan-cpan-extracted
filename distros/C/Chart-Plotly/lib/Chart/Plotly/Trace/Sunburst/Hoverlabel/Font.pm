package Chart::Plotly::Trace::Sunburst::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Sunburst::Hoverlabel::Font - This attribute is one of the possible options for the trace sunburst.
