use strict;
use warnings;
package App::FilterUtils::NFD;
# ABSTRACT: Convert to Unicode Normalization Form Canonical Decomposition
...
sub validate_args {
    ...
    if ($opt->{'help'}) {
        ...
        print $usage;
        print "\n";
        print "For more detailed help see 'perldoc App::FilterUtils::NFD'\n";

        print "\n";
        exit;
    }
    elsif ($opt->{'version'}) {
        print $App::FilterUtils::NFD::VERSION, "\n";
        exit;
    }
