...
*gsl_error = *Math::GSL::Permutationc::gsl_error;
*gsl_stream_printf = *Math::GSL::Permutationc::gsl_stream_printf;
*gsl_strerror = *Math::GSL::Permutationc::gsl_strerror;
*gsl_set_error_handler = *Math::GSL::Permutationc::gsl_set_error_handler;
*gsl_set_error_handler_off = *Math::GSL::Permutationc::gsl_set_error_handler_off;
*gsl_set_stream_handler = *Math::GSL::Permutationc::gsl_set_stream_handler;
*gsl_set_stream = *Math::GSL::Permutationc::gsl_set_stream;
*gsl_permute_complex_long_double = *Math::GSL::Permutationc::gsl_permute_complex_long_double;
*gsl_permute_complex_long_double_inverse = *Math::GSL::Permutationc::gsl_permute_complex_long_double_inverse;
*gsl_permute_complex = *Math::GSL::Permutationc::gsl_permute_complex;
*gsl_permute_complex_inverse = *Math::GSL::Permutationc::gsl_permute_complex_inverse;
*gsl_permute_complex_float = *Math::GSL::Permutationc::gsl_permute_complex_float;
*gsl_permute_complex_float_inverse = *Math::GSL::Permutationc::gsl_permute_complex_float_inverse;
*gsl_permute_long_double = *Math::GSL::Permutationc::gsl_permute_long_double;
*gsl_permute_long_double_inverse = *Math::GSL::Permutationc::gsl_permute_long_double_inverse;
...
*gsl_permute_uint = *Math::GSL::Permutationc::gsl_permute_uint;
*gsl_permute_uint_inverse = *Math::GSL::Permutationc::gsl_permute_uint_inverse;
...
*gsl_permute_vector_uint = *Math::GSL::Permutationc::gsl_permute_vector_uint;
*gsl_permute_vector_uint_inverse = *Math::GSL::Permutationc::gsl_permute_vector_uint_inverse;
*gsl_permute_vector_long = *Math::GSL::Permutationc::gsl_permute_vector_long;
*gsl_permute_vector_long_inverse = *Math::GSL::Permutationc::gsl_permute_vector_long_inverse;
*gsl_permute_vector_long_double = *Math::GSL::Permutationc::gsl_permute_vector_long_double;
*gsl_permute_vector_long_double_inverse = *Math::GSL::Permutationc::gsl_permute_vector_long_double_inverse;
*gsl_permute_vector_ulong = *Math::GSL::Permutationc::gsl_permute_vector_ulong;
*gsl_permute_vector_ulong_inverse = *Math::GSL::Permutationc::gsl_permute_vector_ulong_inverse;
*gsl_permute_vector_short = *Math::GSL::Permutationc::gsl_permute_vector_short;
*gsl_permute_vector_short_inverse = *Math::GSL::Permutationc::gsl_permute_vector_short_inverse;
*gsl_permute_vector_ushort = *Math::GSL::Permutationc::gsl_permute_vector_ushort;
*gsl_permute_vector_ushort_inverse = *Math::GSL::Permutationc::gsl_permute_vector_ushort_inverse;
...
*GSL_VERSION = *Math::GSL::Permutationc::GSL_VERSION;
...
*GSL_SUCCESS = *Math::GSL::Permutationc::GSL_SUCCESS;
*GSL_FAILURE = *Math::GSL::Permutationc::GSL_FAILURE;
*GSL_CONTINUE = *Math::GSL::Permutationc::GSL_CONTINUE;
*GSL_EDOM = *Math::GSL::Permutationc::GSL_EDOM;
*GSL_ERANGE = *Math::GSL::Permutationc::GSL_ERANGE;
*GSL_EFAULT = *Math::GSL::Permutationc::GSL_EFAULT;
*GSL_EINVAL = *Math::GSL::Permutationc::GSL_EINVAL;
*GSL_EFAILED = *Math::GSL::Permutationc::GSL_EFAILED;
*GSL_EFACTOR = *Math::GSL::Permutationc::GSL_EFACTOR;
*GSL_ESANITY = *Math::GSL::Permutationc::GSL_ESANITY;
*GSL_ENOMEM = *Math::GSL::Permutationc::GSL_ENOMEM;
*GSL_EBADFUNC = *Math::GSL::Permutationc::GSL_EBADFUNC;
*GSL_ERUNAWAY = *Math::GSL::Permutationc::GSL_ERUNAWAY;
*GSL_EMAXITER = *Math::GSL::Permutationc::GSL_EMAXITER;
*GSL_EZERODIV = *Math::GSL::Permutationc::GSL_EZERODIV;
*GSL_EBADTOL = *Math::GSL::Permutationc::GSL_EBADTOL;
*GSL_ETOL = *Math::GSL::Permutationc::GSL_ETOL;
*GSL_EUNDRFLW = *Math::GSL::Permutationc::GSL_EUNDRFLW;
*GSL_EOVRFLW = *Math::GSL::Permutationc::GSL_EOVRFLW;
*GSL_ELOSS = *Math::GSL::Permutationc::GSL_ELOSS;
*GSL_EROUND = *Math::GSL::Permutationc::GSL_EROUND;
*GSL_EBADLEN = *Math::GSL::Permutationc::GSL_EBADLEN;
*GSL_ENOTSQR = *Math::GSL::Permutationc::GSL_ENOTSQR;
*GSL_ESING = *Math::GSL::Permutationc::GSL_ESING;
*GSL_EDIVERGE = *Math::GSL::Permutationc::GSL_EDIVERGE;
*GSL_EUNSUP = *Math::GSL::Permutationc::GSL_EUNSUP;
*GSL_EUNIMPL = *Math::GSL::Permutationc::GSL_EUNIMPL;
*GSL_ECACHE = *Math::GSL::Permutationc::GSL_ECACHE;
*GSL_ETABLE = *Math::GSL::Permutationc::GSL_ETABLE;
*GSL_ENOPROG = *Math::GSL::Permutationc::GSL_ENOPROG;
*GSL_ENOPROGJ = *Math::GSL::Permutationc::GSL_ENOPROGJ;
*GSL_ETOLF = *Math::GSL::Permutationc::GSL_ETOLF;
*GSL_ETOLX = *Math::GSL::Permutationc::GSL_ETOLX;
*GSL_ETOLG = *Math::GSL::Permutationc::GSL_ETOLG;
*GSL_EOF = *Math::GSL::Permutationc::GSL_EOF;
