...
(C<IPPROTO_SCTP>) protocol, respectively. I< Optional. Type enum. choice: 'udplite', 'sctp'.  > 
...
C<both>. I< Optional. Type enum. choice: 'default', 'both', 'ipv6-only'.  > 
...
packet sockets. See
L<listen(2)>
for details. Defaults to SOMAXCONN (128). I< Optional. Type uniline.  > 
...
notation. Defaults to 0666. I< Optional. Type uniline.  > 
...
above. Disabled by default. I< Optional. Type uniline.  > 
...
Defaults value is 7200 seconds (2 hours). I< Optional. Type integer.  > 
...
the L<TCP Keepalive
HOWTO|http://www.tldp.org/HOWTO/html_single/TCP-Keepalive-HOWTO/> for details.) Defaults value is 75 seconds. I< Optional. Type integer.  > 
...
carry timestamping metadata. Defaults to C<off>. I< Optional. Type enum. choice: 'off', 'us', 'usec', 'µs', 'ns', 'nsec'.  > 
...
Configures a limit on how often this socket unit may be activated within a specific time
...
C<min>, C<h>, … and defaults to 2s (See
...
limit is enforced before the service activation is enqueued. I< Optional. Type uniline.  > 
