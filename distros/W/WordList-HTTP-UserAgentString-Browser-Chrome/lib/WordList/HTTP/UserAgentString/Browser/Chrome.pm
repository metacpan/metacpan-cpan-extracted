package WordList::HTTP::UserAgentString::Browser::Chrome;

our $AUTHORITY = 'cpan:PERLANCAR'; # AUTHORITY
our $DATE = '2020-05-01'; # DATE
our $DIST = 'WordList-HTTP-UserAgentString-Browser-Chrome'; # DIST
...
our %STATS = ("longest_word_len",244,"avg_word_len",114.505300353357,"num_words_contains_unicode",0,"num_words_contains_whitespace",849,"num_words",849,"num_words_contains_nonword_chars",849,"shortest_word_len",77); # STATS

1;
# ABSTRACT: Collection of Chrome browser User-Agent strings
...
WordList::HTTP::UserAgentString::Browser::Chrome - Collection of Chrome browser User-Agent strings

=head1 VERSION

This document describes version 20200501.0.0 of WordList::HTTP::UserAgentString::Browser::Chrome (from Perl distribution WordList-HTTP-UserAgentString-Browser-Chrome), released on 2020-05-01.

=head1 SYNOPSIS

 use WordList::HTTP::UserAgentString::Browser::Chrome;

 my $wl = WordList::HTTP::UserAgentString::Browser::Chrome->new;
...
Taken from https://useragentstring.com/pages/useragentstring.php?name=Chrome
...
=head1 STATISTICS
 ...
 | key                              | value            |
 +----------------------------------+------------------+
 | avg_word_len                     | 114.505300353357 |
 | longest_word_len                 | 244              |
 | num_words                        | 849              |
 | num_words_contains_nonword_chars | 849              |
 | num_words_contains_unicode       | 0                |
 | num_words_contains_whitespace    | 849              |
 | shortest_word_len                | 77               |
 +----------------------------------+------------------+
...
Please visit the project's homepage at L<https://metacpan.org/release/WordList-HTTP-UserAgentString-Browser-Chrome>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-WordList-HTTP-UserAgentString-Browser-Chrome>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=WordList-HTTP-UserAgentString-Browser-Chrome>
