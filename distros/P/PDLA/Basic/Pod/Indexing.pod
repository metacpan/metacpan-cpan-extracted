...
that apply to PDLAs.  From the L<perldl|perldl> (or L<pdl2|PDLA::Perldl2>) shell, you
...
C<perldl> or C<pdl2> shell that comes with PDLA.
]
...
easily achieved with the powerful slice function:
 ...
 pdl> help vars  # or just PDLA->vars
 PDLA variables in package main::
