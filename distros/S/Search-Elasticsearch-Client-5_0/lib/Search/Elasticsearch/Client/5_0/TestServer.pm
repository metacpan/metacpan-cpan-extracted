package Search::Elasticsearch::Client::5_0::TestServer;
$Search::Elasticsearch::Client::5_0::TestServer::VERSION = '6.00';
use strict;
use warnings;
...
Search::Elasticsearch::Client::5_0::TestServer - Client-specific backend for Search::Elasticsearch::TestServer
