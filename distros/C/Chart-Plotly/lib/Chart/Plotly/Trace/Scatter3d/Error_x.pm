package Chart::Plotly::Trace::Scatter3d::Error_x;
use Moose;
...
Chart::Plotly::Trace::Scatter3d::Error_x - This attribute is one of the possible options for the trace scatter3d.
