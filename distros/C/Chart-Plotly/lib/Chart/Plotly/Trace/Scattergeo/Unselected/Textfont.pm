package Chart::Plotly::Trace::Scattergeo::Unselected::Textfont;
use Moose;
...
Chart::Plotly::Trace::Scattergeo::Unselected::Textfont - This attribute is one of the possible options for the trace scattergeo.
