...
# This file was generated from the 'java.xml' file of the syntax highlight
# engine of the kate text editor (http://www.kate-editor.org

#kate xml version 1.15
#kate version 2.4
#kate author Alfredo Luiz Foltran Fialho (alfoltran@ig.com.br)
#generated: Sun Feb  3 22:02:05 2008, localtime

package Syntax::Highlight::Engine::Kate::Java;
...
sub new {
   ...
   $self->contextdata({
      ...
      'Printf' => {
         callback => \&parsePrintf,
         attribute => 'Printf',
         lineending => '#pop',
      },
      'PrintfString' => {
         callback => \&parsePrintfString,
         attribute => 'PrintfString',
         lineending => '#pop',
      },
      'StaticImports' => {
         callback => \&parseStaticImports,
         attribute => 'Normal Text',
         lineending => '#pop',
      },
      'String' => {
...
sub parseImports {
   ...
   # context => '#pop'
   # type => 'RegExpr'
   if ($self->testRegExpr($text, '\\s*.*$', 0, 0, 0, undef, 0, '#pop', 'Imports')) {
      return 1
   }
   return 0;
};
...
sub parseNormal {
   ...
   # context => '##Javadoc'
   # type => 'IncludeRules'
   if ($self->includePlugin('Javadoc', $text)) {
      return 1
   }
   # String => 'keywords'
   # attribute => 'Keyword'
   ...
   # context => '#stay'
   # type => 'keyword'
   if ($self->testKeyword($text, 'java15', 0, undef, 0, '#stay', 'Java15')) {
      return 1
   }
   # attribute => 'Float'
   # context => '#stay'
   # items => 'ARRAY(0x1739d60)'
   # type => 'Float'
   ...
   # context => '#stay'
   # type => 'RegExpr'
   if ($self->testRegExpr($text, '//\\s*BEGIN.*$', 0, 0, 0, undef, 0, '#stay', 'Decimal')) {
      return 1
   }
   # String => '//\s*END.*$'
   # attribute => 'Decimal'
   ...
   # endRegion => 'Region1'
   # type => 'RegExpr'
   if ($self->testRegExpr($text, '//\\s*END.*$', 0, 0, 0, undef, 0, '#stay', 'Decimal')) {
      return 1
   }
   # attribute => 'String'
   # char => '"'
   ...
   # String => '\.(format|printf)\b'
   # attribute => 'Function'
   # context => 'Printf'
   # type => 'RegExpr'
   if ($self->testRegExpr($text, '\\.(format|printf)\\b', 0, 0, 0, undef, 0, 'Printf', 'Function')) {
      return 1
   }
   # attribute => 'Comment'
   # char => '/'
   ...
   # context => '#stay'
   # type => 'RegExpr'
   if ($self->testRegExpr($text, '\\.{3,3}\\s+', 0, 0, 0, undef, 0, '#stay', 'Keyword')) {
      return 1
   }
   # String => '\b(import\s+static)\b'
   # attribute => 'Keyword'
   # context => 'StaticImports'
   # type => 'RegExpr'
   if ($self->testRegExpr($text, '\\b(import\\s+static)\\b', 0, 0, 0, undef, 0, 'StaticImports', 'Keyword')) {
      return 1
   }
   # String => '\b(package|import)\b'
   # attribute => 'Keyword'
   # context => 'Imports'
   # type => 'RegExpr'
   if ($self->testRegExpr($text, '\\b(package|import)\\b', 0, 0, 0, undef, 0, 'Imports', 'Keyword')) {
      return 1
   }
   # String => '\b[_\w][_\w\d]*(?=[\s]*(/\*\s*\d+\s*\*/\s*)?[(])'
   # attribute => 'Function'
   # context => '#stay'
   # type => 'RegExpr'
   if ($self->testRegExpr($text, '\\b[_\\w][_\\w\\d]*(?=[\\s]*(/\\*\\s*\\d+\\s*\\*/\\s*)?[(])', 0, 0, 0, undef, 0, '#stay', 'Function')) {
      return 1
   }
   # String => '[.]{1,1}'
   # attribute => 'Symbol'
...
sub parsePrintf {
   ...
   # attribute => 'String'
   # char => '"'
   # context => 'PrintfString'
   # type => 'DetectChar'
   if ($self->testDetectChar($text, '"', 0, 0, 0, undef, 0, 'PrintfString', 'String')) {
      return 1
   }
   return 0;
};

sub parsePrintfString {
   my ($self, $text) = @_;
   # attribute => 'String'
   # context => '#stay'
   # type => 'LineContinue'
   ...
   # String => '%(\d+\$)?(-|#|\+|\ |0|,|\()*\d*(\.\d+)?[a-hosxA-CEGHSX]'
   # attribute => 'String Char'
   # context => '#stay'
   # type => 'RegExpr'
   if ($self->testRegExpr($text, '%(\\d+\\$)?(-|#|\\+|\\ |0|,|\\()*\\d*(\\.\\d+)?[a-hosxA-CEGHSX]', 0, 0, 0, undef, 0, '#stay', 'String Char')) {
      return 1
   }
   # String => '%(\d+\$)?(-|#|\+|\ |0|,|\()*\d*(t|T)(a|A|b|B|c|C|d|D|e|F|h|H|I|j|k|l|L|m|M|N|p|P|Q|r|R|s|S|T|y|Y|z|Z)'
   # attribute => 'String Char'
   # context => '#stay'
   # type => 'RegExpr'
   if ($self->testRegExpr($text, '%(\\d+\\$)?(-|#|\\+|\\ |0|,|\\()*\\d*(t|T)(a|A|b|B|c|C|d|D|e|F|h|H|I|j|k|l|L|m|M|N|p|P|Q|r|R|s|S|T|y|Y|z|Z)', 0, 0, 0, undef, 0, '#stay', 'String Char')) {
      return 1
   }
   # String => '%(%|n)'
   # attribute => 'String Char'
   # context => '#stay'
   # type => 'RegExpr'
   if ($self->testRegExpr($text, '%(%|n)', 0, 0, 0, undef, 0, '#stay', 'String Char')) {
      return 1
   }
   return 0;
};

sub parseStaticImports {
   my ($self, $text) = @_;
   # String => '\s*.*$'
   # attribute => 'StaticImports'
   # context => '#pop'
   # type => 'RegExpr'
   if ($self->testRegExpr($text, '\\s*.*$', 0, 0, 0, undef, 0, '#pop', 'StaticImports')) {
      return 1
   }
   return 0;
};
...
Syntax::Highlight::Engine::Kate::Java - a Plugin for Java syntax highlighting
...
Syntax::Highlight::Engine::Kate::Java is a  plugin module that provides syntax highlighting
for Java to the Syntax::Haghlight::Engine::Kate highlighting engine.
