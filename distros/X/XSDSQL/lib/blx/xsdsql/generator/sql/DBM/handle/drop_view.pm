package blx::xsdsql::generator::sql::DBM::handle::drop_view;
...
use blx::xsdsql::generator::sql::DBM::handle::drop_view
...
See  blx::xsdsql::generator::sql::generic::handle::drop_view  - this class inherit from this
