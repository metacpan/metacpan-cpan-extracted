...
package Sah::SchemaR::perl::qualified_funcname;
...
Sah::SchemaR::perl::qualified_funcname - Perl function name qualified with a package name, e.g. Foo::subname

=head1 VERSION

This document describes version 0.050 of Sah::SchemaR::perl::qualified_funcname (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
