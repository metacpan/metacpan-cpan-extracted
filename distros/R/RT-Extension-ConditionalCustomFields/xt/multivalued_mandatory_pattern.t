...
$ticket_cf_condition_schrodingerized = $mjs->xpath('//select[@name="Object-RT::Ticket-' . $ticket->id . '-CustomField:Groupone-' . $cf_condition->id . '-Values"]/option[@value="' . $cf_values->[2]->Name . '"]', single => 1);
$mjs->click($ticket_cf_condition_schrodingerized);
$mjs->eval_in_page("jQuery('#Object-RT\\\\:\\\\:Ticket-" . $ticket->id . "-CustomField\\\\:Groupone-" . $cf_condition->id . "-Values').trigger('change');");
$mjs->click('SubmitTicket');
