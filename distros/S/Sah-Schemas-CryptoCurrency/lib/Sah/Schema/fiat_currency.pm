...
1;
# ABSTRACT: Alias for currency::code
...
Sah::Schema::fiat_currency - Alias for currency::code

=head1 VERSION

This document describes version 0.015 of Sah::Schema::fiat_currency (from Perl distribution Sah-Schemas-CryptoCurrency), released on 2020-03-08.
...
Using with L<Data::Sah>:
 ...
 my $vdr = gen_validator("fiat_currency*");
