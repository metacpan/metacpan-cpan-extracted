...
#
# Copyright (c) 2016, 2017, 2018, 2019, 2023 INABA Hitoshi <ina@cpan.org> in a CPAN
######################################################################
...
L<Encode|http://search.cpan.org/dist/Encode/> - CPAN

=item *

L<Encode561.pm - Encode::from_to compatible for Perl 5.6.x and 5.005|http://www.kawa.net/works/perl/i18n-emoji/Encode561.pm.html> - www.kawa.net

=item *

L<Encode::compat|http://search.cpan.org/dist/Encode-compat/> - CPAN

=item *

L<Porting code from perl-5.6.X|http://perldoc.perl.org/perlunicode.html#Porting-code-from-perl-5.6.X> - perldoc

=item *

L<Perl 5.6+: Unicode-processing issues and how to cope with it.|http://ahinea.com/en/tech/perl-5.6-unicode-struggle.html> - ahinea.com

=item *

L<Correct processing method of the UTF-8 flag|http://blog.livedoor.jp/dankogai/archives/50116398.html> - blog.livedoor.jp/dankogai/

=item *

L<perl - utf8::is_utf8("\x{ff}") == 0|http://blog.livedoor.jp/dankogai/archives/51004472.html> - blog.livedoor.jp/dankogai/

=item *

L<To the person who fights against UTF-8 flag|http://blog.livedoor.jp/nipotan/archives/50228106.html> - blog.livedoor.jp/nipotan/

=item *

L<utf8::is_utf8 considered harmful|https://subtech.g.hatena.ne.jp/miyagawa/20080218/1203312527> - subtech.g.hatena.ne.jp/miyagawa/
