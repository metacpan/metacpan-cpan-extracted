package Perinci::Package::CopyContents::Test;
...
Perinci::Package::CopyContents::Test - A dummy module for testing

=head1 VERSION

This document describes version 0.002 of Perinci::Package::CopyContents::Test (from Perl distribution Perinci-Package-CopyContents), released on 2020-02-16.
