...
BEGIN {
    ...
    package
        main::HBase;
    use Test2::Harness::HashBase qw/foo bar baz/;
...
BEGIN {
    package
        main::HBaseSub;
    use base 'main::HBase';
    use Test2::Harness::HashBase qw/apple pear/;
...
BEGIN {
    package
        main::Const::Test;
    use Test2::Harness::HashBase qw/foo/;
...
BEGIN {
    ...
    package
        main::HBase::Wrapped;
    use Test2::Harness::HashBase qw/foo bar dup/;
...
BEGIN {
    ...
    use Test2::Harness::HashBase qw/baz dup/;
}
...
is_deeply(
    [Test2::Harness::HashBase::attr_list('main::HBase::Wrapped::Inherit')],
    [qw/foo bar dup baz/],
