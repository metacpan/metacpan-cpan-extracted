...
package PDF::API3::Compat::API2::Resource::ColorSpace::DeviceN;

BEGIN {

    use strict;
    use vars qw(@ISA $VERSION);
    use PDF::API3::Compat::API2::Resource::ColorSpace;
    use PDF::API3::Compat::API2::Basic::PDF::Utils;
    use PDF::API3::Compat::API2::Util;
    use Math::Trig;

    @ISA = qw( PDF::API3::Compat::API2::Resource::ColorSpace );
    ( $VERSION ) = sprintf '%i.%03i', split(/\./,('$Revision: 2.0 $' =~ /Revision: (\S+)\s/)[0]); # $Date: 2005/11/16 02:18:14 $

}
no warnings qw[ deprecated recursion uninitialized ];

=item $cs = PDF::API3::Compat::API2::Resource::ColorSpace::DeviceN->new $pdf, $key, %parameters
...
=item $cs = PDF::API3::Compat::API2::Resource::ColorSpace::DeviceN->new_api $api
