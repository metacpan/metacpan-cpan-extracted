...
defaults to L<PDF::API3::Compat::API2::Basic::TTF::Glyph>.
...
Reads the location table creating glyph objects (L<PDF::API3::Compat::API2::Basic::TTF::Glyph>) for each glyph
