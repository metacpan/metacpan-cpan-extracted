...
my %tests = (
    '9780571224814' => [
        ...
        [ 'is',     'publisher',    'Farrar, Straus and Giroux' ],
        ...
        [ 'is',     'depth',        20                          ],
        [ 'is',     'weight',       undef                       ],
        [ 'like',   'image_link',   qr|9780571224814_p0_v2_s550x406\.jpg| ],
        [ 'like',   'thumb_link',   qr|9780571224814_p0_v2_s550x406\.jpg| ],
    ...
    '9781452138459' => [
        ...
        [ 'is',     'depth',        27                          ],
        [ 'is',     'weight',       undef                       ],
        [ 'like',   'image_link',   qr|9781452138459_p0_v2_s550x406\.jpg| ],
        [ 'like',   'thumb_link',   qr|9781452138459_p0_v2_s550x406\.jpg| ],
        [ 'like',   'description',  qr|Joy Division|            ],
