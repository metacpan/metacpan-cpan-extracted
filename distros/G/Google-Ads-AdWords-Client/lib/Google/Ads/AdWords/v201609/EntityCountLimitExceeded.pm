package Google::Ads::AdWords::v201609::EntityCountLimitExceeded;
use strict;
use warnings;
...
EntityCountLimitExceeded from the namespace https://adwords.google.com/api/adwords/cm/v201609.
