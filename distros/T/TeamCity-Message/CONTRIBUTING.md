...
https://metacpan.org/release/TeamCity-Message

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends TeamCity::Message
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends TeamCity::Message
...
The code for this distribution is [hosted at GitHub](https://github.com/maxmind/TeamCity-Message).
...
can submit an issue report [via the web](https://github.com/maxmind/TeamCity-Message/issues)
).
