...
App::grepdate - Grep date in text

=head1 VERSION

This document describes version 0.001 of App::grepdate (from Perl distribution App-grepdate), released on 2017-04-25.

=head1 SYNOPSIS

See the included script L<grepdate>.
