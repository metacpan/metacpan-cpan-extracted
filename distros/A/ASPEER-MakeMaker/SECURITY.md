...
This is the security policy for the Perl ASPEER::MakeMaker distribution.
...
https://github.com/aspeer/pm-ASPEER-MakeMaker/security/advisories/new
...
- the affected ASPEER::MakeMaker version
...
Security fixes are normally made against the latest ASPEER::MakeMaker release on CPAN.
...
newer ASPEER::MakeMaker release on CPAN or in the main GitHub repository before relying
...
appropriate. ASPEER::MakeMaker is maintained by a volunteer maintainer, so exact response
...
This policy applies to vulnerabilities in the ASPEER::MakeMaker distribution itself.
