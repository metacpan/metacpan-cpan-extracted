...
There are three classes of parameters used by iterators and adapters:
...
I<Signal> parameters define how the iterator signals exhaustion or error.

=back

Signal and Interface parameters are also called I<General Parameters>.
...
=head3 Signal Exhaustion

=over

=item C<input_exhaustion>

This applies only to iterator adapters, and indicates how the consumed iterator signals exhaustion.
...
Only for adapters; the consumed iterator will throw on exhaustion; let that exception propagate.
...
This applies to both iterators and  adapters, and indicates how they signal exhaustion.
It takes the same values as L</input_exhaustion>
