package Bio::VertRes::Config::Recipes::BacteriaMappingUsingBwa;
...
override '_pipeline_configs' => sub {
    ...
    $self->add_bacteria_bwa_mapping_config(\@pipeline_configs);
...
Bio::VertRes::Config::Recipes::BacteriaMappingUsingBwa - Standard snp calling pipeline for bacteria
...
Standard snp calling pipeline for bacteria.
   ...
   my $obj = Bio::VertRes::Config::Recipes::BacteriaMappingUsingBwa->new( 
     database => 'abc', 
