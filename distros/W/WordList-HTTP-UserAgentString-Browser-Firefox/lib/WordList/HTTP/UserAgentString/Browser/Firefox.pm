...
our $DIST = 'WordList-HTTP-UserAgentString-Browser-Firefox'; # DIST
our $VERSION = '20200501.0.1'; # VERSION
...
our %STATS = ("num_words_contains_unicode",0,"shortest_word_len",42,"num_words",2040,"longest_word_len",176,"num_words_contains_nonword_chars",2040,"num_words_contains_whitespace",2040,"avg_word_len",92.5892156862745); # STATS
...
WordList::HTTP::UserAgentString::Browser::Firefox - Collection of Firefox browser User-Agent strings

=head1 VERSION

This document describes version 20200501.0.1 of WordList::HTTP::UserAgentString::Browser::Firefox (from Perl distribution WordList-HTTP-UserAgentString-Browser-Firefox), released on 2020-05-01.

=head1 SYNOPSIS

 use WordList::HTTP::UserAgentString::Browser::Firefox;
...
Taken from https://useragentstring.com/pages/useragentstring.php?name=Firefox
...
=head1 STATISTICS
 ...
 | key                              | value            |
 +----------------------------------+------------------+
 | avg_word_len                     | 92.5892156862745 |
 | longest_word_len                 | 176              |
 | num_words                        | 2040             |
 | num_words_contains_nonword_chars | 2040             |
 | num_words_contains_unicode       | 0                |
 | num_words_contains_whitespace    | 2040             |
 | shortest_word_len                | 42               |
 +----------------------------------+------------------+
...
Please visit the project's homepage at L<https://metacpan.org/release/WordList-HTTP-UserAgentString-Browser-Firefox>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-WordList-HTTP-UserAgentString-Browser-Firefox>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=WordList-HTTP-UserAgentString-Browser-Firefox>
