...
EOF
    ...
    # Doc error code list
    my %details;
    if ( open F, 'lemonldap-ng-portal/site/htdocs/static/languages/en.json' ) {
        local $/ = undef, my $tmp = JSON::from_json(<F>);
        close F;
        %details = map { s/^\s+//; $_ } %$tmp;
    }
    $content = <<EOF;
..
   This file is generated by $module. Don't modify it by hand
...
.. csv-table::
   :header: "Error label", "Error number", "Detail"
   :delim: ,
   :widths: auto
