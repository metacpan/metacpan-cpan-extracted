package Chart::Plotly::Trace::Heatmapgl::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Heatmapgl::Legendgrouptitle::Font - This attribute is one of the possible options for the trace heatmapgl.
