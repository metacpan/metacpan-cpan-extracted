...
our $DIST = 'TableData-Perl-CPAN-Release-Static-2023'; # DIST
our $VERSION = '20231208.0'; # VERSION

with 'TableDataRole::Perl::CPAN::Release::Static::2023';

our %STATS = ("num_columns",9,"num_rows",9637); # STATS
...
TableDataRole::Perl::CPAN::Release::Static::2023 - CPAN releases for the year 2023

=head1 VERSION

This document describes version 20231208.0 of TableDataRole::Perl::CPAN::Release::Static::2023 (from Perl distribution TableData-Perl-CPAN-Release-Static-2023), released on 2023-12-08.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Perl::CPAN::Release::Static::2023;

 my $td = TableData::Perl::CPAN::Release::Static::2023->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Perl::CPAN::Release::Static::2023 --page

 # Get number of rows
 % tabledata --action count_rows Perl::CPAN::Release::Static::2023
...
Please visit the project's homepage at L<https://metacpan.org/release/TableData-Perl-CPAN-Release-Static-2023>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-TableData-Perl-CPAN-Release-Static-2023>.
...
Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=TableData-Perl-CPAN-Release-Static-2023>
