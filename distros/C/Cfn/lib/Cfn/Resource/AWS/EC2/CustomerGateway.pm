...
Cfn::Resource::AWS::EC2::CustomerGateway - Cfn resource for AWS::EC2::CustomerGateway

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::EC2::CustomerGateway.
