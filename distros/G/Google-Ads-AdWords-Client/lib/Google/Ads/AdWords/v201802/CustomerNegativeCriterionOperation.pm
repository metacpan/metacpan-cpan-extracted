package Google::Ads::AdWords::v201802::CustomerNegativeCriterionOperation;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'operand' => 'Google::Ads::AdWords::v201802::CustomerNegativeCriterion',
    },
    {
...
Google::Ads::AdWords::v201802::CustomerNegativeCriterionOperation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CustomerNegativeCriterionOperation from the namespace https://adwords.google.com/api/adwords/cm/v201802.
