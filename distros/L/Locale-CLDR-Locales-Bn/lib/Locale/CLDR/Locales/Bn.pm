	...
	default		=> sub {
		{
			'calendar' => {
 			...
 			'hc' => {
 				'h11' => q{12 ঘণ্টার হিসাবে (0–11)},
 				'h12' => q{12 ঘণ্টার হিসাবে (1–12)},
 				'h23' => q{24 ঘণ্টার হিসাবে (0–23)},
 				'h24' => q{24 ঘণ্টার হিসাবে (1–24)},
 			},
 			'lb' => {
 				'loose' => q{loose},
 				'normal' => q{normal},
	...
	default		=> sub { {
				'long' => {
					...
					'liter-per-100kilometers' => {
						'name' => q(লিটার, প্রতি 100 কিলোমিটারে),
						'one' => q({0} লিটার, প্রতি 100 কিলোমিটারে),
						'other' => q({0} L/100km),
					},
					'liter-per-kilometer' => {
					...
					'mile-per-gallon' => {
						'name' => q(মাইল প্রতি গ্যালন),
						'one' => q({0} মাইল প্রতি গ্যালন),
						'other' => q({0} mpg),
					},
					'mile-per-hour' => {
					...
					'square-centimeter' => {
						...
						'one' => q({0} cm²),
						'other' => q({0} cm²),
						'per' => q(প্রতি বর্গ সেন্টিমিটারে {0}),
					},
					'square-foot' => {
						'name' => q(বর্গ ফুট),
						'one' => q({0} বর্গ ফুট),
	...
	default		=> sub { {
		...
		'ALL' => {
			...
			display_name => {
				...
				'one' => q(আলবেনিয়ান লিক),
				'other' => q(আলবেনিয়ান লিক),
			},
		},
		'AMD' => {
			symbol => 'AMD',
	...
	default	=> sub { {
		...
		'America_Pacific' => {
			long => {
				...
				'standard' => q(প্রশান্ত মহাসাগরীয় অঞ্চলের প্রমাণ সময়),
			},
		},
		'Anadyr' => {
			long => {
		...
		'Argentina_Western' => {
			long => {
				'daylight' => q(পশ্চিমি আর্জেনটিনা গৃষ্মকালীন সময়),
		...
		'Europe_Central' => {
			long => {
				'daylight' => q(মধ্য ইউরোপের গ্রীষ্মকালীন সময়),
				'generic' => q(মধ্য ইউরোপের সময়),
				'standard' => q(মধ্য ইউরোপের প্রমাণ সময়),
			},
		},
		'Europe_Eastern' => {
			long => {
				'daylight' => q(পূর্ব ইউরোপের গ্রীষ্মকালীন সময়),
				'generic' => q(পূর্ব ইউরোপের সময়),
				'standard' => q(পূর্ব ইউরোপের প্রমাণ সময়),
			},
		},
		...
		'Europe_Western' => {
			long => {
				'daylight' => q(পশ্চিম ইউরোপের গ্রীষ্মকালীন সময়),
				'generic' => q(পশ্চিম ইউরোপের সময়),
				'standard' => q(পশ্চিম ইউরোপের প্রমাণ সময়),
			},
		},
		'Falkland' => {
			long => {
		...
		'Irkutsk' => {
			long => {
				'daylight' => q(য়াকুটস্ক গ্রীষ্মকালীন সময়),
		...
		'Mexico_Pacific' => {
			long => {
				'daylight' => q(মেক্সিকান প্রশান্ত মহাসাগরীয় দিনের সময়),
