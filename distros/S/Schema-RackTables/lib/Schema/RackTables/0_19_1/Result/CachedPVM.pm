use utf8;
package Schema::RackTables::0_19_1::Result::CachedPVM;
...
Schema::RackTables::0_19_1::Result::CachedPVM
...
Related object: L<Schema::RackTables::0_19_1::Result::CachedPAV>

=cut

__PACKAGE__->has_many(
  "cached_pavs",
  "Schema::RackTables::0_19_1::Result::CachedPAV",
  {
...
Related object: L<Schema::RackTables::0_19_1::Result::PortVLANMode>

=cut

__PACKAGE__->might_have(
  "port_vlanmode",
  "Schema::RackTables::0_19_1::Result::PortVLANMode",
  {
    "foreign.object_id" => "self.object_id",
    "foreign.port_name" => "self.port_name",
  },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:cZu46xnUR0Y9U1G0BWh0Ug
