...
Extends L<"Server connections" in Couch::DB|Couch::DB/"Server connections">.
 
=over 4

=item $obj-E<gt>B<addClient>($client)

Inherited, see L<Couch::DB/"Server connections">

=item $obj-E<gt>B<call>(\%options|($method, $path, %options))
...
Extends L<"Conversions" in Couch::DB|Couch::DB/"Conversions">.
 
=over 4

=item $obj-E<gt>B<check>($condition, $change, $version, $what)

Inherited, see L<Couch::DB/"Conversions">
...
This module is part of Couch-DB distribution version 0.002,
built on May 31, 2024. Website: F<http://perl.overmeer.net/CPAN/>
