#########1 Test File for Spreadsheet::Reader::ExcelXML::XMLReader::PositionStyles  #######9
#!/usr/bin/env perl
...
map{ 
has_attribute_ok
			$test_instance, $_,			"Check that PositionStyles has the -$_- attribute"
} 			@class_attributes;
map{
...
is			$test_instance->get_default_format->{cell_fill}->{patternFill}->{patternType}, 'none',
										"Check that the default format sub-value for fill is: none";
...
}										"Prep a new Styles instance - with caching";
