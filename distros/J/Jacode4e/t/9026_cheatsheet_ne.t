...
#
#   $line             : रूपान्तरण गर्नुपर्ने स्ट्रिङ (सन्दर्भद्वारा पठाइएको, स्थानमै ओभरराइट हुन्छ)
#   $OUTPUT_encoding  : आउटपुट इन्कोडिङको नाम
#   $INPUT_encoding   : इनपुट इन्कोडिङको नाम
#   $char_count       : रूपान्तरणपछिको अक्षर संख्या
#
# [इन्कोडिङ नामहरूको सूची]
#
#   संक्षिप्त नाम   अर्थ
#   ----------     ---------------------------------------------------
#   cp932x         CP932X (JIS X 0213 मा विस्तार, एकल शिफ्ट 0x9C5A)
#   cp932          Microsoft CP932 (Windows-31J / IANA दर्ता नाम)
#   cp932ibm       IBM CP932
#   cp932nec       NEC CP932
...
#   jef            FUJITSU JEF (12pt, OUTPUT_SHIFTING सँग शिफ्ट कोड)
#   jef9p          FUJITSU JEF ( 9pt, OUTPUT_SHIFTING सँग शिफ्ट कोड)
#   jipsj          NEC JIPS(J)
#   jipse          NEC JIPS(E)
#   letsj          UNISYS LetsJ
#   utf8           UTF-8.0 (सामान्य UTF-8)
#   utf8.1         UTF-8.1 (CP932 होइन, Shift_JIS-Unicode अनुवाद तालिकामा आधारित रूपान्तरण)
#   utf8jp         UTF-8-SPUA-JP (JIS X 0213 Unicode SPUA मा म्याप गरिएको)
#
# [विकल्पहरू]
#
#   कुञ्जी           मान / विवरण
#   ---------------  ---------------------------------------------------
#   INPUT_LAYOUT     इनपुट रेकर्ड लेआउट ('S'=SBCS, 'D'=DBCS)
#   OUTPUT_SHIFTING  सत्य भए आउटपुटमा DBCS अनुक्रमको वरिपरि शिफ्ट कोड थप्नुस्
#   SPACE            DBCS/MBCS स्पेस कोड (बाइनरी स्ट्रिङ)
#   GETA             म्याप गर्न नसकिने अक्षरहरूको लागि गेता चिह्न
#   OVERRIDE_MAPPING अक्षरवार ओभरराइड { "\x12\x34"=>"\x56\x78" }
#
...
BEGIN {
    ...
    @test = (
        ...
        ["\x81\x40", 'cp00930', 'cp932', {}, "\x40\x40", 'cp932(8140)->cp00930 शिफ्ट बिना(4040)'],
        ...
        ["\x81\x40\x31", 'keis83', 'cp932', {}, "\xA1\xA1\xF1",
            'cp932(814031)->keis83 शिफ्ट बिना(A1A1F1)'],
        ...
        ["\x81\x60", 'utf8', 'cp932', {'INPUT_LAYOUT'=>'D'}, "\xE3\x80\x9C",
            'cp932(8160 लहर ड्याश)->utf8(E3809C U+301C)'],
