...
1;
# ABSTRACT: List POD mentions by script(s)
...
App::lcpan::Cmd::mentions_by_script - List POD mentions by script(s)

=head1 VERSION

This document describes version 1.034 of App::lcpan::Cmd::mentions_by_script (from Perl distribution App-lcpan), released on 2019-06-19.
