...
connected server.  Returns a L<Couch::DB::Result|Couch::DB::Result> object.
...
=item $obj-E<gt>B<databaseInfo>(%options)
...
Use the filter options described by L<databaseNames()|Couch::DB::Client/"Server information">.

=back

=item $obj-E<gt>B<databaseNames>(%options)
...
=item $obj-E<gt>B<replicate>(%options)
