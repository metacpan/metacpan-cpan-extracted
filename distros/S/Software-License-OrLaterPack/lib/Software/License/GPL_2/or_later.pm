#   - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#
#   file: lib/Software/License/GPL_2/or_later.pm
#
...
#pod =for :this This is C<Software::License::GPL_2::or_later> module documentation. Read this if you
...
#pod =head1 SYNOPSIS
#pod
#pod     my $lic = Software::License::GPL_2::or_later->new( {
#pod         holder  => 'John Doe',
#pod         year    => '2010',
#pod         program => 'Assa'
#pod     } );
...
#pod     $lic->_abbr;    # 'GPL'
#pod     $lic->abbr;     # 'GPLv2+'
#pod     $lic->_name;    # 'GNU General Public License'
#pod     $lic->name;     # 'The GNU General Public License version 2 or later'
#pod
#pod     $lic->notice;
...
#pod
#pod     # …and other methods inherited from Software::License::GPL_2
#pod     # and Software::License.
#pod
#pod =head1 DESCRIPTION
#pod
#pod C<Software::License::GPL_2::or_later> is a subclass of C<Software::License::GPL_2>.
...
package Software::License::GPL_2::or_later;

use strict;
use warnings;
use version 0.77;

# ABSTRACT: GPLv2+ license for Software::License infrastructure
our $VERSION = 'v0.10.2'; # VERSION

use parent 'Software::License::GPL_2';
use Text::Wrap;

#pod =attr _abbr
#pod
#pod Bare abbreviated license name, "GPL".
#pod
...
sub base {
    ...
    if ( not $self->{ base } ) {
        ...
        $self->{ base } = Software::License::GPL_2->new( \%base );
    };
    return $self->{ base };
};
...
This is C<Software::License::GPL_2::or_later> module documentation. Read this if you
...
C<Software::License::GPL_2::or_later> is a subclass of C<Software::License::GPL_2>.
