...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Module-Extract-Namespaces> or 
L<MetaCPAN|http://www.metacpan.org/module/Module::Extract::Namespaces>:

=over 4

=item *	L<http://search.cpan.org/dist/Module-Extract-Namespaces>

=item *	L<http://www.metacpan.org/module/Module::Extract::Namespaces>
