...
This document describes version 0.116 of Sort::Sub::by_perl_function (from Perl distribution Sort-Sub), released on 2019-12-15.
...
Compare using Perl's <=> instead of cmp.
