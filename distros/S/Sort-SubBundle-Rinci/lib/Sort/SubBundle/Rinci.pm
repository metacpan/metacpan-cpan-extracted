...
1;
# ABSTRACT: Sort::Sub subroutines related to Rinci
...
Sort::SubBundle::Rinci - Sort::Sub subroutines related to Rinci

=head1 VERSION

This document describes version 0.001 of Sort::SubBundle::Rinci (from Perl distribution Sort-SubBundle-Rinci), released on 2024-01-12.
