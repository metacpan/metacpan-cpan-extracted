#!/usr/bin/env perl
# $Id: get_obsolete_term_id_vs_def_in_go.pl 2015-10-29 erick.antezana $
#
...
sub print_help {
	print "\n";
	print "\tdescription: Collects the obsolete terms (term id vs. its definition) from within an OBO ontology.\n";
	print "\tusage      : get_obsolete_term_id_vs_def_in_go.pl [options]\n";
	print "\toptions    :\n";
	print "\t\t-f  	 OBO input file\n";
	print "\texample:\n";
	print "\t\tperl get_obsolete_term_id_vs_def_in_go.pl -f go.obo\n";
	exit;
}
