...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TargetHttpProxy Google::Cloud::Compute::V1::Compute::TargetHttpProxyAggregatedList Google::Cloud::Compute::V1::Compute::TargetHttpProxyList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::TargetHttpProxiesClient->new( credentials => 'dummy' );
