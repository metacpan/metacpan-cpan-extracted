...
package Meta::Baseline::Lang::Bdbx;
...
Meta::Baseline::Lang::Bdbx - language for Berkeley DB files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Bdbx::env();

=head1 DESCRIPTION

This package contains stuff specific to Berkeley DB files in the baseline. 
