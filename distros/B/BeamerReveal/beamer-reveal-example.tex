...
\begin{frame}
  ...
  \iframe[draw,anchor=north,height=0.6,aspectratio=16/9,
          fit=cover]
  at (0.5,0.7) {Media/beamer-reveal-PCB.html}
\end{frame}
...
\begin{frame}
  ...
  at (0.85,0.1) {Media/beamer-reveal-AudioSample.ogg}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \animation[framerate=25,duration=7.5,pdfprogress=0.1,autoplay,loop] at (0.5,0.35) {
