package Google::Ads::AdWords::v201607::AdGroupExperimentBidMultipliers;
use strict;
use warnings;
...
AdGroupExperimentBidMultipliers from the namespace https://adwords.google.com/api/adwords/cm/v201607.
