package Net::RRP::Response::n421;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n421::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n421::VERSION = '0.1';
...
Net::RRP::Response::n421 - the 421 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
