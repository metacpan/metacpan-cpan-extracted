...
IO::K8s::ExternalSecrets::V1::ClusterExternalSecretNamespaceFailure - ClusterExternalSecretNamespaceFailure represents a failed namespace deployment and it's reason.
