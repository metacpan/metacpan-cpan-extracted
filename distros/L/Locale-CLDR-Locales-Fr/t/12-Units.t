...
is($locale->unit(2, 'liter', 'narrow'), '2 l', 'French narrow 2 litres');
...
is($locale->unit(1, 'month', 'narrow'), '1 m.', 'French narrow 1 month');
is($locale->unit(2, 'month', 'narrow'), '2 m.', 'French narrow 2 months');
...
is($locale->unit(1, 'week', 'narrow'), '1 sem.', 'French narrow 1 week');
is($locale->unit(2, 'week', 'narrow'), '2 sem.', 'French narrow 2 weeks');
