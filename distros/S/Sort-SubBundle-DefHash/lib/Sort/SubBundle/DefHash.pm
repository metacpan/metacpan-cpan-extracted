...
package Sort::SubBundle::DefHash;
...
1;
# ABSTRACT: Sort::Sub subroutines related to DefHash
...
Sort::SubBundle::DefHash - Sort::Sub subroutines related to DefHash

=head1 VERSION

This document describes version 0.001 of Sort::SubBundle::DefHash (from Perl distribution Sort-SubBundle-DefHash), released on 2024-01-10.
