...
(This example is included as L<F<synopsis.pl>|https://api.metacpan.org/source/BKB/Unicode-Diacritic-Strip-0.09/examples/synopsis.pl> in the distribution.)


=head1 VERSION

This documents Unicode::Diacritic::Strip version 0.09
corresponding to git commit L<3069a4a261cef77ec40ff6aebfd2243819e64b1f|https://github.com/benkasminbullock/Unicode-Diacritic-Strip/commit/3069a4a261cef77ec40ff6aebfd2243819e64b1f> released on Wed Apr 5 11:18:47 2017 +0900.
...
L</fast_strip>, is a faster alternative, which is basically C<tr> with
a big list of alphabetical characters with and without
diacritics. There is also L</strip_alphabet>, which is the same as
L</strip_diacritics>, but it also returns a list of what characters
were changed.
...
(This example is included as L<F<strip-alphabet.pl>|https://api.metacpan.org/source/BKB/Unicode-Diacritic-Strip-0.09/examples/strip-alphabet.pl> in the distribution.)
...
to zap them into ASCII. It also contains a few other things like the
thorn character and a ligature.
...
(This example is included as L<F<ask.pl>|https://api.metacpan.org/source/BKB/Unicode-Diacritic-Strip-0.09/examples/ask.pl> in the distribution.)
...
The page at L<Strip diacritics from
text|https://www.lemoda.net/tools/strip-diacritics/index.html> offers
an online interface to this module.
