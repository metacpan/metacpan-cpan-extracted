package Google::Cloud::Dataflow::V1beta3::SnapshotsV1beta3Client;
...
1; # End of Google::Cloud::Dataflow::V1beta3::SnapshotsV1beta3Client

__END__

=head1 NAME

Google::Cloud::Dataflow::V1beta3::SnapshotsV1beta3Client - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Dataflow::V1beta3::SnapshotsV1beta3Client->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Dataflow::V1beta3::SnapshotsV1beta3Client->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Dataflow::V1beta3::SnapshotsV1beta3Client> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Dataflow::V1beta3::SnapshotsV1beta3Client->new(
