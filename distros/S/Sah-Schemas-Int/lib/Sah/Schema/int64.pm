...
Sah::Schema::int64 - 64-bit signed integer

=head1 VERSION

This document describes version 0.077 of Sah::Schema::int64 (from Perl distribution Sah-Schemas-Int), released on 2022-10-19.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("int64*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("int64", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("int64", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("int64*");
     $validator->(\@args);
     ...
 }
...
To create a type constraint and type library from a schema:
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('$sch_name*', name=>'Int64')
     );
 }

 use My::Types qw(Int64);
 Int64->assert_valid($data);
...
L<Types::CLike> - Equivalent Type::Tiny constraints: Long, LongLong, BigInt, Int64, Signed64

L<Types::XSD> - Equivalent Type::Tiny constraints: Long
