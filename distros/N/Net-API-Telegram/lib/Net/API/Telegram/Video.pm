...
##----------------------------------------------------------------------------
package Net::API::Telegram::Video;
BEGIN
{
	use strict;
...
Net::API::Telegram::Video - A video file

=head1 SYNOPSIS

	my $msg = Net::API::Telegram::Video->new( %data ) || 
	die( Net::API::Telegram::Video->error, "\n" );

=head1 DESCRIPTION

L<Net::API::Telegram::Video> is a Telegram Message Object as defined here L<https://core.telegram.org/bots/api#video>
