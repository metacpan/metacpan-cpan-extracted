...
It takes an optional argument that can be an alternative string to remove at the end of the sstring or a regular expression, such as one provided with C<qr> in L<perlfunc>
