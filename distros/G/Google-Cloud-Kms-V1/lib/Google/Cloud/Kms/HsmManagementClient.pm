package Google::Cloud::Kms::HsmManagementClient;
...
sub list_single_tenant_hsm_instances {
    ...
    my $request_class = 'Google::Cloud::Kms::V1::HsmManagement::ListSingleTenantHsmInstancesRequest';
    my $request = eval { $request_class->new(\%params) } || eval { $request_class->new(%params) } || ($request_class->can('encode') ? $request_class->encode(\%params) : \%params);

    my $response_class = 'Google::Cloud::Kms::V1::HsmManagement::ListSingleTenantHsmInstancesResponse';
...
1; # End of Google::Cloud::Kms::HsmManagementClient

__END__

=head1 NAME

Google::Cloud::Kms::HsmManagementClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Kms::HsmManagementClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Kms::HsmManagementClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Kms::HsmManagementClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Kms::HsmManagementClient->new(
...
=item * B<list_single_tenant_hsm_instances>

Calls the RPC method C<ListSingleTenantHsmInstances> on the service. Takes a hash of parameters representing the request.
