package Google::Cloud::Networkservices::V1::DepServiceClient;
...
1; # End of Google::Cloud::Networkservices::V1::DepServiceClient

__END__

=head1 NAME

Google::Cloud::Networkservices::V1::DepServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Networkservices::V1::DepServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Networkservices::V1::DepServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Networkservices::V1::DepServiceClient> is an auto-generated client library for Google Cloud Services.
