...
IO::K8s::CertManager::V1::Route53KubernetesAuth - Kubernetes authenticates with Route53 using AssumeRoleWithWebIdentity by passing a bound ServiceAccount token.
