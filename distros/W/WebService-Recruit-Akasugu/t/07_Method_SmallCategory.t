#
# Test case for WebService::Recruit::Akasugu::SmallCategory
#
...
my $service = new WebService::Recruit::Akasugu::SmallCategory();

ok( ref $service, 'new WebService::Recruit::Akasugu::SmallCategory()' );
...
# Test[0]
{
    ...
    my $res = new WebService::Recruit::Akasugu::SmallCategory();
    ...
    ok( eval { $data->small_category->[0]->middle_category }, 'Test[0]: middle_category' );
    ...
    ok( eval { $data->small_category->[0]->middle_category->code }, 'Test[0]: code' );
    can_ok( $data->small_category->[0]->middle_category, 'name' );
    ok( eval { $data->small_category->[0]->middle_category->name }, 'Test[0]: name' );
}
