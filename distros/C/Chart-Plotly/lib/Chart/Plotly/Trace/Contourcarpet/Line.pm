package Chart::Plotly::Trace::Contourcarpet::Line;
use Moose;
...
Chart::Plotly::Trace::Contourcarpet::Line - This attribute is one of the possible options for the trace contourcarpet.
