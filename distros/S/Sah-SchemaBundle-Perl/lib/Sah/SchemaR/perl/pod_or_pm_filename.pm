...
Sah::SchemaR::perl::pod_or_pm_filename - A .pod or .pm filename, e.g. /path/Foo.pm or /path/Bar/Baz.pod

=head1 VERSION

This document describes version 0.050 of Sah::SchemaR::perl::pod_or_pm_filename (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
