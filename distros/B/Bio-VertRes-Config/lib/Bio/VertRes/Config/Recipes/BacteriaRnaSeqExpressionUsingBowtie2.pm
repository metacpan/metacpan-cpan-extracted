package Bio::VertRes::Config::Recipes::BacteriaRnaSeqExpressionUsingBowtie2;
...
Bio::VertRes::Config::Recipes::BacteriaRnaSeqExpressionUsingBowtie2 - Standard snp calling pipeline for bacteria
...
RNA seq expression with Bowtie2
   use Bio::VertRes::Config::Recipes::BacteriaRnaSeqExpressionUsingBowtie2;

   my $obj = Bio::VertRes::Config::Recipes::BacteriaRnaSeqExpressionUsingBowtie2->new( 
     database => 'abc', 
