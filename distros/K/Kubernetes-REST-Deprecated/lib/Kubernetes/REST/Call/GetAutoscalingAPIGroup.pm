...
Kubernetes::REST::Call::GetAutoscalingAPIGroup - REMOVED -- superseded by Kubernetes::REST's unified v1 API, see Kubernetes::REST::Deprecated
...
C<Kubernetes::REST::Call::GetAutoscalingAPIGroup> itself was never functional in the C<1.x> series -- it
...
C<cpanm Kubernetes::REST::Call::GetAutoscalingAPIGroup> -- or a cpanfile / code that still references the
...
Kubernetes::REST::Call::GetAutoscalingAPIGroup - REMOVED, superseded by Kubernetes::REST's unified v1 API
