package Chart::Plotly::Trace::Scattermapbox::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Scattermapbox::Hoverlabel::Font - This attribute is one of the possible options for the trace scattermapbox.
