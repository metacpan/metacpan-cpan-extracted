...
if ("A" =~ /[B-궺]/i) {
    print qq{ok - 1 "A"=~/[B-궺]/i $^X $__FILE__\n};
}
else {
    print qq{not ok - 1 "A"=~/[B-궺]/i $^X $__FILE__\n};
}

if ("B" =~ /[B-궺]/i) {
    print qq{ok - 2 "B"=~/[B-궺]/i $^X $__FILE__\n};
}
else {
    print qq{not ok - 2 "B"=~/[B-궺]/i $^X $__FILE__\n};
}

if ("궹" =~ /[B-궺]/i) {
    print qq{ok - 3 "궹"=~/[B-궺]/i $^X $__FILE__\n};
}
else {
    print qq{not ok - 3 "궹"=~/[B-궺]/i $^X $__FILE__\n};
}

if ("궺" =~ /[B-궺]/i) {
    print qq{ok - 4 "궺"=~/[B-궺]/i $^X $__FILE__\n};
}
else {
    print qq{not ok - 4 "궺"=~/[B-궺]/i $^X $__FILE__\n};
}

if ("궻" !~ /[B-궺]/i) {
    print qq{ok - 5 "궻"!~/[B-궺]/i $^X $__FILE__\n};
}
else {
    print qq{not ok - 5 "궻"!~/[B-궺]/i $^X $__FILE__\n};
}

my $from = 'B';
if ("A" =~ /[$from-궺]/i) {
    print qq{ok - 6 "A"=~/[\$from-궺]/i $^X $__FILE__\n};
}
else {
    print qq{not ok - 6 "A"=~/[\$from-궺]/i $^X $__FILE__\n};
}

if ("B" =~ /[$from-궺]/i) {
    print qq{ok - 7 "B"=~/[\$from-궺]/i $^X $__FILE__\n};
}
else {
    print qq{not ok - 7 "B"=~/[\$from-궺]/i $^X $__FILE__\n};
}
