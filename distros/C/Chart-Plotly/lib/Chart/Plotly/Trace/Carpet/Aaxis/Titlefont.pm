package Chart::Plotly::Trace::Carpet::Aaxis::Titlefont;
use Moose;
...
has description => ( is      => "ro",
                     default => "Sets this axis' title font.", );
...
Chart::Plotly::Trace::Carpet::Aaxis::Titlefont - This attribute is one of the possible options for the trace carpet.
