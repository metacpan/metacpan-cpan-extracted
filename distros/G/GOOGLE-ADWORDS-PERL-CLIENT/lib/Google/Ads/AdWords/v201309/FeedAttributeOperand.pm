package Google::Ads::AdWords::v201309::FeedAttributeOperand;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201309::FunctionArgumentOperand);
# Variety: sequence
...
Google::Ads::AdWords::v201309::FeedAttributeOperand

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedAttributeOperand from the namespace https://adwords.google.com/api/adwords/cm/v201309.
