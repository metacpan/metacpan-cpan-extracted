...
Cfn::Resource::AWS::IAM::ManagedPolicy - Cfn resource for AWS::IAM::ManagedPolicy

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::IAM::ManagedPolicy.
