...
our $schema = [bool => {
    summary => 'A false boolean, e.g. "" in Perl',
    is_true => 0,
}];
...
Sah::Schema::false - A false boolean, e.g. "" in Perl

=head1 VERSION

This document describes version 0.002 of Sah::Schema::false (from Perl distribution Sah-Schemas-Bool), released on 2022-09-25.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("false*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("false", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("false", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("false*");
     $validator->(\@args);
     ...
 }
