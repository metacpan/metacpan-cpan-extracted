package OWL::DirectSemantics::Element::ObjectComplementOf;

BEGIN {
	$OWL::DirectSemantics::Element::ObjectComplementOf::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::ObjectComplementOf::VERSION   = '0.001';
};
...
OWL::DirectSemantics::Element::ObjectComplementOf - represents an OWL ObjectComplementOf

=head1 DESCRIPTION

This class represents the ObjectComplementOf element in OWL Direct Semantics.
