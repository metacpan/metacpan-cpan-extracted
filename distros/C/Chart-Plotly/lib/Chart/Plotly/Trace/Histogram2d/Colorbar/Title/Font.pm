package Chart::Plotly::Trace::Histogram2d::Colorbar::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Histogram2d::Colorbar::Title::Font - This attribute is one of the possible options for the trace histogram2d.
