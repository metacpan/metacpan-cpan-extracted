package Developer::Dashboard::Pax::Mode;
...
Developer::Dashboard::Pax::Mode - mode normalizer for capture and build flows

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::Mode;

  my $result = Developer::Dashboard::Pax::Mode->policy(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::Mode -e 1
