package Net::RRP::Response::n220;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n220::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n220::VERSION = '0.1';
...
Net::RRP::Response::n220 - the 220 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
