...
static asn_TYPE_member_t asn_MBR_GANSS_MsrSetElement_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct GANSS_MsrSetElement, deltaGANSSTOD),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GANSS_MsrSetElement, ganss_MsrElementList),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SeqOfGANSS_MsrElement,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
...
static asn_TYPE_tag2member_t asn_MAP_GANSS_MsrSetElement_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* referenceFrame at 2197 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ganssTODm at 2201 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* deltaGANSSTOD at 2202 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* ganssTODUncertainty at 2203 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* ganss-MsrElementList at 2206 */
};
