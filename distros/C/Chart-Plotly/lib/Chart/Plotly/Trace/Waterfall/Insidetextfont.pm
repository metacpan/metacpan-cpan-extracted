package Chart::Plotly::Trace::Waterfall::Insidetextfont;
use Moose;
...
Chart::Plotly::Trace::Waterfall::Insidetextfont - This attribute is one of the possible options for the trace waterfall.
