...
package Google::Ads::AdWords::v201705::AdGroupExtensionSettingService::RequestHeader;
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::AdGroupExtensionSettingService::RequestHeader->new($data);
