...
$Map::Tube::Exception::DuplicateStationName::VERSION = '3.11';
=head1 NAME
...
has status => (is => 'ro', default => sub { 109 });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Map::Tube::Exception::DuplicateStationName
...
1; # End of Map::Tube::Exception::DuplicateStationName
