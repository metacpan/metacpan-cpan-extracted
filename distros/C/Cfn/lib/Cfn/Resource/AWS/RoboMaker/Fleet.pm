# AWS::RoboMaker::Fleet generated from spec 14.3.0
...
Cfn::Resource::AWS::RoboMaker::Fleet - Cfn resource for AWS::RoboMaker::Fleet

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::RoboMaker::Fleet.
