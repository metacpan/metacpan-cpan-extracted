...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::HealthCheck Google::Cloud::Compute::V1::Compute::HealthCheckList Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::RegionHealthChecksClient->new( credentials => 'dummy' );
