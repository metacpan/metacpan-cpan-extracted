package Google::Ads::AdWords::v201802::FirstPartyUploadMetadata;
use strict;
use warnings;
...
Google::Ads::AdWords::v201802::FirstPartyUploadMetadata

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FirstPartyUploadMetadata from the namespace https://adwords.google.com/api/adwords/rm/v201802.
