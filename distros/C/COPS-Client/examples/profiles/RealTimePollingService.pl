...
if ( $cops_client->connect() )
	...
	$cops_client->envelope_add (
			...
			Service_Type		=> 'Real-Time Polling Service',

			'Envelope_authorize_Request Transmission Policy' => 0,
			'Envelope_authorize_Maximum Sustained Traffic Rate' => 2000000,
			'Envelope_authorize_Maximum Traffic Burst' => 100000,
			...
			'Envelope_authorize_Maximum Concatenated Burst' => 8000,
			'Envelope_authorize_Nominal Polling Interval' => 20000,
			'Envelope_authorize_Tolerated Poll Jitter' => 200,
			...
			'Envelope_reserve_Maximum Sustained Traffic Rate' => 2000000,
			'Envelope_reserve_Maximum Traffic Burst' => 100000,
			'Envelope_reserve_Minimum Reserved Traffic Rate' => 0,
			'Envelope_reserve_Assumed Minimum Reserved Traffic Rate Packet Size' => 64,
			'Envelope_reserve_Maximum Concatenated Burst' => 8000,
			'Envelope_reserve_Nominal Polling Interval' => 20000,
			'Envelope_reserve_Tolerated Poll Jitter' => 200,
			...
			'Envelope_commit_Maximum Sustained Traffic Rate' => 2000000,
			'Envelope_commit_Maximum Traffic Burst' => 100000,
			'Envelope_commit_Minimum Reserved Traffic Rate' => 0,
			'Envelope_commit_Assumed Minimum Reserved Traffic Rate Packet Size' => 64,
			'Envelope_commit_Maximum Concatenated Burst' => 8000,
			'Envelope_commit_Nominal Polling Interval' => 20000,
			'Envelope_commit_Tolerated Poll Jitter' => 200,
