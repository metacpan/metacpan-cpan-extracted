...
$BenchmarkAnything::Storage::Backend::SQL::Query::mysql::VERSION = '0.029';
use strict;
use warnings;
...
BenchmarkAnything::Storage::Backend::SQL::Query::mysql - BenchmarkAnything::Storage::Backend::SQL - querying - MySQL backend
