...
package UMMF::MOF_1_3::Model::EnumerationType;
...
=head2 C<labels> : UMMF::MOF_1_3::Model::String [C<1..*>]
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_3::Model::EnumerationType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_3::Model::EnumerationType|UMMF::MOF_1_3::Model::EnumerationType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_3::Model::EnumerationType')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_3::Model::EnumerationType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_3::Model::EnumerationType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_3::Model::EnumerationType' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_3::Model::EnumerationType|UMMF::MOF_1_3::Model::EnumerationType>.
...
sub __initialize
{
  ...
  $self->UMMF::MOF_1_3::Model::EnumerationType::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_3::Model::EnumerationType::___create(@args);
...
Returns the L<UMMF::MOF_1_3::Model::String|UMMF::MOF_1_3::Model::String> values of Attribute C<labels>.
