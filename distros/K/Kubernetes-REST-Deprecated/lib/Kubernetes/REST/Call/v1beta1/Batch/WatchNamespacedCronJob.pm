...
Kubernetes::REST::Call::v1beta1::Batch::WatchNamespacedCronJob - REMOVED -- superseded by Kubernetes::REST's unified v1 API, see Kubernetes::REST::Deprecated
...
C<Kubernetes::REST::Call::v1beta1::Batch::WatchNamespacedCronJob> itself was never functional in the C<1.x> series -- it
...
C<cpanm Kubernetes::REST::Call::v1beta1::Batch::WatchNamespacedCronJob> -- or a cpanfile / code that still references the
...
Kubernetes::REST::Call::v1beta1::Batch::WatchNamespacedCronJob - REMOVED, superseded by Kubernetes::REST's unified v1 API
