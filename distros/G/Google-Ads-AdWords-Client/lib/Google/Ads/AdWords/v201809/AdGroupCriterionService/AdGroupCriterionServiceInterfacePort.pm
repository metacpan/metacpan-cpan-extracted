package Google::Ads::AdWords::v201809::AdGroupCriterionService::AdGroupCriterionServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201809::TypeMaps::AdGroupCriterionService
    if not Google::Ads::AdWords::v201809::TypeMaps::AdGroupCriterionService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201809/AdGroupCriterionService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201809::TypeMaps::AdGroupCriterionService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::AdGroupCriterionService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201809::AdGroupCriterionService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::AdGroupCriterionService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::AdGroupCriterionService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::AdGroupCriterionService::query )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201809/AdGroupCriterionService.
...
Returns a L<Google::Ads::AdWords::v201809::AdGroupCriterionService::getResponse|Google::Ads::AdWords::v201809::AdGroupCriterionService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::AdGroupCriterionService::mutateResponse|Google::Ads::AdWords::v201809::AdGroupCriterionService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::AdGroupCriterionService::mutateLabelResponse|Google::Ads::AdWords::v201809::AdGroupCriterionService::mutateLabelResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::AdGroupCriterionService::queryResponse|Google::Ads::AdWords::v201809::AdGroupCriterionService::queryResponse> object.
