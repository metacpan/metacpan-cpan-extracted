...
our $schema = [int => {
    summary => 'Second of minute (0-60), e.g. 39',
    min     => 0,
    max     => 60,
    examples => [
...
# ABSTRACT: Second of minute (0-60), e.g. 39
...
Sah::Schema::date::second - Second of minute (0-60), e.g. 39

=head1 VERSION

This document describes version 0.019 of Sah::Schema::date::second (from Perl distribution Sah-Schemas-Date), released on 2023-12-09.
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"date::second*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('date::second*', name=>'DateSecond')
     );
 }

 use My::Types qw(DateSecond);
 DateSecond->assert_valid($data);
