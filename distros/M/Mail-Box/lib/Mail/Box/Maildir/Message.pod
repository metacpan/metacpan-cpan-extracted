...
Inherited, see L<Mail::Box::Dir::Message/"Constructors">

=back

=head2 Attributes

Extends L<"Attributes" in Mail::Box::Dir::Message|Mail::Box::Dir::Message/"Attributes">.

=over 4

=item $obj-E<gt>B<filename>( [$filename] )

Returns the current filename for this message.  If the C<$filename> argument
...
Improves base, see L<Mail::Box::Dir::Message/"Attributes">

=item $obj-E<gt>B<fixHeader>()

Inherited, see L<Mail::Box::Dir::Message/"Attributes">
...
the C<BOOLEAN> is C<false>).  When you accept an already accepted message,
nothing will happen.
...
=item Fault: cannot rename file $from to $to: $!

Cast by C<filename()>

=item Fault: cannot rename file $from to $to: $!

Cast by C<labelsToFilename()>
