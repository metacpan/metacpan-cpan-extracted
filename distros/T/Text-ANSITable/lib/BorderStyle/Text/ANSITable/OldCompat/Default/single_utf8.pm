...
BorderStyle::Text::ANSITable::OldCompat::Default::single_utf8 - UTF8::SingleLine border style (with old name)

=head1 VERSION

This document describes version 0.606 of BorderStyle::Text::ANSITable::OldCompat::Default::single_utf8 (from Perl distribution Text-ANSITable), released on 2021-08-27.
