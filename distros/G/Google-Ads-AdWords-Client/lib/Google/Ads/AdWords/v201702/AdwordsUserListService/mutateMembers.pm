...
package Google::Ads::AdWords::v201702::AdwordsUserListService::mutateMembers;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201702::MutateMembersOperation',
    },
    {
...
mutateMembers from the namespace https://adwords.google.com/api/adwords/rm/v201702.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::AdwordsUserListService::mutateMembers->new($data);

Constructor. The following data structure may be passed to new():

 {
   operations =>  $a_reference_to, # see Google::Ads::AdWords::v201702::MutateMembersOperation
 },
