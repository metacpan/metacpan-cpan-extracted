...
The code for this distribution is [hosted on GitHub](https://github.com/houseabsolute/Log-Dispatch).
...
on Linux by [Travis](https://travis-ci.org/houseabsolute/Log-Dispatch) and on Windows by [AppVeyor](https://ci.appveyor.com/project/autarch/Log-Dispatch).
