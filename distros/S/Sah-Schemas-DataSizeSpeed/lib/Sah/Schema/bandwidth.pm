...
This document describes version 0.009 of Sah::Schema::bandwidth (from Perl distribution Sah-Schemas-DataSizeSpeed), released on 2020-03-08.
...
Using with L<Data::Sah>:
 ...
 my $vdr = gen_validator("bandwidth*");
