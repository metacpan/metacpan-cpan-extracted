...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::PreviewFeature Google::Cloud::Compute::V1::Compute::PreviewFeatureList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::PreviewFeaturesClient->new( credentials => 'dummy' );
