...
use Chart::Plotly::Trace::Volume::Legendgrouptitle;
...
has legendgrouptitle => ( is  => "rw",
                          isa => "Maybe[HashRef]|Chart::Plotly::Trace::Volume::Legendgrouptitle", );
...
=for markdown ![Screenshot of the above example](https://raw.githubusercontent.com/pablrod/p5-Chart-Plotly/master/examples/traces/volume.png)
