...
=item paginate => BOOLEAN

This call supports pagination via bookmarks.
This enables the use of L<Couch::DB::Result::nextPage()|Couch::DB::Result/"When the document is collected">.
...
values and objects.  See L<Couch::DB::toPerl()|Couch::DB/"Conversions">.
