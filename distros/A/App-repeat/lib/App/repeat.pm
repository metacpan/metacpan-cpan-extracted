...
App::repeat - Repeat a command a number of times

=head1 VERSION

This document describes version 0.006 of App::repeat (from Perl distribution App-repeat), released on 2024-12-10.

=head1 SYNOPSIS

See the command-line script L<repeat>.
