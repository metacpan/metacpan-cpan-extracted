package Google::Ads::AdWords::v201802::UserIdentifier;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'userIdentifierType' => 'Google::Ads::AdWords::v201802::OfflineDataUploadUserIdentifierType',
...
Google::Ads::AdWords::v201802::UserIdentifier

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
UserIdentifier from the namespace https://adwords.google.com/api/adwords/rm/v201802.
