package Google::Ads::AdWords::v201705::AdGroupAdCountLimitExceeded;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201705::EntityCountLimitExceeded);
# Variety: sequence
...
AdGroupAdCountLimitExceeded from the namespace https://adwords.google.com/api/adwords/cm/v201705.
