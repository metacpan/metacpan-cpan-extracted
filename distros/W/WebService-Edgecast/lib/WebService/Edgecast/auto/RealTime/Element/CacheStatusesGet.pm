...
package WebService::Edgecast::auto::RealTime::Element::CacheStatusesGet;
BEGIN {
  $WebService::Edgecast::auto::RealTime::Element::CacheStatusesGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CacheStatusesGet');
...
WebService::Edgecast::auto::RealTime::Element::CacheStatusesGet
...
CacheStatusesGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::RealTime::Element::CacheStatusesGet->new($data);
