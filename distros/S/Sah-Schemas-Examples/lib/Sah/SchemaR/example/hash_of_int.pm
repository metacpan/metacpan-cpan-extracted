...
our $rschema = [
  "hash",
  [
    { of => ["int", { req => 1 }, {}], summary => "Hash of integers" },
  ],
  ["hash"],
];
...
This document describes version 0.005 of Sah::SchemaR::example::hash_of_int (from Perl distribution Sah-Schemas-Examples), released on 2016-12-09.
