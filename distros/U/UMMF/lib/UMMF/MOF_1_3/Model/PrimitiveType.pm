...
package UMMF::MOF_1_3::Model::PrimitiveType;
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_3::Model::PrimitiveType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_3::Model::PrimitiveType|UMMF::MOF_1_3::Model::PrimitiveType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_3::Model::PrimitiveType')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_3::Model::PrimitiveType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_3::Model::PrimitiveType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_3::Model::PrimitiveType' . ": value '$x'")
    unless __validate_type($self, $x);
}


=head2 C<isaPrimitiveType>


Returns true if receiver is a L<UMMF::MOF_1_3::Model::PrimitiveType|UMMF::MOF_1_3::Model::PrimitiveType>.
Other receivers will return false.

=cut
sub isaPrimitiveType { 1 }


=head2 C<isaModel__PrimitiveType>


Returns true if receiver is a L<UMMF::MOF_1_3::Model::PrimitiveType|UMMF::MOF_1_3::Model::PrimitiveType>.
Other receivers will return false.
This is the fully qualified version of the C<isaPrimitiveType> method.

=cut
sub isaModel__PrimitiveType { 1 }
...
Returns the UML Model name (C<'Model::PrimitiveType'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Model::PrimitiveType' }
  ...
  $__tangram_schema ||=
  {
   ...
   [
	 ...
	 # Associations
       ...
       'bases' => [  'UMMF::MOF_1_3::Model::DataType',  ],
       'sql' => {
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_3::Model::PrimitiveType::___create(@args);
