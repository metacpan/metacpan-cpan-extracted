...
package WebService::Edgecast::auto::Administration::Element::CustomerOriginAdvancedAdd;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerOriginAdvancedAdd::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerOriginAdvancedAdd');
...
WebService::Edgecast::auto::Administration::Element::CustomerOriginAdvancedAdd
...
CustomerOriginAdvancedAdd from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerOriginAdvancedAdd->new($data);
