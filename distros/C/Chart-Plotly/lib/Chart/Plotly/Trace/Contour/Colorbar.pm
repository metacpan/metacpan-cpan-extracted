package Chart::Plotly::Trace::Contour::Colorbar;
use Moose;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Contour::Colorbar::Tickfont", );
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Contour::Colorbar::Tickformatstop]", );
...
Chart::Plotly::Trace::Contour::Colorbar - This attribute is one of the possible options for the trace contour.
