...
Cfn::Resource::AWS::Logs::SubscriptionFilter - Cfn resource for AWS::Logs::SubscriptionFilter

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::Logs::SubscriptionFilter.
