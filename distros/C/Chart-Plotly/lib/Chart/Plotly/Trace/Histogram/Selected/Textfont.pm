package Chart::Plotly::Trace::Histogram::Selected::Textfont;
use Moose;
...
Chart::Plotly::Trace::Histogram::Selected::Textfont - This attribute is one of the possible options for the trace histogram.
