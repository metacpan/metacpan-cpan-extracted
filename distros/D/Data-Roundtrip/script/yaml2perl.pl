...
sub usage { return
	"Usage : $0 [--I 'a-yaml-string' | --i 'afile.yaml'] [--o afile] [--escape-unicode|-e] [--pretty] [--terse] [--no-indent]\n"
...
Convert YAML data to a Perl variable (dump) which can be parsed or eval'ed by any Perl script.
