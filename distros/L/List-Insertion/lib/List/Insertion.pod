...
=head2 General Binary Search Performance

Thanks to the lack of a CODE blocks and more streamlined comparison, this
module is on par with L<List::BinarySearch::XS> for at least one level of
structured data. Not bad for pure perl.

Please see the associated benchmarking script F<bench.pl> in this distribution:
...
The benchmarking script F<build-sorted.pl> in this distribution demonstrates
...
L<List::BinarySearch::XS> and is much faster than the pure perl
L<List::BinarySearch::PP>.
...
=head2 Using Generated or Exported subrotines
