...
This document describes version 0.45 of App::FilterOrgByHeadlines (from Perl distribution App-OrgUtils), released on 2016-12-24.

=head1 FUNCTIONS


=head2 filter_org_by_headlines(%args) -> str|array[str]
