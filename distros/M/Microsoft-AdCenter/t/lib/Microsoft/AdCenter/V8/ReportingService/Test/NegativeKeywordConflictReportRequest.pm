package Microsoft::AdCenter::V8::ReportingService::Test::NegativeKeywordConflictReportRequest;
...
use Microsoft::AdCenter::V8::ReportingService::NegativeKeywordConflictReportRequest;

sub test_can_create_negative_keyword_conflict_report_request_and_set_all_fields : Test(3) {
    my $negative_keyword_conflict_report_request = Microsoft::AdCenter::V8::ReportingService::NegativeKeywordConflictReportRequest->new
        ->Columns('columns')
        ->Scope('scope')
    ;
