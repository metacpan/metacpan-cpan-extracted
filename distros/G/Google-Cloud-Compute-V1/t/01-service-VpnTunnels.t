...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::VpnTunnel Google::Cloud::Compute::V1::Compute::VpnTunnelAggregatedList Google::Cloud::Compute::V1::Compute::VpnTunnelList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::VpnTunnelsClient->new( credentials => 'dummy' );
