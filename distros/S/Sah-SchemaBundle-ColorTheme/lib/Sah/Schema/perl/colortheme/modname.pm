...
This document describes version 0.004 of Sah::Schema::perl::colortheme::modname (from Perl distribution Sah-SchemaBundle-ColorTheme), released on 2024-06-21.
...
Used completion: L<perl_modname|Perinci::Sub::XCompletion::perl_modname>, L<HASH(0x5622aa9f8ac8)|Perinci::Sub::XCompletion::HASH(0x5622aa9f8ac8)>
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::colortheme::modname", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::colortheme::modname", {return_type=>'str_errmsg+val'});
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::colortheme::modname*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::colortheme::modname*', name=>'PerlColorthemeModname')
     );
 }

 use My::Types qw(PerlColorthemeModname);
 PerlColorthemeModname->assert_valid($data);
