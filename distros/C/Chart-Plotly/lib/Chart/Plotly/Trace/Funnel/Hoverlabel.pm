package Chart::Plotly::Trace::Funnel::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Funnel::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Funnel::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Funnel::Hoverlabel - This attribute is one of the possible options for the trace funnel.
