...
SQL::Statement::Function::ByName::ARGMAXNUM - SQL function to return the (numerically) maximum parameter

=head1 VERSION

This document describes version 0.002 of SQL::Statement::Function::ByName::ARGMAXNUM (from Perl distribution SQL-Statement-Functions-ArgMinMax), released on 2017-01-25.
