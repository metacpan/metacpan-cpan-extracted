...
Borang::HTML::Widget::Select - Select box input widget

=head1 VERSION

This document describes version 0.02 of Borang::HTML::Widget::Select (from Perl distribution Borang), released on 2015-09-22.
