...
1;
# ABSTRACT: Complete from list of ISO-639 language codes
...
Complete::Language - Complete from list of ISO-639 language codes

=head1 VERSION

This document describes version 0.001 of Complete::Language (from Perl distribution Complete-Language), released on 2019-07-18.
...
=head2 complete_language_code

Usage:

 complete_language_code(%args) -> any

Complete from list of ISO-639 language codes.
...
Please visit the project's homepage at L<https://metacpan.org/release/Complete-Language>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Complete-Language>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=Complete-Language>
