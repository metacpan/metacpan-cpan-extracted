...
SKIP: {
  skip "Tests only implemented for single precision perl, '-Duselongdouble' or '-Dusequadmath' detected ...", 348
    if defined $Config{uselongdouble} or defined $Config{usequadmath};
...
AV* omp_get_renew_aref(SV *ARRAY) {
  ...
  PerlOMP_1D_Array_TO_1D_FLOAT_ARRAY_r(ARRAY, num_elements, raw_array); // call macro to put AoA into native "nodes" array - threaded version
