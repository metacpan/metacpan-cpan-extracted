...
package UMMF::UML_1_5::Foundation::Core::Usage;
...
=head2 C<__validate_type>
  ...
  UMMF::UML_1_5::Foundation::Core::Usage->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::Foundation::Core::Usage|UMMF::UML_1_5::Foundation::Core::Usage>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::Foundation::Core::Usage')  ;
}


=head2 C<__typecheck>

  UMMF::UML_1_5::Foundation::Core::Usage->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::Foundation::Core::Usage->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::Foundation::Core::Usage' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML_1_5::Foundation::Core::Usage|UMMF::UML_1_5::Foundation::Core::Usage>.
...
=head2 C<isaFoundation__Core__Usage>


Returns true if receiver is a L<UMMF::UML_1_5::Foundation::Core::Usage|UMMF::UML_1_5::Foundation::Core::Usage>.
Other receivers will return false.
This is the fully qualified version of the C<isaUsage> method.

=cut
sub isaFoundation__Core__Usage { 1 }
...
Returns the UML Model name (C<'Foundation::Core::Usage'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Foundation::Core::Usage' }
...
sub __initialize
{
  ...
  $self->UMMF::UML_1_5::Foundation::Core::Usage::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::Foundation::Core::Usage::___create(@args);
