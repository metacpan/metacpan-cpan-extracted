...
IMDB::Local::VideoGame - Object representation of VideoGame information.
...
Perhaps a little code snippet.
    ...
    use IMDB::Local::VideoGame;

    my $foo = IMDB::Local::VideoGame->new();
    ...
