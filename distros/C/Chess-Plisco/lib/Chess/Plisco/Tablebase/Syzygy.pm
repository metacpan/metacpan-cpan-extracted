...
$Chess::Plisco::Tablebase::Syzygy::Testing::VERSION = 'v1.0.2';
sub calc_key {
...
$Chess::Plisco::Tablebase::Syzygy::MissingTableException::VERSION = 'v1.0.2';
...
$Chess::Plisco::Tablebase::Syzygy::PairsData::VERSION = 'v1.0.2';
sub new {
	my ($class, %args) = @_;
...
$Chess::Plisco::Tablebase::Syzygy::PawnFileData::VERSION = 'v1.0.2';
sub new {
	my ($class) = @_;
	bless {
		precomp => [],
...
$Chess::Plisco::Tablebase::Syzygy::PawnFileDataDtz::VERSION = 'v1.0.2';
sub new {
	my ($class, %args) = @_;
...
$Chess::Plisco::Tablebase::Syzygy::Table::VERSION = 'v1.0.2';
use integer;
...
$Chess::Plisco::Tablebase::Syzygy::WdlTable::VERSION = 'v1.0.2';
use Chess::Plisco qw(:all);
...
$Chess::Plisco::Tablebase::Syzygy::DtzTable::VERSION = 'v1.0.2';
use Chess::Plisco qw(:all);
...
$Chess::Plisco::Tablebase::Syzygy::VERSION = 'v1.0.2';
