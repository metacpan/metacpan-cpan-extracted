...
1;
# ABSTRACT: Perl SortKey::* module name without the prefix, e.g. Num/pattern_count
...
Sah::Schema::perl::sortkey::modname - Perl SortKey::* module name without the prefix, e.g. Num/pattern_count

=head1 VERSION

This document describes version 0.002 of Sah::Schema::perl::sortkey::modname (from Perl distribution Sah-SchemaBundle-SortKey), released on 2024-03-07.
...
Used completion: L<perl_modname|Perinci::Sub::XCompletion::perl_modname>, L<HASH(0x55811b9391e8)|Perinci::Sub::XCompletion::HASH(0x55811b9391e8)>
...
=head2 Sample data and validation results against this schema
 ...
 "Num/pattern_count"  # valid, becomes "Num::pattern_count"
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::sortkey::modname*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::sortkey::modname", {return_type=>'str_errmsg'});
 my $errmsg = $validator->($data);
 
 # a sample valid data
 $data = "Num/pattern_count";
 my $errmsg = $validator->($data); # => ""
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::sortkey::modname", {return_type=>'str_errmsg+val'});
 my $res = $validator->($data); # [$errmsg, $validated_val]
 
 # a sample valid data
 $data = "Num/pattern_count";
 my $res = $validator->($data); # => ["","Num::pattern_count"]
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::sortkey::modname*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::sortkey::modname*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::sortkey::modname*', name=>'PerlSortkeyModname')
     );
 }

 use My::Types qw(PerlSortkeyModname);
 PerlSortkeyModname->assert_valid($data);
