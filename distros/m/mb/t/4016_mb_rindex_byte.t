...
# 1
    ...
    sub { $_='‚ AB‚¤123‚ AB‚¤123‚ AB‚¤123'; my $r=mb::rindex_byte($_,'B‚¤1');    $r == 21 },
    sub { $_='‚ AB‚¤123‚ AB‚¤123‚ AB‚¤123'; my $r=mb::rindex_byte($_,'B‚¤1',17); $r == 12 },
...
# 11
    ...
    sub { $_='‚ AB‚¤123‚ AB‚¤123‚ AB‚¤123'; my $r=mb::rindex_byte($_,'‚©3Z');    $r == -1 },
    sub { $_='‚ AB‚¤123‚ AB‚¤123‚ AB‚¤123'; my $r=mb::rindex_byte($_,'‚©3Z',17); $r == -1 },
    #         012345678901234567890123456
    sub {1},
    sub {1},
    sub {1},
