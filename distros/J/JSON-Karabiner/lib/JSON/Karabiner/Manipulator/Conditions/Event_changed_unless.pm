...
$JSON::Karabiner::Manipulator::Conditions::Event_changed_unless::VERSION = '0.017';
use strict;
use warnings;
use JSON;
use Carp;
...
JSON::Karabiner::Manipulator::Conditions::Event_changed_unless - definition for event_changed_unless condition
