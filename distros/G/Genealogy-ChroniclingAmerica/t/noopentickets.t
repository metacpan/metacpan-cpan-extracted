...
use constant URL => 'https://api.github.com/repos/nigelhorne/Genealogy-ChroniclingAmerica/issues';
...
RT: {
	...
	SKIP: {
		...
		} elsif(my @rc = @{WWW::RT::CPAN::list_dist_active_tickets(dist => 'Genealogy-ChroniclingAmerica')}) {
			cmp_ok($rc[0], '==', 200);
			cmp_ok($rc[1], 'eq', 'OK');
