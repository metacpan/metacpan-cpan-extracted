...
Flail::Exec::Cmd::cmdname - Flail "cmdname" command

=head1 VERSION

  Time-stamp: <2006-12-03 11:04:26 attila@stalphonsos.com>

=head1 SYNOPSIS

  use Flail::Exec::Cmd::cmdname;
  blah;
...
package Flail::Exec::Cmd::cmdname;
use strict;
use Carp;
use Flail::Utils;
use base qw(Exporter);
use vars qw(@EXPORT @EXPORT_OK %EXPORT_TAGS);
@EXPORT_OK = qw(flail_cmdname);
@EXPORT = ();
