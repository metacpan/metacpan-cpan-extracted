package Chart::Plotly::Trace::Parcats::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Parcats::Legendgrouptitle::Font - This attribute is one of the possible options for the trace parcats.
