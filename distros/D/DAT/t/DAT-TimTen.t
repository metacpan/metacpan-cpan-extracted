...
# `make test'. After `make install' it should work as `perl DAT-TimTen.t'
...
sub get_policy {
    my ($policy_class) = @_;
    $policy_class = "DAT::TimTen::Policy::$policy_class" unless $policy_class =~ /::/;
