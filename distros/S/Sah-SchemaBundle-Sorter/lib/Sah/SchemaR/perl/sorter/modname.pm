...
Sah::SchemaR::perl::sorter::modname - Perl Sorter::* module name without the prefix, e.g. foo

=head1 VERSION

This document describes version 0.002 of Sah::SchemaR::perl::sorter::modname (from Perl distribution Sah-SchemaBundle-Sorter), released on 2024-03-07.
