package Perinci::Sub::XCompletion::unix_uid;
...
use Complete::Unix qw(complete_uid);
...
1;
# ABSTRACT: Generate completion for Unix UIDs
...
Perinci::Sub::XCompletion::unix_uid - Generate completion for Unix UIDs

=head1 VERSION

This document describes version 0.022 of Perinci::Sub::XCompletion::unix_uid (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.

=head1 SYNOPSIS

=head1 DESCRIPTION

This creates a completion from list of local Unix UIDs.
