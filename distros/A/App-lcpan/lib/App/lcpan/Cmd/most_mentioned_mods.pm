...
1;
# ABSTRACT: Alias for 'mods-by-mention-count', with default n=100
...
App::lcpan::Cmd::most_mentioned_mods - Alias for 'mods-by-mention-count', with default n=100

=head1 VERSION

This document describes version 1.070 of App::lcpan::Cmd::most_mentioned_mods (from Perl distribution App-lcpan), released on 2022-03-27.
