package Chart::Plotly::Trace::Contourcarpet::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Contourcarpet::Legendgrouptitle::Font - This attribute is one of the possible options for the trace contourcarpet.
