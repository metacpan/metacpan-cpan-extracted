...
eval { $v .= pmver('Catalyst::Controller::POD','1.0.0') };
eval { $v .= pmver('Catalyst::Engine::HTTP','any version') };
eval { $v .= pmver('Catalyst::Engine::PSGI','any version') };
eval { $v .= pmver('Catalyst::Plugin::ConfigLoader','any version') };
eval { $v .= pmver('Catalyst::Plugin::Static::Simple','any version') };
eval { $v .= pmver('Catalyst::Restarter','any version') };
eval { $v .= pmver('Catalyst::Runtime','5.7014') };
...
eval { $v .= pmver('Plack::Middleware::Conditional','any version') };
eval { $v .= pmver('Plack::Middleware::ReverseProxy','any version') };
