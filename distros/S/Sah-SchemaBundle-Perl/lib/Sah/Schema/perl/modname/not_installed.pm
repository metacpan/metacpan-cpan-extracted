...
This document describes version 0.050 of Sah::Schema::perl::modname::not_installed (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
=head1 SAH SCHEMA DEFINITION
 ...
 [
   ...
   {
     summary    => "Name of a Perl module that is not installed locally",
     prefilters => ["Perl::check_module_not_installed"],
   },
 ]

Base schema: L<perl::modname|Sah::Schema::perl::modname>

Used prefilters: L<Perl::check_module_not_installed|Data::Sah::Filter::perl::Perl::check_module_not_installed>
