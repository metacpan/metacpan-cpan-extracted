...
our $rschema = ["int",[{max=>255,min=>0,summary=>"8-bit unsigned integer"},{summary=>"Same as uint8"}],["uint8","int"]];
...
This document describes version 0.071 of Sah::SchemaR::byte (from Perl distribution Sah-Schemas-Int), released on 2018-04-03.
