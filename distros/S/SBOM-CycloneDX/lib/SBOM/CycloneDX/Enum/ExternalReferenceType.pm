...
=item * L<VCS>, Version Control System

=item * L<ISSUE_TRACKER>, Issue or defect tracking system, or an
Application Lifecycle Management (ALM) system

=item * L<WEBSITE>, Website

=item * L<ADVISORIES>, Security advisories

=item * L<BOM>, Bill of Materials (SBOM, OBOM, HBOM, SaaSBOM, etc)

=item * L<MAILING_LIST>, Mailing list or discussion group

=item * L<SOCIAL>, Social media account

=item * L<CHAT>, Real-time chat platform

=item * L<DOCUMENTATION>, Documentation, guides, or how-to instructions

=item * L<SUPPORT>, Community or commercial support

=item * L<SOURCE_DISTRIBUTION>, The location where the source code
...
=item * L<DISTRIBUTION>, Direct or repository download location

=item * L<DISTRIBUTION_INTAKE>, The location where a component was
...
=item * L<LICENSE>, The reference to the license file. If a license URL has
been defined in the license node, it should also be defined as an external
reference for completeness.

=item * L<BUILD_META>, Build-system specific meta file (i.e. pom.xml,
package.json, .nuspec, etc)

=item * L<BUILD_SYSTEM>, Reference to an automated build system

=item * L<RELEASE_NOTES>, Reference to release notes

=item * L<SECURITY_CONTACT>, Specifies a way to contact the maintainer,
...
=item * L<MODEL_CARD>, A model card describes the intended uses of a
...
=item * L<LOG>, A record of events that occurred in a computer system or
application, such as problems, errors, or information on current
operations.

=item * L<CONFIGURATION>, Parameters or settings that may be used by other
components or services.

=item * L<EVIDENCE>, Information used to substantiate a claim.

=item * L<FORMULATION>, Describes the formulation of any referencable
object within the BOM, including components, services, metadata,
declarations, or the BOM itself.

=item * L<ATTESTATION>, Human or machine-readable statements containing
facts, evidence, or testimony.

=item * L<THREAT_MODEL>, An enumeration of identified weaknesses, threats,
...
=item * L<ADVERSARY_MODEL>, The defined assumptions, goals, and
capabilities of an adversary.

=item * L<RISK_ASSESSMENT>, Identifies and analyzes the potential of future
...
=item * L<VULNERABILITY_ASSERTION>, A Vulnerability Disclosure Report (VDR)
...
=item * L<EXPLOITABILITY_STATEMENT>, A Vulnerability Exploitability
...
=item * L<PENTEST_REPORT>, Results from an authorized simulated cyberattack
on a component or service, otherwise known as a penetration test.

=item * L<STATIC_ANALYSIS_REPORT>, SARIF or proprietary machine or
...
=item * L<DYNAMIC_ANALYSIS_REPORT>, Dynamic analysis report that has
identified issues such as vulnerabilities and misconfigurations.

=item * L<RUNTIME_ANALYSIS_REPORT>, Report generated by analyzing the call
stack of a running application.

=item * L<COMPONENT_ANALYSIS_REPORT>, Report generated by Software
Composition Analysis (SCA), container analysis, or other forms of component
analysis.

=item * L<MATURITY_REPORT>, Report containing a formal assessment of an
organization, business unit, or team against a maturity model.

=item * L<CERTIFICATION_REPORT>, Industry, regulatory, or other
certification from an accredited (if applicable) certification body.

=item * L<CODIFIED_INFRASTRUCTURE>, Code or configuration that defines and
provisions virtualized infrastructure, commonly referred to as
Infrastructure as Code (IaC).

=item * L<QUALITY_METRICS>, Report or system in which quality metrics can
be obtained.

=item * L<POAM>, Plans of Action and Milestones (POA&M) complement an
...
=item * L<ELECTRONIC_SIGNATURE>, An e-signature is commonly a scanned
representation of a written signature or a stylized script of the person's
name.

=item * L<DIGITAL_SIGNATURE>, A signature that leverages cryptography,
typically public/private key pairs, which provides strong authenticity
verification.

=item * L<RFC_9116>, Document that complies with L<RFC
9116|https://www.ietf.org/rfc/rfc9116.html> (A File Format to Aid in
Security Vulnerability Disclosure)

=item * L<PATENT>, References information about patents which may be
...
=item * L<PATENT_FAMILY>, References information about a patent family
...
=item * L<PATENT_ASSERTION>, References assertions made regarding patents
...
=item * L<CITATION>, A reference to external citations applicable to the
...
=item * L<OTHER>, Use this if no other types accurately describe the
