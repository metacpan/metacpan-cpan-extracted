package Google::Ads::AdWords::v201702::DateSpecificRuleUserList;
use strict;
use warnings;
...
DateSpecificRuleUserList from the namespace https://adwords.google.com/api/adwords/rm/v201702.
