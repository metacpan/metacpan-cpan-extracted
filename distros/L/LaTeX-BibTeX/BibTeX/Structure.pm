...
# CLASSES    : LaTeX::BibTeX::Structure, LaTeX::BibTeX::StructuredEntry
# RELATIONS  : 
# DESCRIPTION: Provides the two base classes needed to implement
#              LaTeX::BibTeX structure modules.
...
package LaTeX::BibTeX::Structure;
...
use LaTeX::BibTeX ('check_class');

=head1 NAME

LaTeX::BibTeX::Structure - provides base classes for user structure modules
...
=head1 SYNOPSIS
   ...
   package LaTeX::BibTeX::FooStructure;
   @ISA = ('LaTeX::BibTeX::Structure');
   ...
   package LaTeX::BibTeX::FooEntry;
   @ISA = ('LaTeX::BibTeX::StructuredEntry');

   # define whatever methods you like

=head1 DESCRIPTION

The module C<LaTeX::BibTeX::Structure> provides two classes that form the
...
classes provided by the C<LaTeX::BibTeX::Structure> module are
C<LaTeX::BibTeX::Structure> and C<LaTeX::BibTeX::StructuredEntry>; these
...
structure, see L<LaTeX::BibTeX::Bib>.

Please note that the C<LaTeX::BibTeX> prefix is dropped from most module
...
C<LaTeX::BibTeX::Structure> knows nothing about the format or syntax of
...
C<LaTeX::BibTeX::StructuredEntry>, the other class provided by the
C<LaTeX::BibTeX::Structure> module.  (For the record, those requirements
...
entry classes that inherit from C<LaTeX::BibTeX::StructuredEntry>, so
...
of interactions between various classes in the C<LaTeX::BibTeX> library
...
application program, core C<LaTeX::BibTeX> classes, and some structure
module.
...
Typically, a C<LaTeX::BibTeX>-based program is based around a kernel of
code like this:
...
C<$bibfile> object is blessed into the C<LaTeX::BibTeX::File> class, and
C<$entry> is blessed into C<LaTeX::BibTeX::Entry>.  This is the
...
a C<LaTeX::BibTeX::File::set_structure> or
C<LaTeX::BibTeX::Structure::new> call attempts to load it.)
...
Now, the behaviour of the C<LaTeX::BibTeX::Entry::new> constructor
changes subtly: rather than returning an object blessed into the
C<LaTeX::BibTeX::Entry> class as you might expect from the code, the
...
(Ordinarily, this module would be called C<LaTeX::BibTeX::Foo>---but you
can customize this.)  Calling the C<set_structure> method on C<$bibfile>
will attempt to create a new structure object via the
C<LaTeX::BibTeX::Structure> constructor, which loads the structure module
C<LaTeX::BibTeX::Foo>.  Once this module is successfully loaded, the new
object is blessed into its structure class, which will presumably be
called C<LaTeX::BibTeX::FooStructure> (again, this is customizable).  The
...
C<LaTeX::BibTeX::FooEntry> (also customizable).
...
C<LaTeX::BibTeX::StructuredEntry>, and they may also call any methods
...
The first class provided by the C<LaTeX::BibTeX::Structure> module is
C<LaTeX::BibTeX::Structure>.  This class is intended to provide methods
...
can only call C<LaTeX::BibTeX::Structure::new> (usually via
C<LaTeX::BibTeX::File::set_structure>).
...
Constructs a new structure object---I<not> a C<LaTeX::BibTeX::Structure>
...
STRUCTURE to C<"LaTeX::BibTeX::">---thus, the module C<LaTeX::BibTeX::Bib>
...
implemented by the module C<Foo>:
   ...
   $structure = new LaTeX::BibTeX::Structure
      ('Foo', module => 'Foo');
...
C<LaTeX::BibTeX::BibStructure> and C<LaTeX::BibTeX::BibEntry>.  Either or
...
that they inherit correctly (from C<LaTeX::BibTeX::Structure> and
C<LaTeX::BibTeX::StructuredEntry> respectively), and that the structure
...
sub new 
{
   ...
   # - $type is presumably "LaTeX::BibTeX::Structure" (if called from 
   #   LaTeX::BibTeX::File::set_structure), but shouldn't assume that
   ...
   #   'module'), by LaTeX::BibTeX::StructuredEntry (? 'check', 'coerce', 
   #   'warn' flags), and by the user structure classes

   my $module = (delete $options{'module'}) || ('LaTeX::BibTeX::' . $name);

   my $module_info = eval "require $module";
   die "LaTeX::BibTeX::Structure: unable to load module \"$module\" for " .
       "user structure \"$name\": $@\n"
      if $@;
...
# ----------------------------------------------------------------------
# LaTeX::BibTeX::StructuredEntry methods dealing with entry structure

package LaTeX::BibTeX::StructuredEntry;
use strict;
use vars qw(@ISA);
use Carp;

@ISA = ('LaTeX::BibTeX::Entry');
use LaTeX::BibTeX qw(:metatypes display_list);
...
type C<foo>, you might do this:
   ...
   # it inherits from LaTeX::BibTeX::StructuredEntry
...
L<LaTeX::BibTeX>, L<LaTeX::BibTeX::Entry>, L<LaTeX::BibTeX::File>
