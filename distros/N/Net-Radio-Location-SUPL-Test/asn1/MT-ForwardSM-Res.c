...
static int asn_MAP_MT_ForwardSM_Res_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_MT_ForwardSM_Res_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MT_ForwardSM_Res_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 0, 0, 0 }, /* sm-RP-UI at 144 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, 0, 0 } /* extensionContainer at 145 */
};
static asn_SEQUENCE_specifics_t asn_SPC_MT_ForwardSM_Res_specs_1 = {
	...
	asn_MAP_MT_ForwardSM_Res_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	1,	/* Start extensions */
	3	/* Stop extensions */
};
