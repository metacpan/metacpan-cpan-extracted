...
BEGIN { use_ok('Net::Autoconfig::Device::HP', 'Net::Autoconfig::Device') };
...
#########################
# Test all of methods
my @methods = qw(new connect discover_dev_type get_admin_rights configure disable_paging);
foreach my $method (@methods) {
	can_ok("Net::Autoconfig::Device::HP", $method);
}
...
ok(Net::Autoconfig::Device::HP->new(), "Testing for empty Device object creation"); 

$device = Net::Autoconfig::Device::HP->new("ip_addr" => "192.168.0.1");
