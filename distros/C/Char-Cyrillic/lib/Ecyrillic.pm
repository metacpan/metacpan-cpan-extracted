...
sub import {
    ...
    *Char::ord           = \&Cyrillic::ord;
    *Char::ord_          = \&Cyrillic::ord_;
    *Char::reverse       = \&Cyrillic::reverse;
    *Char::getc          = \&Cyrillic::getc;
    *Char::length        = \&Cyrillic::length;
    *Char::substr        = \&Cyrillic::substr;
    *Char::index         = \&Cyrillic::index;
    *Char::rindex        = \&Cyrillic::rindex;
    *Char::eval          = \&Cyrillic::eval;
    *Char::escape        = \&Cyrillic::escape;
    *Char::escape_token  = \&Cyrillic::escape_token;
    *Char::escape_script = \&Cyrillic::escape_script;
}
...
my $qq_substr  = qr{(?> Char::substr | Cyrillic::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Ecyrillic::re_r=CORE::eval $Ecyrillic::re_r; ' x $e_modifier,          #  5
            );
        }
    ...
    # without /r
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Ecyrillic::re_r=CORE::eval $Ecyrillic::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
