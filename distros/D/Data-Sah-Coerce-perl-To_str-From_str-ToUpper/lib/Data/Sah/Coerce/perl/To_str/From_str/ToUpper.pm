package Data::Sah::Coerce::perl::To_str::From_str::ToUpper;
...
Data::Sah::Coerce::perl::To_str::From_str::ToUpper - Coerce string to upper case

=head1 VERSION

This document describes version 0.005 of Data::Sah::Coerce::perl::To_str::From_str::ToUpper (from Perl distribution Data-Sah-Coerce-perl-To_str-From_str-ToUpper), released on 2019-11-28.

=head1 SYNOPSIS

To use in a Sah schema:

 ["str",{"x.perl.coerce_rules"=>["From_str::ToUpper"]}]
