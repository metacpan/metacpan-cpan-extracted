...
Perinci::Sub::XCompletion::perl_wordlist_modname_with_optional_args - Generate completion for WordList::* module name with optional params

=head1 VERSION

This document describes version 0.005 of Perinci::Sub::XCompletion::perl_wordlist_modname_with_optional_args (from Perl distribution Sah-Schemas-WordList), released on 2023-01-19.
