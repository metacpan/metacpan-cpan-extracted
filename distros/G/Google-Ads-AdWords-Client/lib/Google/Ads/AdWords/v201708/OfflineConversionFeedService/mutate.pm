...
package Google::Ads::AdWords::v201708::OfflineConversionFeedService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201708::OfflineConversionFeedOperation',
    },
    {
...
Google::Ads::AdWords::v201708::OfflineConversionFeedService::mutate
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201708::OfflineConversionFeedService::mutate->new($data);

Constructor. The following data structure may be passed to new():

 {
   operations =>  $a_reference_to, # see Google::Ads::AdWords::v201708::OfflineConversionFeedOperation
 },
