...
package Shipment::UPS::WSDL::ShipElements::ShipmentResponse;
$Shipment::UPS::WSDL::ShipElements::ShipmentResponse::VERSION = '2.03';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    __PACKAGE__->__set_name('ShipmentResponse');
...
ShipmentResponse from the namespace http://www.ups.com/XMLSchema/XOLTWS/Ship/v1.0.
