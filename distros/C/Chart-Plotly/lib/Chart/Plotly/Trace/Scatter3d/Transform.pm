package Chart::Plotly::Trace::Scatter3d::Transform;
use Moose;
...
Chart::Plotly::Trace::Scatter3d::Transform - This attribute is one of the possible options for the trace scatter3d.
