...
ArrayData::Lingua::Word::ID::KBBI - Indonesian words from Kamus Besar Bahasa Indonesia
...
=head1 SYNOPSIS
 ...
 use ArrayData::Lingua::Word::ID::KBBI;

 my $ary = ArrayData::Lingua::Word::ID::KBBI->new;
 ...
 $ary->apply_roles('FindItem::Iterator'); # or: $ary = ArrayData::Lingua::Word::ID::KBBI->new->apply_roles(...);
 ...
 $ary->apply_roles('PickItems::Iterator'); # or: $ary = ArrayData::Lingua::Word::ID::KBBI->new->apply_roles(...);
...
Please visit the project's homepage at L<https://metacpan.org/release/ArrayData-Lingua-Word-ID-KBBI>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-ArrayData-Lingua-Word-ID-KBBI>.
...
Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=ArrayData-Lingua-Word-ID-KBBI>
