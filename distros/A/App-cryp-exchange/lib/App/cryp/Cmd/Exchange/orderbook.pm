...
1;
# ABSTRACT: Get order book on an exchange
...
App::cryp::Cmd::Exchange::orderbook - Get order book on an exchange

=head1 VERSION

This document describes version 0.011 of App::cryp::Cmd::Exchange::orderbook (from Perl distribution App-cryp-exchange), released on 2018-11-29.
