...
my $module = 'Net::DNS::ToolKit::RR::MX';
...
$exptext = q(
  ...
  30    :  0000_0111  0x07    9    
  31    :  0000_0000  0x00    0    
  32    :  0011_1000  0x38   56  8  
  33    :  0000_0100  0x04    4    
  34    :  0110_1101  0x6D  109  m  
  35    :  0111_1000  0x78  120  x  
  36    :  0011_1001  0x39   57  9  
  37    :  0011_1001  0x39   57  9  
  38    :  1100_0000  0xC0  192    
  39    :  0001_0000  0x10   16    
);
$name = 'mx99.bar.com';
my $pref = 56;
### offset from above = 29
(my $newoff, @dnptrs) = $module->put(\$buffer,$off,\@dnptrs,$pref,$name);
#print_buf(\$buffer);
#print_ptrs(@dnptrs);
chk_exp(\$buffer,\$exptext);      
...
($newoff,$newpref,$newname) = $module->get(\$buffer,$start);
# check offset against PUT operation above
print "bad offset, $newoff, exp: $off\nnot "
  unless $newoff == $off;
&ok;

## test 6	verify preference
print "bad preference, $newpref, exp: $pref\nnot "
	unless $newpref == $pref;
&ok;
...
## test 8	check parse pref
$pref = 45;
$name = 'the quick brown fox jumped over the lazy dog';
($newpref,$newname) = $module->parse($pref,$name);
print "bad preference, $newpref, exp: $pref\nnot "
	unless $newpref == $pref;
&ok;
