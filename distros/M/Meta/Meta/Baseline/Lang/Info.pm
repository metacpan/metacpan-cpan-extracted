...
package Meta::Baseline::Lang::Info;
...
Meta::Baseline::Lang::Info - language for GNU info files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Info::env();

=head1 DESCRIPTION

This package contains stuff specific to Info in the baseline:
Its mainly here to authorize entries of GNU Info files to the baseline.
