...
package Meta::Baseline::Lang::Midi;
...
Meta::Baseline::Lang::Midi - language for Midi files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Midi::env();

=head1 DESCRIPTION

This package contains stuff specific to Midi in the baseline:
Its mainly here to authorize entries of Midi files to the baseline.
