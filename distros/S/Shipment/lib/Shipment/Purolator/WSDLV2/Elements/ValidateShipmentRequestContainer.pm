...
package Shipment::Purolator::WSDLV2::Elements::ValidateShipmentRequestContainer;
$Shipment::Purolator::WSDLV2::Elements::ValidateShipmentRequestContainer::VERSION = '3.09';
use strict;
use warnings;
...
__PACKAGE__->__set_name('ValidateShipmentRequestContainer');
...
Shipment::Purolator::WSDLV2::Elements::ValidateShipmentRequestContainer
...
ValidateShipmentRequestContainer from the namespace http://purolator.com/pws/datatypes/v2.
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDLV2::Elements::ValidateShipmentRequestContainer->new($data);
