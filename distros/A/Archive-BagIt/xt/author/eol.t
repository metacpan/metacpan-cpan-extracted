...
my @files = (
    ...
    't/pod-coverage.t',
    't/pod.t',
    't/src/broken_baginfo/bag-info.txt',
    't/src/broken_baginfo/bagit.txt',
    't/src/broken_baginfo/data/test',
    't/src/broken_baginfo/manifest-md5.txt',
    't/src/broken_baginfo/manifest-sha512.txt',
    't/src/broken_baginfo/tagmanifest-md5.txt',
