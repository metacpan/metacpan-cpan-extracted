...
https://metacpan.org/release/Mojolicious-Plugin-WithCSRFProtection

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Mojolicious::Plugin::WithCSRFProtection
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Mojolicious::Plugin::WithCSRFProtection
...
The code for this distribution is [hosted at GitHub](https://github.com/maxmind/Mojolicious-Plugin-WithCSRFProtection).
...
can submit an issue report [via the web](https://github.com/maxmind/Mojolicious-Plugin-WithCSRFProtection/issues)
.
