...
int check_exclude(struct file_list *f, 
                  char *name, int name_is_dir);
void add_exclude(struct file_list *f,
                 const char *pattern, int xflags);
void add_exclude_file(struct file_list *f,
                      const char *fname, int xflags);
...
void send_file_entry(struct file_list *flist, struct file_struct *file, unsigned short base_flags);
...
void write_int_named(struct file_list *f, int32 x, const char *phase);
...
int read_line(struct file_list *f, char *buf, size_t maxlen);
