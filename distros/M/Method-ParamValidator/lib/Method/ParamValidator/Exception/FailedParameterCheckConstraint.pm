...
$Method::ParamValidator::Exception::FailedParameterCheckConstraint::VERSION   = '0.15';
$Method::ParamValidator::Exception::FailedParameterCheckConstraint::AUTHORITY = 'cpan:MANWAR';

=head1 NAME

Method::ParamValidator::Exception::FailedParameterCheckConstraint - Handles 'failed parameter check constraint' exception.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Method::ParamValidator::Exception::FailedParameterCheckConstraint
...
1; # End of Method::ParamValidator::Exception::FailedParameterCheckConstraint
