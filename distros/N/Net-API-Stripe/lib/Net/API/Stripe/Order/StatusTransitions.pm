...
sub canceled { return( shift->_set_get_datetime( 'canceled', @_ ) ); }

sub fulfiled { return( shift->_set_get_datetime( 'fulfiled', @_ ) ); }

sub paid { return( shift->_set_get_datetime( 'paid', @_ ) ); }

sub returned { return( shift->_set_get_datetime( 'returned', @_ ) ); }
...
=head2 canceled timestamp

When set, this returns a C<DateTime> object.

=head2 fulfiled timestamp

When set, this returns a C<DateTime> object.

=head2 paid timestamp

When set, this returns a C<DateTime> object.

=head2 returned timestamp
