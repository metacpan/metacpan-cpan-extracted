package Prty::TimeLapse::RangeDef;
...
=head1 SYNOPSIS
    ...
    $trd = Prty::TimeLapse::RangeDef->new('/my/timelapse/dir');
...
sub new {
    ...
    my $clipH = Prty::OrderedHash->new;
    my $clipPropertyH = Prty::OrderedHash->new;
    my $rangeH = Prty::OrderedHash->new;
    my $junkExpr;
   
    # Range-Definitionsdateien einlesen.

    my @files = sort Prty::Path->find($dir,-pattern=>qr/range.def$/);
    for my $file (@files) {
