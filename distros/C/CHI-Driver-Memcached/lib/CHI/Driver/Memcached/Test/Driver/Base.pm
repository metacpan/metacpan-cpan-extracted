...
$CHI::Driver::Memcached::Test::Driver::Base::VERSION = '0.16';
use strict;
use warnings;
use Moose::Role;
use CHI::t::Driver;
...
sub all_test_keys {
    my ($standard_keys) =
      CHI::Driver::Memcached::t::CHIDriverTests::Base
      ->set_standard_keys_and_values();
    my $all_test_keys = [
        values(%$standard_keys),
        CHI::Driver::Memcached::t::CHIDriverTests::Base->extra_test_keys()
    ];
