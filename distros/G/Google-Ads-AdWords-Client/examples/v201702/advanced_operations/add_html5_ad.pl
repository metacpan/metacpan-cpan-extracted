...
use Google::Ads::AdWords::v201702::Dimensions;
...
sub add_html5_ad {
  ...
  my $html5_ad = Google::Ads::AdWords::v201702::TemplateAd->new({
      name       => "Ad for HTML5",
      templateId => 419,
      finalUrls  => ["http://example.com/html5"],
      displayUrl => "www.example.com/html5",
      dimensions => Google::Ads::AdWords::v201702::Dimensions->new({
          width  => 300,
          height => 250
        })});
  ...
  my $media = Google::Ads::AdWords::v201702::TemplateElementField->new({
      name       => "Custom_layout",
      fieldMedia => $media_bundle,
      type       => "MEDIA_BUNDLE"
  });
  my $layout = Google::Ads::AdWords::v201702::TemplateElementField->new({
      name      => "layout",
      fieldText => "Custom",
      type      => "ENUM"
  });
  ...
  my $html5_ad_group_ad = Google::Ads::AdWords::v201702::AdGroupAd->new({
