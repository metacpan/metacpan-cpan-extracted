...
package Google::Ads::AdWords::v201607::AdwordsUserListService::get;
use strict;
use warnings;
...
get from the namespace https://adwords.google.com/api/adwords/rm/v201607.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201607::AdwordsUserListService::get->new($data);
