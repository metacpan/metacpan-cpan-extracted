...
package UMMF::UML_1_5::Foundation::Core::Primitive;
...
=head2 C<__validate_type>
  ...
  UMMF::UML_1_5::Foundation::Core::Primitive->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::Foundation::Core::Primitive|UMMF::UML_1_5::Foundation::Core::Primitive>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::Foundation::Core::Primitive')  ;
}


=head2 C<__typecheck>

  UMMF::UML_1_5::Foundation::Core::Primitive->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::Foundation::Core::Primitive->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::Foundation::Core::Primitive' . ": value '$x'")
    unless __validate_type($self, $x);
}


=head2 C<isaPrimitive>


Returns true if receiver is a L<UMMF::UML_1_5::Foundation::Core::Primitive|UMMF::UML_1_5::Foundation::Core::Primitive>.
...
=head2 C<isaFoundation__Core__Primitive>


Returns true if receiver is a L<UMMF::UML_1_5::Foundation::Core::Primitive|UMMF::UML_1_5::Foundation::Core::Primitive>.
Other receivers will return false.
This is the fully qualified version of the C<isaPrimitive> method.

=cut
sub isaFoundation__Core__Primitive { 1 }
...
Returns the UML Model name (C<'Foundation::Core::Primitive'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Foundation::Core::Primitive' }
...
sub __tangram_schema
{
  ...
  $__tangram_schema ||=
  {
   ...
   [
     'UMMF::UML_1_5::Foundation::Core::Primitive' =>
     {
       'table' => 'Foundation__Core__Primitive',
       'abstract' => 0,
       'slots' => 
       { 
	 # Attributes
...
sub __initialize
{
  ...
  $self->UMMF::UML_1_5::Foundation::Core::Primitive::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::Foundation::Core::Primitive::___create(@args);
