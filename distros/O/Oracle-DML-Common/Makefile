# This Makefile is for the Oracle::DML::Common extension to perl.
#
...
#	ABSTRACT => q[Common routines for Oracle DML]
#	AUTHOR => q[geotiger2001@yahoo.com]
#	DISTNAME => q[Oracle-DML-Common-0.21.tar.gz]
#	NAME => q[Oracle::DML::Common]
#	PREREQ_PM => { Test::Harness=>q[0.1], Test::More=>q[0.45] }
#	VERSION => q[0.21]
#	test => { TESTS=>q[t/Common.t] }
...
AR_STATIC_ARGS = cr
NAME = Oracle::DML::Common
DISTNAME = Oracle-DML-Common-0.21.tar.gz
NAME_SYM = Oracle_DML_Common
VERSION = 0.21
VERSION_SYM = 0_21
XS_VERSION = 0.21
INST_BIN = blib/bin
...
FULLEXT = Oracle/DML/Common
BASEEXT = Common
PARENT_NAME = Oracle::DML
DLBASE = $(BASEEXT)
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Oracle/DML
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Oracle/DML
...
TO_INST_PM = Common.pm

PM_TO_BLIB = Common.pm \
	$(INST_LIBDIR)/Common.pm
...
manifypods : pure_all Common.pm
	@$(POD2MAN) \
	Common.pm \
	$(INST_MAN3DIR)/Oracle::DML::Common.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Oracle-DML-Common-0.21.tar.gz\" VERSION=\"0,21,0,0\">\n}. qq{\t<TITLE>Oracle-DML-Common-0.21.tar.gz</TITLE>\n}. qq{\t<ABSTRACT>Common routines for Oracle DML</ABSTRACT>\n}. qq{\t<AUTHOR>geotiger2001\@yahoo.com</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"Test-Harness\" VERSION=\"0,1,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Test-More\" VERSION=\"0,45,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"sun4-solaris-64int\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Oracle-DML-Common-0.21.tar.gz.ppd
