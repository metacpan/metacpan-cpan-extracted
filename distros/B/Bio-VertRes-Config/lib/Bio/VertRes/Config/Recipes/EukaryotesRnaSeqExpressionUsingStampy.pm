package Bio::VertRes::Config::Recipes::EukaryotesRnaSeqExpressionUsingStampy;
...
Bio::VertRes::Config::Recipes::EukaryotesRnaSeqExpressionUsingStampy - Standard snp calling pipeline for bacteria
...
RNA seq expression with Stampy
   ...
   my $obj = Bio::VertRes::Config::Recipes::EukaryotesRnaSeqExpressionUsingStampy->new( 
     database => 'abc', 
