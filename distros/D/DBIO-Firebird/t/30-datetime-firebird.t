...
my $env2optdep = {
  DBIO_TEST_FIREBIRD => 'test_rdbms_firebird',
  DBIO_TEST_FIREBIRD_INTERBASE => 'test_rdbms_firebird_interbase',
  DBIO_TEST_FIREBIRD_ODBC => 'test_rdbms_firebird_odbc',
};

plan skip_all => join (' ',
  'Set $ENV{DBIO_TEST_FIREBIRD_DSN} and/or $ENV{DBIO_TEST_FIREBIRD_INTERBASE_DSN}',
  'and/or $ENV{DBIO_TEST_FIREBIRD_ODBC_DSN},',
...
for my $prefix (keys %$env2optdep) { SKIP: {
  ...
  $prefix eq 'DBIO_TEST_FIREBIRD_ODBC'
    and
