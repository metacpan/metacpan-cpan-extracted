package Chart::Plotly::Trace::Sunburst::Transform;
use Moose;
...
Chart::Plotly::Trace::Sunburst::Transform - This attribute is one of the possible options for the trace sunburst.
