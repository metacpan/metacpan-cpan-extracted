{
  ...
  first_day_of_week => 1,
  glibc_date_1_format => "%A\N{U+1361} %B %e \N{U+130d}\N{U+122d}\N{U+130b} %r %Z %Y \N{U+12a3}\N{U+12f5}",
  glibc_date_format => "%d/%m/%Y",
  glibc_datetime_format => "%A\N{U+1361} %B %e \N{U+130d}\N{U+122d}\N{U+130b} %Y %r %Z",
