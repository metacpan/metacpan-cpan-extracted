...
use DateTimeX::Lite::TimeZone::Local::Unix;
...
my @aliases = sort keys %{ DateTimeX::Lite::TimeZone::links() };
...
DateTimeX::Lite::TimeZone::Local->_load_subclass();

{
    ...
    {
        local $ENV{TZ} = $alias;
        my $tz = eval { DateTimeX::Lite::TimeZone::Local->TimeZone() };
...

{
    ...
    my $tz = DateTimeX::Lite::TimeZone::Local::Unix->FromEnv();
    is( $tz, undef,
        'invalid time zone name in $ENV{TZ} fails' );

    local $ENV{TZ} = '123/456';

    $tz = DateTimeX::Lite::TimeZone::Local::Unix->FromEnv();
    is( $tz, undef,
        'invalid time zone name in $ENV{TZ} fails' );
}

{
    ...
    local $ENV{TZ} = 0;
    $tz = eval { DateTimeX::Lite::TimeZone::Local->TimeZone() };
    is( $tz->name(), 'UTC',
...

{
    ...
    DateTimeX::Lite::TimeZone::Local::Unix->FromEnv();
...
SKIP:
{
    ...
    local *DateTimeX::Lite::TimeZone::Local::Unix::_Readlink = sub { '/usr/share/zoneinfo/US/Eastern' };

    my $tz;
    eval { $tz = DateTimeX::Lite::TimeZone::Local::Unix->FromEtcLocaltime() };
    ...
    local *DateTimeX::Lite::TimeZone::Local::Unix::_Readlink = sub { '/usr/share/zoneinfo/Foo/Bar' };

    $tz = DateTimeX::Lite::TimeZone::Local::Unix->FromEtcLocaltime() ;
    is( $@, '', 'valid time zone name in /etc/localtime symlink should not leave $@ set' );
    ok( ! $tz, 'no time zone was found' );


    local *DateTimeX::Lite::TimeZone::Local::Unix::_Readlink = sub { undef };
    local *DateTimeX::Lite::TimeZone::Local::Unix::_FindMatchingZoneinfoFile = sub { 'America/Los_Angeles' };
...
SKIP:
{
    ...
    local *DateTimeX::Lite::TimeZone::Local::Unix::_ReadEtcSysconfigClock = sub { 'US/Eastern' };

    my $tz;
    eval { $tz = DateTimeX::Lite::TimeZone::Local::Unix->FromEtcSysconfigClock() };
...
SKIP:
{
    ...
    local *DateTimeX::Lite::TimeZone::Local::Unix::_ReadEtcDefaultInit = sub { 'Asia/Tokyo' };

    my $tz;
    eval { $tz = DateTimeX::Lite::TimeZone::Local::Unix->FromEtcDefaultInit() };
...
SKIP:
{
...

    {
        ...
        my $tz;
        eval { $tz = DateTimeX::Lite::TimeZone::Local->TimeZone() };
    ...
    {
        local *DateTimeX::Lite::TimeZone::Local::Unix::FromEtcLocaltime = sub { undef };
...

    {
        ...
        local *DateTimeX::Lite::TimeZone::Local::Unix::FromEtcLocaltime = sub { undef };
        local *DateTimeX::Lite::TimeZone::Local::Unix::FromEtcTimezone = sub { undef };
        local *DateTimeX::Lite::TimeZone::Local::Unix::FromEtcTIMEZONE = sub { undef };
...
SKIP:
{
    ...
    DateTimeX::Lite::TimeZone::Local::Unix->FromEtcTimezone();
...
SKIP:
{
...

    {
        ...
        $tz = DateTimeX::Lite::TimeZone::Local->TimeZone();
...

{
    ...
    my $tz = eval { DateTimeX::Lite::TimeZone->load( name => 'local' ) };
    is( $tz->name(), 'Australia/Melbourne',
...
SKIP:
{
    ...
    is( basename( DateTimeX::Lite::TimeZone::Local::Unix->_Readlink( $third ) ),
        basename( $first ),
