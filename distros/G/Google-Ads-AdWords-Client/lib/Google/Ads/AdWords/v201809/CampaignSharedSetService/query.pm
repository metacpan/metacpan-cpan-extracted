...
package Google::Ads::AdWords::v201809::CampaignSharedSetService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::CampaignSharedSetService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201809::CampaignSharedSetService::query->new($data);
