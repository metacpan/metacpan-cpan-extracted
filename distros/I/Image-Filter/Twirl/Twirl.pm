...
$VERSION = 0.07;
package Image::Filter::Twirl;
bootstrap Image::Filter::Twirl;

1;
__END__
=head1 NAME

Image::Filter::Twirl - Rotate an image funny
...
=head1 SYNOPSIS
    ...
    $image = $image->filter("twirl"); #Load Image::Filter::Twirl
    $image->Jpeg("test.jpg"); 

=head1 DESCRIPTION

Image::Filter is a perl module that can apply image filters. This module
implements a funny image rotation. It uses the gd lib from Thomas 
