...
module_boilerplate_ok('bin/bem-static');
module_boilerplate_ok('lib/Data/Context/BEM.pm');
module_boilerplate_ok('lib/Data/Context/BEM/Instance.pm');
module_boilerplate_ok('lib/Data/Context/BEM/Block.pm');
module_boilerplate_ok('lib/Data/Context/BEM/Block/Page.pm');
module_boilerplate_ok('lib/Data/Context/BEM/Merge.pm');
