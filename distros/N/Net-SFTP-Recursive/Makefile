# This Makefile is for the Net::SFTP::Recursive extension to perl.
#
...
FULLEXT = Net/SFTP/Recursive
BASEEXT = Recursive
PARENT_NAME = Net::SFTP
DLBASE = $(BASEEXT)
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Net/SFTP
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Net/SFTP
...
TO_INST_PM = Recursive.pm

PM_TO_BLIB = Recursive.pm \
	$(INST_LIBDIR)/Recursive.pm
...
manifypods : pure_all Recursive.pm
	@$(POD2MAN) \
	Recursive.pm \
	$(INST_MAN3DIR)/Net::SFTP::Recursive.$(MAN3EXT)
...
installdeps ::
	$(PERL) Makefile.PL --config= --installdeps=File::Stat::Ls,0.1
