...
Google::Cloud::Metastore::V1::DataprocMetastoreClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Metastore::V1::DataprocMetastoreClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Metastore::V1::DataprocMetastoreClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Metastore::V1::DataprocMetastoreClient> is an auto-generated client library for Google Cloud Services.
