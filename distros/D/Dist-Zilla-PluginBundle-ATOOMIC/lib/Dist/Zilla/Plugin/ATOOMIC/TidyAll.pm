package Dist::Zilla::Plugin::ATOOMIC::TidyAll;
...
Dist::Zilla::Plugin::ATOOMIC::TidyAll - Creates default tidyall.ini, perltidyrc, and perlcriticrc files if they don't yet exist
