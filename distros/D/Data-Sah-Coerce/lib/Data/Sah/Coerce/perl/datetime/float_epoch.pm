...
Data::Sah::Coerce::perl::datetime::float_epoch - Coerce datetime from number (assumed to be epoch)

=head1 VERSION

This document describes version 0.033 of Data::Sah::Coerce::perl::datetime::float_epoch (from Perl distribution Data-Sah-Coerce), released on 2019-01-26.
