...
Sah::SchemaR::perl::modulefeatures::modname - Perl module in the Module::Features::* namespace, without the namespace prefix, e.g. "TextLabel"

=head1 VERSION

This document describes version 0.001 of Sah::SchemaR::perl::modulefeatures::modname (from Perl distribution Sah-Schemas-ModuleFeatures), released on 2021-02-22.
