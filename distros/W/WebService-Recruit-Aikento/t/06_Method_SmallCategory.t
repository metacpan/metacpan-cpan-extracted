#
# Test case for WebService::Recruit::Aikento::SmallCategory
#
...
my $service = new WebService::Recruit::Aikento::SmallCategory();

ok( ref $service, 'new WebService::Recruit::Aikento::SmallCategory()' );
...
# Test[0]
{
    ...
    my $res = new WebService::Recruit::Aikento::SmallCategory();
