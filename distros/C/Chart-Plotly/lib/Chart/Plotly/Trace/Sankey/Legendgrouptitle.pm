package Chart::Plotly::Trace::Sankey::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Sankey::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Sankey::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Sankey::Legendgrouptitle - This attribute is one of the possible options for the trace sankey.
