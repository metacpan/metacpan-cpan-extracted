...
package Google::Ads::AdWords::v201609::ConstantDataService::getProductBiddingCategoryData;
use strict;
use warnings;
...
getProductBiddingCategoryData from the namespace https://adwords.google.com/api/adwords/cm/v201609.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201609::ConstantDataService::getProductBiddingCategoryData->new($data);
