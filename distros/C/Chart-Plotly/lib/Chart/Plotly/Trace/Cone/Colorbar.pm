package Chart::Plotly::Trace::Cone::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Cone::Colorbar::Tickfont;
use Chart::Plotly::Trace::Cone::Colorbar::Tickformatstop;
use Chart::Plotly::Trace::Cone::Colorbar::Titlefont;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Cone::Colorbar::Tickfont", );
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Cone::Colorbar::Tickformatstop]", );
...
has titlefont => ( is  => "rw",
                   isa => "Maybe[HashRef]|Chart::Plotly::Trace::Cone::Colorbar::Titlefont", );
...
Chart::Plotly::Trace::Cone::Colorbar - This attribute is one of the possible options for the trace cone.
