...
Cfn::Resource::AWS::EC2::SubnetCidrBlock - Cfn resource for AWS::EC2::SubnetCidrBlock

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::EC2::SubnetCidrBlock.
