# AWS::IAM::AccessKey generated from spec 14.3.0
...
Cfn::Resource::AWS::IAM::AccessKey - Cfn resource for AWS::IAM::AccessKey

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::IAM::AccessKey.
