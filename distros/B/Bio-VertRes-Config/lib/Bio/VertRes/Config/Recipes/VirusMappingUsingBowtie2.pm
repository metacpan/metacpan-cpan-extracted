package Bio::VertRes::Config::Recipes::VirusMappingUsingBowtie2;
...
override '_pipeline_configs' => sub {
    ...
    $self->add_virus_bowtie2_mapping_config(\@pipeline_configs);
...
Bio::VertRes::Config::Recipes::VirusMappingUsingBowtie2 - Standard snp calling pipeline for virus
...
Standard snp calling pipeline for virus.
   ...
   my $obj = Bio::VertRes::Config::Recipes::VirusMappingUsingBowtie2->new( 
     database => 'abc', 
