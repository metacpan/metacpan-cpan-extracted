...
(This example is included as L<F<synopsis.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.47/examples/synopsis.pl> in the distribution.)


=head1 VERSION

This document describes Image::PNG::Libpng version 0.47, corresponding to git commit L<bacc581807af81359e3a430444c394c080bfeeb2|https://github.com/benkasminbullock/image-png-libpng/commit/bacc581807af81359e3a430444c394c080bfeeb2> at Thu Sep 17 15:26:53 2020 +0900.
...
(This example is included as L<F<get-www-png.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.47/examples/get-www-png.pl> in the distribution.)
...
(This example is included as L<F<png-cgi.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.47/examples/png-cgi.pl> in the distribution.)
...
(This example is included as L<F<copy-png.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.47/examples/copy-png.pl> in the distribution.)
...
(This example is included as L<F<color-type-name.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.47/examples/color-type-name.pl> in the distribution.)
...
you can find each instance L<in the file C<perl-libpng.c> in the top directory of the distribution|http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.47/perl-libpng.c> in the macro
C<UNUSED_ZERO_ARG>.
...
=item Row %d is %d bytes, which is too long; truncating to %d
