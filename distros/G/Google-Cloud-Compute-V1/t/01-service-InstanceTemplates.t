...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::InstanceTemplate Google::Cloud::Compute::V1::Compute::InstanceTemplateAggregatedList Google::Cloud::Compute::V1::Compute::InstanceTemplateList Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::Policy Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::InstanceTemplatesClient->new( credentials => 'dummy' );
