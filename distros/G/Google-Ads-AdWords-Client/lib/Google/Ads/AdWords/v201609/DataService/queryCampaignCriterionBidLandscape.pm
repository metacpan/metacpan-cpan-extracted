...
package Google::Ads::AdWords::v201609::DataService::queryCampaignCriterionBidLandscape;
use strict;
use warnings;
...
queryCampaignCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201609.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201609::DataService::queryCampaignCriterionBidLandscape->new($data);
