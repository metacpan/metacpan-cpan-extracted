...
=item Script incremental build supports configuration overwrite (todo)
...
Per-activity goals are experimental starting with 0.2.7.  Support from the commandline is being considered.
