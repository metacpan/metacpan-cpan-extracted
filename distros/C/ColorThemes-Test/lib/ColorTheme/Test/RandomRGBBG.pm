...
1;
# ABSTRACT: A color theme which gives random RGB background colors
...
ColorTheme::Test::RandomRGBBG - A color theme which gives random RGB background colors

=head1 VERSION

This document describes version 0.007 of ColorTheme::Test::RandomRGBBG (from Perl distribution ColorThemes-Test), released on 2021-08-01.
