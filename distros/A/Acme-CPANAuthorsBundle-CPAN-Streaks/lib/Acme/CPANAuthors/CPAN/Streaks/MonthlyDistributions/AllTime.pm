package Acme::CPANAuthors::CPAN::Streaks::MonthlyDistributions::AllTime;
...
1;
# ABSTRACT: Authors with all-time monthly distributions streak (release a new [for them] distribution every month)
...
Acme::CPANAuthors::CPAN::Streaks::MonthlyDistributions::AllTime - Authors with all-time monthly distributions streak (release a new [for them] distribution every month)

=head1 VERSION

This document describes version 20240101.0 of Acme::CPANAuthors::CPAN::Streaks::MonthlyDistributions::AllTime (from Perl distribution Acme-CPANAuthorsBundle-CPAN-Streaks), released on 2024-01-01.
...
Current standings (as of 2024-01-01, produced by L<cpan-streaks>, only streaks with length of at least 6 are included):
  ...
  | TIMLEGGE  |   6 | 2023-06    | 2023-11  | broken      |
  +-----------+-----+------------+----------+-------------+
