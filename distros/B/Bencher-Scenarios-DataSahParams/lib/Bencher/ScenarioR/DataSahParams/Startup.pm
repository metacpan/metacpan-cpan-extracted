package Bencher::ScenarioR::DataSahParams::Startup;
  ...
  [
    ...
    ],
    {
      "func.bencher_args"              => {
                                            ...
                                            scenario_module => "DataSahParams::Startup",
                                          },
      ...
      "func.elapsed_time"              => 1.39719986915588,
      "func.module_startup"            => undef,
      "func.module_versions"           => {
                                            "__PACKAGE__" => 1.034,
                                            "Bencher::Scenario::DataSahParams::Startup" => undef,
                                            "Benchmark::Dumb" => "0.10",
      ...
      "func.precision"                 => 0,
      "func.scenario_module"           => "Bencher::Scenario::DataSahParams::Startup",
      "func.scenario_module_md5sum"    => "ff8cb88f30c0640b0becc20e21f6d963",
      "func.scenario_module_mtime"     => 1464242472,
      "func.scenario_module_sha1sum"   => "3ab9c2d75e868ed77a03fc51a324acf49e54c666",
      "func.scenario_module_sha256sum" => "5e7a3d9e1254bd2c2896481279e021a5de8823eac85ab1d1f505ce3966f49daa",
      "func.time_end"                  => 1485329207.64075,
      "func.time_factor"               => 1000,
      "func.time_start"                => 1485329206.24355,
