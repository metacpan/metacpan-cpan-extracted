...
Perl::Examples::Accessors::Moose

=head1 VERSION

This document describes version 0.132 of Perl::Examples::Accessors::Moose (from Perl distribution Perl-Examples-Accessors), released on 2021-08-03.

=head1 DESCRIPTION

This is an example of a class which uses L<Moose>. It is hash-based.
