...
the source repository: L<https://github.com/briandfoy/test-env>
...
=item * L<https://bitbucket.com/briandfoy/test-env>

=item * L<https://codeberg.org/briandfoy/test-env>

=item * L<https://gitlab.com/briandfoy/test-env>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify Test-Env-1.23.tar.gz --owner briandfoy
