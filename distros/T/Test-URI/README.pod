...
=for HTML <a href="https://www.github.com/briandfoy/test-uri/actions?query=workflow%3Amacos"><img src="https://www.github.com/briandfoy/test-uri/workflows/macos/badge.svg"></a>

=for HTML <a href="https://www.github.com/briandfoy/test-uri/actions?query=workflow%3Aubuntu"><img src="https://www.github.com/briandfoy/test-uri/workflows/ubuntu/badge.svg"></a>

=for HTML <a href="https://www.github.com/briandfoy/test-uri/actions?query=workflow%3Awindows"><img src="https://www.github.com/briandfoy/test-uri/workflows/windows/badge.svg"></a>

=for HTML <a href='https://ci.appveyor.com/project/briandfoy/test-uri'><img src='https://ci.appveyor.com/api/projects/status/ob4713nm18ab9mkw?svg=true' /></a>

=for HTML <a href='https://coveralls.io/github/briandfoy/test-uri?branch=master'><img src='https://coveralls.io/repos/github/briandfoy/test-uri/badge.svg?branch=master' alt='Coverage Status' /></a>

=for HTML <a href="https://github.com/briandfoy/test-uri/blob/master/LICENSE"><img src="https://img.shields.io/cpan/l/Test-URI.svg" /></a>

=for HTML <a href="https://metacpan.org/pod/Test::URI"><img src="https://img.shields.io/cpan/v/Test-URI.svg" /></A>

=head1 The Test::URI module

This is the I<README> for the L<Test::URI> Perl module. You're probably
...
To read about L<Test::URI>, look at the embedded documentation
in the module itself. Inside the distribution, you can format it
with L<perldoc|https://perldoc.perl.org/perldoc.html>:

	% perldoc lib/Test/URI.pm
...
L<MetaCPAN|https://metacpan.org/pod/Test::URI>.
...
the source repository: L<https://github.com/briandfoy/test-uri>

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/briandfoy/test-uri/issues>.
...
=item * L<https://bitbucket.com/briandfoy/test-uri>

=item * L<https://codeberg.org/briandfoy/test-uri>

=item * L<https://gitlab.com/briandfoy/test-uri>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify Test-URI-1.23.tar.gz --owner briandfoy
