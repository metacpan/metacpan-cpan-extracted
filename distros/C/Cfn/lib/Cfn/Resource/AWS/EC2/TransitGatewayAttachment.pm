# AWS::EC2::TransitGatewayAttachment generated from spec 34.0.0
...
package Cfn::Resource::AWS::EC2::TransitGatewayAttachment {
  ...
  sub supported_regions {
    [ 'af-south-1','ap-northeast-1','ap-northeast-2','ap-south-1','ap-southeast-1','ap-southeast-2','ca-central-1','eu-central-1','eu-south-1','eu-west-1','eu-west-2','eu-west-3','sa-east-1','us-east-1','us-east-2','us-gov-east-1','us-gov-west-1','us-west-1','us-west-2' ]
  }
}
...
Cfn::Resource::AWS::EC2::TransitGatewayAttachment - Cfn resource for AWS::EC2::TransitGatewayAttachment

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::EC2::TransitGatewayAttachment.
