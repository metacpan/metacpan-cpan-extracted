package Microsoft::AdCenter::V8::CampaignManagementService::Test::MigrationStatusInfo;
...
use Microsoft::AdCenter::V8::CampaignManagementService::MigrationStatusInfo;

sub test_can_create_migration_status_info_and_set_all_fields : Test(4) {
    my $migration_status_info = Microsoft::AdCenter::V8::CampaignManagementService::MigrationStatusInfo->new
