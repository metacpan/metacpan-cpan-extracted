package Bencher::Scenarios::ArchiveTarModules;

our $DATE = '2017-01-25'; # DATE
our $VERSION = '0.002'; # VERSION

1;
# ABSTRACT: Scenarios to benchmark Archive::Tar modules
...
Bencher::Scenarios::ArchiveTarModules - Scenarios to benchmark Archive::Tar modules

=head1 VERSION

This document describes version 0.002 of Bencher::Scenarios::ArchiveTarModules (from Perl distribution Bencher-Scenarios-ArchiveTarModules), released on 2017-01-25.
...
=item * L<Bencher::Scenario::ArchiveTarModules::ListMemUsage>
