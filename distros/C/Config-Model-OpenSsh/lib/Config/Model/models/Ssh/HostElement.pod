...
This configuration class was generated from ssh_system documentation.
...
in matching B<Host> and B<Match> stanzas. I< Optional. Type enum. choice: 'no', 'yes', 'always'.  > 
...
challenge-response authentication. The argument to this
keyword must be B<yes> (the default) or B<no>. I< Optional. Type boolean.  > 
...
in the process, regardless of the setting of
B<StrictHostKeyChecking>. If the option is set to
B<no>, the check will not be executed. I< Optional. Type boolean.  > 
...
using the default system TCP timeout. This value is used
only when the target is down or really unreachable, not when
it refuses the connection. I< Optional. Type integer.  > 
...
placed in a directory that is not writable by other users.
This ensures that shared connections are uniquely
identified. I< Optional. Type uniline.  > 
...
to this keyword must be B<yes> or B<no> (the
default). This option is intended for situations where
ssh-agent offers many different identities. I< Optional. Type boolean.  > 
...
from all interfaces. I< Optional. Type list of node of class L<Ssh::PortForward|Config::Model::models::Ssh::PortForward> .  > 
...
PKCS#11 token providing the user’s private RSA
...
the other from taking effect. I< Optional. Type list of uniline.  > 
...
B<default none>, which means that rekeying is performed
after the cipher’s default amount of data has been
sent or received and no time based rekeying is done. I< Optional. Type uniline.  > 
...
use for the user host key database, separated by whitespace.
The default is I<~/.ssh/known_hosts>,
I<~/.ssh/known_hosts2>. I< Optional. Type uniline.  > 
