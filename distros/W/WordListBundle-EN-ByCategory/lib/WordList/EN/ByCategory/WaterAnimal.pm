package WordList::EN::ByCategory::WaterAnimal;
...
our %STATS = ("shortest_word_len",3,"num_words_contain_whitespace",13,"longest_word_len",18,"num_words_contain_unicode",0,"num_words_contains_nonword_chars",14,"num_words_contains_unicode",0,"num_words_contains_whitespace",13,"avg_word_len",7.57692307692308,"num_words",104,"num_words_contain_nonword_chars",14); # STATS

1;
# ABSTRACT: List of water animals in English
...
WordList::EN::ByCategory::WaterAnimal - List of water animals in English

=head1 VERSION

This document describes version 0.001 of WordList::EN::ByCategory::WaterAnimal (from Perl distribution WordListBundle-EN-ByCategory), released on 2025-01-14.

=head1 SYNOPSIS

 use WordList::EN::ByCategory::WaterAnimal;

 my $wl = WordList::EN::ByCategory::WaterAnimal->new;
