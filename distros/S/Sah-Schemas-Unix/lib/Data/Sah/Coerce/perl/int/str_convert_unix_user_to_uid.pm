...
Data::Sah::Coerce::perl::int::str_convert_unix_user_to_uid - Convert Unix username into UID

=head1 VERSION

This document describes version 0.004 of Data::Sah::Coerce::perl::int::str_convert_unix_user_to_uid (from Perl distribution Sah-Schemas-Unix), released on 2019-07-12.
