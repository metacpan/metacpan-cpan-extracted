package Chart::Plotly::Trace::Parcats::Tickfont;
use Moose;
...
has description => ( is      => "ro",
                     default => "Sets the font for the `category` labels.", );
...
Chart::Plotly::Trace::Parcats::Tickfont - This attribute is one of the possible options for the trace parcats.
