package Data::Sah::Filter::perl::Array::uniq;
...
sub meta {
    +{
        v => 1,
        summary => 'Make an array uniq using List::Util\'s uniq()',
        target_type => 'array',
        args => {
        },
        examples => [
...
1;
# ABSTRACT: Make an array uniq using List::Util's uniq()
...
Data::Sah::Filter::perl::Array::uniq - Make an array uniq using List::Util's uniq()

=head1 VERSION

This document describes version 0.016 of Data::Sah::Filter::perl::Array::uniq (from Perl distribution Data-Sah-Filter), released on 2023-04-25.

=head1 SYNOPSIS

=head2 Using in Sah schema's C<prefilters> (or C<postfilters>) clause

 ["array","prefilters",[["Array::uniq"]]]

=head2 Using with L<Data::Sah>:

 use Data::Sah qw(gen_validator);
 
 my $schema = ["array","prefilters",[["Array::uniq"]]];
...
=head2 Using with L<Data::Sah:Filter> directly:
 ...
 my $filter = gen_filter([["Array::uniq"]]);
...
=head2 Sample data and filtering results
 ...
 [] # valid, unchanged
 ["a","b"] # valid, unchanged
 ["a","b","a","a","c","b"] # valid, becomes ["a","b","c"]
...
L<Data::Sah::Filter::perl::Array::uniqnum>, L<Data::Sah::Filter::perl::Array::uniqstr>.
