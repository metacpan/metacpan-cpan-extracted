package CloudApp::REST::Item::Image;
...
CloudApp::REST::Item::Image - Image item class of CloudApp::REST

=cut

has item_type => (is => 'ro', required => 1, isa => 'Str', default => 'image',);
...
Image item class of CloudApp::REST.

=head1 ATTRIBUTES

See L<CloudApp::REST::Item> for common attributes and methods of all items.
The attributes listed here are only accessible for image items.
