...
[Security Advisories](https://github.com/pmqs/Compress-Raw-Bzip2/security/advisories).
(If you do not have access to GitHub, then you can report issues via email
to <pmqs@cpan.org>.)

The latest version of the Security Policy can be found in the
[git repository for Compress::Raw::Bzip2](https://github.com/pmqs/Compress-Raw-Bzip2/blob/main/SECURITY.md).
...
Any security vulnerabilities in Compress::Raw::Bzip2 are covered by this policy.
