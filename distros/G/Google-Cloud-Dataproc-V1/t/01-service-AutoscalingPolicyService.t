...
BEGIN {
    for my $pkg (qw( Google::Cloud::Dataproc::V1::AutoscalingPolicies::AutoscalingPolicy )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Dataproc::V1::AutoscalingPolicyServiceClient->new( credentials => 'dummy' );
