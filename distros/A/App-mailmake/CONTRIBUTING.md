...
I welcome any contribution to App::mailmake, including, but not limited to bug reports, feature requests, general comments, and patches.

Feel free to clone it from its gitlab repository at <https://gitlab.com/jackdeguest/App-mailmake> and issue a pull request.
...
File [an issue on bug tracker](https://gitlab.com/jackdeguest/App-mailmake/issues) if you think you've found a bug. Please describe
...
Issues are currently reported using CPAN [bug tracker](https://gitlab.com/jackdeguest/App-mailmake/issues)

## More information

Please refer to the [README](https://metacpan.org/source/JDEGUEST/App-mailmake-v0.1.1/README.md)
