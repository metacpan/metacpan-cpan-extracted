package Google::Ads::AdWords::v201607::CategoryProductsAndServicesSearchParameter;
use strict;
use warnings;
...
CategoryProductsAndServicesSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201607.
