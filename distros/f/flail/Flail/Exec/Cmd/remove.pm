...
Flail::Exec::Cmd::remove - Flail "remove" command

=head1 VERSION

  Time-stamp: <2006-12-03 11:04:31 attila@stalphonsos.com>

=head1 SYNOPSIS

  use Flail::Exec::Cmd::remove;
  blah;
...
package Flail::Exec::Cmd::remove;
use strict;
use Carp;
use Flail::Utils;
use base qw(Exporter);
use vars qw(@EXPORT @EXPORT_OK %EXPORT_TAGS);
@EXPORT_OK = qw(flail_remove);
@EXPORT = ();
