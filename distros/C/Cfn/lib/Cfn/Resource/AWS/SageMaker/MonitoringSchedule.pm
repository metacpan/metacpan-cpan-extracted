# AWS::SageMaker::MonitoringSchedule generated from spec 22.0.0
...
package Cfn::Resource::AWS::SageMaker::MonitoringSchedule {
  ...
  sub AttributeList {
    [ 'CreationTime','LastModifiedTime','MonitoringScheduleArn' ]
  }
...
package Cfn::Resource::Properties::Object::AWS::SageMaker::MonitoringSchedule::MonitoringScheduleConfig {
  ...
  has MonitoringJobDefinition => (isa => 'Cfn::Resource::Properties::AWS::SageMaker::MonitoringSchedule::MonitoringJobDefinition', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
  has MonitoringJobDefinitionName => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
  has MonitoringType => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
...
package Cfn::Resource::Properties::AWS::SageMaker::MonitoringSchedule {
  ...
  has MonitoringScheduleName => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, required => 1, traits => [ 'CfnMutability' ], mutability => 'Immutable');
