package Chart::Plotly::Trace::Histogram::Xbins::ImpliedEdits;
use Moose;
...
Chart::Plotly::Trace::Histogram::Xbins::ImpliedEdits - This attribute is one of the possible options for the trace histogram.
