...
https://metacpan.org/release/Stepford

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Stepford
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Stepford
...
The code for this distribution is [hosted at GitHub](https://github.com/maxmind/Stepford).
...
can submit an issue report [via the web](https://github.com/maxmind/Stepford/issues)
.
