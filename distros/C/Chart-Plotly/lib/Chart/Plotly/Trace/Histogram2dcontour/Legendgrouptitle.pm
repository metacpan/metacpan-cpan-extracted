package Chart::Plotly::Trace::Histogram2dcontour::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Histogram2dcontour::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram2dcontour::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Histogram2dcontour::Legendgrouptitle - This attribute is one of the possible options for the trace histogram2dcontour.
