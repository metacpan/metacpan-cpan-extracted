...
package Prty::Confluence::Markup::Test;
...
sub test_loadClass : Init(1) {
    shift->useOk('Prty::Confluence::Markup');
}
...
sub test_fmt : Test(2) {
    ...
    my $text = 'Ein Test';
    my $val = Prty::Confluence::Markup->fmt('bold',$text);
    $self->is($val,"*$text*");

    $val = Prty::Confluence::Markup->fmt('red',$text);
...
package main;
Prty::Confluence::Markup::Test->runTests;
