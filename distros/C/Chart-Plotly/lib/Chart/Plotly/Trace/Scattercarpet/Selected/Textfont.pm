package Chart::Plotly::Trace::Scattercarpet::Selected::Textfont;
use Moose;
...
Chart::Plotly::Trace::Scattercarpet::Selected::Textfont - This attribute is one of the possible options for the trace scattercarpet.
