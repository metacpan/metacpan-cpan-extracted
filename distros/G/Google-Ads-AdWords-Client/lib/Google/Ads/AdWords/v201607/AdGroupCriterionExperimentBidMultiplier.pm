package Google::Ads::AdWords::v201607::AdGroupCriterionExperimentBidMultiplier;
use strict;
use warnings;
...
AdGroupCriterionExperimentBidMultiplier from the namespace https://adwords.google.com/api/adwords/cm/v201607.
