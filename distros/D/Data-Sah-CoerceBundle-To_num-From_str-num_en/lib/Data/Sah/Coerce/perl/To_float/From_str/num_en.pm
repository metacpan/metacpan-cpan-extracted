package Data::Sah::Coerce::perl::To_float::From_str::num_en;
...
Data::Sah::Coerce::perl::To_float::From_str::num_en - Parse number using Parse::Number::EN

=head1 VERSION

This document describes version 0.005 of Data::Sah::Coerce::perl::To_float::From_str::num_en (from Perl distribution Data-Sah-CoerceBundle-To_num-From_str-num_en), released on 2019-11-28.

=head1 SYNOPSIS

To use in a Sah schema:

 ["float",{"x.perl.coerce_rules"=>["From_str::num_en"]}]
