package Chart::Plotly::Trace::Treemap::Marker::Pad;
use Moose;
...
has b => ( is            => "rw",
           isa           => "Num",
           documentation => "Sets the padding form the bottom (in px).",
);

has l => ( is            => "rw",
           isa           => "Num",
           documentation => "Sets the padding form the left (in px).",
);

has r => ( is            => "rw",
           isa           => "Num",
           documentation => "Sets the padding form the right (in px).",
);

has t => ( is            => "rw",
           isa           => "Num",
           documentation => "Sets the padding form the top (in px).",
);
...
Chart::Plotly::Trace::Treemap::Marker::Pad - This attribute is one of the possible options for the trace treemap.
