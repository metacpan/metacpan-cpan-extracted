# Contributing to PDF-Reuse-OverlayChart

Thank you for considering contributing!

## How to Contribute

1. **Report Bugs** - Open an issue at https://github.com/cnighswonger/PDF-Reuse-OverlayChart/issues
...
```bash
git clone https://github.com/cnighswonger/PDF-Reuse-OverlayChart.git
cd PDF-Reuse-OverlayChart
perl Makefile.PL
make
make test
```
