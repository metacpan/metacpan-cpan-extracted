package Google::Ads::AdWords::v201809::ForwardCompatibilityError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201809::ForwardCompatibilityError::Reason',
    },
    {
...
Google::Ads::AdWords::v201809::ForwardCompatibilityError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ForwardCompatibilityError from the namespace https://adwords.google.com/api/adwords/cm/v201809.

A ForwardComptibilityError represents possible errors when using the forwardCompatibilityMap in some of the common services. 
