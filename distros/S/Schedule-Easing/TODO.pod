...
C<schedule-easing.pl --timestamps> should work.

=head2 Function support

Functions are available but the configuration does not currently support specifying functions other than Linear for easing.

=head2 Expiration warnings

The C<expired> and C<warnExpired> behaviors may not be consistent.
