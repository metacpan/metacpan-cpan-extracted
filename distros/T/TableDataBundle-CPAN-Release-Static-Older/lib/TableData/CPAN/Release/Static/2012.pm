package ## no critic: Modules::RequireFilenameMatchesPackage
    # hide from PAUSE
    TableDataRole::CPAN::Release::Static::2012;
...
around new => sub {
    ...
    my $filename = File::Basename::dirname(__FILE__) . '/../../../../../share/2012.csv';
    unless (-f $filename) {
        require File::ShareDir;
        $filename = File::ShareDir::dist_file('TableDataBundle-CPAN-Release-Static-Older', '2012.csv');
    }
    $orig->(@_, filename=>$filename);
};

package TableData::CPAN::Release::Static::2012;
...
with 'TableDataRole::CPAN::Release::Static::2012';

our %STATS = ("num_columns",9,"num_rows",22623); # STATS

1;
# ABSTRACT: CPAN releases for the year 2012
...
TableDataRole::CPAN::Release::Static::2012 - CPAN releases for the year 2012

=head1 VERSION

This document describes version 20210927.0 of TableDataRole::CPAN::Release::Static::2012 (from Perl distribution TableDataBundle-CPAN-Release-Static-Older), released on 2021-09-27.

=head1 SYNOPSIS

 use TableData::CPAN::Release::Static::2012;

 my $td = TableData::CPAN::Release::Static::2012->new;
