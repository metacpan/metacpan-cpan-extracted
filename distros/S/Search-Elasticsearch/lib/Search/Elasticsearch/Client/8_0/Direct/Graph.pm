...
$Search::Elasticsearch::Client::8_0::Direct::Graph::VERSION = '8.00';
use Moo;
...
Search::Elasticsearch::Client::8_0::Direct::Graph - Plugin providing Graph API for Search::Elasticsearch 8.x
