...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::Policy Google::Cloud::Compute::V1::Compute::Subnetwork Google::Cloud::Compute::V1::Compute::SubnetworkAggregatedList Google::Cloud::Compute::V1::Compute::SubnetworkList Google::Cloud::Compute::V1::Compute::TestPermissionsResponse Google::Cloud::Compute::V1::Compute::UsableSubnetworksAggregatedList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::SubnetworksClient->new( credentials => 'dummy' );
