...
our $rschema = ["str",[{match=>"\\A(?:/|/?(?:[^/\\0]{1,255})(?:/[^/\\0]{1,255})?)\\z",summary=>"Filesystem file name on a Unix system","x.perl.coerce_rules"=>["From_str::strip_slashes"]},{description=>"\nThis is just a convenient alias for filename::unix.\n\n",summary=>"File name (with optional path) on a Unix system"}],["filename::unix","str"]];
...
This document describes version 0.009 of Sah::SchemaR::unix::filename (from Perl distribution Sah-Schemas-Unix), released on 2019-12-09.
