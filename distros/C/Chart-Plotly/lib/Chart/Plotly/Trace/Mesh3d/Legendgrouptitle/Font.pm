package Chart::Plotly::Trace::Mesh3d::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Mesh3d::Legendgrouptitle::Font - This attribute is one of the possible options for the trace mesh3d.
