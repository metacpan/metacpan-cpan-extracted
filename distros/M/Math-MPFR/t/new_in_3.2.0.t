...
if(!defined(MPFR_VERSION) || 197120 > MPFR_VERSION) {$have_new = 0} # mpfr version is pre 3.2.0
...
if($have_new) {
  ...
  if($@ =~ /^Rmpfr_fmodquo not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 1\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 1\n";
  }
...
if($write) {
  ...
  if($@) {
    if($@ =~ /^Rmpfr_fpif_export not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 2\n"}
    else {
      warn "\n\$\@:\n$@\n";
      print "not ok 2\n";
    }
...
if($read) {
  ...
  if($@) {
    if($@ =~ /^Rmpfr_fpif_import not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 3\n"}
    else {
      warn "\n\$\@:\n$@\n";
      print "not ok 3\n";
    }
...
if($have_new) {
  ...
  if($@ =~ /^Rmpfr_flags_clear not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 4\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 4\n";
  }
  ...
  if($@ =~ /^Rmpfr_flags_set not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 5\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 5\n";
  }
  ...
  if($@ =~ /^Rmpfr_flags_test not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 6\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 6\n";
  }
  ...
  if($@ =~ /^Rmpfr_flags_save not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 7\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 7\n";
  }
  ...
  if($@ =~ /^Rmpfr_flags_restore not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 8\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 8\n";
  }
...
if($have_new) {
  ...
  if($@ =~ /^Rmpfr_rint_roundeven not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 24\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 24\n";
  }
...
if($have_new) {
  ...
  if($@ =~ /^Rmpfr_rint_roundeven not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 25\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 25\n";
  }
...
if($have_new) {
  ...
  if($@ =~ /^Rmpfr_roundeven not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 26\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 26\n";
  }
...
if($have_new) {
  ...
  if($@ =~ /^Rmpfr_roundeven not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 27\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 27\n";
  }
...
if($have_new) {
  ...
  if($@ =~ /^Rmpfr_nrandom not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 28\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 28\n";
  }
...
if($have_new) {
  ...
  if($@ =~ /^Rmpfr_erandom not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 29\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 29\n";
  }
...
if($have_new) {
  ...
  if($@ =~ /^Rmpfr_fmma not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 30\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 30\n";
  }
...
if($have_new) {
  ...
  if($@ =~ /^Rmpfr_fmms not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 31\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 31\n";
  }
...
if($have_new) {
  ...
  if($@ =~ /^Rmpfr_log_ui not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 32\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 32\n";
  }
...
if($have_new) {
  ...
  if($@ =~ /^Rmpfr_gamma_inc not implemented \- need at least mpfr\-3\.2\.0/) {print "ok 33\n"}
  else {
    warn "\n\$\@:\n$@\n";
    print "not ok 33\n";
  }
