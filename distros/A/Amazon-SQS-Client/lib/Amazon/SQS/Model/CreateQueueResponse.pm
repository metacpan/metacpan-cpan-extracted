...
package Amazon::SQS::Model::CreateQueueResponse;
...
use base qw (Amazon::SQS::Model);
    ...
    #
    # Amazon::SQS::Model::CreateQueueResponse
    # 
    # Properties:
    #
    # 
    # CreateQueueResult: Amazon::SQS::Model::CreateQueueResult
    ...
    sub fromXML {
        ...
        return new Amazon::SQS::Model::CreateQueueResponse($tree);
          
    }
    
    sub getCreateQueueResult {
        return shift->{_fields}->{CreateQueueResult}->{FieldValue};
    }


    sub setCreateQueueResult {
        my ($self, $value) = @_;
        $self->{_fields}->{CreateQueueResult}->{FieldValue} = $value;
    }


    sub withCreateQueueResult {
        my ($self, $value) = @_;
        $self->setCreateQueueResult($value);
        return $self;
    }


    sub isSetCreateQueueResult {
        return defined (shift->{_fields}->{CreateQueueResult}->{FieldValue});
