package App::GitHooks::Plugin::Test::CustomReply;
...
App::GitHooks::Plugin::Test::CustomReply - A test plugin that allows specifying the return code.
...
=head1 SYNOPSIS
	...
	# In .githooksrc.
	# [Test::CustomReply]
	# pre-commit = PLUGIN_RETURN_FAILED
	# prepare-commit-msg = PLUGIN_RETURN_PASSED
...
Return a pattern to filter the files this plugin should analyze.
	...
	my $file_pattern = App::GitHooks::Plugin::Test::CustomReply->get_file_pattern(
		app => $app,
	);
...
success or failure of the plugin.
	...
	my $description = App::GitHooks::Plugin::Test::CustomReply->get_file_check_description();

=cut

sub get_file_check_description
{
	return 'Test plugin - custom return codes.';
}
	...
	*$sub = sub
	{
		...
		my $return = $config->get( 'Test::CustomReply', $hook ) // '';
...
You can find documentation for this module with the perldoc command.
	...
	perldoc App::GitHooks::Plugin::Test::CustomReply
