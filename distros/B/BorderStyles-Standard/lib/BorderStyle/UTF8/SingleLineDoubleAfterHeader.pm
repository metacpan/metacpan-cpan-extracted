...
1;
# ABSTRACT: Just like UTF8::SingleLine but uses double line to separate header row and first data row
...
BorderStyle::UTF8::SingleLineDoubleAfterHeader - Just like UTF8::SingleLine but uses double line to separate header row and first data row

=head1 VERSION

This document describes version 0.006 of BorderStyle::UTF8::SingleLineDoubleAfterHeader (from Perl distribution BorderStyles-Standard), released on 2021-02-19.
...
To use with L<Text::ANSITable>:
 ...
 $t->border_style("UTF8::SingleLineDoubleAfterHeader");
 $t->columns($rows->[0]);
...
To use with L<Text::Table::Span>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"UTF8::SingleLineDoubleAfterHeader");
...
To use with L<Text::Table::TinyBorderStyle>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"BorderStyle::UTF8::SingleLineDoubleAfterHeader");
