...
extern char *mmc_isrc_get_track_isrc (const CdIo_t *p_cdio, track_t i_track);

 char * mmc_get_isrc(CdIo_t *p_cdio, track_t track) {
    return mmc_isrc_get_track_isrc (p_cdio, track);
}
...
XS(_wrap_mmc_isrc_get_track_isrc) {
  {
    CdIo_t *arg1 = (CdIo_t *) 0 ;
    track_t arg2 ;
    void *argp1 = 0 ;
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: mmc_isrc_get_track_isrc(p_cdio,i_track);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_CdIo_t, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "mmc_isrc_get_track_isrc" "', argument " "1"" of type '" "CdIo_t const *""'"); 
    }
    arg1 = (CdIo_t *)(argp1);
    ecode2 = SWIG_AsVal_unsigned_SS_int SWIG_PERL_CALL_ARGS_2(ST(1), &val2);
    if (!SWIG_IsOK(ecode2)) {
      SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "mmc_isrc_get_track_isrc" "', argument " "2"" of type '" "track_t""'");
    } 
    arg2 = (track_t)(val2);
    result = (char *)mmc_isrc_get_track_isrc((CdIo_t const *)arg1,arg2);
    ST(argvi) = SWIG_FromCharPtr((const char *)result); argvi++ ;
...
{"perlmmcc::mmc_isrc_get_track_isrc", _wrap_mmc_isrc_get_track_isrc},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
