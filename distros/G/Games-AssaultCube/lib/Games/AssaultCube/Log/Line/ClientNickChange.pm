# Declare our package
package Games::AssaultCube::Log::Line::ClientNickChange;
...
has 'tostr' => (
	...
	default		=> sub {
		my $self = shift;
		return "Client " . $self->oldnick . " changed nick to " . $self->nick;
	},
);
...
Describes the ClientNickChange event in a log line

=head1 DESCRIPTION

This module holds the "ClientNickChange" event data from a log line. Normally, you would not use this class directly
but via the L<Games::AssaultCube::Log::Line> class.

This line is emitted when a client changes his/her nick.
...
The old nick of the client

=head3 nick

The new nick of the client
