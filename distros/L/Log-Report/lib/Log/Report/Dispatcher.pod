...
to avoid the case that it is accidentally used.  Returns C<undef> (C<false>)
...
directly.  Internally, it will call L<translate()|Log::Report::Dispatcher/"Logging">, which does most C<$of>
the work.
