...
Faker::Plugin::EsEs::JargonTermPrefix
...
$test->for('synopsis', sub {
  ...
  ok $result->isa('Faker::Plugin::EsEs::JargonTermPrefix');
...
$test->render('lib/Faker/Plugin/EsEs/JargonTermPrefix.pod') if $ENV{RENDER};
