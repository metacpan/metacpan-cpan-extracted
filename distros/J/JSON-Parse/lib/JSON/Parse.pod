...
This documents version 0.53 of JSON::Parse corresponding to
L<git commit aa17c3b5630219e3964dbf6b2c4a3905abc18e33|https://github.com/benkasminbullock/JSON-Parse/commit/aa17c3b5630219e3964dbf6b2c4a3905abc18e33> released on Wed Oct 18 19:42:07 2017 +0900.
...
(This example is included as L<F<hash.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Parse-0.53/examples/hash.pl> in the distribution.)
...
(This example is included as L<F<array.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Parse-0.53/examples/array.pl> in the distribution.)
...
(This example is included as L<F<assert.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Parse-0.53/examples/assert.pl> in the distribution.)
...
(This example is included as L<F<unicode-details.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Parse-0.53/examples/unicode-details.pl> in the distribution.)
...
(This example is included as L<F<key-collision.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Parse-0.53/examples/key-collision.pl> in the distribution.)
...
(This example is included as L<F<json-tiny-round-trip-demo.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Parse-0.53/examples/json-tiny-round-trip-demo.pl> in the distribution.)
...
(This example is included as L<F<collide.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Parse-0.53/examples/collide.pl> in the distribution.)
...
script L<F<benchmarks/bench>|https://github.com/benkasminbullock/JSON-Parse/blob/aa17c3b5630219e3964dbf6b2c4a3905abc18e33/benchmarks/bench> is an adaptation of the similar
script in the L<JSON::XS> distribution. The script L<F<benchmarks/pub-bench.pl>|https://github.com/benkasminbullock/JSON-Parse/blob/aa17c3b5630219e3964dbf6b2c4a3905abc18e33/benchmarks/pub-bench.pl> runs the benchmarks and prints them
out as POD.
...
supplied in the CPAN distribution. A script, L<F<randomjson.pl>|https://github.com/benkasminbullock/JSON-Parse/blob/aa17c3b5630219e3964dbf6b2c4a3905abc18e33/randomjson.pl>,
...
This setup relies on a C file, L<F<json-random-test.c>|https://github.com/benkasminbullock/JSON-Parse/blob/aa17c3b5630219e3964dbf6b2c4a3905abc18e33/json-random-test.c>, which isn't in
the CPAN distribution, and it also requires L<F<Json3.xs>|https://github.com/benkasminbullock/JSON-Parse/blob/aa17c3b5630219e3964dbf6b2c4a3905abc18e33/Json3.xs> to be edited
...
A pure C version called L<F<random-test.c>|https://github.com/benkasminbullock/JSON-Parse/blob/aa17c3b5630219e3964dbf6b2c4a3905abc18e33/random-test.c> also exists. This applies
exactly the same tests, and requires no Perl at all.

If you're interested in testing your own JSON parser, the outputs
generated by L<F<randomjson.pl>|https://github.com/benkasminbullock/JSON-Parse/blob/aa17c3b5630219e3964dbf6b2c4a3905abc18e33/randomjson.pl> are quite a good place to start. The
...
however, in the repository under L<F<xt/jpts.t>|https://github.com/benkasminbullock/JSON-Parse/blob/aa17c3b5630219e3964dbf6b2c4a3905abc18e33/xt/jpts.t> and the
subdirectory L<F<xt/jpts>|https://github.com/benkasminbullock/JSON-Parse/blob/aa17c3b5630219e3964dbf6b2c4a3905abc18e33/xt/jpts>, so if you are interested in the
results, please copy that and try it. There is also a test for the
L<validjson|/SCRIPT> script as L<F<xt/validjson.t>|https://github.com/benkasminbullock/JSON-Parse/blob/aa17c3b5630219e3964dbf6b2c4a3905abc18e33/xt/validjson.t> in the
...
See L<F<Changes>|https://github.com/benkasminbullock/JSON-Parse/blob/aa17c3b5630219e3964dbf6b2c4a3905abc18e33/Changes> in the distribution for a full list of changes.
