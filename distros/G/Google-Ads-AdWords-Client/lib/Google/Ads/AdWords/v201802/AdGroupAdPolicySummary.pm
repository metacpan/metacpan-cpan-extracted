package Google::Ads::AdWords::v201802::AdGroupAdPolicySummary;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'policyTopicEntries' => 'Google::Ads::AdWords::v201802::PolicyTopicEntry',
        'reviewState' => 'Google::Ads::AdWords::v201802::PolicySummaryReviewState',
        'denormalizedStatus' => 'Google::Ads::AdWords::v201802::PolicySummaryDenormalizedStatus',
        'combinedApprovalStatus' => 'Google::Ads::AdWords::v201802::PolicyApprovalStatus',
    },
    {
...
Google::Ads::AdWords::v201802::AdGroupAdPolicySummary

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupAdPolicySummary from the namespace https://adwords.google.com/api/adwords/cm/v201802.
