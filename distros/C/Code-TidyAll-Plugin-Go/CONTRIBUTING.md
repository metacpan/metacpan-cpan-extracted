...
https://metacpan.org/release/Code-TidyAll-Plugin-Go

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Code::TidyAll::Plugin::Go
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Code::TidyAll::Plugin::Go
...
The code for this distribution is [hosted at GitHub](https://github.com/Code-TidyAll-Plugin-Go).
