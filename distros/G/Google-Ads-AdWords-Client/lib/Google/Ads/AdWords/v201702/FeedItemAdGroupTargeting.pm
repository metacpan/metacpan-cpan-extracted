package Google::Ads::AdWords::v201702::FeedItemAdGroupTargeting;
use strict;
use warnings;
...
FeedItemAdGroupTargeting from the namespace https://adwords.google.com/api/adwords/cm/v201702.
