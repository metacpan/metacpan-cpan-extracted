...
Kubernetes::REST::Call::GetAPIVersions - REMOVED -- superseded by Kubernetes::REST's unified v1 API, see Kubernetes::REST::Deprecated
...
C<Kubernetes::REST::Call::GetAPIVersions> itself was never functional in the C<1.x> series -- it
...
C<cpanm Kubernetes::REST::Call::GetAPIVersions> -- or a cpanfile / code that still references the
...
Kubernetes::REST::Call::GetAPIVersions - REMOVED, superseded by Kubernetes::REST's unified v1 API
