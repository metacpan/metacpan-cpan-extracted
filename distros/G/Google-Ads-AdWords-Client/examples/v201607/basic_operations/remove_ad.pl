...
use Google::Ads::AdWords::v201607::Ad;
...
sub remove_ad {
  ...
  my $ad = Google::Ads::AdWords::v201607::Ad->new({id => $ad_id,});

  # Create ad group ad.
  my $ad_group_ad = Google::Ads::AdWords::v201607::AdGroupAd->new({
      adGroupId => $ad_group_id,
      ad        => $ad
  });

  # Create operations.
  my $operation = Google::Ads::AdWords::v201607::AdGroupAdOperation->new({
      operand  => $ad_group_ad,
      operator => "REMOVE"
  });
