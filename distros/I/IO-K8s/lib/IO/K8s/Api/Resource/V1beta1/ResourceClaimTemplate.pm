...
IO::K8s::Api::Resource::V1beta1::ResourceClaimTemplate - ResourceClaimTemplate is used to produce ResourceClaim objects.  This is an alpha type and requires enabling the DynamicResourceAllocation feature gate.
