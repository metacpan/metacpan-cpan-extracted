# This Makefile is for the DBIx::Repgen extension to perl.
#
...
#	ABSTRACT_FROM => q[Repgen.pm]
#	AUTHOR => q[Anatoly K.Lasareff <tolik@aaanet.ru>]
#	NAME => q[DBIx::Repgen]
#	PREREQ_PM => { DBD::Sponge=>q[0.1], DBI=>q[0.1] }
#	VERSION_FROM => q[Repgen.pm]
...
AR_STATIC_ARGS = cr
NAME = DBIx::Repgen
DISTNAME = DBIx-Repgen
NAME_SYM = DBIx_Repgen
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
INST_BIN = blib/bin
...
TO_INST_PM = Repgen.pm \
	Repgen.ru.pod

PM_TO_BLIB = Repgen.ru.pod \
	$(INST_LIBDIR)/Repgen.ru.pod \
	Repgen.pm \
	$(INST_LIBDIR)/Repgen.pm
...
manifypods : pure_all Repgen.ru.pod \
	...
	@$(POD2MAN) \
	Repgen.ru.pod \
	$(INST_MAN3DIR)/DBIx::Repgen.ru.$(MAN3EXT) \
	Repgen.pm \
	$(INST_MAN3DIR)/DBIx::Repgen.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f  $(INST_LIBDIR)/Repgen.ru.pod $(INST_LIBDIR)/Repgen.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"DBIx-Repgen\" VERSION=\"0,01,0,0\">\n}. qq{\t<TITLE>DBIx-Repgen</TITLE>\n}. qq{\t<ABSTRACT>simple report generator from DB-selected data</ABSTRACT>\n}. qq{\t<AUTHOR>Anatoly K.Lasareff &lt;tolik\@aaanet.ru&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"DBD-Sponge\" VERSION=\"0,1,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"DBI\" VERSION=\"0,1,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > DBIx-Repgen.ppd
