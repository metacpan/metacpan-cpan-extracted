...
package Google::Ads::AdWords::v201806::TrafficEstimatorService::get;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201806::TrafficEstimatorSelector',
    },
    {
...
Google::Ads::AdWords::v201806::TrafficEstimatorService::get

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
get from the namespace https://adwords.google.com/api/adwords/o/v201806.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201806::TrafficEstimatorService::get->new($data);

Constructor. The following data structure may be passed to new():

 {
   selector =>  $a_reference_to, # see Google::Ads::AdWords::v201806::TrafficEstimatorSelector
 },
