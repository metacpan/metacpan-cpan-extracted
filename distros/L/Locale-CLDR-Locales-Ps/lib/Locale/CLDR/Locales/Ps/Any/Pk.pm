...
Locale::CLDR::Locales::Ps::Any::Pk - Package for language Pashto

=cut

package Locale::CLDR::Locales::Ps::Any::Pk;
...
extends('Locale::CLDR::Locales::Ps::Any');
...
has 'characters' => (
	...
	sub {
		...
		return {
			auxiliary => qr{[‌ ‍ ‎‏]},
			main => qr{[َ ِ ُ ً ٍ ٌ ّ ْ ٔ ٰ آ ا أ ء ب پ ت ټ ث ج ځ چ څ ح خ د ډ ذ ر ړ ز ژ ږ س ش ښ ص ض ط ظ ع غ ف ق ک ګ گ ل م ن ڼ ه ة و ؤ ی ے ي ې ۍ ئ]},
		};
	},
EOT
: sub {
