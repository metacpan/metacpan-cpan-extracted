package ODO::RDFS::Properties::seeAlso;
...
@ISA = (  'ODO::RDFS::Resource',  'ODO::RDFS::Property', );
...
sub new {
	...
	$self->propertyContainerName( 'ODO::RDFS::Properties::seeAlso::PropertiesContainer' );
	$self->properties(bless {}, 'ODO::RDFS::Properties::seeAlso::PropertiesContainer');
