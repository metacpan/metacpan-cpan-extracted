package Chart::Plotly::Trace::Scatterpolargl::Marker::Line;
use Moose;
...
Chart::Plotly::Trace::Scatterpolargl::Marker::Line - This attribute is one of the possible options for the trace scatterpolargl.
