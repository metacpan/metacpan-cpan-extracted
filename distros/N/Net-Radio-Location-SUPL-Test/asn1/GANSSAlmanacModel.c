...
static int asn_MAP_GANSSAlmanacModel_oms_1[] = { 1, 2 };
...
static asn_TYPE_tag2member_t asn_MAP_GANSSAlmanacModel_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* weekNumber at 1553 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* toa at 1554 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* ioda at 1555 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* ganssAlmanacList at 1557 */
};
