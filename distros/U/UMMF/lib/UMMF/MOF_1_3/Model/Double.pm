...
package UMMF::MOF_1_3::Model::Double;
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_3::Model::Double->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_3::Model::Double|UMMF::MOF_1_3::Model::Double>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_3::Model::Double')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_3::Model::Double->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_3::Model::Double->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_3::Model::Double' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_3::Model::Double|UMMF::MOF_1_3::Model::Double>.
...
sub __initialize
{
  ...
  $self->UMMF::MOF_1_3::Model::Double::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_3::Model::Double::___create(@args);
