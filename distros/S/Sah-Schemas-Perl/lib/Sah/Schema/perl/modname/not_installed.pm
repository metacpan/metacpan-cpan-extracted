...
This document describes version 0.049 of Sah::Schema::perl::modname::not_installed (from Perl distribution Sah-Schemas-Perl), released on 2023-10-26.
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::modname::not_installed*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::modname::not_installed*', name=>'PerlModnameNotInstalled')
     );
 }
