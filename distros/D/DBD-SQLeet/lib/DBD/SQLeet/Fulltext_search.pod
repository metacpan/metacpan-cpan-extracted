...
DBD::SQLeet::Fulltext_search - Using fulltext searches with DBD::SQLeet
...
with C<DBD::SQLeet>, starting from version 1.31.
...
syntax, use  L<DBD::SQLeet::FTS3Transitional> (published
...
recompile C<DBD::SQLeet>; of course, the prerequisite is to have
...
In addition to the builtin SQLite tokenizers, C<DBD::SQLeet>
