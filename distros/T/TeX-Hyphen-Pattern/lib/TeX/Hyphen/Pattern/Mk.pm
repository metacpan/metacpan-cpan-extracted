...
package TeX::Hyphen::Pattern::Mk v1.1.5;
use strict;
use warnings;
use 5.014000;
use utf8;
...
sub version {
    return $TeX::Hyphen::Pattern::Mk::VERSION;
}
...
=for stopwords CTAN Ipenburg Mk

=head1 NAME

TeX::Hyphen::Pattern::Mk - class for hyphenation in locale Mk
...
title: Hyphenation patterns for Macedonian
copyright: Copyright (C) 2006 Vasil Taneski
