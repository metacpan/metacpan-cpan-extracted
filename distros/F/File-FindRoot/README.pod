...
=head1 The File::FindRoot module

This is the I<README> for the L<File::FindRoot> Perl module.
...
the source repository: L<https://github.com/briandfoy/file-findroot>

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/briandfoy/file-findroot/issues>.
...
=item * L<https://bitbucket.com/briandfoy/file-findroot>

=item * L<https://codeberg.org/briandfoy/file-findroot>

=item * L<https://gitlab.com/briandfoy/file-findroot>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify File::FindRoot-1.23.tar.gz --owner briandfoy
