...
MODULE = Image::Sane	PACKAGE = Image::Sane::Device		PREFIX = sane_
...
void
sane__set_io_mode (handle, non_blocking)
		SANE_Handle	handle
...
MODULE = Image::Sane       PACKAGE = Image::Sane		  PREFIX = sane_

PROTOTYPES: ENABLE
  
BOOT:
	HV *stash;
	stash = gv_stashpv("Image::Sane", TRUE);
