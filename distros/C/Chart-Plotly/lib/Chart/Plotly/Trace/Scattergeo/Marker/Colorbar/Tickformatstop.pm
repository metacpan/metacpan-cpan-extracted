package Chart::Plotly::Trace::Scattergeo::Marker::Colorbar::Tickformatstop;
use Moose;
...
Chart::Plotly::Trace::Scattergeo::Marker::Colorbar::Tickformatstop - This attribute is one of the possible options for the trace scattergeo.
