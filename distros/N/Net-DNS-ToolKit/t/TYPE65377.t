...
# see test 20 for testing as TYPE65377 - unknown
##################################################
...
## test 18	check rdlength, note that text strings include a count byte at 
#		the beginning of the string and the 'rdata' is one byte shorter
# newtext, above is correct for a TXT record but for a TYPE65377 record should
# have the count as the first character in test 20 below
