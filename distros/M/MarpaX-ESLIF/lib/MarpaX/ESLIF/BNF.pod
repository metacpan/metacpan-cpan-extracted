...
Note that the newline is hardcoded to be any unicode newline, i.e. C<(*BSR_UNICODE)\R> in PCRE2 terminology. The presence of :eol pseudo-terminal anywhere in the grammar enforces the C<newlineb> flag in recognizers.
