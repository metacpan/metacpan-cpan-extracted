...
Kubernetes::REST::Extensions - REMOVED -- superseded by Kubernetes::REST's unified v1 API, see Kubernetes::REST::Deprecated
...
C<Kubernetes::REST::Extensions> itself was never functional in the C<1.x> series -- it
...
C<cpanm Kubernetes::REST::Extensions> -- or a cpanfile / code that still references the
...
Kubernetes::REST::Extensions - REMOVED, superseded by Kubernetes::REST's unified v1 API
