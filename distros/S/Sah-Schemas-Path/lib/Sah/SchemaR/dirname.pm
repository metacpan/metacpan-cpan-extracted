...
our $rschema = ["str",[{examples=>[{valid=>0,value=>""},{valid=>1,value=>"foo"},{valid=>1,value=>"foo/bar"}],min_len=>1,prefilters=>["Path::expand_tilde_when_on_unix","Path::strip_slashes_when_on_unix"],summary=>"Filesystem directory name","x.completion"=>["dirname"]}],["str"]];
...
This document describes version 0.015 of Sah::SchemaR::dirname (from Perl distribution Sah-Schemas-Path), released on 2020-08-26.
