...
use Google::Ads::AdWords::v201806::CampaignGroup;
use Google::Ads::AdWords::v201806::CampaignGroupOperation;
use Google::Ads::AdWords::v201806::CampaignGroupPerformanceTarget;
use Google::Ads::AdWords::v201806::CampaignGroupPerformanceTargetOperation;
use Google::Ads::AdWords::v201806::CampaignOperation;
use Google::Ads::AdWords::v201806::Money;
use Google::Ads::AdWords::v201806::PerformanceTarget;
...
sub _create_campaign_group {
  ...
  my $campaign_group = Google::Ads::AdWords::v201806::CampaignGroup->new({
    name => sprintf("Mars campaign group - #%s", uniqid()),
  });
  # Create the operation.
  my $operation = Google::Ads::AdWords::v201806::CampaignGroupOperation->new({
    operator => "ADD",
...
sub _create_performance_target {
  ...
  my $performance_target =
    Google::Ads::AdWords::v201806::PerformanceTarget->new({
      ...
      spendTarget =>
        Google::Ads::AdWords::v201806::Money->new({microAmount => 500000000}),
  ...
  my $campaign_group_performance_target =
    Google::Ads::AdWords::v201806::CampaignGroupPerformanceTarget->new({
      campaignGroupId   => $campaign_group_id,
      performanceTarget => $performance_target
    });
  # Create the operation.
  my $operation =
    Google::Ads::AdWords::v201806::CampaignGroupPerformanceTargetOperation->new(
    {
      operator => "ADD",
