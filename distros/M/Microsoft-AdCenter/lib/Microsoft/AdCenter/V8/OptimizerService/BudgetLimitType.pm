package Microsoft::AdCenter::V8::OptimizerService::BudgetLimitType;
...
Microsoft::AdCenter::V8::OptimizerService::BudgetLimitType - Represents "BudgetLimitType" in Microsoft AdCenter Optimizer Service.
