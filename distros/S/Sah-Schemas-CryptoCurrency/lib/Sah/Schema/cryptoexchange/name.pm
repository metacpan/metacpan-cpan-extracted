...
our $schema = [str => {
    ...
    'x.completion' => 'cryptoexchange_name',
}, {}];

1;
# ABSTRACT: Cryptocurrency exchange name
...
Sah::Schema::cryptoexchange::name - Cryptocurrency exchange name

=head1 VERSION

This document describes version 0.015 of Sah::Schema::cryptoexchange::name (from Perl distribution Sah-Schemas-CryptoCurrency), released on 2020-03-08.
...
Using with L<Data::Sah>:
 ...
 my $vdr = gen_validator("cryptoexchange::name*");
