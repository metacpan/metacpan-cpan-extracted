package blx::xsdsql::generator::sql::mysql::handle::drop_sequence;
...
sub _sql_drop_sequence {
	return 'drop table if exists %n cascade';
}
1;
...
use blx::xsdsql::generator::sql::mysql::handle::drop_sequence
