...
$Shipment::Temando::WSDL::Types::Anything::VERSION = '3.02';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    my %qualifierFreightGeneralDangerousGoods_of :
      ATTR(:get<qualifierFreightGeneralDangerousGoods>);
    my %qualifierFreightGeneralFragile_of :
      ATTR(:get<qualifierFreightGeneralFragile>);
    my %qualifierFreightGeneralRefrigerated_of :
      ATTR(:get<qualifierFreightGeneralRefrigerated>);
    my %qualifierVehicleMake_of : ATTR(:get<qualifierVehicleMake>);
    my %qualifierVehicleModel_of : ATTR(:get<qualifierVehicleModel>);
    my %qualifierVehicleDescription_of :
      ATTR(:get<qualifierVehicleDescription>);
    ...
    my %qualifierVehicleRegistration_of :
      ATTR(:get<qualifierVehicleRegistration>);
    ...
    __PACKAGE__->_factory(
        ...
        {   'class'               => \%class_of,
            ...
            'qualifierFreightGeneralDangerousGoods' =>
              \%qualifierFreightGeneralDangerousGoods_of,
            'qualifierFreightGeneralFragile' =>
