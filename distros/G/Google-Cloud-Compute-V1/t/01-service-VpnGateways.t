...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TestPermissionsResponse Google::Cloud::Compute::V1::Compute::VpnGateway Google::Cloud::Compute::V1::Compute::VpnGatewayAggregatedList Google::Cloud::Compute::V1::Compute::VpnGatewayList Google::Cloud::Compute::V1::Compute::VpnGatewaysGetStatusResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::VpnGatewaysClient->new( credentials => 'dummy' );
