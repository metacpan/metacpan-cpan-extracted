...
This document describes version 0.001 of Complete::Acme::MetaSyntactic (from Perl distribution Complete-Acme-MetaSyntactic), released on 2017-02-15.

=head1 FUNCTIONS


=head2 complete_meta_categories

Usage:

 complete_meta_categories(%args) -> any
...
=head2 complete_meta_themes

Usage:

 complete_meta_themes(%args) -> any
...
=head2 complete_meta_themes_and_categories

Usage:

 complete_meta_themes_and_categories(%args) -> any

Complete from list of available themes (or "theme/category").

This routine can complete from a list of themes, like C<complete_meta_themes()>.
Additionally, if the word is in the form of "word/" or "word/rest" then the
"rest" will be completed from list of categories of theme "word".
