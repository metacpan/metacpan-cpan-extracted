...
if(!(-d "t")) {   
    ...
    print STDERR "directory as : perl t/getAssociatedCuis.t \n";
    exit;  
}                                                              
...
my $perl     = $^X;
my $util_prg = File::Spec->catfile('utils', 'getAssociatedCuis.pl');

my ($keyfile, $file, $output, $term, $config);
...
#######################################################################################
$term    = "hand";
$file    = "getAssociatedCuis.mth.rb-rn.$term";
...
#######################################################################################
$term    = "hand";
$file    = "getAssociatedCuis.snomedct.par-chd.$term";
$keyfile = File::Spec->catfile($keydir, $file);
...
#######################################################################################
$term    = "hand";
$file    = "getAssociatedCuis.msh.par-chd.$term";
$keyfile = File::Spec->catfile($keydir, $file);
