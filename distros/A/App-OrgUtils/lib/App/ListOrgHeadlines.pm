...
This document describes version 0.471 of App::ListOrgHeadlines (from Perl distribution App-OrgUtils), released on 2020-12-30.
...
Usage:
 ...
 list_org_headlines(%args) -> [status, msg, payload, meta]
