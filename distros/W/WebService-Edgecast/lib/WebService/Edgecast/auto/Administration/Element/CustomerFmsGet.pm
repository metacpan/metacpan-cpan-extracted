...
package WebService::Edgecast::auto::Administration::Element::CustomerFmsGet;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerFmsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerFmsGet');
...
WebService::Edgecast::auto::Administration::Element::CustomerFmsGet
...
CustomerFmsGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerFmsGet->new($data);
