package Chart::Plotly::Trace::Histogram::Marker::Colorbar::Tickformatstop;
use Moose;
...
Chart::Plotly::Trace::Histogram::Marker::Colorbar::Tickformatstop - This attribute is one of the possible options for the trace histogram.
