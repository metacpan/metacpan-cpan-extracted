### 20-skipstage.t #############################################################
# This file tests setting the files attribute with skipstage settings in its
        ...
        sub check_stat {
            ...
            if ($check =~ qr(^(pass|fail)$)) {
                ...
                like(
                    ...
                    $testinfo // "$testheader should have been skipped because of failed pre-req"
                );
            }
                ...
                like(
                    $stat->{$stage}[-1]{exit_status},
                    qr/skipped.*skipstage/,
                    $testinfo // "$testheader should have been skipped by skipstage"
                );
            }
        }
