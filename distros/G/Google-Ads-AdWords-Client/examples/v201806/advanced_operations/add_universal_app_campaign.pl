...
use Google::Ads::AdWords::v201806::GeoTargetTypeSetting;
use Google::Ads::AdWords::v201806::Language;
use Google::Ads::AdWords::v201806::Location;
use Google::Ads::AdWords::v201806::Money;
use Google::Ads::AdWords::v201806::NetworkSetting;
use Google::Ads::AdWords::v201806::TargetCpaBiddingScheme;
use Google::Ads::AdWords::v201806::UniversalAppCampaignSetting;
...
sub add_universal_app_campaign {
  ...
  my $universalAppSetting =
    Google::Ads::AdWords::v201806::UniversalAppCampaignSetting->new({
  ...
  # Google::Ads::AdWords::v201806::SelectiveOptimization->new({
  #  conversionTypeIds =>
  ...
  my $geoSetting = Google::Ads::AdWords::v201806::GeoTargetTypeSetting->new({
  ...
  my $campaign = Google::Ads::AdWords::v201806::Campaign->new({
      ...
      biddingStrategyConfiguration =>
        Google::Ads::AdWords::v201806::BiddingStrategyConfiguration->new({
          ...
          biddingScheme =>
            Google::Ads::AdWords::v201806::TargetCpaBiddingScheme->new({
              targetCpa => Google::Ads::AdWords::v201806::Money->new(
                {microAmount => 1000000})})}
        ),
      # Budget (required) - note only the budgetId is required.
      budget =>
        Google::Ads::AdWords::v201806::Budget->new({budgetId => $budgetId}),
...
sub set_campaign_targeting_criteria() {
  ...
  my $mexico = Google::Ads::AdWords::v201806::Location->new({id => 2484});
