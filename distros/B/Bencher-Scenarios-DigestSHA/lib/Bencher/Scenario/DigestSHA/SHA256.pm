...
Bencher::Scenario::DigestSHA::SHA256 - Benchmark Digest::SHA against sha512sum

=head1 VERSION

This document describes version 0.003 of Bencher::Scenario::DigestSHA::SHA256 (from Perl distribution Bencher-Scenarios-DigestSHA), released on 2017-07-10.

=head1 SYNOPSIS

To run benchmark with default option:

 % bencher -m DigestSHA::SHA256

To run module startup overhead benchmark:

 % bencher --module-startup -m DigestSHA::SHA256
...
Benchmark with default options (C<< bencher -m DigestSHA::SHA256 >>):

 #table1#
 +-------------+-----------+-----------+------------+-----------+---------+
 | participant | rate (/s) | time (ms) | vs_slowest |  errors   | samples |
 +-------------+-----------+-----------+------------+-----------+---------+
 | Digest::SHA |      4.5  |       220 |       1    |   0.00024 |       7 |
 | sha256sum   |      4.65 |       215 |       1.03 | 7.2e-05   |       6 |
 +-------------+-----------+-----------+------------+-----------+---------+


Benchmark module startup overhead (C<< bencher -m DigestSHA::SHA256 --module-startup >>):

 #table2#
 +---------------------+------------------------------+--------------------+----------------+-----------+------------------------+------------+---------+---------+
 | participant         | proc_private_dirty_size (MB) | proc_rss_size (MB) | proc_size (MB) | time (ms) | mod_overhead_time (ms) | vs_slowest |  errors | samples |
 +---------------------+------------------------------+--------------------+----------------+-----------+------------------------+------------+---------+---------+
 | Digest::SHA         | 0.83                         | 4.2                | 20             |     14    |                   8.61 |       1    | 3.1e-05 |       6 |
 | String::ShellQuote  | 1.5                          | 5                  | 25             |      9.5  |                   4.11 |       1.4  | 4.1e-05 |       8 |
 | perl -e1 (baseline) | 1.03                         | 4.43               | 20.2           |      5.39 |                   0    |       2.52 | 4.5e-06 |       6 |
 +---------------------+------------------------------+--------------------+----------------+-----------+------------------------+------------+---------+---------+
