package Chart::Plotly::Trace::Densitymapbox::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Densitymapbox::Legendgrouptitle::Font - This attribute is one of the possible options for the trace densitymapbox.
