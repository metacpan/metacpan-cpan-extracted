...
is($obj->descriptive_cataloging_form, undef, 'Get descriptive cataloging form (undef - default).');
...
is($obj->descriptive_cataloging_form, 'i', 'Get descriptive cataloging form (i).');
