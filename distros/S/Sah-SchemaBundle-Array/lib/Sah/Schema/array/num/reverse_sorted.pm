...
This document describes version 0.004 of Sah::Schema::array::num::reverse_sorted (from Perl distribution Sah-SchemaBundle-Array), released on 2024-02-13.
...
Used prefilters: L<Array::check_elems_numeric_reverse_sorted|Data::Sah::Filter::perl::Array::check_elems_numeric_reverse_sorted>
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"array::num::reverse_sorted*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('array::num::reverse_sorted*', name=>'ArrayNumReverseSorted')
     );
 }
