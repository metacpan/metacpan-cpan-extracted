...
is LL<https://github.com/mate-desktop/mate-doc-utils/tree/master/xml2po>,
...
=item * C</usr/share/locale>

=item * C</usr/local/share/locale>
...
C<< html
    [% IF num != 1 %]
    [% gtx.xgettext("{number} documents deleted!", number =E<gt> num) %]
    [% ELSE %]
...
C<< perl
    npxgettext(CONTEXT, SINGULAR, PLURAL, COUNT,
               KEY1 =E<gt> VALUE1, KEY2 =E<gt> VALUE2, ...)
 >>

=head4 More Esoteric Functions

The L<lib/Template/Plugin/Gettext.pod#user-content-FUNCTIONS> contains
...
LL<https://github.com/gflohr/Template-Plugin-Gettext-Seed>
...
a lot more languages.  See the LL<https://www.gnu.org/software/gettext/manual/html_node/xgettext-Invocation.html>
and the documentation for LL<https://github.com/gflohr/Locale-XGettext/blob/master/lib/Locale/XGettext.pod>
...
C<xgettext-tt2> is based on LL<https://github.com/gflohr/Locale-XGettext>
...
You can use the seed project LL<https://github.com/gflohr/Template-Plugin-Gettext-Seed>
as a fully functional starting point for such setups.

=head2 Bugs

Please report bugs at LL<https://github.com/gflohr/Template-Plugin-Gettext/issues>

=head2 Author

Template-Plugin-Gettext was written by LL<http://www.guido-flohr.net/>.
