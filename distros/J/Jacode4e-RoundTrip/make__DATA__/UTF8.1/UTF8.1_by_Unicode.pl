...
sub UTF8p1_by_Unicode {
    my($Unicode) = @_;

    my $Unicode_LTS = {
        #----------------------------------------------------------------------------------
        '2015' => '2014', # U+2015 HORIZONTAL BAR         => U+2014 EM DASH
        '2225' => '2016', # U+2225 PARALLEL TO            => U+2016 DOUBLE VERTICAL LINE
        'FF0D' => '2212', # U+FF0D FULLWIDTH HYPHEN-MINUS => U+2212 MINUS SIGN
        #----------------------------------------------------------------------------------
        '2014' => '2015', # U+2014 EM DASH                => U+2015 HORIZONTAL BAR
        '2016' => '2225', # U+2016 DOUBLE VERTICAL LINE   => U+2225 PARALLEL TO
        '2212' => 'FF0D', # U+2212 MINUS SIGN             => U+FF0D FULLWIDTH HYPHEN-MINUS
        #----------------------------------------------------------------------------------
    }->{$Unicode} || $Unicode;

    return join('', map { _UTF8p1_by_Unicode($_) } split(/\+/, $Unicode_LTS));
}

sub _UTF8p1_by_Unicode {
    my($Unicode) = @_;
