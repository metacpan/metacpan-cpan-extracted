...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::PublicDelegatedPrefix Google::Cloud::Compute::V1::Compute::PublicDelegatedPrefixAggregatedList Google::Cloud::Compute::V1::Compute::PublicDelegatedPrefixList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::PublicDelegatedPrefixesClient->new( credentials => 'dummy' );
