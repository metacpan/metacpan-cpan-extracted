#
# Test case for WebService::Recruit::CarSensor::Body
#
...
my $service = new WebService::Recruit::CarSensor::Body();

ok( ref $service, 'new WebService::Recruit::CarSensor::Body()' );
...
# Test[0]
{
    ...
    my $res = new WebService::Recruit::CarSensor::Body();
    ...
    can_ok( $data, 'body' );
    ok( eval { $data->body }, 'Test[0]: body' );
    ok( eval { ref $data->body } eq 'ARRAY', 'Test[0]: body' );
    can_ok( $data->body->[0], 'code' );
    ok( eval { $data->body->[0]->code }, 'Test[0]: code' );
    can_ok( $data->body->[0], 'name' );
    ok( eval { $data->body->[0]->name }, 'Test[0]: name' );
}
