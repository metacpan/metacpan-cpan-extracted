...
$Map::Tube::Exception::InvalidStationStructure::VERSION = '3.21';
=head1 NAME
...
has status => (is => 'ro', default => sub { 129 });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Map::Tube::Exception::InvalidStationStructure
...
1; # End of Map::Tube::Exception::InvalidStationStructure
