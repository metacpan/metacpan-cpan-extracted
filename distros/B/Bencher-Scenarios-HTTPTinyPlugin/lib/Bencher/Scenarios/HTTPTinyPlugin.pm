package Bencher::Scenarios::HTTPTinyPlugin;
...
Bencher::Scenarios::HTTPTinyPlugin - Scenarios to benchmark HTTP::Tiny::Plugin

=head1 VERSION

This document describes version 0.001 of Bencher::Scenarios::HTTPTinyPlugin (from Perl distribution Bencher-Scenarios-HTTPTinyPlugin), released on 2019-05-04.
...
=item * L<Bencher::Scenario::HTTPTinyPlugin::Startup>

=item * L<Bencher::Scenario::HTTPTinyPlugin::request_overhead>
