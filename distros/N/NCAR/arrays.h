...
void* pack1D(SV* arg, char packtype, long* maxlen);     /* Pack perl 1D array        */
void* pack2D(SV* arg, char packtype, long* maxlen);     /* Pack perl 1-2D array      */
void* packND(SV* arg, char packtype, long* maxlen);     /* Pack perl array N-D array */
