package Chart::Plotly::Trace::Violin::Selected::Marker;
use Moose;
...
Chart::Plotly::Trace::Violin::Selected::Marker - This attribute is one of the possible options for the trace violin.
