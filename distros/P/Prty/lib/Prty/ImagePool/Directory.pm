package Prty::ImagePool::Directory;
...
Prty::ImagePool::Directory - Unterverzeichnis eines Image-Pool
...
sub new {
    ...
    return $class->SUPER::new(
        path=>$path,
        imageList=>Prty::TimeLapse::Directory->new("$path/img"),
        sequenceH=>{},
    );
}
