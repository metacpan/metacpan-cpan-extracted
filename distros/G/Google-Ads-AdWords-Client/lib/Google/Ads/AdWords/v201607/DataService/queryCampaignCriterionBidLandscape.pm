...
package Google::Ads::AdWords::v201607::DataService::queryCampaignCriterionBidLandscape;
use strict;
use warnings;
...
queryCampaignCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201607.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201607::DataService::queryCampaignCriterionBidLandscape->new($data);
