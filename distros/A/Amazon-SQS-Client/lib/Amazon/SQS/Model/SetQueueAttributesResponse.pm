...
package Amazon::SQS::Model::SetQueueAttributesResponse;
...
use base qw (Amazon::SQS::Model);
    ...
    #
    # Amazon::SQS::Model::SetQueueAttributesResponse
    # 
    # Properties:
    #
    # 
    ...
    sub new {
     ...
     #
     # Construct Amazon::SQS::Model::SetQueueAttributesResponse from XML string
     # 
    sub fromXML {
        my ($self, $xml) = @_;
        eval "use XML::Simple";
        ...
        return new Amazon::SQS::Model::SetQueueAttributesResponse($tree);
    ...
    sub toXML {
        my $self = shift;
        my $xml = "";
        $xml .= "<SetQueueAttributesResponse xmlns=\"http://queue.amazonaws.com/doc/2009-02-01/\">";
