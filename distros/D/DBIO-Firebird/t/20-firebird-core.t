...
use Try::Tiny;
use DBIO::Test;
use DBIO::Firebird::Test::SequenceTest;

# SequenceTest is a Firebird-specific result class (generator-based auto-PK
# without a trigger); register it onto the shared core test schema.
DBIO::Test::Schema->register_class(
  SequenceTest => 'DBIO::Firebird::Test::SequenceTest'
) unless DBIO::Test::Schema->source_registrations->{SequenceTest};
