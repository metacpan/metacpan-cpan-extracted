...
$ENV{MOJO_MYSQL_DATABASE_ROLE_LOAD_DATA_INFILE_NO_XS} = 1;
require Mojo::mysql::Database::Role::LoadDataInfile;
Mojo::mysql::Database::Role::LoadDataInfile->import;

note 'Use Text::CSV_PP';
ok !exists $INC{'Text/CSV_XS.pm'}, 'Text::CSV_XS not loaded';
ok exists $INC{'Text/CSV_PP.pm'}, 'Text::CSV_PP loaded';
