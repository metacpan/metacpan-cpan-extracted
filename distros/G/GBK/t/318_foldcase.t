...
if (fc('傾僀僂僄僆') eq '傾僀僂僄僆') {
    print qq{ok - 2 fc('傾僀僂僄僆') eq '傾僀僂僄僆'\n};
}
else {
    print qq{not ok - 2 fc('傾僀僂僄僆') eq '傾僀僂僄僆'\n};
}
...
if ("\F傾僀僂僄僆\E" eq "傾僀僂僄僆") {
    print qq{ok - 4 "\\F傾僀僂僄僆\\E" eq "傾僀僂僄僆"\n};
}
else {
    print qq{not ok - 4 "\\F傾僀僂僄僆\\E" eq "傾僀僂僄僆"\n};
}
...
if ("傾僀僂僄僆" =~ /\F傾僀僂僄僆\E/) {
    print qq{ok - 11 "傾僀僂僄僆" =~ /\\F傾僀僂僄僆\\E/\n};
}
else {
    print qq{not ok - 11 "傾僀僂僄僆" =~ /\\F傾僀僂僄僆\\E/\n};
}

if ("傾僀僂僄僆" =~ /\F傾僀僂僄僆\E/i) {
    print qq{ok - 12 "傾僀僂僄僆" =~ /\\F傾僀僂僄僆\\E/i\n};
}
else {
    print qq{not ok - 12 "傾僀僂僄僆" =~ /\\F傾僀僂僄僆\\E/i\n};
}

$var = '傾僀僂僄僆';
if ("傾僀僂僄僆" =~ /\F$var\E/i) {
    print qq{ok - 13 "傾僀僂僄僆" =~ /\\F\$var\\E/i\n};
}
else {
    print qq{not ok - 13 "傾僀僂僄僆" =~ /\\F\$var\\E/i\n};
}
