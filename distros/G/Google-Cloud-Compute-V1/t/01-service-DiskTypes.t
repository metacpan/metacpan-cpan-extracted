...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::DiskType Google::Cloud::Compute::V1::Compute::DiskTypeAggregatedList Google::Cloud::Compute::V1::Compute::DiskTypeList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::DiskTypesClient->new( credentials => 'dummy' );
