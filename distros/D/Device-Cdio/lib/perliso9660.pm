...
*imaxabs = *perliso9660c::imaxabs;
*imaxdiv = *perliso9660c::imaxdiv;
*strtoimax = *perliso9660c::strtoimax;
*strtoumax = *perliso9660c::strtoumax;
...
*ifs_find_lsn = *perliso9660c::ifs_find_lsn;
...
*get_posix_filemode = *perliso9660c::get_posix_filemode;
...
############# Class : perliso9660::imaxdiv_t ##############

package perliso9660::imaxdiv_t;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( perliso9660 );
%OWNER = ();
%ITERATORS = ();
*swig_quot_get = *perliso9660c::imaxdiv_t_quot_get;
*swig_quot_set = *perliso9660c::imaxdiv_t_quot_set;
*swig_rem_get = *perliso9660c::imaxdiv_t_rem_get;
*swig_rem_set = *perliso9660c::imaxdiv_t_rem_set;
sub new {
    my $pkg = shift;
    my $self = perliso9660c::new_imaxdiv_t(@_);
...
sub DESTROY {
    ...
    if (exists $OWNER{$self}) {
        perliso9660c::delete_imaxdiv_t($self);
        delete $OWNER{$self};
    }
}
