...
package Acme::PERLANCAR::Test::Require::PrintOne;
...
Acme::PERLANCAR::Test::Require::PrintOne - Print "1" when loaded

=head1 VERSION

This document describes version 0.001 of Acme::PERLANCAR::Test::Require::PrintOne (from Perl distribution Acme-PERLANCAR-Test-Require), released on 2023-12-06.
