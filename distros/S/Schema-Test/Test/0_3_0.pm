...
Schema::Test::0_3_0 - Test schema version 0.3.0.

=head1 SYNOPSIS

 use Schema::Test::0_3_0;

 my $obj = Schema::Test::0_3_0->connect(@connect_info);

 $obj->source('Person');

=head1 DESCRIPTION

Versioned DBIx::Class schema for the C<0.3.0> test layout.

=head1 METHODS

=head2 C<connect>

 my $schema = Schema::Test::0_3_0->connect(@connect_info);
