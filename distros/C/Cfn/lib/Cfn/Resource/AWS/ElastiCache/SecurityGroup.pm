...
Cfn::Resource::AWS::ElastiCache::SecurityGroup - Cfn resource for AWS::ElastiCache::SecurityGroup

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::ElastiCache::SecurityGroup.
