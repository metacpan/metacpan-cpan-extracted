...
commandName: the name of the command being excuted; for legacy operations that don't use commands, the driver will convert them to appear as if they are in command form.
...
commandName: the name of the command being excuted
