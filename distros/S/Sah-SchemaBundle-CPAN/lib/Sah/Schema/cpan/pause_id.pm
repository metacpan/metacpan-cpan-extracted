...
This document describes version 0.016 of Sah::Schema::cpan::pause_id (from Perl distribution Sah-SchemaBundle-CPAN), released on 2024-06-13.
...
Used completion: L<lcpan_authorid|Perinci::Sub::XCompletion::lcpan_authorid>
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"cpan::pause_id*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('cpan::pause_id*', name=>'CpanPauseId')
     );
 }

 use My::Types qw(CpanPauseId);
 CpanPauseId->assert_valid($data);
