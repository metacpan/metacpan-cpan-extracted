...
Cfn::Resource::AWS::CodeDeploy::Application - Cfn resource for AWS::CodeDeploy::Application

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::CodeDeploy::Application.
