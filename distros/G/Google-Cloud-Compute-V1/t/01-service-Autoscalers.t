...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Autoscaler Google::Cloud::Compute::V1::Compute::AutoscalerAggregatedList Google::Cloud::Compute::V1::Compute::AutoscalerList Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::AutoscalersClient->new( credentials => 'dummy' );
