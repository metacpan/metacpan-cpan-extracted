...
class InvokeStandaloneMethodGeneratorHandler extends AbstractGeneratorHandler {
    generate_code(existing_string_builder, common_command, used_object, handlers) {
        ...
        existing_string_builder.append('function ')
        ...
        CommonGenerator.process_method_arguments(
            existing_string_builder,
            common_command,
            used_object.payload[4],
...
module.exports = InvokeStandaloneMethodGeneratorHandler
