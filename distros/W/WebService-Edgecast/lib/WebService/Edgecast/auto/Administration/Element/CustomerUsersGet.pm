...
package WebService::Edgecast::auto::Administration::Element::CustomerUsersGet;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerUsersGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerUsersGet');
...
WebService::Edgecast::auto::Administration::Element::CustomerUsersGet
...
CustomerUsersGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerUsersGet->new($data);
