...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    PACK_TOK = 259,                /* PACK_TOK  */
    PUSH_TOK = 260,                /* PUSH_TOK  */
    POP_TOK = 261                  /* POP_TOK  */
  };
...
int pragma_parse (PragmaState *pState);
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PACK_TOK = 4,                   /* PACK_TOK  */
  YYSYMBOL_PUSH_TOK = 5,                   /* PUSH_TOK  */
  YYSYMBOL_POP_TOK = 6,                    /* POP_TOK  */
  YYSYMBOL_7_ = 7,                         /* '('  */
  YYSYMBOL_8_ = 8,                         /* ')'  */
  YYSYMBOL_9_ = 9,                         /* ','  */
  YYSYMBOL_YYACCEPT = 10,                  /* $accept  */
  YYSYMBOL_pragma = 11,                    /* pragma  */
  YYSYMBOL_pragma_pack = 12,               /* pragma_pack  */
  YYSYMBOL_pragma_pack_args = 13           /* pragma_pack_args  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "CONSTANT", "PACK_TOK",
  "PUSH_TOK", "POP_TOK", "'('", "')'", "','", "$accept", "pragma",
  "pragma_pack", "pragma_pack_args", YY_NULLPTR
};
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, PragmaState *pState)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (pState);
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, PragmaState *pState)
{
  YY_USE (yyvaluep);
  YY_USE (pState);
  if (!yymsg)
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* pragma_pack: PACK_TOK  */
#line 223 "ctlib/pragma.y"
          { PSTATE->pack.current = 0; }
#line 1590 "ctlib/y_pragma.c"
    break;

  case 4: /* pragma_pack: PACK_TOK '(' ')'  */
#line 225 "ctlib/pragma.y"
          { PSTATE->pack.current = 0; }
#line 1596 "ctlib/y_pragma.c"
    break;

  case 6: /* pragma_pack_args: CONSTANT  */
#line 231 "ctlib/pragma.y"
          {
	    if (is_valid_pack_arg(PSTATE, (yyvsp[0].ival)))
	    {
	      PSTATE->pack.current = (yyvsp[0].ival);
	    }
	  }
#line 1607 "ctlib/y_pragma.c"
    break;

  case 7: /* pragma_pack_args: PUSH_TOK ',' CONSTANT  */
...
#line 1619 "ctlib/y_pragma.c"
    break;

  case 8: /* pragma_pack_args: POP_TOK  */
...
#line 1635 "ctlib/y_pragma.c"
    break;


#line 1639 "ctlib/y_pragma.c"
