...
#
# created on Mon Feb  5 21:23:58 2001 by /home/jasons/work/GeneX-Server/Genex/scripts/create_genex_class.pl --dir=/home/jasons/work/GeneX-Server/Genex --target=ExternalDatabase
#
# cvs id: $Id: ExternalDatabase.pm,v 1.14 2001/02/06 18:58:52 jes Exp $ 
#
##############################
...
;
  ...
  $COLUMN2NAME  = {
          'main_url' => 'Main DB URL',
          'parameterized_url' => 'Parameterized URL',
          'name' => 'Accession Number'
        }
;
  $NAME2COLUMN  = {
          'Accession Number' => 'name',
          'Parameterized URL' => 'parameterized_url',
          'Main DB URL' => 'main_url'
        }
;
  $FKEY_OBJ2RAW = {}
;
...
sub get_all_objects {
  ...
  if (ref($_[0]) eq 'HASH') {
    ...
    die "Bio::Genex::ExternalDatabase::get_all_objects: Must define both 'column' and 'value'" 
  ...
  my $sth = $dbh->prepare($sql) 
    or die "Bio::Genex::ExternalDatabase::get_all_objects:\nSQL=<$sql>,\nDBI=<$DBI::errstr>";
  $sth->execute() 
    or die "Bio::Genex::ExternalDatabase::get_all_objects:\nSQL=<$sql>,\nDBI=<$DBI::errstr>";
  ...
  die "Bio::Genex::ExternalDatabase::get_all_objects:\nSQL=<$sql>,\nDBI=<$DBI::errstr>" 
    if $sth->err;
...
sub get_objects {
  ...
  if (ref($_[0]) eq 'HASH' || scalar @_ == 0) {
    croak("Bio::Genex::ExternalDatabase::get_objects called with no ID's, perhaps you meant to use Bio::Genex::ExternalDatabase::get_all_objects
");
  } 
  my @ids = @_;
  my $obj;
...
=head1 SYNOPSIS
  ...
  my @objects = Bio::Genex::ExternalDatabase->get_all_objects();
...
on Mon Feb  5 21:23:58 2001 by /home/jasons/work/GeneX-Server/Genex/scripts/create_genex_class.pl --dir=/home/jasons/work/GeneX-Server/Genex --target=ExternalDatabase
