...
our $rschema = ["str",[{match=>qr(\A[0-9A-Fa-f]{6}\z),summary=>"RGB 24-digit color, a hexdigit e.g. ffcc00"}],["str"]];
...
This document describes version 0.001 of Sah::SchemaR::color::rgb24 (from Perl distribution Sah-Schemas-Color), released on 2017-12-03.
