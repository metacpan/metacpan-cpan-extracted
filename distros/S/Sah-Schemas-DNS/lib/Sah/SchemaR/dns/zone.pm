package Sah::SchemaR::dns::zone;

our $DATE = '2019-07-25'; # DATE
our $VERSION = '0.002'; # VERSION

our $rschema = ["hash",[{keys=>{records=>["dns::records_of_known_types",{req=>1},{}]},req_keys=>["records"],summary=>"DNS zone structure"}],["hash"]];
...
Sah::SchemaR::dns::zone - DNS zone structure

=head1 VERSION

This document describes version 0.002 of Sah::SchemaR::dns::zone (from Perl distribution Sah-Schemas-DNS), released on 2019-07-25.
