package Chart::Plotly::Trace::Histogram2d::Colorbar::Titlefont;
use Moose;
...
Chart::Plotly::Trace::Histogram2d::Colorbar::Titlefont - This attribute is one of the possible options for the trace histogram2d.
