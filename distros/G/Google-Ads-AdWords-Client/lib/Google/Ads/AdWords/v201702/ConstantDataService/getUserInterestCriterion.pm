...
package Google::Ads::AdWords::v201702::ConstantDataService::getUserInterestCriterion;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'userInterestTaxonomyType' => 'Google::Ads::AdWords::v201702::ConstantDataService::UserInterestTaxonomyType',
    },
    {
...
getUserInterestCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201702.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::ConstantDataService::getUserInterestCriterion->new($data);
