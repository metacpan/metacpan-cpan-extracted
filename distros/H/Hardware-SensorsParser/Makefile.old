# This Makefile is for the Hardware::SensorsParser extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Hardware/SensorsParser.pm]
#     AUTHOR => [q["Davide Ticozzi" <"dticozzi@gmail.com">]]
#     BUILD_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[Hardware::SensorsParser]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Hardware/SensorsParser.pm]
#     clean => { FILES=>q[Hardware-SensorsParser-*] }
...
NAME_SYM = Hardware_SensorsParser
VERSION = 0.01
...
MAKE = make
FULLEXT = Hardware/SensorsParser
BASEEXT = SensorsParser
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Hardware/SensorsParser.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Hardware
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Hardware
...
TO_INST_PM = lib/Hardware/SensorsParser.pm

PM_TO_BLIB = lib/Hardware/SensorsParser.pm \
...
DISTNAME = Hardware-SensorsParser
DISTVNAME = Hardware-SensorsParser-0.01
...
manifypods : pure_all  \
	lib/Hardware/SensorsParser.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Hardware/SensorsParser.pm $(INST_MAN3DIR)/Hardware::SensorsParser.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Hardware-SensorsParser' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Simple parser for Lm-sensors output' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - "Davide Ticozzi" <"dticozzi@gmail.com">' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Simple parser for Lm-sensors output</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>"Davide Ticozzi" &lt;"dticozzi@gmail.com"&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Hardware/SensorsParser.pm blib/lib/Hardware/SensorsParser.pm 
