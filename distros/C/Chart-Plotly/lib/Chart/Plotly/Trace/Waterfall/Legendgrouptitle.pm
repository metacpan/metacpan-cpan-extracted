package Chart::Plotly::Trace::Waterfall::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Waterfall::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Waterfall::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Waterfall::Legendgrouptitle - This attribute is one of the possible options for the trace waterfall.
