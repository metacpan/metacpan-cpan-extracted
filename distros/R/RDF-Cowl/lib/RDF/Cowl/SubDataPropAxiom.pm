...
$RDF::Cowl::SubDataPropAxiom::VERSION = '1.0.0';
...
RDF::Cowl::SubDataPropAxiom - Represents a SubDataPropertyOf axiom in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::SubDataPropAxiom>
