...
# 21
    ...
    sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ opendir(DH1,"6005.777.A"     ); my $r = eval q{ int 1000 * -M DH1 }; closedir DH1; $r                                              }) },
    sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ opendir(DH1,"6005.000.A"     ); my $r = eval q{ int 1000 * -M DH1 }; closedir DH1; $r                                              }) },
...
# 31
    ...
    sub { return 'SKIP' unless $MSWin32_MBCS; not                                              mb::eval(q{ opendir(DH2,"6005.777.ソ"     ); int 1000 * -M DH2 }) },
    sub { return 'SKIP' unless $MSWin32_MBCS; not                                              mb::eval(q{ opendir(DH2,"6005.000.ソ"     ); int 1000 * -M DH2 }) },
...
# 41
    ...
    sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ opendir(DH1,"6005.777.A"     ); opendir(DH2,"6005.777.ソ"     ); (int 1000 * -M DH1) xor (int 1000 * -M DH2) }) },
    sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ opendir(DH1,"6005.000.A"     ); opendir(DH2,"6005.000.ソ"     ); (int 1000 * -M DH1) xor (int 1000 * -M DH2) }) },
