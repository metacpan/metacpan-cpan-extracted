...
Data::Sah::Coerce::perl::int::int_check_gid_exists - Check that UID exists (has associated username) on the system

=head1 VERSION

This document describes version 0.005 of Data::Sah::Coerce::perl::int::int_check_gid_exists (from Perl distribution Sah-Schemas-Unix), released on 2019-09-11.
