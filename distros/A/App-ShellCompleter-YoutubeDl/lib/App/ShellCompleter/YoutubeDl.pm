...
App::ShellCompleter::YoutubeDl - Shell completion for youtube-dl

=head1 VERSION

This document describes version 0.123 of App::ShellCompleter::YoutubeDl (from Perl distribution App-ShellCompleter-YoutubeDl), released on 2021-09-07.

=head1 SYNOPSIS

See L<_youtube-dl> included in this distribution.
...
L<App::ShellCompleter::YtDlp> for the newer C<yt-dlp> CLI.

youtube-dl, L<https://rg3.github.io/youtube-dl/>
