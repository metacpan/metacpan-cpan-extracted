...
my $color  = Latin4::substr $s, 4, 5;   # black
my $middle = Latin4::substr $s, 4, -11; # black cat climbed the
my $end    = Latin4::substr $s, 14;     # climebed the green tree
my $tail   = Latin4::substr $s, -4;     # tree
my $z      = Latin4::substr $s, -4, 2;  # tr
