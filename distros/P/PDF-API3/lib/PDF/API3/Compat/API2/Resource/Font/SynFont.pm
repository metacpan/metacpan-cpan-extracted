...
#
#=======================================================================
package PDF::API3::Compat::API2::Resource::Font::SynFont;
...
PDF::API3::Compat::API2::Resource::Font::SynFont - Module for using synthetic Fonts.
...
=item $font = PDF::API3::Compat::API2::Resource::Font::SynFont->new $pdf, $fontobj, %options
...
sub new 
{
    ...
    if($font->isa('PDF::API3::Compat::API2::Resource::CIDFont'))
    {
...
=item $font = PDF::API3::Compat::API2::Resource::Font::SynFont->new_api $api, $fontobj, %options
