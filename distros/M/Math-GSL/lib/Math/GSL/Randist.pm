...
package Math::GSL::Randist;
use base qw(Exporter);
use base qw(DynaLoader);
package Math::GSL::Randistc;
bootstrap Math::GSL::Randist;
package Math::GSL::Randist;
@EXPORT = qw();
...
*gsl_error = *Math::GSL::Randistc::gsl_error;
*gsl_stream_printf = *Math::GSL::Randistc::gsl_stream_printf;
*gsl_strerror = *Math::GSL::Randistc::gsl_strerror;
*gsl_set_error_handler = *Math::GSL::Randistc::gsl_set_error_handler;
*gsl_set_error_handler_off = *Math::GSL::Randistc::gsl_set_error_handler_off;
*gsl_set_stream_handler = *Math::GSL::Randistc::gsl_set_stream_handler;
*gsl_set_stream = *Math::GSL::Randistc::gsl_set_stream;
*gsl_ran_dir_2d = *Math::GSL::Randistc::gsl_ran_dir_2d;
*gsl_ran_dir_2d_trig_method = *Math::GSL::Randistc::gsl_ran_dir_2d_trig_method;
*gsl_ran_dir_3d = *Math::GSL::Randistc::gsl_ran_dir_3d;
*gsl_ran_bivariate_gaussian = *Math::GSL::Randistc::gsl_ran_bivariate_gaussian;
*gsl_ran_dirichlet = *Math::GSL::Randistc::gsl_ran_dirichlet;
*gsl_ran_dirichlet_pdf = *Math::GSL::Randistc::gsl_ran_dirichlet_pdf;
*gsl_ran_dirichlet_lnpdf = *Math::GSL::Randistc::gsl_ran_dirichlet_lnpdf;
*gsl_ran_multinomial = *Math::GSL::Randistc::gsl_ran_multinomial;
*gsl_ran_multinomial_pdf = *Math::GSL::Randistc::gsl_ran_multinomial_pdf;
*gsl_ran_multinomial_lnpdf = *Math::GSL::Randistc::gsl_ran_multinomial_lnpdf;
*gsl_ran_dir_nd = *Math::GSL::Randistc::gsl_ran_dir_nd;
*gsl_ran_bernoulli = *Math::GSL::Randistc::gsl_ran_bernoulli;
*gsl_ran_bernoulli_pdf = *Math::GSL::Randistc::gsl_ran_bernoulli_pdf;
*gsl_ran_beta = *Math::GSL::Randistc::gsl_ran_beta;
*gsl_ran_beta_pdf = *Math::GSL::Randistc::gsl_ran_beta_pdf;
*gsl_ran_binomial = *Math::GSL::Randistc::gsl_ran_binomial;
*gsl_ran_binomial_knuth = *Math::GSL::Randistc::gsl_ran_binomial_knuth;
*gsl_ran_binomial_tpe = *Math::GSL::Randistc::gsl_ran_binomial_tpe;
*gsl_ran_binomial_pdf = *Math::GSL::Randistc::gsl_ran_binomial_pdf;
*gsl_ran_exponential = *Math::GSL::Randistc::gsl_ran_exponential;
*gsl_ran_exponential_pdf = *Math::GSL::Randistc::gsl_ran_exponential_pdf;
*gsl_ran_exppow = *Math::GSL::Randistc::gsl_ran_exppow;
*gsl_ran_exppow_pdf = *Math::GSL::Randistc::gsl_ran_exppow_pdf;
*gsl_ran_cauchy = *Math::GSL::Randistc::gsl_ran_cauchy;
*gsl_ran_cauchy_pdf = *Math::GSL::Randistc::gsl_ran_cauchy_pdf;
*gsl_ran_chisq = *Math::GSL::Randistc::gsl_ran_chisq;
*gsl_ran_chisq_pdf = *Math::GSL::Randistc::gsl_ran_chisq_pdf;
*gsl_ran_erlang = *Math::GSL::Randistc::gsl_ran_erlang;
*gsl_ran_erlang_pdf = *Math::GSL::Randistc::gsl_ran_erlang_pdf;
*gsl_ran_fdist = *Math::GSL::Randistc::gsl_ran_fdist;
*gsl_ran_fdist_pdf = *Math::GSL::Randistc::gsl_ran_fdist_pdf;
*gsl_ran_flat = *Math::GSL::Randistc::gsl_ran_flat;
*gsl_ran_flat_pdf = *Math::GSL::Randistc::gsl_ran_flat_pdf;
*gsl_ran_gamma = *Math::GSL::Randistc::gsl_ran_gamma;
*gsl_ran_gamma_int = *Math::GSL::Randistc::gsl_ran_gamma_int;
*gsl_ran_gamma_pdf = *Math::GSL::Randistc::gsl_ran_gamma_pdf;
*gsl_ran_gamma_mt = *Math::GSL::Randistc::gsl_ran_gamma_mt;
*gsl_ran_gamma_knuth = *Math::GSL::Randistc::gsl_ran_gamma_knuth;
*gsl_ran_gaussian = *Math::GSL::Randistc::gsl_ran_gaussian;
*gsl_ran_gaussian_ratio_method = *Math::GSL::Randistc::gsl_ran_gaussian_ratio_method;
*gsl_ran_gaussian_ziggurat = *Math::GSL::Randistc::gsl_ran_gaussian_ziggurat;
*gsl_ran_gaussian_pdf = *Math::GSL::Randistc::gsl_ran_gaussian_pdf;
*gsl_ran_ugaussian = *Math::GSL::Randistc::gsl_ran_ugaussian;
*gsl_ran_ugaussian_ratio_method = *Math::GSL::Randistc::gsl_ran_ugaussian_ratio_method;
*gsl_ran_ugaussian_pdf = *Math::GSL::Randistc::gsl_ran_ugaussian_pdf;
*gsl_ran_gaussian_tail = *Math::GSL::Randistc::gsl_ran_gaussian_tail;
*gsl_ran_gaussian_tail_pdf = *Math::GSL::Randistc::gsl_ran_gaussian_tail_pdf;
*gsl_ran_ugaussian_tail = *Math::GSL::Randistc::gsl_ran_ugaussian_tail;
*gsl_ran_ugaussian_tail_pdf = *Math::GSL::Randistc::gsl_ran_ugaussian_tail_pdf;
*gsl_ran_bivariate_gaussian_pdf = *Math::GSL::Randistc::gsl_ran_bivariate_gaussian_pdf;
*gsl_ran_multivariate_gaussian = *Math::GSL::Randistc::gsl_ran_multivariate_gaussian;
*gsl_ran_multivariate_gaussian_log_pdf = *Math::GSL::Randistc::gsl_ran_multivariate_gaussian_log_pdf;
*gsl_ran_multivariate_gaussian_pdf = *Math::GSL::Randistc::gsl_ran_multivariate_gaussian_pdf;
*gsl_ran_multivariate_gaussian_mean = *Math::GSL::Randistc::gsl_ran_multivariate_gaussian_mean;
*gsl_ran_multivariate_gaussian_vcov = *Math::GSL::Randistc::gsl_ran_multivariate_gaussian_vcov;
*gsl_ran_wishart = *Math::GSL::Randistc::gsl_ran_wishart;
*gsl_ran_wishart_log_pdf = *Math::GSL::Randistc::gsl_ran_wishart_log_pdf;
*gsl_ran_wishart_pdf = *Math::GSL::Randistc::gsl_ran_wishart_pdf;
*gsl_ran_landau = *Math::GSL::Randistc::gsl_ran_landau;
*gsl_ran_landau_pdf = *Math::GSL::Randistc::gsl_ran_landau_pdf;
*gsl_ran_geometric = *Math::GSL::Randistc::gsl_ran_geometric;
*gsl_ran_geometric_pdf = *Math::GSL::Randistc::gsl_ran_geometric_pdf;
*gsl_ran_hypergeometric = *Math::GSL::Randistc::gsl_ran_hypergeometric;
*gsl_ran_hypergeometric_pdf = *Math::GSL::Randistc::gsl_ran_hypergeometric_pdf;
*gsl_ran_gumbel1 = *Math::GSL::Randistc::gsl_ran_gumbel1;
*gsl_ran_gumbel1_pdf = *Math::GSL::Randistc::gsl_ran_gumbel1_pdf;
*gsl_ran_gumbel2 = *Math::GSL::Randistc::gsl_ran_gumbel2;
*gsl_ran_gumbel2_pdf = *Math::GSL::Randistc::gsl_ran_gumbel2_pdf;
*gsl_ran_logistic = *Math::GSL::Randistc::gsl_ran_logistic;
*gsl_ran_logistic_pdf = *Math::GSL::Randistc::gsl_ran_logistic_pdf;
*gsl_ran_lognormal = *Math::GSL::Randistc::gsl_ran_lognormal;
*gsl_ran_lognormal_pdf = *Math::GSL::Randistc::gsl_ran_lognormal_pdf;
*gsl_ran_logarithmic = *Math::GSL::Randistc::gsl_ran_logarithmic;
*gsl_ran_logarithmic_pdf = *Math::GSL::Randistc::gsl_ran_logarithmic_pdf;
*gsl_ran_negative_binomial = *Math::GSL::Randistc::gsl_ran_negative_binomial;
*gsl_ran_negative_binomial_pdf = *Math::GSL::Randistc::gsl_ran_negative_binomial_pdf;
*gsl_ran_pascal = *Math::GSL::Randistc::gsl_ran_pascal;
*gsl_ran_pascal_pdf = *Math::GSL::Randistc::gsl_ran_pascal_pdf;
*gsl_ran_pareto = *Math::GSL::Randistc::gsl_ran_pareto;
*gsl_ran_pareto_pdf = *Math::GSL::Randistc::gsl_ran_pareto_pdf;
*gsl_ran_poisson = *Math::GSL::Randistc::gsl_ran_poisson;
*gsl_ran_poisson_array = *Math::GSL::Randistc::gsl_ran_poisson_array;
*gsl_ran_poisson_pdf = *Math::GSL::Randistc::gsl_ran_poisson_pdf;
*gsl_ran_rayleigh = *Math::GSL::Randistc::gsl_ran_rayleigh;
*gsl_ran_rayleigh_pdf = *Math::GSL::Randistc::gsl_ran_rayleigh_pdf;
*gsl_ran_rayleigh_tail = *Math::GSL::Randistc::gsl_ran_rayleigh_tail;
*gsl_ran_rayleigh_tail_pdf = *Math::GSL::Randistc::gsl_ran_rayleigh_tail_pdf;
*gsl_ran_tdist = *Math::GSL::Randistc::gsl_ran_tdist;
*gsl_ran_tdist_pdf = *Math::GSL::Randistc::gsl_ran_tdist_pdf;
*gsl_ran_laplace = *Math::GSL::Randistc::gsl_ran_laplace;
*gsl_ran_laplace_pdf = *Math::GSL::Randistc::gsl_ran_laplace_pdf;
*gsl_ran_levy = *Math::GSL::Randistc::gsl_ran_levy;
*gsl_ran_levy_skew = *Math::GSL::Randistc::gsl_ran_levy_skew;
*gsl_ran_weibull = *Math::GSL::Randistc::gsl_ran_weibull;
*gsl_ran_weibull_pdf = *Math::GSL::Randistc::gsl_ran_weibull_pdf;
*gsl_ran_shuffle = *Math::GSL::Randistc::gsl_ran_shuffle;
*gsl_ran_choose = *Math::GSL::Randistc::gsl_ran_choose;
*gsl_ran_sample = *Math::GSL::Randistc::gsl_ran_sample;
*gsl_ran_discrete_preproc = *Math::GSL::Randistc::gsl_ran_discrete_preproc;
*gsl_ran_discrete_free = *Math::GSL::Randistc::gsl_ran_discrete_free;
*gsl_ran_discrete = *Math::GSL::Randistc::gsl_ran_discrete;
*gsl_ran_discrete_pdf = *Math::GSL::Randistc::gsl_ran_discrete_pdf;
*our_gsl_ran_shuffle = *Math::GSL::Randistc::our_gsl_ran_shuffle;
*our_gsl_ran_choose = *Math::GSL::Randistc::our_gsl_ran_choose;
*our_gsl_ran_sample = *Math::GSL::Randistc::our_gsl_ran_sample;

############# Class : Math::GSL::Randist::gsl_ran_discrete_t ##############

package Math::GSL::Randist::gsl_ran_discrete_t;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( Math::GSL::Randist );
%OWNER = ();
%ITERATORS = ();
*swig_K_get = *Math::GSL::Randistc::gsl_ran_discrete_t_K_get;
*swig_K_set = *Math::GSL::Randistc::gsl_ran_discrete_t_K_set;
*swig_A_get = *Math::GSL::Randistc::gsl_ran_discrete_t_A_get;
*swig_A_set = *Math::GSL::Randistc::gsl_ran_discrete_t_A_set;
*swig_F_get = *Math::GSL::Randistc::gsl_ran_discrete_t_F_get;
*swig_F_set = *Math::GSL::Randistc::gsl_ran_discrete_t_F_set;
sub new {
    my $pkg = shift;
    my $self = Math::GSL::Randistc::new_gsl_ran_discrete_t(@_);
...
sub DESTROY {
    ...
    if (exists $OWNER{$self}) {
        Math::GSL::Randistc::delete_gsl_ran_discrete_t($self);
        delete $OWNER{$self};
    }
}
...
*GSL_VERSION = *Math::GSL::Randistc::GSL_VERSION;
...
*GSL_SUCCESS = *Math::GSL::Randistc::GSL_SUCCESS;
*GSL_FAILURE = *Math::GSL::Randistc::GSL_FAILURE;
*GSL_CONTINUE = *Math::GSL::Randistc::GSL_CONTINUE;
*GSL_EDOM = *Math::GSL::Randistc::GSL_EDOM;
*GSL_ERANGE = *Math::GSL::Randistc::GSL_ERANGE;
*GSL_EFAULT = *Math::GSL::Randistc::GSL_EFAULT;
*GSL_EINVAL = *Math::GSL::Randistc::GSL_EINVAL;
*GSL_EFAILED = *Math::GSL::Randistc::GSL_EFAILED;
*GSL_EFACTOR = *Math::GSL::Randistc::GSL_EFACTOR;
*GSL_ESANITY = *Math::GSL::Randistc::GSL_ESANITY;
*GSL_ENOMEM = *Math::GSL::Randistc::GSL_ENOMEM;
*GSL_EBADFUNC = *Math::GSL::Randistc::GSL_EBADFUNC;
*GSL_ERUNAWAY = *Math::GSL::Randistc::GSL_ERUNAWAY;
*GSL_EMAXITER = *Math::GSL::Randistc::GSL_EMAXITER;
*GSL_EZERODIV = *Math::GSL::Randistc::GSL_EZERODIV;
*GSL_EBADTOL = *Math::GSL::Randistc::GSL_EBADTOL;
*GSL_ETOL = *Math::GSL::Randistc::GSL_ETOL;
*GSL_EUNDRFLW = *Math::GSL::Randistc::GSL_EUNDRFLW;
*GSL_EOVRFLW = *Math::GSL::Randistc::GSL_EOVRFLW;
*GSL_ELOSS = *Math::GSL::Randistc::GSL_ELOSS;
*GSL_EROUND = *Math::GSL::Randistc::GSL_EROUND;
*GSL_EBADLEN = *Math::GSL::Randistc::GSL_EBADLEN;
*GSL_ENOTSQR = *Math::GSL::Randistc::GSL_ENOTSQR;
*GSL_ESING = *Math::GSL::Randistc::GSL_ESING;
*GSL_EDIVERGE = *Math::GSL::Randistc::GSL_EDIVERGE;
*GSL_EUNSUP = *Math::GSL::Randistc::GSL_EUNSUP;
*GSL_EUNIMPL = *Math::GSL::Randistc::GSL_EUNIMPL;
*GSL_ECACHE = *Math::GSL::Randistc::GSL_ECACHE;
*GSL_ETABLE = *Math::GSL::Randistc::GSL_ETABLE;
*GSL_ENOPROG = *Math::GSL::Randistc::GSL_ENOPROG;
*GSL_ENOPROGJ = *Math::GSL::Randistc::GSL_ENOPROGJ;
*GSL_ETOLF = *Math::GSL::Randistc::GSL_ETOLF;
*GSL_ETOLX = *Math::GSL::Randistc::GSL_ETOLX;
*GSL_ETOLG = *Math::GSL::Randistc::GSL_ETOLG;
*GSL_EOF = *Math::GSL::Randistc::GSL_EOF;
