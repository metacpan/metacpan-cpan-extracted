package ## no critic: Modules::RequireFilenameMatchesPackage
    # hide from PAUSE
    TableDataRole::Perl::CPAN::Release::Static::1999;
...
around new => sub {
    ...
    my $filename = File::Basename::dirname(__FILE__) . '/../../../../../../share/1999.csv';
    unless (-f $filename) {
        require File::ShareDir;
        $filename = File::ShareDir::dist_file('TableDataBundle-Perl-CPAN-Release-Static-Older', '1999.csv');
    }
    $orig->(@_, filename=>$filename);
};

package TableData::Perl::CPAN::Release::Static::1999;
...
with 'TableDataRole::Perl::CPAN::Release::Static::1999';

our %STATS = ("num_rows",2680,"num_columns",9); # STATS

1;
# ABSTRACT: CPAN releases for the year 1999
...
TableDataRole::Perl::CPAN::Release::Static::1999 - CPAN releases for the year 1999

=head1 VERSION

This document describes version 20210927.1 of TableDataRole::Perl::CPAN::Release::Static::1999 (from Perl distribution TableDataBundle-Perl-CPAN-Release-Static-Older), released on 2021-10-05.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Perl::CPAN::Release::Static::1999;

 my $td = TableData::Perl::CPAN::Release::Static::1999->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Perl::CPAN::Release::Static::1999 --page

 # Get number of rows
 % tabledata --action count_rows Perl::CPAN::Release::Static::1999
