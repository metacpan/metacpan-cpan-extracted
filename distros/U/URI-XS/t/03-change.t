...
$uri = URI::XS->new('http://ya.ru:2345/my/path?p1=v1&p2=v2#myhash');
...
$uri = new URI::XS("http://ya.ru/my/path?p1=v1&p2=v2#myhash");
...
$uri = new URI::XS("//ya.ru:2345/my/path?p1=v1&p2=v2#myacnhor");
is($uri->proto, "");
