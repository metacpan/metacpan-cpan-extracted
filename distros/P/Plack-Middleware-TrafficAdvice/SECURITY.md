This is the Security Policy for the Perl distribution Plack-Middleware-TrafficAdvice.

The latest version of this Security Policy can be found at
https://metacpan.org/dist/Plack-Middleware-TrafficAdvice.
...
Any security vulnerabilities in Plack-Middleware-TrafficAdvice are covered
by this policy.
...
by this policy unless they affect Plack-Middleware-TrafficAdvice, or
Plack-Middleware-TrafficAdvice can be used to exploit vulnerabilities in
them.

Security vulnerabilities in downstream software (any software that
uses Plack-Middleware-TrafficAdvice, or plugins to it that are not included
with the Plack-Middleware-TrafficAdvice distribution) are not covered by
this policy.

## Which Versions of this Software are Supported?

The maintainer(s) will only commit to releasing security fixes for the
latest version of Plack-Middleware-TrafficAdvice.

Note that the Plack-Middleware-TrafficAdvice project only supports major
versions of Perl released in the past ten (10) years, even though
Plack-Middleware-TrafficAdvice will run on older versions of Perl.  If a
