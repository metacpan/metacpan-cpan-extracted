package Bio::VertRes::Config::Recipes::VirusRnaSeqExpressionUsingStampy;
...
Bio::VertRes::Config::Recipes::VirusRnaSeqExpressionUsingStampy - Standard snp calling pipeline for virus
...
RNA seq expression with Stampy
   ...
   my $obj = Bio::VertRes::Config::Recipes::VirusRnaSeqExpressionUsingStampy->new( 
     database => 'abc', 
