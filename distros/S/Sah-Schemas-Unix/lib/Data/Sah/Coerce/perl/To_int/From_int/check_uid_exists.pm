...
Data::Sah::Coerce::perl::To_int::From_int::check_uid_exists - Check that UID exists (has associated username) on the system

=head1 VERSION

This document describes version 0.009 of Data::Sah::Coerce::perl::To_int::From_int::check_uid_exists (from Perl distribution Sah-Schemas-Unix), released on 2019-12-09.

=head1 SYNOPSIS

To use in a Sah schema:

 ["int",{"x.perl.coerce_rules"=>["From_int::check_uid_exists"]}]
