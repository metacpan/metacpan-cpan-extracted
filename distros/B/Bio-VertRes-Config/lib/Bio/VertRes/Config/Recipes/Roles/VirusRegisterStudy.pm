package Bio::VertRes::Config::Recipes::Roles::VirusRegisterStudy;
...
sub add_virus_spades_assembly_config
{
  my ($self, $pipeline_configs_array) = @_;
  push(
      @{$pipeline_configs_array},
...
Bio::VertRes::Config::Recipes::Roles::VirusRegisterStudy - Moose Role for registering a study
