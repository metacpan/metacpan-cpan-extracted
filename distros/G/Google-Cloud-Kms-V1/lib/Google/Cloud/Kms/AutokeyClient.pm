package Google::Cloud::Kms::AutokeyClient;
...
sub create_key_handle {
    ...
    my $request_class = 'Google::Cloud::Kms::V1::Autokey::CreateKeyHandleRequest';
...
1; # End of Google::Cloud::Kms::AutokeyClient

__END__

=head1 NAME

Google::Cloud::Kms::AutokeyClient - Client library for Google Cloud Services

=head1 SYNOPSIS

    use Google::Cloud::Kms::AutokeyClient;
    use Google::Auth;

    my $auth = Google::Auth->default();

    # 1. High-performance gRPC Transport (Default)
    my $grpc_client = Google::Cloud::Kms::AutokeyClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Kms::AutokeyClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Kms::AutokeyClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Kms::AutokeyClient->new(
...
=item * B<create_key_handle>

Calls the RPC method C<CreateKeyHandle> on the service. Takes a hash of parameters representing the request.
