package Bencher::Scenarios::CloneModules;

our $DATE = '2021-07-31'; # DATE
our $VERSION = '0.051'; # VERSION

1;
# ABSTRACT: Scenarios related to data cloning modules
...
Bencher::Scenarios::CloneModules - Scenarios related to data cloning modules

=head1 VERSION

This document describes version 0.051 of Bencher::Scenarios::CloneModules (from Perl distribution Bencher-Scenarios-CloneModules), released on 2021-07-31.
...
=item * L<Bencher::Scenario::CloneModules>

=item * L<Bencher::Scenario::CloneModules::Startup>
