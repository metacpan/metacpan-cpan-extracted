package Google::Ads::AdWords::v201702::AdParamPage;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'entries' => 'Google::Ads::AdWords::v201702::AdParam',
...
AdParamPage from the namespace https://adwords.google.com/api/adwords/cm/v201702.
