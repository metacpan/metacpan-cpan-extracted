...
is_deeply([$locale->get_digits], [0 .. 9], 'Get digits welsh');
...
# RBNF
is($locale->format_number(0, 'spellout-numbering-year'), 'dim', 'RBNF: Spell out year 0');
is($locale->format_number('-0.0', 'spellout-numbering'), 'minws dim pwynt dim', 'RBNF: Spell out -0.0');
