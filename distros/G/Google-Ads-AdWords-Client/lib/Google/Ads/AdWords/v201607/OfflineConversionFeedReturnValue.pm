package Google::Ads::AdWords::v201607::OfflineConversionFeedReturnValue;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201607::ListReturnValue);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'value' => 'Google::Ads::AdWords::v201607::OfflineConversionFeed',
        'partialFailureErrors' => 'Google::Ads::AdWords::v201607::ApiError',
    },
    {
...
OfflineConversionFeedReturnValue from the namespace https://adwords.google.com/api/adwords/cm/v201607.
