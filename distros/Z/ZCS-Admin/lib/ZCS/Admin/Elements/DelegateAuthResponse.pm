...
package ZCS::Admin::Elements::DelegateAuthResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('DelegateAuthResponse');
...
ZCS::Admin::Elements::DelegateAuthResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
DelegateAuthResponse from the namespace urn:zimbraAdmin.
...
=head2 new
 ...
 my $element = ZCS::Admin::Elements::DelegateAuthResponse->new($data);
