...
Sah::SchemaR::lowercase_str - String containing only zero or more lowercase letters

=head1 VERSION

This document describes version 0.016 of Sah::SchemaR::lowercase_str (from Perl distribution Sah-Schemas-Str), released on 2023-10-23.
