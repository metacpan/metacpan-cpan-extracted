...
package Astro::FITS::HdrTrans::LCOSBIG_1m0;

=head1 NAME

Astro::FITS::HdrTrans::LCOSBIG_1m0 - LCO 1.0m SBIG translations

=head1 SYNOPSIS

  use Astro::FITS::HdrTrans::LCOSBIG_1m0;

  %gen = Astro::FITS::HdrTrans::LCOSBIG_1m0->translate_from_FITS( %hdr );
