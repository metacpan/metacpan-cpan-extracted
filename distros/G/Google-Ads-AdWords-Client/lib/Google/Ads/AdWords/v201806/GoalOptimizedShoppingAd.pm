package Google::Ads::AdWords::v201806::GoalOptimizedShoppingAd;
use strict;
use warnings;
...
Google::Ads::AdWords::v201806::GoalOptimizedShoppingAd

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
GoalOptimizedShoppingAd from the namespace https://adwords.google.com/api/adwords/cm/v201806.

Represents a goal-optimized Shopping ad (known as Shopping ad (goal-optimized) in the AdWords user interface). A goal-optimized Shopping ad targets multiple advertising channels across Search, Google Display Network, and YouTube with a focus on retail. This supports ads that display product data (managed using the Google Merchant Center) as specified in the parent campaign's {@linkplain ShoppingSetting Shopping setting} as well as ads using advertiser provided asset data. <p class="caution"><b>Caution:</b> goal-optimized Shopping ads do not use {@link #url url}, {@link #finalUrls finalUrls}, {@link #finalMobileUrls finalMobileUrls}, {@link #finalAppUrls finalAppUrls}, or {@link #displayUrl displayUrl}; setting these fields on a goal-optimized Shopping ad will cause an error. <span class="constraint AdxEnabled">This is enabled for AdX.</span> 
