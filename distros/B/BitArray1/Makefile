# This Makefile is for the BitArray extension to perl.
#
...
#     ABSTRACT => q[]
#     AUTHOR => q[George E. Worroll Jr. (geworrolljr@optonline.net)]
#     NAME => q[BitArray]
#     PREREQ_PM => { Test::Simple=>q[0.44] }
#     VERSION_FROM => q[lib/BitArray.pm]
...
TO_INST_PM = lib/BitArray.pm

PM_TO_BLIB = lib/BitArray.pm \
...
BitArray.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"BitArray\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib\lib\BitArray.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) "name:         BitArray" >> META.yml
	$(NOECHO) $(ECHO) "version:      0.01" >> META.yml
	$(NOECHO) $(ECHO) "version_from: lib/BitArray.pm" >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) "    <AUTHOR>George E. Worroll Jr. (geworrolljr@optonline.net)</AUTHOR>" >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', '$(PM_FILTER)')"\
	  lib/BitArray.pm blib\lib\BitArray.pm 
	$(NOECHO) $(TOUCH) $@
