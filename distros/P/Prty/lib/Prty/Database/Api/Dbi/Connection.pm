package Prty::Database::Api::Dbi::Connection;
...
use Prty::Option;
use DBI ();
use Prty::Database::Api::Dbi::Cursor;
...
Prty::Database::Api::Dbi::Connection - DBI Datenbank-Verbindung
...
Ein Objekt der Klasse Prty::Database::Api::Dbi::Connection repräsentiert eine
...
sein (siehe Doku zu Prty::Database::Connection/sql).
...
sub sql {
    ...
    return Prty::Database::Api::Dbi::Cursor->new(
        sth=>$sth,
        bindVars=>$bindVars,
        db=>$self,
        # titles=>$titles,
