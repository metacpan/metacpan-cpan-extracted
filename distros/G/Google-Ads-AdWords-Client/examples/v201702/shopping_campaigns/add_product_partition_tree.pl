...
use Google::Ads::AdWords::v201702::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201702::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201702::BiddingStrategyConfiguration;
use Google::Ads::AdWords::v201702::CpcBid;
use Google::Ads::AdWords::v201702::Criterion;
use Google::Ads::AdWords::v201702::Money;
use Google::Ads::AdWords::v201702::NegativeAdGroupCriterion;
use Google::Ads::AdWords::v201702::ProductBiddingCategory;
use Google::Ads::AdWords::v201702::ProductCanonicalCondition;
use Google::Ads::AdWords::v201702::ProductBrand;
use Google::Ads::AdWords::v201702::ProductPartition;
...
sub add_product_partition_tree {
  ...
  create_unit(
    ...
    $ad_group_id,
    $root,
    Google::Ads::AdWords::v201702::ProductCanonicalCondition->new(
      {condition => "NEW"}
    ),
    200000
  );
  ...
  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201702::ProductBrand->new({value => "CoolBrand"}),
    900000);

  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201702::ProductBrand->new({value => "CheapBrand"}),
    10000);

  my $other_brand =
    create_subdivision($operations, $next_id--, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201702::ProductBrand->new());
  ...
  create_unit(
    ...
    $ad_group_id,
    $other_brand,
    Google::Ads::AdWords::v201702::ProductBiddingCategory->new({
...
sub create_subdivision {
  ...
  my $division = Google::Ads::AdWords::v201702::ProductPartition->new({
  ...
  my $criterion = Google::Ads::AdWords::v201702::BiddableAdGroupCriterion->new({
...
sub create_unit {
  ...
  my $unit = Google::Ads::AdWords::v201702::ProductPartition->new(
    {partitionType => "UNIT",});
  ...
  if ($bid_amount && $bid_amount > 0) {
    my $biddingStrategyConfiguration =
      Google::Ads::AdWords::v201702::BiddingStrategyConfiguration->new({
        bids => [
          Google::Ads::AdWords::v201702::CpcBid->new({
              bid => Google::Ads::AdWords::v201702::Money->new(
                {microAmount => $bid_amount})})]});

    $criterion =
      Google::Ads::AdWords::v201702::BiddableAdGroupCriterion->new(
      {biddingStrategyConfiguration => $biddingStrategyConfiguration});
  } else {
    $criterion = Google::Ads::AdWords::v201702::NegativeAdGroupCriterion->new();
  }
...
sub create_add_operation {
  ...
  my $operation = Google::Ads::AdWords::v201702::AdGroupCriterionOperation->new(
    {
