...
Data::Sah::Filter::perl::Unix::convert_unix_user_to_uid - Convert Unix username into UID, fail when cannot convert

=head1 VERSION

This document describes version 0.022 of Data::Sah::Filter::perl::Unix::convert_unix_user_to_uid (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.
