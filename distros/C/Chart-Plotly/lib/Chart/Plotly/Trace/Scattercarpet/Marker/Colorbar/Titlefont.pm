package Chart::Plotly::Trace::Scattercarpet::Marker::Colorbar::Titlefont;
use Moose;
...
Chart::Plotly::Trace::Scattercarpet::Marker::Colorbar::Titlefont - This attribute is one of the possible options for the trace scattercarpet.
