package Perinci::Sub::XCompletion::unix_group;
...
use Complete::Unix qw(complete_group);
...
1;
# ABSTRACT: Generate completion for Unix group
...
Perinci::Sub::XCompletion::unix_group - Generate completion for Unix group

=head1 VERSION

This document describes version 0.022 of Perinci::Sub::XCompletion::unix_group (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.

=head1 SYNOPSIS

=head1 DESCRIPTION

This creates a completion from list of local Unix group names.
