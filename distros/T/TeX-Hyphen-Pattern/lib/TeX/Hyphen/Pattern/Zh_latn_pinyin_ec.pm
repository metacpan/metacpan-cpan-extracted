...
package TeX::Hyphen::Pattern::Zh_latn_pinyin_ec v1.1.5;
use strict;
use warnings;
use 5.014000;
use utf8;
...
sub version {
    return $TeX::Hyphen::Pattern::Zh_latn_pinyin_ec::VERSION;
}
...
=head1 C<Zh_latn_pinyin_ec> hyphenation pattern class
...
L<svn://tug.org/texhyphen/trunk/hyph-utf8/tex/generic/hyph-utf8/patterns/ptex/hyph-zh-latn-pinyin.ec.tex>
