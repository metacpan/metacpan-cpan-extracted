...
BEGIN {
  $Dist::Zilla::Plugin::RunByBranch::BeforeRelease::AUTHORITY = 'cpan:FFFINKEL';
}
{
  $Dist::Zilla::Plugin::RunByBranch::BeforeRelease::VERSION = '0.214';
}
...
Dist::Zilla::Plugin::RunByBranch::BeforeRelease
