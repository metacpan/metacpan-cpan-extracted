...
sub attr {
    ...
    for my $attr ( @{ ref $attrs eq 'ARRAY' ? $attrs : [$attrs] } ) {
        ...
        Carp::croak "Deeme::Obj error: $@" unless eval "$code;1";
    }
}
...
L<Deeme::Obj> is a simple base class for L<Deeme>, a fork of  L<Mojo::Base>.
...
L<Deeme::Obj> implements the following functions like L<Mojo::Base>, which can be imported with
...
L<Deeme::Obj> implements the following methods.
