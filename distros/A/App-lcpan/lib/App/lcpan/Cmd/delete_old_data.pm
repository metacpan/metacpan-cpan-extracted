...
1;
# ABSTRACT: Delete old data (contents of old_* tables)
...
App::lcpan::Cmd::delete_old_data - Delete old data (contents of old_* tables)

=head1 VERSION

This document describes version 1.071 of App::lcpan::Cmd::delete_old_data (from Perl distribution App-lcpan), released on 2022-09-19.
