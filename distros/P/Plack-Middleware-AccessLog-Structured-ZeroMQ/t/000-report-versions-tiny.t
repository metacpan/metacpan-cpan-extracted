...
eval { $v .= pmver('Message::Passing::Filter::Decoder::JSON','any version') };
eval { $v .= pmver('Message::Passing::Input::ZeroMQ','any version') };
eval { $v .= pmver('Message::Passing::Output::Test','any version') };
eval { $v .= pmver('Message::Passing::Output::ZeroMQ','any version') };
eval { $v .= pmver('Module::Build','0.28') };
eval { $v .= pmver('Plack::Middleware::AccessLog::Structured','any version') };
