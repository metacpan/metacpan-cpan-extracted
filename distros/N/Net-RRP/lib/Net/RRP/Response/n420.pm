package Net::RRP::Response::n420;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n420::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n420::VERSION = '0.1';
...
Net::RRP::Response::n420 - the 420 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
