...
Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedIngress - REMOVED -- superseded by Kubernetes::REST's unified v1 API, see Kubernetes::REST::Deprecated
...
C<Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedIngress> itself was never functional in the C<1.x> series -- it
...
C<cpanm Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedIngress> -- or a cpanfile / code that still references the
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedIngress - REMOVED, superseded by Kubernetes::REST's unified v1 API
