package
  XS::Install::FrozenShit::ParseXS::Constants;
use strict;
use warnings;
use Symbol;
...
XS::Install::FrozenShit::ParseXS::Constants - Initialization values for some globals

=head1 SYNOPSIS

  use XS::Install::FrozenShit::ParseXS::Constants ();

  $PrototypeRegexp = $XS::Install::FrozenShit::ParseXS::Constants::PrototypeRegexp;

=head1 DESCRIPTION

Initialization of certain non-subroutine variables in XS::Install::FrozenShit::ParseXS and some of its
