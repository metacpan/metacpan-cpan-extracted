package Google::Ads::AdWords::v201802::DataUploadResult;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'uploadStatus' => 'Google::Ads::AdWords::v201802::UserListUploadStatus',
        'removeAllStatus' => 'Google::Ads::AdWords::v201802::UserListUploadStatus',
    },
    {
...
Google::Ads::AdWords::v201802::DataUploadResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DataUploadResult from the namespace https://adwords.google.com/api/adwords/rm/v201802.
