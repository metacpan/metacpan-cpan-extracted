# AWS::Pinpoint::APNSChannel generated from spec 14.3.0
use Moose::Util::TypeConstraints;

coerce 'Cfn::Resource::Properties::AWS::Pinpoint::APNSChannel',
  from 'HashRef',
   via { Cfn::Resource::Properties::AWS::Pinpoint::APNSChannel->new( %$_ ) };

package Cfn::Resource::AWS::Pinpoint::APNSChannel {
  use Moose;
  extends 'Cfn::Resource';
  has Properties => (isa => 'Cfn::Resource::Properties::AWS::Pinpoint::APNSChannel', is => 'rw', coerce => 1);
...
package Cfn::Resource::Properties::AWS::Pinpoint::APNSChannel {
  use Moose;
...
Cfn::Resource::AWS::Pinpoint::APNSChannel - Cfn resource for AWS::Pinpoint::APNSChannel

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::Pinpoint::APNSChannel.
