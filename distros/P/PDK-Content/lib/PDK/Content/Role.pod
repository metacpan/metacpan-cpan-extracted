...
An arrayref of integers representing the parse status of each line in the configuration. It is built using the C<_buildLineParsedFlags> method, which must be implemented by the consuming class.
