...
upload.pl - test suite for the Meta::Lang::Perl::Upload module.
...
Meta::Baseline::Test(3), Meta::Lang::Perl::Upload(3), Meta::Utils::Opts::Opts(3), Meta::Utils::System(3), strict(3)
