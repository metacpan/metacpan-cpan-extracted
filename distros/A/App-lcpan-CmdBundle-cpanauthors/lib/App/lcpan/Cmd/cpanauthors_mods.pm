...
1;
# ABSTRACT: List Acme::CPANAuthors modules available on CPAN
...
App::lcpan::Cmd::cpanauthors_mods - List Acme::CPANAuthors modules available on CPAN
...
This module handles the L<lcpan> subcommand C<cpanauthors-mods>.
...
List Acme::CPANAuthors modules available on CPAN.
