This is the Security Policy for the Perl distribution Data-Enum.

The latest version of this Security Policy can be found at
https://metacpan.org/dist/Data-Enum.
...
Any security vulnerabilities in Data-Enum are covered
by this policy.
...
by this policy unless they affect Data-Enum, or
Data-Enum can be used to exploit vulnerabilities in
them.

Security vulnerabilities in downstream software (any software that
uses Data-Enum, or plugins to it that are not included
with the Data-Enum distribution) are not covered by
this policy.

## Which Versions of this Software are Supported?

The maintainer(s) will only commit to releasing security fixes for the
latest version of Data-Enum.

Note that the Data-Enum project only supports major
versions of Perl released in the past ten (10) years, even though
Data-Enum will run on older versions of Perl.  If a
