...
package Google::Ads::AdWords::v201609::ConstantDataService::getMobileDeviceCriterion;
use strict;
use warnings;
...
getMobileDeviceCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201609.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201609::ConstantDataService::getMobileDeviceCriterion->new($data);
