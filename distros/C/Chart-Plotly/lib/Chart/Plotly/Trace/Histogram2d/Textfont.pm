package Chart::Plotly::Trace::Histogram2d::Textfont;
use Moose;
...
Chart::Plotly::Trace::Histogram2d::Textfont - This attribute is one of the possible options for the trace histogram2d.
