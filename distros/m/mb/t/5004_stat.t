...
# 1
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; mb::eval(q{ open FILE,">5004.ソ"; print FILE "A"; close FILE; }) },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 31
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; mb::eval(  q{ @_ = stat "5004.ソ"; scalar(@_) == 13 }) },
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; mb::eval(  q{ -e "5004.ソ"; @_ = stat _; scalar(@_) == 13 }) },
    sub {1},
    sub {1},
    sub {1},
# 41
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; mb::eval(q{ unlink "5004.ソ";    }) },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
