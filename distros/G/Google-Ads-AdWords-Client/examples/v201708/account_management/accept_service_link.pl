...
use Google::Ads::AdWords::v201708::ServiceLink;
use Google::Ads::AdWords::v201708::ServiceLinkOperation;
...
sub accept_service_link {
  ...
  my $service_link = Google::Ads::AdWords::v201708::ServiceLink->new({
  ...
  my $op = Google::Ads::AdWords::v201708::ServiceLinkOperation->new({
    operator => "SET",
