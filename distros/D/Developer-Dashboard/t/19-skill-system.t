...
Test file in the Developer Dashboard codebase. This file tests isolated skill installation and dispatch behaviour.
...
Run it directly with C<prove -lv t/19-skill-system.t> while iterating, then keep it green under C<prove -lr t> before release. Add or update assertions here before changing the implementation that it covers.
