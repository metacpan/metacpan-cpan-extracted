...
package UMMF::MOF_1_3::Model::StructuralFeature;
...
L<UMMF::MOF_1_3::Model::Feature|UMMF::MOF_1_3::Model::Feature>
...
use base qw(
  UMMF::MOF_1_3::Model::Feature  UMMF::MOF_1_3::Model::TypedElement
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_3::Model::StructuralFeature->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_3::Model::StructuralFeature|UMMF::MOF_1_3::Model::StructuralFeature>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_3::Model::StructuralFeature')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_3::Model::StructuralFeature->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_3::Model::StructuralFeature->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_3::Model::StructuralFeature' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_3::Model::StructuralFeature|UMMF::MOF_1_3::Model::StructuralFeature>.
  ...
  $__tangram_schema ||=
  {
   ...
   [
	 ...
	 # Associations
       ...
       'bases' => [  'UMMF::MOF_1_3::Model::Feature',  'UMMF::MOF_1_3::Model::TypedElement',  ],
       'sql' => {
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_3::Model::StructuralFeature::___create(@args);
...
sub set_multiplicity ($$)
{
  ...
  if ( defined $val ) {
    $self->__use('UMMF::MOF_1_3::Model::MultiplicityType')->__typecheck($val, "UMMF::MOF_1_3::Model::StructuralFeature.multiplicity");
  }
