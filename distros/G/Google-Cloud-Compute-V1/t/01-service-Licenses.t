...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::License Google::Cloud::Compute::V1::Compute::LicensesListResponse Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::Policy Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::LicensesClient->new( credentials => 'dummy' );
