...
IO::K8s::Api::Scheduling::V1beta1::CompositePodGroupSchedulingConstraints - CompositePodGroupSchedulingConstraints defines scheduling constraints (e.g. topology) for a CompositePodGroup.
