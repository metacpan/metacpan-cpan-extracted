package Chart::Plotly::Trace::Funnel::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Funnel::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Funnel::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Funnel::Legendgrouptitle - This attribute is one of the possible options for the trace funnel.
