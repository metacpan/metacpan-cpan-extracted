...
diag "\nusing Nagios::Monitoring::Plugin::Performance revision ". $Nagios::Monitoring::Plugin::Performance::VERSION . "\n" if $ENV{TEST_VERBOSE};

# Round-trip tests
for my $t (@test) {
    # Parse to components
    ($p) = Nagios::Monitoring::Plugin::Performance->parse_perfstring($t->{perfoutput});
    ...
    $p = Nagios::Monitoring::Plugin::Performance->new(map { $_ => $t->{$_} } @construct);
    ...
    $p = Nagios::Monitoring::Plugin::Performance->new(
        map({ $_ => $t->{$_} } @construct), 
        threshold => Nagios::Monitoring::Plugin::Threshold->set_thresholds(warning => $t->{warning}, critical => $t->{critical}),
    );
    is($p->perfoutput, $expected_perfoutput, "perfoutput okay ($expected_perfoutput)");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("/=382MB;15264;15269;; /var=218MB;9443;9448");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("rubbish");
ok( ! @p, "Errors correctly");
ok( ! Nagios::Monitoring::Plugin::Performance->parse_perfstring(""), "Errors on empty string");



# Check 1 bad with 1 good format output
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("rta=&391ms;100,200;500,034;0;   pl=0%;20;60  ");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("   pl=0%;20;60  rta=&391ms;100,200;500,034;0;   ");
is( scalar @p, 1, "One bad piece of data - only one returned" );
is( $p[0]->label, "pl", "label okay for different numeric");
is( $p[0]->value, 0, "value okay");
is( $p[0]->uom, "%", "uom okay");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring(
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring( "users=4;20;50;0" );
...
# Edge cases
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("/home/a-m=0;0;0 shared-folder:big=20 12345678901234567890=20");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("time=0.002722s;0.000000;0.000000;0.000000;10.000000");
cmp_ok( $p[0]->label, "eq", "time", "label okay");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("pct_used=73.7%;90;95");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("availability=93.8%;90:99;");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("offset=-0.004476s;-60.000000:-5;-120.000000:-3;");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("salary=52GBP;~:23.5;45.2:");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("offset=1.120567322e-05");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("offset=-1.120567322e-05unit;-1.1e-05:1.0e-03;4.3e+02:4.3e+25");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("rta=1,391ms;100,200;500,034;0; pl=0%;20;60;;");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("offset=-0,023545s;60,000000;120,000000;");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("time=1800,600,300,0,3600 other=45.6");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("'C:\ Label:  Serial Number bc22aa2e'=8015MB;16387;18435;0;20484 'D:\ Label: Serial Number XA22aa2e'=8015MB;16388;18436;1;2048");
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("  short=4 'C:\ Label:  Serial Number bc22aa2e'=8015MB;16387;18435;0;20484 end=5 ");
is( $p[0]->label, "short" );
...
@p = Nagios::Monitoring::Plugin::Performance->parse_perfstring("processes=9;WKFLSV32.exe;9=");
is_deeply( \@p, [], "Fails parsing correctly");

# add_perfdata tests in t/Nagios-Monitoring-Plugin-01.t
