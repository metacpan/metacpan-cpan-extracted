package ODO::RDFS::Properties::domain;
...
sub new {
	...
	$self->propertyContainerName( 'ODO::RDFS::Properties::domain::PropertiesContainer' );
	$self->properties(bless {}, 'ODO::RDFS::Properties::domain::PropertiesContainer');
