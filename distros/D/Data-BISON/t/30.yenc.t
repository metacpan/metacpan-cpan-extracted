...
my $cooked = join '', map { chr $_ } (
    0xa3, 0x6f, 0x98, 0x8d, 0x4a, 0x57, 0x4a, 0x7e, 0x8f, 0x9d, 0x9e, 0x90,
    0x93, 0x96, 0x8f, 0x4a, 0x52, 0x5b, 0x53, 0x37, 0x34, 0x6b, 0x7d, 0x6d,
    0x73, 0x73, 0x64, 0x4a, 0x5c, 0x5f, 0x5f, 0x58, 0x58, 0x5a, 0x37, 0x34,
    0x29, 0x28, 0x27, 0x26, 0x25, 0x24, 0x23, 0x22, 0x21, 0x20, 0x1f, 0x1e,
    0x1d, 0x1c, 0x1b, 0x1a, 0x19, 0x18, 0x17, 0x16, 0x15, 0x14, 0x13, 0x12,
    0x11, 0x10, 0x0f, 0x0e, 0x3d, 0x4d, 0x0c, 0x0b, 0x3d, 0x4a, 0x09, 0x08,
    0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01, 0x3d, 0x40, 0xff, 0xfe, 0xfd,
    ...
    0x7d, 0x3c, 0x3b, 0x3a, 0x39, 0x38, 0x37, 0x36, 0x35, 0x34, 0x33, 0x32,
    0x31, 0x30, 0x2f, 0x2e, 0x2d, 0x2c, 0x2b, 0x2a, 0x37, 0x34, 0x6b, 0x7d,
    0x6d, 0x73, 0x73, 0x64, 0x4a, 0x5a, 0x58, 0x58, 0x5c, 0x5f, 0x5f, 0x37,
    0x34, 0x2a, 0x2b, 0x2c, 0x2d, 0x2e, 0x2f, 0x30, 0x31, 0x32, 0x33, 0x34,
    0x35, 0x36, 0x37, 0x38, 0x39, 0x3a, 0x3b, 0x3c, 0x3d, 0x7d, 0x3e, 0x3f,
    ...
    0x3d, 0x40, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x3d,
    0x4a, 0x0b, 0x0c, 0x3d, 0x4d, 0x0e, 0x0f, 0x10, 0x11, 0x12, 0x13, 0x14,
    0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 0x20,
    0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x37, 0x34, 0x6f,
    0x98, 0x8e, 0x4a, 0x99, 0x90, 0x4a, 0x7e, 0x8f, 0x9d, 0x9e, 0x90, 0x93,
    0x96, 0x8f, 0x37, 0x34,
);

my $raw = join '', map { chr $_ } (
    0x79, 0x45, 0x6e, 0x63, 0x20, 0x2d, 0x20, 0x54, 0x65, 0x73, 0x74, 0x66,
    0x69, 0x6c, 0x65, 0x20, 0x28, 0x31, 0x29, 0x0d, 0x0a, 0x41, 0x53, 0x43,
    0x49, 0x49, 0x3a, 0x20, 0x32, 0x35, 0x35, 0x2e, 0x2e, 0x30, 0x0d, 0x0a,
    ...
    0x03, 0x02, 0x01, 0x00, 0x0d, 0x0a, 0x41, 0x53, 0x43, 0x49, 0x49, 0x3a,
    0x20, 0x30, 0x2e, 0x2e, 0x32, 0x35, 0x35, 0x0d, 0x0a, 0x00, 0x01, 0x02,
    ...
    0xff, 0x0d, 0x0a, 0x45, 0x6e, 0x64, 0x20, 0x6f, 0x66, 0x20, 0x54, 0x65,
    0x73, 0x74, 0x66, 0x69, 0x6c, 0x65, 0x0d, 0x0a,
);

my @test = (
    {
        name   => 'Encode',
        action => sub { encode_yEnc( shift ) },
        input  => $raw,
        expect => $cooked,
    },
    {
        name   => 'Decode',
        action => sub { decode_yEnc( shift ) },
        input  => $cooked,
        expect => $raw,
    },
);
...
for my $test ( @test ) {
    ...
    my $got    = $test->{action}->( $input );

    # Convert to arrays so the diagnostic is more useful
    my @got    = map { ord $_ } split //, $got;
    my @expect = map { ord $_ } split //, $expect;

    is_deeply \@got, \@expect, $name;
}
