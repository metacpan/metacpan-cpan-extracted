...
package Google::Ads::AdWords::v201705::ConstantDataService::getLanguageCriterion;
use strict;
use warnings;
...
getLanguageCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201705.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::ConstantDataService::getLanguageCriterion->new($data);
