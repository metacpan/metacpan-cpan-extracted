package Shipment::FedEx::WSDL::RateTypes::TransactionDetail;
$Shipment::FedEx::WSDL::RateTypes::TransactionDetail::VERSION = '3.02';
use strict;
use warnings;
...
TransactionDetail from the namespace http://fedex.com/ws/rate/v9.
