...
our %STATS = ("num_rows",12746,"num_columns",9); # STATS
...
TableDataRole::CPAN::Release::Static::2006 - CPAN releases for the year 2006

=head1 VERSION

This document describes version 20210927.0 of TableDataRole::CPAN::Release::Static::2006 (from Perl distribution TableDataBundle-CPAN-Release-Static-Older), released on 2021-09-27.

=head1 SYNOPSIS

 use TableData::CPAN::Release::Static::2006;

 my $td = TableData::CPAN::Release::Static::2006->new;
