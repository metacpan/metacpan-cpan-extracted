# AWS::AppMesh::Mesh generated from spec 2.30.0
...
subtype 'ArrayOfCfn::Resource::Properties::AWS::AppMesh::Mesh::TagRef',
     as 'Cfn::Value',
  where { $_->isa('Cfn::Value::Array') or $_->isa('Cfn::Value::Function') },
message { "$_ is not a Cfn::Value or a Cfn::Value::Function" };

coerce 'ArrayOfCfn::Resource::Properties::AWS::AppMesh::Mesh::TagRef',
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       return $f
  ...
  from 'ArrayRef',
   via {
     Cfn::Value::Array->new(Value => [
       map { 
         Moose::Util::TypeConstraints::find_type_constraint('Cfn::Resource::Properties::AWS::AppMesh::Mesh::TagRef')->coerce($_)
       } @$_
     ]);
   };

subtype 'Cfn::Resource::Properties::AWS::AppMesh::Mesh::TagRef',
     as 'Cfn::Value';

coerce 'Cfn::Resource::Properties::AWS::AppMesh::Mesh::TagRef',
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       return $f
     } else {
       return Cfn::Resource::Properties::AWS::AppMesh::Mesh::TagRefValue->new( %$_ );
     }
   };

package Cfn::Resource::Properties::AWS::AppMesh::Mesh::TagRefValue {
  use Moose;
  use MooseX::StrictConstructor;
  extends 'Cfn::Value::TypedValue';
...
package Cfn::Resource::Properties::AWS::AppMesh::Mesh {
  ...
  has Tags => (isa => 'ArrayOfCfn::Resource::Properties::AWS::AppMesh::Mesh::TagRef', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
}
