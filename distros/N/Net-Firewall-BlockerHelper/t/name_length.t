...
# ipset/pf tables at 31, ipfw tables at 63). Over-long prefix+name combos
# must fail clearly at new rather than as a confusing command error at init.
# The prefix used below is 'kur' so the object base name is 'kur_<name>'.
