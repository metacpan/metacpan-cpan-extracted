...
SQL::Statement::Function::ByName::DAYOFMONTH - DAYOFMONTH() SQL function

=head1 VERSION

This document describes version 0.04 of SQL::Statement::Function::ByName::DAYOFMONTH (from Perl distribution SQL-Statement-Functions-Date), released on 2017-01-25.
