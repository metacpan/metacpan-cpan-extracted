...
Feel free to clone it from its gitlab repository at <https://gitlab.com/deguest/Promise-Me> and issue a pull request.
...
File [an issue on bug tracker](https://gitlab.com/deguest/Promise-Me/issues) if you think you've found a bug. Please describe
...
Issues are currently reported using CPAN [bug tracker](https://gitlab.com/deguest/Promise-Me/issues)

## More information

Please refer to the [README](https://metacpan.org/source/JDEGUEST/Promise-Me-v0.6.0/README.md)
