# -*- perl -*-
##----------------------------------------------------------------------------
## Net/API/Telegram/InlineQueryResultCachedGif.pm
## Version 0.1
...
##----------------------------------------------------------------------------
package Net::API::Telegram::InlineQueryResultCachedGif;
BEGIN
{
	use strict;
...
sub gif_file_id { return( shift->_set_get_scalar( 'gif_file_id', @_ ) ); }
...
Net::API::Telegram::InlineQueryResultCachedGif - A link to an animated GIF file stored on the Telegram servers

=head1 SYNOPSIS

	my $msg = Net::API::Telegram::InlineQueryResultCachedGif->new( %data ) || 
	die( Net::API::Telegram::InlineQueryResultCachedGif->error, "\n" );

=head1 DESCRIPTION

L<Net::API::Telegram::InlineQueryResultCachedGif> is a Telegram Message Object as defined here L<https://core.telegram.org/bots/api#inlinequeryresultcachedgif>
