...
App::lcpan::Cmd::script - Show a single script

=head1 VERSION

This document describes version 1.074 of App::lcpan::Cmd::script (from Perl distribution App-lcpan), released on 2023-09-26.
