package Google::Ads::AdWords::v201702::BudgetOrderRequest;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'status' => 'Google::Ads::AdWords::v201702::BudgetOrderRequest::Status',
...
BudgetOrderRequest from the namespace https://adwords.google.com/api/adwords/billing/v201702.
