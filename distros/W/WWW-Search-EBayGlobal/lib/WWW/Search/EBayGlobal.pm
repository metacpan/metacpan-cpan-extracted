# EBayGlobal.pm
# Written by Andy Pritchard. Original Ebay backend by Martin Thurn 
# $Id: EBayGlobal.pm,v 3.00 2003-03-18 15:00:00 Exp  $

package WWW::Search::EBayGlobal;
...
=head1 SYNOPSIS
    ...
    use WWW::Search;
    my $oSearch = new WWW::Search('EBayGlobal');
...
As of version 3.00 WWW::Search::EBayGlobal can be used to search the following european ebay sites
...
C<WWW::Search::EBayGlobal> was Adapted by Andy Pritchard from Martin Thurn's Ebay module
(pilchkinstein@hotmail.com).

Original C<WWW::Search::Ebay> was written by Martin Thurn
(mthurn@megapipe.net).

C<WWW::Search::EBayGlobal> is maintained by Andy Pritchard
