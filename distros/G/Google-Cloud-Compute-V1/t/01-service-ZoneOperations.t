...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::DeleteZoneOperationResponse Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::OperationList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::ZoneOperationsClient->new( credentials => 'dummy' );
