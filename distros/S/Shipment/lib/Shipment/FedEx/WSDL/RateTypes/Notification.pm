...
$Shipment::FedEx::WSDL::RateTypes::Notification::VERSION = '3.10';
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'Severity' => 'Shipment::FedEx::WSDL::RateTypes::NotificationSeverityType',
...
Notification from the namespace http://fedex.com/ws/rate/v9.
