...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Test-Prereq> or 
L<MetaCPAN|http://www.metacpan.org/module/Test::Prereq>:

=over 4

=item *	L<http://search.cpan.org/dist/Test-Prereq>

=item *	L<http://www.metacpan.org/module/Test::Prereq>
