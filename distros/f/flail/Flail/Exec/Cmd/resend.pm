...
Flail::Exec::Cmd::resend - Flail "resend" command

=head1 VERSION

  Time-stamp: <2006-12-03 11:04:30 attila@stalphonsos.com>

=head1 SYNOPSIS

  use Flail::Exec::Cmd::resend;
  blah;
...
package Flail::Exec::Cmd::resend;
use strict;
use Carp;
use Flail::Utils;
use base qw(Exporter);
use vars qw(@EXPORT @EXPORT_OK %EXPORT_TAGS);
@EXPORT_OK = qw(flail_resend);
@EXPORT = ();
