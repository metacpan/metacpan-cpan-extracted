...
This document describes version 0.031 of Sah::Schema::filename::unix::basename (from Perl distribution Sah-SchemaBundle-Path), released on 2024-02-16.
...
(set-as-default, coerced, prefiltered) value:
 ...
 # a sample invalid data
 $data = "";
 my $res = $validator->($data); # => ["Must match regex pattern \\A(?:[^/\\0]{1,255})\\z",""]
