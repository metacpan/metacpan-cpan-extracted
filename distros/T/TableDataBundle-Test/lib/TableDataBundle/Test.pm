...
1;
# ABSTRACT: Collection of more TableData::Test::* modules for testing
...
TableDataBundle::Test - Collection of more TableData::Test::* modules for testing

=head1 VERSION

This document describes version 0.001 of TableDataBundle::Test (from Perl distribution TableDataBundle-Test), released on 2023-02-10.
...
=item * L<TableData::Test::InfiniteRows>
...
The L<TableDataRoles::Standard> distribution contains some C<TableData::Test::*>
modules as well.
