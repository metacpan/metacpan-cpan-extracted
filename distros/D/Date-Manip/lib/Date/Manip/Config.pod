# Copyright (c) 1996-2026 Sullivan Beck. All rights reserved.
...
=head1 MISCELLANEOUS CONFIGURATION VARIABLES

=over 4

=item B<Use_POSIX_Printf>

In the date printf function, most of the directives match the POSIX
directives.  However, a small number of them do not.

With this option set to 1, all of the directives will match the
POSIX directives.
