...
package Google::Ads::AdWords::v201802::TargetingIdeaService::get;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201802::TargetingIdeaSelector',
    },
    {
...
Google::Ads::AdWords::v201802::TargetingIdeaService::get
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201802::TargetingIdeaService::get->new($data);

Constructor. The following data structure may be passed to new():

 {
   selector =>  $a_reference_to, # see Google::Ads::AdWords::v201802::TargetingIdeaSelector
 },
