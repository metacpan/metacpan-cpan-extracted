# -*- perl -*-
##----------------------------------------------------------------------------
## Net/API/Telegram/InlineQueryResultCachedMpeg4Gif.pm
## Version 0.1
...
##----------------------------------------------------------------------------
package Net::API::Telegram::InlineQueryResultCachedMpeg4Gif;
BEGIN
{
	use strict;
...
sub mpeg4_file_id { return( shift->_set_get_scalar( 'mpeg4_file_id', @_ ) ); }
...
Net::API::Telegram::InlineQueryResultCachedMpeg4Gif - A link to a video animation (H.264/MPEG-4 AVC video without sound) stored on the Telegram servers

=head1 SYNOPSIS

	my $msg = Net::API::Telegram::InlineQueryResultCachedMpeg4Gif->new( %data ) || 
	die( Net::API::Telegram::InlineQueryResultCachedMpeg4Gif->error, "\n" );

=head1 DESCRIPTION

L<Net::API::Telegram::InlineQueryResultCachedMpeg4Gif> is a Telegram Message Object as defined here L<https://core.telegram.org/bots/api#inlinequeryresultcachedmpeg4gif>
