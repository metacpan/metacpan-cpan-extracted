package Chart::Plotly::Trace::Heatmapgl::Colorbar::Title;
use Moose;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Heatmapgl::Colorbar::Title::Font", );
...
Chart::Plotly::Trace::Heatmapgl::Colorbar::Title - This attribute is one of the possible options for the trace heatmapgl.
