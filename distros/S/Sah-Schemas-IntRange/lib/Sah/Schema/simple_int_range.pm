...
our $schema = [str => {
    ...
    examples => [
        ...
        {data=>'1', valid=>0, summary=>'Not a range but single positive integer'},
        {data=>'-2', valid=>0, summary=>'Not a range but single negative integer'},
        ...
        {data=>'1-2-3', valid=>0, summary=>'Invalid syntax'},
        {data=>' 1-2 ', valid=>0, summary=>'Leading and trailing whitespace is currently not allowed'},
    ],
}, {}];

1;
# ABSTRACT: Simple integer range, e.g. 1-10 / -2-7
...
Sah::Schema::simple_int_range - Simple integer range, e.g. 1-10 / -2-7

=head1 VERSION

This document describes version 0.004 of Sah::Schema::simple_int_range (from Perl distribution Sah-Schemas-IntRange), released on 2021-07-17.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("simple_int_range*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("simple_int_range*");
     $validator->(\@args);
     ...
 }
...
Sample data:
 ...
 1  # INVALID (Not a range but single positive integer)

 -2  # INVALID (Not a range but single negative integer)
