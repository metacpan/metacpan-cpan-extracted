...
$RDF::Cowl::ObjCard::VERSION = '1.0.0';
# CowlObjCard
use strict;
use warnings;
...
RDF::Cowl::ObjCard - Represents ObjectMinCardinality, ObjectMaxCardinality and ObjectExactCardinality in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::ObjCard>
