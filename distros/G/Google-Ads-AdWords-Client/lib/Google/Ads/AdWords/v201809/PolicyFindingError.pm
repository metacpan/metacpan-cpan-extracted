package Google::Ads::AdWords::v201809::PolicyFindingError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201809::PolicyFindingError::Reason',
        'policySummary' => 'Google::Ads::AdWords::v201809::PolicySummary',
    },
    {
...
Google::Ads::AdWords::v201809::PolicyFindingError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PolicyFindingError from the namespace https://adwords.google.com/api/adwords/cm/v201809.

Error indicating that an entity will be disapproved unless changes are made to it before it is saved. This error occurs when the entity will have a policy summary that includes a PROHIBITED policy topic entry. 
