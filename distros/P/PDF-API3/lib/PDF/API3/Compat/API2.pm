...
BEGIN {
    ...
    @FontDirs = ( (map { "$_/PDF/API3/Compat/API2/fonts" } @INC), 
    ...
    use PDF::API3::Compat::API2::Basic::PDF::File;
    use PDF::API3::Compat::API2::Basic::PDF::Page;
    use PDF::API3::Compat::API2::Basic::PDF::Utils;

    use PDF::API3::Compat::API2::Util;
    use PDF::API3::Compat::API2::Page;

    use PDF::API3::Compat::API2::Outlines;
    use PDF::API3::Compat::API2::NamedDestination;

    use PDF::API3::Compat::API2::Resource::ExtGState;
    use PDF::API3::Compat::API2::Resource::Pattern;
    use PDF::API3::Compat::API2::Resource::Shading;

    use PDF::API3::Compat::API2::Resource::Font::CoreFont;
    use PDF::API3::Compat::API2::Resource::Font::Postscript;
    use PDF::API3::Compat::API2::Resource::Font::BdFont;
    use PDF::API3::Compat::API2::Resource::Font::SynFont;
    use PDF::API3::Compat::API2::Resource::Font::neTrueType;
    use PDF::API3::Compat::API2::Resource::CIDFont::TrueType;
    use PDF::API3::Compat::API2::Resource::CIDFont::CJKFont;
    use PDF::API3::Compat::API2::Resource::UniFont;

    use PDF::API3::Compat::API2::Resource::XObject::Image::JPEG;
    use PDF::API3::Compat::API2::Resource::XObject::Image::TIFF;
    use PDF::API3::Compat::API2::Resource::XObject::Image::PNM;
    use PDF::API3::Compat::API2::Resource::XObject::Image::PNG;
    use PDF::API3::Compat::API2::Resource::XObject::Image::GIF;
    use PDF::API3::Compat::API2::Resource::XObject::Image::GD;

    use PDF::API3::Compat::API2::Resource::XObject::Form::Hybrid;

    use PDF::API3::Compat::API2::Resource::XObject::Form::BarCode::int2of5;
    use PDF::API3::Compat::API2::Resource::XObject::Form::BarCode::codabar;
    use PDF::API3::Compat::API2::Resource::XObject::Form::BarCode::code128;
    use PDF::API3::Compat::API2::Resource::XObject::Form::BarCode::code3of9;
    use PDF::API3::Compat::API2::Resource::XObject::Form::BarCode::ean13;

    use PDF::API3::Compat::API2::Resource::ColorSpace::Indexed::ACTFile;
    use PDF::API3::Compat::API2::Resource::ColorSpace::Indexed::Hue;
    use PDF::API3::Compat::API2::Resource::ColorSpace::Indexed::WebColor;

    use PDF::API3::Compat::API2::Resource::ColorSpace::Separation;
    use PDF::API3::Compat::API2::Resource::ColorSpace::DeviceN;
...
sub new {
    ...
    my $self={};
    bless($self,$class);
    $self->{pdf}=PDF::API3::Compat::API2::Basic::PDF::File->new();
    $self->{time}='_'.pdfkey(time());

    $self->{pdf}->{' version'} = 4;
    $self->{pages} = PDF::API3::Compat::API2::Basic::PDF::Pages->new($self->{pdf});
    ...
    $self->info( 'Producer' => $PDF::API3::Compat::API2::Version::CVersion{vFredo}." [$^O]" );
    return $self;
}
...
sub open {
    ...
    $self->{pdf}=PDF::API3::Compat::API2::Basic::PDF::File->open($fh,1);
    $self->{pdf}->{' fname'}=$file;
...
sub page {
    ...
    my $page;
    if($index==0) {
        $page=PDF::API3::Compat::API2::Page->new($self->{pdf},$self->{pages});
    } else {
        $page=PDF::API3::Compat::API2::Page->new($self->{pdf},$self->{pages},$index-1);
    }
...
sub openpage {
    ...
    {
        bless($page,'PDF::API3::Compat::API2::Page');
        $page->{' apipdf'}=$self->{pdf};
        $page->{' api'}=$self;
        $self->{pdf}->out_obj($page);
...
sub importPageIntoForm {
	...
	UNIVERSAL::isa($s_pdf, 'PDF::API3::Compat::API2') || die "Invalid usage: 1st argument must be PDF::API3::Compat::API2 instance, not: ".ref($s_pdf);
...
sub corefont {
    my ($self,$name,@opts)=@_;
    my $obj=PDF::API3::Compat::API2::Resource::Font::CoreFont->new_api($self,$name,@opts);
...
sub psfont {
    ...
    $psf=_findFont($psf);
    my $obj=PDF::API3::Compat::API2::Resource::Font::Postscript->new_api($self,$psf,%opts);
...
sub ttfont {
    ...
    $file=_findFont($file);
    my $obj=PDF::API3::Compat::API2::Resource::CIDFont::TrueType->new_api($self,$file,%opts);
...
sub nettfont {
    ...
    $file=_findFont($file);
    my $obj=PDF::API3::Compat::API2::Resource::Font::neTrueType->new_api($self,$file,%opts);
...
sub cjkfont {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::CIDFont::CJKFont->new_api($self,$name,%opts);
...
sub synfont {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::Font::SynFont->new_api($self,@opts);
...
sub bdfont {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::Font::BdFont->new_api($self,@opts);
...
sub unifont {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::UniFont->new_api($self,@opts);
...
sub image_jpeg {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::XObject::Image::JPEG->new_api($self,$file);
...
sub image_tiff {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::XObject::Image::TIFF->new_api($self,$file);
...
sub image_pnm {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::XObject::Image::PNM->new_api($self,$file);
...
sub image_png {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::XObject::Image::PNG->new_api($self,$file);
...
sub image_gif {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::XObject::Image::GIF->new_api($self,$file);
...
sub image_gd {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::XObject::Image::GD->new_api($self,$gd,undef,%opts);
...
sub colorspace_act {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::ColorSpace::Indexed::ACTFile->new_api($self,$file);
...
sub colorspace_web {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::ColorSpace::Indexed::WebColor->new_api($self);
...
sub colorspace_hue {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::ColorSpace::Indexed::Hue->new_api($self);
...
sub colorspace_separation {
    my ($self,$name,@clr)=@_;
    my $obj=PDF::API3::Compat::API2::Resource::ColorSpace::Separation->new_api($self,$name,@clr);
...
sub colorspace_devicen {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::ColorSpace::DeviceN->new_api($self,$clrs,$samples);
...
sub xo_code128 {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::XObject::Form::BarCode::code128->new_api($self,@opts);
...
sub xo_codabar {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::XObject::Form::BarCode::codabar->new_api($self,@opts);
...
sub xo_2of5int {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::XObject::Form::BarCode::int2of5->new_api($self,@opts);
...
sub xo_3of9 {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::XObject::Form::BarCode::code3of9->new_api($self,@opts);
...
sub xo_ean13 {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::XObject::Form::BarCode::ean13->new_api($self,@opts);
...
sub xo_form {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::XObject::Form::Hybrid->new_api($self);
...
sub egstate {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::ExtGState->new_api($self,pdfkey());
...
sub pattern {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::Pattern->new_api($self,undef,%opts);
...
sub shading {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::Shading->new_api($self,undef,%opts);
...
sub outlines {
    ...
    $self->{pdf}->{Root}->{Outlines}||=PDF::API3::Compat::API2::Outlines->new($self);
...
sub named_destination
{
    ...
    unless(defined $obj)
    {
        $obj=PDF::API3::Compat::API2::NamedDestination->new_api($self);
    }
