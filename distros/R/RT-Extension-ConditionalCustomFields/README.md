...
From version 1.13, `HTML` [custom fields](https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html) introduced in RT 5.0.3 can be defined as condition [CustomField](https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html).
