...
$Shipment::Purolator::WSDL::Interfaces::ShippingService::ShippingServiceEndpoint::VERSION = '3.01';
use strict;
use warnings;
...
require Shipment::Purolator::WSDL::Typemaps::ShippingService
  if
  not Shipment::Purolator::WSDL::Typemaps::ShippingService->can('get_class');
...
sub START {
    ...
    $_[0]->set_proxy(
        'https://' . $proxy_domain . '/EWS/V1/Shipping/ShippingService.asmx')
      if not $_[2]->{proxy};
    ...
    return $self->SUPER::call(
        {   operation => 'CreateShipment',
            ...
            body  => {
                ...
                encodingStyle => '',
                parts         => [
                    qw( Shipment::Purolator::WSDL::Elements::CreateShipmentRequest )
                ],
            },
            header => {
            ...
            response => {
                ...
                body => {
                    ...
                    encodingStyle => '',
                    parts         => [
                        qw( Shipment::Purolator::WSDL::Elements::CreateShipmentResponse )
                    ],
                },
            }
        },
    ...
    return $self->SUPER::call(
        {   operation   => 'VoidShipment',
            ...
            body        => {
                ...
                encodingStyle => '',
                parts         => [
                    qw( Shipment::Purolator::WSDL::Elements::VoidShipmentRequest )
                ],
            },
            header => {
            ...
            response => {
                ...
                body => {
                    ...
                    encodingStyle => '',
                    parts         => [
                        qw( Shipment::Purolator::WSDL::Elements::VoidShipmentResponse )
                    ],
                },
            }
        },
    ...
    return $self->SUPER::call(
        {   operation => 'ValidateShipment',
            ...
            body  => {
                ...
                encodingStyle => '',
                parts         => [
                    qw( Shipment::Purolator::WSDL::Elements::ValidateShipmentRequest )
                ],
            },
            header => {
            ...
            response => {
                ...
                body => {
                    ...
                    encodingStyle => '',
                    parts         => [
                        qw( Shipment::Purolator::WSDL::Elements::ValidateShipmentResponse )
                    ],
                },
            }
        },
    ...
    return $self->SUPER::call(
        {   operation   => 'Consolidate',
            ...
            body        => {
                ...
                encodingStyle => '',
                parts         => [
                    qw( Shipment::Purolator::WSDL::Elements::ConsolidateRequest )
                ],
            },
            header => {
            ...
            response => {
                ...
                body => {
                    ...
                    encodingStyle => '',
                    parts         => [
                        qw( Shipment::Purolator::WSDL::Elements::ConsolidateResponse )
                    ],
                },
            }
        },
