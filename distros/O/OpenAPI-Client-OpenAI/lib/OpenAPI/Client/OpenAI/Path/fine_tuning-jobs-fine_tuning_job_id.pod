...
This document describes the API endpoint at C</fine_tuning/jobs/{fine_tuning_job_id}>.

=head1 PATHS


=head2 C<GET /fine_tuning/jobs/{fine_tuning_job_id}>
...
=item * C<fine_tuning_job_id> (in path) (Required) - The ID of the fine-tuning job.
