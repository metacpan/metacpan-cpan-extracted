...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TestPermissionsResponse Google::Cloud::Compute::V1::Compute::UrlMap Google::Cloud::Compute::V1::Compute::UrlMapList Google::Cloud::Compute::V1::Compute::UrlMapsAggregatedList Google::Cloud::Compute::V1::Compute::UrlMapsValidateResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::UrlMapsClient->new( credentials => 'dummy' );
