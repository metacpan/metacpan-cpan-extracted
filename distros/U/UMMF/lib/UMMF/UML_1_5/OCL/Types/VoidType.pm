...
package UMMF::UML_1_5::OCL::Types::VoidType;
...
=head2 C<__validate_type>
  ...
  UMMF::UML_1_5::OCL::Types::VoidType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::OCL::Types::VoidType|UMMF::UML_1_5::OCL::Types::VoidType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::OCL::Types::VoidType')  ;
}


=head2 C<__typecheck>

  UMMF::UML_1_5::OCL::Types::VoidType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::OCL::Types::VoidType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::OCL::Types::VoidType' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML_1_5::OCL::Types::VoidType|UMMF::UML_1_5::OCL::Types::VoidType>.
...
=head2 C<isaOCL__Types__VoidType>


Returns true if receiver is a L<UMMF::UML_1_5::OCL::Types::VoidType|UMMF::UML_1_5::OCL::Types::VoidType>.
Other receivers will return false.
This is the fully qualified version of the C<isaVoidType> method.

=cut
sub isaOCL__Types__VoidType { 1 }
...
Returns the UML Model name (C<'OCL::Types::VoidType'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'OCL::Types::VoidType' }
...
sub __initialize
{
  ...
  $self->UMMF::UML_1_5::OCL::Types::VoidType::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::OCL::Types::VoidType::___create(@args);
