package Google::Ads::AdWords::v201705::ConversionTrackingSettings;
use strict;
use warnings;
...
ConversionTrackingSettings from the namespace https://adwords.google.com/api/adwords/mcm/v201705.
