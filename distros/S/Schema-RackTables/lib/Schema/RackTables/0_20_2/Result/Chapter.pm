use utf8;
package Schema::RackTables::0_20_2::Result::Chapter;
...
Related object: L<Schema::RackTables::0_20_2::Result::AttributeMap>
...
Related object: L<Schema::RackTables::0_20_2::Result::Dictionary>

=cut

__PACKAGE__->has_many(
  "dictionaries",
  "Schema::RackTables::0_20_2::Result::Dictionary",
  { "foreign.chapter_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:d1O3nbdI2N9b9GyzByOAvA
