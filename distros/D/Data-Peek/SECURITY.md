...
uses Data::Peek, or plugins to it that are not included with the
Data::Peek distribution) are not covered by this policy.

## Supported Versions of Data::Peek

The maintainer(s) will only commit to releasing security fixes for
the latest version of Data::Peek.

Note that the Data::Peek project only supports major versions of Perl
released in the past 5 years, even though Data::Peek will run on
...
prerequisites that are required for Data::Peek to work.  However, some
