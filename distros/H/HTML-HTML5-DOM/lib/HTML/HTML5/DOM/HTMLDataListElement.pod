...
HTML::HTML5::DOM::HTMLDataListElement - implementation of the HTMLDataListElement interface of the HTML DOM

=head1 DESCRIPTION

HTML::HTML5::DOM::HTMLDataListElement is an implementation of the HTMLDataListElement interface of the HTML DOM. See L<HTML::HTML5::DOM> for a list of the conventions that have been used when translating the DOM to Perl.
...
=item * C<< {http://www.w3.org/1999/xhtml}datalist >>

=back

=head2 Inheritance

HTML::HTML5::DOM::HTMLDataListElement inherits methods from the following Perl classes.
