package Chart::Plotly::Trace::Pie::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Pie::Legendgrouptitle::Font - This attribute is one of the possible options for the trace pie.
