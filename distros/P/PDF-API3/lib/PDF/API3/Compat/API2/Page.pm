...
#
#=======================================================================
package PDF::API3::Compat::API2::Page;
...
=head1 $page = PDF::API3::Compat::API2::Page->new $pdf, $parent, $index
...
=item $page = PDF::API3::Compat::API2::Page->coerce $pdf, $pdfpage
...
sub gfx {
    my ($self,$dir) = @_;
    my $gfx=PDF::API3::Compat::API2::Content->new();
...
sub text {
    my ($self,$dir) = @_;
    my $text=PDF::API3::Compat::API2::Content::Text->new();
...
sub annotation {
    ...
    my $ant=PDF::API3::Compat::API2::Annotation->new;
