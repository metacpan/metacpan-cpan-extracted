...
IO::K8s::Api::Resource::V1::DeviceToleration - The ResourceClaim this DeviceToleration is attached to tolerates any taint that matches the triple using the matching operator.
