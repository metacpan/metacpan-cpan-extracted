...
App::subsort - Sort lines of text using Sort::Sub routine

=head1 VERSION

This document describes version 0.052 of App::subsort (from Perl distribution App-subsort), released on 2025-01-13.
