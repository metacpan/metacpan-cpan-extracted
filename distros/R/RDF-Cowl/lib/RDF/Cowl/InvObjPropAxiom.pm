...
$RDF::Cowl::InvObjPropAxiom::VERSION = '1.0.0';
# CowlInvObjPropAxiom
use strict;
use warnings;
...
RDF::Cowl::InvObjPropAxiom - Represents an InverseObjectProperties axiom in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::InvObjPropAxiom>
