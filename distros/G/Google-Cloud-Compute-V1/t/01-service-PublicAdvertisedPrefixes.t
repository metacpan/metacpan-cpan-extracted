...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::PublicAdvertisedPrefix Google::Cloud::Compute::V1::Compute::PublicAdvertisedPrefixList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::PublicAdvertisedPrefixesClient->new( credentials => 'dummy' );
