package Chart::Plotly::Trace::Scattersmith::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Scattersmith::Legendgrouptitle::Font - This attribute is one of the possible options for the trace scattersmith.
