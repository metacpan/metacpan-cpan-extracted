...
1;
# ABSTRACT: Sah schemas related to HashData
...
Sah::Schemas::HashData - Sah schemas related to HashData

=head1 VERSION

This document describes version 0.001 of Sah::Schemas::HashData (from Perl distribution Sah-Schemas-HashData), released on 2024-01-15.
