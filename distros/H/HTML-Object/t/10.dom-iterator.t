...
can_ok( 'HTML::Object::DOM::NodeIterator', 'filter' );
can_ok( 'HTML::Object::DOM::NodeIterator', 'nextNode' );
can_ok( 'HTML::Object::DOM::NodeIterator', 'pointerBeforeReferenceNode' );
can_ok( 'HTML::Object::DOM::NodeIterator', 'pos' );
can_ok( 'HTML::Object::DOM::NodeIterator', 'previousNode' );
can_ok( 'HTML::Object::DOM::NodeIterator', 'referenceNode' );
can_ok( 'HTML::Object::DOM::NodeIterator', 'root' );
can_ok( 'HTML::Object::DOM::NodeIterator', 'whatToShow' );
...
ok( $doc->can( 'createNodeIterator' ), 'document->createNodeIterator' ) || BAIL_OUT( "Document object has no method createNodeIterator" );
my $elements = [
    body    => undef,
    div     => 'container',
    div     => 'plop pouec',
...
my $pos = 0;
my $it = $doc->createNodeIterator( $doc->body, SHOW_ELEMENT, sub
{
    my $tag = $_->nodeName;
...
}, debug => $DEBUG ) || BAIL_OUT( "Unable to instantiate a NodeIterator object: ", $doc->error );
...
while( my $e = $it->nextNode )
{
    ...
    my $ref = $it->referenceNode;
    is( $ref->eid, $e->eid, 'referenceNode' );
}
...
$pos = 0;
$it = $doc->createNodeIterator( $doc->body, SHOW_ALL, sub
{
