	...
	default		=> sub {
		{
			'calendar' => {
 			...
 			'ms' => {
 				...
 				'uksystem' => q{Βρετανικό σύστημα μέτρησης},
 				'ussystem' => q{Αγγλοσαξωνικό σύστημα μέτρησης},
 			},
 			'numbers' => {
...
has 'units' => (
	...
	default		=> sub { {
				'long' => {
					...
					'fluid-ounce' => {
						'name' => q(ουγγιές υγρού),
						'one' => q({0} ουγγιά υγρού),
						'other' => q({0} ουγγιές υγρού),
					},
					'foodcalorie' => {
						'name' => q(Θερμίδες),
						'one' => q({0} Θερμίδα),
					...
					'g-force' => {
						'name' => q(ατμοσφαιρική επιτάχυνση βαρύτητας),
...
has 'currencies' => (
	...
	default		=> sub { {
		...
		'XAF' => {
			symbol => 'FCFA',
			display_name => {
				'currency' => q(Φράγκο CFA Κεντρικής Αφρικής \(BEAC\)),
				'one' => q(φράγκο CFA Κεντρικής Αφρικής \(BEAC\)),
				'other' => q(φράγκα CFA Κεντρικής Αφρικής \(BEAC\)),
			},
		},
		'XBA' => {
			display_name => {
		...
		'XOF' => {
			symbol => 'CFA',
			display_name => {
				'currency' => q(Φράγκο CFA Δυτικής Αφρικής \(BCEAO\)),
				'one' => q(φράγκο CFA Δυτικής Αφρικής \(BCEAO\)),
				'other' => q(φράγκα CFA Δυτικής Αφρικής \(BCEAO\)),
			},
		},
		'XPF' => {
			symbol => 'CFPF',
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'America/Lower_Princes' => {
			exemplarCity => q#Άγιος Μαρτίνος Ολλανδίας#,
		},
		'America/Maceio' => {
