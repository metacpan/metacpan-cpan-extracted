package Google::Ads::AdWords::v201809::CustomerService::CustomerServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201809::TypeMaps::CustomerService
    if not Google::Ads::AdWords::v201809::TypeMaps::CustomerService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/mcm/v201809/CustomerService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201809::TypeMaps::CustomerService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::CustomerService::getCustomers )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201809::CustomerService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::CustomerService::getServiceLinks )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::CustomerService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::CustomerService::mutateServiceLinks )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/mcm/v201809/CustomerService.
...
Returns a L<Google::Ads::AdWords::v201809::CustomerService::getCustomersResponse|Google::Ads::AdWords::v201809::CustomerService::getCustomersResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::CustomerService::getServiceLinksResponse|Google::Ads::AdWords::v201809::CustomerService::getServiceLinksResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::CustomerService::mutateResponse|Google::Ads::AdWords::v201809::CustomerService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::CustomerService::mutateServiceLinksResponse|Google::Ads::AdWords::v201809::CustomerService::mutateServiceLinksResponse> object.
