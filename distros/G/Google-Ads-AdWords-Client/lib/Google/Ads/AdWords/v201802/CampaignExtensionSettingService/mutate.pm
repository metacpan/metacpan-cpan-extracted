...
package Google::Ads::AdWords::v201802::CampaignExtensionSettingService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201802::CampaignExtensionSettingOperation',
    },
    {
...
Google::Ads::AdWords::v201802::CampaignExtensionSettingService::mutate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutate from the namespace https://adwords.google.com/api/adwords/cm/v201802.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201802::CampaignExtensionSettingService::mutate->new($data);
