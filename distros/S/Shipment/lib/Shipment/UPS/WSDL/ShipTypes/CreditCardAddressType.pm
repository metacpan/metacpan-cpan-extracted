...
$Shipment::UPS::WSDL::ShipTypes::CreditCardAddressType::VERSION = '3.05';
use strict;
use warnings;
...
CreditCardAddressType from the namespace http://www.ups.com/XMLSchema/XOLTWS/Ship/v1.0.
...
=item * StateProvinceCode (min/maxOccurs: 1/1)
