use utf8;
package Schema::RackTables::0_20_0::Result::AttributeMap;
...
Schema::RackTables::0_20_0::Result::AttributeMap
...
Related object: L<Schema::RackTables::0_20_0::Result::Attribute>

=cut

__PACKAGE__->belongs_to(
  "attr",
  "Schema::RackTables::0_20_0::Result::Attribute",
  { id => "attr_id" },
...
Related object: L<Schema::RackTables::0_20_0::Result::Chapter>

=cut

__PACKAGE__->belongs_to(
  "chapter",
  "Schema::RackTables::0_20_0::Result::Chapter",
  { id => "chapter_id" },
  {
    is_deferrable => 1,
    join_type     => "LEFT",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:e+59yeySQ3PjYJCOnOoI+w
