...
around [
  qw/index allow_no_indices expand_wildcards ignore_unavailable wait_for_active_shards cluster_manager_timeout timeout wait_for_completion task_execution_timeout/
] => sub {
  my $orig = shift;
  my $self = shift;
