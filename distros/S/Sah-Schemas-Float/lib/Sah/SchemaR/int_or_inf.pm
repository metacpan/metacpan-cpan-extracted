...
package Sah::SchemaR::int_or_inf;

our $DATE = '2022-10-20'; # DATE
our $VERSION = '0.013'; # VERSION

our $rschema = do{my$var={base=>"any",clsets_after_base=>[{examples=>[{valid=>1,value=>0},{valid=>0,value=>0.1},{valid=>1,value=>1},{valid=>0,value=>-0.1},{valid=>1,value=>-1},{valid=>1,value=>"Inf"},{valid=>1,value=>"-Inf"},{valid=>0,value=>"NaN"}],of=>[["int",{}],["inf",{}]],summary=>"Integer, or Inf/-Inf"}],clsets_after_type=>['$var->{clsets_after_base}[0]'],"clsets_after_type.alt.merge.merged"=>['$var->{clsets_after_base}[0]'],resolve_path=>["any"],type=>"any",v=>2};$var->{clsets_after_type}[0]=$var->{clsets_after_base}[0];$var->{"clsets_after_type.alt.merge.merged"}[0]=$var->{clsets_after_base}[0];$var};
...
Sah::SchemaR::int_or_inf - Integer, or Inf/-Inf

=head1 VERSION

This document describes version 0.013 of Sah::SchemaR::int_or_inf (from Perl distribution Sah-Schemas-Float), released on 2022-10-20.
