...
BEGIN {
    for my $pkg (qw( Google::Cloud::Kms::V1::Service::ListKeyRingsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
package main;
use Google::Cloud::Kms::KeyManagementServiceClient;

my $client = Google::Cloud::Kms::KeyManagementServiceClient->new( credentials => 'dummy' );
