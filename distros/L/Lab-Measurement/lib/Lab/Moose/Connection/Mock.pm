...
$Lab::Moose::Connection::Mock::VERSION = '3.762';
...
Mock connection object for unit testing. Uses a log recorded previously
with a real instrument using L<Lab::Moose::Instrument::Log>.
