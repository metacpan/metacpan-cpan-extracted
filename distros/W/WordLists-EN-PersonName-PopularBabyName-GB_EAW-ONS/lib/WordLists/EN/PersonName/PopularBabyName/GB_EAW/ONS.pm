package WordLists::EN::PersonName::PopularBabyName::GB_EAW::ONS;
...
1;
# ABSTRACT: Popular baby names in England and Wales (from ONS)
...
WordLists::EN::PersonName::PopularBabyName::GB_EAW::ONS - Popular baby names in England and Wales (from ONS)

=head1 VERSION

This document describes version 0.002 of WordLists::EN::PersonName::PopularBabyName::GB_EAW::ONS (from Perl distribution WordLists-EN-PersonName-PopularBabyName-GB_EAW-ONS), released on 2020-05-22.
