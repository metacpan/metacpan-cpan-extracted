...
Data::Sah::Coerce::perl::int::str_convert_unix_group_to_gid - Convert Unix groupname into GID

=head1 VERSION

This document describes version 0.003 of Data::Sah::Coerce::perl::int::str_convert_unix_group_to_gid (from Perl distribution Sah-Schemas-Unix), released on 2019-05-07.
