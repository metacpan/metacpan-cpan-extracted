...
my $Original_File = 'D:lib\CGI\Wiki\Simple\Plugin\Static.pm';
...
SKIP: {
  ...
  # Check for module CGI::Wiki::Simple::Plugin::Static
  eval { require CGI::Wiki::Simple::Plugin::Static };
  skip "Need module CGI::Wiki::Simple::Plugin::Static to run this test", 1
    if $@;
...
#line 22 lib/CGI/Wiki/Simple/Plugin/Static.pm
