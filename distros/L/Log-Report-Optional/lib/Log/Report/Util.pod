...
This module is part of Log-Report-Optional distribution version 1.04,
built on October 30, 2017. Website: F<http://perl.overmeer.net/log-report/>

=head1 LICENSE

Copyrights 2013-2017 by [Mark Overmeer]. For other contributors see ChangeLog.
