...
BEGIN {
    for my $pkg (qw( Google::Cloud::Networksecurity::V1::SecurityProfileGroupService::ListSecurityProfileGroupsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
package main;
use Google::Cloud::Networksecurity::V1::SecurityProfileGroupServiceClient;

my $client = Google::Cloud::Networksecurity::V1::SecurityProfileGroupServiceClient->new( credentials => 'dummy' );
