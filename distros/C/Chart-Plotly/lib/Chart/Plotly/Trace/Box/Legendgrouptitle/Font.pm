package Chart::Plotly::Trace::Box::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Box::Legendgrouptitle::Font - This attribute is one of the possible options for the trace box.
