...
# File nay duoc ma hoa bang UTF-8.
...
#
#   $line             : chuoi can chuyen doi (truyen bang tham chieu, ghi de tại chỗ)
#   $OUTPUT_encoding  : ten ma hoa dau ra
#   $INPUT_encoding   : ten ma hoa dau vao
#   $char_count       : so luong ky tu sau khi chuyen doi
#
# [DANH SACH TEN MA HOA]
#
#   ky hieu     y nghia
#   ---------   ---------------------------------------------------
#   cp932x      CP932X (mo rong sang JIS X 0213, dich chuyen don 0x9C5A)
#   cp932       Microsoft CP932 (Windows-31J / ten IANA)
#   cp932ibm    IBM CP932
#   cp932nec    NEC CP932
...
#   jef         FUJITSU JEF (12pt, ma dich chuyen voi OUTPUT_SHIFTING)
#   jef9p       FUJITSU JEF ( 9pt, ma dich chuyen voi OUTPUT_SHIFTING)
#   jipsj       NEC JIPS(J)
#   jipse       NEC JIPS(E)
#   letsj       UNISYS LetsJ
#   utf8        UTF-8.0 (UTF-8 thong thuong)
#   utf8.1      UTF-8.1 (chuyen doi dua tren bang Shift_JIS-Unicode, khong phai CP932)
#   utf8jp      UTF-8-SPUA-JP (JIS X 0213 anh xa vao vung SPUA cua Unicode)
#
# [TUY CHON]
#
#   khoa              gia tri / mo ta
#   ---------------   ---------------------------------------------------
#   INPUT_LAYOUT      bo cuc ban ghi dau vao ('S'=SBCS, 'D'=DBCS voi so lan lap)
#   OUTPUT_SHIFTING   neu dung, chen ma dich chuyen xung quanh chuoi DBCS
#   SPACE             ma khoang trang DBCS/MBCS (chuoi nhi phan)
#   GETA              ky hieu geta cho ky tu khong the anh xa
#   OVERRIDE_MAPPING  thay the tung ky tu { "\x12\x34"=>"\x56\x78" }
#
# [LUU Y: CHUYEN DOI HAI CHIEU]
#
#   Co cac chuyen doi mat mat du lieu (vi du CP932 co 398 anh xa khong the dao nguoc).
# [Su khac biet giua Jacode4e va Jacode4e::RoundTrip]
#
#   Jacode4e              : Chuyen doi mot chieu nhanh. Mat du lieu voi mot so
#                           ky tu (vi du CP932 co 398 anh xa khong the dao nguoc).
#   Jacode4e::RoundTrip   : Dam bao do trung thanh hai chieu qua Unicode pivot.
#                           A->B->A luon giong nhau. Cham hon Jacode4e,
#                           nhung dung khi du lieu can di va ve.
#
#   Neu khong can chuyen doi hai chieu, su dung module Jacode4e.
#
# ======================================================================
...
BEGIN {
    ...
    @test = (
        ...
        # --- UTF-8.1: chuyen doi tu Shift_JIS-Unicode, khong phai CP932 ---
