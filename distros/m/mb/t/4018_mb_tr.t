...
# 41
    ...
    sub { $_='‚`‚`‚`';             my $r=mb::tr($_,'‚`','‚P');         $_ eq '‚P‚P‚P'             },
    sub { $_='‚`‚`‚`';             my $r=mb::tr($_,'‚`‚`','‚P‚Q');     $r == 3                    },
    sub { $_='‚`‚`‚`';             my $r=mb::tr($_,'‚`‚`','‚P‚Q');     $_ eq '‚P‚P‚P'             },
    sub { $_='‚`‚`‚`';             my $r=mb::tr($_,'‚`‚`‚`','‚P‚Q‚R'); $r == 3                    },
    sub { $_='‚`‚`‚`';             my $r=mb::tr($_,'‚`‚`‚`','‚P‚Q‚R'); $_ eq '‚P‚P‚P'             },
    sub { $_='‚`‚`‚`‚a‚a‚a‚b‚b‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚Q');     $r == 6                    },
    sub { $_='‚`‚`‚`‚a‚a‚a‚b‚b‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚Q');     $_ eq '‚P‚P‚P‚Q‚Q‚Q‚b‚b‚b' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚Q');     $r == 6                    },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚Q');     $_ eq '‚P‚Q‚b‚P‚Q‚b‚P‚Q‚b' },
# 51
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P');       $r == 6                    },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P');       $_ eq '‚P‚P‚b‚P‚P‚b‚P‚P‚b' },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
#-----------------------------------------------------------------------------
# 101
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','d');      $r == 6              },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','d');      $_ eq '‚P‚b‚P‚b‚P‚b' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','s');      $r == 6              },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','s');      $_ eq '‚P‚b‚P‚b‚P‚b' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚P','s');    $r == 6              },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚P','s');    $_ eq '‚P‚b‚P‚b‚P‚b' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','ds');     $r == 6              },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','ds');     $_ eq '‚P‚b‚P‚b‚P‚b' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚P','ds');   $r == 6              },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚P','ds');   $_ eq '‚P‚b‚P‚b‚P‚b' },
# 111
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a‚b','‚P‚P','ds'); $r == 9              },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a‚b','‚P‚P','ds'); $_ eq '‚P'           },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a‚b','‚P','ds');   $r == 9              },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a‚b','‚P','ds');   $_ eq '‚P'           },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 161
    ...
    sub { $_='‚`‚`‚`';             my $r=mb::tr($_,'‚`‚`','‚P‚Q','c');     $r == 0                    },
    sub { $_='‚`‚`‚`';             my $r=mb::tr($_,'‚`‚`','‚P‚Q','c');     $_ eq '‚`‚`‚`'             },
    sub { $_='‚`‚`‚`';             my $r=mb::tr($_,'‚`‚`‚`','‚P‚Q‚R','c'); $r == 0                    },
    sub { $_='‚`‚`‚`';             my $r=mb::tr($_,'‚`‚`‚`','‚P‚Q‚R','c'); $_ eq '‚`‚`‚`'             },
    sub { $_='‚`‚`‚`‚a‚a‚a‚b‚b‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚Q','c');     $r == 3                    },
    sub { $_='‚`‚`‚`‚a‚a‚a‚b‚b‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚Q','c');     $_ eq '‚`‚`‚`‚a‚a‚a‚Q‚Q‚Q' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚Q','c');     $r == 3                    },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚Q','c');     $_ eq '‚`‚a‚Q‚`‚a‚Q‚`‚a‚Q' },
# 171
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','c');       $r == 3                    },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','c');       $_ eq '‚`‚a‚P‚`‚a‚P‚`‚a‚P' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','cd');      $r == 3                    },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','cd');      $_ eq '‚`‚a‚`‚a‚`‚a'       },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
#-----------------------------------------------------------------------------
# 221
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','cs');    $r == 3                    },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','cs');    $_ eq '‚`‚a‚P‚`‚a‚P‚`‚a‚P' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚P','cs');  $r == 3                    },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚P','cs');  $_ eq '‚`‚a‚P‚`‚a‚P‚`‚a‚P' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚a','‚P','cds');     $r == 6                    },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚a','‚P','cds');     $_ eq '‚a‚a‚a'             },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚a','‚P‚Q','cds');   $r == 6                    },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚a','‚P‚Q','cds');   $_ eq '‚a‚a‚a'             },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚a‚b','‚P‚P','cds'); $r == 3                    },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚a‚b','‚P‚P','cds'); $_ eq '‚a‚b‚a‚b‚a‚b'       },
# 231
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚a‚b','‚P','cds');   $r == 3                    },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚a‚b','‚P','cds');   $_ eq '‚a‚b‚a‚b‚a‚b'       },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
#-----------------------------------------------------------------------------
# 281
    sub { $_='‚`‚`‚`';             my $r=mb::tr($_,'‚`','‚P','r');         $r eq '‚P‚P‚P'             },
    sub { $_='‚`‚`‚`';             my $r=mb::tr($_,'‚`‚`','‚P‚Q','r');     $r eq '‚P‚P‚P'             },
    sub { $_='‚`‚`‚`';             my $r=mb::tr($_,'‚`‚`‚`','‚P‚Q‚R','r'); $r eq '‚P‚P‚P'             },
    sub { $_='‚`‚`‚`‚a‚a‚a‚b‚b‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚Q','r');     $r eq '‚P‚P‚P‚Q‚Q‚Q‚b‚b‚b' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚Q','r');     $r eq '‚P‚Q‚b‚P‚Q‚b‚P‚Q‚b' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','r');       $r eq '‚P‚P‚b‚P‚P‚b‚P‚P‚b' },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
# 291
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','dr');      $r eq '‚P‚b‚P‚b‚P‚b'       },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','sr');      $r eq '‚P‚b‚P‚b‚P‚b'       },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚P','sr');    $r eq '‚P‚b‚P‚b‚P‚b'       },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','dsr');     $r eq '‚P‚b‚P‚b‚P‚b'       },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚P','dsr');   $r eq '‚P‚b‚P‚b‚P‚b'       },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a‚b','‚P‚P','dsr'); $r eq '‚P'                 },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a‚b','‚P','dsr');   $r eq '‚P'                 },
    sub {1},
    sub {1},
    sub {1},
##############################################################################
...
# 341
    ...
    sub { $_='‚`‚`‚`';             my $r=mb::tr($_,'‚`‚`','‚P‚Q','cr');     $r eq '‚`‚`‚`'             },
    sub { $_='‚`‚`‚`';             my $r=mb::tr($_,'‚`‚`‚`','‚P‚Q‚R','cr'); $r eq '‚`‚`‚`'             },
    sub { $_='‚`‚`‚`‚a‚a‚a‚b‚b‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚Q','cr');     $r eq '‚`‚`‚`‚a‚a‚a‚Q‚Q‚Q' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚Q','cr');     $r eq '‚`‚a‚Q‚`‚a‚Q‚`‚a‚Q' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','cr');       $r eq '‚`‚a‚P‚`‚a‚P‚`‚a‚P' },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
# 351
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','cdr');      $r eq '‚`‚a‚`‚a‚`‚a'       },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P','csr');      $r eq '‚`‚a‚P‚`‚a‚P‚`‚a‚P' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚`‚a','‚P‚P','csr');    $r eq '‚`‚a‚P‚`‚a‚P‚`‚a‚P' },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚a','‚P','cdsr');       $r eq '‚a‚a‚a'             },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚a','‚P‚P','cdsr');     $r eq '‚a‚a‚a'             },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚a‚b','‚P‚P','cdsr');   $r eq '‚a‚b‚a‚b‚a‚b'       },
    sub { $_='‚`‚a‚b‚`‚a‚b‚`‚a‚b'; my $r=mb::tr($_,'‚a‚b','‚P','cdsr');     $r eq '‚a‚b‚a‚b‚a‚b'       },
    sub {1},
    sub {1},
    sub {1},
##############################################################################
...
#-----------------------------------------------------------------------------
# 401
    sub { $_='‚P‚`‚a';          my $r=mb::tr($_,'‚`‚a','‚P‚P','s');       $r == 2                 },
    sub { $_='‚P‚`‚a';          my $r=mb::tr($_,'‚`‚a','‚P‚P','s');       $_ eq '‚P‚P'            },
    sub { $_='‚`‚a‚P';          my $r=mb::tr($_,'‚`‚a','‚P‚P','s');       $r == 2                 },
    sub { $_='‚`‚a‚P';          my $r=mb::tr($_,'‚`‚a','‚P‚P','s');       $_ eq '‚P‚P'            },
    sub { $_='‚P‚`‚a‚P';        my $r=mb::tr($_,'‚`‚a','‚P‚P','s');       $r == 2                 },
    sub { $_='‚P‚`‚a‚P';        my $r=mb::tr($_,'‚`‚a','‚P‚P','s');       $_ eq '‚P‚P‚P'          },
    sub { $_='‚P‚P‚P';          my $r=mb::tr($_,'‚`‚a','‚Q‚R','s');       $r == 0                 },
    sub { $_='‚P‚P‚P';          my $r=mb::tr($_,'‚`‚a','‚Q‚R','s');       $_ eq '‚P‚P‚P'          },
    sub { $_='‚P‚P‚`‚a';        my $r=mb::tr($_,'‚`‚a','‚P‚P','s');       $r == 2                 },
    sub { $_='‚P‚P‚`‚a';        my $r=mb::tr($_,'‚`‚a','‚P‚P','s');       $_ eq '‚P‚P‚P'          },
# 411
    sub { $_='‚`‚a‚P‚P';        my $r=mb::tr($_,'‚`‚a','‚P‚P','s');       $r == 2                 },
    sub { $_='‚`‚a‚P‚P';        my $r=mb::tr($_,'‚`‚a','‚P‚P','s');       $_ eq '‚P‚P‚P'          },
    sub { $_='‚P‚P‚`‚a‚P‚P';    my $r=mb::tr($_,'‚`‚a','‚P‚P','s');       $r == 2                 },
    sub { $_='‚P‚P‚`‚a‚P‚P';    my $r=mb::tr($_,'‚`‚a','‚P‚P','s');       $_ eq '‚P‚P‚P‚P‚P'      },
    sub { $_='‚`‚a‚`‚a';        my $r=mb::tr($_,'‚`‚a','‚P‚P');           $r == 4                 },
    sub { $_='‚`‚a‚`‚a';        my $r=mb::tr($_,'‚`‚a','‚P‚P');           $_ eq '‚P‚P‚P‚P'        },
    sub { $_='‚`‚a‚`‚a';        my $r=mb::tr($_,'‚`‚a','‚P‚P','s');       $r == 4                 },
    sub { $_='‚`‚a‚`‚a';        my $r=mb::tr($_,'‚`‚a','‚P‚P','s');       $_ eq '‚P'              },
    sub {1},
    sub {1},
##############################################################################
# 421
...
#-----------------------------------------------------------------------------
# 441
    sub { $_='‚”‚’‚‚Ž‚“‚Œ‚‰‚”‚…‚’‚‚”‚…‚…';  my $r=mb::tr($_,'‚‚‚’‚…‚”','‚P‚Q‚R‚S');      $_ eq '‚S‚R‚P‚Ž‚“‚Œ‚‰‚S‚S‚R‚P‚S‚S‚S' },
    sub { $_='‚”‚’‚‚Ž‚“‚Œ‚‰‚”‚…‚’‚‚”‚…‚…';  my $r=mb::tr($_,'‚‚‚’‚…‚”','‚P‚Q‚R‚S','d');  $_ eq '‚R‚P‚Ž‚“‚Œ‚‰‚S‚R‚P‚S‚S'       },
    sub { $_='‚”‚’‚‚Ž‚“‚Œ‚‰‚”‚…‚’‚‚”‚…‚…';  my $r=mb::tr($_,'‚‚‚’‚…‚”','‚P‚Q‚R‚S','s');  $_ eq '‚S‚R‚P‚Ž‚“‚Œ‚‰‚S‚R‚P‚S'       },
    sub { $_='‚”‚’‚‚Ž‚“‚Œ‚‰‚”‚…‚’‚‚”‚…‚…';  my $r=mb::tr($_,'‚‚‚’‚…‚”','‚P‚Q‚R‚S','ds'); $_ eq '‚R‚P‚Ž‚“‚Œ‚‰‚S‚R‚P‚S'         },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
#-----------------------------------------------------------------------------
# 471
    sub { $_='‚”‚’‚‚Ž‚“‚Œ‚‰‚”‚…‚’‚‚”‚…‚…';  my $r=mb::tr($_,'‚‚…','');   $r == 5                              },
    sub { $_='‚”‚’‚‚Ž‚“‚Œ‚‰‚”‚…‚’‚‚”‚…‚…';  my $r=mb::tr($_,'‚‚…','');   $_ eq '‚”‚’‚‚Ž‚“‚Œ‚‰‚”‚…‚’‚‚”‚…‚…' },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 501
    ...
    sub { $_=qq{‚`‚a‚b‚c‚d‚e‚f‚g‚h‚i};       my $r=mb::tr($_,qq{‚`‚a‚b‚c‚d‚e‚f‚g‚h‚i},qq{\a\b\e\f\n\r\t\053\cC\xeb});          $r == 10                            },
    sub { $_=qq{‚`‚a‚b‚c‚d‚e‚f‚g‚h‚i};       my $r=mb::tr($_,qq{‚`‚a‚b‚c‚d‚e‚f‚g‚h‚i},qq{\a\b\e\f\n\r\t\053\cC\xeb});          $_ eq qq{\a\b\e\f\n\r\t\053\cC\xeb} },
    sub {1},
    sub {1},
    sub {1},
