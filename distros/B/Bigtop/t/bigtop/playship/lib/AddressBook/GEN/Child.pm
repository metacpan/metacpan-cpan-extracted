...
AddressBook::GEN::Child - generated support module for AddressBook::Child

=head1 SYNOPSIS

In AddressBook::Child:
...
Use it in AddressBook::Child to provide the methods below.
