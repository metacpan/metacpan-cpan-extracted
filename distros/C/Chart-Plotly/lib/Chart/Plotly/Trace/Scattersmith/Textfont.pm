package Chart::Plotly::Trace::Scattersmith::Textfont;
use Moose;
...
Chart::Plotly::Trace::Scattersmith::Textfont - This attribute is one of the possible options for the trace scattersmith.
