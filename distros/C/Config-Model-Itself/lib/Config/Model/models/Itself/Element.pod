...
Specify help string applicable to values. The keys are regexp matched to the beggining of the value. See C<help> parameter of L<Config::Model::Value/DESCRIPTION> for more possibilities. I< Optional. Type hash of string.  > 
