...
If you would rather do development without installing all the dependencies,
you can use the docker image that is built automatically from the github
source code.

    docker run -v `pwd`:/home/dev --rm -it -p5000:5000 quay.io/colinnewell/tt2-play-area:latest bash

This will mount the current directory (hopefully the source code assuming you're
in that directory) into the /home/dev folder.  From there you can run the code directly.
