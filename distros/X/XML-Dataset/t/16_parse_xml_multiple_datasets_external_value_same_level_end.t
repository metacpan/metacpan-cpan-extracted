...
#      __NEW_EXTERNAL_VALUE_HOLDER__ = __external_value__1:number __external_value__1:specificvalue

# Create example profile
my $profile = qq(
   catalog
      lowest
      __NEW_EXTERNAL_VALUE_HOLDER__ = __external_value__1:specificvalue
