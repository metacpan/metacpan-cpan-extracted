package ## no critic: Modules::RequireFilenameMatchesPackage
    # hide from PAUSE
    TableDataRole::Perl::CPAN::Release::Static::2000;
...
around new => sub {
    ...
    unless (-f $filename) {
        ...
        $filename = File::ShareDir::dist_file('TableDataBundle-Perl-CPAN-Release-Static-Older', '2000.csv');
    }
    $orig->(@_, filename=>$filename);
};

package TableData::Perl::CPAN::Release::Static::2000;
...
with 'TableDataRole::Perl::CPAN::Release::Static::2000';

our %STATS = ("num_columns",9,"num_rows",3444); # STATS
...
TableDataRole::Perl::CPAN::Release::Static::2000 - CPAN releases for the year 2000

=head1 VERSION

This document describes version 20220218.2 of TableDataRole::Perl::CPAN::Release::Static::2000 (from Perl distribution TableDataBundle-Perl-CPAN-Release-Static-Older), released on 2022-02-18.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Perl::CPAN::Release::Static::2000;

 my $td = TableData::Perl::CPAN::Release::Static::2000->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Perl::CPAN::Release::Static::2000 --page

 # Get number of rows
 % tabledata --action count_rows Perl::CPAN::Release::Static::2000
