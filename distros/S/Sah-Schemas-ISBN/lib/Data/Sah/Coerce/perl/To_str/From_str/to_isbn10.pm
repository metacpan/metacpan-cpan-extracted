...
Data::Sah::Coerce::perl::To_str::From_str::to_isbn10 - Check and format ISBN 10 number from string

=head1 VERSION

This document describes version 0.008 of Data::Sah::Coerce::perl::To_str::From_str::to_isbn10 (from Perl distribution Sah-Schemas-ISBN), released on 2020-05-27.

=head1 SYNOPSIS

To use in a Sah schema:

 ["str",{"x.perl.coerce_rules"=>["From_str::to_isbn10"]}]
