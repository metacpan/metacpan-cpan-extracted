...
=head2 load_fastQ_brew()
 ...
 -file_path, path to sequences e.g. "./"
...
sub _summary_stats {
    ...
    if ( $self->{summary} ne "N" ) {
        ...
        print "| largest error probability \t => ",  $max_prob, "\n";
        print "| smallest error probability \t => ", $min_prob, "\n";
        print "| average error probability \t => ",
