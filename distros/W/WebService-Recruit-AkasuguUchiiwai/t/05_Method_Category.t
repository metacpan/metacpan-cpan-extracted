#
# Test case for WebService::Recruit::AkasuguUchiiwai::Category
#
...
my $service = new WebService::Recruit::AkasuguUchiiwai::Category();

ok( ref $service, 'new WebService::Recruit::AkasuguUchiiwai::Category()' );
...
# Test[0]
{
    ...
    my $res = new WebService::Recruit::AkasuguUchiiwai::Category();
