...
######################################################################
#
# Eksc5601 - Run-time routines for KSC5601.pm
#
# http://search.cpan.org/dist/Char-KSC5601/
#
...
elsif (__PACKAGE__ =~ / \b Eksc5601 \z/oxms) {
    %range_tr = (
        1 => [ [0x00..0xA0],
               [0xFF..0xFF],
             ],
...
sub import {
    ...
    *Char::ord           = \&KSC5601::ord;
    *Char::ord_          = \&KSC5601::ord_;
    *Char::reverse       = \&KSC5601::reverse;
    *Char::getc          = \&KSC5601::getc;
    *Char::length        = \&KSC5601::length;
    *Char::substr        = \&KSC5601::substr;
    *Char::index         = \&KSC5601::index;
    *Char::rindex        = \&KSC5601::rindex;
    *Char::eval          = \&KSC5601::eval;
    *Char::escape        = \&KSC5601::escape;
    *Char::escape_token  = \&KSC5601::escape_token;
    *Char::escape_script = \&KSC5601::escape_script;
}
...
sub Eksc5601::index($$;$);
sub Eksc5601::rindex($$;$);
sub Eksc5601::lcfirst(@);
sub Eksc5601::lcfirst_();
sub Eksc5601::lc(@);
sub Eksc5601::lc_();
sub Eksc5601::ucfirst(@);
sub Eksc5601::ucfirst_();
sub Eksc5601::uc(@);
sub Eksc5601::uc_();
sub Eksc5601::fc(@);
sub Eksc5601::fc_();
sub Eksc5601::ignorecase;
sub Eksc5601::classic_character_class;
sub Eksc5601::capture;
sub Eksc5601::chr(;$);
sub Eksc5601::chr_();
sub Eksc5601::glob($);
sub Eksc5601::glob_();
...
${Eksc5601::anchor} = qr{\G(?>[^\xA1-\xFE]|[\xA1-\xFE][\x00-\xFF])*?}oxms;
...
if (($] >= 5.010001) or
    ...
    # other encoding
        ...
        ${Eksc5601::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[$sbcs](?:[^$sbcs][^$sbcs])*?}oxms;
        #                                                     ******* octets not in multiple octet char (always char boundary)
        #                                                               **************** 2 octet chars
    }

    ${Eksc5601::anchor_SADAHIRO_Tomoyuki_2002_01_17} =
    qr{\G(?(?=.{0,32766}\z)(?:[^\xA1-\xFE]|[\xA1-\xFE][\x00-\xFF])*?|(?(?=[$sbcs]+\z).*?|(?:${Eksc5601::q_char_SADAHIRO_Tomoyuki_2002_01_17})))}oxms;
#   qr{
#      \G # (1), (2)
#        (? # (3)
#          (?=.{0,32766}\z) # (4)
#                          (?:[^\xA1-\xFE]|[\xA1-\xFE][\x00-\xFF])*?| # (5)
#                                                                                      (?(?=[$sbcs]+\z) # (6)
#                                                                                                      .*?| #(7)
#                                                                                                          (?:${Eksc5601::q_char_SADAHIRO_Tomoyuki_2002_01_17}) # (8)
#                                                                                                                                           ))}oxms;
    ...
    if (((('A' x 32768).'B') !~ / ${Eksc5601::anchor}                              B /oxms) and
        ((('A' x 32768).'B') =~ / ${Eksc5601::anchor_SADAHIRO_Tomoyuki_2002_01_17} B /oxms)
    ) {
        ${Eksc5601::anchor} = ${Eksc5601::anchor_SADAHIRO_Tomoyuki_2002_01_17};
    }
    else {
        undef ${Eksc5601::q_char_SADAHIRO_Tomoyuki_2002_01_17};
    }
}
...
# (8)
# else KSC5601::Regexp::Const (SADAHIRO Tomoyuki)
# http://homepage1.nifty.com/nomenclator/perl/shiftjis.htm#long
# http://search.cpan.org/~sadahiro/KSC5601-Regexp/
# $PadA  = '  (?:\A|                                           [\x00-\x80\xA0-\xDF])(?:[\xA1-\xFE]{2})*?';
# $PadG  = '\G(?:                                |[\x00-\xFF]*?[\x00-\x80\xA0-\xDF])(?:[\xA1-\xFE]{2})*?';
# $PadGA = '\G(?:\A|(?:[\xA1-\xFE]{2})+?|[\x00-\xFF]*?[\x00-\x80\xA0-\xDF] (?:[\xA1-\xFE]{2})*?)';

${Eksc5601::dot}         = qr{(?>[^\xA1-\xFE\x0A]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::dot_s}       = qr{(?>[^\xA1-\xFE]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::eD}          = qr{(?>[^\xA1-\xFE0-9]|[\xA1-\xFE][\x00-\xFF])};
...
# ${Eksc5601::eS}          = qr{(?>[^\xA1-\xFE\x09\x0A    \x0C\x0D\x20]|[\xA1-\xFE][\x00-\xFF])};
# ${Eksc5601::eS}          = qr{(?>[^\xA1-\xFE\x09\x0A\x0B\x0C\x0D\x20]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::eS}            = qr{(?>[^\xA1-\xFE\s]|[\xA1-\xFE][\x00-\xFF])};

${Eksc5601::eW}            = qr{(?>[^\xA1-\xFE0-9A-Z_a-z]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::eH}            = qr{(?>[^\xA1-\xFE\x09\x20]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::eV}            = qr{(?>[^\xA1-\xFE\x0A\x0B\x0C\x0D]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::eR}            = qr{(?>\x0D\x0A|[\x0A\x0D])};
${Eksc5601::eN}            = qr{(?>[^\xA1-\xFE\x0A]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::not_alnum}     = qr{(?>[^\xA1-\xFE\x30-\x39\x41-\x5A\x61-\x7A]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::not_alpha}     = qr{(?>[^\xA1-\xFE\x41-\x5A\x61-\x7A]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::not_ascii}     = qr{(?>[^\xA1-\xFE\x00-\x7F]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::not_blank}     = qr{(?>[^\xA1-\xFE\x09\x20]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::not_cntrl}     = qr{(?>[^\xA1-\xFE\x00-\x1F\x7F]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::not_digit}     = qr{(?>[^\xA1-\xFE\x30-\x39]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::not_graph}     = qr{(?>[^\xA1-\xFE\x21-\x7F]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::not_lower}     = qr{(?>[^\xA1-\xFE\x61-\x7A]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::not_lower_i}   = qr{(?>[^\xA1-\xFE\x41-\x5A\x61-\x7A]|[\xA1-\xFE][\x00-\xFF])}; # Perl 5.16 compatible
# ${Eksc5601::not_lower_i} = qr{(?>[^\xA1-\xFE]|[\xA1-\xFE][\x00-\xFF])};                   # older Perl compatible
${Eksc5601::not_print}     = qr{(?>[^\xA1-\xFE\x20-\x7F]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::not_punct}     = qr{(?>[^\xA1-\xFE\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::not_space}     = qr{(?>[^\xA1-\xFE\s\x0B]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::not_upper}     = qr{(?>[^\xA1-\xFE\x41-\x5A]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::not_upper_i}   = qr{(?>[^\xA1-\xFE\x41-\x5A\x61-\x7A]|[\xA1-\xFE][\x00-\xFF])}; # Perl 5.16 compatible
# ${Eksc5601::not_upper_i} = qr{(?>[^\xA1-\xFE]|[\xA1-\xFE][\x00-\xFF])};                   # older Perl compatible
${Eksc5601::not_word}      = qr{(?>[^\xA1-\xFE\x30-\x39\x41-\x5A\x5F\x61-\x7A]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::not_xdigit}    = qr{(?>[^\xA1-\xFE\x30-\x39\x41-\x46\x61-\x66]|[\xA1-\xFE][\x00-\xFF])};
${Eksc5601::eb}            = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Eksc5601::eB}            = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Eksc5601::foo" used only once: possible typo at here.
${Eksc5601::dot}         = ${Eksc5601::dot};
${Eksc5601::dot_s}       = ${Eksc5601::dot_s};
${Eksc5601::eD}          = ${Eksc5601::eD};
${Eksc5601::eS}          = ${Eksc5601::eS};
${Eksc5601::eW}          = ${Eksc5601::eW};
${Eksc5601::eH}          = ${Eksc5601::eH};
${Eksc5601::eV}          = ${Eksc5601::eV};
${Eksc5601::eR}          = ${Eksc5601::eR};
${Eksc5601::eN}          = ${Eksc5601::eN};
${Eksc5601::not_alnum}   = ${Eksc5601::not_alnum};
${Eksc5601::not_alpha}   = ${Eksc5601::not_alpha};
${Eksc5601::not_ascii}   = ${Eksc5601::not_ascii};
${Eksc5601::not_blank}   = ${Eksc5601::not_blank};
${Eksc5601::not_cntrl}   = ${Eksc5601::not_cntrl};
${Eksc5601::not_digit}   = ${Eksc5601::not_digit};
${Eksc5601::not_graph}   = ${Eksc5601::not_graph};
${Eksc5601::not_lower}   = ${Eksc5601::not_lower};
${Eksc5601::not_lower_i} = ${Eksc5601::not_lower_i};
${Eksc5601::not_print}   = ${Eksc5601::not_print};
${Eksc5601::not_punct}   = ${Eksc5601::not_punct};
${Eksc5601::not_space}   = ${Eksc5601::not_space};
${Eksc5601::not_upper}   = ${Eksc5601::not_upper};
${Eksc5601::not_upper_i} = ${Eksc5601::not_upper_i};
${Eksc5601::not_word}    = ${Eksc5601::not_word};
${Eksc5601::not_xdigit}  = ${Eksc5601::not_xdigit};
${Eksc5601::eb}          = ${Eksc5601::eb};
${Eksc5601::eB}          = ${Eksc5601::eB};
...
sub Eksc5601::split(;$$$) {
    ...
    if (CORE::length($string) > 32766) {
        ...
        elsif (defined ${Eksc5601::q_char_SADAHIRO_Tomoyuki_2002_01_17}) {
            $q_char = ${Eksc5601::q_char_SADAHIRO_Tomoyuki_2002_01_17};
        }
    }
...
sub _last_subexpression_offsets {
    ...
    if ($modifier =~ /x/oxms) {
        @char = $pattern =~ /\G((?>
            ...
            \\ $q_char      |
            \# (?>[^\n]*) $ |
            \[ (?>(?:[^\xA1-\xFE\\\]]|[\xA1-\xFE][\x00-\xFF]|\\\\|\\\]|$q_char)+) \] |
            \(\?            |
                $q_char
        ))/oxmsg;
    }
...
#
# KSC5601 lower case first with parameter
#
sub Eksc5601::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Eksc5601::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Eksc5601::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Eksc5601::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# KSC5601 lower case first without parameter
#
sub Eksc5601::lcfirst_() {
    return Eksc5601::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# KSC5601 lower case with parameter
#
sub Eksc5601::lc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# KSC5601 lower case without parameter
#
sub Eksc5601::lc_() {
    my $s = $_;
    return join '', map {defined($lc{$_}) ? $lc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# KSC5601 upper case first with parameter
#
sub Eksc5601::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Eksc5601::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Eksc5601::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Eksc5601::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# KSC5601 upper case first without parameter
#
sub Eksc5601::ucfirst_() {
    return Eksc5601::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# KSC5601 upper case with parameter
#
sub Eksc5601::uc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# KSC5601 upper case without parameter
#
sub Eksc5601::uc_() {
    my $s = $_;
    return join '', map {defined($uc{$_}) ? $uc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# KSC5601 fold case with parameter
#
sub Eksc5601::fc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# KSC5601 fold case without parameter
#
sub Eksc5601::fc_() {
    my $s = $_;
    return join '', map {defined($fc{$_}) ? $fc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
{
    ...
    # KSC5601 mark last regexp matched
    sub Eksc5601::matched() {
        $last_s_matched = 0;
    }

    # KSC5601 mark last s/// matched
    sub Eksc5601::s_matched() {
        $last_s_matched = 1;
    }
    ...
    $Eksc5601::matched = qr/(?{Eksc5601::matched})/;
}

#
# KSC5601 regexp ignore case modifier
#
sub Eksc5601::ignorecase {
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Eksc5601::uc($char[$i]);
                my $fc = Eksc5601::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
#
# prepare KSC5601 characters per length
#
...
#
# KSC5601 open character list for tr
#
sub _charlist_tr {
...
#
# KSC5601 open character list for qr and not qr
#
sub _charlist {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # \P{PROPERTY} --> P\{PROPERTY}
        elsif ($char[$i] =~ /\A \\ ([bBNpP]) ( \{ ([^\xA1-\xFE0-9\}][^\xA1-\xFE\}]*) \} ) \z/oxms) {
            $char[$i] = $1 . '\\' . $2;
        }
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Eksc5601::not_lower_i}',
                '[:^upper:]'  => '${Eksc5601::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Eksc5601::not_alnum}',
                '[:^alpha:]'  => '${Eksc5601::not_alpha}',
                '[:^ascii:]'  => '${Eksc5601::not_ascii}',
                '[:^blank:]'  => '${Eksc5601::not_blank}',
                '[:^cntrl:]'  => '${Eksc5601::not_cntrl}',
                '[:^digit:]'  => '${Eksc5601::not_digit}',
                '[:^graph:]'  => '${Eksc5601::not_graph}',
                '[:^lower:]'  => '${Eksc5601::not_lower}',
                '[:^print:]'  => '${Eksc5601::not_print}',
                '[:^punct:]'  => '${Eksc5601::not_punct}',
                '[:^space:]'  => '${Eksc5601::not_space}',
                '[:^upper:]'  => '${Eksc5601::not_upper}',
                '[:^word:]'   => '${Eksc5601::not_word}',
                '[:^xdigit:]' => '${Eksc5601::not_xdigit}',
...
#
# KSC5601 hexadecimal escape sequence
#
sub hexchr {
    my($hexdigit) = @_;
...
#
# KSC5601 open character list for qr
#
sub charlist_qr {
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Eksc5601::uc($char);
                        my $fc = Eksc5601::fc($char);
                        if ($uc eq $fc) {
...
#
# KSC5601 open character list for not qr
#
sub charlist_not_qr {
    ...
    if (scalar(@multipleoctet) >= 1) {
        if (scalar(@singleoctet) >= 1) {
            ...
            return '(?!' . join('|', @multipleoctet) . ')(?:[^\xA1-\xFE' . join('', @singleoctet) . ']|[\xA1-\xFE][\x00-\xFF])';
        }
        else {
        ...
        if (scalar(@singleoctet) >= 1) {
            ...
            return                                      '(?:[^\xA1-\xFE' . join('', @singleoctet) . ']|[\xA1-\xFE][\x00-\xFF])';
        }
        else {
...
#
# KSC5601 order to character (with parameter)
#
sub Eksc5601::chr(;$) {
...
#
# KSC5601 order to character (without parameter)
#
sub Eksc5601::chr_() {
...
#
# KSC5601 path globbing (with parameter)
#
sub Eksc5601::glob($) {
...
#
# KSC5601 path globbing (without parameter)
#
sub Eksc5601::glob_() {
...
#
# KSC5601 path globbing via File::DosGlob 1.10
#
...
sub _DOS_like_glob {
    ...
    # UNIX-like system
        ...
        $expr =~ s{ \A ~ ( (?:[^\xA1-\xFE/]|[\xA1-\xFE][\x00-\xFF])* ) }
...
#
# KSC5601 path globbing subroutine
#
sub _do_glob {
...
OUTER:
    for my $expr (@expr) {
        ...
        if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
            if ($expr =~ s# \A ((?:[A-Za-z]:)?) ([^\xA1-\xFE/\\]|[\xA1-\xFE][\x00-\xFF]) #$1./$2#oxms) {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Eksc5601::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Eksc5601::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Eksc5601::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Eksc5601::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
sub _parse_line {
    ...
    my @piece = ();
    while ($line =~ /
        " ( (?>(?: [^\xA1-\xFE"]  |[\xA1-\xFE][\x00-\xFF] )* ) ) " (?>\s+) |
          ( (?>(?: [^\xA1-\xFE"\s]|[\xA1-\xFE][\x00-\xFF] )* ) )   (?>\s+)
        /oxmsg
    ) {
...
#
# KSC5601 character to order (without parameter)
#
sub KSC5601::ord_() {
...
#
# KSC5601 getc (with parameter, without parameter)
#
sub KSC5601::getc(;*@) {

    my($package) = caller;
    my $fh = @_ ? qualify_to_ref(shift,$package) : \*STDIN;
    croak 'Too many arguments for KSC5601::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Eksc5601::dot_s} \z/oxms) {
...
#
# KSC5601 index by character
#
sub KSC5601::index($$;$) {

    my $index;
    if (@_ == 3) {
        $index = Eksc5601::index($_[0], $_[1], CORE::length(KSC5601::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Eksc5601::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return KSC5601::length(CORE::substr $_[0], 0, $index);
    }
}

#
# KSC5601 rindex by character
#
sub KSC5601::rindex($$;$) {

    my $rindex;
    if (@_ == 3) {
        $rindex = Eksc5601::rindex($_[0], $_[1], CORE::length(KSC5601::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Eksc5601::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return KSC5601::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
# ord() to ord() or KSC5601::ord()
my $function_ord = 'ord';

# ord to ord or KSC5601::ord_
my $function_ord_ = 'ord';

# reverse to reverse or KSC5601::reverse
my $function_reverse = 'reverse';

# getc to getc or KSC5601::getc
...
my $qq_substr  = qr{(?> Char::substr | KSC5601::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
my $matched     = '';
my $s_matched   = '';
$matched        = q{$Eksc5601::matched};
$s_matched      = q{ Eksc5601::s_matched();};
...
#
# escape KSC5601 token of script
#
sub KSC5601::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Eksc5601::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ (?>\s*) PREMATCH  \b | \$ (?>\s*) \{ (?>\s*) PREMATCH  (?>\s*) \} | \$ (?>\s*) \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Eksc5601::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Eksc5601::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Eksc5601::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Eksc5601::POSTMATCH()
    elsif (/\G (                 \$ (?>\s*) POSTMATCH \b | \$ (?>\s*) \{ (?>\s*) POSTMATCH (?>\s*) \} | \$ (?>\s*) \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Eksc5601::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    elsif (/\G \b while (?>\s*) \( (?>\s*) < ((?:[^\xA1-\xFE>\0\a\e\f\n\r\t]|[\xA1-\xFE][\x00-\xFF])+?) > (?>\s*) \) \b /oxgc) {
        return 'while ($_ = Eksc5601::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob (?>\s*) \) /oxgc) {
        return 'while ($_ = Eksc5601::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob \b /oxgc) {
        return 'while ($_ = Eksc5601::glob';
    }
...
# subroutines of package Eksc5601
    elsif (/\G \b (CORE:: | ->(>?\s*) (?: atan2 | [a-z]{2,})) \b       /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b KSC5601::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Char::escape'; }
    elsif (/\G \b KSC5601::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval KSC5601::escape'; }
    elsif (/\G \b bytes::substr \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Eksc5601::chop';       }
    elsif (/\G \b bytes::index \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::index';       }
    elsif (/\G \b KSC5601::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'KSC5601::index';       }
    elsif (/\G \b index \b         (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Eksc5601::index';      }
    elsif (/\G \b bytes::rindex \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::rindex';      }
    elsif (/\G \b KSC5601::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'KSC5601::rindex';      }
    elsif (/\G \b rindex \b        (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Eksc5601::rindex';     }
    elsif (/\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Eksc5601::lc';         }
    elsif (/\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Eksc5601::lcfirst';    }
    elsif (/\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Eksc5601::uc';         }
    elsif (/\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Eksc5601::ucfirst';    }
    elsif (/\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Eksc5601::fc';         }
    ...
    elsif (/\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Eksc5601::chr';               }
    elsif (/\G \b bytes::ord    (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Eksc5601::glob';              }
    elsif (/\G \b lc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Eksc5601::lc_';               }
    elsif (/\G \b lcfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Eksc5601::lcfirst_';          }
    elsif (/\G \b uc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Eksc5601::uc_';               }
    elsif (/\G \b ucfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Eksc5601::ucfirst_';          }
    elsif (/\G \b fc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Eksc5601::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Eksc5601::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Eksc5601::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Eksc5601::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Eksc5601::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq           (\#) [ ] (\#) /oxgc) { return 'Eksc5601::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Eksc5601::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Eksc5601::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Eksc5601::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Eksc5601::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Eksc5601::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q            (\#) [ ] (\#) /oxgc) { return 'Eksc5601::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Eksc5601::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Eksc5601::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Eksc5601::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Eksc5601::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Eksc5601::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                    ' [ ] '    /oxgc) { return 'Eksc5601::split' . $e . qq     {' '};  }
        elsif (/\G                    " [ ] "    /oxgc) { return 'Eksc5601::split' . $e . qq     {" "};  }
...
# require ignore module
    ...
    elsif (/\G \b require ((?>\s+) (?:$ignore_modules) .*? ;) ([ \t]* [^\xA1-\xFE#]) /oxmsgc) { return "# require$1\n$2";   }
    elsif (/\G \b require ((?>\s+) (?:$ignore_modules)) \b                                    /oxmsgc) { return "# require$1";       }

# use strict; --> use strict; no strict qw(refs);
    elsif (/\G \b use ((?>\s+) strict .*? ;) ([ \t]* [#\n])                                   /oxmsgc) { return "use$1 no strict qw(refs);$2";   }
    elsif (/\G \b use ((?>\s+) strict .*? ;) ([ \t]* [^\xA1-\xFE#])                  /oxmsgc) { return "use$1 no strict qw(refs);\n$2"; }
...
# ignore use module
    ...
    elsif (/\G \b use ((?>\s+) (?:$ignore_modules) .*? ;) ([ \t]* [^\xA1-\xFE#]) /oxmsgc) { return "# use$1\n$2";       }
    elsif (/\G \b use ((?>\s+) (?:$ignore_modules)) \b                                    /oxmsgc) { return "# use$1";           }

# ignore no module
    elsif (/\G \b no  ((?>\s+) (?:$ignore_modules) .*? ;) ([ \t]* [#\n])                  /oxmsgc) { return "# no$1$2";          }
    elsif (/\G \b no  ((?>\s+) (?:$ignore_modules) .*? ;) ([ \t]* [^\xA1-\xFE#]) /oxmsgc) { return "# no$1\n$2";        }
...
# <WILDCARD> --- glob
    ...
    elsif (/\G < ((?:[^\xA1-\xFE>\0\a\e\f\n\r\t]|[\xA1-\xFE][\x00-\xFF])+?) > /oxgc) {
        return 'Eksc5601::glob("' . $1 . '")';
    }
...
sub e_string {
    ...
    my @char = $string =~ / \G (?>[^\xA1-\xFE\\]|\\$q_char|$q_char) /oxmsg;
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Eksc5601::PREMATCH()]}
            ...
            $e_string .= q{Eksc5601::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Eksc5601::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Eksc5601::MATCH()};
            $slash = 'div';
        }
...
sub character_class {
    ...
    if ($char eq '.') {
        ...
        return Eksc5601::classic_character_class($char);
    }
}
...
sub e_capture {
    ...
    return join '', '${Eksc5601::capture(', $_[0], ')}';
    return join '', '${',                $_[0],  '}';
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Eksc5601::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Eksc5601::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Eksc5601::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Eksc5601::hexchr($1);
        }

        # \N{CHARNAME} --> N{CHARNAME}
        elsif ($char[$i] =~ /\A \\ ( N\{ ([^\xA1-\xFE0-9\}][^\xA1-\xFE\}]*) \} ) \z/oxms) {
            $char[$i] = $1;
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Eksc5601::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Eksc5601::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Eksc5601::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Eksc5601::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Eksc5601::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Eksc5601::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Eksc5601::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Eksc5601::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Eksc5601::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Eksc5601::uc($char[$i]) ne Eksc5601::fc($char[$i]))) {
            if (CORE::length(Eksc5601::fc($char[$i])) == 1) {
                $char[$i] = '['   . Eksc5601::uc($char[$i])       . Eksc5601::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Eksc5601::uc($char[$i]) . '|' . Eksc5601::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Eksc5601::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ (?>\s*) 0 (?>\s*) \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Eksc5601::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Eksc5601::ignorecase(Eksc5601::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Eksc5601::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Eksc5601::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Eksc5601::ignorecase(Eksc5601::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Eksc5601::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Eksc5601::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Eksc5601::ignorecase(Eksc5601::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Eksc5601::POSTMATCH()]}';
            }
...
sub e_s2_q {
    ...
    my @char = $string =~ / \G (?>[^\xA1-\xFE\\]|\\\\|$q_char) /oxmsg;
    for (my $i=0; $i <= $#char; $i++) {
        if (0) {
        }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                                                2   3                                  4   5
                q<CORE::eval{local $Eksc5601::re_t=%s; local $Eksc5601::re_a=''; while($Eksc5601::re_t =~ %s){%s local $^W=0; local $Eksc5601::re_r=%s; %s$Eksc5601::re_t="$Eksc5601::re_a${1}$Eksc5601::re_r$'"; pos($Eksc5601::re_t)=length "$Eksc5601::re_a${1}$Eksc5601::re_r"; $Eksc5601::re_a=substr($Eksc5601::re_t,0,pos($Eksc5601::re_t)); } return $Eksc5601::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Eksc5601::re_r=CORE::eval $Eksc5601::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Eksc5601::re_t=%s; while($Eksc5601::re_t =~ %s){%s local $^W=0; local $Eksc5601::re_r=%s; %s$Eksc5601::re_t="$`$Eksc5601::re_r$'"; pos($Eksc5601::re_t)=length "$`$Eksc5601::re_r"; } return $Eksc5601::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Eksc5601::re_r=%s; %s"%s$Eksc5601::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Eksc5601::re_n=0; local $Eksc5601::re_a=''; while(%s =~ %s){%s local $^W=0; local $Eksc5601::re_r=%s; %s%s="$Eksc5601::re_a${1}$Eksc5601::re_r$'"; pos(%s)=length "$Eksc5601::re_a${1}$Eksc5601::re_r"; $Eksc5601::re_a=substr(%s,0,pos(%s)); $Eksc5601::re_n++} return %s$Eksc5601::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Eksc5601::re_n=0; while(%s =~ %s){%s local $^W=0; local $Eksc5601::re_r=%s; %s%s="$`$Eksc5601::re_r$'"; pos(%s)=length "$`$Eksc5601::re_r"; $Eksc5601::re_n++} return %s$Eksc5601::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Eksc5601::re_r=%s; %s%s="%s$Eksc5601::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Eksc5601::re_r=%s; %s%s="%s$Eksc5601::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Eksc5601::re_r=CORE::eval $Eksc5601::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Eksc5601::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Eksc5601::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  # "no Eksc5601;" not supported

=head1 ABSTRACT

This module has run-time routines for use KSC5601 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in KSC5601 software and not
...
This Eksc5601 module first appeared in ActivePerl Build 522 Built under
...
=item * Split string
  ...
  @split = Eksc5601::split(/pattern/,$string,$limit);
  @split = Eksc5601::split(/pattern/,$string);
  @split = Eksc5601::split(/pattern/);
  @split = Eksc5601::split('',$string,$limit);
  @split = Eksc5601::split('',$string);
  @split = Eksc5601::split('');
  @split = Eksc5601::split();
  @split = Eksc5601::split;
  ...
  at all, Eksc5601::split returns the original string as a single substring, If it
  ...
  @chars  = Eksc5601::split(//,  $word);
  @fields = Eksc5601::split(/:/, $line);
  @words  = Eksc5601::split(" ", $paragraph);
  @lines  = Eksc5601::split(/^/, $buffer);
  ...
  print join(":" => Eksc5601::split(/ */, "hi there"));
  ...
  Eksc5601::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Eksc5601::split(/:/, $_, 3);
  ...
  splits on whitespace just as Eksc5601::split with no arguments does. Thus,
  Eksc5601::split(" ") can be used to emulate awk's default behavior. In contrast,
  Eksc5601::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Eksc5601::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Eksc5601::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Eksc5601::split()) {
          $count{$word}++;
      }
  }

  The inverse of Eksc5601::split is join, except that join can only join with the
...
=item * Transliteration
  ...
  $tr = Eksc5601::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Eksc5601::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  This subroutine scans a KSC5601 string character by character and replaces all
  occurrences of the characters found in $searchlist with the corresponding character
  in $replacementlist. It returns the number of characters replaced or deleted.
  If no KSC5601 string is specified via =~ operator, the $_ variable is translated.
  $modifier are:
  ...
  print Eksc5601::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item * Chop string

  $chop = Eksc5601::chop(@list);
  $chop = Eksc5601::chop();
  $chop = Eksc5601::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Eksc5601::chop subroutine is used primary to remove the newline
  ...
  since Eksc5601::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Eksc5601::chop a literal, only a variable. If you Eksc5601::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Eksc5601::chop(@lines);

  You can Eksc5601::chop anything that is an lvalue, including an assignment:

  Eksc5601::chop($cwd = `pwd`);
  Eksc5601::chop($answer = <STDIN>);

  This is different from:

  $answer = Eksc5601::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Eksc5601::chop returns the character
  ...
  In the most general case, Eksc5601::chop can be expressed using substr:

  $last_code = Eksc5601::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Eksc5601::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Eksc5601::chop;
...
=item * Index string
  ...
  $byte_pos = Eksc5601::index($string,$substr,$byte_offset);
  $byte_pos = Eksc5601::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Eksc5601::index($string, $lookfor, $byte_pos)) > -1) {
...
=item * Reverse index string
  ...
  $byte_pos = Eksc5601::rindex($string,$substr,$byte_offset);
  $byte_pos = Eksc5601::rindex($string,$substr);

  This subroutine works just like Eksc5601::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Eksc5601::index).
  ...
  while (($byte_pos = KSC5601::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item * Lower case string
  ...
  $lc = Eksc5601::lc($string);
  $lc = Eksc5601::lc_;

  This subroutine returns a lowercased version of KSC5601 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Eksc5601::fc subroutine for case-insensitive comparisons via KSC5601
  software.

=item * Lower case first character of string

  $lcfirst = Eksc5601::lcfirst($string);
  $lcfirst = Eksc5601::lcfirst_;

  This subroutine returns a version of KSC5601 $string with the first character
  lowercased (or $_, if $string is omitted). This is the internal subroutine
  implementing the \l escape in double-quoted strings.

=item * Upper case string

  $uc = Eksc5601::uc($string);
  $uc = Eksc5601::uc_;

  This subroutine returns an uppercased version of KSC5601 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Eksc5601::ucfirst instead.
...
=item * Upper case first character of string
  ...
  $ucfirst = Eksc5601::ucfirst($string);
  $ucfirst = Eksc5601::ucfirst_;
  ...
  $titlecase = Eksc5601::ucfirst(substr($word,0,1)) . Eksc5601::lc(substr($word,1));
  ...
  $do_not_use = Eksc5601::ucfirst(Eksc5601::lc($word));
...
=item * Fold case string
  ...
  $fc = Eksc5601::fc($string);
  $fc = Eksc5601::fc_;

  New to KSC5601 software, this subroutine returns the full Unicode-like casefold of
  KSC5601 $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Eksc5601::fc($a) eq Eksc5601::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because KSC5601 software has always used casefolding semantics for
...
=item * Make ignore case string
  ...
  @ignorecase = Eksc5601::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item * Make capture number

  $capturenumber = Eksc5601::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item * Make character

  $chr = Eksc5601::chr($code);
  $chr = Eksc5601::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Eksc5601::chr(65) is "A" in either
  ASCII or KSC5601, not Unicode. For the reverse of Eksc5601::chr, use KSC5601::ord.

=item * Filename expansion (globbing)

  @glob = Eksc5601::glob($string);
  @glob = Eksc5601::glob_;
  ...
  The Eksc5601::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Eksc5601::glob('"*e f*"');
  @spacies = Eksc5601::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Eksc5601::glob("'*${var}e f*'");
  @spacies = Eksc5601::glob(qq("*${var}e f*"));
