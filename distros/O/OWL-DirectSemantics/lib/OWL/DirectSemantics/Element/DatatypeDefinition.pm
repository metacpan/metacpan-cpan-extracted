package OWL::DirectSemantics::Element::DatatypeDefinition;
...
OWL::DirectSemantics::Element::DatatypeDefinition - represents an OWL DatatypeDefinition

=head1 DESCRIPTION

This class represents the DatatypeDefinition element in OWL Direct Semantics.
