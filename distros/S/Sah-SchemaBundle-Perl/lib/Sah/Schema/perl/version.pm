...
This document describes version 0.050 of Sah::Schema::perl::version (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
=head1 SAH SCHEMA DEFINITION
 ...
 [
   "obj",
   {
     "summary" => "Perl version object",
     "isa" => "version",
     "x.perl.coerce_rules" => ["From_str::perl_version"],
   },
 ]

Base type: L<obj|Data::Sah::Type::obj>
