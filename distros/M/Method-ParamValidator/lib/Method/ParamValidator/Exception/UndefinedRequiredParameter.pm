...
$Method::ParamValidator::Exception::UndefinedRequiredParameter::VERSION   = '0.14';
...
has status => (is => 'ro', default => sub { 104 });
has reason => (is => 'ro', default => sub { 'Undefined required parameter.' });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Method::ParamValidator::Exception::UndefinedRequiredParameter
...
1; # End of Method::ParamValidator::Exception::UndefinedRequiredParameter
