package Bio::VertRes::Config::Recipes::VirusMappingUsingBwa;
...
override '_pipeline_configs' => sub {
    ...
    $self->add_virus_bwa_mapping_config(\@pipeline_configs);
...
Bio::VertRes::Config::Recipes::VirusMappingUsingBwa - Standard snp calling pipeline for virus
...
Standard snp calling pipeline for virus.
   ...
   my $obj = Bio::VertRes::Config::Recipes::VirusMappingUsingBwa->new( 
     database => 'abc', 
