...
# Windows1250::eval <<END has Windows1250::eval "..."
if (Windows1250::eval <<END) {
...
# Windows1250::eval <<END has Windows1250::eval qq{...}
if (Windows1250::eval <<END) {
...
# Windows1250::eval <<END has Windows1250::eval q{...}
if (Windows1250::eval <<END) {
...
# Windows1250::eval <<END has Windows1250::eval $var
my $var = q{q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }};
if (Windows1250::eval <<END) {
Windows1250::eval $var
END
...
# Windows1250::eval <<END has Windows1250::eval (omit)
