...
I welcome any contribution to Class::Array, including, but not limited to bug reports, feature requests, general comments, and patches.

Feel free to clone it from its gitlab repository at <https://git.deguest.jp/jack/Class-Generic> and issue a pull request.
...
File [an issue on bug tracker](https://git.deguest.jp/jack/Class-Generic/issues) if you think you've found a bug. Please describe
...
Issues are currently reported using CPAN [bug tracker](https://git.deguest.jp/jack/Class-Generic/issues)

## More information

Please refer to the [README](https://metacpan.org/source/JDEGUEST/Class-Array-v0.1.1/README.md)
