...
#
package AgentPushKit::Client::Object::RegisterWebPushSubscriptionInput;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'RegisterWebPushSubscriptionInput',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'keys' => {
        datatype => 'RegisterWebPushSubscriptionInputKeys',
        base_name => 'keys',
        description => '',
        format => '',
        read_only => '',
