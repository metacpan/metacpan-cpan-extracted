...
package Google::Ads::AdWords::v201402::MutateJobService::get;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201402::JobSelector',
    },
    {
...
Google::Ads::AdWords::v201402::MutateJobService::get
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201402::MutateJobService::get->new($data);

Constructor. The following data structure may be passed to new():

 {
   selector =>  $a_reference_to, # see Google::Ads::AdWords::v201402::JobSelector
 },
