...
Lucy - Lucy search engine library.
...
The Lucy search engine library delivers high-performance, modular
full-text search.
...
The Lucy homepage, where you'll find links to our mailing lists and so
...
Lucy is distributed under the Apache License, Version 2.0, as
