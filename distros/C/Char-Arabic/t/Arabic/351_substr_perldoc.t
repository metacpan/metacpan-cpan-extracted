...
my $color  = Arabic::substr $s, 4, 5;   # black
my $middle = Arabic::substr $s, 4, -11; # black cat climbed the
my $end    = Arabic::substr $s, 14;     # climebed the green tree
my $tail   = Arabic::substr $s, -4;     # tree
my $z      = Arabic::substr $s, -4, 2;  # tr
