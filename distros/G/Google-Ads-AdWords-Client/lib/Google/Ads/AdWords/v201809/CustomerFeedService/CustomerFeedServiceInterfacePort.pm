package Google::Ads::AdWords::v201809::CustomerFeedService::CustomerFeedServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201809::TypeMaps::CustomerFeedService
    if not Google::Ads::AdWords::v201809::TypeMaps::CustomerFeedService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201809/CustomerFeedService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201809::TypeMaps::CustomerFeedService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::CustomerFeedService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201809::CustomerFeedService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::CustomerFeedService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::CustomerFeedService::query )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201809/CustomerFeedService.
...
Returns a L<Google::Ads::AdWords::v201809::CustomerFeedService::getResponse|Google::Ads::AdWords::v201809::CustomerFeedService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::CustomerFeedService::mutateResponse|Google::Ads::AdWords::v201809::CustomerFeedService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::CustomerFeedService::queryResponse|Google::Ads::AdWords::v201809::CustomerFeedService::queryResponse> object.
