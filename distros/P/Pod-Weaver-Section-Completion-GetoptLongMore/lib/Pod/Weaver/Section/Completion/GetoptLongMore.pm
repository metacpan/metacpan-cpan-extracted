...
Pod::Weaver::Section::Completion::GetoptLongMore - Add a COMPLETION section for Getopt::Long::More-based scripts

=head1 VERSION

This document describes version 0.001 of Pod::Weaver::Section::Completion::GetoptLongMore (from Perl distribution Pod-Weaver-Section-Completion-GetoptLongMore), released on 2016-12-10.
...
Please visit the project's homepage at L<https://metacpan.org/release/Pod-Weaver-Section-Completion-GetoptLongMore>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Pod-Weaver-Section-Completion-GetoptLongMore>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=Pod-Weaver-Section-Completion-GetoptLongMore>
