package Net::RRP::Response::n536;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n536::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n536::VERSION = '0.1';
...
Net::RRP::Response::n536 - the 536 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
