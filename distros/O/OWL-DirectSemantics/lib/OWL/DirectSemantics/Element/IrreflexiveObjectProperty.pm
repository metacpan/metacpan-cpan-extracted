package OWL::DirectSemantics::Element::IrreflexiveObjectProperty;

BEGIN {
	$OWL::DirectSemantics::Element::IrreflexiveObjectProperty::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::IrreflexiveObjectProperty::VERSION   = '0.001';
};
...
OWL::DirectSemantics::Element::IrreflexiveObjectProperty - represents an OWL IrreflexiveObjectProperty

=head1 DESCRIPTION

This class represents the IrreflexiveObjectProperty element in OWL Direct Semantics.
