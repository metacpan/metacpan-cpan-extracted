package Google::Cloud::Metastore::V1::DataprocMetastoreFederationClient;
...
1; # End of Google::Cloud::Metastore::V1::DataprocMetastoreFederationClient

__END__

=head1 NAME

Google::Cloud::Metastore::V1::DataprocMetastoreFederationClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Metastore::V1::DataprocMetastoreFederationClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Metastore::V1::DataprocMetastoreFederationClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Metastore::V1::DataprocMetastoreFederationClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Metastore::V1::DataprocMetastoreFederationClient->new(
