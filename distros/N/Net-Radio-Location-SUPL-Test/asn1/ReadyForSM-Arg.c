...
static int asn_MAP_ReadyForSM_Arg_oms_1[] = { 2, 3, 4 };
static ber_tlv_tag_t asn_DEF_ReadyForSM_Arg_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ReadyForSM_Arg_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (5 << 2)), 2, 0, 0 }, /* alertReasonIndicator at 233 */
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 1, 0, 0 }, /* alertReason at 232 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, 0, 0 }, /* extensionContainer at 236 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* imsi at 231 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 4, 0, 0 } /* additionalAlertReasonIndicator at 238 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ReadyForSM_Arg_specs_1 = {
	...
	asn_MAP_ReadyForSM_Arg_oms_1,	/* Optional members */
	2, 1,	/* Root/Additions */
	3,	/* Start extensions */
	6	/* Stop extensions */
};
