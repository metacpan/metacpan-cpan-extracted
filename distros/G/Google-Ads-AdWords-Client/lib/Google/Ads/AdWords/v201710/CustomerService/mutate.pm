...
package Google::Ads::AdWords::v201710::CustomerService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'customer' => 'Google::Ads::AdWords::v201710::Customer',
    },
    {
...
Google::Ads::AdWords::v201710::CustomerService::mutate
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201710::CustomerService::mutate->new($data);

Constructor. The following data structure may be passed to new():

 {
   customer =>  $a_reference_to, # see Google::Ads::AdWords::v201710::Customer
 },
