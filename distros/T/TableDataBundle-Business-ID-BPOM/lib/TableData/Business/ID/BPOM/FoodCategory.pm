...
our %STATS = ("num_rows",1960,"num_columns",4); # STATS
...
This document describes version 20221027.0.0 of TableDataRole::Business::ID::BPOM::FoodCategory (from Perl distribution TableDataBundle-Business-ID-BPOM), released on 2022-10-27.
