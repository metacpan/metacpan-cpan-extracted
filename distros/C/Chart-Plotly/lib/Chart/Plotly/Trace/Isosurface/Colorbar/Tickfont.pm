package Chart::Plotly::Trace::Isosurface::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Isosurface::Colorbar::Tickfont - This attribute is one of the possible options for the trace isosurface.
