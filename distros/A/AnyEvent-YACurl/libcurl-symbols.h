...
#define CURL_AT_LEAST_VERSION_FIRST 0x072b00 /* Added in 7.43.0 */
#define CURL_BLOB_COPY_FIRST 0x074700 /* Added in 7.71.0 */
#define CURL_BLOB_NOCOPY_FIRST 0x074700 /* Added in 7.71.0 */
...
#define CURL_DEPRECATED_FIRST 0x075700 /* Added in 7.87.0 */
...
#define CURL_HAS_DECLSPEC_ATTRIBUTE_FIRST 0x080d00 /* Added in 8.13.0 */
...
#define CURL_HTTP_VERSION_3ONLY_FIRST 0x075800 /* Added in 7.88.0 */
...
#define CURL_IGNORE_DEPRECATION_FIRST 0x075700 /* Added in 7.87.0 */
...
#define CURL_ISOCPP_FIRST 0x070a02 /* Added in 7.10.2 */
#define CURL_ISOCPP_LAST 0x080e01 /* Last featured in 8.14.1 */
...
#define CURL_LOCK_DATA_HSTS_FIRST 0x075800 /* Added in 7.88.0 */
...
#define CURL_PULL_SYS_POLL_H_FIRST 0x073800 /* Added in 7.56.0 */
...
#define CURL_REDIR_POST_303_FIRST 0x071a00 /* Added in 7.26.0 */
...
#define CURL_VERSION_BITS_FIRST 0x072b00 /* Added in 7.43.0 */
...
#define CURL_VERSION_THREADSAFE_FIRST 0x075400 /* Added in 7.84.0 */
...
#define CURL_WIN32_LAST 0x080500 /* Last featured in 8.5.0 */
#define CURL_WRITEFUNC_ERROR_FIRST 0x075700 /* Added in 7.87.0 */
...
#define CURLE_TOO_LARGE_FIRST 0x080600 /* Added in 8.6.0 */
...
#define CURLE_UNRECOVERABLE_POLL_FIRST 0x075400 /* Added in 7.84.0 */
...
#define CURLE_ECH_REQUIRED_FIRST 0x080800 /* Added in 8.8.0 */
...
#define CURLFOLLOW_ALL_FIRST 0x080d00 /* Added in 8.13.0 */
#define CURLFOLLOW_OBEYCODE_FIRST 0x080d00 /* Added in 8.13.0 */
#define CURLFOLLOW_FIRSTONLY_FIRST 0x080d00 /* Added in 8.13.0 */
...
#define CURLFORM_CONTENTLEN_FIRST 0x072e00 /* Added in 7.46.0 */
...
#define CURLH_1XX_FIRST 0x075300 /* Added in 7.83.0 */
#define CURLH_CONNECT_FIRST 0x075300 /* Added in 7.83.0 */
#define CURLH_HEADER_FIRST 0x075300 /* Added in 7.83.0 */
#define CURLH_PSEUDO_FIRST 0x075300 /* Added in 7.83.0 */
#define CURLH_TRAILER_FIRST 0x075300 /* Added in 7.83.0 */
#define CURLHE_BAD_ARGUMENT_FIRST 0x075300 /* Added in 7.83.0 */
#define CURLHE_BADINDEX_FIRST 0x075300 /* Added in 7.83.0 */
#define CURLHE_MISSING_FIRST 0x075300 /* Added in 7.83.0 */
#define CURLHE_NOHEADERS_FIRST 0x075300 /* Added in 7.83.0 */
#define CURLHE_NOREQUEST_FIRST 0x075300 /* Added in 7.83.0 */
#define CURLHE_NOT_BUILT_IN_FIRST 0x075300 /* Added in 7.83.0 */
#define CURLHE_OK_FIRST 0x075300 /* Added in 7.83.0 */
#define CURLHE_OUT_OF_MEMORY_FIRST 0x075300 /* Added in 7.83.0 */
...
#define CURLINFO_CAINFO_FIRST 0x075400 /* Added in 7.84.0 */
#define CURLINFO_CAPATH_FIRST 0x075400 /* Added in 7.84.0 */
#define CURLINFO_CERTINFO_FIRST 0x071301 /* Added in 7.19.1 */
#define CURLINFO_CONDITION_UNMET_FIRST 0x071304 /* Added in 7.19.4 */
#define CURLINFO_CONN_ID_FIRST 0x080200 /* Added in 8.2.0 */
...
#define CURLINFO_EARLYDATA_SENT_T_FIRST 0x080b00 /* Added in 8.11.0 */
...
#define CURLINFO_HTTPAUTH_USED_FIRST 0x080c00 /* Added in 8.12.0 */
...
#define CURLINFO_POSTTRANSFER_TIME_T_FIRST 0x080a00 /* Added in 8.10.0 */
...
#define CURLINFO_PROXYAUTH_USED_FIRST 0x080c00 /* Added in 8.12.0 */
#define CURLINFO_PTR_FIRST 0x073601 /* Added in 7.54.1 */
#define CURLINFO_QUEUE_TIME_T_FIRST 0x080600 /* Added in 8.6.0 */
...
#define CURLINFO_USED_PROXY_FIRST 0x080700 /* Added in 8.7.0 */
#define CURLINFO_XFER_ID_FIRST 0x080200 /* Added in 8.2.0 */
...
#define CURLM_ADDED_ALREADY_FIRST 0x072100 /* Added in 7.33.0 */
...
#define CURLM_UNRECOVERABLE_POLL_FIRST 0x075400 /* Added in 7.84.0 */
...
#define CURLOPT_CA_CACHE_TIMEOUT_FIRST 0x075700 /* Added in 7.87.0 */
...
#define CURLOPT_ECH_FIRST 0x080800 /* Added in 8.8.0 */
...
#define CURLOPT_HAPROXY_CLIENT_IP_FIRST 0x080200 /* Added in 8.2.0 */
...
#define CURLOPT_MAIL_RCPT_ALLOWFAILS_FIRST 0x080200 /* Added in 8.2.0 */
#define CURLOPT_QUICK_EXIT_FIRST 0x075700 /* Added in 7.87.0 */
...
#define CURLOPT_PROTOCOLS_STR_FIRST 0x075500 /* Added in 7.85.0 */
...
#define CURLOPT_SERVER_RESPONSE_TIMEOUT_MS_FIRST 0x080600 /* Added in 8.6.0 */
...
#define CURLOPT_SSH_HOSTKEYDATA_FIRST 0x075400 /* Added in 7.84.0 */
#define CURLOPT_SSH_HOSTKEYFUNCTION_FIRST 0x075400 /* Added in 7.84.0 */
...
#define CURLOPT_SSL_SIGNATURE_ALGORITHMS_FIRST 0x080e00 /* Added in 8.14.0 */
...
#define CURLOPT_TCP_KEEPCNT_FIRST 0x080900 /* Added in 8.9.0 */
...
#define CURLOPT_UPLOAD_FLAGS_FIRST 0x080d00 /* Added in 8.13.0 */
...
#define CURLOPT_WS_OPTIONS_FIRST 0x075600 /* Added in 7.86.0 */
...
#define CURLOPTDEPRECATED_FIRST 0x075700 /* Added in 7.87.0 */
...
#define CURLOT_FLAG_ALIAS_FIRST 0x074900 /* Added in 7.73.0 */
...
#define CURLPROXY_HTTPS2_FIRST 0x080100 /* Added in 8.1.0 */
...
#define CURLSSLBACKEND_AWSLC_FIRST 0x080100 /* Added in 8.1.0 */
...
#define CURLSSLBACKEND_QSOSSL_LAST 0x072600 /* Last featured in 7.38.0 */
...
#define CURLSSLOPT_EARLYDATA_FIRST 0x080b00 /* Added in 8.11.0 */
...
#define CURLU_GET_EMPTY_FIRST 0x080800 /* Added in 8.8.0 */
...
#define CURLU_NO_GUESS_SCHEME_FIRST 0x080900 /* Added in 8.9.0 */
#define CURLU_NON_SUPPORT_SCHEME_FIRST 0x073e00 /* Added in 7.62.0 */
#define CURLU_PATH_AS_IS_FIRST 0x073e00 /* Added in 7.62.0 */
#define CURLU_PUNY2IDN_FIRST 0x080300 /* Added in 8.3.0 */
#define CURLU_PUNYCODE_FIRST 0x075800 /* Added in 7.88.0 */
...
#define CURLUE_TOO_LARGE_FIRST 0x080600 /* Added in 8.6.0 */
...
#define CURLULFLAG_ANSWERED_FIRST 0x080d00 /* Added in 8.13.0 */
#define CURLULFLAG_DELETED_FIRST 0x080d00 /* Added in 8.13.0 */
#define CURLULFLAG_DRAFT_FIRST 0x080d00 /* Added in 8.13.0 */
#define CURLULFLAG_FLAGGED_FIRST 0x080d00 /* Added in 8.13.0 */
#define CURLULFLAG_SEEN_FIRST 0x080d00 /* Added in 8.13.0 */
...
#define CURLVERSION_ELEVENTH_FIRST 0x075700 /* Added in 7.87.0 */
...
#define CURLVERSION_TWELFTH_FIRST 0x080800 /* Added in 8.8.0 */
#define CURLWARNING_FIRST 0x074200 /* Added in 7.66.0 */
#define CURLWS_BINARY_FIRST 0x075600 /* Added in 7.86.0 */
#define CURLWS_CLOSE_FIRST 0x075600 /* Added in 7.86.0 */
#define CURLWS_CONT_FIRST 0x075600 /* Added in 7.86.0 */
#define CURLWS_NOAUTOPONG_FIRST 0x080e00 /* Added in 8.14.0 */
#define CURLWS_OFFSET_FIRST 0x075600 /* Added in 7.86.0 */
#define CURLWS_PING_FIRST 0x075600 /* Added in 7.86.0 */
#define CURLWS_PONG_FIRST 0x075600 /* Added in 7.86.0 */
#define CURLWS_RAW_MODE_FIRST 0x075600 /* Added in 7.86.0 */
#define CURLWS_TEXT_FIRST 0x075600 /* Added in 7.86.0 */
