...
Sah::SchemaR::date::month_nums - Array of required month numbers (1-12, with coercions), e.g. [6,12]

=head1 VERSION

This document describes version 0.019 of Sah::SchemaR::date::month_nums (from Perl distribution Sah-Schemas-Date), released on 2023-12-09.
