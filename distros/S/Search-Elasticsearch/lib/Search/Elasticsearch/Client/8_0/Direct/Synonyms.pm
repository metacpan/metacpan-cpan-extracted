...
$Search::Elasticsearch::Client::8_0::Direct::Synonyms::VERSION = '8.12';
use Moo;
...
Search::Elasticsearch::Client::8_0::Direct::Synonyms - The synonyms management API provides a convenient way
