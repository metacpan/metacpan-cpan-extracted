#
# Test case for WebService::Recruit::Shingaku::Subject
#
...
my $service = new WebService::Recruit::Shingaku::Subject();

ok( ref $service, 'new WebService::Recruit::Shingaku::Subject()' );
...
# Test[0]
{
    ...
    my $res = new WebService::Recruit::Shingaku::Subject();
    ...
    can_ok( $data, 'subject' );
    ok( eval { $data->subject }, 'Test[0]: subject' );
    ok( eval { ref $data->subject } eq 'ARRAY', 'Test[0]: subject' );
    can_ok( $data->subject->[0], 'code' );
    ok( eval { $data->subject->[0]->code }, 'Test[0]: code' );
    can_ok( $data->subject->[0], 'name' );
    ok( eval { $data->subject->[0]->name }, 'Test[0]: name' );
    can_ok( $data->subject->[0], 'desc' );
    ok( eval { $data->subject->[0]->desc }, 'Test[0]: desc' );
    can_ok( $data->subject->[0], 'license' );
    ok( eval { $data->subject->[0]->license }, 'Test[0]: license' );
    ok( eval { ref $data->subject->[0]->license } eq 'ARRAY', 'Test[0]: license' );
    can_ok( $data->subject->[0], 'work' );
    ok( eval { $data->subject->[0]->work }, 'Test[0]: work' );
    ok( eval { ref $data->subject->[0]->work } eq 'ARRAY', 'Test[0]: work' );
    can_ok( $data->subject->[0], 'urls' );
    ok( eval { $data->subject->[0]->urls }, 'Test[0]: urls' );
    can_ok( $data->subject->[0]->license->[0], 'code' );
    ok( eval { $data->subject->[0]->license->[0]->code }, 'Test[0]: code' );
    can_ok( $data->subject->[0]->license->[0], 'name' );
    ok( eval { $data->subject->[0]->license->[0]->name }, 'Test[0]: name' );
    can_ok( $data->subject->[0]->work->[0], 'code' );
    ok( eval { $data->subject->[0]->work->[0]->code }, 'Test[0]: code' );
    can_ok( $data->subject->[0]->work->[0], 'name' );
    ok( eval { $data->subject->[0]->work->[0]->name }, 'Test[0]: name' );
    can_ok( $data->subject->[0]->urls, 'mobile' );
    ok( eval { $data->subject->[0]->urls->mobile }, 'Test[0]: mobile' );
    can_ok( $data->subject->[0]->urls, 'pc' );
    ok( eval { $data->subject->[0]->urls->pc }, 'Test[0]: pc' );
    can_ok( $data->subject->[0]->urls, 'qr' );
    ok( eval { $data->subject->[0]->urls->qr }, 'Test[0]: qr' );
}
