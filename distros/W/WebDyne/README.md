...
Install the WebDyne module from CPAN using cpanminus \(cpanm) or cpan, and install Plack for the PSGI version.
...
Create an app.psp file in the appropriate web server home directory. Don&#39;t be put off by the shortcut &lt;start_html&gt; tag, you can still use traditional tags if you like.
...
See the documentation at  [https://webdyne.org](https://webdyne.org)  for more examples and information.