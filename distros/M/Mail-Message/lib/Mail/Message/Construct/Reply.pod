...
=item Message-ID => $field|$line

Supply a C<$field> or C<$line> as specific message-id for the reply.
By default, one is generated for you.  If there are no angles around
your id, they will be added.

=item Subject => $field|$line|CODE

Force the subject line to the specific C<$field> or C<$line>, or the result of
