...
is_deeply([$locale->get_digits], [0 .. 9], 'Get digits cs_CZ');
...
# RBNF
is($locale->format_number(0, 'spellout-numbering-year'), 'nula', 'RBNF: Spell out year 0');
is($locale->format_number('-0.0', 'spellout-numbering'), 'minus nula čárka nula', 'RBNF: Spell out -0.0');
