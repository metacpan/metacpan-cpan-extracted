...
=head2 Formats for interpolation and translation
...
=head3 Format with String::Print

This L<Log::Report|Log::Report> module uses L<String::Print|String::Print> to handle formatted strings.
On object of that module is hidden in the logic of L<__x()|Log::Report/"Messages (optionally translatable)"> and friends.
