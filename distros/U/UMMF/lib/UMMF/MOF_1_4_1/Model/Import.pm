...
package UMMF::MOF_1_4_1::Model::Import;
...
=head2 C<isClustered> : UMMF::MOF_1_4_1::Model::Boolean 
...
=head2 C<importer> : I<THIS> C<0..*> E<lt>---E<gt>  C<imported> : UMMF::MOF_1_4_1::Model::Namespace C<1>
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_4_1::Model::Import->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_4_1::Model::Import|UMMF::MOF_1_4_1::Model::Import>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_4_1::Model::Import')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_4_1::Model::Import->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_4_1::Model::Import->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_4_1::Model::Import' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_4_1::Model::Import|UMMF::MOF_1_4_1::Model::Import>.
...
sub ___initialize
{
  ...
  #  importer 0..*
  #  <--> 
  #  imported 1 UMMF::MOF_1_4_1::Model::Namespace.
...
sub __initialize
{
  ...
  $self->UMMF::MOF_1_4_1::Model::Import::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_4_1::Model::Import::___create(@args);
...
sub set_visibility ($$)
{
  ...
  if ( defined $val ) {
    $self->__use('UMMF::MOF_1_4_1::Model::VisibilityKind')->__typecheck($val, "UMMF::MOF_1_4_1::Model::Import.visibility");
  }
...
Returns the L<UMMF::MOF_1_4_1::Model::Boolean|UMMF::MOF_1_4_1::Model::Boolean> value of Attribute C<isClustered>.
...
Returns the AssociationEnd C<imported> value of type L<UMMF::MOF_1_4_1::Model::Namespace|UMMF::MOF_1_4_1::Model::Namespace>.
...
sub set_imported ($$)
{
  ...
  if ( ($old = $self->{'imported'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::MOF_1_4_1::Model::Namespace')->__typecheck($val, "UMMF::MOF_1_4_1::Model::Import.imported") }
...
sub add_imported ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'imported'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::MOF_1_4_1::Model::Namespace')->__typecheck($val, "UMMF::MOF_1_4_1::Model::Import.imported");
      
    # confess("UMMF::MOF_1_4_1::Model::Import::imported: too many")
    # if defined $self->{'imported'};
...
Clears the AssociationEnd C<imported> links to L<UMMF::MOF_1_4_1::Model::Namespace|UMMF::MOF_1_4_1::Model::Namespace>.
Returns C<$obj>.
...
Returns the number of elements of type L<UMMF::MOF_1_4_1::Model::Namespace|UMMF::MOF_1_4_1::Model::Namespace> associated with C<imported>.
