package Bencher::Scenarios::ArgPassing;

our $DATE = '2017-01-25'; # DATE
our $VERSION = '0.003'; # VERSION

1;
# ABSTRACT: Scenarios related to argument passing
...
Bencher::Scenarios::ArgPassing - Scenarios related to argument passing

=head1 VERSION

This document describes version 0.003 of Bencher::Scenarios::ArgPassing (from Perl distribution Bencher-Scenarios-ArgPassing), released on 2017-01-25.
...
=item * L<Bencher::Scenario::ArgPassing::Mixed>

=item * L<Bencher::Scenario::ArgPassing::NamedVsPos>
