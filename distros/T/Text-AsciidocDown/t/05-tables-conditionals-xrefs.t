...
is(conv("|===\n|A |B\n|1 |2\n|===\n"), "| A | B |\n| --- | --- |\n| 1 | 2 |", 'implicit header table conversion');

is(conv("[%header,cols=2*]\n|===\n|H1\n|H2\n|R1\n|R2\n|===\n"),
   "| H1 | H2 |\n| --- | --- |\n| R1 | R2 |",
...
is(conv("ifdef::show[Visible]\nifndef::show[Hidden]\n"), 'Hidden', 'single-line conditionals evaluated');

is(conv(":show:\nifdef::show[]\nA\nifndef::show[]\nB\nendif::[]\nendif::[]\n"), 'A', 'nested block conditionals evaluated');

is(conv("\\ifdef::flag[]\n"), 'ifdef::flag[]', 'escaped conditional directive preserved');

is(conv("= T\n\ninclude::chap.adoc[]\n\n== S\n"), "# T\n\n## S", 'include directive dropped by default');
