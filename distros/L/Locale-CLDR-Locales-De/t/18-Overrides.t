...
is_deeply ($am_pm, { am => 'AM', pm => 'PM', midnight => 'Mitternacht', morning1 => 'morgens', morning2 => 'vorm.', afternoon1 => 'mittags', afternoon2 => 'nachm.', evening1 => 'abends', night1 => 'nachts' }, 'Islamic AM PM format abbreviated');
$am_pm = $locale->am_pm_format_narrow();
is_deeply ($am_pm, { am => 'AM', pm => 'PM', midnight => 'Mitternacht', morning1 => 'morgens', morning2 => 'vorm.', afternoon1 => 'mittags', afternoon2 => 'nachm.', evening1 => 'abends', night1 => 'nachts' }, 'Islamic AM PM format narrow');
...
is_deeply ($am_pm, { am => 'AM', pm => 'PM', midnight => 'Mitternacht', morning1 => 'Morgen', morning2 => 'Vorm.', afternoon1 => 'Mittag', afternoon2 => 'Nachm.', evening1 => 'Abend', night1 => 'Nacht' }, 'Islamic AM PM stand alone abbreviated');
$am_pm = $locale->am_pm_stand_alone_narrow();
is_deeply ($am_pm, { am => 'AM', pm => 'PM', midnight => 'Mitternacht', morning1 => 'Morgen', morning2 => 'Vorm.', afternoon1 => 'Mittag', afternoon2 => 'Nachm.', evening1 => 'Abend', night1 => 'Nacht' }, 'Islamic AM PM stand alone narrow');
...
is($date_time_format, "EEEE, d. MMMM y, HH:mm:ss zzzz", 'Islamic Date Time Format Full');
