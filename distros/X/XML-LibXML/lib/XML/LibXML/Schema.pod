...
=head1 SYNOPSIS
  ...
  $xmlschema = XML::LibXML::Schema-E<gt>new( location =E<gt> $filename_or_url );
  $xmlschema = XML::LibXML::Schema-E<gt>new( string =E<gt> $xmlschemastring );
  eval { $xmlschema-E<gt>validate( $doc ); };
