package Chart::Plotly::Trace::Scattergl::Unselected::Marker;
use Moose;
...
Chart::Plotly::Trace::Scattergl::Unselected::Marker - This attribute is one of the possible options for the trace scattergl.
