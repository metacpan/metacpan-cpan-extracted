...
This document describes version 0.022 of Sah::Schema::unix::pid (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.

=head1 SAH SCHEMA DEFINITION

 ["posint", {}]

Base schema: L<posint|Sah::Schema::posint>
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"unix::pid*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('unix::pid*', name=>'UnixPid')
     );
 }

 use My::Types qw(UnixPid);
 UnixPid->assert_valid($data);
