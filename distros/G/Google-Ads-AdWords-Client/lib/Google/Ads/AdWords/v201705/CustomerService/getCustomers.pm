...
package Google::Ads::AdWords::v201705::CustomerService::getCustomers;
use strict;
use warnings;
...
getCustomers from the namespace https://adwords.google.com/api/adwords/mcm/v201705.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::CustomerService::getCustomers->new($data);
