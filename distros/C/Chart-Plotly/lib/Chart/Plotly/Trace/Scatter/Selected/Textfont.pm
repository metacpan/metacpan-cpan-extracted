package Chart::Plotly::Trace::Scatter::Selected::Textfont;
use Moose;
...
Chart::Plotly::Trace::Scatter::Selected::Textfont - This attribute is one of the possible options for the trace scatter.
