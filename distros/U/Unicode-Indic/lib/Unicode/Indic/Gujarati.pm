...
=head1	NAME
	...
	Unicode::Indic::Gujarati -Perl module for the Gujarati language.

=head1	SYNOPSIS

	use Unicode::Indic::Gujarati;

=head1	DESCRIPTION

	This perl module is used for transliteration of text from qwerty keyboard characters to Unicode Gujarati font characters and versa.
