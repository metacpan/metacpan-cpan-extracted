# This Makefile is for the Net::Enum::DNSServer extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Net/Enum/DNSServer.pm]
#     AUTHOR => [q[Stefan Certic <support@certic.info>]]
#     BUILD_REQUIRES => { Test::More=>q[0] }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[0] }
#     LICENSE => q[artistic_2]
#     MIN_PERL_VERSION => q[5.006]
#     NAME => q[Net::Enum::DNSServer]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Net/Enum/DNSServer.pm]
#     clean => { FILES=>q[Net-Enum-DNSServer-*] }
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Net::Enum::DNSServer
NAME_SYM = Net_Enum_DNSServer
VERSION = 0.01
...
MAKE = make
FULLEXT = Net/Enum/DNSServer
BASEEXT = DNSServer
PARENT_NAME = Net::Enum
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Net/Enum/DNSServer.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Net/Enum/DNS.pm \
	lib/Net/Enum/DNSServer.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIBDEP)$(DFSEP)Config.pm $(PERL_INCDEP)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Net/Enum
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Net/Enum
...
TO_INST_PM = lib/Net/Enum/DNS.pm \
	lib/Net/Enum/DNSServer.pm

PM_TO_BLIB = lib/Net/Enum/DNS.pm \
	blib/lib/Net/Enum/DNS.pm \
	lib/Net/Enum/DNSServer.pm \
	blib/lib/Net/Enum/DNSServer.pm
...
DISTNAME = Net-Enum-DNSServer
DISTVNAME = Net-Enum-DNSServer-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  lib/Net/Enum/DNS.pm $(INST_MAN3DIR)/Net::Enum::DNS.$(MAN3EXT) \
	  lib/Net/Enum/DNSServer.pm $(INST_MAN3DIR)/Net::Enum::DNSServer.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''The great new Net::Enum::DNSServer!'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Stefan Certic <support@certic.info>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Net-Enum-DNSServer' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "The great new Net::Enum::DNSServer!",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Stefan Certic <support@certic.info>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Net-Enum-DNSServer",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new Net::Enum::DNSServer!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Stefan Certic &lt;support@certic.info&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Net/Enum/DNS.pm blib/lib/Net/Enum/DNS.pm \
	  lib/Net/Enum/DNSServer.pm blib/lib/Net/Enum/DNSServer.pm 
