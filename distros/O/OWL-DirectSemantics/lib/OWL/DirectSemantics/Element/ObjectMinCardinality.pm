package OWL::DirectSemantics::Element::ObjectMinCardinality;
...
OWL::DirectSemantics::Element::ObjectMinCardinality - represents an OWL ObjectMinCardinality

=head1 DESCRIPTION

This class represents the ObjectMinCardinality element in OWL Direct Semantics.
