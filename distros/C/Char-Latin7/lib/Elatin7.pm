...
######################################################################
#
# Elatin7 - Run-time routines for Latin7.pm
#
# http://search.cpan.org/dist/Char-Latin7/
#
...
sub import {
    ...
    *Char::ord           = \&Latin7::ord;
    *Char::ord_          = \&Latin7::ord_;
    *Char::reverse       = \&Latin7::reverse;
    *Char::getc          = \&Latin7::getc;
    *Char::length        = \&Latin7::length;
    *Char::substr        = \&Latin7::substr;
    *Char::index         = \&Latin7::index;
    *Char::rindex        = \&Latin7::rindex;
    *Char::eval          = \&Latin7::eval;
    *Char::escape        = \&Latin7::escape;
    *Char::escape_token  = \&Latin7::escape_token;
    *Char::escape_script = \&Latin7::escape_script;
}
...
sub Elatin7::rindex($$;$);
sub Elatin7::lcfirst(@);
sub Elatin7::lcfirst_();
sub Elatin7::lc(@);
sub Elatin7::lc_();
sub Elatin7::ucfirst(@);
sub Elatin7::ucfirst_();
sub Elatin7::uc(@);
sub Elatin7::uc_();
sub Elatin7::fc(@);
sub Elatin7::fc_();
sub Elatin7::ignorecase;
sub Elatin7::classic_character_class;
sub Elatin7::capture;
sub Elatin7::chr(;$);
sub Elatin7::chr_();
sub Elatin7::glob($);
...
# ${Elatin7::eS}          = qr{(?>[^\x09\x0A    \x0C\x0D\x20])};
# ${Elatin7::eS}          = qr{(?>[^\x09\x0A\x0B\x0C\x0D\x20])};
${Elatin7::eS}            = qr{(?>[^\s])};
...
# avoid: Name "Elatin7::foo" used only once: possible typo at here.
${Elatin7::dot}         = ${Elatin7::dot};
${Elatin7::dot_s}       = ${Elatin7::dot_s};
${Elatin7::eD}          = ${Elatin7::eD};
${Elatin7::eS}          = ${Elatin7::eS};
${Elatin7::eW}          = ${Elatin7::eW};
${Elatin7::eH}          = ${Elatin7::eH};
${Elatin7::eV}          = ${Elatin7::eV};
${Elatin7::eR}          = ${Elatin7::eR};
${Elatin7::eN}          = ${Elatin7::eN};
${Elatin7::not_alnum}   = ${Elatin7::not_alnum};
${Elatin7::not_alpha}   = ${Elatin7::not_alpha};
${Elatin7::not_ascii}   = ${Elatin7::not_ascii};
${Elatin7::not_blank}   = ${Elatin7::not_blank};
${Elatin7::not_cntrl}   = ${Elatin7::not_cntrl};
${Elatin7::not_digit}   = ${Elatin7::not_digit};
${Elatin7::not_graph}   = ${Elatin7::not_graph};
${Elatin7::not_lower}   = ${Elatin7::not_lower};
${Elatin7::not_lower_i} = ${Elatin7::not_lower_i};
${Elatin7::not_print}   = ${Elatin7::not_print};
${Elatin7::not_punct}   = ${Elatin7::not_punct};
${Elatin7::not_space}   = ${Elatin7::not_space};
${Elatin7::not_upper}   = ${Elatin7::not_upper};
${Elatin7::not_upper_i} = ${Elatin7::not_upper_i};
${Elatin7::not_word}    = ${Elatin7::not_word};
${Elatin7::not_xdigit}  = ${Elatin7::not_xdigit};
${Elatin7::eb}          = ${Elatin7::eb};
${Elatin7::eB}          = ${Elatin7::eB};
...
#
# Latin-7 lower case first with parameter
#
sub Elatin7::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Elatin7::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Elatin7::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Elatin7::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Latin-7 lower case first without parameter
#
sub Elatin7::lcfirst_() {
    return Elatin7::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Latin-7 lower case with parameter
#
sub Elatin7::lc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-7 lower case without parameter
#
sub Elatin7::lc_() {
    my $s = $_;
    return join '', map {defined($lc{$_}) ? $lc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-7 upper case first with parameter
#
sub Elatin7::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Elatin7::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Elatin7::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Elatin7::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Latin-7 upper case first without parameter
#
sub Elatin7::ucfirst_() {
    return Elatin7::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Latin-7 upper case with parameter
#
sub Elatin7::uc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-7 upper case without parameter
#
sub Elatin7::uc_() {
    my $s = $_;
    return join '', map {defined($uc{$_}) ? $uc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-7 fold case with parameter
#
sub Elatin7::fc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-7 fold case without parameter
#
sub Elatin7::fc_() {
    my $s = $_;
    return join '', map {defined($fc{$_}) ? $fc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-7 regexp ignore case modifier
#
sub Elatin7::ignorecase {
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Elatin7::uc($char[$i]);
                my $fc = Elatin7::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
#
# prepare Latin-7 characters per length
#
...
#
# Latin-7 open character list for qr and not qr
#
sub _charlist {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Elatin7::not_lower_i}',
                '[:^upper:]'  => '${Elatin7::not_upper_i}',
...
#
# Latin-7 hexadecimal escape sequence
#
sub hexchr {
    my($hexdigit) = @_;
...
#
# Latin-7 open character list for qr
#
sub charlist_qr {
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Elatin7::uc($char);
                        my $fc = Elatin7::fc($char);
                        if ($uc eq $fc) {
...
#
# Latin-7 open character list for not qr
#
sub charlist_not_qr {
...
#
# Latin-7 order to character (with parameter)
#
sub Elatin7::chr(;$) {
...
#
# Latin-7 order to character (without parameter)
#
sub Elatin7::chr_() {
...
#
# Latin-7 path globbing (with parameter)
#
sub Elatin7::glob($) {
...
#
# Latin-7 path globbing (without parameter)
#
sub Elatin7::glob_() {
...
#
# Latin-7 path globbing via File::DosGlob 1.10
#
...
#
# Latin-7 path globbing subroutine
#
sub _do_glob {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Elatin7::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Elatin7::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Elatin7::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Elatin7::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
#
sub Elatin7::POSTMATCH {
    return $';
}

#
# Latin-7 character to order (with parameter)
#
sub Latin7::ord(;$) {
...
#
# Latin-7 character to order (without parameter)
#
sub Latin7::ord_() {
...
#
# Latin-7 getc (with parameter, without parameter)
#
sub Latin7::getc(;*@) {

    my($package) = caller;
    my $fh = @_ ? qualify_to_ref(shift,$package) : \*STDIN;
    croak 'Too many arguments for Latin7::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Elatin7::dot_s} \z/oxms) {
...
#
# Latin-7 index by character
#
sub Latin7::index($$;$) {

    my $index;
    if (@_ == 3) {
        $index = Elatin7::index($_[0], $_[1], CORE::length(Latin7::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Elatin7::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Latin7::length(CORE::substr $_[0], 0, $index);
    }
}

#
# Latin-7 rindex by character
#
sub Latin7::rindex($$;$) {

    my $rindex;
    if (@_ == 3) {
        $rindex = Elatin7::rindex($_[0], $_[1], CORE::length(Latin7::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Elatin7::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Latin7::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
# ord() to ord() or Latin7::ord()
my $function_ord = 'ord';

# ord to ord or Latin7::ord_
my $function_ord_ = 'ord';

# reverse to reverse or Latin7::reverse
my $function_reverse = 'reverse';

# getc to getc or Latin7::getc
...
my $qq_substr  = qr{(?> Char::substr | Latin7::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
#
# escape Latin-7 token of script
#
sub Latin7::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Elatin7::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ (?>\s*) PREMATCH  \b | \$ (?>\s*) \{ (?>\s*) PREMATCH  (?>\s*) \} | \$ (?>\s*) \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin7::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Elatin7::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin7::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Elatin7::POSTMATCH()
    elsif (/\G (                 \$ (?>\s*) POSTMATCH \b | \$ (?>\s*) \{ (?>\s*) POSTMATCH (?>\s*) \} | \$ (?>\s*) \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin7::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Elatin7::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob (?>\s*) \) /oxgc) {
        return 'while ($_ = Elatin7::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob \b /oxgc) {
        return 'while ($_ = Elatin7::glob';
    }
...
# subroutines of package Elatin7
    elsif (/\G \b (CORE:: | ->(>?\s*) (?: atan2 | [a-z]{2,})) \b       /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Latin7::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Char::escape'; }
    elsif (/\G \b Latin7::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Latin7::escape'; }
    elsif (/\G \b bytes::substr \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin7::chop';       }
    elsif (/\G \b bytes::index \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::index';       }
    elsif (/\G \b Latin7::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Latin7::index';       }
    elsif (/\G \b index \b         (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin7::index';      }
    elsif (/\G \b bytes::rindex \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::rindex';      }
    elsif (/\G \b Latin7::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Latin7::rindex';      }
    elsif (/\G \b rindex \b        (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin7::rindex';     }
    elsif (/\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin7::lc';         }
    elsif (/\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin7::lcfirst';    }
    elsif (/\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin7::uc';         }
    elsif (/\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin7::ucfirst';    }
    elsif (/\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin7::fc';         }
    ...
    elsif (/\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin7::chr';               }
    elsif (/\G \b bytes::ord    (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin7::glob';              }
    elsif (/\G \b lc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin7::lc_';               }
    elsif (/\G \b lcfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin7::lcfirst_';          }
    elsif (/\G \b uc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin7::uc_';               }
    elsif (/\G \b ucfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin7::ucfirst_';          }
    elsif (/\G \b fc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin7::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin7::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin7::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Elatin7::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Elatin7::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq           (\#) [ ] (\#) /oxgc) { return 'Elatin7::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Elatin7::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Elatin7::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Elatin7::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Elatin7::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Elatin7::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q            (\#) [ ] (\#) /oxgc) { return 'Elatin7::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Elatin7::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Elatin7::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Elatin7::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Elatin7::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Elatin7::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                    ' [ ] '    /oxgc) { return 'Elatin7::split' . $e . qq     {' '};  }
        elsif (/\G                    " [ ] "    /oxgc) { return 'Elatin7::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Elatin7::PREMATCH()]}
            ...
            $e_string .= q{Elatin7::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Elatin7::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Elatin7::MATCH()};
            $slash = 'div';
        }
...
# subroutines of package Elatin7
        ...
        elsif ($string =~ /\G \b Latin7::eval       (?= (?>\s*) \{ )                    /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::eval \b                                        /oxgc) { $e_string .= 'eval Char::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b Latin7::eval \b                                        /oxgc) { $e_string .= 'eval Latin7::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                                     /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                              /oxgc) { $e_string .= 'Elatin7::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                                      /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::index \b                                       /oxgc) { $e_string .= 'Char::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b Latin7::index \b                                       /oxgc) { $e_string .= 'Latin7::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                             /oxgc) { $e_string .= 'Elatin7::index';      $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b Latin7::rindex \b                                      /oxgc) { $e_string .= 'Latin7::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                            /oxgc) { $e_string .= 'Elatin7::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin7::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin7::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin7::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin7::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin7::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin7::chr';           $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin7::glob';          $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                                      /oxgc) { $e_string .= 'Elatin7::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                                 /oxgc) { $e_string .= 'Elatin7::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                                      /oxgc) { $e_string .= 'Elatin7::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                                 /oxgc) { $e_string .= 'Elatin7::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                                      /oxgc) { $e_string .= 'Elatin7::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                                     /oxgc) { $e_string .= 'Elatin7::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                              /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                                     /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                                    /oxgc) { $e_string .= 'Elatin7::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Elatin7::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Elatin7::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq           (\#) [ ] (\#) /oxgc) { $e_string .= 'Elatin7::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { $e_string .= 'Elatin7::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { $e_string .= 'Elatin7::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { $e_string .= 'Elatin7::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { $e_string .= 'Elatin7::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { $e_string .= 'Elatin7::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q            (\#) [ ] (\#) /oxgc) { $e_string .= 'Elatin7::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { $e_string .= 'Elatin7::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { $e_string .= 'Elatin7::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { $e_string .= 'Elatin7::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { $e_string .= 'Elatin7::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { $e_string .= 'Elatin7::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                    ' [ ] '    /oxgc) { $e_string .= 'Elatin7::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                    " [ ] "    /oxgc) { $e_string .= 'Elatin7::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        ...
        return Elatin7::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Elatin7::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Elatin7::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Elatin7::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Elatin7::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Elatin7::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Elatin7::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Elatin7::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Elatin7::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Elatin7::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Elatin7::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Elatin7::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Elatin7::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Elatin7::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Elatin7::uc($char[$i]) ne Elatin7::fc($char[$i]))) {
            if (CORE::length(Elatin7::fc($char[$i])) == 1) {
                $char[$i] = '['   . Elatin7::uc($char[$i])       . Elatin7::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Elatin7::uc($char[$i]) . '|' . Elatin7::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin7::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ (?>\s*) 0 (?>\s*) \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Elatin7::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin7::ignorecase(Elatin7::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin7::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Elatin7::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin7::ignorecase(Elatin7::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin7::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Elatin7::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin7::ignorecase(Elatin7::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin7::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Elatin7::re_t=%s; while($Elatin7::re_t =~ %s){%s local $^W=0; local $Elatin7::re_r=%s; %s$Elatin7::re_t="$`$Elatin7::re_r$'"; pos($Elatin7::re_t)=length "$`$Elatin7::re_r"; } return $Elatin7::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Elatin7::re_r=CORE::eval $Elatin7::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Elatin7::re_r=%s; %s"%s$Elatin7::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Elatin7::re_n=0; while(%s =~ %s){%s local $^W=0; local $Elatin7::re_r=%s; %s%s="$`$Elatin7::re_r$'"; pos(%s)=length "$`$Elatin7::re_r"; $Elatin7::re_n++} return %s$Elatin7::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Elatin7::re_r=%s; %s%s="%s$Elatin7::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Elatin7::re_r=%s; %s%s="%s$Elatin7::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Elatin7::re_r=CORE::eval $Elatin7::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Elatin7::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Elatin7::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  # "no Elatin7;" not supported

=head1 ABSTRACT

This module has run-time routines for use Latin7 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Latin7 software and not
...
This Elatin7 module first appeared in ActivePerl Build 522 Built under
...
=item * Split string
  ...
  @split = Elatin7::split(/pattern/,$string,$limit);
  @split = Elatin7::split(/pattern/,$string);
  @split = Elatin7::split(/pattern/);
  @split = Elatin7::split('',$string,$limit);
  @split = Elatin7::split('',$string);
  @split = Elatin7::split('');
  @split = Elatin7::split();
  @split = Elatin7::split;
  ...
  at all, Elatin7::split returns the original string as a single substring, If it
  ...
  @chars  = Elatin7::split(//,  $word);
  @fields = Elatin7::split(/:/, $line);
  @words  = Elatin7::split(" ", $paragraph);
  @lines  = Elatin7::split(/^/, $buffer);
  ...
  print join(":" => Elatin7::split(/ */, "hi there"));
  ...
  Elatin7::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Elatin7::split(/:/, $_, 3);
  ...
  splits on whitespace just as Elatin7::split with no arguments does. Thus,
  Elatin7::split(" ") can be used to emulate awk's default behavior. In contrast,
  Elatin7::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Elatin7::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Elatin7::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Elatin7::split()) {
          $count{$word}++;
      }
  }

  The inverse of Elatin7::split is join, except that join can only join with the
...
=item * Transliteration
  ...
  $tr = Elatin7::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Elatin7::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  This subroutine scans a Latin-7 string character by character and replaces all
  occurrences of the characters found in $searchlist with the corresponding character
  in $replacementlist. It returns the number of characters replaced or deleted.
  If no Latin-7 string is specified via =~ operator, the $_ variable is translated.
  $modifier are:
  ...
  print Elatin7::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item * Chop string

  $chop = Elatin7::chop(@list);
  $chop = Elatin7::chop();
  $chop = Elatin7::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Elatin7::chop subroutine is used primary to remove the newline
  ...
  since Elatin7::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Elatin7::chop a literal, only a variable. If you Elatin7::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Elatin7::chop(@lines);

  You can Elatin7::chop anything that is an lvalue, including an assignment:

  Elatin7::chop($cwd = `pwd`);
  Elatin7::chop($answer = <STDIN>);

  This is different from:

  $answer = Elatin7::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Elatin7::chop returns the character
  ...
  In the most general case, Elatin7::chop can be expressed using substr:

  $last_code = Elatin7::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Elatin7::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Elatin7::chop;
...
=item * Index string
  ...
  $byte_pos = Elatin7::index($string,$substr,$byte_offset);
  $byte_pos = Elatin7::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Elatin7::index($string, $lookfor, $byte_pos)) > -1) {
...
=item * Reverse index string
  ...
  $byte_pos = Elatin7::rindex($string,$substr,$byte_offset);
  $byte_pos = Elatin7::rindex($string,$substr);

  This subroutine works just like Elatin7::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Elatin7::index).
  ...
  while (($byte_pos = Latin7::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item * Lower case string
  ...
  $lc = Elatin7::lc($string);
  $lc = Elatin7::lc_;

  This subroutine returns a lowercased version of Latin-7 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Elatin7::fc subroutine for case-insensitive comparisons via Latin7
  software.

=item * Lower case first character of string

  $lcfirst = Elatin7::lcfirst($string);
  $lcfirst = Elatin7::lcfirst_;

  This subroutine returns a version of Latin-7 $string with the first character
  lowercased (or $_, if $string is omitted). This is the internal subroutine
  implementing the \l escape in double-quoted strings.

=item * Upper case string

  $uc = Elatin7::uc($string);
  $uc = Elatin7::uc_;

  This subroutine returns an uppercased version of Latin-7 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Elatin7::ucfirst instead.
...
=item * Upper case first character of string
  ...
  $ucfirst = Elatin7::ucfirst($string);
  $ucfirst = Elatin7::ucfirst_;
  ...
  $titlecase = Elatin7::ucfirst(substr($word,0,1)) . Elatin7::lc(substr($word,1));
  ...
  $do_not_use = Elatin7::ucfirst(Elatin7::lc($word));
...
=item * Fold case string
  ...
  $fc = Elatin7::fc($string);
  $fc = Elatin7::fc_;

  New to Latin7 software, this subroutine returns the full Unicode-like casefold of
  Latin-7 $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Elatin7::fc($a) eq Elatin7::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Latin7 software has always used casefolding semantics for
...
=item * Make ignore case string
  ...
  @ignorecase = Elatin7::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item * Make capture number

  $capturenumber = Elatin7::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item * Make character

  $chr = Elatin7::chr($code);
  $chr = Elatin7::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Elatin7::chr(65) is "A" in either
  ASCII or Latin-7, not Unicode. For the reverse of Elatin7::chr, use Latin7::ord.

=item * Filename expansion (globbing)

  @glob = Elatin7::glob($string);
  @glob = Elatin7::glob_;
  ...
  The Elatin7::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Elatin7::glob('"*e f*"');
  @spacies = Elatin7::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Elatin7::glob("'*${var}e f*'");
  @spacies = Elatin7::glob(qq("*${var}e f*"));
