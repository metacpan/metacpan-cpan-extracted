package Finance::AMEX::Transaction::EPTRN::Detail::Other;
$Finance::AMEX::Transaction::EPTRN::Detail::Other::VERSION = '0.003';
use strict;
use warnings;
...
Finance::AMEX::Transaction::EPTRN::Detail::Other - Parse AMEX Transaction/Invoice Level Reconciliation (EPTRN) Other Fees and Revenues Detail Rows
...
Returns a new L<Finance::AMEX::Transaction::EPTRN::Detail::Other> object.

 my $record = Finance::AMEX::Transaction::EPTRN::Detail::Other->new(line => $line);
...
Finance::AMEX::Transaction::EPTRN::Detail::Other - Object methods for AMEX Reconciliation file chargback detail records.
