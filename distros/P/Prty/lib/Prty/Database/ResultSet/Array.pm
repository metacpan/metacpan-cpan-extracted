package Prty::Database::ResultSet::Array;
use base qw/Prty::Database::ResultSet/;
...
Prty::Database::ResultSet::Array - Liste von Datensätzen in Array-Repräsentation

=head1 BASE CLASS

L<Prty::Database::ResultSet>
...
Liefere den Namen der Default-Rowklasse: 'Prty::Database::Row::Array'
...
sub defaultRowClass {
    return 'Prty::Database::Row::Array';
}
