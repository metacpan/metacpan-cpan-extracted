package Google::Ads::AdWords::v201809::CertificateDomainMismatchInCountryConstraint;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201809::CountryConstraint);
# Variety: sequence
...
Google::Ads::AdWords::v201809::CertificateDomainMismatchInCountryConstraint

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CertificateDomainMismatchInCountryConstraint from the namespace https://adwords.google.com/api/adwords/cm/v201809.
