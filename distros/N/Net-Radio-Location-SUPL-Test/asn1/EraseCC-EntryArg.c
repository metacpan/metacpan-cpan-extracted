...
static int asn_MAP_EraseCC_EntryArg_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_EraseCC_EntryArg_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_EraseCC_EntryArg_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ss-Code at 322 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ccbs-Index at 323 */
};
static asn_SEQUENCE_specifics_t asn_SPC_EraseCC_EntryArg_specs_1 = {
	...
	asn_MAP_EraseCC_EntryArg_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	1,	/* Start extensions */
	3	/* Stop extensions */
};
