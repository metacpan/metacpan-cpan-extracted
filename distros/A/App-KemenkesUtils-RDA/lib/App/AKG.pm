...
App::AKG - Shorter alias for App::KemenkesUtils::RDA

=head1 VERSION

This document describes version 0.001 of App::AKG (from Perl distribution App-KemenkesUtils-RDA), released on 2024-06-08.

=head1 DESCRIPTION

Keywords: kementerian kesehatan, Indonesian ministry of health, recommended
daily allowance, RDA, angka kecukupan gizi.
