...
package Meta::Baseline::Lang::Objs;
...
Meta::Baseline::Lang::Objs - language for object files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Objs::env();

=head1 DESCRIPTION

This package contains stuff specific to Objs in the baseline:
Its mainly here to authorize entries of object files to the baseline.
