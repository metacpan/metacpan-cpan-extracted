package Faker::Plugin::CompanyName;
...
method execute() {
  ...
  return $faker->process(['company', 'name']);
}
...
Faker::Plugin::CompanyName

=cut

=head1 ABSTRACT

Company Name Plugin for Faker
...
=head1 SYNOPSIS
  ...
  use Faker;
  use Faker::Plugin::CompanyName;

  my $f = Faker->new;
  my $p = Faker::Plugin::CompanyName->new(faker => $f);
...
This package provides methods for generating fake company name data.
...
The execute method returns a random fake company name.
