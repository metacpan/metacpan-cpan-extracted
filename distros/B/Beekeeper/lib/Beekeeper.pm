...
- A C<call_remote> synchronous call involves 4 MQTT messages. A broker adds around 2.5 ms of latency 
...
- A C<call_remote_async> asynchronous call to a remote method takes 0.12 ms. This implies a maximum of
