package MusicRoom::Artist;

=head1 NAME

MusicRoom::Artist - Manage the artists in a database
...
use constant TABLE_NAME => "artist";
use constant USER_CLASS => "Artist";
...
sub name_valid
  {
    ...
    my $nearest = MusicRoom::ValidArtists::nearest($arg,"Artist module");
...
sub map_to_valid
  {
    ...
    my $nearest = MusicRoom::ValidArtists::nearest($val,"Artist module");
