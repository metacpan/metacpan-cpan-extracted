...
static asn_TYPE_member_t asn_MBR_UESBI_Iu_1[] = {
	{ ATF_POINTER, 2, offsetof(struct UESBI_Iu, uesbi_IuA),
	...
	{ ATF_POINTER, 1, offsetof(struct UESBI_Iu, uesbi_IuB),
...
static int asn_MAP_UESBI_Iu_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_UESBI_Iu_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UESBI_Iu_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* uesbi-IuA at 1039 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* uesbi-IuB at 1040 */
};
