...
#
#=======================================================================
package PDF::API3::Compat::API2::Resource::CIDFont::TrueType;
...
BEGIN {
    ...
    use PDF::API3::Compat::API2::Resource::CIDFont;

    use PDF::API3::Compat::API2::Basic::TTF::Font;
    use PDF::API3::Compat::API2::Resource::CIDFont::TrueType::FontFile;

    use POSIX;

    use vars qw(@ISA $VERSION);

    @ISA = qw( PDF::API3::Compat::API2::Resource::CIDFont );
...
=item $font = PDF::API3::Compat::API2::Resource::CIDFont::TrueType->new $pdf, $file, %options
...
sub new {
    ...
    $opts{-encode}||='latin1';
    my ($ff,$data)=PDF::API3::Compat::API2::Resource::CIDFont::TrueType::FontFile->new($pdf,$file,@opts);
...
=item $font = PDF::API3::Compat::API2::Resource::CIDFont::TrueType->new_api $api, $file, %options
