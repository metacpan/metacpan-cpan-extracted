...
eval Latin3::escape " if ('éÁ' =~ /[á]/i) { return 1 } else { return 0 } "
END
...
if (eval Latin3::escape <<END) {
eval Latin3::escape qq{ if ('éÁ' =~ /[á]/i) { return 1 } else { return 0 } }
END
...
# eval <<END has eval '...'
if (eval Latin3::escape <<END) {
eval Latin3::escape ' if (qq{éÁ} =~ /[á]/i) { return 1 } else { return 0 } '
END
...
# eval <<END has eval q{...}
if (eval Latin3::escape <<END) {
eval Latin3::escape q{ if ('éÁ' =~ /[á]/i) { return 1 } else { return 0 } }
END
