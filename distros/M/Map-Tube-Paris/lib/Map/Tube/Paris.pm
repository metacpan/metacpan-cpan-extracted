...
has xml => ( is => 'ro', default => sub { return dist_file('Map-Tube-Paris', 'paris-map.xml') } );
...
containing this XML content. The default is the path to F<paris-map.xml>
...
The data for the XML file were taken from the relevant Wikipedia articles.
A sample of data was verified using OpenStreetMap and https://www.ratp.fr.
