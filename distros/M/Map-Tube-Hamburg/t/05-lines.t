...

{
  ...
  is( $ret->id( ),    'U3', 'Line id not correct for line U3' );
  is( $ret->name( ),  'U3', 'Node name not correct for line U3' );
  is( $ret->color( ), '#FFDC01', 'Color not correct for line U3' );
...

{
  ...
  isa_ok( $ret,      'Map::Tube::Line' );
  is( $ret->id( ),   'U3', 'Line id not correct for line U3' );
  is( $ret->name( ), 'U3', 'Line name not correct for line U3' );
}
