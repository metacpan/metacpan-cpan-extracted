...
#define SWIG_init    boot_Math__GSL__Version

#define SWIG_name   "Math::GSL::Versionc::boot_Math__GSL__Version"
#define SWIG_prefix "Math::GSL::Versionc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_Math__GSL__Version_var::
class _wrap_Math__GSL__Version_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(SWIG_init) {
  ...
  /*@SWIG:/usr/local/Cellar/swig2/2.0.12/share/swig/2.0.12/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    ...
    sv_setsv(sv, SWIG_FromCharPtr("2.0.1"));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  /*@SWIG:/usr/local/Cellar/swig2/2.0.12/share/swig/2.0.12/perl5/perltypemaps.swg,65,%set_constant@*/ do {
