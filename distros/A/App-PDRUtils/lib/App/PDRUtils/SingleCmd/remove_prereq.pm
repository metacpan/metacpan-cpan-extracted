...
App::PDRUtils::SingleCmd::remove_prereq - Add a prereq

=head1 VERSION

This document describes version 0.121 of App::PDRUtils::SingleCmd::remove_prereq (from Perl distribution App-PDRUtils), released on 2019-07-25.
