...
$Finance::AMEX::Transaction::EPPRC::Summary::VERSION = '0.004';
use strict;
use warnings;
...
Finance::AMEX::Transaction::EPPRC::Summary - Parse AMEX Transaction/Invoice Level Reconciliation (EPPRC) Summary Rows
