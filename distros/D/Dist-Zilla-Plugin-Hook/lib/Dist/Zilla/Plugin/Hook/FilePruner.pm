...
#pod
#pod This is C<Hook::FilePruner> plugin implementation. Nothing interesting, just using few roles.
#pod
...
package Dist::Zilla::Plugin::Hook::FilePruner;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::FilePruner> plugin implementation
our $VERSION = 'v0.8.3'; # VERSION

with 'Dist::Zilla::Role::Plugin';
with 'Dist::Zilla::Role::Hooker' => {
    -alias => { hook => 'prune_files' },
};
...
Dist::Zilla::Plugin::Hook::FilePruner - C<Hook::FilePruner> plugin implementation
...
This is C<Hook::FilePruner> plugin implementation. Nothing interesting, just using few roles.
