...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::CrossSiteNetwork Google::Cloud::Compute::V1::Compute::CrossSiteNetworkList Google::Cloud::Compute::V1::Compute::Operation )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::CrossSiteNetworksClient->new( credentials => 'dummy' );
