package Chart::Plotly::Trace::Parcoords::Line::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Parcoords::Line::Colorbar::Tickfont - This attribute is one of the possible options for the trace parcoords.
