...
our $rschema = ["int",[{max=>1.84467440737096e+19,min=>0,summary=>"64-bit unsigned integer"}],["int"]];
...
This document describes version 0.070 of Sah::SchemaR::uint64 (from Perl distribution Sah-Schemas-Int), released on 2017-08-19.
