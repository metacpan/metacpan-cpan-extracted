# This Makefile is for the Audio::C4Stream::Wav extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Audio/C4Stream/Wav.pm]
#     AUTHOR => q[C4PC <adeamara@cloud4pc.com>]
#     BUILD_REQUIRES => {  }
#     NAME => q[Audio::C4Stream::Wav]
#     PREREQ_PM => { Inline=>q[0.44] }
#     VERSION_FROM => q[lib/Audio/C4Stream/Wav.pm]
#     clean => { FILES=>q[_Inline Wav.inl] }
...
MAKE = make
FULLEXT = Audio/C4Stream/Wav
BASEEXT = Wav
PARENT_NAME = Audio::C4Stream
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Audio/C4Stream/Wav.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Audio/C4Stream/Wav.pm
...
TO_INST_PM = lib/Audio/C4Stream/Wav.pm

PM_TO_BLIB = lib/Audio/C4Stream/Wav.pm \
	blib/lib/Audio/C4Stream/Wav.pm
...
DISTNAME = Audio-C4Stream-Wav
DISTVNAME = Audio-C4Stream-Wav-1.00
...
manifypods : pure_all  \
	lib/Audio/C4Stream/Wav.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Audio/C4Stream/Wav.pm $(INST_MAN3DIR)/Audio::C4Stream::Wav.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '    Inline:  0.44' >> META_new.yml
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Audio/C4Stream/Wav.pm blib/lib/Audio/C4Stream/Wav.pm 
...
Wav.inl : $(TO_INST_PM)
	$(PERL) -Mblib -MInline=NOISY,_INSTALL_ -MAudio::C4Stream::Wav -e1 1.00 $(INST_ARCHLIB)
