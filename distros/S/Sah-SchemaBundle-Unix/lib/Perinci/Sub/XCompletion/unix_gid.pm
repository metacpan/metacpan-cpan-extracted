package Perinci::Sub::XCompletion::unix_gid;
...
use Complete::Unix qw(complete_gid);
...
1;
# ABSTRACT: Generate completion for Unix GIDs (group IDs)
...
Perinci::Sub::XCompletion::unix_gid - Generate completion for Unix GIDs (group IDs)

=head1 VERSION

This document describes version 0.022 of Perinci::Sub::XCompletion::unix_gid (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.

=head1 SYNOPSIS

=head1 DESCRIPTION

This creates a completion from list of local Unix GIDs (group IDs).
