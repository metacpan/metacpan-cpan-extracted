package Google::Ads::AdWords::v201809::OfflineDataUploadService::OfflineDataUploadServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201809::TypeMaps::OfflineDataUploadService
    if not Google::Ads::AdWords::v201809::TypeMaps::OfflineDataUploadService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/rm/v201809/OfflineDataUploadService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201809::TypeMaps::OfflineDataUploadService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::OfflineDataUploadService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201809::OfflineDataUploadService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::OfflineDataUploadService::mutate )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/rm/v201809/OfflineDataUploadService.
...
Returns a L<Google::Ads::AdWords::v201809::OfflineDataUploadService::getResponse|Google::Ads::AdWords::v201809::OfflineDataUploadService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::OfflineDataUploadService::mutateResponse|Google::Ads::AdWords::v201809::OfflineDataUploadService::mutateResponse> object.
