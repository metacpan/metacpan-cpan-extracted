...
my $color  = KOI8R::substr $s, 4, 5;   # black
my $middle = KOI8R::substr $s, 4, -11; # black cat climbed the
my $end    = KOI8R::substr $s, 14;     # climebed the green tree
my $tail   = KOI8R::substr $s, -4;     # tree
my $z      = KOI8R::substr $s, -4, 2;  # tr
