#!/usr/bin/perl -w
#Тут sex.ru - не наш домен, upanishadi.ru - невалидное мыло, trax.ru - невалидная дата, air.ru - ничего не меняем, don2000-1.ru - домен не существует, sex170004536743.ru - смена NOT DELEGATED на DELEGATED и владельца с Iliya I Liss на Iliya1 I Liss
use strict;
