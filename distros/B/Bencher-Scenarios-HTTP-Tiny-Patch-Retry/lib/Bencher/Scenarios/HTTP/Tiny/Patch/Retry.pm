package Bencher::Scenarios::HTTP::Tiny::Patch::Retry;
...
Bencher::Scenarios::HTTP::Tiny::Patch::Retry - Benchmark HTTP::Tiny::Patch::Retry

=head1 VERSION

This document describes version 0.002 of Bencher::Scenarios::HTTP::Tiny::Patch::Retry (from Perl distribution Bencher-Scenarios-HTTP-Tiny-Patch-Retry), released on 2023-01-19.
...
=item * L<Bencher::Scenario::HTTP::Tiny::Patch::Retry::PatchOverhead>
