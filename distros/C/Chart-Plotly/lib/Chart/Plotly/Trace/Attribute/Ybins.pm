package Chart::Plotly::Trace::Attribute::Ybins;
use Moose;
...
Chart::Plotly::Trace::Attribute::Ybins
...
=head1 SYNOPSIS
	...
	my $ybins = Chart::Plotly::Trace::Attribute::Ybins->new(x => [1 .. 5], y => [1 .. 5]);
	
	HTML::Show::show(Chart::Plotly::render_full_html(data => [$ybins]));
...
Full reference: L<https://plot.ly/javascript/reference/#ybins>
