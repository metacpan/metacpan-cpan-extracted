...
const InvokeStandaloneMethodGeneratorHandler = require('./InvokeStandaloneMethodGeneratorHandler')
const SharedInvokeStandaloneMethodBodyHandler = require('./shared/body/SharedInvokeStandaloneMethodBodyHandler')
...
class Handlers {
    ...
    constructor() {
        ...
        this.SHARED_BODY_HANDLER[CommandType.InvokeInstanceMethod] =
            new SharedInvokeInstanceMethodBodyHandler()
        this.SHARED_BODY_HANDLER[CommandType.InvokeStaticMethod] = new SharedInvokeStaticMethodBodyHandler()
        this.SHARED_BODY_HANDLER[CommandType.InvokeStandaloneMethod] =
            new SharedInvokeStandaloneMethodBodyHandler()
        ...
        this.GENERATOR_HANDLER[CommandType.InvokeStandaloneMethod] =
            new InvokeStandaloneMethodGeneratorHandler()
