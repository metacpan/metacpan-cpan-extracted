...
(This example is included as L<F<example.pl>|https://api.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.15/examples/example.pl> in the distribution.)


=head1 VERSION

This documents Data::Kanji::Kanjidic version 0.15
corresponding to git commit L<6e3f60569b57b1a8254b10873437769812964c26|https://github.com/benkasminbullock/Data-Kanji-Kanjidic/commit/6e3f60569b57b1a8254b10873437769812964c26> released on Thu Feb 2 14:36:47 2017 +0900.
...
(This example is included as L<F<parse-kanjidic.pl>|https://api.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.15/examples/parse-kanjidic.pl> in the distribution.)
...
(This example is included as L<F<frequency.pl>|https://api.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.15/examples/frequency.pl> in the distribution.)
...
(This example is included as L<F<korean.pl>|https://api.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.15/examples/korean.pl> in the distribution.)
...
(This example is included as L<F<english-to-kanji.pl>|https://api.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.15/examples/english-to-kanji.pl> in the distribution.)
...
(This example is included as L<F<onyomi-same.pl>|https://api.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.15/examples/onyomi-same.pl> in the distribution.)
...
(This example is included as L<F<morohashi.pl>|https://api.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.15/examples/morohashi.pl> in the distribution.)
...
(This example is included as L<F<grades.pl>|https://api.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.15/examples/grades.pl> in the distribution.)
