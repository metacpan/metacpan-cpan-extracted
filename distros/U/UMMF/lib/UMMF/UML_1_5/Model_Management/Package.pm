...
package UMMF::UML_1_5::Model_Management::Package;
...
=head2 C<package> : I<THIS> C<0..*> E<lt>---E<gt>  C<importedElement> : UMMF::UML_1_5::Foundation::Core::ModelElement C<0..*>
...
=head2 C<package> : I<THIS> C<1> E<lt>---E<gt>  C<importedElement_AC> : UMMF::UML_1_5::Model_Management::ElementImport C<0..*>
...
use base qw(
  UMMF::UML_1_5::Foundation::Core::GeneralizableElement  UMMF::UML_1_5::Foundation::Core::Namespace
...
=head2 C<__validate_type>
  ...
  UMMF::UML_1_5::Model_Management::Package->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::Model_Management::Package|UMMF::UML_1_5::Model_Management::Package>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::Model_Management::Package')  ;
}


=head2 C<__typecheck>

  UMMF::UML_1_5::Model_Management::Package->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::Model_Management::Package->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::Model_Management::Package' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML_1_5::Model_Management::Package|UMMF::UML_1_5::Model_Management::Package>.
   ...
   [
	 ...
	 'type_impl' => 'iset',
         'class' => 'UMMF::UML_1_5::Model_Management::ElementImport',
                           ...
                           'table' => 'Model_Management__Package__importedElement_AC', 
      ...
      ,
       ...
       'bases' => [  'UMMF::UML_1_5::Foundation::Core::GeneralizableElement',  'UMMF::UML_1_5::Foundation::Core::Namespace',  ],
       'sql' => {
...
sub ___initialize
{
  ...
  #  package 0..*
  #  <--> 
  #  importedElement 0..* UMMF::UML_1_5::Foundation::Core::ModelElement.
  ...
  #  package 1
  #  <--> 
  #  importedElement_AC 0..* UMMF::UML_1_5::Model_Management::ElementImport.
...
sub __initialize
{
  ...
  $self->UMMF::UML_1_5::Model_Management::Package::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::Model_Management::Package::___create(@args);
...
Returns the AssociationEnd C<importedElement> values of type L<UMMF::UML_1_5::Foundation::Core::ModelElement|UMMF::UML_1_5::Foundation::Core::ModelElement>.
...
sub add_importedElement ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        ...
        $self->__use('UMMF::UML_1_5::Foundation::Core::ModelElement')->__typecheck($val, "UMMF::UML_1_5::Model_Management::Package.importedElement");
...
Returns the AssociationEnd C<importedElement_AC> values of type L<UMMF::UML_1_5::Model_Management::ElementImport|UMMF::UML_1_5::Model_Management::ElementImport>.
In array context, returns all the objects in the Association.
In scalar context, returns an array ref of all the objects in the Association.
...
sub add_importedElement_AC ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        next if $x->includes($val);
        $self->__use('UMMF::UML_1_5::Model_Management::ElementImport')->__typecheck($val, "UMMF::UML_1_5::Model_Management::Package.importedElement_AC");
...
Clears the AssociationEnd C<importedElement_AC> links to L<UMMF::UML_1_5::Model_Management::ElementImport|UMMF::UML_1_5::Model_Management::ElementImport>.
Returns C<$obj>.
