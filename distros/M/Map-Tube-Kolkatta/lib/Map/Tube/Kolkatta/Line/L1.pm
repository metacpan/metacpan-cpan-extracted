...
$Map::Tube::Kolkatta::Line::L1::VERSION   = '0.34';
...
The map data for the line B<L1 - Blue> collected from L<this page|https://en.wikipedia.org/wiki/Blue_Line_(Kolkata_Metro)>.
