...
Tables::Sample::DeNiro - Rotten Tomato ratings of movies with Robert De Niro

=head1 VERSION

This document describes version 0.006 of Tables::Sample::DeNiro (from Perl distribution TablesRoles-Standard), released on 2020-11-10.
