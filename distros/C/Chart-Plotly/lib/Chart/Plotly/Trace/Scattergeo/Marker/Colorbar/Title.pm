package Chart::Plotly::Trace::Scattergeo::Marker::Colorbar::Title;
use Moose;
...
Chart::Plotly::Trace::Scattergeo::Marker::Colorbar::Title - This attribute is one of the possible options for the trace scattergeo.
