package Chart::Plotly::Trace::Heatmap::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Heatmap::Colorbar::Tickfont - This attribute is one of the possible options for the trace heatmap.
