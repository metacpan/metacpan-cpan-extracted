package Chart::Plotly::Trace::Scatterpolargl::Hoverlabel;
use Moose;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatterpolargl::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Scatterpolargl::Hoverlabel - This attribute is one of the possible options for the trace scatterpolargl.
