...
# Big5HKSCS::eval <<END has Big5HKSCS::eval "..."
if (Big5HKSCS::eval <<END) {
...
# Big5HKSCS::eval <<END has Big5HKSCS::eval qq{...}
if (Big5HKSCS::eval <<END) {
...
# Big5HKSCS::eval <<END has Big5HKSCS::eval q{...}
if (Big5HKSCS::eval <<END) {
...
# Big5HKSCS::eval <<END has Big5HKSCS::eval $var
...
# Big5HKSCS::eval <<END has Big5HKSCS::eval (omit)
