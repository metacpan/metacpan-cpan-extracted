...
#     ABSTRACT => q[The one stop shop for parsing static column width text tables!]
#     AUTHOR => q[Evan <me@evancarroll.com>]
#     DIR => []
#     DISTNAME => q[DataExtract-FixedWidth]
...
MAKE = make
FULLEXT = DataExtract/FixedWidth
BASEEXT = FixedWidth
PARENT_NAME = DataExtract
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/DataExtract/FixedWidth.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/DataExtract
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/DataExtract
...
DISTVNAME = DataExtract-FixedWidth-0.09
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/DataExtract/FixedWidth.pm $(INST_MAN3DIR)/DataExtract::FixedWidth.$(MAN3EXT) 
