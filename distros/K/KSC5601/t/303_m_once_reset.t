...
if (join(',',@m_once) eq '1,1,1') {
    print qq{ok - 1 ?ㄲㄲㄲ?; reset $^X $__FILE__\n};
}
else {
    print qq{not ok - 1 ?ㄲㄲㄲ?; reset $^X $__FILE__\n};
}
...
if (join(',',@m_once) eq '1,1,1') {
    print qq{ok - 3 ? ㄲ ㄲ ㄲ ?x; reset $^X $__FILE__\n};
}
else {
    print qq{not ok - 3 ? ㄲ ㄲ ㄲ ?x; reset $^X $__FILE__\n};
}
...
if (join(',',@m_once) eq '1,1,1') {
    print qq{ok - 4 ?^ㄴㄴㄴ?m; reset $^X $__FILE__\n};
}
else {
    print qq{not ok - 4 ?^ㄴㄴㄴ?m; reset $^X $__FILE__\n};
}
...
if (join(',',@m_once) eq '1,1,1') {
    print qq{ok - 5 ?ㄲ.ㄴ?s; reset $^X $__FILE__\n};
}
else {
    print qq{not ok - 5 ?ㄲ.ㄴ?s; reset $^X $__FILE__\n};
}
...
if (join(',',@m_once) eq '1,1,1') {
    print qq{ok - 7 ?ㄲㄲㄲ?g; reset $^X $__FILE__\n};
}
else {
    print qq{not ok - 7 ?ㄲㄲㄲ?g; reset $^X $__FILE__\n};
}
...
if (join(',',@m_once) eq '1,1,1') {
    print qq{ok - 8 ?ㄲㄲㄲ?gc; reset $^X $__FILE__\n};
}
else {
    print qq{not ok - 8 ?ㄲㄲㄲ?gc; reset $^X $__FILE__\n};
}
