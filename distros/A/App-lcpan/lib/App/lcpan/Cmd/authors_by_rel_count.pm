...
1;
# ABSTRACT: List authors ranked by number of releases
...
App::lcpan::Cmd::authors_by_rel_count - List authors ranked by number of releases

=head1 VERSION

This document describes version 1.034 of App::lcpan::Cmd::authors_by_rel_count (from Perl distribution App-lcpan), released on 2019-06-19.
