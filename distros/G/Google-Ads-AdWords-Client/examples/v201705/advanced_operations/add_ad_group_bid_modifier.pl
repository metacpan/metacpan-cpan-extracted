...
use Google::Ads::AdWords::v201705::AdGroupBidModifierOperation;
use Google::Ads::AdWords::v201705::AdGroupBidModifier;
...
sub add_ad_group_bid_modifier {
  ...
  my $modifier = Google::Ads::AdWords::v201705::AdGroupBidModifier->new({
  ...
  my $operation =
    Google::Ads::AdWords::v201705::AdGroupBidModifierOperation->new({
      operator => "ADD",
      operand  => $modifier
    });
