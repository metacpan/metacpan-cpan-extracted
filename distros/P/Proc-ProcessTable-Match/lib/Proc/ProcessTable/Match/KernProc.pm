package Proc::ProcessTable::Match::KernProc;
...
Proc::ProcessTable::Match::KernProc - Attempts to match the kernel processes.
...
=head1 SYNOPSIS
    ...
    my $checker=Proc::ProcessTable::Match::KernProc->new;
    
    if ( $checker->match( $proc ) ){
        print "It matches.\n";
    }

This modules functions via looking for processes matching the following.
...
sub match{
	...
	# a zombie also has a blank cmndline, but is not a kernel proc
