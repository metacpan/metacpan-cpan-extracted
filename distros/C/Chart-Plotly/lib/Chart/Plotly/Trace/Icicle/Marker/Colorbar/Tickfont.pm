package Chart::Plotly::Trace::Icicle::Marker::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Icicle::Marker::Colorbar::Tickfont - This attribute is one of the possible options for the trace icicle.
