...
PM
    ...
    my $changed=ASPEER::MakeMaker::Markdown::Pod->new->markpod_process_and_update($fn);
...
PM
    ...
    my $markpod_or=ASPEER::MakeMaker::Markdown::Pod->new({nobackup => 1});
...
PM
    ...
    my $changed=ASPEER::MakeMaker::Markdown::Pod->new({nobackup => 1})->markpod_process_and_update($fn);
