...
our $rschema = ["int",[{summary=>"Year number"}],["int"]];
...
This document describes version 0.003 of Sah::SchemaR::date::year (from Perl distribution Sah-Schemas-Date), released on 2019-06-20.
