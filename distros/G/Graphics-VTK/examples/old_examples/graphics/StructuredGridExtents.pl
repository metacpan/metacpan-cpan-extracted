...
$points->SetNumberOfPoints(21 * 21 * 21);
$n = 0;
for ($k = 0; $k < 21; $k += 1)
 {
  $z = 0.1 * $k - 10;
...
$geom2 = Graphics::VTK::StructuredGridGeometryFilter->new;
...
$geom3 = Graphics::VTK::StructuredGridGeometryFilter->new;
