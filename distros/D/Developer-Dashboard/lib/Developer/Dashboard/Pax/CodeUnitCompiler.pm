...
sub _capture_live_unit {
    my ($abs_path) = @_;
    return Developer::Dashboard::Pax::Capture->new(mode => 'live')->capture($abs_path);
}
...
Developer::Dashboard::Pax::CodeUnitCompiler - Perl source-unit compiler for standalone packaging

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::CodeUnitCompiler;

  my $obj = Developer::Dashboard::Pax::CodeUnitCompiler->new(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::CodeUnitCompiler -e 1
