package Perinci::Sub::XCompletion::filename_curdir;
...
1;
# ABSTRACT: Generate completion for regular file name in the current directory
...
Perinci::Sub::XCompletion::filename_curdir - Generate completion for regular file name in the current directory

=head1 VERSION

This document describes version 0.106 of Perinci::Sub::XCompletion::filename_curdir (from Perl distribution Perinci-Sub-XCompletion), released on 2023-11-18.
...
Do not include dotdirs:
 ...
 'x.completion' => ['filename_curdir' => {allow_dot=>0}],
