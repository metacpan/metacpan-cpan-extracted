package Chart::Plotly::Trace::Bar::Selected::Textfont;
use Moose;
...
Chart::Plotly::Trace::Bar::Selected::Textfont - This attribute is one of the possible options for the trace bar.
