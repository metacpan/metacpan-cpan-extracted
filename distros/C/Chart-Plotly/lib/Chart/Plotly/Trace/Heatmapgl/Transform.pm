package Chart::Plotly::Trace::Heatmapgl::Transform;
use Moose;
...
Chart::Plotly::Trace::Heatmapgl::Transform - This attribute is one of the possible options for the trace heatmapgl.
