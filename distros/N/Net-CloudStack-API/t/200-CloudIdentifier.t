##############################################################################
# This test file tests the functions found in the CloudIdentifier section.
...
$tests++;       # Test loading of CloudIdentifier group
...
timeit { ok( eval "use Net::CloudStack::API ':CloudIdentifier'; 1", 'use statement' ) } 'use took';
explain $@ if $@;
