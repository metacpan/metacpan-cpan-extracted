...
L<processFiles()|OODoc/"Parser"> call, before the formatters are called.
...
You can also pass many options which are passed to L<OODoc::Format::createPages()|OODoc::Format/"Page generation">
