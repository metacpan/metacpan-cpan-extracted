##############################################################################
# This test file tests the functions found in the SystemCapacity section.
...
$tests++;       # Test loading of SystemCapacity group
...
timeit { ok( eval "use Net::CloudStack::API ':SystemCapacity'; 1", 'use statement' ) } 'use took';
explain $@ if $@;
