...
package Google::Ads::AdWords::v201705::SharedCriterionService::RequestHeader;
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::SharedCriterionService::RequestHeader->new($data);
