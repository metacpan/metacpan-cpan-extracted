...
$Search::Elasticsearch::Client::7_0::Direct::Graph::VERSION = '7.711001';
use Moo;
...
Search::Elasticsearch::Client::7_0::Direct::Graph - Plugin providing Graph API for Search::Elasticsearch 7.x
