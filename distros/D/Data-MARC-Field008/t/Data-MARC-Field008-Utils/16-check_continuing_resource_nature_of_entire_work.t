...
use Data::MARC::Field008::Utils qw(check_continuing_resource_nature_of_entire_work);
...
my $ret = check_continuing_resource_nature_of_entire_work($self, 'key');
is($ret, undef, 'Right continuing resource nature of entire work is present (a).');

# Test.
$self = {
	'key' => ' ',
};
$ret = check_continuing_resource_nature_of_entire_work($self, 'key');
is($ret, undef, 'Right continuing resource nature of entire work is present ( ).');
