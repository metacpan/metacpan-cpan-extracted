# AWS::ApiGatewayV2::IntegrationResponse generated from spec 14.3.0
...
package Cfn::Resource::Properties::AWS::ApiGatewayV2::IntegrationResponse {
  ...
  has ResponseTemplates => (isa => 'Cfn::Value::Json|Cfn::DynamicValue', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
...
Cfn::Resource::AWS::ApiGatewayV2::IntegrationResponse - Cfn resource for AWS::ApiGatewayV2::IntegrationResponse

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::ApiGatewayV2::IntegrationResponse.
