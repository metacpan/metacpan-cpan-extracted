package Chart::Plotly::Trace::Ohlc::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Ohlc::Hoverlabel::Font - This attribute is one of the possible options for the trace ohlc.
