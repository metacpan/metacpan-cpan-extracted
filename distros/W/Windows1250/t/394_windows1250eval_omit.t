...
# Windows1250::eval (omit) has Windows1250::eval "..."
$_ = <<'END';
...
# Windows1250::eval (omit) has Windows1250::eval qq{...}
$_ = <<'END';
...
# Windows1250::eval (omit) has Windows1250::eval q{...}
$_ = <<'END';
...
# Windows1250::eval (omit) has Windows1250::eval $var
$_ = <<'END';
...
# Windows1250::eval (omit) has Windows1250::eval (omit)
$_ = <<'END';
