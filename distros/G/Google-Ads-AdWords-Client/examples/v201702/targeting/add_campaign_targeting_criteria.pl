...
use Google::Ads::AdWords::v201702::LocationExtensionOperand;
use Google::Ads::AdWords::v201702::LocationGroups;
...
sub add_campaign_targeting_criteria {
  ...
  my $mexico = Google::Ads::AdWords::v201702::Location->new({
      id => 2484    # Mexico
  });
  ...
  if ($location_feed_id) {
    ...
    my $radius = Google::Ads::AdWords::v201702::ConstantOperand->new({
        type        => "DOUBLE",
        unit        => "MILES",
        doubleValue => 10.0
    });
    my $radiusLocationGroup =
      Google::Ads::AdWords::v201702::LocationGroups->new({
        matchingFunction => Google::Ads::AdWords::v201702::Function->new({
            operator => "IDENTITY",
            lhsOperand =>
              Google::Ads::AdWords::v201702::LocationExtensionOperand->new(
              {radius => $radius})}
        ),
