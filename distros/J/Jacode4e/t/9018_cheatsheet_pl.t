...
#
#   $line             : lancuch do konwersji (przekazywany przez referencje, nadpisywany w miejscu)
#   $OUTPUT_encoding  : nazwa kodowania wyjsciowego
#   $INPUT_encoding   : nazwa kodowania wejsciowego
#   $char_count       : liczba znakow po konwersji
#
# [LISTA NAZW KODOWNAN]
#
#   skrot       znaczenie
#   ---------   ---------------------------------------------------
#   cp932x      CP932X (rozszerzenie do JIS X 0213, pojedyncze przesunięcie 0x9C5A)
#   cp932       Microsoft CP932 (Windows-31J / nazwa IANA)
#   cp932ibm    IBM CP932
#   cp932nec    NEC CP932
...
#   jef         FUJITSU JEF (12pt, kody przesunięcia z OUTPUT_SHIFTING)
#   jef9p       FUJITSU JEF ( 9pt, kody przesunięcia z OUTPUT_SHIFTING)
#   jipsj       NEC JIPS(J)
#   jipse       NEC JIPS(E)
#   letsj       UNISYS LetsJ
#   utf8        UTF-8.0 (zwykly UTF-8)
#   utf8.1      UTF-8.1 (konwersja oparta na mapowaniu Shift_JIS-Unicode, nie CP932)
#   utf8jp      UTF-8-SPUA-JP (JIS X 0213 odwzorowany w obszarze SPUA Unicode)
#
# [OPCJE]
#
#   klucz             wartosc / opis
#   ---------------   ---------------------------------------------------
#   INPUT_LAYOUT      uklad rekordu wejsciowego ('S'=SBCS, 'D'=DBCS z licznikiem powtorzen)
#   OUTPUT_SHIFTING   jesli prawda, wstawia kody przesunięcia wokol sekwencji DBCS
#   SPACE             kod spacji DBCS/MBCS (lancuch binarny)
#   GETA              symbol geta dla znakow niemapowanych
#   OVERRIDE_MAPPING  zastapienie na znak { "\x12\x34"=>"\x56\x78" }
#
# [OSTRZEZENIE: KONWERSJA W DWU KIERUNKACH]
#
#   Istnieja konwersje stratne (np. CP932 ma 398 nieodwracalnych mapowań).
#   Do konwersji dwukierunkowej uzyj modulu Jacode4e::RoundTrip.
#
# ======================================================================
...
BEGIN {
    ...
    @test = (
        ...
        # --- UTF-8.1: konwersja oparta na Shift_JIS-Unicode, nie CP932 ---
