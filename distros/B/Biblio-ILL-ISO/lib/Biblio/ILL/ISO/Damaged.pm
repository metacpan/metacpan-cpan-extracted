package Biblio::ILL::ISO::Damaged;

=head1 NAME

Biblio::ILL::ISO::Damaged - Perl extension for handling ISO 10161 interlibrary loan Damaged messages
...
Biblio::ILL::ISO::Damaged is a derivation of the abstract 
Biblio::ILL::ISO::ISO object, and handles the Damaged message type.
...
Damaged message from a file (followed by a call to
...
To read a message from a file, use the following:
    ...
    my $href = $msg->read("msg_16.damaged.ber");
...
sub from_asn {
	...
	} elsif ($k =~ /^damaged-details$/) {
	    croak "damaged-details is currently unsupported.";
