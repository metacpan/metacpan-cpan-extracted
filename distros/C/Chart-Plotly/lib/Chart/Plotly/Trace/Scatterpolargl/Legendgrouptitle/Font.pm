package Chart::Plotly::Trace::Scatterpolargl::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Scatterpolargl::Legendgrouptitle::Font - This attribute is one of the possible options for the trace scatterpolargl.
