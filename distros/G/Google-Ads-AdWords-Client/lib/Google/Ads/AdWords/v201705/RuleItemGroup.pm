package Google::Ads::AdWords::v201705::RuleItemGroup;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'items' => 'Google::Ads::AdWords::v201705::RuleItem',
    },
    {
...
RuleItemGroup from the namespace https://adwords.google.com/api/adwords/rm/v201705.
