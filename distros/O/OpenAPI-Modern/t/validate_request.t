      ...
      errors => [
        {
          ...
          keywordLocation => jsonp(qw(/paths /foo/{null_path}/{boolean_path} get parameters 0 schema)),
          absoluteKeywordLocation => $doc_uri->clone->fragment(jsonp(qw(/paths /foo/{null_path}/{boolean_path} get parameters 0 schema)))->to_string,
          error => 'cannot deserialize as form style to requested type (null)',
        },
        {
          instanceLocation => '/request/uri/query/boolean_query',
          keywordLocation => jsonp(qw(/paths /foo/{null_path}/{boolean_path} get parameters 1 schema)),
          absoluteKeywordLocation => $doc_uri->clone->fragment(jsonp(qw(/paths /foo/{null_path}/{boolean_path} get parameters 1 schema)))->to_string,
          error => 'cannot deserialize as form style to requested type (boolean)',
        },
        {
          instanceLocation => '/request/header/NullHeader',
          keywordLocation => jsonp(qw(/paths /foo/{null_path}/{boolean_path} get parameters 2 schema)),
          absoluteKeywordLocation => $doc_uri->clone->fragment(jsonp(qw(/paths /foo/{null_path}/{boolean_path} get parameters 2 schema)))->to_string,
          error => 'cannot deserialize to requested type (null)',
        },
        {
          instanceLocation => '/request/header/BooleanHeader',
          keywordLocation => jsonp(qw(/paths /foo/{null_path}/{boolean_path} get parameters 3 schema)),
          absoluteKeywordLocation => $doc_uri->clone->fragment(jsonp(qw(/paths /foo/{null_path}/{boolean_path} get parameters 3 schema)))->to_string,
          error => 'cannot deserialize to requested type (boolean)',
        },
        {
          instanceLocation => '/request/uri/path/null_path',
          keywordLocation => jsonp(qw(/paths /foo/{null_path}/{boolean_path} parameters 0 schema)),
          absoluteKeywordLocation => $doc_uri->clone->fragment(jsonp(qw(/paths /foo/{null_path}/{boolean_path} parameters 0 schema)))->to_string,
          error => 'cannot deserialize as simple style to requested type (null)',
        },
        {
          instanceLocation => '/request/uri/path/boolean_path',
          keywordLocation => jsonp(qw(/paths /foo/{null_path}/{boolean_path} parameters 1 schema)),
          absoluteKeywordLocation => $doc_uri->clone->fragment(jsonp(qw(/paths /foo/{null_path}/{boolean_path} parameters 1 schema)))->to_string,
          error => 'cannot deserialize as simple style to requested type (boolean)',
        },
      ],
    },
    ...
    $openapi->validate_request($request)->TO_JSON,
    {
      ...
      errors => [
        ...
        },
        {
          ...
          keywordLocation => jsonp(qw(/paths /foo get parameters 8 schema)),
          absoluteKeywordLocation => $doc_uri->clone->fragment(jsonp(qw(/paths /foo get parameters 8 schema)))->to_string,
