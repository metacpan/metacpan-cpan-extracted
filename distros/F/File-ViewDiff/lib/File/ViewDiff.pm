...
File::ViewDiff - Perl extension for finding [uniq/intersection/difference] of lines among two files
...
File::ViewDiff utility or module is very usefull for finding the lines of uniq/difference/intersection of two files,
