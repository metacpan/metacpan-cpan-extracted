package Chart::Plotly::Trace::Icicle::Pathbar::Textfont;
use Moose;
...
Chart::Plotly::Trace::Icicle::Pathbar::Textfont - This attribute is one of the possible options for the trace icicle.
