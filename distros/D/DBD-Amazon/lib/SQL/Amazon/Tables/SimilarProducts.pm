...
=head4 SimilarProducts (table, readonly)

URLs of similar products, keyed by ASIN.
...
=item Title - hopefully this is same for all products!

=back

=cut

package SQL::Amazon::Tables::SimilarProducts;
