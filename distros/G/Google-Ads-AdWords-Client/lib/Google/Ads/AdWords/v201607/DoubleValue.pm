package Google::Ads::AdWords::v201607::DoubleValue;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201607::NumberValue);
# Variety: sequence
...
DoubleValue from the namespace https://adwords.google.com/api/adwords/cm/v201607.
