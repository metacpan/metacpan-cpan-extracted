package Shipment::Purolator::WSDLV2::Types::ArrayOfContentDetail;
$Shipment::Purolator::WSDLV2::Types::ArrayOfContentDetail::VERSION = '3.04';
use strict;
use warnings;
...
ArrayOfContentDetail from the namespace http://purolator.com/pws/datatypes/v2.
