...
&NCAR::agsetf('Y/MINIMUM.',-1.4);
&NCAR::agsetf('Y/MAXIMUM.', 1.4);
&NCAR::agsetf('Y/NICE.',    0.0);

&NCAR::ezmxy ($XDRA,$YDRA,$NPTS,$NCURVE,$NPTS,'X-Y PLOT CAPABILITIES$');
...
rename 'gmeta', 'ncgm/fagovrvw.ncgm';
