package Chart::Plotly::Trace::Image::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Image::Hoverlabel::Font - This attribute is one of the possible options for the trace image.
