...
package WebService::Edgecast::auto::Administration::Element::CustomerFmsUpdate;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerFmsUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerFmsUpdate');
...
WebService::Edgecast::auto::Administration::Element::CustomerFmsUpdate
...
CustomerFmsUpdate from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerFmsUpdate->new($data);
