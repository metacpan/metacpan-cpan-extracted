...
our $schema = ['array' => {
    summary => 'Array of required month numbers, coercible from English/Indonesian full/abbreviated month names, e.g. [1,"May","AGU"]',
...
# ABSTRACT: Array of required month numbers, coercible from English/Indonesian full/abbreviated month names, e.g. [1,"May","AGU"]
...
Sah::Schema::date::month_nums::en_or_id - Array of required month numbers, coercible from English/Indonesian full/abbreviated month names, e.g. [1,"May","AGU"]

=head1 VERSION

This document describes version 0.008 of Sah::Schema::date::month_nums::en_or_id (from Perl distribution Sah-Schemas-Date-ID), released on 2022-10-20.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("date::month_nums::en_or_id*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("date::month_nums::en_or_id", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("date::month_nums::en_or_id", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("date::month_nums::en_or_id*");
     $validator->(\@args);
     ...
 }
 ...
 $SPEC{myfunc} = {
     ...
     args => {
         arg1 => {
             ...
             schema => ['date::month_nums::en_or_id*'],
         },
         ...
     },
 };
...
To create a type constraint and type library from a schema:
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('$sch_name*', name=>'DateMonthNumsEnOrId')
     );
 }

 use My::Types qw(DateMonthNumsEnOrId);
 DateMonthNumsEnOrId->assert_valid($data);
