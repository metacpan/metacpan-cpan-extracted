...
package WebService::Edgecast::auto::Administration::Element::CustomerHttpLargeUpdate;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerHttpLargeUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerHttpLargeUpdate');
...
WebService::Edgecast::auto::Administration::Element::CustomerHttpLargeUpdate
...
CustomerHttpLargeUpdate from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerHttpLargeUpdate->new($data);
