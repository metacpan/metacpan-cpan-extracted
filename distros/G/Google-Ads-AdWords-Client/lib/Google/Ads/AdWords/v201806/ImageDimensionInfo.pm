package Google::Ads::AdWords::v201806::ImageDimensionInfo;
use strict;
use warnings;
...
Google::Ads::AdWords::v201806::ImageDimensionInfo

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ImageDimensionInfo from the namespace https://adwords.google.com/api/adwords/cm/v201806.
