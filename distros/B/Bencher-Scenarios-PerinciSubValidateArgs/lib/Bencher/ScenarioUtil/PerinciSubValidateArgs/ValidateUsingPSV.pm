...
Bencher::ScenarioUtil::PerinciSubValidateArgs::ValidateUsingPSV - An example module that uses Perinci::Sub::ValidateArgs

=head1 VERSION

This document describes version 0.004 of Bencher::ScenarioUtil::PerinciSubValidateArgs::ValidateUsingPSV (from Perl distribution Bencher-Scenarios-PerinciSubValidateArgs), released on 2016-05-25.
