...
my %config = Lingua::BioYaTeA::load_config("t/bioyatea/bioyatea-tft.rc");
...
ok((stat('sampleEN/bioyatea/raw/termList.txt'))[7] != 0, 'Number of extracted terms greater than 0 with tesstified terms');
rmtree('sampleEN');
