package Chart::Plotly::Trace::Treemap::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Treemap::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Treemap::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Treemap::Hoverlabel - This attribute is one of the possible options for the trace treemap.
