...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::ExternalVpnGateway Google::Cloud::Compute::V1::Compute::ExternalVpnGatewayList Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::ExternalVpnGatewaysClient->new( credentials => 'dummy' );
