package Chart::Plotly::Trace::Violin::Box::Line;
use Moose;
...
has width => ( is            => "rw",
               isa           => "Num",
               documentation => "Sets the inner box plot bounding line width.",
);
...
Chart::Plotly::Trace::Violin::Box::Line - This attribute is one of the possible options for the trace violin.
