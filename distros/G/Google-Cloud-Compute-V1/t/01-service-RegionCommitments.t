...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Commitment Google::Cloud::Compute::V1::Compute::CommitmentAggregatedList Google::Cloud::Compute::V1::Compute::CommitmentList Google::Cloud::Compute::V1::Compute::Operation )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::RegionCommitmentsClient->new( credentials => 'dummy' );
