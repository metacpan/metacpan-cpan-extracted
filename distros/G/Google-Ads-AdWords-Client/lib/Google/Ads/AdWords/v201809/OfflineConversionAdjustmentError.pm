package Google::Ads::AdWords::v201809::OfflineConversionAdjustmentError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201809::OfflineConversionAdjustmentError::Reason',
    },
    {
...
Google::Ads::AdWords::v201809::OfflineConversionAdjustmentError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OfflineConversionAdjustmentError from the namespace https://adwords.google.com/api/adwords/cm/v201809.

Errors that the OfflineConversionAdjustmentFeedService can return. 
