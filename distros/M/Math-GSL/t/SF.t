...
sub TEST_ELLINT : Tests {
    ...
    if ($major < 2 ) {
        ...
        $results = {
            'gsl_sf_ellint_D_e($M_PI/2.0, 0.99, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 2.375395076351788975665323192,
            'gsl_sf_ellint_D_e($M_PI/2.0, 0.50, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 0.8731525818926755496456335628,
            'gsl_sf_ellint_D_e($M_PI/2.0, 0.01, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 0.7854276176694868932799393751,
            'gsl_sf_ellint_D_e(2*$M_PI/3.0, 0.99, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 4.305885125424644860264320635,
            'gsl_sf_ellint_D_e(2*$M_PI/3.0, 0.50, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 1.418324704155697579394036402,
            'gsl_sf_ellint_D_e(2*$M_PI/3.0, 0.01, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 1.263755353901126149206022061,
            'gsl_sf_ellint_D_e($M_PI, 0.99, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 4.750790152703577951330646444,
            'gsl_sf_ellint_D_e($M_PI, 0.50, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 1.746305163785351099291267125,
            'gsl_sf_ellint_D_e($M_PI, 0.01, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 1.570855235338973786559878750,
            'gsl_sf_ellint_D_e(4*$M_PI/3, 0.99, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 5.195695179982511042396972113,
            'gsl_sf_ellint_D_e(4*$M_PI/3, 0.50, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 2.074285623415004619188497818,
            'gsl_sf_ellint_D_e(4*$M_PI/3, 0.01, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 1.877955116776821423913735408,
            'gsl_sf_ellint_D_e(3*$M_PI/2.0, 0.99, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 7.126185229055366926995969476,
            'gsl_sf_ellint_D_e(3*$M_PI/2.0, 0.50, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 2.619457745678026648936900687,
            'gsl_sf_ellint_D_e(3*$M_PI/2.0, 0.01, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 2.356282853008460679839818125,
            'gsl_sf_ellint_D_e(5*$M_PI/3, 0.99, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 9.056675278128222811594967044,
            'gsl_sf_ellint_D_e(5*$M_PI/3, 0.50, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 3.164629867941048678685303509,
            'gsl_sf_ellint_D_e(5*$M_PI/3, 0.01, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 2.834610589240099935765900794,
            'gsl_sf_ellint_D_e(2*$M_PI, 0.99, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 9.501580305407155902661292832,
            'gsl_sf_ellint_D_e(2*$M_PI, 0.50, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 3.492610327570702198582534249,
            'gsl_sf_ellint_D_e(2*$M_PI, 0.01, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 3.141710470677947573119757500,
            'gsl_sf_ellint_D_e(7*$M_PI/3.0, 0.99, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 9.946485332686088993727618315,
            'gsl_sf_ellint_D_e(7*$M_PI/3.0, 0.50, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 3.820590787200355718479764901,
            'gsl_sf_ellint_D_e(7*$M_PI/3.0, 0.01, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> 3.448810352115795210473614120,
            'gsl_sf_ellint_D_e(-$M_PI/2.0, 0.99, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> -2.375395076351788975665323192,
            'gsl_sf_ellint_D_e(-$M_PI/2.0, 0.50, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> -0.8731525818926755496456335628,
            'gsl_sf_ellint_D_e(-$M_PI/2.0, 0.01, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> -0.7854276176694868932799393751,
            'gsl_sf_ellint_D_e(-2*$M_PI/3.0, 0.99, $Math::GSL::GSL_MODE_DEFAULT,$r)'	=> -4.305885125424644860264320635,
