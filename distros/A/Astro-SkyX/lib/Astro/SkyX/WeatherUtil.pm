package Astro::SkyX::WeatherUtil;
...
our $VERSION = '0.11';
our @FUNCTIONS = qw( isStartedUP isShutdown startupShutdownState lastError connectAll disconnectAll startup shutdown connectWeatherStation disconnectWeatherStation weatherUtilDoCommand );
