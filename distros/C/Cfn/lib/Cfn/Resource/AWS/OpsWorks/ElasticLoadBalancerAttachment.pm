...
Cfn::Resource::AWS::OpsWorks::ElasticLoadBalancerAttachment - Cfn resource for AWS::OpsWorks::ElasticLoadBalancerAttachment

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::OpsWorks::ElasticLoadBalancerAttachment.
