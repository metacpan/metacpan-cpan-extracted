package Sah::SchemaR::example::hash_of_str;

our $DATE = '2020-05-27'; # DATE
our $VERSION = '0.006'; # VERSION

our $rschema = ["hash",[{of=>["str",{req=>1},{}],summary=>"Hash of string"}],["hash"]];
...
Sah::SchemaR::example::hash_of_str - Hash of string

=head1 VERSION

This document describes version 0.006 of Sah::SchemaR::example::hash_of_str (from Perl distribution Sah-Schemas-Examples), released on 2020-05-27.
