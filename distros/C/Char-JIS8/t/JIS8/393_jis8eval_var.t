...
# JIS8::eval $var has JIS8::eval qq{...}
$var = <<'END';
...
# JIS8::eval $var has JIS8::eval $var
$var = <<'END';
JIS8::eval $var2
END
...
# JIS8::eval $var has JIS8::eval (omit)
$var = <<'END';
JIS8::eval
END
