...
$Shipment::Temando::WSDL::Elements::confirmManifestResponse::VERSION = '3.09';
use strict;
use warnings;
...
__PACKAGE__->__set_name('confirmManifestResponse');
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'requests' => 'Shipment::Temando::WSDL::Elements::confirmManifestResponse::_requests',
...
$Shipment::Temando::WSDL::Elements::confirmManifestResponse::_requests::VERSION = '3.09';
use strict;
use warnings;
{
our $XML_ATTRIBUTE_CLASS;
...
confirmManifestResponse from the namespace http://' . $Shipment::Temando::WSDL::Interfaces::quoting_Service::quoting_port::ns_url . '/schema/2009_06/server.xsd.
...
=head2 new
 ...
 my $element = Shipment::Temando::WSDL::Elements::confirmManifestResponse->new($data);
