...
1;
# ABSTRACT: No borders, but columns are still separated using spaces and data row separator is still drawn using dashes
...
BorderStyle::ASCII::SpaceInnerOnly - No borders, but columns are still separated using spaces and data row separator is still drawn using dashes

=head1 VERSION

This document describes version 0.013 of BorderStyle::ASCII::SpaceInnerOnly (from Perl distribution BorderStyles-Standard), released on 2022-02-14.
...
To use with L<Text::ANSITable>:
 ...
 $t->border_style("ASCII::SpaceInnerOnly");
 $t->columns($rows->[0]);
...
To use with L<Text::Table::More>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"ASCII::SpaceInnerOnly");
...
To use with L<Text::Table::TinyBorderStyle>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"BorderStyle::ASCII::SpaceInnerOnly");
