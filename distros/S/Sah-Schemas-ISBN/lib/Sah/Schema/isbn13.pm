...
_
    ...
    examples => [
        {value=>'', valid=>0},
        {value=>'0-545-01022-1', valid=>1, validated_value=>'9780545010221'},
...
This document describes version 0.008 of Sah::Schema::isbn13 (from Perl distribution Sah-Schemas-ISBN), released on 2020-05-27.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("isbn13*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("isbn13*");
     $validator->(\@args);
     ...
 }
...
Sample data:
 ...
 "0-545-01022-1"  # valid, becomes 9780545010221
