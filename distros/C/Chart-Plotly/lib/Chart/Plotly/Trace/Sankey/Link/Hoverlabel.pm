package Chart::Plotly::Trace::Sankey::Link::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Sankey::Link::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Sankey::Link::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Sankey::Link::Hoverlabel - This attribute is one of the possible options for the trace sankey.
