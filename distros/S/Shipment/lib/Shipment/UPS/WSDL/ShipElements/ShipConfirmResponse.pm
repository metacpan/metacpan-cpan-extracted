...
package Shipment::UPS::WSDL::ShipElements::ShipConfirmResponse;
$Shipment::UPS::WSDL::ShipElements::ShipConfirmResponse::VERSION = '3.06';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    __PACKAGE__->__set_name('ShipConfirmResponse');
...
ShipConfirmResponse from the namespace http://www.ups.com/XMLSchema/XOLTWS/Ship/v1.0.
...
=head2 new
 ...
 my $element = Shipment::UPS::WSDL::ShipElements::ShipConfirmResponse->new($data);
