package Chart::Plotly::Trace::Heatmap::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Heatmap::Colorbar::Tickfont;
use Chart::Plotly::Trace::Heatmap::Colorbar::Tickformatstop;
use Chart::Plotly::Trace::Heatmap::Colorbar::Titlefont;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Heatmap::Colorbar::Tickfont", );
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Heatmap::Colorbar::Tickformatstop]", );
...
has titlefont => ( is  => "rw",
                   isa => "Maybe[HashRef]|Chart::Plotly::Trace::Heatmap::Colorbar::Titlefont", );
...
Chart::Plotly::Trace::Heatmap::Colorbar - This attribute is one of the possible options for the trace heatmap.
