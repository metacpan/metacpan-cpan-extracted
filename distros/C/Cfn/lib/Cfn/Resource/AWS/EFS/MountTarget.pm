...
Cfn::Resource::AWS::EFS::MountTarget - Cfn resource for AWS::EFS::MountTarget

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::EFS::MountTarget.
