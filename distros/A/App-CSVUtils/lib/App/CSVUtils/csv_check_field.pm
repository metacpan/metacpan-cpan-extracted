...
1;
# ABSTRACT: Check the value of a whole field against code/schema
...
App::CSVUtils::csv_check_field - Check the value of a whole field against code/schema
...
=head2 csv_check_field

Usage:

 csv_check_field(%args) -> [$status_code, $reason, $payload, \%result_meta]

Check the value of a whole field against codeE<sol>schema.
