package Google::Ads::AdWords::v201802::ServiceLink;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'serviceType' => 'Google::Ads::AdWords::v201802::ServiceType',
        'serviceLinkId' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'linkStatus' => 'Google::Ads::AdWords::v201802::ServiceLink::LinkStatus',
...
Google::Ads::AdWords::v201802::ServiceLink

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ServiceLink from the namespace https://adwords.google.com/api/adwords/mcm/v201802.
