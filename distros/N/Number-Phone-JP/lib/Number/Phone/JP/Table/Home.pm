...
our %TEL_TABLE = (
    ...
    123  => '(?:(?:[458][02-9]|3[1-9]|7[2-9]|9[0238]|6[68]|2\d)\d{4})',
    124  => '(?:(?:2[2-9]|3[03])\d{4})',
    ...
    137  => '(?:(?:6[02-9]|8[2-9]|5[05])\d{4})',
    1372 => '(?:[235-8]\d{4})',
    1374 => '(?:[2-9]\d{4})',
    1377 => '(?:[2-68]\d{4})',
    138  => '(?:(?:[68][2-8]|3[0-8]|2[1-7]|7[3-8]|[45]\d|9[16])\d{4})',
    139  => '(?:(?:5[02-9]|4[2-9]|6[02-79]|3[03])\d{4})',
    1392 => '(?:[25-9]\d{4})',
    1397 => '(?:[235-7]\d{4})',
    1398 => '(?:[2-578]\d{4})',
    ...
    145  => '(?:(?:2[02-9]|4[2-9]|3[01])\d{4})',
    1456 => '(?:[2-9]\d{4})',
    1457 => '(?:[2-689]\d{4})',
    146  => '(?:(?:[2-4][02-9]|5[045])\d{4})',
    1466 => '(?:[2-9]\d{4})',
    15   => '(?:(?:5(?:7[02-9]|10)|4(?:8[2-9]|10))\d{4})',
    152  => '(?:(?:[27][02-9]|4[13-8]|6[1-46-8]|5[2-7]|80)\d{4})',
    153  => '(?:(?:[278][02-9]|5[2-8]|6[24-8]|3[578]|46|92)\d{4})',
    154  => '(?:(?:4[0-7]|5[1-79]|3[125-9]|2[0-5]|9[12589]|6\d)\d{4})',
    1547 => '(?:[235-9]\d{4})',
    155  => '(?:(?:3[0-8]|5[2-9]|9[13479]|[246]\d)\d{4})',
    1558 => '(?:[2-9]\d{4})',
    156  => '(?:(?:6[02-9]|2[2-9]|3[023]|7[07])\d{4})',
    1564 => '(?:[2-57-9]\d{4})',
    157  => '(?:(?:3[0-35-9]|5[1-8]|2[1-6]|6[126-9]|4[2457]|8[89]|77)\d{4})',
    158  => '(?:(?:8[02-9]|2[03-9]|4[2-9]|5[05]|33)\d{4})',
    1586 => '(?:[24-9]\d{4})',
    1587 => '(?:[235-8]\d{4})',
    ...
    1634 => '(?:[24-9]\d{4})',
    1635 => '(?:[2-79]\d{4})',
    164  => '(?:(?:[25][02-9]|[36][2-9]|4[02-469]|70)\d{4})',
    1648 => '(?:[2358]\d{4})',
    ...
    167  => '(?:(?:5[2-8]|2[2-47-9]|4[1245]|3[389]|60|77)\d{4})',
    ...
    174  => '(?:(?:3[013-8]|2[257-9])\d{4})',
    175  => '(?:(?:[47][0-8]|[236]\d)\d{4})',
    ...
    240  => '(?:(?:4[013]|[23]\d)\d{4})',
    241  => '(?:(?:4[1-9]|8[1-8]|7[0-3568]|[2356]\d|9[0258])\d{4})',
    ...
    247  => '(?:(?:5[1-79]|2[2-689]|3[2-8]|4[2-46-9]|6[125-9]|8[124-68]|7\d)\d{4})',
    248  => '(?:(?:2[1-9]|6[0-35-9]|4[1-8]|5[1-578]|7[235-9]|9[2-49]|[38]\d)\d{4})',
    25   => '(?:(?:2(?:8[0-8]|3[0-49]|5[05-9]|[2467]\d|1[0-27]|01|90)|7(?:[57][02-9]|9[2-9]|0[016-8]|1[01369]|[68]\d)|3(?:7[0-57-9]|8[1-8]|6[2457-9]|1[1-3]|3[38]|21)|5(?:6[0-8]|9[2-9]|[2-5]\d|0[0168]|1[124])|[68]00)\d{4})',
    250  => '(?:(?:2[1-578]|4[0-378]|6[1-36-8]|5[058]|38|79)\d{4})',
    254  => '(?:(?:7[0235-9]|9[2-9]|3[1-357-9]|5[0235-8]|6[0246-9]|[24]\d|8[58])\d{4})',
    255  => '(?:(?:7[02-57-9]|8[1-35-8])\d{4})',
    256  => '(?:(?:3[1-689]|6[0-46-8]|7[0235-9]|9[1-578]|4[014-7]|8[025-8]|5[2357]|26)\d{4})',
    257  => '(?:(?:3[0-357-9]|4[13578]|2\d)\d{4})',
    258  => '(?:(?:2[0-57-9]|8[0-46-9]|4[0-2467]|5[1-3589]|7[24-8]|6[1-36]|9[245]|3\d)\d{4})',
    259  => '(?:(?:2[02-9]|5[1257-9]|7[3-8]|6[136-8]|8[16-9]|3[036])\d{4})',
    26   => '(?:(?:2(?:[235][1-9]|4[1-8]|6[1-46-9]|9[0-3569]|7[2-68]|1[3-579]|8[2-6])|4(?:7[4-7]|0[035]|6[268]|80))\d{4})',
    260  => '(?:(?:3[0-68]|2[24-8])\d{4})',
    261  => '(?:(?:2[1-3569]|7[12458]|8[2358]|6[126]|33)\d{4})',
    ...
    274  => '(?:(?:5[025-9]|2[02-58]|6[02-467]|8[0247-9]|3[03579]|7[03-57]|4[0238])\d{4})',
    ...
    288  => '(?:(?:2[1-35-8]|5[013-6]|7[06-9]|3[0-24]|8[0578]|9[36-8]|6[23])\d{4})',
    ...
    470  => '(?:(?:8[0-8]|2[02-57-9]|4[0134679]|6[02-46-8]|7[013-7]|3[0136-8]|5[013578])\d{4})',
    ...
    551  => '(?:(?:2[0-35-9]|3[0235-8]|4[25-8]|[57]5|88|90)\d{4})',
    553  => '(?:(?:3[0-579]|2[0-36]|4[478]|88|90)\d{4})',
    554  => '(?:(?:2[0-6]|6[236-8]|4[3568]|5[256]|3[07]|9[01]|77|88)\d{4})',
    ...
    575  => '(?:(?:2[0-57-9]|3[0-8]|6[0235-9]|7[1-57-9]|4[015-9]|8[2-8])\d{4})',
    ...
    735  => '(?:(?:7[02-9]|4[02-79]|5[024-9]|6[025-9]|3[0-48]|2[1-389])\d{4})',
    ...
    746  => '(?:(?:6[02-9]|3[2-689]|4[2-46-8]|5[2-578])\d{4})',
    7468 => '(?:[2-79]\d{4})',
    ...
    761  => '(?:(?:7[0-8]|2[0-57]|5[0-25-8]|4[1346-8]|6[5-9]|8[013]|3[38])\d{4})',
    763  => '(?:(?:3[02-578]|5[1-358]|6[246-8]|2[235]|8[238]|77)\d{4})',
    765  => '(?:(?:5[024-8]|7[246-8]|2[2-5]|3[1-38]|8[2-48]|6[25])\d{4})',
    766  => '(?:(?:5[0-79]|7[2-9]|8[2-46-9]|3[0-368]|9[125]|[26]\d|4[45])\d{4})',
    767  => '(?:(?:2[2-9]|3[0235-8]|4[24-8]|5[2-47-9]|7[0246-8]|6[0268]|8[3-58])\d{4})',
    768  => '(?:(?:8[02-46-8]|3[0246-8]|2[02368]|5[25-8]|4[2356]|6[0278]|7[2467])\d{4})',
    ...
    772  => '(?:(?:2[0-35-8]|6[024-689]|7[024-79]|4[2-7]|8[2-578]|3[23578])\d{4})',
    ...
    778  => '(?:(?:2[1-57-9]|3[2-46-9]|4[2-578]|5[1-5]|6[25-7]|7[78])\d{4})',
    779  => '(?:(?:6[24-9]|8[35-9]|7[7-9])\d{4})',
    ...
    799  => '(?:(?:[35][02-9]|[68][024-68]|4[2-8]|7[02-57]|2\d)\d{4})',
    ...
    83   => '(?:(?:9(?:2[0-57-9]|7[0-689]|8[013-9]|5[2-8]|0[0-28]|3[2-4]|4[129]|6[36]|9[56])|2(?:6[0-8]|8[1-46-9]|2[02-47-9]|3[1-578]|4[0-25689]|7[178]|9[124]|5\d)|7(?:7[0-24-8]|8[2-68]|6[6-8])|60[089])\d{4})',
    ...
    837  => '(?:(?:2[1-35-9]|3[2-9]|5[2-8]|6[02-59]|4[238])\d{4})',
    838  => '(?:(?:[25][1-8]|33|47)\d{4})',
    8387 => '(?:[2-689]\d{4})',
    8388 => '(?:[2-689]\d{4})',
    8396 => '(?:[2578]\d{4})',
    84   => '(?:9(?:3[0-79]|6[0-8]|8[0-46-8]|9[013489]|0[5-9]|[2457]\d|1[6-9])\d{4})',
    845  => '(?:(?:2[02-8]|3[037])\d{4})',
    846  => '(?:(?:2[1-9]|6[2-8]|4[15-8]|3[138]|70)\d{4})',
    847  => '(?:(?:4[013-9]|5[1-9]|8[02-9]|2[02-57-9]|3[2-57-9]|6[126-8])\d{4})',
    8477 => '(?:[2-79]\d{4})',
    ...
    854  => '(?:(?:3[02-8]|5[1-8]|2[1-46-8]|7[2-7]|6[0-248]|9[025]|[48]\d)\d{4})',
    855  => '(?:(?:[38][02-578]|2[2-9]|5[1-7]|7[024-8]|4[024578]|6[02568]|9[2357])\d{4})',
    856  => '(?:(?:7[1-9]|2[2-9]|5[02568]|3[1-38]|8[08]|40)\d{4})',
    ...
    863  => '(?:(?:3[0-35]|[24][13]|7[1367]|5[135]|8[138]|66)\d{4})',
    865  => '(?:(?:4[2-578]|7[0-2578]|5[048]|6\d)\d{4})',
    866  => '(?:(?:2[1-35-9]|3[1-47-9]|5[124-8]|9[02-69]|6[235-8]|7[2-57]|8[2-478]|4[2568])\d{4})',
    867  => '(?:(?:7[0-8]|5[2-8]|4[0-24-6]|9[2-68]|6[25-8]|3[3-6]|2[57]|8[08])\d{4})',
    ...
    879  => '(?:(?:2[2-79]|6[124578]|5[235-7]|4[2389]|7[5-79]|8[248]|3[13])\d{4})',
    ...
    880  => '(?:(?:[26][02-9]|5[02-8]|7[2-79]|4[3469]|9[018]|[38]\d)\d{4})',
    883  => '(?:(?:6[1-8]|7[024-9]|8[02-8]|5[0-3568]|2[124-7]|3[03568]|4[235])\d{4})',
    884  => '(?:(?:2[1-8]|4[024589]|3[3-68]|[67]\d|8[01])\d{4})',
    885  => '(?:(?:3[2-9]|4[2-8])\d{4})',
    887  => '(?:(?:[23][02-9]|4[1-578]|8[2-48]|6[069]|9[078]|[57]\d)\d{4})',
    889  => '(?:(?:4[02-9]|5[024-9]|3[2-79]|2[0246-8]|6[25-8])\d{4})',
    ...
    959  => '(?:(?:[57][1-9]|3[0-79]|4[2-9]|8[02-46-8]|6[468]|2\d)\d{4})',
    ...
    966  => '(?:(?:2[02-9]|3[1-9]|4[2-9]|6[1-35-9]|8[2-46-9]|7[178]|55)\d{4})',
    967  => '(?:(?:6[02-8]|7[0-7]|2[2-578]|3[1-59]|8[2-58]|4[2468]|9[018]|55)\d{4})',
    968  => '(?:(?:7[1-9]|3[1-46-9]|2[2-8]|4[1-4689]|6[2-689]|8[024-8]|5[1-379])\d{4})',
    969  => '(?:(?:[25][2-8]|7[02-9]|3[1-79]|6[2-46-9]|4[25-7])\d{4})',
    97   => '(?:5(?:[39][2-9]|0[0-46-9]|5[1-8]|1[0-5]|7[3-689]|8[235689]|6[07-9]|[24]\d)\d{4})',
    972  => '(?:(?:[56][1-8]|3[0-79]|8[2-8]|4[2-68]|7[2379]|2\d)\d{4})',
    973  => '(?:(?:7[02-9]|5[2-8]|8[06-8]|3[0-2]|2\d)\d{4})',
    ...
    980  => '(?:(?:[78][02-9]|[45]\d|[39]8|66)\d{4})',
    9802 => '(?:[2-479]\d{4})',
    982  => '(?:(?:7[1-8]|8[1-36-9]|9[0-35-7]|[2-6]\d)\d{4})',
    983  => '(?:(?:4[1-9]|2[1-8]|3\d|55)\d{4})',
    984  => '(?:(?:2[1-7]|4[0-246-8]|3[1-357])\d{4})',
    985  => '(?:(?:4[0-57-9]|7[1-578]|8[2-689]|[2356]\d)\d{4})',
    986  => '(?:(?:5[1-57-9]|7[024-9]|3[036-9]|4[4-7]|6[2468]|8[08]|2\d)\d{4})',
    987  => '(?:(?:2[1-9]|7[0-8]|6[46-8]|3[1-3]|5[568])\d{4})',
    99   => '(?:(?:2(?:9[2-9]|1[02-4689]|0[1-468]|4[3-8]|8[1-6]|7[2-58]|[256]\d|3[089])|8(?:0[0-8]|1[1-4]|3[36-8]|2[128])|4(?:8[0-8]|0[018]|7\d)|3(?:4[357]|31))\d{4})',
    9912 => '(?:[2-479]\d{4})',
    9913 => '(?:[2379]\d{4})',
    993  => '(?:(?:2[1-8]|3[2-9]|5[1-35-9]|6[2-8]|8[3-9]|7[236-8]|4[019])\d{4})',
    994  => '(?:(?:2[02-9]|3[0-8]|5[1-358]|6[23578]|9[018]|4\d)\d{4})',
    995  => '(?:(?:2[02-9]|7[0-8]|6[2-9]|3[018]|[45]\d)\d{4})',
    996  => '(?:(?:6[1-9]|8[02-9]|7[1-57-9]|4[124578]|[235]\d)\d{4})',
    9969 => '(?:[2-9]\d{4})',
    997  => '(?:(?:2[02-9]|5[0-8]|6[1-35-9]|8[1-689]|9[2357]|[47]\d|33)\d{4})',
);
