...
=head3 FROM PACKAGE (RECOMMENDED)

There are prebuild packages of mtpolicyd available for several linux distributions. The easiest way is to install mtpolicyd by installing the package build for your distribution.
