...
sub import {
    ...
    *Char::ord           = \&Latin1::ord;
    *Char::ord_          = \&Latin1::ord_;
    *Char::reverse       = \&Latin1::reverse;
    *Char::getc          = \&Latin1::getc;
    *Char::length        = \&Latin1::length;
    *Char::substr        = \&Latin1::substr;
    *Char::index         = \&Latin1::index;
    *Char::rindex        = \&Latin1::rindex;
    *Char::eval          = \&Latin1::eval;
    *Char::escape        = \&Latin1::escape;
    *Char::escape_token  = \&Latin1::escape_token;
    *Char::escape_script = \&Latin1::escape_script;
}
...
my $qq_substr  = qr{(?> Char::substr | Latin1::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Elatin1::re_t=%s; while($Elatin1::re_t =~ %s){%s local $^W=0; local $Elatin1::re_r=%s; %s$Elatin1::re_t="$`$Elatin1::re_r$'"; pos($Elatin1::re_t)=length "$`$Elatin1::re_r"; } return $Elatin1::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Elatin1::re_r=CORE::eval $Elatin1::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Elatin1::re_r=%s; %s"%s$Elatin1::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Elatin1::re_n=0; while(%s =~ %s){%s local $^W=0; local $Elatin1::re_r=%s; %s%s="$`$Elatin1::re_r$'"; pos(%s)=length "$`$Elatin1::re_r"; $Elatin1::re_n++} return %s$Elatin1::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Elatin1::re_r=%s; %s%s="%s$Elatin1::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Elatin1::re_r=%s; %s%s="%s$Elatin1::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Elatin1::re_r=CORE::eval $Elatin1::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
