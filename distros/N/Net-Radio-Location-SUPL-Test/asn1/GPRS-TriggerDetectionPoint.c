...
asn_dec_rval_t
GPRS_TriggerDetectionPoint_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
GPRS_TriggerDetectionPoint_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_GPRS_TriggerDetectionPoint_constr_1 = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  3,  3,  0,  4 }	/* (0..4,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_GPRS_TriggerDetectionPoint_value2enum_1[] = {
	{ 1,	6,	"attach" },
...
static unsigned int asn_MAP_GPRS_TriggerDetectionPoint_enum2value_1[] = {
	0,	/* attach(1) */
...
static asn_INTEGER_specifics_t asn_SPC_GPRS_TriggerDetectionPoint_specs_1 = {
	asn_MAP_GPRS_TriggerDetectionPoint_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_GPRS_TriggerDetectionPoint_enum2value_1,	/* N => "tag"; sorted by N */
...
static ber_tlv_tag_t asn_DEF_GPRS_TriggerDetectionPoint_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_GPRS_TriggerDetectionPoint = {
	...
	GPRS_TriggerDetectionPoint_decode_uper,
	GPRS_TriggerDetectionPoint_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_GPRS_TriggerDetectionPoint_tags_1,
	sizeof(asn_DEF_GPRS_TriggerDetectionPoint_tags_1)
		/sizeof(asn_DEF_GPRS_TriggerDetectionPoint_tags_1[0]), /* 1 */
	asn_DEF_GPRS_TriggerDetectionPoint_tags_1,	/* Same as above */
	sizeof(asn_DEF_GPRS_TriggerDetectionPoint_tags_1)
		/sizeof(asn_DEF_GPRS_TriggerDetectionPoint_tags_1[0]), /* 1 */
	&asn_PER_type_GPRS_TriggerDetectionPoint_constr_1,
	0, 0,	/* Defined elsewhere */
	&asn_SPC_GPRS_TriggerDetectionPoint_specs_1	/* Additional specs */
};
