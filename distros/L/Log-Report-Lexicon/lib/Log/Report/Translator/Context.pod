...
[Added in L<Log::Report|Log::Report> v1.00]
...
L<Log::Report::Message|Log::Report::Message> object.  The C<$context> is the default context
...
In L<Log::Report|Log::Report>'s extended concept of "contexts", you can select between
...
So, L<Log::Report|Log::Report> translations add extra syntax:
