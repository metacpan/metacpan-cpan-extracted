package Bencher::ScenarioR::RegexpIPv4;
...
our $results = [
  [
    ...
    [
      ...
      {
        dataset    => "2001:cdba:0000:0000:0000:0000:3257:9652",
        errors     => 5.2e-10,
        rate       => 4000000,
        samples    => 20,
        time       => 250,
    ...
    ],
    {
      ...
      "func.elapsed_time"              => 0.0840590000152588,
      "func.module_startup"            => undef,
      "func.module_versions"           => {
                                            "__PACKAGE__" => 1.034,
                                            "Bencher::Scenario::RegexpIPv4" => undef,
                                            "Benchmark::Dumb" => "0.10",
      ...
      "func.precision"                 => 0,
      "func.scenario_module"           => "Bencher::Scenario::RegexpIPv4",
      "func.scenario_module_md5sum"    => "403a8090b8ed2824cfd654a7dcf6c71b",
      "func.scenario_module_mtime"     => 1476937505,
      "func.scenario_module_sha1sum"   => "6d43a820f3b52d30b33c90cd08b55f1c282220b7",
      "func.scenario_module_sha256sum" => "debd725c6e3d41cf45bd0de3a325f729989625704d6b0067ffe2a5055240f01d",
      "func.time_end"                  => 1485324364.7169,
      "func.time_factor"               => 1000000000,
      "func.time_start"                => 1485324364.63284,
