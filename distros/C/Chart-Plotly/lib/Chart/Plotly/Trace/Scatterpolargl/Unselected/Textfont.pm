package Chart::Plotly::Trace::Scatterpolargl::Unselected::Textfont;
use Moose;
...
Chart::Plotly::Trace::Scatterpolargl::Unselected::Textfont - This attribute is one of the possible options for the trace scatterpolargl.
