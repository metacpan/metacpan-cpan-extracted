...
Perinci::Sub::XCompletion::date_dow_num_id - Generate completion for date::dow_num::id

=head1 VERSION

This document describes version 0.005 of Perinci::Sub::XCompletion::date_dow_num_id (from Perl distribution Sah-Schemas-Date-ID), released on 2020-03-08.
