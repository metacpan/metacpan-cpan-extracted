...
static asn_TYPE_member_t asn_MBR_GANSSDataBitAssist_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GANSSDataBitAssist, ganssDataBitsSatList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SeqOfGanssDataBitsElement,
...
static asn_TYPE_tag2member_t asn_MAP_GANSSDataBitAssist_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ganssTOD at 1484 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ganssDataBitsSatList at 1486 */
};
