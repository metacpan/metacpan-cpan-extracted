...
Sah::SchemaR::filename::default_newest_file_in_curdir - File name, defaults to newest file in current directory (if there is one)

=head1 VERSION

This document describes version 0.031 of Sah::SchemaR::filename::default_newest_file_in_curdir (from Perl distribution Sah-SchemaBundle-Path), released on 2024-02-16.
