...
# ====
#
# Daje::Database::View::Super::vCompaniesUsers - Daje db model
#
# SYNOPSIS
# ========
#
#
#       use Daje::Database::View::Super::vCompaniesUsers;
#
#       my $table = Daje::Database::View::Super::vCompaniesUsers->new(db => $db);
#
...
# ===========
#
# Daje::Database::View::Super::vCompaniesUsers is a View super class
#
# METHODS
# =======
#
...
has 'fields' => '"companies_users_pkey", "editnum", "insby", "insdatetime", "modby", "moddatetime","comment","companies_companies_fkey","users_users_fkey"';
has 'primary_key_name' => "companies_users_pkey";
has 'table_name' => "v_companies_users";
