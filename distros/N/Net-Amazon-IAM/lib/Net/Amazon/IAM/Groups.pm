package Net::Amazon::IAM::Groups;
use Moose;

=head1 NAME

Net::Amazon::IAM::Groups

=head1 DESCRIPTION

A class representing a IAM Groups list.
...
request using the Marker request parameter to retrieve more groups in the list.
...
has 'Groups' => (
   is       => 'ro',
   isa      => 'Maybe[ArrayRef[Net::Amazon::IAM::Group]]',
   required => 0,
);
