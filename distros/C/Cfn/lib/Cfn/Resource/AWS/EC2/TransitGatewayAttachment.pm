# AWS::EC2::TransitGatewayAttachment generated from spec 2.16.0
...
package Cfn::Resource::Properties::AWS::EC2::TransitGatewayAttachment {
  ...
  has SubnetIds => (isa => 'Cfn::Value::Array|Cfn::Value::Function', is => 'rw', coerce => 1, required => 1, traits => [ 'CfnMutability' ], mutability => 'Immutable');
