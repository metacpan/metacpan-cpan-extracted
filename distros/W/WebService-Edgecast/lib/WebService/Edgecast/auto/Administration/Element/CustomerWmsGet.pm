...
package WebService::Edgecast::auto::Administration::Element::CustomerWmsGet;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerWmsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerWmsGet');
...
WebService::Edgecast::auto::Administration::Element::CustomerWmsGet
...
CustomerWmsGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerWmsGet->new($data);
