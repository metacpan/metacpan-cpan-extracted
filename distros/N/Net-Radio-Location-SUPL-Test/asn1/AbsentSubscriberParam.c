...
static int asn_MAP_AbsentSubscriberParam_oms_1[] = { 0, 1 };
...
static asn_TYPE_tag2member_t asn_MAP_AbsentSubscriberParam_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 0 }, /* extensionContainer at 258 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 1, 0, 0 } /* absentSubscriberReason at 260 */
};
static asn_SEQUENCE_specifics_t asn_SPC_AbsentSubscriberParam_specs_1 = {
	...
	asn_MAP_AbsentSubscriberParam_oms_1,	/* Optional members */
	1, 1,	/* Root/Additions */
	0,	/* Start extensions */
	3	/* Stop extensions */
};
