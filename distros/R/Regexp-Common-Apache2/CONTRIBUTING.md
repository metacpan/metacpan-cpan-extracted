...
I welcome any contribution to Regexp::Common::Apache2, including, but not limited to bug reports, feature requests, general comments, and patches.

Feel free to clone it from its gitlab repository at <https://git.deguest.jp/jack/Regexp-Common-Apache2> and issue a pull request.
...
File [an issue on CPAN bug tracker](https://rt.cpan.org/Public/Dist/Display.html?Name=Regexp-Common-Apache2) if you think you've found a bug. Please describe
...
Issues are currently reported using CPAN [bug tracker](https://git.deguest.jp/jack/Regexp-Common-Apache2/issues)

## More information

Please refer to the [README](https://metacpan.org/source/JDEGUEST/Regexp-Common-Apache2-v0.1.0/README.md)
