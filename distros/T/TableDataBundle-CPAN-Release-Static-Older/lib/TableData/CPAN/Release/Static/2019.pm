package ## no critic: Modules::RequireFilenameMatchesPackage
    # hide from PAUSE
    TableDataRole::CPAN::Release::Static::2019;
...
around new => sub {
    ...
    unless (-f $filename) {
        ...
        $filename = File::ShareDir::dist_file('TableDataBundle-CPAN-Release-Static-Older', '2019.csv');
    }
    $orig->(@_, filename=>$filename);
};

package TableData::CPAN::Release::Static::2019;
...
with 'TableDataRole::CPAN::Release::Static::2019';
...
TableDataRole::CPAN::Release::Static::2019 - CPAN releases for the year 2019

=head1 VERSION

This document describes version 20210927.0 of TableDataRole::CPAN::Release::Static::2019 (from Perl distribution TableDataBundle-CPAN-Release-Static-Older), released on 2021-09-27.

=head1 SYNOPSIS

 use TableData::CPAN::Release::Static::2019;

 my $td = TableData::CPAN::Release::Static::2019->new;
