package Chart::Plotly::Trace::Histogram::Textfont;
use Moose;
...
Chart::Plotly::Trace::Histogram::Textfont - This attribute is one of the possible options for the trace histogram.
