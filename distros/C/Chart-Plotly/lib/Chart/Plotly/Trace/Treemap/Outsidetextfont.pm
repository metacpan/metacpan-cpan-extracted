package Chart::Plotly::Trace::Treemap::Outsidetextfont;
use Moose;
...
Chart::Plotly::Trace::Treemap::Outsidetextfont - This attribute is one of the possible options for the trace treemap.
