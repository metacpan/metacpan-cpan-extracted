...
our %STATS = ("num_columns",2,"num_rows",2847); # STATS
...
TableDataRole::Business::ID::DGIP::Class::29 - List of products/services in class 29 ("Meat, fish & poultries; preserved fruits/vegetables; jams; eggs & milks; edible oils & fats") in Indonesian DGIP (Directorate General of Intellectual Property)

=head1 VERSION

This document describes version 20230207.0.0 of TableDataRole::Business::ID::DGIP::Class::29 (from Perl distribution TableDataBundle-Business-ID-DGIP), released on 2023-02-07.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Business::ID::DGIP::Class::29;

 my $td = TableData::Business::ID::DGIP::Class::29->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Business::ID::DGIP::Class::29 --page

 # Get number of rows
 % tabledata --action count_rows Business::ID::DGIP::Class::29
