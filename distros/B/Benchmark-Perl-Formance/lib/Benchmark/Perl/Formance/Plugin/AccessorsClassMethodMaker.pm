package Benchmark::Perl::Formance::Plugin::AccessorsClassMethodMaker;
...
Benchmark::Perl::Formance::Plugin::AccessorsClassMethodMaker - benchmark plugin - Compare OO'ish accessors
