package Microsoft::AdCenter::V7::ReportingService::Test::ShareOfVoiceReportRequest;
...
use Microsoft::AdCenter::V7::ReportingService::ShareOfVoiceReportRequest;

sub test_can_create_share_of_voice_report_request_and_set_all_fields : Test(6) {
    my $share_of_voice_report_request = Microsoft::AdCenter::V7::ReportingService::ShareOfVoiceReportRequest->new
