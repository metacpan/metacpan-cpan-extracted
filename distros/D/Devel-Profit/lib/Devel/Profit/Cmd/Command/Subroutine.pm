package Devel::Profit::Cmd::Command::Subroutine;
use strict;
use warnings;
use IO::File;
use PPI;
...
sub usage_desc {
    my $self = shift;
    return "devel_profit subroutine [--filename other.out]";
}

sub abstract {
    my $self = shift;
    return 'Profile by package and subroutine';
}
