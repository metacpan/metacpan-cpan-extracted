...
#
package AgentPushKit::Client::Object::ServicePreference;
...
sub from_hash {
    ...
    while ( my ($_key, $_type) = each %{$self->openapi_types} ) {
        my $_json_attribute = $self->attribute_map->{$_key};
        if (!defined $hash->{$_json_attribute}) {
            $self->{$_key} = undef;
...
__PACKAGE__->method_documentation({
    ...
    'type_overrides' => {
        datatype => 'ARRAY[TypeOverride]',
        base_name => 'typeOverrides',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    ...
    'display_name' => 'string',
    'enabled' => 'boolean',
    'type_overrides' => 'ARRAY[TypeOverride]'
} );
