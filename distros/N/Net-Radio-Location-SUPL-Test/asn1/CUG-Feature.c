...
static int asn_MAP_CUG_Feature_oms_1[] = { 0, 1, 3 };
static ber_tlv_tag_t asn_DEF_CUG_Feature_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CUG_Feature_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 1, 0, 0 }, /* preferentialCUG-Indicator at 1703 */
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 2, 0, 0 }, /* interCUG-Restrictions at 1704 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, 0, 0 }, /* extensionContainer at 1705 */
...
static asn_SEQUENCE_specifics_t asn_SPC_CUG_Feature_specs_1 = {
	...
	asn_MAP_CUG_Feature_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	3,	/* Start extensions */
	5	/* Stop extensions */
};
