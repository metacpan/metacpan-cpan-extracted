...
$Search::Elasticsearch::Client::0_90::Role::API::VERSION = '5.02';
use Moo::Role;
...
Search::Elasticsearch::Client::0_90::Role::API - This class contains the spec for the Elasticsearch APIs
