...
#===============================================================================
#         FILE: 003_samples.t
#  DESCRIPTION: test Sys::OsRelease::Lite with samples from various OS's 
...
foreach my $file (sort keys %{$test_config->{files}}) {
    # instantiate
    my $osrelease = Sys::OsRelease::Lite->instance(search_path => [$input_dir], file_name => $file);
    #require Data::Dumper;
    ...
    isa_ok($osrelease, "Sys::OsRelease::Lite", "$file: instance is correct type");
    ...
    Sys::OsRelease::Lite->clear_instance();
}
