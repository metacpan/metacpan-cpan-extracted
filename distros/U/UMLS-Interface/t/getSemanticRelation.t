...
my $perl     = $^X;
my $util_prg = File::Spec->catfile('utils', 'getSemanticRelation.pl');

my ($keyfile, $file, $output, $st1, $st2);
...
$st1    = "bpoc";
$st2    = "cell";
$file    = "getSemanticRelation.$st1.$st2";
$keyfile = File::Spec->catfile($keydir, $file);
$output = `$perl $util_prg $st1 $st2 2>&1`;
