...
1;
# ABSTRACT: Single line border with ASCII characters, horizontal only
...
BorderStyle::ASCII::SingleLineHorizontalOnly - Single line border with ASCII characters, horizontal only

=head1 VERSION

This document describes version 0.013 of BorderStyle::ASCII::SingleLineHorizontalOnly (from Perl distribution BorderStyles-Standard), released on 2022-02-14.
...
To use with L<Text::ANSITable>:
 ...
 $t->border_style("ASCII::SingleLineHorizontalOnly");
 $t->columns($rows->[0]);
...
To use with L<Text::Table::More>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"ASCII::SingleLineHorizontalOnly");
...
To use with L<Text::Table::TinyBorderStyle>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"BorderStyle::ASCII::SingleLineHorizontalOnly");
