...
package Google::Ads::AdWords::v201607::BudgetOrderService::get;
use strict;
use warnings;
...
get from the namespace https://adwords.google.com/api/adwords/billing/v201607.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201607::BudgetOrderService::get->new($data);
