...
$HTML::Mason::Exceptions::VERSION = '1.60';
use strict;
use warnings;
...
$HTML::Mason::Exception::VERSION = '1.60';
...
$HTML::Mason::Exception::Compilation::VERSION = '1.60';
sub full_message
{
    my $self = shift;
...
$HTML::Mason::Exception::Syntax::VERSION = '1.60';
sub full_message
{
    my $self = shift;
