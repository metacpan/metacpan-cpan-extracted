...
[File an issue](https://github.com/dyacob/Convert-Number-Coptic/issues) if you think you've found a [bug](https://en.wikipedia.org/wiki/Software_bug). Please describe the following:
