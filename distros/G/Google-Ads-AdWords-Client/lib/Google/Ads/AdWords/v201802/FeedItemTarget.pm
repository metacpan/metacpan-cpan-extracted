package Google::Ads::AdWords::v201802::FeedItemTarget;
use strict;
use warnings;
...
Google::Ads::AdWords::v201802::FeedItemTarget

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItemTarget from the namespace https://adwords.google.com/api/adwords/cm/v201802.
