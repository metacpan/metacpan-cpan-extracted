...
B<before_validate> is fired just once for the form, before any field is validated. It is passed a hashref - the input data. This method is free to do anything with the input, but its return value is discarded.
...
=item * L<Form::Tiny>, the importer class for this distribution
