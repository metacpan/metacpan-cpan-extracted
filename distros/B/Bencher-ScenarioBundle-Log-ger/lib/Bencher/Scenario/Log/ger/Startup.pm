...
1;
# ABSTRACT: Benchmark startup of Log::ger vs some other modules
...
Bencher::Scenario::Log::ger::Startup - Benchmark startup of Log::ger vs some other modules

=head1 VERSION

This document describes version 0.020 of Bencher::Scenario::Log::ger::Startup (from Perl distribution Bencher-ScenarioBundle-Log-ger), released on 2024-05-12.

=head1 SYNOPSIS

To run benchmark with default option:

 % bencher -m Log::ger::Startup
...
Result formatted as table:
 ...
 +---------------------+-----------+-------------------+-----------------------+-----------------------+---------+---------+
 | Log::Any            |     14.4  |              7.47 |                 0.00% |               107.90% | 4.4e-06 |      20 |
 | Log::ger            |      7.71 |              0.78 |                86.89% |                11.24% | 6.5e-06 |      20 |
 | perl -e1 (baseline) |      6.93 |              0    |               107.90% |                 0.00% | 5.2e-06 |      20 |
 +---------------------+-----------+-------------------+-----------------------+-----------------------+---------+---------+


The above result formatted in L<Benchmark.pm|Benchmark> style:

                          Rate   L:A   L:g  perl -e1 (baseline) 
  L:A                   69.4/s    --  -46%                 -51% 
  L:g                  129.7/s   86%    --                 -10% 
  perl -e1 (baseline)  144.3/s  107%   11%                   -- 
 
 Legends:
   L:A: mod_overhead_time=7.47 participant=Log::Any
   L:g: mod_overhead_time=0.78 participant=Log::ger
