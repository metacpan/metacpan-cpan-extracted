use utf8;
package Schema::RackTables::0_20_1::Result::PortNativeVLAN;
...
Schema::RackTables::0_20_1::Result::PortNativeVLAN
...
Related object: L<Schema::RackTables::0_20_1::Result::PortAllowedVLAN>

=cut

__PACKAGE__->belongs_to(
  "port_allowed_vlan",
  "Schema::RackTables::0_20_1::Result::PortAllowedVLAN",
  {
    object_id => "object_id",
    port_name => "port_name",
    vlan_id   => "vlan_id",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:EXea/mXozZKhPcE5lELN8w
