package ## no critic: Modules::RequireFilenameMatchesPackage
    # hide from PAUSE
    TableDataRole::Perl::CPAN::Release::Static::2021;
...
around new => sub {
    ...
    unless (-f $filename) {
        ...
        $filename = File::ShareDir::dist_file('TableData-Perl-CPAN-Release-Static-2021', '2021.csv');
    }
    $orig->(@_, filename=>$filename);
};

package TableData::Perl::CPAN::Release::Static::2021;
...
our $DIST = 'TableData-Perl-CPAN-Release-Static-2021'; # DIST
our $VERSION = '20210928.2'; # VERSION

with 'TableDataRole::Perl::CPAN::Release::Static::2021';
...
TableDataRole::Perl::CPAN::Release::Static::2021 - CPAN releases for the year 2021

=head1 VERSION

This document describes version 20210928.2 of TableDataRole::Perl::CPAN::Release::Static::2021 (from Perl distribution TableData-Perl-CPAN-Release-Static-2021), released on 2021-10-05.
...
Please visit the project's homepage at L<https://metacpan.org/release/TableData-Perl-CPAN-Release-Static-2021>.
...
Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=TableData-Perl-CPAN-Release-Static-2021>
