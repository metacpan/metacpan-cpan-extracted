...
Test::Shared::Fixture::Wikibase::Datatype::Snak::Wikidata::InstanceOf::Human - Test instance for Wikidata snak.
...
=for comment filename=fixture_create_and_print_snak_wd_instance_of_human.pl
...
L<Test::Shared::Fixture::Wikibase::Datatype::Value::Item::Wikidata::Human>,
