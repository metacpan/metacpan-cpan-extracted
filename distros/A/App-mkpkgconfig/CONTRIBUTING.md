...
comfortable using that, drop a line to Diab Jerius <djerius@sao.si.edu>.
...
at this website:
  ...
  https://rt.cpan.org/Public/Dist/Display.html?Name=App-mkpkgconfig

or via email to:

  bug-app-mkpkgconfig@rt.cpan.org
