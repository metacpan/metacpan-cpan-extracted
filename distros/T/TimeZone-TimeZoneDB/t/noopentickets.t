...
use constant SITE =>'https://api.github.com/repos/nigelhorne/TimeZone-TimeZoneDB/issues';
...
RT: {
	...
	SKIP: {
		if($ENV{AUTHOR_TESTING}) {
			...
			} elsif(my @rc = @{WWW::RT::CPAN::list_dist_active_tickets(dist => 'TimeZone-TimeZoneDB')}) {
				ok($rc[0] == 200);
				ok($rc[1] eq 'OK');
