package Chart::Plotly::Trace::Treemap::Insidetextfont;
use Moose;
...
Chart::Plotly::Trace::Treemap::Insidetextfont - This attribute is one of the possible options for the trace treemap.
