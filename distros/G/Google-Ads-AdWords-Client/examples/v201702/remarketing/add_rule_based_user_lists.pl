...
use Google::Ads::AdWords::v201702::DateKey;
use Google::Ads::AdWords::v201702::DateRuleItem;
use Google::Ads::AdWords::v201702::DateSpecificRuleUserList;
use Google::Ads::AdWords::v201702::ExpressionRuleUserList;
use Google::Ads::AdWords::v201702::NumberKey;
use Google::Ads::AdWords::v201702::NumberRuleItem;
use Google::Ads::AdWords::v201702::Operator;
use Google::Ads::AdWords::v201702::Rule;
use Google::Ads::AdWords::v201702::RuleItem;
use Google::Ads::AdWords::v201702::RuleItemGroup;
use Google::Ads::AdWords::v201702::StringKey;
use Google::Ads::AdWords::v201702::StringRuleItem;
...
sub add_rule_based_user_lists {
  ...
  my $checkout_string_rule_item =
    Google::Ads::AdWords::v201702::StringRuleItem->new({
      key => Google::Ads::AdWords::v201702::StringKey->new(
        {name => "ecomm_pagetype"}
      ),
      op    => "EQUALS",
      value => "checkout"
    });
  my $checkout_rule_item = Google::Ads::AdWords::v201702::RuleItem->new(
    {StringRuleItem => $checkout_string_rule_item});

  my $cart_size_number_rule_item =
    Google::Ads::AdWords::v201702::NumberRuleItem->new({
      key =>
        Google::Ads::AdWords::v201702::NumberKey->new({name => "cartsize"}),
      op    => "GREATER_THAN",
      value => "1"
    });
  my $cart_size_rule_item = Google::Ads::AdWords::v201702::RuleItem->new(
  ...
  my $checkout_multiple_item_group =
    Google::Ads::AdWords::v201702::RuleItemGroup->new(
  ...
  my $start_date_date_rule_item =
    Google::Ads::AdWords::v201702::DateRuleItem->new({
      key =>
        Google::Ads::AdWords::v201702::DateKey->new({name => "checkoutdate"}),
      op    => "AFTER",
      value => $rule_start_date
    });

  my $start_date_rule_item = Google::Ads::AdWords::v201702::RuleItem->new(
  ...
  my $end_date_rule_item = Google::Ads::AdWords::v201702::RuleItem->new(
  ...
  # together.
  my $rule = Google::Ads::AdWords::v201702::Rule->new({
      groups => [
  ...
  my $expression_user_list =
    Google::Ads::AdWords::v201702::ExpressionRuleUserList->new({
  ...
  my $date_user_list =
    Google::Ads::AdWords::v201702::DateSpecificRuleUserList->new({
  ...
  my $operations = [
    Google::Ads::AdWords::v201702::UserListOperation->new({
        operator => "ADD",
