  ...
  { dist_root => 'does-not-exist' },
  {
    add_files => {
      path('source', 'dist.ini') => simple_ini({},
        ['@Starter' => { revision => 5, installer => 'ModuleBuild', 'ModuleBuild.mb_class' => 'My::Module::Builder' }],
        [Prereqs => { 'perl' => '5.006' }],
      ),
...
like $build_pl, qr/Module::Build/, 'Build.PL uses Module::Build';
like $build_pl, qr/My::Module::Builder/, 'Build.PL uses Module::Build subclass';
