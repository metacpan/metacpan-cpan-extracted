...
eval { $v .= pmver('Catalyst::Action::Serialize::SimpleExcel','0.015') };
...
eval { $v .= pmver('CatalystX::Controller::ExtJS::REST','any version') };
eval { $v .= pmver('CatalystX::ExtJS','2.0.0') };
...
eval { $v .= pmver('Moose::Meta::Role::Application::ToClass','any version') };
