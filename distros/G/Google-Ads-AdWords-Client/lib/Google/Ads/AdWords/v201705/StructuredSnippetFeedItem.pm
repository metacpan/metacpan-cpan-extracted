package Google::Ads::AdWords::v201705::StructuredSnippetFeedItem;
use strict;
use warnings;
...
StructuredSnippetFeedItem from the namespace https://adwords.google.com/api/adwords/cm/v201705.
