package Chart::Plotly::Trace::Sunburst::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Sunburst::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Sunburst::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Sunburst::Legendgrouptitle - This attribute is one of the possible options for the trace sunburst.
