...
#
#=======================================================================
package PDF::API3::Compat::API2::Resource::XObject::Form::Hybrid;
...
BEGIN {
    ...
    use PDF::API3::Compat::API2::Resource::XObject::Form;
    ...
    @ISA = (
        'PDF::API3::Compat::API2::Content',
        'PDF::API3::Compat::API2::Resource::XObject::Form'
    );
...
=item $res = PDF::API3::Compat::API2::Resource::XObject::Form::Hybrid->new $pdf
...
sub new {
    ...
    $self=PDF::API3::Compat::API2::Resource::XObject::Form::new($class,$pdf,pdfkey());
...
=item $res = PDF::API3::Compat::API2::Resource::XObject::Form::Hybrid->new_api $api, $name
...
sub outobjdeep {
    ...
    PDF::API3::Compat::API2::Basic::PDF::Dict::outobjdeep($self,@opts);
}
