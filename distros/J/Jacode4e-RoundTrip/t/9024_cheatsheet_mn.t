...
# Энэ файл UTF-8 кодлолтоор бичигдсэн.
...
#
#   $line             : хөрвүүлэх мөр (лавлагаагаар дамжуулж, байранд нь дарж бичнэ)
#   $OUTPUT_encoding  : гаралтын кодлолтын нэр
#   $INPUT_encoding   : оролтын кодлолтын нэр
#   $char_count       : хөрвүүлсний дараах тэмдэгтийн тоо
#
# [КОДЛОЛТЫН НЭРСИЙН ЖАГСААЛТ]
#
#   товчлол     тайлбар
#   ---------   ---------------------------------------------------
#   cp932x      CP932X (JIS X 0213 рүү өргөтгөл, нэг шилжилт 0x9C5A)
#   cp932       Microsoft CP932 (Windows-31J / IANA бүртгэлтэй нэр)
#   cp932ibm    IBM CP932
#   cp932nec    NEC CP932
...
#   jef         FUJITSU JEF (12pt, OUTPUT_SHIFTING ашиглан шилжилт код)
#   jef9p       FUJITSU JEF ( 9pt, OUTPUT_SHIFTING ашиглан шилжилт код)
#   jipsj       NEC JIPS(J)
#   jipse       NEC JIPS(E)
#   letsj       UNISYS LetsJ
#   utf8        UTF-8.0 (ердийн UTF-8)
#   utf8.1      UTF-8.1 (CP932 биш, Shift_JIS-Unicode хөрвүүлгийн хүснэгтэд суурилсан)
#   utf8jp      UTF-8-SPUA-JP (JIS X 0213 Unicode SPUA руу зураглагдсан)
#
# [СОНГОЛТУУД]
#
#   түлхүүр          утга / тайлбар
#   ---------------  ---------------------------------------------------
#   INPUT_LAYOUT     оролтын бичлэгийн зохион байгуулалт ('S'=SBCS, 'D'=DBCS)
#   OUTPUT_SHIFTING  үнэн бол гаралтад DBCS дарааллын эргэн тойронд шилжилт код нэмнэ
#   SPACE            DBCS/MBCS зайн код (хоёртын мөр)
#   GETA             зураглах боломжгүй тэмдэгтүүдийн гэта тэмдэг
#   OVERRIDE_MAPPING тэмдэгт тус бүрийн орлуулалт { "\x12\x34"=>"\x56\x78" }
#
# [АНХААРУУЛГА: ХОЁР ЧИГЛЭЛИЙН ХӨРВҮҮЛЭЛТ]
#
#   Алдагдалтай хөрвүүлэлтүүд байдаг (жш: CP932 нь 398 буцаах боломжгүй зураглалтай).
# [Jacode4e ба Jacode4e::RoundTrip-ийн ялгаа]
#
#   Jacode4e              : Хурдан нэг чиглэлийн хөрвүүлэлт. Зарим тэмдэгтүүдэд
#                           алдагдалтай (жш: CP932 нь 398 буцаах боломжгүй
#                           зураглалтай).
#   Jacode4e::RoundTrip   : Unicode тэнхлэгээр хоёр чиглэлийн нарийвчлалыг
#                           баталгаажуулна. A->B->A үргэлж ижил. Jacode4e-ээс
#                           удаан боловч өгөгдөл буцаан ирэх шаардлагатай үед ашиглана.
#
#   Хоёр чиглэлийн хөрвүүлэлт шаардлагагүй бол Jacode4e модулийг ашиглана уу.
#
# ======================================================================
...
BEGIN {
    ...
    @test = (
        ...
        ["\x81\x40", 'cp00930', 'cp932', {}, "\x40\x40", 'cp932(8140)->cp00930 шилжилтгүй(4040)'],
        ...
        ["\x81\x40\x31", 'keis83', 'cp932', {}, "\xA1\xA1\xF1",
            'cp932(814031)->keis83 шилжилтгүй(A1A1F1)'],
        ...
        ["\x81\x60", 'utf8', 'cp932', {'INPUT_LAYOUT'=>'D'}, "\xE3\x80\x9C",
            'cp932(8160 долгион зураас)->utf8(E3809C U+301C)'],
