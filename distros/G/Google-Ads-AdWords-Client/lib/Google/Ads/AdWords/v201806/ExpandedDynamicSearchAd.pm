package Google::Ads::AdWords::v201806::ExpandedDynamicSearchAd;
use strict;
use warnings;
...
Google::Ads::AdWords::v201806::ExpandedDynamicSearchAd

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ExpandedDynamicSearchAd from the namespace https://adwords.google.com/api/adwords/cm/v201806.
