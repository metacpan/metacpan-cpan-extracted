...
This module only works with reference data, such as array, hash or reference to scalar. Anything that L<Storable::Improved> knows how to L<Storable::Improved/freeze> and L<Storable::Improved/thaw>
...
Write the data provided to the shared memory, after having encoded it using L<JSON>, L<CBOR|CBOR::XS>, L<Sereal> or L<Storable::Improved/freeze> depending on your choice. See L</json>, L</cbor>, L</sereal> and L</storable>
