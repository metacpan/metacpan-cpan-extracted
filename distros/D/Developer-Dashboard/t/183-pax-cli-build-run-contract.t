...
# share/private-cli/pax's own `use lib "$Bin/../lib"` resolves to
# share/lib (nonexistent) when invoked directly as a subprocess from this
# test rather than through dashboard's own staging/bootstrap, which sets
# PERL5LIB before ever reaching a staged helper - so this test sets it
# explicitly to the real repo lib/ for every subprocess invocation below.
