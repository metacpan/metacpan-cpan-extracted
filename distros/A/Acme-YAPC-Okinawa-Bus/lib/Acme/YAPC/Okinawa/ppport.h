...
=head1 SYNOPSIS
  ...
  perl lib/Acme/YAPC/Okinawa/ppport.h [options] [source files]
  ...
  --strip                     strip all script and doc functionality from
                              lib/Acme/YAPC/Okinawa/ppport.h
...
This version of F<lib/Acme/YAPC/Okinawa/ppport.h> is designed to support operation with Perl
...
Display the version of F<lib/Acme/YAPC/Okinawa/ppport.h>.
...
Tell F<lib/Acme/YAPC/Okinawa/ppport.h> to check for compatibility with the given
...
Strip all script and documentation functionality from F<lib/Acme/YAPC/Okinawa/ppport.h>.
This reduces the size of F<lib/Acme/YAPC/Okinawa/ppport.h> dramatically and may be useful
if you want to include F<lib/Acme/YAPC/Okinawa/ppport.h> in smaller modules without
increasing their distribution size too much.

The stripped F<lib/Acme/YAPC/Okinawa/ppport.h> will have a C<--unstrip> option that allows
...
F<lib/Acme/YAPC/Okinawa/ppport.h>. Also lists if it must be explicitly requested,
if it has dependencies, and if there are hints or warnings for it.

=head2 --list-unsupported

Lists the API elements that are known not to be supported by
F<lib/Acme/YAPC/Okinawa/ppport.h> and below which version of Perl they probably
...
earlier Perl releases. Use
    ...
    perl lib/Acme/YAPC/Okinawa/ppport.h --list-provided
...
more C<#define>s in your source code before the inclusion of F<lib/Acme/YAPC/Okinawa/ppport.h>.
...
macro. Just C<#define> the macro before including C<lib/Acme/YAPC/Okinawa/ppport.h>:

    #define DPPP_NAMESPACE MyOwnNamespace_
    #include "lib/Acme/YAPC/Okinawa/ppport.h"
...
use something like this:
    ...
    perl lib/Acme/YAPC/Okinawa/ppport.h --compat-version=5.6.0 --cplusplus --patch=test.diff

If you only want your code to be scanned without any suggestions
for changes, use:

    perl lib/Acme/YAPC/Okinawa/ppport.h --nochanges

You can specify a different C<diff> program or options, using
the C<--diff> option:

    perl lib/Acme/YAPC/Okinawa/ppport.h --diff='diff -C 10'

This would output context diffs with 10 lines of context.

If you want to create patched copies of your files instead, use:

    perl lib/Acme/YAPC/Okinawa/ppport.h --copy=.new

To display portability information for the C<newSVpvn> function,
use:

    perl lib/Acme/YAPC/Okinawa/ppport.h --api-info=newSVpvn

Since the argument to C<--api-info> can be a regular expression,
you can use

    perl lib/Acme/YAPC/Okinawa/ppport.h --api-info=/_nomg$/

to display portability information for all C<_nomg> functions or

    perl lib/Acme/YAPC/Okinawa/ppport.h --api-info=/./

to display information for all known API elements.

=head1 BUGS

If this version of F<lib/Acme/YAPC/Okinawa/ppport.h> is causing failure during
 ...
 * 5.005 perls, you can use aTHXR (supplied by lib/Acme/YAPC/Okinawa/ppport.h), which will
...
/* Hint: SvPVbyte
 * Does not work in perl-5.6.1, lib/Acme/YAPC/Okinawa/ppport.h implements a version
...
/* End of File lib/Acme/YAPC/Okinawa/ppport.h */
