...
Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::GivenName::Douglas - Test instance for Wikidata statement.

=head1 SYNOPSIS

 use Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::GivenName::Douglas;

 my $obj = Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::GivenName::Douglas->new(%params);
 my $id = $obj->id;
...
L<Test::Shared::Fixture::Wikibase::Datatype::Snak::Wikidata::GivenName::Douglas>,
