package Chart::Plotly::Trace::Scatterternary::Selected::Marker;
use Moose;
...
Chart::Plotly::Trace::Scatterternary::Selected::Marker - This attribute is one of the possible options for the trace scatterternary.
