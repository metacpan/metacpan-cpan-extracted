package Bencher::Scenarios::Text::Table::Sprintf;
...
Bencher::Scenarios::Text::Table::Sprintf - Scenarios for benchmarking Text::Table::Sprintf

=head1 VERSION

This document describes version 0.001 of Bencher::Scenarios::Text::Table::Sprintf (from Perl distribution Bencher-Scenarios-Text-Table-Sprintf), released on 2023-11-11.
...
=item * L<Bencher::Scenario::Text::Table::Sprintf::Startup>

=item * L<Bencher::Scenario::Text::Table::Sprintf::Render>
