package Test::Shared::Fixture::Wikibase::Datatype::Value::Lexeme::Wikidata::Dorota;

use base qw(Wikibase::Datatype::Value::Lexeme);
use strict;
use warnings;
...
Test::Shared::Fixture::Wikibase::Datatype::Value::Lexeme::Wikidata::Dorota - Test instance for Wikidata lexeme value.

=head1 SYNOPSIS

 use Test::Shared::Fixture::Wikibase::Datatype::Value::Lexeme::Wikidata::Michal;
...
=for comment filename=fixture_create_and_print_value_lexeme_wd_dorota.pl
