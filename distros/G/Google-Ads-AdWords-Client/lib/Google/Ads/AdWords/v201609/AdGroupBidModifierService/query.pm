...
package Google::Ads::AdWords::v201609::AdGroupBidModifierService::query;
use strict;
use warnings;
...
query from the namespace https://adwords.google.com/api/adwords/cm/v201609.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201609::AdGroupBidModifierService::query->new($data);
