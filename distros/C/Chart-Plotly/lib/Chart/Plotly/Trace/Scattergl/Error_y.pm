package Chart::Plotly::Trace::Scattergl::Error_y;
use Moose;
...
Chart::Plotly::Trace::Scattergl::Error_y - This attribute is one of the possible options for the trace scattergl.
