...
END
            ...
            if ($list !~ /\A (?>\s*) \z/oxms) {
                ...
                for (@list) {
                    ...
                    $Elatin5::function_ord     = $Elatin5::function_ord;
                    $Elatin5::function_ord_    = $Elatin5::function_ord_;
                    $Elatin5::function_reverse = $Elatin5::function_reverse;
                    $Elatin5::function_getc    = $Elatin5::function_getc;
                }
            }
        }
    }
