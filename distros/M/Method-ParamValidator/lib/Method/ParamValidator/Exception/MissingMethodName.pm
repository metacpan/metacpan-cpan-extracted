...
$Method::ParamValidator::Exception::MissingMethodName::VERSION   = '0.15';
$Method::ParamValidator::Exception::MissingMethodName::AUTHORITY = 'cpan:MANWAR';

=head1 NAME

Method::ParamValidator::Exception::MissingMethodName - Handles 'missing method name' exception.
...
has reason => (is => 'ro', default => sub { 'Missing method name.' });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Method::ParamValidator::Exception::MissingMethodName
...
1; # End of Method::ParamValidator::Exception::MissingMethodName
