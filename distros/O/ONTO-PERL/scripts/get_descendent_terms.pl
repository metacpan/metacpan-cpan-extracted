#!/usr/bin/env perl
# $Id: get_descendent_terms.pl 2015-10-29 erick.antezana $
#
...
sub print_help {
	print "\n";
	print "\tdescription: Collects the descendent terms from a given term in the given OBO ontology.\n";
	print "\tusage      : get_descendent_terms.pl [options]\n";
	print "\toptions    :\n";
	print "\t\t-f  	 OBO input file\n";
	print "\t\t-t 	 term ID\n";
	print "\texample:\n";
	print "\t\tperl get_descendent_terms.pl -f go.obo -t GO:0000234\n";
	exit;
}
