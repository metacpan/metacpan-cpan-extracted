...
@DESCRIPTION: Glue between my `btparse' library and the Perl module
              LaTeX::BibTeX.  Provides the following functions to Perl:
                 LaTeX::BibTeX::constant
                 LaTeX::BibTeX::initialize
                 LaTeX::BibTeX::cleanup
                 LaTeX::BibTeX::split_list
                 LaTeX::BibTeX::purify_string
                 LaTeX::BibTeX::Entry::_parse_s
                 LaTeX::BibTeX::Entry::_parse
                 LaTeX::BibTeX::Name::split
                 LaTeX::BibTeX::Name::free
                 LaTeX::BibTeX::add_macro_text
                 LaTeX::BibTeX::delete_macro
                 LaTeX::BibTeX::delete_all_macros
                 LaTeX::BibTeX::macro_length
                 LaTeX::BibTeX::macro_text
@GLOBALS    : 
@CALLS      : 
...
MODULE = LaTeX::BibTeX           PACKAGE = LaTeX::BibTeX::Name

# The XSUBs that go in the LaTeX::BibTeX::Name package (ie. that operate
# on name objects):
#    split
#    free
...
MODULE = LaTeX::BibTeX           PACKAGE = LaTeX::BibTeX::NameFormat
