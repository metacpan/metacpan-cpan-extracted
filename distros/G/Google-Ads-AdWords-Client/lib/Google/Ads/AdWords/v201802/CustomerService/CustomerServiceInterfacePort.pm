package Google::Ads::AdWords::v201802::CustomerService::CustomerServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201802::TypeMaps::CustomerService
    if not Google::Ads::AdWords::v201802::TypeMaps::CustomerService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/mcm/v201802/CustomerService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201802::TypeMaps::CustomerService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201802::CustomerService::getCustomers )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201802::CustomerService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201802::CustomerService::getServiceLinks )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201802::CustomerService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201802::CustomerService::mutateServiceLinks )],
        },
        header => {
...
Google::Ads::AdWords::v201802::CustomerService::CustomerServiceInterfacePort - SOAP Interface for the CustomerService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201802::CustomerService::CustomerServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201802::CustomerService::CustomerServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/mcm/v201802/CustomerService.
...
Returns a L<Google::Ads::AdWords::v201802::CustomerService::getCustomersResponse|Google::Ads::AdWords::v201802::CustomerService::getCustomersResponse> object.
...
Returns a L<Google::Ads::AdWords::v201802::CustomerService::getServiceLinksResponse|Google::Ads::AdWords::v201802::CustomerService::getServiceLinksResponse> object.
...
Returns a L<Google::Ads::AdWords::v201802::CustomerService::mutateResponse|Google::Ads::AdWords::v201802::CustomerService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201802::CustomerService::mutateServiceLinksResponse|Google::Ads::AdWords::v201802::CustomerService::mutateServiceLinksResponse> object.
...
Generated by SOAP::WSDL on Mon Feb 26 21:11:15 2018
