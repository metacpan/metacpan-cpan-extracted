...
package Acme::CPANModules::WorkingWithODT;
...
L<App::cpanm::cpanmodules> distribution):
 ...
 % cpanm-cpanmodules -n WorkingWithODT

Alternatively you can use the L<cpanmodules> CLI (from L<App::cpanmodules>
distribution):

    % cpanmodules ls-entries WorkingWithODT | cpanm -n

or L<Acme::CM::Get>:

    % perl -MAcme::CM::Get=WorkingWithODT -E'say $_->{module} for @{ $LIST->{entries} }' | cpanm -n

or directly:

    % perl -MAcme::CPANModules::WorkingWithODT -E'say $_->{module} for @{ $Acme::CPANModules::WorkingWithODT::LIST->{entries} }' | cpanm -n
