...
# WARNING, going left from home screen can start an app
# and keep asking you to register etc.
# so, after going to a screen TODO: hit the round button at the botton
...
is($mother->next_screen(), 0, 'next_screen()'." : called and got good result.") or BAIL_OUT;

sleep(1);

is($mother->previous_screen(), 0, 'previous_screen()'." : called and got good result.") or BAIL_OUT;
