...
#
# [Jacode4e va Jacode4e::RoundTrip o'rtasidagi farq]
#
#   Jacode4e              : Tezkor bir yo'nalishli konversiya. Ba'zi belgilar uchun
#                           yo'qotishli (masalan CP932 da 398 ta qaytarib bo'lmaydigan
#                           xaritalash mavjud).
#   Jacode4e::RoundTrip   : Unicode o'qi orqali ikki yo'nalishli aniqlikni kafolatlaydi.
#                           A->B->A har doim bir xil. Jacode4e dan sekin,
#                           ammo ma'lumotlar ikki tomonlama o'tishi kerak bo'lganda foydalaning.
#
#   Yo'qotishli konversiyalar mavjud (masalan, CP932 da 398 ta qaytarib bo'lmaydigan
#   xaritalash mavjud).
#   Ikki tomonlama konversiya kerak bo'lmasa, Jacode4e modulidan foydalaning.
#
# ======================================================================
