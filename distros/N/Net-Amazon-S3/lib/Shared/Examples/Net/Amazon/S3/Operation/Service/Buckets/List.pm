...
$Shared::Examples::Net::Amazon::S3::Operation::Service::Buckets::List::VERSION = '0.86';
use strict;
use warnings;
...
Shared::Examples::Net::Amazon::S3::Operation::Service::Buckets::List - used for testing and as example
