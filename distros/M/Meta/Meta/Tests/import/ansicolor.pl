...
#Meta::Utils::Output::print(Term::ANSIColor::color('bold blue'));
...
Meta::Baseline::Test(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), Term::ANSIColor(3), strict(3)
