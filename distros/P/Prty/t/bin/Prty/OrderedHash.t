...
sub test_unitTest : Test(5) {
    ...
    my @keys = ('a'..'d');
    my $oh = Prty::OrderedHash->new(a=>1,b=>2,c=>3,d=>4);
    $self->is(ref($oh),'Prty::OrderedHash');
...
sub test_clear : Test(4) {
    ...
    $oh = Prty::OrderedHash->new(a=>1,b=>2,c=>3,d=>4);
...
sub test_copy : Test(3) {
    ...
    my $oh1 = Prty::OrderedHash->new(a=>1,b=>2,c=>3,d=>4);
    my $oh2 = $oh1->copy;
...
sub test_increment : Test(3) {
    ...
    my $h = Prty::OrderedHash->new(a=>1,b=>2,c=>3);
...
package main;
Prty::OrderedHash::Test->runTests;
