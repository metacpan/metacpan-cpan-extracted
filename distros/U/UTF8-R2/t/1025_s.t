...
# 1
    ...
    sub { $_='AあいDAあいDAあいD'; my $r= $_ =~ s<@{[UTF8::R2::qr qr/いD/]}><12か>; $r == 1                     },
    sub { $_='AあいDAあいDAあいD'; my $r= $_ =~ s<@{[UTF8::R2::qr qr/いD/]}><12か>; $_ eq 'Aあ12かAあいDAあいD' },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
# 11
    ...
    sub { $_='AあいDAあいDAあいD'; my $r= $_ =~ s<@{[UTF8::R2::qr qr/いD/]}><12か>g; $r == 3                       },
    sub { $_='AあいDAあいDAあいD'; my $r= $_ =~ s<@{[UTF8::R2::qr qr/いD/]}><12か>g; $_ eq 'Aあ12かAあ12かAあ12か' },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
# 21
    ...
    sub { ($] < 5.014) or eval q{ $_='AあいDAあいDAあいD'; my $r= $_ =~ s<@{[UTF8::R2::qr qr/いD/]}><12か>r; $r eq 'Aあ12かAあいDAあいD' }},
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 31
    ...
    sub { ($] < 5.014) or eval q{ $_='AあいDAあいDAあいD'; my $r= $_ =~ s<@{[UTF8::R2::qr qr/いD/]}><12か>gr; $r eq 'Aあ12かAあ12かAあ12か' }},
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 81
    ...
    sub { $_='AあいDAあいDAあいD'; my $r= $_ =~ s<@{[UTF8::R2::qr qr/(い)(D)/]}><$2$1>;      $r == 1                    },
    sub { $_='AあいDAあいDAあいD'; my $r= $_ =~ s<@{[UTF8::R2::qr qr/(い)(D)/]}><$2$1>;      $_ eq 'AあDいAあいDAあいD' },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
