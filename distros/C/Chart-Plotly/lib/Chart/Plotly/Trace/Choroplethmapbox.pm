...
use Chart::Plotly::Trace::Choroplethmapbox::Legendgrouptitle;
...
has legendgrouptitle => ( is  => "rw",
                          isa => "Maybe[HashRef]|Chart::Plotly::Trace::Choroplethmapbox::Legendgrouptitle", );
...
Chart::Plotly::Trace::Choroplethmapbox - GeoJSON features to be filled are set in `geojson` The data that describes the choropleth value-to-color mapping is set in `locations` and `z`.
...
=for markdown ![Screenshot of the above example](https://raw.githubusercontent.com/pablrod/p5-Chart-Plotly/master/examples/traces/choroplethmapbox.png)
