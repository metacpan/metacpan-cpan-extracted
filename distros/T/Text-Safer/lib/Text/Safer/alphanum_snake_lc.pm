...
1;
# ABSTRACT: Like alphanum_snake, but additionally lower case
...
Text::Safer::alphanum_snake_lc - Like alphanum_snake, but additionally lower case

=head1 VERSION

This document describes version 0.003 of Text::Safer::alphanum_snake_lc (from Perl distribution Text-Safer), released on 2025-06-14.
