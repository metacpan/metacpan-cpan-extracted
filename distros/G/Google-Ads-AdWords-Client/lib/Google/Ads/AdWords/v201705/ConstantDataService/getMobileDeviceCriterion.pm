...
package Google::Ads::AdWords::v201705::ConstantDataService::getMobileDeviceCriterion;
use strict;
use warnings;
...
getMobileDeviceCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201705.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::ConstantDataService::getMobileDeviceCriterion->new($data);
