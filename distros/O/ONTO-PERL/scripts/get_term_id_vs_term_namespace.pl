#!/usr/bin/env perl
# $Id: get_term_id_vs_term_namespace.pl 2015-10-29 erick.antezana $
#
...
sub print_help {
	print "\n";
	print "\tdescription: Gets the term IDs and its namespaces in a given ontology.\n";
	print "\tusage      : get_term_id_vs_term_namespace.pl [options]\n";
	print "\toptions    :\n";
	print "\t\t-f  	 OBO input file\n";
	print "\texample:\n";
	print "\t\tperl get_term_id_vs_term_namespace.pl -f go.obo\n";
	exit;
}
