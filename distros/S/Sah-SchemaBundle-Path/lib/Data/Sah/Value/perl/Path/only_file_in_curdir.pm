...
sub meta {
    +{
        v => 1,
        summary => 'Only file in current directory',
        description => <<'MARKDOWN',

This default value rule will return filename if there is a plain file in the
current directory and nothing else. See <pm:File::Util::Test>'s
`get_dir_only_file`.
...
sub value {
    ...
    $res->{expr_value} = join(
        '',
        'File::Util::Test::get_dir_only_file()',
    );
...
Data::Sah::Value::perl::Path::only_file_in_curdir

=head1 VERSION

This document describes version 0.031 of Data::Sah::Value::perl::Path::only_file_in_curdir (from Perl distribution Sah-SchemaBundle-Path), released on 2024-02-16.
