package Google::Ads::AdWords::v201702::SystemFeedGenerationData;
use strict;
use warnings;
...
SystemFeedGenerationData from the namespace https://adwords.google.com/api/adwords/cm/v201702.
