# This Makefile is for the Chemistry::Artificial::Graphics extension to perl.
#
...
#     NAME => q[Chemistry::Artificial::Graphics]
#     PREREQ_PM => { Chemistry::Artificial::SQL=>q[0.01] }
#     VERSION_FROM => q[lib/Chemistry/Artificial/Graphics.pm]
...
NAME_SYM = Chemistry_Artificial_Graphics
VERSION = 0.01
...
FULLEXT = Chemistry/Artificial/Graphics
BASEEXT = Graphics
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Chemistry/Artificial/Graphics.pm
...
TO_INST_PM = lib/Chemistry/Artificial/Graphics.pm

PM_TO_BLIB = lib/Chemistry/Artificial/Graphics.pm \
	blib/lib/Chemistry/Artificial/Graphics.pm
...
DISTNAME = Chemistry-Artificial-Graphics
DISTVNAME = Chemistry-Artificial-Graphics-0.01
...
manifypods : pure_all  \
	lib/Chemistry/Artificial/Graphics.pm \
	lib/Chemistry/Artificial/Graphics.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW)\
	  lib/Chemistry/Artificial/Graphics.pm $(INST_MAN3DIR)/Chemistry::Artificial::Graphics.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Chemistry/Artificial/Graphics.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Chemistry-Artificial-Graphics' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.01' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Chemistry/Artificial/Graphics.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    Chemistry::Artificial::SQL:    0.01' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Chemistry-Artificial-SQL" VERSION="0,01,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Chemistry/Artificial/Graphics.pm blib/lib/Chemistry/Artificial/Graphics.pm 
	$(NOECHO) $(TOUCH) $@
