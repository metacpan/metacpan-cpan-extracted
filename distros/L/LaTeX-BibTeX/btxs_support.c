...
convert_value (char * field_name, AST * field, boolean preserve)
{
   ...
   if (preserve)
   {
      ...
      /* Make a LaTeX::BibTeX::Value object from our list of SimpleValues */
...
convert_assigned_entry (AST *top, HV *entry, boolean preserve)
{
   ...
   while (field)
   {
       ...
       * it might be a reference to a LaTeX::BibTeX::Value object (if
       * 'preserve' is true).
       */
             ...
             boolean preserve)
{
    ...
    * LaTeX::BibTeX::Entry object).  (We don't blow the hash away with
...
/*
   if (preserve)
   {
      printf ("requiring LaTeX::BibTeX::Value...\n");
      perl_require_pv ("LaTeX::BibTeX::Value");
   }
*/
