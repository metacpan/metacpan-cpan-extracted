...
L<http://www.ctan.org/tex-archive/language/hyph-utf8/source/generic/hyph-utf8/languages/tr>.
...
L<Lingua::TR::Hyphenate> is a completely different implementation. It has at least one bug acknowledged by its author
which this module does not have. Try hyphenating "antrparantez".

L<http://mirror.ctan.org/language/turkish/hyphen/turk_hyf.c>, L<http://www.tug.org/TUGboat/Articles/tb09-1/tb20mackay.pdf>,
L<http://www.ctan.org/tex-archive/language/hyph-utf8/source/generic/hyph-utf8/languages/tr>.

=head1 BUGS AND SUPPORT

This code is hosted on Github, please see L<https://github.com/kappa/Text-Hyphen-TR>.
...
See L<http://www.ctan.org/tex-archive/language/hyph-utf8/> and specifically
L<http://mirrors.ctan.org/language/hyph-utf8/tex/generic/hyph-utf8/patterns/tex/hyph-tr.tex>.
