...
addressof(T& o) BOOST_NOEXCEPT
{
    ...
    return databb_boost::detail::addrof<T>::get(o, 0);
#else
    return databb_boost::detail::addrof<T>::get(databb_boost::detail::addrof_ref<T>(o), 0);
#endif
}
...
BOOST_FORCEINLINE typename databb_boost::detail::addrof_result<T[N]>::type
...
addressof(T& o) BOOST_NOEXCEPT
{
    return databb_boost::detail::addressof(o);
}
#endif
