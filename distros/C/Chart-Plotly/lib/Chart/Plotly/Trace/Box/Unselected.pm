package Chart::Plotly::Trace::Box::Unselected;
use Moose;
...
has marker => ( is  => "rw",
                isa => "Maybe[HashRef]|Chart::Plotly::Trace::Box::Unselected::Marker", );
...
Chart::Plotly::Trace::Box::Unselected - This attribute is one of the possible options for the trace box.
