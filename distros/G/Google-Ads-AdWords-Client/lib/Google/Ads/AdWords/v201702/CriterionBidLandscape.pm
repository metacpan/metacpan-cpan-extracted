package Google::Ads::AdWords::v201702::CriterionBidLandscape;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201702::BidLandscape);
# Variety: sequence
...
CriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201702.
