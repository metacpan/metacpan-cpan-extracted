...
----------------------------------------------------------------------
    ...
    ppport.h -- Perl/Pollution/Portability Version 3.38

    Automatically created by Devel::PPPort running under perl 5.027008.
...
static void DPPP_(my_croak_xs_usage)(pTHX_ const CV *const cv, const char *const params);
static
#else
extern void DPPP_(my_croak_xs_usage)(pTHX_ const CV *const cv, const char *const params);
#endif
