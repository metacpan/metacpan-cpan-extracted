...
Prty::Test::Class - Basisklasse für Testklassen
...
Prty::Test::Class ist eine Basisklasse für Testklassen (Unit-Tests). Als
...
Prty::Test::Class definiert sechs Typen von Testmethoden: Init(N), Foreach,
...
gleich benannten C<< Prty::Test::Class >>-Methoden kann damit umgangen werden.
...
sub MODIFY_CODE_ATTRIBUTES {
    ...
    if ($type) {
        push @Methods,Prty::Test::Class::Method->new(
