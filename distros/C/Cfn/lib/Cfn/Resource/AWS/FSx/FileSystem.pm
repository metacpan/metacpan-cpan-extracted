# AWS::FSx::FileSystem generated from spec 34.0.0
...
package Cfn::Resource::AWS::FSx::FileSystem {
  ...
  sub supported_regions {
    [ 'ap-east-1','ap-northeast-1','ap-northeast-2','ap-south-1','ap-southeast-2','ca-central-1','cn-north-1','cn-northwest-1','eu-central-1','eu-north-1','eu-west-1','eu-west-2','eu-west-3','sa-east-1','us-east-1','us-east-2','us-gov-east-1','us-gov-west-1','us-west-1','us-west-2' ]
  }
}
...
package Cfn::Resource::Properties::Object::AWS::FSx::FileSystem::WindowsConfiguration {
  ...
  has ThroughputCapacity => (isa => 'Cfn::Value::Integer', is => 'rw', coerce => 1, required => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
...
Cfn::Resource::AWS::FSx::FileSystem - Cfn resource for AWS::FSx::FileSystem

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::FSx::FileSystem.
