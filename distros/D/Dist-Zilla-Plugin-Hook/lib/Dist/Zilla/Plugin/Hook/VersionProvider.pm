...
#pod
#pod This is C<Hook::VersionProvider> plugin implementation. Nothing interesting, just using few roles.
#pod
...
#pod = L<Dist::Zilla>
#pod = L<Dist::Zilla::Role::VersionProvider>
#pod
#pod =cut

package Dist::Zilla::Plugin::Hook::VersionProvider;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::VersionProvider> plugin implementation
our $VERSION = 'v0.8.3'; # VERSION

with 'Dist::Zilla::Role::Plugin';
with 'Dist::Zilla::Role::Hooker' => {
    -alias => { hook => 'provide_version' },
};
...
Dist::Zilla::Plugin::Hook::VersionProvider - C<Hook::VersionProvider> plugin implementation
...
This is C<Hook::VersionProvider> plugin implementation. Nothing interesting, just using few roles.
...
=item L<Dist::Zilla::Role::VersionProvider>
