...
Security vulnerabilities can be reported to the current App::SpeedTest
...
included in App::SpeedTest are also covered by this policy.
...
unless they affect App::SpeedTest, or App::SpeedTest can
