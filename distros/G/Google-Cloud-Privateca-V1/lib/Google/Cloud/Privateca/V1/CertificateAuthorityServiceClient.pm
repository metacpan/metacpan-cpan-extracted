...
Google::Cloud::Privateca::V1::CertificateAuthorityServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Privateca::V1::CertificateAuthorityServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Privateca::V1::CertificateAuthorityServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
