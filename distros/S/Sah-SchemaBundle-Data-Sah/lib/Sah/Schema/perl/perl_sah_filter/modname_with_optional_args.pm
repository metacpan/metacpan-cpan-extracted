...
This document describes version 0.004 of Sah::Schema::perl::perl_sah_filter::modname_with_optional_args (from Perl distribution Sah-SchemaBundle-Data-Sah), released on 2024-06-26.
...
Used completion: L<perl_perl_sah_filter_modname_with_optional_args|Perinci::Sub::XCompletion::perl_perl_sah_filter_modname_with_optional_args>
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::perl_sah_filter::modname_with_optional_args*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::perl_sah_filter::modname_with_optional_args*', name=>'PerlPerlSahFilterModnameWithOptionalArgs')
     );
 }
