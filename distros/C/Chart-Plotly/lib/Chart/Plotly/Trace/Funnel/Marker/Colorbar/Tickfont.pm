package Chart::Plotly::Trace::Funnel::Marker::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Funnel::Marker::Colorbar::Tickfont - This attribute is one of the possible options for the trace funnel.
