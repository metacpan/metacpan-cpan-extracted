package Chart::Plotly::Trace::Ohlc::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Ohlc::Legendgrouptitle::Font - This attribute is one of the possible options for the trace ohlc.
