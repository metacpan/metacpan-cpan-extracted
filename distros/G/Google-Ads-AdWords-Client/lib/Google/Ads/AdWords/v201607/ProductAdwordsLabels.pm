package Google::Ads::AdWords::v201607::ProductAdwordsLabels;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201607::ProductDimension);
# Variety: sequence
...
ProductAdwordsLabels from the namespace https://adwords.google.com/api/adwords/cm/v201607.
