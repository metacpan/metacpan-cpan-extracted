...
# Testing with correct service key and empty incident_key
my $correct_event = $pager_duty->event( service_key => $pd_service_key );
...
$response = $correct_event->trigger( description => 'Test triggering event with good service_key and empty incident_key' );
...
ok( $response->incident_key, 'Response have non-empty incident_key (auto-generated by PD)' );
$incident_key = $response->incident_key;

$response = $correct_event->acknowledge(
    incident_key => $incident_key,
    description  => 'Problem accepted, auto-generated incident_key=' . $incident_key,
);
...
is( $response->incident_key, $incident_key, 'Response should return same incident_key (acknowledge)' );

$response = $correct_event->resolve(
    incident_key => $incident_key,
    description  => 'Problem resolved, auto-generated incident_key=' . $incident_key,
);
...
is( $response->incident_key, $incident_key, 'Response should return same incident_key (resolve)' );
