package Prty::Fibu::BankbuchungListe;
...
Prty::Fibu::BankbuchungListe - Liste von Buchungen von einem Postbank-Konto
...
sub anfangssaldoLesbar {
    ...
    return Prty::Formatter->readableNumber($saldo);
}
...
sub append {
    ...
    my $bbu = Prty::Fibu::Bankbuchung->new($self->titleA,$valueA);
