...
https://metacpan.org/release/Dist-Zilla-PluginBundle-ATOOMIC

You can use cpanminus to do this without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Dist::Zilla::PluginBundle::ATOOMIC
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Dist::Zilla::PluginBundle::ATOOMIC
...
The code for this distribution is [hosted on GitHub](https://github.com/atoomic/Dist-Zilla-PluginBundle-ATOOMIC).
...
template file originating in Dist-Zilla-PluginBundle-ATOOMIC-1.00.
