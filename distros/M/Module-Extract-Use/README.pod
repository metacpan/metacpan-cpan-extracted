...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Module-Extract-Use> or 
L<MetaCPAN|http://www.metacpan.org/module/Module::Extract::Use>:

=over 4

=item *	L<http://search.cpan.org/dist/Module-Extract-Use>

=item *	L<http://www.metacpan.org/module/Module::Extract::Use>
