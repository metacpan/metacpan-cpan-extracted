package App::PDRUtils::MultiCmd::add_prereq;
...
App::PDRUtils::MultiCmd::add_prereq - Add a prereq

=head1 VERSION

This document describes version 0.120 of App::PDRUtils::MultiCmd::add_prereq (from Perl distribution App-PDRUtils), released on 2018-04-03.
