...
BorderStyleRole::Transform::OuterOnly - Strip inner border characters

=head1 VERSION

This document describes version 3.0.2 of BorderStyleRole::Transform::OuterOnly (from Perl distribution BorderStyle), released on 2022-02-14.
