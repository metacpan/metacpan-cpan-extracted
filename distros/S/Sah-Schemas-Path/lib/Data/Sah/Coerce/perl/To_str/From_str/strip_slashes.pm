...
Data::Sah::Coerce::perl::To_str::From_str::strip_slashes - Strip extra and trailing slash from a string

=head1 VERSION

This document describes version 0.010 of Data::Sah::Coerce::perl::To_str::From_str::strip_slashes (from Perl distribution Sah-Schemas-Path), released on 2019-11-29.

=head1 SYNOPSIS

To use in a Sah schema:

 ["str",{"x.perl.coerce_rules"=>["From_str::strip_slashes"]}]
