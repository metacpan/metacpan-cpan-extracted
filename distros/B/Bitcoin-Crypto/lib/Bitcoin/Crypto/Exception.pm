...
$Bitcoin::Crypto::Exception::VERSION = '2.005';
use v5.10;
use strict;
use warnings;
...
$Bitcoin::Crypto::Exception::Transaction::VERSION = '2.005';
...
$Bitcoin::Crypto::Exception::UTXO::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
...
$Bitcoin::Crypto::Exception::Sign::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
...
$Bitcoin::Crypto::Exception::Verify::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::KeyCreate::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::KeyDerive::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::MnemonicGenerate::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::MnemonicCheck::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::Base58::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::Base58InputFormat::VERSION = '2.005';
...
$Bitcoin::Crypto::Exception::Base58InputChecksum::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception::Base58';
}
...
$Bitcoin::Crypto::Exception::Bech32::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::Bech32InputFormat::VERSION = '2.005';
...
$Bitcoin::Crypto::Exception::Bech32InputData::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception::Bech32';
}
...
$Bitcoin::Crypto::Exception::Bech32InputChecksum::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception::Bech32';
}
...
$Bitcoin::Crypto::Exception::SegwitProgram::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::ScriptType::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::ScriptOpcode::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::ScriptPush::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::ScriptSyntax::VERSION = '2.005';
use Moo;
	use Mooish::AttributeBuilder -standard;
...
$Bitcoin::Crypto::Exception::ScriptRuntime::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::TransactionScript::VERSION = '2.005';
...
$Bitcoin::Crypto::Exception::NetworkCheck::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::NetworkConfig::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::Address::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::AddressGenerate::VERSION = '2.005';
...
$Bitcoin::Crypto::Exception::PSBT::VERSION = '2.005';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
