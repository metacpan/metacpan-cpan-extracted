...
XS_EUPXS(XS_Storable_init_perinterp)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 7778 "Storable.xs"
    init_perinterp(aTHX);
#line 7918 "Storable.c"
    }
    XSRETURN_EMPTY;
}
...
XS_EUPXS(XS_Storable_last_op_in_netorder)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 7857 "Storable.xs"
    bool result;
#line 8061 "Storable.c"
