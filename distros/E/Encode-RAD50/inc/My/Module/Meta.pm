...
sub abstract {
    return 'Convert to and from the Rad50 character set';
}
...
sub meta_merge {
	...
	resources	=> {
	    ...
	    repository	=> {
		type	=> 'git',
		url	=> 'git://github.com/trwyant/perl-Encode-RAD50.git',
		web	=> 'https://github.com/trwyant/perl-Encode-RAD50',
	    },
	},
	@extra,
    };
...
Copyright (C) 2010-2023, 2026 by Thomas R. Wyant, III
