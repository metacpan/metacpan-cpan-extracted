package Bencher::ScenarioR::SetComparison;
...
our $results = [
  [
    ...
    ],
    {
      ...
      "func.elapsed_time"              => 4.99571895599365,
      "func.module_startup"            => undef,
      "func.module_versions"           => {
                                            "__PACKAGE__" => 1.034,
                                            "Bencher::Scenario::SetComparison" => undef,
                                            "Benchmark::Dumb" => "0.10",
      ...
      "func.precision"                 => 0,
      "func.scenario_module"           => "Bencher::Scenario::SetComparison",
      "func.scenario_module_md5sum"    => "976e61e07a6507f069b70774f21014a6",
      "func.scenario_module_mtime"     => 1476882368,
      "func.scenario_module_sha1sum"   => "dde995876e43f1c07c391d6f8fd0c2aff230d48e",
      "func.scenario_module_sha256sum" => "19fe367e40bdf3635833329190fb883ee277a6198f051464f2bb506f452d6839",
      "func.time_end"                  => 1485324737.66215,
      "func.time_factor"               => 1000,
      "func.time_start"                => 1485324732.66643,
