...
BEGIN {
	...
	sub Lastly :ATTR(INIT) { ::ok $_[4][0] && $main::phase, $_[4][1] }
...
BEGIN { eval 'package some_other; my $x7 :Dokay(0,28)' or ::ok(1,28); }
my Test $x8 :Dokay(1,29);
eval 'package some_other; sub x7 :Dokay(0,30) {}' or ::ok(1,30);
...
# Subject: Attribute::Handlers::Clean phase variance
