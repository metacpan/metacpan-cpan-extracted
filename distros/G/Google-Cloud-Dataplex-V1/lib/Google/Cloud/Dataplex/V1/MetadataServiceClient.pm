package Google::Cloud::Dataplex::V1::MetadataServiceClient;
...
1; # End of Google::Cloud::Dataplex::V1::MetadataServiceClient

__END__

=head1 NAME

Google::Cloud::Dataplex::V1::MetadataServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Dataplex::V1::MetadataServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Dataplex::V1::MetadataServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Dataplex::V1::MetadataServiceClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Dataplex::V1::MetadataServiceClient->new(
