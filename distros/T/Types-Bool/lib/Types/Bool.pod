...
but also
    ...
    Types::Bool::true->isa(Types::Bool::BOOL_CORE);
...
operators for L<Type::Bool> booleans.
...
can be imported individually (except for C<BOOL_CORE>).

=head2 BOOL_CORE

    $package = Types::Bool::BOOL_CORE;
...
This is not exported. It is meant to be used as a fully qualified name.
...
L<Types::Bool> implements the following methods.

=head2 new

    $bool = Types::Bool->new($value);

Creates a new L<Types::Bool> object from a true or false Perl value.
