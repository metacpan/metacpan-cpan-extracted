...
Versioning|http://semver.org/spec/v2.0.0.html> scheme.  All public functions
(C<getopts()>, C<processopts()>, C<readopts()>, C<print_version_info()>)
and public constants (EOOD, EXIT_SUCCESS, EXIT_FAILURE, EXIT_USAGE) provided
by this module are exported on request.
