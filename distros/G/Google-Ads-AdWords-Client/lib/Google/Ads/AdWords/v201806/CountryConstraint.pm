package Google::Ads::AdWords::v201806::CountryConstraint;
use strict;
use warnings;
...
Google::Ads::AdWords::v201806::CountryConstraint

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CountryConstraint from the namespace https://adwords.google.com/api/adwords/cm/v201806.

Information about countries that were targeted that caused a policy finding. If a CountryConstraint has 0 targeted countries and an empty list of constrained countries, it means that the constraint applies globally. 
