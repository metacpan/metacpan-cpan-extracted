...
BEGIN {
  $MooseX::TrackDirty::Attributes::Trait::Class::AUTHORITY = 'cpan:RSRCHBOY';
}
$MooseX::TrackDirty::Attributes::Trait::Class::VERSION = '2.003';
...
This document describes version 2.003 of MooseX::TrackDirty::Attributes::Trait::Class - released December 23, 2014 as part of MooseX-TrackDirty-Attributes.
