...
Developer::Dashboard::Pax::HIR - high-level intermediate representation builder

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::HIR;

  my $obj = Developer::Dashboard::Pax::HIR->new(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::HIR -e 1
