package Test::Shared::Fixture::Wikibase::Datatype::Snak::Wikidata::GivenName::Michal;
...
sub new {
	...
	my @params = (
		...
		'datavalue' => Test::Shared::Fixture::Wikibase::Datatype::Value::Item::Wikidata::Michal->new,
		'property' => 'P735',
	);
...
Test::Shared::Fixture::Wikibase::Datatype::Snak::Wikidata::GivenName::Michal - Test instance for Wikidata snak.
...
L<Test::Shared::Fixture::Wikibase::Datatype::Value::Item::Wikidata::Michal>,
