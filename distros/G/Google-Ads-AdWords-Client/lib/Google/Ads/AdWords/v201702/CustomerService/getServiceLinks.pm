...
package Google::Ads::AdWords::v201702::CustomerService::getServiceLinks;
use strict;
use warnings;
...
getServiceLinks from the namespace https://adwords.google.com/api/adwords/mcm/v201702.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::CustomerService::getServiceLinks->new($data);
