...

{
  ...
  foreach my $case (@tests) {
    my ($string, $exp) = @$case;
    my $got = str2date($string, format => 'RFC3339');
    is_deeply($got, $exp, qq[str2date('$string', format => 'RFC3339')]);
  }
}

{
  ...
  foreach my $case (@tests) {
    ...
    my $got = str2date($str, format => 'RFC3339');
    is_deeply($got, $exp, qq[str2date('$str', format => 'RFC3339')]);
  }
}
...

{
  ...
  foreach my $case (@tests) {
    my ($string, $time) = @$case;
    my $got = str2time($string, format => 'RFC3339');
    is($got, $time, qq[str2time($string, format => 'RFC3339')]);
  }
}

{
  ...
  foreach my $case (@tests) {
    ...
    {
      my $got = time2str($time, format => 'RFC3339', precision => $precision);
      is($got, $string, qq[time2str($time, format => 'RFC3339', precision => $precision)]);
    }
    {
      my $got = str2time($string, format => 'RFC3339', precision => $precision);
      delta_within($got, $time, $epsilon, qq[str2time($string, format => 'RFC3339', precision => $precision)]);
    }
  }
}

{
  ...
  foreach my $case (@tests) {
    ...
    my $got = time2str($time, format => 'RFC3339', %$params);
...

{
  ...
  foreach my $case (@tests) {
    ...
    my $got = str2time($string, format => 'RFC3339', precision => $precision);
    delta_within($got, $time, 1e-9, qq[str2time($string, format => 'RFC3339', precision => $precision)]);
  }
}
