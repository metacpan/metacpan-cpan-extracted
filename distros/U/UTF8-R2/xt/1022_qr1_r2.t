...
# 1
    sub { ("‚ ‚¢12ABC" =~ $r2{qr/./})                         },
    sub { ("‚ ‚¢12ABC" =~ $r2{qr/./})      && ($& eq '‚ ')    },
    sub { ("‚ ‚¢12ABC" =~ $r2{qr/.{2}/})   && ($& eq '‚ ‚¢')  },
    sub { ("‚ ‚¢12ABC" =~ $r2{qr/.{2}/})   && ($` eq '')      },
    sub { ("‚ ‚¢12ABC" =~ $r2{qr/.{2}/})   && ($' eq '12ABC') },
    sub { ("‚ ‚¢12ABC" =~ $r2{qr/(.{3})/}) && ($1 eq '‚ ‚¢1') },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
# 11
    sub { not ("‚ ‚¢12ABC" !~ $r2{qr/./})                         },
    sub { not ("‚ ‚¢12ABC" !~ $r2{qr/./})      && ($& eq '‚ ')    },
    sub { not ("‚ ‚¢12ABC" !~ $r2{qr/.{2}/})   && ($& eq '‚ ‚¢')  },
    sub { not ("‚ ‚¢12ABC" !~ $r2{qr/.{2}/})   && ($` eq '')      },
    sub { not ("‚ ‚¢12ABC" !~ $r2{qr/.{2}/})   && ($' eq '12ABC') },
    sub { not ("‚ ‚¢12ABC" !~ $r2{qr/(.{3})/}) && ($1 eq '‚ ‚¢1') },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 161
    ...
    sub { ($] < 5.006) or (5.022 < $]) or eval q{     ("‚ " =~ $r2{qr/\C/})                                           }},
    sub { ($] < 5.006) or (5.022 < $]) or eval q{     ("‚ " =~ $r2{qr/\C/})   && ($& eq "\xE3")                       }},
    sub { ($] < 5.006) or (5.022 < $]) or eval q{     ("‚ " =~ $r2{qr/\C/})   && ($& eq "\xE3") && ($' eq "\x81\x82") }},
    sub { ($] < 5.006) or (5.022 < $]) or eval q{     ("‚ " =~ $r2{qr/(\C)/})                                         }},
    sub { ($] < 5.006) or (5.022 < $]) or eval q{     ("‚ " =~ $r2{qr/(\C)/}) && ($1 eq "\xE3")                       }},
    sub { ($] < 5.006) or (5.022 < $]) or eval q{     ("‚ " =~ $r2{qr/(\C)/}) && ($1 eq "\xE3") && ($' eq "\x81\x82") }},
    sub {1},
    sub {1},
    sub {1},
# 171
    sub { ($] < 5.012) or eval q{     ("‚ " =~ $r2{qr/\N/})                   }},
    sub { ($] < 5.012) or eval q{     ("‚ " =~ $r2{qr/\N/})   && ($& eq '‚ ') }},
    sub { ($] < 5.012) or eval q{     ("‚ " =~ $r2{qr/(\N)/}) && ($1 eq '‚ ') }},
...
# 331
    ...
    sub {1},
# 341
    sub { 1 or ("12345 2345 345" =~ $r2{qr/\b345/})                          },
    sub { 1 or ("12345 2345 345" =~ $r2{qr/\b345/}) && ($` eq "12345 2345 ") },
    sub { 1 or ("12345 1234 123" =~ $r2{qr/234\b/})                          },
    sub { 1 or ("12345 1234 123" =~ $r2{qr/234\b/}) && ($` eq "12345 1")     },
    sub { 1 or ("12345 2345 345" =~ $r2{qr/\B345/})                          },
    sub { 1 or ("12345 2345 345" =~ $r2{qr/\B345/}) && ($` eq "12")          },
    sub { 1 or ("12345 1234 123" =~ $r2{qr/234\B/})                          },
    sub { 1 or ("12345 1234 123" =~ $r2{qr/234\B/}) && ($` eq "1")           },
    sub {1},
    sub {1},
# 351
    sub { 1 or not ("‚P‚Q‚R‚S‚T@‚Q‚R‚S‚T@‚R‚S‚T" =~ $r2{qr/\b‚R‚S‚T/})                   },
    sub { 1 or not ("‚P‚Q‚R‚S‚T@‚P‚Q‚R‚S@‚P‚Q‚R" =~ $r2{qr/‚Q‚R‚S\b/})                   },
    sub { 1 or     ("‚P‚Q‚R‚S‚T@‚Q‚R‚S‚T@‚R‚S‚T" =~ $r2{qr/\B‚R‚S‚T/})                   },
    sub { 1 or     ("‚P‚Q‚R‚S‚T@‚Q‚R‚S‚T@‚R‚S‚T" =~ $r2{qr/\B‚R‚S‚T/}) && ($` eq "‚P‚Q") },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 371
    ...
    sub { 1 or "\xE0\xA0\x80"     =~ $r2{qr/\xE0\xA0\x80/}     },
    sub { 1 or "\xE0\xBF\x9A"     =~ $r2{qr/\xE0\xBF\x9A/}     },
    sub { 1 or "\xF0\x90\x80\x80" =~ $r2{qr/\xF0\x90\x80\x80/} },
    sub { 1 or "\xF0\x90\xB9\xBE" =~ $r2{qr/\xF0\x90\xB9\xBE/} },
    sub {1},
    sub {1},
# 381
