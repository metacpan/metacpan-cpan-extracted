...
# eval <<"END" has eval "..."
if (eval Latin4::escape <<"END") {
eval Latin4::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } "
END
...
if (eval Latin4::escape <<"END") {
eval Latin4::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
...
# eval <<"END" has eval '...'
if (eval Latin4::escape <<"END") {
eval Latin4::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } '
END
...
# eval <<"END" has eval q{...}
if (eval Latin4::escape <<"END") {
eval Latin4::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
