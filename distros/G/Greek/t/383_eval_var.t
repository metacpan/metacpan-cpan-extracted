...
# eval $var has eval "..."
$var = <<'END';
eval Greek::escape " if ('ιΑ' =~ /[α]/i) { return 1 } else { return 0 } "
END
if (eval Greek::escape $var) {
...
$var = <<'END';
eval Greek::escape qq{ if ('ιΑ' =~ /[α]/i) { return 1 } else { return 0 } }
END
if (eval Greek::escape $var) {
...
# eval $var has eval '...'
$var = <<'END';
eval Greek::escape ' if (qq{ιΑ} =~ /[α]/i) { return 1 } else { return 0 } '
END
if (eval Greek::escape $var) {
...
# eval $var has eval q{...}
$var = <<'END';
eval Greek::escape q{ if ('ιΑ' =~ /[α]/i) { return 1 } else { return 0 } }
END
if (eval Greek::escape $var) {
...
# eval $var has eval {...}
$var = <<'END';
eval { if ('ιΑ' =~ /[α]/i) { return 1 } else { return 0 } }
END
if (eval Greek::escape $var) {
