...
# TIS620::eval (omit) has TIS620::eval "..."
$_ = <<'END';
...
# TIS620::eval (omit) has TIS620::eval qq{...}
$_ = <<'END';
...
# TIS620::eval (omit) has TIS620::eval q{...}
$_ = <<'END';
...
# TIS620::eval (omit) has TIS620::eval $var
$_ = <<'END';
TIS620::eval $var2
END
...
# TIS620::eval (omit) has TIS620::eval (omit)
$_ = <<'END';
