...
This document describes version 0.08 of Bencher::Scenario::LogAny::NullLogging (from Perl distribution Bencher-Scenarios-LogAny), released on 2017-01-25.
...
Benchmark with C<< bencher -m LogAny::NullLogging --env-hashes-json '[{"PERL5OPT":"-Iarchive/Log-Any-1.040/lib"},{"PERL5OPT":"-Iarchive/Log-Any-1.041/lib"}]' >>:
 ...
 +----------------+--------------------------------------+-----------+-----------+------------+---------+---------+
 | 100k_log_trace | PERL5OPT=-Iarchive/Log-Any-1.041/lib |        15 |        67 |        1   | 0.00019 |      20 |
 | 100k_log_trace | PERL5OPT=-Iarchive/Log-Any-1.040/lib |        15 |        66 |        1   | 0.00029 |      21 |
 | 100k_is_trace  | PERL5OPT=-Iarchive/Log-Any-1.041/lib |        22 |        45 |        1.5 | 0.00015 |      20 |
 | 100k_is_trace  | PERL5OPT=-Iarchive/Log-Any-1.040/lib |        23 |        44 |        1.5 | 0.00021 |      21 |
 +----------------+--------------------------------------+-----------+-----------+------------+---------+---------+
