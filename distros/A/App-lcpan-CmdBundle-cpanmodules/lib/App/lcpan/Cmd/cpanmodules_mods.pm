...
1;
# ABSTRACT: List Acme::CPANModules modules available on CPAN
...
App::lcpan::Cmd::cpanmodules_mods - List Acme::CPANModules modules available on CPAN
...
This module handles the L<lcpan> subcommand C<cpanmodules-mods>.
