package Sah::SchemaR::example::hash_of_posint;

our $DATE = '2020-05-27'; # DATE
our $VERSION = '0.006'; # VERSION

our $rschema = ["hash",[{of=>["posint",{req=>1},{}],summary=>"Hash of positive integers"}],["hash"]];
...
Sah::SchemaR::example::hash_of_posint - Hash of positive integers

=head1 VERSION

This document describes version 0.006 of Sah::SchemaR::example::hash_of_posint (from Perl distribution Sah-Schemas-Examples), released on 2020-05-27.
