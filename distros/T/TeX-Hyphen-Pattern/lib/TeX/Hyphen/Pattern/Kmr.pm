...
package TeX::Hyphen::Pattern::Kmr v1.1.5;
use strict;
use warnings;
use 5.014000;
use utf8;
...
sub version {
    return $TeX::Hyphen::Pattern::Kmr::VERSION;
}
...
=for stopwords CTAN Ipenburg Kmr

=head1 NAME

TeX::Hyphen::Pattern::Kmr - class for hyphenation in locale Kmr
