...
IMDB::Local::Movie - Object representation of Movie information.
...
Perhaps a little code snippet.
    ...
    use IMDB::Local::Movie;

    my $foo = IMDB::Local::Movie->new();
    ...
