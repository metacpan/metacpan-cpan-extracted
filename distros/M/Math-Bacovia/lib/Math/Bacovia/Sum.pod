...
This section describes the methods provided by the B<Math::Bacovia::Sum> module.

=head2 new

    my $obj = Math::Bacovia::Sum->new($x, $y, $z, , ,);

Constructs and returns a new B<Math::Bacovia::Sum> object.
...
This section describes the special methods provided by the B<Math::Bacovia::Sum> module.
