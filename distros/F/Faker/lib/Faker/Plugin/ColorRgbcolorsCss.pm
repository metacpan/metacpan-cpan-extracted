...
Faker::Plugin::ColorRgbcolorsCss

=cut

=head1 ABSTRACT

Color Rgbcolors Css Plugin for Faker
...
=head1 SYNOPSIS
  ...
  use Faker;
  use Faker::Plugin::ColorRgbcolorsCss;

  my $f = Faker->new;
  my $p = Faker::Plugin::ColorRgbcolorsCss->new(faker => $f);
...
This package provides methods for generating fake color rgbcolors css data.
...
The execute method returns a random fake color rgbcolors css.
