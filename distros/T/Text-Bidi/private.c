...
XS(_wrap_remove_bidi_marks) {
  {
    ...
    if ((items < 4) || (items > 4)) {
      SWIG_croak("Usage: remove_bidi_marks(strl,positions_to_this,position_from_this_list,emb_levels);");
    }
    ...
    *_global_p_len = (FriBidiStrIndex)(size1/sizeof(FriBidiChar));
    ...
    arg3 = (FriBidiStrIndex *)SvPV_nolen(ST(1));
    
    
    arg4 = (FriBidiStrIndex *)SvPV_nolen(ST(2));
    
    
    arg5 = (FriBidiLevel *)SvPV_nolen(ST(3));
...
XS(SWIG_init) {
  ...
  /*@SWIG:/usr/share/swig/3.0.10/perl5/perltypemaps.swg,65,%set_constant@*/ do {
