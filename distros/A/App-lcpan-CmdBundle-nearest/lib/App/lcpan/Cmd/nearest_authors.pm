...
1;
# ABSTRACT: List CPAN ID's with names nearest to a specified name
...
App::lcpan::Cmd::nearest_authors - List CPAN ID's with names nearest to a specified name

=head1 VERSION

This document describes version 0.002 of App::lcpan::Cmd::nearest_authors (from Perl distribution App-lcpan-CmdBundle-nearest), released on 2017-01-20.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<nearest-authors>.
...
List CPAN ID's with names nearest to a specified name.
