package Chart::Plotly::Trace::Scattergeo::Selected::Marker;
use Moose;
...
Chart::Plotly::Trace::Scattergeo::Selected::Marker - This attribute is one of the possible options for the trace scattergeo.
