...
package Google::Ads::AdWords::v201402::CampaignFeedService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201402::CampaignFeedService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201402::CampaignFeedService::query->new($data);
