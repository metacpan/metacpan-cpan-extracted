...
=item Fault: Will never get a FcntlLock lock at $file for $folder: $!
...
=item Warning: folder $name already lockf'd.

Cast by C<lock()>

=item Fault: unable to check lock file $file for $folder: $!
...
=item Fault: unable to open FcntlLock lock file $file for $folder
