package Google::Ads::AdWords::v201708::UrlData;
use strict;
use warnings;
...
Google::Ads::AdWords::v201708::UrlData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
UrlData from the namespace https://adwords.google.com/api/adwords/cm/v201708.
