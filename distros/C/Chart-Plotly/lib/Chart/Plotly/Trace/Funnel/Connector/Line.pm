package Chart::Plotly::Trace::Funnel::Connector::Line;
use Moose;
...
Chart::Plotly::Trace::Funnel::Connector::Line - This attribute is one of the possible options for the trace funnel.
