...
</form><h1>/{table}/{id}</h1><form method="get" action="https://solsa.crystallography.net/db/samples/{table}/{id}" enctype="multipart/form-data"><fieldset><legend>GET: Get an entry by its ID</legend><h3>table</h3><p>Name of the table</p><input data-in-path="1" name="table" placeholder="books" type="text" /><h3>id</h3><p>Unique identifier of an entry. ID and UUID are supported. In principle other unique keys should work as well.</p><input data-in-path="1" name="id" placeholder="1" type="text" /><h3>format</h3><p>Requested return format. 'html' by default</p><select name="format" >
<option value=""></option>
<option value="html">html</option>
<option value="csv">csv</option>
<option value="xlsx">xlsx</option>
...
</form><form method="post" action="https://solsa.crystallography.net/db/samples/{table}/{id}" enctype="multipart/form-data"><fieldset><legend>POST: Insert or update an entry</legend><h3>table</h3><p>Name of the table</p><input data-in-path="1" name="table" placeholder="books" type="text" /><h3>id</h3><p>Unique identifier of an entry. ID and UUID are supported. In principle other unique keys should work as well.</p><input data-in-path="1" name="id" placeholder="1" type="text" /><h3>csvfile</h3><input type="file" name="csvfile"  /><h3>jsonfile</h3><input type="file" name="jsonfile"  /><h3>odsfile</h3><input type="file" name="odsfile"  /><h3>spreadsheet</h3><input type="file" name="spreadsheet"  /><h3>xlsfile</h3><input type="file" name="xlsfile"  /><h3>xlsxfile</h3><input type="file" name="xlsxfile"  /><input type="submit" onclick="replace_url_parameters( this.form )" /></fieldset>
...
</form><form method="delete" action="https://solsa.crystallography.net/db/samples/{table}/{id}" enctype="multipart/form-data"><fieldset><legend>DELETE: Delete an entry</legend><h3>table</h3><p>Name of the table</p><input data-in-path="1" name="table" placeholder="books" type="text" /><h3>id</h3><p>Unique identifier of an entry. ID and UUID are supported. In principle other unique keys should work as well.</p><input data-in-path="1" name="id" placeholder="1" type="text" /><input type="submit" name="Submit Query (cannot be handled for DELETE)" value="Submit Query (cannot be handled for DELETE)" disabled="disabled" /></fieldset>
</form><h1>/{table}/{id}/{field}</h1><form method="get" action="https://solsa.crystallography.net/db/samples/{table}/{id}/{field}" enctype="multipart/form-data"><fieldset><legend>GET: Get a file stored in entry's field</legend><h3>table</h3><p>Name of the table</p><input data-in-path="1" name="table" placeholder="books" type="text" /><h3>id</h3><p>Unique identifier of an entry. ID and UUID are supported. In principle other unique keys should work as well.</p><input data-in-path="1" name="id" placeholder="1" type="text" /><h3>field</h3><input data-in-path="1" name="field" type="text" /><input type="submit" onclick="replace_url_parameters( this.form )" /></fieldset>
</form>
</body>
</html>
END
