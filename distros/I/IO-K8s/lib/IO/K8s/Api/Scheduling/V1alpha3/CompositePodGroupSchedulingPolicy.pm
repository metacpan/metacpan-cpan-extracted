...
IO::K8s::Api::Scheduling::V1alpha3::CompositePodGroupSchedulingPolicy - CompositePodGroupSchedulingPolicy defines the scheduling configuration for a CompositePodGroup. Exactly one policy must be set.
