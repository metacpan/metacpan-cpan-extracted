...
#
package BmltClient::Configuration;
...
=head1 Name
        ...
        BmltClient::Configuration - holds the configuration for all BmltClient Modules
...
default: http://localhost:8000/main_server
...
sub new {
    ...
    # base_url
    $p{base_url} //= 'http://localhost:8000/main_server';
