package Chart::Plotly::Trace::Surface::Contours::X::Project;
use Moose;
...
Chart::Plotly::Trace::Surface::Contours::X::Project - This attribute is one of the possible options for the trace surface.
