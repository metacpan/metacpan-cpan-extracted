package Google::Ads::AdWords::v201802::PlatformCampaignEstimate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'platform' => 'Google::Ads::AdWords::v201802::Platform',
        'minEstimate' => 'Google::Ads::AdWords::v201802::StatsEstimate',
        'maxEstimate' => 'Google::Ads::AdWords::v201802::StatsEstimate',
    },
    {
...
Google::Ads::AdWords::v201802::PlatformCampaignEstimate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PlatformCampaignEstimate from the namespace https://adwords.google.com/api/adwords/o/v201802.
