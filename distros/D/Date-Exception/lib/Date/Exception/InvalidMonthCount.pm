package Date::Exception::InvalidMonthCount;

$Date::Exception::InvalidMonthCount::VERSION   = '0.08';
$Date::Exception::InvalidMonthCount::AUTHORITY = 'cpan:MANWAR';

=head1 NAME

Date::Exception::InvalidMonthCount - Handles 'invalid month count' exception.
...
Handles 'invalid month count' exception, with statu code C<105>.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Date::Exception::InvalidMonthCount
...
1; # End of Date::Exception::InvalidMonthCount
