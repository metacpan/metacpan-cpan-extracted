...
Google::Cloud::Pubsub::V1::PublisherClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Pubsub::V1::PublisherClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Pubsub::V1::PublisherClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Pubsub::V1::PublisherClient> is an auto-generated client library for Google Cloud Services.
