...
package PDF::API3::Compat::API2::Resource::ColorSpace::Separation;
...
=item $cs = PDF::API3::Compat::API2::Resource::ColorSpace::Separation->new $pdf, $key, %parameters
...
=item $cs = PDF::API3::Compat::API2::Resource::ColorSpace::Separation->new_api $api, $name
