...
$Date::Exception::InvalidDayCount::VERSION   = '0.04';
$Date::Exception::InvalidDayCount::AUTHORITY = 'cpan:MANWAR';

=head1 NAME

Date::Exception::InvalidDayCount - Handles 'invalid day count' exception.
...
Handles 'invalid day count' exception, with statu code C<104>.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Date::Exception::InvalidDayCount
...
1; # End of Date::Exception::InvalidDayCount
