...
Read the content of the shared memory and decode the data read using L<Storable/thaw>
...
Write the data provided to the shared memory, after having encoded it using L<Storable/freeze>.
