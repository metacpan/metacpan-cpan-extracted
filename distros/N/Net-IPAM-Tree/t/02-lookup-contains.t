...
is( $t->contains($b), $b, "contains $b" );
is( $t->lookup($b),   $b, "lookup $b: ::cafe:affe/128" );

isnt( $t->contains_not_equal($b), $b, "contains_not_equal is NOT $b" );
isnt( $t->lookup_not_equal($b),   $b, "lookup_not_equal $b: _not_equal is NOT::cafe:affe/128" );
