...
use strict;
our $DEBUGME = shift || 0;
use Storable::Improved qw(store nstore retrieve thaw freeze);
{
    no warnings;
    $Storable::Improved::DEBUGME = ($DEBUGME > 1);
}
...
$Storable::Improved::flags = Storable::Improved::FLAGS_COMPAT;
$Storable::Improved::canonical = $Storable::Improved::canonical; # Shut up a used only once warning.

for $Storable::Improved::canonical (0, 1) {
