package Chart::Plotly::Trace::Cone::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Cone::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Cone::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Cone::Hoverlabel - This attribute is one of the possible options for the trace cone.
