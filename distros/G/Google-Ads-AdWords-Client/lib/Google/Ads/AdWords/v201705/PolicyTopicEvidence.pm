package Google::Ads::AdWords::v201705::PolicyTopicEvidence;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'policyTopicEvidenceType' => 'Google::Ads::AdWords::v201705::PolicyTopicEvidenceType',
...
PolicyTopicEvidence from the namespace https://adwords.google.com/api/adwords/cm/v201705.
