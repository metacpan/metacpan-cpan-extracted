...
package WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthStreamKeyGet;
BEGIN {
  $WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthStreamKeyGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('FmsLiveAuthStreamKeyGet');
...
WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthStreamKeyGet
...
FmsLiveAuthStreamKeyGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthStreamKeyGet->new($data);
