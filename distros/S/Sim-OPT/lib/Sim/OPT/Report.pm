...
{  
  ...
  my $countinstance = $dat{countinstance}; 
  ...
  my $resfile = $dat{resfile}; ################ THIS IS PROVISIONAL!!!
...
#  open( TOFILE, ">>$tofile" ) or die "Can't open $tofile: $!";  
  ...
  my $instance = $instances[ $countinstance ];
