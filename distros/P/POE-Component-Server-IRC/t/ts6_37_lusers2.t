...
sub client_input {
  ...
  if ( $cmd eq '251' ) {
    ...
    is( $params->[1], 'There are 1 users and 2 invisible on 1 servers', 'Correct text' );
    return;
  }
  if ( $cmd eq '252' ) {
    pass("IRC$cmd");
  ...
  if ( $cmd eq '255' ) {
    pass("IRC$cmd");
    is( $params->[0], 'bobbins', 'It is me, bobbins' );
    is( $params->[1], 'I have 3 clients and 0 servers', 'Correct text' );
    return;
  }
  if ( $cmd eq '265' ) {
    pass("IRC$cmd");
    is( $params->[0], 'bobbins', 'It is me, bobbins' );
    is( $params->[1], 'Current local users: 3  Max: 3', 'Correct text' );
    return;
  }
  if ( $cmd eq '266' ) {
    pass("IRC$cmd");
...
sub client_input2 {
  ...
  if ( $cmd eq '251' ) {
    pass("IRC$cmd");
    is( $params->[0], 'bobbins', 'It is me, bobbins' );
    is( $params->[1], 'There are 0 users and 3 invisible on 1 servers', 'Correct text' );
    return;
  }
  if ( $cmd eq '252' ) {
    pass("IRC$cmd");
