package Chart::Plotly::Trace::Splom::Marker::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Splom::Marker::Colorbar::Tickfont;
use Chart::Plotly::Trace::Splom::Marker::Colorbar::Tickformatstop;
use Chart::Plotly::Trace::Splom::Marker::Colorbar::Titlefont;
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Splom::Marker::Colorbar::Tickformatstop]", );
...
has titlefont => ( is  => "rw",
                   isa => "Maybe[HashRef]|Chart::Plotly::Trace::Splom::Marker::Colorbar::Titlefont", );
...
Chart::Plotly::Trace::Splom::Marker::Colorbar - This attribute is one of the possible options for the trace splom.
