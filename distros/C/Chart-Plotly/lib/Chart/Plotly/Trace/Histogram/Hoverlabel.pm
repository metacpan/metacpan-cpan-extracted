package Chart::Plotly::Trace::Histogram::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Histogram::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Histogram::Hoverlabel - This attribute is one of the possible options for the trace histogram.
