...
static int asn_MAP_GPSDeltaEpochHeader_oms_1[] = { 0, 1, 2 };
static ber_tlv_tag_t asn_DEF_GPSDeltaEpochHeader_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_GPSDeltaEpochHeader_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* validityPeriod at 2010 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ephemerisDeltaSizes at 2011 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* ephemerisDeltaScales at 2012 */
};
