...
is ref $reactor, 'Mojo::Reactor::POE', 'right object';
is ref Mojo::Reactor::POE->new, 'Mojo::Reactor::Poll', 'right object';
undef $reactor;
is ref Mojo::Reactor::POE->new, 'Mojo::Reactor::POE', 'right object';
use_ok 'Mojo::IOLoop';
...
ok !$recurring, 'recurring was not triggered again';
my $reactor2 = Mojo::Reactor::POE->new;
...
# Detection
is(Mojo::Reactor->detect, 'Mojo::Reactor::POE', 'right class');
