...
my $color  = Latin5::substr $s, 4, 5;   # black
my $middle = Latin5::substr $s, 4, -11; # black cat climbed the
my $end    = Latin5::substr $s, 14;     # climebed the green tree
my $tail   = Latin5::substr $s, -4;     # tree
my $z      = Latin5::substr $s, -4, 2;  # tr
