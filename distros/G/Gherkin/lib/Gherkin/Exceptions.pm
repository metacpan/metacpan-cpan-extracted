...
$Gherkin::Exceptions::VERSION = '17.0.2';
use overload
    q{""}    => 'stringify',
    fallback => 1;
...
$Gherkin::Exceptions::Parser::VERSION = '17.0.2';
use base 'Gherkin::Exceptions';

# Composite exceptions
package Gherkin::Exceptions::CompositeParser;
$Gherkin::Exceptions::CompositeParser::VERSION = '17.0.2';
...
$Gherkin::Exceptions::SingleParser::VERSION = '17.0.2';
use base 'Gherkin::Exceptions::Parser';
...
$Gherkin::Exceptions::NoSuchLanguage::VERSION = '17.0.2';
...
$Gherkin::Exceptions::AstBuilder::VERSION = '17.0.2';
use base 'Gherkin::Exceptions::SingleParser';
...
$Gherkin::Exceptions::UnexpectedEOF::VERSION = '17.0.2';
use base 'Gherkin::Exceptions::SingleParser';
...
$Gherkin::Exceptions::UnexpectedToken::VERSION = '17.0.2';
use base 'Gherkin::Exceptions::SingleParser';
