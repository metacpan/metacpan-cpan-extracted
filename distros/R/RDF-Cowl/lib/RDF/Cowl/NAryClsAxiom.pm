...
$RDF::Cowl::NAryClsAxiom::VERSION = '1.0.0';
# CowlNAryClsAxiom
use strict;
use warnings;
...
RDF::Cowl::NAryClsAxiom - Represents an EquivalentClasses or DisjointClasses axiom in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::NAryClsAxiom>
