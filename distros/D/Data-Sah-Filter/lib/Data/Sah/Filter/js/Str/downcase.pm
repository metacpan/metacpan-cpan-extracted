...
This document describes version 0.013 of Data::Sah::Filter::js::Str::downcase (from Perl distribution Data-Sah-Filter), released on 2022-07-24.
...
=head2 Using with L<Data::Sah>:
 ...
 my $schema = ["str","prefilters",[["Str::downcase"]]];
...
=head2 Using with L<Data::Sah:Filter> directly:
 ...
 my $filter = gen_filter([["Str::downcase"]]);
