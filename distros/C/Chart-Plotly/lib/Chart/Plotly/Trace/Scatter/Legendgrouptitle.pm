package Chart::Plotly::Trace::Scatter::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Scatter::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatter::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Scatter::Legendgrouptitle - This attribute is one of the possible options for the trace scatter.
