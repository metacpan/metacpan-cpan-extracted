...
my($pidx)=Meta::Utils::Pid::mypid();
Meta::Utils::Output::print("This programs pid is [".$pidx."]\n");
...
pid.pl - testing program for the Meta::Utils::Pid.pm module.
...
This script tests the Meta::Utils::Pid module.
It prints the current process Id.
...
Meta::Baseline::Test(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::Pid(3), Meta::Utils::System(3), strict(3)
