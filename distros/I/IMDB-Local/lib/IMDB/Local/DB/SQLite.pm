...
IMDB::Local::DB::SQLite - The great new IMDB::Local!
...
Perhaps a little code snippet.
    ...
    use IMDB::Local::DB::SQLite;

    my $foo = IMDB::Local::DB::SQLite->new();
    ...
