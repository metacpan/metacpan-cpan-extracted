...
lives_ok {
    ...
    my %expect = (
        'default file config'       => {qw/left 4 right 4 same 3 diff 1 miss 0 add 0 dup 0 limit 0/},
        ...
        'chunked'                   => {qw/left 4 right 4 same 2 diff 2 miss 0 add 0 dup 0 limit 2/},
        'explicit properties'       => {qw/left 4 right 4 same 2 diff 2 miss 0 add 0 dup 0 limit 2/},
        'explicit sep_auto'         => {qw/left 4 right 4 same 2 diff 2 miss 0 add 0 dup 0 limit 2/},
    );
