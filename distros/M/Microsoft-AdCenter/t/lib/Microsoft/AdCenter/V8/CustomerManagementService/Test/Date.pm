package Microsoft::AdCenter::V8::CustomerManagementService::Test::Date;
...
use Microsoft::AdCenter::V8::CustomerManagementService::Date;

sub test_can_create_date_and_set_all_fields : Test(4) {
    my $date = Microsoft::AdCenter::V8::CustomerManagementService::Date->new
        ->Day('day')
        ->Month('month')
        ->Year('year')
    ;
