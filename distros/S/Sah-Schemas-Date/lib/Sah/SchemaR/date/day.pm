...
our $rschema = ["int",[{examples=>[{valid=>0,value=>""},{valid=>1,value=>1},{valid=>1,value=>31},{valid=>0,value=>32}],max=>31,min=>1,summary=>"Day of month"}],["int"]];
...
Sah::SchemaR::date::day - Day of month

=head1 VERSION

This document describes version 0.013 of Sah::SchemaR::date::day (from Perl distribution Sah-Schemas-Date), released on 2020-03-08.
