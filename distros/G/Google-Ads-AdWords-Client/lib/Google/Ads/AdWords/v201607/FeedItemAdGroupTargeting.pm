package Google::Ads::AdWords::v201607::FeedItemAdGroupTargeting;
use strict;
use warnings;
...
FeedItemAdGroupTargeting from the namespace https://adwords.google.com/api/adwords/cm/v201607.
