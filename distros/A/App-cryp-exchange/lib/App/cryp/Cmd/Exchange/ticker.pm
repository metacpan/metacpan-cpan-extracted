...
1;
# ABSTRACT: Get a pair's ticker (last 24h price & volume information)
...
App::cryp::Cmd::Exchange::ticker - Get a pair's ticker (last 24h price & volume information)

=head1 VERSION

This document describes version 0.012 of App::cryp::Cmd::Exchange::ticker (from Perl distribution App-cryp-exchange), released on 2021-05-26.
