...
Perl::Examples::POD::Text - Show the various examples of text

=head1 VERSION

This document describes version 0.096 of Perl::Examples::POD::Text (from Perl distribution Perl-Examples), released on 2023-02-24.
...
=for comment This is a text under comment.

=for comment This is a data paragraph. Mention a module: Pod::Simple::RTF. Mention a module
