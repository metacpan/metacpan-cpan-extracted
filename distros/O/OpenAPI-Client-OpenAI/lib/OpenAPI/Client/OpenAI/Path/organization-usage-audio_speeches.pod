...
OpenAPI::Client::OpenAI::Path::organization-usage-audio_speeches - Documentation for the /organization/usage/audio_speeches path.

=head1 DESCRIPTION

This document describes the API endpoint at C</organization/usage/audio_speeches>.

=head1 PATHS


=head2 C<GET /organization/usage/audio_speeches>
...
C<usage-audio-speeches>

    $client->usage-audio-speeches( ... );
