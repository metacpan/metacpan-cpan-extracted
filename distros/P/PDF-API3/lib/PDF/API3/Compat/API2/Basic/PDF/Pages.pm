...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::PDF::Pages;
...
PDF::API3::Compat::API2::Basic::PDF::Pages - a PDF pages hierarchical element. Inherits from L<PDF::API3::Compat::API2::Basic::PDF::Dict>
...
=head2 PDF::API3::Compat::API2::Basic::PDF::Pages->new($pdfs,$parent)
...
sub new
{
    ...
    $self->{'Count'} = PDFNum(0);
    $self->{'Kids'} = PDF::API3::Compat::API2::Basic::PDF::Array->new;
...
sub find_prop
{
    ...
    {
        if (ref $self->{$prop} && $self->{$prop}->isa("PDF::API3::Compat::API2::Basic::PDF::Objind"))
...
sub bbox
{
    ...
    $inh = PDF::API3::Compat::API2::Basic::PDF::Array->new;
    foreach $e (@bbox[0..3])
