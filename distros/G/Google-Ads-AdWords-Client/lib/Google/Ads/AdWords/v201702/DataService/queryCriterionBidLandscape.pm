...
package Google::Ads::AdWords::v201702::DataService::queryCriterionBidLandscape;
use strict;
use warnings;
...
queryCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201702.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::DataService::queryCriterionBidLandscape->new($data);
