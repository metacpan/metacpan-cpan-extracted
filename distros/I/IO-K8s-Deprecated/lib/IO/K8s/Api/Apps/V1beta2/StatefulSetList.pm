...
IO::K8s::Api::Apps::V1beta2::StatefulSetList - REMOVED -- superseded by the generic IO::K8s::List, see IO::K8s::Deprecated
...
back in the C<1.00> Moose-to-Moo rewrite; C<IO::K8s::Api::Apps::V1beta2::StatefulSetList> itself was never a real
...
that C<cpanm IO::K8s::Api::Apps::V1beta2::StatefulSetList> -- or a cpanfile / code that still references the old
...
IO::K8s::Api::Apps::V1beta2::StatefulSetList - REMOVED, superseded by IO::K8s::List
