package Sah::SchemaR::perl::tables::modnames_with_optional_args;

our $DATE = '2020-11-10'; # DATE
our $VERSION = '0.001'; # VERSION

our $rschema = ["array",[{description=>"\nArray of Perl Tables::* module names, where each element is of\n`perl::tables::modname_with_optional_args` schema, e.g. `Sample::DeNiro`,\n`Test::Dynamic=random,1`.\n\nContains coercion rule that expands wildcard, so you can specify:\n\n    Sample::*\n\nand it will be expanded to e.g.:\n\n    [\"Sample::DeNiro\", \"Sample::CelineDion\"]\n\nThe wildcard syntax supports jokers (`?`, `*`, `**`), brackets (`[abc]`), and\nbraces (`{one,two}`). See <pm:Module::List::Wildcard> for more details.\n\n",of=>["perl::tables::modname_with_optional_args",{req=>1},{}],summary=>"Array of Perl Tables::* module names without the prefix, with optional args, e.g. [\"Sample::DeNiro\", \"Test::Dynamic=random,1\"]","x.element_completion"=>["perl_modname",{ns_prefix=>"Tables"}],"x.perl.coerce_rules"=>[["From_str_or_array::expand_perl_modname_wildcard",{ns_prefix=>"Tables"}]]}],["array"]];
...
Sah::SchemaR::perl::tables::modnames_with_optional_args - Array of Perl Tables::* module names without the prefix, with optional args, e.g. ["Sample::DeNiro", "Test::Dynamic=random,1"]

=head1 VERSION

This document describes version 0.001 of Sah::SchemaR::perl::tables::modnames_with_optional_args (from Perl distribution Sah-Schemas-Tables), released on 2020-11-10.
