package Data::Sah::Coerce::perl::To_int::From_str::try_convert_unix_group_to_gid;
...
Data::Sah::Coerce::perl::To_int::From_str::try_convert_unix_group_to_gid - Try to convert Unix groupname into GID, leave as-is when cannot convert

=head1 VERSION

This document describes version 0.009 of Data::Sah::Coerce::perl::To_int::From_str::try_convert_unix_group_to_gid (from Perl distribution Sah-Schemas-Unix), released on 2019-12-09.

=head1 SYNOPSIS

To use in a Sah schema:

 ["int",{"x.perl.coerce_rules"=>["From_str::try_convert_unix_group_to_gid"]}]
...
L<Data::Sah::Coerce::perl::To_int::From_str::convert_unix_group_to_gid> which
