...
1;
# ABSTRACT: Expression to select module release
...
Sah::Schema::perl::module::release::version - Expression to select module release

=head1 VERSION

This document describes version 0.050 of Sah::Schema::perl::module::release::version (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
Used prefilters: L<Perl::check_module_release_expr|Data::Sah::Filter::perl::Perl::check_module_release_expr>
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::module::release::version*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::module::release::version", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::module::release::version", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::module::release::version*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::module::release::version*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::module::release::version*', name=>'PerlModuleReleaseVersion')
     );
 }

 use My::Types qw(PerlModuleReleaseVersion);
 PerlModuleReleaseVersion->assert_valid($data);
