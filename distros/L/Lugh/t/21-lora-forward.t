...
SKIP: {
    ...
    my @logits_baseline;
    eval {
        @logits_baseline = $ctx->forward(\@tokens);
    };
    ...
    eval {
        @logits_positional = $ctx->forward(\@tokens);
    };
...
SKIP: {
    ...
    SKIP: {
        ...
        # Get baseline
        my @tokens = (1, 2, 3);
        my @logits_baseline = $ctx->forward(\@tokens);
