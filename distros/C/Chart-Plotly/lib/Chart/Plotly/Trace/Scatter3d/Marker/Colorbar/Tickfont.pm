package Chart::Plotly::Trace::Scatter3d::Marker::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Scatter3d::Marker::Colorbar::Tickfont - This attribute is one of the possible options for the trace scatter3d.
