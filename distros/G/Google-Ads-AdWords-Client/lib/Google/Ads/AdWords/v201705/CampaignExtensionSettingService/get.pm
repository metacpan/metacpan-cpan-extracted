...
package Google::Ads::AdWords::v201705::CampaignExtensionSettingService::get;
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::CampaignExtensionSettingService::get->new($data);
