...
#
#   Jacode4e              : Conversao unidirecional rapida. Com perdas para
#                           alguns caracteres (ex. CP932 tem 398 mapeamentos
#                           nao reversiveis).
#   Jacode4e::RoundTrip   : Garante fidelidade de ida e volta via pivot Unicode.
#                           A->B->A e sempre identico. Mais lento que Jacode4e,
#                           mas usar quando os dados precisam de ir e voltar.
#
#   Existem conversoes com perdas (ex. CP932 tem 398 caracteres sem
#   mapeamento de ida e volta).
#   Se a conversao de ida e volta nao for necessaria, usar o modulo Jacode4e.
#
# ======================================================================
