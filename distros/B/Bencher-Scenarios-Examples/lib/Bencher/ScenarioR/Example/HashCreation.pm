package Bencher::ScenarioR::Example::HashCreation;
  ...
  [
    ...
    ],
    {
      "func.bencher_args"              => {
                                            ...
                                            scenario_module => "Example::HashCreation",
                                          },
      ...
      "func.elapsed_time"              => 21.1440238952637,
      "func.module_startup"            => undef,
      "func.module_versions"           => {
                                            "__PACKAGE__" => 1.034,
                                            "Bencher::Scenario::Example::HashCreation" => undef,
                                            "Benchmark::Dumb" => "0.10",
      ...
      "func.precision"                 => 0,
      "func.scenario_module"           => "Bencher::Scenario::Example::HashCreation",
      "func.scenario_module_md5sum"    => "5bd2e12d56a4b386c20029d00baaaa94",
      "func.scenario_module_mtime"     => 1460106950,
      "func.scenario_module_sha1sum"   => "6acb94c59d5ef640728c14e60df526090e3bdf05",
      "func.scenario_module_sha256sum" => "49c97635e821c0b1c6f4fc45103aaf7547d825b51daafbe2d0a37135f94d69d5",
      "func.time_end"                  => 1485329798.31318,
      "func.time_factor"               => 1000,
      "func.time_start"                => 1485329777.16916,
