package Bio::VertRes::Config::Recipes::VirusSnpCallingUsingBowtie2;
...
Bio::VertRes::Config::Recipes::VirusSnpCallingUsingBowtie2 - Standard snp calling pipeline for virus
...
Standard snp calling pipeline for virus. Register study, QC, map with bwa, snp call
   ...
   my $obj = Bio::VertRes::Config::Recipes::VirusSnpCallingUsingBowtie2->new( 
     database => 'abc', 
