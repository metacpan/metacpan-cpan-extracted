package Firewall::Config::Element::Rule::Hillstone;
...
#------------------------------------------------------------------------------
# Firewall::Config::Element::Rule::Hillstone 通用属性
#------------------------------------------------------------------------------
has policyId => (
  is       => 'ro',
  isa      => 'Str',
...
sub _buildSrcAddressGroup {
  my $self = shift;
  return Firewall::Config::Element::AddressGroup::Hillstone->new( addrGroupName => '^' );
}
...
sub _buildServiceGroup {
  my $self = shift;
  return Firewall::Config::Element::ServiceGroup::Hillstone->new( srvGroupName => '^' );
}
