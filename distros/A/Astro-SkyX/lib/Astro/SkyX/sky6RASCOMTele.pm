...
our $VERSION = '0.11';
our @PROPERTIES = qw( Abort CommutateMotors Connect DoCommand Disconnect FindHome FocusInFast FocusInSlow FocusOutFast FocusOutSlow GetAzAlt GetRaDec Jog Park SetParkPosition SetTracking SlewToAzAlt Sync SlewToRaDec ParkAndDoNotDisconnect Unpark IsParked ConnectAndDoNotUnpark );
