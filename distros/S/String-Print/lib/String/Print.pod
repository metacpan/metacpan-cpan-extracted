...
=head4 POSIX modifier extensions '%[+ -0]?[0-9]*[_,.]?d'
...
=head3 Modifier: EL, EL($width), or EL($width,$replace)
...
=head3 Modifier: CHOP, CHOP($width) or CHOP($width,$units)
...
This module is part of String-Print version 1.00,
built on December 03, 2025. Website: F<http://perl.overmeer.net/CPAN/>
