package Chart::Plotly::Trace::Scattergeo::Marker::Gradient;
use Moose;
...
Chart::Plotly::Trace::Scattergeo::Marker::Gradient - This attribute is one of the possible options for the trace scattergeo.
