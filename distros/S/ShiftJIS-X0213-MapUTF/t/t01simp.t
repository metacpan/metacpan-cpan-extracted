...
for my $ary (@arys) {
    ...
    print $unicode eq sjis0213_to_unicode($sjis)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $utf8    eq sjis0213_to_utf8($sjis)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $utf16le eq sjis0213_to_utf16le($sjis)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $utf16be eq sjis0213_to_utf16be($sjis)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $utf32le eq sjis0213_to_utf32le($sjis)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $utf32be eq sjis0213_to_utf32be($sjis)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjisre eq unicode_to_sjis0213($unicode)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjisre eq utf8_to_sjis0213($utf8)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjisre eq utf16le_to_sjis0213($utf16le)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjisre eq utf16be_to_sjis0213($utf16be)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjisre eq utf32le_to_sjis0213($utf32le)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjisre eq utf32be_to_sjis0213($utf32be)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjisre eq utf16_to_sjis0213($utf16_b)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjisre eq utf16_to_sjis0213($utf16_l)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjisre eq utf16_to_sjis0213($utf16_n)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjisre eq utf32_to_sjis0213($utf32_b)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjisre eq utf32_to_sjis0213($utf32_l)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjisre eq utf32_to_sjis0213($utf32_n)
	? "ok" : "not ok" , " ", ++$loaded, "\n";
}
