...
or L<Acme::CM::Get>:
    ...
    % perl -MAcme::CM::Get=PERLANCAR::MyRetired -E'say $_->{module} for @{ $LIST->{entries} }' | cpanm -n

or directly:

    % perl -MAcme::CPANModules::PERLANCAR::MyRetired -E'say $_->{module} for @{ $Acme::CPANModules::PERLANCAR::MyRetired::LIST->{entries} }' | cpanm -n
