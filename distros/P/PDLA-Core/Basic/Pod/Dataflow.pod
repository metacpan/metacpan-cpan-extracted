...
a flag in $c: "PDLA_PARENTDIMSCHANGED" and $y just raises the same flag
...
What should $e and $f contain now? What about when $x is changed
...
between the two objects: when $x is changed and this diagram is re-evaluated,
