...
use Google::Ads::AdWords::v201708::ShowcaseAd;
...
sub _create_ad_group {
  ...
  # Create operation
  my $operation = Google::Ads::AdWords::v201708::AdGroupOperation->new({
    operand  => $ad_group,
    operator => "ADD"
  });
...
sub _create_showcase_ad {
  ...
  my $showcase_ad = Google::Ads::AdWords::v201708::ShowcaseAd->new({
  ...
  my $expanded_image = Google::Ads::AdWords::v201708::Image->new({
  ...
  my $collapsed_image = Google::Ads::AdWords::v201708::Image->new({
      mediaId => _upload_image(
