...
I welcome any contribution to Module::Generic::Number, including, but not limited to bug reports, feature requests, general comments, and patches.

Feel free to clone it from its gitlab repository at <https://gitlab.com/deguest/Module-Generic> and issue a pull request.
...
File [an issue on bug tracker](https://gitlab.com/deguest/Module-Generic/issues) if you think you've found a bug. Please describe
...
Issues are currently reported using CPAN [bug tracker](https://gitlab.com/deguest/Module-Generic/issues)

## More information

Please refer to the [README](https://metacpan.org/source/JDEGUEST/Module-Generic-Number-v2.3.5/README.md)
