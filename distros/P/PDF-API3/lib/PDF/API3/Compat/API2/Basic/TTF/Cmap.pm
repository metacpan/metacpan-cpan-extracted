...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::TTF::Cmap;

=head1 NAME

PDF::API3::Compat::API2::Basic::TTF::Cmap - Character map table
...
sub out
{
    ...
    for ($i = 0; $i < $self->{'Num'}; $i++)
    {
        ...
        } elsif ($s->{'Format'} == 4)
        {
            ...
            ($num, $sRange, $eSel, $eShift) = PDF::API3::Compat::API2::Basic::TTF::Utils::TTF_bininfo($num, 2);
