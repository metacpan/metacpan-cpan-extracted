...
XS(_wrap_gsl_spmatrix_work_sze_set) {
  {
    gsl_spmatrix *arg1 = (gsl_spmatrix *) 0 ;
    size_t *arg2 = (size_t *) 0 ;
    void *argp1 = 0 ;
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: gsl_spmatrix_work_sze_set(self,work_sze);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_gsl_spmatrix, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "gsl_spmatrix_work_sze_set" "', argument " "1"" of type '" "gsl_spmatrix *""'"); 
    }
    arg1 = (gsl_spmatrix *)(argp1);
    res2 = SWIG_ConvertPtr(ST(1), &argp2,SWIGTYPE_p_size_t, SWIG_POINTER_DISOWN |  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "gsl_spmatrix_work_sze_set" "', argument " "2"" of type '" "size_t *""'"); 
    }
    arg2 = (size_t *)(argp2);
    if (arg1) (arg1)->work_sze = arg2;
    ST(argvi) = &PL_sv_undef;
...
XS(_wrap_gsl_spmatrix_work_sze_get) {
  {
    gsl_spmatrix *arg1 = (gsl_spmatrix *) 0 ;
    void *argp1 = 0 ;
    int res1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: gsl_spmatrix_work_sze_get(self);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_gsl_spmatrix, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "gsl_spmatrix_work_sze_get" "', argument " "1"" of type '" "gsl_spmatrix *""'"); 
    }
    arg1 = (gsl_spmatrix *)(argp1);
    result = (size_t *) ((arg1)->work_sze);
    ST(argvi) = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_size_t, 0 | 0); argvi++ ;
...
XS(_wrap_gsl_spmatrix_work_dbl_set) {
  {
    gsl_spmatrix *arg1 = (gsl_spmatrix *) 0 ;
    double *arg2 = (double *) 0 ;
    void *argp1 = 0 ;
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: gsl_spmatrix_work_dbl_set(self,work_dbl);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_gsl_spmatrix, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "gsl_spmatrix_work_dbl_set" "', argument " "1"" of type '" "gsl_spmatrix *""'"); 
    }
    arg1 = (gsl_spmatrix *)(argp1);
    res2 = SWIG_ConvertPtr(ST(1), &argp2,SWIGTYPE_p_double, SWIG_POINTER_DISOWN |  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "gsl_spmatrix_work_dbl_set" "', argument " "2"" of type '" "double *""'"); 
    }
    arg2 = (double *)(argp2);
    if (arg1) (arg1)->work_dbl = arg2;
    ST(argvi) = &PL_sv_undef;
...
XS(_wrap_gsl_spmatrix_work_dbl_get) {
  {
    gsl_spmatrix *arg1 = (gsl_spmatrix *) 0 ;
    void *argp1 = 0 ;
    int res1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: gsl_spmatrix_work_dbl_get(self);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_gsl_spmatrix, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "gsl_spmatrix_work_dbl_get" "', argument " "1"" of type '" "gsl_spmatrix *""'"); 
    }
    arg1 = (gsl_spmatrix *)(argp1);
    result = (double *) ((arg1)->work_dbl);
    ST(argvi) = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_double, 0 | 0); argvi++ ;
...
{"Math::GSL::SparseMatrixc::gsl_spmatrix_work_sze_set", _wrap_gsl_spmatrix_work_sze_set},
{"Math::GSL::SparseMatrixc::gsl_spmatrix_work_sze_get", _wrap_gsl_spmatrix_work_sze_get},
{"Math::GSL::SparseMatrixc::gsl_spmatrix_work_dbl_set", _wrap_gsl_spmatrix_work_dbl_set},
{"Math::GSL::SparseMatrixc::gsl_spmatrix_work_dbl_get", _wrap_gsl_spmatrix_work_dbl_get},
