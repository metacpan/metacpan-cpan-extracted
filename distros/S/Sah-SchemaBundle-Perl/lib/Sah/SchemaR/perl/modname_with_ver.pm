...
Sah::SchemaR::perl::modname_with_ver - Perl module name with version number suffix, e.g. Foo::Bar@0.001

=head1 VERSION

This document describes version 0.050 of Sah::SchemaR::perl::modname_with_ver (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
