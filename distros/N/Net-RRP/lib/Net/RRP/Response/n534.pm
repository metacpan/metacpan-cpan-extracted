package Net::RRP::Response::n534;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n534::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n534::VERSION = '0.1';
...
Net::RRP::Response::n534 - the 534 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
