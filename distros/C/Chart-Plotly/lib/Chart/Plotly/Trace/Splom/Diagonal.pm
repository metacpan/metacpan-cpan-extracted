package Chart::Plotly::Trace::Splom::Diagonal;
use Moose;
...
has visible => ( is            => "rw",
                 isa           => "Bool",
                 documentation => "Determines whether or not subplots on the diagonal are displayed.",
);
...
Chart::Plotly::Trace::Splom::Diagonal - This attribute is one of the possible options for the trace splom.
