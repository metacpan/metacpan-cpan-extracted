package Google::Ads::AdWords::v201809::CountryConstraint;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::CountryConstraint

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CountryConstraint from the namespace https://adwords.google.com/api/adwords/cm/v201809.
