...
#pod
#pod This is C<Hook::ModuleMaker> plugin implementation. Nothing interesting, just using few roles.
#pod
...
#pod = L<Dist::Zilla>
#pod = L<Dist::Zilla::Role::ModuleMaker>
#pod
#pod =cut

package Dist::Zilla::Plugin::Hook::ModuleMaker;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::ModuleMaker> plugin implementation
our $VERSION = 'v0.8.3'; # VERSION

with 'Dist::Zilla::Role::Plugin';
with 'Dist::Zilla::Role::Hooker' => {
    -alias => { hook => 'make_module' },
};
...
Dist::Zilla::Plugin::Hook::ModuleMaker - C<Hook::ModuleMaker> plugin implementation
...
This is C<Hook::ModuleMaker> plugin implementation. Nothing interesting, just using few roles.
...
=item L<Dist::Zilla::Role::ModuleMaker>
