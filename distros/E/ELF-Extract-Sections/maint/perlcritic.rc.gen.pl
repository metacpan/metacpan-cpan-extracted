...
my @stopwords = (
    qw(
      HashRef ArrayRef Str Objdump perl FILENAME FilterField ElfSection ENUM disassembly Bool Undef RegexpRef objdump objdump's FileHandle acknowledgements initialise
      )
);
