...
Этот документ дает общее представление о Юникоде и как правильно использовать Юникод
в Perl. Смотрите L</Дополнительные Ресурсы> для ссылок на более глубокие
 исследования Юникода.

=head2 Юникод

Юникодом является стандарт кодировки символов, которым планируют кодифицировать все
системы письменности мира, а также многие другие символы.
