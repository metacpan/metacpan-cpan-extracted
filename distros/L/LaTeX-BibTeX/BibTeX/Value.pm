# ----------------------------------------------------------------------
# NAME       : LaTeX::BibTeX::Value
# CLASSES    : LaTeX::BibTeX::Value, LaTeX::BibTeX::SimpleValue
# RELATIONS  : 
...
LaTeX::BibTeX::Value - interfaces to BibTeX values and simple values
...
=head1 SYNOPSIS
   ...
   # 'get' method now returns a LaTeX::BibTeX::Value object 
...
The C<LaTeX::BibTeX::Value> module provides two classes,
C<LaTeX::BibTeX::Value> and C<LaTeX::BibTeX::SimpleValue>, which respectively
...
C<LaTeX::BibTeX>, field values are "fully processed," so that you only have
...
this entry in the usual way:
   ...
   $entry = new LaTeX::BibTeX::Entry $entry_text;
...
object:
   ...
   $bibfile = new LaTeX::BibTeX::File $filename;
   $bibfile->preserve_values (1);

   $entry = new LaTeX::BibTeX::Entry $bibfile;
...
simple values.  The C<LaTeX::BibTeX::Value> class (hereinafter
...
the C<values> method, or a single value using C<value>:
   ...
   $author = $entry->get ('author');   # now a LaTeX::BibTeX::Value object
   @all_values = $author->values;      # array of LaTeX::BibTeX::SimpleValue
   $second = $author->value (1);       # same as $all_values[1]

The simple values may be queried using the C<LaTeX::BibTeX::SimpleValue>
...
=head2 LaTeX::BibTeX::Value methods
...
L<"DESCRIPTION"> would be:
   ...
   $and_macro = new LaTeX::BibTeX::SimpleValue (BTAST_MACRO, 'and');
   $value = new LaTeX::BibTeX::Value 
...
sub new
{
   ...
   while (my $sval = shift)
   {
      $sval = new LaTeX::BibTeX::SimpleValue @$sval
         if ref $sval eq 'ARRAY' && @$sval == 2;
      croak "simple value is neither a two-element array ref " .
            "nor a LaTeX::BibTeX::SimpleValue object"
         unless isa ($sval, 'LaTeX::BibTeX::SimpleValue');
      push (@$self, $sval);
   }
...
# A LaTeX::BibTeX::Value object is just an array ref; that array is a list
# of LaTeX::BibTeX::SimpleValue objects.  Most of the real work for Value
...
package LaTeX::BibTeX::SimpleValue;

use strict;
use Carp;
use LaTeX::BibTeX qw(:nodetypes);

=head2 LaTeX::BibTeX::SimpleValue methods
...
probably want to import these constants from C<LaTeX::BibTeX> using the
...
L<LaTeX::BibTeX>, L<LaTeX::BibTeX::File>, L<LaTeX::BibTeX::Entry>
