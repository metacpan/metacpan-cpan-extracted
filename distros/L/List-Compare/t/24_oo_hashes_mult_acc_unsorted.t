...
### new ###
my $lcmu   = List::Compare->new('-u', '-a', \%h0, \%h1, \%h2, \%h3, \%h4);
...
### new ###
my $lcmu_dj   = List::Compare->new('-u', '-a', \%h0, \%h1, \%h2, \%h3, \%h4, \%h8);
