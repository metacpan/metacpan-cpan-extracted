package Bencher::Scenarios::File::Flock::Retry;
...
1;
# ABSTRACT: Scenarios to benchmark File::Flock::Retry
...
Bencher::Scenarios::File::Flock::Retry - Scenarios to benchmark File::Flock::Retry

=head1 VERSION

This document describes version 0.002 of Bencher::Scenarios::File::Flock::Retry (from Perl distribution Bencher-Scenarios-File-Flock-Retry), released on 2023-01-19.
...
=item * L<Bencher::Scenario::File::Flock::Retry::Startup>
