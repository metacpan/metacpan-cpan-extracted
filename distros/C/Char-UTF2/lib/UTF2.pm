...
# regexp of character
my $qq_char   = qr/(?> \\c[\x40-\x5F] | \\? (?:(?:[\xC2-\xDF]|[\xE0-\xE0][\xA0-\xBF]|[\xE1-\xEC][\x80-\xBF]|[\xED-\xED][\x80-\x9F]|[\xEE-\xEF][\x80-\xBF]|[\xF0-\xF0][\x90-\xBF][\x80-\xBF]|[\xF1-\xF3][\x80-\xBF][\x80-\xBF]|[\xF4-\xF4][\x80-\x8F][\x80-\xBF])[\x80-\xBF] | [\x00-\xFF]) )/oxms;
my  $q_char   = qr/(?> (?:[\xC2-\xDF]|[\xE0-\xE0][\xA0-\xBF]|[\xE1-\xEC][\x80-\xBF]|[\xED-\xED][\x80-\x9F]|[\xEE-\xEF][\x80-\xBF]|[\xF0-\xF0][\x90-\xBF][\x80-\xBF]|[\xF1-\xF3][\x80-\xBF][\x80-\xBF]|[\xF4-\xF4][\x80-\x8F][\x80-\xBF])[\x80-\xBF] | [\x00-\xFF] )/oxms;
...
sub UTF2::escape_script {
    ...
    if (/^ use Eutf2(?:(?>\s+)(?>[0-9\.]*))?(?>\s*); $/oxms) {
        ...
        if (s/^ (?>\s*) use (?>\s+) (?: Char | UTF2 ) (?>\s*) ([^\x80-\xFF;]*) ; \s* \n? $//oxms) {
...
=head1 Un-Escaping \ of \b{}, \B{}, \N{}, \p{}, \P{}, and \X (UTF2 software provides)

UTF2 software removes '\' at head of alphanumeric regexp metasymbols \b{}, \B{},
...
=head1 Yada Yada Operator (UTF2 software provides)
