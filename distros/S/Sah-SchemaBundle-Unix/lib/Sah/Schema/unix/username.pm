...
MARKDOWN
    'prefilters' => ['Unix::convert_uid_to_unix_user'],
...
This document describes version 0.022 of Sah::Schema::unix::username (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.
...
Used prefilters: L<Unix::convert_uid_to_unix_user|Data::Sah::Filter::perl::Unix::convert_uid_to_unix_user>

Used completion: L<unix_user_or_uid|Perinci::Sub::XCompletion::unix_user_or_uid>
...
(set-as-default, coerced, prefiltered) value:
 ...
 # a sample invalid data
 $data = "-andy";
 my $res = $validator->($data); # => ["Must match regex pattern qr((?=\\A[A-Za-z0-9._][A-Za-z0-9._-]{0,31}\\z)(?=.*[A-Za-z._-]))","-andy"]
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"unix::username*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('unix::username*', name=>'UnixUsername')
     );
 }

 use My::Types qw(UnixUsername);
 UnixUsername->assert_valid($data);
