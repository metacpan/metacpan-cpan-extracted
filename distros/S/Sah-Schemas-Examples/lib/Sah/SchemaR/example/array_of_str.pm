...
our $rschema = [
  "array",
  [
    { of => ["str", { req => 1 }, {}], summary => "Array of string" },
  ],
  ["array"],
];
...
This document describes version 0.005 of Sah::SchemaR::example::array_of_str (from Perl distribution Sah-Schemas-Examples), released on 2016-12-09.
