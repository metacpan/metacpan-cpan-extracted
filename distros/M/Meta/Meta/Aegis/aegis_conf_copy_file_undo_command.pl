...
aegis_conf_copy_file_undo_command.pl - copy_file_undo aegis hook.
...
=head1 DETAILS
	...
	MANIFEST: aegis_conf_copy_file_undo_command.pl
	PROJECT: meta
	VERSION: 0.01

=head1 SYNOPSIS

	aegis_conf_copy_file_undo_command.pl [options]

=head1 DESCRIPTION

This program handles the copy_file_undo aegis hook actions.
