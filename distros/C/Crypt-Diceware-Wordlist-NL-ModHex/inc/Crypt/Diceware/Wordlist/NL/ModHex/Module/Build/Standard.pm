...
package Crypt::Diceware::Wordlist::NL::ModHex::Module::Build::Standard v0.0.1;
...
Crypt::Diceware::Wordlist::NL::ModHex::Module::Build::Standard - Customization
of L<Module::Build> for L<Crypt::Diceware::Wordlist::NL::ModHex> distributions.
...
L<Crypt::Diceware::Wordlist::NL::ModHex>. The following actions have been added
or redefined:
