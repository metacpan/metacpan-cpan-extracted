...
1;
# ABSTRACT: Dump Perinci::CmdLine script and generate fish completion from it
...
=head2 gen_fish_complete_from_perinci_cmdline_script(%args) -> [status, msg, result, meta]

Dump Perinci::CmdLine script and generate fish completion from it.

This routine generate C<complete> fish command for each option, allowing fish to
display the options in a different color.
...
Please visit the project's homepage at L<https://metacpan.org/release/Complete-Fish-Gen-FromPerinciCmdLine>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Complete-Fish-Gen-FromPerinciCmdLine>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=Complete-Fish-Gen-FromPerinciCmdLine>
