...
#
# Copyright (C) 2015, 2025, 2026 Gisbert W. Selke. All rights reserved.
...
our $VERSION = version->declare('v0.62.5');
...
containing this XML content. The default is the path to F<lyon-map.xml>
...
L<https://github.com/gwselke/Map-Tube-Lyon/issues>. I will be
