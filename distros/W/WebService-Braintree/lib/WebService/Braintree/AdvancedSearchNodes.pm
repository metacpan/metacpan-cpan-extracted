...
$WebService::Braintree::AdvancedSearchNodes::VERSION = '0.9';
use Moose;
}

{
    package WebService::Braintree::SearchNode;
$WebService::Braintree::SearchNode::VERSION = '0.9';
use Moose;
...
$WebService::Braintree::IsNode::VERSION = '0.9';
use Moose;
...
$WebService::Braintree::EqualityNode::VERSION = '0.9';
use Moose;
...
$WebService::Braintree::KeyValueNode::VERSION = '0.9';
use Moose;
    extends ("WebService::Braintree::SearchNode");
...
$WebService::Braintree::PartialMatchNode::VERSION = '0.9';
use Moose;
...
$WebService::Braintree::TextNode::VERSION = '0.9';
use Moose;
...
$WebService::Braintree::RangeNode::VERSION = '0.9';
use Moose;
    extends ("WebService::Braintree::EqualityNode");
...
$WebService::Braintree::MultipleValuesNode::VERSION = '0.9';
use Carp;
    use Moose;
