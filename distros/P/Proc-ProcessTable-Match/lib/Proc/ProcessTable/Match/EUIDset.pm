package Proc::ProcessTable::Match::EUIDset;
...
Proc::ProcessTable::Match::EUIDset - Check if the the process has a EUID set.
...
=head1 SYNOPSIS
    ...
    my $checker=Proc::ProcessTable::Match::EUIDset->new;
