package Chart::Plotly::Trace::Contourcarpet::Colorbar::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Contourcarpet::Colorbar::Title::Font - This attribute is one of the possible options for the trace contourcarpet.
