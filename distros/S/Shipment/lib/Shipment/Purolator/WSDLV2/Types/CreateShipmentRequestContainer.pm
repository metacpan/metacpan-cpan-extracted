...
$Shipment::Purolator::WSDLV2::Types::CreateShipmentRequestContainer::VERSION = '3.04';
use strict;
use warnings;
...
CreateShipmentRequestContainer from the namespace http://purolator.com/pws/datatypes/v2.
