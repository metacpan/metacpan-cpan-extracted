package Data::Sah::Coerce::perl::To_str::From_str::ToLower;
...
Data::Sah::Coerce::perl::To_str::From_str::ToLower - Coerce string to lower case

=head1 VERSION

This document describes version 0.005 of Data::Sah::Coerce::perl::To_str::From_str::ToLower (from Perl distribution Data-Sah-Coerce-perl-To_str-From_str-ToUpper), released on 2019-11-28.

=head1 SYNOPSIS

To use in a Sah schema:

 ["str",{"x.perl.coerce_rules"=>["From_str::ToLower"]}]
