package Chart::Plotly::Trace::Contour::Colorbar::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Contour::Colorbar::Title::Font - This attribute is one of the possible options for the trace contour.
