...
sub Windows1258::escape_script {
    ...
    if (/^ use Ewindows1258(?:(?>\s+)(?>[0-9\.]*))?(?>\s*); $/oxms) {
        ...
        $e_script .= sprintf("use Ewindows1258 '%s.0'; # 'quote' for perl5.6\n", $Windows1258::VERSION); # require run-time routines version
...
END
            ...
            if ($list !~ /\A (?>\s*) \z/oxms) {
                ...
                for (@list) {
                    $Ewindows1258::function_ord     = 'Windows1258::ord'     if /\A ord \z/oxms;
                    $Ewindows1258::function_ord_    = 'Windows1258::ord_'    if /\A ord \z/oxms;
                    $Ewindows1258::function_reverse = 'Windows1258::reverse' if /\A reverse \z/oxms;
                    $Ewindows1258::function_getc    = 'Windows1258::getc'    if /\A getc \z/oxms;

                    # avoid: used only once: possible typo at ...
                    $Ewindows1258::function_ord     = $Ewindows1258::function_ord;
                    $Ewindows1258::function_ord_    = $Ewindows1258::function_ord_;
                    $Ewindows1258::function_reverse = $Ewindows1258::function_reverse;
                    $Ewindows1258::function_getc    = $Ewindows1258::function_getc;
                }
            }
        }
    }

    $e_script .= Windows1258::escape();
...
=head1 Calling 'Ewindows1258::ignorecase()' (Windows1258 software provides)

Windows1258 software applies calling 'Ewindows1258::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \b{}, \B{}, \N{}, \p{}, \P{}, and \X (Windows1258 software provides)

Windows1258 software removes '\' at head of alphanumeric regexp metasymbols \b{}, \B{},
...
=head1 Escaping Built-in Functions (Windows1258 software provides)
...
=head1 Yada Yada Operator (Windows1258 software provides)
...
=head1 Un-Escaping bytes::* Subroutines (Windows1258 software provides)

Windows1258 software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Windows1258 software and
