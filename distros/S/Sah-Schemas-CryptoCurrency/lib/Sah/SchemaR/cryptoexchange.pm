...
our $rschema = ["str",[{description=>"\nCryptoexchange code or name or safename that is listed in\n<pm:CryptoExchange::Catalog>, e.g. GDAX, \"BX Thailand\", bx-thailand.\n\nCode/name/safename must be listed.\n\nWill be normalized to safename in lowercase.\n\n",examples=>[{valid=>0,value=>""},{valid=>0,value=>"foo"},{valid=>1,validated_value=>"bx-thailand",value=>"BX Thailand"},{valid=>1,validated_value=>"bx-thailand",value=>"BX-thailand"},{valid=>1,validated_value=>"bx-thailand",value=>"bx"}],summary=>"Cryptoexchange code, name, or safename","x.completion"=>"cryptoexchange","x.perl.coerce_rules"=>["From_str::to_cryptoexchange_safename"]}],["str"]];
...
Sah::SchemaR::cryptoexchange - Cryptoexchange code, name, or safename

=head1 VERSION

This document describes version 0.015 of Sah::SchemaR::cryptoexchange (from Perl distribution Sah-Schemas-CryptoCurrency), released on 2020-03-08.
