...
The place to report them is [RT, CPAN's request tracker](https://rt.cpan.org/NoAuth/Bugs.html?Dist=Dev-Util). 
...
not, then try [Github: Dev-Util](https://github.com/mattmartini/Dev-Util) 
or submit a bug report. (As far as I'm concerned the lack of a
link is a bug.)

To submit the patch, do a [pull request](https://github.com/mattmartini/Dev-Util/pulls) 
