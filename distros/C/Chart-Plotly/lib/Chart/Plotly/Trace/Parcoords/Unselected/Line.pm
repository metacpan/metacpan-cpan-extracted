package Chart::Plotly::Trace::Parcoords::Unselected::Line;
use Moose;
...
has color => (is            => "rw",
              isa           => "Str",
              documentation => "Sets the base color of unselected lines. in connection with `unselected.line.opacity`.",
);
...
Chart::Plotly::Trace::Parcoords::Unselected::Line - This attribute is one of the possible options for the trace parcoords.
