package Chart::Plotly::Trace::Parcats::Labelfont;
use Moose;
...
has description => ( is      => "ro",
                     default => "Sets the font for the `dimension` labels.", );
...
Chart::Plotly::Trace::Parcats::Labelfont - This attribute is one of the possible options for the trace parcats.
