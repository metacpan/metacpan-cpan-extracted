...
eval { Nagios::Monitoring::Plugin->new(); };
...
$p = Nagios::Monitoring::Plugin->new( usage => "dummy usage statement" );

# option accessors work
can_ok $p, 'opts';
isa_ok $p->opts, 'Nagios::Monitoring::Plugin::Getopt', "Getopt object is defined";
...
can_ok $p, 'perfdata';
#isa_ok $p->perfdata, 'Nagios::Monitoring::Plugin::Performance', "perfdata object is defined";


can_ok $p, 'threshold';
#isa_ok $p->threshold, 'Nagios::Monitoring::Plugin::Threshold', "threshold object is defined";
