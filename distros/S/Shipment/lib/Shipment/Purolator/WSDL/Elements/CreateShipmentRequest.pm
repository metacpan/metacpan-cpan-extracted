...
package Shipment::Purolator::WSDL::Elements::CreateShipmentRequest;
$Shipment::Purolator::WSDL::Elements::CreateShipmentRequest::VERSION = '3.06';
use strict;
use warnings;
...
CreateShipmentRequest from the namespace http://purolator.com/pws/datatypes/v1.
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDL::Elements::CreateShipmentRequest->new($data);
