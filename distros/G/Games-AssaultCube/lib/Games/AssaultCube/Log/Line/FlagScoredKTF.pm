# Declare our package
package Games::AssaultCube::Log::Line::FlagScoredKTF;
...
Describes the FlagScoredKTF event in a log line

=head1 DESCRIPTION

This module holds the "FlagScoredKTF" event data from a log line. Normally, you would not use this class directly
but via the L<Games::AssaultCube::Log::Line> class.

This line is emitted when a client scores a flag in KTF ( Keep The Flag ) mode.
...
How long ( in seconds ) the client carried the flag

=head3 score

The new score for the client
