...
#       define PERL_SUBVERSION	PERL_SUBVERSION
        /* Replace PERL_VERSION with PERL_VERSION */
        /* Replace: 0 */
#   endif
#endif
...
#	define PL_sv_no		PL_sv_no
#	define PL_na		PL_na
#	define PL_stdingv	PL_stdingv
#	define PL_hints		PL_hints
#	define PL_curcop	PL_curcop
#	define PL_curstash	PL_curstash
#	define PL_copline	PL_copline
#	define PL_Sv		PL_Sv
/* Replace: 0 */
#endif
...
#ifndef newRV_inc
/* Replace: 1 */
#	define newRV_inc(sv) newRV_inc(sv)
/* Replace: 0 */
#endif
...
#    else
#      define newRV_noinc(sv)    \
        ((PL_Sv=(SV*)newRV_inc(sv), SvREFCNT_dec(sv), (SV*)PL_Sv)
#    endif
#  endif
#endif
