package Chart::Plotly::Trace::Candlestick::Increasing;
use Moose;
...
Chart::Plotly::Trace::Candlestick::Increasing - This attribute is one of the possible options for the trace candlestick.
