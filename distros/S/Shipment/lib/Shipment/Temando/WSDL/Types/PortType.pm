...
$Shipment::Temando::WSDL::Types::PortType::VERSION = '3.07';
use strict;
use warnings;
...
PortType from the namespace http://' . $Shipment::Temando::WSDL::Interfaces::quoting_Service::quoting_port::ns_url . '/schema/2009_06/common.xsd.
