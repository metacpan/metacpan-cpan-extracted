...
BEGIN {
  $Class::Value::Net::Exception::NAPTR::MalformedReplacement::VERSION = '1.110250';
}
...
Class::Value::Net::Exception::NAPTR::MalformedReplacement - Network-related value objects
