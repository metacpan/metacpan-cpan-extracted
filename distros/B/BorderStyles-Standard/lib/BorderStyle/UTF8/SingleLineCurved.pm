...
1;
# ABSTRACT: Single-line border with UTF8 characters, curved edges
...
BorderStyle::UTF8::SingleLineCurved - Single-line border with UTF8 characters, curved edges

=head1 VERSION

This document describes version 0.014 of BorderStyle::UTF8::SingleLineCurved (from Perl distribution BorderStyles-Standard), released on 2022-02-20.
...
To use with L<Text::ANSITable>:
 ...
 $t->border_style("UTF8::SingleLineCurved");
 $t->columns($rows->[0]);
...
To use with L<Text::Table::More>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"UTF8::SingleLineCurved");
...
To use with L<Text::Table::TinyBorderStyle>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"BorderStyle::UTF8::SingleLineCurved");
