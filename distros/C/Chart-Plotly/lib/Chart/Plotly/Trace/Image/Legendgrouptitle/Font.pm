package Chart::Plotly::Trace::Image::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Image::Legendgrouptitle::Font - This attribute is one of the possible options for the trace image.
