...
This document describes version 0.045 of Sah::Schema::perl::distname_with_optional_ver (from Perl distribution Sah-Schemas-Perl), released on 2022-09-11.
...
prefiltered) value:
 ...
 # a sample valid data
 $data = "Foo-Bar\@1";
 my $res = $validator->($data); # => ["","Foo-Bar\@1"]
