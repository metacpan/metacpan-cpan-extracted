...
Sah::Schema::perl::modname::default_this_mod - Perl module, defaults to "this module"

=head1 VERSION

This document describes version 0.050 of Sah::Schema::perl::modname::default_this_mod (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::modname::default_this_mod*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::modname::default_this_mod", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::modname::default_this_mod", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::modname::default_this_mod*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::modname::default_this_mod*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::modname::default_this_mod*', name=>'PerlModnameDefaultThisMod')
     );
 }
