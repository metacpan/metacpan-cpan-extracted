package HTML::Widget::JavaScript::Constraint::Any;

use warnings;
use strict;

use base 'HTML::Widget::Constraint::Any';

=head1 NAME

HTML::Widget::JavaScript::Constraint::Any - JavaScript Any Constraint
...
See L<HTML::Widget::Constraint::Any>.
