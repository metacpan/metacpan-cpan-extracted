package Google::Ads::AdWords::v201607::AdGroupCriterionLimitExceeded;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201607::EntityCountLimitExceeded);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201607::EntityCountLimitExceeded::Reason',
        ...
        'limitType' => 'Google::Ads::AdWords::v201607::AdGroupCriterionLimitExceeded::CriteriaLimitType',
    },
    {
...
AdGroupCriterionLimitExceeded from the namespace https://adwords.google.com/api/adwords/cm/v201607.
