package Chart::Plotly::Trace::Histogram2dcontour::Colorbar::Title;
use Moose;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram2dcontour::Colorbar::Title::Font", );
...
Chart::Plotly::Trace::Histogram2dcontour::Colorbar::Title - This attribute is one of the possible options for the trace histogram2dcontour.
