package Google::Ads::AdWords::v201806::CertificateDomainMismatchInCountryConstraint;
use strict;
use warnings;
...
Google::Ads::AdWords::v201806::CertificateDomainMismatchInCountryConstraint

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CertificateDomainMismatchInCountryConstraint from the namespace https://adwords.google.com/api/adwords/cm/v201806.
