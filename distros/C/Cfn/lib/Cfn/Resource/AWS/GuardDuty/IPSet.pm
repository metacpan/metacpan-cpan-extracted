# AWS::GuardDuty::IPSet generated from spec 14.3.0
...
Cfn::Resource::AWS::GuardDuty::IPSet - Cfn resource for AWS::GuardDuty::IPSet

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::GuardDuty::IPSet.
