...
sub meta {
    +{
        v => 4,
        summary => "Coerce string's first character to lower case",
        prio => 50,
    };
}
...
Data::Sah::Coerce::perl::To_str::From_str::to_lower_first - Coerce string's first character to lower case

=head1 VERSION

This document describes version 0.006 of Data::Sah::Coerce::perl::To_str::From_str::to_lower_first (from Perl distribution Data-Sah-Coerce-perl-To_str-From_str-to_upper), released on 2019-11-28.
