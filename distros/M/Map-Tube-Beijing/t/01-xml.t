...
ok( defined( $root->att('name_alt') ),         '<tube> tag should have a name_alt attribute' );
isnt( $root->att('name'),     '',              'name attribute of <tube> tag should not be empty' )     if defined( $root->att('name') );
isnt( $root->att('name_alt'), '',              'name_alt attribute of <tube> tag should not be empty' ) if defined( $root->att('name_alt') );
...
if ( defined($lines) ) {
  ...
  while ($line) {
    ...
    ok( $line->att('name_alt'), "<line> tag #$i should have a non-empty name_alt attribute"  );
...
if ( defined($stations) ) {
  ...
  while ($station) {
    ...
    ok( $station->att('name_alt'), "<station> tag #$i should have a non-empty name_alt attribute"  );
