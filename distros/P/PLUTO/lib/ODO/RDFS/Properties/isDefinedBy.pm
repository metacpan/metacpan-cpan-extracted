package ODO::RDFS::Properties::isDefinedBy;
...
use ODO::RDFS::Properties::seeAlso;

@ISA = (  'ODO::RDFS::Resource',  'ODO::RDFS::Properties::seeAlso', );
...
sub new {
	...
	$self->propertyContainerName( 'ODO::RDFS::Properties::isDefinedBy::PropertiesContainer' );
	$self->properties(bless {}, 'ODO::RDFS::Properties::isDefinedBy::PropertiesContainer');
