...
Faker::Plugin::EsEs::CompanyNamePrefix
...
$test->for('synopsis', sub {
  ...
  ok $result->isa('Faker::Plugin::EsEs::CompanyNamePrefix');
...
$test->for('example', 1, 'execute', sub {
  ...
  is $result->execute, 'Empresa';
  ok $result->faker->random->make; # reset randomizer
  is $result->execute, 'Empresa';
  ok $result->faker->random->make; # reset randomizer
  is $result->execute, 'Viajes';
...
$test->render('lib/Faker/Plugin/EsEs/CompanyNamePrefix.pod') if $ENV{RENDER};
