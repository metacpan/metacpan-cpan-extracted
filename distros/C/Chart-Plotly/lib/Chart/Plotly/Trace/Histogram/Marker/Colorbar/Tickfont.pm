package Chart::Plotly::Trace::Histogram::Marker::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Histogram::Marker::Colorbar::Tickfont - This attribute is one of the possible options for the trace histogram.
