...
Version: 0.08
Release: 1
Source: ftp://ftp.uu.net/vendor/bitsko/gdo/Quilt-0.08.tar.gz
...
SPEC_DIR="${RPM_ROOT_DIR}/usr/lib/sgml/Quilt-0.08"
mkdir -p ${SPEC_DIR}
...
sed <tmpfront.sh >"${RPM_ROOT_DIR}/usr/bin/sroff" \
  -e "s|/home/ken/src/Quilt/specs|${RPM_PREFIX:-/usr}/lib/sgml/Quilt-0.08|" \
