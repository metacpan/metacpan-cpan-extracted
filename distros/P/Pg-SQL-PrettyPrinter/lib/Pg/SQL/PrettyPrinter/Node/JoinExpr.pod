...
Pg::SQL::PrettyPrinter::Node::JoinExpr - Class representing join between two "tables"
...
Textual representation of current join type (JOIN, LEFT/RIGHT/FULL JOIN).
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Pg::SQL::PrettyPrinter::Node::JoinExpr
