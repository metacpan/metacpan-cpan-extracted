...
if (fc('ⅱⅳⅵⅷⅹ') eq 'ⅱⅳⅵⅷⅹ') {
    print qq{ok - 2 fc('ⅱⅳⅵⅷⅹ') eq 'ⅱⅳⅵⅷⅹ'\n};
}
else {
    print qq{not ok - 2 fc('ⅱⅳⅵⅷⅹ') eq 'ⅱⅳⅵⅷⅹ'\n};
}
...
if ("\Fⅱⅳⅵⅷⅹ\E" eq "ⅱⅳⅵⅷⅹ") {
    print qq{ok - 4 "\\Fⅱⅳⅵⅷⅹ\\E" eq "ⅱⅳⅵⅷⅹ"\n};
}
else {
    print qq{not ok - 4 "\\Fⅱⅳⅵⅷⅹ\\E" eq "ⅱⅳⅵⅷⅹ"\n};
}
...
if ("ⅱⅳⅵⅷⅹ" =~ /\Fⅱⅳⅵⅷⅹ\E/) {
    print qq{ok - 11 "ⅱⅳⅵⅷⅹ" =~ /\\Fⅱⅳⅵⅷⅹ\\E/\n};
}
else {
    print qq{not ok - 11 "ⅱⅳⅵⅷⅹ" =~ /\\Fⅱⅳⅵⅷⅹ\\E/\n};
}

if ("ⅱⅳⅵⅷⅹ" =~ /\Fⅱⅳⅵⅷⅹ\E/i) {
    print qq{ok - 12 "ⅱⅳⅵⅷⅹ" =~ /\\Fⅱⅳⅵⅷⅹ\\E/i\n};
}
else {
    print qq{not ok - 12 "ⅱⅳⅵⅷⅹ" =~ /\\Fⅱⅳⅵⅷⅹ\\E/i\n};
}

$var = 'ⅱⅳⅵⅷⅹ';
if ("ⅱⅳⅵⅷⅹ" =~ /\F$var\E/i) {
    print qq{ok - 13 "ⅱⅳⅵⅷⅹ" =~ /\\F\$var\\E/i\n};
}
else {
    print qq{not ok - 13 "ⅱⅳⅵⅷⅹ" =~ /\\F\$var\\E/i\n};
}
