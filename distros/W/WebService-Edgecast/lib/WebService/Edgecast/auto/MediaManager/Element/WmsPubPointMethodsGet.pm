...
package WebService::Edgecast::auto::MediaManager::Element::WmsPubPointMethodsGet;
BEGIN {
  $WebService::Edgecast::auto::MediaManager::Element::WmsPubPointMethodsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('WmsPubPointMethodsGet');
...
WebService::Edgecast::auto::MediaManager::Element::WmsPubPointMethodsGet
...
WmsPubPointMethodsGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::MediaManager::Element::WmsPubPointMethodsGet->new($data);
