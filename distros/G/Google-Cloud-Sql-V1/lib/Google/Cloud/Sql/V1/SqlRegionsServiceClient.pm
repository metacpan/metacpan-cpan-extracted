package Google::Cloud::Sql::V1::SqlRegionsServiceClient;
...
our $VERSION = '0.02';
1; # End of Google::Cloud::Sql::V1::SqlRegionsServiceClient

__END__

=head1 NAME

Google::Cloud::Sql::V1::SqlRegionsServiceClient - Auto-generated Protocol Buffers schema container
