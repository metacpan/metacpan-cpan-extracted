...
This document describes Attean::TripleModel version 0.039
...
package Attean::TripleModel 0.039 {
	use Moo;
...
package Attean::AddativeTripleModelRole 0.039 {
...
package Attean::MutableTripleModel 0.039 {
	use Moo;
	use Types::Standard qw(ArrayRef ConsumerOf HashRef);
...
package Attean::AddativeTripleModel 0.039 {
	use Moo;
	use Scalar::Util qw(blessed);
	use Types::Standard qw(CodeRef);
	use namespace::clean;
...
package Attean::AddativeMutableTripleModel 0.039 {
	use Moo;
	use Scalar::Util qw(blessed);
	use Types::Standard qw(CodeRef);
	use namespace::clean;
