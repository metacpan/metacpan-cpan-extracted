...
foreach my $filename (
    ...
    "lib\/Dist\/Zilla\/Plugin\/Hook\/AfterBuild\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/AfterMint\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/AfterRelease\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/BeforeArchive\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/BeforeBuild\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/BeforeMint\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/BeforeRelease\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/FileGatherer\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/FileMunger\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/FilePruner\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/Init\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/InstallTool\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/LicenseProvider\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/Manual\.pod",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/MetaProvider\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/ModuleMaker\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/NameProvider\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/PrereqSource\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/ReleaseStatusProvider\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/Releaser\.pm",
    "lib\/Dist\/Zilla\/Plugin\/Hook\/VersionProvider\.pm",
