...
our $rschema = ["array",[{examples=>[{valid=>1,validated_value=>[],value=>""},{valid=>0,value=>0},{valid=>1,validated_value=>[1],value=>1},{valid=>1,validated_value=>[1,7],value=>"1,7"},{valid=>1,value=>[1,7]},{valid=>0,value=>"1,7,8"},{valid=>0,value=>[1,7,8]}],of=>["date::dow_num::id",{},{}],summary=>"Array of day-of-week numbers (1-7, 1=Monday)","x.completion"=>["date_dow_nums_id"],"x.perl.coerce_rules"=>["From_str::comma_sep"]}],["array"]];
...
Sah::SchemaR::date::dow_nums::id - Array of day-of-week numbers (1-7, 1=Monday)

=head1 VERSION

This document describes version 0.005 of Sah::SchemaR::date::dow_nums::id (from Perl distribution Sah-Schemas-Date-ID), released on 2020-03-08.
