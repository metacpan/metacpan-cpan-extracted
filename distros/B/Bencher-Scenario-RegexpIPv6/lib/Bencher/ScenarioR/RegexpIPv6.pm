package Bencher::ScenarioR::RegexpIPv6;
...
our $results = [
  [
    ...
    ],
    {
      ...
      "func.elapsed_time"              => 0.0828828811645508,
      "func.module_startup"            => undef,
      "func.module_versions"           => {
                                            "__PACKAGE__" => 1.034,
                                            "Bencher::Scenario::RegexpIPv6" => undef,
                                            "Benchmark::Dumb" => "0.10",
      ...
      "func.precision"                 => 0,
      "func.scenario_module"           => "Bencher::Scenario::RegexpIPv6",
      "func.scenario_module_md5sum"    => "eee35fc50f60ada24ba0ef713959b305",
