...
my $color  = Latin10::substr $s, 4, 5;   # black
my $middle = Latin10::substr $s, 4, -11; # black cat climbed the
my $end    = Latin10::substr $s, 14;     # climebed the green tree
my $tail   = Latin10::substr $s, -4;     # tree
my $z      = Latin10::substr $s, -4, 2;  # tr
