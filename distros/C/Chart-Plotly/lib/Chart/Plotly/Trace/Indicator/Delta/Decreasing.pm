package Chart::Plotly::Trace::Indicator::Delta::Decreasing;
use Moose;
...
Chart::Plotly::Trace::Indicator::Delta::Decreasing - This attribute is one of the possible options for the trace indicator.
