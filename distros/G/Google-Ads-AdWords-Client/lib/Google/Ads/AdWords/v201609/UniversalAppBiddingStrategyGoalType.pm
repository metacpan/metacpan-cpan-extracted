package Google::Ads::AdWords::v201609::UniversalAppBiddingStrategyGoalType;
use strict;
use warnings;
...
UniversalAppBiddingStrategyGoalType from the namespace https://adwords.google.com/api/adwords/cm/v201609.
