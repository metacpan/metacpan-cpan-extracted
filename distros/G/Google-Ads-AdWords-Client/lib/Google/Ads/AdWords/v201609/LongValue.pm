package Google::Ads::AdWords::v201609::LongValue;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201609::NumberValue);
# Variety: sequence
...
LongValue from the namespace https://adwords.google.com/api/adwords/cm/v201609.
