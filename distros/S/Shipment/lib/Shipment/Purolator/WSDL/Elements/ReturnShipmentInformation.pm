...
package Shipment::Purolator::WSDL::Elements::ReturnShipmentInformation;
$Shipment::Purolator::WSDL::Elements::ReturnShipmentInformation::VERSION = '3.11';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    __PACKAGE__->__set_name('ReturnShipmentInformation');
