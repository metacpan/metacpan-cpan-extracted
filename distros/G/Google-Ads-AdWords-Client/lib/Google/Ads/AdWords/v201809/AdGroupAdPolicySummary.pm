package Google::Ads::AdWords::v201809::AdGroupAdPolicySummary;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::AdGroupAdPolicySummary

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupAdPolicySummary from the namespace https://adwords.google.com/api/adwords/cm/v201809.
