...
Sah::Schema::posodd - Positive odd number

=head1 VERSION

This document describes version 0.077 of Sah::Schema::posodd (from Perl distribution Sah-Schemas-Int), released on 2022-10-19.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("posodd*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("posodd", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("posodd", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("posodd*");
     $validator->(\@args);
     ...
 }
...
To create a type constraint and type library from a schema:
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('$sch_name*', name=>'Posodd')
     );
 }

 use My::Types qw(Posodd);
 Posodd->assert_valid($data);
