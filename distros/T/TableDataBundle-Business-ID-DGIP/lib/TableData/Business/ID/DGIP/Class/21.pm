...
our %STATS = ("num_rows",2390,"num_columns",2); # STATS
...
This document describes version 20220831.0.0 of TableDataRole::Business::ID::DGIP::Class::21 (from Perl distribution TableDataBundle-Business-ID-DGIP), released on 2022-09-01.
