package App::toposort;

our $VERSION = '0.001'; # VERSION

1;
# ABSTRACT: Topological sort
...
App::toposort - Topological sort

=head1 VERSION

This document describes version 0.001 of App::toposort (from Perl distribution App-toposort), released on 2017-04-03.

=head1 SYNOPSIS

See the command-line script L<toposort>.
