package Chart::Plotly::Trace::Isosurface::Caps::X;
use Moose;
...
Chart::Plotly::Trace::Isosurface::Caps::X - This attribute is one of the possible options for the trace isosurface.
