...
$Shipment::FedEx::WSDL::RateTypes::SmartPostShipmentDetail::VERSION = '3.10';
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'Indicia' => 'Shipment::FedEx::WSDL::RateTypes::SmartPostIndiciaType',
        'AncillaryEndorsement' => 'Shipment::FedEx::WSDL::RateTypes::SmartPostAncillaryEndorsementType',
...
SmartPostShipmentDetail from the namespace http://fedex.com/ws/rate/v9.
