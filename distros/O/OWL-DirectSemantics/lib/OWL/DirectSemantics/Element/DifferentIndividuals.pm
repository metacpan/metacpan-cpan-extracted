package OWL::DirectSemantics::Element::DifferentIndividuals;

BEGIN {
	$OWL::DirectSemantics::Element::DifferentIndividuals::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::DifferentIndividuals::VERSION   = '0.001';
};
...
OWL::DirectSemantics::Element::DifferentIndividuals - represents an OWL DifferentIndividuals

=head1 DESCRIPTION

This class represents the DifferentIndividuals element in OWL Direct Semantics.
