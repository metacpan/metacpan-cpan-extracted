...
#line 160 "t/lib/MyTest_xsgen.cc"


XS_EUPXS(XS_MyTest_native_srand) { xs::throw_guard(cv, [=]() 
{
    dVAR; dXSARGS;
    if (items != 1)
    ...
    SP -= items;
    {
	int	seed = (int)SvIV(ST(0))
;
#line 10 "t/lib/MyTest.xs"
    seed = 778;
    std::srand(seed);
#line 176 "t/lib/MyTest_xsgen.cc"
	PUTBACK;
	return;
    }
}); }
...
#  endif
        ...
        newXS_deffile("MyTest::native_srand", XS_MyTest_native_srand);
#if PERL_VERSION_LE(5, 21, 5)
