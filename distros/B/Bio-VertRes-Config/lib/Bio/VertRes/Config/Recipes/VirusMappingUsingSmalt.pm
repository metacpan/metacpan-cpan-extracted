package Bio::VertRes::Config::Recipes::VirusMappingUsingSmalt;
...
override '_pipeline_configs' => sub {
    ...
    $self->add_virus_smalt_mapping_config(\@pipeline_configs);
...
Bio::VertRes::Config::Recipes::VirusMappingUsingSmalt - Standard snp calling pipeline for virus
...
Standard snp calling pipeline for virus.
   ...
   my $obj = Bio::VertRes::Config::Recipes::VirusMappingUsingSmalt->new( 
     database => 'abc', 
