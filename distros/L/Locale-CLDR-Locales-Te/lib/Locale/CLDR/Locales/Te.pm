	...
	default		=> sub {
		{
			'calendar' => {
 			...
 			'lb' => {
 				'loose' => q{వదులు లైన్ బ్రేక్ శైలి},
 				'normal' => q{సాధారణ లైన్ బ్రేక్ శైలి},
 				'strict' => q{కఠిన లైన్ బ్రేక్ శైలి},
 			},
 			'ms' => {
	...
	default		=> sub { {
				'long' => {
					...
					'liter-per-100kilometers' => {
						'name' => q(లీటర్లు/100 కిలోమీటర్లకు),
						'one' => q({0} లీటరు/100 కిలోమీటర్లకు),
						'other' => q({0} లీటర్లు/100 కిలోమీటర్లకు),
					},
					'liter-per-kilometer' => {
					...
					'pound-per-square-inch' => {
						'name' => q(పౌండ్లు/చదరపు అంగుళం),
						'one' => q({0} పౌండు/చదరపు అంగుళం),
						'other' => q({0} పౌండ్లు/చదరపు అంగుళం),
					},
					'quart' => {
						'name' => q(పావు వంతులు),
						'one' => q({0} పావు వంతు),
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'Australia_CentralWestern' => {
			long => {
				'daylight' => q(మధ్యమ ఆస్ట్రేలియన్ పశ్చిమ పగటి సమయం),
				'generic' => q(మధ్యమ ఆస్ట్రేలియన్ పశ్చిమ సమయం),
		...
		'Australia_Western' => {
			long => {
				'daylight' => q(పశ్చిమ ఆస్ట్రేలియన్ పగటి సమయం),
				'generic' => q(పశ్చిమ ఆస్ట్రేలియా సమయం),
				'standard' => q(పశ్చిమ ఆస్ట్రేలియన్ ప్రామాణిక సమయం),
			},
		},
		'Azerbaijan' => {
			long => {
		...
		'Irkutsk' => {
			long => {
				'daylight' => q(ఇరక్వుట్స్క్ వేసవి సమయం),
				'generic' => q(ఇరక్వుట్స్క్ సమయం),
				'standard' => q(ఇరక్వుట్స్క్ ప్రామాణిక సమయం),
			},
		},
		'Israel' => {
			long => {
		...
		'Mawson' => {
			long => {
				'standard' => q(మావ్సన్ సమయం),
			},
		},
		'Mexico_Northwest' => {
			long => {
				'daylight' => q(వాయవ్య మెక్సికో పగటి సమయం),
				'generic' => q(వాయవ్య మెక్సికో సమయం),
				'standard' => q(వాయవ్య మెక్సికో ప్రామాణిక సమయం),
			},
		},
		'Mexico_Pacific' => {
			long => {
				'daylight' => q(మెక్సికన్ పసిఫిక్ పగటి సమయం),
		...
		'Pierre_Miquelon' => {
			long => {
				'daylight' => q(సెయింట్ పియర్ మరియు మిక్వెలాన్ పగటి సమయం),
