...
my $color  = Latin3::substr $s, 4, 5;   # black
my $middle = Latin3::substr $s, 4, -11; # black cat climbed the
my $end    = Latin3::substr $s, 14;     # climebed the green tree
my $tail   = Latin3::substr $s, -4;     # tree
my $z      = Latin3::substr $s, -4, 2;  # tr
