...
IMDB::Local::Keyword - Object representation of Keyword information.
...
sub createNew($%)
{
    ...
    return new IMDB::Local::Keyword(imdbdb=>$imdbdb, TableID=>$id);
}

sub findByKeywordID($$)
{
    my ($imdbdb, $id)=@_;
    return new IMDB::Local::Keyword(imdbdb=>$imdbdb, DB_KEY, $id);
}
