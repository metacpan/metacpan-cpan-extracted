package Microsoft::AdCenter::V8::BulkService::Test::BatchError;
...
use Microsoft::AdCenter::V8::BulkService::BatchError;

sub test_can_create_batch_error_and_set_all_fields : Test(6) {
    my $batch_error = Microsoft::AdCenter::V8::BulkService::BatchError->new
        ->Code('code')
        ->Details('details')
