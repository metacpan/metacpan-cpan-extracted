#!/usr/bin/env perl
# PODNAME: debrief-taxR-42.pl
# ABSTRACT: [UNSTABLE] Summarize the results of a 42 metagenomic run
...
# TODO: devise a better name for this script (so as to explain it in 42 manual)
...
# TODO: rethink column names for direct compatibility with R

say {$out} join "\t", 'bank', 'tested-genes', 'enrich-ali', 'clean-ali',
                        'contam-ali', 'completeness', 'added_seq', 'clean-seq', 'contam-seq',
                        'unclassified-contam-seq', 'unkown-seq', @mod_phyla, 'foreign-phyla',
                        'global-contam-perc', 'contam-perc', 'unclassified-contam-perc', 'unknown-perc'
                        ;

say {$out_sum} join "\t", 'bank', 'tested-genes', 'enrich-ali', 'clean-ali',
                            'contam-ali', 'completeness', 'added_seq', 'clean-seq', 'contam-seq',
                            'unclassified-contam-seq', 'unknown-seq', 'foreign-phyla', 'global-contam-perc',
                            'contam-perc', 'unclassified-contam-perc', 'unknown-perc';
