...
package TeX::Hyphen::Pattern::Fi_ec v1.1.7;
use strict;
use warnings;
use 5.014000;
use utf8;
...
sub version {
    return $TeX::Hyphen::Pattern::Fi_ec::VERSION;
}
...
=head1 C<Fi_ec> hyphenation pattern class
...
L<svn://tug.org/texhyphen/trunk/hyph-utf8/tex/generic/hyph-utf8/patterns/ptex/hyph-fi.ec.tex>
