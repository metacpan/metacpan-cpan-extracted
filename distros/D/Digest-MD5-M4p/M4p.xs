 ...
 * 
 *  From observation of iTunes implementations.
 *
 *  Copyright 2004 William Herrera.
 *  Copyright 1998-2000 Gisle Aas.
 *  Copyright 1995-1996 Neil Winton.
 *  Copyright 1991-1992 RSA Data Security, Inc.
 *
 * This code is shamelessly copied from Gisle Aas's Digest::MD5 code, 
 * which in turn is derived from  Neil Winton's MD5-1.7 Perl module, which in 
 * turn is derived from the reference implementation in RFC 1321, which is
...
/* begin apple md5 modification type 1 */
	...
	if(AppleModLevel == 1) 
	{
	    GG (b, c, d, a,  8, S24, 0x445a14ed); /* 28 */
	}
	else /* real MD5 */
	{
...
static MD5_CTX* get_md5_ctx(pTHX_ SV* sv)
{
    ...
    croak("Not a reference to a Digest::MD5::M4p object");
