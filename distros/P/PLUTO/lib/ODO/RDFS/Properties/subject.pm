package ODO::RDFS::Properties::subject;
...
sub new {
	...
	$self->propertyContainerName( 'ODO::RDFS::Properties::subject::PropertiesContainer' );
	$self->properties(bless {}, 'ODO::RDFS::Properties::subject::PropertiesContainer');
