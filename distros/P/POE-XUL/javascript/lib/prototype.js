    ...
    if (state == 'Complete') {
      try {
        ...
        if( ! ( name in this.options ) ) {
            name = 'on' + (this.success() ? 'Success' : 'Failure');
        }
...
Element.addMethods = function(methods) {
  ...
  if( typeof XULElement != 'undefined' ) {
    copy( Element.Methods, XULElement.prototype );
    copy(Element.Methods.Simulated, XULElement.prototype, true);
  }
}
