# AWS::Pinpoint::APNSSandboxChannel generated from spec 14.3.0
use Moose::Util::TypeConstraints;

coerce 'Cfn::Resource::Properties::AWS::Pinpoint::APNSSandboxChannel',
  from 'HashRef',
   via { Cfn::Resource::Properties::AWS::Pinpoint::APNSSandboxChannel->new( %$_ ) };

package Cfn::Resource::AWS::Pinpoint::APNSSandboxChannel {
  use Moose;
  extends 'Cfn::Resource';
  has Properties => (isa => 'Cfn::Resource::Properties::AWS::Pinpoint::APNSSandboxChannel', is => 'rw', coerce => 1);
...
package Cfn::Resource::Properties::AWS::Pinpoint::APNSSandboxChannel {
  use Moose;
...
Cfn::Resource::AWS::Pinpoint::APNSSandboxChannel - Cfn resource for AWS::Pinpoint::APNSSandboxChannel

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::Pinpoint::APNSSandboxChannel.
