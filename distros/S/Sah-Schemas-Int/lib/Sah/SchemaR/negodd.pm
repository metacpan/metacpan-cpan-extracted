...
our $rschema = [
  ...
  [
    ...
    { "div_by" => 2, "div_by.op" => "not", "summary" => "Negative odd number" },
  ],
  ["negint", "int"],
];
...
This document describes version 0.06 of Sah::SchemaR::negodd (from Perl distribution Sah-Schemas-Int), released on 2016-07-22.
