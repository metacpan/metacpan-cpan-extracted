...
#  set some to zero, and shuffle them
my @data
  = Math::Random::MT::Auto::shuffle
    map {rand() < 0.5 ? $_ : 0}
    map {int ($_ ** 1.3)} (1..$nsamples);
