package OWL::DirectSemantics::Element::FunctionalDataProperty;
...
OWL::DirectSemantics::Element::FunctionalDataProperty - represents an OWL FunctionalDataProperty

=head1 DESCRIPTION

This class represents the FunctionalDataProperty element in OWL Direct Semantics.
