...
Please report any bugs or feature requests to C<bug-ansible at rt.cpan.org>, or through
the web interface at L<https://rt.cpan.org/NoAuth/ReportBug.html?Queue=Ansible>.  I will be notified, and then you'll
...
L<https://rt.cpan.org/NoAuth/Bugs.html?Dist=Ansible>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/Ansible>

=item * CPAN Ratings

L<https://cpanratings.perl.org/d/Ansible>

=item * Search CPAN

L<https://metacpan.org/release/Ansible>
