package Google::Ads::AdWords::v201309::FeedChangeData;
use strict;
use warnings;
...
my %deletedFeedItems_of :ATTR(:get<deletedFeedItems>);
...
__PACKAGE__->_factory(
    ...
    ) ],
    {
        ...
        'deletedFeedItems' => \%deletedFeedItems_of,
    },
    {
        'feedId' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'feedChangeStatus' => 'Google::Ads::AdWords::v201309::ChangeStatus',
        'changedFeedItems' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'deletedFeedItems' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
    },
    {
...
Google::Ads::AdWords::v201309::FeedChangeData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedChangeData from the namespace https://adwords.google.com/api/adwords/ch/v201309.
