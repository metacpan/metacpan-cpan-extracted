package Chart::Plotly::Trace::Candlestick::Hoverlabel;
use Moose;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Candlestick::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Candlestick::Hoverlabel - This attribute is one of the possible options for the trace candlestick.
