########################################
# fetch deleted objects when Oid already in object cache
########################################
use t::lib;
use strict;
use Carp;
...
ok_objcache($actual_p0,$p0_oid,'OidDeleted',
	    'Persistent','p0 fetched as OidDeleted',__FILE__,__LINE__);
ok_objcache($actual_p1,$p1_oid,'OidDeleted','Persistent',
	    'p1 fetched as OidDeleted',__FILE__,__LINE__);
