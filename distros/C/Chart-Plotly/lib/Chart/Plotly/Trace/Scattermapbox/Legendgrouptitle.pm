package Chart::Plotly::Trace::Scattermapbox::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Scattermapbox::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattermapbox::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Scattermapbox::Legendgrouptitle - This attribute is one of the possible options for the trace scattermapbox.
