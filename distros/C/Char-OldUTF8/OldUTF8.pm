...
# regexp of character
my $qq_char   = qr/(?> \\c[\x40-\x5F] | \\? (?:(?:[\xC0-\xDF]|[\xE0-\xEF][\x80-\xBF]|[\xF0-\xF4][\x80-\xBF][\x80-\xBF])[\x80-\xBF] | [\x00-\xFF]) )/oxms;
my  $q_char   = qr/(?> (?:[\xC0-\xDF]|[\xE0-\xEF][\x80-\xBF]|[\xF0-\xF4][\x80-\xBF][\x80-\xBF])[\x80-\xBF] | [\x00-\xFF] )/oxms;
...
=head1 Un-Escaping \ of \b{}, \B{}, \N{}, \p{}, \P{}, and \X (OldUTF8 software provides)

OldUTF8 software removes '\' at head of alphanumeric regexp metasymbols \b{}, \B{},
...
=head1 Yada Yada Operator (OldUTF8 software provides)
