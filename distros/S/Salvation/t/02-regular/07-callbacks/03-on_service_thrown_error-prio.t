...
package Salvation::_t02_07_03::System;
...
sub on_service_thrown_error
{
	...
	&Test::More::isnt( $err -> [ 0 ], 'second' );

	&Test::More::ok( !blessed( $service ) );
	&Test::More::is( $service, 'Salvation::_t02_07_03::System::Services::Service01' );
	&Test::More::isa_ok( $service, 'Salvation::Service' );

	&Test::More::ok( blessed $instance );
	&Test::More::isa_ok( $instance, 'Salvation::_t02_07_03::System::Services::Service01' );
	&Test::More::isa_ok( $instance, 'Salvation::Service' );
}

no Moose;

package Salvation::_t02_07_03::System::Services::Service01;
...
my $o = new_ok( 'Salvation::_t02_07_03::System' );
