...
# 161
    ...
    sub { 1 or eval q{     ("‚ " =~ $r2{qr/[\C]/})                                           }},
    sub { 1 or eval q{     ("‚ " =~ $r2{qr/[\C]/})   && ($& eq "\xE3")                       }},
    sub { 1 or eval q{     ("‚ " =~ $r2{qr/[\C]/})   && ($& eq "\xE3") && ($' eq "\x81\x82") }},
    sub { 1 or eval q{     ("‚ " =~ $r2{qr/([\C])/})                                         }},
    sub { 1 or eval q{     ("‚ " =~ $r2{qr/([\C])/}) && ($1 eq "\xE3")                       }},
    sub { 1 or eval q{     ("‚ " =~ $r2{qr/([\C])/}) && ($1 eq "\xE3") && ($' eq "\x81\x82") }},
    sub {1},
    sub {1},
    sub {1},
# 171
    sub { 1 or eval q{     ("‚ " =~ $r2{qr/[\N]/})                   }},
    sub { 1 or eval q{     ("‚ " =~ $r2{qr/[\N]/})   && ($& eq '‚ ') }},
    sub { 1 or eval q{     ("‚ " =~ $r2{qr/([\N])/}) && ($1 eq '‚ ') }},
    sub { 1 or eval q{ not ("\n" =~ $r2{qr/[\N]/})                   }},
    sub {1},
    sub {1},
    sub {1},
...
# 341
    ...
    sub {1},
# 351
    sub { 1 or ($] >= 5.006) or "\x00"             =~ $r2{qr/[\x00]/}                   },
    sub { 1 or ($] >= 5.006) or "\x7F"             =~ $r2{qr/[\x7F]/}                   },
    sub { 1 or ($] >= 5.006) or "\xC2\x80"         =~ $r2{qr/[\xC2][\x80]/}             },
    sub { 1 or ($] >= 5.006) or "\xDF\xBA"         =~ $r2{qr/[\xDF][\xBA]/}             },
    sub { 1 or ($] >= 5.006) or "\xE0\xA0\x80"     =~ $r2{qr/[\xE0][\xA0][\x80]/}       },
    sub { 1 or ($] >= 5.006) or "\xE0\xBF\x9A"     =~ $r2{qr/[\xE0][\xBF][\x9A]/}       },
    sub { 1 or ($] >= 5.006) or "\xF0\x90\x80\x80" =~ $r2{qr/[\xF0][\x90][\x80][\x80]/} },
    sub { 1 or ($] >= 5.006) or "\xF0\x90\xB9\xBE" =~ $r2{qr/[\xF0][\x90][\xB9][\xBE]/} },
    sub {1},
    sub {1},
# 361
    sub { ($] < 5.006) or "\x00"             =~ $r2{qr/[\x{00}]/}     },
    sub { ($] < 5.006) or "\x7F"             =~ $r2{qr/[\x{7F}]/}     },
    sub { ($] < 5.006) or "\xC2\x80"         =~ $r2{qr/[\x{80}]/}     },
    sub { ($] < 5.006) or "\xC2\x80"         =~ $r2{qr/[\x{0080}]/}   },
    sub { ($] < 5.006) or "\xDF\xBA"         =~ $r2{qr/[\x{7FA}]/}    },
    sub { ($] < 5.006) or "\xDF\xBA"         =~ $r2{qr/[\x{07FA}]/}   },
    sub { ($] < 5.006) or "\xE0\xA0\x80"     =~ $r2{qr/[\x{800}]/}    },
    sub { ($] < 5.006) or "\xE0\xA0\x80"     =~ $r2{qr/[\x{0800}]/}   },
    sub { ($] < 5.006) or "\xE0\xBF\x9A"     =~ $r2{qr/[\x{FDA}]/}    },
    sub { ($] < 5.006) or "\xE0\xBF\x9A"     =~ $r2{qr/[\x{0FDA}]/}   },
# 371
    sub { ($] < 5.006) or "\xF0\x90\x80\x80" =~ $r2{qr/[\x{10000}]/}  },
    sub { ($] < 5.006) or "\xF0\x90\x80\x80" =~ $r2{qr/[\x{010000}]/} },
    sub { ($] < 5.006) or "\xF0\x90\xB9\xBE" =~ $r2{qr/[\x{10E7E}]/}  },
    sub { ($] < 5.006) or "\xF0\x90\xB9\xBE" =~ $r2{qr/[\x{010E7E}]/} },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 411
    sub {                       ("‚ A‚¢‚¤12" =~ $r2{qr/[^‚¢‚¤]/})                     },
    sub { ($] =~ /\A5\.006/) or ("‚ A‚¢‚¤12" =~ $r2{qr/[^‚¢‚¤]/})    && ($& eq '‚ ')  },
    sub { ($] =~ /\A5\.006/) or ("‚ A‚¢‚¤12" =~ $r2{qr/([^‚¢‚¤])/})  && ($1 eq '‚ ')  },
    sub { ($] =~ /\A5\.006/) or ("‚ A‚¢‚¤12" =~ $r2{qr/[^‚¢‚¤]+/})   && ($& eq '‚ A') },
    sub { ($] =~ /\A5\.006/) or ("‚ A‚¢‚¤12" =~ $r2{qr/([^‚¢‚¤]+)/}) && ($1 eq '‚ A') },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 421
    ...
    sub {             ($] =~ /\A5\.006/) or ("‚ A‚¢‚¤12" =~ $r2{qr/[^‚¦‚¨]/})   && ($& eq '‚ ') },
    sub {             ($] =~ /\A5\.006/) or ("‚ A‚¢‚¤12" =~ $r2{qr/([^‚¦‚¨])/}) && ($1 eq '‚ ') },
    sub { my $e='‚¦'; ($] =~ /\A5\.006/) or ("‚ A‚¢‚¤12" =~ $r2{qr/[^${e}‚¨]/}) && ($& eq '‚ ') },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
