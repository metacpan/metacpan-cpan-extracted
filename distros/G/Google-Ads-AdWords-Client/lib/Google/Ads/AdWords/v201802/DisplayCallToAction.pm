package Google::Ads::AdWords::v201802::DisplayCallToAction;
use strict;
use warnings;
...
Google::Ads::AdWords::v201802::DisplayCallToAction

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DisplayCallToAction from the namespace https://adwords.google.com/api/adwords/cm/v201802.
