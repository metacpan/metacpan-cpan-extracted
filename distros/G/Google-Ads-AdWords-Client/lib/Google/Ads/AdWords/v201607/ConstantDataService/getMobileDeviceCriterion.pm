...
package Google::Ads::AdWords::v201607::ConstantDataService::getMobileDeviceCriterion;
use strict;
use warnings;
...
getMobileDeviceCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201607.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201607::ConstantDataService::getMobileDeviceCriterion->new($data);
