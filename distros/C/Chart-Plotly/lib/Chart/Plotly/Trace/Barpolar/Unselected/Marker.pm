package Chart::Plotly::Trace::Barpolar::Unselected::Marker;
use Moose;
...
Chart::Plotly::Trace::Barpolar::Unselected::Marker - This attribute is one of the possible options for the trace barpolar.
