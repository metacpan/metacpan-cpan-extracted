...
our $rschema = [
  ...
  [
    {
      max => 1.70141183460469e+38,
      min => -1.70141183460469e+38,
...
This document describes version 0.06 of Sah::SchemaR::int128 (from Perl distribution Sah-Schemas-Int), released on 2016-07-22.
