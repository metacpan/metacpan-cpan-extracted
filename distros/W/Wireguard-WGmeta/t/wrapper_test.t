...
# add peer
my ($iface_privkey, $iface_listen) = $wg_meta->add_peer('mini_wg0', '10.0.0.9/32', 'sa9sXzMC5h4oE+38M38D1bcakH7nQBChAN1ib30lODc=');
...
# enable disable peer
$wg_meta->disable('mini_wg1','Alias2');
$wg_meta->enable('mini_wg1', 'WG_1_PEER_B_PUBLIC_KEY');
$wg_meta->disable('mini_wg1','WG_1_PEER_B_PUBLIC_KEY');
