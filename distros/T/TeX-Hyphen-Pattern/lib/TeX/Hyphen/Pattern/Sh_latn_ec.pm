...
package TeX::Hyphen::Pattern::Sh_latn_ec v1.1.1;
use strict;
use warnings;
use 5.014000;
use utf8;
...
sub version {
    return $TeX::Hyphen::Pattern::Sh_latn_ec::VERSION;
}
...
=head1 C<Sh_latn_ec> hyphenation pattern class
...
L<svn://tug.org/texhyphen/trunk/hyph-utf8/tex/generic/hyph-utf8/patterns/ptex/hyph-sh-latn.ec.tex>
