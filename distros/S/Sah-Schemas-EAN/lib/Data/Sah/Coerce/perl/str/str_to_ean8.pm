...
Data::Sah::Coerce::perl::str::str_to_ean8 - Check and format EAN-8 number from string

=head1 VERSION

This document describes version 0.003 of Data::Sah::Coerce::perl::str::str_to_ean8 (from Perl distribution Sah-Schemas-EAN), released on 2019-07-25.
