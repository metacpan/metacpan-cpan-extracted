...
aegis_conf_development_test_command.pl - run tests for aegis in development.
...
=head1 DETAILS
	...
	MANIFEST: aegis_conf_development_test_command.pl
	PROJECT: meta
	VERSION: 0.01

=head1 SYNOPSIS

	aegis_conf_development_test_command.pl

=head1 DESCRIPTION

This script is called by aegis to run tests at development time..
