...
[Security Advisories](https://github.com/pmqs/Compress-Raw-Lzma/security/advisories).
(If you do not have access to GitHub, then you can report issues via email
to <pmqs@cpan.org>.)

The latest version of the Security Policy can be found in the
[git repository for Compress::Raw::Lzma](https://github.com/pmqs/Compress-Raw-Lzma/blob/main/SECURITY.md).
