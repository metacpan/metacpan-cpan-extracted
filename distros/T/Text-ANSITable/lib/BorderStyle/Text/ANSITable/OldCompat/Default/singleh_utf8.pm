...
BorderStyle::Text::ANSITable::OldCompat::Default::singleh_utf8 - UTF8::SingleLineHorizontalOnly border style (with old name)

=head1 VERSION

This document describes version 0.607 of BorderStyle::Text::ANSITable::OldCompat::Default::singleh_utf8 (from Perl distribution Text-ANSITable), released on 2021-08-27.
