package Chart::Plotly::Trace::Scattergl::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Scattergl::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattergl::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Scattergl::Hoverlabel - This attribute is one of the possible options for the trace scattergl.
