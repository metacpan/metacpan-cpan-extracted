...
$Search::Elasticsearch::Client::6_0::Direct::VERSION = '6.81';
use Moo;
...
The L<Search::Elasticsearch::Client::6_0::Direct> class provides the
...
Returns a L<Search::Elasticsearch::Client::6_0::Direct::Indices> object which can be used
...
Returns a L<Search::Elasticsearch::Client::6_0::Direct::Ingest> object which can be used
...
Returns a L<Search::Elasticsearch::Client::6_0::Direct::Cluster> object which can be used
...
Returns a L<Search::Elasticsearch::Client::6_0::Direct::Nodes> object which can be used
...
Returns a L<Search::Elasticsearch::Client::6_0::Direct::Snapshot> object which
...
Returns a L<Search::Elasticsearch::Client::6_0::Direct::Tasks> object which
...
See L<Search::Elasticsearch::Client::6_0::Bulk> and L</bulk_helper()> for a helper module that makes
...
which defaults to L<Search::Elasticsearch::Client::6_0::Bulk>.
...
See L</scroll_helper()> and L<Search::Elasticsearch::Client::6_0::Scroll> for a helper utility
...
which defaults to L<Search::Elasticsearch::Client::6_0::Scroll>.
