...
package Google::Ads::AdWords::v201809::SharedSetService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::SharedSetService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201809::SharedSetService::query->new($data);
