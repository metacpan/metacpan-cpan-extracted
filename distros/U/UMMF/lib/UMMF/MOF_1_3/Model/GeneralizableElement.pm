...
package UMMF::MOF_1_3::Model::GeneralizableElement;
...
L<UMMF::MOF_1_3::Model::Namespace|UMMF::MOF_1_3::Model::Namespace>
...
=head2 C<isRoot> : UMMF::MOF_1_3::Model::Boolean 
...
=head2 C<isLeaf> : UMMF::MOF_1_3::Model::Boolean 
...
=head2 C<isAbstract> : UMMF::MOF_1_3::Model::Boolean 
...
=head2 C<supertype> : I<THIS> C<0..*> E<lt>---E<gt>  C<subtype> : UMMF::MOF_1_3::Model::GeneralizableElement C<0..*>
...
=item type = L<UMMF::MOF_1_3::Model::GeneralizableElement|UMMF::MOF_1_3::Model::GeneralizableElement>
...
=head2 C<subtype> : I<THIS> C<0..*> E<lt>---E<gt>  C<supertype> : UMMF::MOF_1_3::Model::GeneralizableElement C<0..*>
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_3::Model::GeneralizableElement->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_3::Model::GeneralizableElement|UMMF::MOF_1_3::Model::GeneralizableElement>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_3::Model::GeneralizableElement')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_3::Model::GeneralizableElement->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_3::Model::GeneralizableElement->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_3::Model::GeneralizableElement' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_3::Model::GeneralizableElement|UMMF::MOF_1_3::Model::GeneralizableElement>.
   ...
   [
	 ...
	 'type_impl' => 'array',
      ...
      ,
       ...
       'bases' => [  'UMMF::MOF_1_3::Model::Namespace',  ],
       'sql' => {
...
sub ___initialize
{
  ...
  #  supertype 0..*
  #  <--> 
  #  subtype 0..* UMMF::MOF_1_3::Model::GeneralizableElement.
  ...
  #  subtype 0..*
  #  <--> 
  #  supertype 0..* UMMF::MOF_1_3::Model::GeneralizableElement.
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_3::Model::GeneralizableElement::___create(@args);
...
Returns the L<UMMF::MOF_1_3::Model::Boolean|UMMF::MOF_1_3::Model::Boolean> value of Attribute C<isRoot>.
...
Returns the L<UMMF::MOF_1_3::Model::Boolean|UMMF::MOF_1_3::Model::Boolean> value of Attribute C<isLeaf>.
...
Returns the L<UMMF::MOF_1_3::Model::Boolean|UMMF::MOF_1_3::Model::Boolean> value of Attribute C<isAbstract>.
...
sub set_visibility ($$)
{
  ...
  if ( defined $val ) {
    $self->__use('UMMF::MOF_1_3::Model::VisibilityKind')->__typecheck($val, "UMMF::MOF_1_3::Model::GeneralizableElement.visibility");
  }
...
# type = UMMF::MOF_1_3::Model::GeneralizableElement
# multiplicity = 0..*
# ordering = 
...
Returns the AssociationEnd C<subtype> values of type L<UMMF::MOF_1_3::Model::GeneralizableElement|UMMF::MOF_1_3::Model::GeneralizableElement>.
...
Elements of C<@val> must of type L<UMMF::MOF_1_3::Model::GeneralizableElement|UMMF::MOF_1_3::Model::GeneralizableElement>.
Returns C<$obj>.
...
sub add_subtype ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        ...
        $self->__use('UMMF::MOF_1_3::Model::GeneralizableElement')->__typecheck($val, "UMMF::MOF_1_3::Model::GeneralizableElement.subtype");
...
Clears the AssociationEnd C<subtype> links to L<UMMF::MOF_1_3::Model::GeneralizableElement|UMMF::MOF_1_3::Model::GeneralizableElement>.
Returns C<$obj>.
...
Returns the AssociationEnd C<supertype> values of type L<UMMF::MOF_1_3::Model::GeneralizableElement|UMMF::MOF_1_3::Model::GeneralizableElement>.
In array context, returns all the objects in the Association.
In scalar context, returns an array ref of all the objects in the Association.
...
sub add_supertype ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        ...
        $self->__use('UMMF::MOF_1_3::Model::GeneralizableElement')->__typecheck($val, "UMMF::MOF_1_3::Model::GeneralizableElement.supertype");
...
Clears the AssociationEnd C<supertype> links to L<UMMF::MOF_1_3::Model::GeneralizableElement|UMMF::MOF_1_3::Model::GeneralizableElement>.
Returns C<$obj>.
