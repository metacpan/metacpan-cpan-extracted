...
# Big5Plus::eval <<END has Big5Plus::eval "..."
if (Big5Plus::eval <<END) {
...
# Big5Plus::eval <<END has Big5Plus::eval qq{...}
if (Big5Plus::eval <<END) {
...
# Big5Plus::eval <<END has Big5Plus::eval q{...}
if (Big5Plus::eval <<END) {
...
# Big5Plus::eval <<END has Big5Plus::eval $var
...
# Big5Plus::eval <<END has Big5Plus::eval (omit)
