...
IO::K8s::ExternalSecrets::V1alpha1::Webhook - Webhook connects to a third party API server to handle the secrets generation configuration parameters in spec.
