package App::lcpan::Cmd::dzil_roles_by_rdep_count;
...
$SPEC{'handle_cmd'} = {
    v => 1.1,
    summary => 'List Dist::Zilla roles ranked by number of reverse dependencies',
    args => {
...
sub handle_cmd {
    ...
    my @where;
    my @binds;
    push @where, "(name LIKE 'Dist::Zilla::Role::%')";
    if ($args{author}) {
        push @where, "(author=?)";
...
1;
# ABSTRACT: List Dist::Zilla roles ranked by number of reverse dependencies
...
App::lcpan::Cmd::dzil_roles_by_rdep_count - List Dist::Zilla roles ranked by number of reverse dependencies

=head1 VERSION

This document describes version 0.060 of App::lcpan::Cmd::dzil_roles_by_rdep_count (from Perl distribution App-lcpan-CmdBundle-dzil), released on 2019-11-20.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<dzil-roles-by-rdep-count>.
...
List Dist::Zilla roles ranked by number of reverse dependencies.
