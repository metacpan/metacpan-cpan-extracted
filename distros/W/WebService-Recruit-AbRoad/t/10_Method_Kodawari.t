#
# Test case for WebService::Recruit::AbRoad::Kodawari
#
...
my $service = new WebService::Recruit::AbRoad::Kodawari();

ok( ref $service, 'new WebService::Recruit::AbRoad::Kodawari()' );
...
# Test[0]
{
    ...
    my $res = new WebService::Recruit::AbRoad::Kodawari();
