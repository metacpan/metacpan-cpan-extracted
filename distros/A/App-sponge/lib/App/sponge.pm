...
1;
# ABSTRACT: Soak up standard input and write to a file
...
App::sponge - Soak up standard input and write to a file

=head1 VERSION

This document describes version 0.003 of App::sponge (from Perl distribution App-sponge), released on 2023-02-15.

=head1 SYNOPSIS

See the included script L<sponge>.
