...
TO_INST_PM = lib/Sew/.recently-used \
	lib/Sew/Color.pm

PM_TO_BLIB = lib/Sew/.recently-used \
	blib/lib/Sew/.recently-used \
	lib/Sew/Color.pm \
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Sew/.recently-used blib/lib/Sew/.recently-used \
