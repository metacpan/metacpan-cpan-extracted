...
Sah::Schema::array::int::reverse_sorted - An array of reversely sorted integers

=head1 VERSION

This document describes version 0.004 of Sah::Schema::array::int::reverse_sorted (from Perl distribution Sah-SchemaBundle-Array), released on 2024-02-13.
...
=head2 Sample data and validation results against this schema
 ...
 [3,2.9,1]  # INVALID (Contains non-integers)
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("array::int::reverse_sorted*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("array::int::reverse_sorted", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("array::int::reverse_sorted", {return_type=>'str_errmsg+val'});
 my $res = $validator->($data); # [$errmsg, $validated_val]
 
 # a sample valid data
 $data = [3,2,1];
 my $res = $validator->($data); # => ["",[3,2,1]]
 
 # a sample invalid data
 $data = [1,"a"];
 my $res = $validator->($data); # => ["\@[1]: Not of type integer",[1,"a"]]
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("array::int::reverse_sorted*");
     $validator->(\@args);
     ...
 }
 ...
 $SPEC{myfunc} = {
     ...
     args => {
         arg1 => {
             ...
             schema => ['array::int::reverse_sorted*'],
         },
         ...
     },
 };
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"array::int::reverse_sorted*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('array::int::reverse_sorted*', name=>'ArrayIntReverseSorted')
     );
 }

 use My::Types qw(ArrayIntReverseSorted);
 ArrayIntReverseSorted->assert_valid($data);
