package Chart::Plotly::Trace::Scatterternary::Marker::Gradient;
use Moose;
...
Chart::Plotly::Trace::Scatterternary::Marker::Gradient - This attribute is one of the possible options for the trace scatterternary.
