...
our $rschema = ["int",[{max=>255,min=>0,summary=>"8-bit unsigned integer"}],["int"]];
...
Sah::SchemaR::uint8 - 8-bit unsigned integer

=head1 VERSION

This document describes version 0.071 of Sah::SchemaR::uint8 (from Perl distribution Sah-Schemas-Int), released on 2018-04-03.
