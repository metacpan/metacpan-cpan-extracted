...
This document describes version 0.008 of Sah::Schema::str_or_aos (from Perl distribution Sah-Schemas-Str), released on 2022-06-09.
...
prefiltered) value:
 ...
 # a sample invalid data
 $data = ["a",undef];
 my $res = $validator->($data); # => ["Not of type text",["a",undef]]
