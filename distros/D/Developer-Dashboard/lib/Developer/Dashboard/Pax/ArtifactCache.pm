...
Developer::Dashboard::Pax::ArtifactCache - artifact metadata store for compiled native outputs

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::ArtifactCache;

  my $obj = Developer::Dashboard::Pax::ArtifactCache->new(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::ArtifactCache -e 1
