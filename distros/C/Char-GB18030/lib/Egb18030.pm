...
sub import {
    ...
    *Char::ord           = \&GB18030::ord;
    *Char::ord_          = \&GB18030::ord_;
    *Char::reverse       = \&GB18030::reverse;
    *Char::getc          = \&GB18030::getc;
    *Char::length        = \&GB18030::length;
    *Char::substr        = \&GB18030::substr;
    *Char::index         = \&GB18030::index;
    *Char::rindex        = \&GB18030::rindex;
    *Char::eval          = \&GB18030::eval;
    *Char::escape        = \&GB18030::escape;
    *Char::escape_token  = \&GB18030::escape_token;
    *Char::escape_script = \&GB18030::escape_script;
}
...
sub Egb18030::classic_character_class;
...
${Egb18030::anchor} = qr{\G(?>[^\x81-\xFE]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])*?}oxms;
...
if (($] >= 5.010001) or
    ...
    # GB18030 encoding
        ...
        ${Egb18030::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[^\x30-\x39\x81-\xFE](?>[\x30-\x39]|[\x81-\xFE][\x81-\xFE]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x30-\x39])*?}oxms;
    ...
    # other encoding
        ...
        ${Egb18030::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[$sbcs](?:[^$sbcs][^$sbcs])*?}oxms;
        #                                                     ******* octets not in multiple octet char (always char boundary)
        #                                                               **************** 2 octet chars
    }

    ${Egb18030::anchor_SADAHIRO_Tomoyuki_2002_01_17} =
    qr{\G(?(?=.{0,32766}\z)(?:[^\x81-\xFE]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])*?|(?(?=[$sbcs]+\z).*?|(?:${Egb18030::q_char_SADAHIRO_Tomoyuki_2002_01_17})))}oxms;
#   qr{
#      \G # (1), (2)
#        (? # (3)
#          (?=.{0,32766}\z) # (4)
#                          (?:[^\x81-\xFE]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])*?| # (5)
#                                                                                      (?(?=[$sbcs]+\z) # (6)
#                                                                                                      .*?| #(7)
#                                                                                                          (?:${Egb18030::q_char_SADAHIRO_Tomoyuki_2002_01_17}) # (8)
#                                                                                                                                           ))}oxms;

    # avoid: Complex regular subexpression recursion limit (32766) exceeded at here.
    local $^W = 0;

    if (((('A' x 32768).'B') !~ / ${Egb18030::anchor}                              B /oxms) and
        ((('A' x 32768).'B') =~ / ${Egb18030::anchor_SADAHIRO_Tomoyuki_2002_01_17} B /oxms)
    ) {
        ${Egb18030::anchor} = ${Egb18030::anchor_SADAHIRO_Tomoyuki_2002_01_17};
    }
    else {
        undef ${Egb18030::q_char_SADAHIRO_Tomoyuki_2002_01_17};
    }
}
...
# (8)
# else GB18030::Regexp::Const (SADAHIRO Tomoyuki)
# http://homepage1.nifty.com/nomenclator/perl/shiftjis.htm#long
# http://search.cpan.org/~sadahiro/GB18030-Regexp/
# $PadA  = '  (?:\A|                                           [\x00-\x80\xA0-\xDF])(?:[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE]{2})*?';
# $PadG  = '\G(?:                                |[\x00-\xFF]*?[\x00-\x80\xA0-\xDF])(?:[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE]{2})*?';
# $PadGA = '\G(?:\A|(?:[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE]{2})+?|[\x00-\xFF]*?[\x00-\x80\xA0-\xDF] (?:[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE]{2})*?)';

${Egb18030::dot}         = qr{(?>[^\x81-\xFE\x0A]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::dot_s}       = qr{(?>[^\x81-\xFE]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::eD}          = qr{(?>[^\x81-\xFE0-9]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
...
# ${Egb18030::eS}          = qr{(?>[^\x81-\xFE\x09\x0A    \x0C\x0D\x20]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
# ${Egb18030::eS}          = qr{(?>[^\x81-\xFE\x09\x0A\x0B\x0C\x0D\x20]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::eS}            = qr{(?>[^\x81-\xFE\s]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};

${Egb18030::eW}            = qr{(?>[^\x81-\xFE0-9A-Z_a-z]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::eH}            = qr{(?>[^\x81-\xFE\x09\x20]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::eV}            = qr{(?>[^\x81-\xFE\x0A\x0B\x0C\x0D]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::eR}            = qr{(?>\x0D\x0A|[\x0A\x0D])};
${Egb18030::eN}            = qr{(?>[^\x81-\xFE\x0A]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::not_alnum}     = qr{(?>[^\x81-\xFE\x30-\x39\x41-\x5A\x61-\x7A]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::not_alpha}     = qr{(?>[^\x81-\xFE\x41-\x5A\x61-\x7A]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::not_ascii}     = qr{(?>[^\x81-\xFE\x00-\x7F]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::not_blank}     = qr{(?>[^\x81-\xFE\x09\x20]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::not_cntrl}     = qr{(?>[^\x81-\xFE\x00-\x1F\x7F]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::not_digit}     = qr{(?>[^\x81-\xFE\x30-\x39]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::not_graph}     = qr{(?>[^\x81-\xFE\x21-\x7F]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::not_lower}     = qr{(?>[^\x81-\xFE\x61-\x7A]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::not_lower_i}   = qr{(?>[^\x81-\xFE\x41-\x5A\x61-\x7A]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])}; # Perl 5.16 compatible
# ${Egb18030::not_lower_i} = qr{(?>[^\x81-\xFE]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};                   # older Perl compatible
${Egb18030::not_print}     = qr{(?>[^\x81-\xFE\x20-\x7F]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::not_punct}     = qr{(?>[^\x81-\xFE\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::not_space}     = qr{(?>[^\x81-\xFE\s\x0B]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::not_upper}     = qr{(?>[^\x81-\xFE\x41-\x5A]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::not_upper_i}   = qr{(?>[^\x81-\xFE\x41-\x5A\x61-\x7A]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])}; # Perl 5.16 compatible
# ${Egb18030::not_upper_i} = qr{(?>[^\x81-\xFE]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};                   # older Perl compatible
${Egb18030::not_word}      = qr{(?>[^\x81-\xFE\x30-\x39\x41-\x5A\x5F\x61-\x7A]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
${Egb18030::not_xdigit}    = qr{(?>[^\x81-\xFE\x30-\x39\x41-\x46\x61-\x66]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])};
...
# avoid: Name "Egb18030::foo" used only once: possible typo at here.
${Egb18030::dot}         = ${Egb18030::dot};
${Egb18030::dot_s}       = ${Egb18030::dot_s};
${Egb18030::eD}          = ${Egb18030::eD};
${Egb18030::eS}          = ${Egb18030::eS};
${Egb18030::eW}          = ${Egb18030::eW};
${Egb18030::eH}          = ${Egb18030::eH};
${Egb18030::eV}          = ${Egb18030::eV};
${Egb18030::eR}          = ${Egb18030::eR};
${Egb18030::eN}          = ${Egb18030::eN};
${Egb18030::not_alnum}   = ${Egb18030::not_alnum};
${Egb18030::not_alpha}   = ${Egb18030::not_alpha};
${Egb18030::not_ascii}   = ${Egb18030::not_ascii};
${Egb18030::not_blank}   = ${Egb18030::not_blank};
${Egb18030::not_cntrl}   = ${Egb18030::not_cntrl};
${Egb18030::not_digit}   = ${Egb18030::not_digit};
${Egb18030::not_graph}   = ${Egb18030::not_graph};
${Egb18030::not_lower}   = ${Egb18030::not_lower};
${Egb18030::not_lower_i} = ${Egb18030::not_lower_i};
${Egb18030::not_print}   = ${Egb18030::not_print};
${Egb18030::not_punct}   = ${Egb18030::not_punct};
${Egb18030::not_space}   = ${Egb18030::not_space};
${Egb18030::not_upper}   = ${Egb18030::not_upper};
${Egb18030::not_upper_i} = ${Egb18030::not_upper_i};
${Egb18030::not_word}    = ${Egb18030::not_word};
${Egb18030::not_xdigit}  = ${Egb18030::not_xdigit};
${Egb18030::eb}          = ${Egb18030::eb};
${Egb18030::eB}          = ${Egb18030::eB};
...
sub Egb18030::split(;$$$) {
    ...
    if (CORE::length($string) > 32766) {
        ...
        elsif (defined ${Egb18030::q_char_SADAHIRO_Tomoyuki_2002_01_17}) {
            $q_char = ${Egb18030::q_char_SADAHIRO_Tomoyuki_2002_01_17};
        }
    }
...
sub _last_subexpression_offsets {
    ...
    if ($modifier =~ /x/oxms) {
        @char = $pattern =~ /\G((?>
            ...
            \\ $q_char      |
            \# (?>[^\n]*) $ |
            \[ (?>(?:[^\x81-\xFE\\\]]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF]|\\\\|\\\]|$q_char)+) \] |
            \(\?            |
                $q_char
        ))/oxmsg;
    }
...
#
# GB18030 lower case first with parameter
#
sub Egb18030::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
...
#
# GB18030 lower case first without parameter
#
sub Egb18030::lcfirst_() {
    return Egb18030::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# GB18030 lower case without parameter
#
sub Egb18030::lc_() {
    my $s = $_;
    return join '', map {defined($lc{$_}) ? $lc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# GB18030 upper case first with parameter
#
sub Egb18030::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
...
#
# GB18030 upper case first without parameter
#
sub Egb18030::ucfirst_() {
    return Egb18030::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# GB18030 upper case without parameter
#
sub Egb18030::uc_() {
    my $s = $_;
    return join '', map {defined($uc{$_}) ? $uc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# GB18030 fold case with parameter
#
sub Egb18030::fc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# GB18030 fold case without parameter
#
sub Egb18030::fc_() {
    my $s = $_;
    return join '', map {defined($fc{$_}) ? $fc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
{
    ...
    # GB18030 mark last regexp matched
    sub Egb18030::matched() {
        $last_s_matched = 0;
    }

    # GB18030 mark last s/// matched
    ...
    $Egb18030::matched = qr/(?{Egb18030::matched})/;
}
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Egb18030::not_lower_i}',
                '[:^upper:]'  => '${Egb18030::not_upper_i}',
...
#
# GB18030 hexadecimal escape sequence
#
sub hexchr {
    my($hexdigit) = @_;
...
sub charlist_qr {
    ...
    if (scalar(@singleoctet) >= 1) {
        ...
        my $not_anchor = '';
        $not_anchor = '(?![\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE])';
...
sub charlist_not_qr {
    ...
    if (scalar(@multipleoctet) >= 1) {
        if (scalar(@singleoctet) >= 1) {
            ...
            return '(?!' . join('|', @multipleoctet) . ')(?:[^\x81-\xFE' . join('', @singleoctet) . ']|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])';
        }
        else {
        ...
        if (scalar(@singleoctet) >= 1) {
            ...
            return                                      '(?:[^\x81-\xFE' . join('', @singleoctet) . ']|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])';
        }
        else {
...
sub Egb18030::filetest {
    ...
    unless (CORE::eval qq{Egb18030::$filetest(\$file)}) {
        return '';
    }
...
sub Egb18030::r(;*@) {
    ...
    # (and so on)
        ...
        if (-d "$_/.") {
            ...
            # Even if ${^WIN32_SLOPPY_STAT} is set to a true value, Egb18030::*()
...
sub Egb18030::T(;*@) {
    ...
    #     croak 'Too many arguments for -T (Egb18030::T)';
...
sub Egb18030::filetest_ {
    ...
    unless (CORE::eval qq{Egb18030::${filetest}_}) {
        return '';
    }
    for my $filetest (CORE::reverse @_) {
        unless (CORE::eval qq{ $filetest _ }) {
...
sub _DOS_like_glob {
    ...
    # UNIX-like system
        ...
        $expr =~ s{ \A ~ ( (?:[^\x81-\xFE/]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF])* ) }
...
OUTER:
    for my $expr (@expr) {
        ...
        if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
            if ($expr =~ s# \A ((?:[A-Za-z]:)?) ([^\x81-\xFE/\\]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF]) #$1./$2#oxms) {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Egb18030::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Egb18030::fc($_[0]) =~ /\A $pattern \z/xms };
...
sub _parse_line {
    ...
    my @piece = ();
    while ($line =~ /
        " ( (?>(?: [^\x81-\xFE"]  |[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF] )* ) ) " (?>\s+) |
          ( (?>(?: [^\x81-\xFE"\s]|[\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF] )* ) )   (?>\s+)
        /oxmsg
    ) {
        ...
        # rejected idea ...
            ...
            if (($] =~ /^5\.006/oxms)                     and
                ...
                *{'Dyna'.'Loader::dl_install_xsub'}{'CODE'}->('_SetCurrentDirectoryA', unpack('L', pack 'P', $x86));
                ...
                if (Egb18030::fc($chdir) eq Egb18030::fc($dir)) {
                    return 1;
                }
                else {
                    return 0;
...
#   long filename form.
        ...
        if (qx{ver} =~ /\b(?:Windows NT|Windows 2000)\b/oms) {
            ...
            for my $dirx (sort { CORE::length($a) <=> CORE::length($b) } @dirx) {
                if (Egb18030::fc(CORE::substr $dirx,-CORE::length($subdir[-1]),CORE::length($subdir[-1])) eq Egb18030::fc($subdir[-1])) {
        ...
        elsif (Egb18030::fc($shortdir) eq Egb18030::fc($dir)) {
            return 0;
        }
        return CORE::chdir $shortdir;
    }
...
sub GB18030::getc(;*@) {
    ...
    croak 'Too many arguments for GB18030::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Egb18030::dot_s} \z/oxms) {
...
# ord() to ord() or GB18030::ord()
my $function_ord = 'ord';

# ord to ord or GB18030::ord_
my $function_ord_ = 'ord';

# reverse to reverse or GB18030::reverse
my $function_reverse = 'reverse';

# getc to getc or GB18030::getc
...
my $qq_paren   = qr{(?{local $nest=0}) (?>(?:
                       [^\x81-\xFE\\()] |
                           \(  (?{$nest++}) |
                           \)  (?(?{$nest>0})(?{$nest--})|(?!)))*) (?(?{$nest!=0})(?!)) |
                       [\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF] |
                    \\ [^\x81-\xFEc] |
                    \\c[\x40-\x5F] |
                    \\ [\x81-\xFE][^\x30-\x39]|[\x81-\xFE][\x30-\x39][\x81-\xFE][\x00-\xFF] |
                       [\x00-\xFF]
...
my $qq_substr  = qr{(?> Char::substr | GB18030::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
#
# escape GB18030 token of script
#
sub GB18030::escape_token {
...
# subroutines of package Egb18030
    ...
    elsif (/\G \b GB18030::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Char::escape'; }
    elsif (/\G \b GB18030::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval GB18030::escape'; }
    ...
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC])            (?>\s*) (\") ((?:$qq_char)+?)                (\") /oxgc) { $slash = 'm//'; return "Egb18030::$1(" . e_qq('',  $2,$4,$3) . ")"; }
    ...
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC])            (?>\s*) (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $slash = 'm//'; return "Egb18030::$1(" . e_q ('',  $2,$4,$3) . ")"; }
...
# subroutines of package Egb18030
        ...
        elsif ($string =~ /\G \b GB18030::eval       (?= (?>\s*) \{ )                    /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::eval \b                                        /oxgc) { $e_string .= 'eval Char::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b GB18030::eval \b                                        /oxgc) { $e_string .= 'eval GB18030::escape'; $slash = 'm//'; }
        ...
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC])            (?>\s*) (\") ((?:$qq_char)+?)                (\") /oxgc) { $e_string .= "Egb18030::$1(" . e_qq('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        ...
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC])            (?>\s*) (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $e_string .= "Egb18030::$1(" . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                                                2   3                                  4   5
                q<CORE::eval{local $Egb18030::re_t=%s; local $Egb18030::re_a=''; while($Egb18030::re_t =~ %s){%s local $^W=0; local $Egb18030::re_r=%s; %s$Egb18030::re_t="$Egb18030::re_a${1}$Egb18030::re_r$'"; pos($Egb18030::re_t)=length "$Egb18030::re_a${1}$Egb18030::re_r"; $Egb18030::re_a=substr($Egb18030::re_t,0,pos($Egb18030::re_t)); } return $Egb18030::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Egb18030::re_r=CORE::eval $Egb18030::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Egb18030::re_t=%s; while($Egb18030::re_t =~ %s){%s local $^W=0; local $Egb18030::re_r=%s; %s$Egb18030::re_t="$`$Egb18030::re_r$'"; pos($Egb18030::re_t)=length "$`$Egb18030::re_r"; } return $Egb18030::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Egb18030::re_r=%s; %s"%s$Egb18030::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Egb18030::re_n=0; local $Egb18030::re_a=''; while(%s =~ %s){%s local $^W=0; local $Egb18030::re_r=%s; %s%s="$Egb18030::re_a${1}$Egb18030::re_r$'"; pos(%s)=length "$Egb18030::re_a${1}$Egb18030::re_r"; $Egb18030::re_a=substr(%s,0,pos(%s)); $Egb18030::re_n++} return %s$Egb18030::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Egb18030::re_n=0; while(%s =~ %s){%s local $^W=0; local $Egb18030::re_r=%s; %s%s="$`$Egb18030::re_r$'"; pos(%s)=length "$`$Egb18030::re_r"; $Egb18030::re_n++} return %s$Egb18030::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Egb18030::re_r=%s; %s%s="%s$Egb18030::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Egb18030::re_r=%s; %s%s="%s$Egb18030::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Egb18030::re_r=CORE::eval $Egb18030::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
This module has run-time routines for use GB18030 software automatically, you
do not have to use.
...
=item * Split string
  ...
  at all, Egb18030::split returns the original string as a single substring, If it
  ...
  @chars  = Egb18030::split(//,  $word);
  @fields = Egb18030::split(/:/, $line);
  @words  = Egb18030::split(" ", $paragraph);
  @lines  = Egb18030::split(/^/, $buffer);
  ...
  print join(":" => Egb18030::split(/ */, "hi there"));
  ...
  Egb18030::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Egb18030::split(/:/, $_, 3);
  ...
  splits on whitespace just as Egb18030::split with no arguments does. Thus,
  Egb18030::split(" ") can be used to emulate awk's default behavior. In contrast,
  Egb18030::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Egb18030::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Egb18030::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Egb18030::split()) {
          $count{$word}++;
      }
  }

  The inverse of Egb18030::split is join, except that join can only join with the
...
=item * Transliteration
  ...
  This subroutine scans a GB18030 string character by character and replaces all
  ...
  print Egb18030::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'
...
=item * Chop string
  ...
  character chopped. The Egb18030::chop subroutine is used primary to remove the newline
  ...
  since Egb18030::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Egb18030::chop a literal, only a variable. If you Egb18030::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Egb18030::chop(@lines);

  You can Egb18030::chop anything that is an lvalue, including an assignment:

  Egb18030::chop($cwd = `pwd`);
  Egb18030::chop($answer = <STDIN>);

  This is different from:

  $answer = Egb18030::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Egb18030::chop returns the character
  ...
  In the most general case, Egb18030::chop can be expressed using substr:

  $last_code = Egb18030::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Egb18030::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Egb18030::chop;
...
=item * Index string
  ...
  $byte_pos = Egb18030::index($string,$substr,$byte_offset);
  $byte_pos = Egb18030::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Egb18030::index($string, $lookfor, $byte_pos)) > -1) {
...
=item * Reverse index string
  ...
  $byte_pos = Egb18030::rindex($string,$substr,$byte_offset);
  $byte_pos = Egb18030::rindex($string,$substr);

  This subroutine works just like Egb18030::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Egb18030::index).
  ...
  while (($byte_pos = GB18030::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item * Lower case string
  ...
  This subroutine returns a lowercased version of GB18030 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Egb18030::fc subroutine for case-insensitive comparisons via GB18030
  software.
...
=item * Lower case first character of string
  ...
  This subroutine returns a version of GB18030 $string with the first character
...
=item * Upper case string
  ...
  This subroutine returns an uppercased version of GB18030 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Egb18030::ucfirst instead.
...
=item * Upper case first character of string
  ...
  $titlecase = Egb18030::ucfirst(substr($word,0,1)) . Egb18030::lc(substr($word,1));
  ...
  $do_not_use = Egb18030::ucfirst(Egb18030::lc($word));
...
=item * Fold case string
  ...
  $fc = Egb18030::fc($string);
  $fc = Egb18030::fc_;

  New to GB18030 software, this subroutine returns the full Unicode-like casefold of
  GB18030 $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Egb18030::fc($a) eq Egb18030::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because GB18030 software has always used casefolding semantics for
...
=item * Make character
  ...
  that $code in the character set. For example, Egb18030::chr(65) is "A" in either
  ASCII or GB18030, not Unicode. For the reverse of Egb18030::chr, use GB18030::ord.

=item * File test subroutine Egb18030::X
  ...
  ------------------------------------------------------------------------------
  Egb18030::r(*), Egb18030::r_()   File or directory is readable by this (effective) user or group
  Egb18030::w(*), Egb18030::w_()   File or directory is writable by this (effective) user or group
  Egb18030::e(*), Egb18030::e_()   File or directory name exists
  Egb18030::x(*), Egb18030::x_()   File or directory is executable by this (effective) user or group
  Egb18030::z(*), Egb18030::z_()   File exists and has zero size (always false for directories)
  Egb18030::f(*), Egb18030::f_()   Entry is a plain file
  Egb18030::d(*), Egb18030::d_()   Entry is a directory
  ------------------------------------------------------------------------------
  ...
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Egb18030::R(*), Egb18030::R_()   File or directory is readable by this real user or group
                             Same as Egb18030::r(*), Egb18030::r_() on MacOS
  Egb18030::W(*), Egb18030::W_()   File or directory is writable by this real user or group
                             Same as Egb18030::w(*), Egb18030::w_() on MacOS
  Egb18030::X(*), Egb18030::X_()   File or directory is executable by this real user or group
                             Same as Egb18030::x(*), Egb18030::x_() on MacOS
  Egb18030::l(*), Egb18030::l_()   Entry is a symbolic link
  Egb18030::S(*), Egb18030::S_()   Entry is a socket
  ------------------------------------------------------------------------------
  ...
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Egb18030::o(*), Egb18030::o_()   File or directory is owned by this (effective) user
  ...
  a filehandle. Both Egb18030::T and Egb18030::B doesn't work when given the special
  filehandle consisting of a solitary underline. Because Egb18030::T has to read to
  do the test, you don't want to use Egb18030::T on special files that might hang or
  give you other kinds or grief. So on most occasions you'll want to test with a
  Egb18030::f first, as in:

  next unless Egb18030::f($file) && Egb18030::T($file);

  Available in MSWin32, MacOS, and UNIX-like systems
  ------------------------------------------------------------------------------
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Egb18030::T(*), Egb18030::T_()   File looks like a "text" file
  Egb18030::B(*), Egb18030::B_()   File looks like a "binary" file
  ------------------------------------------------------------------------------

  File ages for Egb18030::M, Egb18030::M_, Egb18030::A, Egb18030::A_, Egb18030::C, and Egb18030::C_
  ...
  next unless Egb18030::M($file) > 0.5;     # files are older than 12 hours
  &newfile if Egb18030::M($file) < 0;       # file is newer than process
  &mailwarning if int(Egb18030::A_) == 90;  # file ($_) was accessed 90 days ago today

  Available in MSWin32, MacOS, and UNIX-like systems
  ------------------------------------------------------------------------------
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Egb18030::M(*), Egb18030::M_()   Modification age (measured in days)
  Egb18030::A(*), Egb18030::A_()   Access age (measured in days)
                             Same as Egb18030::M(*), Egb18030::M_() on MacOS
  Egb18030::C(*), Egb18030::C_()   Inode-modification age (measured in days)
  ------------------------------------------------------------------------------

  The Egb18030::s, and Egb18030::s_ returns file size in bytes if succesful, or undef
  unless successful.
  ...
  Subroutine and Prototype   Meaning
  ------------------------------------------------------------------------------
  Egb18030::s(*), Egb18030::s_()   File or directory exists and has nonzero size
...
=item * Filename expansion (globbing)
  ...
  The Egb18030::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Egb18030::glob('"*e f*"');
  @spacies = Egb18030::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Egb18030::glob("'*${var}e f*'");
  @spacies = Egb18030::glob(qq("*${var}e f*"));
...
=item * Require file
  ...
  Egb18030::require loads and executes the Perl code found in the separate file whose
  name is given by the $file. This is similar to using a Egb18030::do on a file, except
  that Egb18030::require checks to see whether the library file has been loaded already
  ...
  its cousins Egb18030::do, Egb18030::require knows how to search the include path stored
...
=item * Current position of the readdir
  ...
  $telldir = Egb18030::telldir(DIRHANDLE);
