...
# 1
    ...
    sub { return 'SKIP' if $^O !~ /MSWin32/; mb::eval(q{ mkdir "5004.777.ソ",0777;                         }) },
    sub { mb::eval(q{ open FILE,">5004.A";  print FILE "A"; close FILE; }) },
    sub { return 'SKIP' if $^O !~ /MSWin32/; mb::eval(q{ open FILE,">5004.ソ"; print FILE "A"; close FILE; }) },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 11
    ...
    sub { return 'SKIP' if $^O !~ /MSWin32/; mb::eval(  q{ @_ = stat "5004.NOTEXTST.ソ"; scalar(@_) == 0 }) },
    sub { CORE::eval(q{ -e "5004.NOTEXTST.A";  @_ = stat _; scalar(@_) == 0 }) },
    sub { mb::eval(  q{ -e "5004.NOTEXTST.A";  @_ = stat _; scalar(@_) == 0 }) },
    sub { return 'SKIP' if $^O !~ /MSWin32/; mb::eval(  q{ -e "5004.NOTEXTST.ソ"; @_ = stat _; scalar(@_) == 0 }) },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
# 21
    ...
    sub { return 'SKIP' if $^O !~ /MSWin32/; mb::eval(  q{ @_ = stat "5004.777.ソ"; scalar(@_) == 13 }) },
    ...
    sub { return 'SKIP' if $^O !~ /MSWin32/; mb::eval(  q{ -e "5004.777.ソ"; @_ = stat _; scalar(@_) == 13 }) },
    sub {1},
    sub {1},
    sub {1},
# 31
    ...
    sub { return 'SKIP' if $^O !~ /MSWin32/; mb::eval(  q{ @_ = stat "5004.ソ"; scalar(@_) == 13 }) },
    ...
    sub { return 'SKIP' if $^O !~ /MSWin32/; mb::eval(  q{ -e "5004.ソ"; @_ = stat _; scalar(@_) == 13 }) },
    sub {1},
    sub {1},
    sub {1},
# 41
    sub { mb::eval(q{ rmdir "5004.777.A";  }) },
    sub { return 'SKIP' if $^O !~ /MSWin32/; mb::eval(q{ rmdir "5004.777.ソ"; }) },
    sub { mb::eval(q{ unlink "5004.A";     }) },
    sub { return 'SKIP' if $^O !~ /MSWin32/; mb::eval(q{ unlink "5004.ソ";    }) },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
