...
MyTestHelpers::diag ("Pod::Parser version ", Pod::Parser->VERSION);
...
#------------------------------------------------------------------------------
{
  ...
  {
    ok (eval { Pod::MinimumVersion::Parser->VERSION($want_version); 1 },
        1,
        "VERSION class check $want_version");
    my $check_version = $want_version + 1000;
    ok (! eval { Pod::MinimumVersion::Parser->VERSION($check_version); 1 },
        1,
        "VERSION class check $check_version");
  }
  { my $pmv = Pod::MinimumVersion::Parser->new;
