...
package WebService::Edgecast::auto::Administration::Element::CustomerCustomIdUpdate;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerCustomIdUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerCustomIdUpdate');
...
WebService::Edgecast::auto::Administration::Element::CustomerCustomIdUpdate
...
CustomerCustomIdUpdate from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerCustomIdUpdate->new($data);
