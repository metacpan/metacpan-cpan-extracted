# This Makefile is for the Tree::SEMETrie extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Tree/SEMETrie.pm]
...
manifypods : pure_all  \
	lib/Tree/SEMETrie.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Tree/SEMETrie.pm $(INST_MAN3DIR)/Tree::SEMETrie.$(MAN3EXT) 
