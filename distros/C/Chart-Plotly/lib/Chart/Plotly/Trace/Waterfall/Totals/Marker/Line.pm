package Chart::Plotly::Trace::Waterfall::Totals::Marker::Line;
use Moose;
...
Chart::Plotly::Trace::Waterfall::Totals::Marker::Line - This attribute is one of the possible options for the trace waterfall.
