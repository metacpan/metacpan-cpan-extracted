...
L<Comparing with native Perl|Text::Parser::Manual::ComparingWithNativePerl> - this chapter should explain why one should consider using L<Text::Parser> instead of native Perl.
...
You can L<jump here|Text::Parser::Manual::ExtendedAWKSyntax> for a quickstart.
