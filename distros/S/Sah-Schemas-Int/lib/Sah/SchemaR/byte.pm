...
our $rschema = [
  "int",
  [
    { max => 255, min => 0, summary => "8-bit unsigned integer" },
...
This document describes version 0.06 of Sah::SchemaR::byte (from Perl distribution Sah-Schemas-Int), released on 2016-07-22.
