...
use Google::Ads::AdWords::v201702::AdGroupEstimateRequest;
use Google::Ads::AdWords::v201702::CampaignEstimateRequest;
use Google::Ads::AdWords::v201702::Keyword;
use Google::Ads::AdWords::v201702::KeywordEstimateRequest;
use Google::Ads::AdWords::v201702::Language;
use Google::Ads::AdWords::v201702::Location;
use Google::Ads::AdWords::v201702::TrafficEstimatorSelector;
...
sub estimate_keyword_traffic {
  ...
  my @keywords = (
    Google::Ads::AdWords::v201702::Keyword->new({
        text      => "mars cruise",
        matchType => "BROAD"
      }
    ),
  ...
  foreach my $keyword (@keywords) {
    push @keyword_estimate_requests,
      Google::Ads::AdWords::v201702::KeywordEstimateRequest->new(
      {keyword => $keyword,});
  }
  ...
  my $ad_group_estimate_request =
    Google::Ads::AdWords::v201702::AdGroupEstimateRequest->new({
      keywordEstimateRequests => \@keyword_estimate_requests,
      maxCpc =>
        Google::Ads::AdWords::v201702::Money->new({microAmount => 1000000})});

  my $location = Google::Ads::AdWords::v201702::Location->new({
      id => "2840"    # US - see http://goo.gl/rlrFr
  });
  my $language = Google::Ads::AdWords::v201702::Language->new({
      id => "1000"    # en - see http://goo.gl/LvMmS
  });

  # Create campaign estimate requests.
  my $campaign_estimate_request =
    Google::Ads::AdWords::v201702::CampaignEstimateRequest->new({
  ...
  # Create selector.
  my $selector = Google::Ads::AdWords::v201702::TrafficEstimatorSelector->new({
