# This Makefile is for the Plugins::Factory extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Plugins/Factory.pm]
#     AUTHOR => q[Ivan Sivirinov]
#     NAME => q[Plugins::Factory]
#     PREREQ_PM => { Module::Pluggable=>q[0], Module::Load=>q[0] }
#     VERSION_FROM => q[lib/Plugins/Factory.pm]
...
MAKE = make
FULLEXT = Plugins/Factory
BASEEXT = Factory
PARENT_NAME = Plugins
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Plugins/Factory.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Plugins/Factory.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Plugins
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Plugins
...
TO_INST_PM = lib/Plugins/Factory.pm

PM_TO_BLIB = lib/Plugins/Factory.pm \
	blib/lib/Plugins/Factory.pm
...
DISTNAME = Plugins-Factory
DISTVNAME = Plugins-Factory-0.01
...
manifypods : pure_all  \
	lib/Plugins/Factory.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Plugins/Factory.pm $(INST_MAN3DIR)/Plugins::Factory.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Plugins-Factory' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           ~' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Ivan Sivirinov' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Ivan Sivirinov</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Plugins/Factory.pm blib/lib/Plugins/Factory.pm 
