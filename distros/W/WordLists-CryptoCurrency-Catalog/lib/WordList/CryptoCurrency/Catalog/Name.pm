...
WordList::CryptoCurrency::Catalog::Name - List of cryptocurrency names
...
=head1 SYNOPSIS
 ...
 use WordList::CryptoCurrency::Catalog::Name;

 my $wl = WordList::CryptoCurrency::Catalog::Name->new;
