...
# shell program to test tmi.pm's output during normal operation (that
...
# now the test!
echo "Test:   statistic.pl tmi test-2.out $TESTFILE" 
statistic.pl tmi test-2.out $TESTFILE 
...
# now the test!
echo "Test:   statistic.pl --set_freq_combo $FREQCOMBFILE tmi test-2.out $TESTFILE" 
statistic.pl --set_freq_combo $FREQCOMBFILE tmi test-2.out $TESTFILE
