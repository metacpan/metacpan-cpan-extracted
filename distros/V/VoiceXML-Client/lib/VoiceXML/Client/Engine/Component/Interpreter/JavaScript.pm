package VoiceXML::Client::Engine::Component::Interpreter::JavaScript;
...
use JavaScript;
use base qw(JavaScript);


package VoiceXML::Client::Engine::Component::Interpreter::JavaScript::Context;

use JavaScript;
use base qw (JavaScript::Context);
