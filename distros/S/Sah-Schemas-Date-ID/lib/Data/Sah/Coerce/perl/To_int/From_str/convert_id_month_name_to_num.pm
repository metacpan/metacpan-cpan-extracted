...
Data::Sah::Coerce::perl::To_int::From_str::convert_id_month_name_to_num - Convert Indonesian month name (e.g. Des, april) to number (1-12)

=head1 VERSION

This document describes version 0.008 of Data::Sah::Coerce::perl::To_int::From_str::convert_id_month_name_to_num (from Perl distribution Sah-Schemas-Date-ID), released on 2022-10-20.

=head1 SYNOPSIS

To use in a Sah schema:

 ["int",{"x.perl.coerce_rules"=>["From_str::convert_id_month_name_to_num"]}]
