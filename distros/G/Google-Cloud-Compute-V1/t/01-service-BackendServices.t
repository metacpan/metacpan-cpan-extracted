...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::BackendService Google::Cloud::Compute::V1::Compute::BackendServiceAggregatedList Google::Cloud::Compute::V1::Compute::BackendServiceGroupHealth Google::Cloud::Compute::V1::Compute::BackendServiceList Google::Cloud::Compute::V1::Compute::BackendServiceListUsable Google::Cloud::Compute::V1::Compute::GetEffectiveSecurityPoliciesBackendServiceResponse Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::Policy Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::BackendServicesClient->new( credentials => 'dummy' );
