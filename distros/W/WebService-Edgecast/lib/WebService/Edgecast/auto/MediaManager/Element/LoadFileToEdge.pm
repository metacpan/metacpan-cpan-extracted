...
package WebService::Edgecast::auto::MediaManager::Element::LoadFileToEdge;
BEGIN {
  $WebService::Edgecast::auto::MediaManager::Element::LoadFileToEdge::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('LoadFileToEdge');
...
WebService::Edgecast::auto::MediaManager::Element::LoadFileToEdge
...
LoadFileToEdge from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::MediaManager::Element::LoadFileToEdge->new($data);
