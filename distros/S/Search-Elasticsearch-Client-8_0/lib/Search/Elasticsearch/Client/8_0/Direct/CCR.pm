...
$Search::Elasticsearch::Client::8_0::Direct::CCR::VERSION = '8.12';
use Moo;
...
Search::Elasticsearch::Client::8_0::Direct::CCR - Plugin providing cross-cluster replication APIs for Search::Elasticsearch 8.x
