...
Developer::Dashboard::Pax::Paxfile - paxfile.yml parser and normalizer

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::Paxfile;

  my $result = Developer::Dashboard::Pax::Paxfile->load_optional(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::Paxfile -e 1
