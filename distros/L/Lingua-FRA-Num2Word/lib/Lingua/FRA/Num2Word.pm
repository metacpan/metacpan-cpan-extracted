...
sub num2fra_cardinal :Export { goto &number_to_fr }
sub num2fra_ordinal  :Export { goto &ordinate_to_fr }
...
=head2 num2fra_cardinal( $number )

Exported alias for C<number_to_fr>.

=head2 num2fra_ordinal( $number )

Exported alias for C<ordinate_to_fr>.  Returns the French ordinal
string for a strictly positive integer (e.g. 1 => "premier",
5 => "cinquième").
