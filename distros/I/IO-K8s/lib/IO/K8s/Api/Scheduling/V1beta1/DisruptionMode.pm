...
IO::K8s::Api::Scheduling::V1beta1::DisruptionMode - DisruptionMode defines how individual entities within a group can be disrupted. Exactly one mode can be set.
