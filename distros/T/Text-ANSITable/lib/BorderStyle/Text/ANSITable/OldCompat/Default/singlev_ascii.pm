...
BorderStyle::Text::ANSITable::OldCompat::Default::singlev_ascii - ASCII::SingleLineVerticalOnly border style (with old name)

=head1 VERSION

This document describes version 0.606 of BorderStyle::Text::ANSITable::OldCompat::Default::singlev_ascii (from Perl distribution Text-ANSITable), released on 2021-08-27.
