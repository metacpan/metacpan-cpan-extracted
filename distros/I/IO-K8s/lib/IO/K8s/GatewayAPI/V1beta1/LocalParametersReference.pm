...
IO::K8s::GatewayAPI::V1beta1::LocalParametersReference - ParametersRef is a reference to a resource that contains the configuration parameters corresponding to the Gateway.
