package Google::Ads::AdWords::v201809::TextLabel;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201809::Label);
# Variety: sequence
...
Google::Ads::AdWords::v201809::TextLabel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TextLabel from the namespace https://adwords.google.com/api/adwords/cm/v201809.
