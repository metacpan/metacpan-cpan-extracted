...
# Bio::Genex::Protocol
#
# created on Mon Feb  5 21:23:55 2001 by /home/jasons/work/GeneX-Server/Genex/scripts/create_genex_class.pl --dir=/home/jasons/work/GeneX-Server/Genex --target=Protocol --support=SampleProtocols
#
# cvs id: $Id: Protocol.pm,v 1.17 2001/02/06 18:58:52 jes Exp $ 
#
##############################
...
sub get_all_objects {
  ...
  if (ref($_[0]) eq 'HASH') {
    ...
    die "Bio::Genex::Protocol::get_all_objects: Must define both 'column' and 'value'" 
  ...
  my $sth = $dbh->prepare($sql) 
    or die "Bio::Genex::Protocol::get_all_objects:\nSQL=<$sql>,\nDBI=<$DBI::errstr>";
  $sth->execute() 
    or die "Bio::Genex::Protocol::get_all_objects:\nSQL=<$sql>,\nDBI=<$DBI::errstr>";
  ...
  die "Bio::Genex::Protocol::get_all_objects:\nSQL=<$sql>,\nDBI=<$DBI::errstr>" 
    if $sth->err;
...
sub get_objects {
  ...
  if (ref($_[0]) eq 'HASH' || scalar @_ == 0) {
    croak("Bio::Genex::Protocol::get_objects called with no ID's, perhaps you meant to use Bio::Genex::Protocol::get_all_objects
");
  } 
  my @ids = @_;
  my $obj;
...
=head1 SYNOPSIS
  ...
  my @objects = Bio::Genex::Protocol->get_all_objects();
...
on Mon Feb  5 21:23:55 2001 by /home/jasons/work/GeneX-Server/Genex/scripts/create_genex_class.pl --dir=/home/jasons/work/GeneX-Server/Genex --target=Protocol --support=SampleProtocols
