...
our $rschema = do{my$var={base=>"int",clsets_after_base=>[{examples=>[{summary=>"Empty string",valid=>0,value=>""},{valid=>1,value=>0},{valid=>1,value=>59},{valid=>1,value=>60},{summary=>"Not in 0-60",valid=>0,value=>61}],max=>60,min=>0,summary=>"Second of minute (0-60), e.g. 39"}],clsets_after_type=>['$var->{clsets_after_base}[0]'],"clsets_after_type.alt.merge.merged"=>['$var->{clsets_after_base}[0]'],resolve_path=>["int"],type=>"int",v=>2};$var->{clsets_after_type}[0]=$var->{clsets_after_base}[0];$var->{"clsets_after_type.alt.merge.merged"}[0]=$var->{clsets_after_base}[0];$var};
...
Sah::SchemaR::date::second - Second of minute (0-60), e.g. 39

=head1 VERSION

This document describes version 0.018 of Sah::SchemaR::date::second (from Perl distribution Sah-Schemas-Date), released on 2022-10-12.
