...
package XS::Parse::Keyword::Builder 0.06;
...
enum {
  /* skip zero */
  XS_PARSE_KEYWORD_LITERALCHAR = 1,
  XS_PARSE_KEYWORD_LITERALSTR,
  XS_PARSE_KEYWORD_FAILURE = 0x0f,
  ...
  XS_PARSE_KEYWORD_ATTRS,         /* attr.name + attr.val */
  XS_PARSE_KEYWORD_VSTRING,       /* sv */

  XS_PARSE_KEYWORD_SEQUENCE = 0x80,
  XS_PARSE_KEYWORD_REPEATED,
  XS_PARSE_KEYWORD_CHOICE,
  XS_PARSE_KEYWORD_TAGGEDCHOICE,
  XS_PARSE_KEYWORD_SEPARATEDLIST,
  XS_PARSE_KEYWORD_PARENSCOPE = 0xb0, /* (...) */
