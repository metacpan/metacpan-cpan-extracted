...
$omnithreads::shared::threads_shared = 1;

sub omnithreads::shared::tie::SPLICE
{
...
omnithreads::shared - Perl extension for sharing data structures between threads
...
It is used together with the omnithreads module.

=head1 EXPORT

C<share>, C<cond_wait>, C<cond_timedwait>, C<cond_signal>, C<cond_broadcast>

Note that if this module is imported when C<omnithreads> has not yet been
...
L<omnithreads>, L<threads>, L<perlthrtut>, L<http://www.perl.com/pub/a/2002/06/11/threads.html>
