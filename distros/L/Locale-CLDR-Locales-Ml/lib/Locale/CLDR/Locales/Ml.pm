...
has 'characters' => (
	...
	sub {
		...
		return {
			...
			main => qr{(?^u:[‌‍ ഃ അ ആ ഇ ഈ ഉ ഊ ഋ ൠ ഌ ൡ എ ഏ ഐ ഒ ഓ ഔ ക ൿ ഖ ഗ ഘ ങ ച ഛ ജ ഝ ഞ ട ഠ ഡ ഢ ണ ൺ ത ഥ ദ ധ ന ൻ പ ഫ ബ ഭ മ ം യ ര ർ ല ൽ വ ശ ഷ സ ഹ ള ൾ ഴ റ ാ ി ീ ു ൂ ൃ െ േ ൈ ൊ ോ ൌ ൗ ്])},
			punctuation => qr{(?^u:[\- , ; \: ! ? . ' ‘ ’ " “ ” ( ) \[ \] \{ \}])},
		};
	},
EOT
	...
	default		=> sub { {
				'long' => {
					...
					'pound-per-square-inch' => {
						'name' => q(ചതുരശ്ര ഇഞ്ചിലുള്ള റാത്തൽ),
						'one' => q({0} ചതുരശ്ര ഇഞ്ചിലുള്ള റാത്തൽ),
						'other' => q({0} ചതുരശ്ര ഇഞ്ചിലുള്ള റാത്തൽ),
					},
					'quart' => {
						'name' => q(ക്വാർട്ട്),
						'one' => q({0} ക്വാർട്ട്),
...
has 'currencies' => (
	...
	default		=> sub { {
		...
		'KZT' => {
			symbol => 'KZT',
			display_name => {
				'currency' => q(കസാക്കിസ്ഥാൻ ടെംഗെ),
				'one' => q(കസാക്കിസ്ഥാൻ ടെംഗെ),
				'other' => q(കസാക്കിസ്ഥാൻ ടെംഗെ),
			},
		},
		'LAK' => {
			symbol => 'LAK',
		...
		'PEN' => {
			symbol => 'PEN',
			display_name => {
				'currency' => q(പെറുവിയൻ ന്യൂവോ സോൾ),
				'one' => q(പെറുവിയൻ ന്യൂവോ സോൾ),
				'other' => q(പെറുവിയൻ ന്യൂവോ സോൾ),
			},
		},
		'PES' => {
			display_name => {
		...
		'TJS' => {
			symbol => 'TJS',
			display_name => {
				'currency' => q(താജിക്കിസ്ഥാനി സൊമോനി),
				'one' => q(താജിക്കിസ്ഥാനി സൊമോനി),
		...
		'UZS' => {
			symbol => 'UZS',
			display_name => {
				'currency' => q(ഉസ്‌ബെക്കിസ്ഥാൻ സോം),
				'one' => q(ഉസ്‌ബെക്കിസ്ഥാൻ സോം),
				'other' => q(ഉസ്‌ബെക്കിസ്ഥാൻ സോം),
			},
		},
		'VEB' => {
			display_name => {
