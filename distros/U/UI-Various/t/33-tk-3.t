...
my $button3 = UI::Various::Button->new(text => 'Close',
					   ...
					   $flow *= 2;
					   $button5->_tk()->invoke;
					   # Note that destroying the
					   # dialogue here would cause a lot
					   # of problems as the Tk mainloop
					   # hasn't even start running!
				       });
...
#		 });
    ...
    'mainloop "window + dialogue" produces correct empty output';
