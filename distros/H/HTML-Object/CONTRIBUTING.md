...
Feel free to clone it from its gitlab repository at <https://git.deguest.jp/jack/HTML-Object> and issue a pull request.
...
File [an issue on CPAN bug tracker](https://git.deguest.jp/jack/HTML-Object/issues) if you think you've found a bug. Please describe
...
Issues are currently reported using CPAN [bug tracker](https://git.deguest.jp/jack/HTML-Object/issues)

## More information

Please refer to the [README](https://metacpan.org/source/JDEGUEST/HTML-Object-v0.1.0/README.md)
