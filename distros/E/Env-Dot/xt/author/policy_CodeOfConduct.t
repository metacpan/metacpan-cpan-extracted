...
my $policy = path('CODE_OF_CONDUCT.md')->slurp_utf8 =~ s/[[:space:]]+$//rmsx;
...
do {
    ...
    is(\@policy_lines, \@wanted_lines, 'Policy file CODE_OF_CONDUCT.md is current');
...
Env-Dot project a harassment-free experience for everyone, regardless of age,
...
This Code of Conduct applies within all Env-Dot project spaces, and also
applies when an individual is officially representing the Env-Dot project in
public spaces. Examples of representing the Env-Dot project include using an
