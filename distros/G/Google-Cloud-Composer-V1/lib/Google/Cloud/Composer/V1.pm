...
package Google::Cloud::Composer::V1;
...
sub BUILD {
    ...
    my $client = Google::gRPC::Client->new(
        target     => 'composer.googleapis.com:443',
        auth_token => $token,
    );
...
Google::Cloud::Composer::V1 - Google Cloud Composer V1 API Client

=head1 SYNOPSIS

    use Google::Cloud::Composer::V1;
    use Google::Auth;

    my $auth = Google::Auth->default();
    my $client = Google::Cloud::Composer::V1->new(credentials => $auth);

=head1 DESCRIPTION

Google Cloud Composer V1 API Client over high-performance gRPC transport.
