...
Map::Tube::Leipzig::Line::S7 - Leipzig Rail Map: S7 Line.
...
Leipzig Rail Map: S7.
    ...
    +------------------+------------------------------+
    | Neitleben        | Neustadt                     |
    | Neustadt         | Neitleben, Zscherbener Str.  |
    | Zscherbener Str. | Neustadt, Süd-stadt          |
    | Süd-stadt        | Zscherbener Str., Suber-höhe |
    | Suber-höhe       | Süd-stadt,Rosen-garten       |
    | Rosen-garten     | Suber-höhe, Halle Hbf        |
    | Halle Hbf        | Rosen-garten, Steintorbrücke |
    | Steintorbrücke   | Halle Hbf, Dessauer Brücke   |
    | Dessauer Brücke  | Steintorbrücke, Zoo          |
    | Zoo              | Dessauer Brücke, Schkeuditz  |
    | Wohnstadt Nord   | Zoo, Trotha                  |
    | Trotha           | Wohnstadt Nord, Beidersee    |
    | Beidersee        | Trotha, Gimritz              |
    | Gimritz          | Beidersee, Wettin            |
    | Wettin           | Gimritz                      |
    +------------------+------------------------------+
...
1; # End of Map::Tube::Leipzig::Line::S7
