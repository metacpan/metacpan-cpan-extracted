 ...
 *
 * The Hugs 98 system is Copyright (c) JosÅÈ Enrique Gallardo, Mark P Jones,
 ...
 */
#define HUGSPATH ".;{Hugs}\\libraries:{Hugs}\\oldlib:{Hugs}\\win32"
...
#define USE_THREADS	1  /* Use a different thread to run the evaluator */
