...
sub evaluate { $_[1]->eval_set($_[0]) }

=pod

=head1 NAME

Zuzu::AST::Expr::Set - AST node for set expressions
...
Unordered input expressions used to build a unique-value set.
...
B<< Zuzu::AST::Expr::Set >> is copyright Toby Inkster.
