...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::HealthAggregationPolicy Google::Cloud::Compute::V1::Compute::HealthAggregationPolicyAggregatedList Google::Cloud::Compute::V1::Compute::HealthAggregationPolicyList Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::RegionHealthAggregationPoliciesClient->new( credentials => 'dummy' );
