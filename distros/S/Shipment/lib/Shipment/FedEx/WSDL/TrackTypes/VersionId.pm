package Shipment::FedEx::WSDL::TrackTypes::VersionId;
$Shipment::FedEx::WSDL::TrackTypes::VersionId::VERSION = '3.10';
use strict;
use warnings;
...
VersionId from the namespace http://fedex.com/ws/track/v9.
