package Chart::Plotly::Trace::Scattermapbox::Unselected;
use Moose;
...
use Chart::Plotly::Trace::Scattermapbox::Unselected::Marker;
...
has marker => ( is  => "rw",
                isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattermapbox::Unselected::Marker", );
...
Chart::Plotly::Trace::Scattermapbox::Unselected - This attribute is one of the possible options for the trace scattermapbox.
