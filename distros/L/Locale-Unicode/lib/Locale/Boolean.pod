...
=head1 SYNOPSIS
    ...
    my $bool = Locale::Unicode::Boolean->true;
    # or
    my $bool = Locale::Unicode::Boolean::true;
    # Now I have a Locale::Unicode::Boolean object
...
Provided with a true, or false value, and this instantiate a new C<Locale::Unicode::Boolean> object and returns it.
...
Provided with a value and this returns true if it is a L<Locale::Unicode::Boolean> object

=head2 is_true

Provided with a value and this returns true if it is a L<Locale::Unicode::Boolean> object and this is true.

=head2 is_false

Provided with a value and this returns true if it is a L<Locale::Unicode::Boolean> object and this is false.
