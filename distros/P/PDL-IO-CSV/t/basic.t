...
### TAB2
my $t2  = rcsv2D('t/_sample2.csv');
my @p2  = rcsv1D('t/_sample2.csv');
my @p2d = rcsv1D('t/_sample2.csv', {type=>double, empty2bad=>1});
my @p2f = rcsv1D('t/_sample2.csv', {type=>float, empty2bad=>1});
...
### TAB3
my $t3  = rcsv2D('t/_sample3.csv', {type=>long});
my $t3b = rcsv2D('t/_sample3.csv', {type=>long, empty2bad=>1});
my $t3x = rcsv2D('t/_sample3.csv', {type=>long, empty2bad=>1, text2bad=>1});
is($t3->sum,  32, '$t3->sum');
