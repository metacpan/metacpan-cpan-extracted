...
$RDF::Cowl::DataPropExp::VERSION = '1.0.0';
# CowlDataPropExp
use strict;
use warnings;
...
RDF::Cowl::DataPropExp - Represents a DataPropertyExpression in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::DataPropExp>
