...
use Google::Ads::AdWords::v201702::CustomParameter;
use Google::Ads::AdWords::v201702::CustomParameters;
use Google::Ads::AdWords::v201702::ExpandedTextAd;
use Google::Ads::AdWords::v201702::Image;
use Google::Ads::AdWords::v201702::ImageAd;
use Google::Ads::AdWords::v201702::TemplateAd;
use Google::Ads::AdWords::v201702::Video;
...
sub add_text_ad_with_upgraded_urls {
  ...
  # Create text ad.
  my $text_ad = Google::Ads::AdWords::v201702::ExpandedTextAd->new({
  ...
  # or feed item levels.
  my $season_parameter = Google::Ads::AdWords::v201702::CustomParameter->new({
      key   => "season",
      value => "christmas"
  });
  my $promo_code_parameter =
    Google::Ads::AdWords::v201702::CustomParameter->new({
      key   => "promocode",
      value => "NYC123"
    });
  my $tracking_url_parameters =
    Google::Ads::AdWords::v201702::CustomParameters->new(
  ...
  my $text_ad_group_ad = Google::Ads::AdWords::v201702::AdGroupAd->new({
