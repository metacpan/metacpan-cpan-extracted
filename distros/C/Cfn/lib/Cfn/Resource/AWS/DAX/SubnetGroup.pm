# AWS::DAX::SubnetGroup generated from spec 14.3.0
...
Cfn::Resource::AWS::DAX::SubnetGroup - Cfn resource for AWS::DAX::SubnetGroup

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::DAX::SubnetGroup.
