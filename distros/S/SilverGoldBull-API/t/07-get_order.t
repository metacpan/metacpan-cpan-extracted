...
my $order_id = '1396940734';
ok( my $order_response = $sgb->get_order($order_id), 'Get order list response object' );

isa_ok($order_response, 'SilverGoldBull::API::Response');
can_ok($order_response, qw(is_success data));