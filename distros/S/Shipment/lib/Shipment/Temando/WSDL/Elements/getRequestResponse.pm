...
package Shipment::Temando::WSDL::Elements::getRequestResponse;
$Shipment::Temando::WSDL::Elements::getRequestResponse::VERSION = '2.03';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    __PACKAGE__->__set_name('getRequestResponse');
...
getRequestResponse from the namespace http://' . $Shipment::Temando::WSDL::Interfaces::quoting_Service::quoting_port::ns_url . '/schema/2009_06/server.xsd.
