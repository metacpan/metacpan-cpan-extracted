...
# $Id: 01_load.t,v 1.1 2006/06/11 16:34:47 robertemay Exp $
#
# - check pre-requsites
# - check module loads
...
# Check that Win32::GUI::DIBitmap loads, and bail out of all
# tests if it doesn't
use_ok('Win32::GUI::DIBitmap')
  or print STDOUT "Bail out! Can't load Win32::GUI::DIBitmap";

# Check that Win32::GUI::DIBitmap has a version
ok(defined $Win32::GUI::DIBitmap::VERSION, "Win32::GUI::DIBitmap version check");
