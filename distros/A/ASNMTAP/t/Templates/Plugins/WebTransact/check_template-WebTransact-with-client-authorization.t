...
#
# ... Tests via check_template-WebTransact-with-client-authorization.pl
#
# $Id: check_template-WebTransact-with-client-authorization.t, v 1.0 2007/03/15 Alex Peeters Exp $
#
...
my $plugin = 'check_template-WebTransact-with-client-authorization.pl';
