...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::InterconnectLocation Google::Cloud::Compute::V1::Compute::InterconnectLocationList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::InterconnectLocationsClient->new( credentials => 'dummy' );
