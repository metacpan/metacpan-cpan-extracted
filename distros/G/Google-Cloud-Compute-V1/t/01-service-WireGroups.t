...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::WireGroup Google::Cloud::Compute::V1::Compute::WireGroupList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::WireGroupsClient->new( credentials => 'dummy' );
