...
our $rschema = ["str",[{len=>1,match=>qr(\A[A-Za-z]\z),summary=>"Latin letter, i.e. A-Z or a-z"}],["str"]];
...
This document describes version 0.001 of Sah::SchemaR::latin_letter (from Perl distribution Sah-Schemas-Str), released on 2019-08-23.
