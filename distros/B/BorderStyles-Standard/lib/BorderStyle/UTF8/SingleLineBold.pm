...
1;
# ABSTRACT: Bold single-line border with UTF8 characters
...
BorderStyle::UTF8::SingleLineBold - Bold single-line border with UTF8 characters

=head1 VERSION

This document describes version 0.013 of BorderStyle::UTF8::SingleLineBold (from Perl distribution BorderStyles-Standard), released on 2022-02-14.
