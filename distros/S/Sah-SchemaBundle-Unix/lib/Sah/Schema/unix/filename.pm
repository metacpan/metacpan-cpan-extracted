...
This document describes version 0.022 of Sah::Schema::unix::filename (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"unix::filename*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('unix::filename*', name=>'UnixFilename')
     );
 }

 use My::Types qw(UnixFilename);
 UnixFilename->assert_valid($data);
