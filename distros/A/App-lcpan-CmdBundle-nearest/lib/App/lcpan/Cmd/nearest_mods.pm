...
1;
# ABSTRACT: List modules with names nearest to a specified name
...
App::lcpan::Cmd::nearest_mods - List modules with names nearest to a specified name
...
This module handles the L<lcpan> subcommand C<nearest-mods>.
