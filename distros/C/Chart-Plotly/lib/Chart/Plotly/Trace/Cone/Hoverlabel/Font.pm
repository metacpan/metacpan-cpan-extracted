package Chart::Plotly::Trace::Cone::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Cone::Hoverlabel::Font - This attribute is one of the possible options for the trace cone.
