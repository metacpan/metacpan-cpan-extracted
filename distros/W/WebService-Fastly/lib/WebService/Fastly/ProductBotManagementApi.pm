...
#
package WebService::Fastly::ProductBotManagementApi;
...
# @param string $service_id Alphanumeric string identifying the service. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'disable_product_bot_management' } = {
...
# @return void
#
sub disable_product_bot_management {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling disable_product_bot_management");
    }

    # parse inputs
    my $_resource_path = '/enabled-products/v1/bot_management/services/{service_id}';
...
# @param string $service_id Alphanumeric string identifying the service. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'enable_product_bot_management' } = {
        summary => 'Enable product',
        params => $params,
        returns => 'BotManagementResponseBodyEnable',
        };
}
# @return BotManagementResponseBodyEnable
#
sub enable_product_bot_management {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling enable_product_bot_management");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('BotManagementResponseBodyEnable', $response);
...
# @param string $service_id Alphanumeric string identifying the service. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_product_bot_management' } = {
...
# @return BotManagementResponseBodyEnable
#
sub get_product_bot_management {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling get_product_bot_management");
    }
...
#
{
    ...
    __PACKAGE__->method_documentation->{ 'get_services_product_bot_management' } = {
        summary => 'Get services with product enabled',
        params => $params,
        returns => 'BotManagementResponseBodyGetAllServices',
        };
}
# @return BotManagementResponseBodyGetAllServices
#
sub get_services_product_bot_management {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/enabled-products/v1/bot_management/services';
