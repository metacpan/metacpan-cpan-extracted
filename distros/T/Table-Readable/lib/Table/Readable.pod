...
(This example is included as L<F<synopsis.pl>|https://fastapi.metacpan.org/source/BKB/Table-Readable-0.07/examples/synopsis.pl> in the distribution.)


=head1 VERSION

This documents Table::Readable version 0.07
corresponding to git commit L<d22f9bfccf5e16259afac966c7d8d761a93cb60a|https://github.com/benkasminbullock/Table-Readable/commit/d22f9bfccf5e16259afac966c7d8d761a93cb60a> released on Tue Aug 18 12:49:12 2026 +0900.
...
Look for C<%old> in C<$file> and replace it with C<%new>. If C<%old>
does not match anything in C<$file>, it prints a warning and returns.

=head2 sort_file

    sort_file ($file, $tag);

Sort the entries of C<$file> using the key C<$tag>.
...
(This example is included as L<F<comment-not-row.pl>|https://fastapi.metacpan.org/source/BKB/Table-Readable-0.07/examples/comment-not-row.pl> in the distribution.)
...
(This example is included as L<F<slash.pl>|https://fastapi.metacpan.org/source/BKB/Table-Readable-0.07/examples/slash.pl> in the distribution.)
...
(This example is included as L<F<whitespace.pl>|https://fastapi.metacpan.org/source/BKB/Table-Readable-0.07/examples/whitespace.pl> in the distribution.)
