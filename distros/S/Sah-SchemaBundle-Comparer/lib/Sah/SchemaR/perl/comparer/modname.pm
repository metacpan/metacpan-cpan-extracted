...
Sah::SchemaR::perl::comparer::modname - Perl Comparer::* module name without the prefix, e.g. foo

=head1 VERSION

This document describes version 0.002 of Sah::SchemaR::perl::comparer::modname (from Perl distribution Sah-SchemaBundle-Comparer), released on 2024-03-07.
