...
Some history from the creator of PDLA, leading into the philosophy and
...
started to create a file called `PDLA.xs' - a Perl extension module to
...
all the features they thought PDLA ought to have and I had heinously
neglected. PDLA is a prime example of that modern phenomenon of authoring
...
functionality to large modules to the smallest of bug patches. PDLA
...
and the phenomenon continues.  I firmly believe that PDLA is a great tool
...
--- Karl Glazebook, the creator of PDLA
...
The third idea is interoperability: we want to be able to use PDLA to
...
The fourth idea is related to C<PDLA::PP> and is Tuomas's personal favorite:
...
that code could probably be generated by a simple Perl script. The PDLA C
...
compiler) be possible to compile C<PDLA::PP> subs to C and obtain the top
...
Well, that's the philosophy behind PDLA - speed, conciseness, free,
