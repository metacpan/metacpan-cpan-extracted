#
# $Header: /cvsroot/gtk2-perl-ex/Gtk2-Ex/Simple/Menu/t/GtkExSimpleMenu.t,v 1.1.1.1 2004/10/21 00:00:58 rwmcfa1 Exp $
#

#########################
# GtkSimple::Menu Tests
# 	- rm
#########################

use Gtk2::TestHelper tests => 43;

require_ok( 'Gtk2::Ex::Simple::Menu' );
...
ok( my $menu = Gtk2::Ex::Simple::Menu->new(
				menu_tree        => $menu_tree,
