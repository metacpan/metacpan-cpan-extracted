...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TargetPool Google::Cloud::Compute::V1::Compute::TargetPoolAggregatedList Google::Cloud::Compute::V1::Compute::TargetPoolInstanceHealth Google::Cloud::Compute::V1::Compute::TargetPoolList Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::TargetPoolsClient->new( credentials => 'dummy' );
