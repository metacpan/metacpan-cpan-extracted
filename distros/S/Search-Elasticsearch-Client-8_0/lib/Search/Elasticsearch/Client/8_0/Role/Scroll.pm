...
$Search::Elasticsearch::Client::8_0::Role::Scroll::VERSION = '8.12';
use Moo::Role;
requires 'finish';
...
Search::Elasticsearch::Client::8_0::Role::Scroll - Provides common functionality to L<Search::Elasticsearch::Client::8_0::Scroll> and L<Search::Elasticsearch::Client::8_0::Async::Scroll>
