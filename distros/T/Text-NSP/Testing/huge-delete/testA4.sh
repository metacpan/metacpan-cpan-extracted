...
echo "Running huge-delete.pl --remove 2 --uremove 2 test-1.output test-1.delete1" 
huge-delete.pl --remove 2 --uremove 2 test-1.output test-1.delete1

echo "Running count.pl --newline --remove 2  --uremove 2 test-1.delete2 test-1.txt" 
count.pl --newline --remove 2 --uremove 2 test-1.delete2 test-1.txt
