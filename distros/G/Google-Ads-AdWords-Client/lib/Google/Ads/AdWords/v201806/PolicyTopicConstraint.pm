package Google::Ads::AdWords::v201806::PolicyTopicConstraint;
use strict;
use warnings;
...
Google::Ads::AdWords::v201806::PolicyTopicConstraint

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PolicyTopicConstraint from the namespace https://adwords.google.com/api/adwords/cm/v201806.
