...
This documentation refers to version 1.82 of Tk::AbstractCanvas, which was released on
Thu Jul 13 10:47:29:46 -0500 2017.
...
Albachten <Rudy@Albachten.Com>) and L<Tk::RotCanvas> by Ala Qumsieh <AQumsieh@CPAN.Org>.
...
Most of the I<AbstractCanvas> methods are the same as regular I<Canvas> methods except that they accept and return abstract coordinates instead of widget
coordinates.
...
Abstract coordinates are supplied and returned to B<AbstractCanvas> methods instead of widget coordinates unless otherwise specified. (i.e., These methods take
...
B<Scale> should not be used to 'zoom' the display in and out as it will change the abstract coordinates of the scaled objects. Methods B<zoom>,
B<viewArea>, and B<viewAll> should be used to change the scale of the display without affecting the dimensions of the objects.
...
To be able to rotate rectangles and ovals, this module is capable of intercepting any calls to B<create()>, B<createRectangle()>, and
...
=item - 1.82 H7DMAlTk Thu Jul 13 10:47:29:46 -0500 2017
...
* added test skipping in 02acnv.t to resolve L<HTTPS://RT.CPAN.Org/Ticket/Display.html?id=122405>. (Thanks again Slaven!)

* removed broken Build.PL         to resolve L<HTTPS://RT.CPAN.Org/Ticket/Display.html?id=122404>. (Thank you,   Slaven.)

=item - 1.6 H78MEDIC Sat Jul  8 14:13:18:12 -0500 2017

* cleaned up examples and tested that grid works from L<HTTPS://RT.CPAN.Org/Ticket/Display.html?id=46655>. (Thanks Josef!)
...
Please report any bugs or feature requests to   bug-Tk-AbstractCanvas at RT.CPAN.Org, or through the web interface at
  L<HTTPS://RT.CPAN.Org/NoAuth/ReportBug.html?Queue=Tk-AbstractCanvas>. I will be notified, and then you can be updated of progress on your bug
  as I address fixes.
