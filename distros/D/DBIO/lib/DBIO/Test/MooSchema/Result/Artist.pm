package DBIO::Test::MooSchema::Result::Artist;
...
__PACKAGE__->resultset_class('DBIO::Test::MooSchema::ResultSet::Artist');

__PACKAGE__->has_many(
  cds => 'DBIO::Test::MooSchema::Result::CD', 'artist_id'
);
...
DBIO::Test::MooSchema::Result::Artist - Moo-enabled test result class for the artist table
