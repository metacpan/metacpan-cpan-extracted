package Google::Ads::AdWords::v201708::CampaignGroupPerformanceTargetReturnValue;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'value' => 'Google::Ads::AdWords::v201708::CampaignGroupPerformanceTarget',
...
Google::Ads::AdWords::v201708::CampaignGroupPerformanceTargetReturnValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignGroupPerformanceTargetReturnValue from the namespace https://adwords.google.com/api/adwords/cm/v201708.
