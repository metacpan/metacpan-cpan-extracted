package Google::Ads::AdWords::v201705::TargetOutrankShareBiddingScheme;
use strict;
use warnings;
...
TargetOutrankShareBiddingScheme from the namespace https://adwords.google.com/api/adwords/cm/v201705.
