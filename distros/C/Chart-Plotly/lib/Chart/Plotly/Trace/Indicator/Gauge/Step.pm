package Chart::Plotly::Trace::Indicator::Gauge::Step;
use Moose;
...
use Chart::Plotly::Trace::Indicator::Gauge::Step::Line;
...
has line => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Indicator::Gauge::Step::Line", );
...
Chart::Plotly::Trace::Indicator::Gauge::Step - This attribute is one of the possible options for the trace indicator.
