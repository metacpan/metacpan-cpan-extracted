package Chart::Plotly::Trace::Cone::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Cone::Colorbar::Tickfont - This attribute is one of the possible options for the trace cone.
