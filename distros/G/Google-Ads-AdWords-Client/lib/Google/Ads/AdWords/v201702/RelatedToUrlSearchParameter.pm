package Google::Ads::AdWords::v201702::RelatedToUrlSearchParameter;
use strict;
use warnings;
...
RelatedToUrlSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201702.
