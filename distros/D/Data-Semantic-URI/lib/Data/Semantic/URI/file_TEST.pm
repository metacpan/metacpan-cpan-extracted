...
package Data::Semantic::URI::file_TEST;
our $VERSION = '1.100850';
# ABSTRACT: Test companion class for the file URI semantic data class
use Test::More;
use parent qw(
  Data::Semantic::Test
  Data::Semantic::URI::TestData::file
);
1;
...
Test companion class for L<Data::Semantic::URI::file>. Gets its
test data from L<Data::Semantic::URI::TestData::file>.
