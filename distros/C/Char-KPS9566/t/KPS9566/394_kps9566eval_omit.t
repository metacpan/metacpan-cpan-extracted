...
# KPS9566::eval (omit) has KPS9566::eval "..."
$_ = <<'END';
...
# KPS9566::eval (omit) has KPS9566::eval qq{...}
$_ = <<'END';
...
# KPS9566::eval (omit) has KPS9566::eval q{...}
$_ = <<'END';
...
# KPS9566::eval (omit) has KPS9566::eval $var
$_ = <<'END';
KPS9566::eval $var2
END
...
# KPS9566::eval (omit) has KPS9566::eval (omit)
$_ = <<'END';
