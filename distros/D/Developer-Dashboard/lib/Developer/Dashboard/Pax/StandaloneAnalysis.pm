...
sub _native_artifacts_from_units {
    ...
    for my $unit (@$units) {
        my $artifact = Developer::Dashboard::Pax::Tier1->new(out_dir => '.pax/standalone-native')->compile($unit);
        my %item = (
...
Developer::Dashboard::Pax::StandaloneAnalysis - standalone dependency and payload analyzer

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::StandaloneAnalysis;

  my $obj = Developer::Dashboard::Pax::StandaloneAnalysis->new(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::StandaloneAnalysis -e 1
