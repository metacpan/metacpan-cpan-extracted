#
# $Header: /cvsroot/gtk2-perl-ex/Gtk2-Ex/Simple/Menu/lib/Gtk2/Ex/Simple/Menu.pm,v 1.1.1.1 2004/10/21 00:00:58 rwmcfa1 Exp $
#

package Gtk2::Ex::Simple::Menu;
...
Gtk2::Ex::Simple::Menu - A simple interface to Gtk2's ItemFactory for creating
application menus
...
Simple::Menu is an interface for creating application menubars in as simple a
...
Simple::Menu aims to simplify the design and management of a complex application
...
Another advantage of the Simple::Menu widget is that it simplifies the creation
and use of accelerators.

Simple::Menu is a child of Gtk2::ItemFactory, so that it may be treated as such.
Any method that can be called on a ItemFactory can be called on a Simple::Menu.
...
=item $menu = Gtk2::Ex::Simple::Menu->new (menu_tree => $menu_tree, ...)

Creates a new Gtk2::Ex::Simple::Menu object with the specified tree. Optionally
key value paris providing a default_callback and user_data can be provided as
well.  After creating the menu object all of the subsequent widgets will have
been created and are ready for use.
...
The Gtk2::MenuBar root of the Simple::Menu. This is what should be added to the
widget which will contain the Simple::Menu.
