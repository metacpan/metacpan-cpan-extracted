package Chart::Plotly::Trace::Heatmap::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Heatmap::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Heatmap::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Heatmap::Legendgrouptitle - This attribute is one of the possible options for the trace heatmap.
