...
https://metacpan.org/release/Dist-Zilla-Plugin-Meta-Maintainers

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Dist::Zilla::Plugin::Meta::Maintainers
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Dist::Zilla::Plugin::Meta::Maintainers
...
The code for this distribution is [hosted at GitHub](https://github.com/houseabsolute/Dist-Zilla-Plugin-Meta-Maintainers).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Dist-Zilla-Plugin-Meta-Maintainers)
or [via email](bug-dist-zilla-plugin-meta-maintainers@rt.cpan.org.
