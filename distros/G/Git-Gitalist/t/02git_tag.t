...
my $instance = Git::Gitalist::Tag->new($revline);
isa_ok($instance, 'Git::Gitalist::Tag');
...
ok(!Git::Gitalist::Tag::is_valid_tag($oldtag), 'Git::Gitalist::Tag::is_valid_tag ancient tag');
ok(Git::Gitalist::Tag::is_valid_tag($revline), 'Git::Gitalist::Tag::is_valid_tag regular tag');

# Tags don't necessarily have a refname, check we deal with its absence.
$revline =~ s/$ref_sha1//;
ok(Git::Gitalist::Tag::is_valid_tag($revline), 'Git::Gitalist::Tag::is_valid_tag regular tag sans ref sha1');
