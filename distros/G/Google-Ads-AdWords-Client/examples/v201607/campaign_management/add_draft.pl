...
use Google::Ads::AdWords::v201607::CampaignCriterion;
use Google::Ads::AdWords::v201607::CampaignCriterionOperation;
use Google::Ads::AdWords::v201607::Draft;
use Google::Ads::AdWords::v201607::DraftOperation;
use Google::Ads::AdWords::v201607::Language;
...
sub add_draft {
  ...
  my $draft = Google::Ads::AdWords::v201607::Draft->new({
      baseCampaignId => $base_campaign_id,
      draftName      => sprintf("Test Draft #%s", uniqid())});

  # Create operation.
  my $draft_operation = Google::Ads::AdWords::v201607::DraftOperation->new({
      operator => "ADD",
      operand  => $draft
  });
  ...
  if ($result) {
    ...
    my $criterion = Google::Ads::AdWords::v201607::Language->new({
        id => 1003    # Spanish
    });
    ...
    my $operation =
      Google::Ads::AdWords::v201607::CampaignCriterionOperation->new({
        operator => "ADD",
        operand  => Google::Ads::AdWords::v201607::CampaignCriterion->new({
