...
This document describes version 1.574 of Data::Unixish::rins (from Perl distribution Data-Unixish), released on 2025-02-24.
...
Usage:
 ...
 rins(%args) -> [$status_code, $reason, $payload, \%result_meta]
