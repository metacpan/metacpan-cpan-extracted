...
use Google::Ads::AdWords::v201607::ResponsiveDisplayAd;
...
sub add_responsive_display_ad {
  ...
  my $marketing_image = Google::Ads::AdWords::v201607::Image->new(
    {mediaId => $image->get_mediaId()});

  # Create the responsive display ad.
  my $responsive_display_ad =
    Google::Ads::AdWords::v201607::ResponsiveDisplayAd->new({
