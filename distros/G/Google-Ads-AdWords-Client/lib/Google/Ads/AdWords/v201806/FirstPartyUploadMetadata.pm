package Google::Ads::AdWords::v201806::FirstPartyUploadMetadata;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201806::StoreSalesUploadCommonMetadata);
# Variety: sequence
...
Google::Ads::AdWords::v201806::FirstPartyUploadMetadata

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FirstPartyUploadMetadata from the namespace https://adwords.google.com/api/adwords/rm/v201806.
