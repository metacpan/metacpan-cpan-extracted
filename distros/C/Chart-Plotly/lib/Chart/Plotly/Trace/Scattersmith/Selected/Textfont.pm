package Chart::Plotly::Trace::Scattersmith::Selected::Textfont;
use Moose;
...
Chart::Plotly::Trace::Scattersmith::Selected::Textfont - This attribute is one of the possible options for the trace scattersmith.
