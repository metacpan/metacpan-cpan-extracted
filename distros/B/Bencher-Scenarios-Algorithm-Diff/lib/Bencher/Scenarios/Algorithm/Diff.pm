...
Bencher::Scenarios::Algorithm::Diff - Scenarios to benchmark Algorithm::Diff

=head1 VERSION

This document describes version 0.002 of Bencher::Scenarios::Algorithm::Diff (from Perl distribution Bencher-Scenarios-Algorithm-Diff), released on 2023-01-18.
...
=item * L<Bencher::Scenario::Algorithm::Diff::Diff>

=item * L<Bencher::Scenario::Algorithm::Diff::Startup>
