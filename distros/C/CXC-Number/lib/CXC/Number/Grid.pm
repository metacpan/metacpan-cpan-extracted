...
overlying grid and inserts the overlying grid in that place.  For example,

C<$grid1> is the underlying grid,

     +-------------------------------------------------+
     |    |    |    |    |    |    |    |    |    |    |
     +-------------------------------------------------+

and C<$grid2> is the grid which will be overlayed:

            +--------------------------------+
            |          |         |           |
            +--------------------------------+

The result of C<overlay_n( $grid1, $grid2 )> is:
