...
${B}4${E}
	...
	${G}4,${R}Pl,Perlium,2:pltest basis,5.32.0${E}
	${I}n/a${E}
${B}8${E}
	${G}8,O,Oxygen,16:O ${R}&${G} chalcogen,16${E}
	${G}8,O,Oxygen,16:O ${R}&${G} chalcogen,16${E}
...
pltest '-F,', '--color', 'K', @files;
pltest '--color', '-F,', 'k $F[0]', @files;
pltest '-lF,', '--color=always', 'k $F[0], $_', @files;
pltest '--color=always', '-F,', '/(.*?),/; k', @files;
pltest '--color', '-F,', '/(.*?),/; k, $1', @files;
pltest '--color', '-lF,', '/(.*?),/; k, $1, $_', @files;
