package Chart::Plotly::Trace::Scatter3d::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Scatter3d::Legendgrouptitle::Font - This attribute is one of the possible options for the trace scatter3d.
