...
## unix_test.pl
##
## Script to test the Unix::General device class. A debug file called "dump.log" is created.
##
## $Id: unix_test.pl 35 2007-07-11 13:57:17Z mwallraf $
## $Author: mwallraf $
...
my $w = Net::Telnet::Wrapper->new('device_class' => 'Unix::General', -host => "$device", Dump_Log => "dump.log" );
