...
$Gherkin::Exceptions::VERSION = '19.0.3';
use overload
    q{""}    => 'stringify',
    fallback => 1;
...
$Gherkin::Exceptions::Parser::VERSION = '19.0.3';
use base 'Gherkin::Exceptions';

# Composite exceptions
package Gherkin::Exceptions::CompositeParser;
$Gherkin::Exceptions::CompositeParser::VERSION = '19.0.3';
...
$Gherkin::Exceptions::SingleParser::VERSION = '19.0.3';
use base 'Gherkin::Exceptions::Parser';
...
$Gherkin::Exceptions::NoSuchLanguage::VERSION = '19.0.3';
...
$Gherkin::Exceptions::AstBuilder::VERSION = '19.0.3';
use base 'Gherkin::Exceptions::SingleParser';
...
$Gherkin::Exceptions::UnexpectedEOF::VERSION = '19.0.3';
use base 'Gherkin::Exceptions::SingleParser';
...
$Gherkin::Exceptions::UnexpectedToken::VERSION = '19.0.3';
use base 'Gherkin::Exceptions::SingleParser';
