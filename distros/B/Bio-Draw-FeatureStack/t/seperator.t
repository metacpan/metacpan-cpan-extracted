##test case for seperator parameter
...
lives_ok { figure1() }  'Generation of seperator test figure';

sub figure1
{
	my $output_basename = "t/images/seperator";
	
	my @gene_names = (qw (xbx-1 xbx-3));
	...
	(
		...
		-separator => 1,
		-glyph_params => {
							-description => sub {"separators should be on" },
							-utr_color   => 'white',
							-pad_bottom  => 10,
							-height      =>  12,
							-label_transcripts => 1,
