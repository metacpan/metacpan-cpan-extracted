...
HTML::HTML5::DOM::HTMLOptGroupElement - implementation of the HTMLOptGroupElement interface of the HTML DOM

=head1 DESCRIPTION

HTML::HTML5::DOM::HTMLOptGroupElement is an implementation of the HTMLOptGroupElement interface of the HTML DOM. See L<HTML::HTML5::DOM> for a list of the conventions that have been used when translating the DOM to Perl.
...
=item * C<< {http://www.w3.org/1999/xhtml}optgroup >>

=back

=head2 Inheritance

HTML::HTML5::DOM::HTMLOptGroupElement inherits methods from the following Perl classes.
