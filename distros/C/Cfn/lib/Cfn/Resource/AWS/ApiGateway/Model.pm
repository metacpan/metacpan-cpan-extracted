...
Cfn::Resource::AWS::ApiGateway::Model - Cfn resource for AWS::ApiGateway::Model

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::ApiGateway::Model.
