...
IO::K8s::ExternalSecrets::V1alpha1::GrafanaServiceAccount - ServiceAccount is the configuration for the service account that is supposed to be generated by the generator.
