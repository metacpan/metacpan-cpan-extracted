...
static swig_type_info _swigt__p_gsl_cheb_series_struct = {"_p_gsl_cheb_series_struct", "gsl_cheb_series *|struct gsl_cheb_series_struct *|gsl_cheb_series_struct *", 0, 0, (void*)"Math::GSL::Chebyshev::gsl_cheb_series_struct", 0};
static swig_type_info _swigt__p_gsl_function_fdf_struct = {"_p_gsl_function_fdf_struct", "gsl_function_fdf *|struct gsl_function_fdf_struct *|gsl_function_fdf_struct *", 0, 0, (void*)"Math::GSL::Chebyshev::gsl_function_fdf_struct", 0};
