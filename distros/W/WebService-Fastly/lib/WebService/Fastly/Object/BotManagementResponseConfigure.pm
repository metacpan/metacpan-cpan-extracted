...
#
package WebService::Fastly::Object::BotManagementResponseConfigure;
...
use WebService::Fastly::Object::BotManagementResponseConfiguration;
use WebService::Fastly::Object::BotManagementResponseConfigurationConfiguration;
...
__PACKAGE__->method_documentation({
    'product' => {
        datatype => 'BotManagementResponseProductProduct',
        base_name => 'product',
        description => '',
        format => '',
        read_only => 'false',
    ...
    'configuration' => {
        datatype => 'BotManagementResponseConfigurationConfiguration',
    ...
    '_links' => {
        datatype => 'BotManagementResponseLinksLinks',
        base_name => '_links',
        description => '',
        format => '',
        read_only => 'false',
...
__PACKAGE__->openapi_types( {
    ...
    'configuration' => 'BotManagementResponseConfigurationConfiguration',
