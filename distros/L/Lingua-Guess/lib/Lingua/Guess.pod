...
(This example is included as L<F<synopsis.pl>|https://api.metacpan.org/source/BKB/Lingua-Guess-0.01/examples/synopsis.pl> in the distribution.)
...
The scores should be fractional probabilities.
