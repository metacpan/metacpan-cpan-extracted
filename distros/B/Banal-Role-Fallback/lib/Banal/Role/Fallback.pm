...
package Banal::Role::Fallback; # git description: a65908e
# vim: set ts=2 sts=2 sw=2 tw=115 et :
# ABSTRACT: A Moo/Moose compatible incarnation of C<Banal::Role::Fallback::Tiny>
...
Banal::Role::Fallback - A Moo/Moose compatible incarnation of C<Banal::Role::Fallback::Tiny>
