...
This document describes version 0.005 of Sah::Schema::perl::arraydata::modname (from Perl distribution Sah-SchemaBundle-ArrayData), released on 2024-02-16.
...
Used completion: L<perl_modname|Perinci::Sub::XCompletion::perl_modname>, L<HASH(0x55e1c17538a8)|Perinci::Sub::XCompletion::HASH(0x55e1c17538a8)>
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::arraydata::modname*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::arraydata::modname*', name=>'PerlArraydataModname')
     );
 }

 use My::Types qw(PerlArraydataModname);
 PerlArraydataModname->assert_valid($data);
