package Chart::Plotly::Trace::Carpet::Baxis::Tickformatstop;
use Moose;
...
Chart::Plotly::Trace::Carpet::Baxis::Tickformatstop - This attribute is one of the possible options for the trace carpet.
