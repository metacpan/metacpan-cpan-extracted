...
package UMMF::UML_1_5::OCL::Types::OCLModelElementType;
...
=head2 C<__validate_type>
  ...
  UMMF::UML_1_5::OCL::Types::OCLModelElementType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::OCL::Types::OCLModelElementType|UMMF::UML_1_5::OCL::Types::OCLModelElementType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::OCL::Types::OCLModelElementType')  ;
}


=head2 C<__typecheck>

  UMMF::UML_1_5::OCL::Types::OCLModelElementType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::OCL::Types::OCLModelElementType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::OCL::Types::OCLModelElementType' . ": value '$x'")
    unless __validate_type($self, $x);
}


=head2 C<isaOCLModelElementType>


Returns true if receiver is a L<UMMF::UML_1_5::OCL::Types::OCLModelElementType|UMMF::UML_1_5::OCL::Types::OCLModelElementType>.
Other receivers will return false.

=cut
sub isaOCLModelElementType { 1 }


=head2 C<isaOCL__Types__OCLModelElementType>


Returns true if receiver is a L<UMMF::UML_1_5::OCL::Types::OCLModelElementType|UMMF::UML_1_5::OCL::Types::OCLModelElementType>.
Other receivers will return false.
This is the fully qualified version of the C<isaOCLModelElementType> method.

=cut
sub isaOCL__Types__OCLModelElementType { 1 }
...
Returns the UML Model name (C<'OCL::Types::OCLModelElementType'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'OCL::Types::OCLModelElementType' }
...
sub __tangram_schema
{
  ...
  $__tangram_schema ||=
  {
   ...
   [
     'UMMF::UML_1_5::OCL::Types::OCLModelElementType' =>
     {
       'table' => 'OCL__Types__OCLModelElementType',
       'abstract' => 0,
       'slots' => 
       { 
	 # Attributes
...
sub __initialize
{
  ...
  $self->UMMF::UML_1_5::OCL::Types::OCLModelElementType::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::OCL::Types::OCLModelElementType::___create(@args);
...
# End of Class OCLModelElementType
