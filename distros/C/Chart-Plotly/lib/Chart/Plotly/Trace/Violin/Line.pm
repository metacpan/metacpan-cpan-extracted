package Chart::Plotly::Trace::Violin::Line;
use Moose;
...
has color => ( is            => "rw",
               isa           => "Str",
               documentation => "Sets the color of line bounding the violin(s).",
);

has width => ( is            => "rw",
               isa           => "Num",
               documentation => "Sets the width (in px) of line bounding the violin(s).",
);
...
Chart::Plotly::Trace::Violin::Line - This attribute is one of the possible options for the trace violin.
