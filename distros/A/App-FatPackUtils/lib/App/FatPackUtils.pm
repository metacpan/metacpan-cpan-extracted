...
App::FatPackUtils - Collection of CLI utilities related to fatpacking

=head1 VERSION

This document describes version 0.121 of App::FatPackUtils (from Perl distribution App-FatPackUtils), released on 2020-04-30.
...
=item * L<fatpack-extract>

=item * L<fatpack-info>

=item * L<fatpack-modules>

=item * L<update-fatpack-snippets>
