...
# File ini dikodekan dalam UTF-8.
...
#
#   $line             : string yang akan dikonversi (dikirim melalui referensi, ditimpa di tempat)
#   $OUTPUT_encoding  : nama pengkodean output
#   $INPUT_encoding   : nama pengkodean input
#   $char_count       : jumlah karakter setelah konversi
#
# [DAFTAR NAMA PENGKODEAN]
#
#   mnemonik    arti
#   ---------   ---------------------------------------------------
#   cp932x      CP932X (perluasan ke JIS X 0213, pergeseran tunggal 0x9C5A)
...
#   jef         FUJITSU JEF (12pt, kode pergeseran dengan OUTPUT_SHIFTING)
#   jef9p       FUJITSU JEF ( 9pt, kode pergeseran dengan OUTPUT_SHIFTING)
#   jipsj       NEC JIPS(J)
#   jipse       NEC JIPS(E)
#   letsj       UNISYS LetsJ
#   utf8        UTF-8.0 (UTF-8 biasa)
#   utf8.1      UTF-8.1 (konversi berdasarkan pemetaan Shift_JIS-Unicode, bukan CP932)
#   utf8jp      UTF-8-SPUA-JP (JIS X 0213 dipetakan ke area SPUA Unicode)
#
# [PILIHAN]
#
#   kunci             nilai / keterangan
#   ---------------   ---------------------------------------------------
#   INPUT_LAYOUT      tata letak rekaman input ('S'=SBCS, 'D'=DBCS dengan jumlah pengulangan)
#   OUTPUT_SHIFTING   jika benar, sisipkan kode pergeseran di sekitar urutan DBCS
#   SPACE             kode spasi DBCS/MBCS (string biner)
#   GETA              simbol geta untuk karakter yang tidak dapat dipetakan
#   OVERRIDE_MAPPING  penggantian per karakter { "\x12\x34"=>"\x56\x78" }
#
...
BEGIN {
    ...
    @test = (
        ...
        # --- UTF-8.1: konversi berdasarkan Shift_JIS-Unicode, bukan CP932 ---
