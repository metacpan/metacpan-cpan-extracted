...
require Aion::Type::DNF;
require Aion::Type::Espresso;

our @ISA = qw/Aion::Type::DNF Aion::Type::Espresso/;
...
sub _range_lbaund_addr { Scalar::Util::refaddr shift->{coerce} }
sub is_range_type { exists $range_lbound{shift->_range_lbaund_addr} }
sub range_lbound { $range_lbound{shift->_range_lbaund_addr} }
