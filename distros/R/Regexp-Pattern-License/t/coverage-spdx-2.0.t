...
# Data sources (exceptions extrapolated from release 2.1 data):
# <https://web.archive.org/web/20150409013137/http://spdx.org:80/licenses/>
# <https://web.archive.org/web/20150717181518/http://spdx.org:80/licenses/exceptions-index.html>
# <https://wiki.spdx.org/view/Legal_Team/Minutes/2015-06-11>
# <https://docs.google.com/spreadsheets/d/11AKxLBoN_VXM32OmDTk2hKeYExKzsnPjAVM7rLstQ8s/edit?pli=1>
...
like(
	...
	hash {
		...
		field 'Creative Commons Attribution 1.0 Generic'  => 'CC-BY-1.0';
		field 'Creative Commons Attribution 2.0 Generic'  => 'CC-BY-2.0';
		field 'Creative Commons Attribution 2.5 Generic'  => 'CC-BY-2.5';
		field 'Creative Commons Attribution 3.0 Unported' => 'CC-BY-3.0';
		field 'Creative Commons Attribution 4.0 International' => 'CC-BY-4.0';
		field 'Creative Commons Attribution No Derivatives 1.0 Generic' =>
			'CC-BY-ND-1.0';
		field 'Creative Commons Attribution No Derivatives 2.0 Generic' =>
			'CC-BY-ND-2.0';
		field 'Creative Commons Attribution No Derivatives 2.5 Generic' =>
			'CC-BY-ND-2.5';
		field 'Creative Commons Attribution No Derivatives 3.0 Unported' =>
			'CC-BY-ND-3.0';
		field 'Creative Commons Attribution No Derivatives 4.0 International'
			=> 'CC-BY-ND-4.0';
		field 'Creative Commons Attribution Non Commercial 1.0 Generic' =>
			'CC-BY-NC-1.0';
		field 'Creative Commons Attribution Non Commercial 2.0 Generic' =>
			'CC-BY-NC-2.0';
		field 'Creative Commons Attribution Non Commercial 2.5 Generic' =>
			'CC-BY-NC-2.5';
		field 'Creative Commons Attribution Non Commercial 3.0 Unported' =>
			'CC-BY-NC-3.0';
		field 'Creative Commons Attribution Non Commercial 4.0 International'
			=> 'CC-BY-NC-4.0';
		field
		...
		field
			...
			=> 'CC-BY-NC-SA-4.0';
		field 'Creative Commons Attribution Share Alike 1.0 Generic' =>
			'CC-BY-SA-1.0';
		field 'Creative Commons Attribution Share Alike 2.0 Generic' =>
			'CC-BY-SA-2.0';
		field 'Creative Commons Attribution Share Alike 2.5 Generic' =>
			'CC-BY-SA-2.5';
		field 'Creative Commons Attribution Share Alike 3.0 Unported' =>
			'CC-BY-SA-3.0';
		field 'Creative Commons Attribution Share Alike 4.0 International' =>
			'CC-BY-SA-4.0';
...
# TODO		field 'XSkat License'              => 'XSkat';
	...
	'coverage of SPDX 2.0, announced 2015-05-13'
);
