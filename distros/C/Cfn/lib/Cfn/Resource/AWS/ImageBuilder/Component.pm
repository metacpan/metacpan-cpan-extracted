# AWS::ImageBuilder::Component generated from spec 34.0.0
...
package Cfn::Resource::Properties::AWS::ImageBuilder::Component {
  ...
  has SupportedOsVersions => (isa => 'Cfn::Value::Array|Cfn::Value::Function|Cfn::DynamicValue', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Immutable');
...
Cfn::Resource::AWS::ImageBuilder::Component - Cfn resource for AWS::ImageBuilder::Component

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::ImageBuilder::Component.
