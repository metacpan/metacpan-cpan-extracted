...
Sah::SchemaR::perl::comparer::modnames_with_optional_args - Array of Perl Comparer::* module names without the prefix, with optional args, e.g. ["Foo::bar", "Foo::baz=qux,quux"]

=head1 VERSION

This document describes version 0.002 of Sah::SchemaR::perl::comparer::modnames_with_optional_args (from Perl distribution Sah-SchemaBundle-Comparer), released on 2024-03-07.
