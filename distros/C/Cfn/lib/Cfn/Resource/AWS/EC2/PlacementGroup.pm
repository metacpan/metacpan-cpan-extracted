...
Cfn::Resource::AWS::EC2::PlacementGroup - Cfn resource for AWS::EC2::PlacementGroup

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::EC2::PlacementGroup.
