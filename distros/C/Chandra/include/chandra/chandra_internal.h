...
static const char CHANDRA_ROUTER_JS[] =
    ...
    "        };\n"
    "    }\n"
    "    if (window.__chandraClickHandler) {\n"
    "        document.removeEventListener('click', window.__chandraClickHandler);\n"
    "    }\n"
    "    window.__chandraClickHandler = function(e) {\n"
    "        var el = e.target;\n"
    ...
    "    };\n"
    "    document.addEventListener('click', window.__chandraClickHandler);\n"
    "    if (window.__chandraPopstateHandler) {\n"
    "        window.removeEventListener('popstate', window.__chandraPopstateHandler);\n"
    "    }\n"
    "    window.__chandraPopstateHandler = function() {\n"
    "        window.chandra.invoke('__chandra_navigate', [location.pathname || '/']);\n"
    "    };\n"
    "    window.addEventListener('popstate', window.__chandraPopstateHandler);\n"
    "})();\n";
