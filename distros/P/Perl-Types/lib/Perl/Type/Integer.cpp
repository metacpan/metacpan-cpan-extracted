...
#ifndef __CPP__INCLUDED__Perl__Type__Integer_cpp
#define __CPP__INCLUDED__Perl__Type__Integer_cpp 0.008_000

// [[[ INCLUDES ]]]
#include <Perl/Type/Integer.h>  // -> NULL (relies on native C type)
...
SV* integer_to_nonsigned_integer(SV* input_integer) {
//  integer_CHECK(input_integer);
...
nonsigned_integer integer_to_nonsigned_integer(integer input_integer) {
    if (input_integer < 0) { return (nonsigned_integer) (input_integer * -1); }
    else { return (nonsigned_integer) input_integer; }
}
...
SV* integer_typetest0() {
	SV* retval = newSViv((21 / 7) + SvIV(Perl__Type__Integer__MODE_ID()));
...
//fprintf(stderr, "in CPPOPS_PERLTYPES integer_typetest1(), received lucky_integer = %"INTEGER"\n", (integer)SvIV(lucky_integer));
	return newSViv((SvIV(lucky_integer) * 2) + SvIV(Perl__Type__Integer__MODE_ID()));
}

# elif defined __CPP__TYPES

integer integer_typetest0() {
	integer retval = (21 / 7) + Perl__Type__Integer__MODE_ID();
...
//fprintf(stderr, "in CPPOPS_CPPTYPES integer_typetest1(), received lucky_integer = %"INTEGER"\n", lucky_integer);
	return (lucky_integer * 2) + Perl__Type__Integer__MODE_ID();
}
