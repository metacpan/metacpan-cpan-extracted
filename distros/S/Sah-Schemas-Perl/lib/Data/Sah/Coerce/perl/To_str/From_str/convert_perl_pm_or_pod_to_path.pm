package Data::Sah::Coerce::perl::To_str::From_str::convert_perl_pm_or_pod_to_path;
...
sub meta {
    +{
        v => 4,
        summary => 'Convert module/POD name existing in @INC to its filesystem path',
        prio => 50,
    };
}
...
Data::Sah::Coerce::perl::To_str::From_str::convert_perl_pm_or_pod_to_path

=head1 VERSION

This document describes version 0.027 of Data::Sah::Coerce::perl::To_str::From_str::convert_perl_pm_or_pod_to_path (from Perl distribution Sah-Schemas-Perl), released on 2020-02-15.
