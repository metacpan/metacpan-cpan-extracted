...
END
            ...
            if ($list !~ /\A (?>\s*) \z/oxms) {
                ...
                for (@list) {
                    ...
                    $Elatin3::function_ord     = $Elatin3::function_ord;
                    $Elatin3::function_ord_    = $Elatin3::function_ord_;
                    $Elatin3::function_reverse = $Elatin3::function_reverse;
                    $Elatin3::function_getc    = $Elatin3::function_getc;
                }
            }
        }
    }
