package OWL::DirectSemantics::Element::DataUnionOf;

BEGIN {
	$OWL::DirectSemantics::Element::DataUnionOf::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::DataUnionOf::VERSION   = '0.001';
};
...
OWL::DirectSemantics::Element::DataUnionOf - represents an OWL DataUnionOf

=head1 DESCRIPTION

This class represents the DataUnionOf element in OWL Direct Semantics.
