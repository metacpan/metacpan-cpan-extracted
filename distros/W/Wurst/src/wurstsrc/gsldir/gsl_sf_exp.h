 ...
 * exceptions: GSL_EOVRFLW, GSL_EUNDRFLW
 */
int gsl_sf_exp_mult_e(const double x, const double y,
 ...
 */
int gsl_sf_exp_err_e(const double x, const double dx,
		     gsl_sf_result * result);
...
#include "gsl_errno.h"
__BEGIN_DECLS
    extern inline int gsl_sf_exp_e(const double x, gsl_sf_result * result)
{
