package Chart::Plotly::Trace::Bar::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Bar::Legendgrouptitle::Font;
...
Chart::Plotly::Trace::Bar::Legendgrouptitle - This attribute is one of the possible options for the trace bar.
