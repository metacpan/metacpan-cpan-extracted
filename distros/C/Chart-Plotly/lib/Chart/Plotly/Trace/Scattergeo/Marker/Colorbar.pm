package Chart::Plotly::Trace::Scattergeo::Marker::Colorbar;
use Moose;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattergeo::Marker::Colorbar::Tickfont", );
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Scattergeo::Marker::Colorbar::Tickformatstop]",
);
...
Chart::Plotly::Trace::Scattergeo::Marker::Colorbar - This attribute is one of the possible options for the trace scattergeo.
