...
# eval (omit) has eval "..."
$_ = <<'END';
eval Windows1250::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } "
END
if (eval Windows1250::escape) {
...
$_ = <<'END';
eval Windows1250::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
if (eval Windows1250::escape) {
...
# eval (omit) has eval '...'
$_ = <<'END';
eval Windows1250::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } '
END
if (eval Windows1250::escape) {
...
$_ = <<'END';
eval Windows1250::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
if (eval Windows1250::escape) {
