...
IO::K8s::ExternalSecrets::V1::OnePasswordAuthSecretRef - OnePasswordAuthSecretRef holds secret references for 1Password credentials.

=head1 VERSION

version 1.108

=head2 connectTokenSecretRef
