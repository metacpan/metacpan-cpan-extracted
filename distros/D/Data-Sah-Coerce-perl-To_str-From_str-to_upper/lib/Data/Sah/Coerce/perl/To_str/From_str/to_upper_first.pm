...
sub meta {
    +{
        v => 4,
        summary => "(DEPRECATED) Coerce string's first character to upper case",
        prio => 50,
    };
}
...
1;
# ABSTRACT: (DEPRECATED) Coerce string's first character to upper case
...
Data::Sah::Coerce::perl::To_str::From_str::to_upper_first - (DEPRECATED) Coerce string's first character to upper case

=head1 VERSION

This document describes version 0.007 of Data::Sah::Coerce::perl::To_str::From_str::to_upper_first (from Perl distribution Data-Sah-Coerce-perl-To_str-From_str-to_upper), released on 2020-02-11.
