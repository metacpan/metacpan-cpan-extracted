package Chart::Plotly::Trace::Histogram2d::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Histogram2d::Colorbar::Tickfont;
use Chart::Plotly::Trace::Histogram2d::Colorbar::Tickformatstop;
use Chart::Plotly::Trace::Histogram2d::Colorbar::Titlefont;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram2d::Colorbar::Tickfont", );
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Histogram2d::Colorbar::Tickformatstop]", );
...
has titlefont => ( is  => "rw",
                   isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram2d::Colorbar::Titlefont", );
...
Chart::Plotly::Trace::Histogram2d::Colorbar - This attribute is one of the possible options for the trace histogram2d.
