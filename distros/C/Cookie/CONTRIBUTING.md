...
Feel free to clone it from its gitlab repository at <https://git.deguest.jp/jack/Cookie> and issue a pull request.
...
File [an issue on CPAN bug tracker](https://git.deguest.jp/jack/Cookie/issues) if you think you've found a bug. Please describe
...
Issues are currently reported using CPAN [bug tracker](https://git.deguest.jp/jack/Cookie/issues)

## More information

Please refer to the [README](https://metacpan.org/source/JDEGUEST/Cookie-v0.1.3/README.md)
