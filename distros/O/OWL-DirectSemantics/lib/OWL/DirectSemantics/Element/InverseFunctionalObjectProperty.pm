package OWL::DirectSemantics::Element::InverseFunctionalObjectProperty;
...
OWL::DirectSemantics::Element::InverseFunctionalObjectProperty - represents an OWL InverseFunctionalObjectProperty

=head1 DESCRIPTION

This class represents the InverseFunctionalObjectProperty element in OWL Direct Semantics.
