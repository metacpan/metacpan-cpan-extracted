...
";
    ...
    my $resmeta = {};
    $resmeta->{'table.fields'} = [qw/rank author mod_count mod_count_pct/];
    [200, "OK", \@res, $resmeta];
}
...
This document describes version 1.073 of App::lcpan::Cmd::authors_by_mod_count (from Perl distribution App-lcpan), released on 2023-07-09.
