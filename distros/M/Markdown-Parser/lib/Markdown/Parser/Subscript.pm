## -*- perl -*-
##----------------------------------------------------------------------------
## Markdown Parser Only - ~/lib/Markdown/Parser/Subscript.pm
## Version v0.2.0
...
##----------------------------------------------------------------------------
package Markdown::Parser::Subscript;
BEGIN
{
    use strict;
    use warnings;
...
This class represents a subscript formatting. It is used by L<Markdown::Parser> and inherits from L<Markdown::Parser::Element>
...
Returns a string representation of the subscript formatted in L<pod|perlpod>.
