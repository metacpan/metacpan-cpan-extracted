package Google::Ads::AdWords::v201609::AdGroupCriterionService::AdGroupCriterionServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201609::TypeMaps::AdGroupCriterionService
    if not Google::Ads::AdWords::v201609::TypeMaps::AdGroupCriterionService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201609/AdGroupCriterionService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201609::TypeMaps::AdGroupCriterionService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201609::AdGroupCriterionService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201609::AdGroupCriterionService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201609::AdGroupCriterionService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201609::AdGroupCriterionService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201609::AdGroupCriterionService::query )],
        },
        header => {
...
Google::Ads::AdWords::v201609::AdGroupCriterionService::AdGroupCriterionServiceInterfacePort - SOAP Interface for the AdGroupCriterionService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201609::AdGroupCriterionService::AdGroupCriterionServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201609::AdGroupCriterionService::AdGroupCriterionServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/cm/v201609/AdGroupCriterionService.
...
Returns a L<Google::Ads::AdWords::v201609::AdGroupCriterionService::getResponse|Google::Ads::AdWords::v201609::AdGroupCriterionService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201609::AdGroupCriterionService::mutateResponse|Google::Ads::AdWords::v201609::AdGroupCriterionService::mutateResponse> object.

 $response = $interface->mutate( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201609::AdGroupCriterionOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201609::AdGroupCriterionService::mutateLabelResponse|Google::Ads::AdWords::v201609::AdGroupCriterionService::mutateLabelResponse> object.
...
Returns a L<Google::Ads::AdWords::v201609::AdGroupCriterionService::queryResponse|Google::Ads::AdWords::v201609::AdGroupCriterionService::queryResponse> object.
...
Generated by SOAP::WSDL on Thu May 25 09:58:51 2017
