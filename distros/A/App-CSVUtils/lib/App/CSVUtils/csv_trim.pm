...
1;
# ABSTRACT: Trim (remove leading & trailing whitespace) values and/or fields in CSV
...
App::CSVUtils::csv_trim - Trim (remove leading & trailing whitespace) values and/or fields in CSV

=head1 VERSION

This document describes version 1.023 of App::CSVUtils::csv_trim (from Perl distribution App-CSVUtils), released on 2023-03-31.
...
Usage:
 ...
 csv_trim(%args) -> [$status_code, $reason, $payload, \%result_meta]

Trim (remove leading & trailing whitespace) values andE<sol>or fields in CSV.

Examples:

=over

=item * Trim values in a CSV:

 csv_trim(input_filename => "FILE.csv");
