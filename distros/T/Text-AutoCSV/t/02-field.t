...
my $csv = Text::AutoCSV->new(in_file => "t/${ww}l01a.csv", croak_if_error => 0, out_file => $tmpf,
	quiet => 1)->write();
...
is_deeply($all,
	[{'A' => '', 'C' => '', 'B' => ''}, {'A' => 'k1', 'B' => '', 'C' => 'v'},
		{'A' => '', 'C' => '', 'B' => ''}, {'C' => 'v2', 'B' => 'foo', 'A' => 'k2'},
		{'A' => 'k3', 'B' => 'bar', 'C' => 'v3'}, {'A' => '', 'C' => 'v4', 'B' => 'foobar'}],
...
$csv->read();
is_deeply(\@l,
	[{'A' => '', 'B' => 'foobar', 'C' => 'v4'}, {'A' => 'k3', 'B' => 'bar', 'C' => 'v3'},
		{'A' => 'k2', 'B' => 'foo', 'C' => 'v2'}, {'A' => '', 'B' => '', 'C' => ''},
		{'A' => 'k1', 'B' => '', 'C' => 'v'}, {'A' => '', 'B' => '', 'C' => ''}],
...
is_deeply(\@l,
	[ ],
	"WR04 - check set_walker_hr(undef) removes callback"
);
...
@l2 = ();
$csv->read();
is_deeply(\@l2, [ ], "WR07 - check set_walker_ar(undef) removes callback (2)"
);

@l2 = ();
$csv = Text::AutoCSV->new(in_file => "t/${ww}l01a.csv", croak_if_error => 0, walker_ar => \&walker_ar,
	quiet => 1)->read();
is_deeply(\@l2,
	[{':a' => '', ':b' => 'foobar', ':c' => 'v4'}, {':a' => 'k3', ':b' => 'bar', ':c' => 'v3'},
		{':a' => 'k2', ':b' => 'foo', ':c' => 'v2'}, {':a' => '', ':b' => '', ':c' => ''},
...
is_deeply($all,
	[{'A' => '', 'B' => '', 'C' => ''}, {'A' => 'k1', 'B' => '', 'C' => 'v'},
		{'A' => '', 'B' => '', 'C' => ''}, {'A' => 'k2', 'B' => 'foo', 'C' => 'v2'},
		{'A' => 'k3', 'B' => 'bar', 'C' => 'v3'}, {'A' => '', 'B' => 'foobar', 'C' => 'v4'}],
...
is_deeply($all,
	[{'A' => '', 'B' => '', 'BCOPY' => '', 'BCOPYZ' => '<>', 'C' => ''},
		{'A' => 'k1', 'B' => '', 'BCOPY' => '', 'BCOPYZ' => '<>', 'C' => 'v'},
		{'A' => '', 'B' => '', 'BCOPY' => '', 'BCOPYZ' => '<>', 'C' => ''},
		{'A' => 'k2', 'B' => 'foo', 'BCOPY' => 'foo', 'BCOPYZ' => '<FOO>', 'C' => 'v2'},
		{'A' => 'k3', 'B' => 'bar', 'BCOPY' => 'bar', 'BCOPYZ' => '<BAR>', 'C' => 'v3'},
		{'A' => '', 'B' => 'foobar', 'BCOPY' => 'foobar', 'BCOPYZ' => '<FOOBAR>', 'C' => 'v4'}],
...
$csv = Text::AutoCSV->new(in_file => "t/${ww}l01a.csv", croak_if_error => 0, quiet => 1,
...
is_deeply(\@cols2, ['A', 'B', 'C', 'CREATED'], "CR05 - check column names (2)");

$csv->field_add_copy('COPIED', 'A');
my @cols3 = $csv->get_fields_names();
is_deeply(\@cols3, ['A', 'B', 'C', 'CREATED', 'COPIED'], "CR06 - check column names (3)");

$csv->field_add_link('LINKED', 'A->B->SITE', "t/${ww}l01b.csv");
my @cols4 = $csv->get_fields_names();
is_deeply(\@cols4, ['A', 'B', 'C', 'CREATED', 'COPIED', 'LINKED'], "CR07 - check column names (4)");

$csv->read();
my @cols5 = $csv->get_fields_names();
is_deeply(\@cols5, ['A', 'B', 'C', 'CREATED', 'COPIED', 'LINKED'], "CR08 - check column names (5)");

$all = [ $csv->get_hr_all() ];
is_deeply($all,
	[{'A' => '', 'B' => '', 'C' => '', 'COPIED' => '', 'CREATED' => '--<>',
			'LINKED' => undef},
		{'A' => 'k1', 'B' => '', 'C' => 'v', 'COPIED' => 'k1', 'CREATED' => 'k1--<V>',
			'LINKED' => 'ici'},
		{'A' => '', 'B' => '', 'C' => '', 'COPIED' => '', 'CREATED' => '--<>',
			'LINKED' => undef},
		{'A' => 'k2', 'B' => 'foo', 'C' => 'v2', 'COPIED' => 'k2', 'CREATED' => 'k2--<V2>',
			'LINKED' => 'ici'},
		{'A' => 'k3', 'B' => 'bar', 'C' => 'v3', 'COPIED' => 'k3', 'CREATED' => 'k3--<V3>',
			'LINKED' => undef},
		{'A' => '', 'B' => 'foobar', 'C' => 'v4', 'COPIED' => '', 'CREATED' => '--<V4>',
			'LINKED' => undef }],
...
$all = [ $csv->get_hr_all() ];
is_deeply($all,
	[{'A' => '', 'B' => '', 'C' => '', 'COPIED' => '', 'COPY_OF_A' => '',
			'CREATED' => '--<>', 'LINKED' => undef},
		{'A' => 'k1', 'B' => '', 'C' => 'v', 'COPIED' => 'k1', 'COPY_OF_A' => 'k1',
			'CREATED' => 'k1--<V>', 'LINKED' => 'ici'},
		{'A' => '', 'B' => '', 'C' => '', 'COPIED' => '', 'COPY_OF_A' => '',
			'CREATED' => '--<>', 'LINKED' => undef},
		{'A' => 'k2', 'B' => 'foo', 'C' => 'v2', 'COPIED' => 'k2', 'COPY_OF_A' => 'k2',
			'CREATED' => 'k2--<V2>', 'LINKED' => 'ici'},
		{'A' => 'k3', 'B' => 'bar', 'C' => 'v3', 'COPIED' => 'k3', 'COPY_OF_A' => 'k3',
			'CREATED' => 'k3--<V3>', 'LINKED' => undef},
		{'A' => '', 'B' => 'foobar', 'C' => 'v4', 'COPIED' => '', 'COPY_OF_A' => '',
			'CREATED' => '--<V4>', 'LINKED' => undef}],
...
my $tmpf = &get_non_existent_temp_file_name();
my $csv_link_target = Text::AutoCSV->new(in_file => "t/${ww}l01b.csv", croak_if_error => 0,
	search_ignore_ambiguous => 0);
my $csv = Text::AutoCSV->new(in_file => "t/${ww}l01a.csv", croak_if_error => 0, out_file => $tmpf)
...
$csv = Text::AutoCSV->new(in_file => "t/${ww}l01a.csv", croak_if_error => 0)
	->field_add_link('T', 'A->B->SITE', "t/${ww}l01b.csv", { ignore_ambiguous => 0 });
$all = [ $csv->get_hr_all() ];
is_deeply($all,
	[{'A' => '', 'B' => '', 'C' => '', 'T' => undef},
		{'A' => 'k1', 'B' => '', 'C' => 'v', 'T' => 'ici'},
...
$csv = Text::AutoCSV->new(in_file => "t/${ww}l01a.csv", croak_if_error => 0,
	search_ignore_ambiguous => 0)
	->field_add_link('T', 'A->B->SITE', "t/${ww}l01b.csv", {value_if_not_found => '<not found>'});
$all = [ $csv->get_hr_all() ];
is_deeply($all,
	[{'A' => '', 'B' => '', 'C' => '', 'T' => '<not found>'},
		{'A' => 'k1', 'B' => '', 'C' => 'v', 'T' => 'ici'},
...
$csv = Text::AutoCSV->new(in_file => "t/${ww}l01a.csv", croak_if_error => 0,
	search_ignore_ambiguous => 0)
	->field_add_link(undef, 'A->B->SITE', "t/${ww}l01b.csv", {value_if_not_found => '<not found>',
...
is_deeply($all,
	[{'A' => '', 'B' => '', 'C' => '', 'SITE' => '<not found>'},
		...
		{'A' => '', 'B' => 'foobar', 'C' => 'v4', 'SITE' => '<not found>'}],
	"LI05 - field_add_link with filename and options value_if_not_found + value_if_ambiguous"
);

$csv = Text::AutoCSV->new(in_file => "t/${ww}l01a.csv", croak_if_error => 0,
	search_ignore_ambiguous => 0)
	->field_add_link('T', 'A->B->SITE', "t/${ww}l01b.csv", {ignore_ambiguous => 1});
$all = [ $csv->get_hr_all() ];
is_deeply($all,
	[{'A' => '', 'B' => '', 'C' => '', 'T' => undef},
		{'A' => 'k1', 'B' => '', 'C' => 'v', 'T' => 'ici'},
...
$csv = Text::AutoCSV->new(in_file => "t/${ww}l01a.csv", croak_if_error => 0)
	->field_add_link('T', 'A->B->SITE', "t/${ww}l01b.csv",
			{value_if_not_found => '<not found>', value_if_found => '<found>',
			 ignore_ambiguous => 1}
);
$all = [ $csv->get_hr_all() ];
is_deeply($all,
...
my $csv = Text::AutoCSV->new(in_file => "t/${ww}l01a.csv", out_file => $tmpf)
	->links('1:', 'A->B', "t/${ww}l01b.csv");
my $all = [ $csv->get_hr_all() ];
is_deeply($all,
	[{'1:B' => undef, '1:SITE' => undef, 'A' => '', 'B' => '', 'C' => ''},
		{'1:B' => 'k1', '1:SITE' => 'ici', 'A' => 'k1', 'B' => '', 'C' => 'v'},
		{'1:B' => undef, '1:SITE' => undef, 'A' => '', 'B' => '', 'C' => ''},
		{'1:B' => 'k2', '1:SITE' => 'ici', 'A' => 'k2', 'B' => 'foo', 'C' => 'v2'},
		{'1:B' => 'k3', '1:SITE' => 'labas', 'A' => 'k3', 'B' => 'bar', 'C' => 'v3'},
		{'1:B' => undef, '1:SITE' => undef, 'A' => '', 'B' => 'foobar', 'C' => 'v4'}],
	"JO01 - check links (1)");
$csv->write();
$all = [ Text::AutoCSV->new(in_file => $tmpf)->get_hr_all() ];
is_deeply($all,
	[{'1B' => '', '1SITE' => '', 'A' => '', 'B' => '', 'C' => ''},
		{'1B' => 'k1', '1SITE' => 'ici', 'A' => 'k1', 'B' => '', 'C' => 'v'},
		{'1B' => '', '1SITE' => '', 'A' => '', 'B' => '', 'C' => ''},
		{'1B' => 'k2', '1SITE' => 'ici', 'A' => 'k2', 'B' => 'foo', 'C' => 'v2'},
		{'1B' => 'k3', '1SITE' => 'labas', 'A' => 'k3', 'B' => 'bar', 'C' => 'v3'},
		{'1B' => '', '1SITE' => '', 'A' => '', 'B' => 'foobar', 'C' => 'v4'}],
...
$all = [ $csv->get_hr_all() ];
is_deeply($all,
	[{'A' => '', 'B' => '', 'B_2' => undef, 'C' => '', 'SITE' => undef},
		{'A' => 'k1', 'B' => '', 'B_2' => 'k1', 'C' => 'v', 'SITE' => 'ici'},
		{'A' => '', 'B' => '', 'B_2' => undef, 'C' => '', 'SITE' => undef},
		{'A' => 'k2', 'B' => 'foo', 'B_2' => 'k2', 'C' => 'v2', 'SITE' => 'ici'},
		{'A' => 'k3', 'B' => 'bar', 'B_2' => 'k3', 'C' => 'v3', 'SITE' => 'labas'},
		{'A' => '', 'B' => 'foobar', 'B_2' => undef, 'C' => 'v4', 'SITE' => undef}],
...
{
note("");
note("[MU]ltiple - combination of field_add_copy(), field_add_computed() and field_add_link()");

my $csv = Text::AutoCSV->new(in_file => "t/${ww}l01a.csv", croak_if_error => 0, walker_hr => \&f,
	quiet => 1, search_ignore_ambiguous => 0, no_undef => 1)
	->field_add_link('S', 'A->B->SITE', "t/${ww}l01b.csv")
	->field_add_link('T', 'A->B->SITE', "t/${ww}l01b.csv", {ignore_ambiguous => 1})
	->field_add_link('U', 'A->B->SITE', "t/${ww}l01b.csv", {value_if_ambiguous => '<ambiguous>'})
	->field_add_link('V', 'A->B->SITE', "t/${ww}l01b.csv", {value_if_not_found => '<not found>'})
	->field_add_link('W', 'A->ALPHA->S', "t/${ww}l01c.csv", {ignore_ambiguous => 1})
	->field_add_copy('Y1', 'B')
	->field_add_copy('Y2', 'W')
	->field_add_copy('Y3', 'W', \&t)
	->field_add_link('Y4', 'A->ALPHA->S', "t/${ww}l01c.csv",
					{value_if_not_found => '314', value_if_ambiguous => '315'})
	->field_add_computed('Y5', \&c)
	->read();
my @recs;
sub f { push @recs, $_[0] };
sub t { s/^.*$/<<\U$&>>/; $_; }
sub c { return uc($_[1]->{A}) . lc($_[1]->{'Y3'}) . '[' . uc($_[1]->{'Y4'}) . ']'; }
is_deeply([ @recs ],
	[{'A' => '', 'B' => '', 'C' => '', 'S' => '', 'T' => '', 'U' => '',
		'V' => '<not found>', 'W' => '', 'Y1' => '', 'Y2' => '', 'Y3' => '<<>>', 'Y4' => '314',
		'Y5' => '<<>>[314]'},
		{'A' => 'k1', 'B' => '', 'C' => 'v', 'S' => 'ici', 'T' => 'ici', 'U' => 'ici',
		'V' => 'ici', 'W' => '(ici)', 'Y1' => '', 'Y2' => '(ici)', 'Y3' => '<<(ICI)>>',
		'Y4' => '315', 'Y5' => 'K1<<(ici)>>[315]'},
		{'A' => '', 'B' => '', 'C' => '', 'S' => '', 'T' => '', 'U' => '',
		'V' => '<not found>', 'W' => '', 'Y1' => '', 'Y2' => '', 'Y3' => '<<>>', 'Y4' => '314',
		'Y5' => '<<>>[314]'},
		{'A' => 'k2', 'B' => 'foo', 'C' => 'v2', 'S' => 'ici', 'T' => 'ici', 'U' => 'ici',
		'V' => 'ici', 'W' => '(encore)', 'Y1' => 'foo', 'Y2' => '(encore)', 'Y3' => '<<(ENCORE)>>',
		'Y4' => '(encore)', 'Y5' => 'K2<<(encore)>>[(ENCORE)]'},
		{'A' => 'k3', 'B' => 'bar', 'C' => 'v3', 'S' => '', 'T' => 'labas', 'U' => '<ambiguous>',
		'V' => '', 'W' => '(labas)', 'Y1' => 'bar', 'Y2' => '(labas)', 'Y3' => '<<(LABAS)>>',
		'Y4' => '(labas)', 'Y5' => 'K3<<(labas)>>[(LABAS)]'},
		{'A' => '', 'B' => 'foobar', 'C' => 'v4', 'S' => '', 'T' => '', 'U' => '',
		'V' => '<not found>', 'W' => '', 'Y1' => 'foobar', 'Y2' => '', 'Y3' => '<<>>',
		'Y4' => '314', 'Y5' => '<<>>[314]'} ],
	"MU01 - combination of field_add_computed(), field_add_copy() and field_add_link()"
);

	# 1- write and that's it (see below "2-")
my $fields_hr = {'A' => 'A', 'B' => 'B', 'C' => 'C', 'S' => 'S', 'T' => 'T', 'U' => 'U',
	'V' => 'V', 'W' => 'W', 'Y1' => 'Y1', 'Y2' => 'Y2', 'Y3' => 'Y3', 'Y4' => 'Y4',
	'Y5' => 'Y5'};
my $tmpf = &get_non_existent_temp_file_name();
$csv->set_out_file($tmpf)->write();
my $csvcopy = Text::AutoCSV->new(in_file => $tmpf, croak_if_error => 0, fields_hr => $fields_hr);
my $all = [ $csvcopy->get_hr_all() ];
is_deeply($all,
	[{'A' => '', 'B' => '', 'C' => '', 'S' => '', 'T' => '', 'U' => '',
		'V' => '<not found>', 'W' => '', 'Y1' => '', 'Y2' => '', 'Y3' => '<<>>', 'Y4' => '314',
...
my $csvcopy2 = Text::AutoCSV->new(in_file => $tmpf, croak_if_error => 0, fields_hr => $fields_hr);
...
my $csv = Text::AutoCSV->new(in_file => "t/${ww}u1.csv", croak_if_error => 0);
my $all = [ $csv->get_hr_all() ];
is_deeply($all,
	[{'A' => '2', 'B' => '4'},
		{'A' => '7', 'B' => '49'},
...
my $tmpf = &get_non_existent_temp_file_name();
Text::AutoCSV->new(in_file => "t/${ww}u1.csv", croak_if_error => 0, write_filter_hr => \&wf,
	out_file => $tmpf)->write();
...
Text::AutoCSV->new(in_file => "t/${ww}u1.csv", croak_if_error => 0, out_filter => \&wf,
	read_post_update_hr => \&up, out_file => $tmpf)->write();
$csv = Text::AutoCSV->new(in_file => $tmpf);
$all = [ $csv->get_hr_all() ];
is_deeply($all,
	[{'A' => '2', 'B' => '4'},
...
Text::AutoCSV->new(in_file => "t/${ww}u1.csv", croak_if_error => 0, out_filter => \&wf2,
	read_post_update_hr => \&up, out_file => $tmpf)
	->field_add_copy('C', 'B', \&ccalc)
	->write();
$csv = Text::AutoCSV->new(in_file => $tmpf);
$all = [ $csv->get_hr_all() ];
is_deeply($all,
...
is($csv->get_max_in_mem_record_count(), 2, "UP05 - t/u1.csv: check record count in-memory");

unlink $tmpf;

my $c = 0;
$csv = Text::AutoCSV->new(in_file => "t/${ww}u1.csv", walker_hr => sub { $c++; $_[1]->{'my ev'}++; });
is($csv->get_max_in_mem_record_count(), 0, "UP06 - t/u1.csv: check in-memory record count");
$csv->read();
is($csv->get_max_in_mem_record_count(), 0,
	"UP07 - t/u1.csv: check in-memory record count after read()");
is($c, 13, "UP08 - t/u1.csv: check in-memory record count after read() (2)");
}
...
sub get_non_existent_temp_file_name {
	...
	if (-f $tmpf) {
		note("* WARNING *");
		note("Deleting file '$tmpf' before starting test. Strange this file already exists!");
		unlink $tmpf;
	}
