...
This document describes version 0.003 of Sah::Schema::array::num::monotonically_decreasing (from Perl distribution Sah-Schemas-Array), released on 2023-02-03.
...
prefiltered) value:
 ...
 # a sample invalid data
 $data = [3,2,2,1];
 my $res = $validator->($data); # => ["Elements not monotonically increasing (check element[2]) ",[3,2,2,1]]
...
To create a type constraint and type library from a schema:
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('$sch_name*', name=>'ArrayNumMonotonicallyDecreasing')
     );
 }
