...
# regexp of character
my $your_char = q{[\x8E\xA1-\xFE][\xA1-\xFE]|\x8F[\xA1-\xFE][\x00-\xFF]|[\x00-\xFF]};
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                                                2   3                                  4   5
                q<CORE::eval{local $Eeucjp::re_t=%s; local $Eeucjp::re_a=''; while($Eeucjp::re_t =~ %s){%s local $^W=0; local $Eeucjp::re_r=%s; %s$Eeucjp::re_t="$Eeucjp::re_a${1}$Eeucjp::re_r$'"; pos($Eeucjp::re_t)=length "$Eeucjp::re_a${1}$Eeucjp::re_r"; $Eeucjp::re_a=substr($Eeucjp::re_t,0,pos($Eeucjp::re_t)); } return $Eeucjp::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Eeucjp::re_r=CORE::eval $Eeucjp::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Eeucjp::re_t=%s; while($Eeucjp::re_t =~ %s){%s local $^W=0; local $Eeucjp::re_r=%s; %s$Eeucjp::re_t="$`$Eeucjp::re_r$'"; pos($Eeucjp::re_t)=length "$`$Eeucjp::re_r"; } return $Eeucjp::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Eeucjp::re_r=%s; %s"%s$Eeucjp::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Eeucjp::re_n=0; local $Eeucjp::re_a=''; while(%s =~ %s){%s local $^W=0; local $Eeucjp::re_r=%s; %s%s="$Eeucjp::re_a${1}$Eeucjp::re_r$'"; pos(%s)=length "$Eeucjp::re_a${1}$Eeucjp::re_r"; $Eeucjp::re_a=substr(%s,0,pos(%s)); $Eeucjp::re_n++} return %s$Eeucjp::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Eeucjp::re_n=0; while(%s =~ %s){%s local $^W=0; local $Eeucjp::re_r=%s; %s%s="$`$Eeucjp::re_r$'"; pos(%s)=length "$`$Eeucjp::re_r"; $Eeucjp::re_n++} return %s$Eeucjp::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Eeucjp::re_r=%s; %s%s="%s$Eeucjp::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Eeucjp::re_r=%s; %s%s="%s$Eeucjp::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Eeucjp::re_r=CORE::eval $Eeucjp::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
