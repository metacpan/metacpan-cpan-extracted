package OWL::DirectSemantics::Element::Datatype;

BEGIN {
	$OWL::DirectSemantics::Element::Datatype::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::Datatype::VERSION   = '0.001';
};

use constant MAPPING_CODE => 'DR';
...
OWL::DirectSemantics::Element::Datatype - represents an OWL Datatype

=head1 DESCRIPTION

This class represents the Datatype element in OWL Direct Semantics.
