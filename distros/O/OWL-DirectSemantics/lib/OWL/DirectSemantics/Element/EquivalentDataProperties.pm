package OWL::DirectSemantics::Element::EquivalentDataProperties;
...
OWL::DirectSemantics::Element::EquivalentDataProperties - represents an OWL EquivalentDataProperties

=head1 DESCRIPTION

This class represents the EquivalentDataProperties element in OWL Direct Semantics.
