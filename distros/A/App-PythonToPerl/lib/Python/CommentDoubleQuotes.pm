...
#
# [[[ HEADER ]]]
# ABSTRACT: a single-line comment string wrapped in """double quotes"""
#use RPerl;
package Python::CommentDoubleQuotes;
use strict;
use warnings;
...
our hashref $properties = {
    component_type => my string $TYPED_component_type = 'Python::CommentDoubleQuotes',
