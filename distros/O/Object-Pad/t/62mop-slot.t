...
class Example {
   has $slot :mutator :param(initial_slot) = undef;
}
...
ok( $slotmeta->has_attribute( "mutator" ), '$slotmeta has "mutator" attribute' );
is( $slotmeta->get_attribute_value( "mutator" ), "slot",
   'value of $slotmeta "mutator" attribute' );

is( $slotmeta->get_attribute_value( "param" ), "initial_slot",
   'value of $slotmeta "param" attribute' );
