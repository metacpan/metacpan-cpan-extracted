...
my $module = 'App::GUI::Harmonograph::Color';
eval "use $module";
is( not( $@), 1, 'could load the module');


warning_like {App::GUI::Harmonograph::Color->new()}                    {carped => qr/constructor of/},  "need argument to create object";
warning_like {App::GUI::Harmonograph::Color->new('weirdcolorname')}    {carped => qr/unknown color/},   "accept only known color names";
warning_like {App::GUI::Harmonograph::Color->new('CHIMNEY:red')}       {carped => qr/ not installed/},  "accept only known palletes";
warning_like {App::GUI::Harmonograph::Color->new('#23232')       }     {carped => qr/hex color definition/},  "hex definition too short";
warning_like {App::GUI::Harmonograph::Color->new('#232321f')     }     {carped => qr/hex color definition/},  "hex definition too long";
warning_like {App::GUI::Harmonograph::Color->new('#23232g')       }    {carped => qr/hex color definition/},    "hex definition has forbidden chars";
warning_like {App::GUI::Harmonograph::Color->new('#2322%E')       }    {carped => qr/hex color definition/},    "hex definition has forbidden chars";
warning_like {App::GUI::Harmonograph::Color->new(1,1)}                 {carped => qr/constructor of/},  "too few positional args";
warning_like {App::GUI::Harmonograph::Color->new(1,1,1,1,1)}           {carped => qr/constructor of/},  "too many positional args";
warning_like {App::GUI::Harmonograph::Color->new([1,1])}               {carped => qr/need exactly 3/},  "too few positional args in ref";
warning_like {App::GUI::Harmonograph::Color->new([1,1,1,1])}           {carped => qr/need exactly 3/},  "too many positional args in ref";
warning_like {App::GUI::Harmonograph::Color->new({ r=>1, g=>1})}       {carped => qr/constructor of/},  "too few named args in ref";
warning_like {App::GUI::Harmonograph::Color->new({r=>1,g=>1,b=>1,h=>1,})} {carped => qr/constructor of/},"too many name args in ref";
warning_like {App::GUI::Harmonograph::Color->new( r=>1)}               {carped => qr/constructor of/},  "too few named args";
warning_like {App::GUI::Harmonograph::Color->new(r=>1,g=>1,b=>1,h=>1,a=>1)} {carped => qr/constructor of/},  "too many name args";
warning_like {App::GUI::Harmonograph::Color->new(r=>1,g=>1,h=>1)}      {carped => qr/argument keys/},   "don't mix named args";
warning_like {App::GUI::Harmonograph::Color->new(r=>1,g=>1,t=>1)}      {carped => qr/argument keys/},   "don't invent named args";

my $red = App::GUI::Harmonograph::Color->new('red');
...
is( App::GUI::Harmonograph::Color->new(15,12,13)->string, '[ 15, 12, 13 ]', 'random color does stringify correctly');


$red = App::GUI::Harmonograph::Color->new('#FF0000');
...
$red = App::GUI::Harmonograph::Color->new(r => 255, g => 0, b => 0);
...
$red = App::GUI::Harmonograph::Color->new({Red => 255, Green => 0, Blue => 0 });
...
$red = App::GUI::Harmonograph::Color->new({h => 0, s => 100, l => 50 });
...
$red = App::GUI::Harmonograph::Color->new( Hue => 0, Sat => 100, Light => 50 );
...
my $c = App::GUI::Harmonograph::Color->new( 1,2,3 );
...
my $blue = App::GUI::Harmonograph::Color->new( 'blue' );
...
my $white = App::GUI::Harmonograph::Color->new('white');
my $black = App::GUI::Harmonograph::Color->new('black');
...
is( App::GUI::Harmonograph::Color->new(1,2,3)->add( 2,1,0)->name,     'gray1',   "adding positional args"); # = 3, 3, 3
...
@g = App::GUI::Harmonograph::Color->new(15,12,13)->complementary(3);
...
@g = App::GUI::Harmonograph::Color->new(15,12,13)->complementary(4, 12, 20);
...
@g = App::GUI::Harmonograph::Color->new(15,12,13)->complementary(4, 512, 520);
...
@g = App::GUI::Harmonograph::Color->new(15,12,13)->complementary(5, 10, 20);
