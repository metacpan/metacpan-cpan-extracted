...
$Map::Tube::Exception::InvalidStationId::VERSION = '3.13';
=head1 NAME
...
has status => (is => 'ro', default => sub { 103 });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Map::Tube::Exception::InvalidStationId
...
1; # End of Map::Tube::Exception::InvalidStationId
