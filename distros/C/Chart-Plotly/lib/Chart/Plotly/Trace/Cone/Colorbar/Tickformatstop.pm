package Chart::Plotly::Trace::Cone::Colorbar::Tickformatstop;
use Moose;
...
Chart::Plotly::Trace::Cone::Colorbar::Tickformatstop - This attribute is one of the possible options for the trace cone.
