...
$Bio::Roary::AccessoryClustering::VERSION = '3.11.3';
...
Bio::Roary::AccessoryClustering - Take an a clusters file from CD-hit and the fasta file and output a fasta file without full clusters
