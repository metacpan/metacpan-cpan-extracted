package Chart::Plotly::Trace::Contourcarpet::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Contourcarpet::Hoverlabel::Font - This attribute is one of the possible options for the trace contourcarpet.
