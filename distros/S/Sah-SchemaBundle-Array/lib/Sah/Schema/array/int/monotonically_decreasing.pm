...
This document describes version 0.004 of Sah::Schema::array::int::monotonically_decreasing (from Perl distribution Sah-SchemaBundle-Array), released on 2024-02-13.
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"array::int::monotonically_decreasing*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('array::int::monotonically_decreasing*', name=>'ArrayIntMonotonicallyDecreasing')
     );
 }
