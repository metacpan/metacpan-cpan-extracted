...
$Consul::Check::Script::VERSION = '0.024';
use Moo;
...
$Consul::Check::TTL::VERSION = '0.024';
use Moo;
use Types::Standard qw(Str);
use JSON::MaybeXS;
...
$Consul::Check::HTTP::VERSION = '0.024';
use Moo;
...
$Consul::Check::TCP::VERSION = '0.024';
use Moo;
use Types::Standard qw(Str);
use JSON::MaybeXS;
...
$Consul::Check::Docker::VERSION = '0.024';
use Moo;
use Types::Standard qw(Str);
use JSON::MaybeXS;
