package XML::MetaGenerator::Formula::Collector::Apache;

use strict;
use XML::MetaGenerator;

BEGIN  {
  $XML::MetaGenerator::Formula::Collector::Apache::VERSION = '0.03';
  @XML::MetaGenerator::Formula::Collector::Apache::ISA = qw();
}
