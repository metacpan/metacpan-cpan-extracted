...
use Chart::Plotly::Trace::Waterfall::Legendgrouptitle;
...
has legendgrouptitle => ( is  => "rw",
                          isa => "Maybe[HashRef]|Chart::Plotly::Trace::Waterfall::Legendgrouptitle", );
...
has measuresrc => ( is            => "rw",
                    isa           => "Str",
                    documentation => "Sets the source reference on Chart Studio Cloud for `measure`.",
);
