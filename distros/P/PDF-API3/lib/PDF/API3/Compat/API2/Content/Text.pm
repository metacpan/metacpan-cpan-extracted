...
#
#=======================================================================
package PDF::API3::Compat::API2::Content::Text;
...
BEGIN {
    ...
    use PDF::API3::Compat::API2::Content;

    @ISA = qw(PDF::API3::Compat::API2::Content);
...
=head1 $txt = PDF::API3::Compat::API2::Content::Text->new @parameters
