...
When a number is returned by Stripe, L<Net::API::Stripe> will return a L<Module::Generic::Number>, so one could call the method representing a number like this:
