...
our $DIST = 'Filename-Type-Archive'; # DIST
...
sub check_archive_filename {
    ...
    my @compressor_info;
    while (1) {
        my $res = Filename::Type::Compressed::check_compressed_filename(
...
This document describes version 0.033 of Filename::Type::Archive (from Perl distribution Filename-Type-Archive), released on 2024-12-20.
...
Please visit the project's homepage at L<https://metacpan.org/release/Filename-Type-Archive>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Filename-Type-Archive>.
...
Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=Filename-Type-Archive>
