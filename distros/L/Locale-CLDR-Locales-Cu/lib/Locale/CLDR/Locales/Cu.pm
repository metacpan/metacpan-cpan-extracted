...
has 'characters' => (
	...
	sub {
		...
		return {
			auxiliary => qr{(?^u:[‌‍︯ ⷶ ⷷ ꙴ ꙵ ꙶ ꙻ ⷫ ⷵ ⷮ ⷹ ꙷ ⷰ ⷲ ⷳ ꙸ ꙹ ꙺ ⷺ ⷻ ⷼ ⷽ ⷾ ⷿ ҈҉꙰꙱꙲ ҄ ︮ ꙯ ꙣ ꙃ ꙅ ꙇ ꙉ ⷸ ꙥ ꙧ ҥ ꙩꙫꙭꙮꚙꚛ ҁ ꚞ ꙡ џ ꙏ ꙑ ꙓ ꙕ ѥ ꚟ ꙙ ꙛ ѩ ꙝ ѭ ꙟ])},
			index => ['А', 'Б', 'В', 'Г', 'Д', 'Є', 'Ж', 'Ѕ', 'З', 'И', 'І', 'К', 'Л', 'М', 'Н', 'Ѻ', 'О', 'Ѡ', 'Ѿ', 'П', 'Р', 'С', 'Т', 'Ꙋ', 'Ф', 'Х', 'Ц', 'Ч', 'Ш', 'Щ', 'Ъ', 'Ы', 'Ь', 'Ѣ', 'Ю', 'Ꙗ', 'Ѧ', 'Ѫ', 'Ѯ', 'Ѱ', 'Ѳ', 'Ѵ'],
			main => qr{(?^u:[҇ ҃ ⷠ ⷡ ⷢ ⷣ ⷤ ⷥ ⷦ ⷧ ⷨ ⷩ ⷪ ⷬ ⷭ ⷯ ⷱ ⸯ ꙽ ꙿ ⷴ ҂ а б в г д е є ж ѕ з ꙁ и і ї й к л м н ѻ о ѡ ꙍ ѽ ѿ п р с т ꙋ у ф х ц ч ш щ ъ ы ь ѣ ю ꙗ ѧ ѫ ѯ ѱ ѳ ѵ ѷ])},
			punctuation => qr{(?^u:[꙾ , \- . \: ; _ – — ꙳ ‐ ! ? ( ) /])},
		};
	},
EOT
: sub {
		return { index => ['А', 'Б', 'В', 'Г', 'Д', 'Є', 'Ж', 'Ѕ', 'З', 'И', 'І', 'К', 'Л', 'М', 'Н', 'Ѻ', 'О', 'Ѡ', 'Ѿ', 'П', 'Р', 'С', 'Т', 'Ꙋ', 'Ф', 'Х', 'Ц', 'Ч', 'Ш', 'Щ', 'Ъ', 'Ы', 'Ь', 'Ѣ', 'Ю', 'Ꙗ', 'Ѧ', 'Ѫ', 'Ѯ', 'Ѱ', 'Ѳ', 'Ѵ'], };
},
);
