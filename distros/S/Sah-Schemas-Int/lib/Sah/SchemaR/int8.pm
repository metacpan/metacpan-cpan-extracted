...
our $rschema = [
  "int",
  [
    { max => 127, min => -128, summary => "8-bit signed integer" },
  ],
  ["int"],
];
...
This document describes version 0.06 of Sah::SchemaR::int8 (from Perl distribution Sah-Schemas-Int), released on 2016-07-22.
