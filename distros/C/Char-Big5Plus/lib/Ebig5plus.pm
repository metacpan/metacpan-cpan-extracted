...
sub import {
    ...
    *Char::ord           = \&Big5Plus::ord;
    *Char::ord_          = \&Big5Plus::ord_;
    *Char::reverse       = \&Big5Plus::reverse;
    *Char::getc          = \&Big5Plus::getc;
    *Char::length        = \&Big5Plus::length;
    *Char::substr        = \&Big5Plus::substr;
    *Char::index         = \&Big5Plus::index;
    *Char::rindex        = \&Big5Plus::rindex;
    *Char::eval          = \&Big5Plus::eval;
    *Char::escape        = \&Big5Plus::escape;
    *Char::escape_token  = \&Big5Plus::escape_token;
    *Char::escape_script = \&Big5Plus::escape_script;
}
...
${Ebig5plus::anchor} = qr{\G(?>[^\x81-\xFE]|[\x81-\xFE][\x00-\xFF])*?}oxms;
...
if (($] >= 5.010001) or
    ...
    # other encoding
        ...
        ${Ebig5plus::q_char_SADAHIRO_Tomoyuki_2002_01_17} = qr{.*?[$sbcs](?:[^$sbcs][^$sbcs])*?}oxms;
        #                                                     ******* octets not in multiple octet char (always char boundary)
        #                                                               **************** 2 octet chars
    }

    ${Ebig5plus::anchor_SADAHIRO_Tomoyuki_2002_01_17} =
    qr{\G(?(?=.{0,32766}\z)(?:[^\x81-\xFE]|[\x81-\xFE][\x00-\xFF])*?|(?(?=[$sbcs]+\z).*?|(?:${Ebig5plus::q_char_SADAHIRO_Tomoyuki_2002_01_17})))}oxms;
#   qr{
#      \G # (1), (2)
#        (? # (3)
#          (?=.{0,32766}\z) # (4)
...
# ${Ebig5plus::eS}          = qr{(?>[^\x81-\xFE\x09\x0A    \x0C\x0D\x20]|[\x81-\xFE][\x00-\xFF])};
# ${Ebig5plus::eS}          = qr{(?>[^\x81-\xFE\x09\x0A\x0B\x0C\x0D\x20]|[\x81-\xFE][\x00-\xFF])};
...
my $qq_substr  = qr{(?> Char::substr | Big5Plus::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
# subroutines of package Ebig5plus
    ...
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC])            (?>\s*) (\") ((?:$qq_char)+?)                (\") /oxgc) { $slash = 'm//'; return "Ebig5plus::$1(" . e_qq('',  $2,$4,$3) . ")"; }
    ...
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC])            (?>\s*) (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $slash = 'm//'; return "Ebig5plus::$1(" . e_q ('',  $2,$4,$3) . ")"; }
...
# subroutines of package Ebig5plus
        ...
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC])            (?>\s*) (\") ((?:$qq_char)+?)                (\") /oxgc) { $e_string .= "Ebig5plus::$1(" . e_qq('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        ...
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC])            (?>\s*) (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $e_string .= "Ebig5plus::$1(" . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                                                2   3                                  4   5
                q<CORE::eval{local $Ebig5plus::re_t=%s; local $Ebig5plus::re_a=''; while($Ebig5plus::re_t =~ %s){%s local $^W=0; local $Ebig5plus::re_r=%s; %s$Ebig5plus::re_t="$Ebig5plus::re_a${1}$Ebig5plus::re_r$'"; pos($Ebig5plus::re_t)=length "$Ebig5plus::re_a${1}$Ebig5plus::re_r"; $Ebig5plus::re_a=substr($Ebig5plus::re_t,0,pos($Ebig5plus::re_t)); } return $Ebig5plus::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Ebig5plus::re_r=CORE::eval $Ebig5plus::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Ebig5plus::re_t=%s; while($Ebig5plus::re_t =~ %s){%s local $^W=0; local $Ebig5plus::re_r=%s; %s$Ebig5plus::re_t="$`$Ebig5plus::re_r$'"; pos($Ebig5plus::re_t)=length "$`$Ebig5plus::re_r"; } return $Ebig5plus::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Ebig5plus::re_r=%s; %s"%s$Ebig5plus::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Ebig5plus::re_n=0; local $Ebig5plus::re_a=''; while(%s =~ %s){%s local $^W=0; local $Ebig5plus::re_r=%s; %s%s="$Ebig5plus::re_a${1}$Ebig5plus::re_r$'"; pos(%s)=length "$Ebig5plus::re_a${1}$Ebig5plus::re_r"; $Ebig5plus::re_a=substr(%s,0,pos(%s)); $Ebig5plus::re_n++} return %s$Ebig5plus::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Ebig5plus::re_n=0; while(%s =~ %s){%s local $^W=0; local $Ebig5plus::re_r=%s; %s%s="$`$Ebig5plus::re_r$'"; pos(%s)=length "$`$Ebig5plus::re_r"; $Ebig5plus::re_n++} return %s$Ebig5plus::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Ebig5plus::re_r=%s; %s%s="%s$Ebig5plus::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Ebig5plus::re_r=%s; %s%s="%s$Ebig5plus::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Ebig5plus::re_r=CORE::eval $Ebig5plus::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
