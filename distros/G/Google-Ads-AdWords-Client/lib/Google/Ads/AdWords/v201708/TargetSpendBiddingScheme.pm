package Google::Ads::AdWords::v201708::TargetSpendBiddingScheme;
use strict;
use warnings;
...
Google::Ads::AdWords::v201708::TargetSpendBiddingScheme

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TargetSpendBiddingScheme from the namespace https://adwords.google.com/api/adwords/cm/v201708.
