...
has 'currencies' => (
	...
	default		=> sub { {
		...
		'CNH' => {
			symbol => 'CNH',
			display_name => {
				'currency' => q(Renminbi chinês \(offshore\)),
		...
		'MMK' => {
			symbol => 'MMK',
			display_name => {
				'currency' => q(Quiat de Myanmar),
				'one' => q(Quiat de Myanmar),
				'other' => q(Quiat de Myanmar),
			},
		},
		'MNT' => {
			symbol => 'MNT',
