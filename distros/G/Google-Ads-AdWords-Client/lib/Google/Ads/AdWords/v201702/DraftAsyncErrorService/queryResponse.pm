...
package Google::Ads::AdWords::v201702::DraftAsyncErrorService::queryResponse;
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::DraftAsyncErrorService::queryResponse->new($data);
