...
$ctcmd_current_version::CtCmd = '1.18';
$ClearCase::CtCmd::VERSION = '1.18';
...
ClearCase::CtCmd - Perl extension for DevOps Code ClearCase

=head1 PLATFORMS/VERSIONS

See INSTALL for a list of supported platforms and DevOps Code ClearCase versions.
