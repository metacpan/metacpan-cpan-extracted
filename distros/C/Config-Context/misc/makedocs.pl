...
my %HTML = (
    'Config-Context.html'               => 'lib/Config/Context.pm',
    'Config-Context-ConfigGeneral.html' => 'lib/Config/Context/ConfigGeneral.pm',
    'Config-Context-ConfigScoped.html'  => 'lib/Config/Context/ConfigScoped.pm',
    'Config-Context-XMLSimple.html'     => 'lib/Config/Context/XMLSimple.pm',
);

my %TEXT = (
    'README'     => 'lib/Config/Context.pm',
);
