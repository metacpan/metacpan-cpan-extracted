package Chart::Plotly::Trace::Surface::Contours;
use Moose;
...
use Chart::Plotly::Trace::Surface::Contours::X;
...
has x => ( is  => "rw",
           isa => "Maybe[HashRef]|Chart::Plotly::Trace::Surface::Contours::X", );

has y => ( is  => "rw",
           isa => "Maybe[HashRef]|Chart::Plotly::Trace::Surface::Contours::Y", );

has z => ( is  => "rw",
           isa => "Maybe[HashRef]|Chart::Plotly::Trace::Surface::Contours::Z", );
...
Chart::Plotly::Trace::Surface::Contours - This attribute is one of the possible options for the trace surface.
