package Google::Ads::AdWords::v201802::CertificateMissingConstraint;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201802::PolicyTopicConstraint);
# Variety: sequence
...
Google::Ads::AdWords::v201802::CertificateMissingConstraint

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CertificateMissingConstraint from the namespace https://adwords.google.com/api/adwords/cm/v201802.
