package WWW::Google::AutoSuggest::Obj;
use strict;
use warnings;
use utf8;
...
sub attr {
    ...
    for my $attr ( @{ ref $attrs eq 'ARRAY' ? $attrs : [$attrs] } ) {
        ...
        warn "-- Attribute $attr in $class\n$code\n\n"
            if $ENV{AUTOSUGGEST_OBJ_DEBUG};
        die "WWW::Google::AutoSuggest::Obj error: $@" unless eval "$code;1";
    }
}
...
WWW::Google::AutoSuggest::Obj - Minimal base class for WWW::Google::AutoSuggest
...
=head1 SYNOPSIS
  ...
  package Tiger;
  use WWW::Google::AutoSuggest::Obj 'Cat';

  has friend  => sub { Cat->new };
  has stripes => 42;

  package main;
  use WWW::Google::AutoSuggest::Obj -strict;
...
L<WWW::Google::AutoSuggest::Obj> is a simple base class for L<WWW::Google::AutoSuggest>, a fork of  L<Mojo::Base>.

  # Automatically enables "strict", "warnings", "utf8" and Perl 5.10 features
  use WWW::Google::AutoSuggest::Obj -strict;
  use WWW::Google::AutoSuggest::Obj -base;
  use WWW::Google::AutoSuggest::Obj 'SomeBaseClass';
...
All three forms save a lot of typing.
  ...
  use feature ':5.10';
  use IO::Handle ();
  use WWW::Google::AutoSuggest::Obj;
  push @ISA, 'WWW::Google::AutoSuggest::Obj';
  sub has { WWW::Google::AutoSuggest::Obj::attr(__PACKAGE__, @_) }
...
L<WWW::Google::AutoSuggest::Obj> implements the following functions like L<Mojo::Base>, which can be imported with
...
L<WWW::Google::AutoSuggest::Obj> implements the following methods.
...
You can set the C<AUTOSUGGEST_OBJ_DEBUG> environment variable to get some advanced
diagnostics information printed to C<STDERR>.

  AUTOSUGGEST_OBJ_DEBUG=1

=head1 SEE ALSO

L<WWW::Google::AutoSuggest>, L<Mojo::Base>.
