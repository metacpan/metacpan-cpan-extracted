...
(This example is included as L<F<examples/synopsis.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/synopsis.pl> in the distribution.)


=head1 VERSION

This document describes JSON::Create version 0.30,
corresponding to L<git commit bab30b64e7903fd89cb46e60815dfd18971da1af|https://github.com/benkasminbullock/json-create/commit/bab30b64e7903fd89cb46e60815dfd18971da1af> at Mon Jan 4 08:53:12 2021 +0900.
...
(This example is included as L<F<examples/hash.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/hash.pl> in the distribution.)
...
(This example is included as L<F<examples/nested-hash.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/nested-hash.pl> in the distribution.)
...
(This example is included as L<F<examples/array.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/array.pl> in the distribution.)
...
(This example is included as L<F<examples/nested-array.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/nested-array.pl> in the distribution.)
...
(This example is included as L<F<examples/nested.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/nested.pl> in the distribution.)
...
(This example is included as L<F<examples/weirdstring.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/weirdstring.pl> in the distribution.)
...
(This example is included as L<F<examples/strict-non-finite.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/strict-non-finite.pl> in the distribution.)
...
(This example is included as L<F<examples/undef.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/undef.pl> in the distribution.)
...
(This example is included as L<F<examples/json-parse-bool.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/json-parse-bool.pl> in the distribution.)
...
(This example is included as L<F<examples/fatal-errors.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/fatal-errors.pl> in the distribution.)
...
(This example is included as L<F<examples/boolean.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/boolean.pl> in the distribution.)
...
(This example is included as L<F<examples/cmp.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/cmp.pl> in the distribution.)
...
(This example is included as L<F<examples/escape-slash.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/escape-slash.pl> in the distribution.)
...
(This example is included as L<F<examples/indent.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/indent.pl> in the distribution.)
...
(This example is included as L<F<examples/indent-format.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/indent-format.pl> in the distribution.)
...
(This example is included as L<F<examples/js-safe.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/js-safe.pl> in the distribution.)
...
(This example is included as L<F<examples/non-finite-handler.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/non-finite-handler.pl> in the distribution.)
...
(This example is included as L<F<examples/zilog.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/zilog.pl> in the distribution.)
...
(This example is included as L<F<examples/too-many-values.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/too-many-values.pl> in the distribution.)
...
(This example is included as L<F<examples/closure.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/closure.pl> in the distribution.)
...
(This example is included as L<F<examples/exception.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/exception.pl> in the distribution.)
...
(This example is included as L<F<examples/obj-handler.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/obj-handler.pl> in the distribution.)
...
(This example is included as L<F<examples/try-harder.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/try-harder.pl> in the distribution.)
...
(This example is included as L<F<examples/set-fformat.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/set-fformat.pl> in the distribution.)
...
(This example is included as L<F<examples/sort.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/sort.pl> in the distribution.)
...
(This example is included as L<F<examples/type-handler.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/type-handler.pl> in the distribution.)
...
(This example is included as L<F<examples/type-handler-scalar.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/type-handler-scalar.pl> in the distribution.)
...
(This example is included as L<F<examples/escape-all.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/escape-all.pl> in the distribution.)
...
(This example is included as L<F<examples/escape-all-no-utf8.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/escape-all-no-utf8.pl> in the distribution.)
...
(This example is included as L<F<examples/valid-chars.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/valid-chars.pl> in the distribution.)
...
(This example is included as L<F<examples/json-unicode.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/json-unicode.pl> in the distribution.)
...
(This example is included as L<F<examples/json-unicode-gzip-bytes.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/json-unicode-gzip-bytes.pl> in the distribution.)
...
(This example is included as L<F<examples/user-bad-utf8.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.30/examples/user-bad-utf8.pl> in the distribution.)
