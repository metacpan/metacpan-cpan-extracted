...
=item C<Muldis::Rosetta::Engine::[SQLite|Postgres|Oracle|\w+]>
...
L<Bricolage|http://www.bricolage.cc/>, L<RT|http://bestpractical.com/rt/>.
...
L<DB::Ent>, L<DBIx::Romani>, L<DBIx::DBSchema>, L<TripleStore>,
...
L<Data::Visitor>, L<DBIx::Simple::Procedure>, L<DBIx::Skinny>,
L<Data::Couplet>, L<SQL::Preproc>, L<DBIx::QueryByName>, L<Data::Schema>,
L<Devel::Ladybug>, L<Class::AutoDB>.
