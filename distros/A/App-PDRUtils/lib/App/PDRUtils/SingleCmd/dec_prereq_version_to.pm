...
App::PDRUtils::SingleCmd::dec_prereq_version_to - Decrease prereq version to a specified version

=head1 VERSION

This document describes version 0.121 of App::PDRUtils::SingleCmd::dec_prereq_version_to (from Perl distribution App-PDRUtils), released on 2019-07-25.
