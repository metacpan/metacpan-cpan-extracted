...
isa_ok($icontext, 'Data::Identifier::Interface::Userdata');
isa_ok($icontext, 'Data::Identifier::Interface::Subobjects');
isa_ok($icontext, 'Data::Identifier::Interface::Simple');
isa_ok($icontext, 'Data::Identifier::Interface::Known');
