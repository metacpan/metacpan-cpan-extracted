...
This document describes version 0.003 of Sah::Schema::array::num::sorted (from Perl distribution Sah-Schemas-Array), released on 2023-02-03.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("array::num::sorted*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("array::num::sorted", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("array::num::sorted", {return_type=>'str_errmsg+val'});
 ...
 # a sample invalid data
 $data = [1,undef];
 my $res = $validator->($data); # => ["Elements not numerically sorted (check element[1]) ",[1,undef]]
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("array::num::sorted*");
     $validator->(\@args);
     ...
 }
...
To create a type constraint and type library from a schema:
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('$sch_name*', name=>'ArrayNumSorted')
     );
 }

 use My::Types qw(ArrayNumSorted);
 ArrayNumSorted->assert_valid($data);
