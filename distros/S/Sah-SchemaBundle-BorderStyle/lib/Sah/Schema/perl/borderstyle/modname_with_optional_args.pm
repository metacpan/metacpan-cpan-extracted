...
This document describes version 0.003 of Sah::Schema::perl::borderstyle::modname_with_optional_args (from Perl distribution Sah-SchemaBundle-BorderStyle), released on 2024-02-25.
...
Used completion: L<perl_modname|Perinci::Sub::XCompletion::perl_modname>, L<HASH(0x55ebc5a491a8)|Perinci::Sub::XCompletion::HASH(0x55ebc5a491a8)>
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::borderstyle::modname_with_optional_args", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::borderstyle::modname_with_optional_args", {return_type=>'str_errmsg+val'});
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::borderstyle::modname_with_optional_args*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::borderstyle::modname_with_optional_args*', name=>'PerlBorderstyleModnameWithOptionalArgs')
     );
 }

 use My::Types qw(PerlBorderstyleModnameWithOptionalArgs);
 PerlBorderstyleModnameWithOptionalArgs->assert_valid($data);
