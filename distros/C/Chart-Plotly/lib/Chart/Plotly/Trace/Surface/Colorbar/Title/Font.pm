package Chart::Plotly::Trace::Surface::Colorbar::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Surface::Colorbar::Title::Font - This attribute is one of the possible options for the trace surface.
