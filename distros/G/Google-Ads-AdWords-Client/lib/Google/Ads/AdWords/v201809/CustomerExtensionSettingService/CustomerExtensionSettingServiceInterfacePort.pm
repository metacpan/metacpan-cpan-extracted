package Google::Ads::AdWords::v201809::CustomerExtensionSettingService::CustomerExtensionSettingServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201809::TypeMaps::CustomerExtensionSettingService
    if not Google::Ads::AdWords::v201809::TypeMaps::CustomerExtensionSettingService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201809/CustomerExtensionSettingService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201809::TypeMaps::CustomerExtensionSettingService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::CustomerExtensionSettingService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201809::CustomerExtensionSettingService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::CustomerExtensionSettingService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::CustomerExtensionSettingService::query )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201809/CustomerExtensionSettingService.
...
Returns a L<Google::Ads::AdWords::v201809::CustomerExtensionSettingService::getResponse|Google::Ads::AdWords::v201809::CustomerExtensionSettingService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::CustomerExtensionSettingService::mutateResponse|Google::Ads::AdWords::v201809::CustomerExtensionSettingService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::CustomerExtensionSettingService::queryResponse|Google::Ads::AdWords::v201809::CustomerExtensionSettingService::queryResponse> object.
