...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::MachineImage Google::Cloud::Compute::V1::Compute::MachineImageList Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::Policy Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::MachineImagesClient->new( credentials => 'dummy' );
