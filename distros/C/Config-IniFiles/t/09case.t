...
# TEST
is_deeply( [ $ini->GroupMembers("GrOuP") ],
...
# TEST
is(
    scalar( $ini->val( 'test2', 'FOUR' ) ),
    'value4', "Case insensitivity in parameters",
);
...
is(
    scalar( $ini->val( 'TEST2', 'four' ) ),
    'value4', "Case insensitivity in sections",
);

# TEST
is(
    scalar( $ini->val( 'mixedcasesect', 'mixedcaseparam' ) ),
    'MixedCaseVal', "Mixed case val.",
);
