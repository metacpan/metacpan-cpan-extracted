...
The L<POSIX::1003|POSIX::1003> suite provides access to b<many> POSIX functions. The
...
B<Start looking> in L<POSIX::Overview|POSIX::Overview>, to discover which module
...
=item L<POSIX::1003::Socket|POSIX::1003::Socket>
...
=head2 POSIX::1003 compared to POSIX.pm
