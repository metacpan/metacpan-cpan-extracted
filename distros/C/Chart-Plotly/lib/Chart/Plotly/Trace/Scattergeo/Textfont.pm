package Chart::Plotly::Trace::Scattergeo::Textfont;
use Moose;
...
Chart::Plotly::Trace::Scattergeo::Textfont - This attribute is one of the possible options for the trace scattergeo.
