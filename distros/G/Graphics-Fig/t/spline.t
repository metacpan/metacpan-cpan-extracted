...
#
# Test 2: spline given three points
#
eval {
...
#
# Test 3: superimposed spline subtypes
#
eval {
    my $fig = Graphics::Fig->new();
...
#
# Test 4: superimposed open x-splines with different shape factors
#
eval {
    my $fig = Graphics::Fig->new();
    my $points = [[ 0, 1 ], [ 1, 1 ], [ 2, 2 ], [ 3, 1 ]];
...
#
# Test 5: closed x-spline with per-point shape factors
#
eval {
    my $fig = Graphics::Fig->new();
    ...
    $fig->save("${dir}/spline5.fig");
    &FigCmp::figCmp("${dir}/spline5.fig", "t/spline5.fig") || die;
};
ok($@ eq "", "test5");
