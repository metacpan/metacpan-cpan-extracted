...
package Google::Ads::AdWords::v201705::DataService::getCriterionBidLandscape;
use strict;
use warnings;
...
getCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201705.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::DataService::getCriterionBidLandscape->new($data);
