...
#
package AsposeThreeDCloud::Object::ObjSaveOption;
...
__PACKAGE__->method_documentation({
    ...
    'serialize_w' => {
    	datatype => 'boolean',
    	base_name => 'SerializeW',
    	description => 'Gets or sets whether serialize W component in model&#39;s vertex position.',
    	format => '',
    	read_only => '',
    		},
    'enable_materials' => {
    	datatype => 'boolean',
    	base_name => 'EnableMaterials',
    ...
    'flip_coordinate_system' => {
    	...
    	description => 'Gets or sets whether flip coordinate system of control points/normal during importing/exporting.',
    	format => '',
    	read_only => '',
    		},
});
