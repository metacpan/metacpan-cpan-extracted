...
mkdir $remote;
$ENV{GIT_DIR} = encode_utf8($remote);
...
my $hook = "$remote/hooks/post-receive";
...
TestBot->expect( 'dummy/#test 12test/03€ 05master '
        . $commit->id
        . ' 06Test U. Ser (06ser) 03a initial import * 14http://scm.host.org/€/master/?commit='
        . $commit->id
        . '' );
...
TestBot->expect( 'dummy/#test 12test/03€ 05master '
        . $commit->id
        . ' 06Test U. Ser (06ser) 10a 03b some changes * 14http://scm.host.org/€/master/?commit='
        . $commit->id
        . '' );
...
TestBot->expect( 'dummy/#test 12test/03€ 05master '
        . $c1->id
        . ' 06Test U. Ser (06ser) 04a a removed * 14http://scm.host.org/€/master/?commit='
        . $c1->id
        . '' );
TestBot->expect( 'dummy/#test 12test/03€ 05other '
        . $c2->id
        . ' 06Test U. Ser (06ser) 10b 03c a change in the other branch * 14http://scm.host.org/€/other/?commit='
        . $c2->id
        . '' );
TestBot->expect( 'dummy/#test 12test/03€ 05tags '
        . $c2->id
        . ' 031.0-beta tag \'1.0-beta\' created * 14http://scm.host.org/€/tags/?commit='
        . $c2->id
        . '' );
...
TestBot->expect( 'dummy/#test 12test/03€ 05other '
        . $c1->id
        . ' 06Test U. Ser (06ser) 03debian/README add README for release * 14http://scm.host.org/€/other/?commit='
        . $c1->id
        . '' );
TestBot->expect( 'dummy/#test 12test/03€ 05tags '
        . $c2->id
        ...
        . $c1->id
        . ') * 14http://scm.host.org/€/tags/?commit='
        . $c2->id
        . '' );
...
TestBot->expect( 'dummy/#test 12test/03€ 05hollow '
        . $commit->id
        . ' branch created * 14http://scm.host.org/€/hollow/?commit='
        . $commit->id
        . '' );
...
TestBot->expect( 'dummy/#test 12test/03€ 05other '
        . $commit->id
        . ' 06Test U. Ser (06ser) 03README update readme with an über cléver cómmít with cyrillics: привет * 14http://scm.host.org/€/other/?commit='
        . $commit->id
        . '' );
...
TestBot->expect( 'dummy/#test 12test/03€ 05allnew '
        . $commit->id
        . ' 06Test U. Ser (06ser) created empty branch allnew * 14http://scm.host.org/€/allnew/?commit='
        . $commit->id
        . '' );
...
TestBot->expect( 'dummy/#test 12test/03€ 05other '
        . $commit->id
        . ' 06Test U. Ser (06ser) 10debian/patches/ 03series 03some.patch A change in two files * 14http://scm.host.org/€/other/?commit='
        . $commit->id
        . '' );
