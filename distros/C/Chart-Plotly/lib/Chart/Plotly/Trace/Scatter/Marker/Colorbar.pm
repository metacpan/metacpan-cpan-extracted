package Chart::Plotly::Trace::Scatter::Marker::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Scatter::Marker::Colorbar::Titlefont;
...
has titlefont => ( is  => "rw",
                   isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatter::Marker::Colorbar::Titlefont", );
