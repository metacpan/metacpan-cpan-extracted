...
our $rschema = ["array",[{of=>["date::month_num",{},{}],summary=>"Array of month numbers","x.completion"=>["date_month_num"],"x.perl.coerce_rules"=>["From_str::comma_sep"]}],["array"]];
...
This document describes version 0.007 of Sah::SchemaR::date::month_nums (from Perl distribution Sah-Schemas-Date), released on 2019-11-28.
