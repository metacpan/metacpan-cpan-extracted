...
sub abstract {
    return 'Play John Horton Conway\'s Game of Life, hopefully faster than a naive implementation.';
}
...
sub meta_merge {
	...
	resources	=> {
		...
		web	=> 'https://github.com/trwyant/perl-Game-Life-Faster',
	    },
	},
	@extra,
    };
...
sub version_from {
    return 'lib/Game/Life/Faster.pm';
}
...
My::Module::Meta - Information needed to build Game::Life::Faster
...
This module centralizes information needed to build C<Game::Life::Faster>. It
is private to the C<Game::Life::Faster> package, and may be changed or
...
modules required to build the C<Game::Life::Faster> package, suitable for
...
the modules required to run the C<Game::Life::Faster>
...
Copyright (C) 2019-2022, 2026 by Thomas R. Wyant, III
