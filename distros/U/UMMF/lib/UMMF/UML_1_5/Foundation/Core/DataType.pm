...
package UMMF::UML_1_5::Foundation::Core::DataType;
...
=head2 C<type> : I<THIS> C<1> E<lt>----  C<> : UMMF::UML_1_5::Behavioral_Elements::Actions::Computation_Actions::ArgumentSpecification C<0..*>
...
=head2 C<__validate_type>
  ...
  UMMF::UML_1_5::Foundation::Core::DataType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::Foundation::Core::DataType|UMMF::UML_1_5::Foundation::Core::DataType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::Foundation::Core::DataType')  ;
}


=head2 C<__typecheck>

  UMMF::UML_1_5::Foundation::Core::DataType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::Foundation::Core::DataType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::Foundation::Core::DataType' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML_1_5::Foundation::Core::DataType|UMMF::UML_1_5::Foundation::Core::DataType>.
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::Foundation::Core::DataType::___create(@args);
