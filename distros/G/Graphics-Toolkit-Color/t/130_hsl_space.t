...
is( $space->family,                         'HSL', '"HSL" is also family name');
...
is( $space->pos_from_axis_name('hue'),          0,  '"hue" is the first axis');
is( $space->pos_from_axis_name('saturation'),   1,  '"saturation" is the second axis');
is( $space->pos_from_axis_name('lightness'),    2,  '"lightness" is the third axis');
is( $space->pos_from_axis_name('h'),            0,  '"h" is the first axis');
is( $space->pos_from_axis_name('s'),            1,  '"s" is the second axis');
is( $space->pos_from_axis_name('l'),            2,  '"l" is the third axis');
