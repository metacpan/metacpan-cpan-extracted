use utf8;
package Schema::RackTables::0_19_5::Result::VLANDescription;
...
Related object: L<Schema::RackTables::0_19_5::Result::VLANValidID>
...
Related object: L<Schema::RackTables::0_19_5::Result::VLANIPv4>

=cut

__PACKAGE__->has_many(
  "vlanipv4s",
  "Schema::RackTables::0_19_5::Result::VLANIPv4",
  {
...
Related object: L<Schema::RackTables::0_19_5::Result::VLANIPv6>

=cut

__PACKAGE__->has_many(
  "vlanipv6s",
  "Schema::RackTables::0_19_5::Result::VLANIPv6",
  {
    "foreign.domain_id" => "self.domain_id",
    "foreign.vlan_id"   => "self.vlan_id",
  },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Z+UPUqhmWF/FQb5AHuImtQ
