...
Released October 4, 2015 all changes by BTM

=over 

=item

generalized the rank.pl program format to accept any input in the 
w1<>w2<>rank format -- it does not look at any additional information 
if exists after the rank

=item 

modified the Testing programs for rank
...
Fixed rank.pl so that it checks for required ngram count in first line.
...
$Id: CHANGES.pod,v 1.37 2015/10/04 16:22:52 btmcinnes Exp $
