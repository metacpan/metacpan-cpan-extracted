...
Kubernetes::REST::ListToRequest - REMOVED -- superseded by Kubernetes::REST's unified v1 API, see Kubernetes::REST::Deprecated
...
C<Kubernetes::REST::ListToRequest> itself was never functional in the C<1.x> series -- it
...
C<cpanm Kubernetes::REST::ListToRequest> -- or a cpanfile / code that still references the
...
Kubernetes::REST::ListToRequest - REMOVED, superseded by Kubernetes::REST's unified v1 API
