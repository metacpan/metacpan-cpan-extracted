...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::RolloutPlan Google::Cloud::Compute::V1::Compute::RolloutPlansListResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::RolloutPlansClient->new( credentials => 'dummy' );
