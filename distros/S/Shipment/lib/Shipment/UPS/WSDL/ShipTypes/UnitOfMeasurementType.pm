package Shipment::UPS::WSDL::ShipTypes::UnitOfMeasurementType;
$Shipment::UPS::WSDL::ShipTypes::UnitOfMeasurementType::VERSION = '3.11';
use strict;
use warnings;
...
UnitOfMeasurementType from the namespace http://www.ups.com/XMLSchema/XOLTWS/IF/v1.0.
