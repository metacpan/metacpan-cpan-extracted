package Google::Ads::AdWords::v201607::EnhancedCpcBiddingScheme;
use strict;
use warnings;
...
EnhancedCpcBiddingScheme from the namespace https://adwords.google.com/api/adwords/cm/v201607.
