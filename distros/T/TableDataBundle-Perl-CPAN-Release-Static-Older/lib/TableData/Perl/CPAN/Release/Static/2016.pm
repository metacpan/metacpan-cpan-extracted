...
our %STATS = ("num_columns",9,"num_rows",19714); # STATS
...
TableDataRole::Perl::CPAN::Release::Static::2016 - CPAN releases for the year 2016

=head1 VERSION

This document describes version 20220218.2 of TableDataRole::Perl::CPAN::Release::Static::2016 (from Perl distribution TableDataBundle-Perl-CPAN-Release-Static-Older), released on 2022-02-18.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Perl::CPAN::Release::Static::2016;

 my $td = TableData::Perl::CPAN::Release::Static::2016->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Perl::CPAN::Release::Static::2016 --page

 # Get number of rows
 % tabledata --action count_rows Perl::CPAN::Release::Static::2016
