...
> InlineResponse20012 ddos_protection_event_list(cursor => $cursor, limit => $limit, service_id => $service_id, from => $from, to => $to, name => $name)
...
> InlineResponse20013 ddos_protection_event_rule_list(event_id => $event_id, cursor => $cursor, limit => $limit, include => $include)
