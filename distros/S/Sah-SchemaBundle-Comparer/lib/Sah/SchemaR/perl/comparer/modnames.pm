...
Sah::SchemaR::perl::comparer::modnames - Array of Perl Comparer::* module names without the prefix, e.g. ["Foo::bar", "Foo::baz"]

=head1 VERSION

This document describes version 0.002 of Sah::SchemaR::perl::comparer::modnames (from Perl distribution Sah-SchemaBundle-Comparer), released on 2024-03-07.
