...
the coredump to systemd-coredump within the container. I< Optional. Type boolean.  > 
...
C<ReadOnlyPaths>, see below. Defaults to off. I< Optional. Type enum. choice: 'full', 'no', 'strict', 'yes'.  > 
