...
Sah::Schema::perl::colortheme::modname_with_optional_args - Perl module in the ColorTheme::* namespace, without the namespace prefix, with optional args e.g. "Harmony::Analogous=central_h,120"
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::colortheme::modname_with_optional_args*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::colortheme::modname_with_optional_args*");
     $validator->(\@args);
     ...
 }
