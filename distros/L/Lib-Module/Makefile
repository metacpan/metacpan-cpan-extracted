# This Makefile is for the Lib::Module extension to perl.
#
...
#     ABSTRACT_FROM => q[Module.pm]
#     BUILD_REQUIRES => {  }
#     NAME => q[Lib::Module]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[Module.pm]
...
INST_LIBDIR      = $(INST_LIB)/Lib
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Lib
...
TO_INST_PM = Module.pm \
	ModuleSymbol.pm \
	SymbolRef.pm

PM_TO_BLIB = SymbolRef.pm \
	$(INST_LIB)/Lib/SymbolRef.pm \
	ModuleSymbol.pm \
	$(INST_LIB)/Lib/ModuleSymbol.pm \
	Module.pm \
	$(INST_LIB)/Lib/Module.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  Module.pm $(INST_MAN3DIR)/Lib::Module.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Lib-Module' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.7' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Perl library module utilities.' >> META_new.yml
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.7">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl library module utilities.</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  SymbolRef.pm $(INST_LIB)/Lib/SymbolRef.pm \
	  ModuleSymbol.pm $(INST_LIB)/Lib/ModuleSymbol.pm \
	  Module.pm $(INST_LIB)/Lib/Module.pm 
