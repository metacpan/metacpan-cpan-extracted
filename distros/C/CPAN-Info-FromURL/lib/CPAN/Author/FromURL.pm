...
1;
# ABSTRACT: Extract CPAN author from a URL
...
This document describes version 0.07 of CPAN::Author::FromURL (from Perl distribution CPAN-Info-FromURL), released on 2016-11-07.

=head1 FUNCTIONS


=head2 extract_cpan_author_from_url($url) -> str
