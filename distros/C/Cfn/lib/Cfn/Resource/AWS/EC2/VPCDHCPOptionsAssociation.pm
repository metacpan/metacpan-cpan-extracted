...
Cfn::Resource::AWS::EC2::VPCDHCPOptionsAssociation - Cfn resource for AWS::EC2::VPCDHCPOptionsAssociation

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::EC2::VPCDHCPOptionsAssociation.
