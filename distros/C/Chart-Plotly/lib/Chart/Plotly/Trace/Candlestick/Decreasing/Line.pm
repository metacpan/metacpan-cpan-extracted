package Chart::Plotly::Trace::Candlestick::Decreasing::Line;
use Moose;
...
Chart::Plotly::Trace::Candlestick::Decreasing::Line - This attribute is one of the possible options for the trace candlestick.
