...
## test 3 - 18, 19 - 34
my @expected0 = (	# type or section does not match
			# test 3, 4
q|0	= [];
|,
q|0	= [];
...
my @expected1 = (
			# test 35, 36
q|15	= [[40,'alt4.gmail-smtp-in.l.google.com',],
...
my @expected4 = (
			# test 83, 84
q|8	= [['ns1.google.com','dns-admin.google.com',2009061900,21600,3600,1209600,300,],
];
|,
			# test 85, 86
q|8	= [['ns1.google.com.','dns-admin.google.com.',2009061900,21600,3600,1209600,300,],
...
## test 3	get data pointer, binary
    my $rv = $dig->records($type,$section[$i]);
    my $exp = $expected->[$k];
    my $got = Dumper($rv);
    print "got: $got\nexp: $exp\nnot "
        unless $got eq $exp;
...
$dig = Net::DNS::Dig->new(PeerAddr => '127.2');
$dig->{SERVER} = '127.2';
$dig->{ELAPSED} = 65;
...
my @expected5 = (	# type or section does not match
			# test 103, 104
q|2	= [['&òø¥p         ',],
];
|,
			# test 105, 106
q|2	= [['2607:F2F8:A570:0:0:0:0:2',],
];
|,
			# test 107, 108
q|2	= [['&òø¥p         ',],
