...
my %server_to_resources = (
    github => {
        %bugtracker,
        homepage => 'https://github.com/tabulon/p5-Dist-Zilla-PluginBundle-Author-TABULO',
        repository => {
            type => 'git',
            # note that we use use .git/config in the local repo!
            url => 'https://github.com/tabulon/p5-Dist-Zilla-PluginBundle-Author-TABULO.git',
            web => 'https://github.com/tabulon/p5-Dist-Zilla-PluginBundle-Author-TABULO',
        },
    },
    gitmo => {
        %bugtracker,
