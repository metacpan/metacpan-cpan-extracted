package Chart::Plotly::Trace::Histogram::Ybins::ImpliedEdits;
use Moose;
...
Chart::Plotly::Trace::Histogram::Ybins::ImpliedEdits - This attribute is one of the possible options for the trace histogram.
