...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::NetworkEndpointGroup Google::Cloud::Compute::V1::Compute::NetworkEndpointGroupAggregatedList Google::Cloud::Compute::V1::Compute::NetworkEndpointGroupList Google::Cloud::Compute::V1::Compute::NetworkEndpointGroupsListNetworkEndpoints Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::NetworkEndpointGroupsClient->new( credentials => 'dummy' );
