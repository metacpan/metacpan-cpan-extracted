package Chart::Plotly::Trace::Violin::Meanline;
use Moose;
...
has width => ( is            => "rw",
               isa           => "Num",
               documentation => "Sets the mean line width.",
);
...
Chart::Plotly::Trace::Violin::Meanline - This attribute is one of the possible options for the trace violin.
