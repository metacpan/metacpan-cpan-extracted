...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Task/SDK/Perigrin.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Task/SDK
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Task/SDK
...
TO_INST_PM = lib/Task/SDK/Perigrin.pm

PM_TO_BLIB = lib/Task/SDK/Perigrin.pm \
	blib/lib/Task/SDK/Perigrin.pm
...
manifypods : pure_all  \
	lib/Task/SDK/Perigrin.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Task/SDK/Perigrin.pm $(INST_MAN3DIR)/Task::SDK::Perigrin.$(MAN3EXT) 
