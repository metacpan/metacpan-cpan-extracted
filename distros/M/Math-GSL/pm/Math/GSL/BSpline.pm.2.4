...
*swig_A_get = *Math::GSL::BSplinec::gsl_bspline_workspace_A_get;
*swig_A_set = *Math::GSL::BSplinec::gsl_bspline_workspace_A_set;
*swig_dB_get = *Math::GSL::BSplinec::gsl_bspline_workspace_dB_get;
*swig_dB_set = *Math::GSL::BSplinec::gsl_bspline_workspace_dB_set;
sub new {
    my $pkg = shift;
