...
eval { $v .= pmver('SDL::Color','any version') };
eval { $v .= pmver('SDL::Event','any version') };
eval { $v .= pmver('SDL::Video','any version') };
eval { $v .= pmver('SDLx::App','any version') };
eval { $v .= pmver('SDLx::Rect','any version') };
eval { $v .= pmver('SDLx::Sprite','any version') };
eval { $v .= pmver('SDLx::Surface','any version') };
eval { $v .= pmver('SDLx::Text','any version') };
