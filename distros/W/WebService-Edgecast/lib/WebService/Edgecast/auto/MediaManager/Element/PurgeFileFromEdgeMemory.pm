...
package WebService::Edgecast::auto::MediaManager::Element::PurgeFileFromEdgeMemory;
BEGIN {
  $WebService::Edgecast::auto::MediaManager::Element::PurgeFileFromEdgeMemory::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('PurgeFileFromEdgeMemory');
...
WebService::Edgecast::auto::MediaManager::Element::PurgeFileFromEdgeMemory
...
PurgeFileFromEdgeMemory from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::MediaManager::Element::PurgeFileFromEdgeMemory->new($data);
