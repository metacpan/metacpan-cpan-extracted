...
# Output: Developer::Dashboard::Pax::AppImage object.
sub new {
    my ($class, %args) = @_;
    return bless {
...
Developer::Dashboard::Pax::AppImage - application image builder and launcher packager

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::AppImage;

  my $images = Developer::Dashboard::Pax::AppImage->new(root => '.pax/apps');
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::AppImage -e 'Developer::Dashboard::Pax::AppImage->new(root => q(.pax/apps))'
