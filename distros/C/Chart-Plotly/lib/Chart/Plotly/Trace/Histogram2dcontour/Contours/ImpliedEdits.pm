package Chart::Plotly::Trace::Histogram2dcontour::Contours::ImpliedEdits;
use Moose;
...
Chart::Plotly::Trace::Histogram2dcontour::Contours::ImpliedEdits - This attribute is one of the possible options for the trace histogram2dcontour.
