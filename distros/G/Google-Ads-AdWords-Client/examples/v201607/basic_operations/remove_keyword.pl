...
sub remove_keyword {
  ...
  my $criterion =
    Google::Ads::AdWords::v201607::Criterion->new({id => $keyword_id});

  # Create ad group criterion.
  my $ad_group_criterion = Google::Ads::AdWords::v201607::AdGroupCriterion->new(
    {
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201607::AdGroupCriterionOperation->new(
    {
