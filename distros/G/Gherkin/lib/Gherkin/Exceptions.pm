...
$Gherkin::Exceptions::VERSION = '20.0.0';
use overload
    q{""}    => 'stringify',
    fallback => 1;
...
$Gherkin::Exceptions::Parser::VERSION = '20.0.0';
use base 'Gherkin::Exceptions';

# Composite exceptions
package Gherkin::Exceptions::CompositeParser;
$Gherkin::Exceptions::CompositeParser::VERSION = '20.0.0';
...
$Gherkin::Exceptions::SingleParser::VERSION = '20.0.0';
use base 'Gherkin::Exceptions::Parser';
...
$Gherkin::Exceptions::NoSuchLanguage::VERSION = '20.0.0';
...
$Gherkin::Exceptions::AstBuilder::VERSION = '20.0.0';
use base 'Gherkin::Exceptions::SingleParser';
...
$Gherkin::Exceptions::UnexpectedEOF::VERSION = '20.0.0';
use base 'Gherkin::Exceptions::SingleParser';
...
$Gherkin::Exceptions::UnexpectedToken::VERSION = '20.0.0';
use base 'Gherkin::Exceptions::SingleParser';
