# This file was auto-generated from iller.yaml by Dist::Iller on 2021-03-29 20:23:39 UTC.

on runtime => sub {
    requires 'Dist::Zilla' => '6.017';
    requires 'Dist::Zilla::Plugin::InlineFiles' => '6.017';
    requires 'Dist::Zilla::Role::FileGatherer' => '6.017';
    requires 'Dist::Zilla::Role::MintingProfile::ShareDir' => '6.017';
    requires 'Dist::Zilla::Role::TextTemplate' => '6.017';
