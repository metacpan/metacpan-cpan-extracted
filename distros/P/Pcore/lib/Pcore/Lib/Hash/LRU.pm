package Pcore::Lib::Hash::LRU::_CONST;
...
package Pcore::Lib::Hash::LRU;

use Pcore;

Pcore::Lib::Hash::LRU::_CONST->import(qw[:CONST]);
...
sub new ( $self, $max_size ) {
    ...
    tie $data->[$TIED_HASH]->%*, 'Pcore::Lib::Hash::LRU::_HASH', $data;
...
package Pcore::Lib::Hash::LRU::_HASH;
