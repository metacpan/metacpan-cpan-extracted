...
Dist-Zilla-Plugin-Software-Policies project a harassment-free experience for everyone,
...
Dist-Zilla-Plugin-Software-Policies project include:
...
This Code of Conduct applies within all Dist-Zilla-Plugin-Software-Policies project
spaces, and also applies when an individual is officially representing the
Dist-Zilla-Plugin-Software-Policies project in public spaces. Examples of representing
the Dist-Zilla-Plugin-Software-Policies project include using an official email address,
...
Mikko Koivunalho <mikkoi@cpan.org>. All complaints will be reviewed and investigated
promptly and fairly.
