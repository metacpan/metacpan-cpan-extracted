...
ok 10 - Got the cpan site [http://cpan.org] [/CPAN/ should match] # TODO Doesn't match now but should later
ok 11 - 'CPAN sites' link count == 2
not ok 12 - Got the python site [http://python.org] [/CPAN/ should match] # TODO Doesn't match now but should later
not ok 13 - 'CPAN sites' link count == 2
not ok 14 - Got the ruby site [http://ruby.org] [/CPAN/ should match] # TODO Doesn't match now but should later
not ok 15 - 'CPAN sites' link count == 2
EOS
