use utf8;
package Schema::RackTables::0_19_7::Result::RackSpace;
...
Related object: L<Schema::RackTables::0_19_7::Result::Rack>

=cut

__PACKAGE__->belongs_to(
  "rack",
  "Schema::RackTables::0_19_7::Result::Rack",
  { id => "rack_id" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QdkYfJvwWukHH+YhsgxplQ
