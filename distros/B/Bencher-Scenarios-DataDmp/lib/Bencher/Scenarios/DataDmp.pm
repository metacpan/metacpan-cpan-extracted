...
Bencher::Scenarios::DataDmp - Benchmark Data::Dmp against some other related modules

=head1 VERSION

This document describes version 0.002 of Bencher::Scenarios::DataDmp (from Perl distribution Bencher-Scenarios-DataDmp), released on 2017-01-25.
...
=item * L<Bencher::Scenario::DataDmp>
