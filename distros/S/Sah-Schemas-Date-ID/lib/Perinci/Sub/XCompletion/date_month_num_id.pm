package Perinci::Sub::XCompletion::date_month_num_id;
...
Perinci::Sub::XCompletion::date_month_num_id - Generate completion for date::month_num

=head1 VERSION

This document describes version 0.005 of Perinci::Sub::XCompletion::date_month_num_id (from Perl distribution Sah-Schemas-Date-ID), released on 2020-03-08.
