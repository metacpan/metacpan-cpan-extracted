...
1;
# ABSTRACT: Perl Sorter::* module name without the prefix (e.g. Foo::bar) with optional arguments (e.g. Foo::baz,qux,quux)
...
Sah::Schema::perl::sorter::modname_with_optional_args - Perl Sorter::* module name without the prefix (e.g. Foo::bar) with optional arguments (e.g. Foo::baz,qux,quux)

=head1 VERSION

This document describes version 0.002 of Sah::Schema::perl::sorter::modname_with_optional_args (from Perl distribution Sah-SchemaBundle-Sorter), released on 2024-03-07.
...
Used completion: L<perl_sorter_modname_with_optional_args|Perinci::Sub::XCompletion::perl_sorter_modname_with_optional_args>
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::sorter::modname_with_optional_args*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::sorter::modname_with_optional_args", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::sorter::modname_with_optional_args", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::sorter::modname_with_optional_args*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::sorter::modname_with_optional_args*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::sorter::modname_with_optional_args*', name=>'PerlSorterModnameWithOptionalArgs')
     );
 }

 use My::Types qw(PerlSorterModnameWithOptionalArgs);
 PerlSorterModnameWithOptionalArgs->assert_valid($data);
...
See also: C<perl::sorter::modname>.
