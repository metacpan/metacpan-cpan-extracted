...
/*****************************************************************************/
/*  MODULE NAME:  pc2iso.c                              MODULE TYPE:  (app)  */
/*****************************************************************************/
/*  MODULE IMPORTS:                                                          */
/*****************************************************************************/
...
/*
    ...
    from one of the "CP 850" PC character sets to the "ISO-Latin-1"
    ("ISO-8859-1") character set (and vice-versa) in a REVERSIBLE way
