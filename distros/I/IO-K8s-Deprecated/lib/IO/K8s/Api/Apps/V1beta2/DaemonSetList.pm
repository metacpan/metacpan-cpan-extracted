...
back in the C<1.00> Moose-to-Moo rewrite; C<IO::K8s::Api::Apps::V1beta2::DaemonSetList> itself was never a real
...
that C<cpanm IO::K8s::Api::Apps::V1beta2::DaemonSetList> -- or a cpanfile / code that still references the old
