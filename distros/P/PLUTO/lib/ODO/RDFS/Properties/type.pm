package ODO::RDFS::Properties::type;
...
sub new {
	...
	$self->propertyContainerName( 'ODO::RDFS::Properties::type::PropertiesContainer' );
	$self->properties(bless {}, 'ODO::RDFS::Properties::type::PropertiesContainer');
