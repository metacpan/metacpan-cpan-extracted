package Chart::Plotly::Trace::Scatterpolar::Textfont;
use Moose;
...
Chart::Plotly::Trace::Scatterpolar::Textfont - This attribute is one of the possible options for the trace scatterpolar.
