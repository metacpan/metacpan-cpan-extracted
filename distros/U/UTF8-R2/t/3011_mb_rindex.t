...
# 1
    ...
    sub { $_='あABう123あABう123あABう123'; my $r=mb::rindex($_,'Bう1');    $r == 16 },
    sub { $_='あABう123あABう123あABう123'; my $r=mb::rindex($_,'Bう1',14); $r == 9  },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
# 11
    ...
    sub { $_='あABう123あABう123あABう123'; my $r=mb::rindex($_,'か3Z');    $r == -1 },
    sub { $_='あABう123あABう123あABう123'; my $r=mb::rindex($_,'か3Z',14); $r == -1 },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
