...
# Program:  10-basic-dbug-on.t
#   Does a very basic fish trace with fish turned on.
...
BEGIN {
   ...
   unless (use_ok ( "Fred::Fish::DBUG", qw ( on ) )) {     # Test # 1
...
BEGIN {
   ...
   is2 ( $mod, "Fred::Fish::DBUG::ON", "Inherited from $mod");   # Test # 3

   ok2 (DBUG_ACTIVE(), "Fish is turned ON.");      # Test # 4
