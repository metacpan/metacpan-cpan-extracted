package Chart::Plotly::Trace::Densitymapbox::Colorbar::Title;
use Moose;
...
use Chart::Plotly::Trace::Densitymapbox::Colorbar::Title::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Densitymapbox::Colorbar::Title::Font", );
...
Chart::Plotly::Trace::Densitymapbox::Colorbar::Title - This attribute is one of the possible options for the trace densitymapbox.
