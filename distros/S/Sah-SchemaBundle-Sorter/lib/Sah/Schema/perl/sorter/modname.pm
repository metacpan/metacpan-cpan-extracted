...
Sah::Schema::perl::sorter::modname - Perl Sorter::* module name without the prefix, e.g. foo

=head1 VERSION

This document describes version 0.002 of Sah::Schema::perl::sorter::modname (from Perl distribution Sah-SchemaBundle-Sorter), released on 2024-03-07.
...
Used completion: L<perl_modname|Perinci::Sub::XCompletion::perl_modname>, L<HASH(0x558a63102e78)|Perinci::Sub::XCompletion::HASH(0x558a63102e78)>
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::sorter::modname*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::sorter::modname", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::sorter::modname", {return_type=>'str_errmsg+val'});
 ...
 # a sample invalid data
 $data = "baz qux";
 my $res = $validator->($data); # => ["Must match regex pattern \\A[A-Za-z_][A-Za-z_0-9]*(::[A-Za-z_0-9]+)*\\z","baz qux"]
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::sorter::modname*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::sorter::modname*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::sorter::modname*', name=>'PerlSorterModname')
     );
 }

 use My::Types qw(PerlSorterModname);
 PerlSorterModname->assert_valid($data);
