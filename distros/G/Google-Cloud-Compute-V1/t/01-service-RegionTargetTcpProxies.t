...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TargetTcpProxy Google::Cloud::Compute::V1::Compute::TargetTcpProxyList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::RegionTargetTcpProxiesClient->new( credentials => 'dummy' );
