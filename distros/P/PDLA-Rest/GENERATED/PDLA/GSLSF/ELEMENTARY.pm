...
#
package PDLA::GSLSF::ELEMENTARY;

@EXPORT_OK  = qw( PDLA::PP gsl_sf_multiply PDLA::PP gsl_sf_multiply_err );
...
use DynaLoader;
   ...
   bootstrap PDLA::GSLSF::ELEMENTARY ;
...
*gsl_sf_multiply = \&PDLA::gsl_sf_multiply;
...
*gsl_sf_multiply_err = \&PDLA::gsl_sf_multiply_err;
