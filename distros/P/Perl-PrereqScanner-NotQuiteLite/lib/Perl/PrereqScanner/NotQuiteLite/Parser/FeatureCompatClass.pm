package Perl::PrereqScanner::NotQuiteLite::Parser::FeatureCompatClass;
...
sub register { return {
  use => {
    'Feature::Compat::Class' => 'parse_feature_compat_class_args',
  },
}}

sub parse_feature_compat_class_args {
...
Perl::PrereqScanner::NotQuiteLite::Parser::FeatureCompatClass

=head1 DESCRIPTION

This parser is to deal with modules loaded by L<Feature::Compat::Class>.
...
This software is copyright (c) 2026 by Kenichi Ishigaki.
