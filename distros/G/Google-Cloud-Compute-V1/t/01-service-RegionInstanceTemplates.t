...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::InstanceTemplate Google::Cloud::Compute::V1::Compute::InstanceTemplateList Google::Cloud::Compute::V1::Compute::Operation )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::RegionInstanceTemplatesClient->new( credentials => 'dummy' );
