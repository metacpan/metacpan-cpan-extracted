package Finance::AMEX::Transaction::EPTRN 0.005;
...
=item L<Finance::AMEX::Transaction::EPTRN::Header>

Header Rows

 print $record->type; # HEADER

=item L<Finance::AMEX::Transaction::EPTRN::Summary>

Summary Rows

 print $record->type; # SUMMARY

=item L<Finance::AMEX::Transaction::EPTRN::Detail::ChargeSummary>

Summary of Charge (SOC) Detail Rows

 print $record->type; # SOC_DETAIL

=item L<Finance::AMEX::Transaction::EPTRN::Detail::RecordSummary>

Record of Charge (ROC) Detail Rows

 print $record->type; # ROC_DETAIL

=item L<Finance::AMEX::Transaction::EPTRN::Detail::Chargeback>

Chargeback Detail Rows

 print $record->type; # CHARGEBACK_DETAIL

=item L<Finance::AMEX::Transaction::EPTRN::Detail::Adjustment>

Adjustment Detail Rows

 print $record->type; # ADJUSTMENT_DETAIL

=item L<Finance::AMEX::Transaction::EPTRN::Detail::Other>

Other Fees and Revenues Detail Rows

 print $record->type; # OTHER_DETAIL

=item L<Finance::AMEX::Transaction::EPTRN::Trailer>

Trailer Rows

 print $record->type; # TRAILER

=item L<Finance::AMEX::Transaction::EPTRN::Unknown>
...
Returns one of the line types for the EPTRN format.
