package Google::Ads::AdWords::v201702::CustomerExtensionSettingReturnValue;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201702::ListReturnValue);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'value' => 'Google::Ads::AdWords::v201702::CustomerExtensionSetting',
        'partialFailureErrors' => 'Google::Ads::AdWords::v201702::ApiError',
    },
    {
...
CustomerExtensionSettingReturnValue from the namespace https://adwords.google.com/api/adwords/cm/v201702.
