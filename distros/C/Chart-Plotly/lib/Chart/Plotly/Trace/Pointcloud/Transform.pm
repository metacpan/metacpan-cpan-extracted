package Chart::Plotly::Trace::Pointcloud::Transform;
use Moose;
...
Chart::Plotly::Trace::Pointcloud::Transform - This attribute is one of the possible options for the trace pointcloud.
