...
$Games::Solitaire::Verify::App::CmdLine::Expand::VERSION = '0.1900';
use strict;
use warnings;
...
sub run
{
    ...
    my $solution =
        Games::Solitaire::Verify::Solution::ExpandMultiCardMoves->new(
        {
            input_fh       => $fh,
            variant        => "custom",
...
You can find documentation for this module with the perldoc command.
  ...
  perldoc Games::Solitaire::Verify::App::CmdLine::Expand
