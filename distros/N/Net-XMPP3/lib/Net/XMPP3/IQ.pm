...
package Net::XMPP3::IQ;

=head1 NAME

Net::XMPP3::IQ - XMPP Info/Query Module

=head1 SYNOPSIS

  Net::XMPP3::IQ is a companion to the Net::XMPP3 module. It
  provides the user a simple interface to set and retrieve all
  parts of an XMPP IQ.

=head1 DESCRIPTION

  Net::XMPP3::IQ differs from the other Net::XMPP3::* modules in that
  the XMLNS of the query is split out into a submodule under
  IQ.  For specifics on each module please view the documentation
  for the Net::XMPP3::Namespaces module.

  A Net::XMPP3::IQ object is passed to the callback function for the
...
=head2 Retrieval functions
  ...
  GetTo("jid")   Net::XMPP3::JID object for the person who is
  ...
  GetFrom("jid")    Net::XMPP3::JID object for the person who
  ...
  GetQuery() - returns a Net::XMPP3::Stanza object that contains the data
...
=head2 Creation functions
  ...
  NewChild(string) - creates a new Net::XMPP3::Stanza object with the
                     ...
                     documentation for Net::XMPP3::Stanza.
...
sub _iq { my $self = shift; return new Net::XMPP3::IQ(); }
...
##############################################################################
#
# Reply - returns a Net::XMPP3::IQ object with the proper fields
