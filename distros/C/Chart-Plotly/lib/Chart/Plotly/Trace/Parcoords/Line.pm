package Chart::Plotly::Trace::Parcoords::Line;
use Moose;
...
use Chart::Plotly::Trace::Parcoords::Line::Colorbar;
...
has colorbar => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Parcoords::Line::Colorbar", );
...
Chart::Plotly::Trace::Parcoords::Line - This attribute is one of the possible options for the trace parcoords.
