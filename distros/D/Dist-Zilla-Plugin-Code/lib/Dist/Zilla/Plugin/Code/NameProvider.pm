package Dist::Zilla::Plugin::Code::NameProvider;
...
Dist::Zilla::Plugin::Code::NameProvider - something that provides a name for the dist
...
This plugin implements the L<Dist::Zilla::Role::NameProvider> role.
...
L<Dist::Zilla>, L<Dist::Zilla::Role::NameProvider>
