...
=item $class-E<gt>B<build>($fields)
...
Get the information about the header line C<$name>.  Realization will
take place.
...
=item Error: attempt to set field on a delayed header.

Cast by C<setNoRealize()>
