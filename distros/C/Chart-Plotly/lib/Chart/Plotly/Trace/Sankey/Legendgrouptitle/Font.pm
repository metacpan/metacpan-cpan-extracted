package Chart::Plotly::Trace::Sankey::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Sankey::Legendgrouptitle::Font - This attribute is one of the possible options for the trace sankey.
