...
typedef struct {
	...
	double        Add;
	float         Dither;
	float         ErrorHistory     [FLAC__MAX_SUPPORTED_CHANNELS] [16];  /* 16th order Noise shaping */
	float         DitherHistory    [FLAC__MAX_SUPPORTED_CHANNELS] [16];
	int           LastRandomNumber [FLAC__MAX_SUPPORTED_CHANNELS];
