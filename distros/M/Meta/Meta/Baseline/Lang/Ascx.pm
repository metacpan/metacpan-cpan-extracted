...
package Meta::Baseline::Lang::Ascx;
...
Meta::Baseline::Lang::Ascx - doing public key stuff in the baseline.
...
=head1 SYNOPSIS
	...
	my($obje)=Meta::Baseline::Lang::Ascx->new();
	my($result)=$obje->myfile("data/myfile.txt");

=head1 DESCRIPTION

This package is the public key package of the baseline.
It currently does nothing and authorises .asc files to be added.
