package Google::Ads::AdWords::v201710::PolicyTopicConstraint;
use strict;
use warnings;
...
Google::Ads::AdWords::v201710::PolicyTopicConstraint

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PolicyTopicConstraint from the namespace https://adwords.google.com/api/adwords/cm/v201710.
