...
Sah::SchemaR::pathname::unix::not_exists - Unix path name, must not already exist on filesystem

=head1 VERSION

This document describes version 0.030 of Sah::SchemaR::pathname::unix::not_exists (from Perl distribution Sah-Schemas-Path), released on 2024-01-08.
