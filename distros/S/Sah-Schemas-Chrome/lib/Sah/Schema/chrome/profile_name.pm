...
Sah::Schema::chrome::profile_name - Chrome profile name

=head1 VERSION

This document describes version 0.003 of Sah::Schema::chrome::profile_name (from Perl distribution Sah-Schemas-Chrome), released on 2021-07-20.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("chrome::profile_name*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("chrome::profile_name*");
     $validator->(\@args);
     ...
 }
