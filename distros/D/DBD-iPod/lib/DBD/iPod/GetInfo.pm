package DBD::iPod::GetInfo;

# The %info hash was automatically generated by
# DBI::iPod::Metadata::write_getinfo_pm v.
...
$VERSION = "0.10";  # $Date: 2004/02/04 17:31:36 $
my $sql_driver = 'iPod';
my $sql_ver_fmt = '%02d.%02d.%04d';   # ODBC version string: ##.##.#####
my $sql_driver_ver = sprintf $sql_ver_fmt, split (/\./, $DBD::iPod::VERSION);
...
%info = (
     ...
     13 => 'localhost',                   # SQL_SERVER_NAME
     17 => 'iPod',                        # SQL_DBMS_NAME
