...
package Google::Ads::AdWords::v201705::TrafficEstimatorService::get;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201705::TrafficEstimatorSelector',
    },
    {
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::TrafficEstimatorService::get->new($data);

Constructor. The following data structure may be passed to new():

 {
   selector =>  $a_reference_to, # see Google::Ads::AdWords::v201705::TrafficEstimatorSelector
 },
