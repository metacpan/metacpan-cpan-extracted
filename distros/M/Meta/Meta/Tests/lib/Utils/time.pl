...
Meta::Utils::Output::print(Meta::Utils::Time::now_epoch()."\n");
...
time.pl - testing program for the Meta::Utils::Time.pm module.
...
This script tests the Meta::Utils::Time module.
...
Meta::Baseline::Test(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), Meta::Utils::Time(3), strict(3)
