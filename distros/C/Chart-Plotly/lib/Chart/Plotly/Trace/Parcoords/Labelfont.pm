package Chart::Plotly::Trace::Parcoords::Labelfont;
use Moose;
...
Chart::Plotly::Trace::Parcoords::Labelfont - This attribute is one of the possible options for the trace parcoords.
