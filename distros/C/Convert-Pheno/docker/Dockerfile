...
RUN rm -rf convert-pheno/.git convert-pheno/.github convert-pheno/.gitattributes convert-pheno/.gitignore

# Remove docs
RUN rm -rf convert-pheno/docs/ convert-pheno/mkdocs.yml
