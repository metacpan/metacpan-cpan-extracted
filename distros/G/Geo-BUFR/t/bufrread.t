...
`$perl ./bufrread.pl --data_only --noqc --width 10 --outfile t/outrea1 t/substituted.bufr -t t/bt`;
...
`$perl ./bufrread.pl --strict_checking 1 t/iozx.bufr -t t/bt > t/outrea2 2> t/warnrea2`;
...
`$perl ./bufrread.pl --strict_checking 2 t/iozx.bufr -t t/bt > t/outrea3 2> t/errrea3`;
...
`$perl ./bufrread.pl --strict_checking 1 t/iupd_bad.bufr -t t/bt > t/outrea4 2> t/warnrea4`;
...
$output = `$perl ./bufrread.pl t/change_refval.bufr -t t/bt`;
$expected = read_file('t/change_refval.txt');
is($output, $expected, 'testing bufrread.pl on message containing 203Y');

$output = `$perl ./bufrread.pl t/change_refval_compressed.bufr -t t/bt`;
...
$output = `$perl ./bufrread.pl t/signify_datawidth.bufr -t t/bt`;
...
$output = `$perl ./bufrread.pl t/signify_datawidth.bufr2 -t t/bt -all -v 1`;
...
`$perl ./bufrread.pl t/BUFRBUFR.bufr -t t/bt > t/outrea5 2> t/errrea5`;
...
`$perl ./bufrread.pl t/short_truncated_temp_synop.bufr  -t t/bt > t/outrea6 2> t/errrea6`;
...
`$perl ./bufrread.pl t/long_truncated_temp_synop.bufr  -t t/bt > t/outrea7 2> t/errrea7`;
...
`$perl ./bufrread.pl t/long_truncated_temp_synop_temp.bufr  -t t/bt > t/outrea8 2> t/errrea8`;
...
$output = `$perl ./bufrread.pl --nodata t/long_truncated_temp_synop_temp.bufr -t t/bt`;
...
`$perl ./bufrread.pl --ahl "ISXD99|ENMI|OKPR" --param t/param t/set_filter.bufr -t t/bt > t/outrea9 2> t/errrea10`;
...
$output = `$perl ./bufrread.pl --ahl "ISXD99|ENMI|OKPR" --nodata t/set_filter.bufr -t t/bt`;
