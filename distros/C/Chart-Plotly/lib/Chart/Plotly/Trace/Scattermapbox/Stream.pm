package Chart::Plotly::Trace::Scattermapbox::Stream;
use Moose;
...
Chart::Plotly::Trace::Scattermapbox::Stream - This attribute is one of the possible options for the trace scattermapbox.
