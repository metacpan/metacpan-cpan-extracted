...
sub new {
    ...
    $self->SUPER::new(
        ...
        calc_key => sub {
            ...
            my $dt_sunday = DateTime->new(year=>$1, month=>$2, day=>$3); $dt_sunday->subtract(days => $dt_sunday->day_of_week) unless $dt_sunday->day_of_week == 7;
...
our %STATS = ("num_columns",2,"num_rows",1476); # STATS
...
This document describes version 20231120.3 of TableData::Perl::CPAN::Release::Static::GroupedWeekly (from Perl distribution TableDataBundle-Perl-CPAN-Release), released on 2023-11-25.
