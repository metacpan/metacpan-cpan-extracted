...
Perl::Examples::Accessors::ClassInsideOut

=head1 VERSION

This document describes version 0.133 of Perl::Examples::Accessors::ClassInsideOut (from Perl distribution Perl-Examples-Accessors), released on 2024-05-06.
