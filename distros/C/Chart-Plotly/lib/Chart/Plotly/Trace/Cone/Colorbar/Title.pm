package Chart::Plotly::Trace::Cone::Colorbar::Title;
use Moose;
...
use Chart::Plotly::Trace::Cone::Colorbar::Title::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Cone::Colorbar::Title::Font", );
...
Chart::Plotly::Trace::Cone::Colorbar::Title - This attribute is one of the possible options for the trace cone.
