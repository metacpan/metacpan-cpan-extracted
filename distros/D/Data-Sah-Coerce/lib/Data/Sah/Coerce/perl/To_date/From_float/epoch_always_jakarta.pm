package Data::Sah::Coerce::perl::To_date::From_float::epoch_always_jakarta;
...
sub meta {
    +{
        v => 4,
        summary => 'Coerce date from number (all range assumed to be epoch) (Asia/Jakarta time zone)',
        prio => 50,
...
1;
# ABSTRACT: Coerce date from number (all range assumed to be epoch) (Asia/Jakarta time zone)
...
Data::Sah::Coerce::perl::To_date::From_float::epoch_always_jakarta - Coerce date from number (all range assumed to be epoch) (Asia/Jakarta time zone)

=head1 VERSION

This document describes version 0.051 of Data::Sah::Coerce::perl::To_date::From_float::epoch_always_jakarta (from Perl distribution Data-Sah-Coerce), released on 2021-10-18.

=head1 SYNOPSIS

To use in a Sah schema:

 ["date",{"x.perl.coerce_rules"=>["From_float::epoch_always_jakarta"]}]
