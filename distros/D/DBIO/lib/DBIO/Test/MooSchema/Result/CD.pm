package DBIO::Test::MooSchema::Result::CD;
...
__PACKAGE__->belongs_to(
  artist => 'DBIO::Test::MooSchema::Result::Artist', 'artist_id'
);
...
DBIO::Test::MooSchema::Result::CD - Moo-enabled test result class for the cd table
