...
$Finance::AMEX::Transaction::EPTRN::Detail::ChargeSummary::VERSION = '0.003';
use strict;
use warnings;
...
Finance::AMEX::Transaction::EPTRN::Detail::ChargeSummary - Parse AMEX Transaction/Invoice Level Reconciliation (EPTRN) Summary of Charge (SOC) Detail Rows
...
Returns a new L<Finance::AMEX::Transaction::EPTRN::Detail::ChargeSummary> object.

 my $record = Finance::AMEX::Transaction::EPTRN::Detail::ChargeSummary->new(line => $line);
...
Finance::AMEX::Transaction::EPTRN::Detail::ChargeSummary - Object methods for AMEX Reconciliation file summary of charge detail records.
