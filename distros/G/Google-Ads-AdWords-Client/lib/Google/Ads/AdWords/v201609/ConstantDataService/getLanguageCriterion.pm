...
package Google::Ads::AdWords::v201609::ConstantDataService::getLanguageCriterion;
use strict;
use warnings;
...
getLanguageCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201609.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201609::ConstantDataService::getLanguageCriterion->new($data);
