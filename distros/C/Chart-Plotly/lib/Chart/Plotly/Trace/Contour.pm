...
use Chart::Plotly::Trace::Contour::Legendgrouptitle;
use Chart::Plotly::Trace::Contour::Line;
use Chart::Plotly::Trace::Contour::Stream;
use Chart::Plotly::Trace::Contour::Textfont;
...
has legendgrouptitle => ( is  => "rw",
                          isa => "Maybe[HashRef]|Chart::Plotly::Trace::Contour::Legendgrouptitle", );
...
has textfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Contour::Textfont", );
