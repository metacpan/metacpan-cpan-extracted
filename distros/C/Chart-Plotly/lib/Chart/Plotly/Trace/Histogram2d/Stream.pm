package Chart::Plotly::Trace::Histogram2d::Stream;
use Moose;
...
Chart::Plotly::Trace::Histogram2d::Stream - This attribute is one of the possible options for the trace histogram2d.
