...
Pg::SQL::PrettyPrinter::Node::DefElem - Class representing single param
definition, for example "ANALYZE ON" for explains..
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Pg::SQL::PrettyPrinter::Node::DefElem
