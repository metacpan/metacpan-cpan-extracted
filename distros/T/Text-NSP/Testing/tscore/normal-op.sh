...
# shell program to test tscore.pm's output during normal operation (that
...
# now the test!
echo "Test:   statistic.pl tscore test-1.out $TESTFILE" 
statistic.pl tscore test-1.out $TESTFILE 
...
# now the test!
echo "Test:   statistic.pl --set_freq_combo $FREQCOMBFILE tscore test-2.out $TESTFILE" 
statistic.pl --set_freq_combo $FREQCOMBFILE tscore test-2.out $TESTFILE
