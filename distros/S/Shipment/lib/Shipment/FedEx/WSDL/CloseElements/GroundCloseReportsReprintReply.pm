...
package Shipment::FedEx::WSDL::CloseElements::GroundCloseReportsReprintReply;
$Shipment::FedEx::WSDL::CloseElements::GroundCloseReportsReprintReply::VERSION = '3.06';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    __PACKAGE__->__set_name('GroundCloseReportsReprintReply');
...
=head2 new
 ...
 my $element = Shipment::FedEx::WSDL::CloseElements::GroundCloseReportsReprintReply->new($data);
