...
1;
# ABSTRACT: Run commands with some environment variables set
...
App::EnvUtils - Run commands with some environment variables set

=head1 VERSION

This document describes version 0.001 of App::EnvUtils (from Perl distribution App-EnvUtils), released on 2024-11-12.
