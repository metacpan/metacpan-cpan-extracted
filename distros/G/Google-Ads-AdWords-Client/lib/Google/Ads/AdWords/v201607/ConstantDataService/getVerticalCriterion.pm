...
package Google::Ads::AdWords::v201607::ConstantDataService::getVerticalCriterion;
use strict;
use warnings;
...
getVerticalCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201607.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201607::ConstantDataService::getVerticalCriterion->new($data);
