...
This document describes version 0.010 of Sah::Schema::dataquota (from Perl distribution Sah-SchemaBundle-DataSizeSpeed), released on 2024-08-03.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("dataquota*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("dataquota", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("dataquota", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("dataquota*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"dataquota*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('dataquota*', name=>'Dataquota')
     );
 }

 use My::Types qw(Dataquota);
 Dataquota->assert_valid($data);
