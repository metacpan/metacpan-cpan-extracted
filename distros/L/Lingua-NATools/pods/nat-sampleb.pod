...
=head1 SYNOPSIS
 ...
 nat-sampleb <steps> <crp1> <crp2> <mat-in> <mat-out>
...
Sample-b is an iterative method for the EM-Algorithm. To use it, you
must supply the number of times the method should iterate, both corpus
