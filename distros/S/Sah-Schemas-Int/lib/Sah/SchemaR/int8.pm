...
our $rschema = ["int",[{max=>127,min=>-128,summary=>"8-bit signed integer"}],["int"]];
...
This document describes version 0.071 of Sah::SchemaR::int8 (from Perl distribution Sah-Schemas-Int), released on 2018-04-03.
