package Chart::Plotly::Trace::Scatterternary::Marker;
use Moose;
...
use Chart::Plotly::Trace::Scatterternary::Marker::Colorbar;
...
has colorbar => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatterternary::Marker::Colorbar", );
...
has gradient => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatterternary::Marker::Gradient", );

has line => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatterternary::Marker::Line", );
...
Chart::Plotly::Trace::Scatterternary::Marker - This attribute is one of the possible options for the trace scatterternary.
