...
1;
# ABSTRACT: Check that string is a well-formed Mandiri account number
...
Data::Sah::Filter::perl::Business::ID::Mandiri::check_account_num - Check that string is a well-formed Mandiri account number

=head1 VERSION

This document describes version 0.002 of Data::Sah::Filter::perl::Business::ID::Mandiri::check_account_num (from Perl distribution Sah-SchemaBundle-Business-ID-Mandiri), released on 2024-04-03.
