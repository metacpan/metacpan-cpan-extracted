...
package Meta::Projects::Md5::Node;
...
Meta::Projects::Md5::Node - fortune table node Class::DBI wrapper.
...
=head1 SYNOPSIS
	...
	my($object)=Meta::Projects::Md5::Node->new();
...
This is a testing suite for the Meta::Projects::Md5::Node module.
