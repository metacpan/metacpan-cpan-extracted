...
use Google::Ads::AdWords::v201708::LanguageSearchParameter;
use Google::Ads::AdWords::v201708::NetworkSearchParameter;
...
sub get_keyword_ideas {
  ...
  my $language_english =
    Google::Ads::AdWords::v201708::Language->new({id => 1000});
