...
'http' => Firewall::Config::Element::Service::H3c->new( srvName => 'http', protocol => 'tcp', srcPort => '0-65535', dstPort => '80'),};
=cut
...
my $predefinedService;
use Firewall::Config::Dao::PredefinedService::H3c;
$predefinedService = Firewall::Config::Dao::PredefinedService::H3c->new( dbi => $dbi );
$predefinedService = $predefinedService->load(24);

#say dumper $predefinedService;exit;
my $parser;
eval(
...
#say dumper $parser->{elements}{address};
