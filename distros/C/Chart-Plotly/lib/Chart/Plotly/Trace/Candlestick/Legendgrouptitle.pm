package Chart::Plotly::Trace::Candlestick::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Candlestick::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Candlestick::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Candlestick::Legendgrouptitle - This attribute is one of the possible options for the trace candlestick.
