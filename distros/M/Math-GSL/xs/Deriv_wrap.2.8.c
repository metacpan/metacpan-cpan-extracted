...
static swig_type_info _swigt__p_gsl_function_fdf_struct = {"_p_gsl_function_fdf_struct", "gsl_function_fdf *|struct gsl_function_fdf_struct *|gsl_function_fdf_struct *", 0, 0, (void*)"Math::GSL::Deriv::gsl_function_fdf_struct", 0};
