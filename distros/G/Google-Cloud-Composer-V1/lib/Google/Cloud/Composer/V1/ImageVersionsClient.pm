package Google::Cloud::Composer::V1::ImageVersionsClient;
...
1; # End of Google::Cloud::Composer::V1::ImageVersionsClient

__END__

=head1 NAME

Google::Cloud::Composer::V1::ImageVersionsClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Composer::V1::ImageVersionsClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Composer::V1::ImageVersionsClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Composer::V1::ImageVersionsClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Composer::V1::ImageVersionsClient->new(
