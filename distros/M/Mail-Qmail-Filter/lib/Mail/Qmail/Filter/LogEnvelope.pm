...
This L<Mail::Qmail::Filter> plugin logs the following items:

=over 4

=item RELAYCLIENT

only if the environmental variable C<RELAYCLIENT> is set:
information about C<TCPREMOTEHOST> and C<TCPREMOTEIP>

=item RFC5232.MailFrom
