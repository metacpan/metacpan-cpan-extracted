...
Source data is generated from C<Locale::Codes::Language_Codes>. so make sure you
have a relatively recent version of the module.
...
Please visit the project's homepage at L<https://metacpan.org/release/App-ListLanguages>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-App-ListLanguages>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=App-ListLanguages>
