...
This document describes version 0.018 of Sah::Schema::date::month_num (from Perl distribution Sah-Schemas-Date), released on 2022-10-12.
...
To create a type constraint and type library from a schema:
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('$sch_name*', name=>'DateMonthNum')
     );
 }
