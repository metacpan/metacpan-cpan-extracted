...
$Finance::AMEX::Transaction::EPTRN::Unknown::VERSION = '0.002';
use strict;
use warnings;
...
Finance::AMEX::Transaction::EPTRN::Unknown - Parse AMEX Transaction/Invoice Level Reconciliation (EPTRN) Unknown Rows
