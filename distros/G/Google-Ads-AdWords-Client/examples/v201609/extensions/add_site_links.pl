...
use Google::Ads::AdWords::v201609::CampaignExtensionSetting;
use Google::Ads::AdWords::v201609::CampaignExtensionSettingOperation;
use Google::Ads::AdWords::v201609::FeedItemGeoRestriction;
use Google::Ads::AdWords::v201609::Keyword;
use Google::Ads::AdWords::v201609::Location;
use Google::Ads::AdWords::v201609::SitelinkFeedItem;
...
sub add_site_links {
  ...
  my $site_link_1 = Google::Ads::AdWords::v201609::SitelinkFeedItem->new({
      sitelinkText      => 'Store Hours',
      sitelinkFinalUrls => Google::Ads::AdWords::v201609::UrlList->new(
        {urls => ['http://www.example.com/storehours']})});

  # Set the startTime and endTime to show the Thanksgiving specials link only
  # from 20 - 27 Nov.
  my $site_link_2 = Google::Ads::AdWords::v201609::SitelinkFeedItem->new({
  ...
  my $geo_targeting_restriction =
    Google::Ads::AdWords::v201609::FeedItemGeoRestriction->new({
  ...
  my $keyword = Google::Ads::AdWords::v201609::Keyword->new({
    text      => "free wifi",
    matchType => "BROAD"
  });
  my $site_link_3 = Google::Ads::AdWords::v201609::SitelinkFeedItem->new({
      ...
      devicePreference =>
        Google::Ads::AdWords::v201609::FeedItemDevicePreference->new({
  ...
  # 6PM to 9PM.
  my $site_link_4 = Google::Ads::AdWords::v201609::SitelinkFeedItem->new({
  ...
  {
    push @schedules,
      Google::Ads::AdWords::v201609::FeedItemSchedule->new({
        'dayOfWeek'   => $day_name,
        'startHour'   => 18,
        'startMinute' => 'ZERO',
        'endHour'     => 21,
  ...
  $site_link_4->set_scheduling(
    Google::Ads::AdWords::v201609::FeedItemScheduling->new(
      {feedItemSchedules => \@schedules}));

  my $campaign_extension_setting =
    Google::Ads::AdWords::v201609::CampaignExtensionSetting->new({
      campaignId       => $campaign_id,
      extensionType    => 'SITELINK',
      extensionSetting => Google::Ads::AdWords::v201609::ExtensionSetting->new({
          extensions => [$site_link_1, $site_link_2, $site_link_3, $site_link_4]
        })});

  my $mutate_result = $client->CampaignExtensionSettingService()->mutate({
      operations => [
        Google::Ads::AdWords::v201609::CampaignExtensionSettingOperation->new({
