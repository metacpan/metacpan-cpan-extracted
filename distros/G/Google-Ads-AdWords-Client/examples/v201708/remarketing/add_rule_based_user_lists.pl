...
use Google::Ads::AdWords::v201708::BasicUserList;
use Google::Ads::AdWords::v201708::CombinedRuleUserList;
use Google::Ads::AdWords::v201708::DateKey;
use Google::Ads::AdWords::v201708::DateRuleItem;
use Google::Ads::AdWords::v201708::DateSpecificRuleUserList;
use Google::Ads::AdWords::v201708::ExpressionRuleUserList;
use Google::Ads::AdWords::v201708::NumberKey;
use Google::Ads::AdWords::v201708::NumberRuleItem;
use Google::Ads::AdWords::v201708::Operator;
use Google::Ads::AdWords::v201708::Rule;
use Google::Ads::AdWords::v201708::RuleItem;
use Google::Ads::AdWords::v201708::RuleItemGroup;
use Google::Ads::AdWords::v201708::StringKey;
use Google::Ads::AdWords::v201708::StringRuleItem;
...
sub add_rule_based_user_lists {
  ...
  my $checkout_string_rule_item =
    Google::Ads::AdWords::v201708::StringRuleItem->new({
      key => Google::Ads::AdWords::v201708::StringKey->new(
        {name => "ecomm_pagetype"}
      ),
      op    => "EQUALS",
      value => "checkout"
    });
  my $checkout_rule_item = Google::Ads::AdWords::v201708::RuleItem->new(
    {StringRuleItem => $checkout_string_rule_item});

  my $cart_size_number_rule_item =
    Google::Ads::AdWords::v201708::NumberRuleItem->new({
      key =>
        Google::Ads::AdWords::v201708::NumberKey->new({name => "cartsize"}),
      op    => "GREATER_THAN",
      value => "1"
    });
  my $cart_size_rule_item = Google::Ads::AdWords::v201708::RuleItem->new(
  ...
  my $checkout_multiple_item_group =
    Google::Ads::AdWords::v201708::RuleItemGroup->new(
  ...
  my $start_date_date_rule_item =
    Google::Ads::AdWords::v201708::DateRuleItem->new({
      key =>
        Google::Ads::AdWords::v201708::DateKey->new({name => "checkoutdate"}),
      op    => "AFTER",
      value => $rule_start_date
    });

  my $start_date_rule_item = Google::Ads::AdWords::v201708::RuleItem->new(
  ...
  my $end_date_rule_item = Google::Ads::AdWords::v201708::RuleItem->new(
  ...
  # rules.
  my $rule = Google::Ads::AdWords::v201708::Rule->new({
      groups => [
  ...
  my $site1_rule_item = Google::Ads::AdWords::v201708::RuleItem->new(
  ...
  my $site2_rule_item = Google::Ads::AdWords::v201708::RuleItem->new(
    {StringRuleItem => $site2_string_rule_item});

  # Create two RuleItemGroups to show that a visitor browsed two sites.
  my $site1_item_group = Google::Ads::AdWords::v201708::RuleItemGroup->new(
    {items => [$site1_rule_item]});
  my $site2_item_group = Google::Ads::AdWords::v201708::RuleItemGroup->new(
    {items => [$site2_rule_item]});

  # Create two rules to show that a visitor browsed two sites.
  my $user_visited_site1_rule = Google::Ads::AdWords::v201708::Rule->new({
      groups => [$site1_item_group]
    });
  my $user_visited_site2_rule = Google::Ads::AdWords::v201708::Rule->new({
  ...
  my $expression_user_list =
    Google::Ads::AdWords::v201708::ExpressionRuleUserList->new({
  ...
  my $date_user_list =
    Google::Ads::AdWords::v201708::DateSpecificRuleUserList->new({
  ...
  my $combined_user_list =
    Google::Ads::AdWords::v201708::CombinedRuleUserList->new({
  ...
  my $operations = [
    Google::Ads::AdWords::v201708::UserListOperation->new({
        operator => "ADD",
