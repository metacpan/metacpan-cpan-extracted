package Developer::Dashboard::Pax::ProfileStore;
...
Developer::Dashboard::Pax::ProfileStore - profile persistence layer

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::ProfileStore;

  my $obj = Developer::Dashboard::Pax::ProfileStore->new(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::ProfileStore -e 1
