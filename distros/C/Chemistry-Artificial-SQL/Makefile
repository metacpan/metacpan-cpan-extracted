# This Makefile is for the Chemistry::Artificial::SQL extension to perl.
#
...
#     NAME => q[Chemistry::Artificial::SQL]
#     PREREQ_PM => { Chemistry::Reaction=>q[0.02], Chemistry::SQL=>q[0.01] }
#     VERSION_FROM => q[lib/Chemistry/Artificial/SQL.pm]
...
NAME_SYM = Chemistry_Artificial_SQL
VERSION = 0.01
...
FULLEXT = Chemistry/Artificial/SQL
BASEEXT = SQL
PARENT_NAME = Chemistry::Artificial
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Chemistry/Artificial/SQL.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DIRFILESEP)Config.pm $(PERL_INC)$(DIRFILESEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Chemistry/Artificial
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Chemistry/Artificial
...
TO_INST_PM = lib/Chemistry/Artificial/SQL.pm

PM_TO_BLIB = lib/Chemistry/Artificial/SQL.pm \
	blib/lib/Chemistry/Artificial/SQL.pm
...
DISTNAME = Chemistry-Artificial-SQL
DISTVNAME = Chemistry-Artificial-SQL-0.01
...
manifypods : pure_all  \
	lib/Chemistry/Artificial/SQL.pm \
	lib/Chemistry/Artificial/SQL.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW)\
	  lib/Chemistry/Artificial/SQL.pm $(INST_MAN3DIR)/Chemistry::Artificial::SQL.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Chemistry/Artificial/SQL.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Chemistry-Artificial-SQL' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.01' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Chemistry/Artificial/SQL.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    Chemistry::Reaction:           0.02' >> META.yml
	$(NOECHO) $(ECHO) '    Chemistry::SQL:                0.01' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Chemistry-Reaction" VERSION="0,02,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Chemistry-SQL" VERSION="0,01,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Chemistry/Artificial/SQL.pm blib/lib/Chemistry/Artificial/SQL.pm 
	$(NOECHO) $(TOUCH) $@
