...
Sah::SchemaR::perl::distname - Perl distribution name, e.g. Foo-Bar

=head1 VERSION

This document describes version 0.050 of Sah::SchemaR::perl::distname (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
