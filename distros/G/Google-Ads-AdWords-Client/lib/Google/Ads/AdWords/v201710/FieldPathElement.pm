package Google::Ads::AdWords::v201710::FieldPathElement;
use strict;
use warnings;
...
Google::Ads::AdWords::v201710::FieldPathElement

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FieldPathElement from the namespace https://adwords.google.com/api/adwords/cm/v201710.
