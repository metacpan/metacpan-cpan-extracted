package ## no critic: Modules::RequireFilenameMatchesPackage
    # hide from PAUSE
    TableDataRole::Perl::CPAN::Release::Static::2005;
...
around new => sub {
    ...
    my $filename = File::Basename::dirname(__FILE__) . '/../../../../../../share/2005.csv';
    unless (-f $filename) {
        require File::ShareDir;
        $filename = File::ShareDir::dist_file('TableDataBundle-Perl-CPAN-Release-Static-Older', '2005.csv');
    }
    $orig->(@_, filename=>$filename);
};

package TableData::Perl::CPAN::Release::Static::2005;
...
with 'TableDataRole::Perl::CPAN::Release::Static::2005';

our %STATS = ("num_rows",12389,"num_columns",9); # STATS

1;
# ABSTRACT: CPAN releases for the year 2005
...
TableDataRole::Perl::CPAN::Release::Static::2005 - CPAN releases for the year 2005

=head1 VERSION

This document describes version 20220218.2 of TableDataRole::Perl::CPAN::Release::Static::2005 (from Perl distribution TableDataBundle-Perl-CPAN-Release-Static-Older), released on 2022-02-18.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Perl::CPAN::Release::Static::2005;

 my $td = TableData::Perl::CPAN::Release::Static::2005->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Perl::CPAN::Release::Static::2005 --page

 # Get number of rows
 % tabledata --action count_rows Perl::CPAN::Release::Static::2005
