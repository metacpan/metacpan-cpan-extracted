...
Sah::Schema::example::recurse2a - Recursive schema

=head1 VERSION

This document describes version 0.005 of Sah::Schema::example::recurse2a (from Perl distribution Sah-Schemas-Examples), released on 2016-12-09.
