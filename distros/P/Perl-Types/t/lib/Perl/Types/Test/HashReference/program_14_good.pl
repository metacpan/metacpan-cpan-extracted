...
my hashref $unknown_hash = {
    ...
    0    => my arrayref::number $TYPED_zero      = [ 42 / 1_701, 21.12, 2_112.23 ],
    0.1  => my hashref::string $TYPED_zerodotone = { 'alpha' => 'strings are scalars, too', 12.345_678 => 'hello world', gamma => 'last one' },
    '0.1'       => 'replacement',
    "0.1\n"     => 'close but not quite',
