...
package Meta::Baseline::Lang::Chec;
...
Meta::Baseline::Lang::Chec - language for chec files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Chec::env();

=head1 DESCRIPTION

This package contains stuff specific to Chec in the baseline:
Its mainly here to authorize entries of chec files to the baseline.
