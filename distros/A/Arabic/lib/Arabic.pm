...
END
            ...
            if ($list !~ /\A (?>\s*) \z/oxms) {
                ...
                for (@list) {
                    ...
                    $Earabic::function_ord     = $Earabic::function_ord;
                    $Earabic::function_ord_    = $Earabic::function_ord_;
                    $Earabic::function_reverse = $Earabic::function_reverse;
                    $Earabic::function_getc    = $Earabic::function_getc;
                }
            }
        }
    }
...
=head1 Yada Yada Operator (Arabic software provides)
