...
ColorTheme::Text::ANSITable::OldCompat::Default::no_color - NoColor color theme (with old name)

=head1 VERSION

This document describes version 0.609 of ColorTheme::Text::ANSITable::OldCompat::Default::no_color (from Perl distribution Text-ANSITable), released on 2023-07-14.
