...
static asn_TYPE_member_t asn_MBR_RRLP_Component_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRLP_Component, choice.posCapabilityReq),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_PosCapability_Req,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"posCapabilityReq"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RRLP_Component, choice.posCapabilityRsp),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_PosCapability_Rsp,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"posCapabilityRsp"
...
static asn_TYPE_tag2member_t asn_MAP_RRLP_Component_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 } /* posCapabilityRsp at 29 */
};
