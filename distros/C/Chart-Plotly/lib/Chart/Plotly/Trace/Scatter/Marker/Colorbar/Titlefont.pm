package Chart::Plotly::Trace::Scatter::Marker::Colorbar::Titlefont;
use Moose;
...
Chart::Plotly::Trace::Scatter::Marker::Colorbar::Titlefont - This attribute is one of the possible options for the trace scatter.
