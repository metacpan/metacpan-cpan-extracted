package WordLists::EN::PersonName::PopularBabyNames::US::SSA;
...
WordLists::EN::PersonName::PopularBabyNames::US::SSA - Popular baby names in the USA (from Social Security Administration)

=head1 VERSION

This document describes version 0.002 of WordLists::EN::PersonName::PopularBabyNames::US::SSA (from Perl distribution WordLists-EN-PersonName-PopularBabyNames-US-SSA), released on 2020-05-04.
