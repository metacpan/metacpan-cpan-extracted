package Chart::Plotly::Trace::Violin::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Violin::Legendgrouptitle::Font - This attribute is one of the possible options for the trace violin.
