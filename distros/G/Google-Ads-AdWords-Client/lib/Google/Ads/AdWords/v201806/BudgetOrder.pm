package Google::Ads::AdWords::v201806::BudgetOrder;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'spendingLimit' => 'Google::Ads::AdWords::v201806::Money',
        'totalAdjustments' => 'Google::Ads::AdWords::v201806::Money',
        'startDateTime' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'endDateTime' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'lastRequest' => 'Google::Ads::AdWords::v201806::BudgetOrderRequest',
    },
    {
...
BudgetOrder from the namespace https://adwords.google.com/api/adwords/billing/v201806.
