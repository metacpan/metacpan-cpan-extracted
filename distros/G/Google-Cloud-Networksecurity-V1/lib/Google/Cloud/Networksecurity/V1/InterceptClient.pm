package Google::Cloud::Networksecurity::V1::InterceptClient;
...
1; # End of Google::Cloud::Networksecurity::V1::InterceptClient

__END__

=head1 NAME

Google::Cloud::Networksecurity::V1::InterceptClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Networksecurity::V1::InterceptClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Networksecurity::V1::InterceptClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Networksecurity::V1::InterceptClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Networksecurity::V1::InterceptClient->new(
