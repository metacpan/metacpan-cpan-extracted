...
App::PDRUtils::DistIniCmd::set_prereq_version_to - Set prereq version to a specified version

=head1 VERSION

This document describes version 0.120 of App::PDRUtils::DistIniCmd::set_prereq_version_to (from Perl distribution App-PDRUtils), released on 2018-04-03.
