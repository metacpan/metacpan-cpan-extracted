...
Gtk3::Helper - Convenience functions for the Gtk3 module
...
This module collects Gtk3 helper functions, which should make
implementing some common tasks easier.

=head1 DESCRIPTION

=head2 Gtk3::Helper->add_watch ( ... )
...
and use Gtk3::Helper->remove_watch to disable a watcher, which was
installed with Gtk3::Helper->add_watch.

(Gtk3::Helper could circumvent this by wrapping your callback
...
Later you need to pass this tag to Gtk3::Helper->remove_watch to
remove the watcher.
...
=head2 Gtk3::Helper->remove_watch ( ... )

  $rc = Gtk3::Helper->remove_watch ( $tag )

This method removes a watcher, which was created using
Gtk3::Helper->add_watch().

=over 4

=item $tag

This is the tag returned from Gtk3::Helper->add_watch().
