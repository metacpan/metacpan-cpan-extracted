...
1;
# ABSTRACT: String containing only zero or more lowercases Latin letters, i.e. a-z
...
Sah::Schema::latin_lowercase_alpha - String containing only zero or more lowercases Latin letters, i.e. a-z
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("latin_lowercase_alpha*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("latin_lowercase_alpha", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("latin_lowercase_alpha", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("latin_lowercase_alpha*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"latin_lowercase_alpha*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('latin_lowercase_alpha*', name=>'LatinLowercaseAlpha')
     );
 }

 use My::Types qw(LatinLowercaseAlpha);
 LatinLowercaseAlpha->assert_valid($data);
