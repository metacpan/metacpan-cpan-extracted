...
## catos_test.pl
##
## Script to test the Cisco::CATOS device class. A debug file called "dump.log" is created.
##
## $Id: catos_test.pl 35 2007-07-11 13:57:17Z mwallraf $
## $Author: mwallraf $
...
my $w = Net::Telnet::Wrapper->new('device_class' => 'Cisco::CATOS', -host => "$device", Dump_Log => "dump.log" );
