...
our $DIST = 'Data-Dump-IfSmall'; # DIST
...
Data::Dump::IfSmall - Like Data::Dump but reference with dump larger than a certain size will be dumped as something like 'LARGE:ARRAY(0x5636145ea5e8)'

=head1 VERSION

This document describes version 0.001 of Data::Dump::IfSmall (from Perl distribution Data-Dump-IfSmall), released on 2024-02-16.
...
Please visit the project's homepage at L<https://metacpan.org/release/Data-Dump-IfSmall>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Data-Dump-IfSmall>.
...
Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=Data-Dump-IfSmall>
