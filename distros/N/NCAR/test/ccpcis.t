...
#
&NCAR::cpsetr ('CIS - CONTOUR INTERVAL SPECIFIER',15.);
&NCAR::cpseti ('LIS - LABEL INTERVAL SPECIFIER',2);
&NCAR::cpsetr ('CMN - CONTOUR MINIMUM',-5.);
&NCAR::cpsetr ('CMX - CONTOUR MAXIMUM',75.);
#
# Initialize Conpack
#
