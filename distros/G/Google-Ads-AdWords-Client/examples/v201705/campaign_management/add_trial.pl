...
use Google::Ads::AdWords::v201705::Trial;
use Google::Ads::AdWords::v201705::TrialOperation;
...
sub add_trial {
  ...
  my $trial = Google::Ads::AdWords::v201705::Trial->new({
      draftId             => $draft_id,
  ...
  # Create operation.
  my $trial_operation = Google::Ads::AdWords::v201705::TrialOperation->new({
      operator => "ADD",
      operand  => $trial
  });
  ...
  if ($result) {
    ...
    if ($trial->get_status() eq 'ACTIVE') {
      ...
      my $error_selector = Google::Ads::AdWords::v201705::Selector->new({
