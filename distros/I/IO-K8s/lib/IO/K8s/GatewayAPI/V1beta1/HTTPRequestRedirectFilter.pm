...
IO::K8s::GatewayAPI::V1beta1::HTTPRequestRedirectFilter - RequestRedirect defines a schema for a filter that responds to the request with an HTTP redirection.
