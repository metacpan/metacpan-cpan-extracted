package Google::Ads::AdWords::v201809::CriterionCustomAffinity;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::CriterionCustomAffinity

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CriterionCustomAffinity from the namespace https://adwords.google.com/api/adwords/cm/v201809.
