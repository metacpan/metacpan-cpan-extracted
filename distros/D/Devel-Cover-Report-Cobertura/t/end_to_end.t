...
my @test = (
    ...
    sub {
        ...
        my $outfile   = testcover::test_path('multi_file') . "/cobertura-1-$$.xml";
        $b->generate($outfile);
    ...
    sub {
        ...
        my $o         = {
            'option' => {
                ...
                'outputfile'  => "cobertura-2-$$.xml"
            },
            'silent'  => 1,
            outputdir => testcover::test_path('multi_file'),
        };

        Devel::Cover::Report::Cobertura->report( $MULTI_FILE_DB, $o );
...
sub BUILDER {
    return Devel::Cover::Report::Cobertura::Builder->new(shift);
}
