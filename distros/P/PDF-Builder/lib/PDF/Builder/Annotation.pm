...
Defines the annotation as launch-page with page C<$page> and
...
Defines the annotation as launch-url with url C<$url> and
...
Defines the annotation as launch-file with filepath C<$file> and
options %opts (-rect and/or -border).
...
=item $ant->pdfile($pdfile, $pagenum)

Defines the annotation as pdf-file with filepath C<$pdfile, $pagenum>
...
Defines the annotation as textnote with content C<$text> and
...
=item $ant->movie($file, $contentype)

Defines the annotation as a movie from C<$file> with C<$contentype> and
options %opts (-rect).
