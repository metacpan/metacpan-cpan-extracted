...
#
package WebService::Fastly::LoggingOpenstackApi;
...
# @param string $user The username for your OpenStack account. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_log_openstack' } = {
        summary => 'Create an OpenStack log endpoint',
        params => $params,
        returns => 'LoggingOpenstackResponse',
        };
}
# @return LoggingOpenstackResponse
#
sub create_log_openstack {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling create_log_openstack");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling create_log_openstack");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/openstack';
    ...
    my $_response_object = $self->{api_client}->deserialize('LoggingOpenstackResponse', $response);
...
# @param string $logging_openstack_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_log_openstack' } = {
...
#
sub delete_log_openstack {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling delete_log_openstack");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling delete_log_openstack");
    }

    # verify the required parameter 'logging_openstack_name' is set
    unless (exists $args{'logging_openstack_name'}) {
      croak("Missing the required parameter 'logging_openstack_name' when calling delete_log_openstack");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/openstack/{logging_openstack_name}';
    ...
    # path params
    if ( exists $args{'logging_openstack_name'}) {
        my $_base_variable = "{" . "logging_openstack_name" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'logging_openstack_name'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
# @param string $logging_openstack_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_log_openstack' } = {
...
# @return LoggingOpenstackResponse
#
sub get_log_openstack {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling get_log_openstack");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling get_log_openstack");
    }

    # verify the required parameter 'logging_openstack_name' is set
    unless (exists $args{'logging_openstack_name'}) {
      croak("Missing the required parameter 'logging_openstack_name' when calling get_log_openstack");
    }
...
# @param int $version_id Integer identifying a service version. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_log_openstack' } = {
        summary => 'List OpenStack log endpoints',
        params => $params,
        returns => 'ARRAY[LoggingOpenstackResponse]',
        };
}
# @return ARRAY[LoggingOpenstackResponse]
#
sub list_log_openstack {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling list_log_openstack");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling list_log_openstack");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[LoggingOpenstackResponse]', $response);
    return $_response_object;
}
...
# @param string $user The username for your OpenStack account. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_log_openstack' } = {
...
# @return LoggingOpenstackResponse
#
sub update_log_openstack {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling update_log_openstack");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling update_log_openstack");
    }

    # verify the required parameter 'logging_openstack_name' is set
    unless (exists $args{'logging_openstack_name'}) {
      croak("Missing the required parameter 'logging_openstack_name' when calling update_log_openstack");
    }
