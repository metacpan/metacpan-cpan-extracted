...
my($modu)=($ARGV[0]);
my($scod)=Meta::Utils::System::system("perl",["-d",$modu]);
...
perl_debug.pl - debug a perl program in base fashion.
...
This is a wrapper for the activation of the perl debugger.
currently it does almost nothing.
