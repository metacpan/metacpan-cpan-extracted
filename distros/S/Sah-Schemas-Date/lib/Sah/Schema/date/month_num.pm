...
Sah::Schema::date::month_num - Month number, coercible from English month names (Dec/DECEMBER), e.g. 2 or "Feb"

=head1 VERSION

This document describes version 0.019 of Sah::Schema::date::month_num (from Perl distribution Sah-Schemas-Date), released on 2023-12-09.
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"date::month_num*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('date::month_num*', name=>'DateMonthNum')
     );
 }

 use My::Types qw(DateMonthNum);
 DateMonthNum->assert_valid($data);
