package Chart::Plotly::Trace::Scatterternary::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Scatterternary::Legendgrouptitle::Font - This attribute is one of the possible options for the trace scatterternary.
