...
Data::Sah::Coerce::perl::str::int_convert_gid_to_unix_group - Convert GID into Unix groupname

=head1 VERSION

This document describes version 0.005 of Data::Sah::Coerce::perl::str::int_convert_gid_to_unix_group (from Perl distribution Sah-Schemas-Unix), released on 2019-09-11.
