package Google::Cloud::Networksecurity::V1::SecurityProfileGroupServiceClient;
...
1; # End of Google::Cloud::Networksecurity::V1::SecurityProfileGroupServiceClient

__END__

=head1 NAME

Google::Cloud::Networksecurity::V1::SecurityProfileGroupServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Networksecurity::V1::SecurityProfileGroupServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Networksecurity::V1::SecurityProfileGroupServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Networksecurity::V1::SecurityProfileGroupServiceClient> is an auto-generated client library for Google Cloud Services.
