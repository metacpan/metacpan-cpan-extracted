...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::NetworkProfile Google::Cloud::Compute::V1::Compute::NetworkProfilesListResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::NetworkProfilesClient->new( credentials => 'dummy' );
