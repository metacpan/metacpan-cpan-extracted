package Google::Ads::AdWords::v201802::UploadCallConversion;
use strict;
use warnings;
...
Google::Ads::AdWords::v201802::UploadCallConversion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
UploadCallConversion from the namespace https://adwords.google.com/api/adwords/cm/v201802.
