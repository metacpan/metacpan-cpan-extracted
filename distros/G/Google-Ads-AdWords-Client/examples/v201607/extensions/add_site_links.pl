...
sub add_site_links {
  ...
  my $site_link_1 = Google::Ads::AdWords::v201607::SitelinkFeedItem->new({
      sitelinkText      => 'Store Hours',
      sitelinkFinalUrls => Google::Ads::AdWords::v201607::UrlList->new(
        {urls => ['http://www.example.com/storehours']})});

  # Set the startTime and endTime to show the Thanksgiving specials link only
  # from 20 - 27 Nov.
  my $site_link_2 = Google::Ads::AdWords::v201607::SitelinkFeedItem->new({
  ...
  my $site_link_3 = Google::Ads::AdWords::v201607::SitelinkFeedItem->new({
      ...
      devicePreference =>
        Google::Ads::AdWords::v201607::FeedItemDevicePreference->new({
  ...
  # 6PM to 9PM.
  my $site_link_4 = Google::Ads::AdWords::v201607::SitelinkFeedItem->new({
  ...
  $site_link_4->set_scheduling(
    Google::Ads::AdWords::v201607::FeedItemScheduling->new(
