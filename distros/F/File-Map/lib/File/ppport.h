...
----------------------------------------------------------------------
    ...
    lib/File/ppport.h -- Perl/Pollution/Portability Version 3.68
...
Lists the API elements that are known not to be FULLY supported by F<lib/File/ppport.h>,
...
version of Perl that F<lib/File/ppport.h> supports at all.
...
Although the purpose of F<lib/File/ppport.h> is to keep you from having to concern
...
# These are tools that must be included in lib/File/ppport.h.  It doesn't work if given
# a .pl suffix.
#
...
/* Hint: isPSXSPC, isPSXSPC_A, isPSXSPC_L1, isPSXSPC_utf8_safe
    ...
    lib/File/ppport.h SPACE version does match VT in all perl releases.  Since VT's are
    extremely rarely found in real-life files, this difference effectively
    doesn't matter */

/* Hint: isSPACE, isSPACE_A, isSPACE_L1, isSPACE_utf8_safe
    Until Perl 5.18, this did not match the vertical tab (VT).  The lib/File/ppport.h
