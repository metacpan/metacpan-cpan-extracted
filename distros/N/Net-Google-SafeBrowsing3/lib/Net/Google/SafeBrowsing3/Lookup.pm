package Net::Google::SafeBrowsing3::Lookup;
...
=head1 SYNOPSIS
  ...
  use Net::Google::SafeBrowsing3::Lookup;

  my $gsb = Net::Google::SafeBrowsing3::Lookup->new(
	  key 	=> "my key", 
  );
...
The Lookup API allows only 10,000 URL checks a day. if you need more, use the L<Net::Google::SafeBrowsing3> library.
...
See L<Net::Google::SafeBrowsing3> for the implementation of Google Safe Browsing v3 API.
