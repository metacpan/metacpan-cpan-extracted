...
Acme::CPANModules::GeneratingMockData - Alias for Acme::CPANModules::RandomData

=head1 VERSION

This document describes version 0.004 of Acme::CPANModules::GeneratingMockData (from Perl distribution Acme-CPANModules-RandomData), released on 2023-04-10.
...
L<App::cpanm::cpanmodules> distribution):
 ...
 % cpanm-cpanmodules -n GeneratingMockData

Alternatively you can use the L<cpanmodules> CLI (from L<App::cpanmodules>
distribution):

    % cpanmodules ls-entries GeneratingMockData | cpanm -n

or L<Acme::CM::Get>:

    % perl -MAcme::CM::Get=GeneratingMockData -E'say $_->{module} for @{ $LIST->{entries} }' | cpanm -n

or directly:

    % perl -MAcme::CPANModules::GeneratingMockData -E'say $_->{module} for @{ $Acme::CPANModules::GeneratingMockData::LIST->{entries} }' | cpanm -n
