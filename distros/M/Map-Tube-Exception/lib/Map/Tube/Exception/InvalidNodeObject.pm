...
$Map::Tube::Exception::InvalidNodeObject::VERSION = '3.15';
=head1 NAME

Map::Tube::Exception::InvalidNodeObject - Represent 'invalid node object' exception.
...
has status => (is => 'ro', default => sub { 107 });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Map::Tube::Exception::InvalidNodeObject
...
1; # End of Map::Tube::Exception::InvalidNodeObject
