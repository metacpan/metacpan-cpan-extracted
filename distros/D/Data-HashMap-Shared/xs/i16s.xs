...
new(char* class, SV* path_sv, UV max_entries, UV lru_max = 0, UV ttl_default = 0, UV lru_skip = 0, UV arena_cap = 0, UV file_mode = 0600)
    CODE:
        CK_U32(max_entries, "max_entries", "Data::HashMap::Shared::I16S"); CK_U32(lru_max, "lru_max", "Data::HashMap::Shared::I16S"); CK_U32(ttl_default, "ttl_default", "Data::HashMap::Shared::I16S"); CK_U32(lru_skip, "lru_skip", "Data::HashMap::Shared::I16S");
        char errbuf[SHM_ERR_BUFLEN]; const char* path = SHM_WRITE_PATH_ARG(path_sv, "path", "Data::HashMap::Shared::I16S", "new"); ShmHandle* map = shm_i16s_create(path, (uint32_t)max_entries, (uint32_t)lru_max, (uint32_t)ttl_default, (uint32_t)lru_skip, (uint64_t)arena_cap, (mode_t)file_mode, errbuf);
        if (!map) croak("Data::HashMap::Shared::I16S: %s", errbuf[0] ? errbuf : "unknown error");
        RETVAL = sv_setref_pv(newSV(0), class, (void*)map);
        CK_MAX_SIZE(map, "Data::HashMap::Shared::I16S", RETVAL);
    OUTPUT:
        RETVAL
...
new_sharded(char* class, SV* path_prefix_sv, UV num_shards, UV max_entries, UV lru_max = 0, UV ttl_default = 0, UV lru_skip = 0, UV arena_cap = 0, UV file_mode = 0600)
    CODE:
        const char* path_prefix = SHM_WRITE_PATH_ARG(path_prefix_sv, "path prefix", "Data::HashMap::Shared::I16S", "new_sharded");
        CK_U32(max_entries, "max_entries", "Data::HashMap::Shared::I16S"); CK_U32(lru_max, "lru_max", "Data::HashMap::Shared::I16S"); CK_U32(ttl_default, "ttl_default", "Data::HashMap::Shared::I16S"); CK_U32(lru_skip, "lru_skip", "Data::HashMap::Shared::I16S");
        CK_U32(num_shards, "num_shards", "Data::HashMap::Shared::I16S");
        char errbuf[SHM_ERR_BUFLEN]; ShmHandle* map = shm_i16s_create_sharded(path_prefix, (uint32_t)num_shards, (uint32_t)max_entries, (uint32_t)lru_max, (uint32_t)ttl_default, (uint32_t)lru_skip, (uint64_t)arena_cap, (mode_t)file_mode, errbuf);
        if (!map) croak("Data::HashMap::Shared::I16S: %s", errbuf[0] ? errbuf : "unknown error");
        RETVAL = sv_setref_pv(newSV(0), class, (void*)map);
        CK_MAX_SIZE(map, "Data::HashMap::Shared::I16S", RETVAL);
    OUTPUT:
...
new_memfd(char* class, SV* name_sv, UV max_entries, UV lru_max = 0, UV ttl_default = 0, UV lru_skip = 0, UV arena_cap = 0)
    CODE:
        ...
        const char* name = SHM_PATH_ARG(name_sv, "name", "Data::HashMap::Shared::I16S");
        CK_U32(max_entries, "max_entries", "Data::HashMap::Shared::I16S"); CK_U32(lru_max, "lru_max", "Data::HashMap::Shared::I16S"); CK_U32(ttl_default, "ttl_default", "Data::HashMap::Shared::I16S"); CK_U32(lru_skip, "lru_skip", "Data::HashMap::Shared::I16S");
        ShmHandle* map = shm_i16s_create_memfd(name, (uint32_t)max_entries, (uint32_t)lru_max, (uint32_t)ttl_default, (uint32_t)lru_skip, (uint64_t)arena_cap, errbuf);
        if (!map) croak("Data::HashMap::Shared::I16S: %s", errbuf[0] ? errbuf : "unknown error");
        RETVAL = sv_setref_pv(newSV(0), class, (void*)map);
        CK_MAX_SIZE(map, "Data::HashMap::Shared::I16S", RETVAL);
    OUTPUT:
...
new_from_fd(char* class, int fd)
    CODE:
        char errbuf[SHM_ERR_BUFLEN];
        SHM_TAINT_CHECK("Data::HashMap::Shared::I16S->new_from_fd");
        ShmHandle* map = shm_i16s_open_fd(fd, errbuf);
        if (!map) croak("Data::HashMap::Shared::I16S: %s", errbuf[0] ? errbuf : "unknown error");
        RETVAL = sv_setref_pv(newSV(0), class, (void*)map);
        CK_MAX_SIZE(map, "Data::HashMap::Shared::I16S", RETVAL);
    OUTPUT:
...
new_readonly(char* class, SV* path_sv)
    CODE:
        char errbuf[SHM_ERR_BUFLEN];
        const char* path = SHM_PATH_ARG(path_sv, "path", "Data::HashMap::Shared::I16S");
        if (!path) croak("Data::HashMap::Shared::I16S->new_readonly: path is required");
        ShmHandle* map = shm_i16s_open_readonly(path, errbuf);
        if (!map) croak("Data::HashMap::Shared::I16S: %s", errbuf[0] ? errbuf : "unknown error");
        RETVAL = sv_setref_pv(newSV(0), class, (void*)map);
    OUTPUT:
        RETVAL
...
freeze(SV* self_sv)
    CODE:
        ...
        if (h->readonly || shm_is_fully_sealed(h)) croak("Data::HashMap::Shared::I16S->freeze: map is frozen (read-only)");
        if (shm_freeze(h) != 0) croak("Data::HashMap::Shared::I16S->freeze: msync: %s", strerror(errno));
        shm_mark_readonly(h);
...
sync(SV* self_sv)
    CODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        if (shm_msync(h) != 0) croak("Data::HashMap::Shared::I16S sync: %s", strerror(errno));

void
DESTROY(SV* self_sv)
    CODE:
        if (!sv_isobject(self_sv) || !sv_derived_from(self_sv, "Data::HashMap::Shared::I16S")) return;
...
put(SV* self_sv, int16_t key, SV* value)
    CODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        if (h->readonly || shm_is_sealed(h)) croak("Data::HashMap::Shared::I16S: map is frozen (read-only)");
...
set_multi(SV* self_sv, ...)
    CODE:
        ...
        if (h->shard_handles) {
            ...
            int _n = (items - 1) / 2;
            int16_t *_ks; const char **_vs; STRLEN *_vl; bool *_vu;
            Newx(_ks, _n ? _n : 1, int16_t);      SAVEFREEPV(_ks);
            ...
            WRSEQ_GUARD(h);
            for (int j = 0; j < _n; j++)
                count += shm_i16s_put_inner(h, _ks[j], _vs[j], (uint32_t)_vl[j], _vu[j], SHM_TTL_USE_DEFAULT);
        }
        RETVAL = count;
    OUTPUT:
        RETVAL
...
remove_multi(SV* self_sv, ...)
    CODE:
        ...
        if (h->shard_handles) {
            ...
            WRSEQ_GUARD(h);
            for (int j = 0; j < _n; j++)
                count += shm_i16s_remove_inner(h, _ks[j]);
...
get_multi(SV* self_sv, ...)
    PPCODE:
        ...
        if (h->shard_handles) {
            ...
            SAVEFREEPV(hashes);
            int64_t *keys = NULL;   /* read once: a tied key's second FETCH may differ */
            Newx(keys, nkeys, int64_t);
            SAVEFREEPV(keys);
            for (int i = 0; i < nkeys; i++)
...
stats(SV* self_sv)
    CODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        HV *hv = newHV();
        hv_store(hv, "size", 4, newSVuv(shm_i16s_size(h)), 0);
        hv_store(hv, "capacity", 8, newSVuv(shm_i16s_capacity(h)), 0);
        hv_store(hv, "max_entries", 11, newSVuv(shm_i16s_max_entries(h)), 0);
        hv_store(hv, "tombstones", 10, newSVuv(shm_i16s_tombstones(h)), 0);
        hv_store(hv, "mmap_size", 9, newSVuv(shm_i16s_mmap_size(h)), 0);
        hv_store(hv, "arena_used", 10, newSVuv(shm_i16s_arena_used(h)), 0);
        hv_store(hv, "arena_cap", 9, newSVuv(shm_i16s_arena_cap(h)), 0);
        hv_store(hv, "evictions", 9, newSVuv(shm_i16s_stat_evictions(h)), 0);
        hv_store(hv, "expired", 7, newSVuv(shm_i16s_stat_expired(h)), 0);
        hv_store(hv, "recoveries", 10, newSVuv(shm_i16s_stat_recoveries(h)), 0);
        hv_store(hv, "max_size", 8, newSVuv(shm_i16s_max_size(h)), 0);
        hv_store(hv, "ttl", 3, newSVuv(shm_i16s_ttl(h)), 0);
...
set_ttl(SV* self_sv, int16_t key, UV ttl_sec)
    CODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        if (h->readonly || shm_is_sealed(h)) croak("Data::HashMap::Shared::I16S: map is frozen (read-only)");
        CK_U32(ttl_sec, "ttl", "Data::HashMap::Shared::I16S");
        RETVAL = shm_i16s_set_ttl(h, key, (uint32_t)ttl_sec);
    OUTPUT:
        RETVAL
...
flush_expired_partial(SV* self_sv, UV limit)
    PPCODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        if (h->readonly || shm_is_sealed(h)) croak("Data::HashMap::Shared::I16S: map is frozen (read-only)");
        CK_U32(limit, "limit", "Data::HashMap::Shared::I16S");
        int done = 0;
...
reserve(SV* self_sv, UV target)
    CODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        if (h->readonly || shm_is_sealed(h)) croak("Data::HashMap::Shared::I16S: map is frozen (read-only)");
        CK_U32(target, "target", "Data::HashMap::Shared::I16S");
...
arena_used(SV* self_sv)
    CODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        RETVAL = (UV)shm_i16s_arena_used(h);
    OUTPUT:
        RETVAL
...
arena_cap(SV* self_sv)
    CODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        RETVAL = (UV)shm_i16s_arena_cap(h);
    OUTPUT:
        RETVAL

bool
add(SV* self_sv, int16_t key, SV* val_sv)
    CODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        if (h->readonly || shm_is_sealed(h)) croak("Data::HashMap::Shared::I16S: map is frozen (read-only)");
...
bool
add_ttl(SV* self_sv, int16_t key, SV* val_sv, UV ttl_sec)
    CODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        if (h->readonly || shm_is_sealed(h)) croak("Data::HashMap::Shared::I16S: map is frozen (read-only)");
        CK_U32(ttl_sec, "ttl", "Data::HashMap::Shared::I16S");
...
bool
update(SV* self_sv, int16_t key, SV* val_sv)
    CODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        if (h->readonly || shm_is_sealed(h)) croak("Data::HashMap::Shared::I16S: map is frozen (read-only)");
        EXTRACT_STR_VAL(val_sv);
...
bool
update_ttl(SV* self_sv, int16_t key, SV* val_sv, UV ttl_sec)
    CODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        if (h->readonly || shm_is_sealed(h)) croak("Data::HashMap::Shared::I16S: map is frozen (read-only)");
        CK_U32(ttl_sec, "ttl", "Data::HashMap::Shared::I16S");
...
SV*
swap(SV* self_sv, int16_t key, SV* val_sv)
    CODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        if (h->readonly || shm_is_sealed(h)) croak("Data::HashMap::Shared::I16S: map is frozen (read-only)");
        EXTRACT_STR_VAL(val_sv);
...
bool
cas(SV* self_sv, int16_t key, SV* expected_sv, SV* desired_sv)
    CODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        if (h->readonly || shm_is_sealed(h)) croak("Data::HashMap::Shared::I16S: map is frozen (read-only)");
...
SV*
cas_take(SV* self_sv, int16_t key, SV* expected_sv)
    CODE:
        EXTRACT_MAP("Data::HashMap::Shared::I16S", self_sv);
        if (h->readonly || shm_is_sealed(h)) croak("Data::HashMap::Shared::I16S: map is frozen (read-only)");
...
unlink(SV* self_or_class, ...)
    CODE:
        if (sv_isobject(self_or_class) && sv_derived_from(self_or_class, "Data::HashMap::Shared::I16S")) {
            EXTRACT_MAP("Data::HashMap::Shared::I16S", self_or_class);
            if (h->path) {
                SHM_TAINT_CHECK("Data::HashMap::Shared::I16S->unlink");
                REEXTRACT_MAP("Data::HashMap::Shared::I16S", self_or_class);
            }
            RETVAL = shm_unlink_sharded(h);
        } else {
            if (items < 2) croak("Usage: Data::HashMap::Shared::I16S->unlink($path)");
            SvGETMAGIC(ST(1));
            RETVAL = shm_unlink_path(shm_write_path_arg(aTHX_ ST(1), "path", "Data::HashMap::Shared::I16S", "Data::HashMap::Shared::I16S->unlink"));
        }
    OUTPUT:
        RETVAL
...
DESTROY(SV* self_sv)
    CODE:
        if (!sv_isobject(self_sv) || !sv_derived_from(self_sv, "Data::HashMap::Shared::I16S::Cursor")) return;
