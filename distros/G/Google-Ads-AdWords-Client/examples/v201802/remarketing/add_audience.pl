...
use Google::Ads::AdWords::v201802::BasicUserList;
use Google::Ads::AdWords::v201802::Selector;
use Google::Ads::AdWords::v201802::UserListConversionType;
...
sub add_audience {
  ...
  my $conversion_type =
    Google::Ads::AdWords::v201802::UserListConversionType->new({name => $name});

  # Create remarketing user list.
  my $user_list = Google::Ads::AdWords::v201802::BasicUserList->new({
      name            => $name,
