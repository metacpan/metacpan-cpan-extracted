package Proc::ProcessTable::Match::RSS;
...
Proc::ProcessTable::Match::RSS - Check if the resident set size of a process matches.
...
=head1 SYNOPSIS
    ...
    use Proc::ProcessTable::Match::RSS;
...
that is 'rss', which is a array of RSS values to match.

The RSS values can be prefixed with the equalities below for doing
...
sub match{
	...
	my $rss_int=0;
	while (defined( $self->{rss}[$rss_int] )){
