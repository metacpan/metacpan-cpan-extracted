#
# Test case for WebService::Recruit::HotPepperBeauty::SmallArea
#
...
my $service = new WebService::Recruit::HotPepperBeauty::SmallArea();

ok( ref $service, 'new WebService::Recruit::HotPepperBeauty::SmallArea()' );
...
# Test[0]
{
    ...
    my $res = new WebService::Recruit::HotPepperBeauty::SmallArea();
    ...
    ok( eval { $data->small_area }, 'Test[0]: small_area' );
    ok( eval { ref $data->small_area } eq 'ARRAY', 'Test[0]: small_area' );
    can_ok( $data->small_area->[0], 'code' );
    ok( eval { $data->small_area->[0]->code }, 'Test[0]: code' );
    can_ok( $data->small_area->[0], 'name' );
    ok( eval { $data->small_area->[0]->name }, 'Test[0]: name' );
    can_ok( $data->small_area->[0], 'middle_area' );
    ok( eval { $data->small_area->[0]->middle_area }, 'Test[0]: middle_area' );
    can_ok( $data->small_area->[0], 'service_area' );
    ok( eval { $data->small_area->[0]->service_area }, 'Test[0]: service_area' );
    can_ok( $data->small_area->[0]->middle_area, 'code' );
    ok( eval { $data->small_area->[0]->middle_area->code }, 'Test[0]: code' );
    can_ok( $data->small_area->[0]->middle_area, 'name' );
    ok( eval { $data->small_area->[0]->middle_area->name }, 'Test[0]: name' );
    can_ok( $data->small_area->[0]->service_area, 'code' );
    ok( eval { $data->small_area->[0]->service_area->code }, 'Test[0]: code' );
    can_ok( $data->small_area->[0]->service_area, 'name' );
    ok( eval { $data->small_area->[0]->service_area->name }, 'Test[0]: name' );
}
