package Chart::Plotly::Trace::Densitymapbox::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Densitymapbox::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Densitymapbox::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Densitymapbox::Hoverlabel - This attribute is one of the possible options for the trace densitymapbox.
