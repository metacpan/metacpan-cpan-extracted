package Chart::Plotly::Trace::Table::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Table::Hoverlabel::Font - This attribute is one of the possible options for the trace table.
