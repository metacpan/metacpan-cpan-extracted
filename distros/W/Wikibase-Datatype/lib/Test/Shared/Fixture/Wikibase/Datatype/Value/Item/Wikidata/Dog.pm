package Test::Shared::Fixture::Wikibase::Datatype::Value::Item::Wikidata::Dog;
...
Test::Shared::Fixture::Wikibase::Datatype::Value::Item::Wikidata::Dog - Test instance for Wikidata item value.
...
=for comment filename=fixture_create_and_print_value_item_wd_dog.pl
