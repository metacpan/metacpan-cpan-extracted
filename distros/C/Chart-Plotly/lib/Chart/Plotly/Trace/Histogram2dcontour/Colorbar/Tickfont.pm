package Chart::Plotly::Trace::Histogram2dcontour::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Histogram2dcontour::Colorbar::Tickfont - This attribute is one of the possible options for the trace histogram2dcontour.
