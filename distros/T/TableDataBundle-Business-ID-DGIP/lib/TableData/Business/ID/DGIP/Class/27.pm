package ## no critic: Modules::RequireFilenameMatchesPackage
    # hide from PAUSE
    TableDataRole::Business::ID::DGIP::Class::27;
...
around new => sub {
    ...
    my $filename = File::Basename::dirname(__FILE__) . '/../../../../../../share/class27.csv';
    unless (-f $filename) {
        require File::ShareDir;
        $filename = File::ShareDir::dist_file('TableDataBundle-Business-ID-DGIP', 'class27.csv');
    }
    $orig->(@_, filename=>$filename);
};

package TableData::Business::ID::DGIP::Class::27;
...
with 'TableDataRole::Business::ID::DGIP::Class::27';

our %STATS = ("num_columns",2,"num_rows",143); # STATS

1;
# ABSTRACT: List of products/services in class 27 ("floor mats; non-weaved wall decorations") in Indonesian DGIP (Directorate General of Intellectual Property)
...
TableDataRole::Business::ID::DGIP::Class::27 - List of products/services in class 27 ("floor mats; non-weaved wall decorations") in Indonesian DGIP (Directorate General of Intellectual Property)

=head1 VERSION

This document describes version 20230207.0.0 of TableDataRole::Business::ID::DGIP::Class::27 (from Perl distribution TableDataBundle-Business-ID-DGIP), released on 2023-02-07.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Business::ID::DGIP::Class::27;

 my $td = TableData::Business::ID::DGIP::Class::27->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Business::ID::DGIP::Class::27 --page

 # Get number of rows
 % tabledata --action count_rows Business::ID::DGIP::Class::27

See the L<tabledata> CLI's documentation for other available actions and options.

=head1 DESCRIPTION

Keyword: DJKI, Sistem Klasifikasi Merek. Alas lantai, alat-alat dinding bukan tenunan
