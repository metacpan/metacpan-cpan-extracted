...
# Trick PAUSE into indexing us properly: Old versions of PAUSE used
# Text::MicroMason::Commands::VERSION for Text::MicroMason::PL because
# they're in the same file, so PLP gained version 1.9 on PAUSE, and new
# versions won't be reindexed unless they have a greater version.
our $VERSION = "2.18";
