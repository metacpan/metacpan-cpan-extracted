package Faker::Plugin::CompanyBuzzwordType3;
...
method execute() {
  ...
  return $faker->process(['company', 'buzzword_type3']);
}
...
Faker::Plugin::CompanyBuzzwordType3

=cut

=head1 ABSTRACT

Company Buzzword Type3 Plugin for Faker
...
=head1 SYNOPSIS
  ...
  use Faker;
  use Faker::Plugin::CompanyBuzzwordType3;

  my $f = Faker->new;
  my $p = Faker::Plugin::CompanyBuzzwordType3->new(faker => $f);
...
This package provides methods for generating fake company buzzword type3 data.
...
The execute method returns a random fake company buzzword type3.
