...
Sah::SchemaR::uppercase_str - String containing only zero or more uppercase letters

=head1 VERSION

This document describes version 0.016 of Sah::SchemaR::uppercase_str (from Perl distribution Sah-Schemas-Str), released on 2023-10-23.
