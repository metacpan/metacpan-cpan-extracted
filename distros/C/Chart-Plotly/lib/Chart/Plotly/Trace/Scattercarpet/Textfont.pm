package Chart::Plotly::Trace::Scattercarpet::Textfont;
use Moose;
...
Chart::Plotly::Trace::Scattercarpet::Textfont - This attribute is one of the possible options for the trace scattercarpet.
