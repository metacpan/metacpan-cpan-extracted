...
OpenAPI::Client::OpenAI::Path::organization-usage-embeddings - Documentation for the /organization/usage/embeddings path.

=head1 DESCRIPTION

This document describes the API endpoint at C</organization/usage/embeddings>.

=head1 PATHS


=head2 C<GET /organization/usage/embeddings>
