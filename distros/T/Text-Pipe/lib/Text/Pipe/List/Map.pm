...
Text::Pipe::List::Map - Common text filter API

=head1 SYNOPSIS

    Text::Pipe::List::Map->new;
...
all elements have been processed by the coderef.

If the input is a single string, it just returns that string.

=back

Text::Pipe::List::Map inherits from L<Text::Pipe::Base>.
