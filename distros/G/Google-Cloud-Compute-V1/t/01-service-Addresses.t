...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Address Google::Cloud::Compute::V1::Compute::AddressAggregatedList Google::Cloud::Compute::V1::Compute::AddressList Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::AddressesClient->new( credentials => 'dummy' );
