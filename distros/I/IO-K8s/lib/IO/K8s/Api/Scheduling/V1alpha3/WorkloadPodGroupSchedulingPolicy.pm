...
IO::K8s::Api::Scheduling::V1alpha3::WorkloadPodGroupSchedulingPolicy - WorkloadPodGroupSchedulingPolicy defines the scheduling policy for a group of pods managed by a workload controller. Exactly one policy must be set.
