...
is $mtr->parse('A#m7'), 'vi7', 'vi7';
is $mtr->parse('A#m7b5'), 'vi7b5', 'vi7b5';
is $mtr->parse('A#min7'), 'vimin7', 'vimin7';
...
is $mtr->parse('Bbm7'), 'vi7', 'vi7';
is $mtr->parse('Bbm7b5'), 'vi7b5', 'vi7b5';
is $mtr->parse('Bbmin7'), 'vimin7', 'vimin7';
is $mtr->parse('Bm'), 'bvii', 'bvii';
is $mtr->parse('Bo'), 'bviio', 'bviio';
