...
Sah::SchemaR::perl::cellfunc::modname - Perl CellFunc::* module name without the prefix, e.g. File/stat_row

=head1 VERSION

This document describes version 0.001 of Sah::SchemaR::perl::cellfunc::modname (from Perl distribution Sah-SchemaBundle-CellFunc), released on 2024-12-10.
