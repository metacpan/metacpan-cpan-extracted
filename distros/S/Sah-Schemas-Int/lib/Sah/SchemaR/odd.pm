...
our $rschema = [
  "int",
  [
    { "div_by" => 2, "div_by.op" => "not", "summary" => "Odd number" },
  ],
  ["int"],
];
...
This document describes version 0.06 of Sah::SchemaR::odd (from Perl distribution Sah-Schemas-Int), released on 2016-07-22.
