package DateTime::Format::Epoch::TJD;
...
my $epoch = DateTime->new( year => 1968, month => 5, day => 24 );
...
DateTime::Format::Epoch::TJD - Convert DateTimes to/from Truncated Julian Days
...
converted to a DateTime object) to the Truncated Julian Day number. See
