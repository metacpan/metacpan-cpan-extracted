# AWS::Athena::NamedQuery generated from spec 34.0.0
...
package Cfn::Resource::Properties::AWS::Athena::NamedQuery {
  ...
  has WorkGroup => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Immutable');
}
...
Cfn::Resource::AWS::Athena::NamedQuery - Cfn resource for AWS::Athena::NamedQuery

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::Athena::NamedQuery.
