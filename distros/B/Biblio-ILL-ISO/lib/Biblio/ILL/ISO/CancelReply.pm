package Biblio::ILL::ISO::CancelReply;
...
Biblio::ILL::ISO::CancelReply is a derivation of the abstract 
Biblio::ILL::ISO::ISO object, and handles the Cancel-Reply message type.
...
Cancel-Reply message from a file (followed by a call to
...
sub set_answer {
    ...
    croak "missing answer flag" unless $parm;
