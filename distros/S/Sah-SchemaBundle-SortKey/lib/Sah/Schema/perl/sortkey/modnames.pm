...
1;
# ABSTRACT: Array of Perl SortKey::* module names without the prefix, e.g. ["Num::length", "Num::pattern_count"]
...
Sah::Schema::perl::sortkey::modnames - Array of Perl SortKey::* module names without the prefix, e.g. ["Num::length", "Num::pattern_count"]

=head1 VERSION

This document describes version 0.002 of Sah::Schema::perl::sortkey::modnames (from Perl distribution Sah-SchemaBundle-SortKey), released on 2024-03-07.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::sortkey::modnames*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::sortkey::modnames", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::sortkey::modnames", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::sortkey::modnames*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::sortkey::modnames*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::sortkey::modnames*', name=>'PerlSortkeyModnames')
     );
 }

 use My::Types qw(PerlSortkeyModnames);
 PerlSortkeyModnames->assert_valid($data);
