...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Module-Release-Git> or 
L<MetaCPAN|http://www.metacpan.org/module/Module::Release::Git>:

=over 4

=item *	L<http://search.cpan.org/dist/Module-Release-Git>

=item *	L<http://www.metacpan.org/module/Module::Release::Git>
...
=item *	L<https://github.com/briandfoy/module-release-git>
...
=item *	L<https://github.com/briandfoy/module-release-git/issues>
