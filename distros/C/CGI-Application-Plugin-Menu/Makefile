...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '    Exporter:          5' >> META_new.yml
	$(NOECHO) $(ECHO) '    HTML::Template:    2.9' >> META_new.yml
	$(NOECHO) $(ECHO) '    LEOCHARRE::DEBUG:  1.13' >> META_new.yml
	$(NOECHO) $(ECHO) '    Smart::Comments:   1' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="CGI-Application" VERSION="4,06,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Carp" VERSION="1,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Exporter" VERSION="5,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="HTML-Template" VERSION="2,9,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="LEOCHARRE-DEBUG" VERSION="1,13,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Smart-Comments" VERSION="1,0,0,0" />' >> $(DISTNAME).ppd
