...
=item User::Identity::Collection::Emails-E<gt>B<new>( [NAME], OPTIONS )
...
=item User::Identity::Collection::Emails-E<gt>B<type>()
...
This module is part of User-Identity distribution version 0.97,
...
at  Website: F<http://perl.overmeer.net/userid/>
...
Copyrights 2003-2017 by [Mark Overmeer <perl@overmeer.net>]. For other contributors see Changes.
