...
our @ISA = qw(Exporter EcoreFilePtr);
...
require XSLoader;
XSLoader::load('pEFL::Ecore::File');

sub add {
     my ($class,$path,$func,$data) = @_;
     my $id = pEFL::PLSide::register_ecore_file_monitor_cb($path, $func, $data);
     my $widget = _ecore_file_monitor_add($path, $func, $data, $id);
     return $widget;
}
 
*new = \&add;

package EcoreFilePtr;
