package Net::RRP::Response::n552;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n552::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n552::VERSION = '0.1';
...
Net::RRP::Response::n552 - the 552 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
