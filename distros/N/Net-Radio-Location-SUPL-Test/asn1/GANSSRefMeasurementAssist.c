...
static asn_TYPE_member_t asn_MBR_GANSSRefMeasurementAssist_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GANSSRefMeasurementAssist, ganssSignalID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GANSSRefMeasurementAssist, ganssRefMeasAssistList),
...
static asn_TYPE_tag2member_t asn_MAP_GANSSRefMeasurementAssist_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ganssSignalID at 1514 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ganssRefMeasAssistList at 1516 */
};
