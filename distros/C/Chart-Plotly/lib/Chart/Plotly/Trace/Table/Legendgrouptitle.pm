package Chart::Plotly::Trace::Table::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Table::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Table::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Table::Legendgrouptitle - This attribute is one of the possible options for the trace table.
