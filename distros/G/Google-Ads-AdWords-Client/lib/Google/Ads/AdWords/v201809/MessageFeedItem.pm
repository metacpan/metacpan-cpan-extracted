package Google::Ads::AdWords::v201809::MessageFeedItem;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::MessageFeedItem

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MessageFeedItem from the namespace https://adwords.google.com/api/adwords/cm/v201809.
