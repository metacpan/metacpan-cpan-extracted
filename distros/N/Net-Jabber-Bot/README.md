[![testsuite](https://github.com/cpan-authors/perl-net-jabber-bot/actions/workflows/testsuite.yml/badge.svg)](https://github.com/cpan-authors/perl-net-jabber-bot/actions/workflows/testsuite.yml)
...
- **new**
    ...
    - **conference\_server**
        ...
        Conference server (usually conference.$server\_name)
    ...
    - **gtalk**
        ...
        Boolean value. defaults to 0. Set to 1 for Google Talk connections. This automatically enables TLS and sets server\_host to 'gmail.com' (unless you provide your own server\_host).
    ...
    - **out\_messages\_per\_second**
        ...
        Limits the number of messages per second. Number must be > 0
...
- **Stop**
    ...
    Typically called from within the background\_function or message\_function callback.
...
[https://github.com/cpan-authors/perl-net-jabber-bot/issues](https://github.com/cpan-authors/perl-net-jabber-bot/issues).
...
- GitHub
    ...
    [https://github.com/cpan-authors/perl-net-jabber-bot](https://github.com/cpan-authors/perl-net-jabber-bot)
