...
1;
# ABSTRACT: List pairs supported by exchange
...
App::cryp::Cmd::Exchange::pairs - List pairs supported by exchange

=head1 VERSION

This document describes version 0.011 of App::cryp::Cmd::Exchange::pairs (from Perl distribution App-cryp-exchange), released on 2018-11-29.
