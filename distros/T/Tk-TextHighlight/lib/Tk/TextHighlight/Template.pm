package Tk::TextHighlight::Template;
...
Tk::TextHighlight::Template - a template for syntax highlighting plugins
...
Tk::TextHighlight::Template is a framework to assist authors of plugin modules.
All methods to provide highlighting in a Tk::TextHighlight widget are there, Just
no syntax definitions and callbacks. An instance of Tk::TextHighlight::Template 
