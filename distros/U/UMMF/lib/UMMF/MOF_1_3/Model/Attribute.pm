...
package UMMF::MOF_1_3::Model::Attribute;
...
=head2 C<isDerived> : UMMF::MOF_1_3::Model::Boolean 
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_3::Model::Attribute->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_3::Model::Attribute|UMMF::MOF_1_3::Model::Attribute>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_3::Model::Attribute')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_3::Model::Attribute->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_3::Model::Attribute->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_3::Model::Attribute' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_3::Model::Attribute|UMMF::MOF_1_3::Model::Attribute>.
...
sub __initialize
{
  ...
  $self->UMMF::MOF_1_3::Model::Attribute::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_3::Model::Attribute::___create(@args);
...
Returns the L<UMMF::MOF_1_3::Model::Boolean|UMMF::MOF_1_3::Model::Boolean> value of Attribute C<isDerived>.
