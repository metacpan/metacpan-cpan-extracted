package Chart::Plotly::Trace::Surface::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Surface::Legendgrouptitle::Font - This attribute is one of the possible options for the trace surface.
