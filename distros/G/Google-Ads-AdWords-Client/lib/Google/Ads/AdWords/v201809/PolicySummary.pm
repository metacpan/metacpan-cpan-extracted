package Google::Ads::AdWords::v201809::PolicySummary;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::PolicySummary

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PolicySummary from the namespace https://adwords.google.com/api/adwords/cm/v201809.
