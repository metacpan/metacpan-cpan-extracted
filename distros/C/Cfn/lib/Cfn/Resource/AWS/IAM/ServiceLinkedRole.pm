# AWS::IAM::ServiceLinkedRole generated from spec 14.3.0
...
Cfn::Resource::AWS::IAM::ServiceLinkedRole - Cfn resource for AWS::IAM::ServiceLinkedRole

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::IAM::ServiceLinkedRole.
