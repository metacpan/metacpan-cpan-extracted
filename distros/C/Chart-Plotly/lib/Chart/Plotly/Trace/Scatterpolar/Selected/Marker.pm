package Chart::Plotly::Trace::Scatterpolar::Selected::Marker;
use Moose;
...
Chart::Plotly::Trace::Scatterpolar::Selected::Marker - This attribute is one of the possible options for the trace scatterpolar.
