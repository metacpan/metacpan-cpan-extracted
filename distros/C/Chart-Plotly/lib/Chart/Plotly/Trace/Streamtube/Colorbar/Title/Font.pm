package Chart::Plotly::Trace::Streamtube::Colorbar::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Streamtube::Colorbar::Title::Font - This attribute is one of the possible options for the trace streamtube.
