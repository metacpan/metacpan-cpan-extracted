...
static int asn_MAP_FacilityNotSupParam_oms_1[] = { 0, 1, 2 };
...
static asn_TYPE_tag2member_t asn_MAP_FacilityNotSupParam_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 1, 0, 0 }, /* shapeOfLocationEstimateNotSupported at 205 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 2, 0, 0 } /* neededLcsCapabilityNotSupportedInServingNode at 206 */
};
static asn_SEQUENCE_specifics_t asn_SPC_FacilityNotSupParam_specs_1 = {
	...
	asn_MAP_FacilityNotSupParam_oms_1,	/* Optional members */
	1, 2,	/* Root/Additions */
	0,	/* Start extensions */
	4	/* Stop extensions */
};
