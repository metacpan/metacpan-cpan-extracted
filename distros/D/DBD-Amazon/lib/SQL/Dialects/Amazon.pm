...
=head1 SYNOPSIS
  ...
  see SQL::Parse, SQL::Squish, SQL::Amazon, DBD::Amazon

=head1 DESCRIPTION

Derived from SQL::Dialects::ANSI, with the CONTAINS operator added,
and CREATE/DROP removed.
