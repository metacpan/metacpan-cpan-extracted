package WebService::Edgecast::auto::Administration::Type::HttpSmallInfo;
BEGIN {
  $WebService::Edgecast::auto::Administration::Type::HttpSmallInfo::VERSION = '0.01.00';
}
use strict;
use warnings;
...
HttpSmallInfo from the namespace EC:WebServices.
