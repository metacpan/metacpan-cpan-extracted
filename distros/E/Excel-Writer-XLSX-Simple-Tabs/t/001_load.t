...
BEGIN { use_ok( 'Excel::Writer::XLSX::Simple::Tabs' ); }

my $ss = Excel::Writer::XLSX::Simple::Tabs->new ();
isa_ok ($ss, 'Excel::Writer::XLSX::Simple::Tabs');
isa_ok ($ss->book, 'Excel::Writer::XLSX');
my @sheet=();
...
isa_ok($sheet[0], "Excel::Writer::XLSX::Worksheet", 'sheet');
isa_ok($sheet[1], "Excel::Writer::XLSX::Worksheet", 'sheet');
isa_ok($sheet[2], "Excel::Writer::XLSX::Worksheet", 'sheet');
isa_ok($sheet[3], "Excel::Writer::XLSX::Worksheet", 'sheet');
...
my $header='';
$header=$ss->header;
is($header, "Content-type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet\n\n", 'header1');

$header=$ss->header(content_type=>"CT");
is($header, "Content-type: CT\n\n", 'header2');

$header=$ss->header(filename=>"FN");
is($header, qq{Content-type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet\nContent-Disposition: attachment; filename="FN";\n\n}, 'header3');
