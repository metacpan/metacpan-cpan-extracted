...
*{box-sizing:border-box;margin:0;padding:0;}.form-change-password{width:300px;background-color:#f2f2f2;padding:20px;border-radius:5px;box-shadow:0 0 10px rgba(0, 0, 0, 0.2);}.form-change-password fieldset{border:none;padding:0;margin-bottom:20px;}.form-change-password legend{font-weight:bold;margin-bottom:10px;}.form-change-password p{margin:0;padding:10px 0;}.form-change-password label{display:block;font-weight:bold;margin-bottom:5px;}.form-change-password input[type="text"],.form-change-password input[type="password"]{width:100%;padding:8px;border:1px solid #ccc;border-radius:3px;}.form-change-password button[type="submit"]{width:100%;padding:10px;background-color:#4CAF50;color:#fff;border:none;border-radius:3px;cursor:pointer;}.form-change-password button[type="submit"]:hover{background-color:#45a049;}.form-change-password .messages{text-align:center;}.error{color:red;}.info{color:blue;}.container{display:flex;align-items:center;justify-content:center;height:100vh;}
...
$app = Plack::App::ChangePassword->new(
	...
	'text' => {
		'cze' => {
			'change_password' => decode_utf8('Změna hesla'),
			'old_password_label' => decode_utf8('Staré heslo'),
			'password1_label' => decode_utf8('Nové heslo'),
			'password2_label' => decode_utf8('Potvrdit nové heslo'),
			'submit' => decode_utf8('Ulož nové heslo'),
		},
	},
);
$test = Plack::Test->create($app);
