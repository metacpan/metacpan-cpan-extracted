package Google::Ads::AdWords::v201705::AdGroupService::AdGroupServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201705::TypeMaps::AdGroupService
    if not Google::Ads::AdWords::v201705::TypeMaps::AdGroupService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201705/AdGroupService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201705::TypeMaps::AdGroupService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201705::AdGroupService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201705::AdGroupService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201705::AdGroupService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201705::AdGroupService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201705::AdGroupService::query )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201705/AdGroupService.
...
Returns a L<Google::Ads::AdWords::v201705::AdGroupService::getResponse|Google::Ads::AdWords::v201705::AdGroupService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201705::AdGroupService::mutateResponse|Google::Ads::AdWords::v201705::AdGroupService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201705::AdGroupService::mutateLabelResponse|Google::Ads::AdWords::v201705::AdGroupService::mutateLabelResponse> object.
...
Returns a L<Google::Ads::AdWords::v201705::AdGroupService::queryResponse|Google::Ads::AdWords::v201705::AdGroupService::queryResponse> object.
