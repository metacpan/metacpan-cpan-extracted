...
package WebService::Edgecast::auto::Administration::Element::OriginShieldPOPsGet;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::OriginShieldPOPsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('OriginShieldPOPsGet');
...
WebService::Edgecast::auto::Administration::Element::OriginShieldPOPsGet
...
OriginShieldPOPsGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::OriginShieldPOPsGet->new($data);
