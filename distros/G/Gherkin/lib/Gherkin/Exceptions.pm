...
$Gherkin::Exceptions::VERSION = '4.0.0';
use overload
    q{""}    => 'stringify',
    fallback => 1;
...
$Gherkin::Exceptions::SingleParser::VERSION = '4.0.0';
use base 'Gherkin::Exceptions::Parser';
...
$Gherkin::Exceptions::NoSuchLanguage::VERSION = '4.0.0';
...
$Gherkin::Exceptions::AstBuilder::VERSION = '4.0.0';
use base 'Gherkin::Exceptions::SingleParser';
...
$Gherkin::Exceptions::UnexpectedEOF::VERSION = '4.0.0';
use base 'Gherkin::Exceptions::SingleParser';
...
$Gherkin::Exceptions::UnexpectedToken::VERSION = '4.0.0';
use base 'Gherkin::Exceptions::SingleParser';
