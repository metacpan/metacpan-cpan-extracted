...
package PDF::API3::Compat::API2::Resource::ColorSpace;
...
BEGIN {
    ...
    @ISA = qw(PDF::API3::Compat::API2::Basic::PDF::Array);
...
=item $cs = PDF::API3::Compat::API2::Resource::ColorSpace->new $pdf, $key, %parameters
...
=item $cs = PDF::API3::Compat::API2::Resource::ColorSpace->new_api $api, $name
