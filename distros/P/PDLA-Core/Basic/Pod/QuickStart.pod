...
To find their location, try the following:
 ...
 pdl> foreach ( map{"$_/PDLA/HtmlDocs"}@INC ) { p "$_\n" if -d $_ }  
...
or L<pdl2|PDLA::Perldl2> for details.
...
to PDLA.  If the latest Readlines/ReadKey modules have been installed C<pdl2>
...
e.g.:
 ...
 Found docs database /home/pdl/dev/lib/perl5/site_perl/PDLA/pdldoc.db
