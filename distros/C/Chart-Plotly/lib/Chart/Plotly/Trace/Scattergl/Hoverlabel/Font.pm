package Chart::Plotly::Trace::Scattergl::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Scattergl::Hoverlabel::Font - This attribute is one of the possible options for the trace scattergl.
