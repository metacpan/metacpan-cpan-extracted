...
Dockeri toiminguid haldab skript C<dozo>, mida saab kasutada ka iseseisva käsuna. Skript C<dozo> toetab püsivate konteinerisätete jaoks konfiguratsioonifaili C<.dozorc>.
...
Teek C<getoptlong.sh> kasutatakse valikute parsimiseks skriptides C<xlate> ja C<dozo>.
