...
package Google::Ads::AdWords::v201609::CustomerExtensionSettingService::get;
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201609::CustomerExtensionSettingService::get->new($data);
