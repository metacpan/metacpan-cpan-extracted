package Chart::Plotly::Trace::Bar::Marker::Colorbar::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Bar::Marker::Colorbar::Title::Font - This attribute is one of the possible options for the trace bar.
