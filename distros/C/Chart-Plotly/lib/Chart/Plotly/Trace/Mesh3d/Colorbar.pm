package Chart::Plotly::Trace::Mesh3d::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Mesh3d::Colorbar::Tickfont;
use Chart::Plotly::Trace::Mesh3d::Colorbar::Tickformatstop;
use Chart::Plotly::Trace::Mesh3d::Colorbar::Titlefont;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Mesh3d::Colorbar::Tickfont", );
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Mesh3d::Colorbar::Tickformatstop]", );
...
has titlefont => ( is  => "rw",
                   isa => "Maybe[HashRef]|Chart::Plotly::Trace::Mesh3d::Colorbar::Titlefont", );
...
Chart::Plotly::Trace::Mesh3d::Colorbar - This attribute is one of the possible options for the trace mesh3d.
