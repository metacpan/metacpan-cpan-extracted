package Bencher::ScenarioR::PerinciSubUtil::Startup;
  ...
  [
    ...
    ],
    {
      "func.bencher_args"              => {
                                            ...
                                            scenario_module => "PerinciSubUtil::Startup",
                                          },
      ...
      "func.elapsed_time"              => 0.307440996170044,
      "func.module_startup"            => 1,
      "func.module_versions"           => {
                                            "__PACKAGE__" => 1.034,
                                            "Bencher::Scenario::PerinciSubUtil::Startup" => undef,
                                            "Benchmark::Dumb" => "0.10",
      ...
      "func.precision"                 => 0,
      "func.scenario_module"           => "Bencher::Scenario::PerinciSubUtil::Startup",
      "func.scenario_module_md5sum"    => "f9fdb6d4340c93eb64fa1ca2aa5afb8a",
      "func.scenario_module_mtime"     => 1485832179,
      "func.scenario_module_sha1sum"   => "02ec0090d9c734557b94c2aaa4f3e6c4bef346ff",
      "func.scenario_module_sha256sum" => "e9a229c5ce3fbea7d4b392b98989c195db2cc64b059f73e14c952667e23519b3",
      "func.time_end"                  => 1485832189.61331,
      "func.time_factor"               => 1000,
      "func.time_start"                => 1485832189.30587,
      "table.field_aligns"             => [
                                            "left",
                                            "left",
                                            "left",
