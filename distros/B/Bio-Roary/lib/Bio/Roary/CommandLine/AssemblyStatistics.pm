...
$Bio::Roary::CommandLine::AssemblyStatistics::VERSION = '3.11.0';
...
Bio::Roary::CommandLine::AssemblyStatistics - Given a spreadsheet of gene presence and absence calculate some statistics
