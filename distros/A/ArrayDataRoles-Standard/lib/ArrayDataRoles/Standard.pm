...
ArrayDataRoles::Standard - Standard set of roles for ArrayData

=head1 VERSION

This document describes version 0.001 of ArrayDataRoles::Standard (from Perl distribution ArrayDataRoles-Standard), released on 2021-04-13.
