...
aegis_conf_new_file_undo_command.pl - new_file_undo aegis hook.
...
=head1 DETAILS
	...
	MANIFEST: aegis_conf_new_file_undo_command.pl
	PROJECT: meta
	VERSION: 0.01

=head1 SYNOPSIS

	aegis_conf_new_file_undo_command.pl [options]

=head1 DESCRIPTION

This program handles the new_file_undo aegis actions.
