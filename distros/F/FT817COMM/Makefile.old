...
DISTVNAME = Ham-Device-FT817COMM-0.9.0_01
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version:            0.9.0_01' >> META_new.yml
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.9.0_01">' > $(DISTNAME).ppd
