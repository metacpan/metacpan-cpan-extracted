...
package TeX::Hyphen::Pattern::Nl v1.1.7;
use strict;
use warnings;
use 5.014000;
use utf8;
...
sub version {
    return $TeX::Hyphen::Pattern::Nl::VERSION;
}
...
=for stopwords CTAN Ipenburg Nl

=head1 NAME

TeX::Hyphen::Pattern::Nl - class for hyphenation in locale Nl
