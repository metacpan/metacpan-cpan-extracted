...
App::nrand - Generate normally distributed random numbers

=head1 VERSION

This document describes version 0.002 of App::nrand (from Perl distribution App-nrand), released on 2019-03-07.

=head1 SYNOPSIS

See the command-line script L<nrand>.
...
L<Math::Random::NormalDistribution>
