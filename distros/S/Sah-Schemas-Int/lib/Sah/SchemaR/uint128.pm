...
our $rschema = ["int",[{max=>3.40282366920938e+38,min=>0,summary=>"128-bit unsigned integer"}],["int"]];
...
This document describes version 0.071 of Sah::SchemaR::uint128 (from Perl distribution Sah-Schemas-Int), released on 2018-04-03.
