#
# Test case for WebService::Recruit::HotPepperBeauty::HairImage
#
...
my $service = new WebService::Recruit::HotPepperBeauty::HairImage();

ok( ref $service, 'new WebService::Recruit::HotPepperBeauty::HairImage()' );
...
# Test[0]
{
    ...
    my $res = new WebService::Recruit::HotPepperBeauty::HairImage();
    ...
    ok( eval { $data->hair_image }, 'Test[0]: hair_image' );
    ok( eval { ref $data->hair_image } eq 'ARRAY', 'Test[0]: hair_image' );
    can_ok( $data->hair_image->[0], 'code' );
    ok( eval { $data->hair_image->[0]->code }, 'Test[0]: code' );
    can_ok( $data->hair_image->[0], 'name' );
    ok( eval { $data->hair_image->[0]->name }, 'Test[0]: name' );
}
