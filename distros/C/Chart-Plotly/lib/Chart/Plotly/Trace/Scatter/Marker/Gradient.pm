package Chart::Plotly::Trace::Scatter::Marker::Gradient;
use Moose;
...
Chart::Plotly::Trace::Scatter::Marker::Gradient - This attribute is one of the possible options for the trace scatter.
