...
on Linux by [Travis](https://travis-ci.org/houseabsolute/Devel-StackTrace) and on Windows by [AppVeyor](https://ci.appveyor.com/project/autarch/Devel-StackTrace).
