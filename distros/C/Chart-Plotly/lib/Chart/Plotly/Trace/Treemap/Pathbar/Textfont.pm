package Chart::Plotly::Trace::Treemap::Pathbar::Textfont;
use Moose;
...
has description => ( is      => "ro",
                     default => "Sets the font used inside `pathbar`.", );
...
Chart::Plotly::Trace::Treemap::Pathbar::Textfont - This attribute is one of the possible options for the trace treemap.
