...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::Policy Google::Cloud::Compute::V1::Compute::ReservationBlocksGetResponse Google::Cloud::Compute::V1::Compute::ReservationBlocksListResponse Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
package main;
use Google::Cloud::Compute::V1::ReservationBlocksClient;

my $client = Google::Cloud::Compute::V1::ReservationBlocksClient->new( credentials => 'dummy' );
