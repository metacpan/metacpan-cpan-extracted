## -*- perl -*-
##----------------------------------------------------------------------------
## Markdown Parser Only - ~/lib/Markdown/Parser/StrikeThrough.pm
## Version v0.2.0
...
##----------------------------------------------------------------------------
package Markdown::Parser::StrikeThrough;
BEGIN
{
    use strict;
    use warnings;
...
This class represents a strike-through formatting. It is used by L<Markdown::Parser> and inherits from L<Markdown::Parser::Element>
...
Returns a string representation of the strike-through formatted in L<pod|perlpod>.
