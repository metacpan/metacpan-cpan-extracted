...
IMDB::Local::TVShow - Object representation of TVShow information.
...
Perhaps a little code snippet.
    ...
    use IMDB::Local::TVShow;

    my $foo = IMDB::Local::TVShow->new();
    ...
