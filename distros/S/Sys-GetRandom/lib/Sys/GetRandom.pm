...
MidnightBSD, and Illumos). It also supports OpenBSD by emulating C<getrandom>
using L<getentropy(2)>. It exports (on request) two functions and two
constants.
...
On OpenBSD, these flags are ignored and I<LENGTH> must be 256 or less.
