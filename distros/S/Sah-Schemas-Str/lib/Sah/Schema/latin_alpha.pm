...
This document describes version 0.016 of Sah::Schema::latin_alpha (from Perl distribution Sah-Schemas-Str), released on 2023-10-23.
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"latin_alpha*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('latin_alpha*', name=>'LatinAlpha')
     );
 }

 use My::Types qw(LatinAlpha);
 LatinAlpha->assert_valid($data);
