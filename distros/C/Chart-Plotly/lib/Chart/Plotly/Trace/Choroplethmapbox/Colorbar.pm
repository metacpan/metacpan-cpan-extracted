package Chart::Plotly::Trace::Choroplethmapbox::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Choroplethmapbox::Colorbar::Tickfont;
use Chart::Plotly::Trace::Choroplethmapbox::Colorbar::Tickformatstop;
use Chart::Plotly::Trace::Choroplethmapbox::Colorbar::Title;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Choroplethmapbox::Colorbar::Tickfont", );
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Choroplethmapbox::Colorbar::Tickformatstop]",
);
...
has title => ( is  => "rw",
               isa => "Maybe[HashRef]|Chart::Plotly::Trace::Choroplethmapbox::Colorbar::Title", );
...
Chart::Plotly::Trace::Choroplethmapbox::Colorbar - This attribute is one of the possible options for the trace choroplethmapbox.
