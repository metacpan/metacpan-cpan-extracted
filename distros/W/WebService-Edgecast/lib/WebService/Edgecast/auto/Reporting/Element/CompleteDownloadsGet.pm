...
package WebService::Edgecast::auto::Reporting::Element::CompleteDownloadsGet;
BEGIN {
  $WebService::Edgecast::auto::Reporting::Element::CompleteDownloadsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CompleteDownloadsGet');
...
WebService::Edgecast::auto::Reporting::Element::CompleteDownloadsGet
...
CompleteDownloadsGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Reporting::Element::CompleteDownloadsGet->new($data);
