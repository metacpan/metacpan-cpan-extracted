...
This document describes version 0.79 of Perinci::Examples::CSV (from Perl distribution Perinci-Examples), released on 2017-01-12.
...
=head2 output_table() -> [status, msg, result, meta]
