package Net::RRP::Response::n547;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n547::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n547::VERSION = '0.1';
...
Net::RRP::Response::n547 - the 547 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
