package Chart::Plotly::Trace::Bar::Marker::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Bar::Marker::Colorbar::Titlefont;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Bar::Marker::Colorbar::Tickfont", );
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Bar::Marker::Colorbar::Tickformatstop]", );
...
has titlefont => ( is  => "rw",
                   isa => "Maybe[HashRef]|Chart::Plotly::Trace::Bar::Marker::Colorbar::Titlefont", );
...
Chart::Plotly::Trace::Bar::Marker::Colorbar - This attribute is one of the possible options for the trace bar.
