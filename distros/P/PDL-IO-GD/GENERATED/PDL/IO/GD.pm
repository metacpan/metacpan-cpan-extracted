...
read_true_png does not process bad values.
It will set the bad-value flag of all output ndarrays if the flag is set for any of the input ndarrays.
...
*read_true_png = \&PDL::read_true_png;
...
read_png does not process bad values.
It will set the bad-value flag of all output ndarrays if the flag is set for any of the input ndarrays.
...
*_gd_image_to_rpic_true = \&PDL::_gd_image_to_rpic_true;
...
*_gd_image_to_rpic = \&PDL::_gd_image_to_rpic;
...
read_png_lut does not process bad values.
It will set the bad-value flag of all output ndarrays if the flag is set for any of the input ndarrays.
...
write_gif_anim does not process bad values.
It will set the bad-value flag of all output ndarrays if the flag is set for any of the input ndarrays.
...
*write_gif_anim = \&PDL::write_gif_anim;
