# AWS::ApiGateway::Account generated from spec 14.3.0
...
Cfn::Resource::AWS::ApiGateway::Account - Cfn resource for AWS::ApiGateway::Account

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::ApiGateway::Account.
