...
=head1 SYNOPSIS
    ...
    my $multi = XLog::Multi->new([
        ...
        {logger => XLog::File->new({file => "error.log"}), min_level => XLog::WARNING, formatter => XLog::Formatter::Pattern->new("[%L] %t: %m")},
    ]);
...
Formatter object for this backend. If not specified, will use main formatter (XLog::set_formatter).
