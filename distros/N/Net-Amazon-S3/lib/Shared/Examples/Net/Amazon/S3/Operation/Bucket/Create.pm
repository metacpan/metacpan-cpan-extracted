...
$Shared::Examples::Net::Amazon::S3::Operation::Bucket::Create::VERSION = '0.88';
use strict;
use warnings;
...
Shared::Examples::Net::Amazon::S3::Operation::Bucket::Create - used for testing and as example
