...
my $tap     = slurp ("t/backcompat/tap_archive_headers_kvm.tap");
...
$tap     = slurp ("t/backcompat/tap_archive_headers_xen.tap");
...
$tap     = slurp ("t/backcompat/tap_archive_headers_simnow.tap");
$harness = new Tapper::TAP::Harness( tap => $tap );
