...
#
#   Modified for PDF::API3::Compat::API2 by Alfred Reibenschuh <alfredreibenschuh@gmx.net>
#
...
the C<PDF::API3::Compat::API2::Basic::PDF::File> object (so if you need to save, be sure to do it before
calling this method).

B<NOTE>, that it is important that you call this method on any
C<PDF::API3::Compat::API2::Basic::PDF::File> object when you wish to destruct it and free up its memory.
...
able to do anything else with the C<PDF::API3::Compat::API2::Basic::PDF::File> object; it'll have B<no>
internal state whatsoever.

B<Developer note:> As part of the brute-force cleanup done here, this method
will throw a warning message whenever unexpected key values are found within
the C<PDF::API3::Compat::API2::Basic::PDF::File> object.  This is done to help ensure that any unexpected
