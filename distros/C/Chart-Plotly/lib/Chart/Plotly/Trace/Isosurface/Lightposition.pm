package Chart::Plotly::Trace::Isosurface::Lightposition;
use Moose;
...
has x => ( is            => "rw",
           isa           => "Num",
           documentation => "Numeric vector, representing the X coordinate for each vertex.",
);

has y => ( is            => "rw",
           isa           => "Num",
           documentation => "Numeric vector, representing the Y coordinate for each vertex.",
);

has z => ( is            => "rw",
           isa           => "Num",
           documentation => "Numeric vector, representing the Z coordinate for each vertex.",
);
...
Chart::Plotly::Trace::Isosurface::Lightposition - This attribute is one of the possible options for the trace isosurface.
