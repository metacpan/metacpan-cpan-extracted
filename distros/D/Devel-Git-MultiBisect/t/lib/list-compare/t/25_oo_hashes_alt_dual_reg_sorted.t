...
### new ###
my $lc = List::Compare->new( { lists => [ \%h0, \%h1 ] } );
...
### new ###
my $lc_s  = List::Compare->new( { lists => [ \%h2, \%h3 ] } );
...
### new ###
my $lc_e  = List::Compare->new( { lists => [ \%h3, \%h4 ] } );
...
### new ###
my $lc_dj  = List::Compare->new( { lists => [ \%h4, \%h8 ] } );
...
eval { $lc_bad = List::Compare->new( { lists => [ \%h0 ] } ) };
