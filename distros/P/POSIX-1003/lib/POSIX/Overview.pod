...
languages.  You may take a look at various implementations of C<gettext>,
like L<Locale::gettext>, L<File::Gettext>, L<Locale::TextDomain>, and
L<Log::Report::Lexicon>
...
See also the many logging frameworks, like L<Log::Log4perl>,
L<Log::Dispatch>, or L<Log::Report>.
...
Non-standard, but commonly available.  See also L<POSIX::1003::User>.
