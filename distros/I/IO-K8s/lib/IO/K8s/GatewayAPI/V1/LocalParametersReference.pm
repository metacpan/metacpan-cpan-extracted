...
IO::K8s::GatewayAPI::V1::LocalParametersReference - ParametersRef is a reference to a resource that contains the configuration parameters corresponding to the Gateway.
