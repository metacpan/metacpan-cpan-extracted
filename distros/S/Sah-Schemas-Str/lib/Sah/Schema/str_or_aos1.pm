...
Sah::Schema::str_or_aos1 - String or array (1+ length) of (defined) string

=head1 VERSION

This document describes version 0.016 of Sah::Schema::str_or_aos1 (from Perl distribution Sah-Schemas-Str), released on 2023-10-23.
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("str_or_aos1*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"str_or_aos1*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('str_or_aos1*', name=>'StrOrAos1')
     );
 }

 use My::Types qw(StrOrAos1);
 StrOrAos1->assert_valid($data);
