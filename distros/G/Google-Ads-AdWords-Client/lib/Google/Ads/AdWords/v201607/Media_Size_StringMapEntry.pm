package Google::Ads::AdWords::v201607::Media_Size_StringMapEntry;
use strict;
use warnings;
...
Media_Size_StringMapEntry from the namespace https://adwords.google.com/api/adwords/cm/v201607.
