...
#
# perl imap_query_sample.pl --machine imap.gmail.com --user joe2774 
#
# Set PASSWD_KEYRING_DEBUG=1 environment variable to get details
# of what is picked and why.
