...
$RDF::Cowl::DataCard::VERSION = '1.0.0';
# CowlDataCard
use strict;
use warnings;
...
RDF::Cowl::DataCard - Represents DataMinCardinality, DataMaxCardinality and DataExactCardinality in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::DataCard>
