...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Mac-Errors> or 
L<MetaCPAN|http://www.metacpan.org/module/Mac::Errors>:

=over 4

=item *	L<http://search.cpan.org/dist/Mac-Errors>

=item *	L<http://www.metacpan.org/module/Mac::Errors>
