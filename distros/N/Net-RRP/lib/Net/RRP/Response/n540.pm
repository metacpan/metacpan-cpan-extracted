package Net::RRP::Response::n540;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n540::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n540::VERSION = '0.1';
...
Net::RRP::Response::n540 - the 540 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
