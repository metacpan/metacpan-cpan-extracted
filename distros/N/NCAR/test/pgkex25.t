...
&NCAR::gsplci(2);
#
#  Initialize the AUTOGRAPH entry EZXY so that the frame is not advanced.
#
&NCAR::displa(2,0,1);
#
#  Tell EZXY that the SET ordering of the window is to be used.
#
&NCAR::anotat(' ',' ',1,4,0,' ');
#
...
&NCAR::pcseti( 'FN', 25 );
&NCAR::pcseti( 'CC', 2 );
&NCAR::plchhq(.5,.09,'X Axis Reversal with SPPS',.025,0.,0.);
#
&NCAR::frame;
...
rename 'gmeta', 'ncgm/pgkex25.ncgm';
