package Google::Cloud::Bigquery::V2::ModelServiceClient;
...
1; # End of Google::Cloud::Bigquery::V2::ModelServiceClient
...
C<Google::Cloud::Bigquery::V2::ModelServiceClient> is an auto-generated client library for Google Cloud Services.
