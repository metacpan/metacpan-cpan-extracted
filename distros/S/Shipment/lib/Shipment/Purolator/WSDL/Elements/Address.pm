...
package Shipment::Purolator::WSDL::Elements::Address;
$Shipment::Purolator::WSDL::Elements::Address::VERSION = '3.04';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    __PACKAGE__->__set_name('Address');
...
Shipment::Purolator::WSDL::Elements::Address
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDL::Elements::Address->new($data);
