...
=head1 SYNOPSIS
  ...
  # Create a UserAgent with persistable cookies and load existing cookies
  my $cj = Mojo::UserAgent::CookieJar->with_roles('+Persistent')->new;
  $cj->load;
  my $ua = Mojo::UserAgent->new(cookie_jar => $cj);
  
  # After cookie adding response e.g. logging into a website
  $cj->save;
