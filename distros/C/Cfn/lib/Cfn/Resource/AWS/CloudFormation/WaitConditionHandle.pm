...
Cfn::Resource::AWS::CloudFormation::WaitConditionHandle - Cfn resource for AWS::CloudFormation::WaitConditionHandle

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::CloudFormation::WaitConditionHandle.
