...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::InstanceGroupManagerResizeRequest Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::RegionInstanceGroupManagerResizeRequestsListResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::RegionInstanceGroupManagerResizeRequestsClient->new( credentials => 'dummy' );
