package Bio::VertRes::Config::Recipes::VirusRnaSeqExpressionUsingTophat;
...
Bio::VertRes::Config::Recipes::VirusRnaSeqExpressionUsingTophat - Standard snp calling pipeline for virus
...
RNA seq expression with Tophat
   use Bio::VertRes::Config::Recipes::VirusRnaSeqExpressionUsingTophat;

   my $obj = Bio::VertRes::Config::Recipes::VirusRnaSeqExpressionUsingTophat->new( 
     database => 'abc', 
