...
$w->element( 'Button',   'my_button', )->value(1)->retain_default(1);
$w->element( 'Checkbox', 'my_checkbox' )->value(1)->checked('checked')
    ->retain_default(1);
$w->element( 'Checkbox', 'my_checkbox' )->value(0)->retain_default(1);
$w->element( 'Hidden',   'my_hidden' )->value(1)->retain_default(1);
$w->element( 'Password', 'my_password' )->value(1)->fill(1)->retain_default(1);
$w->element( 'Radio',    'my_radio' )->value(1)->checked('checked')
    ->retain_default(1);
$w->element( 'Radio', 'my_radio' )->value(0)->retain_default(1);
$w->element( 'RadioGroup', 'my_radiogroup' )->values( 1, 0 )->checked(1)
    ->retain_default(1);
$w->element( 'Reset',  'my_reset' )->value(1)->retain_default(1);
$w->element( 'Select', 'my_select' )
    ->options( 0 => 'unsubscribed', 1 => 'subscribed' )->selected(1)
    ->retain_default(1);
$w->element( 'Submit',    'my_submit' )->value(1)->retain_default(1);
$w->element( 'Textarea',  'my_textarea' )->value(1)->retain_default(1);
$w->element( 'Textfield', 'my_textfield' )->value(1)->retain_default(1);
