package Google::Ads::AdWords::v201702::BudgetOptimizerBiddingScheme;
use strict;
use warnings;
...
BudgetOptimizerBiddingScheme from the namespace https://adwords.google.com/api/adwords/cm/v201702.
