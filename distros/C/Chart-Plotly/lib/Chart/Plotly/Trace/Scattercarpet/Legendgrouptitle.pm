package Chart::Plotly::Trace::Scattercarpet::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Scattercarpet::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattercarpet::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Scattercarpet::Legendgrouptitle - This attribute is one of the possible options for the trace scattercarpet.
