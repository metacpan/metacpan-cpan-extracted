...
# {{{ to_string
sub num2jpn_cardinal :Export { goto &to_string }
...
=head1 SYNOPSIS
  ...
  use Lingua::JPN::Num2Word;

  my @words = Lingua::JPN::Num2Word::to_string(1234);
...
C<Lingua::JPN::Num2Word> translates numbers into Japanese.
...
C<Term::ReadKey>, which is available from CPAN:
    ...
    use Term::ReadKey;
    use Getopt::Std;
    use Lingua::JPN::Num2Word qw(to_string);
...
C<Lingua::JPN::Num2Word::Tall>,
C<Lingua::JPN::Num2Word::Flat>,
C<Lingua::JPN::Num2Word::Person>,
C<Lingua::JPN::Num2Word::Misc> to cover the
