...
our $rschema = ["str",[{summary=>"Filesystem directory name","x.completion"=>["dirname"]}],["str"]];
...
This document describes version 0.008 of Sah::SchemaR::dirname (from Perl distribution Sah-Schemas-Path), released on 2019-07-25.
