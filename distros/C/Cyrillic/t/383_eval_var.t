...
# eval $var has eval "..."
$var = <<'END';
eval Cyrillic::escape " if ('щС' =~ /[с]/i) { return 1 } else { return 0 } "
END
if (eval Cyrillic::escape $var) {
...
$var = <<'END';
eval Cyrillic::escape qq{ if ('щС' =~ /[с]/i) { return 1 } else { return 0 } }
END
if (eval Cyrillic::escape $var) {
...
# eval $var has eval '...'
$var = <<'END';
eval Cyrillic::escape ' if (qq{щС} =~ /[с]/i) { return 1 } else { return 0 } '
END
if (eval Cyrillic::escape $var) {
...
# eval $var has eval q{...}
$var = <<'END';
eval Cyrillic::escape q{ if ('щС' =~ /[с]/i) { return 1 } else { return 0 } }
END
if (eval Cyrillic::escape $var) {
...
# eval $var has eval {...}
$var = <<'END';
eval { if ('щС' =~ /[с]/i) { return 1 } else { return 0 } }
END
if (eval Cyrillic::escape $var) {
