...
# Windows1257::eval <<'END' has Windows1257::eval "..."
if (Windows1257::eval <<'END') {
...
# Windows1257::eval <<'END' has Windows1257::eval qq{...}
if (Windows1257::eval <<'END') {
...
# Windows1257::eval <<'END' has Windows1257::eval q{...}
if (Windows1257::eval <<'END') {
...
# Windows1257::eval <<'END' has Windows1257::eval $var
my $var = q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } };
if (Windows1257::eval <<'END') {
Windows1257::eval $var
END
...
# Windows1257::eval <<'END' has Windows1257::eval (omit)
