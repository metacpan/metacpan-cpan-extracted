...
package Shipment::Purolator::WSDL::Elements::CreateShipmentRequestContainer;
$Shipment::Purolator::WSDL::Elements::CreateShipmentRequestContainer::VERSION = '3.02';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    __PACKAGE__->__set_name('CreateShipmentRequestContainer');
...
Shipment::Purolator::WSDL::Elements::CreateShipmentRequestContainer
...
CreateShipmentRequestContainer from the namespace http://purolator.com/pws/datatypes/v1.
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDL::Elements::CreateShipmentRequestContainer->new($data);
