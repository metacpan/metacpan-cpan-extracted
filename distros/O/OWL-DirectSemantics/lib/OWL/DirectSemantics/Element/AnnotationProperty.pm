package OWL::DirectSemantics::Element::AnnotationProperty;

BEGIN {
	$OWL::DirectSemantics::Element::AnnotationProperty::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::AnnotationProperty::VERSION   = '0.001';
};

use constant MAPPING_CODE => 'AP';
...
OWL::DirectSemantics::Element::AnnotationProperty - represents an OWL AnnotationProperty

=head1 DESCRIPTION

This class represents the AnnotationProperty element in OWL Direct Semantics.
