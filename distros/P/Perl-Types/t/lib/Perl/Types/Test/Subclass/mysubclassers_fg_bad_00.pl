...
my Perl::Types::Test::Subclass::MySubclassersFG_Good_arrayref $foo_a = [];
my Perl::Types::Test::Subclass::MySubclassersFG_Good_hashref $foo_h = {};
my Perl::Types::Test::Subclass::MySubclasserF_Good_arrayref $bar_a = [];
my Perl::Types::Test::Subclass::MySubclasserF_Good_hashref $bar_h = {};
my Perl::Types::Test::Subclass::MySubclasserG_Good_arrayref $bat_a = [];
my Perl::Types::Test::Subclass::MySubclasserG_Good_hashref $bat_h = {};
print 'no errors', "\n";
