...
use Google::Ads::AdWords::v201309::AgeRange;
use Google::Ads::AdWords::v201309::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201309::Gender;
...
sub add_demographic_targeting_criteria {
  ...
  my $gender_male = Google::Ads::AdWords::v201309::Gender->new({
    id => GENDER_MALE
  });
  ...
  my $age_range = Google::Ads::AdWords::v201309::AgeRange->new({
