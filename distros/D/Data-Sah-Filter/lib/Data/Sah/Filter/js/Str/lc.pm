package Data::Sah::Filter::js::Str::lc;
...
Data::Sah::Filter::js::Str::lc - Convert string to lowercase

=head1 VERSION

This document describes version 0.016 of Data::Sah::Filter::js::Str::lc (from Perl distribution Data-Sah-Filter), released on 2023-04-25.

=head1 SYNOPSIS

=head2 Using in Sah schema's C<prefilters> (or C<postfilters>) clause

 ["str","prefilters",[["Str::lc"]]]

=head2 Using with L<Data::Sah>:

 use Data::Sah qw(gen_validator);
 
 my $schema = ["str","prefilters",[["Str::lc"]]];
...
Related filters: L<uc|Data::Sah::Filter::js::Str::uc>.
