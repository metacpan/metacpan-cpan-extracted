...
1;
# ABSTRACT: Show a single Pod::Weaver plugin bundle
...
App::lcpan::Cmd::weaver_bundle - Show a single Pod::Weaver plugin bundle

=head1 VERSION

This document describes version 0.031 of App::lcpan::Cmd::weaver_bundle (from Perl distribution App-lcpan-CmdBundle-weaver), released on 2020-01-19.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<weaver-bundle>.
...
Show a single Pod::Weaver plugin bundle.
...
=item * B<weaver_bundle>* => I<perl::modname>
