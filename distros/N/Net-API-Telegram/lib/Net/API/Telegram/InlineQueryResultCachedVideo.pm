# -*- perl -*-
##----------------------------------------------------------------------------
## Net/API/Telegram/InlineQueryResultCachedVideo.pm
## Version 0.1
...
##----------------------------------------------------------------------------
package Net::API::Telegram::InlineQueryResultCachedVideo;
BEGIN
{
	use strict;
...
sub video_file_id { return( shift->_set_get_scalar( 'video_file_id', @_ ) ); }
...
Net::API::Telegram::InlineQueryResultCachedVideo - A link to a video file stored on the Telegram servers

=head1 SYNOPSIS

	my $msg = Net::API::Telegram::InlineQueryResultCachedVideo->new( %data ) || 
	die( Net::API::Telegram::InlineQueryResultCachedVideo->error, "\n" );

=head1 DESCRIPTION

L<Net::API::Telegram::InlineQueryResultCachedVideo> is a Telegram Message Object as defined here L<https://core.telegram.org/bots/api#inlinequeryresultcachedvideo>
