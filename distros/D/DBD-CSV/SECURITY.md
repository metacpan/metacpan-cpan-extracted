...
Report security issues by email to Jochen Wiedmann.
...
Security vulnerabilities can be reported to the current DBD::CSV
maintainers by email to Jochen Wiedmann.
...
included in DBD::CSV are also covered by this policy.
...
unless they affect DBD::CSV, or DBD::CSV can
