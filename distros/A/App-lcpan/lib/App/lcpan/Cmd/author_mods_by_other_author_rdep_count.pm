...
1;
# ABSTRACT: List modules of an author sorted by their number of reverse dependencies from other authors
...
App::lcpan::Cmd::author_mods_by_other_author_rdep_count - List modules of an author sorted by their number of reverse dependencies from other authors

=head1 VERSION

This document describes version 1.071 of App::lcpan::Cmd::author_mods_by_other_author_rdep_count (from Perl distribution App-lcpan), released on 2022-09-19.
