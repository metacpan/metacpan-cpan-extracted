package Chart::Plotly::Trace::Bar::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Bar::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Bar::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Bar::Hoverlabel - This attribute is one of the possible options for the trace bar.
