...
$Method::ParamValidator::Exception::MissingRequiredParameter::VERSION   = '0.15';
...
has reason => (is => 'ro', default => sub { 'Missing required parameter.' });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Method::ParamValidator::Exception::MissingRequiredParameter
...
1; # End of Method::ParamValidator::Exception::MissingRequiredParameter
