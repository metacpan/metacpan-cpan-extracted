# Tie::Nested
  ...
  * Development via GitHub: <https://github.com/markov2/perl-Tie-Nested>
  * Download from CPAN: <ftp://ftp.cpan.org/pub/CPAN/authors/id/M/MA/MARKOV/>
  * Indexed from CPAN: <http://search.cpan.org/~markov/Tie-Nested/>
    and <https://metacpan.org/release/Tie-Nested>
