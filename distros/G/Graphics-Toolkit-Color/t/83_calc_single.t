...
#### set ###############################################################
my $cyan = $blue->set( {green => 255} );
is( ref $cyan,                   $module,  'aqua (set green value to max) value object');
...
$cyan = $blue->set( {green => 256}, 'RGB' );
$values = $cyan->normalized();
is( ref $cyan,                   $module,  'green is in RGB, and set green over max, got clamped');
is( @$values,                          3,  'has three values');
is( $values->[0],                      0,  'red value is zero');
is( $values->[1],                      1,  'green value is one (max)');
is( $values->[2],                      1,  'blue value is one too');
...
#### add ###############################################################
$cyan = $blue->add( {green => 255} );
is( ref $cyan,                   $module,  'aqua (add green value to max) value object');
