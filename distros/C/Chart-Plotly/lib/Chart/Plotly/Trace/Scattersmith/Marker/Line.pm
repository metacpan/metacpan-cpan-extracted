package Chart::Plotly::Trace::Scattersmith::Marker::Line;
use Moose;
...
Chart::Plotly::Trace::Scattersmith::Marker::Line - This attribute is one of the possible options for the trace scattersmith.
