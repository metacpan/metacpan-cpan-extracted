...
package Google::Ads::AdWords::v201802::OfflineDataUploadService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201802::OfflineDataUploadOperation',
    },
    {
...
Google::Ads::AdWords::v201802::OfflineDataUploadService::mutate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutate from the namespace https://adwords.google.com/api/adwords/rm/v201802.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201802::OfflineDataUploadService::mutate->new($data);
