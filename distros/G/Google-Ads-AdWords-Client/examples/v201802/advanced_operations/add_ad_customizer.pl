...
use Google::Ads::AdWords::v201802::AdCustomizerFeed;
use Google::Ads::AdWords::v201802::AdCustomizerFeedAttribute;
use Google::Ads::AdWords::v201802::AdCustomizerFeedOperation;
...
use Google::Ads::AdWords::v201802::FeedItemAdGroupTargeting;
...
use Google::Ads::AdWords::v201802::FunctionOperand;
use Google::Ads::AdWords::v201802::RequestContextOperand;
  ...
  foreach my $ad_group_id (@{$ad_group_ids}) {
    push @operations,
      Google::Ads::AdWords::v201802::AdGroupAdOperation->new({
        operator => "ADD",
        operand  => Google::Ads::AdWords::v201802::AdGroupAd->new({
