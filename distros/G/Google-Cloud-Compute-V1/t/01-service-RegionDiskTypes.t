...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::DiskType Google::Cloud::Compute::V1::Compute::RegionDiskTypeList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::RegionDiskTypesClient->new( credentials => 'dummy' );
