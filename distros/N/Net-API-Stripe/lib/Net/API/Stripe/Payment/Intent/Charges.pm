##----------------------------------------------------------------------------
## Stripe API - ~/lib/Net/API/Stripe/Payment/Intent/Charges.pm
## Version v0.100.0
...
## 
##----------------------------------------------------------------------------
package Net::API::Stripe::Payment::Intent::Charges;
BEGIN
{
    use strict;
    use warnings;
...
## Arrray of Net::API::Stripe::Charge
# sub data { return( shift->_set_get_object_array( 'data', 'Net::API::Stripe::Charge', @_ ) ); }
...
Net::API::Stripe::Payment::Intent::Charges - A Stripe Payment Intent Charges List Object
