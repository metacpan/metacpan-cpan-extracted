...
package BorderStyle::Text::ANSITable::OldCompat::Default::space_utf8;
...
use alias::module 'BorderStyle::UTF8::Space';

1;
# ABSTRACT: UTF8::Space border style (with old name)
...
BorderStyle::Text::ANSITable::OldCompat::Default::space_utf8 - UTF8::Space border style (with old name)

=head1 VERSION

This document describes version 0.607 of BorderStyle::Text::ANSITable::OldCompat::Default::space_utf8 (from Perl distribution Text-ANSITable), released on 2021-08-27.
