package Google::Ads::AdWords::v201607::ConversionTrackingSettings;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'conversionOptimizerMode' => 'Google::Ads::AdWords::v201607::ConversionDeduplicationMode',
...
ConversionTrackingSettings from the namespace https://adwords.google.com/api/adwords/mcm/v201607.
