package Google::Ads::AdWords::v201809::CertificateMissingInCountryConstraint;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::CertificateMissingInCountryConstraint

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CertificateMissingInCountryConstraint from the namespace https://adwords.google.com/api/adwords/cm/v201809.
