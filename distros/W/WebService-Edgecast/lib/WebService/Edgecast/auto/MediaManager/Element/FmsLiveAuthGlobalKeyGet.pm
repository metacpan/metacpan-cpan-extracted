...
package WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthGlobalKeyGet;
BEGIN {
  $WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthGlobalKeyGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('FmsLiveAuthGlobalKeyGet');
...
WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthGlobalKeyGet
...
FmsLiveAuthGlobalKeyGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthGlobalKeyGet->new($data);
