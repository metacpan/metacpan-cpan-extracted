...
aegis_conf_new_file_command.pl - new_file aegis hook.
...
=head1 DETAILS
	...
	MANIFEST: aegis_conf_new_file_command.pl
	PROJECT: meta
	VERSION: 0.01

=head1 SYNOPSIS

	aegis_conf_new_file_command.pl [options]

=head1 DESCRIPTION

This program handles new_file aegis actions.
...
Meta::Baseline::Aegis(3), Meta::Lang::Perl::Perl(3), Meta::Lang::Python::Python(3), Meta::Utils::File::Prop(3), Meta::Utils::Opts::Opts(3), Meta::Utils::System(3), strict(3)
