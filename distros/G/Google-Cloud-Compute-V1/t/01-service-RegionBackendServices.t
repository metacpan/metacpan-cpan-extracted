...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::BackendService Google::Cloud::Compute::V1::Compute::BackendServiceGroupHealth Google::Cloud::Compute::V1::Compute::BackendServiceList Google::Cloud::Compute::V1::Compute::BackendServiceListUsable Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::Policy Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::RegionBackendServicesClient->new( credentials => 'dummy' );
