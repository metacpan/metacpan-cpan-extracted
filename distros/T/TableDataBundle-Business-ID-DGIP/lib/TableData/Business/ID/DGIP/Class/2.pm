...
This document describes version 20230207.0.0 of TableDataRole::Business::ID::DGIP::Class::2 (from Perl distribution TableDataBundle-Business-ID-DGIP), released on 2023-02-07.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Business::ID::DGIP::Class::2;

 my $td = TableData::Business::ID::DGIP::Class::2->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Business::ID::DGIP::Class::2 --page

 # Get number of rows
 % tabledata --action count_rows Business::ID::DGIP::Class::2
