...
use Google::Ads::AdWords::v201607::AdCustomizerFeed;
use Google::Ads::AdWords::v201607::AdCustomizerFeedAttribute;
use Google::Ads::AdWords::v201607::AdCustomizerFeedOperation;
use Google::Ads::AdWords::v201607::AdGroupAd;
use Google::Ads::AdWords::v201607::AdGroupAdOperation;
use Google::Ads::AdWords::v201607::ConstantOperand;
use Google::Ads::AdWords::v201607::Feed;
use Google::Ads::AdWords::v201607::FeedAttribute;
use Google::Ads::AdWords::v201607::FeedItem;
use Google::Ads::AdWords::v201607::FeedItemAdGroupTargeting;
...
use Google::Ads::AdWords::v201607::FunctionOperand;
use Google::Ads::AdWords::v201607::RequestContextOperand;
use Google::Ads::AdWords::v201607::TextAd;
...
sub create_customizer_feed() {
  ...
  my $name_attribute =
    Google::Ads::AdWords::v201607::AdCustomizerFeedAttribute->new({
      type => "STRING",
      name => "Name"
    });
  my $price_attribute =
  ...
  my $ad_customizer_feed = Google::Ads::AdWords::v201607::AdCustomizerFeed->new(
    {
      feedName       => $feed_name,
      feedAttributes => [$name_attribute, $price_attribute, $date_attribute]});

  my $operation = Google::Ads::AdWords::v201607::AdCustomizerFeedOperation->new(
    {
      operator => "ADD",
...
sub create_feed_item_add_operation() {
  ...
  my $feed_item = Google::Ads::AdWords::v201607::FeedItem->new({
      ...
      adGroupTargeting =>
        Google::Ads::AdWords::v201607::FeedItemAdGroupTargeting->new(
...
sub create_ads_with_customizations() {
  ...
  my $text_ad = Google::Ads::AdWords::v201607::TextAd->new({
  ...
  foreach my $ad_group_id (@{$ad_group_ids}) {
    push @operations,
      Google::Ads::AdWords::v201607::AdGroupAdOperation->new({
        operator => "ADD",
        operand  => Google::Ads::AdWords::v201607::AdGroupAd->new({
