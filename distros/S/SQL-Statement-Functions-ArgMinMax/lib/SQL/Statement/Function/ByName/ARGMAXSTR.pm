...
SQL::Statement::Function::ByName::ARGMAXSTR - SQL function to return the (string-wise) maximum parameter

=head1 VERSION

This document describes version 0.002 of SQL::Statement::Function::ByName::ARGMAXSTR (from Perl distribution SQL-Statement-Functions-ArgMinMax), released on 2017-01-25.
