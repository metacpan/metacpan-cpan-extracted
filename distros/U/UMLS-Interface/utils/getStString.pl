...
getStString.pl - This program returns the name of a semantic type given 
its abbreviation.

=head1 SYNOPSIS

This program takes in a semantic type abbreviation and returns its 
full name.

=head1 USAGE

Usage: getStString.pl [OPTIONS] <semantic type>
...
File containing ST abbreviations. One abbreviation per line. 
For example:
...
if(scalar(@ARGV) < 1 && !(defined $opt_infile) ) {
...
sub minimalUsageNotes {
    ...
    print "Usage: getStString.pl [OPTIONS] <semantic type> \n";
    &askHelp();
    exit;
}
...
sub showHelp() {
    ...
    print "abbreviation and returns its complete name.\n\n";
  
    print "Usage: getStString.pl [OPTIONS] <semantic type>\n\n";

    print "Options:\n\n";
    
    print "--infile FILE            File containing ST abbreviations\n";
...
##############################################################################
sub askHelp {
    print STDERR "Type getStString.pl --help for help.\n";
}
