...
The debug module to log all errors/debug/information messages
...
=head3 getHtml
   ...
   Description : 
      Return the html of the debug for the public debugs who should be presented to the user.
...
C<bug-gui-libhtml-debug at rt.cpan.org>, or through the web interface at
