...

{
    ...
    sub Perlito5::Grammar::Number::val_num {
        ...
        my $tmp = (((do {
            ...
            (((("." eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1)) && (do {
                ...
                while ((do {
                    my $tmp132 = $MATCH->{"to"};
                    ((("_" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1))) || ($MATCH->{"to"} = $tmp132, (do {
                        my $m2 = Perlito5::Grammar::Number::digit($str, $MATCH->{"to"});
                        if ($m2) {
                            $MATCH->{"to"} = $m2->{"to"};
                            1
                ...
                ((do {
                ...
                })) || ($MATCH->{"to"} = $tmp133, ((("." eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1)) && (do {
                    my $tmp = $MATCH;
                    ...
                    while ((do {
                        my $tmp134 = $MATCH->{"to"};
                        ((("_" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1))) || ($MATCH->{"to"} = $tmp134, (do {
                            my $m2 = Perlito5::Grammar::Number::digit($str, $MATCH->{"to"});
                            if ($m2) {
                                $MATCH->{"to"} = $m2->{"to"};
                                1
    ...
    sub Perlito5::Grammar::Number::digits_underscore {
        ...
        my $tmp = (((do {
            ...
            while ((do {
                my $tmp176 = $MATCH->{"to"};
                ((("_" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1))) || ($MATCH->{"to"} = $tmp176, (do {
                    my $m2 = Perlito5::Grammar::Number::digit($str, $MATCH->{"to"});
                    if ($m2) {
                        $MATCH->{"to"} = $m2->{"to"};
                        1
    ...
    sub Perlito5::Grammar::Number::hex_digits_underscore {
        ...
        my $tmp = ((do {
            ...
            while ((do {
                my $tmp187 = $MATCH->{"to"};
                ((("_" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1))) || ($MATCH->{"to"} = $tmp187, (do {
    ...
    sub Perlito5::Grammar::Number::hex_digits_underscore2 {
        ...
        my $tmp = (((do {
            ...
            while ((do {
                my $tmp198 = $MATCH->{"to"};
                ((("_" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1))) || ($MATCH->{"to"} = $tmp198, (do {
                    my $m2 = Perlito5::Grammar::Number::hex_digit($str, $MATCH->{"to"});
                    if ($m2) {
                        $MATCH->{"to"} = $m2->{"to"};
                        1
    ...
    sub Perlito5::Grammar::Number::hex_exponent {
        ...
        my $tmp = (((do {
            my $tmp209 = $MATCH->{"to"};
            ((("+" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1))) || ($MATCH->{"to"} = $tmp209, (("-" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1))) || ($MATCH->{"to"} = $tmp209, 1)
        }) && (do {
    ...
    sub Perlito5::Grammar::Number::val_octal {
        ...
        my $tmp = ((((0 eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1)) && (do {
            ...
            (((do {
                my $tmp217 = $MATCH->{"to"};
                ((("x" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1))) || ($MATCH->{"to"} = $tmp217, (("X" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1)))
            }) && (do {
                my $tmp218 = $MATCH->{"to"};
                (((do {
                    my $tmp219 = $MATCH->{"to"};
                    ...
                    my $tmp221 = $MATCH->{"to"};
                    ((("p" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1))) || ($MATCH->{"to"} = $tmp221, (("P" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1)))
                }) && (do {
                ...
                my $tmp222 = $MATCH->{"to"};
                ((("b" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1))) || ($MATCH->{"to"} = $tmp222, (("B" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1)))
            }) && (do {
                my $last_match_null = 0;
                my $m = $MATCH;
                my $to = $MATCH->{"to"};
                ...
                while ((do {
                    my $tmp223 = $MATCH->{"to"};
                    ((("_" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1))) || ($MATCH->{"to"} = $tmp223, ((0 eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1))) || ($MATCH->{"to"} = $tmp223, ((1 eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1)))
                }) && ($last_match_null < 2)) {
                    if ($to == $MATCH->{"to"}) {;
                        $last_match_null = $last_match_null + 1
                    }
                ...
                while ((do {
                    my $tmp224 = $MATCH->{"to"};
                    ((("_" eq $str->[($MATCH->{"to"}) + 0]) && ($MATCH->{"to"} += 1))) || ($MATCH->{"to"} = $tmp224, (do {
