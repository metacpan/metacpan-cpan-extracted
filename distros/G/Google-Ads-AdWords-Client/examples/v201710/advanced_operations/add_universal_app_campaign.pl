...
use Google::Ads::AdWords::v201710::GeoTargetTypeSetting;
...
use Google::Ads::AdWords::v201710::TargetCpaBiddingScheme;
use Google::Ads::AdWords::v201710::UniversalAppCampaignSetting;
...
sub add_universal_app_campaign {
  ...
  my $universalAppSetting =
    Google::Ads::AdWords::v201710::UniversalAppCampaignSetting->new({
  ...
  # Google::Ads::AdWords::v201710::SelectiveOptimization->new({
  #  conversionTypeIds =>
  ...
  my $geoSetting = Google::Ads::AdWords::v201710::GeoTargetTypeSetting->new({
  ...
  my $campaign = Google::Ads::AdWords::v201710::Campaign->new({
      ...
      biddingStrategyConfiguration =>
        Google::Ads::AdWords::v201710::BiddingStrategyConfiguration->new({
          ...
          biddingScheme =>
            Google::Ads::AdWords::v201710::TargetCpaBiddingScheme->new({
              targetCpa => Google::Ads::AdWords::v201710::Money->new(
                {microAmount => 1000000})})}
        ),
      # Budget (required) - note only the budgetId is required.
      budget =>
        Google::Ads::AdWords::v201710::Budget->new({budgetId => $budgetId}),
...
sub set_campaign_targeting_criteria() {
  ...
  my $california = Google::Ads::AdWords::v201710::Location->new({id => 21137});
  push @criteria, $california;
  my $mexico = Google::Ads::AdWords::v201710::Location->new({id => 2484});
  push @criteria, $mexico;

  # Create languages. The IDs can be found in the documentation or retrieved
  # with the ConstantDataService.
  my $english = Google::Ads::AdWords::v201710::Language->new({id => 1000});
  push @criteria, $english;
  my $spanish = Google::Ads::AdWords::v201710::Language->new({id => 1003});
  ...
  foreach my $criterion (@criteria) {
    my $operation =
      Google::Ads::AdWords::v201710::CampaignCriterionOperation->new({
        operator => "ADD",
        operand  => Google::Ads::AdWords::v201710::CampaignCriterion->new({
