...
package Google::Ads::AdWords::v201710::CampaignService::mutateLabel;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201710::CampaignLabelOperation',
    },
    {
...
Google::Ads::AdWords::v201710::CampaignService::mutateLabel
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201710::CampaignService::mutateLabel->new($data);

Constructor. The following data structure may be passed to new():

 {
   operations =>  $a_reference_to, # see Google::Ads::AdWords::v201710::CampaignLabelOperation
 },
