  ...
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       ...
       return Cfn::Resource::Properties::Object::AWS::Kinesis::Stream::StreamEncryption->new( %$_ );
     }
   };

package Cfn::Resource::Properties::Object::AWS::Kinesis::Stream::StreamEncryption {
  use Moose;
