package Chart::Plotly::Trace::Sunburst::Insidetextfont;
use Moose;
...
Chart::Plotly::Trace::Sunburst::Insidetextfont - This attribute is one of the possible options for the trace sunburst.
