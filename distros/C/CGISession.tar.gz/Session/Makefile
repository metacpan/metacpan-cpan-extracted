# This Makefile is for the CGI::Session extension to perl.
#
...
CCCDLFLAGS = -fPIC
CCDLFLAGS =   -R /usr/local/lib/perl5/5.00503/sun4-solaris/CORE
DLEXT = so
DLSRC = dl_dlopen.xs
LD = gcc -B/usr/ccs/bin/
LDDLFLAGS = -G -L/usr/local/lib/perl5/5.00503/thirdparty/lib -L/usr/local/lib -L/opt/lude/lib -R/usr/local/lib/perl5/5.00503/thirdparty/lib:/usr/local/lib:/opt/lude/lib
LDFLAGS = -L/usr/local/lib/perl5/5.00503/thirdparty/lib -L/usr/local/lib -L/opt/lude/lib -R/usr/local/lib/perl5/5.00503/thirdparty/lib:/usr/local/lib:/opt/lude/lib
LIBC = /lib/libc.so
LIB_EXT = .a
OBJ_EXT = .o
OSNAME = solaris
...
AR_STATIC_ARGS = cr
NAME = CGI::Session
DISTNAME = CGI-Session
NAME_SYM = CGI_Session
VERSION = 0.9b
VERSION_SYM = 0_9b
XS_VERSION = 0.9b
INST_BIN = blib/bin
...
INSTALLSITELIB = $(PREFIX)/lib/perl5/5.00503/site-perl
INSTALLSITEARCH = $(PREFIX)/lib/perl5/5.00503/site-perl/sun4-solaris
INSTALLBIN = $(PREFIX)/bin
INSTALLSCRIPT = $(PREFIX)/bin
PERL_LIB = /usr/local/lib/perl5/5.00503
PERL_ARCHLIB = /usr/local/lib/perl5/5.00503/sun4-solaris
SITELIBEXP = /usr/local/lib/perl5/5.00503/site-perl
SITEARCHEXP = /usr/local/lib/perl5/5.00503/site-perl/sun4-solaris
LIBPERL_A = libperl.a
...
INSTALLMAN1DIR = $(PREFIX)/lib/perl5/man/man1
MAN1EXT = 1
...
realclean purge ::  clean
	...
	rm -f $(INST_LIB)/CGI/Session/Authorizor/LDAP.pm.~1~ $(INST_LIB)/CGI/Session/Authorizor/LDAP.pm.~2~ $(INST_LIB)/CGI/Session/Authorizor/Allowed_User_File.pm.~1~ $(INST_LIB)/CGI/Session/Authenticator/LDAP.pm.~1~ $(INST_LIB)/CGI/Session/Authorizor/Allowed_User_File.pm.~2~ $(INST_LIB)/CGI/Session/Authorizor/LDAP.pm $(INST_LIB)/CGI/Session/Authenticator/LDAP.pm.~2~ $(INST_LIB)/CGI/Session/Authorizor/Allowed_User_File.pm.~3~ $(INST_LIB)/CGI/Session/Authenticator/LDAP.pm.~3~ $(INST_LIB)/CGI/Session/Authorizor/NetLDAP.pm.~1~ $(INST_LIB)/CGI/Session/Authenticator/LDAP.pm.~4~ $(INST_LIBDIR)/Session.pm $(INST_LIB)/CGI/Session/Authorizor/NetLDAP.pm.~2~ $(INST_LIB)/CGI/Session/Authenticator/Backdoor.pm.~1~ $(INST_LIB)/CGI/Session/Authorizor/Allowed_User_File.pm $(INST_LIB)/CGI/Session/Authenticator/LDAP.pm $(INST_LIB)/CGI/Session/Authenticator/Backdoor.pm.~2~ $(INST_LIB)/CGI/Session/Authenticator/Backdoor.pm.~3~ $(INST_LIB)/CGI/Session/Authenticator/NetLDAP.pm.~1~ $(INST_LIB)/CGI/Session/Authorizor/NetLDAP.pm $(INST_LIB)/CGI/Session/Authenticator/NetLDAP.pm.~2~ $(INST_LIB)/CGI/Session/Authenticator/NetLDAP.pm.~3~ $(INST_LIB)/CGI/Session/Authenticator/Backdoor.pm $(INST_LIB)/CGI/Session/Authenticator/NetLDAP.pm $(INST_LIB)/CGI/Session/CGI.pm $(INST_LIB)/CGI/Session/CookieJar/DBI.pm~ $(INST_LIB)/CGI/Session/CookieJar.pm~ $(INST_LIB)/CGI/Session/CookieJar/DBI.pm $(INST_LIB)/CGI/Session/CookieJar.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"CGI-Session\" VERSION=\"0,9b,0,0\">\n}. qq{\t<TITLE>CGI-Session</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"sun4-solaris\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > CGI-Session.ppd
