use utf8;
package Schema::RackTables::0_17_8::Result::PortInterfaceCompat;
...
Related object: L<Schema::RackTables::0_17_8::Result::PortInnerInterface>

=cut

__PACKAGE__->belongs_to(
  "iif",
  "Schema::RackTables::0_17_8::Result::PortInnerInterface",
  { id => "iif_id" },
