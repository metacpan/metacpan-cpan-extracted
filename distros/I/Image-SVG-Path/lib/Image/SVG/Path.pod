...
(This example is included as L<F<synopsis.pl>|https://api.metacpan.org/source/BKB/Image-SVG-Path-0.30/examples/synopsis.pl> in the distribution.)

=head1 VERSION

This documents version 0.30 of Image::SVG::Path corresponding to git
commit 480776a934b033453feec526ab7d0a5931bb44af released on Thu Dec 15 11:32:48 2016 +0900.
...
(This example is included as L<F<xml-parser.pl>|https://api.metacpan.org/source/BKB/Image-SVG-Path-0.30/examples/xml-parser.pl> in the distribution.)
...
(This example is included as L<F<extract-path-info.pl>|https://api.metacpan.org/source/BKB/Image-SVG-Path-0.30/examples/extract-path-info.pl> in the distribution.)
...
(This example is included as L<F<test-reverse.pl>|https://api.metacpan.org/source/BKB/Image-SVG-Path-0.30/examples/test-reverse.pl> in the distribution.)
...
This is L<bug 20|https://github.com/benkasminbullock/Image-SVG-Path/issues/20> on the issue tracker.
...
This is L<bug 21|https://github.com/benkasminbullock/Image-SVG-Path/issues/21> on the issue tracker.
