...
package Google::Ads::AdWords::v201708::ConversionTrackerService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201708::ConversionTrackerService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201708::ConversionTrackerService::query->new($data);
