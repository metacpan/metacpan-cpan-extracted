package Ewindows1257;
use strict;
BEGIN { $INC{'warnings.pm'} = '' if $] < 5.006 } use warnings;
######################################################################
#
# Ewindows1257 - Run-time routines for Windows1257.pm
#
...
BEGIN {
    ...
    sub qualify ($$) {
        ...
        elsif (Ewindows1257::index($name,'::') >= 0) {
            return $name;
        }
        elsif (Ewindows1257::index($name,"'") >= 0) {
            return $name;
...
#
# Windows-1257 character range per length
#
my %range_tr = ();

#
# Windows-1257 case conversion
#
my %lc = ();
...
elsif (__PACKAGE__ =~ / \b Ewindows1257 \z/oxms) {
    %range_tr = (
        1 => [ [0x00..0xFF],
             ],
    );
...
sub import {
    ...
    *Char::ord           = \&Windows1257::ord;
    *Char::ord_          = \&Windows1257::ord_;
    *Char::reverse       = \&Windows1257::reverse;
    *Char::getc          = \&Windows1257::getc;
    *Char::length        = \&Windows1257::length;
    *Char::substr        = \&Windows1257::substr;
    *Char::index         = \&Windows1257::index;
    *Char::rindex        = \&Windows1257::rindex;
    *Char::eval          = \&Windows1257::eval;
    *Char::escape        = \&Windows1257::escape;
    *Char::escape_token  = \&Windows1257::escape_token;
    *Char::escape_script = \&Windows1257::escape_script;
}
...
#
sub unimport {}
sub Ewindows1257::split(;$$$);
sub Ewindows1257::tr($$$$;$);
sub Ewindows1257::chop(@);
sub Ewindows1257::index($$;$);
sub Ewindows1257::rindex($$;$);
sub Ewindows1257::lcfirst(@);
sub Ewindows1257::lcfirst_();
sub Ewindows1257::lc(@);
sub Ewindows1257::lc_();
sub Ewindows1257::ucfirst(@);
sub Ewindows1257::ucfirst_();
sub Ewindows1257::uc(@);
sub Ewindows1257::uc_();
sub Ewindows1257::fc(@);
sub Ewindows1257::fc_();
sub Ewindows1257::ignorecase;
sub Ewindows1257::classic_character_class;
sub Ewindows1257::capture;
sub Ewindows1257::chr(;$);
sub Ewindows1257::chr_();
sub Ewindows1257::glob($);
sub Ewindows1257::glob_();

sub Windows1257::ord(;$);
sub Windows1257::ord_();
sub Windows1257::reverse(@);
sub Windows1257::getc(;*@);
sub Windows1257::length(;$);
sub Windows1257::substr($$;$$);
sub Windows1257::index($$;$);
sub Windows1257::rindex($$;$);
sub Windows1257::escape(;$);
...
# ${Ewindows1257::eS}          = qr{(?>[^\x09\x0A    \x0C\x0D\x20])};
# ${Ewindows1257::eS}          = qr{(?>[^\x09\x0A\x0B\x0C\x0D\x20])};
...
# avoid: Name "Ewindows1257::foo" used only once: possible typo at here.
${Ewindows1257::dot}         = ${Ewindows1257::dot};
${Ewindows1257::dot_s}       = ${Ewindows1257::dot_s};
${Ewindows1257::eD}          = ${Ewindows1257::eD};
${Ewindows1257::eS}          = ${Ewindows1257::eS};
${Ewindows1257::eW}          = ${Ewindows1257::eW};
${Ewindows1257::eH}          = ${Ewindows1257::eH};
${Ewindows1257::eV}          = ${Ewindows1257::eV};
${Ewindows1257::eR}          = ${Ewindows1257::eR};
${Ewindows1257::eN}          = ${Ewindows1257::eN};
${Ewindows1257::not_alnum}   = ${Ewindows1257::not_alnum};
${Ewindows1257::not_alpha}   = ${Ewindows1257::not_alpha};
${Ewindows1257::not_ascii}   = ${Ewindows1257::not_ascii};
${Ewindows1257::not_blank}   = ${Ewindows1257::not_blank};
${Ewindows1257::not_cntrl}   = ${Ewindows1257::not_cntrl};
${Ewindows1257::not_digit}   = ${Ewindows1257::not_digit};
${Ewindows1257::not_graph}   = ${Ewindows1257::not_graph};
${Ewindows1257::not_lower}   = ${Ewindows1257::not_lower};
${Ewindows1257::not_lower_i} = ${Ewindows1257::not_lower_i};
${Ewindows1257::not_print}   = ${Ewindows1257::not_print};
${Ewindows1257::not_punct}   = ${Ewindows1257::not_punct};
${Ewindows1257::not_space}   = ${Ewindows1257::not_space};
${Ewindows1257::not_upper}   = ${Ewindows1257::not_upper};
${Ewindows1257::not_upper_i} = ${Ewindows1257::not_upper_i};
${Ewindows1257::not_word}    = ${Ewindows1257::not_word};
${Ewindows1257::not_xdigit}  = ${Ewindows1257::not_xdigit};
${Ewindows1257::eb}          = ${Ewindows1257::eb};
${Ewindows1257::eB}          = ${Ewindows1257::eB};
...
#
# Windows-1257 transliteration (tr///)
#
sub Ewindows1257::tr($$$$;$) {
...
#
# Windows-1257 lower case first with parameter
#
sub Ewindows1257::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Ewindows1257::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Ewindows1257::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Ewindows1257::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Windows-1257 lower case first without parameter
#
sub Ewindows1257::lcfirst_() {
    return Ewindows1257::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Windows-1257 lower case with parameter
#
sub Ewindows1257::lc(@) {
    if (@_) {
        my $s = shift @_;
        ...
        return Ewindows1257::lc_();
    }
}

#
# Windows-1257 lower case without parameter
#
sub Ewindows1257::lc_() {
    my $s = $_;
    return join '', map {defined($lc{$_}) ? $lc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Windows-1257 upper case first with parameter
#
sub Ewindows1257::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Ewindows1257::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Ewindows1257::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Ewindows1257::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Windows-1257 upper case first without parameter
#
sub Ewindows1257::ucfirst_() {
    return Ewindows1257::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Windows-1257 upper case with parameter
#
sub Ewindows1257::uc(@) {
    if (@_) {
        my $s = shift @_;
        ...
        return Ewindows1257::uc_();
    }
}

#
# Windows-1257 upper case without parameter
#
sub Ewindows1257::uc_() {
    my $s = $_;
    return join '', map {defined($uc{$_}) ? $uc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Windows-1257 fold case with parameter
#
sub Ewindows1257::fc(@) {
    if (@_) {
        my $s = shift @_;
        ...
        return Ewindows1257::fc_();
    }
}

#
# Windows-1257 fold case without parameter
#
sub Ewindows1257::fc_() {
    my $s = $_;
    return join '', map {defined($fc{$_}) ? $fc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Windows-1257 regexp ignore case modifier
#
sub Ewindows1257::ignorecase {
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Ewindows1257::uc($char[$i]);
                my $fc = Ewindows1257::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
#
# prepare Windows-1257 characters per length
#
...
#
# Windows-1257 open character list for tr
#
sub _charlist_tr {
...
#
# Windows-1257 open character class
#
sub _cc {
    if (scalar(@_) == 0) {
...
#
# Windows-1257 open character list for qr and not qr
#
sub _charlist {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Ewindows1257::not_lower_i}',
                '[:^upper:]'  => '${Ewindows1257::not_upper_i}',
...
#
# Windows-1257 octal escape sequence
#
sub octchr {
    my($octdigit) = @_;
...
#
# Windows-1257 hexadecimal escape sequence
#
sub hexchr {
    my($hexdigit) = @_;
...
#
# Windows-1257 open character list for qr
#
sub charlist_qr {
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Ewindows1257::uc($char);
                        my $fc = Ewindows1257::fc($char);
                        if ($uc eq $fc) {
...
#
# Windows-1257 open character list for not qr
#
sub charlist_not_qr {
...
#
# Windows-1257 order to character (with parameter)
#
sub Ewindows1257::chr(;$) {
...
#
# Windows-1257 order to character (without parameter)
#
sub Ewindows1257::chr_() {
...
#
# Windows-1257 path globbing (with parameter)
#
sub Ewindows1257::glob($) {
...
#
# Windows-1257 path globbing (without parameter)
#
sub Ewindows1257::glob_() {
...
#
# Windows-1257 path globbing via File::DosGlob 1.10
#
...
#
# Windows-1257 path globbing subroutine
#
sub _do_glob {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Ewindows1257::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Ewindows1257::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Ewindows1257::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Ewindows1257::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
#
sub Ewindows1257::POSTMATCH {
    return $';
}

#
# Windows-1257 character to order (with parameter)
#
sub Windows1257::ord(;$) {
...
#
# Windows-1257 character to order (without parameter)
#
sub Windows1257::ord_() {
...
#
# Windows-1257 getc (with parameter, without parameter)
#
sub Windows1257::getc(;*@) {

    my($package) = caller;
    my $fh = @_ ? qualify_to_ref(shift,$package) : \*STDIN;
    croak 'Too many arguments for Windows1257::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Ewindows1257::dot_s} \z/oxms) {
...
#
# Windows-1257 length by character
#
sub Windows1257::length(;$) {
...
#
# Windows-1257 substr by character
#
BEGIN {
...
#
# Windows-1257 index by character
#
sub Windows1257::index($$;$) {

    my $index;
    if (@_ == 3) {
        $index = Ewindows1257::index($_[0], $_[1], CORE::length(Windows1257::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Ewindows1257::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Windows1257::length(CORE::substr $_[0], 0, $index);
    }
}

#
# Windows-1257 rindex by character
#
sub Windows1257::rindex($$;$) {

    my $rindex;
    if (@_ == 3) {
        $rindex = Ewindows1257::rindex($_[0], $_[1], CORE::length(Windows1257::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Ewindows1257::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Windows1257::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
# ord() to ord() or Windows1257::ord()
my $function_ord = 'ord';

# ord to ord or Windows1257::ord_
my $function_ord_ = 'ord';

# reverse to reverse or Windows1257::reverse
my $function_reverse = 'reverse';

# getc to getc or Windows1257::getc
...
my $qq_substr  = qr{(?> Char::substr | Windows1257::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
sub Windows1257::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Windows1257::escape_token();
    }
...
#
# escape Windows-1257 token of script
#
sub Windows1257::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Ewindows1257::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ (?>\s*) PREMATCH  \b | \$ (?>\s*) \{ (?>\s*) PREMATCH  (?>\s*) \} | \$ (?>\s*) \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Ewindows1257::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Ewindows1257::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Ewindows1257::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Ewindows1257::POSTMATCH()
    elsif (/\G (                 \$ (?>\s*) POSTMATCH \b | \$ (?>\s*) \{ (?>\s*) POSTMATCH (?>\s*) \} | \$ (?>\s*) \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Ewindows1257::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Ewindows1257::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob (?>\s*) \) /oxgc) {
        return 'while ($_ = Ewindows1257::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob \b /oxgc) {
        return 'while ($_ = Ewindows1257::glob';
    }
...
# subroutines of package Ewindows1257
    elsif (/\G \b (CORE:: | ->(>?\s*) (?: atan2 | [a-z]{2,})) \b       /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Windows1257::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Char::escape'; }
    elsif (/\G \b Windows1257::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Windows1257::escape'; }
    elsif (/\G \b bytes::substr \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Ewindows1257::chop';       }
    elsif (/\G \b bytes::index \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::index';       }
    elsif (/\G \b Windows1257::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Windows1257::index';       }
    elsif (/\G \b index \b         (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Ewindows1257::index';      }
    elsif (/\G \b bytes::rindex \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::rindex';      }
    elsif (/\G \b Windows1257::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Windows1257::rindex';      }
    elsif (/\G \b rindex \b        (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Ewindows1257::rindex';     }
    elsif (/\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ewindows1257::lc';         }
    elsif (/\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ewindows1257::lcfirst';    }
    elsif (/\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ewindows1257::uc';         }
    elsif (/\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ewindows1257::ucfirst';    }
    elsif (/\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ewindows1257::fc';         }
    ...
    elsif (/\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ewindows1257::chr';               }
    elsif (/\G \b bytes::ord    (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ewindows1257::glob';              }
    elsif (/\G \b lc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ewindows1257::lc_';               }
    elsif (/\G \b lcfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ewindows1257::lcfirst_';          }
    elsif (/\G \b uc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ewindows1257::uc_';               }
    elsif (/\G \b ucfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ewindows1257::ucfirst_';          }
    elsif (/\G \b fc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ewindows1257::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ewindows1257::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ewindows1257::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Ewindows1257::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Ewindows1257::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq           (\#) [ ] (\#) /oxgc) { return 'Ewindows1257::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Ewindows1257::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Ewindows1257::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Ewindows1257::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Ewindows1257::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Ewindows1257::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q            (\#) [ ] (\#) /oxgc) { return 'Ewindows1257::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Ewindows1257::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Ewindows1257::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Ewindows1257::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Ewindows1257::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Ewindows1257::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                    ' [ ] '    /oxgc) { return 'Ewindows1257::split' . $e . qq     {' '};  }
        elsif (/\G                    " [ ] "    /oxgc) { return 'Ewindows1257::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Ewindows1257::PREMATCH()]}
            ...
            $e_string .= q{Ewindows1257::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Ewindows1257::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Ewindows1257::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Ewindows1257::POSTMATCH()]}
            ...
            $e_string .= q{Ewindows1257::POSTMATCH()};
            $slash = 'div';
        }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Ewindows1257::dot_s}';
        }
        else {
            return '${Ewindows1257::dot}';
        }
    }
    else {
        return Ewindows1257::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Ewindows1257::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Ewindows1257::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Ewindows1257::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Ewindows1257::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Ewindows1257::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Ewindows1257::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Ewindows1257::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Ewindows1257::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Ewindows1257::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Ewindows1257::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Ewindows1257::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Ewindows1257::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Ewindows1257::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Ewindows1257::uc($char[$i]) ne Ewindows1257::fc($char[$i]))) {
            if (CORE::length(Ewindows1257::fc($char[$i])) == 1) {
                $char[$i] = '['   . Ewindows1257::uc($char[$i])       . Ewindows1257::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Ewindows1257::uc($char[$i]) . '|' . Ewindows1257::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ewindows1257::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ (?>\s*) 0 (?>\s*) \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Ewindows1257::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ewindows1257::ignorecase(Ewindows1257::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Ewindows1257::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Ewindows1257::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ewindows1257::ignorecase(Ewindows1257::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Ewindows1257::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Ewindows1257::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ewindows1257::ignorecase(Ewindows1257::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Ewindows1257::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Ewindows1257::re_t=%s; while($Ewindows1257::re_t =~ %s){%s local $^W=0; local $Ewindows1257::re_r=%s; %s$Ewindows1257::re_t="$`$Ewindows1257::re_r$'"; pos($Ewindows1257::re_t)=length "$`$Ewindows1257::re_r"; } return $Ewindows1257::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Ewindows1257::re_r=CORE::eval $Ewindows1257::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Ewindows1257::re_r=%s; %s"%s$Ewindows1257::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Ewindows1257::re_n=0; while(%s =~ %s){%s local $^W=0; local $Ewindows1257::re_r=%s; %s%s="$`$Ewindows1257::re_r$'"; pos(%s)=length "$`$Ewindows1257::re_r"; $Ewindows1257::re_n++} return %s$Ewindows1257::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Ewindows1257::re_r=%s; %s%s="%s$Ewindows1257::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Ewindows1257::re_r=%s; %s%s="%s$Ewindows1257::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Ewindows1257::re_r=CORE::eval $Ewindows1257::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # ${ foo }
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ewindows1257::ignorecase(' . $1 . ')]}';
            }
        }
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Ewindows1257::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Ewindows1257::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  use Ewindows1257;
    ...
    Ewindows1257::lc(...);
    Ewindows1257::lc_;
    Ewindows1257::lcfirst(...);
    Ewindows1257::lcfirst_;
    Ewindows1257::uc(...);
    Ewindows1257::uc_;
    Ewindows1257::ucfirst(...);
    Ewindows1257::ucfirst_;
    Ewindows1257::fc(...);
    Ewindows1257::fc_;
    Ewindows1257::ignorecase(...);
    Ewindows1257::capture(...);
    Ewindows1257::chr(...);
    Ewindows1257::chr_;
    Ewindows1257::glob(...);
    Ewindows1257::glob_;

  # "no Ewindows1257;" not supported

=head1 ABSTRACT

This module has run-time routines for use Windows1257 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Windows1257 software and not
...
This Ewindows1257 module first appeared in ActivePerl Build 522 Built under
...
=item * Split string
  ...
  @split = Ewindows1257::split(/pattern/,$string,$limit);
  @split = Ewindows1257::split(/pattern/,$string);
  @split = Ewindows1257::split(/pattern/);
  @split = Ewindows1257::split('',$string,$limit);
  @split = Ewindows1257::split('',$string);
  @split = Ewindows1257::split('');
  @split = Ewindows1257::split();
  @split = Ewindows1257::split;
  ...
  at all, Ewindows1257::split returns the original string as a single substring, If it
  ...
  @chars  = Ewindows1257::split(//,  $word);
  @fields = Ewindows1257::split(/:/, $line);
  @words  = Ewindows1257::split(" ", $paragraph);
  @lines  = Ewindows1257::split(/^/, $buffer);
  ...
  print join(":" => Ewindows1257::split(/ */, "hi there"));
  ...
  Ewindows1257::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Ewindows1257::split(/:/, $_, 3);
  ...
  splits on whitespace just as Ewindows1257::split with no arguments does. Thus,
  Ewindows1257::split(" ") can be used to emulate awk's default behavior. In contrast,
  Ewindows1257::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Ewindows1257::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Ewindows1257::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Ewindows1257::split()) {
          $count{$word}++;
      }
  }

  The inverse of Ewindows1257::split is join, except that join can only join with the
...
=item * Transliteration
  ...
  $tr = Ewindows1257::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Ewindows1257::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  This subroutine scans a Windows-1257 string character by character and replaces all
  occurrences of the characters found in $searchlist with the corresponding character
  in $replacementlist. It returns the number of characters replaced or deleted.
  If no Windows-1257 string is specified via =~ operator, the $_ variable is translated.
  $modifier are:
  ...
  print Ewindows1257::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item * Chop string

  $chop = Ewindows1257::chop(@list);
  $chop = Ewindows1257::chop();
  $chop = Ewindows1257::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Ewindows1257::chop subroutine is used primary to remove the newline
  ...
  since Ewindows1257::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Ewindows1257::chop a literal, only a variable. If you Ewindows1257::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Ewindows1257::chop(@lines);

  You can Ewindows1257::chop anything that is an lvalue, including an assignment:

  Ewindows1257::chop($cwd = `pwd`);
  Ewindows1257::chop($answer = <STDIN>);

  This is different from:

  $answer = Ewindows1257::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Ewindows1257::chop returns the character
  ...
  In the most general case, Ewindows1257::chop can be expressed using substr:

  $last_code = Ewindows1257::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Ewindows1257::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Ewindows1257::chop;
...
=item * Index string
  ...
  $byte_pos = Ewindows1257::index($string,$substr,$byte_offset);
  $byte_pos = Ewindows1257::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Ewindows1257::index($string, $lookfor, $byte_pos)) > -1) {
...
=item * Reverse index string
  ...
  $byte_pos = Ewindows1257::rindex($string,$substr,$byte_offset);
  $byte_pos = Ewindows1257::rindex($string,$substr);

  This subroutine works just like Ewindows1257::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Ewindows1257::index).
  ...
  while (($byte_pos = Windows1257::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item * Lower case string
  ...
  $lc = Ewindows1257::lc($string);
  $lc = Ewindows1257::lc_;

  This subroutine returns a lowercased version of Windows-1257 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Ewindows1257::fc subroutine for case-insensitive comparisons via Windows1257
  software.

=item * Lower case first character of string

  $lcfirst = Ewindows1257::lcfirst($string);
  $lcfirst = Ewindows1257::lcfirst_;

  This subroutine returns a version of Windows-1257 $string with the first character
  lowercased (or $_, if $string is omitted). This is the internal subroutine
  implementing the \l escape in double-quoted strings.

=item * Upper case string

  $uc = Ewindows1257::uc($string);
  $uc = Ewindows1257::uc_;

  This subroutine returns an uppercased version of Windows-1257 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Ewindows1257::ucfirst instead.
...
=item * Upper case first character of string
  ...
  $ucfirst = Ewindows1257::ucfirst($string);
  $ucfirst = Ewindows1257::ucfirst_;
  ...
  $titlecase = Ewindows1257::ucfirst(substr($word,0,1)) . Ewindows1257::lc(substr($word,1));
  ...
  $do_not_use = Ewindows1257::ucfirst(Ewindows1257::lc($word));
...
=item * Fold case string
  ...
  $fc = Ewindows1257::fc($string);
  $fc = Ewindows1257::fc_;

  New to Windows1257 software, this subroutine returns the full Unicode-like casefold of
  Windows-1257 $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Ewindows1257::fc($a) eq Ewindows1257::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Windows1257 software has always used casefolding semantics for
...
=item * Make ignore case string
  ...
  @ignorecase = Ewindows1257::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item * Make capture number

  $capturenumber = Ewindows1257::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item * Make character

  $chr = Ewindows1257::chr($code);
  $chr = Ewindows1257::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Ewindows1257::chr(65) is "A" in either
  ASCII or Windows-1257, not Unicode. For the reverse of Ewindows1257::chr, use Windows1257::ord.

=item * Filename expansion (globbing)

  @glob = Ewindows1257::glob($string);
  @glob = Ewindows1257::glob_;
  ...
  The Ewindows1257::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Ewindows1257::glob('"*e f*"');
  @spacies = Ewindows1257::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Ewindows1257::glob("'*${var}e f*'");
  @spacies = Ewindows1257::glob(qq("*${var}e f*"));
