...
Perinci::CmdLine::Plugin::Debugging::DumpR - Dump request stash ($r), by default after action

=head1 VERSION

This document describes version 1.912 of Perinci::CmdLine::Plugin::Debugging::DumpR (from Perl distribution Perinci-CmdLine-Lite), released on 2021-12-01.
