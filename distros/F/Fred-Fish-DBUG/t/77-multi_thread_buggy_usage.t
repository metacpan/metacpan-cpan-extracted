...

{
   ...
   dbug_ok (1, "NOTE: Each thread writes to the same fish log in a buggy way.  So it's output is compromised!");
   ...
   dbug_ok ( 1, "Each thread reopens the same log file!  Can't detect buggy writes!" );
   dbug_ok ( 1, "Fish Log: " . DBUG_FILE_NAME() );
