package Google::Ads::AdWords::v201702::Budget;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'amount' => 'Google::Ads::AdWords::v201702::Money',
        'deliveryMethod' => 'Google::Ads::AdWords::v201702::Budget::BudgetDeliveryMethod',
        'referenceCount' => 'SOAP::WSDL::XSD::Typelib::Builtin::int',
        'isExplicitlyShared' => 'SOAP::WSDL::XSD::Typelib::Builtin::boolean',
        'status' => 'Google::Ads::AdWords::v201702::Budget::BudgetStatus',
    },
    {
...
Budget from the namespace https://adwords.google.com/api/adwords/cm/v201702.
