...
$Search::Elasticsearch::Client::8_0::TestServer::VERSION = '8.12';
use strict;
use warnings;
...
Search::Elasticsearch::Client::8_0::TestServer - Client-specific backend for Search::Elasticsearch::TestServer
