package Proc::ProcessTable::Match::JID;
...
Proc::ProcessTable::Match::JID - Check if the JID of a process matches.
...
=head1 SYNOPSIS
    ...
    use Proc::ProcessTable::Match::JID;
    ...
    my $checker=Proc::ProcessTable::Match::JID->new( \%args );
...
that is 'jids', which is a array of JIDs to match.

The JID values can be prefixed with the equalities below for doing
...
sub match{
	...
	my $jid_int=0;
	while (defined( $self->{jids}[$jid_int] )){
