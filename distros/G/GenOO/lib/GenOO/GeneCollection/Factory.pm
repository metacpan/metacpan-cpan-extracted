...
GenOO::GeneCollection::Factory - Factory for creating L<GenOO::RegionCollection> objects
...
package GenOO::GeneCollection::Factory;
$GenOO::GeneCollection::Factory::VERSION = '1.5.1';
