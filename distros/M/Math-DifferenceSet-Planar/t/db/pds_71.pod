...
pds_71.db - larger database with planar difference set samples
...
It contains 71 cyclic planar difference set planes with orders ranging
from 2 to 257.  The sample sets are generated from Conway polynomials.
