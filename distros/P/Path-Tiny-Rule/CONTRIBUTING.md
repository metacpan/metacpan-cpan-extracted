...
The code for this distribution is [hosted on GitHub](https://github.com/houseabsolute/Path-Tiny-Rule).
...
on Linux by [Travis](https://travis-ci.org/houseabsolute/Path-Tiny-Rule).
