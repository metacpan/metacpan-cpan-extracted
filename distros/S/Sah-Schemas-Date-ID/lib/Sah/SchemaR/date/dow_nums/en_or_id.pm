...
Sah::SchemaR::date::dow_nums::en_or_id - Array of day-of-week numbers (1-7, 1=Monday), e.g. [1,"Mon","Sen"]

=head1 VERSION

This document describes version 0.008 of Sah::SchemaR::date::dow_nums::en_or_id (from Perl distribution Sah-Schemas-Date-ID), released on 2022-10-20.
