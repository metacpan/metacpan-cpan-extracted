...
Kubernetes::REST::Result2Object - REMOVED -- superseded by Kubernetes::REST's unified v1 API, see Kubernetes::REST::Deprecated
...
C<Kubernetes::REST::Result2Object> itself was never functional in the C<1.x> series -- it
...
C<cpanm Kubernetes::REST::Result2Object> -- or a cpanfile / code that still references the
...
Kubernetes::REST::Result2Object - REMOVED, superseded by Kubernetes::REST's unified v1 API
