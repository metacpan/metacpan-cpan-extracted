use utf8;
package Strehler::Schema::Result::Description;
$Strehler::Schema::Result::Description::VERSION = '1.6.8';
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TaC8NpZF73mckjojvxBHmg
