package Chart::Plotly::Trace::Scattergl::Marker::Line;
use Moose;
...
Chart::Plotly::Trace::Scattergl::Marker::Line - This attribute is one of the possible options for the trace scattergl.
