...
package Google::Ads::AdWords::v201702::ConstantDataService::getLanguageCriterion;
use strict;
use warnings;
...
getLanguageCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201702.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::ConstantDataService::getLanguageCriterion->new($data);
