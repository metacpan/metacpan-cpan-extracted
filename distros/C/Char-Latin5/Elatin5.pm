...
######################################################################
#
# Elatin5 - Run-time routines for Latin5.pm
#
...
BEGIN {
    ...
    sub qualify ($;$) {
        my ($name) = @_;
        if (!ref($name) && (Elatin5::index($name, '::') == -1) && (Elatin5::index($name, "'") == -1)) {
            my $pkg;
...
sub import {
    ...
    *Char::ord           = \&Latin5::ord;
    *Char::ord_          = \&Latin5::ord_;
    *Char::reverse       = \&Latin5::reverse;
    *Char::getc          = \&Latin5::getc;
    *Char::length        = \&Latin5::length;
    *Char::substr        = \&Latin5::substr;
    *Char::index         = \&Latin5::index;
    *Char::rindex        = \&Latin5::rindex;
    *Char::eval          = \&Latin5::eval;
    *Char::escape        = \&Latin5::escape;
    *Char::escape_token  = \&Latin5::escape_token;
    *Char::escape_script = \&Latin5::escape_script;
}
...
sub Elatin5::rindex($$;$);
sub Elatin5::lcfirst(@);
sub Elatin5::lcfirst_();
sub Elatin5::lc(@);
sub Elatin5::lc_();
sub Elatin5::ucfirst(@);
sub Elatin5::ucfirst_();
sub Elatin5::uc(@);
sub Elatin5::uc_();
sub Elatin5::fc(@);
sub Elatin5::fc_();
sub Elatin5::ignorecase;
sub Elatin5::classic_character_class;
sub Elatin5::capture;
sub Elatin5::chr(;$);
sub Elatin5::chr_();
sub Elatin5::glob($);
...
# ${Elatin5::eS}          = qr{(?>[^\x09\x0A    \x0C\x0D\x20])};
# ${Elatin5::eS}          = qr{(?>[^\x09\x0A\x0B\x0C\x0D\x20])};
${Elatin5::eS}            = qr{(?>[^\s])};

${Elatin5::eW}            = qr{(?>[^0-9A-Z_a-z])};
${Elatin5::eH}            = qr{(?>[^\x09\x20])};
${Elatin5::eV}            = qr{(?>[^\x0A\x0B\x0C\x0D])};
${Elatin5::eR}            = qr{(?>\x0D\x0A|[\x0A\x0D])};
${Elatin5::eN}            = qr{(?>[^\x0A])};
${Elatin5::not_alnum}     = qr{(?>[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Elatin5::not_alpha}     = qr{(?>[^\x41-\x5A\x61-\x7A])};
${Elatin5::not_ascii}     = qr{(?>[^\x00-\x7F])};
${Elatin5::not_blank}     = qr{(?>[^\x09\x20])};
${Elatin5::not_cntrl}     = qr{(?>[^\x00-\x1F\x7F])};
${Elatin5::not_digit}     = qr{(?>[^\x30-\x39])};
${Elatin5::not_graph}     = qr{(?>[^\x21-\x7F])};
${Elatin5::not_lower}     = qr{(?>[^\x61-\x7A])};
${Elatin5::not_lower_i}   = qr{(?>[^\x41-\x5A\x61-\x7A])}; # Perl 5.16 compatible
# ${Elatin5::not_lower_i} = qr{(?>[\x00-\xFF])};                   # older Perl compatible
${Elatin5::not_print}     = qr{(?>[^\x20-\x7F])};
${Elatin5::not_punct}     = qr{(?>[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Elatin5::not_space}     = qr{(?>[^\s\x0B])};
${Elatin5::not_upper}     = qr{(?>[^\x41-\x5A])};
${Elatin5::not_upper_i}   = qr{(?>[^\x41-\x5A\x61-\x7A])}; # Perl 5.16 compatible
# ${Elatin5::not_upper_i} = qr{(?>[\x00-\xFF])};                   # older Perl compatible
${Elatin5::not_word}      = qr{(?>[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Elatin5::not_xdigit}    = qr{(?>[^\x30-\x39\x41-\x46\x61-\x66])};
${Elatin5::eb}            = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Elatin5::eB}            = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Elatin5::foo" used only once: possible typo at here.
${Elatin5::dot}         = ${Elatin5::dot};
${Elatin5::dot_s}       = ${Elatin5::dot_s};
${Elatin5::eD}          = ${Elatin5::eD};
${Elatin5::eS}          = ${Elatin5::eS};
${Elatin5::eW}          = ${Elatin5::eW};
${Elatin5::eH}          = ${Elatin5::eH};
${Elatin5::eV}          = ${Elatin5::eV};
${Elatin5::eR}          = ${Elatin5::eR};
${Elatin5::eN}          = ${Elatin5::eN};
${Elatin5::not_alnum}   = ${Elatin5::not_alnum};
${Elatin5::not_alpha}   = ${Elatin5::not_alpha};
${Elatin5::not_ascii}   = ${Elatin5::not_ascii};
${Elatin5::not_blank}   = ${Elatin5::not_blank};
${Elatin5::not_cntrl}   = ${Elatin5::not_cntrl};
${Elatin5::not_digit}   = ${Elatin5::not_digit};
${Elatin5::not_graph}   = ${Elatin5::not_graph};
${Elatin5::not_lower}   = ${Elatin5::not_lower};
${Elatin5::not_lower_i} = ${Elatin5::not_lower_i};
${Elatin5::not_print}   = ${Elatin5::not_print};
${Elatin5::not_punct}   = ${Elatin5::not_punct};
${Elatin5::not_space}   = ${Elatin5::not_space};
${Elatin5::not_upper}   = ${Elatin5::not_upper};
${Elatin5::not_upper_i} = ${Elatin5::not_upper_i};
${Elatin5::not_word}    = ${Elatin5::not_word};
${Elatin5::not_xdigit}  = ${Elatin5::not_xdigit};
${Elatin5::eb}          = ${Elatin5::eb};
${Elatin5::eB}          = ${Elatin5::eB};
...
sub Elatin5::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Elatin5::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Elatin5::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Elatin5::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
...
sub Elatin5::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Elatin5::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Elatin5::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Elatin5::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Elatin5::uc($char[$i]);
                my $fc = Elatin5::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Elatin5::not_lower_i}',
                '[:^upper:]'  => '${Elatin5::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Elatin5::not_alnum}',
                '[:^alpha:]'  => '${Elatin5::not_alpha}',
                '[:^ascii:]'  => '${Elatin5::not_ascii}',
                '[:^blank:]'  => '${Elatin5::not_blank}',
                '[:^cntrl:]'  => '${Elatin5::not_cntrl}',
                '[:^digit:]'  => '${Elatin5::not_digit}',
                '[:^graph:]'  => '${Elatin5::not_graph}',
                '[:^lower:]'  => '${Elatin5::not_lower}',
                '[:^print:]'  => '${Elatin5::not_print}',
                '[:^punct:]'  => '${Elatin5::not_punct}',
                '[:^space:]'  => '${Elatin5::not_space}',
                '[:^upper:]'  => '${Elatin5::not_upper}',
                '[:^word:]'   => '${Elatin5::not_word}',
                '[:^xdigit:]' => '${Elatin5::not_xdigit}',
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Elatin5::uc($char);
                        my $fc = Elatin5::fc($char);
                        if ($uc eq $fc) {
...
#
# Latin-5 path globbing via File::DosGlob 1.10
#
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Elatin5::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Elatin5::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Elatin5::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Elatin5::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
sub Latin5::getc(;*@) {
    ...
    croak 'Too many arguments for Latin5::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Elatin5::dot_s} \z/oxms) {
...
sub Latin5::index($$;$) {
    ...
    my $index;
    if (@_ == 3) {
        $index = Elatin5::index($_[0], $_[1], CORE::length(Latin5::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Elatin5::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Latin5::length(CORE::substr $_[0], 0, $index);
    }
}
...
sub Latin5::rindex($$;$) {
    ...
    my $rindex;
    if (@_ == 3) {
        $rindex = Elatin5::rindex($_[0], $_[1], CORE::length(Latin5::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Elatin5::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Latin5::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
my $qq_substr  = qr{(?> Char::substr | Latin5::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
#
# escape Latin-5 token of script
#
sub Latin5::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Elatin5::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ (?>\s*) PREMATCH  \b | \$ (?>\s*) \{ (?>\s*) PREMATCH  (?>\s*) \} | \$ (?>\s*) \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin5::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Elatin5::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin5::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Elatin5::POSTMATCH()
    elsif (/\G (                 \$ (?>\s*) POSTMATCH \b | \$ (?>\s*) \{ (?>\s*) POSTMATCH (?>\s*) \} | \$ (?>\s*) \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin5::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Elatin5::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob (?>\s*) \) /oxgc) {
        return 'while ($_ = Elatin5::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob \b /oxgc) {
        return 'while ($_ = Elatin5::glob';
    }
...
# subroutines of package Elatin5
    elsif (/\G \b (CORE:: | ->(>?\s*) (?: atan2 | [a-z]{2,})) \b       /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Latin5::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Char::escape'; }
    elsif (/\G \b Latin5::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Latin5::escape'; }
    elsif (/\G \b bytes::substr \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin5::chop';       }
    elsif (/\G \b bytes::index \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::index';       }
    elsif (/\G \b Latin5::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Latin5::index';       }
    elsif (/\G \b index \b         (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin5::index';      }
    elsif (/\G \b bytes::rindex \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::rindex';      }
    elsif (/\G \b Latin5::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Latin5::rindex';      }
    elsif (/\G \b rindex \b        (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin5::rindex';     }
    elsif (/\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin5::lc';         }
    elsif (/\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin5::lcfirst';    }
    elsif (/\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin5::uc';         }
    elsif (/\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin5::ucfirst';    }
    elsif (/\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin5::fc';         }
    ...
    elsif (/\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin5::chr';               }
    elsif (/\G \b bytes::ord    (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin5::glob';              }
    elsif (/\G \b lc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin5::lc_';               }
    elsif (/\G \b lcfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin5::lcfirst_';          }
    elsif (/\G \b uc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin5::uc_';               }
    elsif (/\G \b ucfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin5::ucfirst_';          }
    elsif (/\G \b fc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin5::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin5::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin5::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Elatin5::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Elatin5::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq           (\#) [ ] (\#) /oxgc) { return 'Elatin5::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Elatin5::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Elatin5::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Elatin5::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Elatin5::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Elatin5::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q            (\#) [ ] (\#) /oxgc) { return 'Elatin5::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Elatin5::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Elatin5::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Elatin5::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Elatin5::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Elatin5::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                    ' [ ] '    /oxgc) { return 'Elatin5::split' . $e . qq     {' '};  }
        elsif (/\G                    " [ ] "    /oxgc) { return 'Elatin5::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Elatin5::PREMATCH()]}
            ...
            $e_string .= q{Elatin5::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Elatin5::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Elatin5::MATCH()};
            $slash = 'div';
        }
...
# subroutines of package Elatin5
        ...
        elsif ($string =~ /\G \b Latin5::eval       (?= (?>\s*) \{ )                    /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::eval \b                                        /oxgc) { $e_string .= 'eval Char::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b Latin5::eval \b                                        /oxgc) { $e_string .= 'eval Latin5::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                                     /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                              /oxgc) { $e_string .= 'Elatin5::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                                      /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::index \b                                       /oxgc) { $e_string .= 'Char::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b Latin5::index \b                                       /oxgc) { $e_string .= 'Latin5::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                             /oxgc) { $e_string .= 'Elatin5::index';      $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b Latin5::rindex \b                                      /oxgc) { $e_string .= 'Latin5::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                            /oxgc) { $e_string .= 'Elatin5::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin5::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin5::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin5::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin5::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin5::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin5::chr';           $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin5::glob';          $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                                      /oxgc) { $e_string .= 'Elatin5::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                                 /oxgc) { $e_string .= 'Elatin5::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                                      /oxgc) { $e_string .= 'Elatin5::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                                 /oxgc) { $e_string .= 'Elatin5::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                                      /oxgc) { $e_string .= 'Elatin5::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                                     /oxgc) { $e_string .= 'Elatin5::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                              /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                                     /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                                    /oxgc) { $e_string .= 'Elatin5::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Elatin5::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Elatin5::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq           (\#) [ ] (\#) /oxgc) { $e_string .= 'Elatin5::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { $e_string .= 'Elatin5::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { $e_string .= 'Elatin5::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { $e_string .= 'Elatin5::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { $e_string .= 'Elatin5::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { $e_string .= 'Elatin5::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q            (\#) [ ] (\#) /oxgc) { $e_string .= 'Elatin5::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { $e_string .= 'Elatin5::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { $e_string .= 'Elatin5::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { $e_string .= 'Elatin5::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { $e_string .= 'Elatin5::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { $e_string .= 'Elatin5::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                    ' [ ] '    /oxgc) { $e_string .= 'Elatin5::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                    " [ ] "    /oxgc) { $e_string .= 'Elatin5::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        ...
        return Elatin5::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Elatin5::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Elatin5::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Elatin5::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Elatin5::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Elatin5::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Elatin5::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Elatin5::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Elatin5::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Elatin5::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Elatin5::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Elatin5::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Elatin5::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Elatin5::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Elatin5::uc($char[$i]) ne Elatin5::fc($char[$i]))) {
            if (CORE::length(Elatin5::fc($char[$i])) == 1) {
                $char[$i] = '['   . Elatin5::uc($char[$i])       . Elatin5::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Elatin5::uc($char[$i]) . '|' . Elatin5::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin5::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ (?>\s*) 0 (?>\s*) \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Elatin5::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin5::ignorecase(Elatin5::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin5::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Elatin5::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin5::ignorecase(Elatin5::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin5::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Elatin5::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin5::ignorecase(Elatin5::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin5::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Latin5::re_t=%s; while($Latin5::re_t =~ %s){%s local $^W=0; local $Latin5::re_r=%s; %s$Latin5::re_t="$`$Latin5::re_r$'"; pos($Latin5::re_t)=length "$`$Latin5::re_r"; } return $Latin5::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Latin5::re_r=CORE::eval $Latin5::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Latin5::re_r=%s; %s"%s$Latin5::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Latin5::re_n=0; while(%s =~ %s){%s local $^W=0; local $Latin5::re_r=%s; %s%s="$`$Latin5::re_r$'"; pos(%s)=length "$`$Latin5::re_r"; $Latin5::re_n++} return %s$Latin5::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Latin5::re_r=%s; %s%s="%s$Latin5::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Latin5::re_r=%s; %s%s="%s$Latin5::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Latin5::re_r=CORE::eval $Latin5::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Elatin5::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Elatin5::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  # "no Elatin5;" not supported

=head1 ABSTRACT

This module has run-time routines for use Latin5 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Latin5 software and not
...
This Elatin5 module first appeared in ActivePerl Build 522 Built under
...
=item Split string
  ...
  @split = Elatin5::split(/pattern/,$string,$limit);
  @split = Elatin5::split(/pattern/,$string);
  @split = Elatin5::split(/pattern/);
  @split = Elatin5::split('',$string,$limit);
  @split = Elatin5::split('',$string);
  @split = Elatin5::split('');
  @split = Elatin5::split();
  @split = Elatin5::split;
  ...
  at all, Elatin5::split returns the original string as a single substring, If it
  ...
  @chars  = Elatin5::split(//,  $word);
  @fields = Elatin5::split(/:/, $line);
  @words  = Elatin5::split(" ", $paragraph);
  @lines  = Elatin5::split(/^/, $buffer);
  ...
  print join(":" => Elatin5::split(/ */, "hi there"));
  ...
  Elatin5::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Elatin5::split(/:/, $_, 3);
  ...
  splits on whitespace just as Elatin5::split with no arguments does. Thus,
  Elatin5::split(" ") can be used to emulate awk's default behavior. In contrast,
  Elatin5::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Elatin5::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Elatin5::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Elatin5::split()) {
          $count{$word}++;
      }
  }

  The inverse of Elatin5::split is join, except that join can only join with the
...
=item Transliteration
  ...
  $tr = Elatin5::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Elatin5::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  This subroutine scans a Latin-5 string character by character and replaces all
  ...
  print Elatin5::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item Chop string

  $chop = Elatin5::chop(@list);
  $chop = Elatin5::chop();
  $chop = Elatin5::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Elatin5::chop subroutine is used primary to remove the newline
  ...
  since Elatin5::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Elatin5::chop a literal, only a variable. If you Elatin5::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Elatin5::chop(@lines);

  You can Elatin5::chop anything that is an lvalue, including an assignment:

  Elatin5::chop($cwd = `pwd`);
  Elatin5::chop($answer = <STDIN>);

  This is different from:

  $answer = Elatin5::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Elatin5::chop returns the character
  ...
  In the most general case, Elatin5::chop can be expressed using substr:

  $last_code = Elatin5::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Elatin5::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Elatin5::chop;
...
=item Index string
  ...
  $byte_pos = Elatin5::index($string,$substr,$byte_offset);
  $byte_pos = Elatin5::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Elatin5::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Elatin5::rindex($string,$substr,$byte_offset);
  $byte_pos = Elatin5::rindex($string,$substr);

  This subroutine works just like Elatin5::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Elatin5::index).
  ...
  while (($byte_pos = Latin5::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  $lc = Elatin5::lc($string);
  $lc = Elatin5::lc_;

  This subroutine returns a lowercased version of Latin-5 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Elatin5::fc subroutine for case-insensitive comparisons via Latin5
  software.

=item Lower case first character of string

  $lcfirst = Elatin5::lcfirst($string);
  $lcfirst = Elatin5::lcfirst_;

  This subroutine returns a version of Latin-5 $string with the first character
  lowercased (or $_, if $string is omitted). This is the internal subroutine
  implementing the \l escape in double-quoted strings.

=item Upper case string

  $uc = Elatin5::uc($string);
  $uc = Elatin5::uc_;

  This subroutine returns an uppercased version of Latin-5 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Elatin5::ucfirst instead.
...
=item Upper case first character of string
  ...
  $ucfirst = Elatin5::ucfirst($string);
  $ucfirst = Elatin5::ucfirst_;
  ...
  $titlecase = Elatin5::ucfirst(substr($word,0,1)) . Elatin5::lc(substr($word,1));
  ...
  $do_not_use = Elatin5::ucfirst(Elatin5::lc($word));
...
=item Fold case string
  ...
  $fc = Elatin5::fc($string);
  $fc = Elatin5::fc_;

  New to Latin5 software, this subroutine returns the full Unicode-like casefold of
  Latin-5 $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Elatin5::fc($a) eq Elatin5::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Latin5 software has always used casefolding semantics for
...
=item Make ignore case string
  ...
  @ignorecase = Elatin5::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item Make capture number

  $capturenumber = Elatin5::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item Make character

  $chr = Elatin5::chr($code);
  $chr = Elatin5::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Elatin5::chr(65) is "A" in either
  ASCII or Latin-5, not Unicode. For the reverse of Elatin5::chr, use Latin5::ord.

=item Filename expansion (globbing)

  @glob = Elatin5::glob($string);
  @glob = Elatin5::glob_;
  ...
  The Elatin5::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Elatin5::glob('"*e f*"');
  @spacies = Elatin5::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Elatin5::glob("'*${var}e f*'");
  @spacies = Elatin5::glob(qq("*${var}e f*"));
