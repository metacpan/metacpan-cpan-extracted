package IO::K8s::Api::Resource::V1beta1::CELDeviceSelector;
...
IO::K8s::Api::Resource::V1beta1::CELDeviceSelector - CELDeviceSelector contains a CEL expression for selecting a device.
