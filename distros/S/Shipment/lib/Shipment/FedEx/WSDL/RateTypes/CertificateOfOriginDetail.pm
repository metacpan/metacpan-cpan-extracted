...
$Shipment::FedEx::WSDL::RateTypes::CertificateOfOriginDetail::VERSION = '3.09';
use strict;
use warnings;
...
CertificateOfOriginDetail from the namespace http://fedex.com/ws/rate/v9.
...
=item * CustomerImageUsages (min/maxOccurs: 0/1)
