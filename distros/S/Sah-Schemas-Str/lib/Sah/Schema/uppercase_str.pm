...
1;
# ABSTRACT: String containing only zero or more uppercase letters
...
Sah::Schema::uppercase_str - String containing only zero or more uppercase letters

=head1 VERSION

This document describes version 0.016 of Sah::Schema::uppercase_str (from Perl distribution Sah-Schemas-Str), released on 2023-10-23.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("uppercase_str*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("uppercase_str", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("uppercase_str", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("uppercase_str*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"uppercase_str*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('uppercase_str*', name=>'UppercaseStr')
     );
 }

 use My::Types qw(UppercaseStr);
 UppercaseStr->assert_valid($data);
