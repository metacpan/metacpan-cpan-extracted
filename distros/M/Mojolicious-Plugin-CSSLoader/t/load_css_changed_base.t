...
hook( before_render => sub {
    my $c = shift;
    $c->req->url->base( Mojo::URL->new('/test/') );
});
...
my $base_check  = qq~<link rel="stylesheet" href="/test/css/css_file.css"/>~;
my $hello_check = qq~<link rel="stylesheet" href="/test/css/second_file.css"/>
<link rel="stylesheet" href="/test/css/css_file.css"/>~;
