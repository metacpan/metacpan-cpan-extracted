package Text::Statistics::Cyrillic;
...
Text::Statistics::Cyrillic creates a seven column CSV file output with one line each
...
Example:
    ...
    &cyrillic("4"); #3 (4-1) texts will be analised.
    ...
    while ($tempo < 3){                                                             #limita o procedimenento aos ciclos inicial e meta-dado
        ...
        while ($num < $maximo){        
            ...
            while (1) {
                ...
                last unless $line;
                for ($line) {
                    s/[-]|[Ͽ-Ͽ]|[Ա-��]/ /g;;                            #separadores exclusivamente de alfabeto cirílico
                }   
...
L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Text-Statistics-Cyrillic>.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Text::Statistics::Cyrillic
...
L<http://annocpan.org/dist/Text-Statistics-Cyrillic>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/Text-Statistics-Cyrillic>

=item * RT: CPAN's request tracker

L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=Text-Statistics-Cyrillic>

=item * Search CPAN

L<http://search.cpan.org/dist/Text-Statistics-Cyrillic>
...
1; # End of Text::Statistics::Cyrillic
__END__
