...
package WebService::Edgecast::auto::Administration::Element::CustomerOriginsAdvancedGet;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerOriginsAdvancedGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerOriginsAdvancedGet');
...
WebService::Edgecast::auto::Administration::Element::CustomerOriginsAdvancedGet
...
CustomerOriginsAdvancedGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerOriginsAdvancedGet->new($data);
