...
(This example is included as L<F<synopsis.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.29/examples/synopsis.pl> in the distribution.)

=head1 VERSION

This documents version 0.29 of Text::Fuzzy corresponding
to git commit L<0e5db1fbccbc7d7518ec39a95d43a5b20166a727|https://github.com/benkasminbullock/Text-Fuzzy/commit/0e5db1fbccbc7d7518ec39a95d43a5b20166a727> released on Thu Dec 10 14:38:31 2020 +0900.
...
(This example is included as L<F<unicode.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.29/examples/unicode.pl> in the distribution.)
...
(This example is included as L<F<distance.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.29/examples/distance.pl> in the distribution.)
...
(This example is included as L<F<nearestv.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.29/examples/nearestv.pl> in the distribution.)
...
(This example is included as L<F<check-return.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.29/examples/check-return.pl> in the distribution.)
...
(This example is included as L<F<list-context.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.29/examples/list-context.pl> in the distribution.)
...
(This example is included as L<F<last-distance.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.29/examples/last-distance.pl> in the distribution.)
...
(This example is included as L<F<max-dist.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.29/examples/max-dist.pl> in the distribution.)
...
(This example is included as L<F<no-exact.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.29/examples/no-exact.pl> in the distribution.)
...
(This example is included as L<F<distance-edits.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.29/examples/distance-edits.pl> in the distribution.)
...
The file 
L<F<examples/misspelt-web-page.cgi>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.29/examples/misspelt-web-page.cgi> is an example of a CGI
...
The file 
L<F<examples/spell-check.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.29/examples/spell-check.pl> is a spell checker. It uses a
...
The file 
L<F<examples/extract-kana.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.29/examples/extract-kana.pl> extracts the kana entries
