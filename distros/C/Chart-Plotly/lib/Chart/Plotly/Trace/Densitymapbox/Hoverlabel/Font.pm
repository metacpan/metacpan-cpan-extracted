package Chart::Plotly::Trace::Densitymapbox::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Densitymapbox::Hoverlabel::Font - This attribute is one of the possible options for the trace densitymapbox.
