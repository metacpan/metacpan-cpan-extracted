...
has 'currencies' => (
	...
	default		=> sub { {
		...
		'PEN' => {
			symbol => 'PEN',
			display_name => {
				'currency' => q(Перуански нови сол),
				'few' => q(перуанска нова сола),
				'one' => q(перуански нови сол),
				'other' => q(перуанских нових сола),
			},
		},
		'PES' => {
			display_name => {
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'Alaska' => {
			long => {
				'daylight' => q(Аљаска, летње рачунање времена),
				'generic' => q(Аљаска),
		...
		'Armenia' => {
			long => {
				'daylight' => q(Јерменија летње рачунање времена),
		...
		'Cape_Verde' => {
			long => {
				'daylight' => q(Зеленортска Острва летње рачунање времена),
		...
		'Europe/London' => {
			...
			long => {
				'daylight' => q(Британија летње рачунање времена),
			},
		},
		'Europe/Luxembourg' => {
