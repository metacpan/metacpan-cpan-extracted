...
# 341
    ...
    sub {1},
# 351
#   sub { ($] >= 5.006) or eval q{ "\x00"             =~ UTF8::R2::qr(qr/[\x00]/)                   }},
#   sub { ($] >= 5.006) or eval q{ "\x7F"             =~ UTF8::R2::qr(qr/[\x7F]/)                   }},
#   sub { ($] >= 5.006) or eval q{ "\xC2\x80"         =~ UTF8::R2::qr(qr/[\xC2][\x80]/)             }},
#   sub { ($] >= 5.006) or eval q{ "\xDF\xBA"         =~ UTF8::R2::qr(qr/[\xDF][\xBA]/)             }},
#   sub { ($] >= 5.006) or eval q{ "\xE0\xA0\x80"     =~ UTF8::R2::qr(qr/[\xE0][\xA0][\x80]/)       }},
#   sub { ($] >= 5.006) or eval q{ "\xE0\xBF\x9A"     =~ UTF8::R2::qr(qr/[\xE0][\xBF][\x9A]/)       }},
#   sub { ($] >= 5.006) or eval q{ "\xF0\x90\x80\x80" =~ UTF8::R2::qr(qr/[\xF0][\x90][\x80][\x80]/) }},
#   sub { ($] >= 5.006) or eval q{ "\xF0\x90\xB9\xBE" =~ UTF8::R2::qr(qr/[\xF0][\x90][\xB9][\xBE]/) }},
    sub {1},
    sub {1},
    sub {1},
    sub {1},
