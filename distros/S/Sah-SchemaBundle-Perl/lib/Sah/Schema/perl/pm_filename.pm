...
Sah::Schema::perl::pm_filename - A .pm filename, e.g. /path/Foo.pm

=head1 VERSION

This document describes version 0.050 of Sah::Schema::perl::pm_filename (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
=head1 SAH SCHEMA DEFINITION
 ...
 [
   "str",
   {
     ...
     "x.perl.coerce_rules" => ["From_str::convert_perl_pm_to_path"],
   },
 ]

Base type: L<str|Data::Sah::Type::str>

Used completion: L<CODE(0x55f2611bf898)|Perinci::Sub::XCompletion::CODE(0x55f2611bf898)>
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::pm_filename*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::pm_filename", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::pm_filename", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::pm_filename*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::pm_filename*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::pm_filename*', name=>'PerlPmFilename')
     );
 }

 use My::Types qw(PerlPmFilename);
 PerlPmFilename->assert_valid($data);
