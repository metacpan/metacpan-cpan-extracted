package Chart::Plotly::Trace::Parcoords::Line::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Parcoords::Line::Colorbar::Tickfont;
use Chart::Plotly::Trace::Parcoords::Line::Colorbar::Tickformatstop;
use Chart::Plotly::Trace::Parcoords::Line::Colorbar::Titlefont;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Parcoords::Line::Colorbar::Tickfont", );
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Parcoords::Line::Colorbar::Tickformatstop]", );
...
has titlefont => ( is  => "rw",
                   isa => "Maybe[HashRef]|Chart::Plotly::Trace::Parcoords::Line::Colorbar::Titlefont", );
...
Chart::Plotly::Trace::Parcoords::Line::Colorbar - This attribute is one of the possible options for the trace parcoords.
