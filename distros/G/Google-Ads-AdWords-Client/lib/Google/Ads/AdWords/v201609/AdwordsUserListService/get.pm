...
package Google::Ads::AdWords::v201609::AdwordsUserListService::get;
use strict;
use warnings;
...
get from the namespace https://adwords.google.com/api/adwords/rm/v201609.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201609::AdwordsUserListService::get->new($data);
