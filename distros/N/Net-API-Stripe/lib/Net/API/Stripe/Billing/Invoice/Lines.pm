...
# sub data { return( shift->_set_get_object_array( 'data', 'Net::API::Stripe::Billing::Invoice::LineItem', @_ ) ); }
...
Net::API::Stripe::Billing::Invoice::Lines - A Stripe Invoice Lines List Object
