...
use lib 't/lib';
use Jcode;
use Test::WWW::Mechanize::Catalyst 'CharsetsTest::EucToUtf';

my $ua = Test::WWW::Mechanize::Catalyst->new;

my $euc = Jcode->new("日本語", 'utf8')->euc;
$ua->get_ok("http://localhost/foo?bar=".$euc);
$ua->content_is("bar is UTF-8");

$ua->get_ok("http://localhost/buz");
$ua->content_is(Jcode->new('日本語', 'utf8')->euc);
