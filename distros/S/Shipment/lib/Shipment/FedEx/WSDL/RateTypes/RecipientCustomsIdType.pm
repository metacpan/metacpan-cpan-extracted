package Shipment::FedEx::WSDL::RateTypes::RecipientCustomsIdType;
$Shipment::FedEx::WSDL::RateTypes::RecipientCustomsIdType::VERSION = '3.09';
use strict;
use warnings;
...
RecipientCustomsIdType from the namespace http://fedex.com/ws/rate/v9.
