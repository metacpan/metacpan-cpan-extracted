...
# 1
    ...
    sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -d "6007.000.A"         }) xor mb::eval(q{ -d "6007.000.ソ"         }) },
...
# 11
    ...
    sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ (-d "6007.000.A"        ) xor (-d "6007.000.ソ"        ) }) },
...
# 21
    ...
    sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ opendir(DH1,"6007.000.A"        ); my $r = eval q{ -d DH1 }; closedir DH1; $r }) },
...
# 31
    ...
    sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ opendir(DH2,"6007.000.ソ"        ); -d DH2 }) },
...
# 41
    ...
    sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ opendir(DH1,"6007.000.A"        ); opendir(DH2,"6007.000.ソ"        ); (-d DH1) xor (-d DH2) }) },
...
# 71
    ...
    sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ (-d "6007.000.ソ"        ) xor (-d _) }) },
