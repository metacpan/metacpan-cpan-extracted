package Google::Ads::AdWords::v201402::Image;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201402::Media);
# Variety: sequence
...
Google::Ads::AdWords::v201402::Image

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Image from the namespace https://adwords.google.com/api/adwords/cm/v201402.
