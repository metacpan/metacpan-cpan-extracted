package Benchmark::Perl::Formance::Plugin::AccessorsClassAccessorFast;
...
__PACKAGE__->mk_accessors( "zomtec" );
...
Benchmark::Perl::Formance::Plugin::AccessorsClassAccessorFast - benchmark plugin - Compare OO'ish accessors
