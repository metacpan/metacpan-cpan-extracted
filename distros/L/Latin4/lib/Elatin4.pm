...
######################################################################
#
# Elatin4 - Run-time routines for Latin4.pm
#
# http://search.cpan.org/dist/Char-Latin4/
#
...
#
# Latin-4 character range per length
#
my %range_tr = ();

#
# Latin-4 case conversion
#
my %lc = ();
...
sub import {
    ...
    *Char::ord           = \&Latin4::ord;
    *Char::ord_          = \&Latin4::ord_;
    *Char::reverse       = \&Latin4::reverse;
    *Char::getc          = \&Latin4::getc;
    *Char::length        = \&Latin4::length;
    *Char::substr        = \&Latin4::substr;
    *Char::index         = \&Latin4::index;
    *Char::rindex        = \&Latin4::rindex;
    *Char::eval          = \&Latin4::eval;
    *Char::escape        = \&Latin4::escape;
    *Char::escape_token  = \&Latin4::escape_token;
    *Char::escape_script = \&Latin4::escape_script;
}
...
sub Elatin4::rindex($$;$);
sub Elatin4::lcfirst(@);
sub Elatin4::lcfirst_();
sub Elatin4::lc(@);
sub Elatin4::lc_();
sub Elatin4::ucfirst(@);
sub Elatin4::ucfirst_();
sub Elatin4::uc(@);
sub Elatin4::uc_();
sub Elatin4::fc(@);
sub Elatin4::fc_();
sub Elatin4::ignorecase;
sub Elatin4::classic_character_class;
sub Elatin4::capture;
sub Elatin4::chr(;$);
sub Elatin4::chr_();
sub Elatin4::glob($);
...
# ${Elatin4::eS}          = qr{(?>[^\x09\x0A    \x0C\x0D\x20])};
# ${Elatin4::eS}          = qr{(?>[^\x09\x0A\x0B\x0C\x0D\x20])};
${Elatin4::eS}            = qr{(?>[^\s])};

${Elatin4::eW}            = qr{(?>[^0-9A-Z_a-z])};
${Elatin4::eH}            = qr{(?>[^\x09\x20])};
${Elatin4::eV}            = qr{(?>[^\x0A\x0B\x0C\x0D])};
${Elatin4::eR}            = qr{(?>\x0D\x0A|[\x0A\x0D])};
${Elatin4::eN}            = qr{(?>[^\x0A])};
${Elatin4::not_alnum}     = qr{(?>[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Elatin4::not_alpha}     = qr{(?>[^\x41-\x5A\x61-\x7A])};
${Elatin4::not_ascii}     = qr{(?>[^\x00-\x7F])};
${Elatin4::not_blank}     = qr{(?>[^\x09\x20])};
${Elatin4::not_cntrl}     = qr{(?>[^\x00-\x1F\x7F])};
${Elatin4::not_digit}     = qr{(?>[^\x30-\x39])};
${Elatin4::not_graph}     = qr{(?>[^\x21-\x7F])};
${Elatin4::not_lower}     = qr{(?>[^\x61-\x7A])};
${Elatin4::not_lower_i}   = qr{(?>[^\x41-\x5A\x61-\x7A])}; # Perl 5.16 compatible
# ${Elatin4::not_lower_i} = qr{(?>[\x00-\xFF])};                   # older Perl compatible
${Elatin4::not_print}     = qr{(?>[^\x20-\x7F])};
${Elatin4::not_punct}     = qr{(?>[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Elatin4::not_space}     = qr{(?>[^\s\x0B])};
${Elatin4::not_upper}     = qr{(?>[^\x41-\x5A])};
${Elatin4::not_upper_i}   = qr{(?>[^\x41-\x5A\x61-\x7A])}; # Perl 5.16 compatible
# ${Elatin4::not_upper_i} = qr{(?>[\x00-\xFF])};                   # older Perl compatible
${Elatin4::not_word}      = qr{(?>[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Elatin4::not_xdigit}    = qr{(?>[^\x30-\x39\x41-\x46\x61-\x66])};
${Elatin4::eb}            = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Elatin4::eB}            = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Elatin4::foo" used only once: possible typo at here.
${Elatin4::dot}         = ${Elatin4::dot};
${Elatin4::dot_s}       = ${Elatin4::dot_s};
${Elatin4::eD}          = ${Elatin4::eD};
${Elatin4::eS}          = ${Elatin4::eS};
${Elatin4::eW}          = ${Elatin4::eW};
${Elatin4::eH}          = ${Elatin4::eH};
${Elatin4::eV}          = ${Elatin4::eV};
${Elatin4::eR}          = ${Elatin4::eR};
${Elatin4::eN}          = ${Elatin4::eN};
${Elatin4::not_alnum}   = ${Elatin4::not_alnum};
${Elatin4::not_alpha}   = ${Elatin4::not_alpha};
${Elatin4::not_ascii}   = ${Elatin4::not_ascii};
${Elatin4::not_blank}   = ${Elatin4::not_blank};
${Elatin4::not_cntrl}   = ${Elatin4::not_cntrl};
${Elatin4::not_digit}   = ${Elatin4::not_digit};
${Elatin4::not_graph}   = ${Elatin4::not_graph};
${Elatin4::not_lower}   = ${Elatin4::not_lower};
${Elatin4::not_lower_i} = ${Elatin4::not_lower_i};
${Elatin4::not_print}   = ${Elatin4::not_print};
${Elatin4::not_punct}   = ${Elatin4::not_punct};
${Elatin4::not_space}   = ${Elatin4::not_space};
${Elatin4::not_upper}   = ${Elatin4::not_upper};
${Elatin4::not_upper_i} = ${Elatin4::not_upper_i};
${Elatin4::not_word}    = ${Elatin4::not_word};
${Elatin4::not_xdigit}  = ${Elatin4::not_xdigit};
${Elatin4::eb}          = ${Elatin4::eb};
${Elatin4::eB}          = ${Elatin4::eB};
...
#
# Latin-4 lower case first with parameter
#
sub Elatin4::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Elatin4::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Elatin4::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Elatin4::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Latin-4 lower case first without parameter
#
sub Elatin4::lcfirst_() {
    return Elatin4::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Latin-4 lower case with parameter
#
sub Elatin4::lc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-4 lower case without parameter
#
sub Elatin4::lc_() {
    my $s = $_;
    return join '', map {defined($lc{$_}) ? $lc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-4 upper case first with parameter
#
sub Elatin4::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Elatin4::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Elatin4::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Elatin4::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Latin-4 upper case first without parameter
#
sub Elatin4::ucfirst_() {
    return Elatin4::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Latin-4 upper case with parameter
#
sub Elatin4::uc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-4 upper case without parameter
#
sub Elatin4::uc_() {
    my $s = $_;
    return join '', map {defined($uc{$_}) ? $uc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-4 fold case with parameter
#
sub Elatin4::fc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-4 fold case without parameter
#
sub Elatin4::fc_() {
    my $s = $_;
    return join '', map {defined($fc{$_}) ? $fc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-4 regexp ignore case modifier
#
sub Elatin4::ignorecase {
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Elatin4::uc($char[$i]);
                my $fc = Elatin4::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
#
# prepare Latin-4 characters per length
#
...
#
# Latin-4 open character list for tr
#
sub _charlist_tr {
...
#
# Latin-4 open character list for qr and not qr
#
sub _charlist {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Elatin4::not_lower_i}',
                '[:^upper:]'  => '${Elatin4::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Elatin4::not_alnum}',
                '[:^alpha:]'  => '${Elatin4::not_alpha}',
                '[:^ascii:]'  => '${Elatin4::not_ascii}',
                '[:^blank:]'  => '${Elatin4::not_blank}',
                '[:^cntrl:]'  => '${Elatin4::not_cntrl}',
                '[:^digit:]'  => '${Elatin4::not_digit}',
                '[:^graph:]'  => '${Elatin4::not_graph}',
                '[:^lower:]'  => '${Elatin4::not_lower}',
                '[:^print:]'  => '${Elatin4::not_print}',
                '[:^punct:]'  => '${Elatin4::not_punct}',
                '[:^space:]'  => '${Elatin4::not_space}',
                '[:^upper:]'  => '${Elatin4::not_upper}',
                '[:^word:]'   => '${Elatin4::not_word}',
                '[:^xdigit:]' => '${Elatin4::not_xdigit}',
...
#
# Latin-4 hexadecimal escape sequence
#
sub hexchr {
    my($hexdigit) = @_;
...
#
# Latin-4 open character list for qr
#
sub charlist_qr {
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Elatin4::uc($char);
                        my $fc = Elatin4::fc($char);
                        if ($uc eq $fc) {
...
#
# Latin-4 open character list for not qr
#
sub charlist_not_qr {
...
#
# Latin-4 order to character (with parameter)
#
sub Elatin4::chr(;$) {
...
#
# Latin-4 order to character (without parameter)
#
sub Elatin4::chr_() {
...
#
# Latin-4 path globbing (with parameter)
#
sub Elatin4::glob($) {
...
#
# Latin-4 path globbing (without parameter)
#
sub Elatin4::glob_() {
...
#
# Latin-4 path globbing via File::DosGlob 1.10
#
...
#
# Latin-4 path globbing subroutine
#
sub _do_glob {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Elatin4::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Elatin4::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Elatin4::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Elatin4::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
#
sub Elatin4::POSTMATCH {
    return $';
}

#
# Latin-4 character to order (with parameter)
#
sub Latin4::ord(;$) {
...
#
# Latin-4 character to order (without parameter)
#
sub Latin4::ord_() {
...
#
# Latin-4 getc (with parameter, without parameter)
#
sub Latin4::getc(;*@) {

    my($package) = caller;
    my $fh = @_ ? qualify_to_ref(shift,$package) : \*STDIN;
    croak 'Too many arguments for Latin4::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Elatin4::dot_s} \z/oxms) {
...
#
# Latin-4 index by character
#
sub Latin4::index($$;$) {

    my $index;
    if (@_ == 3) {
        $index = Elatin4::index($_[0], $_[1], CORE::length(Latin4::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Elatin4::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Latin4::length(CORE::substr $_[0], 0, $index);
    }
}

#
# Latin-4 rindex by character
#
sub Latin4::rindex($$;$) {

    my $rindex;
    if (@_ == 3) {
        $rindex = Elatin4::rindex($_[0], $_[1], CORE::length(Latin4::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Elatin4::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Latin4::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
# ord() to ord() or Latin4::ord()
my $function_ord = 'ord';

# ord to ord or Latin4::ord_
my $function_ord_ = 'ord';

# reverse to reverse or Latin4::reverse
my $function_reverse = 'reverse';

# getc to getc or Latin4::getc
...
my $qq_substr  = qr{(?> Char::substr | Latin4::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
#
# escape Latin-4 token of script
#
sub Latin4::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Elatin4::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ (?>\s*) PREMATCH  \b | \$ (?>\s*) \{ (?>\s*) PREMATCH  (?>\s*) \} | \$ (?>\s*) \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin4::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Elatin4::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin4::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Elatin4::POSTMATCH()
    elsif (/\G (                 \$ (?>\s*) POSTMATCH \b | \$ (?>\s*) \{ (?>\s*) POSTMATCH (?>\s*) \} | \$ (?>\s*) \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin4::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Elatin4::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob (?>\s*) \) /oxgc) {
        return 'while ($_ = Elatin4::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob \b /oxgc) {
        return 'while ($_ = Elatin4::glob';
    }
...
# subroutines of package Elatin4
    elsif (/\G \b (CORE:: | ->(>?\s*) (?: atan2 | [a-z]{2,})) \b       /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Latin4::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Char::escape'; }
    elsif (/\G \b Latin4::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Latin4::escape'; }
    elsif (/\G \b bytes::substr \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin4::chop';       }
    elsif (/\G \b bytes::index \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::index';       }
    elsif (/\G \b Latin4::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Latin4::index';       }
    elsif (/\G \b index \b         (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin4::index';      }
    elsif (/\G \b bytes::rindex \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::rindex';      }
    elsif (/\G \b Latin4::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Latin4::rindex';      }
    elsif (/\G \b rindex \b        (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin4::rindex';     }
    elsif (/\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin4::lc';         }
    elsif (/\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin4::lcfirst';    }
    elsif (/\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin4::uc';         }
    elsif (/\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin4::ucfirst';    }
    elsif (/\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin4::fc';         }
    ...
    elsif (/\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin4::chr';               }
    elsif (/\G \b bytes::ord    (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin4::glob';              }
    elsif (/\G \b lc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin4::lc_';               }
    elsif (/\G \b lcfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin4::lcfirst_';          }
    elsif (/\G \b uc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin4::uc_';               }
    elsif (/\G \b ucfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin4::ucfirst_';          }
    elsif (/\G \b fc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin4::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin4::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin4::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Elatin4::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Elatin4::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq           (\#) [ ] (\#) /oxgc) { return 'Elatin4::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Elatin4::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Elatin4::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Elatin4::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Elatin4::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Elatin4::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q            (\#) [ ] (\#) /oxgc) { return 'Elatin4::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Elatin4::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Elatin4::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Elatin4::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Elatin4::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Elatin4::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                    ' [ ] '    /oxgc) { return 'Elatin4::split' . $e . qq     {' '};  }
        elsif (/\G                    " [ ] "    /oxgc) { return 'Elatin4::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Elatin4::PREMATCH()]}
            ...
            $e_string .= q{Elatin4::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Elatin4::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Elatin4::MATCH()};
            $slash = 'div';
        }
...
sub character_class {
    ...
    if ($char eq '.') {
        ...
        return Elatin4::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Elatin4::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Elatin4::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Elatin4::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Elatin4::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Elatin4::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Elatin4::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Elatin4::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Elatin4::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Elatin4::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Elatin4::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Elatin4::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Elatin4::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Elatin4::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Elatin4::uc($char[$i]) ne Elatin4::fc($char[$i]))) {
            if (CORE::length(Elatin4::fc($char[$i])) == 1) {
                $char[$i] = '['   . Elatin4::uc($char[$i])       . Elatin4::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Elatin4::uc($char[$i]) . '|' . Elatin4::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin4::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ (?>\s*) 0 (?>\s*) \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Elatin4::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin4::ignorecase(Elatin4::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin4::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Elatin4::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin4::ignorecase(Elatin4::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin4::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Elatin4::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin4::ignorecase(Elatin4::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin4::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Elatin4::re_t=%s; while($Elatin4::re_t =~ %s){%s local $^W=0; local $Elatin4::re_r=%s; %s$Elatin4::re_t="$`$Elatin4::re_r$'"; pos($Elatin4::re_t)=length "$`$Elatin4::re_r"; } return $Elatin4::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Elatin4::re_r=CORE::eval $Elatin4::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Elatin4::re_r=%s; %s"%s$Elatin4::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Elatin4::re_n=0; while(%s =~ %s){%s local $^W=0; local $Elatin4::re_r=%s; %s%s="$`$Elatin4::re_r$'"; pos(%s)=length "$`$Elatin4::re_r"; $Elatin4::re_n++} return %s$Elatin4::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Elatin4::re_r=%s; %s%s="%s$Elatin4::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Elatin4::re_r=%s; %s%s="%s$Elatin4::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Elatin4::re_r=CORE::eval $Elatin4::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Elatin4::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Elatin4::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  # "no Elatin4;" not supported

=head1 ABSTRACT

This module has run-time routines for use Latin4 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Latin4 software and not
...
This Elatin4 module first appeared in ActivePerl Build 522 Built under
...
=item * Split string
  ...
  @split = Elatin4::split(/pattern/,$string,$limit);
  @split = Elatin4::split(/pattern/,$string);
  @split = Elatin4::split(/pattern/);
  @split = Elatin4::split('',$string,$limit);
  @split = Elatin4::split('',$string);
  @split = Elatin4::split('');
  @split = Elatin4::split();
  @split = Elatin4::split;
  ...
  at all, Elatin4::split returns the original string as a single substring, If it
  ...
  @chars  = Elatin4::split(//,  $word);
  @fields = Elatin4::split(/:/, $line);
  @words  = Elatin4::split(" ", $paragraph);
  @lines  = Elatin4::split(/^/, $buffer);
  ...
  print join(":" => Elatin4::split(/ */, "hi there"));
  ...
  Elatin4::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Elatin4::split(/:/, $_, 3);
  ...
  splits on whitespace just as Elatin4::split with no arguments does. Thus,
  Elatin4::split(" ") can be used to emulate awk's default behavior. In contrast,
  Elatin4::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Elatin4::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Elatin4::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Elatin4::split()) {
          $count{$word}++;
      }
  }

  The inverse of Elatin4::split is join, except that join can only join with the
...
=item * Transliteration
  ...
  $tr = Elatin4::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Elatin4::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  This subroutine scans a Latin-4 string character by character and replaces all
  ...
  print Elatin4::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item * Chop string

  $chop = Elatin4::chop(@list);
  $chop = Elatin4::chop();
  $chop = Elatin4::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Elatin4::chop subroutine is used primary to remove the newline
  ...
  since Elatin4::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Elatin4::chop a literal, only a variable. If you Elatin4::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Elatin4::chop(@lines);

  You can Elatin4::chop anything that is an lvalue, including an assignment:

  Elatin4::chop($cwd = `pwd`);
  Elatin4::chop($answer = <STDIN>);

  This is different from:

  $answer = Elatin4::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Elatin4::chop returns the character
  ...
  In the most general case, Elatin4::chop can be expressed using substr:

  $last_code = Elatin4::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Elatin4::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Elatin4::chop;
...
=item * Index string
  ...
  $byte_pos = Elatin4::index($string,$substr,$byte_offset);
  $byte_pos = Elatin4::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Elatin4::index($string, $lookfor, $byte_pos)) > -1) {
...
=item * Reverse index string
  ...
  $byte_pos = Elatin4::rindex($string,$substr,$byte_offset);
  $byte_pos = Elatin4::rindex($string,$substr);

  This subroutine works just like Elatin4::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Elatin4::index).
  ...
  while (($byte_pos = Latin4::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item * Lower case string
  ...
  $lc = Elatin4::lc($string);
  $lc = Elatin4::lc_;

  This subroutine returns a lowercased version of Latin-4 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Elatin4::fc subroutine for case-insensitive comparisons via Latin4
  software.

=item * Lower case first character of string

  $lcfirst = Elatin4::lcfirst($string);
  $lcfirst = Elatin4::lcfirst_;

  This subroutine returns a version of Latin-4 $string with the first character
  lowercased (or $_, if $string is omitted). This is the internal subroutine
  implementing the \l escape in double-quoted strings.

=item * Upper case string

  $uc = Elatin4::uc($string);
  $uc = Elatin4::uc_;

  This subroutine returns an uppercased version of Latin-4 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Elatin4::ucfirst instead.
...
=item * Upper case first character of string
  ...
  $ucfirst = Elatin4::ucfirst($string);
  $ucfirst = Elatin4::ucfirst_;
  ...
  $titlecase = Elatin4::ucfirst(substr($word,0,1)) . Elatin4::lc(substr($word,1));
  ...
  $do_not_use = Elatin4::ucfirst(Elatin4::lc($word));
...
=item * Fold case string
  ...
  $fc = Elatin4::fc($string);
  $fc = Elatin4::fc_;

  New to Latin4 software, this subroutine returns the full Unicode-like casefold of
  Latin-4 $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Elatin4::fc($a) eq Elatin4::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Latin4 software has always used casefolding semantics for
...
=item * Make ignore case string
  ...
  @ignorecase = Elatin4::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item * Make capture number

  $capturenumber = Elatin4::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item * Make character

  $chr = Elatin4::chr($code);
  $chr = Elatin4::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Elatin4::chr(65) is "A" in either
  ASCII or Latin-4, not Unicode. For the reverse of Elatin4::chr, use Latin4::ord.

=item * Filename expansion (globbing)

  @glob = Elatin4::glob($string);
  @glob = Elatin4::glob_;
  ...
  The Elatin4::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Elatin4::glob('"*e f*"');
  @spacies = Elatin4::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Elatin4::glob("'*${var}e f*'");
  @spacies = Elatin4::glob(qq("*${var}e f*"));
