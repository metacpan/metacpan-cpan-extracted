...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::GlobalVmExtensionPolicy Google::Cloud::Compute::V1::Compute::GlobalVmExtensionPolicyList Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::VmExtensionPolicyAggregatedListResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::GlobalVmExtensionPoliciesClient->new( credentials => 'dummy' );
