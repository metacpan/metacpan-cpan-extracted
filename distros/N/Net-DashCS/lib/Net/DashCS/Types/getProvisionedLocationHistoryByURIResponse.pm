package Net::DashCS::Types::getProvisionedLocationHistoryByURIResponse;
use strict;
use warnings;
...
my %ProvisionedLocations_of :ATTR(:get<ProvisionedLocations>);

__PACKAGE__->_factory(
    [ qw(        ProvisionedLocations

    ) ],
    {
        'ProvisionedLocations' => \%ProvisionedLocations_of,
    },
    {
    ...
    },
    {
        ...
        'ProvisionedLocations' => 'ProvisionedLocations',
    }
);
