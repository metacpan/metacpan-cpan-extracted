package Biblio::ILL::ISO::Recall;

=head1 NAME

Biblio::ILL::ISO::Recall - Perl extension for handling ISO 10161 interlibrary loan Recall messages
...
Biblio::ILL::ISO::Recall is a derivation of the abstract 
Biblio::ILL::ISO::ISO object, and handles the Recall message type.
...
Recall message from a file (followed by a call to
...
To read a message from a file, use the following:
    ...
    my $href = $msg->read("msg_09.recall.ber");
