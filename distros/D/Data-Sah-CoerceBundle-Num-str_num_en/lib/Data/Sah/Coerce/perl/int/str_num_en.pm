...
Data::Sah::Coerce::perl::int::str_num_en - Parse number using Parse::Number::EN

=head1 VERSION

This document describes version 0.003 of Data::Sah::Coerce::perl::int::str_num_en (from Perl distribution Data-Sah-CoerceBundle-Num-str_num_en), released on 2019-07-26.
