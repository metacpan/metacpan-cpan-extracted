...
sub abstract {
    return 'Create relative symbolic links';
}
...
sub meta_merge {
	...
	resources	=> {
	    ...
	    repository	=> {
		type	=> 'git',
		url	=> 'git://github.com/trwyant/perl-File-Symlink-Relative.git',
		web	=> 'https://github.com/trwyant/perl-File-Symlink-Relative',
	    },
	},
	@extra,
    };
...
sub version_from {
    return 'lib/File/Symlink/Relative.pm';
}
...
My::Module::Meta - Information needed to build File::Symlink::Relative
...
This module centralizes information needed to build C<File::Symlink::Relative>. It
is private to the C<File::Symlink::Relative> package, and may be changed or
...
modules required to build the C<File::Symlink::Relative> package, suitable for
...
the modules required to run the C<File::Symlink::Relative>
