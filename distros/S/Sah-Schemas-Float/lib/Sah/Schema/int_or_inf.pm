...
Sah::Schema::int_or_inf - Integer, or Inf/-Inf

=head1 VERSION

This document describes version 0.011 of Sah::Schema::int_or_inf (from Perl distribution Sah-Schemas-Float), released on 2020-06-04.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("int_or_inf*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("int_or_inf*");
     $validator->(\@args);
     ...
 }
