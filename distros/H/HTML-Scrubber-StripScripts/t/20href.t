...
$s = HTML::Scrubber::StripScripts->new( Allow_href => 1 );
...
test( '<a href="http://www.example.com/">', '<a href="http://www.example.com/">', 'a href' );
test( '<a href="mailto:foo@example.com">', '<a>', 'a mailto' );
test( '<q cite="http://www.example.com/">', '<q cite="http://www.example.com/">', 'q cite' );
test( '<q cite="mailto:foo@example.com">', '<q>', 'q cite mailto' );
test( '<blockquote cite="http://www.example.com/">', '<blockquote cite="http://www.example.com/">', 'blockquote cite' );
...
test( '<img src="http://www.example.com/">', '<img>', 'img src' );
test( '<img src="http://www.example.com/cgi-bin/foo?asdf=asdf;fs=sdf&asdf=&$#54">', '<img>', 'img src query' );
test( '<img src="https://www.example.com/cgi-bin/foo">', '<img>', 'img src https' );
test( '<img src="HTTPS://WWW.EXAMPLE.COM/CGI-BIN/FOO">', '<img>', 'img src caps' );
test( '<img src="ftp://ftp.example.com/foo.gif">', '<img>', 'img src ftp' );
test( '<img src="/images/foo.gif">', '<img>', 'img src abs local part' );
test( '<img src="foo.gif">', '<img>', 'img src rel local part' );
test( '<img src="../images/foo.gif">', '<img>', 'img src .. local part' );
test( '<table background="http://www.example.com/">', '<table>', 'table background' );
