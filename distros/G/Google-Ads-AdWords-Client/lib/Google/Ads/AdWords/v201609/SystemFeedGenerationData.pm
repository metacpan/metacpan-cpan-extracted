package Google::Ads::AdWords::v201609::SystemFeedGenerationData;
use strict;
use warnings;
...
SystemFeedGenerationData from the namespace https://adwords.google.com/api/adwords/cm/v201609.
