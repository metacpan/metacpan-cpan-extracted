package Google::Ads::AdWords::v201708::PolicySummaryDenormalizedStatus;
use strict;
use warnings;
...
PolicySummaryDenormalizedStatus from the namespace https://adwords.google.com/api/adwords/cm/v201708.
