...
$Map::Tube::Exception::MissingSupportedObject::VERSION = '3.11';
=head1 NAME

Map::Tube::Exception::MissingSupportedObject - Represent 'missing supported object' exception.
...
has status => (is => 'ro', default => sub { 117 });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Map::Tube::Exception::MissingSupportedObject
...
1; # End of Map::Tube::Exception::MissingSupportedObject
