  ...
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       ...
       return Cfn::Resource::Properties::Object::AWS::WAFRegional::RateBasedRule::Predicate->new( %$_ );
     }
   };

package Cfn::Resource::Properties::Object::AWS::WAFRegional::RateBasedRule::Predicate {
  use Moose;
