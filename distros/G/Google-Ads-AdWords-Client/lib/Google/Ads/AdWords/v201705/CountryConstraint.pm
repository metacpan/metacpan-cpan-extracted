package Google::Ads::AdWords::v201705::CountryConstraint;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201705::PolicyTopicConstraint);
# Variety: sequence
...
CountryConstraint from the namespace https://adwords.google.com/api/adwords/cm/v201705.
