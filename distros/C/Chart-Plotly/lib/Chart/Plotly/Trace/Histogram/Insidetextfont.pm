package Chart::Plotly::Trace::Histogram::Insidetextfont;
use Moose;
...
Chart::Plotly::Trace::Histogram::Insidetextfont - This attribute is one of the possible options for the trace histogram.
