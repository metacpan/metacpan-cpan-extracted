# AWS::RDS::DBSecurityGroup generated from spec 18.4.0
...
Cfn::Resource::AWS::RDS::DBSecurityGroup - Cfn resource for AWS::RDS::DBSecurityGroup

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::RDS::DBSecurityGroup.
