...
package UMMF::MOF_1_3::Model::Integer;
...
Constructs new UMMF::MOF_1_3::Model::Integer value.
...
sub new
{
  ...
  __typecheck($self, $x, 'UMMF::MOF_1_3::Model::Integer::new');
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_3::Model::Integer->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_3::Model::Integer|UMMF::MOF_1_3::Model::Integer>.
...
=head2 C<__typecheck>
  ...
  UMMF::MOF_1_3::Model::Integer->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_3::Model::Integer->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_3::Model::Integer' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_3::Model::Integer|UMMF::MOF_1_3::Model::Integer>.
...
Returns the UML Model name (C<'Model::Integer'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Model::Integer' }
...
sub __initialize
{
  ...
  $self->UMMF::MOF_1_3::Model::Integer::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_3::Model::Integer::___create(@args);
