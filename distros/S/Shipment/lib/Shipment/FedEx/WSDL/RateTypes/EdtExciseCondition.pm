package Shipment::FedEx::WSDL::RateTypes::EdtExciseCondition;
$Shipment::FedEx::WSDL::RateTypes::EdtExciseCondition::VERSION = '3.07';
use strict;
use warnings;
...
EdtExciseCondition from the namespace http://fedex.com/ws/rate/v9.
