...
Server-side specialization of L<Protocol::WebSocket::Fast::Parser>.

Methods of this class are used for accepting a logical websocket connection from client.

See L<Protocol::WebSocket::Fast::Parser> for API after accepting a connection.
...
Returns undef if more data is needed, otherwise returns L<Protocol::WebSocket::Fast::ConnectRequest> object.
...
which where enabled by configuration (L<Protocol::WebSocket::Fast::Parser::configure>)
...
C<$response> may be an L<Protocol::WebSocket::Fast::ConnectResponse> object or a params hashref that its constructor supports.
