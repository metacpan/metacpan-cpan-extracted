package Google::Ads::AdWords::v201309::LongValue;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201309::NumberValue);
# Variety: sequence
...
Google::Ads::AdWords::v201309::LongValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LongValue from the namespace https://adwords.google.com/api/adwords/cm/v201309.
