package Chart::Plotly::Trace::Carpet::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Carpet::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Carpet::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Carpet::Hoverlabel - This attribute is one of the possible options for the trace carpet.
