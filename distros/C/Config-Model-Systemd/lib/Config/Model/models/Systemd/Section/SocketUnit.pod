...
Similar to C<Wants>, but declares a stronger
...
be started before the unit that is configured with these options. I< Optional. Type list of uniline.  > 
...
When a job for this unit is queued, a timeout C<JobTimeoutSec> may be
...
is useful to abort only the job waiting for the unit state to change. I< Optional. Type uniline.  > 
...
C<JobTimeoutAction> optionally configures an additional action to take when
...
the start will not be permitted. Defaults to C<none>. I< Optional. Type enum. choice: 'none', 'reboot', 'reboot-force', 'reboot-immediate', 'poweroff', 'poweroff-force', 'poweroff-immediate', 'exit', 'exit-force'.  > 
...
C<ConditionHost> may be used to match against the hostname or
...
looked for with right and left hand side matching. I< Optional. Type list of uniline.  > 
...
mark. I< Optional. Type list of uniline.  > 
...
update. I< Optional. Type list of enum.  > 
...
system instance boots up for the first time. I< Optional. Type list of boolean.  > 
...
Verify that the given cgroup controller (eg. C<cpu>) is available
...
C<pids>. I< Optional. Type list of uniline.  > 
...
operator. In containers compares the amount of memory assigned to the container instead. I< Optional. Type list of uniline.  > 
...
to the container and not the physically available ones. I< Optional. Type list of uniline.  > 
...
below. I< Optional. Type enum. choice: 'none', 'reboot', 'reboot-force', 'reboot-immediate', 'poweroff', 'poweroff-force', 'poweroff-immediate', 'exit', 'exit-force'.  > 
