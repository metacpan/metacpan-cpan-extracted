...
1;
# ABSTRACT: A color theme which gives random 16-color foreground ANSI codes
...
ColorTheme::Test::RandomANSI16FG - A color theme which gives random 16-color foreground ANSI codes

=head1 VERSION

This document describes version 0.007 of ColorTheme::Test::RandomANSI16FG (from Perl distribution ColorThemes-Test), released on 2021-08-01.
