package Chart::Plotly::Trace::Isosurface::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Isosurface::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Isosurface::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Isosurface::Hoverlabel - This attribute is one of the possible options for the trace isosurface.
