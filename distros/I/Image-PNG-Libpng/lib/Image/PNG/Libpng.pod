...
(This example is included as L<F<synopsis.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.46/examples/synopsis.pl> in the distribution.)


=head1 VERSION

This document describes Image::PNG::Libpng version 0.46, corresponding to git commit L<67ee3df9fa8114b3fe3e2517e687ff1184904a70|https://github.com/benkasminbullock/image-png-libpng/commit/67ee3df9fa8114b3fe3e2517e687ff1184904a70> at Sat Sep 15 20:33:25 2018 +0900.
...
(This example is included as L<F<get-www-png.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.46/examples/get-www-png.pl> in the distribution.)
...
(This example is included as L<F<png-cgi.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.46/examples/png-cgi.pl> in the distribution.)
...
(This example is included as L<F<copy-png.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.46/examples/copy-png.pl> in the distribution.)
...
(This example is included as L<F<color-type-name.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.46/examples/color-type-name.pl> in the distribution.)
...
you can find each instance L<in the file C<perl-libpng.c> in the top directory of the distribution|http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.46/perl-libpng.c> in the macro
C<UNUSED_ZERO_ARG>.
