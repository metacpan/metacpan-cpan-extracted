...
static int asn_MAP_T_CSI_oms_1[] = { 1, 2, 3, 4 };
static ber_tlv_tag_t asn_DEF_T_CSI_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_T_CSI_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 1 }, /* t-BcsmCamelTDPDataList at 2318 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, -1, 0 }, /* extensionContainer at 2319 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 2, 0, 0 }, /* camelCapabilityHandling at 2321 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 3, 0, 0 }, /* notificationToCSE at 2322 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 4, 0, 0 } /* csi-Active at 2323 */
};
static asn_SEQUENCE_specifics_t asn_SPC_T_CSI_specs_1 = {
	...
	asn_MAP_T_CSI_oms_1,	/* Optional members */
	1, 3,	/* Root/Additions */
	1,	/* Start extensions */
	6	/* Stop extensions */
};
