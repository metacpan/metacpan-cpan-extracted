...
static int asn_MAP_O_BcsmCamelTDPData_oms_1[] = { 4 };
...
static asn_TYPE_tag2member_t asn_MAP_O_BcsmCamelTDPData_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 1, 0, 0 }, /* serviceKey at 2050 */
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 0, 0, 0 }, /* o-BcsmTriggerDetectionPoint at 2049 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 2, 0, 0 }, /* gsmSCF-Address at 2051 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 3, 0, 0 }, /* defaultCallHandling at 2052 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 4, 0, 0 } /* extensionContainer at 2053 */
};
static asn_SEQUENCE_specifics_t asn_SPC_O_BcsmCamelTDPData_specs_1 = {
	...
	asn_MAP_O_BcsmCamelTDPData_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	4,	/* Start extensions */
	6	/* Stop extensions */
};
