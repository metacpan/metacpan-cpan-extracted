...
int canonicalizeXml (char *xmlString, char *xpathString, char *nameSpace, int exc, int comm, xmlChar **output) {
  ...
  int i = xmlC14NDocDumpMemory (myXmlDoc,  (xpath) ? xpath->nodesetval : NULL, exclusive, list, with_comments, output);
