use utf8;
package Schema::RackTables::0_20_5::Result::IPv4RSPool;
...
Related object: L<Schema::RackTables::0_20_5::Result::IPv4RS>

=cut

__PACKAGE__->has_many(
  "ipv4_rs",
  "Schema::RackTables::0_20_5::Result::IPv4RS",
  { "foreign.rspool_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:O55NUPN3/rTu50V/vuEOmA
