...
package Search::Elasticsearch::Client::6_0::Bulk;
$Search::Elasticsearch::Client::6_0::Bulk::VERSION = '7.711001';
use Moo;
...
This module provides a wrapper for the L<Search::Elasticsearch::Client::6_0::Direct/bulk()>
method which makes it easier to run multiple create, index, update or delete
actions in a single request.

The L<Search::Elasticsearch::Client::6_0::Bulk> module acts as a queue, buffering up actions
...
a L<bulk()|Search::Elasticsearch::Client::6_0::Direct/bulk()> request.
