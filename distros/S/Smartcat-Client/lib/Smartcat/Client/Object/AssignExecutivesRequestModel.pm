...
#
package Smartcat::Client::Object::AssignExecutivesRequestModel;
...
__PACKAGE__->method_documentation(
    {
        'executives' => {
            datatype    => 'ARRAY[Executive]',
            base_name   => 'executives',
            description => '',
            format      => '',
            read_only   => '',
        },
        'min_words_count_for_executive' => {
            datatype    => 'int',
            base_name   => 'minWordsCountForExecutive',
            description => '',
            format      => '',
            read_only   => '',
        },
...
__PACKAGE__->swagger_types(
    {
        ...
        'min_words_count_for_executive' => 'int',
...
__PACKAGE__->attribute_map(
    {
        ...
        'min_words_count_for_executive' => 'minWordsCountForExecutive',
