...

{
  ...
  $dbh->do('CREATE TABLE tab4 ( dt DATE,  ts1 TIMESTAMP, ts2 TIMESTAMP  with time zone, ts3 TIMESTAMP)');
  $dbh->do('INSERT INTO tab4 VALUES (?, ?, ?, ?)', undef, "1969-12-31", "2015-12-31T23:23:23.999999", "2001-11-11T12:23+0000", "2001-11-11");
  $dbh->disconnect;
}
