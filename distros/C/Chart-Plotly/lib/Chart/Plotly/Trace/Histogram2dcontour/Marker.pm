package Chart::Plotly::Trace::Histogram2dcontour::Marker;
use Moose;
...
Chart::Plotly::Trace::Histogram2dcontour::Marker - This attribute is one of the possible options for the trace histogram2dcontour.
