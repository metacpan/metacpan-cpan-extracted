package Chart::Plotly::Trace::Scatterpolargl::Stream;
use Moose;
...
Chart::Plotly::Trace::Scatterpolargl::Stream - This attribute is one of the possible options for the trace scatterpolargl.
