package Google::Ads::AdWords::v201809::CustomAffinityService::CustomAffinityServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201809::TypeMaps::CustomAffinityService
    if not Google::Ads::AdWords::v201809::TypeMaps::CustomAffinityService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/rm/v201809/CustomAffinityService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201809::TypeMaps::CustomAffinityService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::CustomAffinityService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201809::CustomAffinityService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::CustomAffinityService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::CustomAffinityService::mutateToken )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::CustomAffinityService::query )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/rm/v201809/CustomAffinityService.
...
Returns a L<Google::Ads::AdWords::v201809::CustomAffinityService::getResponse|Google::Ads::AdWords::v201809::CustomAffinityService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::CustomAffinityService::mutateResponse|Google::Ads::AdWords::v201809::CustomAffinityService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::CustomAffinityService::mutateTokenResponse|Google::Ads::AdWords::v201809::CustomAffinityService::mutateTokenResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::CustomAffinityService::queryResponse|Google::Ads::AdWords::v201809::CustomAffinityService::queryResponse> object.
