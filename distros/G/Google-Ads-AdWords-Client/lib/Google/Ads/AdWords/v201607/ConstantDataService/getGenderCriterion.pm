...
package Google::Ads::AdWords::v201607::ConstantDataService::getGenderCriterion;
use strict;
use warnings;
...
getGenderCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201607.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201607::ConstantDataService::getGenderCriterion->new($data);
