...
1;
# ABSTRACT: List of directory names, all must exist on filesystem
...
Sah::SchemaR::dirnames::exist - List of directory names, all must exist on filesystem

=head1 VERSION

This document describes version 0.030 of Sah::SchemaR::dirnames::exist (from Perl distribution Sah-Schemas-Path), released on 2024-01-08.
