...
$RDF::Cowl::DataPropRangeAxiom::VERSION = '1.0.0';
...
RDF::Cowl::DataPropRangeAxiom - Represents a DataPropertyRange axiom in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::DataPropRangeAxiom>
