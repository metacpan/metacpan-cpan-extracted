...
This document describes version 0.002 of Bencher::Scenario::DigestSHA::SHA256 (from Perl distribution Bencher-Scenarios-DigestSHA), released on 2017-01-25.
...
Benchmark with default options (C<< bencher -m DigestSHA::SHA256 >>):
 ...
 +-------------+-----------+-----------+------------+---------+---------+
 | sha256sum   |       5.5 |       180 |          1 | 0.0014  |       6 |
 | Digest::SHA |       5.5 |       180 |          1 | 0.00037 |       6 |
 +-------------+-----------+-----------+------------+---------+---------+
...
Benchmark module startup overhead (C<< bencher -m DigestSHA::SHA256 --module-startup >>):
 ...
 +---------------------+------------------------------+--------------------+----------------+-----------+------------------------+------------+---------+---------+
 | Digest::SHA         | 0.83                         | 4.1                | 16             |      13   |                    8   |        1   | 9.1e-05 |       7 |
 | String::ShellQuote  | 1.5                          | 4.9                | 21             |       8.9 |                    3.9 |        1.5 | 7.1e-05 |       6 |
 | perl -e1 (baseline) | 1                            | 4.3                | 16             |       5   |                    0   |        2.6 | 9.8e-06 |       6 |
 +---------------------+------------------------------+--------------------+----------------+-----------+------------------------+------------+---------+---------+
