...
package L<Lab::VISA|http://search.cpan.org/dist/Lab-VISA/> providing the Perl language bindings. Detailed
L<installation instructions|http://search.cpan.org/dist/Lab-VISA/lib/Lab/VISA/Installation.pod> are provided in that
package. >> 
