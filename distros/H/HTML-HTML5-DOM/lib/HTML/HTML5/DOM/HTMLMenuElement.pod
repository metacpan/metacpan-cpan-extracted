...
HTML::HTML5::DOM::HTMLMenuElement - implementation of the HTMLMenuElement interface of the HTML DOM

=head1 DESCRIPTION

HTML::HTML5::DOM::HTMLMenuElement is an implementation of the HTMLMenuElement interface of the HTML DOM. See L<HTML::HTML5::DOM> for a list of the conventions that have been used when translating the DOM to Perl.
...
=item * C<< {http://www.w3.org/1999/xhtml}menu >>

=back

=head2 Inheritance

HTML::HTML5::DOM::HTMLMenuElement inherits methods from the following Perl classes.
