package Chart::Plotly::Trace::Isosurface::Contour;
use Moose;
...
Chart::Plotly::Trace::Isosurface::Contour - This attribute is one of the possible options for the trace isosurface.
