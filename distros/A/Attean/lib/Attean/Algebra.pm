...
This document describes Attean::Algebra version 0.039
...
package Attean::Algebra::Query 0.039 {
...
package Attean::Algebra::Update 0.039 {
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
...
package Attean::Algebra::Sequence 0.039 {
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Moo;
	use namespace::clean;
...
package Attean::Algebra::Join 0.039 {
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Moo;
	use namespace::clean;
...
package Attean::Algebra::LeftJoin 0.039 {
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Moo;
...
package Attean::Algebra::Filter 0.039 {
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Moo;
	use Types::Standard qw(ConsumerOf);
...
package Attean::Algebra::Union 0.039 {
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Moo;
	use Types::Standard qw(ConsumerOf);
...
package Attean::Algebra::Graph 0.039 {
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Moo;
	use Types::Standard qw(ConsumerOf);
...
package Attean::Algebra::Extend 0.039 {
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Moo;
	use Types::Standard qw(ConsumerOf);
...
package Attean::Algebra::Minus 0.039 {
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Moo;
	use Types::Standard qw(ConsumerOf);
...
package Attean::Algebra::Distinct 0.039 {
	use Moo;
	use namespace::clean;
...
package Attean::Algebra::Reduced 0.039 {
	use Moo;
	use namespace::clean;
...
package Attean::Algebra::Slice 0.039 {
	use Moo;
...
package Attean::Algebra::Project 0.039 {
	use Types::Standard qw(ArrayRef ConsumerOf);
	use Moo;
	use namespace::clean;
...
package Attean::Algebra::Comparator 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
...
package Attean::Algebra::OrderBy 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
...
package Attean::Algebra::BGP 0.039 {
	use Moo;
	use Attean::RDF;
	use Set::Scalar;
	use AtteanX::SPARQL::Constants;
...
package Attean::Algebra::Service 0.039 {
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Moo;
...
package Attean::Algebra::Path 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Types::Standard qw(ArrayRef ConsumerOf);
...
package Attean::Algebra::Group 0.039 {
	use utf8;
	use Moo;
	use Attean::API::Query;
	use AtteanX::SPARQL::Constants;
...
package Attean::Algebra::NegatedPropertySet 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Types::Standard qw(ArrayRef ConsumerOf);
...
package Attean::Algebra::PredicatePath 0.039 {
	use Moo;
	use Types::Standard qw(ConsumerOf);
	use namespace::clean;
...
package Attean::Algebra::InversePath 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Types::Standard qw(ConsumerOf);
...
package Attean::Algebra::SequencePath 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use namespace::clean;
...
package Attean::Algebra::AlternativePath 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use namespace::clean;
...
package Attean::Algebra::ZeroOrMorePath 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Types::Standard qw(ConsumerOf);
...
package Attean::Algebra::OneOrMorePath 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Types::Standard qw(ConsumerOf);
...
package Attean::Algebra::ZeroOrOnePath 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Types::Standard qw(ConsumerOf);
...
package Attean::Algebra::Table 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Types::Standard qw(ArrayRef ConsumerOf);
...
package Attean::Algebra::Ask 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use namespace::clean;
...
package Attean::Algebra::Construct 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Types::Standard qw(ArrayRef ConsumerOf);
...
package Attean::Algebra::Describe 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Types::Standard qw(ArrayRef ConsumerOf);
...
package Attean::Algebra::Load 0.039 {
	use Moo;
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
	use Types::Standard qw(Bool ConsumerOf);
...
package Attean::Algebra::Clear 0.039 {
	use Moo;
...
package Attean::Algebra::Create 0.039 {
	use Moo;
	use Scalar::Util qw(blessed);
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
...
package Attean::Algebra::Add 0.039 {
	use Moo;
	use Scalar::Util qw(blessed);
	use AtteanX::SPARQL::Constants;
	use AtteanX::SPARQL::Token;
...
package Attean::Algebra::Modify 0.039 {
	use Moo;
