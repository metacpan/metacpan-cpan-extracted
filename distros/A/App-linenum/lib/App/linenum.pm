...
App::linenum - Add line number to lines

=head1 VERSION

This document describes version 0.002 of App::linenum (from Perl distribution App-linenum), released on 2024-02-01.

=head1 SYNOPSIS

See the command-line script L<linenum>.
