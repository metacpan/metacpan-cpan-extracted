...
IO::K8s::Api::Scheduling::V1alpha3::CompositeDisruptionMode - CompositeDisruptionMode defines how individual entities within a composite pod group can be disrupted. Exactly one mode must be set.
