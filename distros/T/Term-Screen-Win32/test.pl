...
#
# Grabbed by Daniel Podolsky <tpaba@cpan.org> from Term::Screen v.1.01 sources
# to enable test of Term::Screen::Win32
...
$scr->clrscr();
$scr->puts("Test series for Term::Screen::Win32 module for perl5");
