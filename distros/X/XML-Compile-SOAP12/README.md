# distribution XML-Compile-SOAP12
  ...
  * Development via GitHub: <https://github.com/markov2/perl5-XML-Compile-SOAP12>
  * Download from CPAN: <ftp://ftp.cpan.org/pub/CPAN/authors/id/M/MA/MARKOV/>
  * Indexed from CPAN: <http://search.cpan.org/~markov/XML-Compile-SOAP12/>
    and <https://metacpan.org/release/XML-Compile-SOAP12>

The XML-Compile suite is a large set of modules for various XML related
standards.  This optional component implements the SOAP12 1.2 protocol.
