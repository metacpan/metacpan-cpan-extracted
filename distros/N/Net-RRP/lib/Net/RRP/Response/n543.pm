package Net::RRP::Response::n543;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n543::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n543::VERSION = '0.1';
...
Net::RRP::Response::n543 - the 543 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
