...
Bencher::Scenario::RangeIterators::Create - Benchmark iterator creation
...
To run benchmark with default option:
 ...
 % bencher -m RangeIterators::Create

To run module startup overhead benchmark:

 % bencher --module-startup -m RangeIterators::Create
...
Code template:
 ...
 Range::ArrayIter::range_arrayiter(1, 10)
