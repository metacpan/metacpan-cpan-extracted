package Chart::Plotly::Trace::Cone::Colorbar::Titlefont;
use Moose;
...
Chart::Plotly::Trace::Cone::Colorbar::Titlefont - This attribute is one of the possible options for the trace cone.
