package Daje::Database::Model::AuthoritiesRole;
use Mojo::Base 'Daje::Database::Model::Super::AuthoritiesRole', -base, -async_await, -signatures;
use v5.42;
...
#
# methods from Daje::Database::Model::Super::AuthoritiesRole#
