...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::NetworkEdgeSecurityService Google::Cloud::Compute::V1::Compute::NetworkEdgeSecurityServiceAggregatedList Google::Cloud::Compute::V1::Compute::Operation )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::NetworkEdgeSecurityServicesClient->new( credentials => 'dummy' );
