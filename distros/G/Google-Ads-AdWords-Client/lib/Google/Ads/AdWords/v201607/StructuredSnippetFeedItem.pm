package Google::Ads::AdWords::v201607::StructuredSnippetFeedItem;
use strict;
use warnings;
...
StructuredSnippetFeedItem from the namespace https://adwords.google.com/api/adwords/cm/v201607.
