...
acceptance_tests(
  ...
  test => {
    $ENV{NO_TODO} ? () : (todo_tests => [
      ...
      { file => 'email.json', test_description => [
          'a trailing line feed is not valid',
          'a trailing carriage return is not valid',
          'a trailing space is not valid',
          'a leading space is not valid',
          'a domain label starting with a hyphen is not valid',
          'a domain label ending with a hyphen is not valid',
          'a domain ending with a dot is not valid',
          'empty brackets after the @ are not valid',
          'an IPv4-address-literal with three octets is not valid',
          'an IPv4-address-literal with five octets is not valid',
