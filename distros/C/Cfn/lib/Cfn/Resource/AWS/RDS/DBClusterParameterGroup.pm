...
Cfn::Resource::AWS::RDS::DBClusterParameterGroup - Cfn resource for AWS::RDS::DBClusterParameterGroup

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::RDS::DBClusterParameterGroup.
