...
BorderStyle::Text::ANSITable::OldCompat::Default::singlei_boxchar - BoxChar::SingleLineInnerOnly border style (with old name)

=head1 VERSION

This document describes version 0.610 of BorderStyle::Text::ANSITable::OldCompat::Default::singlei_boxchar (from Perl distribution Text-ANSITable), released on 2025-02-24.
