...
$repeated_errmsg = qr{^Your password must contain a mixture of lower and upper-case letters$};
...
@tests = (
	...
	# this should pass, Qwerty is mixed-case
	{
		'password'		=> 'Qwerty',
		'expect_error'	=> 0,
		'error_msg'		=> undef,
	...
	# testing a potential race match - this should pass
	{
		'password'		=> 'aA',
		'expect_error'	=> 0,
		'error_msg'		=> undef,
	...
	# this should fail, all lower
	{
		'password'		=> 'aaaaaaaa',
		'expect_error'	=> 1,
		'error_msg'		=> $repeated_errmsg,
	},
	# this should fail, all upper
	{
		'password'		=> 'AAAAAAAA',
		'expect_error'	=> 1,
		'error_msg'		=> $repeated_errmsg,
	},
	# this should fail - no letters at all
	{
		'password'		=> '123456789',
		'expect_error'	=> 1,
		'error_msg'		=> $repeated_errmsg,
...
foreach my $test (@tests) {
	...
	$pwcheck = Data::Password::Check->check({
		...
		'tests'			=> [ 'mixed_case' ],			# don't want to run any other tests
	});
