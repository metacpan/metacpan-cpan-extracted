{
  ...
  datetime_format_full => "{1}, '\N{U+0432}\N{U+043e}' {0}",
  datetime_format_long => "{1}, '\N{U+0432}\N{U+043e}' {0}",
  datetime_format_medium => "{1}, '\N{U+0432}\N{U+043e}' {0}",
  datetime_format_short => "{1}, '\N{U+0432}\N{U+043e}' {0}",
