package Chart::Plotly::Trace::Bar::Unselected::Marker;
use Moose;
...
Chart::Plotly::Trace::Bar::Unselected::Marker - This attribute is one of the possible options for the trace bar.
