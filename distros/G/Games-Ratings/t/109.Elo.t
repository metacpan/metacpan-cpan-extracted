...
## see the following link for the official calculation (player Hikaru Nakamura)
...
my %expected = (
                rating_change   => '12.2',
                performance     => '2777',
                points_expected => '6.28',
               );
my $player = Games::Ratings::Chess::FIDE->new();
$player->set_rating(2708);
$player->set_coefficient(10);
my @opponent_ratings =   (2657,2641,2696,2790,2810,2749,2723,2788,2720,2712,2739,2675,2662);
my @results          = qw(draw win  win  draw draw draw win  loss loss draw draw draw win );
