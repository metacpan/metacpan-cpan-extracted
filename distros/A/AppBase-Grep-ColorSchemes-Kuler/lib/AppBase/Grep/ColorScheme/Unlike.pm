...
AppBase::Grep::ColorScheme::Unlike - Unlike color scheme

=head1 VERSION

This document describes version 0.001 of AppBase::Grep::ColorScheme::Unlike (from Perl distribution AppBase-Grep-ColorSchemes-Kuler), released on 2018-02-11.
