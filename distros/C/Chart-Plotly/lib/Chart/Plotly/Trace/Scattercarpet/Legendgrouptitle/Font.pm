package Chart::Plotly::Trace::Scattercarpet::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Scattercarpet::Legendgrouptitle::Font - This attribute is one of the possible options for the trace scattercarpet.
