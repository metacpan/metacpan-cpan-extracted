...
$obje->set_text("mark\ndoro\nveltzer","\n");
$obje->remove_line_nre("m");
Meta::Utils::Output::print("text is [".$obje->get_text()."]\n");
...
lines.pl - testing program for the Meta::Utils::Text::Lines.pm module.
...
This is a test suite for the Meta::Utils::Text::Lines.pm package.
Currently it just creates an object with some text and removes some lines
from it.
...
=head1 HISTORY
	...
	0.02 MV put ALL tests back and light the tree
	0.03 MV silense all tests
...
Meta::Baseline::Test(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), Meta::Utils::Text::Lines(3), strict(3)
