...
$Shipment::UPS::WSDL::RateTypes::InvoiceLineTotalType::VERSION = '3.02';
use strict;
use warnings;
...
InvoiceLineTotalType from the namespace http://www.ups.com/XMLSchema/XOLTWS/Rate/v1.1.
...
=item * CurrencyCode (min/maxOccurs: 0/1)
