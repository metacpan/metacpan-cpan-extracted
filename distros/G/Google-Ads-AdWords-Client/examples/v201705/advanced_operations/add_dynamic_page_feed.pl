...
use Google::Ads::AdWords::v201705::PageFeed;
...
sub _create_feed {
  ...
  #  Create attributes.
  my $url_attribute = Google::Ads::AdWords::v201705::FeedAttribute->new({
    type => "URL_LIST",
    name => "Page URL"
  });

  my $label_attribute = Google::Ads::AdWords::v201705::FeedAttribute->new({
    type => "STRING_LIST",
    name => "Label"
  });

  # Create the feed.
  my $dsa_page_feed = Google::Ads::AdWords::v201705::Feed->new({
