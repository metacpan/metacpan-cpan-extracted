...
my $fw = DataExtract::FixedWidth->new({
	heuristic => \@lines
	, cols       => [qw/S F PID TIME NI PPID UID WCHAN TTY CMD C PRI/, 'ADDR SZ']
	, header_row => 'F S   UID   PID  PPID  C PRI  NI ADDR SZ WCHAN  TTY          TIME CMD'
});
