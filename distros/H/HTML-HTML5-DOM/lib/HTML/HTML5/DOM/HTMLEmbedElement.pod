...
HTML::HTML5::DOM::HTMLEmbedElement - implementation of the HTMLEmbedElement interface of the HTML DOM

=head1 DESCRIPTION

HTML::HTML5::DOM::HTMLEmbedElement is an implementation of the HTMLEmbedElement interface of the HTML DOM. See L<HTML::HTML5::DOM> for a list of the conventions that have been used when translating the DOM to Perl.
...
=item * C<< {http://www.w3.org/1999/xhtml}embed >>

=back

=head2 Inheritance

HTML::HTML5::DOM::HTMLEmbedElement inherits methods from the following Perl classes.
