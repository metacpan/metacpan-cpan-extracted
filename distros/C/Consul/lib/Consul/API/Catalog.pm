...
$Consul::API::Catalog::VERSION = '0.021';
...
$Consul::API::Catalog::ShortNode::VERSION = '0.021';
use Moo;
use Types::Standard qw(Str);
...
$Consul::API::Catalog::Service::VERSION = '0.021';
use Moo;
...
$Consul::API::Catalog::Node::VERSION = '0.021';
use Moo;
