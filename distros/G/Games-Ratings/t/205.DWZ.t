...
## * http://schachbund.de/dwz/turniere/2007.html?code=A117-000-OLN&mcount[]=1-5 
##   (Player Bartolomaeus, Christian)

my $player = Games::Ratings::Chess::DWZ->new();
$player->set_rating(2249);
$player->set_coefficient(30);
$player->add_game( {
                     opponent_rating => 2134,
                     result          => 'draw',
                   }
                 );
$player->add_game( {
                     opponent_rating => 2343,
                     result          => 'draw',
                   }
                 );
$player->add_game( {
