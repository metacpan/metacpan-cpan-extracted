...
package WebService::Edgecast::auto::Administration::Element::CustomerAdd;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerAdd::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerAdd');
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'intStatus' => 'SOAP::WSDL::XSD::Typelib::Builtin::unsignedInt',
...
CustomerAdd from the namespace EC:WebServices.
