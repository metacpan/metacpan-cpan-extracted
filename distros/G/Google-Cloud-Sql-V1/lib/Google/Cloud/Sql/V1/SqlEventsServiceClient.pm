package Google::Cloud::Sql::V1::SqlEventsServiceClient;
...
our $VERSION = '0.02';
1; # End of Google::Cloud::Sql::V1::SqlEventsServiceClient

__END__

=head1 NAME

Google::Cloud::Sql::V1::SqlEventsServiceClient - Auto-generated Protocol Buffers schema container
