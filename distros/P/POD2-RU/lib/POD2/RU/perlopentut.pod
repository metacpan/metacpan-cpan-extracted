...
Perl имеет два простых, встроенные способа открытия файлов:  
с помощью шелла для удобства и путем C для точности.	
Шелл путь также имеет 2-х и 3-х аргументную форму, которые имеют различную семантику для обработки файла.
