...
MAKE = make
FULLEXT = Apache/LoadAvgLimit
BASEEXT = LoadAvgLimit
PARENT_NAME = Apache
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Apache/LoadAvgLimit.pm
INC = 
DEFINE = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Apache/LoadAvgLimit.pm \
	loadavg_bench.pl
...
TO_INST_PM = lib/Apache/LoadAvgLimit.pm \
	lib/Apache/LoadAvgLimit/GetAvg.pm \
	lib/Apache/LoadAvgLimit/GetAvg.xs \
	loadavg_bench.pl

PM_TO_BLIB = lib/Apache/LoadAvgLimit/GetAvg.xs \
	blib/lib/Apache/LoadAvgLimit/GetAvg.xs \
	lib/Apache/LoadAvgLimit/GetAvg.pm \
	blib/lib/Apache/LoadAvgLimit/GetAvg.pm \
	loadavg_bench.pl \
	$(INST_LIB)/Apache/loadavg_bench.pl \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  loadavg_bench.pl $(INST_MAN3DIR)/Apache::loadavg_bench.$(MAN3EXT) \
	  lib/Apache/LoadAvgLimit.pm $(INST_MAN3DIR)/Apache::LoadAvgLimit.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Apache-LoadAvgLimit' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires: {}' >> META_new.yml
	$(NOECHO) $(ECHO) 'version: 0.03_01' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Apache-LoadAvgLimit",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   "version" : "0.03_01"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Apache/LoadAvgLimit/GetAvg.xs blib/lib/Apache/LoadAvgLimit/GetAvg.xs \
	  lib/Apache/LoadAvgLimit/GetAvg.pm blib/lib/Apache/LoadAvgLimit/GetAvg.pm \
	  loadavg_bench.pl $(INST_LIB)/Apache/loadavg_bench.pl \
	  lib/Apache/LoadAvgLimit.pm blib/lib/Apache/LoadAvgLimit.pm 
