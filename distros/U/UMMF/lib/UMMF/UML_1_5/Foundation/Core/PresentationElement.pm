...
package UMMF::UML_1_5::Foundation::Core::PresentationElement;
...
=head2 C<presentation> : I<THIS> C<0..*> E<lt>---E<gt>  C<subject> : UMMF::UML_1_5::Foundation::Core::ModelElement C<0..*>
...
=head2 C<__validate_type>
  ...
  UMMF::UML_1_5::Foundation::Core::PresentationElement->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::Foundation::Core::PresentationElement|UMMF::UML_1_5::Foundation::Core::PresentationElement>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::Foundation::Core::PresentationElement')  ;
}


=head2 C<__typecheck>

  UMMF::UML_1_5::Foundation::Core::PresentationElement->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::Foundation::Core::PresentationElement->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::Foundation::Core::PresentationElement' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML_1_5::Foundation::Core::PresentationElement|UMMF::UML_1_5::Foundation::Core::PresentationElement>.
...
sub ___initialize
{
  ...
  #  presentation 0..*
  #  <--> 
  #  subject 0..* UMMF::UML_1_5::Foundation::Core::ModelElement.
...
sub __initialize
{
  ...
  $self->UMMF::UML_1_5::Foundation::Core::PresentationElement::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::Foundation::Core::PresentationElement::___create(@args);
...
Returns the AssociationEnd C<subject> values of type L<UMMF::UML_1_5::Foundation::Core::ModelElement|UMMF::UML_1_5::Foundation::Core::ModelElement>.
...
sub add_subject ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        ...
        $self->__use('UMMF::UML_1_5::Foundation::Core::ModelElement')->__typecheck($val, "UMMF::UML_1_5::Foundation::Core::PresentationElement.subject");
...
Clears the AssociationEnd C<subject> links to L<UMMF::UML_1_5::Foundation::Core::ModelElement|UMMF::UML_1_5::Foundation::Core::ModelElement>.
Returns C<$obj>.
