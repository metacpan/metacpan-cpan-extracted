...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::InterconnectAttachmentGroup Google::Cloud::Compute::V1::Compute::InterconnectAttachmentGroupsGetOperationalStatusResponse Google::Cloud::Compute::V1::Compute::InterconnectAttachmentGroupsListResponse Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::Policy Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
package main;
use Google::Cloud::Compute::V1::InterconnectAttachmentGroupsClient;

my $client = Google::Cloud::Compute::V1::InterconnectAttachmentGroupsClient->new( credentials => 'dummy' );
