...
'*** Notice -- Failed OPER attempt as moo by bobbins (~bobbins@listen.server.irc) - requires SSL/TLS',
...
sub client_input {
  ...
  if ( $cmd eq '491' ) {
    pass("IRC$cmd");
    is($params->[1],'Only few of mere mortals may try to enter the twilight zone','Only few of mere mortals may try to enter the twilight zone');
