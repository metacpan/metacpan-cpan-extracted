package Pcore::Lib::Path::Poll::File;
...
sub scan ($self) {
    ...
    if ( $stat->@* ) {
        ...
        if ( $self->{stat}->@* ) {
            ...
            if ( $self->{stat}->[9] != $stat->[9] ) {
                $change = $Pcore::Lib::Path::Poll::POLL_MODIFIED;
        ...
        # file was created
            ...
            $change = $Pcore::Lib::Path::Poll::POLL_CREATED;
    ...
    # file was removed
        ...
        $change = $Pcore::Lib::Path::Poll::POLL_REMOVED;
