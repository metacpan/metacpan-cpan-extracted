...
# full package name, since we don't want to try to load
# MyTestAgainstSchema::XML.
use MyTestAgainstSchema 'Test::AgainstSchema::XML';

our $VERSION = '1.000';
my (%schemas, %tests, $xmlcontent);

# This is largely the same set of tests as are used for 10_with_xml.t. The
# point here is just to determine that an empty sub-class of
# Test::AgainstSchema works as well as the "real thing".
