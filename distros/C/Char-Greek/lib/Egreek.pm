...
sub import {
    ...
    *Char::ord           = \&Greek::ord;
    *Char::ord_          = \&Greek::ord_;
    *Char::reverse       = \&Greek::reverse;
    *Char::getc          = \&Greek::getc;
    *Char::length        = \&Greek::length;
    *Char::substr        = \&Greek::substr;
    *Char::index         = \&Greek::index;
    *Char::rindex        = \&Greek::rindex;
    *Char::eval          = \&Greek::eval;
    *Char::escape        = \&Greek::escape;
    *Char::escape_token  = \&Greek::escape_token;
    *Char::escape_script = \&Greek::escape_script;
}
...
my $qq_substr  = qr{(?> Char::substr | Greek::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Egreek::re_t=%s; while($Egreek::re_t =~ %s){%s local $^W=0; local $Egreek::re_r=%s; %s$Egreek::re_t="$`$Egreek::re_r$'"; pos($Egreek::re_t)=length "$`$Egreek::re_r"; } return $Egreek::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Egreek::re_r=CORE::eval $Egreek::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Egreek::re_r=%s; %s"%s$Egreek::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Egreek::re_n=0; while(%s =~ %s){%s local $^W=0; local $Egreek::re_r=%s; %s%s="$`$Egreek::re_r$'"; pos(%s)=length "$`$Egreek::re_r"; $Egreek::re_n++} return %s$Egreek::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Egreek::re_r=%s; %s%s="%s$Egreek::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Egreek::re_r=%s; %s%s="%s$Egreek::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Egreek::re_r=CORE::eval $Egreek::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
