package Perl::Examples::Accessors::MojoBaseXS;
...
Perl::Examples::Accessors::MojoBaseXS

=head1 VERSION

This document describes version 0.132 of Perl::Examples::Accessors::MojoBaseXS (from Perl distribution Perl-Examples-Accessors), released on 2021-08-03.
