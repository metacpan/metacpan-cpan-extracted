package Chart::Plotly::Trace::Scattergl::Textfont;
use Moose;
...
Chart::Plotly::Trace::Scattergl::Textfont - This attribute is one of the possible options for the trace scattergl.
