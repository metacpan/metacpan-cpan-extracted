...
This document describes version 0.022 of Sah::Schema::unix::uid (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.
...
Base schema: L<uint|Sah::Schema::uint>

Used prefilters: L<Unix::convert_unix_user_to_uid|Data::Sah::Filter::perl::Unix::convert_unix_user_to_uid>
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"unix::uid*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('unix::uid*', name=>'UnixUid')
     );
 }

 use My::Types qw(UnixUid);
 UnixUid->assert_valid($data);
