package Chart::Plotly::Trace::Scattercarpet::Stream;
use Moose;
...
Chart::Plotly::Trace::Scattercarpet::Stream - This attribute is one of the possible options for the trace scattercarpet.
