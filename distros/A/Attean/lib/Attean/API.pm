...
This document describes Attean::API version 0.039
...
package Attean::API::ResultOrTerm 0.039 {
	use Moo::Role;
}

package Attean::API::BlankOrIRI 0.039 {
	use Moo::Role;
	with 'Attean::API::Term', 'Attean::API::BlankOrIRIOrTriple';
}

package Attean::API::BlankOrIRIOrTriple 0.039 {
	use Moo::Role;
}

package Attean::API::TermOrTriple 0.039 {
	use Moo::Role;
}

package Attean::API::TermOrVariable 0.039 {
...
package Attean::API::TermOrVariableOrTriplePattern 0.039 {
	use Scalar::Util qw(blessed);
	use Sub::Install;
	use Sub::Util qw(set_subname);
...
package Attean::Mapper 0.039 {
	use Moo::Role;
	requires 'map'; # my $that = $object->map($this)
}

package Attean::API::Variable 0.039 {
...
package Attean::API::CanonicalizingBindingSet 0.039 {
	use Attean::RDF;
