package Bencher::ScenarioR::AppHr::Completion;
...
our $results = [
  [
    ...
    [
      ...
      {
        errors => 0.00016,
        participant => "optname_random_color",
        rate => 19,
        samples => 21,
        time => 51,
        vs_slowest => 1,
    ...
    ],
    {
      "func.bencher_args"              => {
                                            ...
                                            scenario_module => "AppHr::Completion",
                                          },
      ...
      "func.elapsed_time"              => 4.98522996902466,
      "func.module_startup"            => undef,
      "func.module_versions"           => {
                                            "__PACKAGE__" => 1.034,
                                            "App::hr" => 0.25,
                                            "Bencher::Scenario::AppHr::Completion" => undef,
                                            "Benchmark::Dumb" => "0.10",
      ...
      "func.precision"                 => 0,
      "func.scenario_module"           => "Bencher::Scenario::AppHr::Completion",
      "func.scenario_module_md5sum"    => "35169e6a7371e4add463962b60cba833",
      "func.scenario_module_mtime"     => 1457609313,
      "func.scenario_module_sha1sum"   => "ea090b0c0bda800077150996547230750eb7a46a",
      "func.scenario_module_sha256sum" => "721d113843867806d8a75d8f4db29085f2b641f3895091e3a2b15bc959a2e260",
      "func.time_end"                  => 1485326656.5125,
      "func.time_factor"               => 1000,
      "func.time_start"                => 1485326651.52727,
