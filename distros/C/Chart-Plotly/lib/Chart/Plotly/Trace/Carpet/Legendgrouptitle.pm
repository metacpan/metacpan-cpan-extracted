package Chart::Plotly::Trace::Carpet::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Carpet::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Carpet::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Carpet::Legendgrouptitle - This attribute is one of the possible options for the trace carpet.
