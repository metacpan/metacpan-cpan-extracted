...
Represents a responsive search ad <p class="caution"><b>Caution:</b> Responsive search ads do not use {@link #url url}, {@link #displayUrl displayUrl}, {@link #finalAppUrls finalAppUrls}, or {@link #devicePreference devicePreference}; setting these fields on a responsive search ad will cause an error. <span class="constraint AdxEnabled">This is enabled for AdX.</span> 
