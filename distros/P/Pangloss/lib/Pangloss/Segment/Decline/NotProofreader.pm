...
Pangloss::Segment::Decline::NotProofreader - decline unless there's a user with
translation capabilities in the session

=head1 SYNOPSIS

  $pipe->add_segment( Pangloss::Segment::NotProofreader->new )

=cut

package Pangloss::Segment::Decline::NotProofreader;
