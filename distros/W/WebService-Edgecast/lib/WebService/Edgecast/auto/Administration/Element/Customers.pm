...
package WebService::Edgecast::auto::Administration::Element::Customers;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::Customers::VERSION = '0.01.00';
}
use strict;
use warnings;
...
WebService::Edgecast::auto::Administration::Element::Customers
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::Customers->new($data);
