package Chart::Plotly::Trace::Histogram::Marker;
use Moose;
...
use Chart::Plotly::Trace::Histogram::Marker::Colorbar;
use Chart::Plotly::Trace::Histogram::Marker::Line;
use Chart::Plotly::Trace::Histogram::Marker::Pattern;
...
has colorbar => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram::Marker::Colorbar", );
...
has line => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram::Marker::Line", );
...
has pattern => ( is  => "rw",
                 isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram::Marker::Pattern", );
...
Chart::Plotly::Trace::Histogram::Marker - This attribute is one of the possible options for the trace histogram.
