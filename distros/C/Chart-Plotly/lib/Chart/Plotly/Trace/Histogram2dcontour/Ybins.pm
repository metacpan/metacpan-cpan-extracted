...
use Chart::Plotly::Trace::Histogram2dcontour::Ybins::ImpliedEdits;
...
has impliedEdits => ( is  => "rw",
                      isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram2dcontour::Ybins::ImpliedEdits", );
...
Chart::Plotly::Trace::Histogram2dcontour::Ybins - This attribute is one of the possible options for the trace histogram2dcontour.
