package Chart::Plotly::Trace::Scattergl::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Scattergl::Legendgrouptitle::Font - This attribute is one of the possible options for the trace scattergl.
