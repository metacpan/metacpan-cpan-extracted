...
our $rschema = ["str",[{match=>"\\A(?:/|/?(?:[^/\\0]{1,255})(?:/[^/\\0]{1,255})?)\\z",summary=>"Filesystem directory name on a Unix system","x.perl.coerce_rules"=>["From_str::strip_slashes"]}],["str"]];
...
This document describes version 0.010 of Sah::SchemaR::dirname::unix (from Perl distribution Sah-Schemas-Path), released on 2019-11-29.
