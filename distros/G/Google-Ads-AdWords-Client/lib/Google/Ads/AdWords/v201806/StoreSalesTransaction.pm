package Google::Ads::AdWords::v201806::StoreSalesTransaction;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'userIdentifiers' => 'Google::Ads::AdWords::v201806::UserIdentifier',
        'transactionTime' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'transactionAmount' => 'Google::Ads::AdWords::v201806::MoneyWithCurrency',
...
Google::Ads::AdWords::v201806::StoreSalesTransaction

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
StoreSalesTransaction from the namespace https://adwords.google.com/api/adwords/rm/v201806.
