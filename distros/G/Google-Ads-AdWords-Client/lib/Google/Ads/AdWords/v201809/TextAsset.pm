package Google::Ads::AdWords::v201809::TextAsset;
use strict;
use warnings;
...
my %assetText_of :ATTR(:get<assetText>);
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'assetText' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
    },
    {
...
Google::Ads::AdWords::v201809::TextAsset

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TextAsset from the namespace https://adwords.google.com/api/adwords/cm/v201809.
