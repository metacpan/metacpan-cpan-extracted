...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TargetInstance Google::Cloud::Compute::V1::Compute::TargetInstanceAggregatedList Google::Cloud::Compute::V1::Compute::TargetInstanceList Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::TargetInstancesClient->new( credentials => 'dummy' );
