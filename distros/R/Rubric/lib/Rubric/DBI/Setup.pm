...
#pod  use warnings;
#pod
#pod  use Rubric::DBI::Setup;
#pod  Rubric::DBI::Setup->setup_tables;
#pod
...
#pod =head2 dbh
#pod
#pod This method returns a connection to the Rubric database.
#pod
#pod =cut
...
#pod =head2 setup_tables
#pod
#pod This method builds the tables in the database, if needed.
#pod
#pod =cut
...
#pod =head2 specialize_sql
#pod
#pod attempts to convert the given sql syntax to the given DBD Driver's
#pod
#pod =cut
...
#pod =head2 determine_version
#pod
#pod This attempts to determine the version of the database schema to which the
#pod given database conforms.  All recent schemata store their version number; for
#pod older versions, some simple table attributes are checked.
#pod
#pod =cut
...
#pod =head2 determine_db_type
#pod
#pod Returns the type of db being used, based on the DSN's DBD driver.
#pod SQLite and Pg support only right now.
#pod
#pod =cut
...
#pod =head2 update_schema
#pod
#pod This method will try to upgrade the database to the most recent schema.  It's
#pod sort of ugly, but it works...
#pod
#pod =cut
