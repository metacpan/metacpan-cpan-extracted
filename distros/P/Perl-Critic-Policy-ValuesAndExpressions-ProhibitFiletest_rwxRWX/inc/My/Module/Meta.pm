...
sub dist_name {
    return 'Perl-Critic-Policy-ValuesAndExpressions-ProhibitFiletest_rwxRWX';
}
...
sub version_from {
    return 'lib/Perl/Critic/Policy/ValuesAndExpressions/ProhibitFiletest_rwxRWX.pm';
}
...
My::Module::Meta - Information needed to build Perl::Critic::Policy::ValuesAndExpressions::ProhibitFiletest_rwxRWX
...
This module centralizes information needed to build C<Perl::Critic::Policy::ValuesAndExpressions::ProhibitFiletest_rwxRWX>. It
is private to the C<Perl::Critic::Policy::ValuesAndExpressions::ProhibitFiletest_rwxRWX> package, and may be changed or
...
modules required to build the C<Perl::Critic::Policy::ValuesAndExpressions::ProhibitFiletest_rwxRWX> package, suitable for
...
the modules required to run the C<Perl::Critic::Policy::ValuesAndExpressions::ProhibitFiletest_rwxRWX>
