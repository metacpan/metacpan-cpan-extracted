...
asn_dec_rval_t
MW_Status_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
MW_Status_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_MW_Status_constr_1 = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  6,  16 }	/* (SIZE(6..16)) */,
...
asn_TYPE_descriptor_t asn_DEF_MW_Status = {
	...
	MW_Status_decode_uper,
	MW_Status_encode_uper,
	...
	sizeof(asn_DEF_MW_Status_tags_1)
		/sizeof(asn_DEF_MW_Status_tags_1[0]), /* 1 */
	&asn_PER_type_MW_Status_constr_1,
