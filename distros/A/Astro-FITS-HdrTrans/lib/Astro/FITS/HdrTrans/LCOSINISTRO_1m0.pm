...
package Astro::FITS::HdrTrans::LCOSINISTRO_1m0;

=head1 NAME

Astro::FITS::HdrTrans::LCOSINISTRO_1m0 - LCO 1.0m SINISTRO translations

=head1 SYNOPSIS

  use Astro::FITS::HdrTrans::LCOSINISTRO_1m0;

  %gen = Astro::FITS::HdrTrans::LCOSINISTRO_1m0->translate_from_FITS( %hdr );

=head1 DESCRIPTION

This class provides a generic set of translations that are specific to
1.0m SINISTROs at LCO.
...
# Unless this is fl02-4 data (which has a bad TRIMSEC), update bounds array 
            @bounds = @newbounds;
	  }
        }
      }
