...
function character_A => sub {
	my @character = $_[0]->default_character(4);
	$character[1][1] = $character[2][0] = $character[2][2] = $character[3][0]
...
function character_B => sub {
	my @character = $_[0]->default_character(4);
	$character[1][0] = $character[1][1] = $character[2][0] = $character[2][2]
...
function character_C => sub {
	my @character = $_[0]->default_character(4);
	$character[1][1] = $character[1][2] = $character[2][0] = $character[3][0]
	    = $character[4][0] = $character[5][1] = $character[5][2] = "\#";
	return \@character;
};
...
function character_E => sub {
	my @character = $_[0]->default_character(4);
	$character[1][0] = $character[1][1] = $character[1][2] = $character[2][0]
	    = $character[3][0] = $character[3][1] = $character[4][0]
...
function character_H => sub {
	...
	$character[1][0] = $character[1][2] = $character[2][0] = $character[2][2]
	    ...
	    = $character[4][0] = $character[4][2] = $character[5][0]
	    = $character[5][2] = "\#";
	return \@character;
};
...
function character_I => sub {
	...
	$character[1][0] = $character[1][1] = $character[1][2] = $character[2][1]
	    = $character[3][1] = $character[4][1] = $character[5][0]
	    = $character[5][1] = $character[5][2] = "\#";
	return \@character;
};
...
function character_J => sub {
	my @character = $_[0]->default_character(4);
	$character[1][1] = $character[1][2] = $character[2][2] = $character[3][2]
...
function character_M => sub {
	my @character = $_[0]->default_character(4);
	$character[1][0] = $character[1][2] = $character[2][0] = $character[2][1]
...
function character_N => sub {
	my @character = $_[0]->default_character(4);
	$character[1][0] = $character[1][1] = $character[1][2] = $character[2][0]
	    = $character[2][2] = $character[3][0] = $character[3][2]
	    = $character[4][0] = $character[4][2] = $character[5][0]
	    = $character[5][2] = "\#";
	return \@character;
};
...
function character_S => sub {
	my @character = $_[0]->default_character(4);
	$character[1][1] = $character[1][2] = $character[2][0] = $character[3][1]
	    = $character[4][2] = $character[5][0] = $character[5][1] = "\#";
	return \@character;
};
...
function character_T => sub {
	my @character = $_[0]->default_character(4);
	$character[1][0] = $character[1][1] = $character[1][2] = $character[2][1]
	    = $character[3][1] = $character[4][1] = $character[5][1] = "\#";
	return \@character;
};
...
function character_X => sub {
	my @character = $_[0]->default_character(4);
	$character[1][0] = $character[1][2] = $character[2][0] = $character[2][2]
	    = $character[3][1] = $character[4][0] = $character[4][2]
	    = $character[5][0] = $character[5][2] = "\#";
	return \@character;
};
...
function character_Z => sub {
	my @character = $_[0]->default_character(4);
	$character[1][0] = $character[1][1] = $character[1][2] = $character[2][2]
	    = $character[3][1] = $character[4][0] = $character[5][0]
	    = $character[5][1] = $character[5][2] = "\#";
	return \@character;
};
...
function character_a => sub {
	my @character = $_[0]->default_character(4);
	$character[2][1] = $character[2][2] = $character[3][0] = $character[3][2]
	    = $character[4][0] = $character[4][1] = $character[4][2] = "\#";
	return \@character;
};
...
function character_b => sub {
	my @character = $_[0]->default_character(4);
	$character[1][0] = $character[2][0] = $character[2][1] = $character[2][2]
	    = $character[3][0] = $character[3][2] = $character[4][0]
...
function character_c => sub {
	my @character = $_[0]->default_character(4);
	$character[2][0] = $character[2][1] = $character[2][2] = $character[3][0]
	    = $character[4][0] = $character[4][1] = $character[4][2] = "\#";
	return \@character;
};
...
function character_d => sub {
	my @character = $_[0]->default_character(4);
	$character[1][2] = $character[2][0] = $character[2][1] = $character[2][2]
	    = $character[3][0] = $character[3][2] = $character[4][0]
	    = $character[4][1] = $character[4][2] = "\#";
	return \@character;
};
...
function character_f => sub {
	my @character = $_[0]->default_character(4);
	$character[1][1] = $character[1][2] = $character[2][1] = $character[3][0]
	    = $character[3][1] = $character[3][2] = $character[4][1]
	    = $character[5][0] = $character[5][1] = "\#";
	return \@character;
};
...
function character_i => sub {
	my @character = $_[0]->default_character(4);
	$character[1][1] = $character[3][1] = $character[4][1] = $character[4][2]
	    = "\#";
	return \@character;
};
...
function character_j => sub {
	my @character = $_[0]->default_character(4);
	$character[1][1] = $character[3][1] = $character[4][1] = $character[5][0]
	    = "\#";
	return \@character;
};
...
function character_n => sub {
	my @character = $_[0]->default_character(4);
	$character[2][0] = $character[2][1] = $character[3][0] = $character[3][2]
...
function character_s => sub {
	my @character = $_[0]->default_character(4);
	$character[2][1] = $character[2][2] = $character[3][1] = $character[4][0]
	    = $character[4][1] = "\#";
	return \@character;
};
...
function character_t => sub {
	my @character = $_[0]->default_character(4);
	$character[1][1] = $character[2][0] = $character[2][1] = $character[2][2]
...
function character_w => sub {
	my @character = $_[0]->default_character(4);
	$character[2][0] = $character[2][2] = $character[3][0] = $character[3][1]
	    = $character[3][2] = $character[4][0] = $character[4][1]
	    = $character[4][2] = "\#";
	return \@character;
};
...
function character_x => sub {
	my @character = $_[0]->default_character(4);
	$character[2][0] = $character[2][2] = $character[3][1] = $character[4][0]
	    = $character[4][2] = "\#";
	return \@character;
};
...
function character_y => sub {
	my @character = $_[0]->default_character(4);
	$character[2][0] = $character[2][2] = $character[3][0] = $character[3][1]
	    = $character[3][2] = $character[4][2] = $character[5][0]
	    = $character[5][1] = $character[5][2] = "\#";
	return \@character;
};
...
function character_z => sub {
	my @character = $_[0]->default_character(4);
	$character[2][0] = $character[2][1] = $character[3][1] = $character[4][1]
	    = $character[4][2] = "\#";
	return \@character;
};
...
function character_1 => sub {
	my @character = $_[0]->default_character(4);
	$character[1][1] = $character[2][0] = $character[2][1] = $character[3][1]
	    = $character[4][1] = $character[5][0] = $character[5][1]
	    = $character[5][2] = "\#";
	return \@character;
};
...
function character_2 => sub {
	...
	$character[1][0] = $character[1][1] = $character[1][2] = $character[2][2]
	    = $character[3][0] = $character[3][1] = $character[3][2]
	    = $character[4][0] = $character[5][0] = $character[5][1]
	    = $character[5][2] = "\#";
	return \@character;
};
...
function character_3 => sub {
	my @character = $_[0]->default_character(4);
	$character[1][0] = $character[1][1] = $character[1][2] = $character[2][2]
	    = $character[3][1] = $character[3][2] = $character[4][2]
	    = $character[5][0] = $character[5][1] = $character[5][2] = "\#";
	return \@character;
};
...
Please report any bugs or feature requests to C<bug-ascii::text::font::3x5 at rt.cpan.org>, or through
the web interface at L<https://rt.cpan.org/NoAuth/ReportBug.html?Queue=Ascii-Text-Font-3x5>.  I will be notified, and then you'll
...
L<https://rt.cpan.org/NoAuth/Bugs.html?Dist=Ascii-Text-Font-3x5>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/Ascii-Text-Font-3x5>

=item * CPAN Ratings

L<https://cpanratings.perl.org/d/Ascii-Text-Font-3x5>

=item * Search CPAN

L<https://metacpan.org/release/Ascii-Text-Font-3x5>
