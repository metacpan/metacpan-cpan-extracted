...
Text as STRING or C<$message> object to be displayed after the display
of this message.
...
Text as STRING or C<$message> object to be displayed before the display
of this message.
...
to delay translations even longer.  When C<$prepend> is C<true>, the C<STRING>
or C<$object> (other C<Log::Report::Message>) needs to prepended, otherwise
it is appended.
...
Returns C<true> if the message is in the specified C<$class> (string) or
...
=head4 Â» Example: using the _count
