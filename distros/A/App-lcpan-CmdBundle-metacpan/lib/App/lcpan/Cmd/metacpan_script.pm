...
1;
# ABSTRACT: Open script POD on MetaCPAN
...
App::lcpan::Cmd::metacpan_script - Open script POD on MetaCPAN

=head1 VERSION

This document describes version 0.006 of App::lcpan::Cmd::metacpan_script (from Perl distribution App-lcpan-CmdBundle-metacpan), released on 2019-06-24.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<metacpan-script>.
...
This will open CL<https://metacpan.org/pod/SCRIPTNAME>. C<SCRIPTNAME> will be first
checked for existence in local index database.
