...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::PDF::Page;
...
PDF::API3::Compat::API2::Basic::PDF::Page - Represents a PDF page, inherits from L<PDF::API3::Compat::API2::Basic::PDF::Pages>
...
=head2 PDF::API3::Compat::API2::Basic::PDF::Page->new($pdf, $parent, $index)
...
sub add
{
    ...
    if (!defined $strm)
    {
        $strm = PDF::API3::Compat::API2::Basic::PDF::Dict->new;
        foreach (@{$self->{' outto'}})
        { $_->new_obj($strm); }
        $self->{'Contents'} = PDFArray() unless defined $self->{'Contents'};
        unless (ref $self->{'Contents'} eq "PDF::API3::Compat::API2::Basic::PDF::Array")
