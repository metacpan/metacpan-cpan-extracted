package Google::Ai::Generativelanguage::V1::ModelServiceClient;
...
sub get_model {
    ...
    my $request_class = 'Google::Ai::Generativelanguage::V1::ModelService::GetModelRequest';
    my $request = eval { $request_class->new(\%params) } || eval { $request_class->new(%params) } || ($request_class->can('encode') ? $request_class->encode(\%params) : \%params);

    my $response_class = 'Google::Ai::Generativelanguage::V1::Model::Model';
...
sub list_models {
    ...
    my $request_class = 'Google::Ai::Generativelanguage::V1::ModelService::ListModelsRequest';
    my $request = eval { $request_class->new(\%params) } || eval { $request_class->new(%params) } || ($request_class->can('encode') ? $request_class->encode(\%params) : \%params);

    my $response_class = 'Google::Ai::Generativelanguage::V1::ModelService::ListModelsResponse';
    my $response = $self->transport->call({
        service        => 'google.ai.generativelanguage.v1.ModelService',
        method         => 'ListModels',
        request        => $request,
...
1; # End of Google::Ai::Generativelanguage::V1::ModelServiceClient

__END__

=head1 NAME

Google::Ai::Generativelanguage::V1::ModelServiceClient - Client library for Google Cloud Services

=head1 SYNOPSIS

    use Google::Ai::Generativelanguage::V1::ModelServiceClient;
    use Google::Auth;

    my $auth = Google::Auth->default();

    # 1. High-performance gRPC Transport (Default)
    my $grpc_client = Google::Ai::Generativelanguage::V1::ModelServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Ai::Generativelanguage::V1::ModelServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Ai::Generativelanguage::V1::ModelServiceClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Ai::Generativelanguage::V1::ModelServiceClient->new(
