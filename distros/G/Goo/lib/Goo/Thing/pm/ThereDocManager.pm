package Goo::Thing::pm::ThereDocManager;
...
# Filename:     Goo::Thing::pm::ThereDocManager.pm
...
use Goo::Thing::pm::ThereDocManager;
...
given a string, look for ThereDocs and then do actions
