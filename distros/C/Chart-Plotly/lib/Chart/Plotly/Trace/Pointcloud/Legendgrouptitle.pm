package Chart::Plotly::Trace::Pointcloud::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Pointcloud::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Pointcloud::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Pointcloud::Legendgrouptitle - This attribute is one of the possible options for the trace pointcloud.
