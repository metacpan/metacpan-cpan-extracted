...
Sah::Schema::array_of_int - Array of integers

=head1 VERSION

This document describes version 0.007 of Sah::Schema::array_of_int (from Perl distribution Sah-Schemas-Examples), released on 2021-07-30.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("array_of_int*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("array_of_int*");
     $validator->(\@args);
     ...
 }
