...
IO::K8s::PrometheusOperator::V1::RelabelConfig - RelabelConfig allows dynamic rewriting of the label set for targets, alerts, scraped samples and remote write samples.
