...
use Google::Ads::AdWords::v201802::UploadConversion;
use Google::Ads::AdWords::v201802::ConversionTrackerOperation;
use Google::Ads::AdWords::v201802::OfflineCallConversionFeed;
use Google::Ads::AdWords::v201802::OfflineCallConversionFeedOperation;
