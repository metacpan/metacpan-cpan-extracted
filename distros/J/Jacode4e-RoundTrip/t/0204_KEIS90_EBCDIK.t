...
for my $byte (0x00 .. 0xFF) {
    ...
    my $return = Jacode4e::RoundTrip::convert(\$got,'keis78','cp932x',{'INPUT_LAYOUT'=>'S'});
...
for my $byte (0x00 .. 0xFF) {
    ...
    my $return = Jacode4e::RoundTrip::convert(\$got,'cp932x','keis78',{'INPUT_LAYOUT'=>'S'});
    ok(($return > 0) and ($got eq $want),
