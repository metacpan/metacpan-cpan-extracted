...
is_deeply ($am_pm, { evening1 => 'вечерта', morning1 => 'сутринта', morning2 => 'на обед', afternoon1 => 'следобед', midnight => 'полунощ', night1 => 'през нощта', am => 'am', pm => 'pm' }, 'AM PM format abbreviated');
$am_pm = $locale->am_pm_format_narrow();
is_deeply ($am_pm, { evening1 => 'вечерта', morning1 => 'сутринта', morning2 => 'на обед', afternoon1 => 'следобед', midnight => 'полунощ', night1 => 'през нощта', am => 'am', pm => 'pm' }, 'AM PM format narrow');
$am_pm = $locale->am_pm_stand_alone_wide();
is_deeply ($am_pm, { evening1 => 'вечерта', morning1 => 'сутринта', morning2 => 'на обед', afternoon1 => 'следобед', midnight => 'полунощ', night1 => 'през нощта', am => 'am', pm => 'pm' }, 'AM PM stand alone wide');
$am_pm = $locale->am_pm_stand_alone_abbreviated();
is_deeply ($am_pm, { evening1 => 'вечерта', morning1 => 'сутринта', morning2 => 'на обед', afternoon1 => 'следобед', midnight => 'полунощ', night1 => 'през нощта', am => 'am', pm => 'pm' }, 'AM PM stand alone abbreviated');
$am_pm = $locale->am_pm_stand_alone_narrow();
is_deeply ($am_pm, { evening1 => 'вечерта', morning1 => 'сутринта', morning2 => 'наобед', afternoon1 => 'следобед', midnight => 'полунощ', night1 => 'през нощта', am => 'am', pm => 'pm' }, 'AM PM stand alone narrow');
...
is($day_period_data, 'на обед', 'Day period data Noon');
$day_period_data = $locale->get_day_period('1210');
is($day_period_data, 'на обед', 'Day period data PM');
...
is($time_format, 'H:mm:ss \'ч\'. zzzz', 'Time Format Full');
$time_format = $locale->time_format_long;
is($time_format, 'H:mm:ss \'ч\'. z', 'Time Format Long');
$time_format = $locale->time_format_medium;
is($time_format, 'H:mm:ss \'ч\'.', 'Time Format Medium');
$time_format = $locale->time_format_short;
is($time_format, 'H:mm \'ч\'.', 'Time Format Short');
...
is($date_time_format, 'd.MM.y \'г\'., H:mm:ss \'ч\'.', 'Date Time Format Medium');
$date_time_format = $locale->datetime_format_short;
is($date_time_format, 'd.MM.yy \'г\'., H:mm \'ч\'.', 'Date Time Format Short');
