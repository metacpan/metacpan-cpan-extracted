...
The name of the ID field for the schema. Defaults to C<id>. It does
...
Update an item. C<$schema> is the schema name. C<$id> is the ID
...
Delete an item. C<$schema> is the schema name. C<$id> is the ID
