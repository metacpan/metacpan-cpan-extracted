...
has 'characters' => (
	...
	sub {
		...
		return {
			...
			main => qr{(?^u:[़ ॐ ं ँ ः अ आ इ ई उ ऊ ऋ ऌ ऍ ए ऐ ऑ ओ औ क ख ग घ ङ च छ ज झ ञ ट ठ ड ढ ण त थ द ध न प फ ब भ म य र ल व श ष स ह ळ ऽ ा ि ी ु ू ृ ॄ ॅ े ै ॉ ो ौ ्])},
			punctuation => qr{(?^u:[\- ‐ – — , ; \: ! ? . … ' ‘ ’ " “ ” ( ) \[ \] @ * / \& # ′ ″])},
		};
	},
EOT
	...
	default		=> sub { {
		...
		'PEN' => {
			...
			display_name => {
				...
				'other' => q(पेरुवियन नुइव्हो सोल्स),
			},
		},
		'PGK' => {
			symbol => 'PGK',
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'Europe_Further_Eastern' => {
			long => {
				'standard' => q(अग्र पुर्व यूरोपीयन वेळ),
			},
		},
		'Europe_Western' => {
			long => {
