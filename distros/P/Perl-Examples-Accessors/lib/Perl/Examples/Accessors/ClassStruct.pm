...
Perl::Examples::Accessors::ClassStruct

=head1 VERSION

This document describes version 0.133 of Perl::Examples::Accessors::ClassStruct (from Perl distribution Perl-Examples-Accessors), released on 2024-05-06.
