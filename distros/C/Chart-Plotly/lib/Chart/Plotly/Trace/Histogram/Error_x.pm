package Chart::Plotly::Trace::Histogram::Error_x;
use Moose;
...
Chart::Plotly::Trace::Histogram::Error_x - This attribute is one of the possible options for the trace histogram.
