...
use Google::Ads::AdWords::v201806::CriterionUserList;
...
sub _attach_user_list {
  ...
  my $user_list = Google::Ads::AdWords::v201806::CriterionUserList->new({
...
sub _create_ad {
  ...
  my $logo_marketing_image = Google::Ads::AdWords::v201806::Image->new(
