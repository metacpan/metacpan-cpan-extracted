...
#pod
#pod This is C<Hook::BeforeArchive> plugin implementation. Nothing interesting, just using few roles.
#pod
...
package Dist::Zilla::Plugin::Hook::BeforeArchive;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::BeforeArchive> plugin implementation
our $VERSION = 'v0.8.4'; # VERSION

with 'Dist::Zilla::Role::Plugin';
with 'Dist::Zilla::Role::Hooker' => {
    -alias => { hook => 'before_archive' },
};
...
Dist::Zilla::Plugin::Hook::BeforeArchive - C<Hook::BeforeArchive> plugin implementation
...
This is C<Hook::BeforeArchive> plugin implementation. Nothing interesting, just using few roles.
