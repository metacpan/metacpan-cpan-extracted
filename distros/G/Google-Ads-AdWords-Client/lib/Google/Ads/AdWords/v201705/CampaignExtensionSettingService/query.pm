...
package Google::Ads::AdWords::v201705::CampaignExtensionSettingService::query;
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::CampaignExtensionSettingService::query->new($data);
