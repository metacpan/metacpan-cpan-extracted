...
AddressBook::Child - A controller in the AddressBook application
...
=head1 METHODS INHERITED FROM AddressBook::GEN::Child
...
=head1 DEPENDENCIES
    ...
    AddressBook
    AddressBook::GEN::Child
    AddressBook::Model::child
