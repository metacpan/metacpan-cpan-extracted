...
# BEGIN REPLACE
	(
	_data_date => 'Fri, 25 Sep 2026 10:04:11 BST',
	_serial    => 'e3d69f43-b370-4dc1-bf4d-8f6a68cbdc01',
	_source    => __FILE__,
	978 => {
		...
		3     => [ 'German language'              => [ '00', '02', '030', '033', '0340', '0369', '03700', '03999', '04', '19', '200', '312', '3130', '3139', '314', '389', '39', '39', '400', '675', '67600', '68799', '688', '688', '68900', '69499', '6950', '8499', '85000', '89999', '900000', '949999', '9500000', '9539999', '95400', '96999', '9700000', '9849999', '98500', '99959', '9996', '9999' ] ],
		4     => [ 'Japan'                        => [ '00', '19', '200', '699', '7000', '8499', '85000', '89999', '900000', '949999', '9500000', '9999999' ] ],
		5     => [ 'former U.S.S.R'               => [ '00000', '00499', '0050', '0099', '01', '19', '200', '361', '3620', '3623', '36240', '36299', '363', '420', '4210', '4299', '430', '430', '4310', '4399', '440', '440', '4410', '4499', '450', '602', '6030000', '6049999', '605', '699', '7000', '8499', '85000', '89999', '900000', '909999', '91000', '91999', '9200', '9299', '93000', '94999', '9500000', '9500999', '9501', '9799', '98000', '98999', '9900000', '9909999', '9910', '9999' ] ],
		7     => [ 'China, People\'s Republic'    => [ '00', '09', '100', '499', '5000', '7999', '80000', '89999', '900000', '999999' ] ],
		65    => [ 'Brazil'                       => [ '00', '02', '250', '299', '300', '302', '5000', '6349', '80000', '81824', '82000', '89999', '900000', '902449', '975500', '999999' ] ],
		66    => [ 'Federated Panel'              => [ '30', '30', '850', '850' ] ],
		80    => [ 'former Czechoslovakia'        => [ '00', '19', '200', '529', '53000', '54999', '550', '689', '69000', '69999', '7000', '8499', '85000', '89999', '900000', '998999', '99900', '99999' ] ],
		81    => [ 'India'                        => [ '00', '16', '17000', '17999', '180000', '189999', '19000', '19999', '200', '647', '6480', '6699', '6700', '6799', '68000', '68499', '685000', '689999', '69000', '69999', '7000', '8499', '85000', '89999', '900000', '999999' ] ],
		...
		91    => [ 'Sweden'                       => [ '0', '1', '20', '49', '500', '649', '6850', '8199', '85000', '94999', '970000', '999999' ] ],
		92    => [ 'International NGO Publishers and EU Organizations' => [ '0', '5', '60', '79', '800', '899', '9000', '9499', '95000', '98999', '990000', '999999' ] ],
		93    => [ 'India'                        => [ '00', '08', '0900', '0999', '100', '469', '47000', '47999', '48000', '49999', '5000', '7999', '80000', '95999', '960000', '999999' ] ],
		...
		607   => [ 'Mexico'                       => [ '00', '25', '2600', '2649', '26500', '26999', '27', '39', '400', '588', '5890', '5929', '59300', '59999', '600', '691', '69200', '69999', '700', '749', '7500', '9499', '95000', '99999' ] ],
		...
		617   => [ 'Ukraine'                      => [ '00', '49', '500', '699', '7000', '8999', '9000', '9049', '90500', '99999' ] ],
		...
		622   => [ 'Iran'                         => [ '00', '10', '110', '129', '1300', '1799', '180', '182', '1830', '1899', '190', '194', '19500', '19999', '200', '459', '4600', '8749', '87500', '99999' ] ],
		623   => [ 'Indonesia'                    => [ '00', '10', '110', '524', '5250', '8799', '88000', '99999' ] ],
		624   => [ 'Sri Lanka'                    => [ '00', '04', '200', '249', '4850', '7199', '91000', '99999' ] ],
		625   => [ 'Türkiye'                      => [ '00', '01', '320', '442', '44300', '44499', '445', '449', '5000', '7793', '77940', '77949', '7795', '8999', '90000', '99999' ] ],
		626   => [ 'Taiwan'                       => [ '00', '04', '300', '499', '6500', '7999', '92500', '99999' ] ],
		627   => [ 'Pakistan'                     => [ '28', '31', '500', '549', '7200', '7999', '94500', '95549' ] ],
		628   => [ 'Colombia'                     => [ '00', '09', '500', '549', '7500', '8499', '95000', '99999' ] ],
		629   => [ 'Malaysia'                     => [ '00', '02', '455', '499', '7100', '7999', '92000', '99999' ] ],
		...
		634   => [ 'Indonesia'                    => [ '00', '05', '200', '349', '7000', '7999', '96000', '99999' ] ],
		635   => [ 'Iran'                         => [ '00', '04', '250', '324', '5800', '6999', '96000', '99999' ] ],
		950   => [ 'Argentina'                    => [ '00', '49', '500', '899', '9000', '9899', '99000', '99999' ] ],
		951   => [ 'Finland'                      => [ '0', '1', '20', '54', '550', '889', '8900', '9499', '95000', '99999' ] ],
		952   => [ 'Finland'                      => [ '00', '17', '180', '189', '19500', '19999', '200', '499', '5000', '5999', '60', '64', '65000', '65999', '6600', '6699', '67000', '69999', '7000', '7999', '80', '94', '9500', '9899', '99000', '99999' ] ],
		...
		956   => [ 'Chile'                        => [ '00', '07', '08000', '09999', '10', '19', '200', '599', '6000', '6999', '7000', '9999' ] ],
		...
		978   => [ 'Nigeria'                      => [ '000', '199', '2000', '2999', '30000', '66999', '67', '68', '690', '699', '765', '799', '8000', '8999', '900', '999' ] ],
		...
		981   => [ 'Singapore'                    => [ '00', '16', '17000', '17999', '18', '19', '200', '299', '3000', '3099', '310', '399', '4000', '5999', '91000', '91999', '92', '99' ] ],
		...
		989   => [ 'Portugal'                     => [ '0', '0', '20', '34', '35000', '36999', '37', '46', '470', '489', '49000', '49999', '50', '52', '53000', '54999', '550', '799', '8000', '9499', '95000', '99999' ] ],
		9905  => [ 'Nepal'                        => [ '0', '0', '20', '23', '600', '624', '9800', '9999' ] ],
		9906  => [ 'Tajikistan'                   => [ '20', '22', '700', '724', '9900', '9999' ] ],
		9907  => [ 'Ecuador'                      => [ '0', '0', '50', '64', '800', '874', '9500', '9999' ] ],
		9908  => [ 'Estonia'                      => [ '0', '3', '40', '69', '825', '899', '9700', '9999' ] ],
		9909  => [ 'Tunisia'                      => [ '00', '19', '750', '849', '9800', '9999' ] ],
		9910  => [ 'Uzbekistan'                   => [ '01', '18', '225', '374', '4500', '5499', '550', '799', '8000', '9999' ] ],
		9911  => [ 'Montenegro'                   => [ '20', '24', '550', '749', '9500', '9999' ] ],
		9912  => [ 'Tanzania'                     => [ '40', '44', '750', '799', '9700', '9999' ] ],
		9913  => [ 'Uganda'                       => [ '00', '09', '600', '709', '9500', '9999' ] ],
		9914  => [ 'Kenya'                        => [ '27', '55', '700', '799', '9200', '9999' ] ],
		...
		9920  => [ 'Morocco'                      => [ '00', '02', '130', '199', '200', '229', '23', '42', '430', '799', '8300', '8549', '8550', '9999' ] ],
		9921  => [ 'Kuwait'                       => [ '0', '0', '30', '39', '700', '899', '9700', '9999' ] ],
		9922  => [ 'Iraq'                         => [ '15', '29', '500', '549', '5500', '5999', '600', '799', '8000', '9999' ] ],
		...
		9929  => [ 'Guatemala'                    => [ '0', '3', '40', '54', '550', '799', '8000', '9799', '980', '999' ] ],
		...
		9941  => [ 'Georgia'                      => [ '0', '0', '10', '39', '400', '749', '75', '78', '7900', '7999', '8', '8', '9000', '9999' ] ],
		...
		9948  => [ 'United Arab Emirates'         => [ '00', '39', '400', '519', '52', '53', '540', '599', '600', '609', '610', '619', '620', '849', '8500', '9924', '9925', '9949', '9950', '9974', '9975', '9999' ] ],
		...
		9969  => [ 'Algeria'                      => [ '00', '19', '500', '749', '9300', '9999' ] ],
		...
		69990 => [ 'Zambia registration group'    => [ '50', '51', '990', '999' ] ],
		...
		99911 => [ 'Lesotho'                      => [ '00', '46', '470', '479', '48', '59', '600', '999' ] ],
		...
		99952 => [ 'Mali'                         => [ '0', '3', '40', '42', '430', '499', '50', '79', '800', '999' ] ],
		...
		99980 => [ 'Bhutan'                       => [ '0', '0', '25', '64', '670', '999' ] ],
		99981 => [ 'Macau'                        => [ '0', '0', '10', '10', '110', '149', '15', '19', '200', '219', '22', '74', '750', '999' ] ],
		99982 => [ 'Benin'                        => [ '0', '4', '50', '79', '845', '999' ] ],
		99983 => [ 'El Salvador'                  => [ '0', '0', '35', '69', '850', '999' ] ],
		...
		99988 => [ 'Sudan'                        => [ '0', '0', '10', '11', '50', '54', '800', '824' ] ],
		99989 => [ 'Paraguay'                     => [ '0', '1', '45', '49', '50', '79', '875', '899', '900', '999' ] ],
		99990 => [ 'Ethiopia'                     => [ '0', '1', '45', '60', '920', '999' ] ],
		99991 => [ 'Burkina Faso'                 => [ '0', '0', '50', '60', '960', '999' ] ],
		99992 => [ 'Oman'                         => [ '0', '2', '50', '69', '900', '999' ] ],
		99993 => [ 'Mauritius'                    => [ '0', '4', '50', '54', '980', '999' ] ],
		99994 => [ 'Haiti'                        => [ '0', '0', '50', '56', '960', '999' ] ],
		99995 => [ 'Seychelles'                   => [ '50', '55', '975', '999' ] ],
		99996 => [ 'Macau'                        => [ '0', '1', '40', '59', '900', '999' ] ],
		99997 => [ 'Srpska, Republic of'          => [ '0', '0', '40', '61', '920', '999' ] ],
		99998 => [ 'Namibia'                      => [ '80', '89' ] ],
	},
	979 => {
		8     => [ 'United States'                => [ '030', '034', '1600', '1699', '1700', '1799', '1800', '1949', '1950', '1999', '200', '239', '2400', '2599', '2600', '2799', '2800', '2999', '3000', '8849', '88500', '89999', '90000', '90999', '94500', '94999', '950000', '969999', '9820000', '9849999', '9850000', '9929999', '9930000', '9959999', '9960000', '9984999', '9985000', '9999999' ] ],
		10    => [ 'France'                       => [ '00', '19', '200', '699', '7000', '8999', '90000', '97599', '976000', '999999' ] ],
		11    => [ 'Korea, Republic'              => [ '00', '21', '220000', '229999', '23000', '24999', '250', '549', '5500', '8499', '85000', '94999', '950000', '999999' ] ],
