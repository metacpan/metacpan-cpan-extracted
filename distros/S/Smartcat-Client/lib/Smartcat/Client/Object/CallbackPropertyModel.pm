...
#
package Smartcat::Client::Object::CallbackPropertyModel;
...
__PACKAGE__->method_documentation(
    {
        ...
        'additional_headers' => {
            datatype    => 'ARRAY[AdditionalHeaderModel]',
            base_name   => 'additionalHeaders',
            description => '',
            format      => '',
            read_only   => '',
        },
...
__PACKAGE__->swagger_types(
    {
        'url'                => 'string',
        'additional_headers' => 'ARRAY[AdditionalHeaderModel]'
    }
);
