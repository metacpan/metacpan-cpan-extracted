package Google::Ads::AdWords::v201806::PlatformCampaignEstimate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'platform' => 'Google::Ads::AdWords::v201806::Platform',
        'minEstimate' => 'Google::Ads::AdWords::v201806::StatsEstimate',
        'maxEstimate' => 'Google::Ads::AdWords::v201806::StatsEstimate',
    },
    {
...
Google::Ads::AdWords::v201806::PlatformCampaignEstimate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PlatformCampaignEstimate from the namespace https://adwords.google.com/api/adwords/o/v201806.
