...
$Search::Elasticsearch::Client::8_0::Direct::Slm::VERSION = '8.12';
use Moo;
...
Search::Elasticsearch::Client::8_0::Direct::Slm - Snapshot lifecycle management feature of Search::Elasticsearch 8.x
