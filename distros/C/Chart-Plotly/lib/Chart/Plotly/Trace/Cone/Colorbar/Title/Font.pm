package Chart::Plotly::Trace::Cone::Colorbar::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Cone::Colorbar::Title::Font - This attribute is one of the possible options for the trace cone.
