...
IO::K8s::Api::Scheduling::V1beta1::CompositeGangSchedulingPolicy - CompositeGangSchedulingPolicy indicates that the groups belonging to the composite group should be scheduled using all-or-nothing semantics.
