...
Panda::Lib::Test::String::test_fill_smap({a => 1, b => 2, c => "hello", world => "hello"});

say Panda::Lib::Test::String::test_smap_sv("world");

#my $str = "jopa ebana rot pizda nahuy blyad suka";
#my $s = Panda::Lib::Test::String->new_ptr("a" x 1000000);
#timethis(-1, sub { Panda::Lib::Test::String::test_at($s) });

#timethis(-1, sub { Panda::Lib::Test::test_mempool16r_threaded() });
#timethis(-1, sub { Panda::Lib::Test::test_oalloc_rotate_tls(16) });
...
sub test_pools {
    say "PREPARE 16";
    Panda::Lib::test_oalloc_serial(16);
    say "PREPARE 32";
    Panda::Lib::test_oalloc_serial(32);
    say "PREPARE 128";
    Panda::Lib::test_oalloc_serial(128);
    say "PREPARE 1024";
    Panda::Lib::test_oalloc_serial(1024);
    say "PREPARE 1025";
    Panda::Lib::test_oalloc_serial(1025);
    say "PREPARE DONE";

    timethese(-1, {
#        mallocs10    => sub { Panda::Lib::test_malloc_serial(16); },
#        mallocs30    => sub { Panda::Lib::test_malloc_serial(32); },
#        mallocs100   => sub { Panda::Lib::test_malloc_serial(128); },
#        mallocs1000  => sub { Panda::Lib::test_malloc_serial(1024); },
#        mallocr10    => sub { Panda::Lib::test_malloc_rotate(16); },
#        mallocr30    => sub { Panda::Lib::test_malloc_rotate(32); },
#        mallocr100   => sub { Panda::Lib::test_malloc_rotate(128); },
#        mallocr1000  => sub { Panda::Lib::test_malloc_rotate(1024); },
#        oallocs10    => sub { Panda::Lib::test_oalloc_serial(16); },
#        oallocs30    => sub { Panda::Lib::test_oalloc_serial(32); },
#        oallocs100   => sub { Panda::Lib::test_oalloc_serial(128); },
#        oallocs1000  => sub { Panda::Lib::test_oalloc_serial(1024); },
#        oallocs1025  => sub { Panda::Lib::test_oalloc_serial(1025); },
#        oallocr16    => sub { Panda::Lib::test_oalloc_rotate(16); },
#        oallocr32    => sub { Panda::Lib::test_oalloc_rotate(32); },
#        oallocr128   => sub { Panda::Lib::test_oalloc_rotate(128); },
#        oallocr1024  => sub { Panda::Lib::test_oalloc_rotate(1024); },
#        oallocr1025  => sub { Panda::Lib::test_oalloc_rotate(1025); },
        oallocr16tls    => sub { Panda::Lib::test_oalloc_rotate_tls(16); },
        #oallocr32tls    => sub { Panda::Lib::test_oalloc_rotate_tls(32); },
        #oallocr128tls   => sub { Panda::Lib::test_oalloc_rotate_tls(128); },
        #oallocr1024tls  => sub { Panda::Lib::test_oalloc_rotate_tls(1024); },
        #oallocr1025tls  => sub { Panda::Lib::test_oalloc_rotate_tls(1025); },
        mempool     => sub { Panda::Lib::test_mempool16r(); },
        mempoolthr  => sub { Panda::Lib::test_mempool16r_threaded(); },
#        new_obj_std     => sub { Panda::Lib::test_new_obj(0) },
#        new_obj_dyn     => sub { Panda::Lib::test_new_obj(1) },
#        new_obj_thr     => sub { Panda::Lib::test_new_obj(2) },
#        new_obj_dyn_thr => sub { Panda::Lib::test_new_obj(3) },
    });
    #Panda::Lib::test_malloc_serial(8) while 1;
}

sub test_tls {
    timethis(-1, sub { Panda::Lib::test_mempool_tls() });
    #Panda::Lib::test_mempool_tls() while 1;
}
