...
{
  $Monitoring::Reporter::Web::Plugin::History::VERSION = '0.01';
}
BEGIN {
  $Monitoring::Reporter::Web::Plugin::History::AUTHORITY = 'cpan:TEX';
}
...
Monitoring::Reporter::Web::Plugin::History - List all triggers
