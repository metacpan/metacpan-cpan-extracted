package Chart::Plotly::Trace::Splom::Marker::Colorbar::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Splom::Marker::Colorbar::Title::Font - This attribute is one of the possible options for the trace splom.
