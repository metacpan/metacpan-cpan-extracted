...
package Google::Ads::AdWords::v201607::AdwordsUserListService::query;
use strict;
use warnings;
...
query from the namespace https://adwords.google.com/api/adwords/rm/v201607.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201607::AdwordsUserListService::query->new($data);
