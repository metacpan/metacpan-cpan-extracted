...
Lab::Measurement::Legacy::Tutorial - Old Tutorial on using the historical/deprecated API of the Lab::Measurement package stack
...
This software is copyright (c) 2021 by the Lab::Measurement team; in detail:
  ...
  Copyright 2006       Daniel SchrÃ¶er
            2010       Daniel SchrÃ¶er
            2011-2012  Andreas K. HÃ¼ttel
