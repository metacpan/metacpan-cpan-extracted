package Chart::Plotly::Trace::Carpet::Aaxis::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Carpet::Aaxis::Tickfont - This attribute is one of the possible options for the trace carpet.
