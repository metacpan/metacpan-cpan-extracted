package PDF::Make::Builder::Text::H2;
use strict;
use warnings;
use Object::Proto;

BEGIN {
    Object::Proto::define('PDF::Make::Builder::Text::H2',
        extends => 'PDF::Make::Builder::Text',
        'toc:Bool:default(0)',
    );
    Object::Proto::import_accessors('PDF::Make::Builder::Text::H2');
}
...
Extends L<PDF::Make::Builder::Text> with heading-level-2 font defaults:
size 40, line_height 48, margin 12 (for spacing after the heading).
