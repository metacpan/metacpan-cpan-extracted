...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::PacketMirroring Google::Cloud::Compute::V1::Compute::PacketMirroringAggregatedList Google::Cloud::Compute::V1::Compute::PacketMirroringList Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::PacketMirroringsClient->new( credentials => 'dummy' );
