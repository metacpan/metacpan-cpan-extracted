...
IO::K8s::Api::Scheduling::V1alpha2::PodGroupTemplateReference - PodGroupTemplateReference references a PodGroup template defined in some object (e.g. Workload). Exactly one reference must be set.
