package Algorithm::Easing::Sinusoidal;
...
Algorithm::Easing::Sinusoidal - Calculate eased translations between two positive whole integer values over time
...
=head1 SYNOPSIS
        ...
        # this example produces traditional 'sinusoidal' output;

        my $translation = Algorithm::Easing::Sinusoidal->new;
...
This method is used to ease in between two positive real whole integers using a positive real integer as the parameter for time in sinusoidal fashion.
...
This method is used to ease both in then out between two positive real whole integers using a positive real integer as the parameter for time in sinusoidal.
