...
=head1 The Mac::Path::Util module

This is the I<README> for the L<Mac::Path::Util> Perl module. You're probably 
...
To read about L<Mac::Path::Util>, look at the embedded documentation 
...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Mac-Path-Util> or 
L<MetaCPAN|http://www.metacpan.org/module/Mac::Path::Util>:

=over 4

=item *	L<http://search.cpan.org/dist/Mac-Path-Util>

=item *	L<http://www.metacpan.org/module/Mac::Path::Util>
...
=item *	L<https://github.com/briandfoy/Mac-Path-Util>

=back

If you find a problem, file a ticket in the L<issue 
tracker|https://github.com/briandfoy/Mac-Path-Util/issues>:

=over 4

=item *	L<https://github.com/briandfoy/Mac-Path-Util/issues>
