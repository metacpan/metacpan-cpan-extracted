...
sub keys_of_EBCDIK_HITACHI_by_JIS8 {
    return keys %EBCDIK_HITACHI_by_JIS8;
}

sub values_of_EBCDIK_HITACHI_by_JIS8 {
    return values %EBCDIK_HITACHI_by_JIS8;
}
