package Finance::AMEX::Transaction::EPTRN::Detail::Chargeback;
$Finance::AMEX::Transaction::EPTRN::Detail::Chargeback::VERSION = '0.002';
use strict;
use warnings;
...
Finance::AMEX::Transaction::EPTRN::Detail::Chargeback - Object methods for AMEX Reconciliation file chargback detail records.
