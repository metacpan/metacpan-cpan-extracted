...
See L<Schedule::Activity/BUGS>.  If a conclusion node can be reached, there are more circumstances where it should be chosen to complete scheduling.  The arithmetic for available buffer time should be updated to include the tmmax of the final node, where applicable.
