...
is($locale->unit(1, 'inch-ofhg', 'narrow'), '1″ Hg', 'Danish narrow 1 inch of mercury');
is($locale->unit(2, 'inch-ofhg', 'narrow'), '2″ Hg', 'Danish narrow 2 inches of mercury');
is($locale->unit(1, 'inch-ofhg', 'short'), '1 # Hg', 'Danish short 1 inch of mercury');
is($locale->unit(2, 'inch-ofhg', 'short'), '2 # Hg', 'Danish short 2 inches of mercury');
is($locale->unit(1, 'inch-ofhg'), '1 tomme kviksølv', 'Danish long 1 inch of mercury');
is($locale->unit(2, 'inch-ofhg'), '2 tommer kviksølv', 'Danish long 2 inches of mercury');
...
is($locale->unit(1, 'kilometer-per-hour'), '1 kilometer i timen', 'Danish long 1 kilometre per hour');
...
is($locale->unit(1, 'mile', 'narrow'), '1 mi', 'Danish narrow 1 mile');
is($locale->unit(2, 'mile', 'narrow'), '2 mi', 'Danish narrow 2 miles');
is($locale->unit(1, 'mile', 'short'), '1 mi', 'Danish short 1 mile');
is($locale->unit(2, 'mile', 'short'), '2 mi', 'Danish short 2 miles');
is($locale->unit(1, 'mile'), '1 mile', 'Danish long 1 mile');
is($locale->unit(2, 'mile'), '2 miles', 'Danish long 2 miles');
...
is($locale->unit(1, 'millibar', 'narrow'), '1 mb', 'Danish narrow 1 millibar');
is($locale->unit(2, 'millibar', 'narrow'), '2 mb', 'Danish narrow 2 millibars');
...
is($locale->unit(2, 'minute', 'narrow'), '2 m', 'Danish narrow 2 minutes');
...
is($locale->unit(1, 'ounce', 'narrow'), '1 oz', 'Danish narrow 1 ounce');
is($locale->unit(2, 'ounce', 'narrow'), '2 oz', 'Danish narrow 2 ounces');
...
is($locale->unit(1, 'square-foot', 'narrow'), '1 fod²', 'Danish narrow 1 square foot');
is($locale->unit(2, 'square-foot', 'narrow'), '2 fod²', 'Danish narrow 2 square feet');
