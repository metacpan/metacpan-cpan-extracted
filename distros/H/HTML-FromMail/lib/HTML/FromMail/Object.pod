...
Contains the special settings for each of the topics.  This expects a C<%map>
...
Returns the settings for objects with a certain C<TOPIC>, by default
...
Convert a C<STRING> into HTML.

=back

=head1 SEE ALSO

This module is part of HTML-FromMail version 3.00,
