...
Pg::SQL::PrettyPrinter::Node::A_Const - Class representing single constant value
...
Makes object, first using parent's constructur, and then "unpacks" it's val
key.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Pg::SQL::PrettyPrinter::Node::A_Const
