...
static int asn_MAP_GPRSMSClass_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_GPRSMSClass_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_GPRSMSClass_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mSNetworkCapability at 2559 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* mSRadioAccessCapability at 2560 */
};
static asn_SEQUENCE_specifics_t asn_SPC_GPRSMSClass_specs_1 = {
	...
	asn_MAP_GPRSMSClass_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
