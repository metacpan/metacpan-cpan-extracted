...
#
# ... Tests via check_template-SOAP.pl
#
# $Id: check_template-SOAP.t, v 1.0 2006/02/01 Alex Peeters Exp $
#
...
my $plugin = 'check_template-SOAP.pl';
...
if ( -x "$prefix/$plugin" ) {
  ...
  unless ( defined $ASNMTAP_PROXY and ( $ASNMTAP_PROXY eq '0.0.0.0' or $ASNMTAP_PROXY eq '' ) ) {
    ...
    $t += checkCmd( "$prefix/$plugin $proxy", [0, 1, 2]);
  } else {
