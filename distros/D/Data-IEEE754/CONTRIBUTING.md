...
https://metacpan.org/release/Data-IEEE754

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Data::IEEE754
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Data::IEEE754
...
The code for this distribution is [hosted at GitHub](https://github.com/maxmind/Data-IEEE754).
...
can submit an issue report [via the web](https://github.com/maxmind/Data-IEEE754/issues)
).
