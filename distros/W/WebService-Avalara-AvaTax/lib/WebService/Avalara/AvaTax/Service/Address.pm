...
#pod =head1 SYNOPSIS
#pod
#pod     use WebService::Avalara::AvaTax::Service::Address;
#pod
#pod     my $avatax = WebService::Avalara::AvaTax::Service::Address->new(
...
#pod address validation web service using SOAP. Most of its mechanics are in
...
#pod Defaults to C</address/addresssvc.wsdl>, with the URI base either
...
#pod is false, the alternate security WSDL file C</address/addresssvcaltsec.wsdl>
...
WebService::Avalara::AvaTax::Service::Address - Avalara AvaTax address validation service via SOAP
