...
our %STATS = ("num_rows",328,"num_columns",2); # STATS
...
This document describes version 20230207.0.0 of TableDataRole::Business::ID::BPOM::FoodType (from Perl distribution TableDataBundle-Business-ID-BPOM), released on 2023-02-07.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Business::ID::BPOM::FoodType;

 my $td = TableData::Business::ID::BPOM::FoodType->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Business::ID::BPOM::FoodType --page

 # Get number of rows
 % tabledata --action count_rows Business::ID::BPOM::FoodType
