...
my($full)=Meta::Utils::Net::Hostname::full();
my($part)=Meta::Utils::Net::Hostname::part();
Meta::Utils::Output::print("hostname full is [".$full."]\n");
Meta::Utils::Output::print("hostname part is [".$part."]\n");
...
hostname.pl - testing program for the Meta::Utils::Net::Hostname.pm module.
...
This is a test suite for the Meta::Utils::Net::Hostname.pm package.
...
Meta::Baseline::Test(3), Meta::Utils::Net::Hostname(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), strict(3)
