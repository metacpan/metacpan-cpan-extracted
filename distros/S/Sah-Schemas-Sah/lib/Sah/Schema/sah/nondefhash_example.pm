...
Sah::Schema::sah::nondefhash_example - Non-defhash example

=head1 VERSION

This document describes version 0.9.50.0 of Sah::Schema::sah::nondefhash_example (from Perl distribution Sah-Schemas-Sah), released on 2021-07-23.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("sah::nondefhash_example*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("sah::nondefhash_example*");
     $validator->(\@args);
     ...
 }
