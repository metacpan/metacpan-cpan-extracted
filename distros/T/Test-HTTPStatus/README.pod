...
=for HTML <a href="https://travis-ci.org/briandfoy/test-httpstatus"><img src="https://travis-ci.org/briandfoy/test-httpstatus.svg?branch=master" /></a>

=for HTML <a href='https://ci.appveyor.com/project/briandfoy/test-httpstatus'><img src='https://ci.appveyor.com/api/projects/status/mtv6s8ix64bh7h44' /></a>

=for HTML <a href='https://coveralls.io/github/briandfoy/test-httpstatus?branch=master'><img src='https://coveralls.io/repos/github/briandfoy/test-httpstatus/badge.svg?branch=master' alt='Coverage Status' /></a>

=for HTML <a href="https://github.com/briandfoy/test-httpstatus/blob/master/LICENSE"><img src="https://img.shields.io/cpan/l/Test-HTTPStatus.svg" /></a>

=for HTML <a href="http://www.metacpan.org/module/Test::HTTPStatus"><img src="https://img.shields.io/cpan/v/Test-HTTPStatus.svg" /></A>

=head1 The Test::HTTPStatus module

This is the I<README> for the L<Test::HTTPStatus> Perl module. You're probably
...
To read about L<Test::HTTPStatus>, look at the embedded documentation
in the module itself. Inside the distribution, you can format it
with L<perldoc|http://perldoc.perl.org/perldoc.html>:

	% perldoc lib/Test/HTTPStatus.pm
...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Test-HTTPStatus> or
L<MetaCPAN|http://www.metacpan.org/module/Test::HTTPStatus>:

=over 4

=item *	L<http://search.cpan.org/dist/Test-HTTPStatus>

=item *	L<http://www.metacpan.org/module/Test::HTTPStatus>
...
and install the dependencies:
	...
	% cpan Test::HTTPStatus
	% cpanm Test::HTTPStatus
...
=item *	L<https://github.com/briandfoy/test-httpstatus>

=back

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/briandfoy/Test-HTTPStatus/issues>:

=over 4

=item *	L<https://github.com/briandfoy/test-httpstatus/issues>
