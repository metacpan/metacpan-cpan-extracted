...
(This example is included as L<F<examples/synopsis.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/synopsis.pl> in the distribution.)


=head1 VERSION

This document describes JSON::Create version 0.28,
corresponding to L<git commit ca96a03577aa417cfa10fd1feaaed4cdea5eea00|https://github.com/benkasminbullock/json-create/commit/ca96a03577aa417cfa10fd1feaaed4cdea5eea00> at Tue Nov 24 08:12:56 2020 +0900.
...
(This example is included as L<F<examples/hash.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/hash.pl> in the distribution.)
...
(This example is included as L<F<examples/nested-hash.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/nested-hash.pl> in the distribution.)
...
(This example is included as L<F<examples/array.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/array.pl> in the distribution.)
...
(This example is included as L<F<examples/nested-array.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/nested-array.pl> in the distribution.)
...
produces output
    ...
    {"dogs":["Tico","Rocky","Pinky"],"cats":["mocha","dusty","milky"],"fruit":{"australia":"orange","thai":"pineapple","japan":"persimmon"},"numbers":[1,2,2.5,99.99]}

(This example is included as L<F<examples/nested.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/nested.pl> in the distribution.)
...
(This example is included as L<F<examples/weirdstring.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/weirdstring.pl> in the distribution.)
...
(This example is included as L<F<examples/strict-non-finite.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/strict-non-finite.pl> in the distribution.)
...
(This example is included as L<F<examples/undef.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/undef.pl> in the distribution.)
...
(This example is included as L<F<examples/json-parse-bool.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/json-parse-bool.pl> in the distribution.)
...
(This example is included as L<F<examples/fatal-errors.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/fatal-errors.pl> in the distribution.)
...
(This example is included as L<F<examples/boolean.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/boolean.pl> in the distribution.)
...
(This example is included as L<F<examples/escape-slash.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/escape-slash.pl> in the distribution.)
...
(This example is included as L<F<examples/indent.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/indent.pl> in the distribution.)
...
(This example is included as L<F<examples/indent-format.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/indent-format.pl> in the distribution.)
...
(This example is included as L<F<examples/js-safe.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/js-safe.pl> in the distribution.)
...
(This example is included as L<F<examples/non-finite-handler.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/non-finite-handler.pl> in the distribution.)
...
(This example is included as L<F<examples/zilog.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/zilog.pl> in the distribution.)
...
(This example is included as L<F<examples/too-many-values.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/too-many-values.pl> in the distribution.)
...
(This example is included as L<F<examples/closure.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/closure.pl> in the distribution.)
...
(This example is included as L<F<examples/exception.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/exception.pl> in the distribution.)
...
produces output
    ...
    {"FunkyKong":0,"KingKong":1,"PeterTork":"Monkees","CuriousGeorge":{}}
    {"FunkyKong":false,"KingKong":true,"PeterTork":"Monkees","CuriousGeorge":null}
    {"FunkyKong":0,"KingKong":1,"PeterTork":"Monkees","CuriousGeorge":{}}


(This example is included as L<F<examples/obj-handler.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/obj-handler.pl> in the distribution.)
...
produces output
    ...
    {"path":"/home/ben/software/install/bin/perl","url":"http://example.com:3000/foo?foo=bar#23"}


(This example is included as L<F<examples/try-harder.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/try-harder.pl> in the distribution.)
...
(This example is included as L<F<examples/set-fformat.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/set-fformat.pl> in the distribution.)
...
produces output
    ...
    {
            "regex":{"type":"Regexp","value":"(?^:.*)"},
            "code":{"value":"강남스타일","type":"CODE"},
            "glob":{"value":"GLOB(0x209a82a0)","type":"GLOB"}
    }
    


(This example is included as L<F<examples/type-handler.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/type-handler.pl> in the distribution.)
...
(This example is included as L<F<examples/type-handler-scalar.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/type-handler-scalar.pl> in the distribution.)
...
(This example is included as L<F<examples/escape-all.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/escape-all.pl> in the distribution.)
...
(This example is included as L<F<examples/escape-all-no-utf8.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/escape-all-no-utf8.pl> in the distribution.)
...
(This example is included as L<F<examples/valid-chars.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/valid-chars.pl> in the distribution.)
...
(This example is included as L<F<examples/json-unicode.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/json-unicode.pl> in the distribution.)
...
(This example is included as L<F<examples/json-unicode-gzip-bytes.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/json-unicode-gzip-bytes.pl> in the distribution.)
...
(This example is included as L<F<examples/user-bad-utf8.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.28/examples/user-bad-utf8.pl> in the distribution.)
