...
BEGIN {
  $Class::Value::Net::Exception::DNSSEC::DS::InvalidDigestType::VERSION = '1.110250';
}
...
Class::Value::Net::Exception::DNSSEC::DS::InvalidDigestType - Network-related value objects
