package Chart::Plotly::Trace::Histogram::Marker::Colorbar::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Histogram::Marker::Colorbar::Title::Font - This attribute is one of the possible options for the trace histogram.
