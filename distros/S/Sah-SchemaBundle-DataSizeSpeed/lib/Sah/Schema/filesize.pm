...
This document describes version 0.010 of Sah::Schema::filesize (from Perl distribution Sah-SchemaBundle-DataSizeSpeed), released on 2024-08-03.

=head1 SAH SCHEMA DEFINITION

 ["datasize", {}, {}]

Base schema: L<datasize|Sah::Schema::datasize>
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("filesize*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("filesize", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("filesize", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("filesize*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"filesize*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('filesize*', name=>'Filesize')
     );
 }

 use My::Types qw(Filesize);
 Filesize->assert_valid($data);
