...
This document describes version 0.005 of App::TrimHistories (from Perl distribution App-TrimHistories), released on 2017-06-19.
...
Usage:
 ...
 trim_histories(%args) -> [status, msg, result, meta]
