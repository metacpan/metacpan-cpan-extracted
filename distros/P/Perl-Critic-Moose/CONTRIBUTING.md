...
https://metacpan.org/release/Perl-Critic-Moose

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Perl::Critic::Moose
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Perl::Critic::Moose
...
The code for this distribution is [hosted at GitHub](https://github.com/moose/Perl-Critic-Moose).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Perl-Critic-Moose)
or [via email](bug-perl-critic-moose@rt.cpan.org.
