...
our $rschema = ["hash",[{description=>"\n",examples=>[{data=>"a",valid=>0},{data=>[],valid=>0},{data=>{},valid=>1},{data=>{k=>"a"},valid=>1},{data=>{k=>undef},valid=>0},{data=>{k=>"a",k2=>[]},valid=>0},{data=>{k=>"a",k2=>{}},valid=>0}],of=>["str",{req=>1},{}],summary=>"Hash of (defined) strings"}],["hash"]];
...
This document describes version 0.002 of Sah::SchemaR::hos (from Perl distribution Sah-Schemas-Collection), released on 2020-03-02.
