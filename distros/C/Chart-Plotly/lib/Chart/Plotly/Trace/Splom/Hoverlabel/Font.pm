package Chart::Plotly::Trace::Splom::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Splom::Hoverlabel::Font - This attribute is one of the possible options for the trace splom.
