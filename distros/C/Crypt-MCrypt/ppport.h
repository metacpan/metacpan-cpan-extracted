...
----------------------------------------------------------------------
    ...
    &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE -- Perl/Pollution/Portability Version 3.21
    ...
    Use 'perldoc &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE' to view the documentation below.
...
=head1 SYNOPSIS
  ...
  perl &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE [options] [source files]
  ...
  --strip                     strip all script and doc functionality from
                              &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE
...
This version of F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE> is designed to support operation with Perl
...
Display the version of F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE>.
...
Tell F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE> to check for compatibility with the given
Perl version. The default is to check for compatibility with Perl
version 5.003. You can use this option to reduce the output
of F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE> if you intend to be backward compatible only
down to a certain Perl version.

=head2 --cplusplus

Usually, F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE> will detect C++ style comments and
replace them with C style comments for portability reasons.
Using this option instructs F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE> to leave C++
comments untouched.
...
Strip all script and documentation functionality from F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE>.
This reduces the size of F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE> dramatically and may be useful
if you want to include F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE> in smaller modules without
increasing their distribution size too much.

The stripped F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE> will have a C<--unstrip> option that allows
...
F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE>. Also lists if it must be explicitly requested,
if it has dependencies, and if there are hints or warnings for it.

=head2 --list-unsupported

Lists the API elements that are known not to be supported by
F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE> and below which version of Perl they probably
...
earlier Perl releases. Use
    ...
    perl &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE --list-provided

to see which API elements are provided by &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE.
...
also deprecated. You can safely use the supported API, as F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE>
...
more C<#define>s in your source code before the inclusion of F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE>.
...
macro. Just C<#define> the macro before including C<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE>:

    #define DPPP_NAMESPACE MyOwnNamespace_
    #include "&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE"
...
F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE> on your source code. See the next section for
details.

=head1 EXAMPLES

To verify whether F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE> is needed for your module, whether you
should make any changes to your code, and whether any special defines
should be used, F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE> can be run as a Perl script to check your
source code. Simply say:

    perl &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE
...
use something like this:
    ...
    perl &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE --compat-version=5.6.0 --cplusplus --patch=test.diff

If you only want your code to be scanned without any suggestions
for changes, use:

    perl &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE --nochanges

You can specify a different C<diff> program or options, using
the C<--diff> option:

    perl &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE --diff='diff -C 10'

This would output context diffs with 10 lines of context.

If you want to create patched copies of your files instead, use:

    perl &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE --copy=.new

To display portability information for the C<newSVpvn> function,
use:

    perl &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE --api-info=newSVpvn

Since the argument to C<--api-info> can be a regular expression,
you can use

    perl &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE --api-info=/_nomg$/

to display portability information for all C<_nomg> functions or

    perl &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE --api-info=/./

to display information for all known API elements.

=head1 BUGS

If this version of F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE> is causing failure during
the compilation of this module, please check if newer versions
of either this module or C<Devel::PPPort> are available on CPAN
before sending a bug report.

If F<&=Dist::Zilla::Plugin::PPPort::PPPORT_FILE> was generated using the latest version of
 ...
 */
#if PERL_REVISION != 5
#  error &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE only works with Perl version 5
 ...
 * 5.005 perls, you can use aTHXR (supplied by &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE), which will
...
/* Hint: SvPVbyte
 * Does not work in perl-5.6.1, &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE implements a version
...
/* End of File &=Dist::Zilla::Plugin::PPPort::PPPORT_FILE */
