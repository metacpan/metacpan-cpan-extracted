package Chart::Plotly::Trace::Histogram::Unselected::Textfont;
use Moose;
...
Chart::Plotly::Trace::Histogram::Unselected::Textfont - This attribute is one of the possible options for the trace histogram.
