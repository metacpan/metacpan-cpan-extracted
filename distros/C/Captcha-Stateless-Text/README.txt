...
DESCRIPTION
    A module to make stateless, text-based CAPTCHAs easy to implement.  It
    supports:
...
LICENSE
    This software is licensed under the OSI certified Artistic License, one
    of the licenses of Perl itself.

    <http://en.wikipedia.org/wiki/Artistic_License>



perl v5.34.0                      2024-04-1.::lib::Captcha::Stateless::Text(3)
