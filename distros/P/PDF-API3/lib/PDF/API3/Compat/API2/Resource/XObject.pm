...
#
#=======================================================================
package PDF::API3::Compat::API2::Resource::XObject;
...
=head1 $res = PDF::API3::Compat::API2::Resource::XObject->new $pdf, $name
...
=item $res = PDF::API3::Compat::API2::Resource::XObject->new_api $api, $name
