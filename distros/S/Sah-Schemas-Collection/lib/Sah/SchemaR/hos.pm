...
our $rschema = ["hash",[{description=>"\n",examples=>[{valid=>0,value=>"a"},{valid=>0,value=>[]},{valid=>1,value=>{}},{valid=>1,value=>{k=>"a"}},{valid=>0,value=>{k=>undef}},{valid=>0,value=>{k=>"a",k2=>[]}},{valid=>0,value=>{k=>"a",k2=>{}}}],of=>["str",{req=>1},{}],summary=>"Hash of (defined) strings"}],["hash"]];
...
This document describes version 0.008 of Sah::SchemaR::hos (from Perl distribution Sah-Schemas-Collection), released on 2020-05-08.
