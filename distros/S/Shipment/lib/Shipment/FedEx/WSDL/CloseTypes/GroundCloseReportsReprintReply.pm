...
Shipment::FedEx::WSDL::CloseTypes::GroundCloseReportsReprintReply
...
GroundCloseReportsReprintReply from the namespace http://fedex.com/ws/close/v2.
...
=item * Manifests (min/maxOccurs: 0/unbounded)
