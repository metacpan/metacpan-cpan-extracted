package Google::Ads::AdWords::v201802::FeedService::FeedServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201802::TypeMaps::FeedService
    if not Google::Ads::AdWords::v201802::TypeMaps::FeedService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201802/FeedService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201802::TypeMaps::FeedService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201802::FeedService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201802::FeedService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201802::FeedService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201802::FeedService::query )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201802/FeedService.
...
Returns a L<Google::Ads::AdWords::v201802::FeedService::getResponse|Google::Ads::AdWords::v201802::FeedService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201802::FeedService::mutateResponse|Google::Ads::AdWords::v201802::FeedService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201802::FeedService::queryResponse|Google::Ads::AdWords::v201802::FeedService::queryResponse> object.
