...
use Google::Ads::AdWords::v201705::AddressInfo;
use Google::Ads::AdWords::v201705::CrmBasedUserList;
use Google::Ads::AdWords::v201705::Member;
use Google::Ads::AdWords::v201705::MutateMembersOperand;
use Google::Ads::AdWords::v201705::MutateMembersOperation;
...
sub add_crm_based_user_list {
  ...
  # Create a user list.
  my $user_list = Google::Ads::AdWords::v201705::CrmBasedUserList->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201705::UserListOperation->new({
    operator => "ADD",
    operand  => $user_list
  });
  ...
  if ($result->get_value()) {
    ...
    foreach my $email (@email_list) {
      ...
      my $member = Google::Ads::AdWords::v201705::Member->new({
        hashedEmail => $email
      });
      push @members, $member;
    }
    ...
    # my $zip_code     = "10011";
    #
    # my $address_info = Google::Ads::AdWords::v201705::AddressInfo->new({
    ...
    # });
    #
    # my $member_by_address = Google::Ads::AdWords::v201705::Member->new({
    #   addressInfo => $address_info
    # });
    # push @members, $member_by_address;

    my $userlist_id = $result->get_value()->[0]->get_id();
    my $operand     = Google::Ads::AdWords::v201705::MutateMembersOperand->new({
      userListId => $userlist_id,
      membersList => \@members
    });

    my $member_operation =
      Google::Ads::AdWords::v201705::MutateMembersOperation->new({
        operator => "ADD",
        operand  => $operand
      });
