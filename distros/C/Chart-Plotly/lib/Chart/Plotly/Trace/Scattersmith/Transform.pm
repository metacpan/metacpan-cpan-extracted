package Chart::Plotly::Trace::Scattersmith::Transform;
use Moose;
...
Chart::Plotly::Trace::Scattersmith::Transform - This attribute is one of the possible options for the trace scattersmith.
