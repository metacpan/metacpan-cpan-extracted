  ...
  (
   inline_states =>
   {
    ...
    selectcol   => sub {
      ...
      $_[HEAP]->{user_data} = Symbol::gensym();
      $_[KERNEL]->post( $LADBI_ALIAS => 'selectcol',
    ...
    cmp_results => sub {
      ...
      unless ($datatype eq 'COLUMN') {
	$err = "datatype != 'COLUMN', datatype=$datatype";
	goto CMP_YIELD;
      }
      unless (defined $data) {
	$err = 'data undefined';
