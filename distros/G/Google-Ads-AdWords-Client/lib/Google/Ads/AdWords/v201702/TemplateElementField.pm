package Google::Ads::AdWords::v201702::TemplateElementField;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'type' => 'Google::Ads::AdWords::v201702::TemplateElementField::Type',
        'fieldText' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'fieldMedia' => 'Google::Ads::AdWords::v201702::Media',
    },
    {
...
TemplateElementField from the namespace https://adwords.google.com/api/adwords/cm/v201702.
