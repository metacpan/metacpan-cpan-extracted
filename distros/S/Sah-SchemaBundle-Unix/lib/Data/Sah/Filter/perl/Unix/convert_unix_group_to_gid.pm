...
Data::Sah::Filter::perl::Unix::convert_unix_group_to_gid - Convert Unix groupname into GID, fail when cannot convert

=head1 VERSION

This document describes version 0.022 of Data::Sah::Filter::perl::Unix::convert_unix_group_to_gid (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.
