package Google::Ads::AdWords::v201705::UniversalAppCampaignAdsPolicyDecisions;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'universalAppCampaignAsset' => 'Google::Ads::AdWords::v201705::UniversalAppCampaignAsset',
        'assetId' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'policyTopicEntries' => 'Google::Ads::AdWords::v201705::PolicyTopicEntry',
    },
    {
...
UniversalAppCampaignAdsPolicyDecisions from the namespace https://adwords.google.com/api/adwords/cm/v201705.
