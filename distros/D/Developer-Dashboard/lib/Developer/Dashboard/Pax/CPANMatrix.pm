...
Developer::Dashboard::Pax::CPANMatrix - CPAN compatibility matrix runner

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::CPANMatrix;

  my $obj = Developer::Dashboard::Pax::CPANMatrix->new(...);
  my $result = $obj->run(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::CPANMatrix -e 1
