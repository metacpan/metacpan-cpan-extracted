...
https://metacpan.org/release/Code-TidyAll-Plugin-YAMLFrontMatter

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Code::TidyAll::Plugin::YAMLFrontMatter
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Code::TidyAll::Plugin::YAMLFrontMatter
...
template file originating in Dist-Zilla-PluginBundle-MAXMIND-0.81.
