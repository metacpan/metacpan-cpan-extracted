  ...
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       ...
       return Cfn::Resource::Properties::Object::AWS::EventSchemas::Discoverer::TagsEntry->new( %$_ );
     }
   };

package Cfn::Resource::Properties::Object::AWS::EventSchemas::Discoverer::TagsEntry {
  use Moose;
