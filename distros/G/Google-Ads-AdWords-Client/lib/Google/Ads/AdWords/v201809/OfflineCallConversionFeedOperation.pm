package Google::Ads::AdWords::v201809::OfflineCallConversionFeedOperation;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'operand' => 'Google::Ads::AdWords::v201809::OfflineCallConversionFeed',
    },
    {
...
Google::Ads::AdWords::v201809::OfflineCallConversionFeedOperation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OfflineCallConversionFeedOperation from the namespace https://adwords.google.com/api/adwords/cm/v201809.
