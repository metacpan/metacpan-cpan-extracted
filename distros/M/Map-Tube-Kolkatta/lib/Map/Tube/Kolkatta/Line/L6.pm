...
$Map::Tube::Kolkatta::Line::L6::VERSION   = '0.34';
...
The map data for the line B<L6 - Pink> collected from L<this page|https://en.wikipedia.org/wiki/Pink_Line_(Kolkata_Metro)>.
