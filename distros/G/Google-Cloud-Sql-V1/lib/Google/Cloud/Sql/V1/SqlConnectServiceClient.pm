package Google::Cloud::Sql::V1::SqlConnectServiceClient;
...
sub resolve_connect_settings {
    ...
    my $request_class = 'Google::Cloud::Sql::V1::CloudSqlConnect::ResolveConnectSettingsRequest';
    my $request = eval { $request_class->new(\%params) } || eval { $request_class->new(%params) } || ($request_class->can('encode') ? $request_class->encode(\%params) : \%params);
...
1; # End of Google::Cloud::Sql::V1::SqlConnectServiceClient

__END__

=head1 NAME

Google::Cloud::Sql::V1::SqlConnectServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Sql::V1::SqlConnectServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Sql::V1::SqlConnectServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Sql::V1::SqlConnectServiceClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Sql::V1::SqlConnectServiceClient->new(
...
=item * B<resolve_connect_settings>

Calls the RPC method C<ResolveConnectSettings> on the service. Takes a hash of parameters representing the request.
