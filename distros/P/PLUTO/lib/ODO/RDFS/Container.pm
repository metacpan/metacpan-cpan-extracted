...
sub new {
	...
	$self->propertyContainerName( 'ODO::RDFS::Container::PropertiesContainer' );
	$self->properties(bless {}, 'ODO::RDFS::Container::PropertiesContainer');
