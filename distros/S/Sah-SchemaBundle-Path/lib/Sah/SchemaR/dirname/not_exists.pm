...
1;
# ABSTRACT: Directory name, must not exist on filesystem
...
Sah::SchemaR::dirname::not_exists - Directory name, must not exist on filesystem

=head1 VERSION

This document describes version 0.031 of Sah::SchemaR::dirname::not_exists (from Perl distribution Sah-SchemaBundle-Path), released on 2024-02-16.
