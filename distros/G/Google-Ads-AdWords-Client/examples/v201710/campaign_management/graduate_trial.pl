...
use Google::Ads::AdWords::v201710::Trial;
use Google::Ads::AdWords::v201710::TrialOperation;
...
sub graduate_trial {
  ...
  my $trial = Google::Ads::AdWords::v201710::Trial->new({
      id       => $trial_id,
      budgetId => $budget_id,
      status   => "GRADUATED"
  });
  ...
  # Create operation.
  my $trial_operation = Google::Ads::AdWords::v201710::TrialOperation->new({
      operator => "SET",
      operand  => $trial
  });
