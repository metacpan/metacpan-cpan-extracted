...
Data::Object::Config::Library is a L<Type::Tiny> type library that extends the
...
The JsonObj type constraint is provided by this library and accepts any object
that is, or is derived from, a L<Data::Object::Json> object. The
C<assert_JsonObj> function can be used to throw an exception if the argument
can not be validated. The C<is_JsonObj> function can be used to return true or
false if the argument can not be validated.
...
The JsonObject type constraint is provided by this library and accepts any
object that is, or is derived from, a L<Data::Object::Json> object. The
C<assert_JsonObject> function can be used to throw an exception if the argument
can not be validated. The C<is_JsonObject> function can be used to return true
or false if the argument can not be validated.
...
The PathObj type constraint is provided by this library and accepts any object
that is, or is derived from, a L<Data::Object::Path> object. The
C<assert_PathObj> function can be used to throw an exception if the argument
can not be validated. The C<is_PathObj> function can be used to return true or
false if the argument can not be validated.
...
The PathObject type constraint is provided by this library and accepts any
object that is, or is derived from, a L<Data::Object::Path> object. The
C<assert_PathObject> function can be used to throw an exception if the argument
can not be validated. The C<is_PathObject> function can be used to return true
or false if the argument can not be validated.
...
The TemplateObj type constraint is provided by this library and accepts any
object that is, or is derived from, a L<Data::Object::Template> object. The
C<assert_TemplateObj> function can be used to throw an exception if the
argument can not be validated. The C<is_TemplateObj> function can be used to
return true or false if the argument can not be validated.
...
The TemplateObject type constraint is provided by this library and accepts any
object that is, or is derived from, a L<Data::Object::Template> object. The
C<assert_TemplateObject> function can be used to throw an exception if the
argument can not be validated. The C<is_TemplateObject> function can be used to
return true or false if the argument can not be validated.
...
The YamlObj type constraint is provided by this library and accepts any object
that is, or is derived from, a L<Data::Object::Yaml> object. The
C<assert_YamlObj> function can be used to throw an exception if the argument
can not be validated. The C<is_YamlObj> function can be used to return true or
false if the argument can not be validated.
...
The YamlObject type constraint is provided by this library and accepts any
object that is, or is derived from, a L<Data::Object::Yaml> object. The
C<assert_YamlObject> function can be used to throw an exception if the argument
can not be validated. The C<is_YamlObject> function can be used to return true
or false if the argument can not be validated.
