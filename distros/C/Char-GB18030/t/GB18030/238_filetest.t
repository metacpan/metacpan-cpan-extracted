...
# 堦斒揑側僼傽僀儖柤偲 chr(0x5C) 偱廔傢傞僼傽僀儖柤偺僼傽僀儖僥僗僩偺寢壥偑堦抳偡傞偙偲偺妋擣
...
if (((-r 'file') ne '') == ((-r 'F婡擻') ne '')) {
    print "ok - 1 -r 'file' == -r 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 1 -r 'file' == -r 'F婡擻' $^X $__FILE__\n";
}
...
if (((-w 'file') ne '') == ((-w 'F婡擻') ne '')) {
    print "ok - 3 -w 'file' == -w 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 3 -w 'file' == -w 'F婡擻' $^X $__FILE__\n";
}
...
if (((-x 'file') ne '') == ((-x 'F婡擻') ne '')) {
    print "ok - 5 -x 'file' == -x 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 5 -x 'file' == -x 'F婡擻' $^X $__FILE__\n";
}
...
if (((-o 'file') ne '') == ((-o 'F婡擻') ne '')) {
    print "ok - 7 -o 'file' == -o 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 7 -o 'file' == -o 'F婡擻' $^X $__FILE__\n";
}
...
if (((-R 'file') ne '') == ((-R 'F婡擻') ne '')) {
    print "ok - 9 -R 'file' == -R 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 9 -R 'file' == -R 'F婡擻' $^X $__FILE__\n";
}
...
if (((-W 'file') ne '') == ((-W 'F婡擻') ne '')) {
    print "ok - 11 -W 'file' == -W 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 11 -W 'file' == -W 'F婡擻' $^X $__FILE__\n";
}
...
if (((-X 'file') ne '') == ((-X 'F婡擻') ne '')) {
    print "ok - 13 -X 'file' == -X 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 13 -X 'file' == -X 'F婡擻' $^X $__FILE__\n";
}
...
if (((-O 'file') ne '') == ((-O 'F婡擻') ne '')) {
    print "ok - 15 -O 'file' == -O 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 15 -O 'file' == -O 'F婡擻' $^X $__FILE__\n";
}
...
if (((-e 'file') ne '') == ((-e 'F婡擻') ne '')) {
    print "ok - 17 -e 'file' == -e 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 17 -e 'file' == -e 'F婡擻' $^X $__FILE__\n";
}
...
if (((-z 'file') ne '') == ((-z 'F婡擻') ne '')) {
    print "ok - 19 -z 'file' == -z 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 19 -z 'file' == -z 'F婡擻' $^X $__FILE__\n";
}
...
if (((-s 'file') ne '') == ((-s 'F婡擻') ne '')) {
    print "ok - 21 -s 'file' == -s 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 21 -s 'file' == -s 'F婡擻' $^X $__FILE__\n";
}
...
if (((-f 'file') ne '') == ((-f 'F婡擻') ne '')) {
    print "ok - 23 -f 'file' == -f 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 23 -f 'file' == -f 'F婡擻' $^X $__FILE__\n";
}
...
if (((-d 'file') ne '') == ((-d 'F婡擻') ne '')) {
    print "ok - 25 -d 'file' == -d 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 25 -d 'file' == -d 'F婡擻' $^X $__FILE__\n";
}
...
if (((-p 'file') ne '') == ((-p 'F婡擻') ne '')) {
    print "ok - 27 -p 'file' == -p 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 27 -p 'file' == -p 'F婡擻' $^X $__FILE__\n";
}
...
if (((-S 'file') ne '') == ((-S 'F婡擻') ne '')) {
    print "ok - 29 -S 'file' == -S 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 29 -S 'file' == -S 'F婡擻' $^X $__FILE__\n";
}
...
if (((-b 'file') ne '') == ((-b 'F婡擻') ne '')) {
    print "ok - 31 -b 'file' == -b 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 31 -b 'file' == -b 'F婡擻' $^X $__FILE__\n";
}
...
if (((-c 'file') ne '') == ((-c 'F婡擻') ne '')) {
    print "ok - 33 -c 'file' == -c 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 33 -c 'file' == -c 'F婡擻' $^X $__FILE__\n";
}
...
if (((-u 'file') ne '') == ((-u 'F婡擻') ne '')) {
    print "ok - 36 -u 'file' == -u 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 36 -u 'file' == -u 'F婡擻' $^X $__FILE__\n";
}
...
if (((-g 'file') ne '') == ((-g 'F婡擻') ne '')) {
    print "ok - 38 -g 'file' == -g 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 38 -g 'file' == -g 'F婡擻' $^X $__FILE__\n";
}
...
if (((-k 'file') ne '') == ((-k 'F婡擻') ne '')) {
    print "ok - 40 -k 'file' == -k 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 40 -k 'file' == -k 'F婡擻' $^X $__FILE__\n";
}
...
if (((-T 'file') ne '') == ((-T 'F婡擻') ne '')) {
    print "ok - 42 -T 'file' == -T 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 42 -T 'file' == -T 'F婡擻' $^X $__FILE__\n";
}
...
if (((-B 'file') ne '') == ((-B 'F婡擻') ne '')) {
    print "ok - 44 -B 'file' == -B 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 44 -B 'file' == -B 'F婡擻' $^X $__FILE__\n";
}
...
if (((-M 'file') ne '') == ((-M 'F婡擻') ne '')) {
    print "ok - 46 -M 'file' == -M 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 46 -M 'file' == -M 'F婡擻' $^X $__FILE__\n";
}
...
if (((-A 'file') ne '') == ((-A 'F婡擻') ne '')) {
    print "ok - 48 -A 'file' == -A 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 48 -A 'file' == -A 'F婡擻' $^X $__FILE__\n";
}
...
if (((-C 'file') ne '') == ((-C 'F婡擻') ne '')) {
    print "ok - 50 -C 'file' == -C 'F婡擻' $^X $__FILE__\n";
}
else {
    print "not ok - 50 -C 'file' == -C 'F婡擻' $^X $__FILE__\n";
}
