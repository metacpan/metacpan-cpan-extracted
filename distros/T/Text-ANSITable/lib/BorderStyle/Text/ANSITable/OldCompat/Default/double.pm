...
1;
# ABSTRACT: UTF8::DoubleLine border style (with old name)
...
BorderStyle::Text::ANSITable::OldCompat::Default::double - UTF8::DoubleLine border style (with old name)

=head1 VERSION

This document describes version 0.607 of BorderStyle::Text::ANSITable::OldCompat::Default::double (from Perl distribution Text-ANSITable), released on 2021-08-27.
