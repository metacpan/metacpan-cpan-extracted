# distribution XML-Compile-Licensed

  * My extended documentation: <http://perl.overmeer.net/CPAN/>
  * Development via GitHub: <https://github.com/markov2/perl5-XML-Compile-Licensed>
  * Download from CPAN: <ftp://ftp.cpan.org/pub/CPAN/authors/id/M/MA/MARKOV/>
  * Indexed from CPAN: <http://search.cpan.org/~markov/XML-Compile-Licensed/>
    and <https://metacpan.org/release/XML-Compile-Licensed>

The XML-Compile suite is a large set of modules for various XML related
standards.  There are hundreds of XML standards, which are usually
free of distribution, but modification is not allowed.  Therefore,
some distributions (like Debian) does not want these files in their
'free' repository.
