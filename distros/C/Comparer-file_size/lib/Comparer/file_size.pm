...
our $DIST = 'Comparer-file_size'; # DIST
...
Comparer::file_size - Compare file's size

=head1 VERSION

This document describes version 0.001 of Comparer::file_size (from Perl distribution Comparer-file_size), released on 2024-11-10.

=head1 SYNOPSIS

 use Comparer::file_size;
...
Source repository is at L<https://github.com/perlancar/perl-Comparer-file_size>.
...
Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=Comparer-file_size>
