package Chart::Plotly::Trace::Funnel::Connector;
use Moose;
...
use Chart::Plotly::Trace::Funnel::Connector::Line;
...
has fillcolor => ( is            => "rw",
                   isa           => "Str",
                   documentation => "Sets the fill color.",
);

has line => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Funnel::Connector::Line", );

has visible => ( is            => "rw",
                 isa           => "Bool",
                 documentation => "Determines if connector regions and lines are drawn.",
);
...
Chart::Plotly::Trace::Funnel::Connector - This attribute is one of the possible options for the trace funnel.
