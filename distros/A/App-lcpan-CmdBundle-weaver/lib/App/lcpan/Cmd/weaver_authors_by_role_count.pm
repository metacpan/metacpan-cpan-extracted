...
1;
# ABSTRACT: List authors ranked by number of Pod::Weaver roles
...
App::lcpan::Cmd::weaver_authors_by_role_count - List authors ranked by number of Pod::Weaver roles

=head1 VERSION

This document describes version 0.030 of App::lcpan::Cmd::weaver_authors_by_role_count (from Perl distribution App-lcpan-CmdBundle-weaver), released on 2019-11-20.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<weaver-authors-by-role-count>.
...
List authors ranked by number of Pod::Weaver roles.
