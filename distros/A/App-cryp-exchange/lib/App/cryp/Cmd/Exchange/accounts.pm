...
1;
# ABSTRACT: List exchange accounts
...
App::cryp::Cmd::Exchange::accounts - List exchange accounts

=head1 VERSION

This document describes version 0.011 of App::cryp::Cmd::Exchange::accounts (from Perl distribution App-cryp-exchange), released on 2018-11-29.
