...
Pangloss::Segment::Decline::CantProofreadTerm - decline unless there's a user
that can add concpets in the session

=head1 SYNOPSIS

  $pipe->add_segment( Pangloss::Segment::CantProofreadTerm->new )

=cut

package Pangloss::Segment::Decline::CantProofreadTerm;
