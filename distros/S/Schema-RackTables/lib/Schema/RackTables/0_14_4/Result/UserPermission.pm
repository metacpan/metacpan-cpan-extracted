use utf8;
package Schema::RackTables::0_14_4::Result::UserPermission;
...
Schema::RackTables::0_14_4::Result::UserPermission
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:m3GULAJjyj+foLXHz/GOew
