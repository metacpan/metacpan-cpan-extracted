package ODO::RDFS::Properties::member;
...
sub new {
	...
	$self->propertyContainerName( 'ODO::RDFS::Properties::member::PropertiesContainer' );
	$self->properties(bless {}, 'ODO::RDFS::Properties::member::PropertiesContainer');
