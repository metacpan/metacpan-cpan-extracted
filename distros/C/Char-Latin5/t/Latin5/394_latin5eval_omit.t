...
# Latin5::eval (omit) has Latin5::eval "..."
$_ = <<'END';
...
# Latin5::eval (omit) has Latin5::eval qq{...}
$_ = <<'END';
...
# Latin5::eval (omit) has Latin5::eval q{...}
$_ = <<'END';
...
# Latin5::eval (omit) has Latin5::eval $var
$_ = <<'END';
Latin5::eval $var2
END
...
# Latin5::eval (omit) has Latin5::eval (omit)
$_ = <<'END';
