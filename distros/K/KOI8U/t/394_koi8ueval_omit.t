...
# KOI8U::eval (omit) has KOI8U::eval "..."
$_ = <<'END';
...
# KOI8U::eval (omit) has KOI8U::eval qq{...}
$_ = <<'END';
...
# KOI8U::eval (omit) has KOI8U::eval q{...}
$_ = <<'END';
...
# KOI8U::eval (omit) has KOI8U::eval $var
$_ = <<'END';
KOI8U::eval $var2
END
...
# KOI8U::eval (omit) has KOI8U::eval (omit)
$_ = <<'END';
