...
SemanticWeb::Schema::MerchantReturnPolicy - A MerchantReturnPolicy provides information about product return policies associated with an Organization or Product .
...
=for html <p>A MerchantReturnPolicy provides information about product return
