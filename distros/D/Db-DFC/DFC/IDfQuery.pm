...
# 
# IDfQuery (com.documentum.fc.client.IDfQuery)
# ------------------------------------------------------------------ #
...
use constant READ_QUERY => 0;
use constant DF_QUERY => 1;
use constant QUERY => 1;
use constant DF_CACHE_QUERY => 2;
use constant CACHE_QUERY => 2;
use constant DF_EXEC_QUERY => 3;
use constant EXEC_QUERY => 3;
use constant DF_EXECREAD_QUERY => 4;
use constant EXECREAD_QUERY => 4;
use constant DF_APPLY => 5;
use constant APPLY => 5;
use constant DF_GETEVENTS => 1000;
use constant DF_GETLASTCOLL => 1001;
use constant DF_GETCONTENT => 1002;
