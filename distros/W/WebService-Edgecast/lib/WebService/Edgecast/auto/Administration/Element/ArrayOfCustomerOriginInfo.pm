...
package WebService::Edgecast::auto::Administration::Element::ArrayOfCustomerOriginInfo;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::ArrayOfCustomerOriginInfo::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('ArrayOfCustomerOriginInfo');
...
WebService::Edgecast::auto::Administration::Element::ArrayOfCustomerOriginInfo
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::ArrayOfCustomerOriginInfo->new($data);
