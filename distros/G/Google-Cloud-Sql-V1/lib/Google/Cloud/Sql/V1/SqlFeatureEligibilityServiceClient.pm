package Google::Cloud::Sql::V1::SqlFeatureEligibilityServiceClient;
...
Google::Cloud::Sql::V1::SqlFeatureEligibilityServiceClient - Auto-generated Protocol Buffers schema container
