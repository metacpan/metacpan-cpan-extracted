use utf8;
package Schema::RackTables::0_19_5::Result::Config;
...
Schema::RackTables::0_19_5::Result::Config
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ycGEgTeHyMNq780mbgjwLQ
