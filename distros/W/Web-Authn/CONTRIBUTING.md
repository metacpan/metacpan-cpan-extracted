...
I welcome any contribution to Web::Authn, including, but not limited to bug reports, feature requests, general comments, and patches.

Feel free to clone it from its gitlab repository at <https://gitlab.com/deguest/Web-Authn> and issue a pull request.
...
File [an issue on bug tracker](https://gitlab.com/deguest/Web-Authn/issues) if you think you've found a bug. Please describe
...
Issues are currently reported using CPAN [bug tracker](https://gitlab.com/deguest/Web-Authn/issues)

## More information

Please refer to the [README](https://metacpan.org/source/JDEGUEST/Web-Authn-v0.2.1/README.md)
