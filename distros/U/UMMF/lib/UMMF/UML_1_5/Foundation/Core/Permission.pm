...
package UMMF::UML_1_5::Foundation::Core::Permission;
...
=head2 C<__validate_type>
  ...
  UMMF::UML_1_5::Foundation::Core::Permission->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::Foundation::Core::Permission|UMMF::UML_1_5::Foundation::Core::Permission>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::Foundation::Core::Permission')  ;
}


=head2 C<__typecheck>

  UMMF::UML_1_5::Foundation::Core::Permission->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::Foundation::Core::Permission->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::Foundation::Core::Permission' . ": value '$x'")
    unless __validate_type($self, $x);
}


=head2 C<isaPermission>


Returns true if receiver is a L<UMMF::UML_1_5::Foundation::Core::Permission|UMMF::UML_1_5::Foundation::Core::Permission>.
...
=head2 C<isaFoundation__Core__Permission>


Returns true if receiver is a L<UMMF::UML_1_5::Foundation::Core::Permission|UMMF::UML_1_5::Foundation::Core::Permission>.
Other receivers will return false.
This is the fully qualified version of the C<isaPermission> method.

=cut
sub isaFoundation__Core__Permission { 1 }
...
Returns the UML Model name (C<'Foundation::Core::Permission'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Foundation::Core::Permission' }
...
sub __tangram_schema
{
  ...
  $__tangram_schema ||=
  {
   ...
   [
     'UMMF::UML_1_5::Foundation::Core::Permission' =>
     {
       'table' => 'Foundation__Core__Permission',
       'abstract' => 0,
       'slots' => 
       { 
	 # Attributes
...
sub __initialize
{
  ...
  $self->UMMF::UML_1_5::Foundation::Core::Permission::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::Foundation::Core::Permission::___create(@args);
