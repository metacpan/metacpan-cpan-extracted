...
#pod
#pod This is C<Hook::InstallTool> plugin implementation. Nothing interesting, just using few roles.
#pod
...
#pod = L<Dist::Zilla>
#pod = L<Dist::Zilla::Role::InstallTool>
#pod
#pod =cut

package Dist::Zilla::Plugin::Hook::InstallTool;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::InstallTool> plugin implementation
our $VERSION = 'v0.8.4'; # VERSION

with 'Dist::Zilla::Role::Plugin';
with 'Dist::Zilla::Role::Hooker' => {
    -alias => { hook => 'setup_installer' },
};
...
Dist::Zilla::Plugin::Hook::InstallTool - C<Hook::InstallTool> plugin implementation
...
This is C<Hook::InstallTool> plugin implementation. Nothing interesting, just using few roles.
