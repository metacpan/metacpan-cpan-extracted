...
Acme::Parataxis follows semver. Only the most recent release line is actively patched for security vulnerabilities.
...
To report a vulnerability, open a private advisory via the repository's [Security Advisories](https://github.com/sanko/Acme-Parataxis.pm/security/advisories/new) page.
...
Thank you for helping keep Acme::Parataxis and its users safe.
