...
my %zip = (
    ...
    Denmark => "(?k:0(?:800|" . "9(?:00|17|60|99))" .
      ...
      "|6(?:0(?:00|40|5[12]|64|70|9[1-4])|" . "100|"
      . "2(?:00|30|40|61|70|80)|"
    ...
    #
    France => "(?k:0(?:1(?:0(?:0[0-9]|1[0-9]|20|59|6[019]|90)|1(?:0[0-9]|"
      ...
      . "7[01]|90)|3(?:00|10|20)|4(?:00|30)|500|600|700|8(?:00|" . "40))|"
      ...
      . "9(?:0[1-9]|10|2[0-39]|30|40|5[0-5]|6[05-9]|7[0-8]|80|" . "90))|"
      ...
      . "40|70|80)|7(?:00|10|40|60)|8(?:00|50|70|80)|9(?:60|" . "90))|"
      ...
      . "40|50|60|70|90)|4(?:0[0-3]|10|40)|500|600|7(?:00|10)|" . "800)|"
      ...
      . "1[1-3569]|2[0-8]|3[0-4]|4[0-9]|5[0-46-9]|7[0-8]))|" . "8799)" . ")",
    ...
    Germany =>
      ...
      . "6[159])|5(?:07|1[0369]|28|46|5[16]|6[59]|7[34]|8[16])|" . "609)|"
      ...
      . "6(?:5[13579]|9[79])|7(?:19|81|99)|8(?:5[3579]|9[79])|" . "929)|"
    ...
    Italy => "(?k:0(?:0(?:0(?:1[0-357-9]|2[0-9]|3[0-9]|4[0-9]|5[0-57-9]|"
      ...
      . "4(?:0(?:1[0-24-8]|7[0-9])|1(?:00|2[1-9]|3[1-9]|4[1-9]|51|" . "70))|"
      ...
      . "8(?:0(?:1[0-2457-9]|2[02-7]|3[1346-8]|4[02-5]|5[13-5])|" . "100)|"
      ...
      . "3(?:01[0-9]|100)|"
      . "4(?:01[0-9]|100)|"
      . "5(?:0(?:1[0-9]|2[0-2457-9]|3[0-9]|4[0-9])|1(?:00|2[1-9]|" . "31))|"
      . "6(?:01[0-9]|100)|"
      . "7(?:01[0-9]|100)|"
    ...
    # (http://bit.ly/1PeTVqY)
    #
    Luxembourg => "(?k:0(?:1(?:01|2[13-5]|3[12]|4[1-3]|61|7[13]|8[1-3]|9[12])|"
    ...
    # Data from: http://download.geonames.org/export/zip/GL.zip
    #
    Norway => "(?k:0(?:0(?:01|1[058]|2[14-68]|3[0-47]|4[05-8]|5[015]|60|80)|"
      ...
      . "7(?:0[09]|1[0-7]|22|3[05]|4[02]|5[01]|6[03-58]|7[0-35]|82|" . "90)|"
    ...
    Switzerland =>
      ...
      . "7[1-4])|"
      . "7(?:0[02-7]|1[13-8]|2[2-5]|5[2-8]|6[2-6]|7[0-35-8]|8[0-5]|" . "92)|"
...
foreach my $country (qw /Netherlands Dutch/) {
    pattern
      name   => [ 'zip', $country => qw /-prefix= -country=/, "-sep= " ],
      create => sub {
        my $pt = _t $_ [1]{-prefix};
        ...
        my $num = '[1-9][0-9]{3}';
        my $let = '[A-EGHJ-NPRTVWXZ][A-EGHJ-NPRSTVWXZ]|' . 'S[BCEGHJ-NPRTVWXZ]';
...
pattern
  name   => [qw /zip US -prefix= -country= -extended= -sep=-/],
  create => sub {
    my $pt = _t $_ [1]{-prefix};
...
#
pattern
  name   => [ 'zip', 'Australia' => qw /-prefix= -country= -lax=/ ],
  create => sub {
    my $pt  = _t $_ [1]{-prefix};
