...
#pod
#pod This is C<Hook::BeforeRelease> plugin implementation. Nothing interesting, just using few roles.
#pod
...
#pod = L<Dist::Zilla>
#pod = L<Dist::Zilla::Role::BeforeRelease>
#pod
#pod =cut

package Dist::Zilla::Plugin::Hook::BeforeRelease;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::BeforeRelease> plugin implementation
our $VERSION = 'v0.8.3'; # VERSION

with 'Dist::Zilla::Role::Plugin';
with 'Dist::Zilla::Role::Hooker' => {
    -alias => { hook => 'before_release' },
};
...
Dist::Zilla::Plugin::Hook::BeforeRelease - C<Hook::BeforeRelease> plugin implementation
...
This is C<Hook::BeforeRelease> plugin implementation. Nothing interesting, just using few roles.
