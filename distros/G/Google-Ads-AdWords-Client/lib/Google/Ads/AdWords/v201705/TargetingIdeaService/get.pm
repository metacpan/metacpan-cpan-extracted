...
package Google::Ads::AdWords::v201705::TargetingIdeaService::get;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201705::TargetingIdeaSelector',
    },
    {
...
get from the namespace https://adwords.google.com/api/adwords/o/v201705.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::TargetingIdeaService::get->new($data);

Constructor. The following data structure may be passed to new():

 {
   selector =>  $a_reference_to, # see Google::Ads::AdWords::v201705::TargetingIdeaSelector
 },
