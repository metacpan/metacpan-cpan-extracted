...
Prty::JQuery::Tabs - Erzeuge HTML einer jQuery UI Tabs Reiterleiste
...
sub html {
    ...
    for my $h (@$tabA) {
        Prty::Hash->validate($h,[qw/content label link/]);
    }
