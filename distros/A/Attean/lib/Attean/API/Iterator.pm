...
This document describes Attean::API::Iterator version 0.039
...
package Attean::API::Iterator 0.039 {
...
package Attean::API::StringyItemIterator 0.039 {
	use Moo::Role;
	sub uniq {
		my $self	= shift;
...
package Attean::API::RepeatableIterator 0.039 {
	use Moo::Role;
	requires 'reset';
...
package Attean::API::ResultOrTermIterator 0.039 {
	use Moo::Role;
...
package Attean::API::StatementIterator 0.039 {
	use Moo::Role;
	use Scalar::Util qw(blessed);
	with 'Attean::API::StringyItemIterator';
	requires 'variables';
...
package Attean::API::TripleIterator 0.039 {
	use Moo::Role;
...
package Attean::API::QuadIterator 0.039 {
	use Moo::Role;
	with 'Attean::API::CanonicalizingBindingIterator';
	with 'Attean::API::StatementIterator';
...
package Attean::API::MixedStatementIterator 0.039 {
	use Moo::Role;
	with 'Attean::API::CanonicalizingBindingIterator';
	with 'Attean::API::StringyItemIterator';
	sub as_quads {
...
package Attean::API::MixedPatternIterator 0.039 {
	use Moo::Role;
	with 'Attean::API::CanonicalizingBindingIterator';
	with 'Attean::API::StringyItemIterator';
	sub as_quads {
...
package Attean::API::ResultIterator 0.039 {
...
package Attean::API::TermIterator 0.039 {
	use Moo::Role;
	sub canonicalize {
		my $self	= shift;
		my $mapper	= Attean::TermMap->canonicalization_map;
