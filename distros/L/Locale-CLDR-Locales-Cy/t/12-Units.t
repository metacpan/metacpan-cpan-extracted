...
is($locale->unit(2, 'arc-minute', 'narrow'), '2 archfun', 'Welsh narrow 2 minutes');
...
is($locale->unit(1, 'celsius', 'narrow'), '1°C', 'Welsh narrow 1 degree Celsius');
is($locale->unit(2, 'celsius', 'narrow'), '2°C', 'Welsh narrow 2 degrees Celsius');
...
is($locale->unit(2, 'celsius'), '2°C', 'Welsh long 2 degrees Celsius');
...
is($locale->unit(2, 'centimeter'), '2 cm', 'Welsh long 2 centimetres');
...
is($locale->unit(2, 'cubic-kilometer'), '2 km³', 'Welsh long 2 cubic kilometres');
...
is($locale->unit(2, 'cubic-mile'), '2 mi³', 'Welsh long 2 cubic miles');
...
is($locale->unit(2, 'degree', 'narrow'), '2 radd', 'Welsh narrow 2 degrees');
...
is($locale->unit(2, 'fahrenheit'), '2°F', 'Welsh long 2 degrees Fahrenheit');
...
is($locale->unit(2, 'g-force'), '2 G', 'Welsh long 2 g-force');
...
is($locale->unit(2, 'gram'), '2 g', 'Welsh long 2 grams');
...
is($locale->unit(2, 'hectare'), '2 ha', 'Welsh long 2 hectares');
...
is($locale->unit(2, 'hectopascal'), '2 hPa', 'Welsh long 2 hectopascals');
...
is($locale->unit(2, 'horsepower'), '2 hp', 'Welsh long 2 horsepower');
...
is($locale->unit(1, 'inch-ofhg', 'narrow'), '1" Hg', 'Welsh narrow 1 inch of mercury');
is($locale->unit(2, 'inch-ofhg', 'narrow'), '2" Hg', 'Welsh narrow 2 inches of mercury');
is($locale->unit(1, 'inch-ofhg', 'short'), '1 inHg', 'Welsh short 1 inch of mercury');
is($locale->unit(2, 'inch-ofhg', 'short'), '2 inHg', 'Welsh short 2 inches of mercury');
is($locale->unit(1, 'inch-ofhg'), '1 fodfedd o fercwri', 'Welsh long 1 inch of mercury');
is($locale->unit(2, 'inch-ofhg'), '2 inHg', 'Welsh long 2 inches of mercury');
is($locale->unit(1, 'kilogram', 'narrow'), '1 kg', 'Welsh narrow 1 kilogram');
is($locale->unit(2, 'kilogram', 'narrow'), '2 kg', 'Welsh narrow 2 kilograms');
...
is($locale->unit(2, 'kilogram'), '2 kg', 'Welsh long 2 kilograms');
...
is($locale->unit(2, 'kilometer'), '2 km', 'Welsh long 2 kilometres');
...
is($locale->unit(2, 'kilowatt'), '2 kW', 'Welsh long 2 kilowatts');
...
is($locale->unit(2, 'meter'), '2 m', 'Welsh long 2 meters');
...
is($locale->unit(2, 'picometer'), '2 pm', 'Welsh long 2 picometres');
...
is($locale->unit(1, 'square-kilometer'), '1 km²', 'Welsh long 1 square kilometre');
is($locale->unit(2, 'square-kilometer'), '2 km²', 'Welsh long 2 square kilometres');
...
is($locale->unit(2, 'square-meter'), '2 m²', 'Welsh long 2 square metres');
...
is($locale->unit(2, 'week', 'narrow'), '2 ws', 'Welsh narrow 2 weeks');
is($locale->unit(1, 'week', 'short'), '1 ws', 'Welsh short 1 week');
is($locale->unit(2, 'week', 'short'), '2 ws', 'Welsh short 2 weeks');
