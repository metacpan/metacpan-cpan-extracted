...
package Meta::Baseline::Lang::Nrfx;
...
Meta::Baseline::Lang::Nrfx - language for Nroff files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Nrfx::env();

=head1 DESCRIPTION

This package contains stuff specific to Nroff in the baseline:
Its mainly here to authorize entries of Nroff files to the baseline.
