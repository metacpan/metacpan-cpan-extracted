...
IO::K8s::ExternalSecrets::V1::ClusterSecretStore - ClusterSecretStore represents a secure external location for storing secrets, which can be referenced as part of `storeRef` fields.
