...
This document describes version 0.005 of Sah::Schema::perl::wordlist::modnames (from Perl distribution Sah-Schemas-WordList), released on 2023-01-19.
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::wordlist::modnames", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("perl::wordlist::modnames", {return_type=>'str_errmsg+val'});
...
To create a type constraint and type library from a schema:
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('$sch_name*', name=>'PerlWordlistModnames')
     );
 }

 use My::Types qw(PerlWordlistModnames);
 PerlWordlistModnames->assert_valid($data);
