...
use Contact::Model::GEN::tshirt;

our $TSHIRT = 'Contact::Model::tshirt';

our @EXPORT_OK = ( '$TSHIRT' );

1;

=head1 NAME

Contact::Model::tshirt - model for tshirt table (stub part)
...
=head1 METHODS (mixed in from Contact::Model::GEN::tshirt)
