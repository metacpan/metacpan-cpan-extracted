...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/File-Find-Closures> or 
L<MetaCPAN|http://www.metacpan.org/module/File::Find::Closures>:

=over 4

=item *	L<http://search.cpan.org/dist/File-Find-Closures>

=item *	L<http://www.metacpan.org/module/File::Find::Closures>
