...
package WebService::Edgecast::auto::Administration::Element::CustomerHttpGet;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerHttpGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerHttpGet');
...
WebService::Edgecast::auto::Administration::Element::CustomerHttpGet
...
CustomerHttpGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerHttpGet->new($data);
