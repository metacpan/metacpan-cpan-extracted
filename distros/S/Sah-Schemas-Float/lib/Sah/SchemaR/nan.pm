...
our $rschema = ["float",[{examples=>[{valid=>0,value=>0},{valid=>0,value=>1},{valid=>0,value=>"Inf"},{valid=>0,value=>"-Inf"},{valid=>1,value=>"NaN"}],is_nan=>1,summary=>"NaN"}],["float"]];
...
This document describes version 0.011 of Sah::SchemaR::nan (from Perl distribution Sah-Schemas-Float), released on 2020-06-04.
