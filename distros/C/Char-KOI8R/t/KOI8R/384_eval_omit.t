...
# eval (omit) has eval "..."
$_ = <<'END';
eval KOI8R::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } "
END
if (eval KOI8R::escape) {
...
$_ = <<'END';
eval KOI8R::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
if (eval KOI8R::escape) {
...
# eval (omit) has eval '...'
$_ = <<'END';
eval KOI8R::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } '
END
if (eval KOI8R::escape) {
...
$_ = <<'END';
eval KOI8R::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
if (eval KOI8R::escape) {
