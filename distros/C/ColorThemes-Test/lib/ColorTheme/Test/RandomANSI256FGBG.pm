...
1;
# ABSTRACT: A color theme which gives random 256-color background ANSI codes
...
ColorTheme::Test::RandomANSI256FGBG - A color theme which gives random 256-color background ANSI codes

=head1 VERSION

This document describes version 0.007 of ColorTheme::Test::RandomANSI256FGBG (from Perl distribution ColorThemes-Test), released on 2021-08-01.
