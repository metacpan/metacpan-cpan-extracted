...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TargetGrpcProxy Google::Cloud::Compute::V1::Compute::TargetGrpcProxyList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::TargetGrpcProxiesClient->new( credentials => 'dummy' );
