use utf8;
package Schema::RackTables::0_20_7::Result::CachedPNV;
...
Schema::RackTables::0_20_7::Result::CachedPNV
...
Related object: L<Schema::RackTables::0_20_7::Result::CachedPAV>

=cut

__PACKAGE__->belongs_to(
  "cached_pav",
  "Schema::RackTables::0_20_7::Result::CachedPAV",
  {
    object_id => "object_id",
    port_name => "port_name",
    vlan_id   => "vlan_id",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:RX3a1WwDRftuQQeTKYObCA
