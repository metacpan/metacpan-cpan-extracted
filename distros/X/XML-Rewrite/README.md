# distribution XML-Rewrite

  * My extended documentation: <http://perl.overmeer.net/CPAN/>
  * Development via GitHub: <https://github.com/markov2/perl5-XML-Rewrite>
  * Download from CPAN: <ftp://ftp.cpan.org/pub/CPAN/authors/id/M/MA/MARKOV/>
  * Indexed from CPAN: <http://search.cpan.org/~markov/XML-Rewrite/>
    and <https://metacpan.org/release/XML-Rewrite>
...
XML::LibXML::Simple).  With this module, you can use XML-Compile to cleanly
strip your XML.
