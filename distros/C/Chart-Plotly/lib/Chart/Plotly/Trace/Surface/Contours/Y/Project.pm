package Chart::Plotly::Trace::Surface::Contours::Y::Project;
use Moose;
...
Chart::Plotly::Trace::Surface::Contours::Y::Project - This attribute is one of the possible options for the trace surface.
