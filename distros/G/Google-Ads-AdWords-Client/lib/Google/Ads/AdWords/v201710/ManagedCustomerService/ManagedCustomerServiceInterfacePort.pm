package Google::Ads::AdWords::v201710::ManagedCustomerService::ManagedCustomerServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201710::TypeMaps::ManagedCustomerService
    if not Google::Ads::AdWords::v201710::TypeMaps::ManagedCustomerService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/mcm/v201710/ManagedCustomerService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201710::TypeMaps::ManagedCustomerService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201710::ManagedCustomerService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201710::ManagedCustomerService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201710::ManagedCustomerService::getPendingInvitations )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201710::ManagedCustomerService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201710::ManagedCustomerService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201710::ManagedCustomerService::mutateLink )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201710::ManagedCustomerService::mutateManager )],
        },
        header => {
...
Google::Ads::AdWords::v201710::ManagedCustomerService::ManagedCustomerServiceInterfacePort - SOAP Interface for the ManagedCustomerService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201710::ManagedCustomerService::ManagedCustomerServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201710::ManagedCustomerService::ManagedCustomerServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/mcm/v201710/ManagedCustomerService.
...
Returns a L<Google::Ads::AdWords::v201710::ManagedCustomerService::getResponse|Google::Ads::AdWords::v201710::ManagedCustomerService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201710::ManagedCustomerService::getPendingInvitationsResponse|Google::Ads::AdWords::v201710::ManagedCustomerService::getPendingInvitationsResponse> object.

 $response = $interface->getPendingInvitations( {
    selector =>  $a_reference_to, # see Google::Ads::AdWords::v201710::PendingInvitationSelector
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201710::ManagedCustomerService::mutateResponse|Google::Ads::AdWords::v201710::ManagedCustomerService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201710::ManagedCustomerService::mutateLabelResponse|Google::Ads::AdWords::v201710::ManagedCustomerService::mutateLabelResponse> object.

 $response = $interface->mutateLabel( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201710::ManagedCustomerLabelOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201710::ManagedCustomerService::mutateLinkResponse|Google::Ads::AdWords::v201710::ManagedCustomerService::mutateLinkResponse> object.
...
Returns a L<Google::Ads::AdWords::v201710::ManagedCustomerService::mutateManagerResponse|Google::Ads::AdWords::v201710::ManagedCustomerService::mutateManagerResponse> object.
...
Generated by SOAP::WSDL on Mon Oct  9 18:30:54 2017
