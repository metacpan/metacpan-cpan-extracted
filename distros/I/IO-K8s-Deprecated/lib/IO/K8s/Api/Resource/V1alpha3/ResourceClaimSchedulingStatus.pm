...
die __PACKAGE__ . " has been removed. It described one ResourceClaim's"
  . " WaitForFirstConsumer scheduling status within a"
  . " IO::K8s::Api::Resource::V1alpha3::PodSchedulingContextStatus, part of"
...
IO::K8s::Api::Resource::V1alpha3::ResourceClaimSchedulingStatus - REMOVED -- classic DRA control-plane-controller allocation retired, see IO::K8s::Deprecated
...
It described one C<ResourceClaim>'s C<WaitForFirstConsumer> scheduling
status nested within a
L<IO::K8s::Api::Resource::V1alpha3::PodSchedulingContextStatus>, part of
...
IO::K8s::Api::Resource::V1alpha3::ResourceClaimSchedulingStatus> -- or a
...
IO::K8s::Api::Resource::V1alpha3::ResourceClaimSchedulingStatus - REMOVED, no direct replacement
