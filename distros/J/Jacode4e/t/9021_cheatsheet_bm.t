...
#   $OUTPUT_encoding  : nama pengekodan output
#   $INPUT_encoding   : nama pengekodan input
...
#   singkatan   maksud
#   ---------   ---------------------------------------------------
#   cp932x      CP932X (lanjutan kepada JIS X 0213, anjakan tunggal 0x9C5A)
#   cp932       Microsoft CP932 (Windows-31J / nama IANA)
#   cp932ibm    IBM CP932
#   cp932nec    NEC CP932
...
#   jef         FUJITSU JEF (12pt, gunakan OUTPUT_SHIFTING untuk kod anjakan)
#   jef9p       FUJITSU JEF ( 9pt, gunakan OUTPUT_SHIFTING untuk kod anjakan)
#   jipsj       NEC JIPS(J)
#   jipse       NEC JIPS(E)
#   letsj       UNISYS LetsJ
#   utf8        UTF-8.0 (UTF-8 biasa)
#   utf8.1      UTF-8.1 (penukaran berdasarkan pemetaan Shift_JIS-Unicode, bukan CP932)
#   utf8jp      UTF-8-SPUA-JP (JIS X 0213 dipetakan ke SPUA Unicode)
#
# [PILIHAN]
#
#   kunci             nilai / penerangan
#   ---------------   ---------------------------------------------------
#   INPUT_LAYOUT      susun atur rekod input ('S'=SBCS, 'D'=DBCS, boleh tambah kiraan ulang)
#   OUTPUT_SHIFTING   jika benar, sisipkan kod anjakan di sekeliling jujukan DBCS dalam output
#   SPACE             kod ruang DBCS/MBCS (rentetan binari)
#   GETA              simbol geta untuk aksara yang tidak dapat dipetakan
#   OVERRIDE_MAPPING  penggantian per aksara { "\x12\x34"=>"\x56\x78" }
#
# [AMARAN: PENUKARAN ULANG-ALIK]
#
#   Terdapat penukaran yang merosakkan data (cth: CP932 mempunyai 398 pemetaan
#   tidak dapat dikembalikan). Untuk penukaran ulang-alik, gunakan modul
#   pilihan 'ROUND_TRIP' => 1. Kedua-dua arah memerlukan
#   'ROUND_TRIP' => 1 dan versi Jacode4e yang sama.
#
# ======================================================================
...
BEGIN {
    ...
    @test = (
        ...
        ["\x81\x40", 'cp00930', 'cp932', {}, "\x40\x40", 'cp932(8140)->cp00930 tanpa anjakan(4040)'],
        ...
        ["\x81\x40\x31", 'keis83', 'cp932', {}, "\xA1\xA1\xF1",
            'cp932(814031)->keis83 tanpa anjakan(A1A1F1)'],
        ...
        ["\x81\x60", 'utf8', 'cp932', {'INPUT_LAYOUT'=>'D'}, "\xE3\x80\x9C",
            'cp932(8160 sempang gelombang)->utf8(E3809C U+301C)'],
