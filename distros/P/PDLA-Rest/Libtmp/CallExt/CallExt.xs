/*
 * We used to say "THIS FILE WAS GENERATED BY PDLA::PP! Do not modify!"
...
static Core* PDLA; /* Structure hold core C functions */
SV* CoreSV;       /* Get's pointer to perl var holding core structure */

/*
 * Call an external C routine loaded dynamically - pass PDLA args list
 *
...
_callext_int(...)
	...
	pdl *t;
        ...
        for(i=0; i<npdl; i++) {
           t = PDLA->SvPDLAV(ST(i+1));
	   PDLA->make_physical(t); 
	   PDLA->make_physdims(t); 
...
BOOT:
   ...
   if (CoreSV==NULL)
     croak("This module requires use of PDLA::Core first");
