...
package Amazon::SQS::Model::GetQueueAttributesResponse;
...
use base qw (Amazon::SQS::Model);
    ...
    #
    # 
    # GetQueueAttributesResult: Amazon::SQS::Model::GetQueueAttributesResult
    ...
    sub fromXML {
        ...
        return new Amazon::SQS::Model::GetQueueAttributesResponse($tree);
          
    }
    
    sub getGetQueueAttributesResult {
        return shift->{_fields}->{GetQueueAttributesResult}->{FieldValue};
    }


    sub setGetQueueAttributesResult {
        my ($self, $value) = @_;
        $self->{_fields}->{GetQueueAttributesResult}->{FieldValue} = $value;
    }


    sub withGetQueueAttributesResult {
        my ($self, $value) = @_;
        $self->setGetQueueAttributesResult($value);
        return $self;
    }


    sub isSetGetQueueAttributesResult {
        return defined (shift->{_fields}->{GetQueueAttributesResult}->{FieldValue});
