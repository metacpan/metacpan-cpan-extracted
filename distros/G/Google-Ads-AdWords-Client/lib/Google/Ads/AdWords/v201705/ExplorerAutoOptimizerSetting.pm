package Google::Ads::AdWords::v201705::ExplorerAutoOptimizerSetting;
use strict;
use warnings;
...
ExplorerAutoOptimizerSetting from the namespace https://adwords.google.com/api/adwords/cm/v201705.
