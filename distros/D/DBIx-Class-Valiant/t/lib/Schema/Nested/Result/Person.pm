...
__PACKAGE__->accept_nested_for('person_roles', +{find_with_uniques=>'allow_create', allow_destroy=>1, delete_omitted=>1});
__PACKAGE__->accept_nested_for('roles', +{find_with_uniques=>'allow_create', allow_destroy=>1, delete_omitted=>1});
