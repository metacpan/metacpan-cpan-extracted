package Chart::Plotly::Trace::Parcoords::Rangefont;
use Moose;
...
has description => ( is      => "ro",
                     default => "Sets the font for the `dimension` range values.", );
...
Chart::Plotly::Trace::Parcoords::Rangefont - This attribute is one of the possible options for the trace parcoords.
