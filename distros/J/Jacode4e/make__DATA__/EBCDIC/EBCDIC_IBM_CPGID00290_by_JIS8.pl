######################################################################
#
# EBCDIC_IBM_CPGID00290_by_JIS8.pl
#
...
my %EBCDIC_IBM_CPGID00290_by_JIS8 = map { sprintf('%02X',$_) => (qw(
...
my %JIS8_by_EBCDIC_IBM_CPGID00290 = map { sprintf('%02X',$_) => (qw(
...
if (scalar(keys %EBCDIC_IBM_CPGID00290_by_JIS8) != 256) {
    die;
}

if (scalar(keys %JIS8_by_EBCDIC_IBM_CPGID00290) != 256) {
    die;
}

for (0..255) {
    my $hex = sprintf('%02X',$_);
    if (not exists $JIS8_by_EBCDIC_IBM_CPGID00290{$hex}) {
        die;
    }
    if (not defined $JIS8_by_EBCDIC_IBM_CPGID00290{$hex}) {
        die;
    }
    if ($EBCDIC_IBM_CPGID00290_by_JIS8{$JIS8_by_EBCDIC_IBM_CPGID00290{$hex}} ne $hex) {
        die "\$hex=($hex) \$JIS8_by_EBCDIC_IBM_CPGID00290{$hex}=($JIS8_by_EBCDIC_IBM_CPGID00290{$hex}) \$EBCDIC_IBM_CPGID00290_by_JIS8{$JIS8_by_EBCDIC_IBM_CPGID00290{$hex}}=($EBCDIC_IBM_CPGID00290_by_JIS8{$JIS8_by_EBCDIC_IBM_CPGID00290{$hex}})";
    }
}

for (0..255) {
    my $hex = sprintf('%02X',$_);
    if (not exists $EBCDIC_IBM_CPGID00290_by_JIS8{$hex}) {
        die;
    }
    if (not defined $EBCDIC_IBM_CPGID00290_by_JIS8{$hex}) {
        die;
    }
    if ($JIS8_by_EBCDIC_IBM_CPGID00290{$EBCDIC_IBM_CPGID00290_by_JIS8{$hex}} ne $hex) {
        die "\$hex=($hex) \$EBCDIC_IBM_CPGID00290_by_JIS8{$hex}=($EBCDIC_IBM_CPGID00290_by_JIS8{$hex}) \$JIS8_by_EBCDIC_IBM_CPGID00290{$EBCDIC_IBM_CPGID00290_by_JIS8{$hex}}=($JIS8_by_EBCDIC_IBM_CPGID00290{$EBCDIC_IBM_CPGID00290_by_JIS8{$hex}})";
    }
}

my %jis2ebcdic_IBM_CPGID00290 = qw(
    9F 4A
    A0 6A
    E0 57
    E1 59
...
for my $jis (sort keys %jis2ebcdic_IBM_CPGID00290) {
    if ($EBCDIC_IBM_CPGID00290_by_JIS8{$jis} ne $jis2ebcdic_IBM_CPGID00290{$jis}) {
        die "jis($jis): ($EBCDIC_IBM_CPGID00290_by_JIS8{$jis}) ne ($jis2ebcdic_IBM_CPGID00290{$jis})";
    }
}

sub EBCDIC_IBM_CPGID00290_by_JIS8 {
    my($byte) = @_;
    return $EBCDIC_IBM_CPGID00290_by_JIS8{$byte};
}

sub keys_of_EBCDIC_IBM_CPGID00290_by_JIS8 {
    return keys %EBCDIC_IBM_CPGID00290_by_JIS8;
}

sub values_of_EBCDIC_IBM_CPGID00290_by_JIS8 {
    return values %EBCDIC_IBM_CPGID00290_by_JIS8;
}
