package Google::Ads::AdWords::v201809::UniversalAppCampaignAdsPolicyDecisions;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'universalAppCampaignAsset' => 'Google::Ads::AdWords::v201809::UniversalAppCampaignAsset',
...
Google::Ads::AdWords::v201809::UniversalAppCampaignAdsPolicyDecisions

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
UniversalAppCampaignAdsPolicyDecisions from the namespace https://adwords.google.com/api/adwords/cm/v201809.
