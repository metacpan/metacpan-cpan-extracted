...
$Tapper::Schema::TestrunDB::Result::TestrunRequestedResourceAlternative::VERSION = '5.0.12';
...
Tapper::Schema::TestrunDB::Result::TestrunRequestedResourceAlternative - Tapper - Relate testruns with resource ( requested )
