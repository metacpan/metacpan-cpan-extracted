...
The code for this distribution is [hosted on GitHub](https://github.com/houseabsolute/File-LibMagic).
...
can submit an issue report [via the web](https://github.com/houseabsolute/File-LibMagic/issues).
