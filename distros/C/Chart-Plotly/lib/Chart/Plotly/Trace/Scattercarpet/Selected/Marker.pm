package Chart::Plotly::Trace::Scattercarpet::Selected::Marker;
use Moose;
...
Chart::Plotly::Trace::Scattercarpet::Selected::Marker - This attribute is one of the possible options for the trace scattercarpet.
