package Bencher::Scenarios::Log::Dispatch;
...
1;
# ABSTRACT: Bencher scenarios related to Log::Dispatch modules
...
Bencher::Scenarios::Log::Dispatch - Bencher scenarios related to Log::Dispatch modules

=head1 VERSION

This document describes version 0.030 of Bencher::Scenarios::Log::Dispatch (from Perl distribution Bencher-Scenarios-Log-Dispatch), released on 2023-10-29.
...
=item * L<Bencher::Scenario::Log::Dispatch::Startup>
