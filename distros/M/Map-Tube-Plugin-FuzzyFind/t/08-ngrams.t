...
is_deeply($ret, [ 'Bakerloo', 'Waterloo & City' ], 'Finding many lines Bagrlo fuzzy with distance 6');
...
is_deeply( a2n($ret), [ 'Baker Street', 'Bond Street', 'Old Street' ], 'Finding many stations Baker Street fuzzy at max distance 4');
