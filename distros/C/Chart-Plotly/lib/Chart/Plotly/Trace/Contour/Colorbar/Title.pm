package Chart::Plotly::Trace::Contour::Colorbar::Title;
use Moose;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Contour::Colorbar::Title::Font", );
...
Chart::Plotly::Trace::Contour::Colorbar::Title - This attribute is one of the possible options for the trace contour.
