...
$Shipment::FedEx::WSDL::ShipElements::ProcessShipmentRequest::VERSION = '3.04';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    __PACKAGE__->__set_name('ProcessShipmentRequest');
    ...
    use base qw(
      ...
      Shipment::FedEx::WSDL::ShipTypes::ProcessShipmentRequest
    );
...
ProcessShipmentRequest from the namespace http://fedex.com/ws/ship/v9.
