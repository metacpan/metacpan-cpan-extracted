package OWL::DirectSemantics::Element::NamedIndividual;

BEGIN {
	$OWL::DirectSemantics::Element::NamedIndividual::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::NamedIndividual::VERSION   = '0.001';
};
...
OWL::DirectSemantics::Element::NamedIndividual - represents an OWL NamedIndividual

=head1 DESCRIPTION

This class represents the NamedIndividual element in OWL Direct Semantics.
