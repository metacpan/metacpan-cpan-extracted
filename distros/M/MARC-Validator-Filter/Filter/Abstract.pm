package MARC::Validator::Filter::Abstract;
...
MARC::Validator::Filter::Abstract - Abstract class for MARC::Validator::Filter plugins.

=head1 SYNOPSIS

 my $obj = MARC::Validator::Filter::Abstract->new;
 my $name = $obj->name;
 my $filter_name = $obj->process($marc_record);

=head1 DESCRIPTION

This is abstract class for L<MARC::Validator::Filter> plugins, which are used in
...
=head2 C<new>
 ...
 my $obj = MARC::Validator::Filter::Abstract->new(%params);
...
=head2 C<process>
 ...
 my $filter_name = $obj->proces($marc_record);
...
=head1 ERRORS
 ...
 new():
         ...
         MARC::Validator::Filter::Abstract is abstract class.
...
=for comment filename=example_plugin.pl
 ...
 package MARC::Validator::Filter::Plugin::Foo;
 ...
 sub process {
	 ...
	 my $field_040 = $marc_record->field('040');
         my $field_040_a = $field_040->subfield('a');
 ...
 my $obj = MARC::Validator::Filter::Plugin::Foo->new;

 my $name = $obj->name;
 print "Name: $name\n";

 my $filter_string = $obj->process($marc_record);
 print "Filter string: ";
