...
(This example is included as L<F<examples/synopsis.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/synopsis.pl> in the distribution.)


=head1 VERSION

This document describes JSON::Create version 0.36,
corresponding to L<git commit c6e87e42a72ce49bbb1fa92712fcbae22df2b592|https://github.com/benkasminbullock/json-create/commit/c6e87e42a72ce49bbb1fa92712fcbae22df2b592> at Tue Apr 7 05:50:22 2026 +0900.
...
(This example is included as L<F<examples/fatal-errors.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/fatal-errors.pl> in the distribution.)
...
(This example is included as L<F<examples/zilog.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/zilog.pl> in the distribution.)
...
(This example is included as L<F<examples/too-many-values.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/too-many-values.pl> in the distribution.)
...
(This example is included as L<F<examples/closure.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/closure.pl> in the distribution.)
...
(This example is included as L<F<examples/exception.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/exception.pl> in the distribution.)
...
(This example is included as L<F<examples/obj-handler.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/obj-handler.pl> in the distribution.)
...
(This example is included as L<F<examples/try-harder.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/try-harder.pl> in the distribution.)
...
(This example is included as L<F<examples/set-fformat.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/set-fformat.pl> in the distribution.)
...
(This example is included as L<F<examples/sort.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/sort.pl> in the distribution.)
...
(This example is included as L<F<examples/type-handler.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/type-handler.pl> in the distribution.)
...
(This example is included as L<F<examples/type-handler-scalar.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/type-handler-scalar.pl> in the distribution.)
...
(This example is included as L<F<examples/escape-all.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/escape-all.pl> in the distribution.)
...
(This example is included as L<F<examples/escape-all-no-utf8.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/escape-all-no-utf8.pl> in the distribution.)
...
(This example is included as L<F<examples/hash.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/hash.pl> in the distribution.)
...
(This example is included as L<F<examples/nested-hash.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/nested-hash.pl> in the distribution.)
...
(This example is included as L<F<examples/array.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/array.pl> in the distribution.)
...
(This example is included as L<F<examples/nested-array.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/nested-array.pl> in the distribution.)
...
(This example is included as L<F<examples/nested.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/nested.pl> in the distribution.)
...
(This example is included as L<F<examples/json-parse-bool.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/json-parse-bool.pl> in the distribution.)
...
(This example is included as L<F<examples/valid-chars.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/valid-chars.pl> in the distribution.)
...
(This example is included as L<F<examples/json-unicode.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/json-unicode.pl> in the distribution.)
...
(This example is included as L<F<examples/json-unicode-gzip-bytes.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/json-unicode-gzip-bytes.pl> in the distribution.)
...
(This example is included as L<F<examples/user-bad-utf8.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.36/examples/user-bad-utf8.pl> in the distribution.)
