...
static int asn_MAP_UnidentifiedSubParam_oms_1[] = { 0 };
...
static asn_TYPE_tag2member_t asn_MAP_UnidentifiedSubParam_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 0 } /* extensionContainer at 230 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UnidentifiedSubParam_specs_1 = {
	...
	asn_MAP_UnidentifiedSubParam_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	0,	/* Start extensions */
	2	/* Stop extensions */
};
