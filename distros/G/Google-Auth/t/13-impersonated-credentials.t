...
BEGIN {
  use_ok('Google::Auth::ImpersonatedServiceAccountCredentials')
    || print "Bail out!\n";
}
...
'https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/first-sa@google.com:generateAccessToken',
  ...
  eval {
    Google::Auth::ImpersonatedServiceAccountCredentials->new(
      ...
      impersonation_url  =>
'https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/second-sa@google.com:generateAccessToken',
      scope => 'https://www.googleapis.com/auth/cloud-platform',
    );
  };
  like(
...
'https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/test-sa@google.com:generateAccessToken';
  ...
  like(
    $@,
    qr/Service account impersonation failed with status 403/,
    'throws detailed error on exchange failure'
  );
};
