...
{
	my $inner = people->join( pets, sub { $_ }, field 'owner', $smush );
...
{
	my $left = people->join( pets, -left, sub { $_ }, field 'owner', $smush );
...
{
	my $right = people->join( pets, -right, sub { $_ }, field 'owner', $smush );
...
{
	my $outer = people->join( pets, -outer, sub { $_ }, field 'owner', $smush );
