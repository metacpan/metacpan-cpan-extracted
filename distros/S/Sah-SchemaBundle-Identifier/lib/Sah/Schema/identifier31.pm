...
1;
# ABSTRACT: Identifier with a maximum length of 31 characters
...
Sah::Schema::identifier31 - Identifier with a maximum length of 31 characters

=head1 VERSION

This document describes version 0.002 of Sah::Schema::identifier31 (from Perl distribution Sah-SchemaBundle-Identifier), released on 2025-11-11.

=head1 SAH SCHEMA DEFINITION

 ["identifier", { max_len => 31 }]
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("identifier31*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("identifier31", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("identifier31", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("identifier31*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"identifier31*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('identifier31*', name=>'Identifier31')
     );
 }

 use My::Types qw(Identifier31);
 Identifier31->assert_valid($data);
