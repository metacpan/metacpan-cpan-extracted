...
use Google::Ads::AdWords::v201607::AdGroupBidModifierOperation;
use Google::Ads::AdWords::v201607::AdGroupBidModifier;
...
sub add_ad_group_bid_modifier {
  ...
  my $modifier = Google::Ads::AdWords::v201607::AdGroupBidModifier->new({
  ...
  my $operation =
    Google::Ads::AdWords::v201607::AdGroupBidModifierOperation->new({
      operator => "ADD",
      operand  => $modifier
    });
