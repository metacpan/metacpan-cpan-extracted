...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::DeleteRegionOperationResponse Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::OperationList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::RegionOperationsClient->new( credentials => 'dummy' );
