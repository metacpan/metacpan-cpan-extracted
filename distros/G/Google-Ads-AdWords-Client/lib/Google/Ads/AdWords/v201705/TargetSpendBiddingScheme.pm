package Google::Ads::AdWords::v201705::TargetSpendBiddingScheme;
use strict;
use warnings;
...
TargetSpendBiddingScheme from the namespace https://adwords.google.com/api/adwords/cm/v201705.
