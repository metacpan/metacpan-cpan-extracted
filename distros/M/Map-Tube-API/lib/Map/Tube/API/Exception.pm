...
$Map::Tube::API::Exception::VERSION   = '0.08';
$Map::Tube::API::Exception::AUTHORITY = 'cpan:MANWAR';

=head1 NAME

Map::Tube::API::Exception - Interface to exception class for Map::Tube::API.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Map::Tube::API::Exception
...
1; # End of Map::Tube::API::Exception
