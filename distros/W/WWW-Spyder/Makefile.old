# This Makefile is for the WWW::Spyder extension to perl.
#
...
#     AUTHOR => q[-2008, Ashley Pond V C<< <ashley@cpan.org> >>. All]
#     DIR => []
...
TO_INST_PM = lib/WWW/Spyder.pm

PM_TO_BLIB = lib/WWW/Spyder.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/WWW/Spyder.pm $(INST_MAN3DIR)/WWW::Spyder.$(MAN3EXT) 
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>-2008, Ashley Pond V C&lt;&lt; &lt;ashley@cpan.org&gt; &gt;&gt;. All</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="HTML-Parser" VERSION="3,0,0,0" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="URI-URL" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/WWW/Spyder.pm blib/lib/WWW/Spyder.pm 
