package Google::Ads::AdWords::v201702::NumberValue;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201702::ComparableValue);
# Variety: sequence
...
NumberValue from the namespace https://adwords.google.com/api/adwords/cm/v201702.
