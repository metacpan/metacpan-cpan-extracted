...
$Test::Reporter::Transport::Socket::VERSION = '0.32';
...
$TRTS::Config::Perl::V::VERSION = '0.32';
use strict;
use warnings;
...
This software is copyright (c) 2015 by David A. Golden, Richard Dawe, Chris Williams and H.Merijn Brand.
