...
This document describes version 0.006 of BorderStyle::BoxChar::None (from Perl distribution BorderStyles-Standard), released on 2021-02-19.
...
To use with L<Text::Table::Span>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"BoxChar::None");
