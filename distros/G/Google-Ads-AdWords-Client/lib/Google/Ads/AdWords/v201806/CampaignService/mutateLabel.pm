...
package Google::Ads::AdWords::v201806::CampaignService::mutateLabel;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201806::CampaignLabelOperation',
    },
    {
...
Google::Ads::AdWords::v201806::CampaignService::mutateLabel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutateLabel from the namespace https://adwords.google.com/api/adwords/cm/v201806.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201806::CampaignService::mutateLabel->new($data);
