...
our %STATS = ("longest_word_len",35,"avg_word_len",15.3075862068966,"shortest_word_len",7,"num_words",1450,"num_words_contains_whitespace",1450,"num_words_contains_nonword_chars",1450,"num_words_contains_unicode",0); # STATS
...
This document describes version 20180116 of WordList::CryptoCurrency::Catalog::NameSymbol (from Perl distribution WordLists-CryptoCurrency-Catalog), released on 2018-01-16.
...
=head1 STATISTICS
 ...
 | key                              | value            |
 +----------------------------------+------------------+
 | avg_word_len                     | 15.3075862068966 |
 | longest_word_len                 | 35               |
 | num_words                        | 1450             |
 | num_words_contains_nonword_chars | 1450             |
 | num_words_contains_unicode       | 0                |
 | num_words_contains_whitespace    | 1450             |
 | shortest_word_len                | 7                |
 +----------------------------------+------------------+
...
Condensate (RAIN)
Confido (CFD)
Content and AD Network (CANETWORK)
Copico (XCPO)
Corethum (CRTM)
CorgiCoin (CORG)
Counterparty (XCP)
