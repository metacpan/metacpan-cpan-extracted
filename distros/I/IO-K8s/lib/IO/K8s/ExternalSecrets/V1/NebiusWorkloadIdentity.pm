...
IO::K8s::ExternalSecrets::V1::NebiusWorkloadIdentity - WorkloadIdentity defines configuration for workload identity authentication to Nebius IAM.

=head1 VERSION

version 1.108

=head2 iamServiceAccountID
