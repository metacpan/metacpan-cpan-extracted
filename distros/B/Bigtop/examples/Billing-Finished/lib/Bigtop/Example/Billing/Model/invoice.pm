...
use Bigtop::Example::Billing::Model::GEN::invoice;

our $INVOICE = 'Bigtop::Example::Billing::Model::invoice';

our @EXPORT_OK = ( '$INVOICE' );

1;

=head1 NAME

Bigtop::Example::Billing::Model::invoice - model for invoice table (stub part)
...
=head1 METHODS (mixed in from Bigtop::Example::Billing::Model::GEN::invoice)
