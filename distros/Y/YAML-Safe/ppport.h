...
----------------------------------------------------------------------
    ...
    ppport.h -- Perl/Pollution/Portability Version 3.53_04
...
av_store|||
av_study|||
av_tindex|5.017009||p
av_top_index|5.017009||p
av_undef|||
av_unshift|||
ax|||n
block_end||5.004000|
...
#ifndef croak_no_modify_sv
#define croak_no_modify_sv(sv) \
    croak_nocontext("%s %s at %s:%d", PL_no_modify, SvPEEK(sv), __FILE__, __LINE__)
#define Perl_croak_no_modify_sv(sv) croak_no_modify_sv(sv, __FILE__, __LINE__)
#endif
...
# define PL_in_pod         D_PPP_my_PL_parser_var(in_pod)
#if defined(USE_CPERL) && (PERL_BCDVERSION >= 0x5027001)
# define PL_in_class       D_PPP_my_PL_parser_var(in_class)
#endif
#if defined(USE_CPERL) && (PERL_BCDVERSION >= 0x5029000)
# define PL_in_sub         D_PPP_my_PL_parser_var(in_sub)
#endif
