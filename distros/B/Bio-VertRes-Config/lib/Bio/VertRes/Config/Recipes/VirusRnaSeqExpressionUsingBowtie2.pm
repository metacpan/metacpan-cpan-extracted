package Bio::VertRes::Config::Recipes::VirusRnaSeqExpressionUsingBowtie2;
...
Bio::VertRes::Config::Recipes::VirusRnaSeqExpressionUsingBowtie2 - Standard snp calling pipeline for virus
...
RNA seq expression with Bowtie2
   ...
   my $obj = Bio::VertRes::Config::Recipes::VirusRnaSeqExpressionUsingBowtie2->new( 
     database => 'abc', 
