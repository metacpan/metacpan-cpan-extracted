...
Sah::Schema::idx::listed_stock_code - Currently listed stock code in the Indonesian Stock Exchange

=head1 VERSION

This document describes version 0.001 of Sah::Schema::idx::listed_stock_code (from Perl distribution Sah-Schemas-Finance-SE-IDX), released on 2021-01-18.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("idx::listed_stock_code*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("idx::listed_stock_code*");
     $validator->(\@args);
     ...
 }
...
Sample data:
 ...
 "KARK"  # INVALID (Not currently listed)
