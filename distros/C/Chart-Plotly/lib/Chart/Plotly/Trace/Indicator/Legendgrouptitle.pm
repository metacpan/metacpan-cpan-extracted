package Chart::Plotly::Trace::Indicator::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Indicator::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Indicator::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Indicator::Legendgrouptitle - This attribute is one of the possible options for the trace indicator.
