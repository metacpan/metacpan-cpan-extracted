 ...
 * contents of parts.xs. Do not edit this file, edit parts.xs instead.
 *
...
extern "C"
#endif
XS_EXTERNAL(boot_t__parts); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_t__parts)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
