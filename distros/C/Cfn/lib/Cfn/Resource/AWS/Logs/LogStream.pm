...
Cfn::Resource::AWS::Logs::LogStream - Cfn resource for AWS::Logs::LogStream

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::Logs::LogStream.
