...
L<Splunk::Base> is a simple base class for L<Splunk> projects with fluent
interfaces.
...
L<Splunk::Base> implements the following functions, which can be imported with
...
L<Splunk::Base> implements the following methods.
...
L<Splunk::HEC>, L<Mojolicious>, L<Mojo::Base>
