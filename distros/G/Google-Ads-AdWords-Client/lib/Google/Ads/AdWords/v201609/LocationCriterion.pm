package Google::Ads::AdWords::v201609::LocationCriterion;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'location' => 'Google::Ads::AdWords::v201609::Location',
...
LocationCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201609.
