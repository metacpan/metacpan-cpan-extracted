...
{
   # NVMCTRL set ADDR
   $mockfio->expect_syswrite( "\x55\x44\x08\x10" );
   $mockfio->expect_sysread( 5 )
      ->returns( "\x55\x44\x08\x10" . "\x40" );
   $mockfio->expect_sleep( 0.1 );
   $mockfio->expect_syswrite( "\x85" );
   $mockfio->expect_sysread( 2 )
      ->returns( "\x85" . "\x40" );
   $mockfio->expect_sleep( 0.1 );
   $mockfio->expect_syswrite( "\x55\x44\x09\x10" );
   $mockfio->expect_sysread( 5 )
      ->returns( "\x55\x44\x09\x10" . "\x40" );
   $mockfio->expect_sleep( 0.1 );
   $mockfio->expect_syswrite( "\x12" );
   $mockfio->expect_sysread( 2 )
      ->returns( "\x12" . "\x40" );
   $mockfio->expect_sleep( 0.1 );
   # NVMCTRL set DATA
   $mockfio->expect_syswrite( "\x55\x44\x06\x10" );
   $mockfio->expect_sysread( 5 )
      ->returns( "\x55\x44\x06\x10" . "\x40" );
   $mockfio->expect_sleep( 0.1 );
   $mockfio->expect_syswrite( "\xC8" );
   $mockfio->expect_sysread( 2 )
      ->returns( "\xC8" . "\x40" );
   $mockfio->expect_sleep( 0.1 );
