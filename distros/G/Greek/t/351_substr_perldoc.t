...
my $color  = Greek::substr $s, 4, 5;   # black
my $middle = Greek::substr $s, 4, -11; # black cat climbed the
my $end    = Greek::substr $s, 14;     # climebed the green tree
my $tail   = Greek::substr $s, -4;     # tree
my $z      = Greek::substr $s, -4, 2;  # tr
