...
Developer::Dashboard::Pax::DeoptEngine - deoptimization policy helper

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::DeoptEngine;

  my $obj = Developer::Dashboard::Pax::DeoptEngine->new(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::DeoptEngine -e 1
