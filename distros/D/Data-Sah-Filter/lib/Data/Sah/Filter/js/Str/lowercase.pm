...
Data::Sah::Filter::js::Str::lowercase - Convert string to lowercase

=head1 VERSION

This document describes version 0.025 of Data::Sah::Filter::js::Str::lowercase (from Perl distribution Data-Sah-Filter), released on 2024-07-17.
...
=head2 Using with L<Data::Sah>:
 ...
 my $schema = ["str","prefilters",[["Str::lowercase"]]];
