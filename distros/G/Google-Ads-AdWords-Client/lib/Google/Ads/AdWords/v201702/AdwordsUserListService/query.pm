...
package Google::Ads::AdWords::v201702::AdwordsUserListService::query;
use strict;
use warnings;
...
query from the namespace https://adwords.google.com/api/adwords/rm/v201702.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::AdwordsUserListService::query->new($data);
