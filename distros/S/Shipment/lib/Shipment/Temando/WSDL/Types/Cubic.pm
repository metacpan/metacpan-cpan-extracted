...
$Shipment::Temando::WSDL::Types::Cubic::VERSION = '3.10';
use strict;
use warnings;
...
Cubic from the namespace http://' . $Shipment::Temando::WSDL::Interfaces::quoting_Service::quoting_port::ns_url . '/schema/2009_06/common.xsd.
