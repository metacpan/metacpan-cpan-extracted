...
Data::Sah::Coerce::perl::To_str::From_int::convert_uid_to_unix_user - Convert UID into Unix username, fail when username does not exist

=head1 VERSION

This document describes version 0.009 of Data::Sah::Coerce::perl::To_str::From_int::convert_uid_to_unix_user (from Perl distribution Sah-Schemas-Unix), released on 2019-12-09.

=head1 SYNOPSIS

To use in a Sah schema:

 ["str",{"x.perl.coerce_rules"=>["From_int::convert_uid_to_unix_user"]}]
