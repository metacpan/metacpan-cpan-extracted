package Chart::Plotly::Trace::Contour::Contours::Labelfont;
use Moose;
...
Chart::Plotly::Trace::Contour::Contours::Labelfont - This attribute is one of the possible options for the trace contour.
