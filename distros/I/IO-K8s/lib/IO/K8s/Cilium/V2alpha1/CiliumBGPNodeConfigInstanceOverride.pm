...
IO::K8s::Cilium::V2alpha1::CiliumBGPNodeConfigInstanceOverride - CiliumBGPNodeConfigInstanceOverride defines configuration options which can be overridden for a specific BGP instance.
