...
# [Jacode4e и Jacode4e::RoundTrip: различия]
#
#   Jacode4e              : Быстрое одностороннее преобразование. Для некоторых
#                           символов с потерями (напр. CP932 имеет 398 необратимых
#                           отображений).
#   Jacode4e::RoundTrip   : Гарантирует обратимость через Unicode-ось.
#                           A->B->A всегда идентично. Медленнее Jacode4e,
#                           но используйте когда данные должны пройти туда и обратно.
#
#   Если двунаправленное преобразование не нужно, используйте модуль Jacode4e.
#
# ======================================================================
