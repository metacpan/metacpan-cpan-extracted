...
Test::Shared::Fixture::Wikibase::Datatype::Snak::Wikidata::SexOrGender::Male - Test instance for Wikidata snak.
...
=for comment filename=fixture_create_and_print_snak_wd_sex_or_gender_male.pl
...
L<Test::Shared::Fixture::Wikibase::Datatype::Value::Item::Wikidata::Male>,
