...
ok(
  do {
    eval {
      $address = PDK::Firewall::Element::Address::Asa->new(
        fwId        => 1,
        addrName    => 'xxxx',
        ip          => '192.168.8.1',
        mask        => '32',
    ...
    warn $@ if !!$@;
    $address->isa('PDK::Firewall::Element::Address::Asa');
  },
  ' 生成 PDK::Firewall::Element::Address::Asa 对象'
);
...
ok(
  do {
    ...
    eval {
      ...
      $address1 = PDK::Firewall::Element::Address::Asa->new(
        fwId        => 1,
        addrName    => 'xxxx',
        ip          => '192.168.8.100',
        mask        => '30',
