...
Kubernetes::REST::Logs - REMOVED -- superseded by Kubernetes::REST's unified v1 API, see Kubernetes::REST::Deprecated
...
C<Kubernetes::REST::Logs> itself was never functional in the C<1.x> series -- it
...
C<cpanm Kubernetes::REST::Logs> -- or a cpanfile / code that still references the
...
Kubernetes::REST::Logs - REMOVED, superseded by Kubernetes::REST's unified v1 API
