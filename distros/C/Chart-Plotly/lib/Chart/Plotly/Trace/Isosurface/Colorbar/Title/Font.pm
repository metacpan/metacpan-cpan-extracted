package Chart::Plotly::Trace::Isosurface::Colorbar::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Isosurface::Colorbar::Title::Font - This attribute is one of the possible options for the trace isosurface.
