...
package Meta::Baseline::Lang::Dirx;
...
Meta::Baseline::Lang::Dirx - language for special directory tags.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Dirx::env();

=head1 DESCRIPTION

This package contains stuff specific to Dirx in the baseline:
Its mainly here to authorize entries of README.dir files to the baseline.
...
-add syntax checks on the README.dir files here.
