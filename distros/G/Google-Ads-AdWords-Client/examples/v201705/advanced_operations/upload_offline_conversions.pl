...
use Google::Ads::AdWords::v201705::OfflineConversionFeed;
use Google::Ads::AdWords::v201705::OfflineConversionFeedOperation;
...
sub upload_offline_conversions {
  ...
  my $upload_conversion = Google::Ads::AdWords::v201705::UploadConversion->new({
      category                  => 'PAGE_VIEW',
  ...
  my $feed = Google::Ads::AdWords::v201705::OfflineConversionFeed->new({
  ...
  my $offline_conversion_operation =
    Google::Ads::AdWords::v201705::OfflineConversionFeedOperation->new({
      operator => "ADD",
      operand  => $feed
    });
