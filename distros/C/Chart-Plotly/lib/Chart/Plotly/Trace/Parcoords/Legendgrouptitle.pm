package Chart::Plotly::Trace::Parcoords::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Parcoords::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Parcoords::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Parcoords::Legendgrouptitle - This attribute is one of the possible options for the trace parcoords.
