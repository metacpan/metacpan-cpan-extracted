package IBM::StorageSystem::Statistic::Node::CPU;
...
our @ATTR = qw(start_time end_time context_switches interrupts avg_idle avg_system avg_user avg_iowait avg_soft_interrupts avg_hard_interrupts avg_nice);
