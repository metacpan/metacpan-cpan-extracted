package ## no critic: Modules::RequireFilenameMatchesPackage
    # hide from PAUSE
    TableDataRole::CPAN::Release::Static::2020;
...
around new => sub {
    ...
    unless (-f $filename) {
        ...
        $filename = File::ShareDir::dist_file('TableDataBundle-CPAN-Release-Static-Older', '2020.csv');
    }
    $orig->(@_, filename=>$filename);
};

package TableData::CPAN::Release::Static::2020;
...
with 'TableDataRole::CPAN::Release::Static::2020';
...
TableDataRole::CPAN::Release::Static::2020 - CPAN releases for the year 2020

=head1 VERSION

This document describes version 20210927.0 of TableDataRole::CPAN::Release::Static::2020 (from Perl distribution TableDataBundle-CPAN-Release-Static-Older), released on 2021-09-27.

=head1 SYNOPSIS

 use TableData::CPAN::Release::Static::2020;

 my $td = TableData::CPAN::Release::Static::2020->new;
