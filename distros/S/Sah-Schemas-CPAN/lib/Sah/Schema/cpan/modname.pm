...
Sah::Schema::cpan::modname - A module name on CPAN, e.g. 'Module::Installed::Tiny'

=head1 VERSION

This document describes version 0.014 of Sah::Schema::cpan::modname (from Perl distribution Sah-Schemas-CPAN), released on 2022-09-25.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("cpan::modname*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("cpan::modname", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("cpan::modname", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("cpan::modname*");
     $validator->(\@args);
     ...
 }
