...
use Google::Ads::AdWords::v201710::BudgetOperation;
...
use Google::Ads::AdWords::v201710::DynamicSearchAdsSetting;
use Google::Ads::AdWords::v201710::ExpandedDynamicSearchAd;
use Google::Ads::AdWords::v201710::Money;
use Google::Ads::AdWords::v201710::Webpage;
use Google::Ads::AdWords::v201710::WebpageCondition;
use Google::Ads::AdWords::v201710::WebpageParameter;
...
sub _create_budget() {
  ...
  my $shared_budget = Google::Ads::AdWords::v201710::Budget->new({
    name => sprintf("Interplanetary Cruise #%s", uniqid()),
    amount =>
      Google::Ads::AdWords::v201710::Money->new({microAmount => 5000000}),
    deliveryMethod => "STANDARD"
  });

  my $budget_operation = Google::Ads::AdWords::v201710::BudgetOperation->new({
    operator => "ADD",
...
sub _add_web_page_criteria {
  ...
  my $url_condition = Google::Ads::AdWords::v201710::WebpageCondition->new({
    operand  => "URL",
    argument => "/specialoffers"
  });

  my $title_condition = Google::Ads::AdWords::v201710::WebpageCondition->new({
    operand  => "PAGE_TITLE",
    argument => "Special Offer"
  });

  # Create a webpage criterion for special offers.
  my $param = Google::Ads::AdWords::v201710::WebpageParameter->new({
