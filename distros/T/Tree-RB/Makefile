# This Makefile is for the Tree::RB extension to perl.
#
...
#     ABSTRACT => q[Perl implementation of the Red/Black tree, a type of balanced binary search tree. ]
#     AUTHOR => [q[Arun Prasad  C<< <arunbear@cpan.org> >>]]
#     BUILD_REQUIRES => { ExtUtils::MakeMaker=>q[6.36], Test::More=>q[0.42] }
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[Tree-RB]
#     LICENSE => q[perl]
#     NAME => q[Tree::RB]
#     NO_META => q[1]
#     PREREQ_PM => { ExtUtils::MakeMaker=>q[6.36], Test::More=>q[0.42], enum=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION => q[0.500005]
#     VERSION_FROM => q[lib/Tree/RB.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Tree/RB.pm \
	lib/Tree/RB/Node.pm \
	lib/Tree/RB/Node/_Constants.pm
...
TO_INST_PM = lib/Tree/RB.pm \
	lib/Tree/RB/Node.pm \
	lib/Tree/RB/Node/_Constants.pm

PM_TO_BLIB = lib/Tree/RB.pm \
	blib/lib/Tree/RB.pm \
	lib/Tree/RB/Node.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/Tree/RB.pm $(INST_MAN3DIR)/Tree::RB.$(MAN3EXT) \
	  lib/Tree/RB/Node.pm $(INST_MAN3DIR)/Tree::RB::Node.$(MAN3EXT) \
	  lib/Tree/RB/Node/_Constants.pm $(INST_MAN3DIR)/Tree::RB::Node::_Constants.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl implementation of the Red/Black tree, a type of balanced binary search tree. </ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Arun Prasad  C&lt;&lt; &lt;arunbear@cpan.org&gt; &gt;&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="enum::" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Tree/RB.pm blib/lib/Tree/RB.pm \
	  lib/Tree/RB/Node.pm blib/lib/Tree/RB/Node.pm \
	  lib/Tree/RB/Node/_Constants.pm blib/lib/Tree/RB/Node/_Constants.pm 
