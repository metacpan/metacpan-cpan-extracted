...
% GP-Test  expand[2,2] == 3
  ...
  \draw [->,bend left=10] (3) to node[pos=.5,auto=left] {1} (5);
% GP-Test  expand[3,1] == 4
% GP-Test  expand[3,2] == 5

  \draw [->] (4) to node[pos=.5,auto=left] {0} (1);
  \draw [->,bend left=10] (4) to node[pos=.5,auto=left] {1} (5);
% GP-Test  expand[4,1] == 1
% GP-Test  expand[4,2] == 5

  \draw [->,bend left=10] (5) to node[pos=.5,auto=left] {0} (4);
  \draw [->,bend left=10] (5) to node[pos=.5,auto=left] {1} (3);
% GP-Test  expand[5,1] == 4
% GP-Test  expand[5,2] == 3
...
\begin{tikzpicture}
  ...
  \node (3)  at (-2,-2) [my box] {3};
  \node (4)  at (-3,-3) [my box] {4};
  \node (5)  at (-1,-3) [my box] {5};
  \node (6)  at (2,-2)  [my box] {6};
  \node (7)  at (1,-3)  [my box] {7};
  \node (8)  at (3,-3)  [my box] {8};
  \node (9)  at (-4,-4) [my box] {9};
  \node (10) at (-5,-5) [my box] {10};
  \node (11) at (-3,-5) [my box] {11};
  \node (12) at (-6,-6) [my box] {12};
  \node (13) at (-7,-7) [my box] {13};
  \node (14) at (-5,-7) [my box] {14};
  \node (15) at (-2,-6) [my box] {15};
  \node (16) at (-3,-7) [my box] {16};
  \node (17) at (-1,-7) [my box] {17};
  \node (18) at (4,-4) [my box] {18};
  \node (19) at (3,-5) [my box] {19};
  \node (20) at (5,-5) [my box] {20};
  \node (21) at (2,-6) [my box] {21};
  \node (22) at (1,-7) [my box] {22};
  \node (23) at (3,-7) [my box] {23};
  \node (24) at (6,-6) [my box] {24};
  \node (25) at (5,-7) [my box] {25};
  \node (26) at (7,-7) [my box] {26};

  \begin{scope}[shift={(-8,-8)}]
  \node (27) at (0,0)   [my box] {27};
  \node (28) at (-1,-1) [my box] {28};
  \node (29) at (1,-1)  [my box] {29};
  \node (30) at (-2,-2) [my box] {30};
  \node (31) at (-3,-3) [my box] {31};
  \node (32) at (-1,-3) [my box] {32};
  \node (33) at (2,-2)  [my box] {33};
  \node (34) at (1,-3)  [my box] {34};
  \node (35) at (3,-3)  [my box] {35};
  \node (36) at (-4,-4) [my box] {36};
  \node (37) at (-5,-5) [my box] {37};
  \node (38) at (-3,-5) [my box] {38};
  \node (39) at (-6,-6) [my box] {39};
  \node (40) at (-7,-7) [my box] {40};
  \node (41) at (-5,-7) [my box] {41};
  \node (42) at (-2,-6) [my box] {42};
  \node (43) at (-3,-7) [my box] {43};
  \node (44) at (-1,-7) [my box] {44};
  \node (45) at (4,-4)  [my box] {45};
  \node (46) at (3,-5)  [my box] {46};
  \node (47) at (5,-5)  [my box] {47};
  \node (48) at (2,-6)  [my box] {48};
  \node (49) at (1,-7)  [my box] {49};
  \node (50) at (3,-7)  [my box] {50};
  \node (51) at (6,-6)  [my box] {51};
  \node (52) at (5,-7)  [my box] {52};
  \node (53) at (7,-7)  [my box] {53};
  \end{scope}

  \begin{scope}[shift={(8,-8)}]
  \node (54) at (0,0)   [my box] {54};
  \node (55) at (-1,-1) [my box] {55};
  \node (56) at (1,-1)  [my box] {56};
  \node (57) at (-2,-2) [my box] {57};
  \node (58) at (-3,-3) [my box] {58};
  \node (59) at (-1,-3) [my box] {59};
  \node (60) at (2,-2)  [my box] {60};
  \node (61) at (1,-3)  [my box] {61};
  \node (62) at (3,-3)  [my box] {62};
  \node (63) at (-4,-4) [my box] {63};
  \node (64) at (-5,-5) [my box] {64};
  \node (65) at (-3,-5) [my box] {65};
  \node (66) at (-6,-6) [my box] {66};
  \node (67) at (-7,-7) [my box] {67};
  \node (68) at (-5,-7) [my box] {68};
  \node (69) at (-2,-6) [my box] {69};
  \node (70) at (-3,-7) [my box] {70};
  \node (71) at (-1,-7) [my box] {71};
  \node (72) at (4,-4)  [my box] {72};
  \node (73) at (3,-5)  [my box] {73};
  \node (74) at (5,-5)  [my box] {74};
  \node (75) at (2,-6)  [my box] {75};
  \node (76) at (1,-7)  [my box] {76};
  \node (77) at (3,-7)  [my box] {77};
  \node (78) at (6,-6)  [my box] {78};
  \node (79) at (5,-7)  [my box] {79};
  \node (80) at (7,-7)  [my box] {80};
  \end{scope}
...
%------------------------------------------------------------------------------
\clearpage
\section{Whythoff Game 3,2}

\url{http://hdl.handle.net/2268/100440}
...
\begin{tikzpicture}
  ...
  \node (3-2) at ( 0,    2   ) [my box] {3,2};
  \node (3-1) at ( 1,    1.72) [my box] {3,1};
  \node (3-0) at ( 1.75,  .9 ) [my box] {3,0};
  \node (2-0) at ( 1.75, 0   ) [my box] {2,0};
  \node (2-2) at (-1,    1.72) [my box] {2,2};
  \node (2-1) at (-1.75,  .9 ) [my box] {2,1};
  \node (1-1) at (-1.75, 0   ) [my box] {1,1};
  \node (1-0) at (0,     0   ) [my box] {1,0};
  \node (0-0) at (0,     -.9 ) [my box] {0,0};

  % \node (3-2) at (90:2) [my box] {3,2};
  % \node (3-1) at (90-30:2) [my box] {3,1};
  % \node (3-0) at (90-30-40:2) [my box] {3,0};
  % \node (2-0) at (90-30-40-30:2) [my box] {2,0};
  % \node (2-2) at (90+30:2) [my box] {2,2};
  % \node (2-1) at (90+30+40:2) [my box] {2,1};
  % \node (1-1) at (90+30+40+30:2) [my box] {1,1};
  % \node (1-0) at (-90:.4) [my box] {1,0};
  % \node (0-0) at (-90:1.5) [my box] {0,0};

  % \node (3-2) at (0,3) [my box] {3,2};
  % \node (3-1) at (1,3) [my box] {3,1};
  % \node (3-0) at (2,2.5) [my box] {3,0};
  % \node (2-1) at (-1,1) [my box] {2,1};
  % \node (2-2) at (-1,2.5) [my box] {2,2};
  % \node (0-0) at (1,-.5) [my box] {0,0};
  % \node (2-0) at (3,1.5) [my box] {2,0};
  % \node (1-0) at (3,.5) [my box] {1,0};
  % \node (1-1) at (0,0) [my box] {1,1};
...
\begin{tikzpicture}
  ...
  \node (3-0) at (-2, 1) [my box] {3,0};
  \node (2-0) at (-1, 1) [my box] {2,0};
  \node (2-2) at ( 0, 1) [my box] {2,2};
  \node (2-1) at ( 1, 1) [my box] {2,1};
  \node (3-1) at ( 2, 1) [my box] {3,1};

  \node (0-0) at (-1.3, 0) [my box] {0,0};
  \node (1-0) at (0,    0) [my box] {1,0};
  \node (1-1) at (1.3,  0) [my box] {1,1};

  \draw [->] (2-0) to (0-0);
  \draw [->] (3-2) to (3-1);
  \draw [->] (1-1) to (1-0);
  \draw [->,bend left=25] (3-2) to (1-0);
  \draw [->] (3-1) to (1-0);
  \draw [->,bend right=25] (3-1) to (2-0);
  \draw [->,bend right=80] (3-1) .. controls +(120:2) and +(60:2) .. (3-0)
    coordinate[pos=.5,name=top];
  \draw [->] (2-2) to (0-0);
  \draw [->] (3-0) to (2-0);
  \draw [->] (2-1) to (1-1);
  \draw [->] (3-2) to (2-2);
  ...
  \draw [->] (3-0) to (1-0);
  \draw [->] (2-1) to (1-0);
  \draw [->,bend left=30] (2-1) to (2-0);
  \draw [->] (3-1) to (2-1);

  \draw [->] (1-0) to (0-0);
  \draw [->,bend left=20] (1-1) to (0-0);

  % Hack for bounding box of Bezier curve to not include its control points.
  % \node at (top) {X};
  \coordinate (top-left) at (current bounding box.north west |- top);
  \coordinate (bottom-right) at (current bounding box.south east);
  \pgfresetboundingbox
  \useasboundingbox (top-left) rectangle (bottom-right);
...
\subsection{Binary Tree Dexter}

N=4 \url{https://hog.grinvin.org/ViewGraphInfo.action?id=33621}
...
%------------------------------------------------------------------------------
\subsection{Binary Tree Rotate A-Empty}

N=4 \url{https://hog.grinvin.org/ViewGraphInfo.action?id=33607}
...
%------------------------------------------------------------------------------
\subsection{Balanced Binary Filling}

N=4 \url{https://hog.grinvin.org/ViewGraphInfo.action?id=33595}
...
\begin{tikzpicture}
    [scale=1.5,
     my box/.style={draw,minimum size=1.5em,inner sep=.1em,outer sep=.3em},
    ]
...
\begin{tikzpicture}
    [scale=1,
     my box/.style={draw,minimum size=1.2em,inner sep=.1em,outer sep=.3em},
    ]
...
\subsection{Noughts and Crosses 2x2, 1 Player}
...
%------------------------------------------------------------------------------
\subsection{Noughts and Crosses 2x2}
...
%------------------------------------------------------------------------------
\subsection{Noughts and Crosses 2x2 up to Rotation}
...
%------------------------------------------------------------------------------
\subsection{Noughts and Crosses 2x2, 1 Player, up to Reflection}
...
%------------------------------------------------------------------------------
\subsection{Noughts and Crosses 2x2, 3 Players, up to Rotation}
...
\subsection{Hanoi 2 Discs, 4 Spindles, Star}
