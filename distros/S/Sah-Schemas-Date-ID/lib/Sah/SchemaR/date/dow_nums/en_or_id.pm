...
our $rschema = ["array",[{of=>["date::dow_num::en_or_id",{},{}],summary=>"Array of day-of-week numbers (1-7, 1=Monday)","x.completion"=>["date_dow_nums_en_or_id"],"x.perl.coerce_rules"=>["str_comma_sep"]}],["array"]];
...
Sah::SchemaR::date::dow_nums::en_or_id - Array of day-of-week numbers (1-7, 1=Monday)

=head1 VERSION

This document describes version 0.002 of Sah::SchemaR::date::dow_nums::en_or_id (from Perl distribution Sah-Schemas-Date-ID), released on 2019-07-21.
