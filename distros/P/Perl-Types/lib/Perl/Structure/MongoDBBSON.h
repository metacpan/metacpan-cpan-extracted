...
#ifndef __CPP__INCLUDED__Perl__Structure__MongoDBBSON_h
#define __CPP__INCLUDED__Perl__Structure__MongoDBBSON_h 0.002_000

// [[[ INCLUDES ]]]
/* DISABLED: the following #include directives are set in $Perl::Inline::ARGS{auto_include} in Compiler.pm
#include <bsoncxx/json.hpp>
#include <bsoncxx/builder/stream/document.hpp>
*/

# ifndef __CPP__INCLUDED__Perl__Structure__MongoDBBSON_h__typedefs
#define __CPP__INCLUDED__Perl__Structure__MongoDBBSON_h__typedefs 1
...
# ifdef __PERL__TYPES
SV* Perl__Structure__MongoDBBSON__MODE_ID() { return(newSViv(1)); }  // CPPOPS_PERLTYPES is 1
# elif defined __CPP__TYPES
int Perl__Structure__MongoDBBSON__MODE_ID() { return 2; }  // CPPOPS_CPPTYPES is 2
# else
