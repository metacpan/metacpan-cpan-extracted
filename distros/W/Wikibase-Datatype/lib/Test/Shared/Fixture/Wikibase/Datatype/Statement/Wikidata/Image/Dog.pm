...
Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::Image::Dog - Test instance for Wikidata statement.

=head1 SYNOPSIS

 use Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::Image::Dog;

 my $obj = Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::Image::Dog->new(%params);
 my $id = $obj->id;
...
=for comment filename=fixture_create_and_print_statement_wd_image_dog.pl
...
L<Test::Shared::Fixture::Wikibase::Datatype::Snak::Wikidata::Image::Dog>,
