...
use Google::Ads::AdWords::v201702::ShowcaseAd;
...
sub _create_showcase_ad {
  ...
  my $showcase_ad = Google::Ads::AdWords::v201702::ShowcaseAd->new({
  ...
  my $expanded_image = Google::Ads::AdWords::v201702::Image->new({
  ...
  my $collapsed_image = Google::Ads::AdWords::v201702::Image->new({
      mediaId => _upload_image(
