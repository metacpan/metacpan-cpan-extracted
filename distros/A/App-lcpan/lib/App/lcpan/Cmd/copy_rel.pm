...
1;
# ABSTRACT: Copy a release file to current directory
...
This document describes version 1.035 of App::lcpan::Cmd::copy_rel (from Perl distribution App-lcpan), released on 2019-06-26.
