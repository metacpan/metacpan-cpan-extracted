package WebService::Affiliate::Voucher::WebGains;
...
WebService::Affiliate::Voucher::WebGains - WebGains specific voucher code model.
...
Models a WebGains voucher code.
...
has commission_type => ( is => 'rw', isa => 'Str' );
has currency        => ( is => 'rw', isa => 'Str' );
has discount        => ( is => 'rw', isa => 'Str' );
