package Google::Ads::AdWords::v201702::AdGroupAdCountLimitExceeded;
use strict;
use warnings;
...
AdGroupAdCountLimitExceeded from the namespace https://adwords.google.com/api/adwords/cm/v201702.
