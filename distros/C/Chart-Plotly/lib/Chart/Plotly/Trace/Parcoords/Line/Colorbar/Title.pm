package Chart::Plotly::Trace::Parcoords::Line::Colorbar::Title;
use Moose;
...
use Chart::Plotly::Trace::Parcoords::Line::Colorbar::Title::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Parcoords::Line::Colorbar::Title::Font", );
...
Chart::Plotly::Trace::Parcoords::Line::Colorbar::Title - This attribute is one of the possible options for the trace parcoords.
