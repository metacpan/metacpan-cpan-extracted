package Bencher::Scenarios::Color::ANSI::Util;
...
1;
# ABSTRACT: Scenarios to benchmark Color::ANSI::Util
...
Bencher::Scenarios::Color::ANSI::Util - Scenarios to benchmark Color::ANSI::Util

=head1 VERSION

This document describes version 0.003 of Bencher::Scenarios::Color::ANSI::Util (from Perl distribution Bencher-Scenarios-Color-ANSI-Util), released on 2023-01-18.
...
=item * L<Bencher::Scenario::Color::ANSI::Util::ansifg>
