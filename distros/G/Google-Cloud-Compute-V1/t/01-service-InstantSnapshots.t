...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::InstantSnapshot Google::Cloud::Compute::V1::Compute::InstantSnapshotAggregatedList Google::Cloud::Compute::V1::Compute::InstantSnapshotList Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::Policy Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::InstantSnapshotsClient->new( credentials => 'dummy' );
