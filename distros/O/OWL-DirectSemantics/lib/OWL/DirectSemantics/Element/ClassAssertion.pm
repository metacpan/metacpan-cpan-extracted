...
sub fs_arguments { return ($_[0]->class, $_[0]->node); }
...
OWL::DirectSemantics::Element::ClassAssertion - represents an OWL ClassAssertion

=head1 DESCRIPTION

This class represents the ClassAssertion element in OWL Direct Semantics.
