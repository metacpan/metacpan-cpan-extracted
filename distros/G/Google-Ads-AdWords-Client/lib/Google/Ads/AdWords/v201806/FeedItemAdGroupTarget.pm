package Google::Ads::AdWords::v201806::FeedItemAdGroupTarget;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201806::FeedItemTarget);
# Variety: sequence
...
Google::Ads::AdWords::v201806::FeedItemAdGroupTarget

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItemAdGroupTarget from the namespace https://adwords.google.com/api/adwords/cm/v201806.
