package Chart::Plotly::Trace::Streamtube::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Streamtube::Hoverlabel::Font - This attribute is one of the possible options for the trace streamtube.
