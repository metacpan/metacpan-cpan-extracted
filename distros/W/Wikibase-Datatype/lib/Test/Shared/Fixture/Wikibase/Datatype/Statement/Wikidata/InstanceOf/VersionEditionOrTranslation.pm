...
Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::InstanceOf::VersionEditionOrTranslation - Test instance for Wikidata statement.

=head1 SYNOPSIS

 use Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::InstanceOf::VersionEditionOrTranslation;

 my $obj = Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::InstanceOf::VersionEditionOrTranslation->new(%params);
 my $id = $obj->id;
...
=for comment filename=fixture_create_and_print_statement_wd_instance_of_version_edition_or_translation.pl
...
L<Test::Shared::Fixture::Wikibase::Datatype::Snak::Wikidata::InstanceOf::VersionEditionOrTranslation>,
L<Test::Shared::Fixture::Wikibase::Datatype::Snak::Wikidata::Of::Poem>,
