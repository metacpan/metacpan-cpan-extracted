...
Sah::SchemaR::perl::calendar::dates::modname - Perl module in the Calendar::Dates::* namespace, without the namespace prefix, e.g. "ID::Holiday"

=head1 VERSION

This document describes version 0.001 of Sah::SchemaR::perl::calendar::dates::modname (from Perl distribution Sah-Schemas-Calendar-Dates), released on 2023-07-02.
