...
use Perl::Structure::Array_cpp;
Perl::Structure::Array_cpp::cpp_load();

Perl::diag(q{in array_test.pl, have Perl__Type__Integer__MODE_ID() = '} . Perl__Type__Integer__MODE_ID() . "'\n");
Perl::diag(q{in array_test.pl, have Perl__Type__Number__MODE_ID() = '} . Perl__Type__Number__MODE_ID() . "'\n");
Perl::diag(q{in array_test.pl, have Perl__Type__String__MODE_ID() = '} . Perl__Type__String__MODE_ID() . "'\n");
Perl::diag(q{in array_test.pl, have array__MODE_ID() = '} . array__MODE_ID() . "'\n");
...
for my integer $i ( 0 .. $i_MAX ) {
    Perl::diag("in array_test.pl, top of for() loop $i/$i_MAX\n");
...
#	$retval_stringify = integer_arrayref_to_string([2, 2112, 42, 23, -877, -33, 1701]);  # TIVAVRV21
    Perl::diag("in array_test.pl $i/$i_MAX, have \$retval_stringify =\n$retval_stringify\n");
...
#	Perl::diag("in array_test.pl $i/$i_MAX, have \$retval_integer_arrayref = \n" . Dumper($retval_integer_arrayref) . "\n");
...
#	Perl::diag("in array_test.pl $i/$i_MAX, have \$retval_number_arrayref = \n" . Dumper($retval_number_arrayref) . "\n");
...
#	Perl::diag("in array_test.pl $i/$i_MAX, have \$retval_jeffys = \n" . Dumper($retval_jeffys) . "\n");
