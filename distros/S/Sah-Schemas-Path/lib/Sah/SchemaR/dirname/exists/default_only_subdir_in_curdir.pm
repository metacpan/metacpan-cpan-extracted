...
Sah::SchemaR::dirname::exists::default_only_subdir_in_curdir - Directory name, must exist on the filesystem, defaults to only subdirectory in current directory (if there is one)

=head1 VERSION

This document describes version 0.030 of Sah::SchemaR::dirname::exists::default_only_subdir_in_curdir (from Perl distribution Sah-Schemas-Path), released on 2024-01-08.
