...
Cfn::Resource::AWS::CertificateManager::Certificate - Cfn resource for AWS::CertificateManager::Certificate

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::CertificateManager::Certificate.
