package Google::Ads::AdWords::v201809::ThirdPartyUploadMetadata;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::ThirdPartyUploadMetadata

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ThirdPartyUploadMetadata from the namespace https://adwords.google.com/api/adwords/rm/v201809.
