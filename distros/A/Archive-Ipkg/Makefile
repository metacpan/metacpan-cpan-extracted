# This Makefile is for the Archive::Ipkg extension to perl.
#
...
#     ABSTRACT_FROM => q[Ipkg.pm]
#     AUTHOR => q[Christian Renz <crenz@web42.com>]
#     LICENSE => q[perl]
#     NAME => q[Archive::Ipkg]
#     PREREQ_PM => { Compress::Zlib=>q[0], Archive::Tar=>q[0.072] }
#     VERSION_FROM => q[Ipkg.pm]
...
MAKE = make
FULLEXT = Archive/Ipkg
BASEEXT = Ipkg
PARENT_NAME = Archive
DLBASE = $(BASEEXT)
VERSION_FROM = Ipkg.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
DISTNAME = Archive-Ipkg
DISTVNAME = Archive-Ipkg-0.04
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  Ipkg.pm $(INST_MAN3DIR)/Archive::Ipkg.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                Archive-Ipkg' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             0.04' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            Module for manipulation of iPKG archives' >> META_new.yml
	$(NOECHO) $(ECHO) 'license:             perl' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:              ' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Christian Renz <crenz@web42.com>' >> META_new.yml
	$(NOECHO) $(ECHO) 'generated_by:        ExtUtils::MakeMaker version 6.42' >> META_new.yml
	$(NOECHO) $(ECHO) 'distribution_type:   module' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:     ' >> META_new.yml
	$(NOECHO) $(ECHO) '    Archive::Tar:                  0.072' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Module for manipulation of iPKG archives</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Christian Renz &lt;crenz@web42.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Archive-Tar" VERSION="0,072,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  Ipkg.pm $(INST_LIB)/Archive/Ipkg.pm 
