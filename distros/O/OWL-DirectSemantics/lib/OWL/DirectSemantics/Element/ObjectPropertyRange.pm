package OWL::DirectSemantics::Element::ObjectPropertyRange;
...
OWL::DirectSemantics::Element::ObjectPropertyRange - represents an OWL ObjectPropertyRange

=head1 DESCRIPTION

This class represents the ObjectPropertyRange element in OWL Direct Semantics.
