...
=head1 SYNOPSIS
  ...
  perl Algorithm-Line-Lerp/ppport.h [options] [source files]
  ...
  --strip                     strip all script and doc functionality
                              from Algorithm-Line-Lerp/ppport.h
...
This version of F<Algorithm-Line-Lerp/ppport.h> is designed to support operation with Perl
...
Display the version of F<Algorithm-Line-Lerp/ppport.h>.
...
Strip all script and documentation functionality from F<Algorithm-Line-Lerp/ppport.h>.
This reduces the size of F<Algorithm-Line-Lerp/ppport.h> dramatically and may be useful
if you want to include F<Algorithm-Line-Lerp/ppport.h> in smaller modules without
increasing their distribution size too much.

The stripped F<Algorithm-Line-Lerp/ppport.h> will have a C<--unstrip> option that allows
...
F<Algorithm-Line-Lerp/ppport.h>. Also lists if it must be explicitly requested,
if it has dependencies, and if there are hints or warnings for it.

=head2 --list-unsupported

Lists the API elements that are known not to be FULLY supported by F<Algorithm-Line-Lerp/ppport.h>,
...
version of Perl that F<Algorithm-Line-Lerp/ppport.h> supports at all.
...
earlier Perl releases. Use
    ...
    perl Algorithm-Line-Lerp/ppport.h --list-provided

to see which API elements are provided by Algorithm-Line-Lerp/ppport.h.
...
also deprecated. You can safely use the supported API, as F<Algorithm-Line-Lerp/ppport.h>
will provide wrappers for older Perl versions.

=item *

Although the purpose of F<Algorithm-Line-Lerp/ppport.h> is to keep you from having to concern
...
more C<#define>s in your source code before the inclusion of F<Algorithm-Line-Lerp/ppport.h>.
...
macro. Just C<#define> the macro before including C<Algorithm-Line-Lerp/ppport.h>:

    #define DPPP_NAMESPACE MyOwnNamespace_
    #include "Algorithm-Line-Lerp/ppport.h"
...
should be used, F<Algorithm-Line-Lerp/ppport.h> can be run as a Perl script to check your
source code. Simply say:

    perl Algorithm-Line-Lerp/ppport.h
...
use something like this:
    ...
    perl Algorithm-Line-Lerp/ppport.h --compat-version=5.6.0 --cplusplus --patch=test.diff

If you only want your code to be scanned without any suggestions
for changes, use:

    perl Algorithm-Line-Lerp/ppport.h --nochanges

You can specify a different C<diff> program or options, using
the C<--diff> option:

    perl Algorithm-Line-Lerp/ppport.h --diff='diff -C 10'

This would output context diffs with 10 lines of context.

If you want to create patched copies of your files instead, use:

    perl Algorithm-Line-Lerp/ppport.h --copy=.new

To display portability information for the C<newSVpvn> function,
use:

    perl Algorithm-Line-Lerp/ppport.h --api-info=newSVpvn

Since the argument to C<--api-info> can be a regular expression,
you can use

    perl Algorithm-Line-Lerp/ppport.h --api-info=/_nomg$/

to display portability information for all C<_nomg> functions or

    perl Algorithm-Line-Lerp/ppport.h --api-info=/./
...
If F<Algorithm-Line-Lerp/ppport.h> was generated using the latest version of
...
# These are tools that must be included in Algorithm-Line-Lerp/ppport.h.  It doesn't work if given
# a .pl suffix.
#
...
/* Hint: isPSXSPC, isPSXSPC_A, isPSXSPC_L1, isPSXSPC_utf8_safe
    ...
    Algorithm-Line-Lerp/ppport.h SPACE version does match VT in all perl releases.  Since VT's are
    extremely rarely found in real-life files, this difference effectively
    doesn't matter */

/* Hint: isSPACE, isSPACE_A, isSPACE_L1, isSPACE_utf8_safe
    Until Perl 5.18, this did not match the vertical tab (VT).  The Algorithm-Line-Lerp/ppport.h
...
/* Hint: SvPVbyte
 * Does not work in perl-5.6.1, Algorithm-Line-Lerp/ppport.h implements a version
...
/* End of File Algorithm-Line-Lerp/ppport.h */
