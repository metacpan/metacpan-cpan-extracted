...
This document describes version 0.003 of Sah::Schema::dns::record_of_known_types (from Perl distribution Sah-SchemaBundle-DNS), released on 2024-06-26.
 ...
 [
   "dns::record",
   {
     ...
     "merge.normal.keys" => {
       type => [
         "str",
         { req => 1, match => "\\A(?:A|CNAME|MX|NS|SOA|SRV|SSHFP|TXT)\\z" },
       ],
     },
   },
 ]
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("dns::record_of_known_types*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("dns::record_of_known_types", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("dns::record_of_known_types", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("dns::record_of_known_types*");
     $validator->(\@args);
     ...
 }
 ...
 $SPEC{myfunc} = {
     ...
     args => {
         arg1 => {
             ...
             schema => ['dns::record_of_known_types*'],
         },
         ...
     },
 };
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"dns::record_of_known_types*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('dns::record_of_known_types*', name=>'DnsRecordOfKnownTypes')
     );
 }

 use My::Types qw(DnsRecordOfKnownTypes);
 DnsRecordOfKnownTypes->assert_valid($data);
