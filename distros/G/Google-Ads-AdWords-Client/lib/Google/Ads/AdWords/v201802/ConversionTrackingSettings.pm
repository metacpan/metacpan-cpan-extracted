package Google::Ads::AdWords::v201802::ConversionTrackingSettings;
use strict;
use warnings;
...
Google::Ads::AdWords::v201802::ConversionTrackingSettings

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ConversionTrackingSettings from the namespace https://adwords.google.com/api/adwords/mcm/v201802.
