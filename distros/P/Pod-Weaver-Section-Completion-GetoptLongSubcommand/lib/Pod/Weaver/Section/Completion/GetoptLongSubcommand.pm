...
Pod::Weaver::Section::Completion::GetoptLongSubcommand - Add a COMPLETION section for Getopt::Long::Subcommand-based scripts

=head1 VERSION

This document describes version 0.04 of Pod::Weaver::Section::Completion::GetoptLongSubcommand (from Perl distribution Pod-Weaver-Section-Completion-GetoptLongSubcommand), released on 2016-04-30.
...
Please visit the project's homepage at L<https://metacpan.org/release/Pod-Weaver-Section-Completion-GetoptLongSubcommand>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Pod-Weaver-Section-Completion-GetoptLongSubcommand>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=Pod-Weaver-Section-Completion-GetoptLongSubcommand>
