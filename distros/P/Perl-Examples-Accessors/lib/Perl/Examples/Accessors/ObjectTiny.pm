package Perl::Examples::Accessors::ObjectTiny;
...
Perl::Examples::Accessors::ObjectTiny

=head1 VERSION

This document describes version 0.130 of Perl::Examples::Accessors::ObjectTiny (from Perl distribution Perl-Examples-Accessors), released on 2017-09-01.

=head1 DESCRIPTION

This is an example of a class which uses L<Object::Tiny>. It is hash-based.
