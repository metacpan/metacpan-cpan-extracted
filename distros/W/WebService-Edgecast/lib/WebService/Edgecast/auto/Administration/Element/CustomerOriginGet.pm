...
package WebService::Edgecast::auto::Administration::Element::CustomerOriginGet;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerOriginGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerOriginGet');
...
WebService::Edgecast::auto::Administration::Element::CustomerOriginGet
...
CustomerOriginGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerOriginGet->new($data);
