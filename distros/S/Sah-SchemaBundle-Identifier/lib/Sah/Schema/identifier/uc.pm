...
Sah::Schema::identifier::uc - A string that starts with [A-Z_] followed by zero of more [A-Z0-9_]

=head1 VERSION

This document describes version 0.002 of Sah::Schema::identifier::uc (from Perl distribution Sah-SchemaBundle-Identifier), released on 2025-11-11.

=head1 SAH SCHEMA DEFINITION

 ["str", { min_len => 1, match => qr/\A[A-Z_][A-Z0-9_]*\z/ }]
...
=head2 Sample data and validation results against this schema
 ...
 "Aa"  # INVALID (Contains lowercase letter)
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("identifier::uc*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("identifier::uc", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("identifier::uc", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("identifier::uc*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"identifier::uc*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('identifier::uc*', name=>'IdentifierUc')
     );
 }

 use My::Types qw(IdentifierUc);
 IdentifierUc->assert_valid($data);
