# -*- perl -*-
##----------------------------------------------------------------------------
## Net/API/Telegram/InlineQueryResultCachedVoice.pm
## Version 0.1
...
##----------------------------------------------------------------------------
package Net::API::Telegram::InlineQueryResultCachedVoice;
BEGIN
{
	use strict;
...
sub voice_file_id { return( shift->_set_get_scalar( 'voice_file_id', @_ ) ); }
...
Net::API::Telegram::InlineQueryResultCachedVoice - A link to a voice message stored on the Telegram servers

=head1 SYNOPSIS

	my $msg = Net::API::Telegram::InlineQueryResultCachedVoice->new( %data ) || 
	die( Net::API::Telegram::InlineQueryResultCachedVoice->error, "\n" );

=head1 DESCRIPTION

L<Net::API::Telegram::InlineQueryResultCachedVoice> is a Telegram Message Object as defined here L<https://core.telegram.org/bots/api#inlinequeryresultcachedvoice>
