...
package UMMF::UML_1_5::OCL::Expressions::IteratorExp;
...
=head2 C<__validate_type>
  ...
  UMMF::UML_1_5::OCL::Expressions::IteratorExp->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::OCL::Expressions::IteratorExp|UMMF::UML_1_5::OCL::Expressions::IteratorExp>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::OCL::Expressions::IteratorExp')  ;
}


=head2 C<__typecheck>

  UMMF::UML_1_5::OCL::Expressions::IteratorExp->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::OCL::Expressions::IteratorExp->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::OCL::Expressions::IteratorExp' . ": value '$x'")
    unless __validate_type($self, $x);
}


=head2 C<isaIteratorExp>


Returns true if receiver is a L<UMMF::UML_1_5::OCL::Expressions::IteratorExp|UMMF::UML_1_5::OCL::Expressions::IteratorExp>.
Other receivers will return false.

=cut
sub isaIteratorExp { 1 }


=head2 C<isaOCL__Expressions__IteratorExp>


Returns true if receiver is a L<UMMF::UML_1_5::OCL::Expressions::IteratorExp|UMMF::UML_1_5::OCL::Expressions::IteratorExp>.
Other receivers will return false.
This is the fully qualified version of the C<isaIteratorExp> method.

=cut
sub isaOCL__Expressions__IteratorExp { 1 }
...
Returns the UML Model name (C<'OCL::Expressions::IteratorExp'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'OCL::Expressions::IteratorExp' }
...
sub __tangram_schema
{
  ...
  $__tangram_schema ||=
  {
   ...
   [
     'UMMF::UML_1_5::OCL::Expressions::IteratorExp' =>
     {
       'table' => 'OCL__Expressions__IteratorExp',
       'abstract' => 0,
       'slots' => 
       { 
	 # Attributes
...
sub __initialize
{
  ...
  $self->UMMF::UML_1_5::OCL::Expressions::IteratorExp::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::OCL::Expressions::IteratorExp::___create(@args);
