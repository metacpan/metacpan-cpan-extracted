package Shipment::UPS::WSDL::ShipTypes::PackageWeightType;
$Shipment::UPS::WSDL::ShipTypes::PackageWeightType::VERSION = '2.03';
use strict;
use warnings;
...
PackageWeightType from the namespace http://www.ups.com/XMLSchema/XOLTWS/Ship/v1.0.
