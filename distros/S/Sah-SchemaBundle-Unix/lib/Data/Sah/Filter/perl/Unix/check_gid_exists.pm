...
1;
# ABSTRACT: Check that GID exists (has associated group name) on the system
...
Data::Sah::Filter::perl::Unix::check_gid_exists - Check that GID exists (has associated group name) on the system

=head1 VERSION

This document describes version 0.022 of Data::Sah::Filter::perl::Unix::check_gid_exists (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.
