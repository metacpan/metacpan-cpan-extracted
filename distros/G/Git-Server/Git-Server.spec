#
#   - Git::Server -
#   This spec file was automatically generated by cpan2rpm [ver: 2.044]
#   The following arguments were used:
#       --force --no-fixin --spec-only --spec Git-Server.spec .
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    Git-Server-0.034.tar.gz
...
%changelog
* Sun Oct 12 2025 hookbot@tiny14.threerings.net
- Initial build.