...
note 'simple anon class';
{
    ...
    is_anon_ok $anon_class;
    test_test 'is_anon_ok works correctly on anon class';
}
...
note 'simple anon role';
{
    ...
    is_anon_ok $anon_role;
    test_test 'is_anon_ok works correctly on anon role';
}
