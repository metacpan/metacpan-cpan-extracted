...
has srv => ( is => 'ro', isa => 'Firewall::Config::Element::Service::Netscreen | Undef', required => 0, );

has natSrcPool => ( is => 'ro', isa => 'Firewall::Config::Element::NatPool::Netscreen | Undef', required => 0, );
...
has srvRange => ( is => 'ro', isa => 'Firewall::Utils::Set | Undef', required => 0, );
