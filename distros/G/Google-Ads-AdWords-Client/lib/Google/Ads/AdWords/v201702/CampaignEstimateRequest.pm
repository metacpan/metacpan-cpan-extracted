package Google::Ads::AdWords::v201702::CampaignEstimateRequest;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'adGroupEstimateRequests' => 'Google::Ads::AdWords::v201702::AdGroupEstimateRequest',
        'criteria' => 'Google::Ads::AdWords::v201702::Criterion',
        'networkSetting' => 'Google::Ads::AdWords::v201702::NetworkSetting',
        'dailyBudget' => 'Google::Ads::AdWords::v201702::Money',
    },
    {
...
CampaignEstimateRequest from the namespace https://adwords.google.com/api/adwords/o/v201702.
