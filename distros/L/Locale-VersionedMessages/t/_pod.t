...
BEGIN {
   ...
   unless ($ENV{Locale_VersionedMessages_RELEASE_TESTING}) {
      plan skip_all => 'Author tests not required for installation (set Locale_VersionedMessages_RELEASE_TESTING to test)';
   }
}
