package Google::Ads::AdWords::v201609::CampaignExtensionSetting;
use strict;
use warnings;
...
CampaignExtensionSetting from the namespace https://adwords.google.com/api/adwords/cm/v201609.
