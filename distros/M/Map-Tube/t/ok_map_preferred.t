...
is( $ret,
    join( ', ',
          ...
          'Liverpool Street (Central, Circle, Elizabeth, Hammersmith and City, Metropolitan, Weaver)',
...
is( $ret,
    join( ', ',
          ...
          'Upton Park (District, Hammersmith and City)',
          'Plaistow (District, Hammersmith and City)',
          'West Ham (District, Elizabeth, Hammersmith and City)',
          'Stratford (Elizabeth)',
          'Whitechapel (Elizabeth)',
          'Liverpool Street (Elizabeth, Northern)',
          'Bank (Northern)',
          'Waterloo (Northern)',
          'Kennington (Northern)',
          'Oval (Northern)',
