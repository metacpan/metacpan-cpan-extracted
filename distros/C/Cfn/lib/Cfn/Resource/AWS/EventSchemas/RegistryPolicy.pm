...
Cfn::Resource::AWS::EventSchemas::RegistryPolicy - Cfn resource for AWS::EventSchemas::RegistryPolicy

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::EventSchemas::RegistryPolicy.
