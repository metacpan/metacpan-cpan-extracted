...
Data::Sah::Coerce::perl::float::str_num_id - Parse number using Parse::Number::ID

=head1 VERSION

This document describes version 0.003 of Data::Sah::Coerce::perl::float::str_num_id (from Perl distribution Data-Sah-CoerceBundle-Num-str_num_id), released on 2019-07-26.
