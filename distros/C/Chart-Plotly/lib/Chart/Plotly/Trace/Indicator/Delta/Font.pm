package Chart::Plotly::Trace::Indicator::Delta::Font;
use Moose;
...
has description => ( is      => "ro",
                     default => "Set the font used to display the delta", );
...
Chart::Plotly::Trace::Indicator::Delta::Font - This attribute is one of the possible options for the trace indicator.
