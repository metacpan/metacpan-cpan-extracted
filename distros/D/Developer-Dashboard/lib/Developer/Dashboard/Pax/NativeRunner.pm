package Developer::Dashboard::Pax::NativeRunner;
...
Developer::Dashboard::Pax::NativeRunner - native artifact launcher and fallback bridge

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::NativeRunner;

  my $obj = Developer::Dashboard::Pax::NativeRunner->new(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::NativeRunner -e 1
