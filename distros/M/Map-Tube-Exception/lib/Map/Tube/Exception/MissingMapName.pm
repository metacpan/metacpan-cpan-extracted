package Map::Tube::Exception::MissingMapName;
$Map::Tube::Exception::MissingLineName::AUTHORITY = 'cpan:MANWAR';
$Map::Tube::Exception::MissingLineName::VERSION = '3.25';
=head1 NAME

Map::Tube::Exception::MissingMapName - Represent 'missing map name' exception.
...
has status => (is => 'ro', default => sub { 134 });
