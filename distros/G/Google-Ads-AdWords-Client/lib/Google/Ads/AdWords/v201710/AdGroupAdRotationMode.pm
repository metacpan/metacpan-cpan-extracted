package Google::Ads::AdWords::v201710::AdGroupAdRotationMode;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'adRotationMode' => 'Google::Ads::AdWords::v201710::AdRotationMode',
    },
    {
...
Google::Ads::AdWords::v201710::AdGroupAdRotationMode

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupAdRotationMode from the namespace https://adwords.google.com/api/adwords/cm/v201710.
