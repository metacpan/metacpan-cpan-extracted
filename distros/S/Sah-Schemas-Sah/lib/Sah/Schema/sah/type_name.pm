...
This document describes version 0.9.49.1 of Sah::Schema::sah::type_name (from Perl distribution Sah-Schemas-Sah), released on 2020-05-08.
...
Using with L<Data::Sah>:
 ...
 my $vdr = gen_validator("sah::type_name*");
