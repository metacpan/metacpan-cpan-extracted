	...
	default		=> sub { {
		...
		'NZD' => {
			...
			display_name => {
				...
				'other' => q(Tola fakanuʻusila),
			},
		},
		'PGK' => {
			display_name => {
				'currency' => q(Kina fakapapuaniukini),
				'other' => q(Kina fakapapuaniukini),
			},
		},
		'SBD' => {
			symbol => 'S$',
