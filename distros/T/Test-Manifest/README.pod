...
the source repository: L<https://github.com/briandfoy/test-manifest>
...
=item * L<https://bitbucket.com/briandfoy/test-manifest>

=item * L<https://codeberg.org/briandfoy/test-manifest>

=item * L<https://gitlab.com/briandfoy/test-manifest>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify Test-Manifest-1.23.tar.gz --owner briandfoy
