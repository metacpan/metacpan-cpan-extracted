...
package TeX::Hyphen::Pattern::El_monoton v1.1.7;
use strict;
use warnings;
use 5.014000;
use utf8;
...
sub version {
    return $TeX::Hyphen::Pattern::El_monoton::VERSION;
}
...
=for stopwords CTAN Ipenburg El_monoton

=head1 NAME

TeX::Hyphen::Pattern::El_monoton - class for hyphenation in locale El_monoton
