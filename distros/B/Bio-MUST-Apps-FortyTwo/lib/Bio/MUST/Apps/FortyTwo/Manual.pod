...
=for todo TODO: try to include a description for CPAN (ABSTRACT does not work here)
    TODO: devise a way to get correct internal links in .md doc
...
C<42> is written in I<Modern Perl> but relies on two external dependencies:
