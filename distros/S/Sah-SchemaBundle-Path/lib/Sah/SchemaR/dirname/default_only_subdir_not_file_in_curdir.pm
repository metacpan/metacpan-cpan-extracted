...
Sah::SchemaR::dirname::default_only_subdir_not_file_in_curdir - Directory name, defaults to only subdirectory in current directory (if there is one) (files ignored)

=head1 VERSION

This document describes version 0.031 of Sah::SchemaR::dirname::default_only_subdir_not_file_in_curdir (from Perl distribution Sah-SchemaBundle-Path), released on 2024-02-16.
