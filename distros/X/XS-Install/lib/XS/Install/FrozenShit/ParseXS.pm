...
BEGIN {
  $VERSION = '3.57';
  require XS::Install::FrozenShit::ParseXS::Constants; XS::Install::FrozenShit::ParseXS::Constants->VERSION($VERSION);
  require XS::Install::FrozenShit::ParseXS::CountLines; XS::Install::FrozenShit::ParseXS::CountLines->VERSION($VERSION);
  require XS::Install::FrozenShit::ParseXS::Node; XS::Install::FrozenShit::ParseXS::Node->VERSION($VERSION);
  require XS::Install::FrozenShit::ParseXS::Utilities; XS::Install::FrozenShit::ParseXS::Utilities->VERSION($VERSION);
  require XS::Install::FrozenShit::ParseXS::Eval; XS::Install::FrozenShit::ParseXS::Eval->VERSION($VERSION);
}
...
# All the valid fields of an XS::Install::FrozenShit::ParseXS hash object. The 'use
...
BEGIN {
  ...
  'config_die_on_error',# Bool: make death() call die() rather than exit().
                        ...
                        # or from the $XS::Install::FrozenShit::ParseXS::DIE_ON_ERROR global.
...
sub process_file {
  my XS::Install::FrozenShit::ParseXS $self;
  ...
  if ($self->{config_WantLineNumbers}) {
    ...
    tie(*PSEUDO_STDOUT, 'XS::Install::FrozenShit::ParseXS::CountLines', $cfile, $Options{output});
  ...
  print <<EOM;
/*
 * This file was generated automatically by XS::Install::FrozenShit::ParseXS version $VERSION from the
...
EOM
 ...
 PARAGRAPH:
  while ($self->fetch_para()) {
    ...
    my XS::Install::FrozenShit::ParseXS::Node::Sig $sig
        = $self->{xsub_sig}
        = XS::Install::FrozenShit::ParseXS::Node::Sig->new();
...
EOF
    ...
    for (@{$self->{xsub_sig}{params}}) {
      push @{$self->{xsub_sig}{orig_params}},
        XS::Install::FrozenShit::ParseXS::Node::Param->new($_);
    }
...
EOF
      ...
      my $generic_xsub_keys =
        $XS::Install::FrozenShit::ParseXS::Constants::generic_xsub_keywords_alt;
...
sub INPUT_handler {
  ...
  for (;  !/^$BLOCK_regexp/o;  $_ = shift(@{ $self->{line} })) {
    ...
    if (defined $param) {
      ...
      $is_alien = 1;
      $param = XS::Install::FrozenShit::ParseXS::Node::Param->new({
                  var      => $var_name,
                  is_alien => 1,
               });
...
sub eval_output_typemap_code {
  my XS::Install::FrozenShit::ParseXS $self = shift;
  my ($code, $other) = @_;
  return XS::Install::FrozenShit::ParseXS::Eval::eval_output_typemap_code($self, $code, $other);
}

sub eval_input_typemap_code {
  my XS::Install::FrozenShit::ParseXS $self = shift;
  my ($code, $other) = @_;
  return XS::Install::FrozenShit::ParseXS::Eval::eval_input_typemap_code($self, $code, $other);
}
