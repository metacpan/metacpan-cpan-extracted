...
##----------------------------------------------------------------------------
package Net::API::Telegram::Animation;
BEGIN
{
	use strict;
...
sub file_name { return( shift->_set_get_scalar( 'file_name', @_ ) ); }
...
Net::API::Telegram::Animation - An animation file (GIF or H.264/MPEG-4 AVC video without sound)

=head1 SYNOPSIS

	my $msg = Net::API::Telegram::Animation->new( %data ) || 
	die( Net::API::Telegram::Animation->error, "\n" );

=head1 DESCRIPTION

L<Net::API::Telegram::Animation> is a Telegram Message Object as defined here L<https://core.telegram.org/bots/api#animation>
