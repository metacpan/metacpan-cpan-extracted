...
package TeX::Hyphen::Pattern::Ro v1.1.8;
use strict;
use warnings;
use 5.014000;
use utf8;
...
sub version {
    return $TeX::Hyphen::Pattern::Ro::VERSION;
}
...
=for stopwords CTAN Ipenburg Ro

=head1 NAME

TeX::Hyphen::Pattern::Ro - class for hyphenation in locale Ro
