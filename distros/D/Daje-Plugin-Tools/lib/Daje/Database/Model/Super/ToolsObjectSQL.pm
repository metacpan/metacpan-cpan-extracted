...
Daje::Database::Model::Super::ToolsObjectSQL
...
=head2 load_tools_object_sql_pkey($self,

 load_tools_object_sql_pkey($self,();

=head2 load_tools_objects_sql_fkey($self,

 load_tools_objects_sql_fkey($self,();
