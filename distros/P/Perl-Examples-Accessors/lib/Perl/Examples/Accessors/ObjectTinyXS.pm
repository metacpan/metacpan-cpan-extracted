...
Perl::Examples::Accessors::ObjectTinyXS

=head1 VERSION

This document describes version 0.131 of Perl::Examples::Accessors::ObjectTinyXS (from Perl distribution Perl-Examples-Accessors), released on 2017-10-15.

=head1 DESCRIPTION

This is an example of a class which uses L<Object::Tiny::XS>. It is hash-based.
