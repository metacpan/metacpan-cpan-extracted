package Perinci::Sub::XCompletion::kdeactivity_guid;
...
sub gen_completion {
    ...
    sub {
        ...
        Complete::KDEActivity::complete_kde_activity_guid(
            word => $word,
        );
    },
}
...
1;
# ABSTRACT: Generate completion for KDE activity GUID
...
Perinci::Sub::XCompletion::kdeactivity_guid - Generate completion for KDE activity GUID

=head1 VERSION

This document describes version 0.002 of Perinci::Sub::XCompletion::kdeactivity_guid (from Perl distribution Sah-SchemaBundle-KDEActivity), released on 2026-04-09.

=head1 SYNOPSIS

To use, put this in your L<Sah> schema's C<x.completion> attribute:

 'x.completion' => ['kdeactivity_guid'],
