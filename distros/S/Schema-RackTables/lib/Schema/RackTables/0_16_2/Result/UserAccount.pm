use utf8;
package Schema::RackTables::0_16_2::Result::UserAccount;
...
Schema::RackTables::0_16_2::Result::UserAccount
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:C2sbTicqNsqH1X1PRx9+aw
