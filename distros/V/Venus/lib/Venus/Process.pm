...
=item B<may raise> L<Venus::Process::Error> C<on.chdir>
...
=item B<may raise> L<Venus::Process::Error> C<on.stderr>
...
=item B<may raise> L<Venus::Process::Error> C<on.stdin>
...
=item B<may raise> L<Venus::Process::Error> C<on.stdout>
