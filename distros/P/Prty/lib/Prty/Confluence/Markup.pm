package Prty::Confluence::Markup;
...
Prty::Confluence::Markup - Confluence-Wiki Markup
...
Test-Seite von der Kommandozeile ins Wiki übertragen:
    ...
    $ prty-confluence test-page | prty-confluence update-page PAGE_ID
