...
The L<Mail::Box|Mail::Box> package has special features to help MUA's access folder
...
Any Message has the structure of the L<Mail::Message|Mail::Message>
...
L<Mail::Box|Mail::Box> report about problems, or do it all yourself.
