# This Makefile is for the AI::Logic::AnswerSet extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/AI/Logic/AnswerSet.pm]
#     AUTHOR => q[leviathan <leviathan@>]
#     BUILD_REQUIRES => {  }
#     NAME => q[AI::Logic::AnswerSet]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/AI/Logic/AnswerSet.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = AI::Logic::AnswerSet
NAME_SYM = AI_Logic_AnswerSet
VERSION = 0.01
...
MAKE = make
FULLEXT = AI/Logic/AnswerSet
BASEEXT = AnswerSet
PARENT_NAME = AI::Logic
DLBASE = $(BASEEXT)
VERSION_FROM = lib/AI/Logic/AnswerSet.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/AI/Logic/AnswerSet.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/AI/Logic
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/AI/Logic
...
TO_INST_PM = lib/AI/Logic/AnswerSet.pm
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               AI-Logic-AnswerSet' >> META_new.yml
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/AI/Logic/AnswerSet.pm blib/lib/AI/Logic/AnswerSet.pm 
