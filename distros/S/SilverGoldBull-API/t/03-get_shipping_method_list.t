...
ok( my $shipping_response = $sgb->get_shipping_method_list(), 'Get shipping method list response object' );
isa_ok($shipping_response, 'SilverGoldBull::API::Response');
can_ok($shipping_response, qw(is_success data));