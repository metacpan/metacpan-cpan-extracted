...
The integer square root of C<n> and the integer cube root of C<n>. Returns NaN when a real root does not exist.
...
The integer C<m-th> root of C<n>. Returns NaN when a real does not exist.
...
Returns C<(NaN,NaN)> when a real root does not exist.
...
Integer k-gonal root of C<n>. Returns NaN when a real root does not exist.
...
Second integer k-gonal root of C<n>. Returns NaN when a real root does not exist.
...
Copyright (C) 2017-2026 Daniel Șuteu
