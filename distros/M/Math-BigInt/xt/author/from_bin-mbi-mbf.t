...
subtest '$x = Math::BigFloat -> from_bin("100");'
  => sub {
      # this must not downgrade

      my $x = Math::BigFloat -> from_bin("100");        # = 4
...
subtest '$x = Math::BigFloat -> new("4.5"); $q = $x -> from_bin("100");'
  => sub {
      # this must not downgrade
...
subtest '$x = Math::BigInt -> from_bin("1.001p+2");'
  => sub {
      ...
      my $x = Math::BigInt -> from_bin("1.001p+2");     # = 4.5
