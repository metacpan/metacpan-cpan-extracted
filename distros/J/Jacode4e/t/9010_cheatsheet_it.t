...
#
#   $line             : stringa da convertire (passata per riferimento, sovrascritta in loco)
#   $OUTPUT_encoding  : nome della codifica di output
#   $INPUT_encoding   : nome della codifica di input
#   $char_count       : numero di caratteri dopo la conversione
#
# [NOMI DI CODIFICA]
#
#   mnemonico   significato
#   ---------   ---------------------------------------------------
#   cp932x      CP932X (estensione a JIS X 0213, shift singolo 0x9C5A)
...
#   jef         FUJITSU JEF (12pt, codici di spostamento con OUTPUT_SHIFTING)
#   jef9p       FUJITSU JEF ( 9pt, codici di spostamento con OUTPUT_SHIFTING)
#   jipsj       NEC JIPS(J)
#   jipse       NEC JIPS(E)
#   letsj       UNISYS LetsJ
#   utf8        UTF-8.0 (il comune UTF-8)
#   utf8.1      UTF-8.1 (conversione basata sulla corrispondenza Shift_JIS-Unicode, non CP932)
#   utf8jp      UTF-8-SPUA-JP (JIS X 0213 mappato nell'area SPUA di Unicode)
#
# [OPZIONI]
#
#   chiave            valore / descrizione
#   ---------------   ---------------------------------------------------
#   INPUT_LAYOUT      layout del record di input ('S'=SBCS, 'D'=DBCS, con contatore)
#   OUTPUT_SHIFTING   se vero, inserisce codici di spostamento attorno alle sequenze DBCS
#   SPACE             codice spazio DBCS/MBCS (stringa binaria)
#   GETA              simbolo geta per caratteri non mappabili
#   OVERRIDE_MAPPING  sostituzione per carattere { "\x12\x34"=>"\x56\x78" }
#
# [AVVERTENZA: CONVERSIONE DI ANDATA E RITORNO]
#
#   Esistono conversioni con perdita (es. CP932 ha 398 mappature non reversibili).
#   Per la conversione di andata e ritorno, usare il modulo Jacode4e::RoundTrip.
#
# ======================================================================
...
BEGIN {
    ...
    @test = (
        ...
        # --- UTF-8.1: conversione basata su Shift_JIS-Unicode, non CP932 ---
