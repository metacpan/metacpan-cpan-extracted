	...
	default		=> sub { 
		{
			'001' => 'વિશ્વ',
 			...
 			'FJ' => 'ફીજી',
 			'FK' => 'ફૉકલેન્ડ ટાપુઓ',
 			'FK@alt=variant' => 'ફૉકલેન્ડ ટાપુઓ (ઇસ્લાસ માલવિનસ)',
 			'FM' => 'માઇક્રોનેશિયા',
 			'FO' => 'ફૅરો ટાપુઓ',
 			'FR' => 'ફ્રાંસ',
 			'GA' => 'ગેબન',
	...
	default		=> sub {
		{
			'calendar' => {
 			...
 			'numbers' => {
 				...
 				'hansfin' => q{સરળીકૃત ચાઇનીઝ નાણાંકીય સંખ્યાઓ},
	...
	default	=> sub { {
		...
		'America_Central' => {
			long => {
				...
				'standard' => q(ઉત્તર અમેરિકન કેન્દ્રિય પ્રમાણભૂત સમય),
			},
		},
		'America_Eastern' => {
			long => {
		...
		'Apia' => {
			long => {
				'daylight' => q(અપિયા દિવસ સમય),
				'generic' => q(એપિયા સમય),
				'standard' => q(એપિયા પ્રમાણભૂત સમય),
			},
		},
		'Aqtau' => {
			long => {
		...
		'Australia_Eastern' => {
			long => {
				...
				'standard' => q(ઓસ્ટ્રેલિયન પૂર્વીય પ્રમાણભૂત સમય),
			},
		},
		'Australia_Western' => {
			long => {
		...
		'Europe_Further_Eastern' => {
			long => {
				'standard' => q(આગળનું-પૂર્વીય યુરોપીયન સમય),
			},
		},
		'Europe_Western' => {
			long => {
		...
		'Mexico_Pacific' => {
			long => {
				'daylight' => q(મેક્સીકન પેસિફિક દિવસ સમય),
				'generic' => q(મેક્સીકન પેસિફિક સમય),
				'standard' => q(મેક્સીકન પેસિફિક માનક સમય),
			},
		},
		'Mongolia' => {
			long => {
