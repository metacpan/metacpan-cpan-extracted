...
is $object->param(darkcolor => 'red')->param('darkcolor'), 'red',
  'Set color to red';
is $object->param(darkcolor => '')->param('darkcolor'), $defaults{darkcolor},
...
is $object->param(darkcolor => 'red')->param(size => 7), $object,
