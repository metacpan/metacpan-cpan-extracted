package Chart::Plotly::Trace::Ohlc::Hoverlabel;
use Moose;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Ohlc::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Ohlc::Hoverlabel - This attribute is one of the possible options for the trace ohlc.
