...
package WebService::Edgecast::auto::RealTime::Element::StreamsGet;
BEGIN {
  $WebService::Edgecast::auto::RealTime::Element::StreamsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('StreamsGet');
...
WebService::Edgecast::auto::RealTime::Element::StreamsGet
...
StreamsGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::RealTime::Element::StreamsGet->new($data);
