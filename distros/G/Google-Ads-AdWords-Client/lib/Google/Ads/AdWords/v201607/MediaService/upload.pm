...
package Google::Ads::AdWords::v201607::MediaService::upload;
use strict;
use warnings;
...
upload from the namespace https://adwords.google.com/api/adwords/cm/v201607.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201607::MediaService::upload->new($data);
