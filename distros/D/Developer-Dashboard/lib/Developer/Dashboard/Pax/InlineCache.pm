...
Developer::Dashboard::Pax::InlineCache - inline-cache state tracker

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::InlineCache;

  my $obj = Developer::Dashboard::Pax::InlineCache->new(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::InlineCache -e 1
