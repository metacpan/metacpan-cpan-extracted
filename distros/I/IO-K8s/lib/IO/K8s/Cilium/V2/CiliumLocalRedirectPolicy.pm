...
IO::K8s::Cilium::V2::CiliumLocalRedirectPolicy - CiliumLocalRedirectPolicy is a Kubernetes Custom Resource that contains a specification to redirect traffic locally within a node.
