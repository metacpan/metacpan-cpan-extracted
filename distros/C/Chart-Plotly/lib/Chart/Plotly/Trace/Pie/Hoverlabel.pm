package Chart::Plotly::Trace::Pie::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Pie::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Pie::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Pie::Hoverlabel - This attribute is one of the possible options for the trace pie.
