...
This document describes version 0.015 of Sah::Schema::hexstr (from Perl distribution Sah-Schemas-Str), released on 2023-09-03.
...
=head2 Sample data and validation results against this schema
 ...
 "A0"  # valid (Uppercase digits are allowed, not coerced to lowercase)

 "a0f"  # INVALID (Odd number of digits (3))

 "a0ff"  # valid

 "a0 ff 61"  # valid (Whitespace will be removed), becomes "a0ff61"
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('hexstr*', name=>'Hexstr')
     );
 }

 use My::Types qw(Hexstr);
 Hexstr->assert_valid($data);
