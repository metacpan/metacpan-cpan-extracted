...
$t->get_ok('/')
  ->status_is(200)
  ->text_is('title'    => 'Blog')
  ->text_is('body > a' => 'New post')
  ->element_exists_not('h2');

# Create a new post
$t->get_ok('/posts/create')
  ->status_is(200)
  ->text_is('title' => 'New post')
...
# Update the post
$t->get_ok('/posts/1/edit')
  ->status_is(200)
  ->text_is('title' => 'Edit post')
...
$t->post_ok('/posts/1?_method=PUT' => form => {title => 'Again', body => 'It works.'})
  ->status_is(200)
  ->text_is('title' => 'Again')
  ->text_is('h2'    => 'Again')
