...
######################################################################
#
# Etis620 - Run-time routines for TIS620.pm
#
# http://search.cpan.org/dist/Char-TIS620/
#
...
#
# TIS-620 character range per length
#
my %range_tr = ();

#
# TIS-620 case conversion
#
my %lc = ();
...
sub import {
    ...
    *Char::ord           = \&TIS620::ord;
    *Char::ord_          = \&TIS620::ord_;
    *Char::reverse       = \&TIS620::reverse;
    *Char::getc          = \&TIS620::getc;
    *Char::length        = \&TIS620::length;
    *Char::substr        = \&TIS620::substr;
    *Char::index         = \&TIS620::index;
    *Char::rindex        = \&TIS620::rindex;
    *Char::eval          = \&TIS620::eval;
    *Char::escape        = \&TIS620::escape;
    *Char::escape_token  = \&TIS620::escape_token;
    *Char::escape_script = \&TIS620::escape_script;
}
...
sub Etis620::rindex($$;$);
sub Etis620::lcfirst(@);
sub Etis620::lcfirst_();
sub Etis620::lc(@);
sub Etis620::lc_();
sub Etis620::ucfirst(@);
sub Etis620::ucfirst_();
sub Etis620::uc(@);
sub Etis620::uc_();
sub Etis620::fc(@);
sub Etis620::fc_();
sub Etis620::ignorecase;
sub Etis620::classic_character_class;
sub Etis620::capture;
sub Etis620::chr(;$);
sub Etis620::chr_();
sub Etis620::glob($);
...
# ${Etis620::eS}          = qr{(?>[^\x09\x0A    \x0C\x0D\x20])};
# ${Etis620::eS}          = qr{(?>[^\x09\x0A\x0B\x0C\x0D\x20])};
${Etis620::eS}            = qr{(?>[^\s])};

${Etis620::eW}            = qr{(?>[^0-9A-Z_a-z])};
${Etis620::eH}            = qr{(?>[^\x09\x20])};
${Etis620::eV}            = qr{(?>[^\x0A\x0B\x0C\x0D])};
${Etis620::eR}            = qr{(?>\x0D\x0A|[\x0A\x0D])};
${Etis620::eN}            = qr{(?>[^\x0A])};
${Etis620::not_alnum}     = qr{(?>[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Etis620::not_alpha}     = qr{(?>[^\x41-\x5A\x61-\x7A])};
${Etis620::not_ascii}     = qr{(?>[^\x00-\x7F])};
${Etis620::not_blank}     = qr{(?>[^\x09\x20])};
${Etis620::not_cntrl}     = qr{(?>[^\x00-\x1F\x7F])};
${Etis620::not_digit}     = qr{(?>[^\x30-\x39])};
${Etis620::not_graph}     = qr{(?>[^\x21-\x7F])};
${Etis620::not_lower}     = qr{(?>[^\x61-\x7A])};
${Etis620::not_lower_i}   = qr{(?>[^\x41-\x5A\x61-\x7A])}; # Perl 5.16 compatible
# ${Etis620::not_lower_i} = qr{(?>[\x00-\xFF])};                   # older Perl compatible
${Etis620::not_print}     = qr{(?>[^\x20-\x7F])};
${Etis620::not_punct}     = qr{(?>[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Etis620::not_space}     = qr{(?>[^\s\x0B])};
${Etis620::not_upper}     = qr{(?>[^\x41-\x5A])};
${Etis620::not_upper_i}   = qr{(?>[^\x41-\x5A\x61-\x7A])}; # Perl 5.16 compatible
# ${Etis620::not_upper_i} = qr{(?>[\x00-\xFF])};                   # older Perl compatible
${Etis620::not_word}      = qr{(?>[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Etis620::not_xdigit}    = qr{(?>[^\x30-\x39\x41-\x46\x61-\x66])};
${Etis620::eb}            = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Etis620::eB}            = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Etis620::foo" used only once: possible typo at here.
${Etis620::dot}         = ${Etis620::dot};
${Etis620::dot_s}       = ${Etis620::dot_s};
${Etis620::eD}          = ${Etis620::eD};
${Etis620::eS}          = ${Etis620::eS};
${Etis620::eW}          = ${Etis620::eW};
${Etis620::eH}          = ${Etis620::eH};
${Etis620::eV}          = ${Etis620::eV};
${Etis620::eR}          = ${Etis620::eR};
${Etis620::eN}          = ${Etis620::eN};
${Etis620::not_alnum}   = ${Etis620::not_alnum};
${Etis620::not_alpha}   = ${Etis620::not_alpha};
${Etis620::not_ascii}   = ${Etis620::not_ascii};
${Etis620::not_blank}   = ${Etis620::not_blank};
${Etis620::not_cntrl}   = ${Etis620::not_cntrl};
${Etis620::not_digit}   = ${Etis620::not_digit};
${Etis620::not_graph}   = ${Etis620::not_graph};
${Etis620::not_lower}   = ${Etis620::not_lower};
${Etis620::not_lower_i} = ${Etis620::not_lower_i};
${Etis620::not_print}   = ${Etis620::not_print};
${Etis620::not_punct}   = ${Etis620::not_punct};
${Etis620::not_space}   = ${Etis620::not_space};
${Etis620::not_upper}   = ${Etis620::not_upper};
${Etis620::not_upper_i} = ${Etis620::not_upper_i};
${Etis620::not_word}    = ${Etis620::not_word};
${Etis620::not_xdigit}  = ${Etis620::not_xdigit};
${Etis620::eb}          = ${Etis620::eb};
${Etis620::eB}          = ${Etis620::eB};
...
#
# TIS-620 lower case first with parameter
#
sub Etis620::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Etis620::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Etis620::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Etis620::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# TIS-620 lower case first without parameter
#
sub Etis620::lcfirst_() {
    return Etis620::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# TIS-620 lower case with parameter
#
sub Etis620::lc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# TIS-620 lower case without parameter
#
sub Etis620::lc_() {
    my $s = $_;
    return join '', map {defined($lc{$_}) ? $lc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# TIS-620 upper case first with parameter
#
sub Etis620::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Etis620::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Etis620::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Etis620::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# TIS-620 upper case first without parameter
#
sub Etis620::ucfirst_() {
    return Etis620::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# TIS-620 upper case with parameter
#
sub Etis620::uc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# TIS-620 upper case without parameter
#
sub Etis620::uc_() {
    my $s = $_;
    return join '', map {defined($uc{$_}) ? $uc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# TIS-620 fold case with parameter
#
sub Etis620::fc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# TIS-620 fold case without parameter
#
sub Etis620::fc_() {
    my $s = $_;
    return join '', map {defined($fc{$_}) ? $fc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# TIS-620 regexp ignore case modifier
#
sub Etis620::ignorecase {
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Etis620::uc($char[$i]);
                my $fc = Etis620::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
#
# prepare TIS-620 characters per length
#
...
#
# TIS-620 open character list for tr
#
sub _charlist_tr {
...
#
# TIS-620 open character list for qr and not qr
#
sub _charlist {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Etis620::not_lower_i}',
                '[:^upper:]'  => '${Etis620::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Etis620::not_alnum}',
                '[:^alpha:]'  => '${Etis620::not_alpha}',
                '[:^ascii:]'  => '${Etis620::not_ascii}',
                '[:^blank:]'  => '${Etis620::not_blank}',
                '[:^cntrl:]'  => '${Etis620::not_cntrl}',
                '[:^digit:]'  => '${Etis620::not_digit}',
                '[:^graph:]'  => '${Etis620::not_graph}',
                '[:^lower:]'  => '${Etis620::not_lower}',
                '[:^print:]'  => '${Etis620::not_print}',
                '[:^punct:]'  => '${Etis620::not_punct}',
                '[:^space:]'  => '${Etis620::not_space}',
                '[:^upper:]'  => '${Etis620::not_upper}',
                '[:^word:]'   => '${Etis620::not_word}',
                '[:^xdigit:]' => '${Etis620::not_xdigit}',
...
#
# TIS-620 hexadecimal escape sequence
#
sub hexchr {
    my($hexdigit) = @_;
...
#
# TIS-620 open character list for qr
#
sub charlist_qr {
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Etis620::uc($char);
                        my $fc = Etis620::fc($char);
                        if ($uc eq $fc) {
...
#
# TIS-620 open character list for not qr
#
sub charlist_not_qr {
...
#
# TIS-620 order to character (with parameter)
#
sub Etis620::chr(;$) {
...
#
# TIS-620 order to character (without parameter)
#
sub Etis620::chr_() {
...
#
# TIS-620 path globbing (with parameter)
#
sub Etis620::glob($) {
...
#
# TIS-620 path globbing (without parameter)
#
sub Etis620::glob_() {
...
#
# TIS-620 path globbing via File::DosGlob 1.10
#
...
#
# TIS-620 path globbing subroutine
#
sub _do_glob {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Etis620::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Etis620::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Etis620::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Etis620::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
#
sub Etis620::POSTMATCH {
    return $';
}

#
# TIS-620 character to order (with parameter)
#
sub TIS620::ord(;$) {
...
#
# TIS-620 character to order (without parameter)
#
sub TIS620::ord_() {
...
#
# TIS-620 getc (with parameter, without parameter)
#
sub TIS620::getc(;*@) {

    my($package) = caller;
    my $fh = @_ ? qualify_to_ref(shift,$package) : \*STDIN;
    croak 'Too many arguments for TIS620::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Etis620::dot_s} \z/oxms) {
...
#
# TIS-620 index by character
#
sub TIS620::index($$;$) {

    my $index;
    if (@_ == 3) {
        $index = Etis620::index($_[0], $_[1], CORE::length(TIS620::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Etis620::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return TIS620::length(CORE::substr $_[0], 0, $index);
    }
}

#
# TIS-620 rindex by character
#
sub TIS620::rindex($$;$) {

    my $rindex;
    if (@_ == 3) {
        $rindex = Etis620::rindex($_[0], $_[1], CORE::length(TIS620::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Etis620::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return TIS620::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
# ord() to ord() or TIS620::ord()
my $function_ord = 'ord';

# ord to ord or TIS620::ord_
my $function_ord_ = 'ord';

# reverse to reverse or TIS620::reverse
my $function_reverse = 'reverse';

# getc to getc or TIS620::getc
...
my $qq_substr  = qr{(?> Char::substr | TIS620::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
#
# escape TIS-620 token of script
#
sub TIS620::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Etis620::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ (?>\s*) PREMATCH  \b | \$ (?>\s*) \{ (?>\s*) PREMATCH  (?>\s*) \} | \$ (?>\s*) \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Etis620::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Etis620::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Etis620::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Etis620::POSTMATCH()
    elsif (/\G (                 \$ (?>\s*) POSTMATCH \b | \$ (?>\s*) \{ (?>\s*) POSTMATCH (?>\s*) \} | \$ (?>\s*) \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Etis620::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Etis620::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob (?>\s*) \) /oxgc) {
        return 'while ($_ = Etis620::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob \b /oxgc) {
        return 'while ($_ = Etis620::glob';
    }
...
# subroutines of package Etis620
    elsif (/\G \b (CORE:: | ->(>?\s*) (?: atan2 | [a-z]{2,})) \b       /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b TIS620::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Char::escape'; }
    elsif (/\G \b TIS620::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval TIS620::escape'; }
    elsif (/\G \b bytes::substr \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Etis620::chop';       }
    elsif (/\G \b bytes::index \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::index';       }
    elsif (/\G \b TIS620::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'TIS620::index';       }
    elsif (/\G \b index \b         (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Etis620::index';      }
    elsif (/\G \b bytes::rindex \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::rindex';      }
    elsif (/\G \b TIS620::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'TIS620::rindex';      }
    elsif (/\G \b rindex \b        (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Etis620::rindex';     }
    elsif (/\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Etis620::lc';         }
    elsif (/\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Etis620::lcfirst';    }
    elsif (/\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Etis620::uc';         }
    elsif (/\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Etis620::ucfirst';    }
    elsif (/\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Etis620::fc';         }
    ...
    elsif (/\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Etis620::chr';               }
    elsif (/\G \b bytes::ord    (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Etis620::glob';              }
    elsif (/\G \b lc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Etis620::lc_';               }
    elsif (/\G \b lcfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Etis620::lcfirst_';          }
    elsif (/\G \b uc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Etis620::uc_';               }
    elsif (/\G \b ucfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Etis620::ucfirst_';          }
    elsif (/\G \b fc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Etis620::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Etis620::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Etis620::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Etis620::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Etis620::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq           (\#) [ ] (\#) /oxgc) { return 'Etis620::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Etis620::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Etis620::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Etis620::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Etis620::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Etis620::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q            (\#) [ ] (\#) /oxgc) { return 'Etis620::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Etis620::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Etis620::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Etis620::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Etis620::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Etis620::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                    ' [ ] '    /oxgc) { return 'Etis620::split' . $e . qq     {' '};  }
        elsif (/\G                    " [ ] "    /oxgc) { return 'Etis620::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Etis620::PREMATCH()]}
            ...
            $e_string .= q{Etis620::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Etis620::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Etis620::MATCH()};
            $slash = 'div';
        }
...
# subroutines of package Etis620
        ...
        elsif ($string =~ /\G \b TIS620::eval       (?= (?>\s*) \{ )                    /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::eval \b                                        /oxgc) { $e_string .= 'eval Char::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b TIS620::eval \b                                        /oxgc) { $e_string .= 'eval TIS620::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                                     /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                              /oxgc) { $e_string .= 'Etis620::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                                      /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::index \b                                       /oxgc) { $e_string .= 'Char::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b TIS620::index \b                                       /oxgc) { $e_string .= 'TIS620::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                             /oxgc) { $e_string .= 'Etis620::index';      $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b TIS620::rindex \b                                      /oxgc) { $e_string .= 'TIS620::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                            /oxgc) { $e_string .= 'Etis620::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Etis620::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Etis620::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Etis620::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Etis620::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Etis620::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Etis620::chr';           $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Etis620::glob';          $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                                      /oxgc) { $e_string .= 'Etis620::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                                 /oxgc) { $e_string .= 'Etis620::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                                      /oxgc) { $e_string .= 'Etis620::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                                 /oxgc) { $e_string .= 'Etis620::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                                      /oxgc) { $e_string .= 'Etis620::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                                     /oxgc) { $e_string .= 'Etis620::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                              /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                                     /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                                    /oxgc) { $e_string .= 'Etis620::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Etis620::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Etis620::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq           (\#) [ ] (\#) /oxgc) { $e_string .= 'Etis620::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { $e_string .= 'Etis620::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { $e_string .= 'Etis620::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { $e_string .= 'Etis620::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { $e_string .= 'Etis620::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { $e_string .= 'Etis620::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q            (\#) [ ] (\#) /oxgc) { $e_string .= 'Etis620::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { $e_string .= 'Etis620::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { $e_string .= 'Etis620::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { $e_string .= 'Etis620::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { $e_string .= 'Etis620::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { $e_string .= 'Etis620::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                    ' [ ] '    /oxgc) { $e_string .= 'Etis620::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                    " [ ] "    /oxgc) { $e_string .= 'Etis620::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        ...
        return Etis620::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Etis620::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Etis620::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Etis620::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Etis620::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Etis620::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Etis620::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Etis620::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Etis620::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Etis620::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Etis620::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Etis620::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Etis620::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Etis620::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Etis620::uc($char[$i]) ne Etis620::fc($char[$i]))) {
            if (CORE::length(Etis620::fc($char[$i])) == 1) {
                $char[$i] = '['   . Etis620::uc($char[$i])       . Etis620::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Etis620::uc($char[$i]) . '|' . Etis620::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Etis620::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ (?>\s*) 0 (?>\s*) \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Etis620::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Etis620::ignorecase(Etis620::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Etis620::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Etis620::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Etis620::ignorecase(Etis620::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Etis620::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Etis620::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Etis620::ignorecase(Etis620::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Etis620::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Etis620::re_t=%s; while($Etis620::re_t =~ %s){%s local $^W=0; local $Etis620::re_r=%s; %s$Etis620::re_t="$`$Etis620::re_r$'"; pos($Etis620::re_t)=length "$`$Etis620::re_r"; } return $Etis620::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Etis620::re_r=CORE::eval $Etis620::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Etis620::re_r=%s; %s"%s$Etis620::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Etis620::re_n=0; while(%s =~ %s){%s local $^W=0; local $Etis620::re_r=%s; %s%s="$`$Etis620::re_r$'"; pos(%s)=length "$`$Etis620::re_r"; $Etis620::re_n++} return %s$Etis620::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Etis620::re_r=%s; %s%s="%s$Etis620::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Etis620::re_r=%s; %s%s="%s$Etis620::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Etis620::re_r=CORE::eval $Etis620::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Etis620::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Etis620::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  # "no Etis620;" not supported

=head1 ABSTRACT

This module has run-time routines for use TIS620 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in TIS620 software and not
...
This Etis620 module first appeared in ActivePerl Build 522 Built under
...
=item * Split string
  ...
  @split = Etis620::split(/pattern/,$string,$limit);
  @split = Etis620::split(/pattern/,$string);
  @split = Etis620::split(/pattern/);
  @split = Etis620::split('',$string,$limit);
  @split = Etis620::split('',$string);
  @split = Etis620::split('');
  @split = Etis620::split();
  @split = Etis620::split;
  ...
  at all, Etis620::split returns the original string as a single substring, If it
  ...
  @chars  = Etis620::split(//,  $word);
  @fields = Etis620::split(/:/, $line);
  @words  = Etis620::split(" ", $paragraph);
  @lines  = Etis620::split(/^/, $buffer);
  ...
  print join(":" => Etis620::split(/ */, "hi there"));
  ...
  Etis620::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Etis620::split(/:/, $_, 3);
  ...
  splits on whitespace just as Etis620::split with no arguments does. Thus,
  Etis620::split(" ") can be used to emulate awk's default behavior. In contrast,
  Etis620::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Etis620::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Etis620::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Etis620::split()) {
          $count{$word}++;
      }
  }

  The inverse of Etis620::split is join, except that join can only join with the
...
=item * Transliteration
  ...
  $tr = Etis620::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Etis620::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  This subroutine scans a TIS-620 string character by character and replaces all
  occurrences of the characters found in $searchlist with the corresponding character
  in $replacementlist. It returns the number of characters replaced or deleted.
  If no TIS-620 string is specified via =~ operator, the $_ variable is translated.
  $modifier are:
  ...
  print Etis620::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item * Chop string

  $chop = Etis620::chop(@list);
  $chop = Etis620::chop();
  $chop = Etis620::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Etis620::chop subroutine is used primary to remove the newline
  ...
  since Etis620::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Etis620::chop a literal, only a variable. If you Etis620::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Etis620::chop(@lines);

  You can Etis620::chop anything that is an lvalue, including an assignment:

  Etis620::chop($cwd = `pwd`);
  Etis620::chop($answer = <STDIN>);

  This is different from:

  $answer = Etis620::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Etis620::chop returns the character
  ...
  In the most general case, Etis620::chop can be expressed using substr:

  $last_code = Etis620::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Etis620::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Etis620::chop;
...
=item * Index string
  ...
  $byte_pos = Etis620::index($string,$substr,$byte_offset);
  $byte_pos = Etis620::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Etis620::index($string, $lookfor, $byte_pos)) > -1) {
...
=item * Reverse index string
  ...
  $byte_pos = Etis620::rindex($string,$substr,$byte_offset);
  $byte_pos = Etis620::rindex($string,$substr);

  This subroutine works just like Etis620::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Etis620::index).
  ...
  while (($byte_pos = TIS620::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item * Lower case string
  ...
  $lc = Etis620::lc($string);
  $lc = Etis620::lc_;

  This subroutine returns a lowercased version of TIS-620 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Etis620::fc subroutine for case-insensitive comparisons via TIS620
  software.

=item * Lower case first character of string

  $lcfirst = Etis620::lcfirst($string);
  $lcfirst = Etis620::lcfirst_;

  This subroutine returns a version of TIS-620 $string with the first character
  lowercased (or $_, if $string is omitted). This is the internal subroutine
  implementing the \l escape in double-quoted strings.

=item * Upper case string

  $uc = Etis620::uc($string);
  $uc = Etis620::uc_;

  This subroutine returns an uppercased version of TIS-620 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Etis620::ucfirst instead.
...
=item * Upper case first character of string
  ...
  $ucfirst = Etis620::ucfirst($string);
  $ucfirst = Etis620::ucfirst_;
  ...
  $titlecase = Etis620::ucfirst(substr($word,0,1)) . Etis620::lc(substr($word,1));
  ...
  $do_not_use = Etis620::ucfirst(Etis620::lc($word));
...
=item * Fold case string
  ...
  $fc = Etis620::fc($string);
  $fc = Etis620::fc_;

  New to TIS620 software, this subroutine returns the full Unicode-like casefold of
  TIS-620 $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Etis620::fc($a) eq Etis620::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because TIS620 software has always used casefolding semantics for
...
=item * Make ignore case string
  ...
  @ignorecase = Etis620::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item * Make capture number

  $capturenumber = Etis620::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item * Make character

  $chr = Etis620::chr($code);
  $chr = Etis620::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Etis620::chr(65) is "A" in either
  ASCII or TIS-620, not Unicode. For the reverse of Etis620::chr, use TIS620::ord.

=item * Filename expansion (globbing)

  @glob = Etis620::glob($string);
  @glob = Etis620::glob_;
  ...
  The Etis620::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Etis620::glob('"*e f*"');
  @spacies = Etis620::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Etis620::glob("'*${var}e f*'");
  @spacies = Etis620::glob(qq("*${var}e f*"));
