...
package UMMF::MOF_1_4_1::Model::String;
...
Constructs new UMMF::MOF_1_4_1::Model::String value.
...
sub new
{
  ...
  __typecheck($self, $x, 'UMMF::MOF_1_4_1::Model::String::new');
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_4_1::Model::String->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_4_1::Model::String|UMMF::MOF_1_4_1::Model::String>.
...
=head2 C<__typecheck>
  ...
  UMMF::MOF_1_4_1::Model::String->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_4_1::Model::String->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_4_1::Model::String' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_4_1::Model::String|UMMF::MOF_1_4_1::Model::String>.
...
sub __initialize
{
  ...
  $self->UMMF::MOF_1_4_1::Model::String::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_4_1::Model::String::___create(@args);
