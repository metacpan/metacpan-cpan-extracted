...
Locale::CLDR::Locales::En::Latn::Za - Package for language English

=cut

package Locale::CLDR::Locales::En::Latn::Za;
...
has 'characters' => (
	...
	sub {
		...
		return {
			auxiliary => qr{[áàăâåäā æ ç ḓ éèĕêëē íìĭîïī ḽ ñṅṋ óòŏôöøō œ š ṱ úùŭûüū ÿ]},
