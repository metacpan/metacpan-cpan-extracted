...
1;
# ABSTRACT: Single line border with ASCII characters, outer borders only
...
BorderStyle::ASCII::SingleLineOuterOnly - Single line border with ASCII characters, outer borders only

=head1 VERSION

This document describes version 0.011 of BorderStyle::ASCII::SingleLineOuterOnly (from Perl distribution BorderStyles-Standard), released on 2022-01-26.
...
To use with L<Text::ANSITable>:
 ...
 $t->border_style("ASCII::SingleLineOuterOnly");
 $t->columns($rows->[0]);
...
To use with L<Text::Table::More>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"ASCII::SingleLineOuterOnly");
...
To use with L<Text::Table::TinyBorderStyle>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"BorderStyle::ASCII::SingleLineOuterOnly");
