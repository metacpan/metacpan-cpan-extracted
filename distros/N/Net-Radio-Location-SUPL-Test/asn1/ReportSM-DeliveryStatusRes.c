...
static int asn_MAP_ReportSM_DeliveryStatusRes_oms_1[] = { 0, 1 };
...
static asn_TYPE_tag2member_t asn_MAP_ReportSM_DeliveryStatusRes_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 0, 0, 0 }, /* storedMSISDN at 201 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, 0, 0 } /* extensionContainer at 202 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ReportSM_DeliveryStatusRes_specs_1 = {
	...
	asn_MAP_ReportSM_DeliveryStatusRes_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	1,	/* Start extensions */
	3	/* Stop extensions */
};
