...
#                                                                              #
# Description:                                                                 # 
# Query bandwidth information of a Tron account from the Tron blockchain using #
...
CryptoTron::GetAccountNet - Perl extension for use with the blockchain of the crypto coin Tron.
...
The module requests the bandwidth information of an Tron account from the
