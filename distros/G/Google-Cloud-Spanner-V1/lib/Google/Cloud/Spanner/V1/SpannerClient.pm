package Google::Cloud::Spanner::V1::SpannerClient;
...
sub create_session {
    ...
    my $request_class = 'Google::Spanner::V1::Spanner::CreateSessionRequest';
    my $request = eval { $request_class->new(\%params) } || eval { $request_class->new(%params) } || ($request_class->can('encode') ? $request_class->encode(\%params) : \%params);

    my $response_class = 'Google::Spanner::V1::Spanner::Session';
...
1; # End of Google::Cloud::Spanner::V1::SpannerClient

__END__

=head1 NAME

Google::Cloud::Spanner::V1::SpannerClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Spanner::V1::SpannerClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Spanner::V1::SpannerClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Spanner::V1::SpannerClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Spanner::V1::SpannerClient->new(
