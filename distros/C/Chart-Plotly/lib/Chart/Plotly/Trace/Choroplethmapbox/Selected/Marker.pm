package Chart::Plotly::Trace::Choroplethmapbox::Selected::Marker;
use Moose;
...
Chart::Plotly::Trace::Choroplethmapbox::Selected::Marker - This attribute is one of the possible options for the trace choroplethmapbox.
