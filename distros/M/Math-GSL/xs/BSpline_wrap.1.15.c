...
#define SWIGTYPE_p_gsl_bspline_workspace swig_types[7]
#define SWIGTYPE_p_gsl_function_fdf_struct swig_types[8]
#define SWIGTYPE_p_gsl_function_struct swig_types[9]
#define SWIGTYPE_p_gsl_function_vec_struct swig_types[10]
...
XS(_wrap_gsl_bspline_alloc) {
  {
    ...
    ST(argvi) = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_gsl_bspline_workspace, 0 | 0); argvi++ ;
...
static swig_type_info _swigt__p_gsl_function_fdf_struct = {"_p_gsl_function_fdf_struct", "gsl_function_fdf *|struct gsl_function_fdf_struct *|gsl_function_fdf_struct *", 0, 0, (void*)"Math::GSL::BSpline::gsl_function_fdf_struct", 0};
