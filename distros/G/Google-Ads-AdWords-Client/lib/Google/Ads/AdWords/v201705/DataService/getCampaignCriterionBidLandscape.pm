...
package Google::Ads::AdWords::v201705::DataService::getCampaignCriterionBidLandscape;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'serviceSelector' => 'Google::Ads::AdWords::v201705::Selector',
    },
    {
...
getCampaignCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201705.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::DataService::getCampaignCriterionBidLandscape->new($data);
