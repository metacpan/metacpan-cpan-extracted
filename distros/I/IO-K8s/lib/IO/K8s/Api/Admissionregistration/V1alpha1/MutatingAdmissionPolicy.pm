...
IO::K8s::Api::Admissionregistration::V1alpha1::MutatingAdmissionPolicy - MutatingAdmissionPolicy describes the definition of an admission mutation policy that mutates the object coming into admission chain.
