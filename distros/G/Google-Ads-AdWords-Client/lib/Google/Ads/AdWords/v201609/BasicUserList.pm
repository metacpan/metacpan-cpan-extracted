package Google::Ads::AdWords::v201609::BasicUserList;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201609::UserList);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201609::UserListMembershipStatus',
        'integrationCode' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'accessReason' => 'Google::Ads::AdWords::v201609::AccessReason',
        'accountUserListStatus' => 'Google::Ads::AdWords::v201609::AccountUserListStatus',
        'membershipLifeSpan' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'size' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'sizeRange' => 'Google::Ads::AdWords::v201609::SizeRange',
        'sizeForSearch' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'sizeRangeForSearch' => 'Google::Ads::AdWords::v201609::SizeRange',
        'listType' => 'Google::Ads::AdWords::v201609::UserListType',
        ...
        'conversionTypes' => 'Google::Ads::AdWords::v201609::UserListConversionType',
    },
    {
...
BasicUserList from the namespace https://adwords.google.com/api/adwords/rm/v201609.
