...
has 'characters' => (
	...
	sub {
		...
		return {
			...
			main => qr{(?^u:[а {аь} б в г {гӏ} д е ё ж з и {ий} й к {кк} {ккх} {кх} {кь} {кӏ} л м н о {ов} {оь} п {пп} {пӏ} р {рхӏ} с {сс} т {тт} {тӏ} у {ув} {уь} {уьй} ф х {хь} {хӏ} ц {цӏ} ч {чӏ} ш щ ъ ы ь э ю {юь} я {яь}])},
			punctuation => qr{(?^u:[\- ‐ – — , ; \: ! ? . … ' ‘ ‚ " “ „ « » ( ) \[ \] \{ \} § @ * / \& #])},
		};
	},
EOT
...
has 'currencies' => (
	...
	default		=> sub { {
		...
		'KZT' => {
			symbol => 'KZT',
			display_name => {
				'currency' => q(Казахстанан тенге),
				'one' => q(Казахстанан тенге),
				'other' => q(Казахстанан тенгеш),
			},
		},
		'LAK' => {
			symbol => 'LAK',
		...
		'PEN' => {
			symbol => 'PEN',
			display_name => {
				'currency' => q(Перун керла соль),
				'one' => q(Перун керла соль),
				'other' => q(Перун керла солаш),
			},
		},
		'PGK' => {
			symbol => 'PGK',
		...
		'SAR' => {
			symbol => 'SAR',
			display_name => {
				'currency' => q(СаӀудийн Аравин риал),
				'one' => q(СаӀудийн Аравин риал),
				'other' => q(СаӀудийн Аравин риалш),
			},
		},
		'SBD' => {
			symbol => 'SBD',
		...
		'UZS' => {
			symbol => 'UZS',
			display_name => {
				'currency' => q(Узбекистанан сум),
				'one' => q(Узбекистанан сум),
				'other' => q(Узбекистанан сумаш),
			},
		},
		'VEF' => {
			symbol => 'VEF',
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'Arabian' => {
			long => {
				'daylight' => q(СаӀудийн Арави, аьхкенан хан),
				'generic' => q(СаӀудийн Арави),
				'standard' => q(СаӀудийн Арави, стандартан хан),
			},
		},
		'Arctic/Longyearbyen' => {
