package Biblio::ILL::ISO::Overdue;

=head1 NAME

Biblio::ILL::ISO::Overdue - Perl extension for handling ISO 10161 interlibrary loan Overdue messages
...
Biblio::ILL::ISO::Overdue is a derivation of the abstract 
Biblio::ILL::ISO::ISO object, and handles the Overdue message type.
...
Overdue message from a file (followed by a call to
...
For any example code, assume the following:
    my $msg = new Biblio::ILL::ISO::Overdue;
...
To read a message from a file, use the following:
    ...
    my $href = $msg->read("msg_12.overdue.ber");
