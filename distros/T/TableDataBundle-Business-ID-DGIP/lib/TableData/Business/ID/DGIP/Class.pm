...
our %STATS = ("num_columns",2,"num_rows",45); # STATS
...
TableDataRole::Business::ID::DGIP::Class - List of classes of products/services in Indonesian DGIP (Directorate General of Intellectual Property)

=head1 VERSION

This document describes version 20230207.0.0 of TableDataRole::Business::ID::DGIP::Class (from Perl distribution TableDataBundle-Business-ID-DGIP), released on 2023-02-07.
...
To use from Perl code:
 ...
 my $td = TableData::Business::ID::DGIP::Class->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Business::ID::DGIP::Class --page

 # Get number of rows
 % tabledata --action count_rows Business::ID::DGIP::Class
