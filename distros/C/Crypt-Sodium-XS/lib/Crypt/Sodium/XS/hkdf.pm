...
*available = \&Crypt::Sodium::XS::hkdf::available;
...
=head1 SYNOPSIS
  ...
  die "no hkdf support" unless Crypt::Sodium::XS::hkdf->available;
...
can be added by calling the L</update> method of that object as many times as
...
import the C<hkdf_E<lt>primitiveE<gt>_*> functions and constants for that
