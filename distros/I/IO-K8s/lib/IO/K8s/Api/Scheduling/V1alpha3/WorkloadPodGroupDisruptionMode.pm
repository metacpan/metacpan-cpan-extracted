...
IO::K8s::Api::Scheduling::V1alpha3::WorkloadPodGroupDisruptionMode - WorkloadPodGroupDisruptionMode defines how individual pods within a group can be disrupted. Exactly one mode must be set.
