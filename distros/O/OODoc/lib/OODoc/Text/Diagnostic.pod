...
=item OODoc::Text::Diagnostic-E<gt>B<new>(%options)
...
=item OODoc::Text::Diagnostic-E<gt>B<filenameToPackage>($filename)

Inherited, see L<OODoc::Object/"Commonly used functions">

=item $obj-E<gt>B<mkdirhier>($directory)

=item OODoc::Text::Diagnostic-E<gt>B<mkdirhier>($directory)
