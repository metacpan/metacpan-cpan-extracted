package Chart::Plotly::Trace::Scatterpolar::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Scatterpolar::Hoverlabel::Font - This attribute is one of the possible options for the trace scatterpolar.
