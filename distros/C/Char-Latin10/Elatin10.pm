...
#
# http://search.cpan.org/dist/Char-Latin10/
#
...
BEGIN {
    ...
    sub qualify ($;$) {
        my ($name) = @_;
        if (!ref($name) && (Elatin10::index($name, '::') == -1) && (Elatin10::index($name, "'") == -1)) {
            my $pkg;
...
#
# Latin-10 character range per length
#
my %range_tr = ();
...
sub import {
    ...
    *Char::ord           = \&Latin10::ord;
    *Char::ord_          = \&Latin10::ord_;
    *Char::reverse       = \&Latin10::reverse;
    *Char::getc          = \&Latin10::getc;
    *Char::length        = \&Latin10::length;
    *Char::substr        = \&Latin10::substr;
    *Char::index         = \&Latin10::index;
    *Char::rindex        = \&Latin10::rindex;
    *Char::eval          = \&Latin10::eval;
    *Char::escape        = \&Latin10::escape;
    *Char::escape_token  = \&Latin10::escape_token;
    *Char::escape_script = \&Latin10::escape_script;
}
...
sub Elatin10::index($$;$);
sub Elatin10::rindex($$;$);
sub Elatin10::lcfirst(@);
sub Elatin10::lcfirst_();
sub Elatin10::lc(@);
sub Elatin10::lc_();
sub Elatin10::ucfirst(@);
sub Elatin10::ucfirst_();
sub Elatin10::uc(@);
sub Elatin10::uc_();
sub Elatin10::fc(@);
sub Elatin10::fc_();
sub Elatin10::ignorecase;
sub Elatin10::classic_character_class;
sub Elatin10::capture;
sub Elatin10::chr(;$);
sub Elatin10::chr_();
sub Elatin10::glob($);
sub Elatin10::glob_();
...
# ${Elatin10::eS}          = qr{(?>[^\x09\x0A    \x0C\x0D\x20])};
# ${Elatin10::eS}          = qr{(?>[^\x09\x0A\x0B\x0C\x0D\x20])};
${Elatin10::eS}            = qr{(?>[^\s])};

${Elatin10::eW}            = qr{(?>[^0-9A-Z_a-z])};
${Elatin10::eH}            = qr{(?>[^\x09\x20])};
${Elatin10::eV}            = qr{(?>[^\x0A\x0B\x0C\x0D])};
${Elatin10::eR}            = qr{(?>\x0D\x0A|[\x0A\x0D])};
${Elatin10::eN}            = qr{(?>[^\x0A])};
${Elatin10::not_alnum}     = qr{(?>[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Elatin10::not_alpha}     = qr{(?>[^\x41-\x5A\x61-\x7A])};
${Elatin10::not_ascii}     = qr{(?>[^\x00-\x7F])};
${Elatin10::not_blank}     = qr{(?>[^\x09\x20])};
${Elatin10::not_cntrl}     = qr{(?>[^\x00-\x1F\x7F])};
${Elatin10::not_digit}     = qr{(?>[^\x30-\x39])};
${Elatin10::not_graph}     = qr{(?>[^\x21-\x7F])};
${Elatin10::not_lower}     = qr{(?>[^\x61-\x7A])};
${Elatin10::not_lower_i}   = qr{(?>[^\x41-\x5A\x61-\x7A])}; # Perl 5.16 compatible
# ${Elatin10::not_lower_i} = qr{(?>[\x00-\xFF])};                   # older Perl compatible
${Elatin10::not_print}     = qr{(?>[^\x20-\x7F])};
${Elatin10::not_punct}     = qr{(?>[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Elatin10::not_space}     = qr{(?>[^\s\x0B])};
${Elatin10::not_upper}     = qr{(?>[^\x41-\x5A])};
${Elatin10::not_upper_i}   = qr{(?>[^\x41-\x5A\x61-\x7A])}; # Perl 5.16 compatible
# ${Elatin10::not_upper_i} = qr{(?>[\x00-\xFF])};                   # older Perl compatible
${Elatin10::not_word}      = qr{(?>[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Elatin10::not_xdigit}    = qr{(?>[^\x30-\x39\x41-\x46\x61-\x66])};
${Elatin10::eb}            = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Elatin10::eB}            = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Elatin10::foo" used only once: possible typo at here.
${Elatin10::dot}         = ${Elatin10::dot};
${Elatin10::dot_s}       = ${Elatin10::dot_s};
${Elatin10::eD}          = ${Elatin10::eD};
${Elatin10::eS}          = ${Elatin10::eS};
${Elatin10::eW}          = ${Elatin10::eW};
${Elatin10::eH}          = ${Elatin10::eH};
${Elatin10::eV}          = ${Elatin10::eV};
${Elatin10::eR}          = ${Elatin10::eR};
${Elatin10::eN}          = ${Elatin10::eN};
${Elatin10::not_alnum}   = ${Elatin10::not_alnum};
${Elatin10::not_alpha}   = ${Elatin10::not_alpha};
${Elatin10::not_ascii}   = ${Elatin10::not_ascii};
${Elatin10::not_blank}   = ${Elatin10::not_blank};
${Elatin10::not_cntrl}   = ${Elatin10::not_cntrl};
${Elatin10::not_digit}   = ${Elatin10::not_digit};
${Elatin10::not_graph}   = ${Elatin10::not_graph};
${Elatin10::not_lower}   = ${Elatin10::not_lower};
${Elatin10::not_lower_i} = ${Elatin10::not_lower_i};
${Elatin10::not_print}   = ${Elatin10::not_print};
${Elatin10::not_punct}   = ${Elatin10::not_punct};
${Elatin10::not_space}   = ${Elatin10::not_space};
${Elatin10::not_upper}   = ${Elatin10::not_upper};
${Elatin10::not_upper_i} = ${Elatin10::not_upper_i};
${Elatin10::not_word}    = ${Elatin10::not_word};
${Elatin10::not_xdigit}  = ${Elatin10::not_xdigit};
${Elatin10::eb}          = ${Elatin10::eb};
${Elatin10::eB}          = ${Elatin10::eB};
...
#
# Latin-10 lower case first with parameter
#
sub Elatin10::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Elatin10::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Elatin10::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Elatin10::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Latin-10 lower case first without parameter
#
sub Elatin10::lcfirst_() {
    return Elatin10::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Latin-10 lower case with parameter
#
sub Elatin10::lc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-10 lower case without parameter
#
sub Elatin10::lc_() {
    my $s = $_;
    return join '', map {defined($lc{$_}) ? $lc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-10 upper case first with parameter
#
sub Elatin10::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Elatin10::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Elatin10::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Elatin10::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Latin-10 upper case first without parameter
#
sub Elatin10::ucfirst_() {
    return Elatin10::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Latin-10 upper case with parameter
#
sub Elatin10::uc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-10 upper case without parameter
#
sub Elatin10::uc_() {
    my $s = $_;
    return join '', map {defined($uc{$_}) ? $uc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-10 fold case with parameter
#
sub Elatin10::fc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-10 fold case without parameter
#
sub Elatin10::fc_() {
    my $s = $_;
    return join '', map {defined($fc{$_}) ? $fc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-10 regexp ignore case modifier
#
sub Elatin10::ignorecase {
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Elatin10::uc($char[$i]);
                my $fc = Elatin10::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
#
# prepare Latin-10 characters per length
#
...
#
# Latin-10 open character list for tr
#
sub _charlist_tr {
...
#
# Latin-10 open character list for qr and not qr
#
sub _charlist {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Elatin10::not_lower_i}',
                '[:^upper:]'  => '${Elatin10::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Elatin10::not_alnum}',
                '[:^alpha:]'  => '${Elatin10::not_alpha}',
                '[:^ascii:]'  => '${Elatin10::not_ascii}',
                '[:^blank:]'  => '${Elatin10::not_blank}',
                '[:^cntrl:]'  => '${Elatin10::not_cntrl}',
                '[:^digit:]'  => '${Elatin10::not_digit}',
                '[:^graph:]'  => '${Elatin10::not_graph}',
                '[:^lower:]'  => '${Elatin10::not_lower}',
                '[:^print:]'  => '${Elatin10::not_print}',
                '[:^punct:]'  => '${Elatin10::not_punct}',
                '[:^space:]'  => '${Elatin10::not_space}',
                '[:^upper:]'  => '${Elatin10::not_upper}',
                '[:^word:]'   => '${Elatin10::not_word}',
                '[:^xdigit:]' => '${Elatin10::not_xdigit}',
...
#
# Latin-10 octal escape sequence
#
sub octchr {
    my($octdigit) = @_;
...
#
# Latin-10 hexadecimal escape sequence
#
sub hexchr {
    my($hexdigit) = @_;
...
#
# Latin-10 open character list for qr
#
sub charlist_qr {
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Elatin10::uc($char);
                        my $fc = Elatin10::fc($char);
                        if ($uc eq $fc) {
...
#
# Latin-10 open character list for not qr
#
sub charlist_not_qr {
...
#
# Latin-10 order to character (with parameter)
#
sub Elatin10::chr(;$) {
...
#
# Latin-10 order to character (without parameter)
#
sub Elatin10::chr_() {
...
#
# Latin-10 path globbing (with parameter)
#
sub Elatin10::glob($) {
...
#
# Latin-10 path globbing (without parameter)
#
sub Elatin10::glob_() {
...
#
# Latin-10 path globbing via File::DosGlob 1.10
#
...
#
# Latin-10 path globbing subroutine
#
sub _do_glob {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Elatin10::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Elatin10::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Elatin10::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Elatin10::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
#
sub Elatin10::POSTMATCH {
    return $';
}

#
# Latin-10 character to order (with parameter)
#
sub Latin10::ord(;$) {
...
#
# Latin-10 character to order (without parameter)
#
sub Latin10::ord_() {
...
#
# Latin-10 getc (with parameter, without parameter)
#
sub Latin10::getc(;*@) {

    my($package) = caller;
    my $fh = @_ ? qualify_to_ref(shift,$package) : \*STDIN;
    croak 'Too many arguments for Latin10::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Elatin10::dot_s} \z/oxms) {
...
#
# Latin-10 index by character
#
sub Latin10::index($$;$) {

    my $index;
    if (@_ == 3) {
        $index = Elatin10::index($_[0], $_[1], CORE::length(Latin10::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Elatin10::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Latin10::length(CORE::substr $_[0], 0, $index);
    }
}

#
# Latin-10 rindex by character
#
sub Latin10::rindex($$;$) {

    my $rindex;
    if (@_ == 3) {
        $rindex = Elatin10::rindex($_[0], $_[1], CORE::length(Latin10::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Elatin10::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Latin10::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
my $qq_substr  = qr{(?> Char::substr | Latin10::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
#
# escape Latin-10 token of script
#
sub Latin10::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Elatin10::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ (?>\s*) PREMATCH  \b | \$ (?>\s*) \{ (?>\s*) PREMATCH  (?>\s*) \} | \$ (?>\s*) \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin10::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Elatin10::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin10::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Elatin10::POSTMATCH()
    elsif (/\G (                 \$ (?>\s*) POSTMATCH \b | \$ (?>\s*) \{ (?>\s*) POSTMATCH (?>\s*) \} | \$ (?>\s*) \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin10::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Elatin10::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob (?>\s*) \) /oxgc) {
        return 'while ($_ = Elatin10::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob \b /oxgc) {
        return 'while ($_ = Elatin10::glob';
    }
...
# subroutines of package Elatin10
    elsif (/\G \b (CORE:: | ->(>?\s*) (?: atan2 | [a-z]{2,})) \b       /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Latin10::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Char::escape'; }
    elsif (/\G \b Latin10::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Latin10::escape'; }
    elsif (/\G \b bytes::substr \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin10::chop';       }
    elsif (/\G \b bytes::index \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::index';       }
    elsif (/\G \b Latin10::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Latin10::index';       }
    elsif (/\G \b index \b         (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin10::index';      }
    elsif (/\G \b bytes::rindex \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::rindex';      }
    elsif (/\G \b Latin10::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Latin10::rindex';      }
    elsif (/\G \b rindex \b        (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin10::rindex';     }
    elsif (/\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin10::lc';         }
    elsif (/\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin10::lcfirst';    }
    elsif (/\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin10::uc';         }
    elsif (/\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin10::ucfirst';    }
    elsif (/\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin10::fc';         }
    ...
    elsif (/\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin10::chr';               }
    elsif (/\G \b bytes::ord    (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin10::glob';              }
    elsif (/\G \b lc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin10::lc_';               }
    elsif (/\G \b lcfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin10::lcfirst_';          }
    elsif (/\G \b uc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin10::uc_';               }
    elsif (/\G \b ucfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin10::ucfirst_';          }
    elsif (/\G \b fc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin10::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin10::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin10::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Elatin10::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Elatin10::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq           (\#) [ ] (\#) /oxgc) { return 'Elatin10::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Elatin10::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Elatin10::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Elatin10::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Elatin10::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Elatin10::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q            (\#) [ ] (\#) /oxgc) { return 'Elatin10::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Elatin10::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Elatin10::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Elatin10::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Elatin10::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Elatin10::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                    ' [ ] '    /oxgc) { return 'Elatin10::split' . $e . qq     {' '};  }
        elsif (/\G                    " [ ] "    /oxgc) { return 'Elatin10::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Elatin10::PREMATCH()]}
            ...
            $e_string .= q{Elatin10::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Elatin10::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Elatin10::MATCH()};
            $slash = 'div';
        }
...
# subroutines of package Elatin10
        ...
        elsif ($string =~ /\G \b Latin10::eval       (?= (?>\s*) \{ )                    /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::eval \b                                        /oxgc) { $e_string .= 'eval Char::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b Latin10::eval \b                                        /oxgc) { $e_string .= 'eval Latin10::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                                     /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                              /oxgc) { $e_string .= 'Elatin10::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                                      /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::index \b                                       /oxgc) { $e_string .= 'Char::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b Latin10::index \b                                       /oxgc) { $e_string .= 'Latin10::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                             /oxgc) { $e_string .= 'Elatin10::index';      $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b Latin10::rindex \b                                      /oxgc) { $e_string .= 'Latin10::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                            /oxgc) { $e_string .= 'Elatin10::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin10::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin10::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin10::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin10::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin10::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin10::chr';           $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin10::glob';          $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                                      /oxgc) { $e_string .= 'Elatin10::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                                 /oxgc) { $e_string .= 'Elatin10::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                                      /oxgc) { $e_string .= 'Elatin10::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                                 /oxgc) { $e_string .= 'Elatin10::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                                      /oxgc) { $e_string .= 'Elatin10::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                                     /oxgc) { $e_string .= 'Elatin10::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                              /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                                     /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                                    /oxgc) { $e_string .= 'Elatin10::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Elatin10::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Elatin10::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq           (\#) [ ] (\#) /oxgc) { $e_string .= 'Elatin10::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { $e_string .= 'Elatin10::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { $e_string .= 'Elatin10::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { $e_string .= 'Elatin10::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { $e_string .= 'Elatin10::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { $e_string .= 'Elatin10::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q            (\#) [ ] (\#) /oxgc) { $e_string .= 'Elatin10::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { $e_string .= 'Elatin10::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { $e_string .= 'Elatin10::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { $e_string .= 'Elatin10::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { $e_string .= 'Elatin10::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { $e_string .= 'Elatin10::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                    ' [ ] '    /oxgc) { $e_string .= 'Elatin10::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                    " [ ] "    /oxgc) { $e_string .= 'Elatin10::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        ...
        return Elatin10::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Elatin10::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Elatin10::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Elatin10::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Elatin10::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Elatin10::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Elatin10::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Elatin10::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Elatin10::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Elatin10::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Elatin10::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Elatin10::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Elatin10::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Elatin10::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Elatin10::uc($char[$i]) ne Elatin10::fc($char[$i]))) {
            if (CORE::length(Elatin10::fc($char[$i])) == 1) {
                $char[$i] = '['   . Elatin10::uc($char[$i])       . Elatin10::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Elatin10::uc($char[$i]) . '|' . Elatin10::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin10::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ (?>\s*) 0 (?>\s*) \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Elatin10::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin10::ignorecase(Elatin10::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin10::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Elatin10::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin10::ignorecase(Elatin10::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin10::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Elatin10::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin10::ignorecase(Elatin10::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin10::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Latin10::re_t=%s; while($Latin10::re_t =~ %s){%s local $^W=0; local $Latin10::re_r=%s; %s$Latin10::re_t="$`$Latin10::re_r$'"; pos($Latin10::re_t)=length "$`$Latin10::re_r"; } return $Latin10::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Latin10::re_r=CORE::eval $Latin10::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Latin10::re_r=%s; %s"%s$Latin10::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Latin10::re_n=0; while(%s =~ %s){%s local $^W=0; local $Latin10::re_r=%s; %s%s="$`$Latin10::re_r$'"; pos(%s)=length "$`$Latin10::re_r"; $Latin10::re_n++} return %s$Latin10::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Latin10::re_r=%s; %s%s="%s$Latin10::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Latin10::re_r=%s; %s%s="%s$Latin10::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Latin10::re_r=CORE::eval $Latin10::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Elatin10::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Elatin10::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  # "no Elatin10;" not supported

=head1 ABSTRACT

This module has run-time routines for use Latin10 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Latin10 software and not
...
This Elatin10 module first appeared in ActivePerl Build 522 Built under
...
=item Split string
  ...
  @split = Elatin10::split(/pattern/,$string,$limit);
  @split = Elatin10::split(/pattern/,$string);
  @split = Elatin10::split(/pattern/);
  @split = Elatin10::split('',$string,$limit);
  @split = Elatin10::split('',$string);
  @split = Elatin10::split('');
  @split = Elatin10::split();
  @split = Elatin10::split;
  ...
  at all, Elatin10::split returns the original string as a single substring, If it
  ...
  @chars  = Elatin10::split(//,  $word);
  @fields = Elatin10::split(/:/, $line);
  @words  = Elatin10::split(" ", $paragraph);
  @lines  = Elatin10::split(/^/, $buffer);
  ...
  print join(":" => Elatin10::split(/ */, "hi there"));
  ...
  Elatin10::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Elatin10::split(/:/, $_, 3);
  ...
  splits on whitespace just as Elatin10::split with no arguments does. Thus,
  Elatin10::split(" ") can be used to emulate awk's default behavior. In contrast,
  Elatin10::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Elatin10::split(" ", $string));
  ...
  The inverse of Elatin10::split is join, except that join can only join with the
...
=item Transliteration
  ...
  $tr = Elatin10::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Elatin10::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  This subroutine scans a Latin-10 string character by character and replaces all
  occurrences of the characters found in $searchlist with the corresponding character
  in $replacementlist. It returns the number of characters replaced or deleted.
  If no Latin-10 string is specified via =~ operator, the $_ variable is translated.
  $modifier are:
  ...
  print Elatin10::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item Chop string

  $chop = Elatin10::chop(@list);
  $chop = Elatin10::chop();
  $chop = Elatin10::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Elatin10::chop subroutine is used primary to remove the newline
  ...
  since Elatin10::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Elatin10::chop a literal, only a variable. If you Elatin10::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Elatin10::chop(@lines);

  You can Elatin10::chop anything that is an lvalue, including an assignment:

  Elatin10::chop($cwd = `pwd`);
  Elatin10::chop($answer = <STDIN>);

  This is different from:

  $answer = Elatin10::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Elatin10::chop returns the character
  ...
  In the most general case, Elatin10::chop can be expressed using substr:

  $last_code = Elatin10::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Elatin10::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Elatin10::chop;
...
=item Index string
  ...
  $byte_pos = Elatin10::index($string,$substr,$byte_offset);
  $byte_pos = Elatin10::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Elatin10::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Elatin10::rindex($string,$substr,$byte_offset);
  $byte_pos = Elatin10::rindex($string,$substr);

  This subroutine works just like Elatin10::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Elatin10::index).
  ...
  while (($byte_pos = Latin10::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  $lc = Elatin10::lc($string);
  $lc = Elatin10::lc_;

  This subroutine returns a lowercased version of Latin-10 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Elatin10::fc subroutine for case-insensitive comparisons via Latin10
  software.

=item Lower case first character of string

  $lcfirst = Elatin10::lcfirst($string);
  $lcfirst = Elatin10::lcfirst_;

  This subroutine returns a version of Latin-10 $string with the first character
  lowercased (or $_, if $string is omitted). This is the internal subroutine
  implementing the \l escape in double-quoted strings.

=item Upper case string

  $uc = Elatin10::uc($string);
  $uc = Elatin10::uc_;

  This subroutine returns an uppercased version of Latin-10 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Elatin10::ucfirst instead.
...
=item Upper case first character of string
  ...
  $ucfirst = Elatin10::ucfirst($string);
  $ucfirst = Elatin10::ucfirst_;
  ...
  $titlecase = Elatin10::ucfirst(substr($word,0,1)) . Elatin10::lc(substr($word,1));
  ...
  $do_not_use = Elatin10::ucfirst(Elatin10::lc($word));
...
=item Fold case string
  ...
  $fc = Elatin10::fc($string);
  $fc = Elatin10::fc_;

  New to Latin10 software, this subroutine returns the full Unicode-like casefold of
  Latin-10 $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Elatin10::fc($a) eq Elatin10::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Latin10 software has always used casefolding semantics for
...
=item Make ignore case string
  ...
  @ignorecase = Elatin10::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item Make capture number

  $capturenumber = Elatin10::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item Make character

  $chr = Elatin10::chr($code);
  $chr = Elatin10::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Elatin10::chr(65) is "A" in either
  ASCII or Latin-10, not Unicode. For the reverse of Elatin10::chr, use Latin10::ord.

=item Filename expansion (globbing)

  @glob = Elatin10::glob($string);
  @glob = Elatin10::glob_;
  ...
  The Elatin10::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Elatin10::glob('"*e f*"');
  @spacies = Elatin10::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Elatin10::glob("'*${var}e f*'");
  @spacies = Elatin10::glob(qq("*${var}e f*"));
