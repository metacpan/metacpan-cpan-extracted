...
1;
# ABSTRACT: List Dist::Zilla bundles ranked by number of reverse dependencies
...
This document describes version 0.05 of App::lcpan::Cmd::dzil_bundles_by_rdep_count (from Perl distribution App-lcpan-CmdBundle-dzil), released on 2017-01-20.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<dzil-bundles-by-rdep-count>.
