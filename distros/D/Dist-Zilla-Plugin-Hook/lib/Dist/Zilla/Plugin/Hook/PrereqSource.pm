...
#pod
#pod This is C<Hook::PrereqSource> plugin implementation. Nothing interesting, just using few roles.
#pod
...
#pod = L<Dist::Zilla>
#pod = L<Dist::Zilla::Role::PrereqSource>
#pod
#pod =cut

package Dist::Zilla::Plugin::Hook::PrereqSource;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::PrereqSource> plugin implementation
our $VERSION = 'v0.8.3'; # VERSION

with 'Dist::Zilla::Role::Plugin';
with 'Dist::Zilla::Role::Hooker' => {
    -alias => { hook => 'register_prereqs' },
};
...
Dist::Zilla::Plugin::Hook::PrereqSource - C<Hook::PrereqSource> plugin implementation
...
This is C<Hook::PrereqSource> plugin implementation. Nothing interesting, just using few roles.
...
=item L<Dist::Zilla::Role::PrereqSource>
