package Shipment::FedEx::WSDL::ShipTypes::RecipientCustomsIdType;
$Shipment::FedEx::WSDL::ShipTypes::RecipientCustomsIdType::VERSION = '3.08';
use strict;
use warnings;
...
RecipientCustomsIdType from the namespace http://fedex.com/ws/ship/v9.
