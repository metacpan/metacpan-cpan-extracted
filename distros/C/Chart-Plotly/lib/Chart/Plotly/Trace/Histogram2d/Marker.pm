package Chart::Plotly::Trace::Histogram2d::Marker;
use Moose;
...
Chart::Plotly::Trace::Histogram2d::Marker - This attribute is one of the possible options for the trace histogram2d.
