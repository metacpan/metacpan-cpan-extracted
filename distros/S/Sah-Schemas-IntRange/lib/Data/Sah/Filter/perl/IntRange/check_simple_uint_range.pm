package Data::Sah::Filter::perl::IntRange::check_simple_uint_range;
...
sub meta {
    +{
        v => 1,
        summary => 'Check the syntax of simple_uint_range',
        might_fail => 1,
    };
}
...
Data::Sah::Filter::perl::IntRange::check_simple_uint_range

=head1 VERSION

This document describes version 0.004 of Data::Sah::Filter::perl::IntRange::check_simple_uint_range (from Perl distribution Sah-Schemas-IntRange), released on 2021-07-17.
