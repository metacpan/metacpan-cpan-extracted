...
package UMMF::UML_1_5::Foundation::Core::Interface;
...
=head2 C<__validate_type>
  ...
  UMMF::UML_1_5::Foundation::Core::Interface->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::Foundation::Core::Interface|UMMF::UML_1_5::Foundation::Core::Interface>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::Foundation::Core::Interface')  ;
}


=head2 C<__typecheck>

  UMMF::UML_1_5::Foundation::Core::Interface->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::Foundation::Core::Interface->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::Foundation::Core::Interface' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML_1_5::Foundation::Core::Interface|UMMF::UML_1_5::Foundation::Core::Interface>.
...
sub __initialize
{
  ...
  $self->UMMF::UML_1_5::Foundation::Core::Interface::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::Foundation::Core::Interface::___create(@args);
