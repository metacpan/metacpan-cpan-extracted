...
package WebService::Edgecast::auto::Reporting::Element::CustomerBytesTransferredByMediaTypeGet;
BEGIN {
  $WebService::Edgecast::auto::Reporting::Element::CustomerBytesTransferredByMediaTypeGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerBytesTransferredByMediaTypeGet');
...
WebService::Edgecast::auto::Reporting::Element::CustomerBytesTransferredByMediaTypeGet
...
CustomerBytesTransferredByMediaTypeGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Reporting::Element::CustomerBytesTransferredByMediaTypeGet->new($data);
