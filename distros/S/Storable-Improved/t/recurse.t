...
$Storable::flags = Storable::Improved::FLAGS_COMPAT;
...
sub STORABLE_freeze {
    my $self = shift;
    my $cloning = shift;
    die "STORABLE_freeze" unless Storable::Improved::is_storing;
...
sub STORABLE_thaw {
    ...
    @$self = @$a;
    die "STORABLE_thaw #4" unless Storable::Improved::is_retrieving;
}
