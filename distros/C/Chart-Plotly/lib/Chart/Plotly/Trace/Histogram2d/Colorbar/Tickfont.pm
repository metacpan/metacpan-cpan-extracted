package Chart::Plotly::Trace::Histogram2d::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Histogram2d::Colorbar::Tickfont - This attribute is one of the possible options for the trace histogram2d.
