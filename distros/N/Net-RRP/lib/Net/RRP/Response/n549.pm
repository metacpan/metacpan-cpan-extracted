package Net::RRP::Response::n549;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n549::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n549::VERSION = '0.1';
...
Net::RRP::Response::n549 - the 549 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
