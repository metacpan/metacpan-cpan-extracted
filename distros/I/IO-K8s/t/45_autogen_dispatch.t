#!/usr/bin/env perl
# k23 -- AutoGen dispatch is apiVersion-aware and deterministic.
#
# Covered here:
#
...
# ---- k71 (P5): a nested $ref to ANOTHER autogenerated definition -----
#
...
# ObjectMeta $ref every GVK class already exercises via k56/k60). This
...
subtest 'nested $ref to another AutoGen definition inflates to a typed object (k71 / P5)' => sub {
    my $nested_spec = {
        definitions => {
