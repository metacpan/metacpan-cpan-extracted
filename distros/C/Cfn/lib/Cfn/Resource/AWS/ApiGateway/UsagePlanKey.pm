...
Cfn::Resource::AWS::ApiGateway::UsagePlanKey - Cfn resource for AWS::ApiGateway::UsagePlanKey

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::ApiGateway::UsagePlanKey.
