...
our $rschema = [
  "any",
  [{ of => ["sah::str_schema", "sah::array_schema"] }],
  ["any"],
];
...
Sah::SchemaR::sah::schema -  

=head1 VERSION

This document describes version 0.9.43.1 of Sah::SchemaR::sah::schema (from Perl distribution Sah-Schemas-Sah), released on 2016-07-25.
