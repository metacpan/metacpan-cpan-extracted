package Shipment::UPS::WSDL::RateTypes::CodeDescriptionType;
$Shipment::UPS::WSDL::RateTypes::CodeDescriptionType::VERSION = '3.08';
use strict;
use warnings;
...
CodeDescriptionType from the namespace http://www.ups.com/XMLSchema/XOLTWS/Rate/v1.1.
