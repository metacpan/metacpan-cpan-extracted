...
package TeX::Hyphen::Pattern::Sv v1.1.8;
use strict;
use warnings;
use 5.014000;
use utf8;
...
sub version {
    return $TeX::Hyphen::Pattern::Sv::VERSION;
}
...
=for stopwords CTAN Ipenburg Sv

=head1 NAME

TeX::Hyphen::Pattern::Sv - class for hyphenation in locale Sv
