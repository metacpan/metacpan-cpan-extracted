package Chart::Plotly::Trace::Contourcarpet::Colorbar::Tickformatstop;
use Moose;
...
Chart::Plotly::Trace::Contourcarpet::Colorbar::Tickformatstop - This attribute is one of the possible options for the trace contourcarpet.
