package Google::Ads::AdWords::v201609::Proximity;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'geoPoint' => 'Google::Ads::AdWords::v201609::GeoPoint',
        'radiusDistanceUnits' => 'Google::Ads::AdWords::v201609::Proximity::DistanceUnits',
        'radiusInUnits' => 'SOAP::WSDL::XSD::Typelib::Builtin::double',
        'address' => 'Google::Ads::AdWords::v201609::Address',
    },
    {
...
Proximity from the namespace https://adwords.google.com/api/adwords/cm/v201609.
