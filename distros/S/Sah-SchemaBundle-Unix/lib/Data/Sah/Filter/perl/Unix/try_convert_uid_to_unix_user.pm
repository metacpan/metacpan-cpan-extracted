...
Data::Sah::Filter::perl::Unix::try_convert_uid_to_unix_user - Try to convert UID into Unix username, leave as-is if cannot convert

=head1 VERSION

This document describes version 0.022 of Data::Sah::Filter::perl::Unix::try_convert_uid_to_unix_user (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.
