package Bencher::Scenarios::LevenshteinModules;

our $DATE = '2017-01-25'; # DATE
our $VERSION = '0.13'; # VERSION

1;
# ABSTRACT: Scenarios to benchmark modules that calculate Levenshtein distance
...
Bencher::Scenarios::LevenshteinModules - Scenarios to benchmark modules that calculate Levenshtein distance

=head1 VERSION

This document describes version 0.13 of Bencher::Scenarios::LevenshteinModules (from Perl distribution Bencher-Scenarios-LevenshteinModules), released on 2017-01-25.
...
=item * L<Bencher::Scenario::DamerauLevenshteinModules>
