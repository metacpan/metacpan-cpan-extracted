...
Test::Float::Results - object for tracking results from a single test file

=head1 SYNOPSIS

One Test::Float::Results object represents the results from one
...
=head2 new()
    ...
    my $results = new Test::Float::Results;
...
sub inc_ok {
    my $self = shift; $self->{ok} += shift; # (@_ ? shift : 1) } # bloody hell... does every module have to clamp this to 0/1?
};
