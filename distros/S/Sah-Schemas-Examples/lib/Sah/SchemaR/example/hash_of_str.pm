...
our $rschema = [
  "hash",
  [
    { of => ["str", { req => 1 }, {}], summary => "Hash of string" },
  ],
  ["hash"],
];
...
This document describes version 0.005 of Sah::SchemaR::example::hash_of_str (from Perl distribution Sah-Schemas-Examples), released on 2016-12-09.
