# AWS::Pinpoint::APNSVoipChannel generated from spec 14.3.0
use Moose::Util::TypeConstraints;

coerce 'Cfn::Resource::Properties::AWS::Pinpoint::APNSVoipChannel',
  from 'HashRef',
   via { Cfn::Resource::Properties::AWS::Pinpoint::APNSVoipChannel->new( %$_ ) };

package Cfn::Resource::AWS::Pinpoint::APNSVoipChannel {
  use Moose;
  extends 'Cfn::Resource';
  has Properties => (isa => 'Cfn::Resource::Properties::AWS::Pinpoint::APNSVoipChannel', is => 'rw', coerce => 1);
...
package Cfn::Resource::Properties::AWS::Pinpoint::APNSVoipChannel {
  use Moose;
...
Cfn::Resource::AWS::Pinpoint::APNSVoipChannel - Cfn resource for AWS::Pinpoint::APNSVoipChannel

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::Pinpoint::APNSVoipChannel.
