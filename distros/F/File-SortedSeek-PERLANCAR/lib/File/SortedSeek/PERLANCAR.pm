...
File::SortedSeek::PERLANCAR - A fork of File::SortedSeek with some more options

=head1 VERSION

This document describes version 0.015.1 of File::SortedSeek::PERLANCAR (from Perl distribution File-SortedSeek-PERLANCAR), released on 2021-04-25.
...
Please visit the project's homepage at L<https://metacpan.org/release/File-SortedSeek-PERLANCAR>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-File-SortedSeek-PERLANCAR>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=File-SortedSeek-PERLANCAR>
