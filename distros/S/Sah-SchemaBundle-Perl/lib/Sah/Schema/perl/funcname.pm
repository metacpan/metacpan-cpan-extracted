...
This document describes version 0.050 of Sah::Schema::perl::funcname (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::funcname", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::funcname", {return_type=>'str_errmsg+val'});
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::funcname*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::funcname*', name=>'PerlFuncname')
     );
 }
