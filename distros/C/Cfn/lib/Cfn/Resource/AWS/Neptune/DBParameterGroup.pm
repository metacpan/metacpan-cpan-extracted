...
Cfn::Resource::AWS::Neptune::DBParameterGroup - Cfn resource for AWS::Neptune::DBParameterGroup

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::Neptune::DBParameterGroup.
