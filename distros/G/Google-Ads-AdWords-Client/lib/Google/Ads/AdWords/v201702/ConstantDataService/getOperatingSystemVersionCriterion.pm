...
package Google::Ads::AdWords::v201702::ConstantDataService::getOperatingSystemVersionCriterion;
use strict;
use warnings;
...
getOperatingSystemVersionCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201702.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::ConstantDataService::getOperatingSystemVersionCriterion->new($data);
