package Google::Cloud::Sql::V1::SqlBackupsServiceClient;
...
1; # End of Google::Cloud::Sql::V1::SqlBackupsServiceClient

__END__

=head1 NAME

Google::Cloud::Sql::V1::SqlBackupsServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Sql::V1::SqlBackupsServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Sql::V1::SqlBackupsServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Sql::V1::SqlBackupsServiceClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Sql::V1::SqlBackupsServiceClient->new(
