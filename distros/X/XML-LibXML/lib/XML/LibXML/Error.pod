...
=head1 SYNOPSIS
  ...
  $message = $@-E<gt>as_string();
  print $@-E<gt>dump();
  $error_domain = $@-E<gt>domain();
  $error_code = $@-E<gt>code();
  $error_message = $@-E<gt>message();
  $error_level = $@-E<gt>level();
  $filename = $@-E<gt>file();
  $line = $@-E<gt>line();
  $nodename = $@-E<gt>nodename();
  $error_str1 = $@-E<gt>str1();
  $error_str2 = $@-E<gt>str2();
  $error_str3 = $@-E<gt>str3();
  $error_num1 = $@-E<gt>num1();
  $error_num2 = $@-E<gt>num2();
  $string = $@-E<gt>context();
  $offset = $@-E<gt>column();
  $previous_error = $@-E<gt>_prev();
