package Chart::Plotly::Trace::Isosurface::Slices::Y;
use Moose;
...
has show => ( is            => "rw",
              isa           => "Bool",
              documentation => "Determines whether or not slice planes about the y dimension are drawn.",
);
...
Chart::Plotly::Trace::Isosurface::Slices::Y - This attribute is one of the possible options for the trace isosurface.
