# AWS::EC2::VPCEndpointServicePermissions generated from spec 14.3.0
...
package Cfn::Resource::AWS::EC2::VPCEndpointServicePermissions {
  ...
  sub supported_regions {
    [ 'ap-east-1','ap-northeast-1','ap-northeast-2','ap-northeast-3','ap-south-1','ap-southeast-1','ap-southeast-2','ca-central-1','cn-north-1','cn-northwest-1','eu-central-1','eu-north-1','eu-west-1','eu-west-2','eu-west-3','sa-east-1','us-east-1','us-east-2','us-west-1','us-west-2' ]
  }
}
...
Cfn::Resource::AWS::EC2::VPCEndpointServicePermissions - Cfn resource for AWS::EC2::VPCEndpointServicePermissions

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::EC2::VPCEndpointServicePermissions.
