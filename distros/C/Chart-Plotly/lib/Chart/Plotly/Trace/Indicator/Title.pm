package Chart::Plotly::Trace::Indicator::Title;
use Moose;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Indicator::Title::Font", );
...
Chart::Plotly::Trace::Indicator::Title - This attribute is one of the possible options for the trace indicator.
