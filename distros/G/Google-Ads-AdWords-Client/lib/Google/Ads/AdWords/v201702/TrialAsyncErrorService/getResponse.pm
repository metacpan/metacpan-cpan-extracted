...
package Google::Ads::AdWords::v201702::TrialAsyncErrorService::getResponse;
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::TrialAsyncErrorService::getResponse->new($data);
