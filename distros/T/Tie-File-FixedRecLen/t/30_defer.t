...
print "1..0\n"; # defer/cache does not work in FixedRecLen
exit;

use POSIX 'SEEK_SET';
my $file = "tf$$.txt";
$: = Tie::File::FixedRecLen::_default_recsep();
...
print F $data;
close F;
$o = tie @a, 'Tie::File::FixedRecLen', $file;
print $o ? "ok $N\n" : "not ok $N\n";
$N++;
...
$o = tie @a, 'Tie::File::FixedRecLen', $file, memory => $MAX, dw_size => $BUF;
print $o ? "ok $N\n" : "not ok $N\n";
$N++;
