...
#     test => { TESTS=>q[t/00-catalyst-controller-psgi.t] }
...
MAKE = make
FULLEXT = CatalystX/Controller/PSGI
BASEEXT = PSGI
PARENT_NAME = CatalystX::Controller
DLBASE = $(BASEEXT)
VERSION_FROM = lib/CatalystX/Controller/PSGI.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/CatalystX/Controller/PSGI.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/CatalystX/Controller
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/CatalystX/Controller
...
TO_INST_PM = lib/CatalystX/Controller/PSGI.pm

PM_TO_BLIB = lib/CatalystX/Controller/PSGI.pm \
	blib/lib/CatalystX/Controller/PSGI.pm
...
manifypods : pure_all  \
	lib/CatalystX/Controller/PSGI.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/CatalystX/Controller/PSGI.pm $(INST_MAN3DIR)/CatalystX::Controller::PSGI.$(MAN3EXT) 
...
TEST_FILE = test.pl
TEST_FILES = t/00-catalyst-controller-psgi.t
TESTDB_SW = -d
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/CatalystX/Controller/PSGI.pm blib/lib/CatalystX/Controller/PSGI.pm 
...
upgradedeps ::
	$(PERL) Makefile.PL --config= --upgradedeps=Test::More,0.94,FindBin,0,Catalyst::Test,0,Plack::Response,0,Plack::App::File,0,Moose,0,namespace::autoclean,0,Catalyst,5.90050

upgradedeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --upgradedeps=Test::More,0.94,FindBin,0,Catalyst::Test,0,Plack::Response,0,Plack::App::File,0,Moose,0,namespace::autoclean,0,Catalyst,5.90050

listdeps ::
	@$(PERL) -le "print for @ARGV" 

listalldeps ::
	@$(PERL) -le "print for @ARGV" Test::More FindBin Catalyst::Test Plack::Response Plack::App::File Moose namespace::autoclean Catalyst
