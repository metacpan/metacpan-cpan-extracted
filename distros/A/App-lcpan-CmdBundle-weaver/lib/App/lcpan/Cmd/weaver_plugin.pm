...
1;
# ABSTRACT: Show a single Pod::Weaver plugin
...
App::lcpan::Cmd::weaver_plugin - Show a single Pod::Weaver plugin

=head1 VERSION

This document describes version 0.030 of App::lcpan::Cmd::weaver_plugin (from Perl distribution App-lcpan-CmdBundle-weaver), released on 2019-11-20.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<weaver-plugin>.
...
Show a single Pod::Weaver plugin.
...
=item * B<weaver_plugin>* => I<perl::modname>
