...
Flail::Exec::Cmd::unmark - Flail "unmark" command

=head1 VERSION

  Time-stamp: <2006-12-03 11:04:24 attila@stalphonsos.com>

=head1 SYNOPSIS

  use Flail::Exec::Cmd::unmark;
  blah;
...
package Flail::Exec::Cmd::unmark;
use strict;
use Carp;
use Flail::Utils;
use base qw(Exporter);
use vars qw(@EXPORT @EXPORT_OK %EXPORT_TAGS);
@EXPORT_OK = qw(flail_unmark);
@EXPORT = ();
