...
Acme::CPANModules::MockData - Alias for Acme::CPANModules::RandomData

=head1 VERSION

This document describes version 0.004 of Acme::CPANModules::MockData (from Perl distribution Acme-CPANModules-RandomData), released on 2023-04-10.
...
L<App::cpanm::cpanmodules> distribution):
 ...
 % cpanm-cpanmodules -n MockData

Alternatively you can use the L<cpanmodules> CLI (from L<App::cpanmodules>
distribution):

    % cpanmodules ls-entries MockData | cpanm -n

or L<Acme::CM::Get>:

    % perl -MAcme::CM::Get=MockData -E'say $_->{module} for @{ $LIST->{entries} }' | cpanm -n

or directly:

    % perl -MAcme::CPANModules::MockData -E'say $_->{module} for @{ $Acme::CPANModules::MockData::LIST->{entries} }' | cpanm -n
