...
Developer::Dashboard::Pax::Backend::Tier1CraneliftEquivalent - tier-1 backend planning stub for fast native code generation

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::Backend::Tier1CraneliftEquivalent;

  my $obj = Developer::Dashboard::Pax::Backend::Tier1CraneliftEquivalent->new(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::Backend::Tier1CraneliftEquivalent -e 1
