# This Makefile is for the Parser::IPTables::Save extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Parser/IPTables/Save.pm]
#     AUTHOR => q[Geovanny Junio <geovannyjs@gmail.com>]
#     BUILD_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[Parser::IPTables::Save]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Parser/IPTables/Save.pm]
#     clean => { FILES=>q[Parser-IPTables-Save-*] }
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/geovanny/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /home/geovanny/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.56
MM_REVISION = 65600
...
MAKE = make
FULLEXT = Parser/IPTables/Save
BASEEXT = Save
PARENT_NAME = Parser::IPTables
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Parser/IPTables/Save.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Parser/IPTables
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Parser/IPTables
...
TO_INST_PM = lib/Parser/IPTables/Save.pm

PM_TO_BLIB = lib/Parser/IPTables/Save.pm \
...
DISTNAME = Parser-IPTables-Save
DISTVNAME = Parser-IPTables-Save-0.01
...
manifypods : pure_all  \
	lib/Parser/IPTables/Save.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Parser/IPTables/Save.pm $(INST_MAN3DIR)/Parser::IPTables::Save.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Parser-IPTables-Save' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           The great new Parser::IPTables::Save!' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Geovanny Junio <geovannyjs@gmail.com>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new Parser::IPTables::Save!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Geovanny Junio &lt;geovannyjs@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Parser/IPTables/Save.pm blib/lib/Parser/IPTables/Save.pm 
