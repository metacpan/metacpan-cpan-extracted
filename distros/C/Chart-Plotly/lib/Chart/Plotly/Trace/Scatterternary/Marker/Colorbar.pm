package Chart::Plotly::Trace::Scatterternary::Marker::Colorbar;
use Moose;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatterternary::Marker::Colorbar::Tickfont", );
...
has tickformatstops => (
                     is  => "rw",
                     isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Scatterternary::Marker::Colorbar::Tickformatstop]",
);
...
Chart::Plotly::Trace::Scatterternary::Marker::Colorbar - This attribute is one of the possible options for the trace scatterternary.
