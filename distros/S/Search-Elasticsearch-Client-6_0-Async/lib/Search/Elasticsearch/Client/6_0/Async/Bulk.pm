...
package Search::Elasticsearch::Client::6_0::Async::Bulk;
$Search::Elasticsearch::Client::6_0::Async::Bulk::VERSION = '7.711001';
use Moo;
...
This module provides an async wrapper for the L<Search::Elasticsearch::Client::6_0::Direct/bulk()>
method which makes it easier to run multiple create, index, update or delete
actions in a single request.

The L<Search::Elasticsearch::Client::6_0::Async::Bulk> module acts as a queue, buffering up actions
...
This class does L<Search::Elasticsearch::Client::6_0::Role::Bulk> and
...
The C<bulk_helper> method loads L<Search::Elasticsearch::Client::6_0::Async::Bulk>,
...
by the L<bulk()|Search::Elasticsearch::Client::6_0::Direct/bulk()> method.
...
a L<bulk()|Search::Elasticsearch::Client::6_0::Direct/bulk()> request and returns
...
It accepts the same parameters as L<Search::Elasticsearch::Client::6_0::Direct/create()>
...
It accepts the same parameters as L<Search::Elasticsearch::Client::6_0::Direct/index()>
except that the document body should be passed as the C<source> or C<_source>
parameter, instead of as C<body>.
...
It accepts the same parameters as L<Search::Elasticsearch::Client::6_0::Direct/delete()>.
...
It accepts the same parameters as L<Search::Elasticsearch::Client::6_0::Direct/update()>.
...
L<Search::Elasticsearch::Client::6_0::Direct/update()>.
