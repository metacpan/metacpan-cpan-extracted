package Google::Ads::AdWords::v201705::IntegerSetAttribute;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201705::Attribute);
# Variety: sequence
...
IntegerSetAttribute from the namespace https://adwords.google.com/api/adwords/o/v201705.
