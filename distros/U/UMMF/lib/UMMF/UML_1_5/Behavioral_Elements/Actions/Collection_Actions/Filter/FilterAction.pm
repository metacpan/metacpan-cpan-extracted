...
package UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction;
...
=head2 C<> : I<THIS> C<0..1> ----E<gt>  C<subtest> : UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::OutputPin C<1>
...
=head2 C<__validate_type>
  ...
  UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction|UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction')  ;
}


=head2 C<__typecheck>

  UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction|UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction>.
...
sub ___initialize
{
  ...
  #   0..1
  #  <--> 
  #  subtest 1 UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::OutputPin.
...
sub __initialize
{
  ...
  $self->UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction::___create(@args);
...
sub add_subinput ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        ...
        $self->__use('UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::OutputPin')->__typecheck($val, "UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction.subinput");
...
Returns the AssociationEnd C<subtest> value of type L<UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::OutputPin|UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::OutputPin>.
...
sub set_subtest ($$)
{
  ...
  if ( ($old = $self->{'subtest'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::OutputPin')->__typecheck($val, "UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction.subtest") }
...
sub add_subtest ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'subtest'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::OutputPin')->__typecheck($val, "UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction.subtest");
      
    # confess("UMMF::UML_1_5::Behavioral_Elements::Actions::Collection_Actions::Filter::FilterAction::subtest: too many")
    # if defined $self->{'subtest'};
...
Clears the AssociationEnd C<subtest> links to L<UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::OutputPin|UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::OutputPin>.
Returns C<$obj>.
...
Returns the number of elements of type L<UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::OutputPin|UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::OutputPin> associated with C<subtest>.
