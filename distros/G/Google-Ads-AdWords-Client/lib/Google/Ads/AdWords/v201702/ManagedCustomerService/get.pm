...
package Google::Ads::AdWords::v201702::ManagedCustomerService::get;
use strict;
use warnings;
...
get from the namespace https://adwords.google.com/api/adwords/mcm/v201702.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::ManagedCustomerService::get->new($data);
