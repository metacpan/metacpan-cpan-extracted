...
# 1
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -B "6001.0B.A"          }) xor mb::eval(q{ -B "6001.0B.ソ"          }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -B "6001.1B.binary.A"   }) xor mb::eval(q{ -B "6001.1B.binary.ソ"   }) },
    sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -B "6001.1B.text.A"     }) xor mb::eval(q{ -B "6001.1B.text.ソ"     }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -B "6001.512B.binary.A" }) xor mb::eval(q{ -B "6001.512B.binary.ソ" }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -B "6001.512B.text.A"   }) xor mb::eval(q{ -B "6001.512B.text.ソ"   }) },
    sub {1},
    sub {1},
# 11
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ (-B "6001.0B.A"         ) xor (-B "6001.0B.ソ"         ) }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ (-B "6001.1B.binary.A"  ) xor (-B "6001.1B.binary.ソ"  ) }) },
    sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ (-B "6001.1B.text.A"    ) xor (-B "6001.1B.text.ソ"    ) }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ (-B "6001.512B.binary.A") xor (-B "6001.512B.binary.ソ") }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ (-B "6001.512B.text.A"  ) xor (-B "6001.512B.text.ソ"  ) }) },
    sub {1},
    sub {1},
# 21
    ...
    sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ opendir(DH1,"6001.777.A"     ); my $r = eval q{ -B DH1 }; closedir DH1; $r                                   }) },
    sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ opendir(DH1,"6001.000.A"     ); my $r = eval q{ -B DH1 }; closedir DH1; $r                                   }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ open(FH1,"6001.0B.A"         ); my $r = -B FH1; close FH1;    $r }) xor mb::eval(q{ -B "6001.0B.ソ"          }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ open(FH1,"6001.1B.binary.A"  ); my $r = -B FH1; close FH1;    $r }) xor mb::eval(q{ -B "6001.1B.binary.ソ"   }) },
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ open(FH1,"6001.512B.binary.A"); my $r = -B FH1; close FH1;    $r }) xor mb::eval(q{ -B "6001.512B.binary.ソ" }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ open(FH1,"6001.512B.text.A"  ); my $r = -B FH1; close FH1;    $r }) xor mb::eval(q{ -B "6001.512B.text.ソ"   }) },
    sub {1},
    sub {1},
# 31
    sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -B "6001.NOTEXIST.A"    }) xor mb::eval(q{ open(FH2,"6001.NOTEXIST.ソ"   ); -B FH2 }) },
    sub { return 'SKIP' unless $MSWin32_MBCS; not                                              mb::eval(q{ opendir(DH2,"6001.777.ソ"     ); -B DH2 }) },
    sub { return 'SKIP' unless $MSWin32_MBCS; not                                              mb::eval(q{ opendir(DH2,"6001.000.ソ"     ); -B DH2 }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -B "6001.0B.A"          }) xor mb::eval(q{ open(FH2,"6001.0B.ソ"         ); -B FH2 }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -B "6001.1B.binary.A"   }) xor mb::eval(q{ open(FH2,"6001.1B.binary.ソ"  ); -B FH2 }) },
    sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -B "6001.1B.text.A"     }) xor mb::eval(q{ open(FH2,"6001.1B.text.ソ"    ); -B FH2 }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -B "6001.512B.binary.A" }) xor mb::eval(q{ open(FH2,"6001.512B.binary.ソ"); -B FH2 }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -B "6001.512B.text.A"   }) xor mb::eval(q{ open(FH2,"6001.512B.text.ソ"  ); -B FH2 }) },
    sub {1},
    sub {1},
# 41
    sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ open(FH1,"6001.NOTEXIST.A"   ); open(FH2,"6001.NOTEXIST.ソ"   ); (-B FH1) xor (-B FH2) }) },
    sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ opendir(DH1,"6001.777.A"     ); opendir(DH2,"6001.777.ソ"     ); (-B DH1) xor (-B DH2) }) },
    sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ opendir(DH1,"6001.000.A"     ); opendir(DH2,"6001.000.ソ"     ); (-B DH1) xor (-B DH2) }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ open(FH1,"6001.0B.A"         ); open(FH2,"6001.0B.ソ"         ); (-B FH1) xor (-B FH2) }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ open(FH1,"6001.1B.binary.A"  ); open(FH2,"6001.1B.binary.ソ"  ); (-B FH1) xor (-B FH2) }) },
    sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ open(FH1,"6001.1B.text.A"    ); open(FH2,"6001.1B.text.ソ"    ); (-B FH1) xor (-B FH2) }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ open(FH1,"6001.512B.binary.A"); open(FH2,"6001.512B.binary.ソ"); (-B FH1) xor (-B FH2) }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ open(FH1,"6001.512B.text.A"  ); open(FH2,"6001.512B.text.ソ"  ); (-B FH1) xor (-B FH2) }) },
    sub {1},
    sub {1},
# 51
