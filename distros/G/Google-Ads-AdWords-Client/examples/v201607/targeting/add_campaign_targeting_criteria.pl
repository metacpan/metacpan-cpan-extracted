...
use Google::Ads::AdWords::v201607::GeoTargetOperand;
use Google::Ads::AdWords::v201607::IncomeOperand;
use Google::Ads::AdWords::v201607::Language;
use Google::Ads::AdWords::v201607::Location;
use Google::Ads::AdWords::v201607::LocationExtensionOperand;
use Google::Ads::AdWords::v201607::LocationGroups;
...
sub add_campaign_targeting_criteria {
  ...
  my $california = Google::Ads::AdWords::v201607::Location->new({id => 21137});
  push @criteria, $california;
  my $mexico = Google::Ads::AdWords::v201607::Location->new({
      id => 2484    # Mexico
  });
  ...
  my $english = Google::Ads::AdWords::v201607::Language->new({id => 1000});
  push @criteria, $english;
  my $spanish = Google::Ads::AdWords::v201607::Language->new({id => 1003});
  ...
  my $income = Google::Ads::AdWords::v201607::LocationGroups->new({
      matchingFunction => Google::Ads::AdWords::v201607::Function->new({
          operator   => "AND",
          lhsOperand => Google::Ads::AdWords::v201607::IncomeOperand->new({
          ...
          rhsOperand => Google::Ads::AdWords::v201607::GeoTargetOperand->new({
  ...
  if ($location_feed_id) {
    ...
    my $radius = Google::Ads::AdWords::v201607::ConstantOperand->new({
        type        => "DOUBLE",
        unit        => "MILES",
        doubleValue => 10.0
    });
    my $radiusLocationGroup =
      Google::Ads::AdWords::v201607::LocationGroups->new({
        matchingFunction => Google::Ads::AdWords::v201607::Function->new({
            operator => "IDENTITY",
            lhsOperand =>
              Google::Ads::AdWords::v201607::LocationExtensionOperand->new(
              {radius => $radius})}
        ),
