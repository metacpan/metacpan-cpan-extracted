package Chart::Plotly::Trace::Histogram::Selected::Marker;
use Moose;
...
Chart::Plotly::Trace::Histogram::Selected::Marker - This attribute is one of the possible options for the trace histogram.
