...
# ABSTRACT: RENAMED -- see DBIO::PostgreSQL::EV::ConnectInfo (dist DBIO-PostgreSQL-EV)
...
die __PACKAGE__ . " has been renamed to DBIO::PostgreSQL::EV::ConnectInfo and this module is"
  . " retired. Install DBIO-PostgreSQL-EV instead:\n"
  . "  cpanm DBIO::PostgreSQL::EV::ConnectInfo\n"
...
DBIO::PostgreSQL::Async::ConnectInfo - RENAMED -- see DBIO::PostgreSQL::EV::ConnectInfo (dist DBIO-PostgreSQL-EV)
...
Install and C<use> L<DBIO::PostgreSQL::EV::ConnectInfo> instead.

=head1 NAME

DBIO::PostgreSQL::Async::ConnectInfo - DEPRECATED, renamed to DBIO::PostgreSQL::EV::ConnectInfo

=head1 SEE ALSO

L<DBIO::PostgreSQL::EV::ConnectInfo>, L<DBIO::PostgreSQL::Async>, L<DBIO::Deprecated>
