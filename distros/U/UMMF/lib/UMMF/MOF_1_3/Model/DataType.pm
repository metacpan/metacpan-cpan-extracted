...
package UMMF::MOF_1_3::Model::DataType;
...
L<UMMF::MOF_1_3::Model::Classifier|UMMF::MOF_1_3::Model::Classifier>
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_3::Model::DataType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_3::Model::DataType|UMMF::MOF_1_3::Model::DataType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_3::Model::DataType')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_3::Model::DataType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_3::Model::DataType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_3::Model::DataType' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_3::Model::DataType|UMMF::MOF_1_3::Model::DataType>.
  ...
  $__tangram_schema ||=
  {
   ...
   [
	 ...
	 # Associations
       ...
       'bases' => [  'UMMF::MOF_1_3::Model::Classifier',  ],
       'sql' => {
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_3::Model::DataType::___create(@args);
