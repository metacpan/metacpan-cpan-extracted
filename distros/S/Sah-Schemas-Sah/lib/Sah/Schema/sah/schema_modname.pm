...
This document describes version 0.9.50.0 of Sah::Schema::sah::schema_modname (from Perl distribution Sah-Schemas-Sah), released on 2021-07-23.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("sah::schema_modname*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("sah::schema_modname*");
     $validator->(\@args);
     ...
 }
