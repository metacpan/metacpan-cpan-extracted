...
The model to use for image generation. Only C<dall-e-2> and the GPT image models are supported. Defaults to C<dall-e-2> unless a parameter specific to the GPT image models is used.
