package Chart::Plotly::Trace::Scatter::Unselected::Textfont;
use Moose;
...
Chart::Plotly::Trace::Scatter::Unselected::Textfont - This attribute is one of the possible options for the trace scatter.
