...
package Google::Ads::AdWords::v201710::CustomerExtensionSettingService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201710::CustomerExtensionSettingOperation',
    },
    {
...
Google::Ads::AdWords::v201710::CustomerExtensionSettingService::mutate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutate from the namespace https://adwords.google.com/api/adwords/cm/v201710.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201710::CustomerExtensionSettingService::mutate->new($data);

Constructor. The following data structure may be passed to new():

 {
   operations =>  $a_reference_to, # see Google::Ads::AdWords::v201710::CustomerExtensionSettingOperation
 },
