...
our $VERSION = '0.11';
our @PROPERTIES = qw( ClickFind EquatorialToStarChartXY Find Open Refresh Save StarChartXYToEquatorial UpdateSolarSystem DocumentProperty SetDocumentProperty DisplayProperty SetDisplayProperty );
