...
use_ok('Net::AmazonS3::Simple::Object::Memory');

my $content = "--SOME-CONTENT--";
our $etag = md5_hex("$content\n");
my $content_length = length $content;

my $obj = Net::AmazonS3::Simple::Object::Memory->create_from_response(
    validate => 1,
...
throws_ok {
    local $etag = 'xx';
    Net::AmazonS3::Simple::Object::Memory->create_from_response(
        validate => 1,
        response => HTTP::Response->parse(msg()),
    );
