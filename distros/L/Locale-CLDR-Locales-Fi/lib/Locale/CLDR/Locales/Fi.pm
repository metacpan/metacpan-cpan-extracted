	...
	default		=> sub { {
				'long' => {
					...
					'liter-per-100kilometers' => {
						'name' => q(litrat per 100 kilometriä),
						'one' => q({0} litra per 100 km),
						'other' => q({0} litraa per 100 km),
					},
					'liter-per-kilometer' => {
						'name' => q(litrat per kilometri),
					...
					'pound-per-square-inch' => {
						'name' => q(paunat neliötuumaa kohti),
