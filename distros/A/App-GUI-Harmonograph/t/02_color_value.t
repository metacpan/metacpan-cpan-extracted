...
my $module = 'App::GUI::Harmonograph::Color::Value';

eval "use $module qw/:all/";
is( not($@), 1, 'could load the module');

my $chk_rgb        = \&App::GUI::Harmonograph::Color::Value::check_rgb;
my $chk_hsl        = \&App::GUI::Harmonograph::Color::Value::check_hsl;
my $tr_rgb         = \&App::GUI::Harmonograph::Color::Value::trim_rgb;
my $tr_hsl         = \&App::GUI::Harmonograph::Color::Value::trim_hsl;
my $d_rgb          = \&App::GUI::Harmonograph::Color::Value::distance_rgb;
my $d_hsl          = \&App::GUI::Harmonograph::Color::Value::distance_hsl;
my $rgb2h          = \&App::GUI::Harmonograph::Color::Value::hex_from_rgb;
...
warning_like {hsl_from_rgb(1,1,1,1)} {carped => qr/3 positive integer/},
                                                      "need 3 values rgb to convert color from rgb to hsl";
warning_like {hsl_from_rgb(1,1)} {carped => qr/3 positive integer/},
                                                      "need 3 values rgb to convert color from rgb to hsl";
warning_like {hsl_from_rgb(1,1,-1)} {carped => qr/blue value/},
                                                      "blue value is too small for conversion";
warning_like {hsl_from_rgb(256,1,0)} {carped => qr/red value/},
                                                      "red value is too large for conversion";
warning_like {rgb_from_hsl(1,1)} {carped => qr/3 positive integer/},
                                                      "need 3 values rgb to convert color from rgb to hsl";

@hsl = hsl_from_rgb(127, 127, 127);
...
is( distance_rgb([1, 2, 3], [  2, 6, 11]), 9,     'compute rgb distance');
is( distance_hsl([1, 2, 3], [  2, 6, 11]), 9,     'compute hsl distance');
is( distance_hsl([0, 2, 3], [359, 6, 11]), 9,     'compute hsl distance (test circular property of hsl)');
