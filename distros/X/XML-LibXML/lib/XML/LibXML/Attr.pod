...
=head1 SYNOPSIS
  ...
  $attr = XML::LibXML::Attr-E<gt>new($name [,$value]);
  $string = $attr-E<gt>getValue();
  $string = $attr-E<gt>value;
  $attr-E<gt>setValue( $string );
  $node = $attr-E<gt>getOwnerElement();
  $attr-E<gt>setNamespace($nsURI, $prefix);
  $bool = $attr-E<gt>isId;
  $string = $attr-E<gt>serializeContent;
