package # Hide from pause
     TestSchema::Sakila3::Result::FilmCategory;
...
Related object: L<TestSchema::Sakila3::Result::Film>

=cut

__PACKAGE__->belongs_to(
  "film",
  "TestSchema::Sakila3::Result::Film",
  { film_id => "film_id" },
...
Related object: L<TestSchema::Sakila3::Result::Category>

=cut

__PACKAGE__->belongs_to(
  "category",
  "TestSchema::Sakila3::Result::Category",
