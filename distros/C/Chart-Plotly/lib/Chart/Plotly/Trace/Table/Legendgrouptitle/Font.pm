package Chart::Plotly::Trace::Table::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Table::Legendgrouptitle::Font - This attribute is one of the possible options for the trace table.
