...
use strict;
use vars qw($Expect);
use Test::Legacy qw($TESTOUT $TESTERR $ntest ok skip plan);
plan tests => 14;

# This test is very specific about what our output looks like.  The
# special code for when run under Test::Harness interferes with that.
