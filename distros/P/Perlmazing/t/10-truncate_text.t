...
is truncate_text($string, 3, '...'), 'Thi...', 'truncated at the right place with appended text';
is truncate_text($string, 3, '...', '---'), 'Thi...---', 'truncated at the right place with appended text';
is truncate_text($string, 3, undef, '---'), 'Thi---', 'truncated at the right place with appended text';
...
is truncate_text($string, 37, '...'), 'This is an awesome string for testing.', 'truncated at the right place';
is truncate_text($string, 37, '...', '---'), 'This is an awesome string for testing.', 'truncated at the right place';
is truncate_text($string, 38), 'This is an awesome string for testing.', 'truncated at the right place';
is truncate_text($string, 38, '...', '---'), 'This is an awesome string for testing.', 'truncated at the right place with appended text';