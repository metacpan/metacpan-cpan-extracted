...
$Shipment::FedEx::WSDL::ShipTypes::ShipmentRoutingDetail::VERSION = '3.02';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    my %DestinationLocationStateOrProvinceCode_of :
      ATTR(:get<DestinationLocationStateOrProvinceCode>);
    ...
    __PACKAGE__->_factory(
        ...
        {   'UrsaPrefixCode'         => \%UrsaPrefixCode_of,
            ...
            'DestinationLocationStateOrProvinceCode' =>
              \%DestinationLocationStateOrProvinceCode_of,
