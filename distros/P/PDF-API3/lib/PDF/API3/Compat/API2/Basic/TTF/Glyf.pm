...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::TTF::Glyf;

=head1 NAME

PDF::API3::Compat::API2::Basic::TTF::Glyf - The Glyf data table
...
sub XML_start
{
    ...
    if ($tag eq 'glyph')
    {
        $context->{'tree'}[-1] = PDF::API3::Compat::API2::Basic::TTF::Glyph->new(read => 2, PARENT => $self->{' PARENT'});
