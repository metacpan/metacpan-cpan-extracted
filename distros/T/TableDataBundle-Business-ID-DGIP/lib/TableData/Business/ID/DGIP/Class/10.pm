...
our %STATS = ("num_columns",2,"num_rows",1592); # STATS
...
TableDataRole::Business::ID::DGIP::Class::10 - List of products/services in class 10 ("Medical equipments & supplies") in Indonesian DGIP (Directorate General of Intellectual Property)

=head1 VERSION

This document describes version 20230207.0.0 of TableDataRole::Business::ID::DGIP::Class::10 (from Perl distribution TableDataBundle-Business-ID-DGIP), released on 2023-02-07.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Business::ID::DGIP::Class::10;

 my $td = TableData::Business::ID::DGIP::Class::10->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Business::ID::DGIP::Class::10 --page

 # Get number of rows
 % tabledata --action count_rows Business::ID::DGIP::Class::10
