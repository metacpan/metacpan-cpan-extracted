package Google::Ads::AdWords::v201609::PolicyData;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'disapprovalReasons' => 'Google::Ads::AdWords::v201609::DisapprovalReason',
...
PolicyData from the namespace https://adwords.google.com/api/adwords/cm/v201609.
