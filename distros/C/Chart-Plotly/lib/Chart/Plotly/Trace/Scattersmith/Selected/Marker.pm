package Chart::Plotly::Trace::Scattersmith::Selected::Marker;
use Moose;
...
Chart::Plotly::Trace::Scattersmith::Selected::Marker - This attribute is one of the possible options for the trace scattersmith.
