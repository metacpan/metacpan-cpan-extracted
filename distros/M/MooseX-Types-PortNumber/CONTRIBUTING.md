...
https://metacpan.org/release/MooseX-Types-PortNumber

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends MooseX::Types::PortNumber
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends MooseX::Types::PortNumber
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=MooseX-Types-PortNumber)
