...
use Google::Ads::AdWords::v201309::BasicUserList;
use Google::Ads::AdWords::v201309::Selector;
use Google::Ads::AdWords::v201309::UserListConversionType;
use Google::Ads::AdWords::v201309::UserListOperation;
...
sub add_audience {
  ...
  my $conversion_type =
      Google::Ads::AdWords::v201309::UserListConversionType->new({
          name => $name
      });

  # Create remarketing user list.
  my $user_list = Google::Ads::AdWords::v201309::BasicUserList->new({
    name => $name,
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201309::UserListOperation->new({
    operator => "ADD",
    operand => $user_list
  });
  ...
  if ($result->get_value()) {
    ...
    sleep(5);
    my $predicate = Google::Ads::AdWords::v201309::Predicate->new({
      field => "Id",
      operator => "IN",
    ...
    $selector = Google::Ads::AdWords::v201309::Selector->new({
      fields => ["Id"],
