...
#=======================================================================
#
#   PDF::API3::Compat::API2::Matrix
#   Original Copyright 1995-96 Ulrich Pfeifer.
#   modified by Alfred Reibenschuh <areibens@cpan.org> for PDF::API3::Compat::API2
#
#   $Id: Matrix.pm,v 2.0 2005/11/16 02:16:00 areibens Exp $
#
#=======================================================================
package PDF::API3::Compat::API2::Matrix;
...
sub concat {
    my $self = shift;
    my $other = shift;
    my $result = new PDF::API3::Compat::API2::Matrix (@{$self});
...
sub transpose {
    ...
    new PDF::API3::Compat::API2::Matrix (@result);
}
...
sub solve {
    my $m    = new PDF::API3::Compat::API2::Matrix (@{$_[0]});
    my $mr   = $#{$m};
    my $mc   = $#{$m->[0]};
    my $f;
    my $try;
...
# Answer is in augmented column
    transpose new PDF::API3::Compat::API2::Matrix @{$m->transpose}[$mr+1 .. $mc];
}
