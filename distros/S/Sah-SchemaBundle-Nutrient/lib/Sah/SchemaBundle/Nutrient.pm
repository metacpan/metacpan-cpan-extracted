package Sah::SchemaBundle::Nutrient;
...
Sah::SchemaBundle::Nutrient - Sah schemas related to nutrients
...
=item * L<nutrient::symbol|Sah::Schema::nutrient::symbol>

A known nutrient symbol, from TableData::Health::Nutrient.
