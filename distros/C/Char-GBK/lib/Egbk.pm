...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                                                2   3                                  4   5
                q<CORE::eval{local $Egbk::re_t=%s; local $Egbk::re_a=''; while($Egbk::re_t =~ %s){%s local $^W=0; local $Egbk::re_r=%s; %s$Egbk::re_t="$Egbk::re_a${1}$Egbk::re_r$'"; pos($Egbk::re_t)=length "$Egbk::re_a${1}$Egbk::re_r"; $Egbk::re_a=substr($Egbk::re_t,0,pos($Egbk::re_t)); } return $Egbk::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Egbk::re_r=CORE::eval $Egbk::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Egbk::re_t=%s; while($Egbk::re_t =~ %s){%s local $^W=0; local $Egbk::re_r=%s; %s$Egbk::re_t="$`$Egbk::re_r$'"; pos($Egbk::re_t)=length "$`$Egbk::re_r"; } return $Egbk::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Egbk::re_r=%s; %s"%s$Egbk::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Egbk::re_n=0; local $Egbk::re_a=''; while(%s =~ %s){%s local $^W=0; local $Egbk::re_r=%s; %s%s="$Egbk::re_a${1}$Egbk::re_r$'"; pos(%s)=length "$Egbk::re_a${1}$Egbk::re_r"; $Egbk::re_a=substr(%s,0,pos(%s)); $Egbk::re_n++} return %s$Egbk::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Egbk::re_n=0; while(%s =~ %s){%s local $^W=0; local $Egbk::re_r=%s; %s%s="$`$Egbk::re_r$'"; pos(%s)=length "$`$Egbk::re_r"; $Egbk::re_n++} return %s$Egbk::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Egbk::re_r=%s; %s%s="%s$Egbk::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Egbk::re_r=%s; %s%s="%s$Egbk::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Egbk::re_r=CORE::eval $Egbk::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
