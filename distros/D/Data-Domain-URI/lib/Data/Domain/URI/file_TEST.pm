...
package Data::Domain::URI::file_TEST;
our $VERSION = '1.100850';
# ABSTRACT: Test companion class for the file URI data domain class
use Test::More;
use parent qw(
...
Test companion class for L<Data::Domain::URI::file>. Gets its
