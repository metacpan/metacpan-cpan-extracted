package Chart::Plotly::Trace::Scattersmith::Marker::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Scattersmith::Marker::Colorbar::Tickfont;
use Chart::Plotly::Trace::Scattersmith::Marker::Colorbar::Tickformatstop;
use Chart::Plotly::Trace::Scattersmith::Marker::Colorbar::Title;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattersmith::Marker::Colorbar::Tickfont", );
...
has tickformatstops => (
                       is  => "rw",
                       isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Scattersmith::Marker::Colorbar::Tickformatstop]",
);
...
has title => ( is  => "rw",
               isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattersmith::Marker::Colorbar::Title", );
...
Chart::Plotly::Trace::Scattersmith::Marker::Colorbar - This attribute is one of the possible options for the trace scattersmith.
