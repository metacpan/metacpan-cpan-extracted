...
Text::Safer::alphanum_snake - Convert text to a safer (e.g. more restricted) encoding using only alphanumeric and underscore characters

=head1 VERSION

This document describes version 0.002 of Text::Safer::alphanum_snake (from Perl distribution Text-Safer), released on 2025-06-11.
