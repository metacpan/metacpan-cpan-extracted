package Chart::Plotly::Trace::Choroplethmapbox::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Choroplethmapbox::Hoverlabel::Font - This attribute is one of the possible options for the trace choroplethmapbox.
