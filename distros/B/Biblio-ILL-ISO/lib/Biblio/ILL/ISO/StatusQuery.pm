package Biblio::ILL::ISO::StatusQuery;

=head1 NAME

Biblio::ILL::ISO::StatusQuery - Perl extension for handling ISO 10161 interlibrary loan Status-Query messages
...
Biblio::ILL::ISO::StatusQuery is a derivation of the abstract 
Biblio::ILL::ISO::ISO object, and handles the Status-Query message type.
...
Status-Query message from a file (followed by a call to
