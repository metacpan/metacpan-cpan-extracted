package Chart::Plotly::Trace::Densitymapbox::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Densitymapbox::Colorbar::Tickfont - This attribute is one of the possible options for the trace densitymapbox.
