...
Sah::SchemaR::pathname::unix - Filesystem path name on a Unix system

=head1 VERSION

This document describes version 0.031 of Sah::SchemaR::pathname::unix (from Perl distribution Sah-SchemaBundle-Path), released on 2024-02-16.
