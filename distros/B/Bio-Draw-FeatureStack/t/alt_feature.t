##test case for alt_feature parameters
...
lives_ok { figure1() }  'Generation of alt_feature test';

sub figure1
{
	my $output_basename = "t/images/alt_feature";
	
	my @gene_names = (qw (xbx-3 xbx-4));
...
#		-verbose => 0,
		-glyph_params => {
							-description => sub {"xbox are the alt feature type" },
							-utr_color   => 'white',
							-pad_bottom  => 10,
							-height      =>  12,
							-label_transcripts => 1,
