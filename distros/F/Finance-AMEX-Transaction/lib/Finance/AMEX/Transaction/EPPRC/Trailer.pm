...
$Finance::AMEX::Transaction::EPPRC::Trailer::VERSION = '0.002';
use strict;
use warnings;

# ABSTRACT: Parse AMEX Transaction/Invoice Level Reconciliation (EPPRC) Trailer Rows
...
Returns a new L<Finance::AMEX::Transaction::EPPRC::Trailer> object.
...
Finance::AMEX::Transaction::EPPRC::Footer - Object methods for AMEX Reconciliation file footer records.
