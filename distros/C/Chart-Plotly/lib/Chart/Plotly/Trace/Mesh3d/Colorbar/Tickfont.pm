package Chart::Plotly::Trace::Mesh3d::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Mesh3d::Colorbar::Tickfont - This attribute is one of the possible options for the trace mesh3d.
