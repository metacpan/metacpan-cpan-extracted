package Data::Sah::Coerce::perl::To_date::From_str::flexible_utc;
...
sub meta {
    +{
        v => 4,
        summary => 'Coerce date from string parsed by DateTime::Format::Flexible (UTC time zone)',
        might_fail => 1,
...
sub coerce {
    ...
    $res->{expr_coerce} = join(
        "",
        "do { my \$datetime; eval { \$datetime = DateTime::Format::Flexible->parse_datetime($dt)->set_time_zone('UTC') }; ",
...
1;
# ABSTRACT: Coerce date from string parsed by DateTime::Format::Flexible (UTC time zone)
...
Data::Sah::Coerce::perl::To_date::From_str::flexible_utc - Coerce date from string parsed by DateTime::Format::Flexible (UTC time zone)

=head1 VERSION

This document describes version 0.009 of Data::Sah::Coerce::perl::To_date::From_str::flexible_utc (from Perl distribution Data-Sah-Coerce-perl-To_date-From_str-flexible), released on 2021-09-07.

=head1 SYNOPSIS

To use in a Sah schema:

 ["date",{"x.perl.coerce_rules"=>["From_str::flexible_utc"]}]
