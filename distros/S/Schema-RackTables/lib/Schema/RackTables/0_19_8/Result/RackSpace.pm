use utf8;
package Schema::RackTables::0_19_8::Result::RackSpace;
...
Schema::RackTables::0_19_8::Result::RackSpace
...
Related object: L<Schema::RackTables::0_19_8::Result::Rack>

=cut

__PACKAGE__->belongs_to(
  "rack",
  "Schema::RackTables::0_19_8::Result::Rack",
  { id => "rack_id" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:puQKRp2742uOexUUkhJEmw
