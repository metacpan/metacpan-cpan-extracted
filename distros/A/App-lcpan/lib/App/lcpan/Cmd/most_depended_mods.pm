...
1;
# ABSTRACT: Alias for 'mods-by-rdep-count', with default n=100
...
App::lcpan::Cmd::most_depended_mods - Alias for 'mods-by-rdep-count', with default n=100

=head1 VERSION

This document describes version 1.073 of App::lcpan::Cmd::most_depended_mods (from Perl distribution App-lcpan), released on 2023-07-09.
