...
sub evaluate { $_[1]->eval_expr_stmt($_[0]) }

=pod

=head1 NAME

Zuzu::AST::Stmt::Expr - AST node for expr statements
...
B<< Zuzu::AST::Stmt::Expr >> is copyright Toby Inkster.
