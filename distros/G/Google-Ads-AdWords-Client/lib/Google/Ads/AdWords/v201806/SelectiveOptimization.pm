package Google::Ads::AdWords::v201806::SelectiveOptimization;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'conversionTypeIdsOps' => 'Google::Ads::AdWords::v201806::ListOperations',
    },
    {
...
Google::Ads::AdWords::v201806::SelectiveOptimization

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
SelectiveOptimization from the namespace https://adwords.google.com/api/adwords/cm/v201806.

Selected set of conversion types or a selective optimization set id for optimizing campaigns. For e.g. For universal app campaigns, these are the set of in-app actions to optimize the campaign towards. 
