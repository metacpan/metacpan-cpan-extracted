...
Meta::Utils::Output::print($gen->person($gen->name("Bob"),$gen->age(34),$gen->job("Accountant")));
...
generator.pl - test the external XML::Generator module.
...
This is a test suite for the XML::Generator package.
...
Meta::Baseline::Test(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), XML::Generator(3), strict(3)
