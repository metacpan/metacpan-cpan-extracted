package Shipment::FedEx::WSDL::ShipTypes::UploadDocumentReferenceDetail;
$Shipment::FedEx::WSDL::ShipTypes::UploadDocumentReferenceDetail::VERSION = '3.10';
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'DocumentProducer' => 'Shipment::FedEx::WSDL::ShipTypes::UploadDocumentProducerType',
        'DocumentType' => 'Shipment::FedEx::WSDL::ShipTypes::UploadDocumentType',
        'DocumentId' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'DocumentIdProducer' => 'Shipment::FedEx::WSDL::ShipTypes::UploadDocumentIdProducer',
    },
    {
...
UploadDocumentReferenceDetail from the namespace http://fedex.com/ws/ship/v9.
