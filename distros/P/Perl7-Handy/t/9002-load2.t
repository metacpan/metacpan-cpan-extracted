...
### Perl 5.10.x makes FAIL on "Section 2: INA_CPAN_Check",
### since Perl7::Handy removes ".(dot)" from @INC at compile-time,
### Thus this dist devides t/9001-loat.t to two tests;
### - t/9001-load1.t for Section 1
### - t/9002-load2.t for Section 2
###
### ######################################################################
