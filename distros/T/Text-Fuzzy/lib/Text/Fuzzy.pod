...
(This example is included as L<F<synopsis.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.26/examples/synopsis.pl> in the distribution.)


=head1 VERSION

This documents version 0.26 of Text::Fuzzy corresponding
to git commit L<41c9f86088a4b233672c4782c164226ff99aba9c|https://github.com/benkasminbullock/Text-Fuzzy/commit/41c9f86088a4b233672c4782c164226ff99aba9c> released on Mon Jul 10 17:20:20 2017 +0900.
...
(This example is included as L<F<unicode.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.26/examples/unicode.pl> in the distribution.)
...
Setting C<max> to zero makes C<$tf> only match exactly, which is also
pointless, but you're very welcome to do it.

The method L</set_max_distance> also does the same thing as this
parameter.
...
(This example is included as L<F<distance.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.26/examples/distance.pl> in the distribution.)
...
(This example is included as L<F<nearestv.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.26/examples/nearestv.pl> in the distribution.)
...
(This example is included as L<F<check-return.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.26/examples/check-return.pl> in the distribution.)
...
(This example is included as L<F<list-context.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.26/examples/list-context.pl> in the distribution.)
...
(This example is included as L<F<last-distance.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.26/examples/last-distance.pl> in the distribution.)
...
(This example is included as L<F<max-dist.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.26/examples/max-dist.pl> in the distribution.)
...
(This example is included as L<F<no-exact.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.26/examples/no-exact.pl> in the distribution.)
...
(This example is included as L<F<distance-edits.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.26/examples/distance-edits.pl> in the distribution.)
...
The file 
L<F<examples/misspelt-web-page.cgi>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.26/examples/misspelt-web-page.cgi>
...
The file 
L<F<examples/spell-check.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.26/examples/spell-check.pl>
 is a spell checker. It uses a
...
The file 
L<F<examples/extract-kana.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.26/examples/extract-kana.pl>
 extracts the kana entries
...
Determine the edit transcript between two strings.
...
L<Text::Levenshtein::Damerau::XS> module. Nils Boeffel reported a bug
where strings may be overwritten in version 0.25.
