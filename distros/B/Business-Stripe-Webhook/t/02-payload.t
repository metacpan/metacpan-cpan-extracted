...
my $webhook_fail1 = Business::Stripe::Webhook->new(
    'signing_secret' => 'whsec_...',
    'payload'        => '',
    'invoice-paid'   => \&pay_invoice,
);

ok( !$webhook_fail1->success, "Didn't instantiate" );
is( $webhook_fail1->error, "Missing payload data", "Missing payload data" );
...
ok( $webhook_pass->success, "Instantiated" );

$ENV{'HTTP_STRIPE_SIGNATURE'} = 't=ABCDEFGHIJ,v1=abcdefghij';

$webhook_pass->process();

ok( $webhook_pass->success, "All webhooks handled" );
