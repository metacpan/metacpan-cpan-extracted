...
This document describes version 0.006 of BorderStyle::UTF8::SingleLineBoldHeader (from Perl distribution BorderStyles-Standard), released on 2021-02-19.
...
To use with L<Text::Table::TinyBorderStyle>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"BorderStyle::UTF8::SingleLineBoldHeader");
