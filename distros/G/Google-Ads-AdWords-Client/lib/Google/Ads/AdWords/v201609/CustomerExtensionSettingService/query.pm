...
package Google::Ads::AdWords::v201609::CustomerExtensionSettingService::query;
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201609::CustomerExtensionSettingService::query->new($data);
