...
package Shipment::Purolator::WSDL::Elements::GetServiceRulesResponse;
$Shipment::Purolator::WSDL::Elements::GetServiceRulesResponse::VERSION = '3.10';
use strict;
use warnings;
...
GetServiceRulesResponse from the namespace http://purolator.com/pws/datatypes/v1.
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDL::Elements::GetServiceRulesResponse->new($data);
