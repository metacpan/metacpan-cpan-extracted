package Chart::Plotly::Trace::Funnel::Outsidetextfont;
use Moose;
...
Chart::Plotly::Trace::Funnel::Outsidetextfont - This attribute is one of the possible options for the trace funnel.
