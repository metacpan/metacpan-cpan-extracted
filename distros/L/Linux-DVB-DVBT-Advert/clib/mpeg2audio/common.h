...
#define get_bits(s, n)  get_bits_trace(s, n, __FILE__, "getbits", __LINE__)
#define get_bits1(s)    get_bits_trace(s, 1, __FILE__, "getbits1", __LINE__)
#define get_xbits(s, n) get_xbits_trace(s, n, __FILE__, __FUNCTION__, __LINE__)
