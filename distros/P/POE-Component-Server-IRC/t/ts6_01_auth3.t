...
my @responses = (
':listen.server.irc NOTICE * :*** Checking Ident',
':listen.server.irc NOTICE * :*** Checking Hostname',
':listen.server.irc NOTICE * :*** Found your hostname',
':listen.server.irc NOTICE * :*** No Ident response',
':listen.server.irc NOTICE * :*** Notice -- You need to install identd to use this server',
