package Chart::Plotly::Trace::Histogram::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Histogram::Legendgrouptitle::Font - This attribute is one of the possible options for the trace histogram.
