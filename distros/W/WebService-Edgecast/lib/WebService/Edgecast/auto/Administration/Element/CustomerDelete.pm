...
package WebService::Edgecast::auto::Administration::Element::CustomerDelete;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerDelete::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerDelete');
...
WebService::Edgecast::auto::Administration::Element::CustomerDelete
...
CustomerDelete from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerDelete->new($data);
