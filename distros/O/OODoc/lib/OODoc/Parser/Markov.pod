...
Inherited, see L<OODoc::Parser/"Parsing a file">
...
When the whole C<$input> was parsed, the documentation part was still open.
...
=item Warning: option "$name" unknown for $call() in $package, found in $manual
