...
1;
# ABSTRACT: List Pod::Weaver plugins ranked by number of reverse dependencies
...
App::lcpan::Cmd::weaver_plugins_by_rdep_count - List Pod::Weaver plugins ranked by number of reverse dependencies

=head1 VERSION

This document describes version 0.030 of App::lcpan::Cmd::weaver_plugins_by_rdep_count (from Perl distribution App-lcpan-CmdBundle-weaver), released on 2019-11-20.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<weaver-plugins-by-rdep-count>.
...
List Pod::Weaver plugins ranked by number of reverse dependencies.
