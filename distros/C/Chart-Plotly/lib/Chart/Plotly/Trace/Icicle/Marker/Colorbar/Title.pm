package Chart::Plotly::Trace::Icicle::Marker::Colorbar::Title;
use Moose;
...
use Chart::Plotly::Trace::Icicle::Marker::Colorbar::Title::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Icicle::Marker::Colorbar::Title::Font", );
...
Chart::Plotly::Trace::Icicle::Marker::Colorbar::Title - This attribute is one of the possible options for the trace icicle.
