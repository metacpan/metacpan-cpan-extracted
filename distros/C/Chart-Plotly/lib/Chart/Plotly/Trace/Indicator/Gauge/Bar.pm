package Chart::Plotly::Trace::Indicator::Gauge::Bar;
use Moose;
...
use Chart::Plotly::Trace::Indicator::Gauge::Bar::Line;
...
has description => ( is      => "ro",
                     default => "Set the appearance of the gauge's value", );

has line => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Indicator::Gauge::Bar::Line", );
...
Chart::Plotly::Trace::Indicator::Gauge::Bar - This attribute is one of the possible options for the trace indicator.
