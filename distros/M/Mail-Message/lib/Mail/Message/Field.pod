...
string is produced by L<unfoldedBody()|Mail::Message::Field/"Access to the body">.
...
L<folded()|Mail::Message::Field/"Access to the body">. However, the optional C<$wrap> will cause to re-fold to take
...
This method may not be what you want: the L<foldedBody()|Mail::Message::Field/"Access to the body"> and
L<unfoldedBody()|Mail::Message::Field/"Access to the body"> are probably where you are looking for.  Those will
