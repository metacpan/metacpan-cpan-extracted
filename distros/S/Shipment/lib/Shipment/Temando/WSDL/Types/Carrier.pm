...
$Shipment::Temando::WSDL::Types::Carrier::VERSION = '3.11';
use strict;
use warnings;
...
Carrier from the namespace http://' . $Shipment::Temando::WSDL::Interfaces::quoting_Service::quoting_port::ns_url . '/schema/2009_06/common.xsd.
