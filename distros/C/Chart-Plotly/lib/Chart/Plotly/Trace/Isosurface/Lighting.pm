package Chart::Plotly::Trace::Isosurface::Lighting;
use Moose;
...
Chart::Plotly::Trace::Isosurface::Lighting - This attribute is one of the possible options for the trace isosurface.
