# distribution XML-Compile-Tester

  * My extended documentation: <http://perl.overmeer.net/CPAN/>
  * Development via GitHub: <https://github.com/markov2/perl5-XML-Compile-Tester>
  * Download from CPAN: <ftp://ftp.cpan.org/pub/CPAN/authors/id/M/MA/MARKOV/>
  * Indexed from CPAN: <http://search.cpan.org/~markov/XML-Compile-Tester/>
    and <https://metacpan.org/release/XML-Compile-Tester>
