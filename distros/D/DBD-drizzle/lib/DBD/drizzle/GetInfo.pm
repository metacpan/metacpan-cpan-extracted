...
my $sql_driver = 'drizzle';
my $sql_ver_fmt = '%02d.%02d.%04d';   # ODBC version string: ##.##.#####
my $sql_driver_ver = do {
    no warnings;
    sprintf $sql_ver_fmt, split (/./, $DBD::drizzle::VERSION);
};
...
sub makefunk ($) {
     my $type = shift;
     return sub {dbd_drizzle_get_info(shift, $type)}
}
...
#     5 => undef,                         # SQL_DRIVER_HSTMT
    ...
    147 => 6016,                          # SQL_FORWARD_ONLY_CURSOR_ATTRIBUTES2
     ...
     #29 => sub {dbd_drizzle_get_info(shift,$GetInfoType {SQL_IDENTIFIER_QUOTE_CHAR})},
