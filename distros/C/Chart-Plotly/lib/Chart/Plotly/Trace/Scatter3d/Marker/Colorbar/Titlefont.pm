package Chart::Plotly::Trace::Scatter3d::Marker::Colorbar::Titlefont;
use Moose;
...
Chart::Plotly::Trace::Scatter3d::Marker::Colorbar::Titlefont - This attribute is one of the possible options for the trace scatter3d.
