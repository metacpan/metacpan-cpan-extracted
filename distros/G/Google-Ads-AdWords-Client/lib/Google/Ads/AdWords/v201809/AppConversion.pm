package Google::Ads::AdWords::v201809::AppConversion;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201809::ConversionTracker);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201809::ConversionTracker::Status',
        'category' => 'Google::Ads::AdWords::v201809::ConversionTracker::Category',
        'googleEventSnippet' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'googleGlobalSiteTag' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'dataDrivenModelStatus' => 'Google::Ads::AdWords::v201809::DataDrivenModelStatus',
        ...
        'countingType' => 'Google::Ads::AdWords::v201809::ConversionDeduplicationMode',
        ...
        'attributionModelType' => 'Google::Ads::AdWords::v201809::AttributionModelType',
        ...
        'appPlatform' => 'Google::Ads::AdWords::v201809::AppConversion::AppPlatform',
        'snippet' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'appConversionType' => 'Google::Ads::AdWords::v201809::AppConversion::AppConversionType',
...
Google::Ads::AdWords::v201809::AppConversion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AppConversion from the namespace https://adwords.google.com/api/adwords/cm/v201809.
