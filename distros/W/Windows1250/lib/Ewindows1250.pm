package Ewindows1250;
use strict;
BEGIN { $INC{'warnings.pm'} = '' if $] < 5.006 } use warnings;
######################################################################
#
# Ewindows1250 - Run-time routines for Windows1250.pm
#
...
BEGIN {
    ...
    sub qualify ($$) {
        ...
        elsif (Ewindows1250::index($name,'::') >= 0) {
            return $name;
        }
        elsif (Ewindows1250::index($name,"'") >= 0) {
            return $name;
...
#
# Windows-1250 character range per length
#
my %range_tr = ();

#
# Windows-1250 case conversion
#
my %lc = ();
...
if (0) {
...
elsif (__PACKAGE__ =~ / \b Ewindows1250 \z/oxms) {
    %range_tr = (
        1 => [ [0x00..0xFF],
             ],
    );
    ...
    %lc = (%lc,
        ...
        "\x8C" => "\x9C",     # LATIN LETTER S WITH ACUTE
        "\x8D" => "\x9D",     # LATIN LETTER T WITH CARON
        "\x8E" => "\x9E",     # LATIN LETTER Z WITH CARON
        "\x8F" => "\x9F",     # LATIN LETTER Z WITH ACUTE
        "\xA3" => "\xB3",     # LATIN LETTER L WITH STROKE
        "\xA5" => "\xB9",     # LATIN LETTER A WITH OGONEK
        "\xAA" => "\xBA",     # LATIN LETTER S WITH CEDILLA
        "\xAF" => "\xBF",     # LATIN LETTER Z WITH DOT ABOVE
        "\xBC" => "\xBE",     # LATIN LETTER L WITH CARON
    ...
    %fc = (%fc,
        ...
        "\x8C" => "\x9C",     # LATIN CAPITAL LETTER S WITH ACUTE        --> LATIN SMALL LETTER S WITH ACUTE
        "\x8D" => "\x9D",     # LATIN CAPITAL LETTER T WITH CARON        --> LATIN SMALL LETTER T WITH CARON
        "\x8E" => "\x9E",     # LATIN CAPITAL LETTER Z WITH CARON        --> LATIN SMALL LETTER Z WITH CARON
        "\x8F" => "\x9F",     # LATIN CAPITAL LETTER Z WITH ACUTE        --> LATIN SMALL LETTER Z WITH ACUTE
        "\xA3" => "\xB3",     # LATIN CAPITAL LETTER L WITH STROKE       --> LATIN SMALL LETTER L WITH STROKE
        "\xA5" => "\xB9",     # LATIN CAPITAL LETTER A WITH OGONEK       --> LATIN SMALL LETTER A WITH OGONEK
        ...
        "\xBC" => "\xBE",     # LATIN CAPITAL LETTER L WITH CARON        --> LATIN SMALL LETTER L WITH CARON
...
sub import {
    ...
    *Char::ord           = \&Windows1250::ord;
    *Char::ord_          = \&Windows1250::ord_;
    *Char::reverse       = \&Windows1250::reverse;
    *Char::getc          = \&Windows1250::getc;
    *Char::length        = \&Windows1250::length;
    *Char::substr        = \&Windows1250::substr;
    *Char::index         = \&Windows1250::index;
    *Char::rindex        = \&Windows1250::rindex;
    *Char::eval          = \&Windows1250::eval;
    *Char::escape        = \&Windows1250::escape;
    *Char::escape_token  = \&Windows1250::escape_token;
    *Char::escape_script = \&Windows1250::escape_script;
}
...
#
sub unimport {}
sub Ewindows1250::split(;$$$);
sub Ewindows1250::tr($$$$;$);
sub Ewindows1250::chop(@);
sub Ewindows1250::index($$;$);
sub Ewindows1250::rindex($$;$);
sub Ewindows1250::lcfirst(@);
sub Ewindows1250::lcfirst_();
sub Ewindows1250::lc(@);
sub Ewindows1250::lc_();
sub Ewindows1250::ucfirst(@);
sub Ewindows1250::ucfirst_();
sub Ewindows1250::uc(@);
sub Ewindows1250::uc_();
sub Ewindows1250::fc(@);
sub Ewindows1250::fc_();
sub Ewindows1250::ignorecase;
sub Ewindows1250::classic_character_class;
sub Ewindows1250::capture;
sub Ewindows1250::chr(;$);
sub Ewindows1250::chr_();
sub Ewindows1250::glob($);
sub Ewindows1250::glob_();

sub Windows1250::ord(;$);
sub Windows1250::ord_();
sub Windows1250::reverse(@);
sub Windows1250::getc(;*@);
sub Windows1250::length(;$);
sub Windows1250::substr($$;$$);
sub Windows1250::index($$;$);
sub Windows1250::rindex($$;$);
sub Windows1250::escape(;$);
...
# ${Ewindows1250::eS}          = qr{(?>[^\x09\x0A    \x0C\x0D\x20])};
# ${Ewindows1250::eS}          = qr{(?>[^\x09\x0A\x0B\x0C\x0D\x20])};
...
# avoid: Name "Ewindows1250::foo" used only once: possible typo at here.
${Ewindows1250::dot}         = ${Ewindows1250::dot};
${Ewindows1250::dot_s}       = ${Ewindows1250::dot_s};
${Ewindows1250::eD}          = ${Ewindows1250::eD};
${Ewindows1250::eS}          = ${Ewindows1250::eS};
${Ewindows1250::eW}          = ${Ewindows1250::eW};
${Ewindows1250::eH}          = ${Ewindows1250::eH};
${Ewindows1250::eV}          = ${Ewindows1250::eV};
${Ewindows1250::eR}          = ${Ewindows1250::eR};
${Ewindows1250::eN}          = ${Ewindows1250::eN};
${Ewindows1250::not_alnum}   = ${Ewindows1250::not_alnum};
${Ewindows1250::not_alpha}   = ${Ewindows1250::not_alpha};
${Ewindows1250::not_ascii}   = ${Ewindows1250::not_ascii};
${Ewindows1250::not_blank}   = ${Ewindows1250::not_blank};
${Ewindows1250::not_cntrl}   = ${Ewindows1250::not_cntrl};
${Ewindows1250::not_digit}   = ${Ewindows1250::not_digit};
${Ewindows1250::not_graph}   = ${Ewindows1250::not_graph};
${Ewindows1250::not_lower}   = ${Ewindows1250::not_lower};
${Ewindows1250::not_lower_i} = ${Ewindows1250::not_lower_i};
${Ewindows1250::not_print}   = ${Ewindows1250::not_print};
${Ewindows1250::not_punct}   = ${Ewindows1250::not_punct};
${Ewindows1250::not_space}   = ${Ewindows1250::not_space};
${Ewindows1250::not_upper}   = ${Ewindows1250::not_upper};
${Ewindows1250::not_upper_i} = ${Ewindows1250::not_upper_i};
${Ewindows1250::not_word}    = ${Ewindows1250::not_word};
${Ewindows1250::not_xdigit}  = ${Ewindows1250::not_xdigit};
${Ewindows1250::eb}          = ${Ewindows1250::eb};
${Ewindows1250::eB}          = ${Ewindows1250::eB};
...
#
# Windows-1250 transliteration (tr///)
#
sub Ewindows1250::tr($$$$;$) {
...
#
# Windows-1250 lower case first with parameter
#
sub Ewindows1250::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Ewindows1250::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Ewindows1250::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Ewindows1250::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Windows-1250 lower case first without parameter
#
sub Ewindows1250::lcfirst_() {
    return Ewindows1250::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Windows-1250 lower case with parameter
#
sub Ewindows1250::lc(@) {
    if (@_) {
        my $s = shift @_;
        ...
        return Ewindows1250::lc_();
    }
}

#
# Windows-1250 lower case without parameter
#
sub Ewindows1250::lc_() {
    my $s = $_;
    return join '', map {defined($lc{$_}) ? $lc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Windows-1250 upper case first with parameter
#
sub Ewindows1250::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Ewindows1250::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Ewindows1250::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Ewindows1250::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Windows-1250 upper case first without parameter
#
sub Ewindows1250::ucfirst_() {
    return Ewindows1250::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Windows-1250 upper case with parameter
#
sub Ewindows1250::uc(@) {
    if (@_) {
        my $s = shift @_;
        ...
        return Ewindows1250::uc_();
    }
}

#
# Windows-1250 upper case without parameter
#
sub Ewindows1250::uc_() {
    my $s = $_;
    return join '', map {defined($uc{$_}) ? $uc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Windows-1250 fold case with parameter
#
sub Ewindows1250::fc(@) {
    if (@_) {
        my $s = shift @_;
        ...
        return Ewindows1250::fc_();
    }
}

#
# Windows-1250 fold case without parameter
#
sub Ewindows1250::fc_() {
    my $s = $_;
    return join '', map {defined($fc{$_}) ? $fc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Windows-1250 regexp ignore case modifier
#
sub Ewindows1250::ignorecase {
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Ewindows1250::uc($char[$i]);
                my $fc = Ewindows1250::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
#
# prepare Windows-1250 characters per length
#
...
#
# Windows-1250 open character list for tr
#
sub _charlist_tr {
...
#
# Windows-1250 open character class
#
sub _cc {
    if (scalar(@_) == 0) {
...
#
# Windows-1250 open character list for qr and not qr
#
sub _charlist {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Ewindows1250::not_lower_i}',
                '[:^upper:]'  => '${Ewindows1250::not_upper_i}',
...
#
# Windows-1250 octal escape sequence
#
sub octchr {
    my($octdigit) = @_;
...
#
# Windows-1250 hexadecimal escape sequence
#
sub hexchr {
    my($hexdigit) = @_;
...
#
# Windows-1250 open character list for qr
#
sub charlist_qr {
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Ewindows1250::uc($char);
                        my $fc = Ewindows1250::fc($char);
                        if ($uc eq $fc) {
...
#
# Windows-1250 open character list for not qr
#
sub charlist_not_qr {
...
#
# Windows-1250 order to character (with parameter)
#
sub Ewindows1250::chr(;$) {
...
#
# Windows-1250 order to character (without parameter)
#
sub Ewindows1250::chr_() {
...
#
# Windows-1250 path globbing (with parameter)
#
sub Ewindows1250::glob($) {
...
#
# Windows-1250 path globbing (without parameter)
#
sub Ewindows1250::glob_() {
...
#
# Windows-1250 path globbing via File::DosGlob 1.10
#
...
#
# Windows-1250 path globbing subroutine
#
sub _do_glob {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Ewindows1250::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Ewindows1250::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Ewindows1250::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Ewindows1250::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
#
sub Ewindows1250::POSTMATCH {
    return $';
}

#
# Windows-1250 character to order (with parameter)
#
sub Windows1250::ord(;$) {
...
#
# Windows-1250 character to order (without parameter)
#
sub Windows1250::ord_() {
...
#
# Windows-1250 getc (with parameter, without parameter)
#
sub Windows1250::getc(;*@) {

    my($package) = caller;
    my $fh = @_ ? qualify_to_ref(shift,$package) : \*STDIN;
    croak 'Too many arguments for Windows1250::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Ewindows1250::dot_s} \z/oxms) {
...
#
# Windows-1250 length by character
#
sub Windows1250::length(;$) {
...
#
# Windows-1250 substr by character
#
BEGIN {
...
#
# Windows-1250 index by character
#
sub Windows1250::index($$;$) {

    my $index;
    if (@_ == 3) {
        $index = Ewindows1250::index($_[0], $_[1], CORE::length(Windows1250::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Ewindows1250::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Windows1250::length(CORE::substr $_[0], 0, $index);
    }
}

#
# Windows-1250 rindex by character
#
sub Windows1250::rindex($$;$) {

    my $rindex;
    if (@_ == 3) {
        $rindex = Ewindows1250::rindex($_[0], $_[1], CORE::length(Windows1250::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Ewindows1250::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Windows1250::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
# ord() to ord() or Windows1250::ord()
my $function_ord = 'ord';

# ord to ord or Windows1250::ord_
my $function_ord_ = 'ord';

# reverse to reverse or Windows1250::reverse
my $function_reverse = 'reverse';

# getc to getc or Windows1250::getc
...
my $qq_substr  = qr{(?> Char::substr | Windows1250::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
sub Windows1250::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Windows1250::escape_token();
    }
...
#
# escape Windows-1250 token of script
#
sub Windows1250::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Ewindows1250::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ (?>\s*) PREMATCH  \b | \$ (?>\s*) \{ (?>\s*) PREMATCH  (?>\s*) \} | \$ (?>\s*) \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Ewindows1250::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Ewindows1250::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Ewindows1250::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Ewindows1250::POSTMATCH()
    elsif (/\G (                 \$ (?>\s*) POSTMATCH \b | \$ (?>\s*) \{ (?>\s*) POSTMATCH (?>\s*) \} | \$ (?>\s*) \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Ewindows1250::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Ewindows1250::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob (?>\s*) \) /oxgc) {
        return 'while ($_ = Ewindows1250::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob \b /oxgc) {
        return 'while ($_ = Ewindows1250::glob';
    }
...
# subroutines of package Ewindows1250
    elsif (/\G \b (CORE:: | ->(>?\s*) (?: atan2 | [a-z]{2,})) \b       /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Windows1250::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Char::escape'; }
    elsif (/\G \b Windows1250::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Windows1250::escape'; }
    elsif (/\G \b bytes::substr \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Ewindows1250::chop';       }
    elsif (/\G \b bytes::index \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::index';       }
    elsif (/\G \b Windows1250::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Windows1250::index';       }
    elsif (/\G \b index \b         (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Ewindows1250::index';      }
    elsif (/\G \b bytes::rindex \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::rindex';      }
    elsif (/\G \b Windows1250::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Windows1250::rindex';      }
    elsif (/\G \b rindex \b        (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Ewindows1250::rindex';     }
    elsif (/\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ewindows1250::lc';         }
    elsif (/\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ewindows1250::lcfirst';    }
    elsif (/\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ewindows1250::uc';         }
    elsif (/\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ewindows1250::ucfirst';    }
    elsif (/\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ewindows1250::fc';         }
    ...
    elsif (/\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ewindows1250::chr';               }
    elsif (/\G \b bytes::ord    (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Ewindows1250::glob';              }
    elsif (/\G \b lc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ewindows1250::lc_';               }
    elsif (/\G \b lcfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ewindows1250::lcfirst_';          }
    elsif (/\G \b uc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ewindows1250::uc_';               }
    elsif (/\G \b ucfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ewindows1250::ucfirst_';          }
    elsif (/\G \b fc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ewindows1250::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ewindows1250::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Ewindows1250::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Ewindows1250::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Ewindows1250::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq           (\#) [ ] (\#) /oxgc) { return 'Ewindows1250::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Ewindows1250::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Ewindows1250::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Ewindows1250::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Ewindows1250::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Ewindows1250::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q            (\#) [ ] (\#) /oxgc) { return 'Ewindows1250::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Ewindows1250::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Ewindows1250::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Ewindows1250::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Ewindows1250::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Ewindows1250::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                    ' [ ] '    /oxgc) { return 'Ewindows1250::split' . $e . qq     {' '};  }
        elsif (/\G                    " [ ] "    /oxgc) { return 'Ewindows1250::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Ewindows1250::PREMATCH()]}
            ...
            $e_string .= q{Ewindows1250::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Ewindows1250::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Ewindows1250::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Ewindows1250::POSTMATCH()]}
            ...
            $e_string .= q{Ewindows1250::POSTMATCH()};
            $slash = 'div';
        }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Ewindows1250::dot_s}';
        }
        else {
            return '${Ewindows1250::dot}';
        }
    }
    else {
        return Ewindows1250::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Ewindows1250::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Ewindows1250::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Ewindows1250::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Ewindows1250::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Ewindows1250::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Ewindows1250::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Ewindows1250::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Ewindows1250::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Ewindows1250::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Ewindows1250::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Ewindows1250::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Ewindows1250::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Ewindows1250::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Ewindows1250::uc($char[$i]) ne Ewindows1250::fc($char[$i]))) {
            if (CORE::length(Ewindows1250::fc($char[$i])) == 1) {
                $char[$i] = '['   . Ewindows1250::uc($char[$i])       . Ewindows1250::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Ewindows1250::uc($char[$i]) . '|' . Ewindows1250::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ewindows1250::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ (?>\s*) 0 (?>\s*) \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Ewindows1250::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ewindows1250::ignorecase(Ewindows1250::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Ewindows1250::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Ewindows1250::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ewindows1250::ignorecase(Ewindows1250::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Ewindows1250::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Ewindows1250::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ewindows1250::ignorecase(Ewindows1250::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Ewindows1250::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Ewindows1250::re_t=%s; while($Ewindows1250::re_t =~ %s){%s local $^W=0; local $Ewindows1250::re_r=%s; %s$Ewindows1250::re_t="$`$Ewindows1250::re_r$'"; pos($Ewindows1250::re_t)=length "$`$Ewindows1250::re_r"; } return $Ewindows1250::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Ewindows1250::re_r=CORE::eval $Ewindows1250::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Ewindows1250::re_r=%s; %s"%s$Ewindows1250::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Ewindows1250::re_n=0; while(%s =~ %s){%s local $^W=0; local $Ewindows1250::re_r=%s; %s%s="$`$Ewindows1250::re_r$'"; pos(%s)=length "$`$Ewindows1250::re_r"; $Ewindows1250::re_n++} return %s$Ewindows1250::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Ewindows1250::re_r=%s; %s%s="%s$Ewindows1250::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Ewindows1250::re_r=%s; %s%s="%s$Ewindows1250::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Ewindows1250::re_r=CORE::eval $Ewindows1250::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # ${ foo }
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ewindows1250::ignorecase(' . $1 . ')]}';
            }
        }
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Ewindows1250::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Ewindows1250::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  use Ewindows1250;
    ...
    Ewindows1250::lc(...);
    Ewindows1250::lc_;
    Ewindows1250::lcfirst(...);
    Ewindows1250::lcfirst_;
    Ewindows1250::uc(...);
    Ewindows1250::uc_;
    Ewindows1250::ucfirst(...);
    Ewindows1250::ucfirst_;
    Ewindows1250::fc(...);
    Ewindows1250::fc_;
    Ewindows1250::ignorecase(...);
    Ewindows1250::capture(...);
    Ewindows1250::chr(...);
    Ewindows1250::chr_;
    Ewindows1250::glob(...);
    Ewindows1250::glob_;

  # "no Ewindows1250;" not supported

=head1 ABSTRACT

This module has run-time routines for use Windows1250 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Windows1250 software and not
...
This Ewindows1250 module first appeared in ActivePerl Build 522 Built under
...
=item * Split string
  ...
  @split = Ewindows1250::split(/pattern/,$string,$limit);
  @split = Ewindows1250::split(/pattern/,$string);
  @split = Ewindows1250::split(/pattern/);
  @split = Ewindows1250::split('',$string,$limit);
  @split = Ewindows1250::split('',$string);
  @split = Ewindows1250::split('');
  @split = Ewindows1250::split();
  @split = Ewindows1250::split;
  ...
  at all, Ewindows1250::split returns the original string as a single substring, If it
  ...
  @chars  = Ewindows1250::split(//,  $word);
  @fields = Ewindows1250::split(/:/, $line);
  @words  = Ewindows1250::split(" ", $paragraph);
  @lines  = Ewindows1250::split(/^/, $buffer);
  ...
  print join(":" => Ewindows1250::split(/ */, "hi there"));
  ...
  Ewindows1250::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Ewindows1250::split(/:/, $_, 3);
  ...
  splits on whitespace just as Ewindows1250::split with no arguments does. Thus,
  Ewindows1250::split(" ") can be used to emulate awk's default behavior. In contrast,
  Ewindows1250::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Ewindows1250::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Ewindows1250::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Ewindows1250::split()) {
          $count{$word}++;
      }
  }

  The inverse of Ewindows1250::split is join, except that join can only join with the
...
=item * Transliteration
  ...
  $tr = Ewindows1250::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Ewindows1250::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  This subroutine scans a Windows-1250 string character by character and replaces all
  occurrences of the characters found in $searchlist with the corresponding character
  in $replacementlist. It returns the number of characters replaced or deleted.
  If no Windows-1250 string is specified via =~ operator, the $_ variable is translated.
  $modifier are:
  ...
  print Ewindows1250::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item * Chop string

  $chop = Ewindows1250::chop(@list);
  $chop = Ewindows1250::chop();
  $chop = Ewindows1250::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Ewindows1250::chop subroutine is used primary to remove the newline
  ...
  since Ewindows1250::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Ewindows1250::chop a literal, only a variable. If you Ewindows1250::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Ewindows1250::chop(@lines);

  You can Ewindows1250::chop anything that is an lvalue, including an assignment:

  Ewindows1250::chop($cwd = `pwd`);
  Ewindows1250::chop($answer = <STDIN>);

  This is different from:

  $answer = Ewindows1250::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Ewindows1250::chop returns the character
  ...
  In the most general case, Ewindows1250::chop can be expressed using substr:

  $last_code = Ewindows1250::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Ewindows1250::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Ewindows1250::chop;
...
=item * Index string
  ...
  $byte_pos = Ewindows1250::index($string,$substr,$byte_offset);
  $byte_pos = Ewindows1250::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Ewindows1250::index($string, $lookfor, $byte_pos)) > -1) {
...
=item * Reverse index string
  ...
  $byte_pos = Ewindows1250::rindex($string,$substr,$byte_offset);
  $byte_pos = Ewindows1250::rindex($string,$substr);

  This subroutine works just like Ewindows1250::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Ewindows1250::index).
  ...
  while (($byte_pos = Windows1250::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item * Lower case string
  ...
  $lc = Ewindows1250::lc($string);
  $lc = Ewindows1250::lc_;

  This subroutine returns a lowercased version of Windows-1250 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Ewindows1250::fc subroutine for case-insensitive comparisons via Windows1250
  software.

=item * Lower case first character of string

  $lcfirst = Ewindows1250::lcfirst($string);
  $lcfirst = Ewindows1250::lcfirst_;

  This subroutine returns a version of Windows-1250 $string with the first character
  lowercased (or $_, if $string is omitted). This is the internal subroutine
  implementing the \l escape in double-quoted strings.

=item * Upper case string

  $uc = Ewindows1250::uc($string);
  $uc = Ewindows1250::uc_;

  This subroutine returns an uppercased version of Windows-1250 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Ewindows1250::ucfirst instead.
...
=item * Upper case first character of string
  ...
  $ucfirst = Ewindows1250::ucfirst($string);
  $ucfirst = Ewindows1250::ucfirst_;
  ...
  $titlecase = Ewindows1250::ucfirst(substr($word,0,1)) . Ewindows1250::lc(substr($word,1));
  ...
  $do_not_use = Ewindows1250::ucfirst(Ewindows1250::lc($word));
...
=item * Fold case string
  ...
  $fc = Ewindows1250::fc($string);
  $fc = Ewindows1250::fc_;

  New to Windows1250 software, this subroutine returns the full Unicode-like casefold of
  Windows-1250 $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Ewindows1250::fc($a) eq Ewindows1250::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Windows1250 software has always used casefolding semantics for
...
=item * Make ignore case string
  ...
  @ignorecase = Ewindows1250::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item * Make capture number

  $capturenumber = Ewindows1250::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item * Make character

  $chr = Ewindows1250::chr($code);
  $chr = Ewindows1250::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Ewindows1250::chr(65) is "A" in either
  ASCII or Windows-1250, not Unicode. For the reverse of Ewindows1250::chr, use Windows1250::ord.

=item * Filename expansion (globbing)

  @glob = Ewindows1250::glob($string);
  @glob = Ewindows1250::glob_;
  ...
  The Ewindows1250::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Ewindows1250::glob('"*e f*"');
  @spacies = Ewindows1250::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Ewindows1250::glob("'*${var}e f*'");
  @spacies = Ewindows1250::glob(qq("*${var}e f*"));
