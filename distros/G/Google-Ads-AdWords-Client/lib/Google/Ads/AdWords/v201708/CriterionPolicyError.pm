package Google::Ads::AdWords::v201708::CriterionPolicyError;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201708::PolicyViolationError);
# Variety: sequence
...
Google::Ads::AdWords::v201708::CriterionPolicyError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CriterionPolicyError from the namespace https://adwords.google.com/api/adwords/cm/v201708.
