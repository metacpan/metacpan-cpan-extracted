...
#
package PeakForest::REST_Client::Configuration;
...
=head1 Name
        ...
        PeakForest::REST_Client::Configuration - holds the configuration for all PeakForest::REST_Client Modules
...
default: OpenAPI-Generator/2.3.0/perl
...
default: https://metabohub.peakforest.org/rest/v2
...
sub new {
    ...
    $p{http_timeout} //= 180;
    $p{http_user_agent} //= 'OpenAPI-Generator/2.3.0/perl';
    ...
    # base_url
    $p{base_url} //= 'https://metabohub.peakforest.org/rest/v2';
