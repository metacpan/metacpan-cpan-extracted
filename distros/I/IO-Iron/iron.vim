...
set ruler
set runtimepath=~/.vim,~/.vim/vim-addons/github-majutsushi-tagbar,~/.vim/vim-addons/github-vim-scripts-SQLComplete.vim,~/.vim/vim-addons/github-c9s-perlomni.vim,~/.vim/vim-addons/github-Valloric-YouCompleteMe,~/.vim/vim-addons/github-embear-vim-localvimrc,~/.vim/vim-addons/lh-vim-lib,~/.vim/vim-addons/local_vimrc,~/.vim/vim-addons/github-LucHermitte-lh-vim-lib,~/.vim/vim-addons/github-syngan-vim-vimlint,~/.vim/vim-addons/github-ynkdir-vim-vimlparser,~/.vim/vim-addons/github-todesking-vint-syntastic,~/.vim/vim-addons/Syntastic,~/.vim/vim-addons/github-altercation-vim-colors-solarized,~/.vim/vim-addons/keepcase,~/.vim/vim-addons/github-pjcj-vim-hl-var,~/.vim/vim-addons/github-stefandtw-quickfix-reflector.vim,~/.vim/vim-addons/github-tpope-vim-surround,~/.vim/vim-addons/github-tpope-vim-fugitive,~/.vim/vim-addons/github-sheerun-vim-polyglot,~/.vim/vim-addons/github-tpope-vim-abolish.git,~/.vim/vim-addons/github-kshenoy-vim-signature,~/.vim/vim-addons/github-duggiefresh-vim-easydir,~/.vim/vim-addons/github-danro-rename.vim,~/.vim/vim-addons/github-tomtom-tcomment_vim,~/.vim/vim-addons/vim-misc,~/.vim/vim-addons/github-xolox-vim-easytags,~/.vim/vim-addons/github-scrooloose-nerdtree.git,~/.vim/vim-addons/github-kennethzfeng-vim-raml,~/.vim/vim-addons/github-IN3D-vim-raml,~/.vim/vim-addons/github-hotchpotch-perldoc-vim,~/.vim/vim-addons/github-vim-airline-vim-airline-themes,~/.vim/vim-addons/github-vim-airline-vim-airline,~/.vim/vim-addons/github-tpope-vim-capslock,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after,~/.vim/vim-addons/github-kshenoy-vim-signature/after,~/.vim/vim-addons/github-sheerun-vim-polyglot/after,~/.vim/vim-addons/vim-addon-manager
set secure
set shiftwidth=4
...
silent only
cd ~/other/own_github/io-iron
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +71 lib/IO/Iron/IronMQ/Client.pm
badd +1 lib/IO/Iron/IronMQ/Api.pm
badd +3 integ_t/IronMQ/client_all.t
badd +9 integ_t/IronMQ/queue_all.t
badd +136 integ_t/IronMQ/queue_pull.t
badd +1 lib/IO/Iron/IronMQ/Queue.pm
badd +1 lib/IO/Iron/IronMQ/Message.pm
badd +92 lib/IO/Iron/Connection.pm
badd +43 lib/IO/Iron/Connector.pm
badd +1 integ_t/Iron/iron_all.t
badd +65 integ_t/IronMQ/client_create_queue.t
badd +1 ~/.anyenv/envs/plenv/versions/5.14.2-for-dev/lib/perl5/site_perl/5.14.2/Carp/Assert/More.pm
badd +112 ~/.anyenv/envs/plenv/versions/5.14.2-for-dev/lib/perl5/site_perl/5.14.2/Carp/Assert.pm
badd +26 t/IronMQ/load.t
badd +12 dist.ini
badd +99 integ_t/IronMQ/client_exceptions.t
badd +17 integ_t/iron_io_integ_tests_common.pl
badd +122 ~/Projects/koivunalho/Vuokra3-SimulateBank/lib/Koivunalho/Vuokra3/SimulateBank/Service/Transactions.pm
badd +105 ~/other/own_github/io-iron-applications/lib/IO/Iron/Applications.pm
badd +53 integ_t/IronMQ/push_queue_all.t
argglobal
silent! argdel *
argadd lib/IO/Iron/IronMQ/Client.pm
edit integ_t/IronMQ/queue_pull.t
...
exe '1resize ' . ((&lines * 12 + 32) / 65)
exe 'vert 1resize ' . ((&columns * 113 + 114) / 229)
exe '2resize ' . ((&lines * 32 + 32) / 65)
exe 'vert 2resize ' . ((&columns * 113 + 114) / 229)
exe '3resize ' . ((&lines * 1 + 32) / 65)
exe 'vert 3resize ' . ((&columns * 113 + 114) / 229)
exe '4resize ' . ((&lines * 3 + 32) / 65)
exe 'vert 4resize ' . ((&columns * 113 + 114) / 229)
exe '5resize ' . ((&lines * 11 + 32) / 65)
exe 'vert 5resize ' . ((&columns * 113 + 114) / 229)
exe '6resize ' . ((&lines * 12 + 32) / 65)
exe 'vert 6resize ' . ((&columns * 115 + 114) / 229)
exe '7resize ' . ((&lines * 12 + 32) / 65)
exe 'vert 7resize ' . ((&columns * 115 + 114) / 229)
exe '8resize ' . ((&lines * 1 + 32) / 65)
exe 'vert 8resize ' . ((&columns * 115 + 114) / 229)
exe '9resize ' . ((&lines * 10 + 32) / 65)
exe 'vert 9resize ' . ((&columns * 115 + 114) / 229)
exe '10resize ' . ((&lines * 12 + 32) / 65)
exe 'vert 10resize ' . ((&columns * 115 + 114) / 229)
exe '11resize ' . ((&lines * 11 + 32) / 65)
exe 'vert 11resize ' . ((&columns * 115 + 114) / 229)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal path=.,/usr/include,,,~/.anyenv/envs/plenv/versions/5.14.2-for-dev/lib/perl5/site_perl/5.14.2/x86_64-linux,~/.anyenv/envs/plenv/versions/5.14.2-for-dev/lib/perl5/site_perl/5.14.2,~/.anyenv/envs/plenv/versions/5.14.2-for-dev/lib/perl5/5.14.2/x86_64-linux,~/.anyenv/envs/plenv/versions/5.14.2-for-dev/lib/perl5/5.14.2,,
...
wincmd w
argglobal
edit integ_t/IronMQ/queue_all.t
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 24 - ((22 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
...
wincmd w
argglobal
edit integ_t/IronMQ/client_all.t
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
edit lib/IO/Iron/IronMQ/Api.pm
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 362 - ((2 * winheight(0) + 5) / 11)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
362
...
wincmd w
argglobal
edit lib/IO/Iron/IronMQ/Message.pm
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
edit lib/IO/Iron/IronMQ/Queue.pm
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 295 - ((6 * winheight(0) + 6) / 12)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
295
...
setlocal spellfile=
setlocal spelllang=en
setlocal statusline=%!airline#statusline(9)
setlocal suffixesadd=
setlocal noswapfile
setlocal synmaxcol=3000
if &syntax != 'qf'
...
wincmd w
argglobal
edit lib/IO/Iron/IronMQ/Client.pm
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal spellfile=
setlocal spelllang=en
setlocal statusline=%!airline#statusline(10)
setlocal suffixesadd=
setlocal swapfile
setlocal synmaxcol=3000
if &syntax != 'perl'
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 601 - ((7 * winheight(0) + 6) / 12)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
601
...
setlocal spellfile=
setlocal spelllang=en
setlocal statusline=%!airline#statusline(11)
setlocal suffixesadd=
setlocal swapfile
setlocal synmaxcol=3000
if &syntax != 'perl'
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 136 - ((6 * winheight(0) + 5) / 11)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
136
