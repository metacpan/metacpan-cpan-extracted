...
All options are passed to L<run()|Math::Formula::Context/"Formula and Fragment management">.
...
This module is part of Math-Formula distribution version 0.14,
built on February 28, 2023. Website: F<http://perl.overmeer.net/CPAN/>
