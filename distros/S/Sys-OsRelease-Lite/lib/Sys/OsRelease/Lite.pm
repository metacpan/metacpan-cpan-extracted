...
$Sys::OsRelease::Lite::VERSION = '0.4.3+lite';
use if $] >= 5.016, "feature", "fc";  # retain even though 5.22 is minimum Perl, same code in ...::Lite
use feature qw(say);
use Config;
use Carp qw(carp croak);

# the instance - use Sys::OsRelease::Lite->instance() to get it
my %_instances = ();
...
# use Sys::OsRelease::Lite can do this too.
#
...
# allow other classes which cooperate with Sys::OsRelease::Lite to import our singleton-management methods
