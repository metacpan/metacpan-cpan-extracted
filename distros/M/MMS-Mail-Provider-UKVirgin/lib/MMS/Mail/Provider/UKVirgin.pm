package MMS::Mail::Provider::UKVirgin;
...
This class provides a parse method for parsing an MMS::Mail::Message object into an MMS::Mail::Message::Parsed object for MMS messages sent from the UK Virgin network.

=head1 METHODS

The following are the top-level methods of the MMS::Mail::Parser::UKVirgin class.
...
Return a new MMS::Mail::Provider::UKVirgin object.
...
C<bug-mms-mail-provider-ukvirgin at rt.cpan.org>, or through the web interface at
L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=MMS-Mail-Provider-UKVirgin>.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc MMS::Mail::Provider::UKVirgin
...
L<http://annocpan.org/dist/MMS-Mail-Provider-UKVirgin>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/MMS-Mail-Provider-UKVirgin>

=item * RT: CPAN's request tracker

L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=MMS-Mail-Provider-UKVirgin>

=item * Search CPAN

L<http://search.cpan.org/dist/MMS-Mail-Provider-UKVirgin>
...
1; # End of MMS::Mail::Provider::UKVirgin
