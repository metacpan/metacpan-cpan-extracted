...
Require::HookChainTest::Two - Another dummy module used in testing Require::HookChain

=head1 VERSION

This document describes version 0.016 of Require::HookChainTest::Two (from Perl distribution Require-HookChain), released on 2023-12-05.
