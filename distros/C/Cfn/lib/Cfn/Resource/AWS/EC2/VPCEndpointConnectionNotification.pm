# AWS::EC2::VPCEndpointConnectionNotification generated from spec 2.5.0
...
package Cfn::Resource::Properties::AWS::EC2::VPCEndpointConnectionNotification {
  ...
  has ConnectionEvents => (isa => 'Cfn::Value::Array|Cfn::Value::Function', is => 'rw', coerce => 1, required => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
