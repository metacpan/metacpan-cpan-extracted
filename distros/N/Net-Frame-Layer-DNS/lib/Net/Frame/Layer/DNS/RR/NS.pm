#
# $Id: NS.pm 49 2009-05-31 13:15:34Z VinsWorldcom $
#
package Net::Frame::Layer::DNS::RR::NS;
...
sub getLength {
   my $self = shift;
   return length($self->nsdname)
}

sub pack {
   my $self = shift;

   my $name = dnsAton($self->nsdname);
...
Net::Frame::Layer::DNS::RR::NS - DNS Resource Record NS rdata type

=head1 SYNOPSIS

   use Net::Frame::Layer::DNS::RR::NS;

   my $rdata = Net::Frame::Layer::DNS::RR::NS->new(
      nsdname => 'localhost',
   );
   $rdata->pack;
...
Record NS rdata type object.  Users need only use this for encoding.
