package Google::Ads::AdWords::v201802::CombinedRuleUserList;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201802::RuleBasedUserList);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201802::UserListMembershipStatus',
        'integrationCode' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'accessReason' => 'Google::Ads::AdWords::v201802::AccessReason',
        'accountUserListStatus' => 'Google::Ads::AdWords::v201802::AccountUserListStatus',
        'membershipLifeSpan' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'size' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'sizeRange' => 'Google::Ads::AdWords::v201802::SizeRange',
        'sizeForSearch' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'sizeRangeForSearch' => 'Google::Ads::AdWords::v201802::SizeRange',
        'listType' => 'Google::Ads::AdWords::v201802::UserListType',
        'isEligibleForSearch' => 'SOAP::WSDL::XSD::Typelib::Builtin::boolean',
        'isEligibleForDisplay' => 'SOAP::WSDL::XSD::Typelib::Builtin::boolean',
        'closingReason' => 'Google::Ads::AdWords::v201802::UserListClosingReason',
        'UserList__Type' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'prepopulationStatus' => 'Google::Ads::AdWords::v201802::RuleBasedUserList::PrepopulationStatus',
        'leftOperand' => 'Google::Ads::AdWords::v201802::Rule',
        'rightOperand' => 'Google::Ads::AdWords::v201802::Rule',
        'ruleOperator' => 'Google::Ads::AdWords::v201802::CombinedRuleUserList::RuleOperator',
    },
    {
...
Google::Ads::AdWords::v201802::CombinedRuleUserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CombinedRuleUserList from the namespace https://adwords.google.com/api/adwords/rm/v201802.
