package Chart::Plotly::Trace::Scattergeo::Stream;
use Moose;
...
Chart::Plotly::Trace::Scattergeo::Stream - This attribute is one of the possible options for the trace scattergeo.
