...
t/fixtures/app_lib/ProtoOps.pm - fixture for fixture module used to test prototype-sensitive operations

=head1 DESCRIPTION

This fixture exists to provide fixture module used to test prototype-sensitive operations. Tests load or execute it to reproduce a
