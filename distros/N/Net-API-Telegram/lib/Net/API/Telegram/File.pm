...
sub file_path { return( shift->_set_get_scalar( 'file_path', @_ ) ); }
...
Net::API::Telegram::File - A file ready to be downloaded

=head1 SYNOPSIS

	my $msg = Net::API::Telegram::File->new( %data ) || 
	die( Net::API::Telegram::File->error, "\n" );

=head1 DESCRIPTION

L<Net::API::Telegram::File> is a Telegram Message Object as defined here L<https://core.telegram.org/bots/api#file>
