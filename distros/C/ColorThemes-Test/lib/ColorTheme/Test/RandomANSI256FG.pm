...
1;
# ABSTRACT: A color theme which gives random 256-color ANSI foreground codes
...
ColorTheme::Test::RandomANSI256FG - A color theme which gives random 256-color ANSI foreground codes

=head1 VERSION

This document describes version 0.007 of ColorTheme::Test::RandomANSI256FG (from Perl distribution ColorThemes-Test), released on 2021-08-01.
