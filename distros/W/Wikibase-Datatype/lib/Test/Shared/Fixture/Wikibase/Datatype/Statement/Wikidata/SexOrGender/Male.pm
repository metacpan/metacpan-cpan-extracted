...
Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::SexOrGender::Male - Test instance for Wikidata statement.

=head1 SYNOPSIS

 use Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::SexOrGender::Male;

 my $obj = Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::SexOrGender::Male->new(%params);
 my $id = $obj->id;
...
=for comment filename=fixture_create_and_print_statement_wd_sex_or_gender_male.pl
...
L<Test::Shared::Fixture::Wikibase::Datatype::Snak::Wikidata::SexOrGender::Male>,
