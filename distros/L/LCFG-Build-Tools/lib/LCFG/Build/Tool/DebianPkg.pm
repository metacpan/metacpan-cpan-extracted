package LCFG::Build::Tool::DebianPkg;    # -*-perl-*-
use strict;
use warnings;

# $Id: DebianPkg.pm.in 35384 2019-01-16 16:25:00Z squinney@INF.ED.AC.UK $
# $Source: /var/cvs/dice/LCFG-Build-Tools/lib/LCFG/Build/Tool/RPM.pm.in,v $
# $Revision: 35384 $
# $HeadURL: https://svn.lcfg.org/svn/source/tags/LCFG-Build-Tools/LCFG_Build_Tools_0_9_30/lib/LCFG/Build/Tool/DebianPkg.pm.in $
...
override 'abstract' => sub {
    return q{Build binary debs from the tagged source tree};
};
...
=head1 NAME
    ...
    LCFG::Build::Tool::DebianPkg - LCFG software packaging tool

=head1 VERSION

    This documentation refers to LCFG::Build::Tool::DebianPkg version 0.9.30

=head1 SYNOPSIS

    my $tool = LCFG::Build::Tool::DebianPkg->new( dir => '.' );

    $tool->execute;

    my $tool2 = LCFG::Build::Tool::DebianPkg->new_with_options();
...
out prior to distribution. Binary Debian packages will then be generated
