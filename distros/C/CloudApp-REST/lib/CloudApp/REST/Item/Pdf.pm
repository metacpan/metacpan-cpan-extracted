package CloudApp::REST::Item::Pdf;
...
CloudApp::REST::Item::Pdf - Pdf item class of CloudApp::REST
...
PDF item class of CloudApp::REST.

=head1 ATTRIBUTES

See L<CloudApp::REST::Item> for common attributes and methods of all items.
The attributes listed here are only accessible for pdf items.
