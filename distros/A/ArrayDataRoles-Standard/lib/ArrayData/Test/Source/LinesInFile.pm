package ArrayData::Test::Source::LinesInFile;

use strict;

use alias::module 'ArrayData::LinesInFile';
...
ArrayData::Test::Source::LinesInFile - Alias package for ArrayData::LinesInFile

=head1 VERSION

This document describes version 0.007 of ArrayData::Test::Source::LinesInFile (from Perl distribution ArrayDataRoles-Standard), released on 2021-12-01.
