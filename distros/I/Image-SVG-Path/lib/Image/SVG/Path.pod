...
(This example is included as L<F<synopsis.pl>|https://fastapi.metacpan.org/source/BKB/Image-SVG-Path-0.33/examples/synopsis.pl> in the distribution.)


=head1 VERSION

This documents version 0.33 of Image-SVG-Path
corresponding to L<git commit 97a7754b59911531c89c334ae0e7731229fa1bbd|https://github.com/benkasminbullock/Image-SVG-Path/commit/97a7754b59911531c89c334ae0e7731229fa1bbd> released on Sat Jun 27 10:10:03 2020 +0900.
...
(This example is included as L<F<xml-parser.pl>|https://fastapi.metacpan.org/source/BKB/Image-SVG-Path-0.33/examples/xml-parser.pl> in the distribution.)
...
(This example is included as L<F<extract-path-info.pl>|https://fastapi.metacpan.org/source/BKB/Image-SVG-Path-0.33/examples/extract-path-info.pl> in the distribution.)
...
(This example is included as L<F<test-reverse.pl>|https://fastapi.metacpan.org/source/BKB/Image-SVG-Path-0.33/examples/test-reverse.pl> in the distribution.)
