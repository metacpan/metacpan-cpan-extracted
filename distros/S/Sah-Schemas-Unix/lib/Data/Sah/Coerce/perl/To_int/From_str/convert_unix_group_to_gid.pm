...
1;
# ABSTRACT: Convert Unix groupname into GID, fail when cannot convert
...
Data::Sah::Coerce::perl::To_int::From_str::convert_unix_group_to_gid - Convert Unix groupname into GID, fail when cannot convert

=head1 VERSION

This document describes version 0.009 of Data::Sah::Coerce::perl::To_int::From_str::convert_unix_group_to_gid (from Perl distribution Sah-Schemas-Unix), released on 2019-12-09.

=head1 SYNOPSIS

To use in a Sah schema:

 ["int",{"x.perl.coerce_rules"=>["From_str::convert_unix_group_to_gid"]}]
