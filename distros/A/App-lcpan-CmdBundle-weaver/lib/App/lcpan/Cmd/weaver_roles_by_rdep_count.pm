package App::lcpan::Cmd::weaver_roles_by_rdep_count;
...
$SPEC{'handle_cmd'} = {
    v => 1.1,
    summary => 'List Pod::Weaver roles ranked by number of reverse dependencies',
    args => {
...
sub handle_cmd {
    ...
    my @where;
    my @binds;
    push @where, "(name LIKE 'Pod::Weaver::Role::%')";
    if ($args{author}) {
        push @where, "(author=?)";
...
1;
# ABSTRACT: List Pod::Weaver roles ranked by number of reverse dependencies
...
App::lcpan::Cmd::weaver_roles_by_rdep_count - List Pod::Weaver roles ranked by number of reverse dependencies

=head1 VERSION

This document describes version 0.031 of App::lcpan::Cmd::weaver_roles_by_rdep_count (from Perl distribution App-lcpan-CmdBundle-weaver), released on 2020-01-19.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<weaver-roles-by-rdep-count>.
...
List Pod::Weaver roles ranked by number of reverse dependencies.
