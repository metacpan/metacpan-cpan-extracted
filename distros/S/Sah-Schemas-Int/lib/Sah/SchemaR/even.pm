...
our $rschema = ["int",[{div_by=>2,examples=>[{data=>0,valid=>1},{data=>2,valid=>1},{data=>1,valid=>0}],summary=>"Even number"}],["int"]];
...
This document describes version 0.074 of Sah::SchemaR::even (from Perl distribution Sah-Schemas-Int), released on 2020-05-08.
