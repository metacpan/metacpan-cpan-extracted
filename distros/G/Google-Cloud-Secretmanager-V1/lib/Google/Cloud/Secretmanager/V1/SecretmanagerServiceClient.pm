...
sub list_secrets {
    ...
    my $request_class = 'Google::Cloud::Secretmanager::V1::Service::ListSecretsRequest';
    my $request = eval { $request_class->new(\%params) } || eval { $request_class->new(%params) } || ($request_class->can('encode') ? $request_class->encode(\%params) : \%params);

    my $response_class = 'Google::Cloud::Secretmanager::V1::Service::ListSecretsResponse';
...
=item * C<google/cloud/secretmanager/v1/service.proto>

=item * C<google/cloud/secretmanager/v1/resources.proto>
...
Calls the RPC method C<ListSecrets> on the service. Takes a hash of parameters representing the request.
