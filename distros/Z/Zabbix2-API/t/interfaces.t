...
cmp_deeply($host->interfaces,
           array_each(isa('Zabbix2::API::HostInterface')),
...
isa_ok($fetched_host, 'Zabbix2::API::Host');
...
my $new_interface = Zabbix2::API::HostInterface->new(
    ...
    data => {
        ...
        main => 1,
        port => 10001,
        type => Zabbix2::API::HostInterface::INTERFACE_TYPE_SNMP,
        hostid => $host->id
    });
...
$new_interface = Zabbix2::API::HostInterface->new(
    root => $zabber,
    data => {
        dns => 'localhost',
        ip => '',
