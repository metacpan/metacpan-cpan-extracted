...
use AddressBook::Model::GEN::child;

our $CHILD = 'AddressBook::Model::child';
...
AddressBook::Model::child - model for child table (stub part)
...
=head1 METHODS (mixed in from AddressBook::Model::GEN::child)
