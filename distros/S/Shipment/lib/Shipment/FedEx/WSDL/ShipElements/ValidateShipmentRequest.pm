...
package Shipment::FedEx::WSDL::ShipElements::ValidateShipmentRequest;
$Shipment::FedEx::WSDL::ShipElements::ValidateShipmentRequest::VERSION = '3.09';
use strict;
use warnings;
...
use base qw(
    ...
    Shipment::FedEx::WSDL::ShipTypes::ValidateShipmentRequest
);
...
ValidateShipmentRequest from the namespace http://fedex.com/ws/ship/v9.
...
=head2 new
 ...
 my $element = Shipment::FedEx::WSDL::ShipElements::ValidateShipmentRequest->new($data);
