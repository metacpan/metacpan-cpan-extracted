...
my $color  = Windows1254::substr $s, 4, 5;   # black
my $middle = Windows1254::substr $s, 4, -11; # black cat climbed the
my $end    = Windows1254::substr $s, 14;     # climebed the green tree
my $tail   = Windows1254::substr $s, -4;     # tree
my $z      = Windows1254::substr $s, -4, 2;  # tr
