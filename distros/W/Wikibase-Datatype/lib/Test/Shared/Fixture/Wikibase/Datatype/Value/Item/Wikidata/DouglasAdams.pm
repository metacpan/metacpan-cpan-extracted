package Test::Shared::Fixture::Wikibase::Datatype::Value::Item::Wikidata::DouglasAdams;
...
Test::Shared::Fixture::Wikibase::Datatype::Value::Item::Wikidata::DouglasAdams - Test instance for Wikidata item value.
...
=for comment filename=fixture_create_and_print_value_item_wd_douglasadams.pl
