...
Pg::SQL::PrettyPrinter::Node::A_Expr - Class representing expression (two values and operator, or operator and single value)
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Pg::SQL::PrettyPrinter::Node::A_Expr
