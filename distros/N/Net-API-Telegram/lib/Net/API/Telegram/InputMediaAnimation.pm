# -*- perl -*-
##----------------------------------------------------------------------------
## Net/API/Telegram/InputMediaAnimation.pm
## Version 0.1
...
##----------------------------------------------------------------------------
package Net::API::Telegram::InputMediaAnimation;
BEGIN
{
	use strict;
...
Net::API::Telegram::InputMediaAnimation - An animation file (GIF or H.264/MPEG-4 AVC video without sound) to be sent

=head1 SYNOPSIS

	my $msg = Net::API::Telegram::InputMediaAnimation->new( %data ) || 
	die( Net::API::Telegram::InputMediaAnimation->error, "\n" );

=head1 DESCRIPTION

L<Net::API::Telegram::InputMediaAnimation> is a Telegram Message Object as defined here L<https://core.telegram.org/bots/api#inputmediaanimation>
