package Chart::Plotly::Trace::Histogram2dcontour::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Histogram2dcontour::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram2dcontour::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Histogram2dcontour::Hoverlabel - This attribute is one of the possible options for the trace histogram2dcontour.
