package Chart::Plotly::Trace::Scattergeo::Unselected::Marker;
use Moose;
...
Chart::Plotly::Trace::Scattergeo::Unselected::Marker - This attribute is one of the possible options for the trace scattergeo.
