package Chart::Plotly::Trace::Funnelarea::Marker;
use Moose;
...
has line => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Funnelarea::Marker::Line", );
...
Chart::Plotly::Trace::Funnelarea::Marker - This attribute is one of the possible options for the trace funnelarea.
