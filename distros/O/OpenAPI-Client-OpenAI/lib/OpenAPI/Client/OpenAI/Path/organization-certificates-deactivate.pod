...
This document describes the API endpoint at C</organization/certificates/deactivate>.

=head1 PATHS


=head2 C<POST /organization/certificates/deactivate>
...
C<deactivateOrganizationCertificates>

    $client->deactivateOrganizationCertificates( ... );
