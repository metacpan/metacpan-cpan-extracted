...
use Google::Ads::AdWords::v201309::CampaignCriterionOperation;
...
sub set_bid_modifier {
  ...
  my $criterion = Google::Ads::AdWords::v201309::CampaignCriterion->new({
  ...
  my $operation =
      Google::Ads::AdWords::v201309::CampaignCriterionOperation->new({
        operator => "SET",
        operand => $criterion
      });
