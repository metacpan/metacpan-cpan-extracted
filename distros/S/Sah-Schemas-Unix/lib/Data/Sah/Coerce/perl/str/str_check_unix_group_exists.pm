...
Data::Sah::Coerce::perl::str::str_check_unix_group_exists - Check that Unix group exists on the system

=head1 VERSION

This document describes version 0.005 of Data::Sah::Coerce::perl::str::str_check_unix_group_exists (from Perl distribution Sah-Schemas-Unix), released on 2019-09-11.
