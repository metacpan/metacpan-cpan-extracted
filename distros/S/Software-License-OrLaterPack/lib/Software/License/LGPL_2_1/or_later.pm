#   - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#
#   file: lib/Software/License/LGPL_2_1/or_later.pm
#
...
#pod =for :this This is C<Software::License::LGPL_2_1::or_later> module documentation. Read this if you
...
#pod =head1 SYNOPSIS
#pod
#pod     my $lic = Software::License::LGPL_2_1::or_later->new( {
#pod         holder  => 'John Doe',
#pod         year    => '2010',
#pod         program => 'Assa'
#pod     } );
#pod
#pod     $lic->_abbr;    # 'LGPL'
#pod     $lic->abbr;     # 'LGPLv2.1+'
#pod     $lic->_name;    # 'GNU Lesser General Public License'
#pod     $lic->name;     # 'The GNU Lesser General Public License version 2.1 or later'
#pod
#pod     $lic->notice;
...
#pod
#pod     # …and other methods inherited from Software::License::LGPL_2_1
#pod     # and Software::License.
#pod
#pod =head1 DESCRIPTION
#pod
#pod C<Software::License::LGPL_2_1::or_later> is a subclass of C<Software::License::LGPL_2_1>.
...
package Software::License::LGPL_2_1::or_later;

use strict;
use warnings;
use version 0.77;

# ABSTRACT: LGPLv2.1+ license for Software::License infrastructure
our $VERSION = 'v0.10.2'; # VERSION

use parent 'Software::License::LGPL_2_1';
use Text::Wrap;
...
sub base {
    ...
    if ( not $self->{ base } ) {
        ...
        $self->{ base } = Software::License::LGPL_2_1->new( \%base );
    };
    return $self->{ base };
};
...
Software::License::LGPL_2_1::or_later - LGPLv2.1+ license for Software::License infrastructure
...
This is C<Software::License::LGPL_2_1::or_later> module documentation. Read this if you
...
=head1 SYNOPSIS
    ...
    my $lic = Software::License::LGPL_2_1::or_later->new( {
        holder  => 'John Doe',
        year    => '2010',
        program => 'Assa'
    } );
    ...
    $lic->name;     # 'The GNU Lesser General Public License version 2.1 or later'
    ...
    # …and other methods inherited from Software::License::LGPL_2_1
    # and Software::License.

=head1 DESCRIPTION

C<Software::License::LGPL_2_1::or_later> is a subclass of C<Software::License::LGPL_2_1>.
