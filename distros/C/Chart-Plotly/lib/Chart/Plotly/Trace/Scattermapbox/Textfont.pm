package Chart::Plotly::Trace::Scattermapbox::Textfont;
use Moose;
...
Chart::Plotly::Trace::Scattermapbox::Textfont - This attribute is one of the possible options for the trace scattermapbox.
