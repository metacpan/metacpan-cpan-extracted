LL<https://github.com/gflohr/File-Globstar/blob/master/LICENSE> <br />
LL<https://travis-ci.org/gflohr/File-Globstar> <br />
...
Two consecutive asterisks stand for all files and directories in the <br />
...
L<https://github.com/gflohr/File-Globstar/issues>

=head2 Copyright

Copyright (C) 2016-2019, Guido Flohr, L<mailto:guido.flohr@cantanea.com>, <br />
all rights reserved.
