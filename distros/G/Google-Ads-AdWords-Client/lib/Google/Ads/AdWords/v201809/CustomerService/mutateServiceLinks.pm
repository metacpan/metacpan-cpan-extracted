...
package Google::Ads::AdWords::v201809::CustomerService::mutateServiceLinks;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201809::ServiceLinkOperation',
    },
    {
...
Google::Ads::AdWords::v201809::CustomerService::mutateServiceLinks

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutateServiceLinks from the namespace https://adwords.google.com/api/adwords/mcm/v201809.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201809::CustomerService::mutateServiceLinks->new($data);
