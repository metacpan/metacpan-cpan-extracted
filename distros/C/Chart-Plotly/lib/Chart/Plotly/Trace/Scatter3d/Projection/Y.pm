package Chart::Plotly::Trace::Scatter3d::Projection::Y;
use Moose;
...
has show => ( is            => "rw",
              isa           => "Bool",
              documentation => "Sets whether or not projections are shown along the y axis.",
);
...
Chart::Plotly::Trace::Scatter3d::Projection::Y - This attribute is one of the possible options for the trace scatter3d.
