...
our $rschema = do{my$var={base=>"str",clsets_after_base=>[{description=>"\nThis is currently just `str` with a minimum length of 1, but adds a completion\nrule to complete from list of profiles from local Firefox installation.\n\n",examples=>[{valid=>0,value=>""},{valid=>1,value=>"standard"}],min_len=>1,summary=>"Firefox profile name","x.completion"=>"firefox_profile_name"}],clsets_after_type=>['$var->{clsets_after_base}[0]'],"clsets_after_type.alt.merge.merged"=>['$var->{clsets_after_base}[0]'],resolve_path=>["str"],type=>"str",v=>2};$var->{clsets_after_type}[0]=$var->{clsets_after_base}[0];$var->{"clsets_after_type.alt.merge.merged"}[0]=$var->{clsets_after_base}[0];$var};
...
This document describes version 0.008 of Sah::SchemaR::firefox::profile_name (from Perl distribution Sah-Schemas-Firefox), released on 2023-06-14.
