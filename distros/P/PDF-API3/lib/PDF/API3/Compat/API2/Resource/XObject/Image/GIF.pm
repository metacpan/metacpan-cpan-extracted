...
package PDF::API3::Compat::API2::Resource::XObject::Image::GIF;
...
=item $res = PDF::API3::Compat::API2::Resource::XObject::Image::GIF->new $pdf, $file [, $name]
...
=item $res = PDF::API3::Compat::API2::Resource::XObject::Image::GIF->new_api $api, $file [, $name]
