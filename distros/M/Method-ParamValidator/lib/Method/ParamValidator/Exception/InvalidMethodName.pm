...
$Method::ParamValidator::Exception::InvalidMethodName::VERSION   = '0.15';
$Method::ParamValidator::Exception::InvalidMethodName::AUTHORITY = 'cpan:MANWAR';

=head1 NAME

Method::ParamValidator::Exception::InvalidMethodName - Handles 'invalid method name' exception.
...
has status => (is => 'ro', default => sub { 100 });
has reason => (is => 'ro', default => sub { 'Invalid method name received.' });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Method::ParamValidator::Exception::InvalidMethodName
...
1; # End of Method::ParamValidator::Exception::InvalidMethodName
