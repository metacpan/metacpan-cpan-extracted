NAME
    MojoX::JSON::RPC - a Perl implementation of the JSON-RPC 2.0 protocol
    for Mojolicious
...
SEE ALSO
    Mojolicious::Plugin::JsonRpcDispatcher, MojoX::JSON::RPC::Dispatcher,
    MojoX::JSON::RPC::Client
...
COPYRIGHT & LICENSE
    ...
    MojoX::JSON::RPC is provided "as is" and without any express or implied
