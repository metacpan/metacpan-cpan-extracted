...
use Google::Ads::AdWords::v201802::LocationExtensionOperand;
use Google::Ads::AdWords::v201802::LocationGroups;
...
sub add_campaign_targeting_criteria {
  ...
  my $mexico = Google::Ads::AdWords::v201802::Location->new({
      id => 2484    # Mexico
  });
  ...
  if ($location_feed_id) {
    ...
    my $radius = Google::Ads::AdWords::v201802::ConstantOperand->new({
        type        => "DOUBLE",
        unit        => "MILES",
        doubleValue => 10.0
    });
    my $radiusLocationGroup =
      Google::Ads::AdWords::v201802::LocationGroups->new({
        matchingFunction => Google::Ads::AdWords::v201802::Function->new({
            operator => "IDENTITY",
            lhsOperand =>
              Google::Ads::AdWords::v201802::LocationExtensionOperand->new(
              {radius => $radius})}
        ),
