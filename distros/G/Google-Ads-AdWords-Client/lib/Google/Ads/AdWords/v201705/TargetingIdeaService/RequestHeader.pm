...
package Google::Ads::AdWords::v201705::TargetingIdeaService::RequestHeader;
use strict;
use warnings;
...
RequestHeader from the namespace https://adwords.google.com/api/adwords/o/v201705.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::TargetingIdeaService::RequestHeader->new($data);
