...
sub evaluate { $_[1]->eval_bag($_[0]) }

=pod

=head1 NAME

Zuzu::AST::Expr::Bag - AST node for bag expressions
...
Unordered input expressions used to build a bag value.
...
B<< Zuzu::AST::Expr::Bag >> is copyright Toby Inkster.
