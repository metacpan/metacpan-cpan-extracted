...
my $d1 = Date::Pcalc->new(2001,3,9,7,35,0);
my $d2 = Date::Pcalc->new(2002,3,9,19,30,5);
my $d3 = Date::Pcalc->new(2001,4,8,8,30,11);
my $d4 = Date::Pcalc->new(2002,3,9,23,0,1);
...
$delta = Date::Pcalc->new(1,4,40,400,40,400,4000);
...
$delta = Date::Pcalc->new(1,+2,-40,+400,-40,+400,-4000);
