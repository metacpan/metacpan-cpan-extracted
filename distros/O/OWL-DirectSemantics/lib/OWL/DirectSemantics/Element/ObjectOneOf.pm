package OWL::DirectSemantics::Element::ObjectOneOf;

BEGIN {
	$OWL::DirectSemantics::Element::ObjectOneOf::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::ObjectOneOf::VERSION   = '0.001';
};
...
OWL::DirectSemantics::Element::ObjectOneOf - represents an OWL ObjectOneOf

=head1 DESCRIPTION

This class represents the ObjectOneOf element in OWL Direct Semantics.
