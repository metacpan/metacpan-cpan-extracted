...
runtime.  Then use L<Alien::Base::Dino> instead of L<Alien::Base> as the 
base class for your L<Alien> module.  Instead of using L<XSLoader> or 
L<DynaLoader> to load your XS module, use the C<xs_load> from your 
L<Alien>.  Hopefully the synopsis above makes it clear.
