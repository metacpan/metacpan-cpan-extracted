...
our $rschema = ["array",[{of=>["date::dow_num::id",{},{}],summary=>"Array of day-of-week numbers (1-7, 1=Monday)","x.completion"=>["date_dow_nums_id"],"x.perl.coerce_rules"=>["From_str::comma_sep"]}],["array"]];
...
This document describes version 0.003 of Sah::SchemaR::date::dow_nums::id (from Perl distribution Sah-Schemas-Date-ID), released on 2019-11-28.
