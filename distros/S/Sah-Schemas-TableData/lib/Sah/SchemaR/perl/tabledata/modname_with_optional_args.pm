...
Sah::SchemaR::perl::tabledata::modname_with_optional_args - Perl TableData::* module name without the prefix (e.g. Locale::US::State) with optional arguments (e.g. WordList=wordlist,EN::Enable)

=head1 VERSION

This document describes version 0.001 of Sah::SchemaR::perl::tabledata::modname_with_optional_args (from Perl distribution Sah-Schemas-TableData), released on 2021-06-11.
