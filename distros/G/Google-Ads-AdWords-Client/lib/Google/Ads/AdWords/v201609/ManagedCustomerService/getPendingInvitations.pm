...
package Google::Ads::AdWords::v201609::ManagedCustomerService::getPendingInvitations;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201609::PendingInvitationSelector',
    },
    {
...
getPendingInvitations from the namespace https://adwords.google.com/api/adwords/mcm/v201609.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201609::ManagedCustomerService::getPendingInvitations->new($data);
