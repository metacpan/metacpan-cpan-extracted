package Chart::Plotly::Trace::Scattersmith::Marker;
use Moose;
...
use Chart::Plotly::Trace::Scattersmith::Marker::Colorbar;
use Chart::Plotly::Trace::Scattersmith::Marker::Gradient;
use Chart::Plotly::Trace::Scattersmith::Marker::Line;
...
has colorbar => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattersmith::Marker::Colorbar", );
...
has gradient => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattersmith::Marker::Gradient", );

has line => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattersmith::Marker::Line", );
...
Chart::Plotly::Trace::Scattersmith::Marker - This attribute is one of the possible options for the trace scattersmith.
