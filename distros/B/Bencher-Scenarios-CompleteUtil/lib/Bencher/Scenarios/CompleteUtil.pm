package Bencher::Scenarios::CompleteUtil;
...
Bencher::Scenarios::CompleteUtil - A collection of bencher scenarios to benchmark Complete::Util

=head1 VERSION

This document describes version 0.05 of Bencher::Scenarios::CompleteUtil (from Perl distribution Bencher-Scenarios-CompleteUtil), released on 2017-01-25.
...
=item * L<Bencher::Scenario::CompleteUtil::complete_array_elem>
