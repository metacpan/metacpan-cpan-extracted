...
1;
# ABSTRACT: Modify CSV data rows using Perl code
...
App::CSVUtils::csv_munge_rows - Modify CSV data rows using Perl code

=head1 VERSION

This document describes version 1.024 of App::CSVUtils::csv_munge_rows (from Perl distribution App-CSVUtils), released on 2023-04-01.
