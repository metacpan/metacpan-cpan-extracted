package OWL::DirectSemantics::Element::ObjectMaxCardinality;

BEGIN {
	$OWL::DirectSemantics::Element::ObjectMaxCardinality::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::ObjectMaxCardinality::VERSION   = '0.001';
};
...
with 'OWL::DirectSemantics::TraitFor::Element::ObjectCardinalityConstraint';
...
OWL::DirectSemantics::Element::ObjectMaxCardinality - represents an OWL ObjectMaxCardinality

=head1 DESCRIPTION

This class represents the ObjectMaxCardinality element in OWL Direct Semantics.
