...
=head3 String typemaps

=over

=item string, std::string, panda::string (mapped to T_STRING)

=item string_view, std::string_view (mapped to T_STRING_VIEW)
...
=head4 panda::string xs::sv2string (SV* svstr) [pTHX]
...
=head4 std::string_view xs::sv2string_view (SV* svstr) [pTHX]
...
=head4 SV* xs::error_sv(const std::exception& err)
