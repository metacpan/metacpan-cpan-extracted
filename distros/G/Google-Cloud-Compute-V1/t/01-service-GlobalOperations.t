...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::DeleteGlobalOperationResponse Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::OperationAggregatedList Google::Cloud::Compute::V1::Compute::OperationList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::GlobalOperationsClient->new( credentials => 'dummy' );
