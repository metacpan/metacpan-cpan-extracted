package Chart::Plotly::Trace::Funnelarea::Domain;
use Moose;
...
has row => (
      is            => "rw",
      isa           => "Int",
      documentation => "If there is a layout grid, use the domain for this row in the grid for this funnelarea trace .",
);

has x => ( is            => "rw",
           isa           => "ArrayRef|PDL",
           documentation => "Sets the horizontal domain of this funnelarea trace (in plot fraction).",
);

has y => ( is            => "rw",
           isa           => "ArrayRef|PDL",
           documentation => "Sets the vertical domain of this funnelarea trace (in plot fraction).",
);
...
Chart::Plotly::Trace::Funnelarea::Domain - This attribute is one of the possible options for the trace funnelarea.
