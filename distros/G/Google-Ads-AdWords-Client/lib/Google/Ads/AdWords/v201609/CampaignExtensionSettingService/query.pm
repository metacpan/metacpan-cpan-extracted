...
package Google::Ads::AdWords::v201609::CampaignExtensionSettingService::query;
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201609::CampaignExtensionSettingService::query->new($data);
