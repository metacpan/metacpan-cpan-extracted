...
# 1
    ...
    sub { $_='A‚ ‚¢DA‚ ‚¢DA‚ ‚¢D'; my $r= $_ =~ s<$r2{qr/‚¢D/}><12‚©>; $r == 1                     },
    sub { $_='A‚ ‚¢DA‚ ‚¢DA‚ ‚¢D'; my $r= $_ =~ s<$r2{qr/‚¢D/}><12‚©>; $_ eq 'A‚ 12‚©A‚ ‚¢DA‚ ‚¢D' },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
# 11
    ...
    sub { $_='A‚ ‚¢DA‚ ‚¢DA‚ ‚¢D'; my $r= $_ =~ s<$r2{qr/‚¢D/}><12‚©>g; $r == 3                       },
    sub { $_='A‚ ‚¢DA‚ ‚¢DA‚ ‚¢D'; my $r= $_ =~ s<$r2{qr/‚¢D/}><12‚©>g; $_ eq 'A‚ 12‚©A‚ 12‚©A‚ 12‚©' },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
# 21
    ...
    sub { ($] < 5.014) or eval q{ $_='A‚ ‚¢DA‚ ‚¢DA‚ ‚¢D'; my $r= $_ =~ s<$r2{qr/‚¢D/}><12‚©>r; $r eq 'A‚ 12‚©A‚ ‚¢DA‚ ‚¢D' }},
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 31
    ...
    sub { ($] < 5.014) or eval q{ $_='A‚ ‚¢DA‚ ‚¢DA‚ ‚¢D'; my $r= $_ =~ s<$r2{qr/‚¢D/}><12‚©>gr; $r eq 'A‚ 12‚©A‚ 12‚©A‚ 12‚©' }},
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 81
    ...
    sub { $_='A‚ ‚¢DA‚ ‚¢DA‚ ‚¢D'; my $r= $_ =~ s<$r2{qr/(‚¢)(D)/}><$2$1>;      $r == 1                    },
    sub { $_='A‚ ‚¢DA‚ ‚¢DA‚ ‚¢D'; my $r= $_ =~ s<$r2{qr/(‚¢)(D)/}><$2$1>;      $_ eq 'A‚ D‚¢A‚ ‚¢DA‚ ‚¢D' },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
