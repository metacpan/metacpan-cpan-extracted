package Chart::Plotly::Trace::Histogram2d::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Histogram2d::Hoverlabel::Font - This attribute is one of the possible options for the trace histogram2d.
