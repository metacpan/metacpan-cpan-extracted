...
# 1
    ...
    sub { UTF8::R2::require "@{[__FILE__]}.1.pl"                             },
    sub { UTF8::R2::require "@{[__FILE__]}.2.pl"                             },
    sub { UTF8::R2::require "@{[__FILE__]}.3.pl"                             },
    sub { UTF8::R2::require "@{[__FILE__]}.4.pl";                            },
    sub { UTF8::R2::require "@{[__FILE__]}.5.pl"; uppercase('ヂa') eq 'ヂA'; },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
