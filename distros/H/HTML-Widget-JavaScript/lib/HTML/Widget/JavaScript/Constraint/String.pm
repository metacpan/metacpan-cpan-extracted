package HTML::Widget::JavaScript::Constraint::String;

use warnings;
use strict;

use base 'HTML::Widget::Constraint::String';

=head1 NAME

HTML::Widget::JavaScript::Constraint::String - JavaScript String Constraint
...
See L<HTML::Widget::Constraint::String>.
...
sub emit_javascript {
	...
	for my $param (@{$self->names}) {
		push(@js_constraints, qq[ (${var_name}.${param}.value != '' && $not /^\\w*\$/.test(${var_name}.${param}.value)) ]);	
	}
