package Chart::Plotly::Trace::Choroplethmapbox::Hoverlabel;
use Moose;
...
Chart::Plotly::Trace::Choroplethmapbox::Hoverlabel - This attribute is one of the possible options for the trace choroplethmapbox.
