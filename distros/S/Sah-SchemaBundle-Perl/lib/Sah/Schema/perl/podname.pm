...
Sah::Schema::perl::podname - Perl POD name, e.g. Moose::Cookbook

=head1 VERSION

This document describes version 0.050 of Sah::Schema::perl::podname (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
Used completion: L<perl_modname|Perinci::Sub::XCompletion::perl_modname>
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::podname*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::podname", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::podname", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::podname*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::podname*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::podname*', name=>'PerlPodname')
     );
 }

 use My::Types qw(PerlPodname);
 PerlPodname->assert_valid($data);
