...
BEGIN {
  $REST::Neo4p::Constraint::Property::VERSION = '0.4000';
}
...
use warnings;
BEGIN {
  $REST::Neo4p::Constraint::NodeProperty::VERSION='0.4000';
  $REST::Neo4p::Constraint::NodeProperty::VERSION='0.4000';
}
...
BEGIN {
  $REST::Neo4p::Constraint::RelationshipProperty::VERSION='0.4000';
  $REST::Neo4p::Constraint::RelationshipProperty::VERSION='0.4000';
}
