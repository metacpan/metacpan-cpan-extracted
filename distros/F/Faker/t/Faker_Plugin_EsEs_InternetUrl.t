...
$test->for('synopsis', sub {
  ...
  ok $result->isa('Faker::Plugin::EsEs::InternetUrl');
...
$test->for('example', 1, 'execute', sub {
  ...
  is $result->execute, 'https://loera-y-santacruz.org/';
  ok $result->faker->random->pick; # reset randomizer
  is $result->execute, 'https://www.lugo-y-ferrer-e-hijo.com.es/';
  ok $result->faker->random->pick; # reset randomizer
  is $result->execute, 'https://cuesta-miramontes.com/';
...
$test->render('lib/Faker/Plugin/EsEs/InternetUrl.pod') if $ENV{RENDER};
