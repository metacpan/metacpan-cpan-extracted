...
Extends L<"Unrelated calls" in Couch::DB|Couch::DB/"Unrelated calls">.
 
=over 4

=item $obj-E<gt>B<freshUUIDs>($count, %options)

Inherited, see L<Couch::DB/"Unrelated calls">
...
This module is part of Couch-DB distribution version 0.005,
built on June 23, 2024. Website: F<http://perl.overmeer.net/CPAN/>
