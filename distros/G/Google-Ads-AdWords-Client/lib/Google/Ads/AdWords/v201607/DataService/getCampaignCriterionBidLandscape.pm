...
package Google::Ads::AdWords::v201607::DataService::getCampaignCriterionBidLandscape;
use strict;
use warnings;
...
getCampaignCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201607.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201607::DataService::getCampaignCriterionBidLandscape->new($data);
