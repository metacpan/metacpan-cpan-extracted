package Carrot::Modularity::Constant::Parental::Obfuscated_Attributes
# /type class
# /capability ""
{
	use strict;
	...
	BEGIN {
		require('Carrot/Modularity/Constant/Parental/Obfuscated_Attributes./manual_modularity.pl');
	} #BEGIN
