package WWW::PIDS::RouteStop;

use strict;
use warnings;

our @ATTR = qw(Description HasConnectingBuses HasConnectingTrains 
HasConnectingTrams IsCityStop IsPlatformStop Latitude Longitude
StopLength UpStop StopName StopSequence SuburbName TID);
...
WWW::PIDS::RouteStop - Utility class for representing tramTRACKER PIDS route
stop.

=head1 DESCRIPTION

WWW::PIDS:: is a utility class for representing tramTRACKER PIDS route
stops as returned by the I<GetRouteStopsByRoute()> method in a the
L<WWW::PIDS> module.
...
Returns the stop description as a human-readable location. 
e.g. 'Barkly St'.
...
Returns a boolean value ('true' or 'false') indicating if the stop is
a city stop.
...
Returns the stop name. e.g. 'Barkly St & Acland St'.

=head2 StopSequence

Returns the stop sequence; this is an integer value representing the
relative sequence of the stop in the specified route.

=head2 SuburbName

returns the suburb name. e.g. 'St Kilda'.

=head2 TID

Returns the tramTRACKER ID of the stop.
