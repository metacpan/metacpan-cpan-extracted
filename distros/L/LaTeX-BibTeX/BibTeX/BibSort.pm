...
# MODIFIED   : 
# VERSION    : $Id: BibSort.pm,v 1.10 2000/03/23 02:08:40 greg Rel $
# COPYRIGHT  : Copyright (c) 1997-2000 by Gregory P. Ward.  All rights 
#              reserved.
# 
#              This file is part of the LaTeX::BibTeX library.  This is free
#              software; you can redistribute it and/or modify it under the
#              same terms as Perl itself.
# ----------------------------------------------------------------------

package LaTeX::BibTeX::BibSort;
use strict;
use vars qw(@ISA);

use LaTeX::BibTeX::Structure;

@ISA = qw(LaTeX::BibTeX::StructuredEntry);

use LaTeX::BibTeX qw(purify_string change_case);
...
C<LaTeX::BibTeX::BibSort> is a base class of C<LaTeX::BibTeX::BibEntry>
...
see L<LaTeX::BibTeX/"Generic string-processing functions"> for a brief
...
{
   require LaTeX::BibTeX::Name;
   require LaTeX::BibTeX::NameFormat;

   my ($self, $field) = @_;
   my ($abbrev, $format, $name);

   $abbrev = ! ($self->structure->get_options ('namestyle') eq 'full');
   $format = new LaTeX::BibTeX::NameFormat ("vljf", $abbrev);
...
L<LaTeX::BibTeX::Structure>, L<LaTeX::BibTeX::Bib>,
