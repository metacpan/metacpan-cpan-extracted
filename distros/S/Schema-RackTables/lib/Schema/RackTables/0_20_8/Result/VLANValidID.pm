use utf8;
package Schema::RackTables::0_20_8::Result::VLANValidID;
...
Schema::RackTables::0_20_8::Result::VLANValidID
...
Related object: L<Schema::RackTables::0_20_8::Result::CachedPAV>

=cut

__PACKAGE__->has_many(
  "cached_pavs",
  "Schema::RackTables::0_20_8::Result::CachedPAV",
...
Related object: L<Schema::RackTables::0_20_8::Result::PortAllowedVLAN>

=cut

__PACKAGE__->has_many(
  "port_allowed_vlans",
  "Schema::RackTables::0_20_8::Result::PortAllowedVLAN",
  { "foreign.vlan_id" => "self.vlan_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4/ZV5Bi2o09XKrRIRCnPGw
