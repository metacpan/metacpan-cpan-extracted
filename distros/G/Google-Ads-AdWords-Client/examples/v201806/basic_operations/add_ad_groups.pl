...
use Google::Ads::AdWords::v201806::AdGroupAdRotationMode;
...
use Google::Ads::AdWords::v201806::TargetingSetting;
use Google::Ads::AdWords::v201806::TargetingSettingDetail;
...
sub add_ad_groups {
  ...
  my $placements = Google::Ads::AdWords::v201806::TargetingSettingDetail->new({
  ...
  my $verticals = Google::Ads::AdWords::v201806::TargetingSettingDetail->new({
  ...
  my $targeting = Google::Ads::AdWords::v201806::TargetingSetting->new({
      details => [$placements, $verticals]});
  $ad_group->set_settings([$targeting]);

  # Set the rotation mode.
  my $rotation_mode = Google::Ads::AdWords::v201806::AdGroupAdRotationMode->new(
    {
  ...
  my $ad_group_2 = Google::Ads::AdWords::v201806::AdGroup->new({
    name       => sprintf("Earth to Mars Cruises #%s", uniqid()),
    status     => "ENABLED",
    campaignId => $campaign_id
  });
  ...
  # Create operations.
  my $operation = Google::Ads::AdWords::v201806::AdGroupOperation->new({
    operator => "ADD",
    operand  => $ad_group
  });
  push @operations, $operation;
  my $operation_2 = Google::Ads::AdWords::v201806::AdGroupOperation->new({
    operator => "ADD",
    operand  => $ad_group_2
  });
