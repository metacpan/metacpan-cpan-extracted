  ...
  is_equal(
    ...
    [
      $doc2_errors->@*,
      {
        ...
        error => 'schema target "http://example2.com/api#/$defs/does_not_exist" is a non-existent location',
      },
      {
        keywordLocation => '/$defs/schema24/$ref',
        absoluteKeywordLocation => 'http://example.com/api2#/$defs/schema24/$ref',
        error => 'schema target "http://example2.com/api#does_not_exist" is a non-existent location',
      },
    ],
