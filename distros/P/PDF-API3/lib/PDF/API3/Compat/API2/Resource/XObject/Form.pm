...
#
#=======================================================================
package PDF::API3::Compat::API2::Resource::XObject::Form;
...
=item $res = PDF::API3::Compat::API2::Resource::XObject::Form->new $pdf
...
=item $res = PDF::API3::Compat::API2::Resource::XObject::Form->new_api $api, $name
