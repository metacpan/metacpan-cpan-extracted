...
This document describes version 0.003 of Sah::Schema::array::num::monotonically_increasing (from Perl distribution Sah-Schemas-Array), released on 2023-02-03.
...
To create a type constraint and type library from a schema:
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('$sch_name*', name=>'ArrayNumMonotonicallyIncreasing')
     );
 }
