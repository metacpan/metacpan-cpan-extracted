...
explicitly switched on dataflow in your piddle by saying C<$a-E<gt>doflow>. For
...
where C<ind0> specifies what to do with index No 0 of the piddle C<$a>,
...
C<func((n,m),[o](n))> with a piddle C<a(2,4,7,1,3)> as C<f($a,($o = null))>
...
and you call it with 3 piddles C<a(5,3,10,11)>,
...
we have a piddle C<a(4,7,2,8)> saying

 $b = $a->thread(2,1)

creates a new virtual piddle of dimension C<b(4,8)> (which we call the
