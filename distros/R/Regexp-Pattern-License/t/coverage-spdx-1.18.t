...
# Data source: <https://web.archive.org/web/20130413002040/http://spdx.org:80/licenses/>

like(
	license_org_metadata( 'spdx', { date => '20130410', rev => '1_18' } ),
	hash {
	...
	'coverage of SPDX 1.18, releases 2013-04-10'
);
