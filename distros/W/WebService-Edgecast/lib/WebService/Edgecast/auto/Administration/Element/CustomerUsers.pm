...
package WebService::Edgecast::auto::Administration::Element::CustomerUsers;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerUsers::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerUsers');
...
WebService::Edgecast::auto::Administration::Element::CustomerUsers
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerUsers->new($data);
