...
use Google::Ads::AdWords::v201802::AddressInfo;
use Google::Ads::AdWords::v201802::CrmBasedUserList;
use Google::Ads::AdWords::v201802::Member;
use Google::Ads::AdWords::v201802::MutateMembersOperand;
use Google::Ads::AdWords::v201802::MutateMembersOperation;
use Google::Ads::AdWords::v201802::UserListOperation;
...
sub add_crm_based_user_list {
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201802::UserListOperation->new({
    operator => "ADD",
    operand  => $user_list
  });
  ...
  if ($result->get_value()) {
    ...
    foreach my $email (@email_list) {
      ...
      my $member = Google::Ads::AdWords::v201802::Member->new({
        hashedEmail => $email
      });
      push @members, $member;
    }
    ...
    my $address_info = Google::Ads::AdWords::v201802::AddressInfo->new({
    ...
    my $member_by_address = Google::Ads::AdWords::v201802::Member->new({
      addressInfo => $address_info
    });
    push @members, $member_by_address;

    my $userlist_id = $result->get_value()->[0]->get_id();
    my $operand     = Google::Ads::AdWords::v201802::MutateMembersOperand->new({
      userListId => $userlist_id,
      membersList => \@members
    });

    my $member_operation =
      Google::Ads::AdWords::v201802::MutateMembersOperation->new({
        operator => "ADD",
        operand  => $operand
      });
