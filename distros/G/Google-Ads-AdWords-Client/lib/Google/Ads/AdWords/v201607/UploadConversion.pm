package Google::Ads::AdWords::v201607::UploadConversion;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201607::ConversionTracker);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201607::ConversionTracker::Status',
        'category' => 'Google::Ads::AdWords::v201607::ConversionTracker::Category',
        ...
        'countingType' => 'Google::Ads::AdWords::v201607::ConversionDeduplicationMode',
...
UploadConversion from the namespace https://adwords.google.com/api/adwords/cm/v201607.
