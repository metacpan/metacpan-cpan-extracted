...
use Google::Ads::AdWords::v201806::CustomerExtensionSetting;
use Google::Ads::AdWords::v201806::CustomerExtensionSettingOperation;
use Google::Ads::AdWords::v201806::FeedItemCampaignTargeting;
use Google::Ads::AdWords::v201806::FeedItemSchedule;
use Google::Ads::AdWords::v201806::FeedItemScheduling;
...
use Google::Ads::AdWords::v201806::PriceFeedItem;
use Google::Ads::AdWords::v201806::PriceTableRow;
...
sub add_prices {
  ...
  my $price_feed_item = Google::Ads::AdWords::v201806::PriceFeedItem->new({
      ...
      language            => 'en',
      campaignTargeting =>
        Google::Ads::AdWords::v201806::FeedItemCampaignTargeting->new({
          TargetingCampaignId => $campaign_id
        }
        ),
      scheduling => Google::Ads::AdWords::v201806::FeedItemScheduling->new({
          feedItemSchedules => [
  ...
  my $customer_extension_setting =
    Google::Ads::AdWords::v201806::CustomerExtensionSetting->new({
      extensionType    => 'PRICE',
  ...
  my $mutate_result = $client->CustomerExtensionSettingService()->mutate({
      operations => [
        Google::Ads::AdWords::v201806::CustomerExtensionSettingOperation->new({
...
sub create_price_table_row {
  my ($header, $description, $final_url, $final_mobile_url, $price_in_micros,
    ...
    = @_;
  my $price_table_row = Google::Ads::AdWords::v201806::PriceTableRow->new({
      header      => $header,
      description => $description,
      finalUrls =>
        [Google::Ads::AdWords::v201806::UrlList->new({urls => [$final_url]})],
      price => Google::Ads::AdWords::v201806::MoneyWithCurrency->new({
