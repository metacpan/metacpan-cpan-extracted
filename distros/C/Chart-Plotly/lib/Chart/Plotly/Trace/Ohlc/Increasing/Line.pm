package Chart::Plotly::Trace::Ohlc::Increasing::Line;
use Moose;
...
Chart::Plotly::Trace::Ohlc::Increasing::Line - This attribute is one of the possible options for the trace ohlc.
