...
Syntax::Highlight::Engine::Kate::Haskell - a Plugin for Haskell syntax highlighting
...
Syntax::Highlight::Engine::Kate::Haskell is a  plugin module that provides syntax highlighting
for Haskell to the Syntax::Haghlight::Engine::Kate highlighting engine.
