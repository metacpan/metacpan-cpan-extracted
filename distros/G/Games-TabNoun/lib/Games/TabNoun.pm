...
Games::TabNoun - Select nouns from list of words, as fast as possible

=head1 VERSION

This document describes version 0.004 of Games::TabNoun (from Perl distribution Games-TabNoun), released on 2021-09-21.
