...
# eval $var has eval "..."
$var = <<'END';
eval Latin1::escape " if ('éÁ' =~ /[Šá]/i) { return 1 } else { return 0 } "
END
if (eval Latin1::escape $var) {
...
$var = <<'END';
eval Latin1::escape qq{ if ('éÁ' =~ /[Šá]/i) { return 1 } else { return 0 } }
END
if (eval Latin1::escape $var) {
...
# eval $var has eval '...'
$var = <<'END';
eval Latin1::escape ' if (qq{éÁ} =~ /[Šá]/i) { return 1 } else { return 0 } '
END
if (eval Latin1::escape $var) {
...
# eval $var has eval q{...}
$var = <<'END';
eval Latin1::escape q{ if ('éÁ' =~ /[Šá]/i) { return 1 } else { return 0 } }
END
if (eval Latin1::escape $var) {
