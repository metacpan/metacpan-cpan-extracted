...
die __PACKAGE__ . " has been removed. It was the nested status type for"
...
IO::K8s::Api::Resource::V1alpha3::PodSchedulingContextStatus - REMOVED -- classic DRA control-plane-controller allocation retired, see IO::K8s::Deprecated
...
It was the nested C<status> type for
...
IO::K8s::Api::Resource::V1alpha3::PodSchedulingContextStatus> -- or a
...
IO::K8s::Api::Resource::V1alpha3::PodSchedulingContextStatus - REMOVED, no direct replacement
