...
This document describes version 0.005 of Sah::Schema::perl::wordlist::modnames_with_optional_args (from Perl distribution Sah-Schemas-WordList), released on 2023-01-19.
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::wordlist::modnames_with_optional_args", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("perl::wordlist::modnames_with_optional_args", {return_type=>'str_errmsg+val'});
...
To create a type constraint and type library from a schema:
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('$sch_name*', name=>'PerlWordlistModnamesWithOptionalArgs')
     );
 }

 use My::Types qw(PerlWordlistModnamesWithOptionalArgs);
 PerlWordlistModnamesWithOptionalArgs->assert_valid($data);
