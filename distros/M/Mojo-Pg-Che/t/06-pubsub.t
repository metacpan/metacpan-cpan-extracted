...
=pod
Копия https://metacpan.org/source/SRI/Mojo-Pg-4.08/t/pubsub.t
заменил  Mojo::Pg->new($ENV{TEST_ONLINE});
на Mojo::Pg::Che->connect($dsn, $user, $pw,)

не пошел один тест 
в https://metacpan.org/source/SRI/Mojo-Pg-4.08/lib/Mojo/Pg/PubSub.pm
исправил 49 строку: my @cbs = @{$self->{chans}{$name} || []};

не пошел тест в строке 154
=cut
...
# JSON
$pg =  Mojo::Pg::Che->connect($dsn, $user, $pw,);
my (@json, @raw);
