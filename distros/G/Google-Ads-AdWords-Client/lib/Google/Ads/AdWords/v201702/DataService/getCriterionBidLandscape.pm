...
package Google::Ads::AdWords::v201702::DataService::getCriterionBidLandscape;
use strict;
use warnings;
...
getCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201702.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::DataService::getCriterionBidLandscape->new($data);
