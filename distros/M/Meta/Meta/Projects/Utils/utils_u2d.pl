...
my($scod)=Meta::Utils::Dos::to_dosx_list(\@ARGV,$verb);
...
utils_u2d.pl - translate UNIX text files to DOS text files.
...
This translates UNIX text file formats to dos text file formats.
