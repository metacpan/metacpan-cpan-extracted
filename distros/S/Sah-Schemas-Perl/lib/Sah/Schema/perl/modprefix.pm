...
This document describes version 0.049 of Sah::Schema::perl::modprefix (from Perl distribution Sah-Schemas-Perl), released on 2023-10-26.
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::modprefix", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::modprefix", {return_type=>'str_errmsg+val'});
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::modprefix*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::modprefix*', name=>'PerlModprefix')
     );
 }

 use My::Types qw(PerlModprefix);
 PerlModprefix->assert_valid($data);
