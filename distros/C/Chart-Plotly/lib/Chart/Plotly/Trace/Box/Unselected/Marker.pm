package Chart::Plotly::Trace::Box::Unselected::Marker;
use Moose;
...
Chart::Plotly::Trace::Box::Unselected::Marker - This attribute is one of the possible options for the trace box.
