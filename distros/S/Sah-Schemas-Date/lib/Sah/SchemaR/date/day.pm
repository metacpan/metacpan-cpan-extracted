...
our $rschema = ["int",[{max=>31,min=>1,summary=>"Day of month"}],["int"]];
...
This document describes version 0.003 of Sah::SchemaR::date::day (from Perl distribution Sah-Schemas-Date), released on 2019-06-20.
