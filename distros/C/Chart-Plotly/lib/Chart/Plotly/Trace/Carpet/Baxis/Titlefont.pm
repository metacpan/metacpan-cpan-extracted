package Chart::Plotly::Trace::Carpet::Baxis::Titlefont;
use Moose;
...
Chart::Plotly::Trace::Carpet::Baxis::Titlefont - This attribute is one of the possible options for the trace carpet.
