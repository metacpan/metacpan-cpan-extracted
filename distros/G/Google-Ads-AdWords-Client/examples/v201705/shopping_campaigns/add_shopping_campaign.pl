...
use Google::Ads::AdWords::v201705::BiddingStrategyConfiguration;
use Google::Ads::AdWords::v201705::Budget;
use Google::Ads::AdWords::v201705::Campaign;
use Google::Ads::AdWords::v201705::CampaignOperation;
use Google::Ads::AdWords::v201705::CpcBid;
use Google::Ads::AdWords::v201705::ProductAd;
use Google::Ads::AdWords::v201705::ProductPartition;
use Google::Ads::AdWords::v201705::ShoppingSetting;
...
sub add_shopping_campaign {
  ...
  my $campaign = Google::Ads::AdWords::v201705::Campaign->new({
      ...
      # Set budget (required)
      budget =>
        Google::Ads::AdWords::v201705::Budget->new({budgetId => $budget_id}),
      ...
      settings => [
        ...
        Google::Ads::AdWords::v201705::ShoppingSetting->new({
            salesCountry     => "US",
            campaignPriority => 0,
  ...
  # Create operation
  $operation = Google::Ads::AdWords::v201705::AdGroupOperation->new({
    operand  => $ad_group,
    operator => "ADD"
  });
  ...
  # Create product ad
  my $product_ad = Google::Ads::AdWords::v201705::ProductAd->new();
  ...
  # Create operation
  $operation = Google::Ads::AdWords::v201705::AdGroupAdOperation->new({
    operand  => $ad_group_ad,
    operator => "ADD"
  });
  ...
  if ($create_default_partition) {
    ...
    my $product_partition =
      Google::Ads::AdWords::v201705::ProductPartition->new({
        partitionType => 'UNIT',
    ...
    # Create operation.
    $operation = Google::Ads::AdWords::v201705::AdGroupCriterionOperation->new({
      operator => "ADD",
