#======================================================================
package DBD::SQLeet::VirtualTable::FileContent;
#======================================================================
use strict;
use warnings;
...
my %defaults = (
  ...
  path_col    => "path",
  expose      => "*",
  get_content => "DBD::SQLeet::VirtualTable::FileContent::get_content",
);
...
#======================================================================
package DBD::SQLeet::VirtualTable::FileContent::Cursor;
#======================================================================
use strict;
use warnings;
...
DBD::SQLeet::VirtualTable::FileContent -- virtual table for viewing file contents
...
Within Perl :
  ...
  $dbh->sqlite_create_module(fcontent => "DBD::SQLeet::VirtualTable::FileContent");
...
fulltext table (see L<DBD::SQLeet::Fulltext_search>) : the index
