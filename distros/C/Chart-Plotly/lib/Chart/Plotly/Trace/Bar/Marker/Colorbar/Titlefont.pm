package Chart::Plotly::Trace::Bar::Marker::Colorbar::Titlefont;
use Moose;
...
Chart::Plotly::Trace::Bar::Marker::Colorbar::Titlefont - This attribute is one of the possible options for the trace bar.
