...
BEGIN {
    ...
    sub qualify ($$) {
        ...
        elsif (Einformixv6als::index($name,'::') >= 0) {
            return $name;
        }
        elsif (Einformixv6als::index($name,"'") >= 0) {
            return $name;
...
# regexp of character
my $your_char = q{[\x81-\x9F\xE0-\xFC][\x00-\xFF]|\xFD[\xA1-\xFE][\x00-\xFF]|[\x00-\xFF]};
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                                                2   3                                  4   5
                q<CORE::eval{local $Einformixv6als::re_t=%s; local $Einformixv6als::re_a=''; while($Einformixv6als::re_t =~ %s){%s local $^W=0; local $Einformixv6als::re_r=%s; %s$Einformixv6als::re_t="$Einformixv6als::re_a${1}$Einformixv6als::re_r$'"; pos($Einformixv6als::re_t)=length "$Einformixv6als::re_a${1}$Einformixv6als::re_r"; $Einformixv6als::re_a=substr($Einformixv6als::re_t,0,pos($Einformixv6als::re_t)); } return $Einformixv6als::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Einformixv6als::re_r=CORE::eval $Einformixv6als::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Einformixv6als::re_t=%s; while($Einformixv6als::re_t =~ %s){%s local $^W=0; local $Einformixv6als::re_r=%s; %s$Einformixv6als::re_t="$`$Einformixv6als::re_r$'"; pos($Einformixv6als::re_t)=length "$`$Einformixv6als::re_r"; } return $Einformixv6als::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Einformixv6als::re_r=%s; %s"%s$Einformixv6als::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Einformixv6als::re_n=0; local $Einformixv6als::re_a=''; while(%s =~ %s){%s local $^W=0; local $Einformixv6als::re_r=%s; %s%s="$Einformixv6als::re_a${1}$Einformixv6als::re_r$'"; pos(%s)=length "$Einformixv6als::re_a${1}$Einformixv6als::re_r"; $Einformixv6als::re_a=substr(%s,0,pos(%s)); $Einformixv6als::re_n++} return %s$Einformixv6als::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Einformixv6als::re_n=0; while(%s =~ %s){%s local $^W=0; local $Einformixv6als::re_r=%s; %s%s="$`$Einformixv6als::re_r$'"; pos(%s)=length "$`$Einformixv6als::re_r"; $Einformixv6als::re_n++} return %s$Einformixv6als::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Einformixv6als::re_r=%s; %s%s="%s$Einformixv6als::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Einformixv6als::re_r=%s; %s%s="%s$Einformixv6als::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Einformixv6als::re_r=CORE::eval $Einformixv6als::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
