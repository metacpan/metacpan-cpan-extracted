    ...
    errors => supersetof(
      {
        ...
        error => 'value does not match (from enum 0: strings not equal; from enum 1: strings not equal; from enum 2: strings not equal; from enum 3: strings not equal; from enum 4: strings not equal; from enum 5: strings not equal; from enum 6: strings not equal)',
      },
    ),
  },
