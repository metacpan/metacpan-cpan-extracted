...
B<XML::Pastor::Builtin::SimpleType> - Ancestor of all classes that correspond to W3C B<builtin> simple types.
...
This class descends from L<XML::Pastor::SimpleType>. 
...
This class inherits many methods from its ancestors. Please see L<XML::Pastor::SimpleType> for 
more methods. 
