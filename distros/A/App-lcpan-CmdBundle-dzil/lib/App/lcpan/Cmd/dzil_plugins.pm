...
1;
# ABSTRACT: List Dist::Zilla plugins available on CPAN
...
App::lcpan::Cmd::dzil_plugins - List Dist::Zilla plugins available on CPAN

=head1 VERSION

This document describes version 0.060 of App::lcpan::Cmd::dzil_plugins (from Perl distribution App-lcpan-CmdBundle-dzil), released on 2019-11-20.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<dzil-plugins>.
...
List Dist::Zilla plugins available on CPAN.
