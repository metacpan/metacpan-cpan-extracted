package Data::Sah::Value::perl::Str::repeat;
...
sub value {
    ...
    $res->{expr_value} = dmp($gen_args->{str}) . " x " . ($gen_args->{n}//1);
...
Data::Sah::Value::perl::Str::repeat

=head1 VERSION

This document describes version 0.001 of Data::Sah::Value::perl::Str::repeat (from Perl distribution Data-Sah-DefaultValue), released on 2021-11-28.
