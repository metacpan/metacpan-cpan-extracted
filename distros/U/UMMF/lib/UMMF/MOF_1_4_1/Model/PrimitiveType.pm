...
package UMMF::MOF_1_4_1::Model::PrimitiveType;
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_4_1::Model::PrimitiveType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_4_1::Model::PrimitiveType|UMMF::MOF_1_4_1::Model::PrimitiveType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_4_1::Model::PrimitiveType')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_4_1::Model::PrimitiveType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_4_1::Model::PrimitiveType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_4_1::Model::PrimitiveType' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_4_1::Model::PrimitiveType|UMMF::MOF_1_4_1::Model::PrimitiveType>.
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_4_1::Model::PrimitiveType::___create(@args);
