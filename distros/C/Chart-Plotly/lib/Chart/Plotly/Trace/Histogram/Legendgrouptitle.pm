package Chart::Plotly::Trace::Histogram::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Histogram::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Histogram::Legendgrouptitle - This attribute is one of the possible options for the trace histogram.
