...
This document describes version 0.050 of Sah::Schema::perl::modprefix (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
=head1 SAH SCHEMA DEFINITION
 ...
 [
   "str",
   {
     ...
     "match" => "\\A(?:[A-Za-z_][A-Za-z_0-9]*(::[A-Za-z_0-9]+)*::)?\\z",
     "x.completion" => "perl_modprefix",
     "x.perl.coerce_rules" => ["From_str::normalize_perl_modprefix"],
   },
 ]

Base type: L<str|Data::Sah::Type::str>

Used completion: L<perl_modprefix|Perinci::Sub::XCompletion::perl_modprefix>
