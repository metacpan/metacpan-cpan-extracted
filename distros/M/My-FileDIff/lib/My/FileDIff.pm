...
My::FileDiff - Perl extension for finding [uniq/intersection/difference] of two files
...
My::FileDiff utility or module is very usefull for finding the lines of uniq/difference/intersection of two files,
