package Google::Ads::AdWords::v201809::PerformanceTarget;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'volumeGoalType' => 'Google::Ads::AdWords::v201809::VolumeGoalType',
        'volumeTargetValue' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'efficiencyTargetType' => 'Google::Ads::AdWords::v201809::EfficiencyTargetType',
        'efficiencyTargetValue' => 'SOAP::WSDL::XSD::Typelib::Builtin::double',
        'spendTarget' => 'Google::Ads::AdWords::v201809::Money',
        'spendTargetType' => 'Google::Ads::AdWords::v201809::SpendTargetType',
        'forecastStatus' => 'Google::Ads::AdWords::v201809::PerformanceTargetStatus',
...
Google::Ads::AdWords::v201809::PerformanceTarget

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PerformanceTarget from the namespace https://adwords.google.com/api/adwords/cm/v201809.
