...
1;
# ABSTRACT: Get distribution(s) of script(s)
...
App::lcpan::Cmd::script2dist - Get distribution(s) of script(s)

=head1 VERSION

This document describes version 1.035 of App::lcpan::Cmd::script2dist (from Perl distribution App-lcpan), released on 2019-06-26.
