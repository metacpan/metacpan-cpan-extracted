...
# Timeouts
{
  is(Mojo::UserAgent::Cached->new->connect_timeout, 2, 'right value'); # 10
  local $ENV{MOJO_CONNECT_TIMEOUT} = 25;
  is(Mojo::UserAgent::Cached->new->connect_timeout,    25, 'right value');
  is(Mojo::UserAgent::Cached->new->inactivity_timeout, 5, 'right value'); # 20
  ...
  is(Mojo::UserAgent::Cached->new->request_timeout,    10, 'right value'); # 0
...
isnt(Mojo::UserAgent::Cached->new->server->app($dummy)->app,
