...
IO::K8s::ExternalSecrets::V1alpha1::PushSecret - PushSecret is the Schema for the PushSecrets API that enables pushing Kubernetes secrets to external secret providers.
