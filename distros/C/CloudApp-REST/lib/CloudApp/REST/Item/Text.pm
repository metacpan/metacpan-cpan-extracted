package CloudApp::REST::Item::Text;
...
CloudApp::REST::Item::Text - Text item class of CloudApp::REST
...
Text item class of CloudApp::REST.

=head1 ATTRIBUTES

See L<CloudApp::REST::Item> for common attributes and methods of all items.
The attributes listed here are only accessible for text items.
