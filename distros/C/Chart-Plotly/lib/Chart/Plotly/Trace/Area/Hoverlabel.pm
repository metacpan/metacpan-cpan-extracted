package Chart::Plotly::Trace::Area::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Area::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Area::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Area::Hoverlabel - This attribute is one of the possible options for the trace area.
