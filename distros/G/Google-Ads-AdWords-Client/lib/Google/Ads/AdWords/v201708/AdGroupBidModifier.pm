package Google::Ads::AdWords::v201708::AdGroupBidModifier;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'criterion' => 'Google::Ads::AdWords::v201708::Criterion',
        'bidModifier' => 'SOAP::WSDL::XSD::Typelib::Builtin::double',
        'baseAdGroupId' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'bidModifierSource' => 'Google::Ads::AdWords::v201708::BidModifierSource',
    },
    {
...
Google::Ads::AdWords::v201708::AdGroupBidModifier

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupBidModifier from the namespace https://adwords.google.com/api/adwords/cm/v201708.
