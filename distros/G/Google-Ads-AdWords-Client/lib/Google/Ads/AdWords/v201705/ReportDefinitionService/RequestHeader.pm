...
package Google::Ads::AdWords::v201705::ReportDefinitionService::RequestHeader;
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::ReportDefinitionService::RequestHeader->new($data);
