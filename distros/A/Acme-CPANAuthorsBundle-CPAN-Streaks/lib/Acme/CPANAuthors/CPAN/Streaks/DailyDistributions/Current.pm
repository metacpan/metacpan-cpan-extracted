package Acme::CPANAuthors::CPAN::Streaks::DailyDistributions::Current;
...
1;
# ABSTRACT: Authors with ongoing daily distributions streak (release a new [for them] distribution everyday)
...
Acme::CPANAuthors::CPAN::Streaks::DailyDistributions::Current - Authors with ongoing daily distributions streak (release a new [for them] distribution everyday)

=head1 VERSION

This document describes version 20240506.0 of Acme::CPANAuthors::CPAN::Streaks::DailyDistributions::Current (from Perl distribution Acme-CPANAuthorsBundle-CPAN-Streaks), released on 2024-05-06.
...
Current standings (as of 2024-05-06, produced by L<cpan-streaks>):
  ...
  +-----------+-----+------------+---------+
  | PERLANCAR |  21 | 2024-04-16 | ongoing |
  +-----------+-----+------------+---------+
