#!/usr/bin/perl
package SQL::QueryBuilder::Pretty::Database::ANSI::Statement;
...
SQL::QueryBuilder::Pretty::Database::ANSI::Statement - Rule to process ANSI 
statements.
