...
our $rschema = ["int",[{max=>-1,summary=>"Negative integer (-1, -2, ...)"},{div_by=>2,summary=>"Negative even number"}],["negint","int"]];
...
This document describes version 0.070 of Sah::SchemaR::negeven (from Perl distribution Sah-Schemas-Int), released on 2017-08-19.
