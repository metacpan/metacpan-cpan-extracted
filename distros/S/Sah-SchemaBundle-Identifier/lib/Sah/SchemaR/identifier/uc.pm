...
Sah::SchemaR::identifier::uc - A string that starts with [A-Z_] followed by zero of more [A-Z0-9_]

=head1 VERSION

This document describes version 0.002 of Sah::SchemaR::identifier::uc (from Perl distribution Sah-SchemaBundle-Identifier), released on 2025-11-11.
