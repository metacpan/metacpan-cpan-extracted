package Chart::Plotly::Trace::Scatterpolargl::Unselected;
use Moose;
...
has marker => ( is  => "rw",
                isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatterpolargl::Unselected::Marker", );

has textfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatterpolargl::Unselected::Textfont", );
...
Chart::Plotly::Trace::Scatterpolargl::Unselected - This attribute is one of the possible options for the trace scatterpolargl.
