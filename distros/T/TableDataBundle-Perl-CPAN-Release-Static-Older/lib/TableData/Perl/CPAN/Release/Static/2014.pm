...
TableDataRole::Perl::CPAN::Release::Static::2014 - CPAN releases for the year 2014
...
To use from Perl code:
 ...
 use TableData::Perl::CPAN::Release::Static::2014;

 my $td = TableData::Perl::CPAN::Release::Static::2014->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Perl::CPAN::Release::Static::2014 --page

 # Get number of rows
 % tabledata --action count_rows Perl::CPAN::Release::Static::2014
