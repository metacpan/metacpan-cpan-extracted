...
BEGIN {
    for (qw( YAML::XS IO::All Template::Toolkit::Simple )) {
        if (not $ENV{PERL_ZILD_TEST_000_COMPILE_MODULES}) {
            eval "use $_; 1" or die "TestML1::Setup requires $_:\n$@";
        }
    }
}
use File::Basename;
...
sub setup {
    ...
    $testml_conf ||=
        $ARGV[0] ||
        DEFAULT_TESTML_CONF;
    die "TestML1 conf file '$testml_conf' not found"
      unless -f $testml_conf;
    die "TestML1 conf file must be .yaml"
...
# DO NOT EDIT
#
# This file was generated by TestML1::Setup ($TestML1::VERSION)
#
#   > perl -MTestML1::Setup -e setup $testml_conf
...
}
