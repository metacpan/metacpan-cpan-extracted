...
----------------------------------------------------------------------
    ...
    lib/Net/ppport.h -- Perl/Pollution/Portability Version 3.03 
   
    Automatically created by Devel::PPPort running under
    perl 5.008006 on Sun Dec 26 15:56:25 2004.
    
    Do NOT edit this file directly! -- Edit PPPort_pm.PL and the
    includes in parts/inc/ instead.
 
    Use 'perldoc lib/Net/ppport.h' to view the documentation below.
...
=head1 SYNOPSIS
  ...
  perl lib/Net/ppport.h [options] [files]
...
This version of F<lib/Net/ppport.h> is designed to support operation with Perl
...
Tell F<lib/Net/ppport.h> to check for compatibility with the given
Perl version. The default is to check for compatibility with Perl
version 5.003. You can use this option to reduce the output
of F<lib/Net/ppport.h> if you intend to be backward compatible only
up to a certain Perl version.

=head2 --cplusplus

Usually, F<lib/Net/ppport.h> will detect C++ style comments and
replace them with C style comments for portability reasons.
Using this option instructs F<lib/Net/ppport.h> to leave C++
comments untouched.
...
F<lib/Net/ppport.h>. Also lists if it must be explicitly requested,
if it has dependencies, and if there are hints for it.

=head2 --list-unsupported

Lists the API elements that are known not to be supported by
F<lib/Net/ppport.h> and below which version of Perl they probably
...
earlier Perl releases. Use
    ...
    perl lib/Net/ppport.h --list-provided

to see which API elements are provided by lib/Net/ppport.h.
...
also deprecated. You can safely use the supported API, as F<lib/Net/ppport.h>
...
more C<#define>s in your source code before the inclusion of F<lib/Net/ppport.h>.
...
Just C<#define> the macro before including C<lib/Net/ppport.h>:

    #define DPPP_NAMESPACE MyOwnNamespace_
    #include "lib/Net/ppport.h"
...
F<lib/Net/ppport.h> on your source code. See the next section for
details.

=head1 EXAMPLES

To verify whether F<lib/Net/ppport.h> is needed for your module, whether you
should make any changes to your code, and whether any special defines
should be used, F<lib/Net/ppport.h> can be run as a Perl script to check your
source code. Simply say:

    perl lib/Net/ppport.h
...
use something like this:
    ...
    perl lib/Net/ppport.h --compat-version=5.6.0 --cplusplus --patch=test.diff

If you only want your code to be scanned without any suggestions
for changes, use:

    perl lib/Net/ppport.h --nochanges

You can specify a different C<diff> program or options, using
the C<--diff> option:

    perl lib/Net/ppport.h --diff='diff -C 10'

This would output context diffs with 10 lines of context.

=head1 BUGS

If this version of F<lib/Net/ppport.h> is causing failure during
the compilation of this module, please check if newer versions
of either this module or C<Devel::PPPort> are available on CPAN
before sending a bug report.

If F<lib/Net/ppport.h> was generated using the latest version of
 ...
 */
#if PERL_REVISION != 5
#  error lib/Net/ppport.h only works with Perl version 5
...
/* Hint: SvPVbyte
 * Does not work in perl-5.6.1, lib/Net/ppport.h implements a version
