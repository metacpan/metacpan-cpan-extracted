package Chart::Plotly::Trace::Scatterternary::Marker::Colorbar::Title;
use Moose;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatterternary::Marker::Colorbar::Title::Font", );
...
Chart::Plotly::Trace::Scatterternary::Marker::Colorbar::Title - This attribute is one of the possible options for the trace scatterternary.
