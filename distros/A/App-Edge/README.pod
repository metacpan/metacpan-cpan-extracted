...
App::Edge installation is straightforward. If your CPAN shell is set up,
...
App::Edge documentation is available as in POD. So you can do:
...
App::Edge is hosted on github
L<http://github.com/bayashi/App-Edge>
