package Net::RRP::Response::n548;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n548::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n548::VERSION = '0.1';
...
Net::RRP::Response::n548 - the 548 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
