package Biblio::ILL::ISO::TransactionResults;
...
Biblio::ILL::ISO::TransactionResults is a derivation of Biblio::ILL::ISO::ENUMERATED.
...
=head2 new( $s )
 ...
 Creates a new TransactionResults object. 
...
sub new {
	...
	if ( exists $self->{"ENUM_LIST"}->{$s} ) {
	    ...
	    croak "invalid TransactionResults: [$s]";
	}
    }
