package Google::Ads::AdWords::v201802::PolicySummaryDenormalizedStatus;
use strict;
use warnings;
...
PolicySummaryDenormalizedStatus from the namespace https://adwords.google.com/api/adwords/cm/v201802.
