package Sah::Schema::perl::comparer::modname;
...
our $schema = ['str' => {
    summary => 'Perl Comparer::* module name without the prefix, e.g. foo',
    description => <<'_',
...
_
    ...
    'x.completion' => ['perl_modname', {ns_prefix=>'Comparer'}],
...
1;
# ABSTRACT: Perl Comparer::* module name without the prefix, e.g. foo
...
Sah::Schema::perl::comparer::modname - Perl Comparer::* module name without the prefix, e.g. foo

=head1 VERSION

This document describes version 0.002 of Sah::Schema::perl::comparer::modname (from Perl distribution Sah-SchemaBundle-Comparer), released on 2024-03-07.
...
Used completion: L<perl_modname|Perinci::Sub::XCompletion::perl_modname>, L<HASH(0x55f2a7cdf318)|Perinci::Sub::XCompletion::HASH(0x55f2a7cdf318)>
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::comparer::modname*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::comparer::modname", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::comparer::modname", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::comparer::modname*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::comparer::modname*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::comparer::modname*', name=>'PerlComparerModname')
     );
 }

 use My::Types qw(PerlComparerModname);
 PerlComparerModname->assert_valid($data);
