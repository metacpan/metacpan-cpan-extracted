...
$Shipment::Temando::WSDL::Elements::makeBookingByRequestResponse::VERSION = '3.07';
use strict;
use warnings;
...
$Shipment::Temando::WSDL::Elements::makeBookingByRequestResponse::_articles::VERSION = '3.07';
use strict;
use warnings;
{
our $XML_ATTRIBUTE_CLASS;
