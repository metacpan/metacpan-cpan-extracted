...
This document describes version 0.050 of Sah::Schema::perl::distname_with_ver (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::distname_with_ver*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::distname_with_ver*', name=>'PerlDistnameWithVer')
     );
 }
