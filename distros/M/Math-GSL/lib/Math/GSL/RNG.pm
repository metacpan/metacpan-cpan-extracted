...
*gsl_error = *Math::GSL::RNGc::gsl_error;
*gsl_stream_printf = *Math::GSL::RNGc::gsl_stream_printf;
*gsl_strerror = *Math::GSL::RNGc::gsl_strerror;
*gsl_set_error_handler = *Math::GSL::RNGc::gsl_set_error_handler;
*gsl_set_error_handler_off = *Math::GSL::RNGc::gsl_set_error_handler_off;
*gsl_set_stream_handler = *Math::GSL::RNGc::gsl_set_stream_handler;
*gsl_set_stream = *Math::GSL::RNGc::gsl_set_stream;
...
*GSL_SUCCESS = *Math::GSL::RNGc::GSL_SUCCESS;
*GSL_FAILURE = *Math::GSL::RNGc::GSL_FAILURE;
*GSL_CONTINUE = *Math::GSL::RNGc::GSL_CONTINUE;
*GSL_EDOM = *Math::GSL::RNGc::GSL_EDOM;
*GSL_ERANGE = *Math::GSL::RNGc::GSL_ERANGE;
*GSL_EFAULT = *Math::GSL::RNGc::GSL_EFAULT;
*GSL_EINVAL = *Math::GSL::RNGc::GSL_EINVAL;
*GSL_EFAILED = *Math::GSL::RNGc::GSL_EFAILED;
*GSL_EFACTOR = *Math::GSL::RNGc::GSL_EFACTOR;
*GSL_ESANITY = *Math::GSL::RNGc::GSL_ESANITY;
*GSL_ENOMEM = *Math::GSL::RNGc::GSL_ENOMEM;
*GSL_EBADFUNC = *Math::GSL::RNGc::GSL_EBADFUNC;
*GSL_ERUNAWAY = *Math::GSL::RNGc::GSL_ERUNAWAY;
*GSL_EMAXITER = *Math::GSL::RNGc::GSL_EMAXITER;
*GSL_EZERODIV = *Math::GSL::RNGc::GSL_EZERODIV;
*GSL_EBADTOL = *Math::GSL::RNGc::GSL_EBADTOL;
*GSL_ETOL = *Math::GSL::RNGc::GSL_ETOL;
*GSL_EUNDRFLW = *Math::GSL::RNGc::GSL_EUNDRFLW;
*GSL_EOVRFLW = *Math::GSL::RNGc::GSL_EOVRFLW;
*GSL_ELOSS = *Math::GSL::RNGc::GSL_ELOSS;
*GSL_EROUND = *Math::GSL::RNGc::GSL_EROUND;
*GSL_EBADLEN = *Math::GSL::RNGc::GSL_EBADLEN;
*GSL_ENOTSQR = *Math::GSL::RNGc::GSL_ENOTSQR;
*GSL_ESING = *Math::GSL::RNGc::GSL_ESING;
*GSL_EDIVERGE = *Math::GSL::RNGc::GSL_EDIVERGE;
*GSL_EUNSUP = *Math::GSL::RNGc::GSL_EUNSUP;
*GSL_EUNIMPL = *Math::GSL::RNGc::GSL_EUNIMPL;
*GSL_ECACHE = *Math::GSL::RNGc::GSL_ECACHE;
*GSL_ETABLE = *Math::GSL::RNGc::GSL_ETABLE;
*GSL_ENOPROG = *Math::GSL::RNGc::GSL_ENOPROG;
*GSL_ENOPROGJ = *Math::GSL::RNGc::GSL_ENOPROGJ;
*GSL_ETOLF = *Math::GSL::RNGc::GSL_ETOLF;
*GSL_ETOLX = *Math::GSL::RNGc::GSL_ETOLX;
*GSL_ETOLG = *Math::GSL::RNGc::GSL_ETOLG;
*GSL_EOF = *Math::GSL::RNGc::GSL_EOF;
