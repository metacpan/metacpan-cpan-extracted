package Shipment::FedEx::WSDL::RateTypes::LabelRotationType;
$Shipment::FedEx::WSDL::RateTypes::LabelRotationType::VERSION = '3.06';
use strict;
use warnings;
...
LabelRotationType from the namespace http://fedex.com/ws/rate/v9.
