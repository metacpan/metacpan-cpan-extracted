...
@EXPORT_OK  = qw(  mn_init mn_def_pars mn_excm mn_pout mn_stat mn_err mn_contour mn_emat PDLA::PP mninit PDLA::PP mn_abre PDLA::PP mn_cierra PDLA::PP mnparm PDLA::PP mnexcm PDLA::PP mnpout PDLA::PP mnstat PDLA::PP mnemat PDLA::PP mnerrs PDLA::PP mncont );
...
*mn_cierra = \&PDLA::Minuit::mn_cierra;
