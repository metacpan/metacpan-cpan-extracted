...
package WebService::Edgecast::auto::RealTime::Element::ConnectionsGet;
BEGIN {
  $WebService::Edgecast::auto::RealTime::Element::ConnectionsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('ConnectionsGet');
...
WebService::Edgecast::auto::RealTime::Element::ConnectionsGet
...
ConnectionsGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::RealTime::Element::ConnectionsGet->new($data);
