...
style.  It allows the various C<Iterator> module features to be used for
filtering or crunching entries from an underling L<File::Locate::Iterator>.

See F<examples/iterator-pm.pl> for a simple complete program.
