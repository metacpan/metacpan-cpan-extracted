...
# $out -> {scanned}{fidonet}{15} = { 'out.00f' => 1,
#                                  };
# is( $out -> _select_domain_zone_dir( 'fidonet', 15 ), 'out.00f', 'our domain our zone, no without zone extension' );
...
is( $out -> _select_domain_zone_dir( 'fidonet', 255 ), 'out.0ff', 'our domain another zone' );
