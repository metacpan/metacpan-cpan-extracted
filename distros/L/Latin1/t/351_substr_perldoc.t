...
my $color  = Latin1::substr $s, 4, 5;   # black
my $middle = Latin1::substr $s, 4, -11; # black cat climbed the
my $end    = Latin1::substr $s, 14;     # climebed the green tree
my $tail   = Latin1::substr $s, -4;     # tree
my $z      = Latin1::substr $s, -4, 2;  # tr
