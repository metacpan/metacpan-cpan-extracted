...
or, re-using an exception object:
    ...
    my $ex = DateTime::Locale::FromCLDR::Exception->new( $other_exception_object );
...
This method is called by perl when you call L<perlfunc/die> with no parameters and C<$@> is set to a L<DateTime::Locale::FromCLDR::Exception> object.
...
Provided with a message string, this will create a new L<DateTime::Locale::FromCLDR::Exception> object and call L<perlfunc/"die"> with it.
