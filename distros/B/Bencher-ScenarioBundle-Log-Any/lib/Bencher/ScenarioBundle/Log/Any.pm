package Bencher::ScenarioBundle::Log::Any;
...
Bencher::ScenarioBundle::Log::Any - Scenarios for benchmarking Log::Any

=head1 VERSION

This document describes version 0.101 of Bencher::ScenarioBundle::Log::Any (from Perl distribution Bencher-ScenarioBundle-Log-Any), released on 2024-05-12.
