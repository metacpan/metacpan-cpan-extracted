...
package WebService::Edgecast::auto::Administration::Element::CustomerGetResponse;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerGetResponse::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerGetResponse');
...
my %CustomerGetResult_of :ATTR(:get<CustomerGetResult>);

__PACKAGE__->_factory(
    [ qw(        CustomerGetResult

    ) ],
    {
        'CustomerGetResult' => \%CustomerGetResult_of,
    },
    {
        'CustomerGetResult' => 'WebService::Edgecast::auto::Administration::Type::Customer',
    },
    {

        'CustomerGetResult' => 'CustomerGetResult',
    }
);
...
WebService::Edgecast::auto::Administration::Element::CustomerGetResponse
...
CustomerGetResponse from the namespace EC:WebServices.
...
=item * CustomerGetResult

 $element->set_CustomerGetResult($data);
 $element->get_CustomerGetResult();
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerGetResponse->new($data);
