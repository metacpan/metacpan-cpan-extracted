...
1;
# ABSTRACT: Double-line border with UTF8 characters
...
BorderStyle::UTF8::DoubleLine - Double-line border with UTF8 characters

=head1 VERSION

This document describes version 0.011 of BorderStyle::UTF8::DoubleLine (from Perl distribution BorderStyles-Standard), released on 2022-01-26.
...
To use with L<Text::ANSITable>:
 ...
 $t->border_style("UTF8::DoubleLine");
 $t->columns($rows->[0]);
...
To use with L<Text::Table::More>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"UTF8::DoubleLine");
...
To use with L<Text::Table::TinyBorderStyle>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"BorderStyle::UTF8::DoubleLine");
