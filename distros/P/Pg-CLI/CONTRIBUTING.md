...
The code for this distribution is [hosted on GitHub](https://github.com/houseabsolute/Pg-CLI).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Pg-CLI) or [via email](bug-pg-cli@rt.cpan.org).


## Continuous Integration

All pull requests for this distribution will be automatically tested
on Linux by [Travis](https://travis-ci.org/autarch/Pg-CLI).
