...
#define SWIG_init    boot_Mac__FindFile

#define SWIG_name   "Mac::FindFilec::boot_Mac__FindFile"
#define SWIG_prefix "Mac::FindFilec::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_Mac__FindFile_var::
class _wrap_Mac__FindFile_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_find_file) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: find_file(query,volumeRoot);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "find_file" "', argument " "1"" of type '" "char *""'");
    }
    arg1 = (char *)(buf1);
    res2 = SWIG_AsCharPtrAndSize(ST(1), &buf2, NULL, &alloc2);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "find_file" "', argument " "2"" of type '" "char *""'");
    }
    arg2 = (char *)(buf2);
    find_file(arg1,arg2);
...
{"Mac::FindFilec::find_file", _wrap_find_file},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
