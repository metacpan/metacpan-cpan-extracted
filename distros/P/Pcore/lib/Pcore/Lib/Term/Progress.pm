package Pcore::Lib::Term::Progress;
...
sub get_indicator (%args) {
    ...
    my $indicator = P->class->load( $args{type} // 'Bar', ns => 'Pcore::Lib::Term::Progress::Indicator' )->new( { %args, id => $INDICATOR_ORDER++ } );
