package Chart::Plotly::Trace::Candlestick::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Candlestick::Legendgrouptitle::Font - This attribute is one of the possible options for the trace candlestick.
