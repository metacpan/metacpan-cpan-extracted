package Daje::Database::View::Super::vMailMails;
...
# ====
#
# Daje::Database::View::Super::vMailMails - Daje db model
#
# SYNOPSIS
# ========
#
#
#       use Daje::Database::View::Super::vMailMails;
#
#       my $table = Daje::Database::View::Super::vMailMails->new(db => $db);
#
...
# ===========
#
# Daje::Database::View::Super::vMailMails is a View super class
#
# METHODS
# =======
#
...
has 'fields' => '"mail_mails_pkey", "editnum", "insby", "insdatetime", "modby", "moddatetime","recipients","carboncopy","subject","message","companies_companies_fkey","users_users_fkey","mail_status_fkey"';
has 'primary_key_name' => "mail_mails_pkey";
has 'table_name' => "v_mail_mails";
