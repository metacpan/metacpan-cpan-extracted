...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::InterconnectRemoteLocation Google::Cloud::Compute::V1::Compute::InterconnectRemoteLocationList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::InterconnectRemoteLocationsClient->new( credentials => 'dummy' );
