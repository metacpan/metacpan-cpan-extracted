package Google::Ads::AdWords::v201809::ManagedCustomerService::ManagedCustomerServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201809::TypeMaps::ManagedCustomerService
    if not Google::Ads::AdWords::v201809::TypeMaps::ManagedCustomerService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/mcm/v201809/ManagedCustomerService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201809::TypeMaps::ManagedCustomerService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::ManagedCustomerService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201809::ManagedCustomerService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::ManagedCustomerService::getPendingInvitations )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::ManagedCustomerService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::ManagedCustomerService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::ManagedCustomerService::mutateLink )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::ManagedCustomerService::mutateManager )],
        },
        header => {
...
Google::Ads::AdWords::v201809::ManagedCustomerService::ManagedCustomerServiceInterfacePort - SOAP Interface for the ManagedCustomerService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201809::ManagedCustomerService::ManagedCustomerServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201809::ManagedCustomerService::ManagedCustomerServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/mcm/v201809/ManagedCustomerService.
...
Returns a L<Google::Ads::AdWords::v201809::ManagedCustomerService::getResponse|Google::Ads::AdWords::v201809::ManagedCustomerService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::ManagedCustomerService::getPendingInvitationsResponse|Google::Ads::AdWords::v201809::ManagedCustomerService::getPendingInvitationsResponse> object.

 $response = $interface->getPendingInvitations( {
    selector =>  $a_reference_to, # see Google::Ads::AdWords::v201809::PendingInvitationSelector
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201809::ManagedCustomerService::mutateResponse|Google::Ads::AdWords::v201809::ManagedCustomerService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::ManagedCustomerService::mutateLabelResponse|Google::Ads::AdWords::v201809::ManagedCustomerService::mutateLabelResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::ManagedCustomerService::mutateLinkResponse|Google::Ads::AdWords::v201809::ManagedCustomerService::mutateLinkResponse> object.

 $response = $interface->mutateLink( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201809::LinkOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201809::ManagedCustomerService::mutateManagerResponse|Google::Ads::AdWords::v201809::ManagedCustomerService::mutateManagerResponse> object.
...
Generated by SOAP::WSDL on Thu Sep 20 11:05:43 2018
