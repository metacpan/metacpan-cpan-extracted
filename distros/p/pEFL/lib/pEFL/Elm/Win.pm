...
=head1 SYNOPSIS
  ...
  use pEFL::Elm;
  [...]
  my $widget = pEFL::Elm::Win->util_standard_add("name", "title of win");
...
For instructions, how to use pEFL::Elm::Win, please study this API reference for now. A perl-specific documentation will perhaps come in later versions. But applying the C documentation should be no problem. pEFL::Elm::Win gives you a nice object-oriented interface that is kept close to the C API. Please note, that the perl method names remove the "elm_win_" at the beginning of the c functions.
