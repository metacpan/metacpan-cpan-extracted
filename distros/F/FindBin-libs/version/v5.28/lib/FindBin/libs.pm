...
contains absolute paths and does not automatically change
...
There are versions of the code for Perl from releases
v5.8, 5.14, and 5.28. Makefile.PL will pick the most recent
version it can based on $^V at Configure time. As of this
writing Perl is at 5.32, which would pick the 5.28 release. 

The version-specific code is in ./version/<perl-v-string.
