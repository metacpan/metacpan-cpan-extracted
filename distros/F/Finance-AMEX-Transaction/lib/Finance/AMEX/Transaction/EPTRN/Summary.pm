package Finance::AMEX::Transaction::EPTRN::Summary;
$Finance::AMEX::Transaction::EPTRN::Summary::VERSION = '0.004';
use strict;
use warnings;

# ABSTRACT: Parse AMEX Transaction/Invoice Level Reconciliation (EPTRN) Summary Rows
