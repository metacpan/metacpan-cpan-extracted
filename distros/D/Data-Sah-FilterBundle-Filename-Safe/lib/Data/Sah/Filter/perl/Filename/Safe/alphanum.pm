...
Data::Sah::Filter::perl::Filename::Safe::alphanum - Replace characters that are not [A-Za-z0-9_] with underscore (_)

=head1 VERSION

This document describes version 0.001 of Data::Sah::Filter::perl::Filename::Safe::alphanum (from Perl distribution Data-Sah-FilterBundle-Filename-Safe), released on 2024-01-22.

=head1 SYNOPSIS

=head2 Using in Sah schema's C<prefilters> (or C<postfilters>) clause

 ["str","prefilters",[["Filename::Safe::alphanum"]]]

=head2 Using with L<Data::Sah>:

 use Data::Sah qw(gen_validator);
 
 my $schema = ["str","prefilters",[["Filename::Safe::alphanum"]]];
...
=head2 Using with L<Data::Sah:Filter> directly:
 ...
 my $filter = gen_filter([["Filename::Safe::alphanum"]]);
...
=head2 Sample data and filtering results
 ...
 "" # valid, unchanged
 "foo" # valid, unchanged
 "123  456-789.foo.bar" # valid, becomes "123_456_789_foo.bar"
