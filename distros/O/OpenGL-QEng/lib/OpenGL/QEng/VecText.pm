###  $Id: VecText.pm 424 2008-08-19 16:27:43Z duncan $
####------------------------------------------
## @file
# Data for creating text strings from vectors - used in scoreboards
package OpenGL::QEng::VecText;
...
our @EXPORT_OK =  # symbols to export on request
  qw(render_string);

## @fn $ render_string($x,$y,$z,$xscale,$yscale,$str)
# Add a text string to a sign
sub render_string {
  my ($x,$y,$z,$pitch,$xscale,$yscale,$str) = @_;

  for my $char (split(//,$str)) {
    my $points;
    ($x,$points) = render_char($x,$y,$z,$pitch,$xscale,$yscale,$char);
  }
}


#Strokes corresponding to the ASCII characters
our @simplex =
  ([ 0,16, #/* Ascii 32 */
   ],
   [ 8,10, #/* Ascii 33 */
   ...
   [31,24, #/* Ascii 37 */
    21,21, 3, 0,-1,-1,
     8,21,10,19,10,17, 9,15, 7,14, 5,14, 3,16, 3,18, 4,20, 6,21, 8,21,10,20,13,19,16,19,19,20,21,21,-1,-1,
   ...
   [ 3,24, #/* Ascii 62 */
     4,18,20, 9, 4, 0],
   [20,18, #/* Ascii 63 */
     3,16, 3,17, 4,19, 5,20, 7,21,11,21,13,20,14,19,15,17,15,15,14,13,13,12, 9,10, 9, 7,-1,-1,
     9, 2, 8, 1, 9, 0,10, 1, 9, 2],
   [55,27, #/* Ascii 64 */
    18,13,17,15,15,16,12,16,10,15, 9,14, 8,11, 8, 8, 9, 6,11, 5,14, 5,16,6,17, 8,-1,-1,
    12,16,10,14, 9,11, 9, 8,10, 6,11, 5,-1,-1,
    18,16,17, 8,17, 6,19, 5,21, 5,23, 7,24,10,24,12,23,15,22,17,20,19,18,20,15,21,12,21, 9,20, 7,19, 5,17, 4,15, 3,12, 3, 9, 4, 6, 5, 4, 7, 2, 9, 1,12, 0,15, 0,18, 1,20, 2,21, 3,-1,-1,
   ...
   [23,21, #/* Ascii 66 */
     4,21, 4, 0,-1,-1,
     4,21,13,21,16,20,17,19,18,17,18,15,17,13,16,12,13,11,-1,-1,
   ...
   [ 8,18, #/* Ascii 70 */
     ...
     4,11,12,11],
   [22,21, #/* Ascii 71 */
    18,16,17,18,15,20,13,21, 9,21, 7,20, 5,18, 4,16, 3,13, 3, 8, 4, 5, 5,3, 7, 1, 9, 0,13, 0,15, 1,17, 3,18, 5,18, 8,-1,-1,
    13, 8,18, 8],
   [ 8,22, #/* Ascii 72 */
     4,21, 4, 0,-1,-1,
    18,21,18, 0,-1,-1,
   ...
   [24,22, #/* Ascii 81 */
     9,21, 7,20, 5,18, 4,16, 3,13, 3, 8, 4, 5, 5, 3, 7, 1, 9, 0,13, 0,15,1,17, 3,18, 5,19, 8,19,13,18,16,17,18,15,20,13,21, 9,21,-1,-1,
    12, 4,18,-2],
   [16,21, #/* Ascii 82 */
     4,21, 4, 0,-1,-1,
     4,21,13,21,16,20,17,19,18,17,18,15,17,13,16,12,13,11, 4,11,-1,-1,
    11,11,18, 0],
   [20,20, #/* Ascii 83 */
    17,18,15,20,12,21, 8,21, 5,20, 3,18, 3,16, 4,14, 5,13, 7,12,13,10,15,9,16, 8,17, 6,17, 3,15, 1,12, 0, 8, 0, 5, 1, 3, 3],
   [ 5,16, #/* Ascii 84 */
   ...
   [ 8, 8, #/* Ascii 105 */
     3,21, 4,20, 5,21, 4,22, 3,21,-1,-1,
     4,14, 4, 0],
   [11,10, #/* Ascii 106 */
     5,21, 6,20, 7,21, 6,22, 5,21,-1,-1,
   ...
   [18,30, #/* Ascii 109 */
     4,14, 4, 0,-1,-1,
     4,10, 7,13, 9,14,12,14,14,13,15,10,15, 0,-1,-1,
   ...
   [ 8,12, #/* Ascii 116 */
     5,21, 5, 4, 6, 1, 8, 0,10, 0,-1,-1,
     2,14, 9,14],
   [10,19, #/* Ascii 117 */
     4,14, 4, 4, 5, 1, 7, 0,10, 0,12, 1,15, 4,-1,-1,
    15,14,15, 0],
   [ 5,16, #/* Ascii 118 */
     2,14, 8, 0,-1,-1,
    14,14, 8, 0],
   ...
   [ 8,17, #/* Ascii 122 */
    14,14, 3, 0,-1,-1,
     ...
     3, 0,14, 0],
   [39,14, #/* Ascii 123 */
     9,25, 7,24, 6,23, 5,21, 5,19, 6,17, 7,16, 8,14, 8,12, 6,10,-1,-1,
     7,24, 6,22, 6,20, 7,18, 8,17, 9,15, 9,13, 8,11, 4, 9, 8, 7, 9, 5, 9, 3,8, 1, 7, 0, 6,-2, 6,-4, 7,-6,-1,-1,
     6, 8, 8, 6, 8, 4, 7, 2, 6, 1, 5,-1, 5,-3, 6,-5, 7,-6, 9,-7],
   [ 2, 8, #/* Ascii 124 */
     4,25, 4,-7],
   [39,14, #/* Ascii 125 */
     5,25, 7,24, 8,23, 9,21, 9,19, 8,17, 7,16, 6,14, 6,12, 8,10,-1,-1,
     7,24, 8,22, 8,20, 7,18, 6,17, 5,15, 5,13, 6,11,10, 9, 6, 7, 5, 5, 5, 3,6, 1, 7, 0, 8,-2, 8,-4, 7,-6,-1,-1,
     8, 8, 6, 6, 6, 4, 7, 2, 8, 1, 9,-1, 9,-3, 8,-5, 7,-6, 5,-7],
   [23,24, #/* Ascii 126 */
     3, 6, 3, 8, 4,11, 6,12, 8,12,10,11,14, 8,16, 7,18, 7,20, 8,21,10,-1,-1,
     3, 8, 4,10, 6,11, 8,11,10,10,14, 7,16, 6,18, 6,20, 7,21,10,21,12],
  );

## @fn $ render_char($x,$y,$z,$xscale,$yscale,$char)
# Add a single char to a sign
sub render_char {
  my ($x,$y,$z,$pitch,$xscale,$yscale,$char) = @_;

  &OpenGL::glColor3f(0.0,0.0,0.0);
  &OpenGL::glLineWidth(2.0);
  my $charIdx = (ord($char)-32);
  my $cnt   = $simplex[$charIdx][0];
  my $width = $simplex[$charIdx][1];
  my $i = 2;
  my @pts;

  glTranslatef($x,$y,$z);
  glRotatef($pitch,1,0,0) if $pitch;
  &OpenGL::glBegin(GL_LINE_STRIP);
  while ($cnt>0){
    if ($simplex[$charIdx][$i]!=-1 && $simplex[$charIdx][$i+1]!=-1) {
      &OpenGL::glEnd();
      &OpenGL::glBegin(GL_LINE_STRIP);
      push(@pts,
	   $simplex[$charIdx][$i]  *$xscale,
	   $simplex[$charIdx][$i+1]*$yscale);
    }
    else {
      if (@pts) {
	while (@pts) {
...
VecText -- Data for creating text strings from vectors - used in scoreboards
