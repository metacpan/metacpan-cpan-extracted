...
my $color  = Latin9::substr $s, 4, 5;   # black
my $middle = Latin9::substr $s, 4, -11; # black cat climbed the
my $end    = Latin9::substr $s, 14;     # climebed the green tree
my $tail   = Latin9::substr $s, -4;     # tree
my $z      = Latin9::substr $s, -4, 2;  # tr
