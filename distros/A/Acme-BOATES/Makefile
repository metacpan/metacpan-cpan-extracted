...
#     ABSTRACT_FROM => q[lib/Acme/BOATES.pm]
...
#     VERSION_FROM => q[lib/Acme/BOATES.pm]
...
TO_INST_PM = lib/Acme/BOATES.pm

PM_TO_BLIB = lib/Acme/BOATES.pm \
	blib/lib/Acme/BOATES.pm
...
DISTNAME = Acme-BOATES
DISTVNAME = Acme-BOATES-0.03
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''The great new Acme::BOATES!'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Brian Oates <boates@cpan.org>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Acme-BOATES' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "The great new Acme::BOATES!",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Brian Oates <boates@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Acme-BOATES",' >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Acme/BOATES.pm blib/lib/Acme/BOATES.pm 
