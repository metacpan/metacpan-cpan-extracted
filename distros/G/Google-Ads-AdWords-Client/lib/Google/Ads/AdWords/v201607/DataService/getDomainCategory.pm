...
package Google::Ads::AdWords::v201607::DataService::getDomainCategory;
use strict;
use warnings;
...
getDomainCategory from the namespace https://adwords.google.com/api/adwords/cm/v201607.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201607::DataService::getDomainCategory->new($data);
