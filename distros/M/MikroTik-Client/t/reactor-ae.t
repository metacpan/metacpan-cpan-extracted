...
# Instantiation
use_ok 'MikroTik::Client::Reactor::AE';
my $reactor = MikroTik::Client::Reactor::AE->new;
is ref $reactor,                           'MikroTik::Client::Reactor::AE', 'right object';
is ref MikroTik::Client::Reactor::AE->new, 'Mojo::Reactor::Poll',           'right object';
$reactor->start;
undef $reactor;
is ref MikroTik::Client::Reactor::AE->new, 'MikroTik::Client::Reactor::AE', 'right object';
use_ok 'Mojo::IOLoop';
...
ok !$recurring, 'recurring was not triggered again';
my $reactor2 = MikroTik::Client::Reactor::AE->new;
...
# Detection
is(Mojo::Reactor->detect, 'MikroTik::Client::Reactor::AE', 'right class');

# Reactor in control
is ref Mojo::IOLoop->singleton->reactor, 'MikroTik::Client::Reactor::AE', 'right object';
