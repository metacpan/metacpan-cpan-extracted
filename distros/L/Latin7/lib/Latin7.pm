...
END
            ...
            if ($list !~ /\A (?>\s*) \z/oxms) {
                ...
                for (@list) {
                    ...
                    $Elatin7::function_ord     = $Elatin7::function_ord;
                    $Elatin7::function_ord_    = $Elatin7::function_ord_;
                    $Elatin7::function_reverse = $Elatin7::function_reverse;
                    $Elatin7::function_getc    = $Elatin7::function_getc;
                }
            }
        }
    }
