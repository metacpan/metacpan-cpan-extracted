...
package WebService::Edgecast::auto::Reporting::Element::FileStatsGet;
BEGIN {
  $WebService::Edgecast::auto::Reporting::Element::FileStatsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('FileStatsGet');
...
WebService::Edgecast::auto::Reporting::Element::FileStatsGet
...
FileStatsGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Reporting::Element::FileStatsGet->new($data);
