...
sub new {
    ...
    my $config;
    if ( $_[0] && ref $_[0] && ref $_[0] eq 'AsposeThreeDCloud::Configuration' ) {
        $config = $_[0];
    } else {
        $config = AsposeThreeDCloud::Configuration->new(@_);
    }
...
sub deserialize
{
    ...
    if (not defined $data) {
        ...
        my $_instance = use_module("AsposeThreeDCloud::Object::$class")->new;
        if (ref $data eq "HASH") {
