...
use Google::Ads::AdWords::v201609::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201609::BiddableAdGroupCriterion;
...
sub update_keyword {
  ...
  my $criterion =
    Google::Ads::AdWords::v201609::Criterion->new({id => $keyword_id,});

  # Create ad group criterion.
  my $ad_group_criterion =
    Google::Ads::AdWords::v201609::BiddableAdGroupCriterion->new({
      adGroupId => $ad_group_id,
      criterion => $criterion
    });

  # Create bids.
  my $bids = Google::Ads::AdWords::v201609::BiddingStrategyConfiguration->new({
      bids => [
        Google::Ads::AdWords::v201609::CpcBid->new({
            bid => Google::Ads::AdWords::v201609::Money->new(
              {microAmount => 1000000})}
        ),
      ]});
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201609::AdGroupCriterionOperation->new(
    {
