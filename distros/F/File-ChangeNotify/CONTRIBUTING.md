...
The code for this distribution is [hosted on GitHub](https://github.com/houseabsolute/File-ChangeNotify).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=File-ChangeNotify) or [via email](bug-file-changenotify@rt.cpan.org).
