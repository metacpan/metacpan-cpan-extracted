...
1;
# ABSTRACT: Array of (defined-)array-of-(defined-)strings
...
Sah::Schema::aoaos - Array of (defined-)array-of-(defined-)strings

=head1 VERSION

This document describes version 0.008 of Sah::Schema::aoaos (from Perl distribution Sah-Schemas-Collection), released on 2020-05-08.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("aoaos*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("aoaos*");
     $validator->(\@args);
     ...
 }
