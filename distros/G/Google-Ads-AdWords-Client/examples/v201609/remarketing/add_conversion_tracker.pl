...
use Google::Ads::AdWords::v201609::AdWordsConversionTracker;
use Google::Ads::AdWords::v201609::ConversionTrackerOperation;
...
sub add_conversion_tracker {
  ...
  my $conversion_tracker =
    Google::Ads::AdWords::v201609::AdWordsConversionTracker->new({
  ...
  my $conversion_operation =
    Google::Ads::AdWords::v201609::ConversionTrackerOperation->new({
      operator => "ADD",
