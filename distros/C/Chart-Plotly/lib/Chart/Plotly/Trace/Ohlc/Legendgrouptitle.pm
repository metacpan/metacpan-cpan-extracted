package Chart::Plotly::Trace::Ohlc::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Ohlc::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Ohlc::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Ohlc::Legendgrouptitle - This attribute is one of the possible options for the trace ohlc.
