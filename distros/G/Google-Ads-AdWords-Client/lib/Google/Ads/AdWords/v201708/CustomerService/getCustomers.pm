...
package Google::Ads::AdWords::v201708::CustomerService::getCustomers;
use strict;
use warnings;
...
Google::Ads::AdWords::v201708::CustomerService::getCustomers

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getCustomers from the namespace https://adwords.google.com/api/adwords/mcm/v201708.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201708::CustomerService::getCustomers->new($data);
