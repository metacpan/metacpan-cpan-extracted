...
EmailCellValidator.prototype.isValid = function(value) { return value == "" || /^[^\s]+\@[^\s]+\.[^\s]+$/.test(value); };
...
WebsiteCellValidator.prototype.isValid = function(value) { return value == "" || /^(https?:\/\/)?[^\s]+\.[^\s]+$/.test(value); };
