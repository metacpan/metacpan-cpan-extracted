package Chart::Plotly::Trace::Pointcloud::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Pointcloud::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Pointcloud::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Pointcloud::Hoverlabel - This attribute is one of the possible options for the trace pointcloud.
