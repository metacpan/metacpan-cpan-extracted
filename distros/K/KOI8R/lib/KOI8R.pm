...
END
            ...
            if ($list !~ /\A (?>\s*) \z/oxms) {
                ...
                for (@list) {
                    ...
                    $Ekoi8r::function_ord     = $Ekoi8r::function_ord;
                    $Ekoi8r::function_ord_    = $Ekoi8r::function_ord_;
                    $Ekoi8r::function_reverse = $Ekoi8r::function_reverse;
                    $Ekoi8r::function_getc    = $Ekoi8r::function_getc;
                }
            }
        }
    }
