...
#
# http://search.cpan.org/dist/CP932NEC-R2/
#
...
sub import {
    ...
    *{caller().'::iolen' } = \&IOas::CP932NEC::length;
    *{caller().'::iomid' } = \&IOas::CP932NEC::substr;
    *{caller().'::ioget' } = \&IOas::CP932NEC::readline;
    *{caller().'::ioput' } = \&IOas::CP932NEC::print;
    *{caller().'::ioputf'} = \&IOas::CP932NEC::printf;
    *{caller().'::iosort'} = \&IOas::CP932NEC::sort;
}
...
=head1 SYNOPSIS
  ...
  use CP932NEC::R2;
    ...
    $result = iomid($utf8expr, $offset_as_cp932nec, $length_as_cp932nec, $utf8replacement)
...
These subroutines provide CP932NEC octets semantics for you.

  ------------------------------------------------------------------------------------------------------------------------------------------
  Acts as SBCS             Acts as MBCS
  Octet in Script          Octet of I/O Encoding                       Note and Limitations
  ------------------------------------------------------------------------------------------------------------------------------------------
  <FILEHANDLE>             ioget(FILEHANDLE)                           get UTF-8 codepoint octets from CP932NEC file
  ------------------------------------------------------------------------------------------------------------------------------------------
  ...
  ------------------------------------------------------------------------------------------------------------------------------------------
  substr                   iomid($utf8expr, $offset_as_cp932nec, $length_as_cp932nec, $utf8replacement)
