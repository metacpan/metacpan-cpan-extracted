...
Sah::SchemaR::perl::colorscheme::modname - Perl module in the Graphics::ColorNames::* namespace, without the namespace prefix, e.g. "WWW", "X"

=head1 VERSION

This document describes version 0.003 of Sah::SchemaR::perl::colorscheme::modname (from Perl distribution Sah-SchemaBundle-ColorScheme), released on 2024-06-21.
