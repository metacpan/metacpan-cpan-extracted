package Bencher::ScenarioR::FileWriteRotate::Writing;
...
our $results = [
  [
    ...
    [
      ...
      {
        errors => 6.8e-05,
        participant => "fwr(rotate_probability=0.1)",
        rate => 24,
        samples => 6,
        time => 42,
        vs_slowest => 1.3,
      ...
      {
        errors => 0.00014,
        participant => "fwr(lock_mode=exclusive)",
        rate => 80,
        samples => 7,
        time => 10,
        vs_slowest => 4,
      ...
      {
        errors => 6.2e-05,
        participant => "fwr(lock_mode=none)",
        rate => 79,
        samples => 6,
        time => 13,
        vs_slowest => 4.2,
    ...
    ],
    {
      "func.bencher_args"              => {
                                            ...
                                            scenario_module => "FileWriteRotate::Writing",
                                          },
      ...
      "func.elapsed_time"              => 1.00196385383606,
      "func.module_startup"            => undef,
      "func.module_versions"           => {
                                            "__PACKAGE__" => 1.034,
                                            "Bencher::Scenario::FileWriteRotate::Writing" => undef,
                                            "Benchmark::Dumb" => "0.10",
      ...
      "func.permute"                   => ["perl", ["perl"], "participant", [0 .. 4], "dataset", [0]],
      "func.platform_info"             => {
                                            archname => "x86_64",
                                            codename => "rosa",
                                            is32bit  => 0,
      ...
      "func.precision"                 => 6,
      "func.scenario_module"           => "Bencher::Scenario::FileWriteRotate::Writing",
      "func.scenario_module_md5sum"    => "d8a04877bff269119a12b4bcfc5e3d7f",
      "func.scenario_module_mtime"     => 1475597243,
      "func.scenario_module_sha1sum"   => "e4be17498e72fa91003baf81e49f9df512a50e31",
      "func.scenario_module_sha256sum" => "132a0ab4f2cb11c71139190ae2915a30e0ec214847ad87267a29c15eaa89056a",
      "func.time_end"                  => 1485330040.70282,
      "func.time_factor"               => 1000,
      "func.time_start"                => 1485330039.70085,
