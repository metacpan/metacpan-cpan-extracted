    ...
    if ($cmdline_mod eq 'Perinci::CmdLine::Inline') {
        ...
        if ($cmdline_mod =~ /\APerinci::CmdLine::(Lite|Any)\z/) {
            if ($cmdline_mod eq 'Perinci::CmdLine::Lite') {
                $cmdline_mod_ver = "1.810";
            } else {
                $extra_modules->{"Perinci::CmdLine::Base"} = "1.810";
...
This document describes version 0.485 of Perinci::CmdLine::Gen (from Perl distribution Perinci-CmdLine-Gen), released on 2018-02-25.
