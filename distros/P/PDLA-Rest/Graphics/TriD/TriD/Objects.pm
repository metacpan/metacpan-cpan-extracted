...
=head2 PDLA::Graphics::TriD::GObject

Inherits from base PDLA::Graphics::TriD::Object and adds fields Points, Colors and
Options.  Need lots more here...

=cut

package PDLA::Graphics::TriD::GObject;
...
sub new {
	...
	$points = PDLA::Graphics::TriD::realcoords($type->r_type,$points);
	print "GObject new - back from  realcoords\n" if($PDLA::debug_trid);

	if(!defined $colors) {$colors = PDLA->pdl(1,1,1);
		$colors = $type->cdummies($colors,$points);
	        $options->{UseDefcols} = 1;  # for VRML efficiency
	} else {
		$colors = PDLA::Graphics::TriD::realcoords("COLOR",$colors);
	}
...
package PDLA::Graphics::TriD::Points;
...
package PDLA::Graphics::TriD::Spheres;
use base qw/PDLA::Graphics::TriD::GObject/;
...
# JNK 06dec00 -- edited from PDLA::Graphics/TriD/GObject in file Objects.pm
# GObjects can be either stand-alone or in Graphs, scaled properly.
# All the points used by the object must be in the member {Points}.
# I guess we can afford to force data to be copied (X,Y,Z) -> (Points)...
...
package PDLA::Graphics::TriD::GPObject;
# @ISA=qw/PDLA::Graphics::TriD::GObject/;
use base qw/PDLA::Graphics::TriD::GObject/;
# use fields qw/.../;
...
sub new { my($type,$points,$faceidx,$colors,$options) = @_;
  ...
  if(!defined $colors) { $colors = PDLA->pdl(1,1,1);
    ...
    $options->{ UseDefcols } = 1; } # for VRML efficiency
  else { $colors = PDLA::Graphics::TriD::realcoords("COLOR",$colors); }
...
package PDLA::Graphics::TriD::STrigrid_S;
# @ISA=qw/PDLA::Graphics::TriD::GPObject/;
use base qw/PDLA::Graphics::TriD::GPObject/;
# use fields qw/.../;
...
package PDLA::Graphics::TriD::Lattice;
use base qw/PDLA::Graphics::TriD::GObject/;
...
package PDLA::Graphics::TriD::Lines;
use base qw/PDLA::Graphics::TriD::GObject/;
...
package PDLA::Graphics::TriD::LineStrip;
use base qw/PDLA::Graphics::TriD::GObject/;
...
package PDLA::Graphics::TriD::GObject_Lattice;
use base qw/PDLA::Graphics::TriD::GObject/;
...
package PDLA::Graphics::TriD::SLattice;
use base qw/PDLA::Graphics::TriD::GObject_Lattice/;

sub cdummies { return $_[1]->dummy(1,$_[2]->getdim(2))
			-> dummy(1,$_[2]->getdim(1)); }

# colors associated with surfaces
package PDLA::Graphics::TriD::SCLattice;
use base qw/PDLA::Graphics::TriD::GObject_Lattice/;
...
package PDLA::Graphics::TriD::SLattice_S;
use base qw/PDLA::Graphics::TriD::GObject_Lattice/;
