package Chart::Plotly::Trace::Splom::Marker::Colorbar::Titlefont;
use Moose;
...
Chart::Plotly::Trace::Splom::Marker::Colorbar::Titlefont - This attribute is one of the possible options for the trace splom.
