...
1;
# ABSTRACT: Try to convert Unix username into UID, leave as-is when cannot convert
...
Data::Sah::Coerce::perl::To_int::From_str::try_convert_unix_user_to_uid - Try to convert Unix username into UID, leave as-is when cannot convert

=head1 VERSION

This document describes version 0.009 of Data::Sah::Coerce::perl::To_int::From_str::try_convert_unix_user_to_uid (from Perl distribution Sah-Schemas-Unix), released on 2019-12-09.

=head1 SYNOPSIS

To use in a Sah schema:

 ["int",{"x.perl.coerce_rules"=>["From_str::try_convert_unix_user_to_uid"]}]
