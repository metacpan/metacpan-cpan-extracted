package Chart::Plotly::Trace::Barpolar::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Barpolar::Hoverlabel::Font - This attribute is one of the possible options for the trace barpolar.
