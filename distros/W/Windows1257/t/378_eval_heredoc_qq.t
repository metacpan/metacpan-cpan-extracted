...
# eval <<"END" has eval "..."
if (eval Windows1257::escape <<"END") {
eval Windows1257::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } "
END
...
if (eval Windows1257::escape <<"END") {
eval Windows1257::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
...
# eval <<"END" has eval '...'
if (eval Windows1257::escape <<"END") {
eval Windows1257::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } '
END
...
# eval <<"END" has eval q{...}
if (eval Windows1257::escape <<"END") {
eval Windows1257::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
