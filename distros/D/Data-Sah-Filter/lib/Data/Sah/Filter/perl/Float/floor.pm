...
This document describes version 0.022 of Data::Sah::Filter::perl::Float::floor (from Perl distribution Data-Sah-Filter), released on 2023-08-16.
...
=head2 Using with L<Data::Sah>:
 ...
 my $schema = ["str","prefilters",[["Float::floor"]]];
...
=head2 Using with L<Data::Sah:Filter> directly:
 ...
 my $filter = gen_filter([["Float::floor"]]);
...
=head2 Sample data and filtering results
 ...
 -1.1 # valid, becomes -2
 1.1 # valid, becomes 1
 1.6 # filtered with args {nearest=>0.5}, valid, becomes 1.5
