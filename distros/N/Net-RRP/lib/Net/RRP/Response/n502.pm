package Net::RRP::Response::n502;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n502::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n502::VERSION = '0.1';
...
Net::RRP::Response::n502 - the 502 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
