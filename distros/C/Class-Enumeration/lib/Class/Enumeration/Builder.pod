...
The C<import()> class method implements the build process. Its first argument
is an optional HASH reference. The allowed options are C<class> (a non-empty
string), C<counter> (a CODE reference), and C<export> (a boolean value).
The C<import()> method returns the name of the enum class.
