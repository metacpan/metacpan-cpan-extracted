# PODNAME: Config::Model::models::Systemd::Section::Unit
# ABSTRACT:  Configuration class Systemd::Section::Unit
=encoding utf8
...
up. Example: C<50> refers to 50 seconds; C<2min 200ms> refers to
...
disable, start, stop,
status, …, and in unit dependency directives C<Wants>,
C<Requires>, C<Before>, C<After>, …, with the
...
immediately. I<< Optional. Type uniline.  >> 
...
systemd. I<< Optional. Type uniline.  >> 
...
affect the listed units. I<< Optional. Type uniline.  >> 
...
unit that is conflicted is stopped. I<< Optional. Type uniline.  >> 
...
C<failed> state. I<< Optional. Type uniline.  >> 
...
some other combination). I<< Optional. Type uniline.  >> 
