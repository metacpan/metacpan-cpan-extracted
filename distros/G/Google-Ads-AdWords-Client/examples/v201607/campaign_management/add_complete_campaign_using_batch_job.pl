...
use Google::Ads::AdWords::v201607::NegativeCampaignCriterion;
...
sub _create_campaign_operations {
  ...
  for (my $i = 1 ; $i < NUMBER_OF_CAMPAIGNS_TO_ADD ; $i++) {
    my $campaign = Google::Ads::AdWords::v201607::Campaign->new({
        ...
        budget => Google::Ads::AdWords::v201607::Budget->new(
...
sub _create_campaign_criterion_operations() {
  ...
  for my $campaign_operation (@campaign_operations) {
    ...
    my $negative_criterion =
      Google::Ads::AdWords::v201607::NegativeCampaignCriterion->new({
