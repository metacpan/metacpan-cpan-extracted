package Shipment::FedEx::WSDL::ShipTypes::PhysicalPackagingType;
$Shipment::FedEx::WSDL::ShipTypes::PhysicalPackagingType::VERSION = '2.03';
use strict;
use warnings;
...
PhysicalPackagingType from the namespace http://fedex.com/ws/ship/v9.
