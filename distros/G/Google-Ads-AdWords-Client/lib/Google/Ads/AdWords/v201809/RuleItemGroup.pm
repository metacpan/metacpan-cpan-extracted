package Google::Ads::AdWords::v201809::RuleItemGroup;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'items' => 'Google::Ads::AdWords::v201809::RuleItem',
    },
    {
...
Google::Ads::AdWords::v201809::RuleItemGroup

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RuleItemGroup from the namespace https://adwords.google.com/api/adwords/rm/v201809.
