...
package WebService::Edgecast::auto::Reporting::Element::CustomerBytesTransferredGet;
BEGIN {
  $WebService::Edgecast::auto::Reporting::Element::CustomerBytesTransferredGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
WebService::Edgecast::auto::Reporting::Element::CustomerBytesTransferredGet
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Reporting::Element::CustomerBytesTransferredGet->new($data);
