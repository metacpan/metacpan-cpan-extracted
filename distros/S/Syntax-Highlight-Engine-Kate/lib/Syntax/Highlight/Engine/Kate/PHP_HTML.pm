...
sub parseJScontent {
   ...
   # context => '##JavaScript/PHP'
   # includeAttrib => 'true'
   # type => 'IncludeRules'
   if ($self->includePlugin('JavaScript/PHP', $text)) {
      return 1
   }
   return 0;
};
...
Syntax::Highlight::Engine::Kate::PHP_HTML - a Plugin for PHP (HTML) syntax highlighting
...
Syntax::Highlight::Engine::Kate::PHP_HTML is a  plugin module that provides syntax highlighting
for PHP (HTML) to the Syntax::Haghlight::Engine::Kate highlighting engine.
