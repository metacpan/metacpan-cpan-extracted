...
use Google::Ads::AdWords::v201609::CampaignSharedSet;
use Google::Ads::AdWords::v201609::CampaignSharedSetOperation;
use Google::Ads::AdWords::v201609::Criterion;
use Google::Ads::AdWords::v201609::Keyword;
use Google::Ads::AdWords::v201609::OrderBy;
use Google::Ads::AdWords::v201609::Paging;
use Google::Ads::AdWords::v201609::Placement;
use Google::Ads::AdWords::v201609::Predicate;
use Google::Ads::AdWords::v201609::Selector;
use Google::Ads::AdWords::v201609::SharedCriterion;
use Google::Ads::AdWords::v201609::SharedCriterionOperation;
use Google::Ads::AdWords::v201609::SharedSet;
use Google::Ads::AdWords::v201609::SharedSetOperation;
...
sub find_and_remove_criteria_from_shared_set {
  ...
  $paging = Google::Ads::AdWords::v201609::Paging->new({
      startIndex    => 0,
      numberResults => PAGE_SIZE
  });
  $selector = Google::Ads::AdWords::v201609::Selector->new({
      fields => [
  ...
  my @remove_criterion_operations =
    ...
    sub {
      ...
      if ($criterion->isa("Google::Ads::AdWords::v201609::Keyword")) {
        printf "Shared negative keyword with ID %d and text '%s' was " .
          "found.\n",
          $criterion->get_id(),
          $criterion->get_text();
      } elsif ($criterion->isa("Google::Ads::AdWords::v201609::Placement")) {
      ...
      my $shared_criterion_operation =
        Google::Ads::AdWords::v201609::SharedCriterionOperation->new({
          operator => 'REMOVE',
          operand  => Google::Ads::AdWords::v201609::SharedCriterion->new({
              criterion => Google::Ads::AdWords::v201609::Criterion->new(
                {id => $criterion->get_id()}
              ),
