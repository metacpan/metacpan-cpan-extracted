# This file was first automatically generated by gen-acme-cpanmodules-module-from-acme-cpanlists-list on Sat Sep 22 08:02:38 2018 from module list in Acme::CPANLists::Import::PerlTricks::WhatsNewOnCPAN::201612 version 0.001.

package Acme::CPANModules::Import::PerlTricks::WhatsNewOnCPAN::201612;

our $DATE = '2018-09-22'; # DATE
our $VERSION = '0.001'; # VERSION

our $LIST = {
  description => "This list is generated by extracting module names mentioned in [http://perltricks.com/article/what-s-new-on-cpan---december-2016/] (retrieved on 2017-01-06). Visit the URL for the full contents.",
  entries     => [
                   { module => "Acme::Damn" },
                   { module => "App::RoboBot" },
                   { module => "App::TestOnTap" },
                   { module => "App::UnANSI" },
                   { module => "B::CompilerPhase::Hook" },
                   { module => "BEGIN::Lift" },
                   { module => "Bb::Collaborate::Ultra" },
                   { module => "Beam::Runner" },
                   { module => "Catalyst::Plugin::Perlinfo" },
                   { module => "Chart::Bokeh" },
                   { module => "Crypt::Perl" },
                   { module => "Dancer2::Plugin::ParamTypes" },
                   { module => "Data::Layout::BuddySystem" },
                   { module => "Data::ULID" },
                   { module => "Game::Asset" },
                   { module => "HTML::Notebook" },
                   ...
                   { module => "Pod::Confluence" },
                   { module => "Redis::RateLimit" },
                   { module => "Stepford::Grapher" },
                   { module => "Sub::Versions" },
...
Please visit the project's homepage at L<https://metacpan.org/release/Acme-CPANModulesBundle-Import-PerlTricks>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Acme-CPANModulesBundle-Import-PerlTricks>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=Acme-CPANModulesBundle-Import-PerlTricks>
