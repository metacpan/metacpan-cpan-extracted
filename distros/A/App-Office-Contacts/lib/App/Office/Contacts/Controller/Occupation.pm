package App::Office::Contacts::Controller::Occupation;

use parent 'App::Office::Contacts::Controller';

use App::Office::Contacts::Controller::Exporter::Occupation qw/-all/;
...
App::Office::Contacts::Controller::Occupation - A web-based contacts manager
