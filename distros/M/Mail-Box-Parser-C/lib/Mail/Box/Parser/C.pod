...
The C<$name> of the file to be read.
...
changed.  The C<%options> are passed to L<openFile()|Mail::Box::Parser::C/"Parsing">.
...
This module is part of Mail-Box-Parser-C version 3.013,
built on November 26, 2025. Website: F<http://perl.overmeer.net/CPAN/>
