# This Makefile is for the Mail::XML extension to perl.
#
...
manifypods : pure_all XML.pm
	@$(POD2MAN) \
	XML.pm \
	$(INST_MAN3DIR)/Mail::XML.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Mail-XML\" VERSION=\"0,03,0,0\">\n}. qq{\t<TITLE>Mail-XML</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Mail-XML.ppd
