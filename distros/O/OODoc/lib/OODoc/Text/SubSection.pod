...
With a C<$name>, the subsubsection within this subsection with that name is
returned.  With an C<$object> (which must be a L<OODoc::Text::SubSubSection|OODoc::Text::SubSubSection>),
