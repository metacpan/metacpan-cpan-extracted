...
#
package PeakForest::REST_Client::Role;
use utf8;
...
use Class::Inspector;
use Log::Any qw($log);
use PeakForest::REST_Client::ApiFactory;
...
has api_factory => ( is => 'ro',
                     isa => 'PeakForest::REST_Client::ApiFactory',
                     builder => '_build_af',
                     lazy => 1,
...
has _cfg => ( is => 'ro',
              isa => 'PeakForest::REST_Client::Configuration',
              default => sub { PeakForest::REST_Client::Configuration->new() },
              );

has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'PeakForest REST API',
                          app_version => '2.3.4',
...
sub _build_af {
    ...
    return PeakForest::REST_Client::ApiFactory->new(%args);
}

=head1 NAME

PeakForest::REST_Client::Role - a Moose role for the PeakForest REST API

=head2 PeakForest REST API version: 2.3.4
...
PeakForest::REST_Client::ApiFactory for non-Moosey usage.
...
role.
    ...
    package MyApp;
    use Moose;
    with 'PeakForest::REST_Client::Role';
...
The tokens will be placed in a L<PeakForest::REST_Client::Configuration> instance
...
Returns an API factory object. You probably won't need to call this directly.
        ...
        $self->api_factory('Pet'); # returns a PeakForest::REST_Client::PetApi instance
