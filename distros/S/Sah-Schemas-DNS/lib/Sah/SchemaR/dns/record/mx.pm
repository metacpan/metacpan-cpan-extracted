...
our $rschema = ["hash",[{keys=>{host=>["net::hostname",{req=>1},{}],name=>["str",{req=>1},{}],prio=>["uint",{req=>1},{}],ttl=>["uint",{},{}],type=>["str",{is=>"MX",match=>"\\A(?:[A-Z]([A-Z0-9]+|[A-Z0-9-]*[A-Z0-9])?|\\*)\\z",req=>1},{}]},"keys.restrict"=>1,req_keys=>["name","type","host","prio"],summary=>"DNS MX record"}],["dns::record","hash"]];
...
This document describes version 0.002 of Sah::SchemaR::dns::record::mx (from Perl distribution Sah-Schemas-DNS), released on 2019-07-25.
