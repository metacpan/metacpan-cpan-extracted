package Chart::Plotly::Trace::Parcats::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Parcats::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Parcats::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Parcats::Legendgrouptitle - This attribute is one of the possible options for the trace parcats.
