...
package Meta::Baseline::Lang::Pyob;
...
Meta::Baseline::Lang::Pyob - language for Python Byte Code files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Pyob::env();

=head1 DESCRIPTION

This package contains stuff specific to Pyob in the baseline:
Its mainly here to authorize entries of Python ByteCode files to the baseline.
