package Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::NumberOfLimbs::Four;
...
sub new {
	...
	my @params = (
		'snak' => Test::Shared::Fixture::Wikibase::Datatype::Snak::Wikidata::NumberOfLimbs::Four->new,
	);
...
Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::NumberOfLimbs::Four - Test instance for Wikidata statement.

=head1 SYNOPSIS

 use Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::NumberOfLimbs::Four;

 my $obj = Test::Shared::Fixture::Wikibase::Datatype::Statement::Wikidata::NumberOfLimbs::Four->new(%params);
 my $id = $obj->id;
...
=for comment filename=fixture_create_and_print_statement_wd_number_of_hands_four.pl
...
L<Test::Shared::Fixture::Wikibase::Datatype::Snak::Wikidata::NumberOfLimbs::Four>,
