...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::TTF::XMLparse;

=head1 NAME

PDF::API3::Compat::API2::Basic::TTF::XMLparse - provides support for XML parsing. Requires Expat module XML::Parser::Expat

=head1 SYNOPSIS

    use PDF::API3::Compat::API2::Basic::TTF::Font;
    use PDF::API3::Compat::API2::Basic::TTF::XMLparse;

    $f = PDF::API3::Compat::API2::Basic::TTF::Font->new;
    read_xml($f, $ARGV[0]);
    $f->out($ARGV[1]);
