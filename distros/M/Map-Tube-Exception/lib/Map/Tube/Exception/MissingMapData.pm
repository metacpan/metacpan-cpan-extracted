...
$Map::Tube::Exception::MissingMapData::VERSION = '3.15';
=head1 NAME
...
has status => (is => 'ro', default => sub { 124 });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Map::Tube::Exception::MissingMapData
...
1; # End of Map::Tube::Exception::MissingMapData
