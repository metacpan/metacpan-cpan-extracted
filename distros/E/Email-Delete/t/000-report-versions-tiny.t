...
eval { $v .= pmver('Email::Folder','any version') };
eval { $v .= pmver('Email::Folder::Mbox','any version') };
eval { $v .= pmver('Email::FolderType','any version') };
eval { $v .= pmver('Email::LocalDelivery::Mbox','any version') };
