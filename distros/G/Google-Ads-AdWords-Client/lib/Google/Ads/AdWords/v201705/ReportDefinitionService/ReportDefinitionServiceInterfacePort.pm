package Google::Ads::AdWords::v201705::ReportDefinitionService::ReportDefinitionServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201705::TypeMaps::ReportDefinitionService
    if not Google::Ads::AdWords::v201705::TypeMaps::ReportDefinitionService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201705/ReportDefinitionService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201705::TypeMaps::ReportDefinitionService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201705::ReportDefinitionService::getReportFields )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201705::ReportDefinitionService::RequestHeader )],
        },
        headerfault => {
...
located at https://adwords.google.com/api/adwords/cm/v201705/ReportDefinitionService.
...
Returns a L<Google::Ads::AdWords::v201705::ReportDefinitionService::getReportFieldsResponse|Google::Ads::AdWords::v201705::ReportDefinitionService::getReportFieldsResponse> object.
