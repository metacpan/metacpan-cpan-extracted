# AWS::DataSync::LocationFSxWindows generated from spec 34.0.0
use Moose::Util::TypeConstraints;

coerce 'Cfn::Resource::Properties::AWS::DataSync::LocationFSxWindows',
  from 'HashRef',
   via { Cfn::Resource::Properties::AWS::DataSync::LocationFSxWindows->new( %$_ ) };

package Cfn::Resource::AWS::DataSync::LocationFSxWindows {
  use Moose;
  extends 'Cfn::Resource';
  has Properties => (isa => 'Cfn::Resource::Properties::AWS::DataSync::LocationFSxWindows', is => 'rw', coerce => 1);
...
package Cfn::Resource::Properties::AWS::DataSync::LocationFSxWindows {
  use Moose;
  use MooseX::StrictConstructor;
  extends 'Cfn::Resource::Properties';
  
  has Domain => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Immutable');
  has FsxFilesystemArn => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, required => 1, traits => [ 'CfnMutability' ], mutability => 'Immutable');
...
Cfn::Resource::AWS::DataSync::LocationFSxWindows - Cfn resource for AWS::DataSync::LocationFSxWindows

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::DataSync::LocationFSxWindows.
