...
package UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin;
...
=head2 C<pin> : I<THIS> C<0..*> E<lt>---E<gt>  C<type> : UMMF::UML_1_5::Foundation::Core::Classifier C<0..1>
...
=head2 C<__validate_type>
  ...
  UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin|UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin')  ;
}


=head2 C<__typecheck>

  UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin|UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin>.
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin::___create(@args);
...
sub set_multiplicity ($$)
{
  ...
  if ( defined $val ) {
    $self->__use('UMMF::UML_1_5::Foundation::Data_Types::Multiplicity')->__typecheck($val, "UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin.multiplicity");
  }
...
sub set_ordering ($$)
{
  ...
  if ( defined $val ) {
    $self->__use('UMMF::UML_1_5::Foundation::Data_Types::OrderingKind')->__typecheck($val, "UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin.ordering");
  }
...
sub set_type ($$)
{
  ...
  if ( ($old = $self->{'type'}) ne $val ) { # Recursion lock
    ...
    if ( defined $val ) { $self->__use('UMMF::UML_1_5::Foundation::Core::Classifier')->__typecheck($val, "UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin.type") }
...
sub add_type ($$)
{
  ...
  my $old;
  if ( ($old = $self->{'type'}) ne $val ) { # Recursion lock
    $self->__use('UMMF::UML_1_5::Foundation::Core::Classifier')->__typecheck($val, "UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin.type");
      
    # confess("UMMF::UML_1_5::Behavioral_Elements::Actions::Action_Foundation::Pin::type: too many")
    # if defined $self->{'type'};
