package Chart::Plotly::Trace::Streamtube::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Streamtube::Colorbar::Tickfont;
use Chart::Plotly::Trace::Streamtube::Colorbar::Tickformatstop;
use Chart::Plotly::Trace::Streamtube::Colorbar::Title;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Streamtube::Colorbar::Tickfont", );
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Streamtube::Colorbar::Tickformatstop]", );
...
has title => ( is  => "rw",
               isa => "Maybe[HashRef]|Chart::Plotly::Trace::Streamtube::Colorbar::Title", );
...
Chart::Plotly::Trace::Streamtube::Colorbar - This attribute is one of the possible options for the trace streamtube.
