...
our $authParameters = {
  ...
  radiusParams => [qw(radiusAuthnLevel radiusSecret radiusServer radiusExportedVars radiusDictionaryFile radiusRequestAttributes)],
