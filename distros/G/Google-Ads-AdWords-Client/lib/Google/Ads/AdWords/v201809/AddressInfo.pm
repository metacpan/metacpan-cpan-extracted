package Google::Ads::AdWords::v201809::AddressInfo;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::AddressInfo

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AddressInfo from the namespace https://adwords.google.com/api/adwords/rm/v201809.
