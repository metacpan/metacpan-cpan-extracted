package Google::Ads::AdWords::v201609::ManagedCustomerService::ManagedCustomerServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201609::TypeMaps::ManagedCustomerService
    if not Google::Ads::AdWords::v201609::TypeMaps::ManagedCustomerService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/mcm/v201609/ManagedCustomerService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201609::TypeMaps::ManagedCustomerService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201609::ManagedCustomerService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201609::ManagedCustomerService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201609::ManagedCustomerService::getPendingInvitations )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201609::ManagedCustomerService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201609::ManagedCustomerService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201609::ManagedCustomerService::mutateLink )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201609::ManagedCustomerService::mutateManager )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/mcm/v201609/ManagedCustomerService.
...
Returns a L<Google::Ads::AdWords::v201609::ManagedCustomerService::getResponse|Google::Ads::AdWords::v201609::ManagedCustomerService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201609::ManagedCustomerService::getPendingInvitationsResponse|Google::Ads::AdWords::v201609::ManagedCustomerService::getPendingInvitationsResponse> object.
...
Returns a L<Google::Ads::AdWords::v201609::ManagedCustomerService::mutateResponse|Google::Ads::AdWords::v201609::ManagedCustomerService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201609::ManagedCustomerService::mutateLabelResponse|Google::Ads::AdWords::v201609::ManagedCustomerService::mutateLabelResponse> object.
...
Returns a L<Google::Ads::AdWords::v201609::ManagedCustomerService::mutateLinkResponse|Google::Ads::AdWords::v201609::ManagedCustomerService::mutateLinkResponse> object.
...
Returns a L<Google::Ads::AdWords::v201609::ManagedCustomerService::mutateManagerResponse|Google::Ads::AdWords::v201609::ManagedCustomerService::mutateManagerResponse> object.
...
Generated by SOAP::WSDL on Fri Sep 30 15:08:39 2016
