# AWS::GuardDuty::Member generated from spec 14.3.0
...
Cfn::Resource::AWS::GuardDuty::Member - Cfn resource for AWS::GuardDuty::Member

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::GuardDuty::Member.
