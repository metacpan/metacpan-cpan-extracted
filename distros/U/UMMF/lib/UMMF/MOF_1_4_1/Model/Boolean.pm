...
package UMMF::MOF_1_4_1::Model::Boolean;
...
Constructs new UMMF::MOF_1_4_1::Model::Boolean value.
...
sub new
{
  ...
  __typecheck($self, $x, 'UMMF::MOF_1_4_1::Model::Boolean::new');
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_4_1::Model::Boolean->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_4_1::Model::Boolean|UMMF::MOF_1_4_1::Model::Boolean>.
...
=head2 C<__typecheck>
  ...
  UMMF::MOF_1_4_1::Model::Boolean->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_4_1::Model::Boolean->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_4_1::Model::Boolean' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_4_1::Model::Boolean|UMMF::MOF_1_4_1::Model::Boolean>.
...
sub __initialize
{
  ...
  $self->UMMF::MOF_1_4_1::Model::Boolean::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_4_1::Model::Boolean::___create(@args);
