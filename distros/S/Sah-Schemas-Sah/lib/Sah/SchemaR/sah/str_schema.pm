package Sah::SchemaR::sah::str_schema;

our $DATE = '2019-07-19'; # DATE
our $VERSION = '0.9.46.0'; # VERSION

our $rschema = ["str",[{match=>"\\A[A-Za-z][A-Za-z0-9_]*(::[A-Za-z][A-Za-z0-9_]*)*\\*?\\z"}],["str"]];
...
Sah::SchemaR::sah::str_schema -  

=head1 VERSION

This document describes version 0.9.46.0 of Sah::SchemaR::sah::str_schema (from Perl distribution Sah-Schemas-Sah), released on 2019-07-19.
