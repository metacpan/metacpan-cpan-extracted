...
my $color  = Latin6::substr $s, 4, 5;   # black
my $middle = Latin6::substr $s, 4, -11; # black cat climbed the
my $end    = Latin6::substr $s, 14;     # climebed the green tree
my $tail   = Latin6::substr $s, -4;     # tree
my $z      = Latin6::substr $s, -4, 2;  # tr
