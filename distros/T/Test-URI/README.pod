...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Test-URI> or
L<MetaCPAN|http://www.metacpan.org/module/Test::URI>:

=over 4

=item *	L<http://search.cpan.org/dist/Test-URI>

=item *	L<http://www.metacpan.org/module/Test::URI>
