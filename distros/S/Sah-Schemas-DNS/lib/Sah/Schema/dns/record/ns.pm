...
Sah::Schema::dns::record::ns - DNS NS record

=head1 VERSION

This document describes version 0.002 of Sah::Schema::dns::record::ns (from Perl distribution Sah-Schemas-DNS), released on 2019-07-25.
