# This Makefile is for the Text::CSV2TXT extension to perl.
#
...
#	ABSTRACT => q[Convert CSV files into text files]
#	AUTHOR => q[SANFACE Software (sanface@sanface.com)]
#	NAME => q[Text::CSV2TXT]
#	VERSION_FROM => q[CSV2TXT.pm]
...
AR_STATIC_ARGS = cr
NAME = Text::CSV2TXT
DISTNAME = Text-CSV2TXT
NAME_SYM = Text_CSV2TXT
VERSION = 2.0
VERSION_SYM = 2_0
XS_VERSION = 2.0
INST_BIN = blib\bin
...
EXPORT_LIST = CSV2TXT.def

PERL_ARCHIVE = $(PERL_INC)\perl56.lib

TO_INST_PM = CSV2TXT.pm

PM_TO_BLIB = CSV2TXT.pm \
	$(INST_LIBDIR)\CSV2TXT.pm
...
CSV2TXT.def: Makefile.PL
	$(PERL) "-I$(PERL_ARCHLIB)" "-I$(PERL_LIB)" -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME' => 'Text::CSV2TXT', 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
realclean purge ::  clean
	...
	$(PERL) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -MExtUtils::Command -e rm_f  $(INST_LIBDIR)\CSV2TXT.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Text-CSV2TXT\" VERSION=\"2,0,0,0\">\n}. qq{\t<TITLE>Text-CSV2TXT</TITLE>\n}. qq{\t<ABSTRACT>Convert CSV files into text files</ABSTRACT>\n}. qq{\t<AUTHOR>SANFACE Software (sanface\@sanface.com)</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"MSWin32-x86-multi-thread\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Text-CSV2TXT.ppd
