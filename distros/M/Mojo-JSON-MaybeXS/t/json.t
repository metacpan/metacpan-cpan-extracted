# JSON test file adapted from Mojolicious
...
if (_cpanel_version('4.09') or !_cpanel_version('3.0235')) {
...
# Escaped slash
if (Mojo::JSON::MaybeXS::JSON eq 'JSON::PP' or _cpanel_version('3.0206')) {
