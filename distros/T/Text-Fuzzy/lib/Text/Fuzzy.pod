...
(This example is included as L<F<synopsis.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.27/examples/synopsis.pl> in the distribution.)


=head1 VERSION

This documents version 0.27 of Text::Fuzzy corresponding
to git commit L<2f4e00c4e7a9c27917ba867c83886037ba17169c|https://github.com/benkasminbullock/Text-Fuzzy/commit/2f4e00c4e7a9c27917ba867c83886037ba17169c> released on Tue Aug 15 12:37:45 2017 +0900.
...
(This example is included as L<F<unicode.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.27/examples/unicode.pl> in the distribution.)
...
(This example is included as L<F<distance.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.27/examples/distance.pl> in the distribution.)
...
(This example is included as L<F<nearestv.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.27/examples/nearestv.pl> in the distribution.)
...
(This example is included as L<F<check-return.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.27/examples/check-return.pl> in the distribution.)
...
(This example is included as L<F<list-context.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.27/examples/list-context.pl> in the distribution.)
...
(This example is included as L<F<last-distance.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.27/examples/last-distance.pl> in the distribution.)
...
(This example is included as L<F<max-dist.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.27/examples/max-dist.pl> in the distribution.)
...
(This example is included as L<F<no-exact.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.27/examples/no-exact.pl> in the distribution.)
...
(This example is included as L<F<distance-edits.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.27/examples/distance-edits.pl> in the distribution.)
...
The file 
L<F<examples/misspelt-web-page.cgi>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.27/examples/misspelt-web-page.cgi>
...
The file 
L<F<examples/spell-check.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.27/examples/spell-check.pl>
...
The file 
L<F<examples/extract-kana.pl>|https://fastapi.metacpan.org/source/BKB/Text-Fuzzy-0.27/examples/extract-kana.pl>
