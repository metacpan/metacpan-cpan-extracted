...
Data::Sah::Coerce::perl::To_any::From_any::validate_filehandle - Validate filehandle

=head1 VERSION

This document describes version 0.003 of Data::Sah::Coerce::perl::To_any::From_any::validate_filehandle (from Perl distribution Sah-Schemas-FileHandle), released on 2019-11-28.

=head1 SYNOPSIS

To use in a Sah schema:

 ["any",{"x.perl.coerce_rules"=>["From_any::validate_filehandle"]}]
