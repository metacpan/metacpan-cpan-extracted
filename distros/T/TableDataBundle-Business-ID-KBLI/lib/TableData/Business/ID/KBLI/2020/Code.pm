...
around new => sub {
    ...
    my $filename = File::Basename::dirname(__FILE__) . '/../../../../../../share/code2020.csv';
    unless (-f $filename) {
        require File::ShareDir;
        $filename = File::ShareDir::dist_file('TableDataBundle-Business-ID-KBLI', 'code2020.csv');
    }
...
1;
# ABSTRACT: List of KBLI 2020 codes
...
TableDataRole::Business::ID::KBLI::2020::Code - List of KBLI 2020 codes

=head1 VERSION

This document describes version 20260626.0.0 of TableDataRole::Business::ID::KBLI::2020::Code (from Perl distribution TableDataBundle-Business-ID-KBLI), released on 2026-06-26.
