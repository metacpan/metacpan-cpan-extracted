...
use Google::Ads::AdWords::v201705::AttributeFieldMapping;
use Google::Ads::AdWords::v201705::CampaignFeed;
use Google::Ads::AdWords::v201705::CampaignFeedOperation;
use Google::Ads::AdWords::v201705::Feed;
use Google::Ads::AdWords::v201705::FeedAttribute;
use Google::Ads::AdWords::v201705::FeedItem;
use Google::Ads::AdWords::v201705::FeedItemAttributeValue;
use Google::Ads::AdWords::v201705::FeedItemGeoRestriction;
use Google::Ads::AdWords::v201705::FeedItemOperation;
use Google::Ads::AdWords::v201705::FeedMapping;
use Google::Ads::AdWords::v201705::FeedMappingOperation;
use Google::Ads::AdWords::v201705::FeedOperation;
...
sub create_site_links_feed {
  ...
  my $text_attribute = Google::Ads::AdWords::v201705::FeedAttribute->new({
    type => "STRING",
    name => "Link Text"
  });
  my $final_url_attribute = Google::Ads::AdWords::v201705::FeedAttribute->new({
    type => "URL_LIST",
    name => "Link Final URLs"
  });
  my $line_2_attribute = Google::Ads::AdWords::v201705::FeedAttribute->new({
    type => "STRING",
    name => "Line 2"
  });
  my $line_3_attribute = Google::Ads::AdWords::v201705::FeedAttribute->new({
    type => "STRING",
    name => "Line 3"
  });
  my $feed = Google::Ads::AdWords::v201705::Feed->new({
      name       => $feed_name,
      attributes => [
  ...
  my $operation = Google::Ads::AdWords::v201705::FeedOperation->new({
    operator => "ADD",
    operand  => $feed
  });
...
sub create_feed_item_add_operation {
  ...
  my $text_attribute_value =
    Google::Ads::AdWords::v201705::FeedItemAttributeValue->new({
  ...
  my $feed_item = Google::Ads::AdWords::v201705::FeedItem->new({
  ...
  if ($location_id) {
    my $location =
      Google::Ads::AdWords::v201705::Location->new({id => $location_id});
  ...
  my $operation = Google::Ads::AdWords::v201705::FeedItemOperation->new({
    operand  => $feed_item,
    operator => "ADD"
  });
...
sub create_site_links_feed_mapping {
  ...
  my $text_field_mapping =
    Google::Ads::AdWords::v201705::AttributeFieldMapping->new({
      feedAttributeId => $site_links_data->{"linkTextFeedAttributeId"},
  ...
  my $feed_mapping = Google::Ads::AdWords::v201705::FeedMapping->new({
  ...
  my $operation = Google::Ads::AdWords::v201705::FeedMappingOperation->new({
...
sub create_site_links_campaign_feed {
  ...
  my $matching_function = Google::Ads::AdWords::v201705::Function->new(
    {functionString => $matching_function_string});

  my $campaign_feed = Google::Ads::AdWords::v201705::CampaignFeed->new({
      feedId           => $site_links_data->{"siteLinksFeedId"},
