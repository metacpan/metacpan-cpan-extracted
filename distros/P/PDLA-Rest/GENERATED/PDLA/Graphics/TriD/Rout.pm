...
#
package PDLA::Graphics::TriD::Rout;

@EXPORT_OK  = qw( PDLA::PP combcoords PDLA::PP repulse PDLA::PP attract PDLA::PP vrmlcoordsvert PDLA::PP contour_segments_internal );
...
use DynaLoader;
   ...
   bootstrap PDLA::Graphics::TriD::Rout ;
...
the PDLA::Graphics::TriD module. Currently, there are
...
objects. For use by the module L<PDLA::Graphics::TriD::MathGraph|PDLA::Graphics::TriD::MathGraph>.
...
For use by the module L<PDLA::Graphics::TriD::MathGraph|PDLA::Graphics::TriD::MathGraph>.
For definition of the potential, see the actual function.
...
*vrmlcoordsvert = \&PDLA::vrmlcoordsvert;
...
use strict;
sub PDLA::Graphics::TriD::Contours::contour_segments {
...
*contour_segments_internal = \&PDLA::contour_segments_internal;
