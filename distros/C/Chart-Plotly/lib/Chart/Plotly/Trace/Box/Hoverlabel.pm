package Chart::Plotly::Trace::Box::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Box::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Box::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Box::Hoverlabel - This attribute is one of the possible options for the trace box.
