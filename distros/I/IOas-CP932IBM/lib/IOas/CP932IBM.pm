...
if ($io_encoding =~ /^(?:cp932ibm|cp932|cp932ibm|cp932nec|sjis2004|cp00930|keis78|keis83|keis90|jef|jef9p|jipsj|jipse|letsj|utf8|utf8\.1)$/) {
    eval q{
...
sub import {
    ...
    if (defined($_[0]) and ($_[0] =~ /\A[0123456789]/)) {
        if ($_[0] != $IOas::CP932IBM::VERSION) {
            ...
            die "$filename requires IOas::CP932IBM $_[0], this is version $IOas::CP932IBM::VERSION, stopped at $filename line $line.\n";
        }
        shift @_;
    }
}
