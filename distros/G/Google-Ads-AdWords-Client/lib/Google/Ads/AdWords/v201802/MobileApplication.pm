package Google::Ads::AdWords::v201802::MobileApplication;
use strict;
use warnings;
...
Google::Ads::AdWords::v201802::MobileApplication

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MobileApplication from the namespace https://adwords.google.com/api/adwords/cm/v201802.

Represents the mobile application to be targeted. <span class="constraint AdxEnabled">This is enabled for AdX.</span> 
