package Google::Ads::AdWords::v201809::Ad;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::Ad

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Ad from the namespace https://adwords.google.com/api/adwords/cm/v201809.

The base class of all ad types. {@code Ad}s are created using the {@code AdGroupAdService}. Some ad types such as {@code ExpandedTextAd}s may be modified using the {@code AdService}. <p>When calling {@code AdGroupAdService} to update the {@code status} of an {@code AdGroupAd}, you can construct an {@code Ad} object (instead of the {@code Ad}'s concrete type) with the {@link #id} field set. <span class="constraint AdxEnabled">This is enabled for AdX.</span> 
