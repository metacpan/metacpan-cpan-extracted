...
1;
# ABSTRACT: Single line border with box-drawing characters
...
BorderStyle::BoxChar::SingleLine - Single line border with box-drawing characters

=head1 VERSION

This document describes version 0.005 of BorderStyle::BoxChar::SingleLine (from Perl distribution BorderStyles-Standard), released on 2021-01-31.
...
To use with L<Text::Table::TinyBorderStyle>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"BorderStyle::BoxChar::SingleLine");
