...
package WebService::Edgecast::auto::Administration::Element::CustomerHttpSmallUpdate;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerHttpSmallUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerHttpSmallUpdate');
...
WebService::Edgecast::auto::Administration::Element::CustomerHttpSmallUpdate
...
CustomerHttpSmallUpdate from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerHttpSmallUpdate->new($data);
