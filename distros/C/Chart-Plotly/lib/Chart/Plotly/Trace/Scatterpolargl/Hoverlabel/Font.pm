package Chart::Plotly::Trace::Scatterpolargl::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Scatterpolargl::Hoverlabel::Font - This attribute is one of the possible options for the trace scatterpolargl.
