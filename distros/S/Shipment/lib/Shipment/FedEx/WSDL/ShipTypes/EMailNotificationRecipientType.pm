package Shipment::FedEx::WSDL::ShipTypes::EMailNotificationRecipientType;
$Shipment::FedEx::WSDL::ShipTypes::EMailNotificationRecipientType::VERSION = '3.02';
use strict;
use warnings;
...
EMailNotificationRecipientType from the namespace http://fedex.com/ws/ship/v9.
