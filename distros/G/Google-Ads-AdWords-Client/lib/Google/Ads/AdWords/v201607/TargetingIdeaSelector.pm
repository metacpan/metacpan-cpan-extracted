package Google::Ads::AdWords::v201607::TargetingIdeaSelector;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'searchParameters' => 'Google::Ads::AdWords::v201607::SearchParameter',
        'ideaType' => 'Google::Ads::AdWords::v201607::IdeaType',
        'requestType' => 'Google::Ads::AdWords::v201607::RequestType',
        'requestedAttributeTypes' => 'Google::Ads::AdWords::v201607::AttributeType',
...
TargetingIdeaSelector from the namespace https://adwords.google.com/api/adwords/o/v201607.
