package Finance::AMEX::Transaction::EPTRN::Detail::RecordSummary 0.005;

use strict;
use warnings;

# ABSTRACT: Parse AMEX Transaction/Invoice Level Reconciliation (EPTRN) Record of Charge (ROC) Detail Rows
...
Finance::AMEX::Transaction::EPTRN::Detail::RecordSummary - Parse AMEX Transaction/Invoice Level Reconciliation (EPTRN) Record of Charge (ROC) Detail Rows
...
=head2 NON_COMPLIANT_ERROR_CODE_1 NON_COMPLIANT_ERROR_CODE_2 NON_COMPLIANT_ERROR_CODE_3 NON_COMPLIANT_ERROR_CODE_4
...
Finance::AMEX::Transaction::EPTRN::Detail::RecordSummary - Object methods for AMEX Transaction/Invoice (ROC) Level detail records.
