...
Sah::SchemaR::pathname::exists - Path name, must exist on filesystem

=head1 VERSION

This document describes version 0.031 of Sah::SchemaR::pathname::exists (from Perl distribution Sah-SchemaBundle-Path), released on 2024-02-16.
