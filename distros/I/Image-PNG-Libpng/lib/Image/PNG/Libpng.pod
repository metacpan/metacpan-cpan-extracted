...
(This example is included as L<F<examples/synopsis.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/synopsis.pl>
in the distribution.)
...
(This example is included as L<F<examples/synopsis-easy.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/synopsis-easy.pl>
in the distribution.)


=head1 VERSION

This document describes Image::PNG::Libpng version 0.58, corresponding to git commit L<01ac5d8d71aaed8c93dd27542274703c084ed54e|https://github.com/benkasminbullock/image-png-libpng/commit/01ac5d8d71aaed8c93dd27542274703c084ed54e> at Mon Jan 29 09:05:33 2024 +0900.

Unless otherwise qualified, comments in this document on the libpng
source code and documentation refer to libpng version 1.6.40. Libpng is not bundled with this distribution, so
...
(This example is included as L<F<examples/copy-png.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/copy-png.pl>
in the distribution.)
...
(This example is included as L<F<examples/set-background.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/set-background.pl>
in the distribution.)




L<examples/luv.png|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/luv.png> is included in the distribution.
...
<tr>
<td>
<img src="https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/luv.png">
</td>
</tr>
<tr>
<th>
<a href='https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/luv.png'>examples/luv.png</a>
</th>
</tr>
</table>
...
L<examples/set-background.png|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/set-background.png> is included in the distribution.
...
<tr>
<td>
<img src="https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/set-background.png">
</td>
</tr>
<tr>
<th>
<a href='https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/set-background.png'>examples/set-background.png</a>
</th>
</tr>
</table>
...
(This example is included as L<F<examples/get-www-png.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/get-www-png.pl>
in the distribution.)
...
(This example is included as L<F<examples/png-cgi.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/png-cgi.pl>
in the distribution.)
...
(This example is included as L<F<examples/libpng-write.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/libpng-write.pl>
in the distribution.)




L<examples/mono.png|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/mono.png> is included in the distribution.
...
<tr>
<td>
<img src="https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/mono.png">
</td>
</tr>
<tr>
<th>
<a href='https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/mono.png'>examples/mono.png</a>
</th>
</tr>
</table>
...
(This example is included as L<F<examples/color-type-name.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/color-type-name.pl>
in the distribution.)
...
(This example is included as L<F<examples/set-text.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/set-text.pl>
in the distribution.)
...
default value of libpng 1.6.40 is 8 megabytes.
...
(This example is included as L<F<examples/xkcd.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/xkcd.pl>
in the distribution.)
...
L<examples/life-gray.png|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/life-gray.png> is included in the distribution.
...
<tr>
<td>
<img src="https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/life-gray.png">
</td>
</tr>
<tr>
<th>
<a href='https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/life-gray.png'>examples/life-gray.png</a>
</th>
</tr>
</table>
...
(This example is included as L<F<examples/q.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/q.pl>
in the distribution.)




L<examples/wave.png|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/wave.png> is included in the distribution.
...
<tr>
<td>
<img src="https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/wave.png">
</td>
</tr>
<tr>
<th>
<a href='https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/wave.png'>examples/wave.png</a>
</th>
</tr>
</table>
...
L<examples/random-wave.png|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/random-wave.png> is included in the distribution.
...
<tr>
<td>
<img src="https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/random-wave.png">
</td>
</tr>
<tr>
<th>
<a href='https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/random-wave.png'>examples/random-wave.png</a>
</th>
</tr>
</table>
...
L<examples/picked-wave.png|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/picked-wave.png> is included in the distribution.
...
<tr>
<td>
<img src="https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/picked-wave.png">
</td>
</tr>
<tr>
<th>
<a href='https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/picked-wave.png'>examples/picked-wave.png</a>
</th>
</tr>
</table>
...
(This example is included as L<F<examples/rgb-to-gray.pl>|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/rgb-to-gray.pl>
in the distribution.)




L<examples/grayface.png|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/grayface.png> is included in the distribution.
...
<tr>
<td>
<img src="https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/grayface.png">
</td>
</tr>
<tr>
<th>
<a href='https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/examples/grayface.png'>examples/grayface.png</a>
</th>
</tr>
</table>
...
you can find each instance L<in the file C<perl-libpng.c> in the top directory of the distribution|https://fastapi.metacpan.org/source/BKB/Image-PNG-Libpng-0.58/perl-libpng.c> in the macro
C<UNUSED_ZERO_ARG>.
...
C<1.2.59>, C<1.4.22>, C<1.5.30>, and C<1.6.40> before
