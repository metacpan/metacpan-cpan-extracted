package Text::DeLoreanIpsumData;
...
my @delorean = (
    ...
    { "Doc" => "Watch this. Not me, the car, the car. My calculations are correct, when this baby hits eighty-eight miles per hour, your gonna see some serious shit. Watch this, watch this. Ha, what did I tell you, eighty-eight miles per hour. The temporal displacement occurred at exactly 1:20 a.m. and zero seconds."},
    ...
    { "Doc" => "The appropriate question is, weren't the hell are they. Einstein has just become the world's first time traveler. I sent him into the future. One minute into the future to be exact. And at exactly 1:21 a.m. we should cat h up with him and the time machine."},
    ...
    { "Son" => "It's already mutated into human form, shoot it."},
    { "Father" => "Take that you mutated son-of-a-bitch. My pine, why you. You space bastard, you killed a pine."},
    { "Marty" => "Alright, alright, okay McFly, get a grip on yourself. It's all a dream. Just a very intense dream. Woh, hey, listen, you gotta help me."},
    ...
    { "Sam" => "Hey wait, wait a minute, who are you? Stella, another one of these damn kids jumped in front of my car. Come on out here, help me take him in the house."},
    ...
    { "Biff" => "So what's it to you, butthead. You know you've been looking for a, since you're new here, I'm gonna cut you a break, today. So why don't you make like a tree, and get out of here."},
    { "Marty" => "George."},
    ...
    { "George" => "I over slept, look I need your help. I have to ask Lorraine out but I don't know how to do it. I have to ask Lorraine out but I don't know how to do it."},
    ...
    { "George" => "Right. Lou, gimme a milk, chocolate. Lorraine, my density has popped me to you."},
    { "Lorraine" => "What?"},
    ...
    { "Marty" => "Its good."},
    { "Doc" => "Oh, thank you, thank you. Okay now, we run some industrial strength electrical cable from the top of the clocktower down to spreading it over the street between two lamp posts. Meanwhile, we out-fitted the vehicle with this big pole and hook which runs directly into the flux-capacitor. At the calculated moment, you start off from down the street driving toward the cable execrating to eighty-eight miles per hour. According to the flyer, at !0:04 pm lightning will strike the clocktower sending one point twenty-one gigawatts into the flux-capacitor, sending you back to 1985. Alright now, watch this. You wind up the car and release it, I'll simulate the lightening. Ready, set, release. Huhh."},
    ...
    { "Marty" => "Uh, I think so."},
    { "Doc" => "What did she say? It's your mom, she's tracked you down. Quick, let's cover the time machine."},
    { "Lorraine" => "Hi, Marty."},
    ...
    { "Lorraine" => "Hi."},
    { "Marty" => "Hello."},
    { "Lorraine" => "Marty, this may seem a little foreward, but I was wondering if you would ask me to the Enchantment Under The Sea Dance on Saturday."},
    ...
    { "Marty" => "Yes, definitely, god-dammit George, swear. Okay, so now, you come up, you punch me in the stomach, I'm out for the count, right? And you and Lorraine live happily ever after."},
    ...
    { "Marvin Berry" => "We're gonna take a little break but we'll be back in a while so, don't nobody go no where."},
    ...
    { "Marty" => "What?"},
    { "Lorraine" => "I don't worry. this is all wrong. I don't know what it is but when I kiss you, it's like kissing my brother. I guess that doesn't make any sense, does it?"},
    ...
    { "Marvin Berry" => "Who are you calling spook, pecker-wood."},
    ...
    { "Marvin Berry" => "Lorenzo, where're you keys?"},
    ...
    { "Marvin Berry" => "Give me a hand, Lorenzo. Ow, dammit, man, I sliced my hand."},
    ...
    { "Marvin Berry" => "Hey man, the dance is over. Unless you know someone else who could play the guitar."},
    ...
    { "Marvin Berry" => "Chuck, Chuck, its' your cousin. Your cousin Marvin Berry, you know that new sound you're lookin for, well listen to this."},
    ...
    { "Marty" => "Right, George. Well, good luck you guys. Oh, one other thing, if you guys ever have kids and one of them when he's eight years old, accidentally sets fire to the living room rug, be easy on him."},
    { "George" => "Okay."},
    ...
    { "Marty" => "Yeah."},
    { "Marty" => "Dammit, Doc, why did you have to tear up that letter? If only I had more time. Wait a minute, I got all the time I want I got a time machine, I'll just go back and warn him. 10 minutes oughta do it. Time-circuits on, flux-capacitor fluxing, engine running, alright. No, no no no no, c'mon c'mon. C'mon c'mon, here we go, this time. Please, please, c'mon."},
    { "Doc" => "Ahh."},
    { "Marty" => "Doc."},
    { "Doc" => "Yoo."},
    { "Red" => "Crazy drunk drivers."},
    { "Marty" => "Wow, ah Red, you look great. Everything looks great. 1:24, I still got time. Oh my god. No, no not again, c'mon, c'mon. Hey. Libyans."},
    { "Marty" => "No, bastards."},
    { "Libyan" => "Go."},
    { "Marty" => "Doc, Doc. Oh, no. You're alive. Bullet proof vest, how did you know, I never got a chance to tell you. About all that talk about screwing up future events, the space time continuum."},
