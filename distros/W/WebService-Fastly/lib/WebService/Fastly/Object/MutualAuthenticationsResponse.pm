...
#
package WebService::Fastly::Object::MutualAuthenticationsResponse;
...
__PACKAGE__->method_documentation({
    ...
    'data' => {
        datatype => 'ARRAY[MutualAuthenticationResponseData]',
        base_name => 'data',
        description => '',
        format => '',
        read_only => 'false',
...
__PACKAGE__->openapi_types( {
    ...
    'data' => 'ARRAY[MutualAuthenticationResponseData]'
} );
