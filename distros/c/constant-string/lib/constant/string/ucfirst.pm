package constant::string::ucfirst;
...
constant::string::ucfirst - Perl pragma to declare constants with the C<ucfirst> (first-letter uppercased) values as names
...
=head1 SYNOPSIS
    ...
    use constant::string::ucfirst qw( foo bar baz );
