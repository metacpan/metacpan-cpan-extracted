...
my $t = new JCM::Net::Patricia;

isa_ok($t, 'JCM::Net::Patricia', 'creating base object');
...
SKIP: {
    skip "No IPv6", 4 if !JCM::Net::Patricia::have_ipv6();
    $t = new JCM::Net::Patricia(AF_INET6);

    isa_ok($t, "JCM::Net::Patricia::AF_INET6", "constructing a Net::Patrica::AF_INET6");
