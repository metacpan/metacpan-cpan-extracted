...
This page describes are Types used by L<Math::Formula|Math::Formula>. All parts of an
...
=item Math::Formula::Type-E<gt>B<new>($token|undef, [$value], %options)
...
=head2 MF::BOOLEAN, a thruth value
