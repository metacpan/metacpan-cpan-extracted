...
1;
# ABSTRACT: Check that string is a valid NOP PBB
...
Data::Sah::Filter::perl::Business::ID::NOPPBB::check_nop_pbb - Check that string is a valid NOP PBB

=head1 VERSION

This document describes version 0.001 of Data::Sah::Filter::perl::Business::ID::NOPPBB::check_nop_pbb (from Perl distribution Sah-Schemas-Business-ID-NOPPBB), released on 2024-01-10.
