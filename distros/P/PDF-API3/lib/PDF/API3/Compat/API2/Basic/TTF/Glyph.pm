...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::TTF::Glyph;

=head1 NAME

PDF::API3::Compat::API2::Basic::TTF::Glyph - Holds a single glyph's information
...
=head1 PDF::API3::Compat::API2::Basic::TTF::Glyph->new(%parms)
...
#        PDF::API3::Compat::API2::Basic::TTF::Utils::XML_hexdump($context, $depth . $context->{'indent'}, $self->{'hints'});
        $dat = PDF::API3::Compat::API2::Basic::TTF::Utils::XML_binhint($self->{'hints'});
        $dat =~ s/\n(?!$)/\n$depth$context->{'indent'}/mg;
        $fh->print("$depth$context->{'indent'}$dat");
        $fh->print("$depth</hints>\n");
    }
    else
    { return PDF::API3::Compat::API2::Basic::TTF::Table::XML_element(@_); }
