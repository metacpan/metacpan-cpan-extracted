...
static int asn_MAP_GANSSPositionMethod_oms_1[] = { 0, 1, 3 };
...
static asn_TYPE_tag2member_t asn_MAP_GANSSPositionMethod_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ganssID at 2283 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* gANSSPositioningMethodTypes at 2286 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* gANSSSignals at 2287 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* sbasID at 2290 */
};
