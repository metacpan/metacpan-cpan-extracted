...
Performs similar tasks as C<use constant>, but adds features to assign values
...
It is important to C<use constant::more> before other modules that also C<use
