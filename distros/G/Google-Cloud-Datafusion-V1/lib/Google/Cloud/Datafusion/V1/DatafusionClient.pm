package Google::Cloud::Datafusion::V1::DatafusionClient;
...
sub list_available_versions {
    ...
    my $request_class = 'Google::Cloud::Datafusion::V1::Datafusion::ListAvailableVersionsRequest';
    my $request = eval { $request_class->new(\%params) } || eval { $request_class->new(%params) } || ($request_class->can('encode') ? $request_class->encode(\%params) : \%params);

    my $response_class = 'Google::Cloud::Datafusion::V1::Datafusion::ListAvailableVersionsResponse';
...
1; # End of Google::Cloud::Datafusion::V1::DatafusionClient

__END__

=head1 NAME

Google::Cloud::Datafusion::V1::DatafusionClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Datafusion::V1::DatafusionClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Datafusion::V1::DatafusionClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Datafusion::V1::DatafusionClient> is an auto-generated client library for Google Cloud Services.
...
=item * C<google/cloud/datafusion/v1/datafusion.proto>
...
=item * B<list_available_versions>

Calls the RPC method C<ListAvailableVersions> on the service. Takes a hash of parameters representing the request.
