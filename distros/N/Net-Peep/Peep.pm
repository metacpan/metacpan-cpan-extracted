...
The Peep client library is composed of the following core modules:
  ...
  Net::Peep::Client::Pinger     Utility class for the pinger client.
...
We do this by instantiating a C<Net::Peep::BC>, the Peep broadcast
object, and calling its C<send> method.
