...
(This example is included as L<F<synopsis.pl>|https://api.metacpan.org/source/BKB/Test-CGI-External-0.22/examples/synopsis.pl> in the distribution.)
...
This documents Test::CGI::External version 0.22
corresponding to git commit L<240033de16aaa936eba002912df13b193e26fea1|https://github.com/benkasminbullock/test-cgi-external/commit/240033de16aaa936eba002912df13b193e26fea1> released on Mon Mar 6 16:51:25 2017 +0900.
...
(This example is included as L<F<rupert.pl>|https://api.metacpan.org/source/BKB/Test-CGI-External-0.22/examples/rupert.pl> in the distribution.)
...
(This example is included as L<F<bad-request.pl>|https://api.metacpan.org/source/BKB/Test-CGI-External-0.22/examples/bad-request.pl> in the distribution.)
...
(This example is included as L<F<never-modified.pl>|https://api.metacpan.org/source/BKB/Test-CGI-External-0.22/examples/never-modified.pl> in the distribution.)
...
(This example is included as L<F<png-test.pl>|https://api.metacpan.org/source/BKB/Test-CGI-External-0.22/examples/png-test.pl> in the distribution.)
...
(This example is included as L<F<length.pl>|https://api.metacpan.org/source/BKB/Test-CGI-External-0.22/examples/length.pl> in the distribution.)
