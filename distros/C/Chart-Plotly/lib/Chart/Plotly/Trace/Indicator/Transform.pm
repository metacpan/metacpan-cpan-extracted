package Chart::Plotly::Trace::Indicator::Transform;
use Moose;
...
Chart::Plotly::Trace::Indicator::Transform - This attribute is one of the possible options for the trace indicator.
