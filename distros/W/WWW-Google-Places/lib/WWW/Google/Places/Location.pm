...
$WWW::Google::Places::Location::VERSION   = '0.33';
$WWW::Google::Places::Location::AUTHORITY = 'cpan:MANWAR';

=head1 NAME

WWW::Google::Places::Location - Placeholder for lat/lng.
...
has 'lat' => (is => 'ro', default => sub { 'N/A' });
has 'lng' => (is => 'ro', default => sub { 'N/A' });
...
sub as_string {
    ...
    return sprintf("Latitude: %s, Longitude: %s", $self->lat, $self->lng);
}
