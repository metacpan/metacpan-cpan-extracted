#
# $Id: A.pm 49 2009-05-31 13:15:34Z VinsWorldcom $
#
package Net::Frame::Layer::DNS::RR::A;
...
sub unpack {
   ...
   $self->address(inetNtoa(substr $self->raw, 0, 4));

   $self->payload(substr $self->raw, 4);
...
Net::Frame::Layer::DNS::RR::A - DNS Resource Record A rdata type
...
Record A rdata type object.  Users need only use this for encoding.
