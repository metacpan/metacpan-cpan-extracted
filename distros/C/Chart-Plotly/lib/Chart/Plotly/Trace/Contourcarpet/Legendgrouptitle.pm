package Chart::Plotly::Trace::Contourcarpet::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Contourcarpet::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Contourcarpet::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Contourcarpet::Legendgrouptitle - This attribute is one of the possible options for the trace contourcarpet.
