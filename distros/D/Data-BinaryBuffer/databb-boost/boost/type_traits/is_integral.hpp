...
template<> struct is_integral< ::databb_boost::ulong_long_type> : public true_type{};
template<> struct is_integral< ::databb_boost::long_long_type> : public true_type{};
...
template<> struct is_integral<databb_boost::int128_type> : public true_type{};
template<> struct is_integral<databb_boost::uint128_type> : public true_type{};
#endif
