...
(This example is included as L<F<synopsis.pl>|https://fastapi.metacpan.org/source/BKB/Image-SVG-Path-0.31/examples/synopsis.pl> in the distribution.)

=head1 VERSION

This documents version 0.31 of Image::SVG::Path corresponding to git
commit e7a4db2cb10fae2fde7d358a92d09280f393dd48 released on Sun Oct 8 14:35:36 2017 +0900.
...
(This example is included as L<F<xml-parser.pl>|https://fastapi.metacpan.org/source/BKB/Image-SVG-Path-0.31/examples/xml-parser.pl> in the distribution.)
...
(This example is included as L<F<extract-path-info.pl>|https://fastapi.metacpan.org/source/BKB/Image-SVG-Path-0.31/examples/extract-path-info.pl> in the distribution.)
...
(This example is included as L<F<test-reverse.pl>|https://fastapi.metacpan.org/source/BKB/Image-SVG-Path-0.31/examples/test-reverse.pl> in the distribution.)
