...
INSERT INTO articles SET articleid=1,folderid=1,title="Pete",userid=1,createdate=1383350400,sectionid=5,quickname='pete',snippet='Guitars, Mandolin and Vocals',imageid=0,publish=3;
INSERT INTO paragraphs SET paraid=1,articleid=1,orderno=1,type=2,imageid=0,body='Born in the Red House, as The Wind Cries Mary';
