...
1;
# ABSTRACT: A single latin uppercase letter, i.e. A-Z
...
Sah::Schema::latin_uppercase_letter - A single latin uppercase letter, i.e. A-Z
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("latin_uppercase_letter*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("latin_uppercase_letter", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("latin_uppercase_letter", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("latin_uppercase_letter*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"latin_uppercase_letter*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('latin_uppercase_letter*', name=>'LatinUppercaseLetter')
     );
 }

 use My::Types qw(LatinUppercaseLetter);
 LatinUppercaseLetter->assert_valid($data);
