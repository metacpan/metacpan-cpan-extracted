...
$Config::Model::Exception::VERSION = '2.126';
use warnings;
use strict;
use Data::Dumper;
use Mouse;
...
$Config::Model::Exception::Any::VERSION = '2.126';
use Mouse;
extends 'Config::Model::Exception';

package Config::Model::Exception::ModelDeclaration;
$Config::Model::Exception::ModelDeclaration::VERSION = '2.126';
use Mouse;
...
$Config::Model::Exception::User::VERSION = '2.126';
use Mouse;
...
$Config::Model::Exception::Syntax::VERSION = '2.126';
use Mouse;
extends 'Config::Model::Exception::Any';
...
$Config::Model::Exception::LoadData::VERSION = '2.126';
use Mouse;
...
$Config::Model::Exception::Model::VERSION = '2.126';
use Mouse;
extends 'Config::Model::Exception::Fatal';
...
$Config::Model::Exception::Load::VERSION = '2.126';
use Mouse;
extends 'Config::Model::Exception::User';
...
$Config::Model::Exception::UnavailableElement::VERSION = '2.126';
use Mouse;
extends 'Config::Model::Exception::User';
...
$Config::Model::Exception::AncestorClass::VERSION = '2.126';
use Mouse;
extends 'Config::Model::Exception::User';
...
$Config::Model::Exception::ObsoleteElement::VERSION = '2.126';
use Mouse;
extends 'Config::Model::Exception::User';
...
$Config::Model::Exception::UnknownElement::VERSION = '2.126';
use Carp;
...
$Config::Model::Exception::WarpError::VERSION = '2.126';
use Mouse;
extends 'Config::Model::Exception::User';
...
$Config::Model::Exception::Fatal::VERSION = '2.126';
use Mouse;
extends 'Config::Model::Exception::Any';
...
$Config::Model::Exception::UnknownId::VERSION = '2.126';
use Mouse;
extends 'Config::Model::Exception::User';
...
$Config::Model::Exception::WrongValue::VERSION = '2.126';
use Mouse;
extends 'Config::Model::Exception::User';
...
$Config::Model::Exception::WrongType::VERSION = '2.126';
use Mouse;
extends 'Config::Model::Exception::User';
...
$Config::Model::Exception::ConfigFile::VERSION = '2.126';
use Mouse;
extends 'Config::Model::Exception::User';
...
$Config::Model::Exception::ConfigFile::Missing::VERSION = '2.126';
use Mouse;
...
$Config::Model::Exception::Formula::VERSION = '2.126';
use Mouse;
...
$Config::Model::Exception::Internal::VERSION = '2.126';
use Mouse;
extends 'Config::Model::Exception::Fatal';
