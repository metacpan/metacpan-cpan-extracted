...
$Finance::AMEX::Transaction::EPPRC::Detail::Other::VERSION = '0.003';
use strict;
use warnings;
...
Finance::AMEX::Transaction::EPPRC::Detail::Other - Object methods for AMEX Reconciliation file chargback detail records.
