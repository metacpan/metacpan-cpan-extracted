package Chart::Plotly::Trace::Parcats::Domain;
use Moose;
...
has column => (
      is            => "rw",
      isa           => "Int",
      documentation => "If there is a layout grid, use the domain for this column in the grid for this parcats trace .",
);

has row => (
         is            => "rw",
         isa           => "Int",
         documentation => "If there is a layout grid, use the domain for this row in the grid for this parcats trace .",
);

has x => ( is            => "rw",
           isa           => "ArrayRef|PDL",
           documentation => "Sets the horizontal domain of this parcats trace (in plot fraction).",
);

has y => ( is            => "rw",
           isa           => "ArrayRef|PDL",
           documentation => "Sets the vertical domain of this parcats trace (in plot fraction).",
);
...
Chart::Plotly::Trace::Parcats::Domain - This attribute is one of the possible options for the trace parcats.
