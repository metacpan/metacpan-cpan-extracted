...
$DBI::Format::VERSION = $DBI::Format::VERSION = substr(q$Revision: 1.1 $, 10)+0;
...
Row is written without formating.  Columns returned in comma | user defined
separated list.
