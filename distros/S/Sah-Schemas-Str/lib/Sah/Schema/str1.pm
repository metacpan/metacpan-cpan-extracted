...
1;
# ABSTRACT: A non-empty string (length >= 1)
...
Sah::Schema::str1 - A non-empty string (length >= 1)
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("str1", {return_type=>'str_errmsg'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("str1*");
     $validator->(\@args);
     ...
 }
