...
#	my($server)=Meta::Comm::Frontier::Server->new();
...
#	my($res)=$client->call("test");
#	Meta::Utils::Output::print("result is [".$res."]\n");
#	#my($res)=$client->call("quit");
#}
my($scod)=1;
...
frontier.pl - test client/server communication.
...
Meta::Baseline::Test(3), Meta::Comm::Frontier::Client(3), Meta::Comm::Frontier::Server(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), strict(3)
