package Net::RRP::Response::n504;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n504::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n504::VERSION = '0.1';
...
Net::RRP::Response::n504 - the 504 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
