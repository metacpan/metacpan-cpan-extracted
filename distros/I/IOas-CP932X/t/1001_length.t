...
@test = (
# 1
    sub { $_='';           IOas::CP932X::length($_) == 0  },
    sub { $_='1';          IOas::CP932X::length($_) == 1  },
    sub { $_='12';         IOas::CP932X::length($_) == 2  },
    sub { $_='123';        IOas::CP932X::length($_) == 3  },
...
# 11
    ...
    sub { $_='1';          IOas::CP932X::length() == 1    },
    sub { $_='12';         IOas::CP932X::length() == 2    },
    sub { $_='123';        IOas::CP932X::length() == 3    },
