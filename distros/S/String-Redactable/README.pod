...
=head1 The String::Redactable module

This is the I<README> for the L<String::Redactable> Perl module.
...
and install the dependencies:
	...
	% cpan String::Redactable
	% cpanm String::Redactable
...
the source repository: L<https://github.com/briandfoy/string-redactable>

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/briandfoy/string-redactable/issues>.
...
=item * L<https://bitbucket.com/briandfoy/string-redactable>

=item * L<https://codeberg.org/briandfoy/string-redactable>

=item * L<https://gitlab.com/briandfoy/string-redactable>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify String::Redactable-1.23.tar.gz --owner briandfoy
