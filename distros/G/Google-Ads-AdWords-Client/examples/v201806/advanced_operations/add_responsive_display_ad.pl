...
use Google::Ads::AdWords::v201806::DisplayAdFormatSetting;
use Google::Ads::AdWords::v201806::DynamicSettings;
use Google::Ads::AdWords::v201806::ResponsiveDisplayAd;
...
sub add_responsive_display_ad {
  ...
  my $responsive_display_ad =
    Google::Ads::AdWords::v201806::ResponsiveDisplayAd->new({
  ...
  my $square_marketing_image = Google::Ads::AdWords::v201806::Image->new(
...
sub _create_dynamic_display_ad_settings {
  ...
  my $dynamic_settings = Google::Ads::AdWords::v201806::DynamicSettings->new({
