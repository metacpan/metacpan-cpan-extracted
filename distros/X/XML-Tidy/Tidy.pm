# 4C3HOH1:   XML::Tidy.pm by Pip Stuart <Pip@CPAN.Org> to tidy XML documents as parsed XML::XPath objects;
package      XML::Tidy;
...
our $VERSION     = '1.16';our $d8VS='G6LM4EST';
@EXPORT = qw(
    UNKNOWN_NODE
    ELEMENT_NODE
    ATTRIBUTE_NODE
...
This documentation refers to version 1.16 of XML::Tidy, which was released on
Tue Jun 21 04:14:28:29 -0500 2016.
...
=item - maybe add to bcompress support for binary char, wide UTF-8, short ints, and single or quad-precision floats

=item - maybe store in compress recurring patterns of node index sets in a new array that can be indexed itself

=item - fix reload() from messing up Unicode escaped &XYZ; components like Copyright &#xA9; and Registered &#xAE;
...
Hopefully the vast majority of files will work fine and support for
...
* fixed 00pod.t and 01podc.t to eval the Test modules from issue and patch: HTTPS://RT.CPAN.Org/Public/Bug/Display.html?id=85592 (Thanks again MichielB.)

* replaced all old '&&' with 'and' in POD

=item - 1.14 G6JMERCY  Sun Jun 19 14:27:12:34 -0500 2016

* separated old PT from VERSION to fix non-numeric issue: HTTPS://RT.CPAN.Org/Public/Bug/Display.html?id=56073 (Thanks to Slaven.)

* removed Unicode from POD but added encoding utf8 anyway to pass tests and resolve issues: HTTPS://RT.CPAN.Org/Public/Bug/Display.html?id=92434 and HTTPS://RT.CPAN.Org/Public/Bug/Display.html?id=85592 (Thanks to Sudhanshu and MichielB.)
...
Copyleft :  This software is licensed under the GNU General Public License
  ...
  extent permitted by law. See HTTP://FSF.Org for further information.
