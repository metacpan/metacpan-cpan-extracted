package Biblio::ILL::ISO::Expired;

=head1 NAME

Biblio::ILL::ISO::Expired - Perl extension for handling ISO 10161 interlibrary loan Expired messages
...
Biblio::ILL::ISO::Expired is a derivation of the abstract 
Biblio::ILL::ISO::ISO object, and handles the Expired message type.
...
Expired message from a file (followed by a call to
...
To read a message from a file, use the following:
    ...
    my $href = $msg->read("msg_20.expired.ber");
