...
return [
  {
    ...
    'description' => {
      'Alias' => 'A space-separated list of additional names this unit shall be installed under. The names listed
...
aliasing.',
      'Also' => 'Additional units to install/deinstall when
...
given.',
      'DefaultInstance' => 'In template unit files, this specifies for
...
must be usable as instance identifier.',
      'RequiredBy' => 'This option may be used more than once, or a space-separated list of unit names may
