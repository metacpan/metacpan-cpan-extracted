...
# [Jacode4e සහ Jacode4e::RoundTrip අතර වෙනස]
#
#   Jacode4e              : වේගවත් එකදිශා පරිවර්තනය. සමහර අක්ෂර සඳහා
#                           හානිකර (උදා. CP932 හි 398 ආපසු හැරවිය නොහැකි
#                           mapping ඇත).
#   Jacode4e::RoundTrip   : Unicode ධ්‍රැවය හරහා ද්විදිශා විශ්වාසනීයත්වය
#                           සහතික කරයි. A->B->A සෑමවිටම සමාන. Jacode4e ට
#                           වඩා මන්දගාමී. දත්ත ද්විදිශා ගමන් කළ යුතු විට භාවිත.
#
#   ද්විදිශානල පරිවර්තනය අවශ්‍ය නොවේ නම් Jacode4e module භාවිත කරන්න.
#
# ======================================================================
