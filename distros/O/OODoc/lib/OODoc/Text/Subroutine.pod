...
=item $obj-E<gt>B<collectedOptions>(%options)
...
=item Warning: no default for option $name defined in $file line $linenr

Cast by C<collectedOptions()>

=item Warning: no option $name for default in $file line $linenr
