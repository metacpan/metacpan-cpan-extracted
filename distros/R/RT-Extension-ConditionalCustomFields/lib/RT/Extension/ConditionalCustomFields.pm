...
This plugin provides the ability to display/edit a L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> – called the "conditioned by L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html>" throughout this documentation – conditioned by the value of another L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> – the "condition L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html>" – for the same object, which can be anything that can have custom fields (L<ticket|https://docs.bestpractical.com/rt/5.0.4/RT/Ticket.html>, L<queue|https://docs.bestpractical.com/rt/5.0.4/RT/Queue.html>, L<user|https://docs.bestpractical.com/rt/5.0.4/RT/User.html>, L<group|https://docs.bestpractical.com/rt/5.0.4/RT/Group.html>, L<article|https://docs.bestpractical.com/rt/5.0.4/RT/Article.html> or L<asset|https://docs.bestpractical.com/rt/5.0.4/RT/Asset.html>).

The condition can be setup on the Admin page for editing the conditioned by L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html>. From version 0.99, any L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> can be chosen as the condition L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> (whereas for earlier version, only C<Select> L<custom fields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> were eligible), and you can specify which operator is to be applied against which value(s) for the condition to be met.
...
The condition is met if and only if the current value of the L<instanciated conditioned by custom field|https://docs.bestpractical.com/rt/5.0.4/RT/ObjectCustomField.html> is included in the value setup for this condition, typically if the current value is a substring of the condition value. As said above, selectable L<custom fields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> – with C<Select>, C<Combobox> or C<Autocomplete> type are not eligible for this operator. Also, C<Date> and C<DateTime> L<custom fields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> are not eligible for this operator.

=item * C<doesn't match>

The condition is met if and only if the current value of the L<instanciated conditioned by custom field|https://docs.bestpractical.com/rt/5.0.4/RT/ObjectCustomField.html> isn't included in the value setup for this condition, typically if the current value isn't a substring of the condition value. As said above, selectable L<custom fields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> – with C<Select>, C<Combobox> or C<Autocomplete> type are not eligible for this operator. Also, C<Date> and C<DateTime> L<custom fields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> are not eligible for this operator.

=item * C<less than>

The condition is met if and only if the current value of the L<instanciated conditioned by custom field|https://docs.bestpractical.com/rt/5.0.4/RT/ObjectCustomField.html> is less than or equal to the value setup for this condition. The comparison is achieved according to some kind of L<natural sort order|https://en.wikipedia.org/wiki/Natural_sort_order>, that is: number values are compared as numbers, strings are compared alphabetically, insensitive to case and accents (C<a = á>, C<a = A>). Moreover, IP Adresses (IPv4 and IPv6) are expanded to be compared as expected. As said above, selectable L<custom fields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> – with C<Select>, C<Combobox> or C<Autocomplete> type are not eligible for this operator.

=item * C<greater than>

The condition is met if and only if the current value of the L<instanciated conditioned by custom field|https://docs.bestpractical.com/rt/5.0.4/RT/ObjectCustomField.html> is greater than or equal to the value setup for this condition. The comparison is achieved according to some kind of L<natural sort order|https://en.wikipedia.org/wiki/Natural_sort_order>, that is: number values are compared as numbers, strings are compared alphabetically, insensitive to case and accents (C<a = á>, C<a = A>), and dates with or without times are compared chronogically. Moreover, IP Adresses (IPv4 and IPv6) are expanded to be compared as expected. As said above, selectable L<custom fields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> – with C<Select>, C<Combobox> or C<Autocomplete> type are not eligible for this operator.
...
From version 0.07, the condition can be multivalued, that is: the conditioned L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> can be displayed/edited if the condition L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> has one of these values (In other words: there is an C<OR> bewteen the values of the condition). The condition L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> can be a select custom field with values defined by L<CustomFieldValues|https://docs.bestpractical.com/rt/5.0.4/RT/CustomFieldValues.html> or an L<external custom field|https://docs.bestpractical.com/rt/5.0.4/extending/external_custom_fields.html>.
...
Set the C<ConditionedBy> property for this L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> object to L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> C<CF> with operator set to C<OP> and value set to C<VALUE>. C<CF> should be an existing L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> object or the id of an existing L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> object, or the name of an unambiguous existing L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> object. C<OP> should be C<is>, C<isn't>, C<match>, C<doesn't match>, C<less than>, C<greater than> or C<between>. C<VALUE> should be a string or an anonymous array of strings (for selectable L<custom fields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> or C<between> operator). Current user should have C<SeeCustomField> and C<ModifyCustomField> rights for this conditioned by L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> and C<SeeCustomField> right for the condition L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html>. Returns (1, 'Status message') on success and (0, 'Error Message') on failure.
...
Returns the current C<ConditionedBy> property for this conditioned by L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> object as a hash with keys C<CF> containing the id of the condition L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html>, C<op> and C<vals> containing the condition operator as string, and the condition value as an array of strings (so we can store several values for selectable L<custom fields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> or C<between> operator, but generally the C<vals> array includes only one string). If neither this conditioned by L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> nor one of its ancestor is conditioned by the C<CF> condition L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html>, that is: if their C<ConditionedBy> property is not (recursively) defined, returns C<undef>. Current user should have C<SeeCustomField> right for both this conditioned by L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> and the condition L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> which this L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> is conditioned recursively by. I<"Recursively"> means that this method will search for a C<ConditionedBy> property for this L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> object, then for the L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> this one is C<BasedOn>, and so on until it finds an ancestor C<Category> with a C<ConditionedBy> property or, the L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> which is being looked up, is not based on any ancestor C<Category>.
...
Also, C<ConditionalCustomFields> allows to set the C<ConditionedBy> property when creating L<CustomFields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomFields.html> from an F<initialdata> file, with one of the following syntaxes:
...
This examples creates a C<Select> condition L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html>, named C<Condition> and three conditioned by L<CustomFields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html>. L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> C<Condition> should have the value C<Passed>, for L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> C<Conditioned with cf name and value> to be displayed or edited. L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> C<Condition> should not have the value C<Failed> for L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> C<Conditioned with cf id and value> to be displayed or edited. L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> C<Condition> should have one of the values C<Passed> or C<Schrödingerized> for L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> C<Conditioned with multiple values> to be displayed or edited.
...
The condition L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> that this new L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> should conditioned by. It can be either the C<id> or the C<Name> of a previously created L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html>. This implies that the condition L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> should be declared before this one in the F<initialdata> file, or it should already exist. When C<ConditionedByCF> attribute is set, C<ConditionedBy> field should always also be set.

=item C<ConditonedBy>

The value as a C<string> of the condition L<CustomField|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> defined by the C<ConditionedByCF> field (which is mandatory).
...
C<ConditionalCustomFields> comes with a fairly complete test suite. As for every L<RT extention|https://docs.bestpractical.com/rt/5.0.4/writing_extensions.html#Tests>, to run it, you will need a installed C<RT>, set up in L<development mode|https://docs.bestpractical.com/rt/5.0.4/hacking.html#Test-suite>. But, since C<ConditionalCustomFields> operates dynamically to show or hide L<custom fields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html>, most of its magic happens in C<Javascript>. Therefore, the test suite requires a scriptable headless browser with C<Javascript> capabilities. So you also need to install L<PhantomJS|http://phantomjs.org/>, along with L<WWW::Mechanize::PhantomJS> and L<Selenium::Remote::Driver>.

It should be noted that with version 0.99, the number of cases to test has exponentially expanded. Not only any object which can have custom fields (L<ticket|https://docs.bestpractical.com/rt/5.0.4/RT/Ticket.html>, L<queue|https://docs.bestpractical.com/rt/5.0.4/RT/Queue.html>, L<user|https://docs.bestpractical.com/rt/5.0.4/RT/User.html>, L<group|https://docs.bestpractical.com/rt/5.0.4/RT/Group.html>, L<article|https://docs.bestpractical.com/rt/5.0.4/RT/Article.html> or L<asset|https://docs.bestpractical.com/rt/5.0.4/RT/Asset.html>) should be tested. But also, any type of L<custom fields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> (C<Select>, C<Freeform>, C<Text>, C<Wikitext>, C<Image>, C<Binary>, C<Combobox>, C<Autocomplete>, C<Date>, C<DateTime> and C<IPAddress>) should be tested both for condition L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> and conditioned by L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html>. And this both for C<Single> and C<Multiple> versions (when available) of each type of L<custom fields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html>. C<Select> L<custom fields|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> should also be tested for each render type (C<Select box>, C<List>, C<Dropdown> and also C<Chosen> when the number of values is greater than ten). Adding to these required unitary tests, some special cases should also be included, for instance when a condition L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> is in turn conditioned by another condition L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html>, or when a condition L<custom field|https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html> is not applied to a L<queue|https://docs.bestpractical.com/rt/5.0.4/RT/Queue.html>, etc. Eventually, the test suite includes 1929 unitary tests and 64 test files. Nevertheless some special cases may have been left over, so you're encourage to fill a bug report, so they can be fixed.
