...
use Google::Ads::AdWords::v201806::BatchJob;
use Google::Ads::AdWords::v201806::BatchJobOperation;
...
use Google::Ads::AdWords::v201806::NegativeCampaignCriterion;
...
sub add_complete_campaign_using_batch_job {
  ...
  my $operation = Google::Ads::AdWords::v201806::BatchJobOperation->new({
      operator => 'ADD',
      operand  => Google::Ads::AdWords::v201806::BatchJob->new({})});
...
sub _create_campaign_criterion_operations() {
  ...
  for my $campaign_operation (@campaign_operations) {
    # Create keyword.
    my $keyword = Google::Ads::AdWords::v201806::Keyword->new(
      {matchType => "BROAD", text => "venus"});

    my $negative_criterion =
      Google::Ads::AdWords::v201806::NegativeCampaignCriterion->new({
...
sub _create_ad_group_ad_operations() {
  ...
  for my $ad_group_operation (@ad_group_operations) {
    ...
    my $text_ad = Google::Ads::AdWords::v201806::ExpandedTextAd->new({
    ...
    my $text_ad_group_ad = Google::Ads::AdWords::v201806::AdGroupAd->new({
