package Chart::Plotly::Trace::Scattergl::Selected;
use Moose;
...
Chart::Plotly::Trace::Scattergl::Selected - This attribute is one of the possible options for the trace scattergl.
