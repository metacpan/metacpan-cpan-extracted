...
is(conv("* one\n** two\n.. three\n"), "* one\n  * two\n  1. three", 'nested mixed list handling');

is(conv("* [x] done\n* [ ] todo\n"), "* [x] done\n* [ ] todo", 'checklist preservation as markdown task list');

is(conv("Term:: Description\n"), "* **Term**\n  Description", 'description list rendered as emphasized term plus detail');

is(conv("[qanda]\nWhat is this?:: A thing\nHow many?:: Two\n"),
   "1. _What is this?_\n  A thing\n1. _How many?_\n  Two",
   'qanda list behavior');

is(conv("* item\n+\nattached paragraph\n"), "* item\n  attached paragraph", 'list continuation attaches following paragraph');
