package Chart::Plotly::Trace::Contour::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Contour::Legendgrouptitle::Font - This attribute is one of the possible options for the trace contour.
