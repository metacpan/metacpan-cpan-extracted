...
package Shipment::Purolator::WSDLV2::Elements::CreateShipmentRequest;
$Shipment::Purolator::WSDLV2::Elements::CreateShipmentRequest::VERSION = '3.04';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    __PACKAGE__->__set_name('CreateShipmentRequest');
...
CreateShipmentRequest from the namespace http://purolator.com/pws/datatypes/v2.
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDLV2::Elements::CreateShipmentRequest->new($data);
