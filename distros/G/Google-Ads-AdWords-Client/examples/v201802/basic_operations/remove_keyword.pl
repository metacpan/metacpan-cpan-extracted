...
use Google::Ads::AdWords::v201802::AdGroupCriterion;
...
sub remove_keyword {
  ...
  my $criterion =
    Google::Ads::AdWords::v201802::Criterion->new({id => $keyword_id});

  # Create ad group criterion.
  my $ad_group_criterion = Google::Ads::AdWords::v201802::AdGroupCriterion->new(
    {
