...
https://metacpan.org/release/Dist-Zilla-Plugin-Conflicts

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Dist::Zilla::Plugin::Conflicts
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Dist::Zilla::Plugin::Conflicts
...
The code for this distribution is [hosted at GitHub](https://github.com/moose/Dist-Zilla-Plugin-Conflicts).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Dist-Zilla-Plugin-Conflicts)
or [via email](bug-dist-zilla-plugin-conflicts@rt.cpan.org.
