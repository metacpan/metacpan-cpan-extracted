...
my $color  = Hebrew::substr $s, 4, 5;   # black
my $middle = Hebrew::substr $s, 4, -11; # black cat climbed the
my $end    = Hebrew::substr $s, 14;     # climebed the green tree
my $tail   = Hebrew::substr $s, -4;     # tree
my $z      = Hebrew::substr $s, -4, 2;  # tr
