...
# 1
    ...
    sub { $_='あABう123あABう123あABう123'; my $r=mb::index_byte($_,'Bう1');   $r == 4  },
    sub { $_='あABう123あABう123あABう123'; my $r=mb::index_byte($_,'Bう1',8); $r == 15 },
...
# 11
    ...
    sub { $_='あABう123あABう123あABう123'; my $r=mb::index_byte($_,'か3Z');   $r == -1 },
    sub { $_='あABう123あABう123あABう123'; my $r=mb::index_byte($_,'か3Z',8); $r == -1 },
    #         0 345 8901 456 9012 567 012
    #         1   6    2   7    3   8    
    #         2   7    3   8    4   9    
    sub {1},
