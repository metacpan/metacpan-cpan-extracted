...
Provided with a value and this returns true if it is found in the array, or false otherwise.
...
Provided with a string, or expression just as documented in L<perlfunc/"join"> and this will return a string.
...
Returns the size of the array starting from 1, and 0 if the array is empty.
