...
ok_objcache($obj0,$oid0,'object','Persistent','== fetched 1st object',
	    __FILE__,__LINE__);
...
ok_objcache($obj,$oid,'object','Persistent','== with self fetched object',__FILE__,__LINE__);
...
ok_objcache($obj,$oid,'object','Persistent','!= of Oid with self fetched object',
	    __FILE__,__LINE__);
