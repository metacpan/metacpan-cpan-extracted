...
$PMLTQ::PML2BASE::Relation::Treex::AEParentCIterator::VERSION = '3.0.1';
...
PMLTQ::PML2BASE::Relation::Treex::AEParentCIterator - Different implementation of effective parent relation iterator on a-nodes for Treex treebanks
