...
my $meta = {
    ...
    args => {
        ...
        int1       => {schema=>'int', cmdline_aliases=>{set_zero=>{summary=>'Whether to set int1 to zero', schema=>'bool', code=>sub{}}}},
        bool1      => {schema=>'bool'},
...
my $expected_res = [
    ...
    },
    {
        'func.specmeta' => {
            ...
            'set-zero' => {is_alias=>1, alias=>'set_zero', alias_for=>'int1=s', is_code=>1, arg=>'int1', fqarg=>'int1', parsed=>'PARSED', summary=>'Whether to set int1 to zero'},
