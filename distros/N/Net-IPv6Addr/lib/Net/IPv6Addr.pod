...
This documents version 0.96 of Net::IPv6Addr corresponding to
L<git commit 64f42c10634b707ccd482644a0fae855d488d5d6|https://github.com/benkasminbullock/net-ipv6addr/commit/64f42c10634b707ccd482644a0fae855d488d5d6> released on Sat Oct 6 15:05:27 2018 +0900.
...
(This example is included as L<F<synopsis.pl>|https://fastapi.metacpan.org/source/BKB/Net-IPv6Addr-0.96/examples/synopsis.pl> in the distribution.)


=head1 DESCRIPTION

C<Net::IPv6Addr> can check whether strings contain valid IPv6
addresses, and convert them into various formats.
...
All of the following except L</new> serve as both object methods and
...
(This example is included as L<F<preferred.pl>|https://fastapi.metacpan.org/source/BKB/Net-IPv6Addr-0.96/examples/preferred.pl> in the distribution.)
...
(This example is included as L<F<compressed.pl>|https://fastapi.metacpan.org/source/BKB/Net-IPv6Addr-0.96/examples/compressed.pl> in the distribution.)
...
L<F<t/rfc5952.t>|https://fastapi.metacpan.org/source/BKB/Net-IPv6Addr-0.96/t/rfc5952.t> for tests.)
...
(This example is included as L<F<to-string-ipv4.pl>|https://fastapi.metacpan.org/source/BKB/Net-IPv6Addr-0.96/examples/to-string-ipv4.pl> in the distribution.)
...
(This example is included as L<F<to-string-ipv4-comp.pl>|https://fastapi.metacpan.org/source/BKB/Net-IPv6Addr-0.96/examples/to-string-ipv4-comp.pl> in the distribution.)
...
(This example is included as L<F<bigint.pl>|https://fastapi.metacpan.org/source/BKB/Net-IPv6Addr-0.96/examples/bigint.pl> in the distribution.)
...
(This example is included as L<F<array.pl>|https://fastapi.metacpan.org/source/BKB/Net-IPv6Addr-0.96/examples/array.pl> in the distribution.)
...
(This example is included as L<F<string-ip6-int.pl>|https://fastapi.metacpan.org/source/BKB/Net-IPv6Addr-0.96/examples/string-ip6-int.pl> in the distribution.)
...
(This example is included as L<F<inos.pl>|https://fastapi.metacpan.org/source/BKB/Net-IPv6Addr-0.96/examples/inos.pl> in the distribution.)
...
(This example is included as L<F<inet.pl>|https://fastapi.metacpan.org/source/BKB/Net-IPv6Addr-0.96/examples/inet.pl> in the distribution.)
...
(This example is included as L<F<from-bigint.pl>|https://fastapi.metacpan.org/source/BKB/Net-IPv6Addr-0.96/examples/from-bigint.pl> in the distribution.)
...
As of version 0.96, L</from_bigint>, L</in_network>, L</in_network_of_size>, L</ipv6_chkip>, L</ipv6_parse>, L</is_ipv6>, L</to_array>, L</to_bigint>, L</to_intarray>, L</to_string_base85>, L</to_string_compressed>, L</to_string_ip6_int>, L</to_string_ipv4>, L</to_string_ipv4_compressed>, L</to_string_preferred> may
...
This is used to parse L</RFC1924> (April Fool's) addresses.

=item L<Math::BigInt>

This is used by the L</RFC1924> (April Fool's) address routines and by
L</to_bigint> and L</from_bigint>.
...
L<F<t/Regexp-IPv6.t>|https://fastapi.metacpan.org/source/BKB/Net-IPv6Addr-0.96/t/Regexp-IPv6.t>) Unlike C<Net::IPv6Addr>,
