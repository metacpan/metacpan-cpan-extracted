# Security Policy for the Crypt::NaCl::Tweet distribution.
...
This is the Security Policy for Crypt::NaCl::Tweet.
...
Security vulnerabilities can be reported to the current Crypt::NaCl::Tweet
...
Any security vulnerabilities in Crypt::NaCl::Tweet are covered by this policy.

Security vulnerabilities in versions of any libraries that are
included in Crypt::NaCl::Tweet are also covered by this policy.
...
unless they affect Crypt::NaCl::Tweet or Crypt::NaCl::Tweet can
be used to exploit vulnerabilities in them.

Security vulnerabilities in downstream software (any software that
uses Crypt::NaCl::Tweet or plugins to it that are not included with the
Crypt::NaCl::Tweet distribution) are not covered by this policy.

## Supported Versions of Crypt::NaCl::Tweet

The maintainer(s) will only commit to releasing security fixes for
the latest version of Crypt::NaCl::Tweet.

Note that the Crypt::NaCl::Tweet project only supports major versions of Perl
released in the past 10 years, even though Crypt::NaCl::Tweet will run on
...
prerequisites that are required for Crypt::NaCl::Tweet to work.  However, some
