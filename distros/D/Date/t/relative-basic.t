...
$rel = new Date::Rel($rel);
is($rel, "1Y 2M 3D 4h 5m 6s");

$rel = new Date::Rel {year => 6, month => 5, day => 4, hour => 3, min => 2, sec => 1};
is($rel->sec, 1);
is($rel->min, 2);
is($rel->hour, 3);
is($rel->day, 4);
...
is(rdate("2012-03-02 15:47:32", "2013-04-03 16:48:33"), Date::Rel->new("2012-03-02 15:47:32", "2013-04-03 16:48:33"));
