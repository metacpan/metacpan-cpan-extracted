...
sub meta {
    return {
        v => 1,
        summary => 'Sort numbers (sorted numerically) before non-numbers (sorted asciibetically)',
    };
}
sub gen_sorter {
...
This document describes version 0.121 of Sort::Sub::by_num_then_ascii (from Perl distribution Sort-Sub), released on 2024-07-17.
