...
This document describes version 0.003 of App::lcpan::Cmd::cpantesters_dist (from Perl distribution App-lcpan-CmdBundle-cpantesters), released on 2022-03-27.
...
CL<http://matrix.cpantesters.org/?dist=DIST>. C<DIST> will first be checked for
existence in local index database.
