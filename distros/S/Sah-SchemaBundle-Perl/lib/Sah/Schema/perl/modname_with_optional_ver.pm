...
Sah::Schema::perl::modname_with_optional_ver - Perl module name (e.g. Foo::Bar) with optional version number suffix (e.g. Foo::Bar@0.001)

=head1 VERSION

This document describes version 0.050 of Sah::Schema::perl::modname_with_optional_ver (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::modname_with_optional_ver*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::modname_with_optional_ver", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::modname_with_optional_ver", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::modname_with_optional_ver*");
     $validator->(\@args);
     ...
 }
 ...
 $SPEC{myfunc} = {
     ...
     args => {
         arg1 => {
             ...
             schema => ['perl::modname_with_optional_ver*'],
         },
         ...
     },
 };
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::modname_with_optional_ver*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::modname_with_optional_ver*', name=>'PerlModnameWithOptionalVer')
     );
 }

 use My::Types qw(PerlModnameWithOptionalVer);
 PerlModnameWithOptionalVer->assert_valid($data);
