...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::NodeType Google::Cloud::Compute::V1::Compute::NodeTypeAggregatedList Google::Cloud::Compute::V1::Compute::NodeTypeList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::NodeTypesClient->new( credentials => 'dummy' );
