...
#pod
#pod This is C<Hook::LicenseProvider> plugin implementation. Nothing interesting, just using few roles.
#pod
...
#pod = L<Dist::Zilla>
#pod = L<Dist::Zilla::Role::LicenseProvider>
#pod
#pod =cut

package Dist::Zilla::Plugin::Hook::LicenseProvider;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::LicenseProvider> plugin implementation
our $VERSION = 'v0.8.3'; # VERSION

with 'Dist::Zilla::Role::Plugin';
with 'Dist::Zilla::Role::Hooker' => {
    -alias => { hook => 'provide_license' },
};
...
Dist::Zilla::Plugin::Hook::LicenseProvider - C<Hook::LicenseProvider> plugin implementation
...
This is C<Hook::LicenseProvider> plugin implementation. Nothing interesting, just using few roles.
...
=item L<Dist::Zilla::Role::LicenseProvider>
