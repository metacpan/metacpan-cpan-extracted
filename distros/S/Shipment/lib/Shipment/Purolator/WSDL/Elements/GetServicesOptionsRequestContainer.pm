...
$Shipment::Purolator::WSDL::Elements::GetServicesOptionsRequestContainer::VERSION = '3.01';
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDL::Elements::GetServicesOptionsRequestContainer->new($data);
