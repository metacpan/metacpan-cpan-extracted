package Chart::Plotly::Trace::Scatter3d::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Scatter3d::Hoverlabel::Font - This attribute is one of the possible options for the trace scatter3d.
