...
$Net::Amazon::S3::Operation::Bucket::Acl::Fetch::Response::VERSION = '0.991';
use Moose;
...
Net::Amazon::S3::Operation::Bucket::Acl::Fetch::Response - An internal class to handle fetch bucket acl response
