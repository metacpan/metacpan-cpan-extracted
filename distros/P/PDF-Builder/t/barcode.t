...
isa_ok($xo_codabar, q{PDF::Builder::Resource::XObject::Form::BarCode::codabar},
       q{xo_codabar loads});

my $xo_code128 = $pdf->xo_code128(-code => 0);
isa_ok($xo_code128, q{PDF::Builder::Resource::XObject::Form::BarCode::code128},
       q{xo_code128 loads});

my $xo_2of5int = $pdf->xo_2of5int(-code => 0);
isa_ok($xo_2of5int, q{PDF::Builder::Resource::XObject::Form::BarCode::int2of5},
       q{xo_2of5int loads});

my $xo_3of9 = $pdf->xo_3of9(-code => 0);
isa_ok($xo_3of9, q{PDF::Builder::Resource::XObject::Form::BarCode::code3of9},
       q{xo_3of9 loads});

my $xo_ean13 = $pdf->xo_ean13(-code => '0123456789012');
isa_ok($xo_ean13, q{PDF::Builder::Resource::XObject::Form::BarCode::ean13},
       q{xo_ean13 loads});
...
is(join('', map { ref($_) ? $_->[0] : $_ } PDF::Builder::Resource::XObject::Form::BarCode::codabar->encode('A31234567890123B')),
...
is(join('', map { ref($_) ? $_->[0] : $_ } PDF::Builder::Resource::XObject::Form::BarCode::code128->encode_128('a', 'TEST')),
   'b1a4a2213311132113213113213311241211b3c1a1b',
   q{Correctly encoded Code 128A barcode});

is(join('', map { ref($_) ? $_->[0] : $_ } PDF::Builder::Resource::XObject::Form::BarCode::code128->encode_128('b', 'Test')),
   'b1a2a4213311112214114212124112311321b3c1a1b',
   q{Correctly encoded Code 128B barcode});

is(join('', map { ref($_) ? $_->[0] : $_ } PDF::Builder::Resource::XObject::Form::BarCode::code128->encode_128('c', '01234567890')),
   'b1a2c2222122312131113123141122212141114131123122111422b3c1a1b',
   q{Correctly encoded Code 128C barcode});

is(join('', map { ref($_) ? $_->[0] : $_ } PDF::Builder::Resource::XObject::Form::BarCode::code128->encode_ean128('00123456780000000001')),
...
is(join('', map { ref($_) ? $_->[0] : $_ } PDF::Builder::Resource::XObject::Form::BarCode::code3of9::encode_3of9('TEST')),
   'abaababaa11111212211211122111111211122111111212211abaababaa1',
   q{Correctly encoded Code 39 barcode});

is(join('', map { ref($_) ? $_->[0] : $_ } PDF::Builder::Resource::XObject::Form::BarCode::code3of9::encode_3of9('TEST', 1, 0)),
...
is(join('', map { ref($_) ? $_->[0] : $_ } PDF::Builder::Resource::XObject::Form::BarCode::code3of9::encode_3of9('Test', 0, 1)),
...
is(join('', map { ref($_) ? $_->[0] : $_ } PDF::Builder::Resource::XObject::Form::BarCode::code3of9::encode_3of9('Test', 1, 1)),
...
foreach my $code (sort keys %$ean13_codes) {
    is(join('', map { ref($_) ? $_->[0] : $_ } PDF::Builder::Resource::XObject::Form::BarCode::ean13->encode($code)),
       $ean13_codes->{$code},
