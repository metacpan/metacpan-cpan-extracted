...
my $gnip;
ok($gnip = Net::Gnip->new($ENV{GNIP_TEST_USERNAME}, $ENV{GNIP_TEST_PASSWORD}, _no_dt => 1), "Created publisher");
...
is($activity->at, $time->epoch, "Got correct time from returned activity");
