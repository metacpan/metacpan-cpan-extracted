package Google::Ads::AdWords::v201806::CertificateMissingConstraint;
use strict;
use warnings;
...
Google::Ads::AdWords::v201806::CertificateMissingConstraint

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CertificateMissingConstraint from the namespace https://adwords.google.com/api/adwords/cm/v201806.
