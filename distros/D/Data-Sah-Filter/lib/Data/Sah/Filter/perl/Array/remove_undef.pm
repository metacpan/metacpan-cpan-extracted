...
1;
# ABSTRACT: Remove undef elements from an array
...
Data::Sah::Filter::perl::Array::remove_undef - Remove undef elements from an array

=head1 VERSION

This document describes version 0.024 of Data::Sah::Filter::perl::Array::remove_undef (from Perl distribution Data-Sah-Filter), released on 2024-01-17.

=head1 SYNOPSIS

=head2 Using in Sah schema's C<prefilters> (or C<postfilters>) clause

 ["array","prefilters",[["Array::remove_undef"]]]

=head2 Using with L<Data::Sah>:

 use Data::Sah qw(gen_validator);
 
 my $schema = ["array","prefilters",[["Array::remove_undef"]]];
...
=head2 Using with L<Data::Sah:Filter> directly:
 ...
 my $filter = gen_filter([["Array::remove_undef"]]);
...
=head2 Sample data and filtering results
 ...
 [] # valid, unchanged
 ["a","b"] # valid, unchanged
 ["a","b",undef,"a",undef] # valid, becomes ["a","b","a"]
