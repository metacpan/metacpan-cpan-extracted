# ----------------------------------------------------------------------
# NAME       : BibFormat.pm
# CLASSES    : LaTeX::BibTeX::BibFormat
# RELATIONS  : sub-class of LaTeX::BibTeX::StructuredEntry
#              super-class of LaTeX::BibTeX::BibEntry
# DESCRIPTION: Provides methods for final output formatting of 
#              bibliographic entries.
# CREATED    : 1997/11/24, GPW
# MODIFIED   : 
# VERSION    : $Id: BibFormat.pm,v 1.11 2000/03/23 02:08:40 greg Rel $
...
package LaTeX::BibTeX::BibFormat;
...
use LaTeX::BibTeX qw(:subs display_list :nameparts :joinmethods);

=head1 NAME

LaTeX::BibTeX::BibFormat - formats bibliography entries
...
The C<LaTeX::BibTeX::BibFormat> class is a base class of
C<LaTeX::BibTeX::BibEntry> for formatting bibliography entries.  It thus
...
class, C<LaTeX::BibTeX::BibSort>.  

C<BibFormat> (the C<LaTeX::BibTeX> prefix will be dropped for brevity)
pays attention to almost all of the structure options described in
L<LaTeX::BibTeX::Bib>; it only ignores those that cover sorting,
...
sub format_names
{
   ...
   $format = new LaTeX::BibTeX::NameFormat ($order, ! ($style eq 'full'));
