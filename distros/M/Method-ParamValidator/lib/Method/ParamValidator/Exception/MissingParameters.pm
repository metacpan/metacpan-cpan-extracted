...
$Method::ParamValidator::Exception::MissingParameters::VERSION   = '0.12';
$Method::ParamValidator::Exception::MissingParameters::AUTHORITY = 'cpan:MANWAR';

=head1 NAME

Method::ParamValidator::Exception::MissingParameters - Handles 'missing parameters' exception.
...
has reason => (is => 'ro', default => sub { 'Missing parameters.' });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Method::ParamValidator::Exception::MissingParameters
...
1; # End of Method::ParamValidator::Exception::MissingParameters
