package App::Yath::Schema::Result::JobTryField;
use utf8;
use strict;
use warnings;
...
require "App/Yath/Schema/${App::Yath::Schema::LOADED}/JobTryField.pm";
require "App/Yath/Schema/Overlay/JobTryField.pm";
...
App::Yath::Schema::Result::JobTryField - Autogenerated result class for JobTryField.
