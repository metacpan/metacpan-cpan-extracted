...
Data::SIprefixes::exa - This provides exa matching for Data::SIprefixes.
...
=head1 SYNOPSIS
    ...
    use Data::SIprefixes::exa;
    
    my $prefix=Data::SIprefixes::exa->new;

    my $origMeasure='exameter';
