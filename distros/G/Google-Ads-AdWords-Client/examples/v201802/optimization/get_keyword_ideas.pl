...
use Google::Ads::AdWords::v201802::Language;
use Google::Ads::AdWords::v201802::LanguageSearchParameter;
use Google::Ads::AdWords::v201802::NetworkSearchParameter;
use Google::Ads::AdWords::v201802::NetworkSetting;
use Google::Ads::AdWords::v201802::Paging;
use Google::Ads::AdWords::v201802::RelatedToQuerySearchParameter;
use Google::Ads::AdWords::v201802::SeedAdGroupIdSearchParameter;
use Google::Ads::AdWords::v201802::TargetingIdeaSelector;
...
sub get_keyword_ideas {
  ...
  my $language_english =
    Google::Ads::AdWords::v201802::Language->new({id => 1000});
  my $language_search_parameter =
    Google::Ads::AdWords::v201802::LanguageSearchParameter->new(
