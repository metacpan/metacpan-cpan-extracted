...
This document describes Attean::API::Query version 0.039
...
package Attean::API::DirectedAcyclicGraph 0.039 {
...
package Attean::API::SPARQLSerializable 0.039 {
...
package Attean::API::SPARQLQuerySerializable 0.039 {
	use Moo::Role;
	use namespace::clean;
...
package Attean::API::Algebra 0.039 {
	use Moo::Role;
	use Types::Standard qw(ArrayRef ConsumerOf);
...
package Attean::API::QueryTree 0.039 {
	use Moo::Role;
...
package Attean::API::NullaryQueryTree 0.039 {
	use Moo::Role;
	sub arity { return 0 }
...
package Attean::API::UnaryQueryTree 0.039 {
	use Moo::Role;
	sub arity { return 1 }
	with 'Attean::API::QueryTree';
...
package Attean::API::BinaryQueryTree 0.039 {
	use Moo::Role;
	sub arity { return 2 }
	with 'Attean::API::QueryTree';
}
...
package Attean::API::PropertyPath 0.039 {
	use Moo::Role;
	with 'Attean::API::QueryTree';
	requires 'as_string';
	requires 'as_sparql';
...
package Attean::API::UnaryPropertyPath 0.039 {
...
package Attean::API::NaryPropertyPath 0.039 {
	use Types::Standard qw(ArrayRef ConsumerOf);
...
package Attean::API::UnionScopeVariables 0.039 {
	use Moo::Role;
...
package Attean::API::IntersectionScopeVariables 0.039 {
	use Moo::Role;
	sub in_scope_variables {
		my $self	= shift;
		my @c		= @{ $self->children };
