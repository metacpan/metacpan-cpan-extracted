...
package WebService::Edgecast::auto::Administration::Element::CustomerUserAdd;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerUserAdd::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerUserAdd');
...
my %strIsAdmin_of :ATTR(:get<strIsAdmin>);
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'strIsAdmin' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
...
WebService::Edgecast::auto::Administration::Element::CustomerUserAdd
...
CustomerUserAdd from the namespace EC:WebServices.
...
=item * strIsAdmin
 ...
 $element->set_strIsAdmin($data);
 $element->get_strIsAdmin();
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerUserAdd->new($data);
