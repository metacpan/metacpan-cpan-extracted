...
Sah::Schema::physical::mass - A physical mass quantity

=head1 VERSION

This document describes version 0.001 of Sah::Schema::physical::mass (from Perl distribution Sah-Schemas-PhysicalQuantity), released on 2020-03-11.
...
Using with L<Data::Sah>:
 ...
 my $vdr = gen_validator("physical::mass*");
