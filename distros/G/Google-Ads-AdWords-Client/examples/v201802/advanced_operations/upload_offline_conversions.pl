...
use Google::Ads::AdWords::v201802::OfflineConversionFeed;
use Google::Ads::AdWords::v201802::OfflineConversionFeedOperation;
...
sub upload_offline_conversions {
  ...
  my $upload_conversion = Google::Ads::AdWords::v201802::UploadConversion->new({
    category                  => 'PAGE_VIEW',
  ...
  my $upload_operation =
    Google::Ads::AdWords::v201802::ConversionTrackerOperation->new({
      operator => "ADD",
  ...
  my $feed = Google::Ads::AdWords::v201802::OfflineConversionFeed->new({
  ...
  my $offline_conversion_operation =
    Google::Ads::AdWords::v201802::OfflineConversionFeedOperation->new({
      operator => "ADD",
      operand  => $feed
    });
