package Chart::Plotly::Trace::Heatmapgl::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Heatmapgl::Colorbar::Tickfont;
use Chart::Plotly::Trace::Heatmapgl::Colorbar::Tickformatstop;
use Chart::Plotly::Trace::Heatmapgl::Colorbar::Titlefont;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Heatmapgl::Colorbar::Tickfont", );
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Heatmapgl::Colorbar::Tickformatstop]", );
...
has titlefont => ( is  => "rw",
                   isa => "Maybe[HashRef]|Chart::Plotly::Trace::Heatmapgl::Colorbar::Titlefont", );
...
Chart::Plotly::Trace::Heatmapgl::Colorbar - This attribute is one of the possible options for the trace heatmapgl.
