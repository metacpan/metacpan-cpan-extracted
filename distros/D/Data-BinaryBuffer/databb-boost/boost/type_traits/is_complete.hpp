...
#define BOOST_TT_HAS_WORKING_IS_COMPLETE
   ...
   template <class T> struct is_complete
      : public integral_constant<bool, ::databb_boost::is_function<typename databb_boost::remove_reference<T>::type>::value || (sizeof(databb_boost::detail::check_is_complete<T>(0)) != sizeof(char))> {};
   ...
   namespace detail
   {
      ...
      {
         template <class U, class = decltype(sizeof(databb_boost::declval< U >())) >
   ...
   template <class T>
   struct is_complete : databb_boost::integral_constant<bool, ::databb_boost::is_function<typename databb_boost::remove_reference<T>::type>::value || ::databb_boost::detail::is_complete_imp<T>::value>
   {};
   template <class T>
   struct is_complete<T&> : databb_boost::is_complete<T> {};
   
#else

      template <class T> struct is_complete
         : public databb_boost::integral_constant<bool, true> {};
