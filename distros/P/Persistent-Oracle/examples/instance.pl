...
# RCS:      $Id: instance.pl,v 1.2 2000/02/10 01:44:04 winters Exp $
#
...
eval {
  ...
  $person = new Persistent::Oracle("dbi:Oracle:testdb", "scott", "tiger",
				   "person");
...
sub create_table {
  ...
  my $sth =
    $dbh->prepare("SELECT * FROM user_tables WHERE table_name = 'PERSON'")
