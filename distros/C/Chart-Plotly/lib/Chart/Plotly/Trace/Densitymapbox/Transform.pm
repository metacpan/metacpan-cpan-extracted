package Chart::Plotly::Trace::Densitymapbox::Transform;
use Moose;
...
Chart::Plotly::Trace::Densitymapbox::Transform - This attribute is one of the possible options for the trace densitymapbox.
