...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::Policy Google::Cloud::Compute::V1::Compute::ServiceAttachment Google::Cloud::Compute::V1::Compute::ServiceAttachmentAggregatedList Google::Cloud::Compute::V1::Compute::ServiceAttachmentList Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::ServiceAttachmentsClient->new( credentials => 'dummy' );
