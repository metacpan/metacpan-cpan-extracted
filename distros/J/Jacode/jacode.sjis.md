...
として利用すると "pkf" のように機能します。名付けるとしたらリブリーノ(、あるい
はライブリーノ)になるかと思います。コマンドラインオプションの説明は何もオプ
ションをつけずに実行することで参照できます。
...
で jacode.pl に移行することができます。Encode モジュールの新しいインタフェース
による新しい悩みとは無縁です。
...
西暦2020年10月の時点では、以下の URL に jacode.pl があります。
...
# 著作者
  ...
  Copyright (c) 2010, 2011, 2014, 2015, 2016, 2017, 2018, 2019, 2020 INABA Hitoshi
