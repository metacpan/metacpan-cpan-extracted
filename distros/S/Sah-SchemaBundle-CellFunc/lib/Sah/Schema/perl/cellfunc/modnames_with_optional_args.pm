...
Sah::Schema::perl::cellfunc::modnames_with_optional_args - Array of Perl CellFunc::* module names without the prefix, with optional args, e.g. ["File::stat_row,follow_symlink,0", "File::Media::attr_row"]

=head1 VERSION

This document describes version 0.001 of Sah::Schema::perl::cellfunc::modnames_with_optional_args (from Perl distribution Sah-SchemaBundle-CellFunc), released on 2024-12-10.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::cellfunc::modnames_with_optional_args*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::cellfunc::modnames_with_optional_args", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::cellfunc::modnames_with_optional_args", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::cellfunc::modnames_with_optional_args*");
     $validator->(\@args);
     ...
 }
 ...
 $SPEC{myfunc} = {
     ...
     args => {
         arg1 => {
             ...
             schema => ['perl::cellfunc::modnames_with_optional_args*'],
         },
         ...
     },
 };
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::cellfunc::modnames_with_optional_args*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::cellfunc::modnames_with_optional_args*', name=>'PerlCellfuncModnamesWithOptionalArgs')
     );
 }

 use My::Types qw(PerlCellfuncModnamesWithOptionalArgs);
 PerlCellfuncModnamesWithOptionalArgs->assert_valid($data);
