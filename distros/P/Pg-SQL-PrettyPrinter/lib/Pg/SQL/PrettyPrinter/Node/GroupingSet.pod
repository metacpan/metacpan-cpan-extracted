...
Pg::SQL::PrettyPrinter::Node::GroupingSet - Class representing grouping set
- that is GROUP BY with either "GROUPING SET", "ROLLUP", or "CUBE"
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Pg::SQL::PrettyPrinter::Node::GroupingSet
