...
1;
# ABSTRACT: Unqualified identifier in Perl, without "use utf8" in effect
...
Sah::Schema::perl::identifier::unqualified_ascii - Unqualified identifier in Perl, without "use utf8" in effect

=head1 VERSION

This document describes version 0.050 of Sah::Schema::perl::identifier::unqualified_ascii (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
=head2 Sample data and validation results against this schema
 ...
 "b\xC3\xA9b\xC3\xA9"  # INVALID (Non-latin letter not accepted)
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::identifier::unqualified_ascii*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::identifier::unqualified_ascii", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::identifier::unqualified_ascii", {return_type=>'str_errmsg+val'});
 ...
 # a sample invalid data
 $data = "b\xC3\xA9b\xC3\xA9";
 my $res = $validator->($data); # => ["Must match regex pattern qr(\\A[A-Za-z_][A-Za-z_0-9]{0,250}\\z)","b\xC3\xA9b\xC3\xA9"]
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::identifier::unqualified_ascii*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::identifier::unqualified_ascii*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::identifier::unqualified_ascii*', name=>'PerlIdentifierUnqualifiedAscii')
     );
 }

 use My::Types qw(PerlIdentifierUnqualifiedAscii);
 PerlIdentifierUnqualifiedAscii->assert_valid($data);
