package Chart::Plotly::Trace::Choroplethmapbox::Marker::Line;
use Moose;
...
Chart::Plotly::Trace::Choroplethmapbox::Marker::Line - This attribute is one of the possible options for the trace choroplethmapbox.
