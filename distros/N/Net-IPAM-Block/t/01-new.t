...
my $good = [
  ...
  [qw(:: ::/128)],
  [qw(::ffff:0.0.0.0 ::ffff:0.0.0.0/128)],
  ...
  [qw(::ffff:1.2.3.0-::ffff:1.2.3.2 ::ffff:1.2.3.0-::ffff:1.2.3.2)],
  [qw(::ffff:1.2.3.0-::ffff:1.2.3.3 ::ffff:1.2.3.0/126)],
];
...
my $ips = [
  [qw(1.2.3.4 1.2.3.4/32)],  [qw(::ffff:0.0.0.0 ::ffff:0.0.0.0/128)],
