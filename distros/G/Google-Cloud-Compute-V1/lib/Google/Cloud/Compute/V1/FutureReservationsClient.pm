package Google::Cloud::Compute::V1::FutureReservationsClient;
...
1; # End of Google::Cloud::Compute::V1::FutureReservationsClient

__END__

=head1 NAME

Google::Cloud::Compute::V1::FutureReservationsClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Compute::V1::FutureReservationsClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Compute::V1::FutureReservationsClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Compute::V1::FutureReservationsClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Compute::V1::FutureReservationsClient->new(
