...
# eval $var has eval "..."
$var = <<'END';
eval GB18030::escape " if ('傾僜' !~ /A/) { return 1 } else { return 0 } "
END
if (eval GB18030::escape $var) {
...
$var = <<'END';
eval GB18030::escape qq{ if ('傾僜' !~ /A/) { return 1 } else { return 0 } }
END
if (eval GB18030::escape $var) {
...
# eval $var has eval '...'
$var = <<'END';
eval GB18030::escape ' if (qq{傾僜} !~ /A/) { return 1 } else { return 0 } '
END
if (eval GB18030::escape $var) {
...
# eval $var has eval q{...}
$var = <<'END';
eval GB18030::escape q{ if ('傾僜' !~ /A/) { return 1 } else { return 0 } }
END
if (eval GB18030::escape $var) {
