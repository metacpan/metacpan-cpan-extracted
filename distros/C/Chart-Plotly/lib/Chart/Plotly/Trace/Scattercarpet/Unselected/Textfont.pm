package Chart::Plotly::Trace::Scattercarpet::Unselected::Textfont;
use Moose;
...
Chart::Plotly::Trace::Scattercarpet::Unselected::Textfont - This attribute is one of the possible options for the trace scattercarpet.
