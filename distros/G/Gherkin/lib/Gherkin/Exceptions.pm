...
$Gherkin::Exceptions::VERSION = '18.1.1';
use overload
    q{""}    => 'stringify',
    fallback => 1;
...
$Gherkin::Exceptions::Parser::VERSION = '18.1.1';
use base 'Gherkin::Exceptions';

# Composite exceptions
package Gherkin::Exceptions::CompositeParser;
$Gherkin::Exceptions::CompositeParser::VERSION = '18.1.1';
...
$Gherkin::Exceptions::SingleParser::VERSION = '18.1.1';
use base 'Gherkin::Exceptions::Parser';
...
$Gherkin::Exceptions::NoSuchLanguage::VERSION = '18.1.1';
...
$Gherkin::Exceptions::AstBuilder::VERSION = '18.1.1';
use base 'Gherkin::Exceptions::SingleParser';
...
$Gherkin::Exceptions::UnexpectedEOF::VERSION = '18.1.1';
use base 'Gherkin::Exceptions::SingleParser';
...
$Gherkin::Exceptions::UnexpectedToken::VERSION = '18.1.1';
use base 'Gherkin::Exceptions::SingleParser';
