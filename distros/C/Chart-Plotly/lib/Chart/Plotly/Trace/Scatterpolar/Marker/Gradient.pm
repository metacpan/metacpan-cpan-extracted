package Chart::Plotly::Trace::Scatterpolar::Marker::Gradient;
use Moose;
...
Chart::Plotly::Trace::Scatterpolar::Marker::Gradient - This attribute is one of the possible options for the trace scatterpolar.
