package OWL::DirectSemantics::Element::SymmetricObjectProperty;

BEGIN {
	$OWL::DirectSemantics::Element::SymmetricObjectProperty::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::SymmetricObjectProperty::VERSION   = '0.001';
};
...
OWL::DirectSemantics::Element::SymmetricObjectProperty - represents an OWL SymmetricObjectProperty

=head1 DESCRIPTION

This class represents the SymmetricObjectProperty element in OWL Direct Semantics.
