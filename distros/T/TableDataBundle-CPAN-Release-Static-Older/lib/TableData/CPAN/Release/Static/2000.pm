...
our %STATS = ("num_rows",3444,"num_columns",9); # STATS
...
TableDataRole::CPAN::Release::Static::2000 - CPAN releases for the year 2000

=head1 VERSION

This document describes version 20210927.0 of TableDataRole::CPAN::Release::Static::2000 (from Perl distribution TableDataBundle-CPAN-Release-Static-Older), released on 2021-09-27.

=head1 SYNOPSIS

 use TableData::CPAN::Release::Static::2000;

 my $td = TableData::CPAN::Release::Static::2000->new;
