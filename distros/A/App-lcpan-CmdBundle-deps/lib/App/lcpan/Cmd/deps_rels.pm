...
1;
# ABSTRACT: List all known prereq relationships
...
App::lcpan::Cmd::deps_rels - List all known prereq relationships

=head1 VERSION

This document describes version 0.007 of App::lcpan::Cmd::deps_rels (from Perl distribution App-lcpan-CmdBundle-deps), released on 2017-07-28.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<deps-rels>.
...
List all known prereq relationships.
