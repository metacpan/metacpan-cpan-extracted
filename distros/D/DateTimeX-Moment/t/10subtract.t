...
# based on bug report from Eric Cholet
{
    ...
    is( $dur1->delta_months,      0, 'delta_months should be 0' );
    is( $dur1->delta_days,        1, 'delta_days should be 1' );
    is( $dur1->delta_minutes,     0, 'delta_minutes should be 0' );
    is( $dur1->delta_seconds,     2, 'delta_seconds should be 2' );
    is( $dur1->delta_nanoseconds, 0, 'delta_nanoseconds should be 0' );
    ...
    is( $dur2->delta_months,      0,  'delta_months should be 0' );
    is( $dur2->delta_days,        -1, 'delta_days should be -1' );
    is( $dur2->delta_minutes,     0,  'delta_minutes should be 0' );
    is( $dur2->delta_seconds,     -2, 'delta_seconds should be -2' );
    is( $dur2->delta_nanoseconds, 0,  'delta_nanoseconds should be 0' );
