...
#
#=======================================================================
package PDF::API3::Compat::API2::Resource::CIDFont::CJKFont;
...
=item $font = PDF::API3::Compat::API2::Resource::CIDFont::CJKFont->new $pdf, $cjkname, %options
...
sub _look_for_font {
    ...
    eval "require PDF::API3::Compat::API2::Resource::CIDFont::CJKFont::$fname; ";
    unless($@){
        return({%{$fonts->{$fname}}});
    } else {
...
sub _look_for_cmap ($) {
    ...
    eval "require PDF::API3::Compat::API2::Resource::CIDFont::CMap::$fname; ";
    unless($@){
        return({%{$cmap->{$fname}}});
    } else {
...
=item $font = PDF::API3::Compat::API2::Resource::CIDFont::CJKFont->new_api $api, $cjkname, %options
