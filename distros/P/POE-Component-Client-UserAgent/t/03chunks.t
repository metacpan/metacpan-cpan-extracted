...
# 03chunks.t -- Receiving response in chunks. Makes a single request
...
POE::Component::Client::UserAgent::debug $debuglevel => '03chunks.log' if $debuglevel;
