...
Faker::Plugin::EnUs::JargonTermSuffix
...
$test->for('synopsis', sub {
  ...
  ok $result->isa('Faker::Plugin::EnUs::JargonTermSuffix');
...
$test->render('lib/Faker/Plugin/EnUs/JargonTermSuffix.pod') if $ENV{RENDER};
