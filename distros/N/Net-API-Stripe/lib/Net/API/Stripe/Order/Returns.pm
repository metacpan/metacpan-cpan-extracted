##----------------------------------------------------------------------------
## Stripe API - ~/lib/Net/API/Stripe/Order/Returns.pm
## Version v0.100.0
...
## 
##----------------------------------------------------------------------------
package Net::API::Stripe::Order::Returns;
BEGIN
{
    use strict;
    use warnings;
...
# sub data { return( shift->_set_get_object_array( 'data', 'Net::API::Stripe::Order::Return', @_ ) ); }
...
Net::API::Stripe::Order::Returns - A Stripe Order Returns List Object
