use v5.14.0;
package JMAP::Tester::LogWriter 0.110;
...
{
  package JMAP::Tester::LogWriter::Code 0.110;
...
{
  package JMAP::Tester::LogWriter::Handle 0.110;
...
{
  package JMAP::Tester::LogWriter::Filename 0.110;
