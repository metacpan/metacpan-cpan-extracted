...
use WebService::Affiliate::Voucher::WebGains;

my $voucher;

lives_ok { $voucher = WebService::Affiliate::Voucher::WebGains->new } "instantiated empty voucher ok";
...
lives_ok { $voucher = WebService::Affiliate::Voucher::WebGains->new(  code => 'ABC123',
                                                           _starts => '2008-05-07T13:24:55+01:00',
...
ok( $voucher->_starts eq '2008-05-07T13:24:55+01:00', "_start date is correct" );
