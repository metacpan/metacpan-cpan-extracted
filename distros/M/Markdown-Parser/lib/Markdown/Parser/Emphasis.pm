...
##----------------------------------------------------------------------------
package Markdown::Parser::Emphasis;
BEGIN
{
    use strict;
    use warnings;
...
This class represents an emphasis formatting. It is used by L<Markdown::Parser> and inherits from L<Markdown::Parser::Element>
...
Sets or gets the markdown type used to declare the emphasis formatting. The value is stored as a L<Module::Generic::Scalar>

Valid type used to mark some text as bold are C<*> or C<_>
