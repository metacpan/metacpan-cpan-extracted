package Sah::Schema::perl::tables::modnames;
...
our $schema = [array => {
    summary => 'Array of Perl Tables::* module names without the prefix, e.g. ["Sample::DeNiro", "Test::Angka"]',
    description => <<'_',

Array of Perl Tables::* module names, where each element is of
`perl::tables::modname` schema, e.g. `Sample::DeNiro`, `Test::Angka`.
...
1;
# ABSTRACT: Array of Perl Tables::* module names without the prefix, e.g. ["Sample::DeNiro", "Test::Angka"]
...
Sah::Schema::perl::tables::modnames - Array of Perl Tables::* module names without the prefix, e.g. ["Sample::DeNiro", "Test::Angka"]

=head1 VERSION

This document describes version 0.001 of Sah::Schema::perl::tables::modnames (from Perl distribution Sah-Schemas-Tables), released on 2020-11-10.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::tables::modnames*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::tables::modnames*");
     $validator->(\@args);
     ...
 }
...
Array of Perl Tables::* module names, where each element is of
C<perl::tables::modname> schema, e.g. C<Sample::DeNiro>, C<Test::Angka>.
