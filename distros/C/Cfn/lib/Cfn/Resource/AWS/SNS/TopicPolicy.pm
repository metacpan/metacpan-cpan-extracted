...
Cfn::Resource::AWS::SNS::TopicPolicy - Cfn resource for AWS::SNS::TopicPolicy

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::SNS::TopicPolicy.
