...
Note that if C<$Config{use64bitint}> (from the L<Config> module) is false, you
can still get deterministic "random" numbers, but they may be slightly
different than those generated by Perls compiled to use 64 bit integers.
Otherwise, the output from this module is portable. See the F<t/random.t> test
for examples.
