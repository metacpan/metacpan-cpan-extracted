...
#
package Smartcat::Client::Object::ModelWithFilesUploadDocumentPropertiesModel;
...
__PACKAGE__->method_documentation(
    {
        'value' => {
            datatype    => 'UploadDocumentPropertiesModel',
            base_name   => 'Value',
            description => '',
            format      => '',
            read_only   => '',
...
__PACKAGE__->swagger_types(
    {
        'value' => 'UploadDocumentPropertiesModel',
