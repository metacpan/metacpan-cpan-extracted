# This Makefile is for the Audio::C4Stream::Mixer extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Audio/C4Stream/Mixer.pm]
#     AUTHOR => q[C4PC <adeamara@cloud4pc.com>]
#     BUILD_REQUIRES => {  }
#     DEFINE => q[]
#     INC => q[-I.]
#     LIBS => [q[]]
#     NAME => q[Audio::C4Stream::Mixer]
#     OBJECT => q[$(O_FILES)]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Audio/C4Stream/Mixer.pm]
...
MAKE = make
FULLEXT = Audio/C4Stream/Mixer
BASEEXT = Mixer
PARENT_NAME = Audio::C4Stream
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Audio/C4Stream/Mixer.pm
INC = -I.
DEFINE = 
OBJECT = $(O_FILES)
LDFROM = $(OBJECT)
...
H_FILES  = INLINE.h \
	ppport.h
MAN1PODS = 
MAN3PODS = lib/Audio/C4Stream/Mixer.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Audio/C4Stream
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Audio/C4Stream
...
TO_INST_PM = lib/Audio/C4Stream/Mixer.pm

PM_TO_BLIB = lib/Audio/C4Stream/Mixer.pm \
...
DISTNAME = Audio-C4Stream-Mixer
DISTVNAME = Audio-C4Stream-Mixer-1.00
...
# Audio::C4Stream::Mixer might depend on some other libraries:
...
manifypods : pure_all  \
	lib/Audio/C4Stream/Mixer.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Audio/C4Stream/Mixer.pm $(INST_MAN3DIR)/Audio::C4Stream::Mixer.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Audio-C4Stream-Mixer' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            1.00' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Perl extension for crossfade mixer.' >> META_new.yml
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Audio/C4Stream/Mixer.pm blib/lib/Audio/C4Stream/Mixer.pm 
