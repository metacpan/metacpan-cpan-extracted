...
package Google::Ads::AdWords::v201809::DataService::getCampaignCriterionBidLandscape;
use strict;
use warnings;
...
getCampaignCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201809.
