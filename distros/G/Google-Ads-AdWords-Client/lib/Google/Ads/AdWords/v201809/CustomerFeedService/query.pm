...
package Google::Ads::AdWords::v201809::CustomerFeedService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::CustomerFeedService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201809::CustomerFeedService::query->new($data);
