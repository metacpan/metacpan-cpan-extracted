...
Sah::SchemaR::perl::comparer::modname_with_optional_args - Perl Comparer::* module name without the prefix (e.g. Foo::bar) with optional arguments (e.g. Foo::baz,qux,quux)

=head1 VERSION

This document describes version 0.002 of Sah::SchemaR::perl::comparer::modname_with_optional_args (from Perl distribution Sah-SchemaBundle-Comparer), released on 2024-03-07.
