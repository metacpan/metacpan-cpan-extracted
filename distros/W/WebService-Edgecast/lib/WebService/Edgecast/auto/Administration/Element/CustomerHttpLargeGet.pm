...
package WebService::Edgecast::auto::Administration::Element::CustomerHttpLargeGet;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerHttpLargeGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerHttpLargeGet');
...
WebService::Edgecast::auto::Administration::Element::CustomerHttpLargeGet
...
CustomerHttpLargeGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerHttpLargeGet->new($data);
