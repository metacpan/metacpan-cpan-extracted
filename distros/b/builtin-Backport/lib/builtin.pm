...
This function is not available on Perl v5.34 or earlier.
...
On Perl version 5.36 or later this function can handle both pure-perl and XS
functions. On Perl version 5.34 or earlier this can only handle pure-perl
functions. Functions implemented in XS cannot be exported lexically.
