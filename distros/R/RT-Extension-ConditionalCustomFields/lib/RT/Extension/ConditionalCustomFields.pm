...
From version 0.07, the condition can be multivalued, that is: the conditioned L<custom field|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> can be displayed/edited if the condition L<custom field|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> has one of these values (In other words: there is an C<OR> bewteen the values of the condition). The condition L<custom field|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> can be a select custom field with values defined by L<CustomFieldValues|https://docs.bestpractical.com/rt/4.4.4/RT/CustomFieldValues.html> or an L<external custom field|https://docs.bestpractical.com/rt/4.4.4/extending/external_custom_fields.html>.
...
Set the C<ConditionedBy> property for this L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> object to L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> C<CF> with operator set to C<OP> and value set to C<VALUE>. C<CF> should be an existing L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> object or the id of an existing L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> object, or the name of an unambiguous existing L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> object. C<OP> should be C<is>, C<isn't>, C<match>, C<doesn't match>, C<less than>, C<greater than> or C<between>. C<VALUE> should be a string or an anonymous array of strings (for selectable L<custom fields|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> or C<between> operator). Current user should have C<SeeCustomField> and C<ModifyCustomField> rights for this conditioned by L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> and C<SeeCustomField> right for the condition L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html>. Returns (1, 'Status message') on success and (0, 'Error Message') on failure.
...
Returns the current C<ConditionedBy> property for this conditioned by L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> object as a hash with keys C<CF> containing the id of the condition L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html>, C<op> and C<vals> containing the condition operator as string, and the condition value as an array of strings (so we can store several values for selectable L<custom fields|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> or C<between> operator, but generally the C<vals> array includes only one string). If neither this conditioned by L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> nor one of its ancestor is conditioned by the C<CF> condition L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html>, that is: if their C<ConditionedBy> property is not (recursively) defined, returns C<undef>. Current user should have C<SeeCustomField> right for both this conditioned by L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> and the condition L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> which this L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> is conditioned recursively by. I<"Recursively"> means that this method will search for a C<ConditionedBy> property for this L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> object, then for the L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> this one is C<BasedOn>, and so on until it finds an ancestor C<Category> with a C<ConditionedBy> property or, the L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> which is being looked up, is not based on any ancestor C<Category>.
...
Also, C<ConditionalCustomFields> allows to set the C<ConditionedBy> property when creating L<CustomFields|https://docs.bestpractical.com/rt/4.4.4/RT/CustomFields.html> from an F<initialdata> file, with one of the following syntaxes:
...
This examples creates a C<Select> condition L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html>, named C<Condition> and three conditioned by L<CustomFields|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html>. L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> C<Condition> should have the value C<Passed>, for L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> C<Conditioned with cf name and value> to be displayed or edited. L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> C<Condition> should not have the value C<Failed> for L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> C<Conditioned with cf id and value> to be displayed or edited. L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> C<Condition> should have one of the values C<Passed> or C<Schrödingerized> for L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> C<Conditioned with multiple values> to be displayed or edited.
...
The condition L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> that this new L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> should conditioned by. It can be either the C<id> or the C<Name> of a previously created L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html>. This implies that the condition L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> should be declared before this one in the F<initialdata> file, or it should already exist. When C<ConditionedByCF> attribute is set, C<ConditionedBy> field should always also be set.

=item C<ConditonedBy>

The value as a C<string> of the condition L<CustomField|https://docs.bestpractical.com/rt/4.4.4/RT/CustomField.html> defined by the C<ConditionedByCF> field (which is mandatory).
