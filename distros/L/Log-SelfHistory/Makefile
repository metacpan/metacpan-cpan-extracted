# This Makefile is for the Log::SelfHistory extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Log/SelfHistory.pm]
#     AUTHOR => q[root <root@>]
#     NAME => q[Log::SelfHistory]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Log/SelfHistory.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Log::SelfHistory
NAME_SYM = Log_SelfHistory
VERSION = 0.01
...
FULLEXT = Log/SelfHistory
BASEEXT = SelfHistory
PARENT_NAME = Log
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Log/SelfHistory.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Log/SelfHistory.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Log
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Log
...
TO_INST_PM = lib/Log/SelfHistory.pm \
	lib/Log/tushar.pm

PM_TO_BLIB = lib/Log/SelfHistory.pm \
	blib/lib/Log/SelfHistory.pm \
	lib/Log/tushar.pm \
	blib/lib/Log/tushar.pm
...
DISTNAME = Log-SelfHistory
DISTVNAME = Log-SelfHistory-0.01
...
manifypods : pure_all  \
	lib/Log/SelfHistory.pm \
	lib/Log/SelfHistory.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Log/SelfHistory.pm $(INST_MAN3DIR)/Log::SelfHistory.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Log-SelfHistory' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Log/SelfHistory.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>root &lt;root@&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/Log/SelfHistory.pm blib/lib/Log/SelfHistory.pm \
	  lib/Log/tushar.pm blib/lib/Log/tushar.pm 
