...
our $rschema = ["str",[{prefilters=>["Path::expand_tilde_when_on_unix","Path::strip_slashes_when_on_unix"],summary=>"Filesystem file name","x.completion"=>["filename"]}],["str"]];
...
This document describes version 0.014 of Sah::SchemaR::filename (from Perl distribution Sah-Schemas-Path), released on 2020-08-08.
