...
END
            ...
            if ($list !~ /\A (?>\s*) \z/oxms) {
                ...
                for (@list) {
                    ...
                    $Elatin9::function_ord     = $Elatin9::function_ord;
                    $Elatin9::function_ord_    = $Elatin9::function_ord_;
                    $Elatin9::function_reverse = $Elatin9::function_reverse;
                    $Elatin9::function_getc    = $Elatin9::function_getc;
                }
            }
        }
    }
