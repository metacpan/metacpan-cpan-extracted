...
This document describes version 0.022 of Sah::Schema::unix::groupname::exists (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.
...
=head1 SAH SCHEMA DEFINITION
 ...
 [
   ...
   {
     prefilters => [
       "Unix::convert_gid_to_unix_group",
       "Unix::check_unix_group_exists",
     ],
   },
 ]

Base schema: L<unix::groupname|Sah::Schema::unix::groupname>

Used prefilters: L<Unix::convert_gid_to_unix_group|Data::Sah::Filter::perl::Unix::convert_gid_to_unix_group>, L<Unix::check_unix_group_exists|Data::Sah::Filter::perl::Unix::check_unix_group_exists>
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"unix::groupname::exists*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('unix::groupname::exists*', name=>'UnixGroupnameExists')
     );
 }

 use My::Types qw(UnixGroupnameExists);
 UnixGroupnameExists->assert_valid($data);
