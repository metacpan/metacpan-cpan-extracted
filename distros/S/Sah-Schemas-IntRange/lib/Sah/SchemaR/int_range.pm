...
Sah::SchemaR::int_range - Integer range (sequence of ints/simple ranges), e.g. 1 / -5-7 / 1,10 / 1,5-7,10

=head1 VERSION

This document describes version 0.004 of Sah::SchemaR::int_range (from Perl distribution Sah-Schemas-IntRange), released on 2021-07-17.
