...
IO::K8s::Api::Resource::V1beta2::CapacityRequestPolicy - CapacityRequestPolicy defines how requests consume device capacity.  Must not set more than one ValidRequestValues.
