package Chart::Plotly::Trace::Histogram2dcontour::Ybins::ImpliedEdits;
use Moose;
...
Chart::Plotly::Trace::Histogram2dcontour::Ybins::ImpliedEdits - This attribute is one of the possible options for the trace histogram2dcontour.
