...
## nortel_test.pl
##
## Script to test the Nortel::Contivity device class. A debug file called "dump.log" is created.
##
## $Id: nortel_test.pl 35 2007-07-11 13:57:17Z mwallraf $
## $Author: mwallraf $
...
my $w = Net::Telnet::Wrapper->new('device_class' => 'Nortel::Contivity', -host => "$device", Dump_Log => "dump.log" );
