package Chart::Plotly::Trace::Scatterpolar::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Scatterpolar::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatterpolar::Hoverlabel::Font", );
