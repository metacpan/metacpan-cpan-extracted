...
Lorem Sentences Plugin for Faker
...
=head1 SYNOPSIS
  ...
  my $f = Faker->new;
  my $p = Faker::Plugin::LoremSentences->new(faker => $f);
...
This package provides methods for generating fake lorem sentences data.
...
The execute method returns a random fake lorem sentences.
