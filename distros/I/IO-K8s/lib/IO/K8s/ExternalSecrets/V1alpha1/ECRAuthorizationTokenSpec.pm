...
IO::K8s::ExternalSecrets::V1alpha1::ECRAuthorizationTokenSpec - ECRAuthorizationTokenSpec defines the desired state to generate an AWS ECR authorization token.
