package Chart::Plotly::Trace::Scatter3d::Line::Colorbar::Tickformatstop;
use Moose;
...
Chart::Plotly::Trace::Scatter3d::Line::Colorbar::Tickformatstop - This attribute is one of the possible options for the trace scatter3d.
