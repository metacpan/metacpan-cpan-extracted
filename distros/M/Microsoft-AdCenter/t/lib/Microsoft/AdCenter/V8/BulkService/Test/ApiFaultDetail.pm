package Microsoft::AdCenter::V8::BulkService::Test::ApiFaultDetail;
...
use Microsoft::AdCenter::V8::BulkService::ApiFaultDetail;

sub test_can_create_api_fault_detail_and_set_all_fields : Test(3) {
    my $api_fault_detail = Microsoft::AdCenter::V8::BulkService::ApiFaultDetail->new
