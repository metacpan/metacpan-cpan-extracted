...
Sah::SchemaR::latin_uppercase_alpha - String containing only zero or more uppercase Latin letters, i.e. A-Z

=head1 VERSION

This document describes version 0.016 of Sah::SchemaR::latin_uppercase_alpha (from Perl distribution Sah-Schemas-Str), released on 2023-10-23.
