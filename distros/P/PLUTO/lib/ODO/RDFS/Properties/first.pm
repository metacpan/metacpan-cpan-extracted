package ODO::RDFS::Properties::first;
...
sub new {
	...
	$self->propertyContainerName( 'ODO::RDFS::Properties::first::PropertiesContainer' );
	$self->properties(bless {}, 'ODO::RDFS::Properties::first::PropertiesContainer');
