package Chart::Plotly::Trace::Candlestick::Transform;
use Moose;
...
Chart::Plotly::Trace::Candlestick::Transform - This attribute is one of the possible options for the trace candlestick.
