package Chart::Plotly::Trace::Image::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Image::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Image::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Image::Legendgrouptitle - This attribute is one of the possible options for the trace image.
