...
my $color  = TIS620::substr $s, 4, 5;   # black
my $middle = TIS620::substr $s, 4, -11; # black cat climbed the
my $end    = TIS620::substr $s, 14;     # climebed the green tree
my $tail   = TIS620::substr $s, -4;     # tree
my $z      = TIS620::substr $s, -4, 2;  # tr
