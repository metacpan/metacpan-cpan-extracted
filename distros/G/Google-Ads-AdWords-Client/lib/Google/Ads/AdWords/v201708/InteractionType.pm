package Google::Ads::AdWords::v201708::InteractionType;
use strict;
use warnings;
...
Google::Ads::AdWords::v201708::InteractionType

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
InteractionType from the namespace https://adwords.google.com/api/adwords/cm/v201708.
