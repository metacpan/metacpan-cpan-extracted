package Chart::Plotly::Trace::Heatmapgl::Colorbar::Tickformatstop;
use Moose;
...
Chart::Plotly::Trace::Heatmapgl::Colorbar::Tickformatstop - This attribute is one of the possible options for the trace heatmapgl.
