...
package Shipment::Purolator::WSDL::Elements::GetFullEstimateRequestContainer;
$Shipment::Purolator::WSDL::Elements::GetFullEstimateRequestContainer::VERSION = '3.07';
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetFullEstimateRequestContainer');
...
Shipment::Purolator::WSDL::Elements::GetFullEstimateRequestContainer
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDL::Elements::GetFullEstimateRequestContainer->new($data);
