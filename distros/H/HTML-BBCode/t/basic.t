...
# new object, with stripscripts off
$bbc = HTML::BBCode->new({ stripscripts => 0 });
isa_ok($bbc, 'HTML::BBCode', 'default');
is($bbc->parse('<i>[b]bold[/b]</i>'), '<i><span style="font-weight:bold">bold</span></i>', 'stripscripts off');
