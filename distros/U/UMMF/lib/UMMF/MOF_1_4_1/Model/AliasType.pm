...
package UMMF::MOF_1_4_1::Model::AliasType;
...
use base qw(
  UMMF::MOF_1_4_1::Model::DataType  UMMF::MOF_1_4_1::Model::TypedElement
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_4_1::Model::AliasType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_4_1::Model::AliasType|UMMF::MOF_1_4_1::Model::AliasType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_4_1::Model::AliasType')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_4_1::Model::AliasType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_4_1::Model::AliasType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_4_1::Model::AliasType' . ": value '$x'")
    unless __validate_type($self, $x);
}


=head2 C<isaAliasType>


Returns true if receiver is a L<UMMF::MOF_1_4_1::Model::AliasType|UMMF::MOF_1_4_1::Model::AliasType>.
...
=head2 C<isaModel__AliasType>


Returns true if receiver is a L<UMMF::MOF_1_4_1::Model::AliasType|UMMF::MOF_1_4_1::Model::AliasType>.
Other receivers will return false.
This is the fully qualified version of the C<isaAliasType> method.

=cut
sub isaModel__AliasType { 1 }
...
Returns the UML Model name (C<'Model::AliasType'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Model::AliasType' }
  ...
  $__tangram_schema ||=
  {
   ...
   [
	 ...
	 # Associations
       ...
       'bases' => [  'UMMF::MOF_1_4_1::Model::DataType',  'UMMF::MOF_1_4_1::Model::TypedElement',  ],
       'sql' => {
...
sub __initialize
{
  ...
  $self->UMMF::MOF_1_4_1::Model::AliasType::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_4_1::Model::AliasType::___create(@args);
