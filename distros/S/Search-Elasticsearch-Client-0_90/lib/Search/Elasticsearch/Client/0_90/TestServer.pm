...
$Search::Elasticsearch::Client::0_90::TestServer::VERSION = '6.81';
use strict;
use warnings;
...
Search::Elasticsearch::Client::0_90::TestServer - Client-specific backend for Search::Elasticsearch::TestServer
