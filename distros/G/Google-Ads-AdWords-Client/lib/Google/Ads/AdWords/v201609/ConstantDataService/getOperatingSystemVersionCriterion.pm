...
package Google::Ads::AdWords::v201609::ConstantDataService::getOperatingSystemVersionCriterion;
use strict;
use warnings;
...
getOperatingSystemVersionCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201609.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201609::ConstantDataService::getOperatingSystemVersionCriterion->new($data);
