...
Biblio::ILL::ISO::Cancel is a derivation of the abstract 
Biblio::ILL::ISO::ISO object, and handles the Cancel message type.
...
Cancel message from a file (followed by a call to
...
To read a message from a file, use the following:
    ...
    my $href = $msg->read("msg_06.cancel.ber");
