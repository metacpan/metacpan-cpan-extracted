...
This document describes version 0.050 of Sah::Schema::perl::distname::default_this_dist (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
=head1 SAH SCHEMA DEFINITION
 ...
 [
   ...
   {
     "summary" => "Perl distribution name, defaults to \"this distribution\"",
     "x.perl.default_value_rules" => ["Perl::this_dist"],
   },
 ]
