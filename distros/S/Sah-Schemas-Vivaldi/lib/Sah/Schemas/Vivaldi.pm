...
1;
# ABSTRACT: Various Sah schemas related to Vivaldi browser
...
Sah::Schemas::Vivaldi - Various Sah schemas related to Vivaldi browser

=head1 VERSION

This document describes version 0.001 of Sah::Schemas::Vivaldi (from Perl distribution Sah-Schemas-Vivaldi), released on 2020-04-19.
