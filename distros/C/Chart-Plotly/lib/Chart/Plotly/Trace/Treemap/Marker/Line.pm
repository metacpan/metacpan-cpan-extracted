package Chart::Plotly::Trace::Treemap::Marker::Line;
use Moose;
...
Chart::Plotly::Trace::Treemap::Marker::Line - This attribute is one of the possible options for the trace treemap.
