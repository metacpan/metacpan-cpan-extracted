...
##  }
	...
	'Carp'				=> 0,
	'Date::Manip'			=> 6.55,	# For new_config()
	'Date::Manip::Date'		=> 6.55,	# to work
	'Module::Load'			=> 0,
	'Scalar::Util'			=> 0,
	'Text::ParseWords'		=> 0,
	constant	=> 0,
...
sub version_from {
    return 'lib/Date/ManipX/Almanac.pm';
}
...
My::Module::Meta - Information needed to build Date::ManipX::Almanac
...
This module centralizes information needed to build C<Date::ManipX::Almanac>. It
is private to the C<Date::ManipX::Almanac> package, and may be changed or
...
modules required to build the C<Date::ManipX::Almanac> package, suitable for
...
the modules required to run the C<Date::ManipX::Almanac>
