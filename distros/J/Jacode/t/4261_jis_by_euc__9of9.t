...
@todo = (
("\xF4\xA6",'jis','euc','',"\x1B\x24\x42\x74\x26\x1B\x28\x42"),
("\xFD",'jis','euc','',"\xFD\x1B\x28\x42"),
("\xFE",'jis','euc','',"\xFE\x1B\x28\x42"),
("\xFF",'jis','euc','',"\xFF\x1B\x28\x42"),
);
