package Require::HookChainTest::One;
...
1;
# ABSTRACT: A dummy module used in testing Require::HookChain
...
Require::HookChainTest::One - A dummy module used in testing Require::HookChain
