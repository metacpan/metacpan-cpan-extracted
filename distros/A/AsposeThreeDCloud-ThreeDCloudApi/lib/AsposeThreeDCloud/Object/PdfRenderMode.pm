...
#
package AsposeThreeDCloud::Object::PdfRenderMode;
...
__PACKAGE__->class_documentation({description => 'Render mode specifies the style in which the 3D artwork is rendered.',
                                  class => 'PdfRenderMode',
                                  required => [], # TODO
}                                 );
