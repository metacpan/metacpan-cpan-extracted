...
sub _fixture_range_compact {
  ...
  return {
    'tc_string'        => 'COyfVVoOyfVVoADACHENAwCAAAAAAAAAAAAAE5QBgALgAqgD8AQACSwEygJyAnSAMABgAFkAgQCDASeAmYBOgAA',
    'consent_language' => 'EN',
    'purpose'          => {'consents' => [], 'legitimate_interests' => []},
    'cmp_id'           => 3,
    ...
    'vendor'                  => {
      'consents'             => [23, 42, 126, 127, 128, 587, 613, 626],
      'legitimate_interests' => [24, 44, 129, 130, 131, 591, 614, 628]
    },
    %extra
  };
}
...
sub _fixture_range_default {
  ...
  return {
    ...
    'publisher_country_code'  => 'AA',
    'vendor'                  => {
      'consents' => {'128' => 1, '613' => 1, '127' => 1, '626' => 1, '42' => 1, '23' => 1, '126' => 1, '587' => 1},
      'legitimate_interests' =>
        {'628' => 1, '591' => 1, '130' => 1, '131' => 1, '24' => 1, '129' => 1, '44' => 1, '614' => 1}
    },
    %extra
  };
}
