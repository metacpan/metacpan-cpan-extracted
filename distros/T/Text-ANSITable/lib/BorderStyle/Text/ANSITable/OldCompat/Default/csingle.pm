...
package BorderStyle::Text::ANSITable::OldCompat::Default::csingle;
...
1;
# ABSTRACT: UTF8::SingleLineCurved border style (with old name)
...
BorderStyle::Text::ANSITable::OldCompat::Default::csingle - UTF8::SingleLineCurved border style (with old name)

=head1 VERSION

This document describes version 0.609 of BorderStyle::Text::ANSITable::OldCompat::Default::csingle (from Perl distribution Text-ANSITable), released on 2023-07-14.
