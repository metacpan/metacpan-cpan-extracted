package Chart::Plotly::Trace::Funnelarea::Stream;
use Moose;
...
Chart::Plotly::Trace::Funnelarea::Stream - This attribute is one of the possible options for the trace funnelarea.
