package Pcore::Lib::Hash::Multivalue;

use Pcore;
use Pcore::Lib::Scalar qw[is_arrayref is_hashref is_plain_arrayref];
use Pcore::Lib::List qw[pairkeys];
use Clone qw[];
use Tie::Hash;
