package Google::Ads::AdWords::v201607::DisplayAttribute;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201607::LabelAttribute);
# Variety: sequence
...
DisplayAttribute from the namespace https://adwords.google.com/api/adwords/cm/v201607.
