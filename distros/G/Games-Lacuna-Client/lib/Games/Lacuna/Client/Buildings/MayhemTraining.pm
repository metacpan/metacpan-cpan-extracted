package Games::Lacuna::Client::Buildings::MayhemTraining;
{
  $Games::Lacuna::Client::Buildings::MayhemTraining::VERSION = '0.003';
}
use 5.0080000;
use strict;
use warnings;
...
Games::Lacuna::Client::Buildings::MayhemTraining - The Mayhem Training Facility building
