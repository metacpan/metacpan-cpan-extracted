...
XS_EUPXS(XS_FASTX__Reader__XS__xs_new); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_FASTX__Reader__XS__xs_new)
{
    dVAR; dXSARGS;
    if (items != 2)
...
XS_EUPXS(XS_FASTX__Reader__XS__xs_next_seq); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_FASTX__Reader__XS__xs_next_seq)
{
    dVAR; dXSARGS;
    if (items != 1)
...
XS_EUPXS(XS_FASTX__Reader__XS_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_FASTX__Reader__XS_DESTROY)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "self");
...
extern "C" {
#endif
XS_EXTERNAL(boot_FASTX__Reader__XS); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_FASTX__Reader__XS)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        newXS_deffile("FASTX::Reader::XS::_xs_new", XS_FASTX__Reader__XS__xs_new);
        newXS_deffile("FASTX::Reader::XS::_xs_next_seq", XS_FASTX__Reader__XS__xs_next_seq);
        newXS_deffile("FASTX::Reader::XS::DESTROY", XS_FASTX__Reader__XS_DESTROY);
#if PERL_VERSION_LE(5, 21, 5)
