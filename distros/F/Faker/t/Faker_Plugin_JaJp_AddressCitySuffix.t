...
Faker::Plugin::JaJp::AddressCitySuffix
...
$test->for('synopsis', sub {
  ...
  ok $result->isa('Faker::Plugin::JaJp::AddressCitySuffix');
...
$test->render('lib/Faker/Plugin/JaJp/AddressCitySuffix.pod') if $ENV{RENDER};
