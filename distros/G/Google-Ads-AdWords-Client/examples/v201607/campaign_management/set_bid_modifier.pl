...
use Google::Ads::AdWords::v201607::CampaignCriterionOperation;
use Google::Ads::AdWords::v201607::Platform;
...
sub set_bid_modifier {
  ...
  my $mobile = Google::Ads::AdWords::v201607::Platform->new({id => 30001});

  # Create criterion with modified bid.
  my $criterion = Google::Ads::AdWords::v201607::CampaignCriterion->new({
  ...
  my $operation =
    Google::Ads::AdWords::v201607::CampaignCriterionOperation->new({
      operator => "SET",
      operand  => $criterion
    });
