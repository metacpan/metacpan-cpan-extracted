...
<html>
	<head>
	<title>TimeZone::TimeZoneDB Coverage Report</title>
	<style>
...
<body>
<div class="badges">
	<a href="https://github.com/nigelhorne/TimeZone-TimeZoneDB">
		<img src="https://img.shields.io/github/stars/nigelhorne/TimeZone-TimeZoneDB?style=social" alt="GitHub stars">
	</a>
	<img src="$coverage_badge_url" alt="Coverage badge">
</div>
<h1>TimeZone::TimeZoneDB</h1><h2>Coverage Report</h2>
<table>
...
chomp $commit_sha;
my $github_base = "https://github.com/nigelhorne/TimeZone-TimeZoneDB/blob/$commit_sha/";
...
my $commit_url = "https://github.com/nigelhorne/TimeZone-TimeZoneDB/commit/$commit_sha";
...
foreach my $file (@history_files) {
	...
	my $url = "https://github.com/nigelhorne/TimeZone-TimeZoneDB/commit/$sha";
...
$html .= <<"HTML";
<footer>
	<p>Project: <a href="https://github.com/nigelhorne/TimeZone-TimeZoneDB">TimeZone-TimeZoneDB</a></p>
