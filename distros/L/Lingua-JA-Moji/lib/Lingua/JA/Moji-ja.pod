...
This document describes Lingua::JA::Moji version 0.54
corresponding to git commit L<79035f5895111c7bd0d2da461ebf78cee8c1d517|https://github.com/benkasminbullock/Lingua-JA-Moji/commit/79035f5895111c7bd0d2da461ebf78cee8c1d517> made on Mon Oct 22 20:28:13 2018 +0900.
...
カタカナをシラブルニワケル。たとえば、「ソーシャル」
ハ'ソ', 'ー', 'シ', 'ャ', 'ル'という意味のない文字ではなく、日本語の「原子」ノ'ソー', 'シャ', 'ル'になります。撥音(ん)は前の仮名と一つになります。例えば、「フラナガン」ハ「フ」, 「ラ」, 「ナ」, 「ガン」となります。
...
正規表現に使うかたかなとひらがなにまっちします。

詳しくいうと以下の正規表現

    qr/\p{Katakana}|\p{InKatakana}|\p{InHiragana}|ｰ|ﾞ|ﾟ>/

と殆ど同じことにまっちしますが、C<\p{Katakana}>がマッチする未使用のコードポイントはマッチしません。「・」もマッチしません。変体仮名もマッチしません。
