...
(This example is included as L<F<synopsis.pl>|https://fastapi.metacpan.org/source/BKB/Lingua-JA-FindDates-0.028/examples/synopsis.pl> in the distribution.)
...
(This example is included as L<F<synopsis-replace.pl>|https://fastapi.metacpan.org/source/BKB/Lingua-JA-FindDates-0.028/examples/synopsis-replace.pl> in the distribution.)
...
(This example is included as L<F<synopsis-make-date.pl>|https://fastapi.metacpan.org/source/BKB/Lingua-JA-FindDates-0.028/examples/synopsis-make-date.pl> in the distribution.)
...
(This example is included as L<F<synopsis-nengo.pl>|https://fastapi.metacpan.org/source/BKB/Lingua-JA-FindDates-0.028/examples/synopsis-nengo.pl> in the distribution.)


=head1 VERSION

This documents Lingua::JA::FindDates version 0.028
corresponding to git commit L<21926e6dc89996f842a306c39d7a7f0b7554fab4|https://github.com/benkasminbullock/Lingua--JA--FindDates/commit/21926e6dc89996f842a306c39d7a7f0b7554fab4> released on Mon Nov 19 12:24:41 2018 +0900.
...
(This example is included as L<F<subsjdate-make-date.pl>|https://fastapi.metacpan.org/source/BKB/Lingua-JA-FindDates-0.028/examples/subsjdate-make-date.pl> in the distribution.)
...
(This example is included as L<F<subsjdate-make-interval.pl>|https://fastapi.metacpan.org/source/BKB/Lingua-JA-FindDates-0.028/examples/subsjdate-make-interval.pl> in the distribution.)
...
(This example is included as L<F<seireki-to-nengo.pl>|https://fastapi.metacpan.org/source/BKB/Lingua-JA-FindDates-0.028/examples/seireki-to-nengo.pl> in the distribution.)
...
(This example is included as L<F<nengo-to-seireki.pl>|https://fastapi.metacpan.org/source/BKB/Lingua-JA-FindDates-0.028/examples/nengo-to-seireki.pl> in the distribution.)
...
(This example is included as L<F<make-date.pl>|https://fastapi.metacpan.org/source/BKB/Lingua-JA-FindDates-0.028/examples/make-date.pl> in the distribution.)
...
(This example is included as L<F<my-date.pl>|https://fastapi.metacpan.org/source/BKB/Lingua-JA-FindDates-0.028/examples/my-date.pl> in the distribution.)
...
(This example is included as L<F<default-make-date-interval.pl>|https://fastapi.metacpan.org/source/BKB/Lingua-JA-FindDates-0.028/examples/default-make-date-interval.pl> in the distribution.)
