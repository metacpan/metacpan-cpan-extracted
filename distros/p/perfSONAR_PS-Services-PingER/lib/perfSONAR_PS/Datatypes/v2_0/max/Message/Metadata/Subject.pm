...
=head1 NAME
 ...
 perfSONAR_PS::Datatypes::v2_0::max::Message::Metadata::Subject  - A base class, implements  'subject'  element from the perfSONAR_PS RelaxNG schema
...
=head1 SYNOPSIS
              ...
              use perfSONAR_PS::Datatypes::v2_0::max::Message::Metadata::Subject;
	      
	      my $el =  perfSONAR_PS::Datatypes::v2_0::max::Message::Metadata::Subject->new($DOM_Obj);
