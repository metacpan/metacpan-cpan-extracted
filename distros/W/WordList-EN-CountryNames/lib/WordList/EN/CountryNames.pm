package WordList::EN::CountryNames;
...
our %STATS = ("num_words",249,"num_words_contains_unicode",0,"longest_word_len",36,"shortest_word_len",2,"avg_word_len",10.0923694779116,"num_words_contains_whitespace",72,"num_words_contains_nonword_chars",74); # STATS
...
WordList::EN::CountryNames - English country names

=head1 VERSION

This document describes version 0.04 of WordList::EN::CountryNames (from Perl distribution WordList-EN-CountryNames), released on 2016-01-13.

=head1 SYNOPSIS

 use WordList::EN::CountryNames;

 my $wl = WordList::EN::CountryNames->new;
