...
# 1
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -z "6017.0B.A"          }) xor mb::eval(q{ -z "6017.0B.ソ"          }) },
...
# 11
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ (-z "6017.0B.A"         ) xor (-z "6017.0B.ソ"         ) }) },
...
# 21
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ open(FH1,"6017.0B.A"         ); my $r = -z FH1; close FH1;    $r }) xor mb::eval(q{ -z "6017.0B.ソ"          }) },
...
# 31
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not CORE::eval(q{ -z "6017.0B.A"          }) xor mb::eval(q{ open(FH2,"6017.0B.ソ"         ); -z FH2 }) },
...
# 41
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; not mb::eval(q{ open(FH1,"6017.0B.A"         ); open(FH2,"6017.0B.ソ"         ); (-z FH1) xor (-z FH2) }) },
