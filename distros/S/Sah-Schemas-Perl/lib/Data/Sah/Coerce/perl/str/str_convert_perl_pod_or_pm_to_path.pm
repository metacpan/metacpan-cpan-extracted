...
Data::Sah::Coerce::perl::str::str_convert_perl_pod_or_pm_to_path - Convert POD/module name existing in @INC to its filesystem path

=head1 VERSION

This document describes version 0.020 of Data::Sah::Coerce::perl::str::str_convert_perl_pod_or_pm_to_path (from Perl distribution Sah-Schemas-Perl), released on 2019-07-05.
