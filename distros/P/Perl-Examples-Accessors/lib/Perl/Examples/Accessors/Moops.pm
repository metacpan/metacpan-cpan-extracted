...
Perl::Examples::Accessors::Moops

=head1 VERSION

This document describes version 0.132 of Perl::Examples::Accessors::Moops (from Perl distribution Perl-Examples-Accessors), released on 2021-08-03.
