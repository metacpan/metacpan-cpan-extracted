...
This document describes version 0.008 of Sah::Schema::country::code::alpha3 (from Perl distribution Sah-Schemas-Country), released on 2020-03-08.
...
Using with L<Data::Sah>:
 ...
 my $vdr = gen_validator("country::code::alpha3*");
