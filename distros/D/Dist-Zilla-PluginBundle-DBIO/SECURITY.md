This is the Security Policy for the Perl Dist-Zilla-PluginBundle-DBIO distribution.
...
[Dist-Zilla-PluginBundle-DBIO on CPAN](https://metacpan.org/dist/Dist-Zilla-PluginBundle-DBIO) or the main branch of the
[Dist-Zilla-PluginBundle-DBIO git repository](https://codeberg.org/dbio/dbio-dzil).
...
Dist-Zilla-PluginBundle-DBIO is hosted on Codeberg, which does not support confidential issue
...
Any security vulnerabilities in Dist-Zilla-PluginBundle-DBIO are covered by this policy.
...
they affect Dist-Zilla-PluginBundle-DBIO, or Dist-Zilla-PluginBundle-DBIO can be used to exploit vulnerabilities in
them.

Security vulnerabilities in downstream software (any software that uses
Dist-Zilla-PluginBundle-DBIO, or plugins to it that are not included with the Dist-Zilla-PluginBundle-DBIO
distribution) are not covered by this policy.

## Supported Versions of Dist-Zilla-PluginBundle-DBIO

Only the latest release of Dist-Zilla-PluginBundle-DBIO will be supported for security fixes.

Only major versions of Perl released in the past ten (10) years will be
supported, even when Dist-Zilla-PluginBundle-DBIO will run on older versions of Perl. If a
...
that are required for Dist-Zilla-PluginBundle-DBIO to work. However, some of these
