...
package WWW::Wookie::Module::Build v1.1.4;
...
use parent 'WWW::Wookie::Module::Build::Standard';
...
WWW::Wookie::Module::Build - Customization of L<Module::Build> for
L<WWW::Wookie>.

=head1 DESCRIPTION

This is a custom subclass of L<Module::Build> (actually,
L<WWW::Wookie::Module::Build::Standard>) that enhances existing functionality
and adds more for the benefit of installing and developing L<WWW::Wookie>. The
following actions have been added or redefined:
