...
1;
# ABSTRACT: Dump request stash ($r), by default after action
...
Perinci::CmdLine::Plugin::Debug::DumpR - Dump request stash ($r), by default after action

=head1 VERSION

This document describes version 1.920 of Perinci::CmdLine::Plugin::Debug::DumpR (from Perl distribution Perinci-CmdLine-Lite), released on 2022-04-21.
