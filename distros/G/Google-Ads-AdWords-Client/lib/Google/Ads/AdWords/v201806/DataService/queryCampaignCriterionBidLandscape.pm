...
package Google::Ads::AdWords::v201806::DataService::queryCampaignCriterionBidLandscape;
use strict;
use warnings;
...
__PACKAGE__->__set_name('queryCampaignCriterionBidLandscape');
...
Google::Ads::AdWords::v201806::DataService::queryCampaignCriterionBidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
queryCampaignCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201806.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201806::DataService::queryCampaignCriterionBidLandscape->new($data);
