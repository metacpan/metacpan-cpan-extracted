package Chart::Plotly::Trace::Waterfall::Increasing::Marker;
use Moose;
...
use Chart::Plotly::Trace::Waterfall::Increasing::Marker::Line;
...
has line => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Waterfall::Increasing::Marker::Line", );
...
Chart::Plotly::Trace::Waterfall::Increasing::Marker - This attribute is one of the possible options for the trace waterfall.
