...
use Google::Ads::AdWords::v201802::FirstPartyUploadMetadata;
use Google::Ads::AdWords::v201802::Money;
use Google::Ads::AdWords::v201802::MoneyWithCurrency;
...
use Google::Ads::AdWords::v201802::OfflineData;
use Google::Ads::AdWords::v201802::OfflineDataUploadOperation;
use Google::Ads::AdWords::v201802::StoreSalesTransaction;
use Google::Ads::AdWords::v201802::ThirdPartyUploadMetadata;
use Google::Ads::AdWords::v201802::UploadConversion;
use Google::Ads::AdWords::v201802::UploadMetadata;
use Google::Ads::AdWords::v201802::UserIdentifier;
...
sub upload_offline_data {
  ...
  if ($store_sales_upload_common_metadata_type eq 'FirstPartyUploadMetadata') {
    $offline_data_upload =
      Google::Ads::AdWords::v201802::OfflineDataUpload->new({
        ...
        uploadMetadata   => Google::Ads::AdWords::v201802::UploadMetadata->new({
            StoreSalesUploadCommonMetadata =>
              Google::Ads::AdWords::v201802::FirstPartyUploadMetadata->new({
                loyaltyRate           => "1.0",
    ...
    $store_sales_upload_common_metadata_type eq 'ThirdPartyUploadMetadata')
  {
    $offline_data_upload =
      Google::Ads::AdWords::v201802::OfflineDataUpload->new({
        ...
        uploadMetadata => Google::Ads::AdWords::v201802::UploadMetadata->new({
            StoreSalesUploadCommonMetadata =>
              Google::Ads::AdWords::v201802::ThirdPartyUploadMetadata->new({
                loyaltyRate           => "1.0",
                transactionUploadRate => "1.0",
  ...
  my $offline_data_upload_operation =
    Google::Ads::AdWords::v201802::OfflineDataUploadOperation->new({
      operator => 'ADD',
...
sub _create_offline_data {
  ...
  my $store_sales_transaction =
    Google::Ads::AdWords::v201802::StoreSalesTransaction->new({
      ...
      transactionAmount =>
        Google::Ads::AdWords::v201802::MoneyWithCurrency->new({
          currencyCode => $transaction_currency,
          money        => Google::Ads::AdWords::v201802::Money->new(
  ...
  $Google::Ads::AdWords::v201802::MoneyWithCurrency::OBJECT_NAMESPACE =
    "https://adwords.google.com/api/adwords/rm/v201802";

  my $offline_data = Google::Ads::AdWords::v201802::OfflineData->new({
...
sub _create_user_identifier {
  ...
  my $user_identifier = Google::Ads::AdWords::v201802::UserIdentifier->new({
