package Google::Ads::AdWords::v201809::ConversionTrackingSettings;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::ConversionTrackingSettings

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ConversionTrackingSettings from the namespace https://adwords.google.com/api/adwords/mcm/v201809.
