package Chart::Plotly::Trace::Sunburst::Marker::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Sunburst::Marker::Colorbar::Tickfont - This attribute is one of the possible options for the trace sunburst.
