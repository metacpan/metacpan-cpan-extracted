...
package WebService::Edgecast::auto::Administration::Element::CustomerHttpUpdate;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerHttpUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
WebService::Edgecast::auto::Administration::Element::CustomerHttpUpdate
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerHttpUpdate->new($data);
