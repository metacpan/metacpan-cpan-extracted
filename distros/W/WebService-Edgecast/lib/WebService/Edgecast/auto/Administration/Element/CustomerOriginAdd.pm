...
package WebService::Edgecast::auto::Administration::Element::CustomerOriginAdd;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerOriginAdd::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerOriginAdd');
...
WebService::Edgecast::auto::Administration::Element::CustomerOriginAdd
...
CustomerOriginAdd from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerOriginAdd->new($data);
