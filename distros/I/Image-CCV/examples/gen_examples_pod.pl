...
sub main {
    ...
    my @examples;
    my $module = $ARGV[0]
        or die "Don't know what module to use";
    my $examples_dir = $ARGV[1] || './examples';

    # Get the version from the local module
...
sub print_footer {
    ...
    print "Copyright 2012 by Max Maischein C<corion\@cpan.org>.\n\n";
