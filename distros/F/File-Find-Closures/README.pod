...
=for HTML <a href="https://www.github.com/briandfoy/file-find-closures/actions?query=workflow%3Amacos"><img src="https://www.github.com/briandfoy/file-find-closures/workflows/macos/badge.svg"></a>

=for HTML <a href="https://www.github.com/briandfoy/file-find-closures/actions?query=workflow%3Aubuntu"><img src="https://www.github.com/briandfoy/file-find-closures/workflows/ubuntu/badge.svg"></a>

=for HTML <a href="https://www.github.com/briandfoy/file-find-closures/actions?query=workflow%3Awindows"><img src="https://www.github.com/briandfoy/file-find-closures/workflows/windows/badge.svg"></a>

=for HTML <a href='https://ci.appveyor.com/project/briandfoy/file-find-closures'><img src='https://ci.appveyor.com/api/projects/status/s2emx0wu4x75c5uv'></a>

=for HTML <a href='https://coveralls.io/github/briandfoy/file-find-closures?branch=master'><img src='https://coveralls.io/repos/github/briandfoy/file-find-closures/badge.svg?branch=master' alt='Coverage Status' /></a>

=for HTML <a href="https://github.com/briandfoy/file-find-closures/blob/master/LICENSE"><img src="https://img.shields.io/cpan/l/File-Find-Closures.svg" /></a>

=for HTML <a href="https://metacpan.org/pod/File::Find::Closures"><img src="https://img.shields.io/cpan/v/File-Find-Closures.svg" /></A>

=head1 The File::Find::Closures module

This is the I<README> for the L<File::Find::Closures> Perl module. You're probably
...
To read about L<File::Find::Closures>, look at the embedded documentation
...
name instead of the file location:
	...
	% perldoc File::Find::Closures

You can read the documentation and inspect the meta data at
L<MetaCPAN|https://metacpan.org/pod/File::Find::Closures>.
...
and install the dependencies:
	...
	% cpan File::Find::Closures
	% cpanm File::Find::Closures
...
the source repository: L<https://github.com/briandfoy/file-find-closures>

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/briandfoy/file-find-closures/issues>.
...
=item * L<https://bitbucket.com/briandfoy/file-find-closures>

=item * L<https://codeberg.org/briandfoy/file-find-closures>

=item * L<https://gitlab.com/briandfoy/file-find-closures>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify File-Find-Closures-1.23.tar.gz --owner briandfoy
