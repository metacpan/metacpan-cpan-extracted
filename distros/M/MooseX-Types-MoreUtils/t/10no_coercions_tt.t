...
Test C<< $_no_coercions >> with L<Type::Tiny>.
...
subtest "Type::Tiny-based types, with coercions as coderefs" => sub
{
...
subtest "Type::Tiny-based types, with coercions as strings" => sub
{
	my $type1 = ArrayRef->$_plus_coercions(
		Int, q{ [ (undef) x $_ ] },
		Str, q{ [ split /:/, $_ ] },
...
subtest "Type::Tiny-based types, with coercions as strings, and Sub::Quote loaded" => sub
{
	my $type1 = ArrayRef->$_plus_coercions(
		Int, q{ [ (undef) x $_ ] },
		Str, q{ [ split /:/, $_ ] },
