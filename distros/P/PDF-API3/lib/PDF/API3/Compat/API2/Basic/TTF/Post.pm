...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::TTF::Post;

=head1 NAME

PDF::API3::Compat::API2::Basic::TTF::Post - Holds the Postscript names for each glyph
...
=item $PDF::API3::Compat::API2::Basic::TTF::Post::no25

If set tells PDF::API3::Compat::API2::Basic::TTF::Post::out to use table type 2 instead of 2.5 in case apps
