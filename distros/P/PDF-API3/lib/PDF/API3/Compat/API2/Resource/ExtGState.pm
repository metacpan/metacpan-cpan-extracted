...
package PDF::API3::Compat::API2::Resource::ExtGState;
...
=item $egs = PDF::API3::Compat::API2::Resource::ExtGState->new @parameters
...
=item $font = PDF::API3::Compat::API2::Resource::ExtGState->new_api $api, $name
