...
use Google::Ads::AdWords::v201702::AdWordsConversionTracker;
use Google::Ads::AdWords::v201702::ConversionTrackerOperation;
...
sub add_conversion_tracker {
  ...
  my $conversion_tracker =
    Google::Ads::AdWords::v201702::AdWordsConversionTracker->new({
  ...
  my $conversion_operation =
    Google::Ads::AdWords::v201702::ConversionTrackerOperation->new({
      operator => "ADD",
