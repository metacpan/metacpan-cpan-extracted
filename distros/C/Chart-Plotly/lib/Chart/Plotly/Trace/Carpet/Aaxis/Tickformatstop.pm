package Chart::Plotly::Trace::Carpet::Aaxis::Tickformatstop;
use Moose;
...
Chart::Plotly::Trace::Carpet::Aaxis::Tickformatstop - This attribute is one of the possible options for the trace carpet.
