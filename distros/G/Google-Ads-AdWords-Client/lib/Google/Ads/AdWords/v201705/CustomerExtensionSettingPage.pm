package Google::Ads::AdWords::v201705::CustomerExtensionSettingPage;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201705::Page);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'entries' => 'Google::Ads::AdWords::v201705::CustomerExtensionSetting',
    },
    {
...
CustomerExtensionSettingPage from the namespace https://adwords.google.com/api/adwords/cm/v201705.

Contains a subset of CustomerExtensionSetting objects resulting from a {@code CustomerExtensionSettingService#get} call. 
