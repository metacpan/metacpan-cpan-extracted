...
#pod =attr comment
#pod
#pod This attribute holds an optional hash comment that appears on the C<text:>
#pod line, as allowed by RFC 5228.  If set, it renders as C<text: # comment>.
#pod
#pod =cut
...
Sieve::Generator::Element::Heredoc - a Sieve multiline string (heredoc)
