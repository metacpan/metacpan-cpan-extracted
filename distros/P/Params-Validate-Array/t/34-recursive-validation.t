...

{
    ...
    use Params::Validate::Array qw( validate SCALAR );

    Params::Validate::Array::validation_options( allow_extra => 1 );
...

{
    ...
    use Params::Validate::Array qw( validate SCALAR );
    Params::Validate::Array::validation_options( allow_extra => 0 );
