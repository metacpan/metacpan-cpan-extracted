...
package Amazon::SQS::Model::RemovePermissionResponse;
...
use base qw (Amazon::SQS::Model);
    ...
    #
    # Amazon::SQS::Model::RemovePermissionResponse
    # 
    # Properties:
    #
    # 
    ...
    sub new {
     ...
     #
     # Construct Amazon::SQS::Model::RemovePermissionResponse from XML string
     # 
    sub fromXML {
        my ($self, $xml) = @_;
        eval "use XML::Simple";
        ...
        return new Amazon::SQS::Model::RemovePermissionResponse($tree);
