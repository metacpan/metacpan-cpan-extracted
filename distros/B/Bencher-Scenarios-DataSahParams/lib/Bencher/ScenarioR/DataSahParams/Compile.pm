package Bencher::ScenarioR::DataSahParams::Compile;
  ...
  [
    ...
    ],
    {
      "func.bencher_args"              => {
                                            ...
                                            scenario_module => "DataSahParams::Compile",
                                          },
      ...
      "func.elapsed_time"              => 0.128812074661255,
      "func.module_startup"            => undef,
      "func.module_versions"           => {
                                            "__PACKAGE__" => 1.034,
                                            "Bencher::Scenario::DataSahParams::Compile" => undef,
                                            "Benchmark::Dumb" => "0.10",
      ...
      "func.precision"                 => 0,
      "func.scenario_module"           => "Bencher::Scenario::DataSahParams::Compile",
      "func.scenario_module_md5sum"    => "e459548a49971596eed2db153b9a1269",
      "func.scenario_module_mtime"     => 1464243203,
      "func.scenario_module_sha1sum"   => "cccd5ab6d5dd4d8bd411e44cbcd45aaeed889898",
      "func.scenario_module_sha256sum" => "119e64233bd3253344003aaffabb2c3a582d2914fcb9a6bc13303917413eb6c7",
      "func.time_end"                  => 1485329204.17013,
      "func.time_factor"               => 1000,
      "func.time_start"                => 1485329204.04132,
