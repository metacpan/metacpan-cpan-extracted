	...
	default		=> sub { {
		...
		'BYN' => {
			...
			display_name => {
				...
				'one' => q(Belarussische roebel),
				'other' => q(Belarussische roebel),
			},
		},
		'BYR' => {
			symbol => 'BYR',
		...
		'UYW' => {
			display_name => {
				...
				'one' => q(Uruguayaanse nominale salarisindexeenheid),
				'other' => q(Uruguayaanse nominale salarisindexeenheid),
			},
		},
		'UZS' => {
			symbol => 'UZS',
