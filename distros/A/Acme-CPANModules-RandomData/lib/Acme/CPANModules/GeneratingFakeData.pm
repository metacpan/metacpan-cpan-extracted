...
package Acme::CPANModules::GeneratingFakeData;
...
Acme::CPANModules::GeneratingFakeData - Alias for Acme::CPANModules::RandomData

=head1 VERSION

This document describes version 0.004 of Acme::CPANModules::GeneratingFakeData (from Perl distribution Acme-CPANModules-RandomData), released on 2023-04-10.
...
L<App::cpanm::cpanmodules> distribution):
 ...
 % cpanm-cpanmodules -n GeneratingFakeData

Alternatively you can use the L<cpanmodules> CLI (from L<App::cpanmodules>
distribution):

    % cpanmodules ls-entries GeneratingFakeData | cpanm -n

or L<Acme::CM::Get>:

    % perl -MAcme::CM::Get=GeneratingFakeData -E'say $_->{module} for @{ $LIST->{entries} }' | cpanm -n

or directly:

    % perl -MAcme::CPANModules::GeneratingFakeData -E'say $_->{module} for @{ $Acme::CPANModules::GeneratingFakeData::LIST->{entries} }' | cpanm -n
