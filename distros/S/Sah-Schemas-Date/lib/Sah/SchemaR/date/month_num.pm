...
1;
# ABSTRACT: Month number, coercible from English month names (Dec/DECEMBER), e.g. 2 or "Feb"
...
Sah::SchemaR::date::month_num - Month number, coercible from English month names (Dec/DECEMBER), e.g. 2 or "Feb"
