...
Returns a L<MongoDB::Async::GridFS> for storing and retrieving files from the database.
...
this command will return success. See C<MongoDB::Async::Connection::w> for more
information.
...
L<MongoDB::Async::Examples/"DATABASE COMMANDS"> section.
...
be a string or an instance of L<MongoDB::Async::Code>.  The C<$args> are an optional
