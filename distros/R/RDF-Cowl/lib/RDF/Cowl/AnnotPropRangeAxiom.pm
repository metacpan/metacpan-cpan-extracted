...
$RDF::Cowl::AnnotPropRangeAxiom::VERSION = '1.0.0';
...
RDF::Cowl::AnnotPropRangeAxiom - Represents an AnnotationPropertyRange axiom in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::AnnotPropRangeAxiom>
