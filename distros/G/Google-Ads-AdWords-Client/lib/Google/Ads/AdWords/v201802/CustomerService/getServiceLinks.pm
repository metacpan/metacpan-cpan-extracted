...
package Google::Ads::AdWords::v201802::CustomerService::getServiceLinks;
use strict;
use warnings;
...
Google::Ads::AdWords::v201802::CustomerService::getServiceLinks

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getServiceLinks from the namespace https://adwords.google.com/api/adwords/mcm/v201802.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201802::CustomerService::getServiceLinks->new($data);
