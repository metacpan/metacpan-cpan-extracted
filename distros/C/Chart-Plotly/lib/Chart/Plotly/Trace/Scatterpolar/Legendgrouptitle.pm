package Chart::Plotly::Trace::Scatterpolar::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Scatterpolar::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatterpolar::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Scatterpolar::Legendgrouptitle - This attribute is one of the possible options for the trace scatterpolar.
