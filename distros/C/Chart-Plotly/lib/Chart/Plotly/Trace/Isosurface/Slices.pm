package Chart::Plotly::Trace::Isosurface::Slices;
use Moose;
...
use Chart::Plotly::Trace::Isosurface::Slices::X;
...
has x => ( is  => "rw",
           isa => "Maybe[HashRef]|Chart::Plotly::Trace::Isosurface::Slices::X", );

has y => ( is  => "rw",
           isa => "Maybe[HashRef]|Chart::Plotly::Trace::Isosurface::Slices::Y", );

has z => ( is  => "rw",
           isa => "Maybe[HashRef]|Chart::Plotly::Trace::Isosurface::Slices::Z", );
...
Chart::Plotly::Trace::Isosurface::Slices - This attribute is one of the possible options for the trace isosurface.
