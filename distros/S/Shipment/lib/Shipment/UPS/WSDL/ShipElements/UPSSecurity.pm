...
$Shipment::UPS::WSDL::ShipElements::UPSSecurity::VERSION = '3.04';
use strict;
use warnings;
...
Shipment::UPS::WSDL::ShipElements::UPSSecurity
...
=head2 new
 ...
 my $element = Shipment::UPS::WSDL::ShipElements::UPSSecurity->new($data);
