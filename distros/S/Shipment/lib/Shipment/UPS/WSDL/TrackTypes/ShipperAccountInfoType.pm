package Shipment::UPS::WSDL::TrackTypes::ShipperAccountInfoType;
$Shipment::UPS::WSDL::TrackTypes::ShipperAccountInfoType::VERSION = '3.05';
use strict;
use warnings;
...
ShipperAccountInfoType from the namespace http://www.ups.com/XMLSchema/XOLTWS/Track/v2.0.
