...
FULLEXT = Acme\Intraweb
BASEEXT = Intraweb
PARENT_NAME = Acme
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Acme/Intraweb.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
EXPORT_LIST = Intraweb.def

PERL_ARCHIVE = $(PERL_INC)\perl56.lib

TO_INST_PM = lib/Acme/Intraweb.pm
