...
$cf_condition->Create(Name => 'Condition', LookupType => 'RT::User', Type => 'SelectSingle', RenderType => 'List');
...
$mjs->eval_in_page("jQuery('#Object-RT\\\\:\\\\:User-" . $user->id . "-CustomField-" . $cf_condition->id . "-Value-" . $cf_values->[0]->id . "').trigger('change');");
...
$mjs->eval_in_page("jQuery('#Object-RT\\\\:\\\\:User-" . $user->id . "-CustomField-" . $cf_condition->id . "-Value-" . $cf_values->[1]->id . "').trigger('change');");
...
$user_cf_condition_passed = $mjs->by_id('Object-RT::User-' . $user->id . '-CustomField-' . $cf_condition->id . '-Value-' . $cf_values->[0]->id, single => 1);
$mjs->click($user_cf_condition_passed);
$mjs->eval_in_page("jQuery('#Object-RT\\\\:\\\\:User-" . $user->id . "-CustomField-" . $cf_condition->id . "-Value-" . $cf_values->[0]->id . "').trigger('change');");
