...
=head1 The CPAN::Mini::Inject module

This is the I<README> for the L<CPAN::Mini::Inject> Perl module. It provides
...
To read about L<CPAN::Mini::Inject>, look at the embedded documentation
...
Starting with 1.005, CPAN::Mini::Inject now uses
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify CPAN-Mini-Inject-1.005.tar.gz --owner briandfoy
