...
package TeX::Hyphen::Pattern::El_polyton v1.1.5;
use strict;
use warnings;
use 5.014000;
use utf8;
...
sub version {
    return $TeX::Hyphen::Pattern::El_polyton::VERSION;
}
...
=for stopwords CTAN Ipenburg El_polyton

=head1 NAME

TeX::Hyphen::Pattern::El_polyton - class for hyphenation in locale El_polyton
