package Gtk2::Ex::FormFactory::Entry;
...
sub widget_to_object {
	...
	$self->set_object_value ($self->get_gtk_widget->get_text);
...
sub backup_widget_value {
	...
	$self->set_backup_widget_value ($self->get_gtk_widget->get_text);
...
sub restore_widget_value {
	...
	$self->get_gtk_widget->set_text($self->get_backup_widget_value);
	
	1;
}

sub get_widget_check_value {
	$_[0]->get_gtk_widget->get_text;
}
...
Gtk2::Ex::FormFactory::Entry - An Entry in a FormFactory framework
...
This class implements an Entry in a Gtk2::Ex::FormFactory framework.
