...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::ReservationSlotsGetResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::ReservationSlotsClient->new( credentials => 'dummy' );
