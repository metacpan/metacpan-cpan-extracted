...
=for HTML <a href="https://travis-ci.org/briandfoy/mojo-promise-role-higherorder"><img src="https://travis-ci.org/briandfoy/mojo-promise-role-higherorder.svg?branch=master" /></a>
...
This is the I<README> for the L<Mojo::Promise::Role::HigherOrder>, and
umbrella module for the C<::Any>, C<::None>, and C<::Some> Mojolicious
roles..
