...
1;
# ABSTRACT: Array of Perl TableData::* module names without the prefix, e.g. ["Quote::JamesFT", "Locale::US::State"]
...
Sah::Schema::perl::tabledata::modnames - Array of Perl TableData::* module names without the prefix, e.g. ["Quote::JamesFT", "Locale::US::State"]

=head1 VERSION

This document describes version 0.002 of Sah::Schema::perl::tabledata::modnames (from Perl distribution Sah-Schemas-TableData), released on 2021-09-29.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::tabledata::modnames*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::tabledata::modnames*");
     $validator->(\@args);
     ...
 }
 ...
 $SPEC{myfunc} = {
     ...
     args => {
         arg1 => {
             ...
             schema => ['perl::tabledata::modnames*'],
         },
         ...
     },
 };
...
Array of Perl TableData::* module names, where each element is of
C<perl::tabledata::modname> schema, e.g. C<Quote::JamesFT>,
C<Locale::US::State>.
