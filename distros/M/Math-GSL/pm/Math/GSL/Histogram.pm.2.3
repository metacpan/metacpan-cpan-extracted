...
package Math::GSL::Histogramc;
bootstrap Math::GSL::Histogram;
package Math::GSL::Histogram;
@EXPORT = qw();
...
*gsl_error = *Math::GSL::Histogramc::gsl_error;
*gsl_stream_printf = *Math::GSL::Histogramc::gsl_stream_printf;
*gsl_strerror = *Math::GSL::Histogramc::gsl_strerror;
*gsl_set_error_handler = *Math::GSL::Histogramc::gsl_set_error_handler;
*gsl_set_error_handler_off = *Math::GSL::Histogramc::gsl_set_error_handler_off;
*gsl_set_stream_handler = *Math::GSL::Histogramc::gsl_set_stream_handler;
*gsl_set_stream = *Math::GSL::Histogramc::gsl_set_stream;
*gsl_histogram_alloc = *Math::GSL::Histogramc::gsl_histogram_alloc;
*gsl_histogram_calloc = *Math::GSL::Histogramc::gsl_histogram_calloc;
*gsl_histogram_calloc_uniform = *Math::GSL::Histogramc::gsl_histogram_calloc_uniform;
*gsl_histogram_free = *Math::GSL::Histogramc::gsl_histogram_free;
*gsl_histogram_increment = *Math::GSL::Histogramc::gsl_histogram_increment;
*gsl_histogram_accumulate = *Math::GSL::Histogramc::gsl_histogram_accumulate;
*gsl_histogram_find = *Math::GSL::Histogramc::gsl_histogram_find;
*gsl_histogram_get = *Math::GSL::Histogramc::gsl_histogram_get;
*gsl_histogram_get_range = *Math::GSL::Histogramc::gsl_histogram_get_range;
*gsl_histogram_max = *Math::GSL::Histogramc::gsl_histogram_max;
*gsl_histogram_min = *Math::GSL::Histogramc::gsl_histogram_min;
*gsl_histogram_bins = *Math::GSL::Histogramc::gsl_histogram_bins;
*gsl_histogram_reset = *Math::GSL::Histogramc::gsl_histogram_reset;
*gsl_histogram_calloc_range = *Math::GSL::Histogramc::gsl_histogram_calloc_range;
*gsl_histogram_set_ranges = *Math::GSL::Histogramc::gsl_histogram_set_ranges;
*gsl_histogram_set_ranges_uniform = *Math::GSL::Histogramc::gsl_histogram_set_ranges_uniform;
*gsl_histogram_memcpy = *Math::GSL::Histogramc::gsl_histogram_memcpy;
*gsl_histogram_clone = *Math::GSL::Histogramc::gsl_histogram_clone;
*gsl_histogram_max_val = *Math::GSL::Histogramc::gsl_histogram_max_val;
*gsl_histogram_max_bin = *Math::GSL::Histogramc::gsl_histogram_max_bin;
*gsl_histogram_min_val = *Math::GSL::Histogramc::gsl_histogram_min_val;
*gsl_histogram_min_bin = *Math::GSL::Histogramc::gsl_histogram_min_bin;
*gsl_histogram_equal_bins_p = *Math::GSL::Histogramc::gsl_histogram_equal_bins_p;
*gsl_histogram_add = *Math::GSL::Histogramc::gsl_histogram_add;
*gsl_histogram_sub = *Math::GSL::Histogramc::gsl_histogram_sub;
*gsl_histogram_mul = *Math::GSL::Histogramc::gsl_histogram_mul;
*gsl_histogram_div = *Math::GSL::Histogramc::gsl_histogram_div;
*gsl_histogram_scale = *Math::GSL::Histogramc::gsl_histogram_scale;
*gsl_histogram_shift = *Math::GSL::Histogramc::gsl_histogram_shift;
*gsl_histogram_sigma = *Math::GSL::Histogramc::gsl_histogram_sigma;
*gsl_histogram_mean = *Math::GSL::Histogramc::gsl_histogram_mean;
*gsl_histogram_sum = *Math::GSL::Histogramc::gsl_histogram_sum;
*gsl_histogram_fwrite = *Math::GSL::Histogramc::gsl_histogram_fwrite;
*gsl_histogram_fread = *Math::GSL::Histogramc::gsl_histogram_fread;
*gsl_histogram_fprintf = *Math::GSL::Histogramc::gsl_histogram_fprintf;
*gsl_histogram_fscanf = *Math::GSL::Histogramc::gsl_histogram_fscanf;
*gsl_histogram_pdf_alloc = *Math::GSL::Histogramc::gsl_histogram_pdf_alloc;
*gsl_histogram_pdf_init = *Math::GSL::Histogramc::gsl_histogram_pdf_init;
*gsl_histogram_pdf_free = *Math::GSL::Histogramc::gsl_histogram_pdf_free;
*gsl_histogram_pdf_sample = *Math::GSL::Histogramc::gsl_histogram_pdf_sample;

############# Class : Math::GSL::Histogram::gsl_histogram ##############

package Math::GSL::Histogram::gsl_histogram;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( Math::GSL::Histogram );
%OWNER = ();
%ITERATORS = ();
*swig_n_get = *Math::GSL::Histogramc::gsl_histogram_n_get;
*swig_n_set = *Math::GSL::Histogramc::gsl_histogram_n_set;
*swig_range_get = *Math::GSL::Histogramc::gsl_histogram_range_get;
*swig_range_set = *Math::GSL::Histogramc::gsl_histogram_range_set;
*swig_bin_get = *Math::GSL::Histogramc::gsl_histogram_bin_get;
*swig_bin_set = *Math::GSL::Histogramc::gsl_histogram_bin_set;
sub new {
    my $pkg = shift;
    my $self = Math::GSL::Histogramc::new_gsl_histogram(@_);
...
sub DESTROY {
    ...
    if (exists $OWNER{$self}) {
        Math::GSL::Histogramc::delete_gsl_histogram($self);
        delete $OWNER{$self};
    }
}
...
############# Class : Math::GSL::Histogram::gsl_histogram_pdf ##############

package Math::GSL::Histogram::gsl_histogram_pdf;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( Math::GSL::Histogram );
%OWNER = ();
%ITERATORS = ();
*swig_n_get = *Math::GSL::Histogramc::gsl_histogram_pdf_n_get;
*swig_n_set = *Math::GSL::Histogramc::gsl_histogram_pdf_n_set;
*swig_range_get = *Math::GSL::Histogramc::gsl_histogram_pdf_range_get;
*swig_range_set = *Math::GSL::Histogramc::gsl_histogram_pdf_range_set;
*swig_sum_get = *Math::GSL::Histogramc::gsl_histogram_pdf_sum_get;
*swig_sum_set = *Math::GSL::Histogramc::gsl_histogram_pdf_sum_set;
sub new {
    my $pkg = shift;
    my $self = Math::GSL::Histogramc::new_gsl_histogram_pdf(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        Math::GSL::Histogramc::delete_gsl_histogram_pdf($self);
        delete $OWNER{$self};
    }
}
...
*GSL_VERSION = *Math::GSL::Histogramc::GSL_VERSION;
...
*GSL_SUCCESS = *Math::GSL::Histogramc::GSL_SUCCESS;
*GSL_FAILURE = *Math::GSL::Histogramc::GSL_FAILURE;
*GSL_CONTINUE = *Math::GSL::Histogramc::GSL_CONTINUE;
*GSL_EDOM = *Math::GSL::Histogramc::GSL_EDOM;
*GSL_ERANGE = *Math::GSL::Histogramc::GSL_ERANGE;
*GSL_EFAULT = *Math::GSL::Histogramc::GSL_EFAULT;
*GSL_EINVAL = *Math::GSL::Histogramc::GSL_EINVAL;
*GSL_EFAILED = *Math::GSL::Histogramc::GSL_EFAILED;
*GSL_EFACTOR = *Math::GSL::Histogramc::GSL_EFACTOR;
*GSL_ESANITY = *Math::GSL::Histogramc::GSL_ESANITY;
*GSL_ENOMEM = *Math::GSL::Histogramc::GSL_ENOMEM;
*GSL_EBADFUNC = *Math::GSL::Histogramc::GSL_EBADFUNC;
*GSL_ERUNAWAY = *Math::GSL::Histogramc::GSL_ERUNAWAY;
*GSL_EMAXITER = *Math::GSL::Histogramc::GSL_EMAXITER;
*GSL_EZERODIV = *Math::GSL::Histogramc::GSL_EZERODIV;
*GSL_EBADTOL = *Math::GSL::Histogramc::GSL_EBADTOL;
*GSL_ETOL = *Math::GSL::Histogramc::GSL_ETOL;
*GSL_EUNDRFLW = *Math::GSL::Histogramc::GSL_EUNDRFLW;
*GSL_EOVRFLW = *Math::GSL::Histogramc::GSL_EOVRFLW;
*GSL_ELOSS = *Math::GSL::Histogramc::GSL_ELOSS;
*GSL_EROUND = *Math::GSL::Histogramc::GSL_EROUND;
*GSL_EBADLEN = *Math::GSL::Histogramc::GSL_EBADLEN;
*GSL_ENOTSQR = *Math::GSL::Histogramc::GSL_ENOTSQR;
*GSL_ESING = *Math::GSL::Histogramc::GSL_ESING;
*GSL_EDIVERGE = *Math::GSL::Histogramc::GSL_EDIVERGE;
*GSL_EUNSUP = *Math::GSL::Histogramc::GSL_EUNSUP;
*GSL_EUNIMPL = *Math::GSL::Histogramc::GSL_EUNIMPL;
*GSL_ECACHE = *Math::GSL::Histogramc::GSL_ECACHE;
*GSL_ETABLE = *Math::GSL::Histogramc::GSL_ETABLE;
*GSL_ENOPROG = *Math::GSL::Histogramc::GSL_ENOPROG;
*GSL_ENOPROGJ = *Math::GSL::Histogramc::GSL_ENOPROGJ;
*GSL_ETOLF = *Math::GSL::Histogramc::GSL_ETOLF;
*GSL_ETOLX = *Math::GSL::Histogramc::GSL_ETOLX;
*GSL_ETOLG = *Math::GSL::Histogramc::GSL_ETOLG;
*GSL_EOF = *Math::GSL::Histogramc::GSL_EOF;
