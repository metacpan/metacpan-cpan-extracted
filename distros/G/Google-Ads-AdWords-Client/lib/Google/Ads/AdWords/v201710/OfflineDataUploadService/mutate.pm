...
package Google::Ads::AdWords::v201710::OfflineDataUploadService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201710::OfflineDataUploadOperation',
    },
    {
...
mutate from the namespace https://adwords.google.com/api/adwords/rm/v201710.
