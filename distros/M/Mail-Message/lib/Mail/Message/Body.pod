...
needs to be changed, call the L<encode()|Mail::Message::Body::Encode/"Constructing a body"> or Mail::Message::Body subroutine ecoded method.
...
Using L<encode()|Mail::Message::Body::Encode/"Constructing a body"> (maybe via Mail::Message::Body subroutine decode), you can convert bodies from one
...
This module is part of Mail-Message distribution version 3.014,
built on October 18, 2023. Website: F<http://perl.overmeer.net/CPAN/>
