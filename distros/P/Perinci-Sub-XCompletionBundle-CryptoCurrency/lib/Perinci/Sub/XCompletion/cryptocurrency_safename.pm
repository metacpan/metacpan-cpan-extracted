...
Perinci::Sub::XCompletion::cryptocurrency_safename - Generate completion for cryptocurrency safename

=head1 VERSION

This document describes version 0.004 of Perinci::Sub::XCompletion::cryptocurrency_safename (from Perl distribution Perinci-Sub-XCompletionBundle-CryptoCurrency), released on 2018-05-29.
