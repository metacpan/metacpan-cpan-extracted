...
asn_dec_rval_t
RequestedCAMEL_SubscriptionInfo_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
RequestedCAMEL_SubscriptionInfo_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_RequestedCAMEL_SubscriptionInfo_constr_1 = {
	{ APC_CONSTRAINED,	 4,  4,  0,  8 }	/* (0..8) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_RequestedCAMEL_SubscriptionInfo_value2enum_1[] = {
	{ 0,	5,	"o-CSI" },
	{ 1,	5,	"t-CSI" },
	{ 2,	6,	"vt-CSI" },
	{ 3,	7,	"tif-CSI" },
...
static unsigned int asn_MAP_RequestedCAMEL_SubscriptionInfo_enum2value_1[] = {
	8,	/* d-csi(8) */
	4,	/* gprs-CSI(4) */
	7,	/* m-CSI(7) */
	5,	/* mo-sms-CSI(5) */
...
static asn_INTEGER_specifics_t asn_SPC_RequestedCAMEL_SubscriptionInfo_specs_1 = {
	asn_MAP_RequestedCAMEL_SubscriptionInfo_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_RequestedCAMEL_SubscriptionInfo_enum2value_1,	/* N => "tag"; sorted by N */
...
static ber_tlv_tag_t asn_DEF_RequestedCAMEL_SubscriptionInfo_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_RequestedCAMEL_SubscriptionInfo = {
	...
	RequestedCAMEL_SubscriptionInfo_decode_uper,
	RequestedCAMEL_SubscriptionInfo_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_RequestedCAMEL_SubscriptionInfo_tags_1,
	sizeof(asn_DEF_RequestedCAMEL_SubscriptionInfo_tags_1)
		/sizeof(asn_DEF_RequestedCAMEL_SubscriptionInfo_tags_1[0]), /* 1 */
	asn_DEF_RequestedCAMEL_SubscriptionInfo_tags_1,	/* Same as above */
	sizeof(asn_DEF_RequestedCAMEL_SubscriptionInfo_tags_1)
		/sizeof(asn_DEF_RequestedCAMEL_SubscriptionInfo_tags_1[0]), /* 1 */
	&asn_PER_type_RequestedCAMEL_SubscriptionInfo_constr_1,
	0, 0,	/* Defined elsewhere */
	&asn_SPC_RequestedCAMEL_SubscriptionInfo_specs_1	/* Additional specs */
};
