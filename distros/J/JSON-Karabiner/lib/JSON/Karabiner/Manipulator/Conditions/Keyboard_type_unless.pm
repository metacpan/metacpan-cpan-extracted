...
$JSON::Karabiner::Manipulator::Conditions::Keyboard_type_unless::VERSION = '0.017';
use strict;
use warnings;
use JSON;
use Carp;
...
JSON::Karabiner::Manipulator::Conditions::Keyboard_type_unless - definition for keyboard_type_unless condition
