package Shipment::FedEx::WSDL::ShipTypes::BinaryBarcode;
$Shipment::FedEx::WSDL::ShipTypes::BinaryBarcode::VERSION = '2.03';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    __PACKAGE__->_factory(
        ...
        {   'Type'  => 'Shipment::FedEx::WSDL::ShipTypes::BinaryBarcodeType',
            'Value' => 'SOAP::WSDL::XSD::Typelib::Builtin::base64Binary',
        },
        {
...
BinaryBarcode from the namespace http://fedex.com/ws/ship/v9.
