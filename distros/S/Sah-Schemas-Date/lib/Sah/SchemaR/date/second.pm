...
our $rschema = ["int",[{max=>60,min=>0,summary=>"Second of minute"}],["int"]];
...
This document describes version 0.003 of Sah::SchemaR::date::second (from Perl distribution Sah-Schemas-Date), released on 2019-06-20.
