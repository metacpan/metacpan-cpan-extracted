package Chart::Plotly::Trace::Streamtube::Colorbar::Title;
use Moose;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Streamtube::Colorbar::Title::Font", );
...
Chart::Plotly::Trace::Streamtube::Colorbar::Title - This attribute is one of the possible options for the trace streamtube.
