...
=item * JSON L<Math::Formula::Config::JSON|Math::Formula::Config::JSON> (save)

=item * YAML L<Math::Formula::Config::YAML|Math::Formula::Config::YAML> (save)

=item * INI  L<Math::Formula::Config::INI|Math::Formula::Config::INI>  (save and load)
