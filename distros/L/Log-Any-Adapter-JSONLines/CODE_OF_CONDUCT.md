...
Log-Any-Adapter-JSONLines project a harassment-free experience for everyone,
...
Log-Any-Adapter-JSONLines project include:
...
This Code of Conduct applies within all Log-Any-Adapter-JSONLines project
spaces, and also applies when an individual is officially representing the
Log-Any-Adapter-JSONLines project in public spaces. Examples of representing
the Log-Any-Adapter-JSONLines project include using an official email
