...
package Google::Ads::AdWords::v201809::DataService::getDomainCategory;
use strict;
use warnings;
...
__PACKAGE__->__set_name('getDomainCategory');
...
Google::Ads::AdWords::v201809::DataService::getDomainCategory

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getDomainCategory from the namespace https://adwords.google.com/api/adwords/cm/v201809.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201809::DataService::getDomainCategory->new($data);
