package Google::Ads::AdWords::v201809::AdGroupService::AdGroupServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201809::TypeMaps::AdGroupService
    if not Google::Ads::AdWords::v201809::TypeMaps::AdGroupService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201809/AdGroupService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201809::TypeMaps::AdGroupService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::AdGroupService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201809::AdGroupService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::AdGroupService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::AdGroupService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201809::AdGroupService::query )],
        },
        header => {
...
Google::Ads::AdWords::v201809::AdGroupService::AdGroupServiceInterfacePort - SOAP Interface for the AdGroupService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201809::AdGroupService::AdGroupServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201809::AdGroupService::AdGroupServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/cm/v201809/AdGroupService.
...
Returns a L<Google::Ads::AdWords::v201809::AdGroupService::getResponse|Google::Ads::AdWords::v201809::AdGroupService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::AdGroupService::mutateResponse|Google::Ads::AdWords::v201809::AdGroupService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::AdGroupService::mutateLabelResponse|Google::Ads::AdWords::v201809::AdGroupService::mutateLabelResponse> object.
...
Returns a L<Google::Ads::AdWords::v201809::AdGroupService::queryResponse|Google::Ads::AdWords::v201809::AdGroupService::queryResponse> object.
...
Generated by SOAP::WSDL on Thu Sep 20 11:06:48 2018
