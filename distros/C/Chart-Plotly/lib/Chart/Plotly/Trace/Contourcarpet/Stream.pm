package Chart::Plotly::Trace::Contourcarpet::Stream;
use Moose;
...
Chart::Plotly::Trace::Contourcarpet::Stream - This attribute is one of the possible options for the trace contourcarpet.
