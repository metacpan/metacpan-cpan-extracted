package OWL::DirectSemantics::Element::ObjectExactCardinality;

BEGIN {
	$OWL::DirectSemantics::Element::ObjectExactCardinality::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::ObjectExactCardinality::VERSION   = '0.001';
};
...
OWL::DirectSemantics::Element::ObjectExactCardinality - represents an OWL ObjectExactCardinality

=head1 DESCRIPTION

This class represents the ObjectExactCardinality element in OWL Direct Semantics.
