...
# 1D array with signs
# pdla> p $c = pdl [ 7, -2, +5 ]
# pdla> p $c = pdl q[ 7 -2 +5 ]
# pdla> p $c = pdl q[ 7, -2, +5 ]
# [7 -2 5]

# 1D array with mixed ops and signs
# pdla> p $d = pdl [ 7 - 2, +5 ]
# pdla> p $d = pdl q[ 7 - 2 +5 ]
# [5 5]
...
# A 3x3 2D array
# pdla> p pdl [ [1, 2, 3], [2, 1, 0], [2, 2, 1] ];
# pdla> p $e = pdl q[ [ 1 2 3 ] ; [ 2 1 0 ] ; [ 2 2 1 ] ];
# pdla> p pdl q[  1 2 3 ; 2 1 0 ; 2 2 1 ]  # this should be the same
#
# [
#  [1 2 3]
#  [2 1 0]
