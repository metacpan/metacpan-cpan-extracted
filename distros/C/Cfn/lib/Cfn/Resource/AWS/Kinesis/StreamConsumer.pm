# AWS::Kinesis::StreamConsumer generated from spec 14.3.0
...
package Cfn::Resource::AWS::Kinesis::StreamConsumer {
  ...
  sub supported_regions {
    [ 'ap-northeast-1','ap-northeast-2','ap-northeast-3','ap-south-1','ap-southeast-1','ap-southeast-2','ca-central-1','cn-north-1','cn-northwest-1','eu-central-1','eu-north-1','eu-west-1','eu-west-2','eu-west-3','sa-east-1','us-east-1','us-east-2','us-gov-east-1','us-gov-west-1','us-west-1','us-west-2' ]
  }
}
...
Cfn::Resource::AWS::Kinesis::StreamConsumer - Cfn resource for AWS::Kinesis::StreamConsumer

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::Kinesis::StreamConsumer.
