package DBIx::Schema::Changelog::Action::Functions;

=head1 NAME

DBIx::Schema::Changelog::Action::Functions - Action for functions
...
sub list_from_schema {
    my ( $self, $schema ) = @_;
    my $indiezes = [];
    foreach ( @{ $self->do( $self->driver->actions->{list_functions}, [] ) } ) {
        push(
            @$indiezes,
            {
                type    => 'createindex',
