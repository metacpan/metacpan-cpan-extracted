package Chart::Plotly::Trace::Barpolar::Unselected::Textfont;
use Moose;
...
Chart::Plotly::Trace::Barpolar::Unselected::Textfont - This attribute is one of the possible options for the trace barpolar.
