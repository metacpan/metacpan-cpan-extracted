package Chart::Plotly::Trace::Funnelarea::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Funnelarea::Hoverlabel::Font - This attribute is one of the possible options for the trace funnelarea.
