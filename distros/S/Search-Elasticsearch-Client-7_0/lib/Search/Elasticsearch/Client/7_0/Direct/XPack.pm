...
$Search::Elasticsearch::Client::7_0::Direct::XPack::VERSION = '7.30';
use Moo;
...
Search::Elasticsearch::Client::7_0::Direct::XPack - Plugin providing XPack APIs for Search::Elasticsearch v7.x
