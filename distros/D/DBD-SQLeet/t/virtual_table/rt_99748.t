...
use lib "t/lib";
use SQLeetTest qw/connect_ok $sqleet_sqlite_call has_sqleet_sqlite/;
use Test::More;
use Test::NoWarnings;
...
my $tests = 14;
$tests += 2 if has_sqleet_sqlite('3.6.19');
...
ok $dbh->$sqleet_sqlite_call(create_module =>
                        perl => "DBD::SQLeet::VirtualTable::PerlData"),
   "create_module";
