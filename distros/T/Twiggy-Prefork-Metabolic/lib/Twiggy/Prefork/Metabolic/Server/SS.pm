package Twiggy::Prefork::Metabolic::Server::SS;

# almost all code are stolen from Twiggy::Prefork::Server::SS

use strict;
use warnings;
use parent qw(Twiggy::Prefork::Metabolic::Server);
use AnyEvent;
...
sub start_listen {
    ...
    if (Twiggy::Prefork::Metabolic::Server::DEBUG() && $self->{listen}) {
