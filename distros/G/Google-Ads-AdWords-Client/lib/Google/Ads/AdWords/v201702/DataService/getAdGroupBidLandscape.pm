...
package Google::Ads::AdWords::v201702::DataService::getAdGroupBidLandscape;
use strict;
use warnings;
...
getAdGroupBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201702.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::DataService::getAdGroupBidLandscape->new($data);
