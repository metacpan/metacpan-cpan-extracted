...
The code for this distribution is [hosted on GitHub](https://github.com/houseabsolute/Params-Validate).
...
can submit an issue report [via the web](https://rt.cpan.org/Public/Dist/Display.html?Name=Params-Validate) or [via email](bug-params-validate@rt.cpan.org).
