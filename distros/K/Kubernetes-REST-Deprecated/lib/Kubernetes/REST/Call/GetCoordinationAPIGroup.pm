...
Kubernetes::REST::Call::GetCoordinationAPIGroup - REMOVED -- superseded by Kubernetes::REST's unified v1 API, see Kubernetes::REST::Deprecated
...
C<Kubernetes::REST::Call::GetCoordinationAPIGroup> itself was never functional in the C<1.x> series -- it
...
C<cpanm Kubernetes::REST::Call::GetCoordinationAPIGroup> -- or a cpanfile / code that still references the
...
Kubernetes::REST::Call::GetCoordinationAPIGroup - REMOVED, superseded by Kubernetes::REST's unified v1 API
