package Google::Ads::AdWords::v201710::PromotionFeedItem;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'discountModifier' => 'Google::Ads::AdWords::v201710::PromotionExtensionDiscountModifier',
        'percentOff' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'moneyAmountOff' => 'Google::Ads::AdWords::v201710::MoneyWithCurrency',
        'promotionCode' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'ordersOverAmount' => 'Google::Ads::AdWords::v201710::MoneyWithCurrency',
        'promotionStart' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'promotionEnd' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'occasion' => 'Google::Ads::AdWords::v201710::PromotionExtensionOccasion',
        ...
        'promotionUrlCustomParameters' => 'Google::Ads::AdWords::v201710::CustomParameters',
...
Google::Ads::AdWords::v201710::PromotionFeedItem

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PromotionFeedItem from the namespace https://adwords.google.com/api/adwords/cm/v201710.
