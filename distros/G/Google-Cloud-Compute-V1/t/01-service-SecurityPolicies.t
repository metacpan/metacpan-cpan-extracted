...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::SecurityPoliciesAggregatedList Google::Cloud::Compute::V1::Compute::SecurityPoliciesListPreconfiguredExpressionSetsResponse Google::Cloud::Compute::V1::Compute::SecurityPolicy Google::Cloud::Compute::V1::Compute::SecurityPolicyList Google::Cloud::Compute::V1::Compute::SecurityPolicyRule )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::SecurityPoliciesClient->new( credentials => 'dummy' );
