...
$Shipment::Temando::WSDL::Types::CountryCode::VERSION = '3.10';
use strict;
use warnings;
...
CountryCode from the namespace http://' . $Shipment::Temando::WSDL::Interfaces::quoting_Service::quoting_port::ns_url . '/schema/2009_06/common.xsd.
