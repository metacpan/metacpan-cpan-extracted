...
**BackWall** | **LinkElement** | Returns a  object that represents the back wall of a 3-D chart. |
**CategoryAxis** | **LinkElement** | Gets the chart's X axis. |
**ChartArea** | **LinkElement** | Gets the chart area in the worksheet. |
**ChartDataTable** | **LinkElement** | Represents the chart data table. |
...
**Floor** | **LinkElement** | Returns a  object that represents the walls of a 3-D chart. |
...
**PlotArea** | **LinkElement** | Gets the chart's plot area which includes axis tick labels. |
