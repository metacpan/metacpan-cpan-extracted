package Chart::Plotly::Trace::Scatterpolar::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Scatterpolar::Legendgrouptitle::Font - This attribute is one of the possible options for the trace scatterpolar.
