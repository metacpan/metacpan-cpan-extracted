...
Data::Sah::Filter::perl::Unix::try_convert_unix_user_to_uid - Try to convert Unix username into UID, leave as-is when cannot convert

=head1 VERSION

This document describes version 0.022 of Data::Sah::Filter::perl::Unix::try_convert_unix_user_to_uid (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.
