...
$a{"僜"} = "昞";
if ("$a{'僜'}" eq $a{'僜'}) {
    print qq/ok - 4 "\$a{'僜'}" eq \$a{'僜'} $^X $__FILE__\n/;
}
else {
    print qq/not ok - 4 "\$a{'僜'}" eq \$a{'僜'} $^X $__FILE__\n/;
}
...
$a{"僜"} = "昞";
if (qq{$a{'僜'}} eq $a{'僜'}) {
    print qq/ok - 9 qq{\$a{'僜'}} eq \$a{'僜'} $^X $__FILE__\n/;
}
else {
    print qq/not ok - 9 "\$a{'僜'}" eq \$a{'僜'} $^X $__FILE__\n/;
}
