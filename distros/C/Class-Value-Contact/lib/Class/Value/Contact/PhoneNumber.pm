...
package Class::Value::Contact::PhoneNumber;
our $VERSION = '1.100840';
# ABSTRACT: Contact-related value objects
use parent 'Class::Value::Contact::PhoneLikeNumber';
use constant NORMALIZE_EXCEPTION_NAME =>
  'Class::Value::Contact::Exception::ReplacePhoneNo';
use constant INVALID_VALUE_EXCEPTION_NAME =>
...
Class::Value::Contact::PhoneNumber - Contact-related value objects
