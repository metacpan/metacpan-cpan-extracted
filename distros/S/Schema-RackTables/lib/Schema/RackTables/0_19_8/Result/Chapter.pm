use utf8;
package Schema::RackTables::0_19_8::Result::Chapter;
...
Schema::RackTables::0_19_8::Result::Chapter
...
Related object: L<Schema::RackTables::0_19_8::Result::Dictionary>

=cut

__PACKAGE__->has_many(
  "dictionaries",
  "Schema::RackTables::0_19_8::Result::Dictionary",
  { "foreign.chapter_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4tglRvWoJD9qNoceL7kjEA
