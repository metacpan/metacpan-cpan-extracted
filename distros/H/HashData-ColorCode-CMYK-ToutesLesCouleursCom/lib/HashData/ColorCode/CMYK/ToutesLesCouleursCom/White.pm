package HashData::ColorCode::CMYK::ToutesLesCouleursCom::White;
...
HashData::ColorCode::CMYK::ToutesLesCouleursCom::White - White CMYK color names (from ToutesLesCouleursCom)

=head1 VERSION

This document describes version 0.002 of HashData::ColorCode::CMYK::ToutesLesCouleursCom::White (from Perl distribution HashData-ColorCode-CMYK-ToutesLesCouleursCom), released on 2024-05-10.
