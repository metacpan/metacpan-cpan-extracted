...
package Sah::SchemaR::identifier::lc;
...
Sah::SchemaR::identifier::lc - A string that starts with [a-z_] followed by zero of more [a-z0-9_]

=head1 VERSION

This document describes version 0.002 of Sah::SchemaR::identifier::lc (from Perl distribution Sah-SchemaBundle-Identifier), released on 2025-11-11.
