...
static int asn_MAP_T_BcsmCamelTDPData_oms_1[] = { 4 };
...
static asn_TYPE_tag2member_t asn_MAP_T_BcsmCamelTDPData_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 1, 0, 0 }, /* serviceKey at 2339 */
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 0, 0, 0 }, /* t-BcsmTriggerDetectionPoint at 2338 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 2, 0, 0 }, /* gsmSCF-Address at 2340 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 3, 0, 0 }, /* defaultCallHandling at 2341 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 4, 0, 0 } /* extensionContainer at 2342 */
};
static asn_SEQUENCE_specifics_t asn_SPC_T_BcsmCamelTDPData_specs_1 = {
	...
	asn_MAP_T_BcsmCamelTDPData_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	4,	/* Start extensions */
	6	/* Stop extensions */
};
