package Chart::Plotly::Trace::Heatmapgl::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Heatmapgl::Hoverlabel::Font - This attribute is one of the possible options for the trace heatmapgl.
