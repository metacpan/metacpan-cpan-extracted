package Chart::Plotly::Trace::Barpolar::Marker::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Barpolar::Marker::Colorbar::Tickfont;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Barpolar::Marker::Colorbar::Tickfont", );
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Barpolar::Marker::Colorbar::Tickformatstop]",
);
...
has title => ( is  => "rw",
               isa => "Maybe[HashRef]|Chart::Plotly::Trace::Barpolar::Marker::Colorbar::Title", );
