# AWS::DMS::EventSubscription generated from spec 1.11.0
...
package Cfn::Resource::Properties::AWS::DMS::EventSubscription {
  ...
  has SourceIds => (isa => 'Cfn::Value::Array|Cfn::Value::Function', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Immutable');
