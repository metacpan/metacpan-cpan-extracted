...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::PDF::Objind;

=head1 NAME

PDF::API3::Compat::API2::Basic::PDF::Objind - PDF indirect object reference. Also acts as an abstract
...
=head2 PDF::API3::Compat::API2::Basic::PDF::Objind->new()
...
'C<PDF::API3::Compat::API2::Basic::PDF::File-E<gt>release>' (so you don't have to call it yourself).
...
the C<PDF::API3::Compat::API2::Basic::PDF::Objind> object.  This is done to help ensure that unexpected
