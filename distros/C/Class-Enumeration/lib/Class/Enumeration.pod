...
Each enum class has an C<ordinal()> getter method (an object method), that
returns the C<ordinal> of the enum object (its position in its definition,
...
Each enum class has a C<values()> class method, that returns the list of
the enum objects in the order they were defined. This method is abstract
and gets implemented by the C<Class::Enumeration::Builder> module.
