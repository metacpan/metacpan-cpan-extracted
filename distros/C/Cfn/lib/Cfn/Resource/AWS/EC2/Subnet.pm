# AWS::EC2::Subnet generated from spec 20.1.0
...
package Cfn::Resource::AWS::EC2::Subnet {
  ...
  sub AttributeList {
    [ 'AvailabilityZone','Ipv6CidrBlocks','NetworkAclAssociationId','OutpostArn','VpcId' ]
  }
...
package Cfn::Resource::Properties::AWS::EC2::Subnet {
  ...
  has OutpostArn => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Immutable');
