...
#
package AsposeThreeDCloud::Object::PdfSaveOption;
...
__PACKAGE__->method_documentation({
    ...
    'flip_coordinate_system' => {
    	...
    	description => 'Gets or sets to flip the coordinate system of the scene during exporting.',
    	format => '',
    	read_only => '',
    		},
    'render_mode' => {
    	datatype => 'PdfRenderMode',
    	base_name => 'RenderMode',
    	description => 'Render mode specifies the style in which the 3D artwork is rendered.',
    	format => '',
    	read_only => '',
    		},
    'lighting_scheme' => {
    	datatype => 'PdfLightingScheme',
    	base_name => 'LightingScheme',
