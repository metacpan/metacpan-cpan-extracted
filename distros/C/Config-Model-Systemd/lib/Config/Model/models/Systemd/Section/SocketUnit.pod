...
container> or C<updating the database once per day.>. I< Optional. Type uniline.  > 
...
Configures dependencies similar to C<Wants>, but as long a this unit
...
failed state only after the start limits are reached. I< Optional. Type uniline.  > 
...
C<device-tree-compatible(xyz)> (for systems with a device tree that is compatible to C<xyz>). I< Optional. Type list of uniline.  > 
...
an exclamation mark. I< Optional. Type list of uniline.  > 
...
L<systemd.service(5)>
for more information). I< Optional. Type list of uniline.  > 
...
C<!=>, C<>=> and C<>>. I< Optional. Type list of uniline.  > 
