...
Sah::SchemaR::perl::cellfunc::modnames - Array of Perl CellFunc::* module names without the prefix, e.g. ["File::stat_row", "File::Media::attr_row"]

=head1 VERSION

This document describes version 0.001 of Sah::SchemaR::perl::cellfunc::modnames (from Perl distribution Sah-SchemaBundle-CellFunc), released on 2024-12-10.
