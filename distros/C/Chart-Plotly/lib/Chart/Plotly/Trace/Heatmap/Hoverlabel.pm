package Chart::Plotly::Trace::Heatmap::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Heatmap::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Heatmap::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Heatmap::Hoverlabel - This attribute is one of the possible options for the trace heatmap.
