...
This document describes version 0.025 of TableDataRole::Test::Source::CSVInFile::Select (from Perl distribution TableDataRoles-Standard), released on 2024-05-14.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Test::Source::CSVInFile::Select;

 my $td = TableData::Test::Source::CSVInFile::Select->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Test::Source::CSVInFile::Select --page

 # Get number of rows
 % tabledata --action count_rows Test::Source::CSVInFile::Select
