...
Sah::SchemaR::perl::perl_sah_filter::modname - Perl module in the Data::Sah::Filter::perl::* namespace, without the namespace prefix, e.g. "Phone::format"

=head1 VERSION

This document describes version 0.003 of Sah::SchemaR::perl::perl_sah_filter::modname (from Perl distribution Sah-Schemas-Data-Sah), released on 2023-01-19.
