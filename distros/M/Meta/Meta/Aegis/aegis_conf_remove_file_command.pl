...
aegis_conf_remove_file_command.pl - remove_file aegis hook.
...
=head1 DETAILS
	...
	MANIFEST: aegis_conf_remove_file_command.pl
	PROJECT: meta
	VERSION: 0.01

=head1 SYNOPSIS

	aegis_conf_remove_file_command.pl [options]

=head1 DESCRIPTION

This program handles remove_file aegis actions.
