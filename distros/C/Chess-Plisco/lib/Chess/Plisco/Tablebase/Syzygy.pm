...
$Chess::Plisco::Tablebase::Syzygy::Testing::VERSION = 'v0.7.0';
sub calc_key {
...
$Chess::Plisco::Tablebase::Syzygy::MissingTableException::VERSION = 'v0.7.0';
...
$Chess::Plisco::Tablebase::Syzygy::PairsData::VERSION = 'v0.7.0';
sub new {
	my ($class, %args) = @_;
...
$Chess::Plisco::Tablebase::Syzygy::PawnFileData::VERSION = 'v0.7.0';
sub new {
	my ($class) = @_;
	bless {
		precomp => [],
...
$Chess::Plisco::Tablebase::Syzygy::PawnFileDataDtz::VERSION = 'v0.7.0';
sub new {
	my ($class, %args) = @_;
...
$Chess::Plisco::Tablebase::Syzygy::Table::VERSION = 'v0.7.0';
use integer;
...
$Chess::Plisco::Tablebase::Syzygy::WdlTable::VERSION = 'v0.7.0';
use Chess::Plisco qw(:all);
...
$Chess::Plisco::Tablebase::Syzygy::DtzTable::VERSION = 'v0.7.0';
use Chess::Plisco qw(:all);
...
$Chess::Plisco::Tablebase::Syzygy::VERSION = 'v0.7.0';
