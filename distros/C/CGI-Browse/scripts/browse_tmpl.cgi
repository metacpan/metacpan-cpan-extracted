...
my $params      = { fields   => $fields,
                    ...
                    #urls     => { root => 'http://www.ourpug.org/', browse => 'cgi-bin/eg/browse_tmpl.cgi', link1 => 'cgi-bin/eg/browse_link1.cgi?id=', link2 => 'cgi-bin/eg/browse_link2.cgi?id=', delete => 'cgi-bin/eg/browse_delete.cgi?id=' },
                    ...
                    features => { default_html => 0, delete => 'multi' },
		  };
...
my $result;
   $template->process( \$tmpl, $build, \$result);
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    <td width="36%">[% browse_show %]</td>
    <td width="34%">[% browse_delete %]</td>
    <td width="30%" align="right">[% browse_goto %]</td>
  </tr>
  <tr>
