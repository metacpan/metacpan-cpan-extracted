...
This document describes version 0.019 of Sah::Schema::unix::filename (from Perl distribution Sah-Schemas-Unix), released on 2022-07-24.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("unix::filename*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("unix::filename", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("unix::filename", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("unix::filename*");
     $validator->(\@args);
     ...
 }
