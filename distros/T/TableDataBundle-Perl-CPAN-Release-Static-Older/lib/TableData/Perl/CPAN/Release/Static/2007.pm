...
our %STATS = ("num_rows",14511,"num_columns",9); # STATS
...
TableDataRole::Perl::CPAN::Release::Static::2007 - CPAN releases for the year 2007

=head1 VERSION

This document describes version 20210927.1 of TableDataRole::Perl::CPAN::Release::Static::2007 (from Perl distribution TableDataBundle-Perl-CPAN-Release-Static-Older), released on 2021-10-05.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Perl::CPAN::Release::Static::2007;

 my $td = TableData::Perl::CPAN::Release::Static::2007->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Perl::CPAN::Release::Static::2007 --page

 # Get number of rows
 % tabledata --action count_rows Perl::CPAN::Release::Static::2007
