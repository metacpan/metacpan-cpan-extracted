...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::PDF::Filter;

no warnings qw[ deprecated recursion uninitialized ];

=head1 NAME

PDF::API3::Compat::API2::Basic::PDF::Filter - Abstract superclass for PDF stream filters

=head1 SYNOPSIS

    $f = PDF::API3::Compat::API2::Basic::PDF::Filter->new;
    $str = $f->outfilt($str, 1);
    print OUTFILE $str;
...
=head2 PDF::API3::Compat::API2::Basic::PDF::Filter->new
...
package PDF::API3::Compat::API2::Basic::PDF::ASCII85Decode;

use strict;
use vars qw(@ISA);
@ISA = qw(PDF::API3::Compat::API2::Basic::PDF::Filter);
no warnings qw[ deprecated recursion uninitialized ];

=head1 NAME

PDF::API3::Compat::API2::Basic::PDF::ASCII85Decode - Ascii85 filter for PDF streams. Inherits from
L<PDF::API3::Compat::API2::Basic::PDF::Filter>
...
package PDF::API3::Compat::API2::Basic::PDF::RunLengthDecode;
...
PDF::API3::Compat::API2::Basic::PDF::RunLengthDecode - Run Length encoding filter for PDF streams. Inherits from
L<PDF::API3::Compat::API2::Basic::PDF::Filter>
...
package PDF::API3::Compat::API2::Basic::PDF::ASCIIHexDecode;
...
PDF::API3::Compat::API2::Basic::PDF::ASCIIHexDecode - Ascii Hex encoding (very inefficient) for PDF streams.
Inherits from L<PDF::API3::Compat::API2::Basic::PDF::Filter>
...
package PDF::API3::Compat::API2::Basic::PDF::FlateDecode;
...
package PDF::API3::Compat::API2::Basic::PDF::LZWDecode;

use vars qw(@ISA @basedict);
@ISA = qw(PDF::API3::Compat::API2::Basic::PDF::FlateDecode);
