package Google::Ads::AdWords::v201705::AdWordsConversionTracker;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'textFormat' => 'Google::Ads::AdWords::v201705::AdWordsConversionTracker::TextFormat',
        'conversionPageLanguage' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'backgroundColor' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'trackingCodeType' => 'Google::Ads::AdWords::v201705::AdWordsConversionTracker::TrackingCodeType',
    },
    {
...
AdWordsConversionTracker from the namespace https://adwords.google.com/api/adwords/cm/v201705.
