package Chart::Plotly::Trace::Choroplethmapbox::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Choroplethmapbox::Colorbar::Tickfont - This attribute is one of the possible options for the trace choroplethmapbox.
