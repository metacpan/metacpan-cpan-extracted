package Schema::Test::0_1_0::Result::Person;
...
Schema::Test::0_1_0::Result::Person - DBIx::Class result class for the person table in schema version 0.1.0.

=head1 SYNOPSIS

 use Schema::Test::0_1_0::Result::Person;

 my $obj = Schema::Test::0_1_0::Result::Person->new(%params);
 my $table = $obj->table;
 my $table = Schema::Test::0_1_0::Result::Person->table;

=head1 DESCRIPTION

DBIx::Class result class for the C<person> table in the C<0.1.0> schema
version. The class inherits row behavior from L<DBIx::Class::Row> and source
behavior from L<DBIx::Class::ResultSourceProxy::Table>.
