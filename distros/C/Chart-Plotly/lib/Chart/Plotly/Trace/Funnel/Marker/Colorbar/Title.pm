package Chart::Plotly::Trace::Funnel::Marker::Colorbar::Title;
use Moose;
...
use Chart::Plotly::Trace::Funnel::Marker::Colorbar::Title::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Funnel::Marker::Colorbar::Title::Font", );
...
Chart::Plotly::Trace::Funnel::Marker::Colorbar::Title - This attribute is one of the possible options for the trace funnel.
