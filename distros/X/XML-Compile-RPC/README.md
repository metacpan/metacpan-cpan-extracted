# distribution XML-Compile-RPC

  * My extended documentation: <http://perl.overmeer.net/CPAN/>
  * Development via GitHub: <https://github.com/markov2/perl5-XML-Compile-RPC>
  * Download from CPAN: <ftp://ftp.cpan.org/pub/CPAN/authors/id/M/MA/MARKOV/>
  * Indexed from CPAN: <https://metacpan.org/release/XML-Compile-RPC>

The XML-Compile suite is a large set of modules for various XML related
standards.  This optional component implements RPC... which is a bit
special: RPC does not have a clean schema!  A schema with some hooks
has been created to make this work.
