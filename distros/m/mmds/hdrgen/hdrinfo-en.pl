...
@::hdr_name = (
 ...
 "C.c.",               	#  3  HDR_CC
 "City",               	#  4  HDR_CITY
 "Closing",            	#  5  HDR_CLOSING
 "Cmpny",              	#  6  HDR_CMPY
 "Company",            	#  7  HDR_COMPANY
 "Date",               	#  8  HDR_DATE
 "Dept.",              	#  9  HDR_DEPT
 "Doc-Id",             	# 10  HDR_DOCID
 "Documentstyle",      	# 11  HDR_DOCUMENTSTYLE
 "Enclosure",          	# 12  HDR_ENCL
 "From",               	# 13  HDR_FROM
 "Index",              	# 14  HDR_INDEX
 "Meeting",            	# 15  HDR_MEETING
 "MH-Id",              	# 16  HDR_MHID
 "Next",               	# 17  HDR_NEXT
 "TechNote",           	# 18  HDR_NOTE
 "Number",             	# 19  HDR_NUMBER
 "Offering",           	# 20  HDR_OFFERING
 "Opening",            	# 21  HDR_OPENING
 "Approved",           	# 22  HDR_OK
 "Options",            	# 23  HDR_OPTIONS
 "Phone",              	# 24  HDR_PHONE
 "Present",            	# 25  HDR_PRESENT
 "Project",            	# 26  HDR_PROJECT
 "Reference",          	# 27  HDR_REF
 "Secretary",          	# 28  HDR_SECR
 "Section",            	# 29  HDR_SECTION
 "Sheets",             	# 30  HDR_SLIDES
 "Subject",            	# 31  HDR_SUBJECT
 "Title",              	# 32  HDR_TITLE
 "To",                 	# 33  HDR_TO
 "Version",            	# 34  HDR_VERSION
);
...
@::nls_table = (
 '',                   	#  0  TXT_NULL
 'English',            	#  1  TXT_LANG
 'English',            	#  2  TXT_LANGUAGE
 'Memorandum',         	#  3  TXT_MEMO
 'Table of Contents',  	#  4  TXT_TOC
 'Contents of Section',	#  5  TXT_COS
 'Section',            	#  6  TXT_SECTION
 'Map',                	#  7  TXT_MAP
 'page',               	#  8  TXT_PAGE
 'Ref.',               	#  9  TXT_REF
 'ext.',               	# 10  TXT_PHEXT
 'Yours sincerely,',   	# 11  TXT_CLOSING
 'Configuration Management',	# 12  TXT_CONFMGT
 'Configuration status',	# 13  TXT_CONFSTAT
 'D R A F T',          	# 14  TXT_DRAFT
 'Index',              	# 15  TXT_INDEX
 'Meeting #%d',        	# 16  FMT_MEETING
 '^config.*(status|management)$',	# 17  PAT_CONFIGMGT
 '^(announcements|actions|decisions)\s*$',	# 18  PAT_ANNOUNCE
);
