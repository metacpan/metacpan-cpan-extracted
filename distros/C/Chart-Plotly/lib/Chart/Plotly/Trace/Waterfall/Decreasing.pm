package Chart::Plotly::Trace::Waterfall::Decreasing;
use Moose;
...
use Chart::Plotly::Trace::Waterfall::Decreasing::Marker;
...
has marker => ( is  => "rw",
                isa => "Maybe[HashRef]|Chart::Plotly::Trace::Waterfall::Decreasing::Marker", );
...
Chart::Plotly::Trace::Waterfall::Decreasing - This attribute is one of the possible options for the trace waterfall.
