package Perinci::Sub::XCompletion::perl_cellfunc_modname_with_optional_args;
...
sub gen_completion {
    ...
    sub {
        ...
        my $meta = ${"$module\::SPEC"}{func};
        do { log_trace "Module $module does not define Rinci metadata for 'func'"; return [$word_mod] } unless $meta;

        do { log_trace "Module $module\'s metadata does not define args"; return [$word_mod] } unless $meta->{args} && keys(%{ $meta->{args} });

        delete $meta->{args}{value};
...
Perinci::Sub::XCompletion::perl_cellfunc_modname_with_optional_args - Generate completion for SortKey::* module name with optional params

=head1 VERSION

This document describes version 0.001 of Perinci::Sub::XCompletion::perl_cellfunc_modname_with_optional_args (from Perl distribution Sah-SchemaBundle-CellFunc), released on 2024-12-10.
