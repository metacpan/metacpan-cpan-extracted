package Chart::Plotly::Trace::Indicator::Delta::Increasing;
use Moose;
...
Chart::Plotly::Trace::Indicator::Delta::Increasing - This attribute is one of the possible options for the trace indicator.
