package Chart::Plotly::Trace::Icicle::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Icicle::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Icicle::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Icicle::Legendgrouptitle - This attribute is one of the possible options for the trace icicle.
