package Chart::Plotly::Trace::Scattercarpet::Marker::Gradient;
use Moose;
...
Chart::Plotly::Trace::Scattercarpet::Marker::Gradient - This attribute is one of the possible options for the trace scattercarpet.
