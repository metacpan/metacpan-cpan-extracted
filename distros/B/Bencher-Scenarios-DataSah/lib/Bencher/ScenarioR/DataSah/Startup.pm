package Bencher::ScenarioR::DataSah::Startup;
...
our $results = [
  [
    ...
    [
      {
        errors => 9.2e-05,
        participant => "genval_str_5typical",
        rate => 18,
        samples => 20,
        time => 57,
        vs_slowest => 1,
    ...
    ],
    {
      "func.bencher_args"              => {
                                            ...
                                            scenario_module => "DataSah::Startup",
                                          },
      ...
      "func.elapsed_time"              => 6.63912296295166,
      "func.module_startup"            => undef,
      "func.module_versions"           => {
                                            "__PACKAGE__" => 1.034,
                                            "Bencher::Scenario::DataSah::Startup" => undef,
                                            "Benchmark::Dumb" => "0.10",
      ...
      "func.precision"                 => 0,
      "func.scenario_module"           => "Bencher::Scenario::DataSah::Startup",
      "func.scenario_module_md5sum"    => "92d744cb1d0f2b73f5bd2d8e7eed582d",
      "func.scenario_module_mtime"     => 1463395211,
      "func.scenario_module_sha1sum"   => "2f847d1406f7e9271698f2441f923d22b15cc079",
      "func.scenario_module_sha256sum" => "0d5565b4d028257afe57a290a91cfc6eaf1ad5e0821eb62f492ce4c105d1bb68",
      "func.time_end"                  => 1485329063.05551,
      "func.time_factor"               => 1000,
      "func.time_start"                => 1485329056.41639,
