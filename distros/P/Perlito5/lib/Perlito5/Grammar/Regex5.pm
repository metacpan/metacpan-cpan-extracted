...

{
    ...
    sub Perlito5::Grammar::Regex5::posix_character_class {
        ...
        my $tmp = ((do {
            my $pos1 = $MATCH->{'to'};
            (do {;
                (('a' eq $str->[$MATCH->{'to'} + 0]) && ('l' eq $str->[$MATCH->{'to'} + 1]) && ('p' eq $str->[$MATCH->{'to'} + 2]) && ('h' eq $str->[$MATCH->{'to'} + 3]) && ('a' eq $str->[$MATCH->{'to'} + 4]) && ($MATCH->{'to'} += 5))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('a' eq $str->[$MATCH->{'to'} + 0]) && ('l' eq $str->[$MATCH->{'to'} + 1]) && ('n' eq $str->[$MATCH->{'to'} + 2]) && ('u' eq $str->[$MATCH->{'to'} + 3]) && ('m' eq $str->[$MATCH->{'to'} + 4]) && ($MATCH->{'to'} += 5))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('a' eq $str->[$MATCH->{'to'} + 0]) && ('s' eq $str->[$MATCH->{'to'} + 1]) && ('c' eq $str->[$MATCH->{'to'} + 2]) && ('i' eq $str->[$MATCH->{'to'} + 3]) && ('i' eq $str->[$MATCH->{'to'} + 4]) && ($MATCH->{'to'} += 5))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('b' eq $str->[$MATCH->{'to'} + 0]) && ('l' eq $str->[$MATCH->{'to'} + 1]) && ('a' eq $str->[$MATCH->{'to'} + 2]) && ('n' eq $str->[$MATCH->{'to'} + 3]) && ('k' eq $str->[$MATCH->{'to'} + 4]) && ($MATCH->{'to'} += 5))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('c' eq $str->[$MATCH->{'to'} + 0]) && ('n' eq $str->[$MATCH->{'to'} + 1]) && ('t' eq $str->[$MATCH->{'to'} + 2]) && ('r' eq $str->[$MATCH->{'to'} + 3]) && ('l' eq $str->[$MATCH->{'to'} + 4]) && ($MATCH->{'to'} += 5))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('d' eq $str->[$MATCH->{'to'} + 0]) && ('i' eq $str->[$MATCH->{'to'} + 1]) && ('g' eq $str->[$MATCH->{'to'} + 2]) && ('i' eq $str->[$MATCH->{'to'} + 3]) && ('t' eq $str->[$MATCH->{'to'} + 4]) && ($MATCH->{'to'} += 5))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('g' eq $str->[$MATCH->{'to'} + 0]) && ('r' eq $str->[$MATCH->{'to'} + 1]) && ('a' eq $str->[$MATCH->{'to'} + 2]) && ('p' eq $str->[$MATCH->{'to'} + 3]) && ('h' eq $str->[$MATCH->{'to'} + 4]) && ($MATCH->{'to'} += 5))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('l' eq $str->[$MATCH->{'to'} + 0]) && ('o' eq $str->[$MATCH->{'to'} + 1]) && ('w' eq $str->[$MATCH->{'to'} + 2]) && ('e' eq $str->[$MATCH->{'to'} + 3]) && ('r' eq $str->[$MATCH->{'to'} + 4]) && ($MATCH->{'to'} += 5))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('p' eq $str->[$MATCH->{'to'} + 0]) && ('r' eq $str->[$MATCH->{'to'} + 1]) && ('i' eq $str->[$MATCH->{'to'} + 2]) && ('n' eq $str->[$MATCH->{'to'} + 3]) && ('t' eq $str->[$MATCH->{'to'} + 4]) && ($MATCH->{'to'} += 5))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('p' eq $str->[$MATCH->{'to'} + 0]) && ('u' eq $str->[$MATCH->{'to'} + 1]) && ('n' eq $str->[$MATCH->{'to'} + 2]) && ('c' eq $str->[$MATCH->{'to'} + 3]) && ('t' eq $str->[$MATCH->{'to'} + 4]) && ($MATCH->{'to'} += 5))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('s' eq $str->[$MATCH->{'to'} + 0]) && ('p' eq $str->[$MATCH->{'to'} + 1]) && ('a' eq $str->[$MATCH->{'to'} + 2]) && ('c' eq $str->[$MATCH->{'to'} + 3]) && ('e' eq $str->[$MATCH->{'to'} + 4]) && ($MATCH->{'to'} += 5))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('u' eq $str->[$MATCH->{'to'} + 0]) && ('p' eq $str->[$MATCH->{'to'} + 1]) && ('p' eq $str->[$MATCH->{'to'} + 2]) && ('e' eq $str->[$MATCH->{'to'} + 3]) && ('r' eq $str->[$MATCH->{'to'} + 4]) && ($MATCH->{'to'} += 5))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('w' eq $str->[$MATCH->{'to'} + 0]) && ('o' eq $str->[$MATCH->{'to'} + 1]) && ('r' eq $str->[$MATCH->{'to'} + 2]) && ('d' eq $str->[$MATCH->{'to'} + 3]) && ($MATCH->{'to'} += 4))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('x' eq $str->[$MATCH->{'to'} + 0]) && ('d' eq $str->[$MATCH->{'to'} + 1]) && ('i' eq $str->[$MATCH->{'to'} + 2]) && ('g' eq $str->[$MATCH->{'to'} + 3]) && ('i' eq $str->[$MATCH->{'to'} + 4]) && ('t' eq $str->[$MATCH->{'to'} + 5]) && ($MATCH->{'to'} += 6))
            })
        }));
        $tmp ? $MATCH : undef
    }
    ...
    sub Perlito5::Grammar::Regex5::character_class {
        ...
        my $tmp = ((do {
            ...
            (do {;
                ...
                $MATCH->{'to'} = $pos1;
                ((('[' eq $str->[$MATCH->{'to'} + 0]) && (':' eq $str->[$MATCH->{'to'} + 1]) && ('^' eq $str->[$MATCH->{'to'} + 2]) && ($MATCH->{'to'} += 3)) && (do {
                    my $m2 = posix_character_class($str, $MATCH->{'to'});
                    if ($m2) {
                        $MATCH->{'to'} = $m2->{'to'};
                        $MATCH->{'posix_character_class'} = $m2;
    ...
    sub Perlito5::Grammar::Regex5::verb {
        ...
        my $tmp = ((do {
            my $pos1 = $MATCH->{'to'};
            (do {;
                (('P' eq $str->[$MATCH->{'to'} + 0]) && ('R' eq $str->[$MATCH->{'to'} + 1]) && ('U' eq $str->[$MATCH->{'to'} + 2]) && ('N' eq $str->[$MATCH->{'to'} + 3]) && ('E' eq $str->[$MATCH->{'to'} + 4]) && ($MATCH->{'to'} += 5))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('S' eq $str->[$MATCH->{'to'} + 0]) && ('K' eq $str->[$MATCH->{'to'} + 1]) && ('I' eq $str->[$MATCH->{'to'} + 2]) && ('P' eq $str->[$MATCH->{'to'} + 3]) && ($MATCH->{'to'} += 4))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('M' eq $str->[$MATCH->{'to'} + 0]) && ('A' eq $str->[$MATCH->{'to'} + 1]) && ('R' eq $str->[$MATCH->{'to'} + 2]) && ('K' eq $str->[$MATCH->{'to'} + 3]) && ($MATCH->{'to'} += 4))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('T' eq $str->[$MATCH->{'to'} + 0]) && ('H' eq $str->[$MATCH->{'to'} + 1]) && ('E' eq $str->[$MATCH->{'to'} + 2]) && ('N' eq $str->[$MATCH->{'to'} + 3]) && ($MATCH->{'to'} += 4))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('C' eq $str->[$MATCH->{'to'} + 0]) && ('O' eq $str->[$MATCH->{'to'} + 1]) && ('M' eq $str->[$MATCH->{'to'} + 2]) && ('M' eq $str->[$MATCH->{'to'} + 3]) && ('I' eq $str->[$MATCH->{'to'} + 4]) && ('T' eq $str->[$MATCH->{'to'} + 5]) && ($MATCH->{'to'} += 6))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('F' eq $str->[$MATCH->{'to'} + 0]) && ('A' eq $str->[$MATCH->{'to'} + 1]) && ('I' eq $str->[$MATCH->{'to'} + 2]) && ('L' eq $str->[$MATCH->{'to'} + 3]) && ($MATCH->{'to'} += 4))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('F' eq $str->[$MATCH->{'to'} + 0]) && ($MATCH->{'to'} += 1))
            }) || (do {
                $MATCH->{'to'} = $pos1;
                (('A' eq $str->[$MATCH->{'to'} + 0]) && ('C' eq $str->[$MATCH->{'to'} + 1]) && ('C' eq $str->[$MATCH->{'to'} + 2]) && ('E' eq $str->[$MATCH->{'to'} + 3]) && ('P' eq $str->[$MATCH->{'to'} + 4]) && ('T' eq $str->[$MATCH->{'to'} + 5]) && ($MATCH->{'to'} += 6))
            })
        }));
        $tmp ? $MATCH : undef
    }
            ...
            (do {;
                ...
                ((('{' eq $str->[$MATCH->{'to'} + 0]) && ($MATCH->{'to'} += 1)) && (do {
                    ...
                    (do {;
                        ...
                        $MATCH->{'to'} = $pos1;
                        (((',' eq $str->[$MATCH->{'to'} + 0]) && ($MATCH->{'to'} += 1)) && (('}' eq $str->[$MATCH->{'to'} + 0]) && ($MATCH->{'to'} += 1)))
                    }) || (do {
                        $MATCH->{'to'} = $pos1;
                        (((',' eq $str->[$MATCH->{'to'} + 0]) && ($MATCH->{'to'} += 1)) && (do {
                            my $m2 = Perlito5::Grammar::Number::digits($str, $MATCH->{'to'});
