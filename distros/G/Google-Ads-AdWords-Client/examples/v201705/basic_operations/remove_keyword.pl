...
use Google::Ads::AdWords::v201705::AdGroupCriterion;
...
sub remove_keyword {
  ...
  my $criterion =
    Google::Ads::AdWords::v201705::Criterion->new({id => $keyword_id});

  # Create ad group criterion.
  my $ad_group_criterion = Google::Ads::AdWords::v201705::AdGroupCriterion->new(
    {
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201705::AdGroupCriterionOperation->new(
    {
