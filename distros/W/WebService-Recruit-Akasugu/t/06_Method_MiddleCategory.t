#
# Test case for WebService::Recruit::Akasugu::MiddleCategory
#
...
my $service = new WebService::Recruit::Akasugu::MiddleCategory();

ok( ref $service, 'new WebService::Recruit::Akasugu::MiddleCategory()' );
...
# Test[0]
{
    ...
    my $res = new WebService::Recruit::Akasugu::MiddleCategory();
    ...
    ok( eval { $data->middle_category }, 'Test[0]: middle_category' );
    ok( eval { ref $data->middle_category } eq 'ARRAY', 'Test[0]: middle_category' );
    can_ok( $data->middle_category->[0], 'code' );
    ok( eval { $data->middle_category->[0]->code }, 'Test[0]: code' );
    can_ok( $data->middle_category->[0], 'name' );
    ok( eval { $data->middle_category->[0]->name }, 'Test[0]: name' );
    can_ok( $data->middle_category->[0], 'large_category' );
    ok( eval { $data->middle_category->[0]->large_category }, 'Test[0]: large_category' );
    can_ok( $data->middle_category->[0]->large_category, 'code' );
    ok( eval { $data->middle_category->[0]->large_category->code }, 'Test[0]: code' );
    can_ok( $data->middle_category->[0]->large_category, 'name' );
    ok( eval { $data->middle_category->[0]->large_category->name }, 'Test[0]: name' );
}
