...
IO::K8s::VolumeSnapshot::V1beta2::VolumeGroupSnapshotContentStatus - VolumeGroupSnapshotContentStatus defines the observed group snapshot content state
