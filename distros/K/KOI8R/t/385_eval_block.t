...
# eval {...} has eval "..."
if (eval { eval KOI8R::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } " }) {
...
# eval {...} has eval qq{...}
if (eval { eval KOI8R::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } }) {
...
# eval {...} has eval '...'
if (eval { eval KOI8R::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } ' }) {
...
# eval {...} has eval q{...}
if (eval { eval KOI8R::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } }) {
