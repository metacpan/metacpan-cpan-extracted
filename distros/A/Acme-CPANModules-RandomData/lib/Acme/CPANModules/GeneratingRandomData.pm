...
Acme::CPANModules::GeneratingRandomData - Alias for Acme::CPANModules::RandomData

=head1 VERSION

This document describes version 0.004 of Acme::CPANModules::GeneratingRandomData (from Perl distribution Acme-CPANModules-RandomData), released on 2023-04-10.
...
L<App::cpanm::cpanmodules> distribution):
 ...
 % cpanm-cpanmodules -n GeneratingRandomData

Alternatively you can use the L<cpanmodules> CLI (from L<App::cpanmodules>
distribution):

    % cpanmodules ls-entries GeneratingRandomData | cpanm -n

or L<Acme::CM::Get>:

    % perl -MAcme::CM::Get=GeneratingRandomData -E'say $_->{module} for @{ $LIST->{entries} }' | cpanm -n

or directly:

    % perl -MAcme::CPANModules::GeneratingRandomData -E'say $_->{module} for @{ $Acme::CPANModules::GeneratingRandomData::LIST->{entries} }' | cpanm -n
