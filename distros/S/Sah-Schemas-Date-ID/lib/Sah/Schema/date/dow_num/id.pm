...
our $schema = [int => {
    ...
    min => 1,
    max => 7,
    'x.perl.coerce_rules' => ['str_convert_id_dow_name_to_num'],
...
This document describes version 0.002 of Sah::Schema::date::dow_num::id (from Perl distribution Sah-Schemas-Date-ID), released on 2019-07-21.
