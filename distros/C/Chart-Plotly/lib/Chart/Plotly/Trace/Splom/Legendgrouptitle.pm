package Chart::Plotly::Trace::Splom::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Splom::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Splom::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Splom::Legendgrouptitle - This attribute is one of the possible options for the trace splom.
