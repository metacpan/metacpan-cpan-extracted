...
$Shipment::Temando::WSDL::Types::ZoneName::VERSION = '3.07';
use strict;
use warnings;
...
ZoneName from the namespace http://' . $Shipment::Temando::WSDL::Interfaces::quoting_Service::quoting_port::ns_url . '/schema/2009_06/common.xsd.
