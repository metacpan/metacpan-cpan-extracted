...
coerce 'Cfn::Resource::Properties::AWS::MediaConvert::Queue',
  from 'HashRef',
   via { Cfn::Resource::Properties::AWS::MediaConvert::Queue->new( %$_ ) };

package Cfn::Resource::AWS::MediaConvert::Queue {
  use Moose;
  extends 'Cfn::Resource';
  has Properties => (isa => 'Cfn::Resource::Properties::AWS::MediaConvert::Queue', is => 'rw', coerce => 1);
...
package Cfn::Resource::Properties::AWS::MediaConvert::Queue {
  use Moose;
  ...
  has PricingPlan => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
