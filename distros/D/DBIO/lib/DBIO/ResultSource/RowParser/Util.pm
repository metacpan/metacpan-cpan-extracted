...
DBIO::ResultSource::RowParser::Util - Assemble row-parser source code for simple and collapsing queries
...
=head2 __wrap_in_strictured_scope

=head2 assemble_simple_parser

=head2 __visit_infmap_simple

=head2 assemble_collapsing_parser

=head2 __visit_infmap_collapse

=head2 __result_struct_to_source
