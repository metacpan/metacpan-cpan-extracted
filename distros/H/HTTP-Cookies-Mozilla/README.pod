...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/HTTP-Cookies-Mozilla> or 
L<MetaCPAN|http://www.metacpan.org/module/HTTP::Cookies::Mozilla>:

=over 4

=item *	L<http://search.cpan.org/dist/HTTP-Cookies-Mozilla>

=item *	L<http://www.metacpan.org/module/HTTP::Cookies::Mozilla>
