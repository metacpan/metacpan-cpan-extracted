...
use warnings;
use lib '../lib';
use Array::CompareAndFilter "compareItem";
...
sub compare {
    ...
    if (compareItem($arr1_ref, $arr2_ref)) {
        print("Result: \@array1 has equal item content like \@array2\n");
        $result = 1;
    }
    else {
...
print("Examples for compareItem()\n");
my @array1 = (1, 2, 3, 4, 5);
my @array2 = (5, 4, 3, 2, 1);
...
#  @array1: 1 2 3 4 5
#  @array2: 5 4 3 2 1
#  Result: @array1 has equal item content like @array2
