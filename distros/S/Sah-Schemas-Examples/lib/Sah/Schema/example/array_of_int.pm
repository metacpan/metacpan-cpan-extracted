...
Sah::Schema::example::array_of_int - Array of integers

=head1 VERSION

This document describes version 0.006 of Sah::Schema::example::array_of_int (from Perl distribution Sah-Schemas-Examples), released on 2020-05-27.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("example::array_of_int*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("example::array_of_int*");
     $validator->(\@args);
     ...
 }
