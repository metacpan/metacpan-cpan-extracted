...
This document describes version 0.45 of Perinci::Access::Manual::FAQ (from Perl distribution Perinci-Access), released on 2017-07-10.

=head1 FAQ

=head2 How do I debug my program?

Most P::A libraries use L<Log::ger>, so you can see the logs they produce by any
Log::ger output.
