...
#pod
#pod This is C<Hook::AfterMint> plugin implementation. Nothing interesting, just using few roles.
#pod
...
#pod = L<Dist::Zilla>
#pod = L<Dist::Zilla::Role::AfterMint>
#pod
#pod =cut

package Dist::Zilla::Plugin::Hook::AfterMint;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::AfterMint> plugin implementation
our $VERSION = 'v0.8.3'; # VERSION

with 'Dist::Zilla::Role::Plugin';
with 'Dist::Zilla::Role::Hooker' => {
    -alias => { hook => 'after_mint' },
};
...
Dist::Zilla::Plugin::Hook::AfterMint - C<Hook::AfterMint> plugin implementation
...
This is C<Hook::AfterMint> plugin implementation. Nothing interesting, just using few roles.
...
=item L<Dist::Zilla::Role::AfterMint>
