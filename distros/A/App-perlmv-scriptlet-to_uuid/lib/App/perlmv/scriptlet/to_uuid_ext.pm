...
# ABSTRACT: Rename to UUID, preserve extension
...
App::perlmv::scriptlet::to_uuid_ext - Rename to UUID, preserve extension

=head1 VERSION

This document describes version 0.001 of App::perlmv::scriptlet::to_uuid_ext (from Perl distribution App-perlmv-scriptlet-to_uuid), released on 2020-08-04.
