...
# FYI,
#
# I wrote a simple text file to PDF converter that uses PDF::API3::Compat::API2::Lite.
...
Options:
  ...
  Also, many thanks to the PDF::API3::Compat::API2 community for such great ideas.
