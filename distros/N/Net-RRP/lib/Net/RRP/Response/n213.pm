package Net::RRP::Response::n213;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n213::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n213::VERSION = '0.1';
...
Net::RRP::Response::n213 - the 213 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
