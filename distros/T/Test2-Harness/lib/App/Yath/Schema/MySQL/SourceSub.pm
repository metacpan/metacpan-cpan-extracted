use utf8;
package App::Yath::Schema::MySQL::SourceSub;
...
App::Yath::Schema::MySQL::SourceSub - Autogenerated result class for SourceSub in MySQL.

=head1 SEE ALSO

L<App::Yath::Schema::Overlay::SourceSub> - Where methods that are not
