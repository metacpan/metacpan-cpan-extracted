package Chart::Plotly::Trace::Histogram2d::Xbins::ImpliedEdits;
use Moose;
...
Chart::Plotly::Trace::Histogram2d::Xbins::ImpliedEdits - This attribute is one of the possible options for the trace histogram2d.
