...
This document describes version 0.015 of Sah::Schema::color::ansi256 (from Perl distribution Sah-SchemaBundle-Color), released on 2024-06-08.

=head1 SAH SCHEMA DEFINITION

 ["int", { min => 0, max => 255 }]

Base type: L<int|Data::Sah::Type::int>
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("color::ansi256", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("color::ansi256", {return_type=>'str_errmsg+val'});
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"color::ansi256*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('color::ansi256*', name=>'ColorAnsi256')
     );
 }

 use My::Types qw(ColorAnsi256);
 ColorAnsi256->assert_valid($data);
