use utf8;
package Schema::RackTables::0_17_9::Result::Config;
...
Schema::RackTables::0_17_9::Result::Config
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DL49se+7X5XKGScyHAGQCQ
