...
----------------------------------------------------------------------
    ...
    Game-RaycastFOV/ppport.h -- Perl/Pollution/Portability Version 3.56
    ...
    Use 'perldoc Game-RaycastFOV/ppport.h' to view the documentation below.
...
=head1 SYNOPSIS
  ...
  perl Game-RaycastFOV/ppport.h [options] [source files]
...
This version of F<Game-RaycastFOV/ppport.h> is designed to support operation with Perl
...
Display the version of F<Game-RaycastFOV/ppport.h>.
...
Tell F<Game-RaycastFOV/ppport.h> to check for compatibility with the given
Perl version. The default is to check for compatibility with Perl
version 5.003_07. You can use this option to reduce the output
of F<Game-RaycastFOV/ppport.h> if you intend to be backward compatible only
down to a certain Perl version.

=head2 --cplusplus

Usually, F<Game-RaycastFOV/ppport.h> will detect C++ style comments and
replace them with C style comments for portability reasons.
Using this option instructs F<Game-RaycastFOV/ppport.h> to leave C++
comments untouched.
...
Strip all script and documentation functionality from F<Game-RaycastFOV/ppport.h>.
This reduces the size of F<Game-RaycastFOV/ppport.h> dramatically and may be useful
if you want to include F<Game-RaycastFOV/ppport.h> in smaller modules without
increasing their distribution size too much.

The stripped F<Game-RaycastFOV/ppport.h> will have a C<--unstrip> option that allows
...
F<Game-RaycastFOV/ppport.h>. Also lists if it must be explicitly requested,
if it has dependencies, and if there are hints or warnings for it.

=head2 --list-unsupported

Lists the API elements that are known not to be supported by
F<Game-RaycastFOV/ppport.h> and below which version of Perl they probably
...
earlier Perl releases. Use
    ...
    perl Game-RaycastFOV/ppport.h --list-provided

to see which API elements are provided by Game-RaycastFOV/ppport.h.
...
also deprecated. You can safely use the supported API, as F<Game-RaycastFOV/ppport.h>
...
more C<#define>s in your source code before the inclusion of F<Game-RaycastFOV/ppport.h>.
...
macro. Just C<#define> the macro before including C<Game-RaycastFOV/ppport.h>:

    #define DPPP_NAMESPACE MyOwnNamespace_
    #include "Game-RaycastFOV/ppport.h"
...
F<Game-RaycastFOV/ppport.h> on your source code. See the next section for
details.

=head1 EXAMPLES

To verify whether F<Game-RaycastFOV/ppport.h> is needed for your module, whether you
should make any changes to your code, and whether any special defines
should be used, F<Game-RaycastFOV/ppport.h> can be run as a Perl script to check your
source code. Simply say:

    perl Game-RaycastFOV/ppport.h
...
use something like this:
    ...
    perl Game-RaycastFOV/ppport.h --compat-version=5.6.0 --cplusplus --patch=test.diff

If you only want your code to be scanned without any suggestions
for changes, use:

    perl Game-RaycastFOV/ppport.h --nochanges

You can specify a different C<diff> program or options, using
the C<--diff> option:

    perl Game-RaycastFOV/ppport.h --diff='diff -C 10'

This would output context diffs with 10 lines of context.

If you want to create patched copies of your files instead, use:

    perl Game-RaycastFOV/ppport.h --copy=.new

To display portability information for the C<newSVpvn> function,
use:

    perl Game-RaycastFOV/ppport.h --api-info=newSVpvn

Since the argument to C<--api-info> can be a regular expression,
you can use

    perl Game-RaycastFOV/ppport.h --api-info=/_nomg$/

to display portability information for all C<_nomg> functions or

    perl Game-RaycastFOV/ppport.h --api-info=/./
...
If this version of F<Game-RaycastFOV/ppport.h> is causing failure during
the compilation of this module, please check if newer versions
of either this module or C<Devel::PPPort> are available on CPAN
before sending a bug report.

If F<Game-RaycastFOV/ppport.h> was generated using the latest version of
...
# These are tools that must be included in Game-RaycastFOV/ppport.h.  It doesn't work if given
# a .pl suffix
 ...
 */
#if PERL_REVISION != 5
#  error Game-RaycastFOV/ppport.h only works with Perl version 5
...
/* Hint: aTHX_
  ...
  through Game-RaycastFOV/ppport.h */
 ...
 * 5.005 perls, you can use aTHXR (supplied by Game-RaycastFOV/ppport.h), which will
...
/* Hint: isPSXSPC, isPSXSPC_A, isPSXSPC_L1, isPSXSPC_utf8_safe
    ...
    Game-RaycastFOV/ppport.h SPACE version does match VT in all perl releases.  Since VT's are
    extremely rarely found in real-life files, this difference effectively
    doesn't matter */

/* Hint: isSPACE, isSPACE_A, isSPACE_L1, isSPACE_utf8_safe
    Until Perl 5.18, this did not match the vertical tab (VT).  The Game-RaycastFOV/ppport.h
...
/* Hint: SvPVbyte
 * Does not work in perl-5.6.1, Game-RaycastFOV/ppport.h implements a version
...
/* End of File Game-RaycastFOV/ppport.h */
