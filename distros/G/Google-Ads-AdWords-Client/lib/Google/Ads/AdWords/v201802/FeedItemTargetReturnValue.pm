package Google::Ads::AdWords::v201802::FeedItemTargetReturnValue;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'value' => 'Google::Ads::AdWords::v201802::FeedItemTarget',
...
Google::Ads::AdWords::v201802::FeedItemTargetReturnValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItemTargetReturnValue from the namespace https://adwords.google.com/api/adwords/cm/v201802.

A container for return values from a call to {@code FeedItemTargetService#mutate} call. 
