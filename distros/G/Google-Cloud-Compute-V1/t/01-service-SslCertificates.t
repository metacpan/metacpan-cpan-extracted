...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::SslCertificate Google::Cloud::Compute::V1::Compute::SslCertificateAggregatedList Google::Cloud::Compute::V1::Compute::SslCertificateList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::SslCertificatesClient->new( credentials => 'dummy' );
