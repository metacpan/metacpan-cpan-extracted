...
# ABSTRACT: Rename to random characters
...
App::perlmv::scriptlet::to_random - Rename to random characters

=head1 VERSION

This document describes version 0.001 of App::perlmv::scriptlet::to_random (from Perl distribution App-perlmv-scriptlet-to_random), released on 2020-08-04.
