...
1;
# ABSTRACT: Return database path that is used
...
App::lcpan::Cmd::db_path - Return database path that is used

=head1 VERSION

This document describes version 1.071 of App::lcpan::Cmd::db_path (from Perl distribution App-lcpan), released on 2022-09-19.
