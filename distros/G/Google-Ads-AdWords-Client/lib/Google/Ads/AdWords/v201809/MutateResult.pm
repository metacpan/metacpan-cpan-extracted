package Google::Ads::AdWords::v201809::MutateResult;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'result' => 'Google::Ads::AdWords::v201809::Operand',
        'errorList' => 'Google::Ads::AdWords::v201809::ErrorList',
...
Google::Ads::AdWords::v201809::MutateResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MutateResult from the namespace https://adwords.google.com/api/adwords/cm/v201809.
