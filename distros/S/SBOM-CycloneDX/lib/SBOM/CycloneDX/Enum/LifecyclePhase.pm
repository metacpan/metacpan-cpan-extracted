...
=item * L<DESIGN>, BOM produced early in the development lifecycle
...
=item * L<PRE_BUILD>, BOM consisting of information obtained prior to a
...
=item * L<BUILD>, BOM consisting of information obtained during a build
...
=item * L<POST_BUILD>, BOM consisting of information obtained after a build
...
=item * L<OPERATIONS>, BOM produced that represents inventory that is
...
=item * L<DISCOVERY>, BOM consisting of information observed through
...
=item * L<DECOMMISSION>, BOM containing inventory that will be, or has been
