package Sah::SchemaR::bencher::env_hash;

our $DATE = '2021-07-23'; # DATE
our $VERSION = '1.054.1'; # VERSION

our $rschema = ["hash",[{of=>["str",{}],summary=>"A hash of environment variable and their value"}],["hash"]];
...
Sah::SchemaR::bencher::env_hash - A hash of environment variable and their value

=head1 VERSION

This document describes version 1.054.1 of Sah::SchemaR::bencher::env_hash (from Perl distribution Sah-Schemas-Bencher), released on 2021-07-23.
