...
IO::K8s::Api::Batch::V2alpha1::CronJobList - REMOVED -- superseded by the generic IO::K8s::List, see IO::K8s::Deprecated
...
back in the C<1.00> Moose-to-Moo rewrite; C<IO::K8s::Api::Batch::V2alpha1::CronJobList> itself was never a real
...
that C<cpanm IO::K8s::Api::Batch::V2alpha1::CronJobList> -- or a cpanfile / code that still references the old
...
IO::K8s::Api::Batch::V2alpha1::CronJobList - REMOVED, superseded by IO::K8s::List
