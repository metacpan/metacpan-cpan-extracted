...
$a{"僜"} = "昞";
if ($a{'僜'} =~ /^\Q$a{'僜'}\E$/) {
    print qq#ok - 4 \$a{'僜'} =~ /^\\Q\$a{'僜'}\\E\$/ $^X $__FILE__\n#;
}
else {
    print qq#not ok - 4 \$a{'僜'} =~ /^\\Q\$a{'僜'}\\E\$/ $^X $__FILE__\n#;
}
...
$a{"僜"} = "昞";
if ($a{'僜'} =~ m/^\Q$a{'僜'}\E$/) {
    print qq#ok - 9 \$a{'僜'} =~ m/^\\Q\$a{'僜'}\\E\$/ $^X $__FILE__\n#;
}
else {
    print qq#not ok - 9 \$a{'僜'} =~ m/^\\Q\$a{'僜'}\\E\$/ $^X $__FILE__\n#;
}
