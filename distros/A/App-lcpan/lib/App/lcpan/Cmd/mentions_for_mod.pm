...
1;
# ABSTRACT: List POD mentions for module(s)
...
App::lcpan::Cmd::mentions_for_mod - List POD mentions for module(s)

=head1 VERSION

This document describes version 1.035 of App::lcpan::Cmd::mentions_for_mod (from Perl distribution App-lcpan), released on 2019-06-26.
