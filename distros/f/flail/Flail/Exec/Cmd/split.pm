...
Flail::Exec::Cmd::split - Flail "split" command

=head1 VERSION

  Time-stamp: <2006-12-03 11:04:28 attila@stalphonsos.com>

=head1 SYNOPSIS

  use Flail::Exec::Cmd::split;
  blah;
...
package Flail::Exec::Cmd::split;
use strict;
use Carp;
use Flail::Utils;
use base qw(Exporter);
use vars qw(@EXPORT @EXPORT_OK %EXPORT_TAGS);
@EXPORT_OK = qw(flail_split);
@EXPORT = ();
