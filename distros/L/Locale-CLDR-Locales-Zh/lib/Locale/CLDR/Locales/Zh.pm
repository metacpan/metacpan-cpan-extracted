		 ...
		 sub {
			 my %languages = (
				'aa' => '阿法尔语',
 				...
 				'zh@alt=menu' => '普通话',
 				'zh_Hans' => '简体中文',
 				'zh_Hans@alt=long' => '现代标准汉语',
 				'zh_Hant' => '繁体中文',
 				'zh_Hant@alt=long' => '台湾国语',
 				'zu' => '祖鲁语',
 				'zun' => '祖尼语',
 				'zxx' => '无语言内容',
 				'zza' => '扎扎语',
