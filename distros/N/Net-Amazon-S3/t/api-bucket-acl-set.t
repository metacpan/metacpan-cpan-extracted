...
expect_api_bucket_acl_set 'set bucket acl using deprecated acl_short' => (
...
expect_api_bucket_acl_set 'set bucket acl using canned acl' => (
	with_bucket             => 'some-bucket',
...
expect_api_bucket_acl_set 'set bucket acl using canned acl coercion' => (
	with_bucket             => 'some-bucket',
	with_acl                => 'private',
	with_response_fixture ('response::acl'),
	expect_request          => { PUT => 'https://some-bucket.s3.amazonaws.com/?acl' },
...
expect_api_bucket_acl_set 'set bucket acl using explicit acl' => (
	with_bucket             => 'some-bucket',
...
expect_api_bucket_acl_set 'set bucket acl using XML content' => (
	with_bucket             => 'some-bucket',
