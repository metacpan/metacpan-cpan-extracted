...
$Shipment::UPS::WSDL::RateTypes::ShipToAddressType::VERSION = '3.10';
use strict;
use warnings;
...
use base qw(Shipment::UPS::WSDL::RateTypes::AddressType);
# Variety: sequence
...
ShipToAddressType from the namespace http://www.ups.com/XMLSchema/XOLTWS/Rate/v1.1.
