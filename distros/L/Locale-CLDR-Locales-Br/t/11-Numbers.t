...
is_deeply([$locale->get_digits], [0 .. 9], 'Get digits Breton');
...
# RBNF
is($locale->format_number(0, 'spellout-numbering-year'), '0', 'RBNF: Spell out year 0');
is($locale->format_number('-0.0', 'spellout-numbering'), '−0', 'RBNF: Spell out -0.0');
