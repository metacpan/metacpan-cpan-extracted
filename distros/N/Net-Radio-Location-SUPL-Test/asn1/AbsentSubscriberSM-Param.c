...
static int asn_MAP_AbsentSubscriberSM_Param_oms_1[] = { 0, 1, 2 };
...
static asn_TYPE_tag2member_t asn_MAP_AbsentSubscriberSM_Param_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 0, 0, 0 }, /* absentSubscriberDiagnosticSM at 161 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, 0, 0 }, /* extensionContainer at 164 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 2, 0, 0 } /* additionalAbsentSubscriberDiagnosticSM at 166 */
};
static asn_SEQUENCE_specifics_t asn_SPC_AbsentSubscriberSM_Param_specs_1 = {
	...
	asn_MAP_AbsentSubscriberSM_Param_oms_1,	/* Optional members */
	2, 1,	/* Root/Additions */
	1,	/* Start extensions */
	4	/* Stop extensions */
};
