...
if(!(-d "t")) {   
    ...
    print STDERR "directory as : perl t/getCompounds.t \n";
    exit;  
}                                                              
...
my $perl     = $^X;
my $util_prg = File::Spec->catfile('utils', 'getCompounds.pl');

my ($keyfile, $file, $output, $config);
