...
package UMMF::MOF_1_3::Model::CollectionType;
...
L<UMMF::MOF_1_3::Model::DataType|UMMF::MOF_1_3::Model::DataType>
...
use base qw(
  UMMF::MOF_1_3::Model::DataType  UMMF::MOF_1_3::Model::TypedElement
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_3::Model::CollectionType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_3::Model::CollectionType|UMMF::MOF_1_3::Model::CollectionType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_3::Model::CollectionType')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_3::Model::CollectionType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_3::Model::CollectionType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_3::Model::CollectionType' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_3::Model::CollectionType|UMMF::MOF_1_3::Model::CollectionType>.
...
=head2 C<isaModel__CollectionType>
...
=cut
sub isaModel__CollectionType { 1 }
...
Returns the UML Model name (C<'Model::CollectionType'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Model::CollectionType' }
  ...
  $__tangram_schema ||=
  {
   ...
   [
	 ...
	 # Associations
       ...
       'bases' => [  'UMMF::MOF_1_3::Model::DataType',  'UMMF::MOF_1_3::Model::TypedElement',  ],
       'sql' => {
...
sub __initialize
{
  ...
  $self->UMMF::MOF_1_3::Model::CollectionType::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_3::Model::CollectionType::___create(@args);
...
sub set_multiplicity ($$)
{
  ...
  if ( defined $val ) {
    $self->__use('UMMF::MOF_1_3::Model::MultiplicityType')->__typecheck($val, "UMMF::MOF_1_3::Model::CollectionType.multiplicity");
  }
