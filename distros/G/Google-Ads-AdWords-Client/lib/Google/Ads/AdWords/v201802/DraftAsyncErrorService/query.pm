...
package Google::Ads::AdWords::v201802::DraftAsyncErrorService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201802::DraftAsyncErrorService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201802::DraftAsyncErrorService::query->new($data);
