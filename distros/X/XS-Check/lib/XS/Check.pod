...
(This example is included as L<F<synopsis.pl>|https://fastapi.metacpan.org/source/BKB/XS-Check-0.12/examples/synopsis.pl> in the distribution.)


=head1 VERSION

This documents version 0.12 of XS-Check
corresponding to L<git commit 09c996b41cd1b91df7a1bb10a3b5624bb361939f|https://github.com/benkasminbullock/xs-check/commit/09c996b41cd1b91df7a1bb10a3b5624bb361939f> released on Sun May 9 10:44:08 2021 +0900.
...
(This example is included as L<F<reporter.pl>|https://fastapi.metacpan.org/source/BKB/XS-Check-0.12/examples/reporter.pl> in the distribution.)
...
(This example is included as L<F<set-file.pl>|https://fastapi.metacpan.org/source/BKB/XS-Check-0.12/examples/set-file.pl> in the distribution.)
...
As of 0.12, the module has the following limitations.
