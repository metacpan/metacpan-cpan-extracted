#======================================================================
package DBD::SQLeet::VirtualTable::PerlData;
#======================================================================
use strict;
use warnings;
use base 'DBD::SQLeet::VirtualTable';
use DBD::SQLeet;
use constant SQLITE_3010000 => $DBD::SQLeet::sqlite_version_number >= 3010000 ? 1 : 0;
use constant SQLITE_3021000 => $DBD::SQLeet::sqlite_version_number >= 3021000 ? 1 : 0;
...
#              TXT     NUM
  ...
  'MATCH' => [ '=~',   '=~' ],
  (SQLITE_3010000 ? (
  'LIKE'  => [ 'DBD::SQLeet::strlike', 'DBD::SQLeet::strlike' ],
  'GLOB'  => [ 'DBD::SQLeet::strglob', 'DBD::SQLeet::strglob' ],
  'REGEXP'=> [ '=~',   '=~' ],
  ) : ()),
  (SQLITE_3021000 ? (
  'NE'    => [ 'ne',   '!=' ],
...
#======================================================================
package DBD::SQLeet::VirtualTable::PerlData::Cursor;
#======================================================================
use strict;
use warnings;
...
DBD::SQLeet::VirtualTable::PerlData -- virtual table hooked to Perl data

=head1 SYNOPSIS

Within Perl :

  $dbh->sqlite_create_module(perl => "DBD::SQLeet::VirtualTable::PerlData");
