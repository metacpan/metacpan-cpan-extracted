use utf8;
package Schema::RackTables::0_20_11::Result::PatchCableType;
...
Related object: L<Schema::RackTables::0_20_11::Result::PatchCableOIFCompat>

=cut

__PACKAGE__->has_many(
  "patch_cable_oifcompats",
  "Schema::RackTables::0_20_11::Result::PatchCableOIFCompat",
  { "foreign.pctype_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:VfzFk16rOjSQVhHmLKshOA
