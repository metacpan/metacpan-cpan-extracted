...
my $predefinedService;
use Firewall::Config::Dao::PredefinedService::Netscreen;
$predefinedService = Firewall::Config::Dao::PredefinedService::Netscreen->new( dbi => $dbi );
$predefinedService = $predefinedService->load(20);
...
$parser->parse();
say dumper $parser->elements->{dynamicNat};
