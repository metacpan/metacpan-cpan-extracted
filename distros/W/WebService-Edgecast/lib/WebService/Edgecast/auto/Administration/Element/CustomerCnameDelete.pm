...
package WebService::Edgecast::auto::Administration::Element::CustomerCnameDelete;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerCnameDelete::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerCnameDelete');
...
WebService::Edgecast::auto::Administration::Element::CustomerCnameDelete
...
CustomerCnameDelete from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerCnameDelete->new($data);
