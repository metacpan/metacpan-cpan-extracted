package Chart::Plotly::Trace::Funnelarea::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Funnelarea::Title::Font - This attribute is one of the possible options for the trace funnelarea.
