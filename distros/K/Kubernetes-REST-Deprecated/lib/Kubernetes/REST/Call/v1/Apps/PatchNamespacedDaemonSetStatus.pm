...
Kubernetes::REST::Call::v1::Apps::PatchNamespacedDaemonSetStatus - REMOVED -- superseded by Kubernetes::REST's unified v1 API, see Kubernetes::REST::Deprecated
...
C<Kubernetes::REST::Call::v1::Apps::PatchNamespacedDaemonSetStatus> itself was never functional in the C<1.x> series -- it
...
C<cpanm Kubernetes::REST::Call::v1::Apps::PatchNamespacedDaemonSetStatus> -- or a cpanfile / code that still references the
...
Kubernetes::REST::Call::v1::Apps::PatchNamespacedDaemonSetStatus - REMOVED, superseded by Kubernetes::REST's unified v1 API
