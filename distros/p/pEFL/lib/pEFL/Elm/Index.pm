...
our @ISA = qw(Exporter ElmIndexPtr);
...
sub insert_before {
    my ($obj,$before,$letter,$func,$func_data) = @_;
    my $id = pEFL::PLSide::save_gen_item_data( $obj,undef,$func,$func_data );
    my $widget = _elm_index_item_insert_before($obj,$before,$letter, $id);
    return $widget;
}

sub insert_after {
    my ($obj,$after,$letter,$func,$func_data) = @_;
    my $id = pEFL::PLSide::save_gen_item_data( $obj,undef,$func,$func_data );
    my $widget = _elm_index_item_insert_after($obj,$after,$letter,$id);
    return $widget;
}

sub item_prepend {
    my ($obj,$letter,$func,$func_data) = @_;
    my $id = pEFL::PLSide::save_gen_item_data( $obj,undef,$func,$func_data );
    my $widget = _elm_index_item_prepend($obj,$letter,$id);
    return $widget;
}
...
sub item_append {
    my ($obj,$letter,$func,$func_data) = @_;
    my $id = pEFL::PLSide::save_gen_item_data( $obj,undef,$func,$func_data );
    my $widget = _elm_index_item_append($obj,$letter,$id);
    return $widget;
}
...
https://www.enlightenment.org/develop/legacy/api/c/start#group__Elm__Index.html
