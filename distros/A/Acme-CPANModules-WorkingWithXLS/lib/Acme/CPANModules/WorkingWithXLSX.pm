...
L<App::cpanm::cpanmodules> distribution):
 ...
 % cpanm-cpanmodules -n WorkingWithXLSX

Alternatively you can use the L<cpanmodules> CLI (from L<App::cpanmodules>
distribution):

    % cpanmodules ls-entries WorkingWithXLSX | cpanm -n

or L<Acme::CM::Get>:

    % perl -MAcme::CM::Get=WorkingWithXLSX -E'say $_->{module} for @{ $LIST->{entries} }' | cpanm -n

or directly:

    % perl -MAcme::CPANModules::WorkingWithXLSX -E'say $_->{module} for @{ $Acme::CPANModules::WorkingWithXLSX::LIST->{entries} }' | cpanm -n
