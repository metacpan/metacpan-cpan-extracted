...
our $schema = ['obj', {
    ...
    examples => [
        {value=>'', valid=>0},
        #{value=>'http://www.example.com', valid=>1, validated_value=>URI->new("http://www.example.com")}, # comment out temporarily, is_deeply problem
    ],
...
Sah::Schema::url - URL string

=head1 VERSION

This document describes version 0.012 of Sah::Schema::url (from Perl distribution Sah-Schemas-URL), released on 2020-05-27.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("url*");
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("url*");
     $validator->(\@args);
     ...
 }
