...
Kubernetes::REST::Auditregistration - REMOVED -- superseded by Kubernetes::REST's unified v1 API, see Kubernetes::REST::Deprecated
...
C<Kubernetes::REST::Auditregistration> itself was never functional in the C<1.x> series -- it
...
C<cpanm Kubernetes::REST::Auditregistration> -- or a cpanfile / code that still references the
...
Kubernetes::REST::Auditregistration - REMOVED, superseded by Kubernetes::REST's unified v1 API
