...
Readonly::Scalar my $FILE => $FindBin::Bin
  . q{../lib/Crypt/Diceware/Wordlist/NL/ModHex.pm};
...
diceware_modhex_wordlist.pl [--language|-l nl_NL] [--machine-friendly]
...
installed. Default is C<nl_NL> because C<en_US> doesn't yield enough words for a
complete list.
