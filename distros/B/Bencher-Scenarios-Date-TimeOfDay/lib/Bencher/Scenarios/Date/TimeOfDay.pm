package Bencher::Scenarios::Date::TimeOfDay;
...
This document describes version 0.002 of Bencher::Scenarios::Date::TimeOfDay (from Perl distribution Bencher-Scenarios-Date-TimeOfDay), released on 2023-01-19.
...
=item * L<Bencher::Scenario::Date::TimeOfDay::format>

=item * L<Bencher::Scenario::Date::TimeOfDay::create>
