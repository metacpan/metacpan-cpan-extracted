...
# Big5::eval (omit) has Big5::eval qq{...}
$_ = <<'END';
...
# Big5::eval (omit) has Big5::eval q{...}
$_ = <<'END';
...
# Big5::eval (omit) has Big5::eval $var
$_ = <<'END';
Big5::eval $var2
END
...
# Big5::eval (omit) has Big5::eval (omit)
$_ = <<'END';
