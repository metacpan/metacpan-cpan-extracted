package
  XS::Install::FrozenShit::ParseXS::Utilities;
use strict;
use warnings;
use Exporter;
use File::Spec;
use XS::Install::FrozenShit::ParseXS::Constants ();
...
XS::Install::FrozenShit::ParseXS::Utilities - Subroutines used with XS::Install::FrozenShit::ParseXS

=head1 SYNOPSIS

  use XS::Install::FrozenShit::ParseXS::Utilities qw(
    standard_typemap_locations
    trim_whitespace
    C_string
    valid_proto_string
...
sub valid_proto_string {
  ...
  if ( $string =~ /^$XS::Install::FrozenShit::ParseXS::Constants::PrototypeRegexp+$/ ) {
    return $string;
  }
...
/* Now, finally, after all this mess, we want an XS::Install::FrozenShit::ParseXS
...
flag, or if C<$XS::Install::FrozenShit::ParseXS::DIE_ON_ERROR> is true when process_file()
...
sub death {
  my XS::Install::FrozenShit::ParseXS $self = $_[0];
