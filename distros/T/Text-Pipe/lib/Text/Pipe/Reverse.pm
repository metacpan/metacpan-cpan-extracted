...
Text::Pipe::Reverse - Common text filter API

=head1 SYNOPSIS

    Text::Pipe::Reverse->new;
...
takes an input string, reverses it (in scalar context) and returns it.

=back

Text::Pipe::Reverse inherits from L<Text::Pipe::Base>.
