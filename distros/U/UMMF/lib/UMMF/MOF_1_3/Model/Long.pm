...
package UMMF::MOF_1_3::Model::Long;
...
Constructs new UMMF::MOF_1_3::Model::Long value.
...
sub new
{
  ...
  __typecheck($self, $x, 'UMMF::MOF_1_3::Model::Long::new');
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_3::Model::Long->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_3::Model::Long|UMMF::MOF_1_3::Model::Long>.
...
=head2 C<__typecheck>
  ...
  UMMF::MOF_1_3::Model::Long->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_3::Model::Long->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_3::Model::Long' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_3::Model::Long|UMMF::MOF_1_3::Model::Long>.
...
=head2 C<isaModel__Long>


Returns true if receiver is a L<UMMF::MOF_1_3::Model::Long|UMMF::MOF_1_3::Model::Long>.
Other receivers will return false.
This is the fully qualified version of the C<isaLong> method.

=cut
sub isaModel__Long { 1 }
...
Returns the UML Model name (C<'Model::Long'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Model::Long' }
...
sub __initialize
{
  ...
  $self->UMMF::MOF_1_3::Model::Long::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_3::Model::Long::___create(@args);
