...
(This example is included as L<F<example.pl>|https://fastapi.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.16/examples/example.pl> in the distribution.)


=head1 VERSION

This documents Data::Kanji::Kanjidic version 0.16
corresponding to git commit L<fae7e516e66801df9d011eb61ac69dfca1ff55dd|https://github.com/benkasminbullock/Data-Kanji-Kanjidic/commit/fae7e516e66801df9d011eb61ac69dfca1ff55dd> released on Fri Oct 5 10:09:51 2018 +0900.
...
(This example is included as L<F<parse-kanjidic.pl>|https://fastapi.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.16/examples/parse-kanjidic.pl> in the distribution.)
...
scheme|http://www.sljfaq.org/afaq/encodings.html#encodings-JIS-X-0208>. The
...
(This example is included as L<F<frequency.pl>|https://fastapi.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.16/examples/frequency.pl> in the distribution.)
...
Kanji|http://www.sljfaq.org/afaq/jouyou-kanji.html>. If the grade is 9 or 10, then the kanji is not part of the
Joyo kanji, but it is part of the L<Jinmeiyo
Kanji|http://www.sljfaq.org/afaq/jinmeiyou-kanji.html>.
...
(This example is included as L<F<korean.pl>|https://fastapi.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.16/examples/korean.pl> in the distribution.)
...
Kanjidic. See L<Which kanji were created in Japan?|http://www.sljfaq.org/afaq/kokuji.html>
for more on kokuji.
...
(This example is included as L<F<english-to-kanji.pl>|https://fastapi.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.16/examples/english-to-kanji.pl> in the distribution.)
...
This is an array reference which contains the L<on'yomi|http://www.sljfaq.org/afaq/kanji-pronunciation.html> of the kanji. It may be
...
(This example is included as L<F<onyomi-same.pl>|https://fastapi.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.16/examples/onyomi-same.pl> in the distribution.)


=item kunyomi

This is an array reference which contains the L<kun'yomi|http://www.sljfaq.org/afaq/kanji-pronunciation.html>.  It may be undefined, if no
...
(This example is included as L<F<morohashi.pl>|https://fastapi.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.16/examples/morohashi.pl> in the distribution.)
...
used?|http://www.sljfaq.org/afaq/using-a-kanji-dictionary.html>
for more on kanji dictionary ordering. See L<What
are kanji radicals?|http://www.sljfaq.org/afaq/radicals.html>
...
by elementary school grade|http://www.sljfaq.org/afaq/grade-list.html>.
...
children?|http://www.sljfaq.org/afaq/education.html>
...
(This example is included as L<F<grades.pl>|https://fastapi.metacpan.org/source/BKB/Data-Kanji-Kanjidic-0.16/examples/grades.pl> in the distribution.)
...
=item L<Summary description of kanjidic|http://www.edrdg.org/kanjidic/kanjidic.html>

=item L<Full documentation|http://www.edrdg.org/kanjidic/kanjidic_doc.html>

=back

=item Download

Download the F<kanjidic> file at one of the following sites:

=over

=item L<ftp://ftp.edrdg.org/pub/Nihongo/00INDEX.html>

=item L<http://ftp.monash.edu.au/pub/nihongo/00INDEX.html>
