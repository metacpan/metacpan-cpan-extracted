package Chart::Plotly::Trace::Pointcloud::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Pointcloud::Hoverlabel::Font - This attribute is one of the possible options for the trace pointcloud.
