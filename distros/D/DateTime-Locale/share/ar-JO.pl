{
  ...
  datetime_format_full => "{1} \N{U+0641}\N{U+064a} {0}",
  datetime_format_long => "{1} \N{U+0641}\N{U+064a} {0}",
  ...
  first_day_of_week => 6,
  glibc_date_1_format => "%d %b, %Y %Z %I:%M:%S %p",
  glibc_date_format => "%d %b, %Y",
  glibc_datetime_format => "%d %b, %Y %I:%M:%S %p",
  glibc_time_12_format => "%Z %I:%M:%S %p",
  glibc_time_format => "%Z %I:%M:%S %p",
  language => "Arabic",
