...
# The original used  "harness" program. Right now that file
# is not available in the testing setup.
# For now we'll change the file used to __FILE__ which is
# Just as good for testing purposes

open(try, __FILE__) || (die "Can't open ${__FILE__}.");
