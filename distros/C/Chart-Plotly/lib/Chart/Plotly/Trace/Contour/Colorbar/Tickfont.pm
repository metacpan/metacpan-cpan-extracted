package Chart::Plotly::Trace::Contour::Colorbar::Tickfont;
use Moose;
...
Chart::Plotly::Trace::Contour::Colorbar::Tickfont - This attribute is one of the possible options for the trace contour.
