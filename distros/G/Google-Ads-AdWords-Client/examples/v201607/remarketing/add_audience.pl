...
use Google::Ads::AdWords::v201607::UserListConversionType;
...
sub add_audience {
  ...
  my $conversion_type =
    Google::Ads::AdWords::v201607::UserListConversionType->new({name => $name});

  # Create remarketing user list.
  my $user_list = Google::Ads::AdWords::v201607::BasicUserList->new({
      name            => $name,
  ...
  if ($result->get_value()) {
    ...
    $selector = Google::Ads::AdWords::v201607::Selector->new({
        fields     => ["Id"],
