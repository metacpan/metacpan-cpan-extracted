...
package Google::Ads::AdWords::v201708::AdGroupAdService::mutateLabel;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201708::AdGroupAdLabelOperation',
    },
    {
...
Google::Ads::AdWords::v201708::AdGroupAdService::mutateLabel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutateLabel from the namespace https://adwords.google.com/api/adwords/cm/v201708.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201708::AdGroupAdService::mutateLabel->new($data);
