...
package Google::Ads::AdWords::v201708::CampaignService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201708::CampaignService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201708::CampaignService::query->new($data);
