...
use Google::Ads::AdWords::v201705::TargetCpaBiddingScheme;
use Google::Ads::AdWords::v201705::UniversalAppCampaignSetting;
...
sub add_universal_app_campaign {
  ...
  my $universalAppSetting =
    Google::Ads::AdWords::v201705::UniversalAppCampaignSetting->new({
  ...
  # Google::Ads::AdWords::v201705::SelectiveOptimization->new({
  #  conversionTypeIds =>
  ...
  my $geoSetting = Google::Ads::AdWords::v201705::GeoTargetTypeSetting->new({
  ...
  my $campaign = Google::Ads::AdWords::v201705::Campaign->new({
      ...
      biddingStrategyConfiguration =>
        Google::Ads::AdWords::v201705::BiddingStrategyConfiguration->new({
          ...
          biddingScheme =>
            Google::Ads::AdWords::v201705::TargetCpaBiddingScheme->new({
              targetCpa => Google::Ads::AdWords::v201705::Money->new(
                {microAmount => 1000000})})}
        ),
...
sub set_campaign_targeting_criteria() {
  ...
  my $mexico = Google::Ads::AdWords::v201705::Location->new({id => 2484});
