package Locales::DB::Language::lag;
...
$Locales::DB::Language::lag::VERSION = '0.09';

$Locales::DB::Language::lag::cldr_version = '2.0';

%Locales::DB::Language::lag::misc_info = (
    ...
    'plural_forms' => {
        ...
        'category_rules_compiled' => {
            'one' => sub {
                if ( ( ( $_[0] >= 0 && $_[0] <= 2 ) && ( $_[0] != 0 ) && ( $_[0] != 2 ) ) ) { return 'one'; }
                return;
            },
            'zero' => sub {
...
%Locales::DB::Language::lag::code_to_name = (
    'aa'     => 'Afar',
    'ab'     => 'Abkhazian',
    'ace'    => 'Achinese',
    'ach'    => 'Acoli',
...
%Locales::DB::Language::lag::name_to_code = (
    'abkhazian'                     => 'ab',
    'achinese'                      => 'ace',
    'acoli'                         => 'ach',
    'adangme'                       => 'ada',
