...
use Google::Ads::AdWords::v201809::ShowcaseAd;
...
sub _create_showcase_ad {
  ...
  my $showcase_ad = Google::Ads::AdWords::v201809::ShowcaseAd->new({
  ...
  my $expanded_image = Google::Ads::AdWords::v201809::Image->new({
  ...
  my $collapsed_image = Google::Ads::AdWords::v201809::Image->new({
      mediaId => _upload_image(
