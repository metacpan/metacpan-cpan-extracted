...
1;
# ABSTRACT: Round number to the nearest integer (or "nearest" argument) that is greater than the number
...
Data::Sah::Filter::perl::Float::ceil - Round number to the nearest integer (or "nearest" argument) that is greater than the number

=head1 VERSION

This document describes version 0.024 of Data::Sah::Filter::perl::Float::ceil (from Perl distribution Data-Sah-Filter), released on 2024-01-17.

=head1 SYNOPSIS

=head2 Using in Sah schema's C<prefilters> (or C<postfilters>) clause

 ["str","prefilters",[["Float::ceil"]]]

=head2 Using with L<Data::Sah>:

 use Data::Sah qw(gen_validator);
 
 my $schema = ["str","prefilters",[["Float::ceil"]]];
