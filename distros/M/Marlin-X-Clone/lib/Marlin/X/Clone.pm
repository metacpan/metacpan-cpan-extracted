...
sub _make_clone_method {
	...
	# Eval::TypeTiny::CodeAccumulator allows you to build up some
	# Perl source code line-by-line and compile it at the end.
...
It is possible to additionally load it with C<< use Marlin::X::Clone >>,
...
L<https://github.com/tobyink/p5-marlin-x-clone/issues>.
