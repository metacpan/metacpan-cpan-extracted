...
#
#=======================================================================
package PDF::API3::Compat::API2::Resource::XObject::Image::GD;
...
=item $res = PDF::API3::Compat::API2::Resource::XObject::Image::GD->new $pdf, $obj [, $name]
...
=item $res = PDF::API3::Compat::API2::Resource::XObject::Image::GD->new_api $api, $obj [, $name]
