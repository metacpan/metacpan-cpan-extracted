...
package Google::Ads::AdWords::v201609::AccountLabelService::get;
use strict;
use warnings;
...
get from the namespace https://adwords.google.com/api/adwords/mcm/v201609.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201609::AccountLabelService::get->new($data);
