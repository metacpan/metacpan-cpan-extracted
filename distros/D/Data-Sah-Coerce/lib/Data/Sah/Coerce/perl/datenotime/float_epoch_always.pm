...
Data::Sah::Coerce::perl::datenotime::float_epoch_always - Coerce datenotime from number (assumed to be epoch)

=head1 VERSION

This document describes version 0.031 of Data::Sah::Coerce::perl::datenotime::float_epoch_always (from Perl distribution Data-Sah-Coerce), released on 2018-12-16.
