package Chart::Plotly::Trace::Scattercarpet::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Scattercarpet::Hoverlabel::Font - This attribute is one of the possible options for the trace scattercarpet.
