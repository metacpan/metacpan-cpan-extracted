...
This document describes version 0.001 of Sah::Schema::business::id::mandiri::account_num (from Perl distribution Sah-Schemas-Business-ID-Mandiri), released on 2024-01-15.
...
(set-as-default, coerced, prefiltered) value:
 ...
 # a sample invalid data
 $data = 123;
 my $res = $validator->($data); # => ["Account number must be 13 digits",123]
