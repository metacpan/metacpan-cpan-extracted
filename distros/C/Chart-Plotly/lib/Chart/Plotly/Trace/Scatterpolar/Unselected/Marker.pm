package Chart::Plotly::Trace::Scatterpolar::Unselected::Marker;
use Moose;
...
Chart::Plotly::Trace::Scatterpolar::Unselected::Marker - This attribute is one of the possible options for the trace scatterpolar.
