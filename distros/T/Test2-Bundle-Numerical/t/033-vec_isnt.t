...
vec_isnt($v1, $v2, 'vec_isnt accepts unequal vectors');
vec_isnt($v1, $v3, 'vec_isnt accepts another unequal pair');
vec_isnt($v2, $v3, 'vec_isnt accepts a third unequal pair');
