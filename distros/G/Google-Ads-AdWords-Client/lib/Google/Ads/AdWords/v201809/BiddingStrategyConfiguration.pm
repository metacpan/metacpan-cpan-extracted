package Google::Ads::AdWords::v201809::BiddingStrategyConfiguration;
use strict;
use warnings;
...
my %targetRoasOverride_of :ATTR(:get<targetRoasOverride>);
...
__PACKAGE__->_factory(
    ...
    ) ],
    {
        ...
        'bids' => \%bids_of,
        'targetRoasOverride' => \%targetRoasOverride_of,
    },
    {
        'biddingStrategyId' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'biddingStrategyName' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'biddingStrategyType' => 'Google::Ads::AdWords::v201809::BiddingStrategyType',
        'biddingStrategySource' => 'Google::Ads::AdWords::v201809::BiddingStrategySource',
        'biddingScheme' => 'Google::Ads::AdWords::v201809::BiddingScheme',
        'bids' => 'Google::Ads::AdWords::v201809::Bids',
        'targetRoasOverride' => 'SOAP::WSDL::XSD::Typelib::Builtin::double',
    },
    {
        ...
        'bids' => 'bids',
        'targetRoasOverride' => 'targetRoasOverride',
    }
);
