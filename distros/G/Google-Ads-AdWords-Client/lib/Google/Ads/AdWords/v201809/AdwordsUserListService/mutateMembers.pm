...
package Google::Ads::AdWords::v201809::AdwordsUserListService::mutateMembers;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201809::MutateMembersOperation',
    },
    {
...
mutateMembers from the namespace https://adwords.google.com/api/adwords/rm/v201809.
