# AWS::IAM::Group generated from spec 18.4.0
...
Cfn::Resource::AWS::IAM::Group - Cfn resource for AWS::IAM::Group

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::IAM::Group.
