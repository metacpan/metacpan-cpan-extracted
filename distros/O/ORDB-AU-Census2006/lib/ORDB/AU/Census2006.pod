...
ORDB::AU::Census2006 - An ORLite-based ORM Database API
...
=head2 dsn
  ...
  my $string = ORDB::AU::Census2006->dsn;
...
=head2 dbh
  ...
  my $handle = ORDB::AU::Census2006->dbh;
...
=head2 pragma
  ...
  my $version = ORDB::AU::Census2006->pragma('user_version');
...
ORDB::AU::Census2006 is based on L<ORLite> 1.28.

Documentation created by L<ORLite::Pod> 0.07.

Bugs should be reported via the CPAN bug tracker at

L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=ORDB-AU-Census2006>
