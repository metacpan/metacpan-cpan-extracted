...
C<-InstallTool> plugins such as L<[MakeMaker]|Dist::Zilla::Plugin::MakeMaker>
or L<[ModuleBuildTiny]|Dist::Zilla::Plugin::ModuleBuildTiny>.
...
the L<< C<dzil authordeps>|Dist::Zilla::App::Command::authordeps >> command.
...
plugin. Comments start with a semicolon.
