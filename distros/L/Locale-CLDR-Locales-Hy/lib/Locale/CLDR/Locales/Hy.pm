...
has 'display_name_type' => (
	...
	default		=> sub {
		{
			'calendar' => {
 				'buddhist' => q{բուդդայական տոմար},
 				'chinese' => q{չինական տոմար},
 				'dangi' => q{դանգի տոմար},
 				'ethiopic' => q{եթովպիական տոմար},
 				'gregorian' => q{գրիգորյան տոմար},
 				'hebrew' => q{հրեական տոմար},
 				'islamic' => q{իսլամական տոմար},
 				'iso8601' => q{ISO-8601 տոմար},
 				'japanese' => q{ճապոնական տոմար},
 				'persian' => q{պարսկական տոմար},
 				'roc' => q{մինգուո տոմար},
 			},
 			'collation' => {
 				'ducet' => q{Unicode-ի ստանդարտ տեսակավորում},
 				'search' => q{որոնում},
 			...
 			'ms' => {
 				...
 				'uksystem' => q{չափման բրիտանական համակարգ},
 				'ussystem' => q{չափման ամերիկյան համակարգ},
 			},
 			'numbers' => {
...
has 'units' => (
	...
	default		=> sub { {
				'long' => {
					...
					'g-force' => {
						'name' => q(ձգողության ուժի արագացում),
					...
					'kelvin' => {
						'name' => q(աստիճան ըստ Կելվինի),
						'one' => q({0} աստիճան ըստ Կելվինի),
						'other' => q({0} աստիճան ըստ Կելվինի),
					},
					'kilobit' => {
						'name' => q(կիլոբիթեր),
						'one' => q({0} կիլոբիթ),
					...
					'liter-per-100kilometers' => {
						'name' => q(լիտրեր 100 կիլոմետրում),
						'one' => q({0} լիտր 100 կիլոմետրում),
						'other' => q({0} լիտր 100 կիլոմետրում),
					},
					'liter-per-kilometer' => {
						'name' => q(լիտր / կիլոմետր),
						'one' => q({0} լիտր / կիլոմետր),
						'other' => q({0} լիտր / կիլոմետր),
					},
					'lux' => {
						'name' => q(լյուքս),
						'one' => q({0} լյուքս),
					...
					'meter-per-second-squared' => {
						'name' => q(մետր /վայրկյան քառակուսի),
						'one' => q({0} մետր /վայրկյան քառակուսի),
						'other' => q({0} մետր /վայրկյան քառակուսի),
					},
					'metric-ton' => {
						'name' => q(մետրիկ տոննաներ),
						'one' => q({0} մետրիկ տոննա),
						'other' => q({0} մետրիկ տոննա),
					},
					'microgram' => {
						'name' => q(միկրոգրամներ),
						'one' => q({0} միկրոգրամ),
					...
					'pound-per-square-inch' => {
						'name' => q(ֆունտ ըստ քառակուսի դյույմի),
						'one' => q({0} ֆունտ ըստ քառակուսի դյույմի),
						'other' => q({0} ֆունտ ըստ քառակուսի դյույմի),
					},
					'quart' => {
						'name' => q(քվարտ),
						'one' => q({0} քվարտ),
...
has 'currencies' => (
	...
	default		=> sub { {
		...
		'GBP' => {
			symbol => '£',
			display_name => {
				'currency' => q(Բրիտանական ֆունտ),
				'one' => q(Բրիտանական ֆունտ),
				'other' => q(Բրիտանական ֆունտ),
			},
		},
		'GEL' => {
			symbol => 'GEL',
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'Europe_Further_Eastern' => {
			long => {
				'standard' => q(Հեռավոր արևելաևրոպական ժամանակ),
			},
		},
		'Europe_Western' => {
			long => {
