...
Cfn::Resource::AWS::CloudFormation::Stack - Cfn resource for AWS::CloudFormation::Stack

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::CloudFormation::Stack.
