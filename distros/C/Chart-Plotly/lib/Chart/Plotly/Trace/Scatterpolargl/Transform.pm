package Chart::Plotly::Trace::Scatterpolargl::Transform;
use Moose;
...
Chart::Plotly::Trace::Scatterpolargl::Transform - This attribute is one of the possible options for the trace scatterpolargl.
