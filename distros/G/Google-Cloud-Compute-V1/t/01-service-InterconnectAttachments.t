...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::InterconnectAttachment Google::Cloud::Compute::V1::Compute::InterconnectAttachmentAggregatedList Google::Cloud::Compute::V1::Compute::InterconnectAttachmentList Google::Cloud::Compute::V1::Compute::Operation )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::InterconnectAttachmentsClient->new( credentials => 'dummy' );
