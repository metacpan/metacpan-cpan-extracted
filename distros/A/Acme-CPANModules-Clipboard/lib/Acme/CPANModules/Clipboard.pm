...
=item L<Win32::Clipboard>

Author: L<JDB|https://metacpan.org/author/JDB>
...
L<App::cpanm::cpanmodules> distribution):
 ...
 % cpanm-cpanmodules -n Clipboard

Alternatively you can use the L<cpanmodules> CLI (from L<App::cpanmodules>
distribution):

    % cpanmodules ls-entries Clipboard | cpanm -n

or L<Acme::CM::Get>:

    % perl -MAcme::CM::Get=Clipboard -E'say $_->{module} for @{ $LIST->{entries} }' | cpanm -n

or directly:

    % perl -MAcme::CPANModules::Clipboard -E'say $_->{module} for @{ $Acme::CPANModules::Clipboard::LIST->{entries} }' | cpanm -n
...
Please visit the project's homepage at L<https://metacpan.org/release/Acme-CPANModules-Clipboard>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Acme-CPANModules-Clipboard>.
