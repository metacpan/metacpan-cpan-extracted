...
Cvs::Result::DiffItem - Result class for cvs status command

=head1 DESCRIPTION

This class handle the cvs diff result for one file.
...
Cvs::Result::DiffItem->mk_accessors
(qw(
    filename
    rcs_file
    from_revision
