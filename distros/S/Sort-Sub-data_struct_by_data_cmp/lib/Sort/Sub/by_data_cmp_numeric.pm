...
1;
# ABSTRACT: Sort data structures by Data::Cmp::Numeric
...
Sort::Sub::by_data_cmp_numeric - Sort data structures by Data::Cmp::Numeric

=head1 VERSION

This document describes version 0.002 of Sort::Sub::by_data_cmp_numeric (from Perl distribution Sort-Sub-data_struct_by_data_cmp), released on 2019-12-15.
...
Generate sorter (accessed as variable) via L<Sort::Sub> import:
 ...
 use Sort::Sub '$by_data_cmp_numeric'; # use '$by_data_cmp_numeric<i>' for case-insensitive sorting, '$by_data_cmp_numeric<r>' for reverse sorting
 my @sorted = sort $by_data_cmp_numeric ('item', ...);

Generate sorter (accessed as subroutine):

 use Sort::Sub 'by_data_cmp_numeric<ir>';
 my @sorted = sort {by_data_cmp_numeric} ('item', ...);

Generate directly without Sort::Sub:

 use Sort::Sub::by_data_cmp_numeric;
 my $sorter = Sort::Sub::by_data_cmp_numeric::gen_sorter(
...
Use in shell/CLI with L<sortsub> (from L<App::sortsub>):
 ...
 % some-cmd | sortsub by_data_cmp_numeric
 % some-cmd | sortsub by_data_cmp_numeric --ignore-case -r
