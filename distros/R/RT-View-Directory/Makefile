# This Makefile is for the RT::View::Directory extension to perl.
#
...
#     ABSTRACT => q[RT View-Directory Extension]
#     AUTHOR => q[Jesse Vincent <jesse@bestpractical.com>]
#     DIR => []
#     DISTNAME => q[RT-View-Directory]
#     INSTALLSITELIB => q[/opt/rt3/local/lib]
#     NAME => q[RT::View::Directory]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => {  }
#     VERSION => q[1.7]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = RT::View::Directory
NAME_SYM = RT_View_Directory
VERSION = 1.7
...
TO_INST_PM = lib/RT/View/Directory.pm

PM_TO_BLIB = lib/RT/View/Directory.pm \
	blib/lib/RT/View/Directory.pm
...
DISTNAME = RT-View-Directory
DISTVNAME = RT-View-Directory-1.7
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>RT View-Directory Extension</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/RT/View/Directory.pm blib/lib/RT/View/Directory.pm 
