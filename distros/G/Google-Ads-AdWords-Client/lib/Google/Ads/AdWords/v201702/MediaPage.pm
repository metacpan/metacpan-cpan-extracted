package Google::Ads::AdWords::v201702::MediaPage;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'entries' => 'Google::Ads::AdWords::v201702::Media',
...
MediaPage from the namespace https://adwords.google.com/api/adwords/cm/v201702.
