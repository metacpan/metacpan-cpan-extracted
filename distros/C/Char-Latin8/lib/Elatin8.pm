...
sub import {
    ...
    *Char::ord           = \&Latin8::ord;
    *Char::ord_          = \&Latin8::ord_;
    *Char::reverse       = \&Latin8::reverse;
    *Char::getc          = \&Latin8::getc;
    *Char::length        = \&Latin8::length;
    *Char::substr        = \&Latin8::substr;
    *Char::index         = \&Latin8::index;
    *Char::rindex        = \&Latin8::rindex;
    *Char::eval          = \&Latin8::eval;
    *Char::escape        = \&Latin8::escape;
    *Char::escape_token  = \&Latin8::escape_token;
    *Char::escape_script = \&Latin8::escape_script;
}
...
my $qq_substr  = qr{(?> Char::substr | Latin8::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Elatin8::re_t=%s; while($Elatin8::re_t =~ %s){%s local $^W=0; local $Elatin8::re_r=%s; %s$Elatin8::re_t="$`$Elatin8::re_r$'"; pos($Elatin8::re_t)=length "$`$Elatin8::re_r"; } return $Elatin8::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Elatin8::re_r=CORE::eval $Elatin8::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Elatin8::re_r=%s; %s"%s$Elatin8::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Elatin8::re_n=0; while(%s =~ %s){%s local $^W=0; local $Elatin8::re_r=%s; %s%s="$`$Elatin8::re_r$'"; pos(%s)=length "$`$Elatin8::re_r"; $Elatin8::re_n++} return %s$Elatin8::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Elatin8::re_r=%s; %s%s="%s$Elatin8::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Elatin8::re_r=%s; %s%s="%s$Elatin8::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Elatin8::re_r=CORE::eval $Elatin8::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
