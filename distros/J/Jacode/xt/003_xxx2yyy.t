...
sub test {
    ...
    Jacode::euc2jis(*string_jis);
    Jacode::euc2sjis(*string_sjis);
    Jacode::euc2utf8(*string_utf8);
    ...
    for $option ('','h','z') {
        ...
        $string = $string_sjis;
        if (($rc = Jacode::sjis2jis(*string,$option)) == $chars) {
        ...
        $string = $string_sjis;
        if (($rc = Jacode::sjis2sjis(*string,$option)) == 0) {
        ...
        $string = $string_sjis;
        if (($rc = Jacode::sjis2euc(*string,$option)) == $chars) {
        ...
        $string = $string_sjis;
        if (($rc = Jacode::sjis2utf8(*string,$option)) == $chars) {
        ...
        $string = $string_jis;
        if (($rc = Jacode::jis2jis(*string,$option)) == 0) {
        ...
        $string = $string_jis;
        if (($rc = Jacode::jis2sjis(*string,$option)) == $chars) {
        ...
        $string = $string_jis;
        if (($rc = Jacode::jis2euc(*string,$option)) == $chars) {
        ...
        $string = $string_jis;
        if (($rc = Jacode::jis2utf8(*string,$option)) == $chars) {
        ...
        $string = $string_euc;
        if (($rc = Jacode::euc2jis(*string,$option)) == $chars) {
        ...
        $string = $string_euc;
        if (($rc = Jacode::euc2sjis(*string,$option)) == $chars) {
        ...
        $string = $string_euc;
        if (($rc = Jacode::euc2euc(*string,$option)) == 0) {
        ...
        $string = $string_euc;
        if (($rc = Jacode::euc2utf8(*string,$option)) == $chars) {
        ...
        $string = $string_utf8;
        if (($rc = Jacode::utf82jis(*string,$option)) == $chars) {
        ...
        $string = $string_utf8;
        if (($rc = Jacode::utf82sjis(*string,$option)) == $chars) {
        ...
        $string = $string_utf8;
        if (($rc = Jacode::utf82euc(*string,$option)) == $chars) {
        ...
        $string = $string_utf8;
        if (($rc = Jacode::utf82utf8(*string,$option)) == 0) {
