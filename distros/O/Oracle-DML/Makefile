# This Makefile is for the Oracle::DML extension to perl.
#
...
#     DISTNAME => q[Oracle-DML-0.10.tar.gz]
#     NAME => q[Oracle::DML]
...
DISTNAME = Oracle-DML-0.10.tar.gz
DISTVNAME = Oracle-DML-0.10.tar.gz-0.1
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  DML.pm $(INST_MAN3DIR)/Oracle::DML.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/Oracle/DML.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Oracle-DML-0.10.tar.gz' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl class for Oracle batch DML</ABSTRACT>' >> $(DISTNAME).ppd
