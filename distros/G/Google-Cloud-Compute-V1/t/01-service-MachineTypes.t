...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::MachineType Google::Cloud::Compute::V1::Compute::MachineTypeAggregatedList Google::Cloud::Compute::V1::Compute::MachineTypeList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::MachineTypesClient->new( credentials => 'dummy' );
