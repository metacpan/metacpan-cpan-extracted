...
eval { $v .= pmver('Role::HasMessage::Errf','0.005') };
eval { $v .= pmver('Role::HasPayload::Merged','0.005') };
eval { $v .= pmver('Role::Identifiable::HasIdent','0.005') };
eval { $v .= pmver('Role::Identifiable::HasTags','0.005') };
