...
This document describes version 0.025 of Data::Sah::Filter::perl::Str::ltrim (from Perl distribution Data-Sah-Filter), released on 2024-07-17.
...
=head2 Sample data and filtering results
 ...
 "  \t  \nfoo " # valid, becomes "foo " (Leading tabs and newlines will also be trimmed)
