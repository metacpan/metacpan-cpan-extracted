package Shipment::Purolator::WSDLV2::Types::Address;
$Shipment::Purolator::WSDLV2::Types::Address::VERSION = '3.04';
use strict;
use warnings;
...
Address from the namespace http://purolator.com/pws/datatypes/v2.
