...
#     ABSTRACT_FROM => q[lib/Acme/WTF.pm]
...
#     VERSION_FROM => q[lib/Acme/WTF.pm]
#     clean => { FILES=>q[Acme-WTF-*] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Acme/WTF.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Acme
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Acme
...
TO_INST_PM = lib/Acme/WTF.pm

PM_TO_BLIB = lib/Acme/WTF.pm \
	blib/lib/Acme/WTF.pm
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''The great new Acme::WTF!'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Marcus Del Greco <marcus@mindmined.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Acme-WTF' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "The great new Acme::WTF!",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Marcus Del Greco <marcus@mindmined.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Acme-WTF",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new Acme::WTF!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Marcus Del Greco &lt;marcus@mindmined.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Acme/WTF.pm blib/lib/Acme/WTF.pm 
