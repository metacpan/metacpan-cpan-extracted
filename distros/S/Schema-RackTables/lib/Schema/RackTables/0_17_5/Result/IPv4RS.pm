use utf8;
package Schema::RackTables::0_17_5::Result::IPv4RS;
...
Related object: L<Schema::RackTables::0_17_5::Result::IPv4RSPool>

=cut

__PACKAGE__->belongs_to(
  "rspool",
  "Schema::RackTables::0_17_5::Result::IPv4RSPool",
  { id => "rspool_id" },
  {
    is_deferrable => 1,
    join_type     => "LEFT",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XfzZD/nrzaXDfSPS8+Hstw
