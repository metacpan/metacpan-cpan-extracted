...
package PDF::API3::Compat::API2::Resource::Pattern;
...
=item $cs = PDF::API3::Compat::API2::Resource::Pattern->new $pdf, $key, %parameters
...
=item $cs = PDF::API3::Compat::API2::Resource::Pattern->new_api $api, $name
