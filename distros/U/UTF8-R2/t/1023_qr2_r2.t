...
# 341
    ...
    sub {1},
# 351
#   sub { ($] >= 5.006) or eval q{ "\x00"             =~ $r2{qr/[\x00]/}                   }},
#   sub { ($] >= 5.006) or eval q{ "\x7F"             =~ $r2{qr/[\x7F]/}                   }},
#   sub { ($] >= 5.006) or eval q{ "\xC2\x80"         =~ $r2{qr/[\xC2][\x80]/}             }},
#   sub { ($] >= 5.006) or eval q{ "\xDF\xBA"         =~ $r2{qr/[\xDF][\xBA]/}             }},
#   sub { ($] >= 5.006) or eval q{ "\xE0\xA0\x80"     =~ $r2{qr/[\xE0][\xA0][\x80]/}       }},
#   sub { ($] >= 5.006) or eval q{ "\xE0\xBF\x9A"     =~ $r2{qr/[\xE0][\xBF][\x9A]/}       }},
#   sub { ($] >= 5.006) or eval q{ "\xF0\x90\x80\x80" =~ $r2{qr/[\xF0][\x90][\x80][\x80]/} }},
#   sub { ($] >= 5.006) or eval q{ "\xF0\x90\xB9\xBE" =~ $r2{qr/[\xF0][\x90][\xB9][\xBE]/} }},
    sub {1},
    sub {1},
    sub {1},
    sub {1},
