...
#
#=======================================================================
package PDF::API3::Compat::API2::Resource::BaseFont;
...
=item $font = PDF::API3::Compat::API2::Resource::BaseFont->new $pdf, $name
...
=item $font = PDF::API3::Compat::API2::Resource::BaseFont->new_api $api, $name
