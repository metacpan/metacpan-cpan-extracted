...
our %STATS = ("num_rows",7490,"num_columns",9); # STATS
...
TableDataRole::Perl::CPAN::Release::Static::2002 - CPAN releases for the year 2002

=head1 VERSION

This document describes version 20220218.2 of TableDataRole::Perl::CPAN::Release::Static::2002 (from Perl distribution TableDataBundle-Perl-CPAN-Release-Static-Older), released on 2022-02-18.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Perl::CPAN::Release::Static::2002;

 my $td = TableData::Perl::CPAN::Release::Static::2002->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Perl::CPAN::Release::Static::2002 --page

 # Get number of rows
 % tabledata --action count_rows Perl::CPAN::Release::Static::2002
