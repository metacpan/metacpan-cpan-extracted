...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    UNIOP = 328,                   /* UNIOP  */
    LSTOP = 329,                   /* LSTOP  */
    BLKLSTOP = 330,                /* BLKLSTOP  */
    POWOP = 331,                   /* POWOP  */
    MULOP = 332,                   /* MULOP  */
    ADDOP = 333,                   /* ADDOP  */
    DOLSHARP = 334,                /* DOLSHARP  */
    HASHBRACK = 335,               /* HASHBRACK  */
    NOAMP = 336,                   /* NOAMP  */
    COLONATTR = 337,               /* COLONATTR  */
    FORMLBRACK = 338,              /* FORMLBRACK  */
    FORMRBRACK = 339,              /* FORMRBRACK  */
    SUBLEXSTART = 340,             /* SUBLEXSTART  */
    SUBLEXEND = 341,               /* SUBLEXEND  */
    PHASER = 342,                  /* PHASER  */
    PREC_LOW = 343,                /* PREC_LOW  */
    PLUGIN_LOW_OP = 344,           /* PLUGIN_LOW_OP  */
    OROP = 345,                    /* OROP  */
    PLUGIN_LOGICAL_OR_LOW_OP = 346, /* PLUGIN_LOGICAL_OR_LOW_OP  */
    ANDOP = 347,                   /* ANDOP  */
    PLUGIN_LOGICAL_AND_LOW_OP = 348, /* PLUGIN_LOGICAL_AND_LOW_OP  */
    NOTOP = 349,                   /* NOTOP  */
    ASSIGNOP = 350,                /* ASSIGNOP  */
    PLUGIN_ASSIGN_OP = 351,        /* PLUGIN_ASSIGN_OP  */
    PERLY_QUESTION_MARK = 352,     /* PERLY_QUESTION_MARK  */
    PERLY_COLON = 353,             /* PERLY_COLON  */
    OROR = 354,                    /* OROR  */
    DORDOR = 355,                  /* DORDOR  */
    PLUGIN_LOGICAL_OR_OP = 356,    /* PLUGIN_LOGICAL_OR_OP  */
    ANDAND = 357,                  /* ANDAND  */
    PLUGIN_LOGICAL_AND_OP = 358,   /* PLUGIN_LOGICAL_AND_OP  */
    BITOROP = 359,                 /* BITOROP  */
    BITANDOP = 360,                /* BITANDOP  */
    CHEQOP = 361,                  /* CHEQOP  */
    NCEQOP = 362,                  /* NCEQOP  */
    CHRELOP = 363,                 /* CHRELOP  */
    NCRELOP = 364,                 /* NCRELOP  */
    PLUGIN_REL_OP = 365,           /* PLUGIN_REL_OP  */
    SHIFTOP = 366,                 /* SHIFTOP  */
    PLUGIN_ADD_OP = 367,           /* PLUGIN_ADD_OP  */
    PLUGIN_MUL_OP = 368,           /* PLUGIN_MUL_OP  */
    MATCHOP = 369,                 /* MATCHOP  */
    PERLY_EXCLAMATION_MARK = 370,  /* PERLY_EXCLAMATION_MARK  */
    PERLY_TILDE = 371,             /* PERLY_TILDE  */
    UMINUS = 372,                  /* UMINUS  */
    REFGEN = 373,                  /* REFGEN  */
    PLUGIN_POW_OP = 374,           /* PLUGIN_POW_OP  */
    PREINC = 375,                  /* PREINC  */
    PREDEC = 376,                  /* PREDEC  */
    POSTINC = 377,                 /* POSTINC  */
    POSTDEC = 378,                 /* POSTDEC  */
    POSTJOIN = 379,                /* POSTJOIN  */
    PLUGIN_HIGH_OP = 380,          /* PLUGIN_HIGH_OP  */
    ARROW = 381,                   /* ARROW  */
    PERLY_PAREN_CLOSE = 382,       /* PERLY_PAREN_CLOSE  */
    PERLY_PAREN_OPEN = 383         /* PERLY_PAREN_OPEN  */
  };
