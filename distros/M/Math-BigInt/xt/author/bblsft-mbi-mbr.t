...
# Test
# - Math::BigInt -> bblsft() with and without upgrading to Math::BigRat
# - Math::BigRat -> bblsft() with and without downgrading to Math::BigInt

use strict;
use warnings;

use Test::More tests => 832814;
...
for my $upg (undef, "Math::BigRat") {
    for my $dng (undef, "Math::BigInt") {
        ...
        for my $ref ("Math::BigInt", "Math::BigRat") {
