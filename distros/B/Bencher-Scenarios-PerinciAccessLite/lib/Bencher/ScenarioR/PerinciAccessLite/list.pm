package Bencher::ScenarioR::PerinciAccessLite::list;
  ...
  [
    ...
    ],
    {
      "func.bencher_args"              => {
                                            ...
                                            scenario_module => "PerinciAccessLite::list",
                                          },
      ...
      "func.elapsed_time"              => 0.059089183807373,
      "func.module_startup"            => undef,
      "func.module_versions"           => {
                                            "__PACKAGE__" => 1.041,
                                            "Bencher::Scenario::PerinciAccessLite::list" => undef,
      ...
      "func.precision"                 => 0,
      "func.scenario_module"           => "Bencher::Scenario::PerinciAccessLite::list",
      "func.scenario_module_md5sum"    => "90fb0be6265616916283a275566d5e10",
      "func.scenario_module_mtime"     => 1542878109,
      "func.scenario_module_sha1sum"   => "0287d295e17c1be3d72ea2a12e82354fb7330aab",
      "func.scenario_module_sha256sum" => "ae2043efcb0d2e9725f596977f103e982d70ee3a7836a98b7319cd8cf432c489",
      "func.time_end"                  => 1542878214.16329,
      "func.time_factor"               => 1000000,
      "func.time_start"                => 1542878214.1042,
