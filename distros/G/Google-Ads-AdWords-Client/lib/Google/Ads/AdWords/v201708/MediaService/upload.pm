...
package Google::Ads::AdWords::v201708::MediaService::upload;
use strict;
use warnings;
...
Google::Ads::AdWords::v201708::MediaService::upload

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
upload from the namespace https://adwords.google.com/api/adwords/cm/v201708.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201708::MediaService::upload->new($data);

Constructor. The following data structure may be passed to new():

 {
   media =>  $a_reference_to, # see Google::Ads::AdWords::v201708::Media
 },
