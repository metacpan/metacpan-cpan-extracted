...
# --------------------------------------
{
   ...
   parse_tv ("Nest-4", 'Eval ${help_${#me}_${please}} ${also#* }', 'Hello ${world} ${2#* }');

   # Corrupted Variable definitions ...
   parse_tv ("Var-Unbal-0", 'Want to ${ ${help_${#me}_${please}} ${also#* }', 'Static Comment');
   parse_tv ("Var-Unbal-1", 'Want to ${ ${help_${#me}_${please}} ${also#* }', 'Hello ${ ${world} ${2#* }');
   parse_tv ("Var-Unbal-2", 'Want to ${help_${#me}_${please}} ${also#* } ${', 'Hello ${world} ${2#* } ${');
   parse_tv ("Var-Unbal-3", 'Want to ${help_${#me}_${please}} ${ ${also#* }', 'Hello ${world} ${ ${2#* }');

   parse_tv ("Var-Unbal-4", 'Ending } ${help_${#me}_${please}} ${also#* }', 'Hello } ${world} ${2#* }');
   parse_tv ("Var-Unbal-5", 'Ending ${help_${#me}_${please}} ${also#* } }', 'Hello ${world} ${2#* } }');
   parse_tv ("Var-Unbal-6", 'Ending ${help_${#me}_${please}} } ${also#* }', 'Hello ${world} } ${2#* }');
   parse_tv ("Var-Unbal-7", 'Ending ${help_${#me}_${please}} } ${also#* }', 'Static Comment');
