package Chart::Plotly::Trace::Contour::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Contour::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Contour::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Contour::Legendgrouptitle - This attribute is one of the possible options for the trace contour.
