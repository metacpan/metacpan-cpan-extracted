...
package Google::Ads::AdWords::v201710::CustomerExtensionSettingService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201710::CustomerExtensionSettingService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201710::CustomerExtensionSettingService::query->new($data);
