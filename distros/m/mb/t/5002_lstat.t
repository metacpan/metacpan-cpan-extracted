...
# 11
    ...
    sub { return 'SKIP' unless $MSWin32_MBCS; mb::eval(  q{ -e "5002.NOTEXTST.ソ"; @_ = eval q{ lstat _ }; scalar(@_) == 0 }) },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
# 21
    ...
    sub { return 'SKIP' unless $MSWin32_MBCS;                          mb::eval(  q{ -e "5002.777.ソ"; @_ = eval q{ lstat _ }; scalar(@_) == 0  }) },
    sub {1},
    sub {1},
# 31
    ...
    sub { return 'SKIP' unless $MSWin32_MBCS;                          mb::eval(  q{ -e "5002.ソ"; @_ = eval q{ lstat _ }; scalar(@_) == 0  }) },
    sub {1},
    sub {1},
# 41
