...
Sah::SchemaR::perl::wordlist::modname - Perl WordList::* module name without the prefix, e.g. EN::Enable

=head1 VERSION

This document describes version 0.005 of Sah::SchemaR::perl::wordlist::modname (from Perl distribution Sah-Schemas-WordList), released on 2023-01-19.
