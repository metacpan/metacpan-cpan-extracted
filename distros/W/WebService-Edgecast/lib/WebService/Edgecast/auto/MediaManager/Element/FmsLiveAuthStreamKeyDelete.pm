...
package WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthStreamKeyDelete;
BEGIN {
  $WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthStreamKeyDelete::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('FmsLiveAuthStreamKeyDelete');
...
WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthStreamKeyDelete
...
FmsLiveAuthStreamKeyDelete from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthStreamKeyDelete->new($data);
