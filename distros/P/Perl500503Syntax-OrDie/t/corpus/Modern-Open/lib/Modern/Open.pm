...
#
# Copyright (c) 2014, 2015, 2018, 2019, 2020, 2021, 2023, 2026 INABA Hitoshi <ina.cpan@gmail.com>
######################################################################
...
L<open|https://perldoc.perl.org/functions/open.html> - Perl Programming Documentation

=item *

L<Three-arg open() (Migrating to Modern Perl)|https://modernperlbooks.com/mt/2010/04/three-arg-open-migrating-to-modern-perl.html> - Modern Perl Programming

=item *

L<Pre-Modern Perl VS Post-Modern Perl: FIGHT!|https://blogs.perl.org/users/buddy_burden/2013/06/pre-modern-perl-vs-post-modern-perl-fight.html> - A blog about the Perl programming language

=item *

L<perl - open my $fh, "comand E<verbar>"; # isn't modern|https://blog.livedoor.jp/dankogai/archives/51176081.html> - 404 Blog Not Found

=item *

L<Migrating scripts back to Perl 5.005_03|https://www.perlmonks.org/?node_id=289351> - PerlMonks

=item *

L<Goodnight, Perl 5.005|https://www.oreillynet.com/onlamp/blog/2007/11/goodnight_perl_5005.html> - ONLamp.com

=item *

L<Perl 5.005_03 binaries|https://guest.engelschall.com/~sb/download/win32/> - engelschall.com

=item *

L<Welcome to CP5.5.3AN|https://cp5.5.3an.barnyard.co.uk/> - cp5.5.3an.barnyard.co.uk

=item *

L<ina|https://search.cpan.org/~ina/> - CPAN

=item *

L<The BackPAN|https://backpan.perl.org/authors/id/I/IN/INA/> - A Complete History of CPAN
