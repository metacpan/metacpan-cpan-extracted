package Toader::Render::Directory::backends::html;
...
Toader::Render::Directory::backends::html - This handles the html backend stuff for Toader::Render::Directory.
...
=head1 SYNOPSIS
    ...
    use Toader::Render::Directory::backends::html;
    
    my $renderer=Toader::Render::Directory::backends::html->new({ toader=>$oader, obj=>$directoryObj });
    my $rendered;
    if ( $renderer->error ){
...
This is the L<Toader> object to use.
	...
	my $foo=Toader::Render::Directory::backends::html->new(\%args);
    if($foo->error){
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Toader::Render::Directory::backends::html
