#
# Test case for WebService::Recruit::Eyeco::LargeCategory
#
...
my $service = new WebService::Recruit::Eyeco::LargeCategory();

ok( ref $service, 'new WebService::Recruit::Eyeco::LargeCategory()' );
...
# Test[0]
{
    ...
    my $res = new WebService::Recruit::Eyeco::LargeCategory();
