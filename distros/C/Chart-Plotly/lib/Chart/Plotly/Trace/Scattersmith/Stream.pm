package Chart::Plotly::Trace::Scattersmith::Stream;
use Moose;
...
Chart::Plotly::Trace::Scattersmith::Stream - This attribute is one of the possible options for the trace scattersmith.
