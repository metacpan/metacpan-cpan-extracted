package Chart::Plotly::Trace::Funnelarea::Insidetextfont;
use Moose;
...
Chart::Plotly::Trace::Funnelarea::Insidetextfont - This attribute is one of the possible options for the trace funnelarea.
