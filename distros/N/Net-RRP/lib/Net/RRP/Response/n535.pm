package Net::RRP::Response::n535;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n535::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n535::VERSION = '0.1';
...
Net::RRP::Response::n535 - the 535 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
