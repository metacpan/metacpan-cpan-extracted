...
#
# Referencia rapida do Jacode4e (Portugues)
# Este teste tambem serve como referencia rapida para utilizadores lusofonos.
######################################################################

# Este ficheiro esta codificado em UTF-8.
...
#
#   $line             : cadeia a converter (passada por referencia, substituida no lugar)
#   $OUTPUT_encoding  : nome da codificacao de saida
#   $INPUT_encoding   : nome da codificacao de entrada
#   $char_count       : numero de caracteres apos conversao
#
# [NOMES DE CODIFICACAO]
#
#   mnemonico   significado
#   ---------   ---------------------------------------------------
#   cp932x      CP932X (extensao para JIS X 0213, mudanca simples 0x9C5A)
#   cp932       Microsoft CP932 (Windows-31J / nome IANA)
#   cp932ibm    IBM CP932
#   cp932nec    NEC CP932
...
#   jef         FUJITSU JEF (12pt, codigos de mudanca com OUTPUT_SHIFTING)
#   jef9p       FUJITSU JEF ( 9pt, codigos de mudanca com OUTPUT_SHIFTING)
#   jipsj       NEC JIPS(J)
#   jipse       NEC JIPS(E)
#   letsj       UNISYS LetsJ
#   utf8        UTF-8.0 (o UTF-8 habitual)
#   utf8.1      UTF-8.1 (conversao baseada na correspondencia Shift_JIS-Unicode, nao CP932)
#   utf8jp      UTF-8-SPUA-JP (JIS X 0213 na zona SPUA do Unicode)
#
# [OPCOES]
#
#   chave             valor / descricao
#   ---------------   ---------------------------------------------------
#   INPUT_LAYOUT      disposicao do registo ('S'=SBCS, 'D'=DBCS, com repeticao)
#   OUTPUT_SHIFTING   se verdadeiro: inserir codigos de mudanca na saida
#   SPACE             codigo de espaco DBCS/MBCS (cadeia binaria)
#   GETA              caractere de substituicao para caracteres nao mapeaveis
#   OVERRIDE_MAPPING  substituicoes por caractere { "\x12\x34"=>"\x56\x78" }
#
# [AVISO: CONVERSAO DE IDA E VOLTA]
#
#   Existem conversoes com perdas (ex. CP932 tem 398 caracteres sem
#   mapeamento de ida e volta). Para conversao de ida e volta, usar
#   o modulo Jacode4e::RoundTrip.
#
# ======================================================================
...
BEGIN {
    ...
    @test = (
        ...
        ["\x81\x40", 'cp00930', 'cp932', {}, "\x40\x40", 'cp932(8140)->cp00930 sem mudanca(4040)'],
        ...
        ["\x81\x40\x31", 'keis83', 'cp932', {}, "\xA1\xA1\xF1",
            'cp932(814031)->keis83 sem mudanca(A1A1F1)'],
        ...
        ["\x81\x60", 'utf8', 'cp932', {'INPUT_LAYOUT'=>'D'}, "\xE3\x80\x9C",
            'cp932(8160 traco ondulado)->utf8(E3809C U+301C)'],
