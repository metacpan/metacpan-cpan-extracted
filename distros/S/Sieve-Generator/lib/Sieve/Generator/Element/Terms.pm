...
#pod an object doing L<Sieve::Generator::Element>; all terms are joined with single
...
Sieve::Generator::Element::Terms - a sequence of Sieve terms joined by spaces
