...
Perinci::CmdLine::Plugin::Debugging::DumpArgs - Dump command-line arguments ($r->{args}), by default after argument validation

=head1 VERSION

This document describes version 1.912 of Perinci::CmdLine::Plugin::Debugging::DumpArgs (from Perl distribution Perinci-CmdLine-Lite), released on 2021-12-01.
