...
package Amazon::SQS::Model::AddPermissionResponse;
...
use base qw (Amazon::SQS::Model);
    ...
    sub fromXML {
        ...
        return new Amazon::SQS::Model::AddPermissionResponse($tree);
    ...
    sub toXML {
        my $self = shift;
        my $xml = "";
        $xml .= "<AddPermissionResponse xmlns=\"http://queue.amazonaws.com/doc/2009-02-01/\">";
        $xml .= $self->_toXMLFragment();
        $xml .= "</AddPermissionResponse>";
        return $xml;
    }
