package Chart::Plotly::Trace::Barpolar::Unselected;
use Moose;
...
has marker => ( is  => "rw",
                isa => "Maybe[HashRef]|Chart::Plotly::Trace::Barpolar::Unselected::Marker", );

has textfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Barpolar::Unselected::Textfont", );
...
Chart::Plotly::Trace::Barpolar::Unselected - This attribute is one of the possible options for the trace barpolar.
