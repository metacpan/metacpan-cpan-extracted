...
our $rschema = ["int",[{max=>2147483647,min=>-2147483648,summary=>"32-bit signed integer"}],["int"]];
...
This document describes version 0.071 of Sah::SchemaR::int32 (from Perl distribution Sah-Schemas-Int), released on 2018-04-03.
