...
<html>
	<head>
	<title>Encode::Wide Coverage Report</title>
	<style>
...
<body>
<div class="badges">
	<a href="https://github.com/nigelhorne/Encode-Wide">
		<img src="https://img.shields.io/github/stars/nigelhorne/Encode-Wide?style=social" alt="GitHub stars">
	</a>
	<img src="$coverage_badge_url" alt="Coverage badge">
</div>
<h1>Encode::Wide</h1><h2>Coverage Report</h2>
...
chomp $commit_sha;
my $github_base = "https://github.com/nigelhorne/Encode-Wide/blob/$commit_sha/";
...
Readonly my $commit_url => "https://github.com/nigelhorne/Encode-Wide/commit/$commit_sha";
...
foreach my $file (reverse sort @history_files) {
	...
	my $url = "https://github.com/nigelhorne/Encode-Wide/commit/$sha";
...
push @html, <<"HTML";
<footer>
	<p>Project: <a href="https://github.com/nigelhorne/Encode-Wide">Encode-Wide</a></p>
