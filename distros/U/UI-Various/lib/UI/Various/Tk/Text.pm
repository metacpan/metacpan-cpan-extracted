package UI::Various::Tk::Text;

# Author, Copyright and License: see end of file

=head1 NAME

UI::Various::Tk::Text - concrete implementation of L<UI::Various::Text>
...
require Exporter;
our @ISA = qw(UI::Various::Text UI::Various::Tk::base);
our @EXPORT_OK = qw();
...
sub _prepare($$$)
{
    ...
    $self->_tk(	$_->_tk
		->Label(ref($self->{text}) eq 'SCALAR'
			? '-textvariable' : '-text' => $self->{text},
			@attributes)
