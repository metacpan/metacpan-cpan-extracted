...
use Shared::Examples::Net::Amazon::S3::API qw[ expect_api_bucket_tags_add ];

plan tests => 5;

expect_api_bucket_tags_add 'add tags to a bucket' => (
...
expect_api_bucket_tags_add 'S3 error - Access Denied' => (
	with_bucket             => 'some-bucket',
	with_tags               => fixture_tags_foo_bar_hashref,
...
expect_api_bucket_tags_add 'S3 error - Bucket Not Found' => (
	with_bucket             => 'some-bucket',
	with_tags               => fixture_tags_foo_bar_hashref,
...
expect_api_bucket_tags_add 'HTTP error - 400 Bad Request' => (
	with_bucket             => 'some-bucket',
	with_tags               => fixture_tags_foo_bar_hashref,
