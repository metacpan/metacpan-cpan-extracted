...
our $rschema = [
  "int",
  [
    { max => 32767, min => -32768, summary => "16-bit signed integer" },
  ],
  ["int"],
];
...
This document describes version 0.06 of Sah::SchemaR::int16 (from Perl distribution Sah-Schemas-Int), released on 2016-07-22.
