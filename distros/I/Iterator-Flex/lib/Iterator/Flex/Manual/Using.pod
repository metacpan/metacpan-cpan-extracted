...
The first thing to do is to construct one.  L<Iterator::Flex::Common> provides
...
True if the iterator is in the L<exhausted state|Iterator::Flex::Manual::Overview/Exhausted State>.
