...
this file, but rather the original, inline with Job::Async::Client::Memory
at lib/Job/Async/Client/Memory.pm
...
L<configure|Job::Async::Client/configure>, L<id|Job::Async::Client/id>, L<timeout|Job::Async::Client/timeout>
