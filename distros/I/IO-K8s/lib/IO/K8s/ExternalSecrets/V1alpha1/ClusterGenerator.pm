...
IO::K8s::ExternalSecrets::V1alpha1::ClusterGenerator - ClusterGenerator represents a cluster-wide generator which can be referenced as part of `generatorRef` fields.
