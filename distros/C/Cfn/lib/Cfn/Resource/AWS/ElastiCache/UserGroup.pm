# AWS::ElastiCache::UserGroup generated from spec 34.0.0
...
package Cfn::Resource::Properties::AWS::ElastiCache::UserGroup {
  ...
  has UserIds => (isa => 'Cfn::Value::Array|Cfn::Value::Function|Cfn::DynamicValue', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
}
