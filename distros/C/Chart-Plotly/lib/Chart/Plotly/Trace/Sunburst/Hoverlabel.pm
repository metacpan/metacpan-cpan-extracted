package Chart::Plotly::Trace::Sunburst::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Sunburst::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Sunburst::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Sunburst::Hoverlabel - This attribute is one of the possible options for the trace sunburst.
