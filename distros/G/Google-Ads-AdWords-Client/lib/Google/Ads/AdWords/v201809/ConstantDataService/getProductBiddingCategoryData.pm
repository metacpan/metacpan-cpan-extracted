...
package Google::Ads::AdWords::v201809::ConstantDataService::getProductBiddingCategoryData;
use strict;
use warnings;
...
getProductBiddingCategoryData from the namespace https://adwords.google.com/api/adwords/cm/v201809.
