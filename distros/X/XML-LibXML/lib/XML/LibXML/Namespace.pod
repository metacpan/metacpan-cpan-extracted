...
=head1 SYNOPSIS
  ...
  my $ns = XML::LibXML::Namespace-E<gt>new($nsURI);
  print $ns-E<gt>nodeName();
  print $ns-E<gt>name();
  $localname = $ns-E<gt>getLocalName();
  print $ns-E<gt>getData();
  print $ns-E<gt>getValue();
  print $ns-E<gt>value();
  $known_uri = $ns-E<gt>getNamespaceURI();
  $known_prefix = $ns-E<gt>getPrefix();
  $key = $ns-E<gt>unique_key();
