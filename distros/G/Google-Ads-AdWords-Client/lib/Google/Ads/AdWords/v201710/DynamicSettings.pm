package Google::Ads::AdWords::v201710::DynamicSettings;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'landscapeLogoImage' => 'Google::Ads::AdWords::v201710::Image',
...
Google::Ads::AdWords::v201710::DynamicSettings

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DynamicSettings from the namespace https://adwords.google.com/api/adwords/cm/v201710.
