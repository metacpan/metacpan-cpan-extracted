...
my @test = (
    sub {
        ...
        my @criteria = Devel::Cover::Report::Cobertura::Builder->accept_criteria();
    ...
    sub {
        ...
        my $ret = Devel::Cover::Report::Cobertura::Builder::template_dir();
    ...
    sub {
        ...
        my $ret    = Devel::Cover::Report::Cobertura::Builder::template_file();
        my $expect = 'cobertura.tt';
