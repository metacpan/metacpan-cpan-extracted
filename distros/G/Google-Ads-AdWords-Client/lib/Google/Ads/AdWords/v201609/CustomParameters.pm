package Google::Ads::AdWords::v201609::CustomParameters;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'parameters' => 'Google::Ads::AdWords::v201609::CustomParameter',
...
CustomParameters from the namespace https://adwords.google.com/api/adwords/cm/v201609.
