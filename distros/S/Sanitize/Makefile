# This Makefile is for the Sanitize extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Sanitize.pm]
...
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Sanitize.pm]
...
TO_INST_PM = lib/Sanitize.pm

PM_TO_BLIB = lib/Sanitize.pm \
	blib\lib\Sanitize.pm
...
Sanitize.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Sanitize\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Sanitize.pm $(INST_MAN3DIR)\Sanitize.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "abstract: 'Returns a sanitized version of strings'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "name: Sanitize" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "   \"abstract\" : \"Returns a sanitized version of strings\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"Sanitize\"," >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <ABSTRACT>Returns a sanitized version of strings</ABSTRACT>" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Sanitize.pm blib\lib\Sanitize.pm 
