...
package Google::Ads::AdWords::v201809::MediaService::upload;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'media' => 'Google::Ads::AdWords::v201809::Media',
    },
    {
...
upload from the namespace https://adwords.google.com/api/adwords/cm/v201809.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201809::MediaService::upload->new($data);

Constructor. The following data structure may be passed to new():

 {
   media =>  $a_reference_to, # see Google::Ads::AdWords::v201809::Media
 },
