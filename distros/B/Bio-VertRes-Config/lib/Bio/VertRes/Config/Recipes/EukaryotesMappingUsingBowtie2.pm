package Bio::VertRes::Config::Recipes::EukaryotesMappingUsingBowtie2;
...
Bio::VertRes::Config::Recipes::EukaryotesMappingUsingBowtie2 - Standard snp calling pipeline for bacteria
...
Standard snp calling pipeline for eukaryotes.
   ...
   my $obj = Bio::VertRes::Config::Recipes::EukaryotesMappingUsingBowtie2->new( 
     database => 'abc', 
