...
my @module_files = (
    'Data/Sah/Filter/perl/UUID/normalize_hexdigit_uuid.pm',
    'Sah/Schema/uuid/hexdigit.pm',
    'Sah/SchemaBundle/GUID.pm',
    'Sah/SchemaBundle/UUID.pm',
    'Sah/SchemaR/uuid/hexdigit.pm'
);
