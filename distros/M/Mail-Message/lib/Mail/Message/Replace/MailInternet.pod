...
the deletion of the message in a folder, so Mail::Box::Message subroutine delete
...
Mail::Box subroutine addMessage process, the message will get L<coerce()|Mail::Message::Replace::MailInternet/"Internals">-d
