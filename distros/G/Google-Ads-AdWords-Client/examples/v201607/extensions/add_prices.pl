...
use Google::Ads::AdWords::v201607::CustomerExtensionSetting;
use Google::Ads::AdWords::v201607::CustomerExtensionSettingOperation;
use Google::Ads::AdWords::v201607::FeedItemCampaignTargeting;
use Google::Ads::AdWords::v201607::FeedItemSchedule;
use Google::Ads::AdWords::v201607::FeedItemScheduling;
use Google::Ads::AdWords::v201607::Keyword;
use Google::Ads::AdWords::v201607::Location;
use Google::Ads::AdWords::v201607::Money;
use Google::Ads::AdWords::v201607::MoneyWithCurrency;
use Google::Ads::AdWords::v201607::PriceFeedItem;
use Google::Ads::AdWords::v201607::PriceTableRow;
...
sub add_prices {
  ...
  my $price_feed_item = Google::Ads::AdWords::v201607::PriceFeedItem->new({
      ...
      language            => 'en',
      campaignTargeting =>
        Google::Ads::AdWords::v201607::FeedItemCampaignTargeting->new({
          TargetingCampaignId => $campaign_id
        }
        ),
      scheduling => Google::Ads::AdWords::v201607::FeedItemScheduling->new({
          feedItemSchedules => [
            Google::Ads::AdWords::v201607::FeedItemSchedule->new({
                dayOfWeek   => "SUNDAY",
                startHour   => "10",
                startMinute => "ZERO",
                endHour     => "18",
  ...
  my $customer_extension_setting =
    Google::Ads::AdWords::v201607::CustomerExtensionSetting->new({
      extensionType    => 'PRICE',
      extensionSetting => Google::Ads::AdWords::v201607::ExtensionSetting->new({
          extensions => [$price_feed_item]})});

  my $mutate_result = $client->CustomerExtensionSettingService()->mutate({
      operations => [
        Google::Ads::AdWords::v201607::CustomerExtensionSettingOperation->new({
...
sub create_price_table_row {
  my ($header, $description, $final_url, $price_in_micros, $currency_code,
    $price_unit)
    = @_;
  my $price_table_row = Google::Ads::AdWords::v201607::PriceTableRow->new({
      header      => $header,
      description => $description,
      finalUrls =>
        [Google::Ads::AdWords::v201607::UrlList->new({urls => [$final_url]})],
      price => Google::Ads::AdWords::v201607::MoneyWithCurrency->new({
          money => Google::Ads::AdWords::v201607::Money->new({
