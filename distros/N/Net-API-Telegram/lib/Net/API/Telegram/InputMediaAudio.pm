# -*- perl -*-
##----------------------------------------------------------------------------
## Net/API/Telegram/InputMediaAudio.pm
## Version 0.1
...
##----------------------------------------------------------------------------
package Net::API::Telegram::InputMediaAudio;
BEGIN
{
	use strict;
...
Net::API::Telegram::InputMediaAudio - An audio file to be treated as music to be sent

=head1 SYNOPSIS

	my $msg = Net::API::Telegram::InputMediaAudio->new( %data ) || 
	die( Net::API::Telegram::InputMediaAudio->error, "\n" );

=head1 DESCRIPTION

L<Net::API::Telegram::InputMediaAudio> is a Telegram Message Object as defined here L<https://core.telegram.org/bots/api#inputmediaaudio>
