...
App::cryp::Cmd::Exchange::cancel_order - Cancel an order

=head1 VERSION

This document describes version 0.010 of App::cryp::Cmd::Exchange::cancel_order (from Perl distribution App-cryp-exchange), released on 2018-06-24.
