...
#
#=======================================================================
package PDF::API3::Compat::API2::Resource::CIDFont;
...
=item $font = PDF::API3::Compat::API2::Resource::CIDFont->new $pdf, $name
...
=item $font = PDF::API3::Compat::API2::Resource::CIDFont->new_api $api, $name, %options
