package Google::Ads::AdWords::v201705::AccountLabelService::AccountLabelServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201705::TypeMaps::AccountLabelService
    if not Google::Ads::AdWords::v201705::TypeMaps::AccountLabelService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/mcm/v201705/AccountLabelService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201705::TypeMaps::AccountLabelService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201705::AccountLabelService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201705::AccountLabelService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201705::AccountLabelService::mutate )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/mcm/v201705/AccountLabelService.
...
Returns a L<Google::Ads::AdWords::v201705::AccountLabelService::getResponse|Google::Ads::AdWords::v201705::AccountLabelService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201705::AccountLabelService::mutateResponse|Google::Ads::AdWords::v201705::AccountLabelService::mutateResponse> object.
