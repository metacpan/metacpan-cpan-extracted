...
sub getStopWords {
    if ( @_ and $_[0] eq 'UTF-8' ) {
        ...
        my %stoplist = map { ( pack("U0a*", $_), 1 ) } qw( 
            ...
            das daÃŸ derselbe derselben denselben desselben demselben
            ...
            ihn ihm es etwas euer eure eurem euren eurer eures fÃ¼r gegen
            ...
            jetzt kann kein keine keinem keinen keiner keines kÃ¶nnen
            kÃ¶nnte machen man manche manchem manchen mancher manches mein
            ...
            solchen solcher solches soll sollte sondern sonst Ã¼ber um und
            uns unse unsem unsen unser unses unter viel vom von vor
            wÃ¤hrend war waren warst was weg weil weiter welche welchem
            welchen welcher welches wenn werde werden wie wieder will wir
            wird wirst wo wollen wollte wÃ¼rde wÃ¼rden zu zum zur zwar
            zwischen 
        );
        return \%stoplist;
    }
