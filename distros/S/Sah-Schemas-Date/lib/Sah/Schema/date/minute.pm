...
# ABSTRACT: Minute of hour (0-59), e.g. 30
...
Sah::Schema::date::minute - Minute of hour (0-59), e.g. 30

=head1 VERSION

This document describes version 0.019 of Sah::Schema::date::minute (from Perl distribution Sah-Schemas-Date), released on 2023-12-09.
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"date::minute*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('date::minute*', name=>'DateMinute')
     );
 }

 use My::Types qw(DateMinute);
 DateMinute->assert_valid($data);
