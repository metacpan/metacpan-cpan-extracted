...
use Google::Ads::AdWords::v201402::Experiment;
use Google::Ads::AdWords::v201402::ExperimentOperation;
...
sub promote_experiment {
  ...
  my $experiment = Google::Ads::AdWords::v201402::Experiment->new({
    id => $experiment_id,
    status => "PROMOTED"
  });
  ...
  my $experiment_operation =
      Google::Ads::AdWords::v201402::ExperimentOperation->new({
        operator => "SET",
        operand => $experiment
      });
