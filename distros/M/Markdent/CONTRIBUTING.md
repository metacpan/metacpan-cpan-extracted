...
The code for this distribution is [hosted on GitHub](https://github.com/houseabsolute/Markdent).
...
on Linux by [Travis](https://travis-ci.org/houseabsolute/Markdent) and on Windows by [AppVeyor](https://ci.appveyor.com/project/autarch/Markdent).
