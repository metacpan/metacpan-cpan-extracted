package Chart::Plotly::Trace::Scattergeo::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Scattergeo::Hoverlabel::Font - This attribute is one of the possible options for the trace scattergeo.
