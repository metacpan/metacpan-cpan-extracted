package App::Git::IssueManager::Start;
...
sub run
{
  ...
  my $issue=$manager->start($self->id);
}
1;
...
App::Git::IssueManager::Start - class implementing the start issue command of the GIT IssueManager
