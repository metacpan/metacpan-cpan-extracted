...
use Google::Ads::AdWords::v201309::FrequencyCap;
use Google::Ads::AdWords::v201309::GeoTargetTypeSetting;
use Google::Ads::AdWords::v201309::KeywordMatchSetting;
use Google::Ads::AdWords::v201309::ManualCpcBiddingScheme;
...
sub add_campaigns {
  ...
  my $budget_operation = Google::Ads::AdWords::v201309::BudgetOperation->new({
    operator => "ADD",
    operand => $budget
  });
    ...
    my $campaign = Google::Ads::AdWords::v201309::Campaign->new({
      ...
      biddingStrategyConfiguration =>
          Google::Ads::AdWords::v201309::BiddingStrategyConfiguration->new({
            ...
            biddingScheme =>
                Google::Ads::AdWords::v201309::ManualCpcBiddingScheme->new({
