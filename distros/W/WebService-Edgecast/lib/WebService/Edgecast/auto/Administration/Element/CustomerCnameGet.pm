...
package WebService::Edgecast::auto::Administration::Element::CustomerCnameGet;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerCnameGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerCnameGet');
...
my %intCustomerCnameId_of :ATTR(:get<intCustomerCnameId>);
...
__PACKAGE__->_factory(
    ...
    ) ],
    {
        ...
        'intCustomerCnameId' => \%intCustomerCnameId_of,
    },
    {
        ...
        'intCustomerCnameId' => 'SOAP::WSDL::XSD::Typelib::Builtin::unsignedInt',
    },
    {
        ...
        'intCustomerCnameId' => 'intCustomerCnameId',
    }
);
...
WebService::Edgecast::auto::Administration::Element::CustomerCnameGet
...
CustomerCnameGet from the namespace EC:WebServices.
...
=item * intCustomerCnameId

 $element->set_intCustomerCnameId($data);
 $element->get_intCustomerCnameId();
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerCnameGet->new($data);
