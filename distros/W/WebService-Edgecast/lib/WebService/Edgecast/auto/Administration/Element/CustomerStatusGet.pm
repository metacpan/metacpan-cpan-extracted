...
package WebService::Edgecast::auto::Administration::Element::CustomerStatusGet;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerStatusGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerStatusGet');
...
WebService::Edgecast::auto::Administration::Element::CustomerStatusGet
...
CustomerStatusGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerStatusGet->new($data);
