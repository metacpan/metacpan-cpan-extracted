...
SQL::Statement::Function::ByName::ARGMINSTR - SQL function to return the (string-wise) minimum parameter

=head1 VERSION

This document describes version 0.002 of SQL::Statement::Function::ByName::ARGMINSTR (from Perl distribution SQL-Statement-Functions-ArgMinMax), released on 2017-01-25.
