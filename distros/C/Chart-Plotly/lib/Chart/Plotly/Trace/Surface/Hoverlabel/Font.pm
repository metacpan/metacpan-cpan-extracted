package Chart::Plotly::Trace::Surface::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Surface::Hoverlabel::Font - This attribute is one of the possible options for the trace surface.
