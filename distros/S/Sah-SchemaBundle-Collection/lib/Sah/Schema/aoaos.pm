...
This document describes version 0.009 of Sah::Schema::aoaos (from Perl distribution Sah-SchemaBundle-Collection), released on 2024-06-13.
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("aoaos", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("aoaos", {return_type=>'str_errmsg+val'});
 ...
 # a sample invalid data
 $data = "a";
 my $res = $validator->($data); # => ["Not of type array","a"]
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('aoaos*', name=>'Aoaos')
     );
 }

 use My::Types qw(Aoaos);
 Aoaos->assert_valid($data);
