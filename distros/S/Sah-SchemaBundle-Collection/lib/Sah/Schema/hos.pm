...
This document describes version 0.009 of Sah::Schema::hos (from Perl distribution Sah-SchemaBundle-Collection), released on 2024-06-13.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("hos*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("hos", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("hos", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("hos*");
     $validator->(\@args);
     ...
 }
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('hos*', name=>'Hos')
     );
 }

 use My::Types qw(Hos);
 Hos->assert_valid($data);
