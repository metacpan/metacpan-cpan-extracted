...
cmp_deeply(
    ...
    superbagof(
        methods(
            ...
            plugin_name => re(qr{^\@Author::TABULO/\@Git::VersionManager/RewriteVersion::Transitional$}),
            global => 1,
        ...
        all(
            methods(
                ...
                plugin_name => re(qr{^\@Author::TABULO/\@Git::VersionManager/CopyFilesFromRelease$}),
            ),
            noclass(superhashof({
        ...
        methods(
            ...
            plugin_name => re(qr{^\@Author::TABULO/\@Git::VersionManager/release snapshot$}),
            add_files_in => [ str('.') ],
        ...
        methods(
            ...
            plugin_name => re(qr{^\@Author::TABULO/\@Git::VersionManager/Git::Tag$}),
            tag_format => 'v%v',
            tag_message => 'v%v%t',
        ),
        methods(
            [ isa => 'Dist::Zilla::Plugin::BumpVersionAfterRelease::Transitional' ] => bool(1),
            plugin_name => re(qr{^\@Author::TABULO/\@Git::VersionManager/BumpVersionAfterRelease::Transitional$}),
            global => 1,
        ),
        methods(
        ...
        methods(
            [ isa => 'Dist::Zilla::Plugin::Git::Commit' ] => bool(1),
            plugin_name => re(qr{^\@Author::TABULO/\@Git::VersionManager/post-release commit$}),
            allow_dirty => superbagof(str('Changes')),
