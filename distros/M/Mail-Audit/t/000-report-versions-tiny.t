...
eval { $v .= pmver('File::HomeDir','0.61') };
...
eval { $v .= pmver('Mail::Mailer','any version') };
eval { $v .= pmver('Mail::POP3Client','any version') };
eval { $v .= pmver('Mail::Send','any version') };
eval { $v .= pmver('Net::SMTP','any version') };
eval { $v .= pmver('POSIX','any version') };
eval { $v .= pmver('Parse::RecDescent','any version') };
