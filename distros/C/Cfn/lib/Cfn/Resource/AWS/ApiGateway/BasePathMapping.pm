...
Cfn::Resource::AWS::ApiGateway::BasePathMapping - Cfn resource for AWS::ApiGateway::BasePathMapping

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::ApiGateway::BasePathMapping.
