...
$schemafile = File::Spec->catfile($dir, 'simple.dtd');
$badschemafile = File::Spec->catfile($dir, 'simple-bad.dtd');

basic_tests(
    type          => 'DTD',
    class         => 'XML::LibXML::Dtd',
    basecall      => \&is_valid_against_sgmldtd,
    alias1        => \&is_valid_against_dtd,
    alias2        => \&sgmldtd_ok,
