# ----------------------------------------------------------------------
# NAME       : BibTeX/Bib.pm
# CLASSES    : LaTeX::BibTeX::BibStructure, LaTeX::BibTeX::BibEntry;
#              loads LaTeX::BibTeX::BibSort and LaTeX::BibTeX::BibFormat
#              for use by BibEntry
...
# MODIFIED   : 
# VERSION    : $Id: Bib.pm,v 1.17 2000/03/23 02:08:40 greg Rel $
...
LaTeX::BibTeX::Bib - defines the "Bib" database structure
...
=head1 SYNOPSIS
   ...
   # a BibEntry
   $entry = new LaTeX::BibTeX::BibEntry ...;
...
reimplement BibTeX 0.99 in Perl using the core C<LaTeX::BibTeX> classes;
...
C<LaTeX::BibTeX::Bib> implements the database structure for
...
leading C<LaTeX::BibTeX> is implied, and will be omitted for the rest of
this document).  These two classes, being specific to bibliographic
data, are outside of the core C<LaTeX::BibTeX> class hierarchy, but are
...
interface for both of these is described in L<LaTeX::BibTeX::Structure>;
...
# first, the "structure class" (inherits from LaTeX::BibTeX::Structure)

package LaTeX::BibTeX::BibStructure;
use strict;
use vars qw(@ISA);
@ISA = qw(LaTeX::BibTeX::Structure);
...
field; see L<LaTeX::BibTeX::BibSort> for details.  Default value: C<name>.
...
As required by the C<LaTeX::BibTeX::Structure> module,
C<LaTeX::BibTeX::Bib> provides two methods for handling options:
C<known_option> and C<default_option>.  (The other two option methods,
C<set_options> and C<get_options>, are just inherited from
C<LaTeX::BibTeX::Structure>.)
...
database structure module should consult L<LaTeX::BibTeX::Structure> for
...
The second class provided by the C<LaTeX::BibTeX::Bib> module is
C<BibEntry> (again, a leading C<LaTeX::BibTeX> is implied).  This being a
...
L<LaTeX::BibTeX::Structure> for the benefit of programmers implementing
...
classes of C<BibEntry>.  Thus, see L<LaTeX::BibTeX::BibSort> and
L<LaTeX::BibTeX::BibFormat> for details on these two methods.

=cut

package LaTeX::BibTeX::BibEntry;
use strict;
use vars qw(@ISA);

use LaTeX::BibTeX::BibSort;
use LaTeX::BibTeX::BibFormat;

@ISA = qw(LaTeX::BibTeX::BibSort LaTeX::BibTeX::BibFormat);
...
my ($macro, $expansion);
LaTeX::BibTeX::add_macro_text ($macro, $expansion)
...
L<LaTeX::BibTeX::Structure>, L<LaTeX::BibTeX::BibSort>, 
L<LaTeX::BibTeX::BibFormat>.
