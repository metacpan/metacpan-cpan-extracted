...
#pod
#pod This is C<Hook::AfterBuild> plugin implementation. Nothing interesting, just using few roles.
#pod
...
#pod = L<Dist::Zilla>
#pod = L<Dist::Zilla::Role::AfterBuild>
#pod
#pod =cut

package Dist::Zilla::Plugin::Hook::AfterBuild;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::AfterBuild> plugin implementation
our $VERSION = 'v0.8.4'; # VERSION

with 'Dist::Zilla::Role::Plugin';
with 'Dist::Zilla::Role::Hooker' => {
    -alias => { hook => 'after_build' },
};
...
Dist::Zilla::Plugin::Hook::AfterBuild - C<Hook::AfterBuild> plugin implementation
...
This is C<Hook::AfterBuild> plugin implementation. Nothing interesting, just using few roles.
