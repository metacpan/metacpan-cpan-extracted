...
SQL::Statement::Function::ByName::DAYOFYEAR - Return day of year of a date/datetime expression

=head1 VERSION

This document describes version 0.050 of SQL::Statement::Function::ByName::DAYOFYEAR (from Perl distribution SQL-Statement-Functions-Date), released on 2022-12-12.
