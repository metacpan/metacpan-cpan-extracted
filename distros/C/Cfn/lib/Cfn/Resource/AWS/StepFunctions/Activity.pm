# AWS::StepFunctions::Activity generated from spec 34.0.0
...
package Cfn::Resource::AWS::StepFunctions::Activity {
  ...
  sub supported_regions {
    [ 'af-south-1','ap-east-1','ap-northeast-1','ap-northeast-2','ap-northeast-3','ap-south-1','ap-southeast-1','ap-southeast-2','ca-central-1','cn-north-1','cn-northwest-1','eu-central-1','eu-north-1','eu-south-1','eu-west-1','eu-west-2','eu-west-3','me-south-1','sa-east-1','us-east-1','us-east-2','us-gov-east-1','us-gov-west-1','us-west-2' ]
  }
}
  ...
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       ...
       return Cfn::Resource::Properties::Object::AWS::StepFunctions::Activity::TagsEntry->new( %$_ );
     }
   };

package Cfn::Resource::Properties::Object::AWS::StepFunctions::Activity::TagsEntry {
  use Moose;
...
Cfn::Resource::AWS::StepFunctions::Activity - Cfn resource for AWS::StepFunctions::Activity

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::StepFunctions::Activity.
