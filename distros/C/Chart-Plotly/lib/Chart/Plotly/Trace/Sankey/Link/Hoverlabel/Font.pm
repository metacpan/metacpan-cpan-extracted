package Chart::Plotly::Trace::Sankey::Link::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Sankey::Link::Hoverlabel::Font - This attribute is one of the possible options for the trace sankey.
