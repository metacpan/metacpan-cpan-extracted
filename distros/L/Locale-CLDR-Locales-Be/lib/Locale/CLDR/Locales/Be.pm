		 ...
		 sub {
			 my %languages = (
				'ab' => 'абхазская',
 				...
 				'en_GB@alt=short' => 'брытанская англійская',
 				'en_US' => 'англійская (ЗША)',
 				'en_US@alt=short' => 'амерыканская англійская',
 				'eo' => 'эсперанта',
 				'es' => 'іспанская',
	...
	default		=> sub {
		sub {
			...
			'Arab' => 'арабскае',
 			...
 			'Hans@alt=stand-alone' => 'спрошчаны хан',
 			'Hant' => 'традыцыйнае кітайскае',
 			'Hant@alt=stand-alone' => 'традыцыйны хан',
 			'Hebr' => 'яўрэйскае',
 			'Hira' => 'хірагана',
 			'Jpan' => 'японскае',
 			'Kana' => 'катакана',
...
has 'display_name_key' => (
	...
	default		=> sub { 
		{
			'calendar' => 'каляндар',
 			'collation' => 'сартаванне',
 			'currency' => 'валюта',
 			'hc' => 'часавы цыкл (12 і 24)',
	...
	default		=> sub {
		{
			'calendar' => {
 			...
 			'lb' => {
 				'loose' => q{гібкія правілы разрыву радка},
 				'normal' => q{стандартныя правілы разрыву радка},
 			...
 			'numbers' => {
 				...
 				'khmr' => q{хмерскія лічбы},
 				'knda' => q{лічбы каннада},
...
has 'units' => (
	...
	default		=> sub { {
				'long' => {
					...
					'arc-minute' => {
						'few' => q({0} вуглавыя хвіліны),
						'many' => q({0} вуглавых хвілін),
						'name' => q(вуглавыя хвіліны),
						'one' => q({0} вуглавая хвіліна),
						'other' => q({0} вуглавой хвіліны),
					},
					'arc-second' => {
					...
					'fluid-ounce' => {
						'few' => q({0} вадкія ўнцыі),
						'many' => q({0} вадкіх унцый),
						'name' => q(вадкія ўнцыі),
						'one' => q({0} вадкая ўнцыя),
					...
					'karat' => {
						'few' => q({0} караты золата),
						'many' => q({0} карат золата),
						'name' => q(караты золата),
						'one' => q({0} карат золата),
						'other' => q({0} карата золата),
					},
					'kelvin' => {
						'few' => q({0} кельвіны),
						'many' => q({0} кельвінаў),
					...
					'kilometer-per-hour' => {
						'few' => q({0} кіламетры ў гадзіну),
						'many' => q({0} кіламетраў у гадзіну),
						'name' => q(кіламетраў у гадзіну),
						'one' => q({0} кіламетр у гадзіну),
						'other' => q({0} кіламетра ў гадзіну),
					},
					'kilowatt' => {
						'few' => q({0} кілаваты),
						'many' => q({0} кілават),
					...
					'meter-per-second' => {
						'few' => q({0} метры ў секунду),
						'many' => q({0} метраў у секунду),
						'name' => q(метраў у секунду),
						'one' => q({0} метр у секунду),
						'other' => q({0} метра ў секунду),
					},
					...
					'mile-per-hour' => {
						'few' => q({0} мілі ў гадзіну),
						'many' => q({0} міль у гадзіну),
						'name' => q(міль у гадзіну),
						'one' => q({0} міля ў гадзіну),
						'other' => q({0} мілі ў гадзіну),
					},
					'mile-scandinavian' => {
					...
					'ounce-troy' => {
						'few' => q({0} тройскія ўнцыі),
						'many' => q({0} тройскіх унцый),
						'name' => q(тройскія ўнцыі),
						'one' => q({0} тройская ўнцыя),
...
has 'currencies' => (
	...
	default		=> sub { {
		...
		'BAM' => {
			symbol => 'BAM',
			display_name => {
				'currency' => q(канверсоўная марка),
				'few' => q(канверсоўныя маркі),
				'many' => q(канверсоўных марак),
				'one' => q(канверсоўная марка),
				'other' => q(канверсоўнай маркі),
			},
		},
		'BBD' => {
			symbol => 'BBD',
		...
		'PEN' => {
			symbol => 'PEN',
			display_name => {
				'currency' => q(перуанскі новы соль),
				'few' => q(перуанскія новыя солі),
				'many' => q(перуанскіх новых соляў),
				'one' => q(перуанскі новы соль),
				'other' => q(перуанскага новага соля),
			},
		},
		'PGK' => {
			symbol => 'PGK',
		...
		'SBD' => {
			...
			display_name => {
				...
				'few' => q(долары Саламонавых Астравоў),
		...
		'STD' => {
			...
			display_name => {
				...
				'many' => q(добр Сан-Тамэ і Прынсіпі),
		...
		'UAH' => {
			symbol => 'UAH',
			display_name => {
				'currency' => q(украінская грыўна),
				'few' => q(украінскія грыўні),
				'many' => q(украінскіх грыўнаў),
				'one' => q(украінская грыўна),
				'other' => q(украінскай грыўны),
			},
		},
		'UGX' => {
			symbol => 'UGX',
		...
		'XXX' => {
			display_name => {
				...
				'few' => q(невядомая валюта),
				'many' => q(невядомая валюта),
				'one' => q(невядомая валюта),
				'other' => q(невядомая валюта),
			},
		},
		'YER' => {
			symbol => 'YER',
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'America/Indiana/Petersburg' => {
			exemplarCity => q#Пецярсбург, Індыяна#,
		},
		...
		'America/Lower_Princes' => {
			exemplarCity => q#Лоуэр Прынсіз Квортар#,
		},
		'America/Maceio' => {
		...
		'America/North_Dakota/Beulah' => {
			exemplarCity => q#Бойла, Паўночная Дакота#,
		},
		'America/North_Dakota/Center' => {
			exemplarCity => q#Сентар, Паўночная Дакота#,
		},
		...
		'Bangladesh' => {
			long => {
				'daylight' => q(Летні час Бангладэша),
				'generic' => q(Час Бангладэша),
				'standard' => q(Стандартны час Бангладэша),
			},
		},
		'Bhutan' => {
			long => {
		...
		'French_Southern' => {
			long => {
				'standard' => q(Час Французскіх Паўднёвых і Антарктычных терыторый),
			},
		},
		'GMT' => {
			long => {
		...
		'Mexico_Northwest' => {
			long => {
				'daylight' => q(Паўночнаамерыканскі летні час),
				'generic' => q(Паўночнаамерыканскі мексіканскі час),
				'standard' => q(Паўночнаамерыканскі мексіканскі стандартны час),
			},
		},
		'Mexico_Pacific' => {
			long => {
		...
		'Pitcairn' => {
			long => {
				'standard' => q(Час астравоў Піткэрн),
			},
		},
		'Ponape' => {
			long => {
				'standard' => q(Час Панапэ),
			},
		},
		'Reunion' => {
			long => {
