package WWW::Opentracker::Stats::Mode::UDP4;
...
WWW::Opentracker::Stats::Mode::UDP4

=head1 DESCRIPTION

Parses the udp4 statistics from opentracker.
...
Decodes the plain text data retrieved from the udp4 statistics of opentracker.

The payload looks like this (no indentation):
 0
 0
 32082 seconds (8 hours)
 opentracker udp4 stats, 0 conns/s :: 0 success/s.
