package Chart::Plotly::Trace::Scattergeo::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Scattergeo::Legendgrouptitle::Font - This attribute is one of the possible options for the trace scattergeo.
