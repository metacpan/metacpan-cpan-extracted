package OWL::DirectSemantics::Element::DisjointClasses;

BEGIN {
	$OWL::DirectSemantics::Element::DisjointClasses::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::DisjointClasses::VERSION   = '0.001';
};
...
This class represents the DisjointClasses element in OWL Direct Semantics.
