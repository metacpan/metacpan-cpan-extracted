package Chart::Plotly::Trace::Histogram2d::Colorbar::Tickformatstop;
use Moose;
...
Chart::Plotly::Trace::Histogram2d::Colorbar::Tickformatstop - This attribute is one of the possible options for the trace histogram2d.
