...
use Google::Ads::AdWords::v201705::ServiceLink;
use Google::Ads::AdWords::v201705::ServiceLinkOperation;
...
sub accept_service_link {
  ...
  my $service_link = Google::Ads::AdWords::v201705::ServiceLink->new({
  ...
  my $op = Google::Ads::AdWords::v201705::ServiceLinkOperation->new({
    operator => "SET",
