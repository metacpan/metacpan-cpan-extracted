...
package Shipment::Purolator::WSDL::Elements::Shipment;
$Shipment::Purolator::WSDL::Elements::Shipment::VERSION = '3.05';
use strict;
use warnings;
...
Shipment from the namespace http://purolator.com/pws/datatypes/v1.
