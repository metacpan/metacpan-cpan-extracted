...
$Shipment::Temando::WSDL::Elements::getQuotesByRequestResponse::VERSION = '3.01';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    __PACKAGE__->__set_name('getQuotesByRequestResponse');
...
getQuotesByRequestResponse from the namespace http://' . $Shipment::Temando::WSDL::Interfaces::quoting_Service::quoting_port::ns_url . '/schema/2009_06/server.xsd.
...
=head2 new
 ...
 my $element = Shipment::Temando::WSDL::Elements::getQuotesByRequestResponse->new($data);
