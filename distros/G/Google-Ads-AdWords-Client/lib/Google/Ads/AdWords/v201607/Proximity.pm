package Google::Ads::AdWords::v201607::Proximity;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'geoPoint' => 'Google::Ads::AdWords::v201607::GeoPoint',
        'radiusDistanceUnits' => 'Google::Ads::AdWords::v201607::Proximity::DistanceUnits',
        'radiusInUnits' => 'SOAP::WSDL::XSD::Typelib::Builtin::double',
        'address' => 'Google::Ads::AdWords::v201607::Address',
    },
    {
...
Proximity from the namespace https://adwords.google.com/api/adwords/cm/v201607.
