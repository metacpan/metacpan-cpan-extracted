package Google::Ads::AdWords::v201705::CampaignSharedSet;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'sharedSetType' => 'Google::Ads::AdWords::v201705::SharedSetType',
        'campaignName' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'status' => 'Google::Ads::AdWords::v201705::CampaignSharedSet::Status',
    },
    {
...
CampaignSharedSet from the namespace https://adwords.google.com/api/adwords/cm/v201705.
