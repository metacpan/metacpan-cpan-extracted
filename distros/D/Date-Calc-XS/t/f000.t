...
if ($Date::Calc::XS_OK || 0)
{
    if ($Date::Calc::XS::VERSION eq '6.4')
    {print "ok $n\n";} else {print "not ok $n\n";}
    $n++;
    if (&Date::Calc::XS::Version() eq '6.4')
    {print "ok $n\n";} else {print "not ok $n\n";}
...
if ($Date::Calc::Object::VERSION >= '6.4')
{print "ok $n\n";} else {print "not ok $n\n";}
$n++;
...
if ($Date::Calendar::Profiles::VERSION >= '6.4')
{print "ok $n\n";} else {print "not ok $n\n";}
$n++;
...
if ($Date::Calendar::Year::VERSION >= '6.4')
{print "ok $n\n";} else {print "not ok $n\n";}
$n++;
