...
This document describes version 0.004 of Sah::Schema::array::int::sorted (from Perl distribution Sah-SchemaBundle-Array), released on 2024-02-13.
...
Used prefilters: L<Array::check_elems_numeric_sorted|Data::Sah::Filter::perl::Array::check_elems_numeric_sorted>
...
valid, a non-empty error message otherwise):
 ...
 $data = [1,"a"];
 my $errmsg = $validator->($data); # => "Elements not numerically sorted (check element[1]) "
...
(set-as-default, coerced, prefiltered) value:
 ...
 # a sample invalid data
 $data = [1,"a"];
 my $res = $validator->($data); # => ["Elements not numerically sorted (check element[1]) ",[1,"a"]]
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"array::int::sorted*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('array::int::sorted*', name=>'ArrayIntSorted')
     );
 }
