...
package Meta::Baseline::Lang::Conf;
...
Meta::Baseline::Lang::Conf - language for XML files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Conf::env();

=head1 DESCRIPTION

This package contains stuff specific to Conf in the baseline:
