package Google::Ads::AdWords::v201809::AdCampaignAdSubProductTypeError;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201809::AdCampaignAdSubProductTypeError::Reason',
    },
    {
...
Google::Ads::AdWords::v201809::AdCampaignAdSubProductTypeError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdCampaignAdSubProductTypeError from the namespace https://adwords.google.com/api/adwords/cm/v201809.

Error for AdCampaignAdSubProductType which is used by AdService.updateCampaignAdSubProductType(). 
