package Chart::Plotly::Trace::Treemap::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Treemap::Legendgrouptitle::Font - This attribute is one of the possible options for the trace treemap.
