...
package Google::Ads::AdWords::v201705::CampaignGroupPerformanceTargetService::get;
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::CampaignGroupPerformanceTargetService::get->new($data);
