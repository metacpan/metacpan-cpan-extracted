package Chart::Plotly::Trace::Waterfall::Decreasing::Marker;
use Moose;
...
use Chart::Plotly::Trace::Waterfall::Decreasing::Marker::Line;
...
has line => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Waterfall::Decreasing::Marker::Line", );
...
Chart::Plotly::Trace::Waterfall::Decreasing::Marker - This attribute is one of the possible options for the trace waterfall.
