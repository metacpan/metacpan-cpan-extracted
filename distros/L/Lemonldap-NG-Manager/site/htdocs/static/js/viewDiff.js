(function () {
  ...
  */
  var llapp;
  llapp = angular.module('llngConfDiff', ['ui.tree', 'ui.bootstrap', 'llApp', 'ngCookies'], ['$rootScopeProvider', function ($rootScopeProvider) {
    return $rootScopeProvider.digestTtl(15);
  }]);
  llapp.controller('DiffCtrl', ['$scope', '$http', '$q', '$translator', '$location', function ($scope, $http, $q, $translator, $location) {
    ...
    readDiff = function (c1, c2, tr = true) {
      var k, res, tmp, v;
      res = [];
      for (k in c1) {
        v = c1[k];
