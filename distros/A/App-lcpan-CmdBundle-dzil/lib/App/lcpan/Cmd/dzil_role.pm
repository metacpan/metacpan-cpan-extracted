...
1;
# ABSTRACT: Show a single Dist::Zilla role
...
App::lcpan::Cmd::dzil_role - Show a single Dist::Zilla role

=head1 VERSION

This document describes version 0.060 of App::lcpan::Cmd::dzil_role (from Perl distribution App-lcpan-CmdBundle-dzil), released on 2019-11-20.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<dzil-role>.
...
=item * B<dzil_role>* => I<perl::modname>
