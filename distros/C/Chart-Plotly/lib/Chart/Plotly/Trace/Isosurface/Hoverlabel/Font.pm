package Chart::Plotly::Trace::Isosurface::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Isosurface::Hoverlabel::Font - This attribute is one of the possible options for the trace isosurface.
