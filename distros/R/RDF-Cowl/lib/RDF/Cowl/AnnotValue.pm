...
$RDF::Cowl::AnnotValue::VERSION = '1.0.0';
# CowlAnnotValue
use strict;
use warnings;
...
RDF::Cowl::AnnotValue - Represents annotation values, which can be either anonymous individuals, IRIs, or literals
...
L<RDF::Cowl::Lib::Gen::Class::AnnotValue>
