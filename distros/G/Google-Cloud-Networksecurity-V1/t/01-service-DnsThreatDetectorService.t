...
BEGIN {
    for my $pkg (qw( Google::Cloud::Networksecurity::V1::DnsThreatDetector::ListDnsThreatDetectorsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Networksecurity::V1::DnsThreatDetectorServiceClient->new( credentials => 'dummy' );
