...
DateTime::Format::Unicode::Exception - DateTime Format Unicode Exception Class

=head1 SYNOPSIS

    my $ex = DateTime::Format::Unicode::Exception->new({
        code => 400,
        type => $error_type,
...
or, providing a list of string that will be concatenated:
    ...
    my $ex = DateTime::Format::Unicode::Exception->new( "Some error", "has occurred:", $details );
...
This method is called by perl when you call L<perlfunc/die> with no parameters and C<$@> is set to a L<DateTime::Format::Unicode::Exception> object.
...
But this is not :
    ...
    DateTime::Format::Unicode::Exception->rethrow;
...
Provided with a message string, this will create a new L<DateTime::Format::Unicode::Exception> object and call L<perlfunc/"die"> with it.
