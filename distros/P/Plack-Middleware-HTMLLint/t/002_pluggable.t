...
<html>
<head><title>hoge</title></head>
<body bgcolor="#000"><div style="border: double 3px; background-color: rgba(255, 0, 0, 0.2); margin: 3px; padding: 2px;"><h4 style="color: red">HTML&nbsp;Error</h4><dl><dt style="margin-left: 0.25em">elem-unknown</dt><dd style="padding-top: 0.25em; border-bottom: 1px solid #cccc00"> (5:52) Unknown element &lt;hoge&gt;</dd></dl></div><header><h1>fuga</h1></header><hoge></hoge></body>
</html>
};
...
<html>
<head><title>hoge</title></head>
<body bgcolor="#000"><header><h1>fuga</h1></header><hoge></hoge><div style="border: double 3px; background-color: rgba(255, 0, 0, 0.2); margin: 3px; padding: 2px;"><h4 style="color: red">HTML&nbsp;Error</h4><dl><dt style="margin-left: 0.25em">elem-unknown</dt><dd style="padding-top: 0.25em; border-bottom: 1px solid #cccc00"> (5:52) Unknown element &lt;hoge&gt;</dd></dl></div></body>
</html>
};
...
<div style="border: double 3px; background-color: rgba(255, 0, 0, 0.2); margin: 3px; padding: 2px;"><h4 style="color: red">HTML&nbsp;Error</h4><dl><dt style="margin-left: 0.25em">elem-unknown</dt><dd style="padding-top: 0.25em; border-bottom: 1px solid #cccc00"> (5:31) Unknown element &lt;hoge&gt;</dd><dt style="margin-left: 0.25em">doc-tag-required</dt><dd style="padding-top: 0.25em; border-bottom: 1px solid #cccc00"> (6:1) &lt;body&gt; tag is required</dd></dl></div>
};
