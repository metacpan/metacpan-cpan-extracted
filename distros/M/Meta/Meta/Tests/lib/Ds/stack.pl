...
$stac->print(Meta::Utils::Output::get_file());
while(!$stac->empty()) {
	my($elem)=$stac->pop();
	$stac->print(Meta::Utils::Output::get_file());
}
...
stack.pl - testing program for the Meta::Ds::Stack.pm module.
...
This is a small test suite for the Meta::Ds::Stack module.
Currently it just creates a stack, pushes some elements, and then prints
out the resulting stack.
...
Meta::Baseline::Test(3), Meta::Ds::Stack(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), strict(3)
