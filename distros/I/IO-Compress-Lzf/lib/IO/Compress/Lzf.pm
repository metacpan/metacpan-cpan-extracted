...
use IO::Compress::Adapter::Lzf  2.214 ;
#use Compress::Lzf ;
...
Note that although this module uses C<Compress::LZF> for compression,
...
For reading lzf files/buffers, see the companion module
L<IO::Uncompress::UnLzf|IO::Uncompress::UnLzf>.

=head1 Functional Interface

A top-level function, C<lzf>, is provided to carry out
...
characters "<" and ">" C<lzf> will assume that it is an
...
C<lzf> that are filehandles.

If C<AutoClose> is specified, and the value is true, it will result in all
input and/or output filehandles being closed once C<lzf> has
completed.
...
It returns an C<IO::Compress::Lzf> object on success and C<undef> on failure.
The variable C<$LzfError> will contain an error message on failure.

If you are running Perl 5.005 or better the object, C<$z>, returned from
IO::Compress::Lzf can be used exactly like an L<IO::File|IO::File> filehandle.
...
C<myfile.lzf> and write some data to it.
...
If the C<$output> parameter is any other type, C<IO::Compress::Lzf>::new will
return undef.
...
closed once either the C<close> method is called or the C<IO::Compress::Lzf>
object is destroyed.
...
To read the contents of the file C<file1.txt> and write the compressed
data to the file C<file1.txt.lzf> there are a few options
...
the IO::Compress::Lzf object is destroyed (either explicitly or by the
...
If the C<AutoClose> option has been enabled when the IO::Compress::Lzf
...
L<Compress::Zlib>, L<IO::Compress::Gzip>, L<IO::Uncompress::Gunzip>, L<IO::Compress::Deflate>, L<IO::Uncompress::Inflate>, L<IO::Compress::RawDeflate>, L<IO::Uncompress::RawInflate>, L<IO::Compress::Bzip2>, L<IO::Uncompress::Bunzip2>, L<IO::Compress::Lzma>, L<IO::Uncompress::UnLzma>, L<IO::Compress::Xz>, L<IO::Uncompress::UnXz>, L<IO::Compress::Lzip>, L<IO::Uncompress::UnLzip>, L<IO::Compress::Lzop>, L<IO::Uncompress::UnLzop>, L<IO::Uncompress::UnLzf>, L<IO::Compress::Zstd>, L<IO::Uncompress::UnZstd>, L<IO::Uncompress::AnyInflate>, L<IO::Uncompress::AnyUncompress>
