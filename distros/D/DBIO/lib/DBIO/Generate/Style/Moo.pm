package DBIO::Generate::Style::Moo;
# ABSTRACT: Moo-style emitter for DBIO::Generate
...
# IMPORTANT: This module writes "use Moo" as text. It does NOT load Moo
# at runtime. Moo is only required if you load the *generated* class.
...
DBIO::Generate::Style::Moo - Moo-style emitter for DBIO::Generate
...
Same spec as L<DBIO::Generate::Style::Vanilla/emit>. Emits C<use Moo> +
C<extends> style. No Moo dependency at generation time.
