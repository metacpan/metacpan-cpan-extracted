...
package Google::Ads::AdWords::v201708::CustomerService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'customer' => 'Google::Ads::AdWords::v201708::Customer',
    },
    {
...
Google::Ads::AdWords::v201708::CustomerService::mutate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutate from the namespace https://adwords.google.com/api/adwords/mcm/v201708.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201708::CustomerService::mutate->new($data);
