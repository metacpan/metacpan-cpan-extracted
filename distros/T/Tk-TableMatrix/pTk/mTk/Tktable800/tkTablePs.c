 ...
 *
 */
/* Currently generating postscript */
#define POSTSCRIPT
...
static Tk_ConfigSpec configSpecs[] = {
  {TK_CONFIG_SCALARVAR, "-colormap", (char *) NULL, (char *) NULL, "",
  ...
  {TK_CONFIG_SCALARVAR, "-fontmap", (char *) NULL, (char *) NULL, "",
...
#define STRING_LENGTH 400
	...
	for (col = firstCol; col <= lastCol; col++) {
	    ...
	    Tcl_DStringAppend(&buffer, Tcl_GetResult(interp), -1);
	}
