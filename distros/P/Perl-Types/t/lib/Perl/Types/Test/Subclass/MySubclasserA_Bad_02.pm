...
# <<< PARSE_ERROR: 'No such class Perl::Types::Test::Subclass::MySubclasserA_Bad_02_hashref::methodd' >>>
...
sub building_blocks {
    { my Perl::Types::Test::Subclass::MySubclasserA_Bad_02::method $RETURN_TYPE };
...
sub finger_paints {
    { my Perl::Types::Test::Subclass::MySubclasserA_Bad_02_arrayref::method $RETURN_TYPE };
    ( my Perl::Types::Test::Subclass::MySubclasserA_Bad_02 $self ) = @ARG;
    $self->{preschool} .= '; orange yellow red';
    my Perl::Types::Test::Subclass::MySubclasserA_Bad_02_arrayref $friends
...
sub sand_box {
    { my Perl::Types::Test::Subclass::MySubclasserA_Bad_02_hashref::methodd $RETURN_TYPE };
    ( my Perl::Types::Test::Subclass::MySubclasserA_Bad_02 $self ) = @ARG;
    $self->{preschool} .= '; castle';
    my Perl::Types::Test::Subclass::MySubclasserA_Bad_02_hashref $classmates = {
...
sub swings {
    { my Perl::Types::Test::Subclass::MySubclasserA_Bad_02_arrayref $RETURN_TYPE };
    my Perl::Types::Test::Subclass::MySubclasserA_Bad_02_arrayref $others
        = [ Perl::Types::Test::Subclass::MySubclasserA_Bad_02->new(), Perl::Types::Test::Subclass::MySubclasserA_Bad_02->new() ];
    return $others;
}

sub tinker_toys {
    { my Perl::Types::Test::Subclass::MySubclasserA_Bad_02_hashref $RETURN_TYPE };
    my Perl::Types::Test::Subclass::MySubclasserA_Bad_02_hashref $peers = {
