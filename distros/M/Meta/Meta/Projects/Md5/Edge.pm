...
package Meta::Projects::Md5::Edge;
...
sub BEGIN() {
	...
	__PACKAGE__->columns(All=>qw/id from_node_id to_node_id/);
}
...
Meta::Projects::Md5::Edge - fortune table edge Class::DBI wrapper.
...
=head1 SYNOPSIS
	...
	my($object)=Meta::Projects::Md5::Edge->new();
...
This is a testing suite for the Meta::Projects::Md5::Edge module.
