...
1;
# ABSTRACT: Convert to sepia tone
...
ColorTransform::Sepia - Convert to sepia tone

=head1 VERSION

This document describes version 0.002 of ColorTransform::Sepia (from Perl distribution ColorTransforms-Standard), released on 2020-06-13.
