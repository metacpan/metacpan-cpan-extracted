...
sub evaluate { $_[1]->eval_index($_[0]) }

=pod

=head1 NAME

Zuzu::AST::Expr::Index - AST node for index expressions
...
Value stored in the C<array> attribute.

=head2 index

Type: B<ConsumerOf["Zuzu::AST::Role::Node"]>.

Expression that evaluates to an index/key value.
...
B<< Zuzu::AST::Expr::Index >> is copyright Toby Inkster.
