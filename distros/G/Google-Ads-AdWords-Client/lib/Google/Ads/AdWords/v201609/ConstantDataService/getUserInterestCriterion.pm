...
package Google::Ads::AdWords::v201609::ConstantDataService::getUserInterestCriterion;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'userInterestTaxonomyType' => 'Google::Ads::AdWords::v201609::ConstantDataService::UserInterestTaxonomyType',
    },
    {
...
getUserInterestCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201609.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201609::ConstantDataService::getUserInterestCriterion->new($data);
