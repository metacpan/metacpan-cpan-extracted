...
package Astro::FITS::HdrTrans::LCOSPECTRAL;

=head1 NAME

Astro::FITS::HdrTrans::LCOSPECTRAL - LCO 2.0m Spectral translations

=head1 SYNOPSIS

  use Astro::FITS::HdrTrans::LCOSPECTRAL;

  %gen = Astro::FITS::HdrTrans::LCOSPECTRAL->translate_from_FITS( %hdr );

=head1 DESCRIPTION

This class provides a generic set of translations that are specific to
2.0m Spectrals at LCO.
...
is used when it's defined.  Otherwise it returns a default value of 0.1520 
