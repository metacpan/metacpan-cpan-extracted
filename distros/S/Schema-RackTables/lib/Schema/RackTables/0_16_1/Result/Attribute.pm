use utf8;
package Schema::RackTables::0_16_1::Result::Attribute;
...
Schema::RackTables::0_16_1::Result::Attribute
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uaShc1ntY1ZpTjjv/p+dfQ
