...
Developer::Dashboard::Pax::Runtime::Value - runtime value normalization helper

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::Runtime::Value;

  my $result = Developer::Dashboard::Pax::Runtime::Value->fast_int(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::Runtime::Value -e 1
