package Google::Ads::AdWords::v201609::ConversionTrackerService::ConversionTrackerServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201609::TypeMaps::ConversionTrackerService
    if not Google::Ads::AdWords::v201609::TypeMaps::ConversionTrackerService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201609/ConversionTrackerService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201609::TypeMaps::ConversionTrackerService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201609::ConversionTrackerService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201609::ConversionTrackerService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201609::ConversionTrackerService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201609::ConversionTrackerService::query )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201609/ConversionTrackerService.
...
Returns a L<Google::Ads::AdWords::v201609::ConversionTrackerService::getResponse|Google::Ads::AdWords::v201609::ConversionTrackerService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201609::ConversionTrackerService::mutateResponse|Google::Ads::AdWords::v201609::ConversionTrackerService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201609::ConversionTrackerService::queryResponse|Google::Ads::AdWords::v201609::ConversionTrackerService::queryResponse> object.
...
Generated by SOAP::WSDL on Thu May 25 10:00:32 2017
