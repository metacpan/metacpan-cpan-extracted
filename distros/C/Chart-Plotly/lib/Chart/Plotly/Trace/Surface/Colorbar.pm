package Chart::Plotly::Trace::Surface::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Surface::Colorbar::Tickfont;
use Chart::Plotly::Trace::Surface::Colorbar::Tickformatstop;
use Chart::Plotly::Trace::Surface::Colorbar::Titlefont;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Surface::Colorbar::Tickfont", );
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Surface::Colorbar::Tickformatstop]", );
...
has titlefont => ( is  => "rw",
                   isa => "Maybe[HashRef]|Chart::Plotly::Trace::Surface::Colorbar::Titlefont", );
...
Chart::Plotly::Trace::Surface::Colorbar - This attribute is one of the possible options for the trace surface.
