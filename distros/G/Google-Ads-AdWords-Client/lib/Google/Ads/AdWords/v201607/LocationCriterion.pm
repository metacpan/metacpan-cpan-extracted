package Google::Ads::AdWords::v201607::LocationCriterion;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'location' => 'Google::Ads::AdWords::v201607::Location',
...
LocationCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201607.
