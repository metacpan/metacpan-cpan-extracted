...
#define SWIGTYPE_p_cdtext_t swig_types[2]
#define SWIGTYPE_p_char swig_types[3]
#define SWIGTYPE_p_imaxdiv_t swig_types[4]
#define SWIGTYPE_p_int swig_types[5]
#define SWIGTYPE_p_iso9660_pvd_t swig_types[6]
...
XS(_wrap_get_cdtext__SWIG_0) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: get_cdtext(p_cdio);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_CdIo_t, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_get_cdtext) {
  ...
  dispatch:
    switch(_index) {
    case 1:
      PUSHMARK(MARK); SWIG_CALLXS(_wrap_get_cdtext__SWIG_0); return;
    case 2:
      PUSHMARK(MARK); SWIG_CALLXS(_wrap_get_cdtext__SWIG_1); return;
    }
  }
  
  croak("No matching function for overloaded 'get_cdtext'");
  XSRETURN(0);
}
