...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Test::DependentModules
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Test-DependentModules) or [via email](bug-test-dependentmodules@rt.cpan.org).
