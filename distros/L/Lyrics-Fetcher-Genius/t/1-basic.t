...
# quick dirty testing for Lyrics::Fetcher::Genius
#
...
# Genius site is unavailable, or, their site changes preventing this from working.
...
TEST: for my $test (@tests) {
    ...
    my $lyrics = Lyrics::Fetcher::Genius->fetch(@$test{ qw(artist title) })
