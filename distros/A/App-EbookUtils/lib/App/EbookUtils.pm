...
This document describes version 0.001 of App::EbookUtils (from Perl distribution App-EbookUtils), released on 2023-02-10.
...
L<App::PDFUtils> distribution includes some utilities like L<epub2pdf>.
