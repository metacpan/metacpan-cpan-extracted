package Google::Ads::AdWords::v201708::ManagedCustomerService::ManagedCustomerServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201708::TypeMaps::ManagedCustomerService
    if not Google::Ads::AdWords::v201708::TypeMaps::ManagedCustomerService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/mcm/v201708/ManagedCustomerService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201708::TypeMaps::ManagedCustomerService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201708::ManagedCustomerService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201708::ManagedCustomerService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201708::ManagedCustomerService::getPendingInvitations )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201708::ManagedCustomerService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201708::ManagedCustomerService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201708::ManagedCustomerService::mutateLink )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201708::ManagedCustomerService::mutateManager )],
        },
        header => {
...
Google::Ads::AdWords::v201708::ManagedCustomerService::ManagedCustomerServiceInterfacePort - SOAP Interface for the ManagedCustomerService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201708::ManagedCustomerService::ManagedCustomerServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201708::ManagedCustomerService::ManagedCustomerServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/mcm/v201708/ManagedCustomerService.
...
Returns a L<Google::Ads::AdWords::v201708::ManagedCustomerService::getResponse|Google::Ads::AdWords::v201708::ManagedCustomerService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201708::ManagedCustomerService::getPendingInvitationsResponse|Google::Ads::AdWords::v201708::ManagedCustomerService::getPendingInvitationsResponse> object.
...
Returns a L<Google::Ads::AdWords::v201708::ManagedCustomerService::mutateResponse|Google::Ads::AdWords::v201708::ManagedCustomerService::mutateResponse> object.

 $response = $interface->mutate( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201708::ManagedCustomerOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201708::ManagedCustomerService::mutateLabelResponse|Google::Ads::AdWords::v201708::ManagedCustomerService::mutateLabelResponse> object.

 $response = $interface->mutateLabel( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201708::ManagedCustomerLabelOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201708::ManagedCustomerService::mutateLinkResponse|Google::Ads::AdWords::v201708::ManagedCustomerService::mutateLinkResponse> object.
...
Returns a L<Google::Ads::AdWords::v201708::ManagedCustomerService::mutateManagerResponse|Google::Ads::AdWords::v201708::ManagedCustomerService::mutateManagerResponse> object.
...
Generated by SOAP::WSDL on Tue Aug  8 22:25:53 2017
