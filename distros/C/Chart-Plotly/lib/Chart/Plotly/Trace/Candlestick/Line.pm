package Chart::Plotly::Trace::Candlestick::Line;
use Moose;
...
Chart::Plotly::Trace::Candlestick::Line - This attribute is one of the possible options for the trace candlestick.
