# AWS::CodeGuruProfiler::ProfilingGroup generated from spec 18.4.0
...
subtype 'ArrayOfCfn::Resource::Properties::AWS::CodeGuruProfiler::ProfilingGroup::Channel',
     as 'Cfn::Value',
  where { $_->isa('Cfn::Value::Array') or $_->isa('Cfn::Value::Function') },
message { "$_ is not a Cfn::Value or a Cfn::Value::Function" };

coerce 'ArrayOfCfn::Resource::Properties::AWS::CodeGuruProfiler::ProfilingGroup::Channel',
  from 'HashRef',
   via {
  ...
  from 'ArrayRef',
   via {
     Cfn::Value::Array->new(Value => [
       map { 
         Moose::Util::TypeConstraints::find_type_constraint('Cfn::Resource::Properties::AWS::CodeGuruProfiler::ProfilingGroup::Channel')->coerce($_)
       } @$_
     ]);
   };

subtype 'Cfn::Resource::Properties::AWS::CodeGuruProfiler::ProfilingGroup::Channel',
     as 'Cfn::Value';

coerce 'Cfn::Resource::Properties::AWS::CodeGuruProfiler::ProfilingGroup::Channel',
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       return $f
...
package Cfn::Resource::Properties::Object::AWS::CodeGuruProfiler::ProfilingGroup::Channel {
  ...
  has channelUri => (isa => 'Cfn::Value::String', is => 'rw', coerce => 1, required => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
}
...
package Cfn::Resource::Properties::AWS::CodeGuruProfiler::ProfilingGroup {
  ...
  has AgentPermissions => (isa => 'Cfn::Value::Json|Cfn::DynamicValue', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
  has AnomalyDetectionNotificationConfiguration => (isa => 'ArrayOfCfn::Resource::Properties::AWS::CodeGuruProfiler::ProfilingGroup::Channel', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
