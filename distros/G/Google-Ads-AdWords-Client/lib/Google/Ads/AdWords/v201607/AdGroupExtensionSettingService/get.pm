...
package Google::Ads::AdWords::v201607::AdGroupExtensionSettingService::get;
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201607::AdGroupExtensionSettingService::get->new($data);
