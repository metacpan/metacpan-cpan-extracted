...
my($hash)=Meta::Utils::File::Collect::hash(Meta::Baseline::Aegis::work_dir(),0);
...
collect.pl - testing program for the Meta::Utils::File::Collect.pm module.
...
This is a test suite for the Meta::Utils::File::Collect.pm package.
...
Meta::Baseline::Aegis(3), Meta::Baseline::Test(3), Meta::Utils::File::Collect(3), Meta::Utils::Hash(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), strict(3)
