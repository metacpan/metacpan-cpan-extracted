...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::SslPoliciesAggregatedList Google::Cloud::Compute::V1::Compute::SslPoliciesList Google::Cloud::Compute::V1::Compute::SslPoliciesListAvailableFeaturesResponse Google::Cloud::Compute::V1::Compute::SslPolicy )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::SslPoliciesClient->new( credentials => 'dummy' );
