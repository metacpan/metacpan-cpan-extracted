package Chart::Plotly::Trace::Heatmapgl::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Heatmapgl::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Heatmapgl::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Heatmapgl::Legendgrouptitle - This attribute is one of the possible options for the trace heatmapgl.
