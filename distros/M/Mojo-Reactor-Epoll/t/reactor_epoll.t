...
is ref $reactor, 'Mojo::Reactor::Epoll', 'right object';
is ref Mojo::Reactor::Epoll->new, 'Mojo::Reactor::Epoll', 'right object';
undef $reactor;
is ref Mojo::Reactor::Epoll->new, 'Mojo::Reactor::Epoll', 'right object';
use_ok 'Mojo::IOLoop';
...
ok !$recurring, 'recurring was not triggered again';
my $reactor2 = Mojo::Reactor::Epoll->new;
is ref $reactor2, 'Mojo::Reactor::Epoll', 'right object';
...
SKIP: {
skip 'Mojolicious 8.37+ required for adjusting timers', 3
  unless eval { require Mojolicious; Mojolicious->VERSION('8.37'); 1 };
# Reset timer
...
# Detection
is(Mojo::Reactor::Epoll->detect, 'Mojo::Reactor::Epoll', 'right class');

# Dummy reactor
package Mojo::Reactor::Test;
use Mojo::Base 'Mojo::Reactor::Epoll';
...
# Reactor in control
is ref Mojo::IOLoop->singleton->reactor, 'Mojo::Reactor::Epoll', 'right object';
