...
package Google::Ads::AdWords::v201609::MediaService::upload;
use strict;
use warnings;
...
upload from the namespace https://adwords.google.com/api/adwords/cm/v201609.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201609::MediaService::upload->new($data);
