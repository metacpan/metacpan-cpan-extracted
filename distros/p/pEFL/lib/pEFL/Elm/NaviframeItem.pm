package pEFL::Elm::NaviframeItem;
...
our @ISA = qw(Exporter ElmNaviframeItemPtr);
...
require XSLoader;
XSLoader::load('pEFL::Elm::NaviframeItem');
...
sub pop_cb_set {
	...
	my $id = pEFL::PLSide::save_gen_item_data($parent, undef, $func, $data);
...
For instructions, how to use pEFL::Elm::NaviframeItem, please study this API reference for now. A perl-specific documentation will perhaps come in later versions. But applying the C documentation should be no problem. pEFL::Elm::NaviframeItem gives you a nice object-oriented interface that is kept close to the C API. Please note, that the perl method names remove the "elm_naviframe_item_" at the beginning of the c functions.
