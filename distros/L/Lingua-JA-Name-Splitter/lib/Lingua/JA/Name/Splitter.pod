...
(This example is included as L<F<synopsis.pl>|https://api.metacpan.org/source/BKB/Lingua-JA-Name-Splitter-0.08/examples/synopsis.pl> in the distribution.)


=head1 VERSION

This documents Lingua::JA::Name::Splitter version 0.08
corresponding to git commit L<c180cc3427768338df4d1462e5ffe9e8c79c134f|https://github.com/benkasminbullock/Lingua-JA-Name-Splitter/commit/c180cc3427768338df4d1462e5ffe9e8c79c134f> released on Sat Jan 28 11:08:45 2017 +0900.
...
(This example is included as L<F<katsu-yoshiki.pl>|https://api.metacpan.org/source/BKB/Lingua-JA-Name-Splitter-0.08/examples/katsu-yoshiki.pl> in the distribution.)
...
The script which makes the dictionary, L<F<enamdict-counter.pl>|https://github.com/benkasminbullock/Lingua-JA-Name-Splitter/blob/c180cc3427768338df4d1462e5ffe9e8c79c134f/enamdict-counter.pl>, is in the module's repository, but it is not provided in the
distribution itself. The script L<F<failures.pl>|https://github.com/benkasminbullock/Lingua-JA-Name-Splitter/blob/c180cc3427768338df4d1462e5ffe9e8c79c134f/failures.pl> counts the
number of failed matches with Enamdict. The script L<F<test-splitter.pl>|https://github.com/benkasminbullock/Lingua-JA-Name-Splitter/blob/c180cc3427768338df4d1462e5ffe9e8c79c134f/test-splitter.pl> is used to compute a probability factor used
in the module. The module L<F<Enamdict.pm>|https://github.com/benkasminbullock/Lingua-JA-Name-Splitter/blob/c180cc3427768338df4d1462e5ffe9e8c79c134f/Enamdict.pm> handles reading and
parsing Enamdict.
