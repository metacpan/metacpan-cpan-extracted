package Chart::Plotly::Trace::Scattersmith::Marker::Gradient;
use Moose;
...
Chart::Plotly::Trace::Scattersmith::Marker::Gradient - This attribute is one of the possible options for the trace scattersmith.
