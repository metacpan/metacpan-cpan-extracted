package Chart::Plotly::Trace::Histogram::Marker::Line;
use Moose;
...
Chart::Plotly::Trace::Histogram::Marker::Line - This attribute is one of the possible options for the trace histogram.
