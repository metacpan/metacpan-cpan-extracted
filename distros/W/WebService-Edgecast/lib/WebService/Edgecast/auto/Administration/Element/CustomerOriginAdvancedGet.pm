...
package WebService::Edgecast::auto::Administration::Element::CustomerOriginAdvancedGet;
BEGIN {
  $WebService::Edgecast::auto::Administration::Element::CustomerOriginAdvancedGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('CustomerOriginAdvancedGet');
...
WebService::Edgecast::auto::Administration::Element::CustomerOriginAdvancedGet
...
CustomerOriginAdvancedGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Administration::Element::CustomerOriginAdvancedGet->new($data);
