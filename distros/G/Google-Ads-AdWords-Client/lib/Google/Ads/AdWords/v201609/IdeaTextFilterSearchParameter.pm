package Google::Ads::AdWords::v201609::IdeaTextFilterSearchParameter;
use strict;
use warnings;
...
IdeaTextFilterSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201609.
