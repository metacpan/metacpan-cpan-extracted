package ODO::RDFS::Properties::comment;
...
sub new {
	...
	$self->propertyContainerName( 'ODO::RDFS::Properties::comment::PropertiesContainer' );
	$self->properties(bless {}, 'ODO::RDFS::Properties::comment::PropertiesContainer');
