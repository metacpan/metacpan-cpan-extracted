...
# Latin7::eval $var has Latin7::eval "..."
$var = <<'END';
...
# Latin7::eval $var has Latin7::eval qq{...}
$var = <<'END';
...
# Latin7::eval $var has Latin7::eval q{...}
$var = <<'END';
...
# Latin7::eval $var has Latin7::eval $var
$var = <<'END';
Latin7::eval $var2
END
...
# Latin7::eval $var has Latin7::eval (omit)
$var = <<'END';
Latin7::eval
END
