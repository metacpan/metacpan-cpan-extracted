...
is_deeply ($am_pm, [qw( vorm. nachm. )], 'Islamic AM PM wide');
$am_pm = $locale->am_pm_abbreviated();
is_deeply ($am_pm, [qw( vorm. nachm. )], 'Islamic AM PM abbreviated');
$am_pm = $locale->am_pm_narrow();
is_deeply ($am_pm, [qw( vm. nm. )], 'Islamic AM PM narrow');
...
is_deeply ($am_pm, { am => 'vm.', pm => 'nm.', midnight => 'Mitternacht', morning1 => 'morgens', morning2 => 'vormittags', afternoon1 => 'mittags', afternoon2 => 'nachmittags', evening1 => 'abends', night1 => 'nachts' }, 'Islamic AM PM format narrow');
