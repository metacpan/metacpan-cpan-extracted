...
Cfn::Resource::AWS::EC2::SubnetRouteTableAssociation - Cfn resource for AWS::EC2::SubnetRouteTableAssociation

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::EC2::SubnetRouteTableAssociation.
