...
$JMAP::Tester::LogWriter::VERSION = '0.020';
use Moo::Role;
...
$JMAP::Tester::LogWriter::Code::VERSION = '0.020';
use Moo;
  use namespace::clean;
...
$JMAP::Tester::LogWriter::Handle::VERSION = '0.020';
use Moo;
  use namespace::clean;
  with 'JMAP::Tester::LogWriter';
...
$JMAP::Tester::LogWriter::Filename::VERSION = '0.020';
use Moo;
  use namespace::clean;
  with 'JMAP::Tester::LogWriter';
