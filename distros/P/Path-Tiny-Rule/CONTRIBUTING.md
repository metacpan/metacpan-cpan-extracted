...
https://metacpan.org/release/Path-Tiny-Rule

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Path::Tiny::Rule
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Path::Tiny::Rule
...
The code for this distribution is [hosted at GitHub](https://github.com/houseabsolute/Path-Tiny-Rule).
...
can submit an issue report [via the web](https://github.com/houseabsolute/Path-Tiny-Rule/issues)
).
