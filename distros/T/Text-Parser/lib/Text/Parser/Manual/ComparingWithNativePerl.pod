...
There will be a compile-time penalty in using L<Text::Parser>. If compile-time performance is important for you, this package is not for you.
...
For now, you should assume that C<Text::Parser> takes roughly 2x run-time. Earlier versions where about 5x slower than native Perl.
