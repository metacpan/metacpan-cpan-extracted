...
=item HTML::FromMail-E<gt>B<new>(OPTIONS)
...
=item formatter => CLASS|OBJECT|HASH
...
=item $obj-E<gt>B<producer>( (CLASS|OBJECT) [, HTML_PRODUCER] )
...
=item $obj-E<gt>B<expandFiles>(DIRECTORY|FILENAME|ARRAY-OF-FILENAMES)
...
=item Warning: Cannot find $dir/file
...
=item Error: Cannot read from directory $thing: $!
...
=item Error: Formatter $class can not be used: $@
...
=item Warning: No templates found in $templates directory

=item Warning: Skipping $full, which is neither file or directory.
