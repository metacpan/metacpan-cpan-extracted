...
Bencher::Scenarios::PERLANCARParseArithmetic - Scenarios to benchmark PERLANCAR::Parse::Arithmetic

=head1 VERSION

This document describes version 0.006 of Bencher::Scenarios::PERLANCARParseArithmetic (from Perl distribution Bencher-Scenarios-PERLANCARParseArithmetic), released on 2017-01-25.
...
=item * L<Bencher::Scenario::PERLANCARParseArithmetic::parse_arithmetic>
