...
The code for this distribution is [hosted on GitHub](https://github.com/houseabsolute/DateTime-Format-Strptime).
...
on Linux by [Travis](https://travis-ci.org/houseabsolute/DateTime-Format-Strptime).
