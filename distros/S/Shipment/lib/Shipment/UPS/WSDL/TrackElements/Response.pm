...
package Shipment::UPS::WSDL::TrackElements::Response;
$Shipment::UPS::WSDL::TrackElements::Response::VERSION = '3.01';
use strict;
use warnings;
...
Shipment::UPS::WSDL::TrackElements::Response
...
=head2 new
 ...
 my $element = Shipment::UPS::WSDL::TrackElements::Response->new($data);
