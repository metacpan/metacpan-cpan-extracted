...
The model to use for image generation. One of C<dall-e-2>, C<dall-e-3>, or a GPT image model (C<gpt-image-1>, C<gpt-image-1-mini>, C<gpt-image-1.5>). Defaults to C<dall-e-2> unless a parameter specific to the GPT image models is used.

=over 4
      
=item * C<gpt-image-1.5>
