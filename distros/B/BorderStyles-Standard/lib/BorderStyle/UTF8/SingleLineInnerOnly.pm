...
1;
# ABSTRACT: Single line border with UTF8 characters, between columns only
...
BorderStyle::UTF8::SingleLineInnerOnly - Single line border with UTF8 characters, between columns only

=head1 VERSION

This document describes version 0.006 of BorderStyle::UTF8::SingleLineInnerOnly (from Perl distribution BorderStyles-Standard), released on 2021-02-19.
...
To use with L<Text::ANSITable>:
 ...
 $t->border_style("UTF8::SingleLineInnerOnly");
 $t->columns($rows->[0]);
...
To use with L<Text::Table::Span>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"UTF8::SingleLineInnerOnly");
...
To use with L<Text::Table::TinyBorderStyle>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"BorderStyle::UTF8::SingleLineInnerOnly");
