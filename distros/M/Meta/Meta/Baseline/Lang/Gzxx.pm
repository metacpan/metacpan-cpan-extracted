...
package Meta::Baseline::Lang::Gzxx;
...
Meta::Baseline::Lang::Gzxx - language for Gzip files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Gzxx::env();

=head1 DESCRIPTION

This package contains stuff specific to Gzip in the baseline:
Its mainly here to authorize entries of Gzip files to the baseline.
