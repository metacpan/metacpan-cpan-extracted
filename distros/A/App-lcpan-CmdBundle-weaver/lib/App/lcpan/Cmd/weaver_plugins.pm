...
1;
# ABSTRACT: List Pod::Weaver plugins available on CPAN
...
App::lcpan::Cmd::weaver_plugins - List Pod::Weaver plugins available on CPAN

=head1 VERSION

This document describes version 0.030 of App::lcpan::Cmd::weaver_plugins (from Perl distribution App-lcpan-CmdBundle-weaver), released on 2019-11-20.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<weaver-plugins>.
...
List Pod::Weaver plugins available on CPAN.
