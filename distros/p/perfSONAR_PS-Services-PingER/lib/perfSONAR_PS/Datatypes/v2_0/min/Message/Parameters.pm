...
=head1 NAME
 ...
 perfSONAR_PS::Datatypes::v2_0::min::Message::Parameters  - A base class, implements  'parameters'  element from the perfSONAR_PS RelaxNG schema
...
=head1 SYNOPSIS
              ...
              use perfSONAR_PS::Datatypes::v2_0::min::Message::Parameters;
	      
	      my $el =  perfSONAR_PS::Datatypes::v2_0::min::Message::Parameters->new($DOM_Obj);
