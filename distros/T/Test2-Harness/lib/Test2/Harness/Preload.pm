...
use Test2::Harness::Preload::Stage();
...
sub build_stage {
    ...
    my $stage = Test2::Harness::Preload::Stage->new(
...
Test2::Harness::Preload - DSL for building complex stage-based preload
tools.
