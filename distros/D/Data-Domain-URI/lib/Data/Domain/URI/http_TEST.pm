...
package Data::Domain::URI::http_TEST;
our $VERSION = '1.100850';
# ABSTRACT: Test companion class for the http URI data domain class
use Test::More;
use parent qw(
...
Data::Domain::URI::http_TEST - Test companion class for the http URI data domain class
...
Test companion class for L<Data::Domain::URI::http>. Gets its
