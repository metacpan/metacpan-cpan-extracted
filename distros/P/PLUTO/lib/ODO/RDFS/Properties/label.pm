package ODO::RDFS::Properties::label;
...
use ODO::RDFS::Literal;
use ODO::RDFS::Property;

@ISA = (  'ODO::RDFS::Literal',  'ODO::RDFS::Property', );
...
sub new {
	...
	$self->propertyContainerName( 'ODO::RDFS::Properties::label::PropertiesContainer' );
	$self->properties(bless {}, 'ODO::RDFS::Properties::label::PropertiesContainer');
