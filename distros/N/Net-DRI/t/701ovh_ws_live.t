...
$dri->add_registry('OVH');
$dri->target('OVH')->add_current_profile('p1','ws',{client_login=>$ENV{TEST_OVH_WS_LIVE_CLIENTID},client_password=>$ENV{TEST_OVH_WS_LIVE_CLIENTPASS}});
