...
use Log::Log4perl;
use_ok('perfSONAR_PS::Datatypes::v2_0::nmtm::Message::Data::CommonTime::Start');
...
#2
eval {
$obj1 = perfSONAR_PS::Datatypes::v2_0::nmtm::Message::Data::CommonTime::Start->new({
  'inclusive' =>  'value_inclusive',  'value' =>  'value_value',  'duration' =>  'value_duration',  'type' =>  'value_type',})
};
  ok( $obj1  && !$EVAL_ERROR , "Create object perfSONAR_PS::Datatypes::v2_0::nmtm::Message::Data::CommonTime::Start..." . $EVAL_ERROR);
  $EVAL_ERROR = undef; 
#3
 my $ns  =  $obj1->nsmap->mapname('start');
 ok($ns  eq 'nmtm', "  mapname('start')...  ");
#4
...
#9
 my $obj22 = undef; 
 eval {
    $obj22   =   perfSONAR_PS::Datatypes::v2_0::nmtm::Message::Data::CommonTime::Start->new({xml => $string});
 };
...
#10
 ...
 my $obj2 = undef; 
 eval {
    $obj2   =   perfSONAR_PS::Datatypes::v2_0::nmtm::Message::Data::CommonTime::Start->new($dom1);
 };
