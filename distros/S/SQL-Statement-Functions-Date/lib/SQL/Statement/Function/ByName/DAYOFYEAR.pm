...
SQL::Statement::Function::ByName::DAYOFYEAR - DAYOFYEAR() SQL function

=head1 VERSION

This document describes version 0.04 of SQL::Statement::Function::ByName::DAYOFYEAR (from Perl distribution SQL-Statement-Functions-Date), released on 2017-01-25.
