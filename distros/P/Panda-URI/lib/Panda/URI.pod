...
=item cloning via L<Panda::Lib>'s C<clone>
...
=head4 size_t encode_uri_component (const std::string_view src, char* dest, const char* unsafe = unsafe_query_component)
...
=head4 void encode_uri_component (const std::string_view src, panda::string& dest, const char* unsafe = unsafe_query_component)

=head4 panda::string encode_uri_component (const std::string_view src, const char* unsafe = unsafe_query_component)

String versions.

=head4 size_t decode_uri_component (const std::string_view src, char* dest)
...
=head4 void decode_uri_component (std::string_view, panda::string& dest)

=head4 panda::string decode_uri_component (std::string_view)
