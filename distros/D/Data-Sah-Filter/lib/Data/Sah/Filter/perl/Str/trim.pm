...
This document describes version 0.024 of Data::Sah::Filter::perl::Str::trim (from Perl distribution Data-Sah-Filter), released on 2024-01-17.
...
=head2 Using with L<Data::Sah>:
 ...
 my $schema = ["str","prefilters",[["Str::trim"]]];
