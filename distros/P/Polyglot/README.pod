...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Polyglot> or
L<MetaCPAN|http://www.metacpan.org/module/Polyglot>:

=over 4

=item *	L<http://search.cpan.org/dist/Polyglot>

=item *	L<http://www.metacpan.org/module/Polyglot>
