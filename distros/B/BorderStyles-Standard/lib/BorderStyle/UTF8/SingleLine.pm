...
1;
# ABSTRACT: Single-line border with UTF8 characters
...
BorderStyle::UTF8::SingleLine - Single-line border with UTF8 characters

=head1 VERSION

This document describes version 0.006 of BorderStyle::UTF8::SingleLine (from Perl distribution BorderStyles-Standard), released on 2021-02-19.
...
To use with L<Text::Table::Span>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"UTF8::SingleLine");
...
To use with L<Text::Table::TinyBorderStyle>:
 ...
 generate_table(rows=>$rows, header_row=>1, separate_rows=>1, border_style=>"BorderStyle::UTF8::SingleLine");
