...
1;
# ABSTRACT: List modules depended "by most number of authors" (modules ranked by number of authors that have dists that depend on the module)
...
App::lcpan::Cmd::mods_by_rdep_author_count - List modules depended "by most number of authors" (modules ranked by number of authors that have dists that depend on the module)

=head1 VERSION

This document describes version 1.070 of App::lcpan::Cmd::mods_by_rdep_author_count (from Perl distribution App-lcpan), released on 2022-03-27.
