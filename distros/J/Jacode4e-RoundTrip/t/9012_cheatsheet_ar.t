...
# [الفرق بين Jacode4e و Jacode4e::RoundTrip]
#
#   Jacode4e              : تحويل أحادي الاتجاه سريع. مع فقد لبعض الأحرف
#                           (مثلاً CP932 لديها 398 تعيين غير قابل للعكس).
#   Jacode4e::RoundTrip   : يضمن أمانة الذهاب والإياب عبر محور Unicode.
#                           A->B->A دائماً متطابق. أبطأ من Jacode4e،
#                           لكن استخدمه عندما تحتاج البيانات إلى الذهاب والإياب.
#
#   إذا لم تكن بحاجة للتحويل ذهاباً وإياباً، استخدم وحدة Jacode4e.
#
# ======================================================================
