...
Flail::Exec::Cmd::next - Flail "next" command

=head1 VERSION

  Time-stamp: <2006-12-03 11:04:34 attila@stalphonsos.com>

=head1 SYNOPSIS

  use Flail::Exec::Cmd::next;
  blah;
...
package Flail::Exec::Cmd::next;
use strict;
use Carp;
use Flail::Utils;
use base qw(Exporter);
use vars qw(@EXPORT @EXPORT_OK %EXPORT_TAGS);
@EXPORT_OK = qw(flail_next);
@EXPORT = ();
