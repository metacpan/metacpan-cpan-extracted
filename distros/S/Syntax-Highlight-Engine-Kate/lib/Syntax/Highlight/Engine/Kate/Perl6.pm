...
Syntax::Highlight::Engine::Kate::Perl6 is a  plugin module that provides syntax highlighting
for Perl 6 to the Syntax::Haghlight::Engine::Kate highlighting engine.
