...
has symbol => (
           is  => "rw",
           isa => union(
               [ enum( [ "circle", "circle-open", "square", "square-open", "diamond", "diamond-open", "cross", "x" ] ),
                 "ArrayRef"
               ]
           ),
...
Chart::Plotly::Trace::Scatter3d::Marker - This attribute is one of the possible options for the trace scatter3d.
