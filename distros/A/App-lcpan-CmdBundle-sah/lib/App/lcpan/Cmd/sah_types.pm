...
1;
# ABSTRACT: List Data::Sah types available on CPAN
...
App::lcpan::Cmd::sah_types - List Data::Sah types available on CPAN

=head1 VERSION

This document describes version 0.01 of App::lcpan::Cmd::sah_types (from Perl distribution App-lcpan-CmdBundle-sah), released on 2017-01-20.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<sah-types>.
