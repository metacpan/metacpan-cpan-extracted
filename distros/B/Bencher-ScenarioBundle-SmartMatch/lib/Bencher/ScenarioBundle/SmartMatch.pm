package Bencher::ScenarioBundle::SmartMatch;
...
1;
# ABSTRACT: Scenarios to benchmark switch & smartmatch in Perl
...
Bencher::ScenarioBundle::SmartMatch - Scenarios to benchmark switch & smartmatch in Perl

=head1 VERSION

This document describes version 0.001 of Bencher::ScenarioBundle::SmartMatch (from Perl distribution Bencher-ScenarioBundle-SmartMatch), released on 2024-07-02.
...
=item * L<Bencher::Scenario::SmartMatch::str_in_ary_of_str>

=item * L<Bencher::Scenario::Switch::Startup>
