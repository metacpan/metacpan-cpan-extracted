...
This document describes version 1.573 of Data::Unixish::ucfirst (from Perl distribution Data-Unixish), released on 2023-09-23.
...
Usage:
 ...
 ucfirst(%args) -> [$status_code, $reason, $payload, \%result_meta]
