...
package Meta::Baseline::Lang::Late;
...
Meta::Baseline::Lang::Late - language for Latex files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Late::env();

=head1 DESCRIPTION

This package contains stuff specific to Latex in the baseline:
Its mainly here to authorize entries of Latex files to the baseline.
...
=head1 HISTORY
	...
	0.01 MV fix docbook and other various stuff
