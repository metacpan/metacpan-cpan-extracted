...
IO::K8s::CertManager::V1::CertificateAdditionalOutputFormat - CertificateAdditionalOutputFormat defines an additional output format of a Certificate resource.
