package Google::Ads::AdWords::v201806::FeedItemCampaignTarget;
use strict;
use warnings;
...
Google::Ads::AdWords::v201806::FeedItemCampaignTarget

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItemCampaignTarget from the namespace https://adwords.google.com/api/adwords/cm/v201806.
