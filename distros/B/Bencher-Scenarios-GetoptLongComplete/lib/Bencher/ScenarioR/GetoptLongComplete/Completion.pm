package Bencher::ScenarioR::GetoptLongComplete::Completion;
  ...
  [
    ...
    ],
    {
      "func.bencher_args"              => {
                                            ...
                                            scenario_module => "GetoptLongComplete::Completion",
                                          },
      ...
      "func.elapsed_time"              => 1.03384208679199,
      "func.module_startup"            => undef,
      "func.module_versions"           => {
                                            "__PACKAGE__" => 1.034,
                                            "Bencher::Scenario::GetoptLongComplete::Completion" => undef,
                                            "Benchmark::Dumb" => "0.10",
      ...
      "func.precision"                 => 0,
      "func.scenario_module"           => "Bencher::Scenario::GetoptLongComplete::Completion",
      "func.scenario_module_md5sum"    => "9c76a221984d8a2f79910b6a8c896514",
      "func.scenario_module_mtime"     => 1452230505,
      "func.scenario_module_sha1sum"   => "38386b73dfabb11e461e058e7485d39702737ef3",
      "func.scenario_module_sha256sum" => "436f15207a7665c111fe344a1bb7fa98b5f05967b11da06058810fa790d27ee3",
      "func.time_end"                  => 1485330105.82276,
      "func.time_factor"               => 1000,
      "func.time_start"                => 1485330104.78892,
