package Chart::Plotly::Trace::Treemap::Marker::Colorbar::Tickformatstop;
use Moose;
...
Chart::Plotly::Trace::Treemap::Marker::Colorbar::Tickformatstop - This attribute is one of the possible options for the trace treemap.
