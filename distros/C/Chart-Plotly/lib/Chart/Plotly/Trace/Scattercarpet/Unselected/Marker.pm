package Chart::Plotly::Trace::Scattercarpet::Unselected::Marker;
use Moose;
...
Chart::Plotly::Trace::Scattercarpet::Unselected::Marker - This attribute is one of the possible options for the trace scattercarpet.
