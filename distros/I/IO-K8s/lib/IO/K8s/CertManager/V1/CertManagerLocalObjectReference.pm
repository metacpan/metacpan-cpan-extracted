...
IO::K8s::CertManager::V1::CertManagerLocalObjectReference - CredentialsRef is a reference to a Secret containing the CyberArk Certificate Manager Self-Hosted API credentials.
