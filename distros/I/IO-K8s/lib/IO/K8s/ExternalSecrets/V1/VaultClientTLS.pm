...
IO::K8s::ExternalSecrets::V1::VaultClientTLS - The configuration used for client side related TLS communication, when the Vault server requires mutual authentication.
