...
my $Map = {
  ...
  '~y'	=>	chr(U+0x2f), # Same as k
  '~m'	=>	chr(U+0x19),
  '~n'	=>	chr(U+0x1e),
  '~r'	=>	chr(U+0x30), #=> U+0x31 is reserved position.
  virama=>	chr(U+0x4d),
  base  =>      chr(U),
};
...
=head1	NAME
	...
	Unicode::Indic::Oriya -Perl module for the Oriya language.

=head1	SYNOPSIS

	use Unicode::Indic::Oriya;

=head1	DESCRIPTION

	This perl module is used for transliteration of text from qwerty keyboard characters to Unicode Oriya font characters and versa.
