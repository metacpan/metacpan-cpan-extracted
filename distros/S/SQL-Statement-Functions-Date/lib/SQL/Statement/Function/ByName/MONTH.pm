...
sub SQL_FUNCTION_MONTH {
    ...
    $param =~ /^\d{4}-(\d{2})-/ or return undef; ## no critic: TestingAndDebugging::ProhibitExplicitReturnUndef
    $1+0;
}
...
SQL::Statement::Function::ByName::MONTH - Return the month part of a date/datetime expression

=head1 VERSION

This document describes version 0.050 of SQL::Statement::Function::ByName::MONTH (from Perl distribution SQL-Statement-Functions-Date), released on 2022-12-12.
