...
package Google::Ads::AdWords::v201705::CustomerService::getServiceLinks;
use strict;
use warnings;
...
getServiceLinks from the namespace https://adwords.google.com/api/adwords/mcm/v201705.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::CustomerService::getServiceLinks->new($data);
