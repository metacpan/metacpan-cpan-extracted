package Chart::Plotly::Trace::Histogram::Marker::Colorbar::Titlefont;
use Moose;
...
Chart::Plotly::Trace::Histogram::Marker::Colorbar::Titlefont - This attribute is one of the possible options for the trace histogram.
