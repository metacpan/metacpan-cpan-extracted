...
This document describes version 0.050 of Sah::Schema::perl::distname_with_optional_ver (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::distname_with_optional_ver", {return_type=>'str_errmsg'});
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 use My::Types qw(PerlDistnameWithOptionalVer);
 PerlDistnameWithOptionalVer->assert_valid($data);
