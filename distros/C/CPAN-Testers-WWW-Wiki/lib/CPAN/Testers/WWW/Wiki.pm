...
CPAN::Testers::WWW::Wiki - The CPAN Testers Wiki website.

=head1 DESCRIPTION

This distribution contains all the code used to run the CPAN Testers Wiki website.

=head1 VHOST FILES

The CPAN Testers Wiki website is built on top of the Labyrinth Website 
