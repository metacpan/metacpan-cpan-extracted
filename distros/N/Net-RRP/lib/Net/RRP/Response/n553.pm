package Net::RRP::Response::n553;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n553::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n553::VERSION = '0.1';
...
Net::RRP::Response::n553 - the 553 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
