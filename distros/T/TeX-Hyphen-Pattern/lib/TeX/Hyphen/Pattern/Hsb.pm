...
package TeX::Hyphen::Pattern::Hsb v1.1.7;
use strict;
use warnings;
use 5.014000;
use utf8;
...
sub version {
    return $TeX::Hyphen::Pattern::Hsb::VERSION;
}
...
=for stopwords CTAN Ipenburg Hsb

=head1 NAME

TeX::Hyphen::Pattern::Hsb - class for hyphenation in locale Hsb
