...
#
# http://search.cpan.org/dist/CP932-R2/
#
...
sub import {
    ...
    *{caller().'::iolen' } = \&IOas::CP932::length;
    *{caller().'::iomid' } = \&IOas::CP932::substr;
    *{caller().'::ioget' } = \&IOas::CP932::readline;
    *{caller().'::ioput' } = \&IOas::CP932::print;
    *{caller().'::ioputf'} = \&IOas::CP932::printf;
    *{caller().'::iosort'} = \&IOas::CP932::sort;
}
...
Following subroutines and tied hash variable provide UTF-8 semantics for us.
  ...
  ------------------------------------------------------------------------------------------------------------------------------------------
  split(//,$_)             mbeach($utf8str)                            split $utf8str as CP932 encoding into each characters
  ------------------------------------------------------------------------------------------------------------------------------------------
...
These subroutines provide CP932 octets semantics for you.
