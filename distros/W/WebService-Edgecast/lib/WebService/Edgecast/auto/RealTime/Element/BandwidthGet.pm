...
package WebService::Edgecast::auto::RealTime::Element::BandwidthGet;
BEGIN {
  $WebService::Edgecast::auto::RealTime::Element::BandwidthGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('BandwidthGet');
...
WebService::Edgecast::auto::RealTime::Element::BandwidthGet
...
BandwidthGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::RealTime::Element::BandwidthGet->new($data);
