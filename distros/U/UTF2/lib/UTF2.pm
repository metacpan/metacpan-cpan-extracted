...
END
            ...
            if ($list !~ /\A (?>\s*) \z/oxms) {
                ...
                for (@list) {
                    ...
                    $Eutf2::function_ord     = $Eutf2::function_ord;
                    $Eutf2::function_ord_    = $Eutf2::function_ord_;
                    $Eutf2::function_reverse = $Eutf2::function_reverse;
                    $Eutf2::function_getc    = $Eutf2::function_getc;
                }
            }
        }
    }
