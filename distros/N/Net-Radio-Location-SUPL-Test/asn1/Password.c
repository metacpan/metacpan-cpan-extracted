...
asn_dec_rval_t
Password_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Password_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_Password_constr_1 = {
	{ APC_CONSTRAINED,	 4,  4,  48,  57 }	/* (48..57) */,
	{ APC_CONSTRAINED,	 0,  0,  4,  4 }	/* (SIZE(4..4)) */,
	0, 0	/* No PER character map necessary */
};
static ber_tlv_tag_t asn_DEF_Password_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_Password = {
	...
	Password_decode_xer,
	Password_encode_xer,
	Password_decode_uper,
	Password_encode_uper,
