...

{
    ...
    is_deeply([ @$y ], [[    0,    0, -200,  -12,  -48 ]], '$y has the right values');
...
note('prod(1) on a 4-by-5 matrix');
...
note('prod(2) on a 4-by-5 matrix');
...
note('prod(1) on a 4-by-1 matrix');
...
note('prod(2) on a 4-by-1 matrix');
