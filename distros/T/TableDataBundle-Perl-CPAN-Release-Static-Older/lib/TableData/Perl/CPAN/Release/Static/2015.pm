package ## no critic: Modules::RequireFilenameMatchesPackage
    # hide from PAUSE
    TableDataRole::Perl::CPAN::Release::Static::2015;
...
around new => sub {
    ...
    my $filename = File::Basename::dirname(__FILE__) . '/../../../../../../share/2015.csv';
    unless (-f $filename) {
        require File::ShareDir;
        $filename = File::ShareDir::dist_file('TableDataBundle-Perl-CPAN-Release-Static-Older', '2015.csv');
    }
    $orig->(@_, filename=>$filename);
};

package TableData::Perl::CPAN::Release::Static::2015;
...
with 'TableDataRole::Perl::CPAN::Release::Static::2015';

our %STATS = ("num_rows",22115,"num_columns",9); # STATS

1;
# ABSTRACT: CPAN releases for the year 2015
...
TableDataRole::Perl::CPAN::Release::Static::2015 - CPAN releases for the year 2015

=head1 VERSION

This document describes version 20210927.1 of TableDataRole::Perl::CPAN::Release::Static::2015 (from Perl distribution TableDataBundle-Perl-CPAN-Release-Static-Older), released on 2021-10-05.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Perl::CPAN::Release::Static::2015;

 my $td = TableData::Perl::CPAN::Release::Static::2015->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Perl::CPAN::Release::Static::2015 --page

 # Get number of rows
 % tabledata --action count_rows Perl::CPAN::Release::Static::2015
