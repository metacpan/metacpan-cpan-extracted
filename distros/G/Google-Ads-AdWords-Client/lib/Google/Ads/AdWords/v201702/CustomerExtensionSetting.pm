package Google::Ads::AdWords::v201702::CustomerExtensionSetting;
use strict;
use warnings;
...
CustomerExtensionSetting from the namespace https://adwords.google.com/api/adwords/cm/v201702.
