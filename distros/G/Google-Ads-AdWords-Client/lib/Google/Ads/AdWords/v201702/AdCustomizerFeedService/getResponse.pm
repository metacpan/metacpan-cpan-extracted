...
package Google::Ads::AdWords::v201702::AdCustomizerFeedService::getResponse;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'rval' => 'Google::Ads::AdWords::v201702::AdCustomizerFeedPage',
    },
    {
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::AdCustomizerFeedService::getResponse->new($data);

Constructor. The following data structure may be passed to new():

 {
   rval =>  $a_reference_to, # see Google::Ads::AdWords::v201702::AdCustomizerFeedPage
 },
