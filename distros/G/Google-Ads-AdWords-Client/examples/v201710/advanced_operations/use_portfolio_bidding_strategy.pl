...
use Google::Ads::AdWords::v201710::SharedBiddingStrategy;
use Google::Ads::AdWords::v201710::TargetSpendBiddingScheme;
use Google::Ads::AdWords::v201710::Money;
use Google::Ads::AdWords::v201710::BiddingStrategyOperation;
...
sub create_bidding_strategy {
  ...
  my $bidding_strategy =
    Google::Ads::AdWords::v201710::SharedBiddingStrategy->new({
      name => "Maximize Clicks " . uniqid(),
      type => "TARGET_SPEND",

      # Create the bidding scheme.
      biddingScheme =>
        Google::Ads::AdWords::v201710::TargetSpendBiddingScheme->new({
          # Optionally set additional bidding scheme parameters.
          bidCeiling => Google::Ads::AdWords::v201710::Money->new(
            {microAmount => 2000000,}
          ),
          spendTarget => Google::Ads::AdWords::v201710::Money->new(
            {microAmount => 20000000,})})});

  # Create operation.
  my $operation = Google::Ads::AdWords::v201710::BiddingStrategyOperation->new({
      operator => "ADD",
...
sub create_shared_budget {
  ...
  my $operation = Google::Ads::AdWords::v201710::BudgetOperation->new({
      operator => 'ADD',
      operand  => Google::Ads::AdWords::v201710::Budget->new({
          amount => Google::Ads::AdWords::v201710::Money->new(
...
sub create_campaign_with_bidding_strategy {
  ...
  my $campaign = Google::Ads::AdWords::v201710::Campaign->new({
      ...
      networkSetting => Google::Ads::AdWords::v201710::NetworkSetting->new({
