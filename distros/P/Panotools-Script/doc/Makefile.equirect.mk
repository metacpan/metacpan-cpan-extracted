...
equirect_all : qtvr sky planet mercator gpano

.PHONY: equirect_all layered psd qtvr preview panosalado vrml x3d spiv sky planet mercator equirect_clean faces_clean sky_clean planet_clean mercator_clean gpano
...
# a JPEG equirectangular with metadata intact

EQUIRECT_JPEG = $(EQUIRECT_PREFIX).jpg
EQUIRECT_JPEG_SHELL = $(EQUIRECT_PREFIX_SHELL).jpg

$(EQUIRECT_JPEG) : $(EQUIRECT_PREFIX).tif
	convert $(EQUIRECT_PREFIX_SHELL).tif $(EQUIRECT_JPEG_SHELL)
	$(EXIFTOOL_SHELL) -overwrite_original_in_place -TagsFromFile $(EQUIRECT_PREFIX_SHELL).tif $(EXIFTOOL_COPY_ARGS_SHELL) $(EQUIRECT_JPEG_SHELL)
