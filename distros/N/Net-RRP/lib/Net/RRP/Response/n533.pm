package Net::RRP::Response::n533;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n533::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n533::VERSION = '0.1';
...
Net::RRP::Response::n533 - the 533 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
