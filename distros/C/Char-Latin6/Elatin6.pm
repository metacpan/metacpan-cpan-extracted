...
######################################################################
#
# Elatin6 - Run-time routines for Latin6.pm
#
# http://search.cpan.org/dist/Char-Latin6/
#
...
BEGIN {
    ...
    sub qualify ($;$) {
        my ($name) = @_;
        if (!ref($name) && (Elatin6::index($name, '::') == -1) && (Elatin6::index($name, "'") == -1)) {
            my $pkg;
...
#
# Latin-6 character range per length
#
my %range_tr = ();
...
sub import {
    ...
    *Char::ord           = \&Latin6::ord;
    *Char::ord_          = \&Latin6::ord_;
    *Char::reverse       = \&Latin6::reverse;
    *Char::getc          = \&Latin6::getc;
    *Char::length        = \&Latin6::length;
    *Char::substr        = \&Latin6::substr;
    *Char::index         = \&Latin6::index;
    *Char::rindex        = \&Latin6::rindex;
    *Char::eval          = \&Latin6::eval;
    *Char::escape        = \&Latin6::escape;
    *Char::escape_token  = \&Latin6::escape_token;
    *Char::escape_script = \&Latin6::escape_script;
}
...
sub Elatin6::rindex($$;$);
sub Elatin6::lcfirst(@);
sub Elatin6::lcfirst_();
sub Elatin6::lc(@);
sub Elatin6::lc_();
sub Elatin6::ucfirst(@);
sub Elatin6::ucfirst_();
sub Elatin6::uc(@);
sub Elatin6::uc_();
sub Elatin6::fc(@);
sub Elatin6::fc_();
sub Elatin6::ignorecase;
sub Elatin6::classic_character_class;
sub Elatin6::capture;
sub Elatin6::chr(;$);
sub Elatin6::chr_();
sub Elatin6::glob($);
...
# ${Elatin6::eS}          = qr{(?>[^\x09\x0A    \x0C\x0D\x20])};
# ${Elatin6::eS}          = qr{(?>[^\x09\x0A\x0B\x0C\x0D\x20])};
${Elatin6::eS}            = qr{(?>[^\s])};

${Elatin6::eW}            = qr{(?>[^0-9A-Z_a-z])};
${Elatin6::eH}            = qr{(?>[^\x09\x20])};
${Elatin6::eV}            = qr{(?>[^\x0A\x0B\x0C\x0D])};
${Elatin6::eR}            = qr{(?>\x0D\x0A|[\x0A\x0D])};
${Elatin6::eN}            = qr{(?>[^\x0A])};
${Elatin6::not_alnum}     = qr{(?>[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Elatin6::not_alpha}     = qr{(?>[^\x41-\x5A\x61-\x7A])};
${Elatin6::not_ascii}     = qr{(?>[^\x00-\x7F])};
${Elatin6::not_blank}     = qr{(?>[^\x09\x20])};
${Elatin6::not_cntrl}     = qr{(?>[^\x00-\x1F\x7F])};
${Elatin6::not_digit}     = qr{(?>[^\x30-\x39])};
${Elatin6::not_graph}     = qr{(?>[^\x21-\x7F])};
${Elatin6::not_lower}     = qr{(?>[^\x61-\x7A])};
${Elatin6::not_lower_i}   = qr{(?>[^\x41-\x5A\x61-\x7A])}; # Perl 5.16 compatible
# ${Elatin6::not_lower_i} = qr{(?>[\x00-\xFF])};                   # older Perl compatible
${Elatin6::not_print}     = qr{(?>[^\x20-\x7F])};
${Elatin6::not_punct}     = qr{(?>[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Elatin6::not_space}     = qr{(?>[^\s\x0B])};
${Elatin6::not_upper}     = qr{(?>[^\x41-\x5A])};
${Elatin6::not_upper_i}   = qr{(?>[^\x41-\x5A\x61-\x7A])}; # Perl 5.16 compatible
# ${Elatin6::not_upper_i} = qr{(?>[\x00-\xFF])};                   # older Perl compatible
${Elatin6::not_word}      = qr{(?>[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Elatin6::not_xdigit}    = qr{(?>[^\x30-\x39\x41-\x46\x61-\x66])};
${Elatin6::eb}            = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Elatin6::eB}            = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Elatin6::foo" used only once: possible typo at here.
${Elatin6::dot}         = ${Elatin6::dot};
${Elatin6::dot_s}       = ${Elatin6::dot_s};
${Elatin6::eD}          = ${Elatin6::eD};
${Elatin6::eS}          = ${Elatin6::eS};
${Elatin6::eW}          = ${Elatin6::eW};
${Elatin6::eH}          = ${Elatin6::eH};
${Elatin6::eV}          = ${Elatin6::eV};
${Elatin6::eR}          = ${Elatin6::eR};
${Elatin6::eN}          = ${Elatin6::eN};
${Elatin6::not_alnum}   = ${Elatin6::not_alnum};
${Elatin6::not_alpha}   = ${Elatin6::not_alpha};
${Elatin6::not_ascii}   = ${Elatin6::not_ascii};
${Elatin6::not_blank}   = ${Elatin6::not_blank};
${Elatin6::not_cntrl}   = ${Elatin6::not_cntrl};
${Elatin6::not_digit}   = ${Elatin6::not_digit};
${Elatin6::not_graph}   = ${Elatin6::not_graph};
${Elatin6::not_lower}   = ${Elatin6::not_lower};
${Elatin6::not_lower_i} = ${Elatin6::not_lower_i};
${Elatin6::not_print}   = ${Elatin6::not_print};
${Elatin6::not_punct}   = ${Elatin6::not_punct};
${Elatin6::not_space}   = ${Elatin6::not_space};
${Elatin6::not_upper}   = ${Elatin6::not_upper};
${Elatin6::not_upper_i} = ${Elatin6::not_upper_i};
${Elatin6::not_word}    = ${Elatin6::not_word};
${Elatin6::not_xdigit}  = ${Elatin6::not_xdigit};
${Elatin6::eb}          = ${Elatin6::eb};
${Elatin6::eB}          = ${Elatin6::eB};
...
#
# Latin-6 lower case first with parameter
#
sub Elatin6::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Elatin6::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Elatin6::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Elatin6::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Latin-6 lower case first without parameter
#
sub Elatin6::lcfirst_() {
    return Elatin6::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Latin-6 lower case with parameter
#
sub Elatin6::lc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-6 lower case without parameter
#
sub Elatin6::lc_() {
    my $s = $_;
    return join '', map {defined($lc{$_}) ? $lc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-6 upper case first with parameter
#
sub Elatin6::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Elatin6::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Elatin6::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Elatin6::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Latin-6 upper case first without parameter
#
sub Elatin6::ucfirst_() {
    return Elatin6::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Latin-6 upper case with parameter
#
sub Elatin6::uc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-6 upper case without parameter
#
sub Elatin6::uc_() {
    my $s = $_;
    return join '', map {defined($uc{$_}) ? $uc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-6 fold case with parameter
#
sub Elatin6::fc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-6 fold case without parameter
#
sub Elatin6::fc_() {
    my $s = $_;
    return join '', map {defined($fc{$_}) ? $fc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-6 regexp ignore case modifier
#
sub Elatin6::ignorecase {
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Elatin6::uc($char[$i]);
                my $fc = Elatin6::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
#
# prepare Latin-6 characters per length
#
...
#
# Latin-6 open character list for tr
#
sub _charlist_tr {
...
#
# Latin-6 open character list for qr and not qr
#
sub _charlist {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Elatin6::not_lower_i}',
                '[:^upper:]'  => '${Elatin6::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Elatin6::not_alnum}',
                '[:^alpha:]'  => '${Elatin6::not_alpha}',
                '[:^ascii:]'  => '${Elatin6::not_ascii}',
                '[:^blank:]'  => '${Elatin6::not_blank}',
                '[:^cntrl:]'  => '${Elatin6::not_cntrl}',
                '[:^digit:]'  => '${Elatin6::not_digit}',
                '[:^graph:]'  => '${Elatin6::not_graph}',
                '[:^lower:]'  => '${Elatin6::not_lower}',
                '[:^print:]'  => '${Elatin6::not_print}',
                '[:^punct:]'  => '${Elatin6::not_punct}',
                '[:^space:]'  => '${Elatin6::not_space}',
                '[:^upper:]'  => '${Elatin6::not_upper}',
                '[:^word:]'   => '${Elatin6::not_word}',
                '[:^xdigit:]' => '${Elatin6::not_xdigit}',
...
#
# Latin-6 hexadecimal escape sequence
#
sub hexchr {
    my($hexdigit) = @_;
...
#
# Latin-6 open character list for qr
#
sub charlist_qr {
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Elatin6::uc($char);
                        my $fc = Elatin6::fc($char);
                        if ($uc eq $fc) {
...
#
# Latin-6 open character list for not qr
#
sub charlist_not_qr {
...
#
# Latin-6 order to character (with parameter)
#
sub Elatin6::chr(;$) {
...
#
# Latin-6 order to character (without parameter)
#
sub Elatin6::chr_() {
...
#
# Latin-6 path globbing (with parameter)
#
sub Elatin6::glob($) {
...
#
# Latin-6 path globbing (without parameter)
#
sub Elatin6::glob_() {
...
#
# Latin-6 path globbing via File::DosGlob 1.10
#
...
#
# Latin-6 path globbing subroutine
#
sub _do_glob {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Elatin6::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Elatin6::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Elatin6::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Elatin6::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
#
sub Elatin6::POSTMATCH {
    return $';
}

#
# Latin-6 character to order (with parameter)
#
sub Latin6::ord(;$) {
...
#
# Latin-6 character to order (without parameter)
#
sub Latin6::ord_() {
...
#
# Latin-6 getc (with parameter, without parameter)
#
sub Latin6::getc(;*@) {

    my($package) = caller;
    my $fh = @_ ? qualify_to_ref(shift,$package) : \*STDIN;
    croak 'Too many arguments for Latin6::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Elatin6::dot_s} \z/oxms) {
...
#
# Latin-6 index by character
#
sub Latin6::index($$;$) {

    my $index;
    if (@_ == 3) {
        $index = Elatin6::index($_[0], $_[1], CORE::length(Latin6::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Elatin6::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Latin6::length(CORE::substr $_[0], 0, $index);
    }
}

#
# Latin-6 rindex by character
#
sub Latin6::rindex($$;$) {

    my $rindex;
    if (@_ == 3) {
        $rindex = Elatin6::rindex($_[0], $_[1], CORE::length(Latin6::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Elatin6::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Latin6::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
my $qq_substr  = qr{(?> Char::substr | Latin6::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
#
# escape Latin-6 token of script
#
sub Latin6::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Elatin6::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ (?>\s*) PREMATCH  \b | \$ (?>\s*) \{ (?>\s*) PREMATCH  (?>\s*) \} | \$ (?>\s*) \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin6::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Elatin6::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin6::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Elatin6::POSTMATCH()
    elsif (/\G (                 \$ (?>\s*) POSTMATCH \b | \$ (?>\s*) \{ (?>\s*) POSTMATCH (?>\s*) \} | \$ (?>\s*) \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin6::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Elatin6::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob (?>\s*) \) /oxgc) {
        return 'while ($_ = Elatin6::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob \b /oxgc) {
        return 'while ($_ = Elatin6::glob';
    }
...
# subroutines of package Elatin6
    elsif (/\G \b (CORE:: | ->(>?\s*) (?: atan2 | [a-z]{2,})) \b       /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Latin6::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Char::escape'; }
    elsif (/\G \b Latin6::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Latin6::escape'; }
    elsif (/\G \b bytes::substr \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin6::chop';       }
    elsif (/\G \b bytes::index \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::index';       }
    elsif (/\G \b Latin6::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Latin6::index';       }
    elsif (/\G \b index \b         (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin6::index';      }
    elsif (/\G \b bytes::rindex \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::rindex';      }
    elsif (/\G \b Latin6::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Latin6::rindex';      }
    elsif (/\G \b rindex \b        (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin6::rindex';     }
    elsif (/\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin6::lc';         }
    elsif (/\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin6::lcfirst';    }
    elsif (/\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin6::uc';         }
    elsif (/\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin6::ucfirst';    }
    elsif (/\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin6::fc';         }
    ...
    elsif (/\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin6::chr';               }
    elsif (/\G \b bytes::ord    (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin6::glob';              }
    elsif (/\G \b lc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin6::lc_';               }
    elsif (/\G \b lcfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin6::lcfirst_';          }
    elsif (/\G \b uc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin6::uc_';               }
    elsif (/\G \b ucfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin6::ucfirst_';          }
    elsif (/\G \b fc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin6::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin6::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin6::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Elatin6::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Elatin6::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq           (\#) [ ] (\#) /oxgc) { return 'Elatin6::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Elatin6::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Elatin6::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Elatin6::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Elatin6::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Elatin6::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q            (\#) [ ] (\#) /oxgc) { return 'Elatin6::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Elatin6::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Elatin6::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Elatin6::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Elatin6::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Elatin6::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                    ' [ ] '    /oxgc) { return 'Elatin6::split' . $e . qq     {' '};  }
        elsif (/\G                    " [ ] "    /oxgc) { return 'Elatin6::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Elatin6::PREMATCH()]}
            ...
            $e_string .= q{Elatin6::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Elatin6::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Elatin6::MATCH()};
            $slash = 'div';
        }
...
# subroutines of package Elatin6
        ...
        elsif ($string =~ /\G \b Latin6::eval       (?= (?>\s*) \{ )                    /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::eval \b                                        /oxgc) { $e_string .= 'eval Char::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b Latin6::eval \b                                        /oxgc) { $e_string .= 'eval Latin6::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                                     /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                              /oxgc) { $e_string .= 'Elatin6::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                                      /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::index \b                                       /oxgc) { $e_string .= 'Char::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b Latin6::index \b                                       /oxgc) { $e_string .= 'Latin6::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                             /oxgc) { $e_string .= 'Elatin6::index';      $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b Latin6::rindex \b                                      /oxgc) { $e_string .= 'Latin6::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                            /oxgc) { $e_string .= 'Elatin6::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin6::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin6::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin6::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin6::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin6::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin6::chr';           $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin6::glob';          $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                                      /oxgc) { $e_string .= 'Elatin6::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                                 /oxgc) { $e_string .= 'Elatin6::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                                      /oxgc) { $e_string .= 'Elatin6::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                                 /oxgc) { $e_string .= 'Elatin6::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                                      /oxgc) { $e_string .= 'Elatin6::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                                     /oxgc) { $e_string .= 'Elatin6::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                              /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                                     /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                                    /oxgc) { $e_string .= 'Elatin6::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Elatin6::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Elatin6::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq           (\#) [ ] (\#) /oxgc) { $e_string .= 'Elatin6::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { $e_string .= 'Elatin6::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { $e_string .= 'Elatin6::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { $e_string .= 'Elatin6::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { $e_string .= 'Elatin6::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { $e_string .= 'Elatin6::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q            (\#) [ ] (\#) /oxgc) { $e_string .= 'Elatin6::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { $e_string .= 'Elatin6::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { $e_string .= 'Elatin6::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { $e_string .= 'Elatin6::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { $e_string .= 'Elatin6::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { $e_string .= 'Elatin6::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                    ' [ ] '    /oxgc) { $e_string .= 'Elatin6::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                    " [ ] "    /oxgc) { $e_string .= 'Elatin6::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        ...
        return Elatin6::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Elatin6::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Elatin6::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Elatin6::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Elatin6::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Elatin6::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Elatin6::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Elatin6::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Elatin6::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Elatin6::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Elatin6::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Elatin6::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Elatin6::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Elatin6::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Elatin6::uc($char[$i]) ne Elatin6::fc($char[$i]))) {
            if (CORE::length(Elatin6::fc($char[$i])) == 1) {
                $char[$i] = '['   . Elatin6::uc($char[$i])       . Elatin6::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Elatin6::uc($char[$i]) . '|' . Elatin6::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin6::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ (?>\s*) 0 (?>\s*) \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Elatin6::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin6::ignorecase(Elatin6::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin6::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Elatin6::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin6::ignorecase(Elatin6::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin6::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Elatin6::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin6::ignorecase(Elatin6::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin6::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Latin6::re_t=%s; while($Latin6::re_t =~ %s){%s local $^W=0; local $Latin6::re_r=%s; %s$Latin6::re_t="$`$Latin6::re_r$'"; pos($Latin6::re_t)=length "$`$Latin6::re_r"; } return $Latin6::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Latin6::re_r=CORE::eval $Latin6::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Latin6::re_r=%s; %s"%s$Latin6::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Latin6::re_n=0; while(%s =~ %s){%s local $^W=0; local $Latin6::re_r=%s; %s%s="$`$Latin6::re_r$'"; pos(%s)=length "$`$Latin6::re_r"; $Latin6::re_n++} return %s$Latin6::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Latin6::re_r=%s; %s%s="%s$Latin6::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Latin6::re_r=%s; %s%s="%s$Latin6::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Latin6::re_r=CORE::eval $Latin6::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Elatin6::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Elatin6::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  # "no Elatin6;" not supported

=head1 ABSTRACT

This module has run-time routines for use Latin6 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Latin6 software and not
...
This Elatin6 module first appeared in ActivePerl Build 522 Built under
...
=item Split string
  ...
  @split = Elatin6::split(/pattern/,$string,$limit);
  @split = Elatin6::split(/pattern/,$string);
  @split = Elatin6::split(/pattern/);
  @split = Elatin6::split('',$string,$limit);
  @split = Elatin6::split('',$string);
  @split = Elatin6::split('');
  @split = Elatin6::split();
  @split = Elatin6::split;
  ...
  at all, Elatin6::split returns the original string as a single substring, If it
  ...
  @chars  = Elatin6::split(//,  $word);
  @fields = Elatin6::split(/:/, $line);
  @words  = Elatin6::split(" ", $paragraph);
  @lines  = Elatin6::split(/^/, $buffer);
  ...
  print join(":" => Elatin6::split(/ */, "hi there"));
  ...
  Elatin6::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Elatin6::split(/:/, $_, 3);
  ...
  splits on whitespace just as Elatin6::split with no arguments does. Thus,
  Elatin6::split(" ") can be used to emulate awk's default behavior. In contrast,
  Elatin6::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Elatin6::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Elatin6::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Elatin6::split()) {
          $count{$word}++;
      }
  }

  The inverse of Elatin6::split is join, except that join can only join with the
...
=item Transliteration
  ...
  $tr = Elatin6::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Elatin6::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  This subroutine scans a Latin-6 string character by character and replaces all
  occurrences of the characters found in $searchlist with the corresponding character
  in $replacementlist. It returns the number of characters replaced or deleted.
  If no Latin-6 string is specified via =~ operator, the $_ variable is translated.
  $modifier are:
  ...
  print Elatin6::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item Chop string

  $chop = Elatin6::chop(@list);
  $chop = Elatin6::chop();
  $chop = Elatin6::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Elatin6::chop subroutine is used primary to remove the newline
  ...
  since Elatin6::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Elatin6::chop a literal, only a variable. If you Elatin6::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Elatin6::chop(@lines);

  You can Elatin6::chop anything that is an lvalue, including an assignment:

  Elatin6::chop($cwd = `pwd`);
  Elatin6::chop($answer = <STDIN>);

  This is different from:

  $answer = Elatin6::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Elatin6::chop returns the character
  ...
  In the most general case, Elatin6::chop can be expressed using substr:

  $last_code = Elatin6::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Elatin6::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Elatin6::chop;
...
=item Index string
  ...
  $byte_pos = Elatin6::index($string,$substr,$byte_offset);
  $byte_pos = Elatin6::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Elatin6::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Elatin6::rindex($string,$substr,$byte_offset);
  $byte_pos = Elatin6::rindex($string,$substr);

  This subroutine works just like Elatin6::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Elatin6::index).
  ...
  while (($byte_pos = Latin6::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  $lc = Elatin6::lc($string);
  $lc = Elatin6::lc_;

  This subroutine returns a lowercased version of Latin-6 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Elatin6::fc subroutine for case-insensitive comparisons via Latin6
  software.

=item Lower case first character of string

  $lcfirst = Elatin6::lcfirst($string);
  $lcfirst = Elatin6::lcfirst_;

  This subroutine returns a version of Latin-6 $string with the first character
  lowercased (or $_, if $string is omitted). This is the internal subroutine
  implementing the \l escape in double-quoted strings.

=item Upper case string

  $uc = Elatin6::uc($string);
  $uc = Elatin6::uc_;

  This subroutine returns an uppercased version of Latin-6 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Elatin6::ucfirst instead.
...
=item Upper case first character of string
  ...
  $ucfirst = Elatin6::ucfirst($string);
  $ucfirst = Elatin6::ucfirst_;
  ...
  $titlecase = Elatin6::ucfirst(substr($word,0,1)) . Elatin6::lc(substr($word,1));
  ...
  $do_not_use = Elatin6::ucfirst(Elatin6::lc($word));
...
=item Fold case string
  ...
  $fc = Elatin6::fc($string);
  $fc = Elatin6::fc_;

  New to Latin6 software, this subroutine returns the full Unicode-like casefold of
  Latin-6 $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Elatin6::fc($a) eq Elatin6::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Latin6 software has always used casefolding semantics for
...
=item Make ignore case string
  ...
  @ignorecase = Elatin6::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item Make capture number

  $capturenumber = Elatin6::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item Make character

  $chr = Elatin6::chr($code);
  $chr = Elatin6::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Elatin6::chr(65) is "A" in either
  ASCII or Latin-6, not Unicode. For the reverse of Elatin6::chr, use Latin6::ord.

=item Filename expansion (globbing)

  @glob = Elatin6::glob($string);
  @glob = Elatin6::glob_;
  ...
  The Elatin6::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Elatin6::glob('"*e f*"');
  @spacies = Elatin6::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Elatin6::glob("'*${var}e f*'");
  @spacies = Elatin6::glob(qq("*${var}e f*"));
