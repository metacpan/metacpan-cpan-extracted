package Microsoft::AdCenter::V7::CampaignManagementService::Test::AccountMigrationStatusesInfo;
...
use Microsoft::AdCenter::V7::CampaignManagementService::AccountMigrationStatusesInfo;

sub test_can_create_account_migration_statuses_info_and_set_all_fields : Test(3) {
    my $account_migration_statuses_info = Microsoft::AdCenter::V7::CampaignManagementService::AccountMigrationStatusesInfo->new
