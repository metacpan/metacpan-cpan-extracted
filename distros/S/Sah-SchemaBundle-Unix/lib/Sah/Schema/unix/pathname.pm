...
This document describes version 0.022 of Sah::Schema::unix::pathname (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.

=head1 SAH SCHEMA DEFINITION

 ["pathname::unix", {}]

Base schema: L<pathname::unix|Sah::Schema::pathname::unix>
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("unix::pathname*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("unix::pathname", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("unix::pathname", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("unix::pathname*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"unix::pathname*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('unix::pathname*', name=>'UnixPathname')
     );
 }

 use My::Types qw(UnixPathname);
 UnixPathname->assert_valid($data);
