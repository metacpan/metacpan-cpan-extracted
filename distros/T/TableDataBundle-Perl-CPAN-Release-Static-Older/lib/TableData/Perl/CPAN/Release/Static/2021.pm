...
around new => sub {
    ...
    unless (-f $filename) {
        ...
        $filename = File::ShareDir::dist_file('TableDataBundle-Perl-CPAN-Release-Static-Older', '2021.csv');
    }
...
our %STATS = ("num_rows",10422,"num_columns",9); # STATS
...
This document describes version 20220218.2 of TableDataRole::Perl::CPAN::Release::Static::2021 (from Perl distribution TableDataBundle-Perl-CPAN-Release-Static-Older), released on 2022-02-18.
