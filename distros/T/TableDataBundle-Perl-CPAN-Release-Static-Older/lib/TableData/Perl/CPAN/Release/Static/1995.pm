package ## no critic: Modules::RequireFilenameMatchesPackage
    # hide from PAUSE
    TableDataRole::Perl::CPAN::Release::Static::1995;
...
around new => sub {
    ...
    unless (-f $filename) {
        ...
        $filename = File::ShareDir::dist_file('TableDataBundle-Perl-CPAN-Release-Static-Older', '1995.csv');
    }
    $orig->(@_, filename=>$filename);
};

package TableData::Perl::CPAN::Release::Static::1995;
...
with 'TableDataRole::Perl::CPAN::Release::Static::1995';

our %STATS = ("num_rows",164,"num_columns",9); # STATS
...
TableDataRole::Perl::CPAN::Release::Static::1995 - CPAN releases for the year 1995

=head1 VERSION

This document describes version 20210927.1 of TableDataRole::Perl::CPAN::Release::Static::1995 (from Perl distribution TableDataBundle-Perl-CPAN-Release-Static-Older), released on 2021-10-05.

=head1 SYNOPSIS

To use from Perl code:

 use TableData::Perl::CPAN::Release::Static::1995;

 my $td = TableData::Perl::CPAN::Release::Static::1995->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Perl::CPAN::Release::Static::1995 --page

 # Get number of rows
 % tabledata --action count_rows Perl::CPAN::Release::Static::1995
