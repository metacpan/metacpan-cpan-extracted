package Games::Lacuna::Client::Buildings::PoliticsTraining;
{
  $Games::Lacuna::Client::Buildings::PoliticsTraining::VERSION = '0.003';
}
use 5.0080000;
use strict;
use warnings;
...
Games::Lacuna::Client::Buildings::PoliticsTraining - The Politics Training Facility building
