package Google::Ads::AdWords::v201609::ProductBiddingCategoryData;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201609::ConstantData);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'dimensionValue' => 'Google::Ads::AdWords::v201609::ProductBiddingCategory',
        'parentDimensionValue' => 'Google::Ads::AdWords::v201609::ProductBiddingCategory',
        'country' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'status' => 'Google::Ads::AdWords::v201609::ShoppingBiddingDimensionStatus',
        'displayValue' => 'Google::Ads::AdWords::v201609::String_StringMapEntry',
    },
    {
...
ProductBiddingCategoryData from the namespace https://adwords.google.com/api/adwords/cm/v201609.
