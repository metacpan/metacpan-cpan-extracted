...
__END__
=== begin_interval_reference a book that has only one chapter - Jude 4
--- input chomp
Jude 4
--- state chomp
VERSE
...
=== begin_interval_reference LCLCV - Ge 1-Ex 2:5
--- input chomp
Ge 1-Ex 2:5
--- expect chomp 
Ex 2:5
=== begin_interval_reference LCLC - Ge 1-Ex 2
--- input chomp
Ge 1-Ex 2
--- expect chomp
Ex 2
=== begin_interval_reference LC - Ge 1
---
--- input chomp
Ge 1
--- expect chomp

=== begin_interval_reference LCVCV - Ge 1:1-2:5
--- input chomp
Ge 1:1-2:5
--- expect chomp
Ge 2:5
=== begin_interval_reference LCCV - Ge 1-2:5
--- input chomp
Ge 1-2:5
--- expect chomp 
Ge 2:5
=== begin_interval_reference LCC - Ge 1-2
--- input chomp
Ge 1-2
--- expect chomp
Ge 2
...
=== begin_interval_reference with canonical name LCLCV - Genèse 1-Ex 2:5
--- input chomp
Genèse 1-Exode 2:5
--- expect chomp 
Exode 2:5
=== begin_interval_reference with canonical name LCLC - Genèse 1-Ex 2
--- input chomp
Genèse 1-Exode 1
--- expect chomp
Exode 1
=== begin_interval_reference with canonical name LC - Genèse 1
--- input chomp
Genèse 1
--- expect chomp

=== begin_interval_reference with canonical name LCVCV - Genèse 1:1-2:5
--- input chomp
Genèse 1:1-2:5
--- expect chomp
Genèse 2:5
=== begin_interval_reference with canonical name LCCV - Genèse 1-2:5
--- input chomp
Genèse 1-2:5
--- expect chomp 
Genèse 2:5
=== begin_interval_reference with canonical name LCC - Genèse 1-2
--- input chomp
Genèse 1-2
--- expect chomp
Genèse 2
...
=== begin_interval_reference CVCV - 1:1-2:5
--- input chomp
1:1-2:5
--- state chomp
CHAPTER
--- expect chomp
2:5
=== begin_interval_reference CCV - 1-2:5
--- input chomp
1-2:5
--- state chomp
CHAPTER
--- expect chomp
2:5
=== begin_interval_reference CC - 1-2
--- input chomp
1-2
--- state chomp
CHAPTER
...
=== begin_interval_reference VV - 1-2
--- input chomp
1-2
--- state chomp
VERSE
