...
This document describes version 0.001 of Sah::Schema::chrome::profile_name (from Perl distribution Sah-Schemas-Chrome), released on 2020-04-19.
...
Using with L<Data::Sah>:
 ...
 my $vdr = gen_validator("chrome::profile_name*");
