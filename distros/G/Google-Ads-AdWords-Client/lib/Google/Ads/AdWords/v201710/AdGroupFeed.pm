package Google::Ads::AdWords::v201710::AdGroupFeed;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'matchingFunction' => 'Google::Ads::AdWords::v201710::Function',
        'placeholderTypes' => 'SOAP::WSDL::XSD::Typelib::Builtin::int',
        'status' => 'Google::Ads::AdWords::v201710::AdGroupFeed::Status',
...
Google::Ads::AdWords::v201710::AdGroupFeed

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupFeed from the namespace https://adwords.google.com/api/adwords/cm/v201710.
