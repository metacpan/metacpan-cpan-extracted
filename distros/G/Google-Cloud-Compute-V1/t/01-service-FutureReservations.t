...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::FutureReservation Google::Cloud::Compute::V1::Compute::FutureReservationsAggregatedListResponse Google::Cloud::Compute::V1::Compute::FutureReservationsListResponse Google::Cloud::Compute::V1::Compute::Operation )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::FutureReservationsClient->new( credentials => 'dummy' );
