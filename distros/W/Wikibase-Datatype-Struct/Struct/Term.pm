package Wikibase::Datatype::Struct::Term;
...
Wikibase::Datatype::Struct::Term - Wikibase term structure serialization.

=head1 SYNOPSIS

 use Wikibase::Datatype::Struct::Term qw(obj2struct struct2obj);
...
Convert L<Wikibase::Datatype::Term> instance to structure.
...
Returns L<Wikibase::Datatype::Term> instance.
...
=for comment filename=obj2struct_term.pl
...
=for comment filename=struct2obj_term.pl
