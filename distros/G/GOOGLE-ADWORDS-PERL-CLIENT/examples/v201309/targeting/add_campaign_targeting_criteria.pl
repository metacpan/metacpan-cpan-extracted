...
sub add_campaign_targeting_criteria {
  ...
  my $california = Google::Ads::AdWords::v201309::Location->new({
    id => 21137
  });
  push @criteria, $california;
  my $mexico = Google::Ads::AdWords::v201309::Location->new({
    id => 2484 # Mexico
  });
  ...
  my $english = Google::Ads::AdWords::v201309::Language->new({
    id => 1000
  });
  push @criteria, $english;
  my $spanish = Google::Ads::AdWords::v201309::Language->new({
    id => 1003
  });
  ...
  foreach my $criterion (@criteria) {
    my $operation =
        Google::Ads::AdWords::v201309::CampaignCriterionOperation->new({
          operator => "ADD",
          operand => Google::Ads::AdWords::v201309::CampaignCriterion->new({
