# AWS::ApiGateway::Authorizer generated from spec 1.11.0
...
package Cfn::Resource::Properties::AWS::ApiGateway::Authorizer {
  ...
  has ProviderARNs => (isa => 'Cfn::Value::Array|Cfn::Value::Function', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
