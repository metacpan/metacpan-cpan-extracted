...
1;
# ABSTRACT: List Pod::Weaver sections available on CPAN
...
App::lcpan::Cmd::weaver_sections - List Pod::Weaver sections available on CPAN

=head1 VERSION

This document describes version 0.031 of App::lcpan::Cmd::weaver_sections (from Perl distribution App-lcpan-CmdBundle-weaver), released on 2020-01-19.

=head1 DESCRIPTION

This module handles the L<lcpan> subcommand C<weaver-sections>.
...
List Pod::Weaver sections available on CPAN.
