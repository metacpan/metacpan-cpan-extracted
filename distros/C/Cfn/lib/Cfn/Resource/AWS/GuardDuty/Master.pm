# AWS::GuardDuty::Master generated from spec 34.0.0
...
Cfn::Resource::AWS::GuardDuty::Master - Cfn resource for AWS::GuardDuty::Master

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::GuardDuty::Master.
