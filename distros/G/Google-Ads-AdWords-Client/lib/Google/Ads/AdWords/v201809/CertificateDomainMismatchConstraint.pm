package Google::Ads::AdWords::v201809::CertificateDomainMismatchConstraint;
use strict;
use warnings;
...
Google::Ads::AdWords::v201809::CertificateDomainMismatchConstraint

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CertificateDomainMismatchConstraint from the namespace https://adwords.google.com/api/adwords/cm/v201809.
