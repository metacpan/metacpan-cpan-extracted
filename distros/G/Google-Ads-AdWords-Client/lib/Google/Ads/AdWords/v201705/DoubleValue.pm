package Google::Ads::AdWords::v201705::DoubleValue;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201705::NumberValue);
# Variety: sequence
...
DoubleValue from the namespace https://adwords.google.com/api/adwords/cm/v201705.
