...
END
            ...
            if ($list !~ /\A (?>\s*) \z/oxms) {
                ...
                for (@list) {
                    ...
                    $Egbk::function_ord     = $Egbk::function_ord;
                    $Egbk::function_ord_    = $Egbk::function_ord_;
                    $Egbk::function_reverse = $Egbk::function_reverse;
                    $Egbk::function_getc    = $Egbk::function_getc;
                }
            }
        }
    }
