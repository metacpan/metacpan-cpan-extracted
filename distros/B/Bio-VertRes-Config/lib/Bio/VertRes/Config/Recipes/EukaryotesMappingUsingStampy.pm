package Bio::VertRes::Config::Recipes::EukaryotesMappingUsingStampy;
...
Bio::VertRes::Config::Recipes::EukaryotesMappingUsingStampy - Standard snp calling pipeline for bacteria
...
Standard snp calling pipeline for eukaryotes.
   ...
   my $obj = Bio::VertRes::Config::Recipes::EukaryotesMappingUsingStampy->new( 
     database => 'abc', 
