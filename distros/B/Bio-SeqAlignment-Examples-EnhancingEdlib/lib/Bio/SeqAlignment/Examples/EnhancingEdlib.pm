...
$Bio::SeqAlignment::Examples::EnhancingEdlib::VERSION = '0.03';
1;
=head1 NAME
...
Homo_sapiens.GRCh38.cds.sample.strip.fasta : 1000 sequences
Homo_sapiens.GRCh38.sample.end.strip.fasta :  648 sequences
...
=head2 testMapMCE_openMP.pl

Perl script that illustrates the use of the Linear dataflow and the Generic  
Mapper dicussed in L<Bio::SeqAlignment::Components::SeqMapping|https://metacpan.org/pod/Bio::SeqAlignment::Components::SeqMapping> 
for the creation of an MCE and OpenMP enhanced version of Edlib. Running the 
script generates the results file timings_openMP.txt . Before running in your
...
Chunk_Size : MCE chunk size 

=head2 timings_openMP.txt
...
=head2 timings_chunk.png

Plot of the timings.txt file

=head2 timings_MCE_OMP.png
...
=head2 timings_MCE_with_OMP.png
...
=head2 spacetime_MCE_with_OMP.png
...
=head2 Worker_Thread_effects.png
...
timings_MCE_with_OMP.txt file and plotting the main effects of the number of
workers and threads.

=head2 Worker_Thread_interaction.png
...
timings_MCE_with_OMP.txt file and plotting the generalized interaction term 
...
=item * L<Bio::SeqAlignment::Components::SeqMapping|https://metacpan.org/pod/Bio::SeqAlignment::Components::SeqMapping>
...
=item * L<MCE|https://metacpan.org/pod/MCE>
...
=item * L<OpenMP|https://www.openmp.org/>
