...
package WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthStreamKeysGet;
BEGIN {
  $WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthStreamKeysGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('FmsLiveAuthStreamKeysGet');
...
WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthStreamKeysGet
...
FmsLiveAuthStreamKeysGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::MediaManager::Element::FmsLiveAuthStreamKeysGet->new($data);
