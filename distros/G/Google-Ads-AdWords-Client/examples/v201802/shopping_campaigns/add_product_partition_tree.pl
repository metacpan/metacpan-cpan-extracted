...
sub add_product_partition_tree {
  ...
  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201802::ProductBrand->new({value => "CoolBrand"}),
    900000);

  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201802::ProductBrand->new({value => "CheapBrand"}),
    10000);

  my $other_brand =
    create_subdivision($operations, $next_id--, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201802::ProductBrand->new());
  ...
  create_unit(
    ...
    $ad_group_id,
    $other_brand,
    Google::Ads::AdWords::v201802::ProductBiddingCategory->new({
...
sub create_subdivision {
  ...
  my $criterion = Google::Ads::AdWords::v201802::BiddableAdGroupCriterion->new({
