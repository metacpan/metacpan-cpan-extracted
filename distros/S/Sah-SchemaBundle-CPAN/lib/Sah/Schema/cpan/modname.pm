...
This document describes version 0.016 of Sah::Schema::cpan::modname (from Perl distribution Sah-SchemaBundle-CPAN), released on 2024-06-13.

=head1 SAH SCHEMA DEFINITION

 ["perl::modname", { "x.completion" => ["lcpan_modname"] }]

Base schema: L<perl::modname|Sah::Schema::perl::modname>

Used completion: L<lcpan_modname|Perinci::Sub::XCompletion::lcpan_modname>
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"cpan::modname*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('cpan::modname*', name=>'CpanModname')
     );
 }

 use My::Types qw(CpanModname);
 CpanModname->assert_valid($data);
