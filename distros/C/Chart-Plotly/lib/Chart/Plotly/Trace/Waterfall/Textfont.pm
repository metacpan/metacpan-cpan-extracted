package Chart::Plotly::Trace::Waterfall::Textfont;
use Moose;
...
has description => ( is      => "ro",
                     default => "Sets the font used for `text`.", );
...
Chart::Plotly::Trace::Waterfall::Textfont - This attribute is one of the possible options for the trace waterfall.
