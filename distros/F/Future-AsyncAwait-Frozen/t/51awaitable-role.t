...
use Future::AsyncAwait::Frozen::Awaitable;
...
package Test::NotAwaitable {
   ...
   Test::More::ok( !eval {
      with( "Future::AsyncAwait::Frozen::Awaitable" );
   }, 'Test package is not Future::AsyncAwait::Frozen::Awaitable' );
   # Possibly a fragile test, in case of changes of error message text
   Test::More::like( $@, qr/^Can't apply Future::AsyncAwait::Frozen::Awaitable to Test::NotAwaitable /,
