# This Makefile is for the Mobile::Executive extension to perl.
#
...
#	NAME => q[Mobile::Executive]
#	PREREQ_PM => { File::Spec=>q[0], constant=>q[0], Crypt::RSA=>q[1.5], Devel::Scooby=>q[4.07], Mobile::Location=>q[4.01] }
#	VERSION_FROM => q[Executive.pm]
...
DISTNAME = Mobile-Executive
NAME_SYM = Mobile_Executive
VERSION = 2.03
VERSION_SYM = 2_03
XS_VERSION = 2.03
INST_BIN = blib/bin
...
FULLEXT = Mobile/Executive
BASEEXT = Executive
PARENT_NAME = Mobile
DLBASE = $(BASEEXT)
VERSION_FROM = Executive.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Mobile
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Mobile
...
TO_INST_PM = Executive.pm

PM_TO_BLIB = Executive.pm \
	$(INST_LIBDIR)/Executive.pm
...
manifypods : pure_all Executive.pm
	@$(POD2MAN) \
	Executive.pm \
	$(INST_MAN3DIR)/Mobile::Executive.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Mobile-Executive\" VERSION=\"2,03,0,0\">\n}. qq{\t<TITLE>Mobile-Executive</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"Crypt-RSA\" VERSION=\"1,5,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Devel-Scooby\" VERSION=\"4,07,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"File-Spec\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Mobile-Location\" VERSION=\"4,01,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"constant\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Mobile-Executive.ppd
