package Chart::Plotly::Trace::Scatter::Selected;
use Moose;
...
has marker => ( is  => "rw",
                isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatter::Selected::Marker", );

has textfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scatter::Selected::Textfont", );
...
Chart::Plotly::Trace::Scatter::Selected - This attribute is one of the possible options for the trace scatter.
