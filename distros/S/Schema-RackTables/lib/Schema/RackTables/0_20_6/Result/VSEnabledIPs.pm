use utf8;
package Schema::RackTables::0_20_6::Result::VSEnabledIPs;
...
Related object: L<Schema::RackTables::0_20_6::Result::IPv4RSPool>

=cut

__PACKAGE__->belongs_to(
  "rspool",
  "Schema::RackTables::0_20_6::Result::IPv4RSPool",
  { id => "rspool_id" },
  { is_deferrable => 1, on_delete => "CASCADE", on_update => "RESTRICT" },
);
...
Related object: L<Schema::RackTables::0_20_6::Result::VSIPs>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xpmQ8R/jV2c2h5fxZfm34A
