...
The URL for the Twitter API. This defaults to "http://api.twitter.com/1.1".
This option is available when the C<API::RESTv1_1> trait is included.
...
=item Parameters: media, media_data, additional_owners

=item Required: media or media_data
...
Or, pass base64-encoded data with the C<media_data> parameter.
