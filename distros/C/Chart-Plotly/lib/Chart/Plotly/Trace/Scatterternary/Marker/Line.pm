package Chart::Plotly::Trace::Scatterternary::Marker::Line;
use Moose;
...
Chart::Plotly::Trace::Scatterternary::Marker::Line - This attribute is one of the possible options for the trace scatterternary.
