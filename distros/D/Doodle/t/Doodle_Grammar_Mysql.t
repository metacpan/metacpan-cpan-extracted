...
$subtests->example(-1, 'create_column', 'method', fun($tryable) {
  ...
  my $sql = q{alter table `users` add column `id` int auto_increment primary key};
...
$subtests->example(-1, 'create_table', 'method', fun($tryable) {
  ...
  my $sql = q{create table `users` (`data` varchar(255))};
  is $result, $sql, 'sql ok';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_decimal.t', fun() {
  use Doodle;

  use_ok 'Doodle::Grammar::Mysql', 'type_decimal';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_integer_medium.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_create_schema.t', fun() {
  use Doodle;
  use Doodle::Grammar::Mysql;

  use_ok 'Doodle::Grammar::Mysql', 'create_schema';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_string.t', fun() {
  use Doodle;

  use_ok 'Doodle::Grammar::Mysql', 'type_string';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_binary.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_time.t', fun() {
  use Doodle;

  use_ok 'Doodle::Grammar::Mysql', 'type_time';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_create_relation.t', fun() {
  use Doodle;
  use Doodle::Grammar::Mysql;

  use_ok 'Doodle::Grammar::Mysql', 'create_relation';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_integer.t', fun() {
  use Doodle;

  use_ok 'Doodle::Grammar::Mysql', 'type_integer';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_update_column.t', fun() {
  use Doodle;
  use Doodle::Grammar::Mysql;

  use_ok 'Doodle::Grammar::Mysql', 'update_column';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_rename_table.t', fun() {
  use Doodle;
  use Doodle::Grammar::Mysql;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_enum.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_text.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_integer_tiny_unsigned.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_create_column.t', fun() {
  use Doodle;
  use Doodle::Grammar::Mysql;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_integer_big_unsigned.t', fun() {
  use Doodle;

  use_ok 'Doodle::Grammar::Mysql', 'type_integer_big_unsigned';
  ...
  is $s, 'bigint unsigned';

  ok 1 and done_testing;
};

subtest 't/0.05/can/Doodle_Grammar_Mysql_type_integer_small.t', fun() {
  use Doodle;

  use_ok 'Doodle::Grammar::Mysql', 'type_integer_small';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_text_medium.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_uuid.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_integer_big.t', fun() {
  use Doodle;

  use_ok 'Doodle::Grammar::Mysql', 'type_integer_big';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_char.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_delete_relation.t', fun() {
  use Doodle;
  use Doodle::Grammar::Mysql;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_delete_index.t', fun() {
  use Doodle;
  use Doodle::Grammar::Mysql;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_boolean.t', fun() {
  use Doodle;

  use_ok 'Doodle::Grammar::Mysql', 'type_boolean';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_integer_medium_unsigned.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_wrap.t', fun() {
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_create_table.t', fun() {
  use Doodle;
  use Doodle::Grammar::Mysql;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_datetime.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_datetime_tz.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_json.t', fun() {
  use Doodle;

  use_ok 'Doodle::Grammar::Mysql', 'type_json';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_rename_column.t', fun() {
  use Doodle;
  use Doodle::Grammar::Mysql;

  use_ok 'Doodle::Grammar::Mysql', 'rename_column';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_delete_column.t', fun() {
  use Doodle;
  use Doodle::Grammar::Mysql;

  use_ok 'Doodle::Grammar::Mysql', 'delete_column';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_timestamp.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_date.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_time_tz.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_text_long.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_delete_schema.t', fun() {
  use Doodle;
  use Doodle::Grammar::Mysql;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_integer_small_unsigned.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_integer_tiny.t', fun() {
  use Doodle;

  use_ok 'Doodle::Grammar::Mysql', 'type_integer_tiny';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_integer_unsigned.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_delete_table.t', fun() {
  use Doodle;
  use Doodle::Grammar::Mysql;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_create_index.t', fun() {
  use Doodle;
  use Doodle::Grammar::Mysql;

  use_ok 'Doodle::Grammar::Mysql', 'create_index';
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_float.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_timestamp_tz.t', fun() {
  use Doodle;
...
subtest 't/0.05/can/Doodle_Grammar_Mysql_type_double.t', fun() {
  use Doodle;
