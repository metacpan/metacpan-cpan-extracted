package Google::Ads::AdWords::v201806::CustomerNegativeCriterion;
use strict;
use warnings;
...
Google::Ads::AdWords::v201806::CustomerNegativeCriterion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CustomerNegativeCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201806.
