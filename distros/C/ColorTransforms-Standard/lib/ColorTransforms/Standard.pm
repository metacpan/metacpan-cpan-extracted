package ColorTransforms::Standard;
...
1;
# ABSTRACT: Standard collection of color transforms
...
ColorTransforms::Standard - Standard collection of color transforms

=head1 VERSION

This document describes version 0.002 of ColorTransforms::Standard (from Perl distribution ColorTransforms-Standard), released on 2020-06-13.
