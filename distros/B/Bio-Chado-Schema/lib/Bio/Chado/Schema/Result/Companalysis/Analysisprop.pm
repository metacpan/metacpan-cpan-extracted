package Bio::Chado::Schema::Result::Companalysis::Analysisprop;
BEGIN {
  $Bio::Chado::Schema::Result::Companalysis::Analysisprop::AUTHORITY = 'cpan:RBUELS';
}
{
  $Bio::Chado::Schema::Result::Companalysis::Analysisprop::VERSION = '0.20000';
}
