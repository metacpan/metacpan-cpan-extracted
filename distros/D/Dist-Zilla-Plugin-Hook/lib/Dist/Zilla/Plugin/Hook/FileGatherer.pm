...
#pod
#pod This is C<Hook::FileGatherer> plugin implementation. Nothing interesting, just using few roles.
#pod
...
package Dist::Zilla::Plugin::Hook::FileGatherer;
...
Dist::Zilla::Plugin::Hook::FileGatherer - C<Hook::FileGatherer> plugin implementation
...
This is C<Hook::FileGatherer> plugin implementation. Nothing interesting, just using few roles.
