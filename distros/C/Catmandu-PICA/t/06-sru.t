...
note "Catmandu::Importer::SRU::Parser::ppxml";
{
    ...
    isa_ok($importer, 'Catmandu::Importer::SRU');
    can_ok($importer, 'each');
    is($importer->url, 'http://www.unicat.be/sru?version=1.1&operation=searchRetrieve&query=sru_ppxml.xml&recordSchema=PicaPlus-xml&startRecord=1&maximumRecords=10');
