package OWL::DirectSemantics::Element::Class;
...
OWL::DirectSemantics::Element::Class - represents an OWL Class

=head1 DESCRIPTION

This class represents the Class element in OWL Direct Semantics.
