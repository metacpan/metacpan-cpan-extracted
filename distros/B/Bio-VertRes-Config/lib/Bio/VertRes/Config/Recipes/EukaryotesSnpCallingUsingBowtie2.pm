package Bio::VertRes::Config::Recipes::EukaryotesSnpCallingUsingBowtie2;
...
Bio::VertRes::Config::Recipes::EukaryotesSnpCallingUsingBowtie2 - Standard snp calling pipeline for bacteria
...
Standard snp calling pipeline for eukaryotes.
   ...
   my $obj = Bio::VertRes::Config::Recipes::EukaryotesSnpCallingUsingBowtie2->new( 
     database => 'abc', 
