...
*gsl_integration_romberg_alloc = *Math::GSL::Integrationc::gsl_integration_romberg_alloc;
*gsl_integration_romberg_free = *Math::GSL::Integrationc::gsl_integration_romberg_free;
*gsl_integration_romberg = *Math::GSL::Integrationc::gsl_integration_romberg;
*gsl_integration_fixed_alloc = *Math::GSL::Integrationc::gsl_integration_fixed_alloc;
*gsl_integration_fixed_free = *Math::GSL::Integrationc::gsl_integration_fixed_free;
*gsl_integration_fixed_n = *Math::GSL::Integrationc::gsl_integration_fixed_n;
*gsl_integration_fixed_nodes = *Math::GSL::Integrationc::gsl_integration_fixed_nodes;
*gsl_integration_fixed_weights = *Math::GSL::Integrationc::gsl_integration_fixed_weights;
*gsl_integration_fixed = *Math::GSL::Integrationc::gsl_integration_fixed;
...
############# Class : Math::GSL::Integration::gsl_integration_romberg_workspace ##############

package Math::GSL::Integration::gsl_integration_romberg_workspace;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( Math::GSL::Integration );
%OWNER = ();
%ITERATORS = ();
*swig_n_get = *Math::GSL::Integrationc::gsl_integration_romberg_workspace_n_get;
*swig_n_set = *Math::GSL::Integrationc::gsl_integration_romberg_workspace_n_set;
*swig_work1_get = *Math::GSL::Integrationc::gsl_integration_romberg_workspace_work1_get;
*swig_work1_set = *Math::GSL::Integrationc::gsl_integration_romberg_workspace_work1_set;
*swig_work2_get = *Math::GSL::Integrationc::gsl_integration_romberg_workspace_work2_get;
*swig_work2_set = *Math::GSL::Integrationc::gsl_integration_romberg_workspace_work2_set;
sub new {
    my $pkg = shift;
    my $self = Math::GSL::Integrationc::new_gsl_integration_romberg_workspace(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        Math::GSL::Integrationc::delete_gsl_integration_romberg_workspace($self);
        delete $OWNER{$self};
    }
}
...
############# Class : Math::GSL::Integration::gsl_integration_fixed_params ##############

package Math::GSL::Integration::gsl_integration_fixed_params;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( Math::GSL::Integration );
%OWNER = ();
%ITERATORS = ();
*swig_alpha_get = *Math::GSL::Integrationc::gsl_integration_fixed_params_alpha_get;
*swig_alpha_set = *Math::GSL::Integrationc::gsl_integration_fixed_params_alpha_set;
*swig_beta_get = *Math::GSL::Integrationc::gsl_integration_fixed_params_beta_get;
*swig_beta_set = *Math::GSL::Integrationc::gsl_integration_fixed_params_beta_set;
*swig_a_get = *Math::GSL::Integrationc::gsl_integration_fixed_params_a_get;
*swig_a_set = *Math::GSL::Integrationc::gsl_integration_fixed_params_a_set;
*swig_b_get = *Math::GSL::Integrationc::gsl_integration_fixed_params_b_get;
*swig_b_set = *Math::GSL::Integrationc::gsl_integration_fixed_params_b_set;
*swig_zemu_get = *Math::GSL::Integrationc::gsl_integration_fixed_params_zemu_get;
*swig_zemu_set = *Math::GSL::Integrationc::gsl_integration_fixed_params_zemu_set;
*swig_shft_get = *Math::GSL::Integrationc::gsl_integration_fixed_params_shft_get;
*swig_shft_set = *Math::GSL::Integrationc::gsl_integration_fixed_params_shft_set;
*swig_slp_get = *Math::GSL::Integrationc::gsl_integration_fixed_params_slp_get;
*swig_slp_set = *Math::GSL::Integrationc::gsl_integration_fixed_params_slp_set;
*swig_al_get = *Math::GSL::Integrationc::gsl_integration_fixed_params_al_get;
*swig_al_set = *Math::GSL::Integrationc::gsl_integration_fixed_params_al_set;
*swig_be_get = *Math::GSL::Integrationc::gsl_integration_fixed_params_be_get;
*swig_be_set = *Math::GSL::Integrationc::gsl_integration_fixed_params_be_set;
sub new {
    my $pkg = shift;
    my $self = Math::GSL::Integrationc::new_gsl_integration_fixed_params(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        Math::GSL::Integrationc::delete_gsl_integration_fixed_params($self);
        delete $OWNER{$self};
    }
}
...
############# Class : Math::GSL::Integration::gsl_integration_fixed_type ##############

package Math::GSL::Integration::gsl_integration_fixed_type;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( Math::GSL::Integration );
%OWNER = ();
%ITERATORS = ();
*swig_check_get = *Math::GSL::Integrationc::gsl_integration_fixed_type_check_get;
*swig_check_set = *Math::GSL::Integrationc::gsl_integration_fixed_type_check_set;
*swig_init_get = *Math::GSL::Integrationc::gsl_integration_fixed_type_init_get;
*swig_init_set = *Math::GSL::Integrationc::gsl_integration_fixed_type_init_set;
sub new {
    my $pkg = shift;
    my $self = Math::GSL::Integrationc::new_gsl_integration_fixed_type(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        Math::GSL::Integrationc::delete_gsl_integration_fixed_type($self);
        delete $OWNER{$self};
    }
}
...
############# Class : Math::GSL::Integration::gsl_integration_fixed_workspace ##############

package Math::GSL::Integration::gsl_integration_fixed_workspace;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( Math::GSL::Integration );
%OWNER = ();
%ITERATORS = ();
*swig_n_get = *Math::GSL::Integrationc::gsl_integration_fixed_workspace_n_get;
*swig_n_set = *Math::GSL::Integrationc::gsl_integration_fixed_workspace_n_set;
*swig_weights_get = *Math::GSL::Integrationc::gsl_integration_fixed_workspace_weights_get;
*swig_weights_set = *Math::GSL::Integrationc::gsl_integration_fixed_workspace_weights_set;
*swig_x_get = *Math::GSL::Integrationc::gsl_integration_fixed_workspace_x_get;
*swig_x_set = *Math::GSL::Integrationc::gsl_integration_fixed_workspace_x_set;
*swig_diag_get = *Math::GSL::Integrationc::gsl_integration_fixed_workspace_diag_get;
*swig_diag_set = *Math::GSL::Integrationc::gsl_integration_fixed_workspace_diag_set;
*swig_subdiag_get = *Math::GSL::Integrationc::gsl_integration_fixed_workspace_subdiag_get;
*swig_subdiag_set = *Math::GSL::Integrationc::gsl_integration_fixed_workspace_subdiag_set;
*swig_type_get = *Math::GSL::Integrationc::gsl_integration_fixed_workspace_type_get;
*swig_type_set = *Math::GSL::Integrationc::gsl_integration_fixed_workspace_type_set;
sub new {
    my $pkg = shift;
    my $self = Math::GSL::Integrationc::new_gsl_integration_fixed_workspace(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        Math::GSL::Integrationc::delete_gsl_integration_fixed_workspace($self);
        delete $OWNER{$self};
    }
}
...
my %__gsl_integration_fixed_legendre_hash;
tie %__gsl_integration_fixed_legendre_hash,"Math::GSL::Integration::gsl_integration_fixed_type", $Math::GSL::Integrationc::gsl_integration_fixed_legendre;
$gsl_integration_fixed_legendre= \%__gsl_integration_fixed_legendre_hash;
bless $gsl_integration_fixed_legendre, Math::GSL::Integration::gsl_integration_fixed_type;

my %__gsl_integration_fixed_chebyshev_hash;
tie %__gsl_integration_fixed_chebyshev_hash,"Math::GSL::Integration::gsl_integration_fixed_type", $Math::GSL::Integrationc::gsl_integration_fixed_chebyshev;
$gsl_integration_fixed_chebyshev= \%__gsl_integration_fixed_chebyshev_hash;
bless $gsl_integration_fixed_chebyshev, Math::GSL::Integration::gsl_integration_fixed_type;

my %__gsl_integration_fixed_gegenbauer_hash;
tie %__gsl_integration_fixed_gegenbauer_hash,"Math::GSL::Integration::gsl_integration_fixed_type", $Math::GSL::Integrationc::gsl_integration_fixed_gegenbauer;
$gsl_integration_fixed_gegenbauer= \%__gsl_integration_fixed_gegenbauer_hash;
bless $gsl_integration_fixed_gegenbauer, Math::GSL::Integration::gsl_integration_fixed_type;

my %__gsl_integration_fixed_jacobi_hash;
tie %__gsl_integration_fixed_jacobi_hash,"Math::GSL::Integration::gsl_integration_fixed_type", $Math::GSL::Integrationc::gsl_integration_fixed_jacobi;
$gsl_integration_fixed_jacobi= \%__gsl_integration_fixed_jacobi_hash;
bless $gsl_integration_fixed_jacobi, Math::GSL::Integration::gsl_integration_fixed_type;

my %__gsl_integration_fixed_laguerre_hash;
tie %__gsl_integration_fixed_laguerre_hash,"Math::GSL::Integration::gsl_integration_fixed_type", $Math::GSL::Integrationc::gsl_integration_fixed_laguerre;
$gsl_integration_fixed_laguerre= \%__gsl_integration_fixed_laguerre_hash;
bless $gsl_integration_fixed_laguerre, Math::GSL::Integration::gsl_integration_fixed_type;

my %__gsl_integration_fixed_hermite_hash;
tie %__gsl_integration_fixed_hermite_hash,"Math::GSL::Integration::gsl_integration_fixed_type", $Math::GSL::Integrationc::gsl_integration_fixed_hermite;
$gsl_integration_fixed_hermite= \%__gsl_integration_fixed_hermite_hash;
bless $gsl_integration_fixed_hermite, Math::GSL::Integration::gsl_integration_fixed_type;

my %__gsl_integration_fixed_exponential_hash;
tie %__gsl_integration_fixed_exponential_hash,"Math::GSL::Integration::gsl_integration_fixed_type", $Math::GSL::Integrationc::gsl_integration_fixed_exponential;
$gsl_integration_fixed_exponential= \%__gsl_integration_fixed_exponential_hash;
bless $gsl_integration_fixed_exponential, Math::GSL::Integration::gsl_integration_fixed_type;

my %__gsl_integration_fixed_rational_hash;
tie %__gsl_integration_fixed_rational_hash,"Math::GSL::Integration::gsl_integration_fixed_type", $Math::GSL::Integrationc::gsl_integration_fixed_rational;
$gsl_integration_fixed_rational= \%__gsl_integration_fixed_rational_hash;
bless $gsl_integration_fixed_rational, Math::GSL::Integration::gsl_integration_fixed_type;

my %__gsl_integration_fixed_chebyshev2_hash;
tie %__gsl_integration_fixed_chebyshev2_hash,"Math::GSL::Integration::gsl_integration_fixed_type", $Math::GSL::Integrationc::gsl_integration_fixed_chebyshev2;
$gsl_integration_fixed_chebyshev2= \%__gsl_integration_fixed_chebyshev2_hash;
bless $gsl_integration_fixed_chebyshev2, Math::GSL::Integration::gsl_integration_fixed_type;
