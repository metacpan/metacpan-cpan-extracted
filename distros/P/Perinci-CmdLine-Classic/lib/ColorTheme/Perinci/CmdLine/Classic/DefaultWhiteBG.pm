...
our %THEME = (
    v => 2,
    summary => 'Default color theme for Perinci::CmdLine::Classic (for terminals with white background)',
    items => {
    },
);
...
ColorTheme::Perinci::CmdLine::Classic::DefaultWhiteBG

=head1 VERSION

This document describes version 1.815 of ColorTheme::Perinci::CmdLine::Classic::DefaultWhiteBG (from Perl distribution Perinci-CmdLine-Classic), released on 2021-07-11.
