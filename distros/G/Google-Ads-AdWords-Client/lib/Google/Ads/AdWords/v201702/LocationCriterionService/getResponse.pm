...
package Google::Ads::AdWords::v201702::LocationCriterionService::getResponse;
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::LocationCriterionService::getResponse->new($data);
