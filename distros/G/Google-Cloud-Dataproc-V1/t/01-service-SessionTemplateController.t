...
BEGIN {
    for my $pkg (qw( Google::Cloud::Dataproc::V1::SessionTemplates::SessionTemplate )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Dataproc::V1::SessionTemplateControllerClient->new( credentials => 'dummy' );
