...
ok( defined $simd && $simd =~ /^(AVX2|SSE4\.2|scalar)$/,
    "simd reports the compiled flavor ($simd)" );
...
$meter->mark(123);
is( unpack( 'H*', $snapshot ), $before,
    'marking does not modify copy-on-write snapshots of the buffer' );
