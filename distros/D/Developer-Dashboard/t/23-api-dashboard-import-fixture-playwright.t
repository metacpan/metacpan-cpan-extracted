...
Test file in the Developer Dashboard codebase. This file runs the browser import-fixture regression for api-dashboard imports.
...
Run it directly with C<prove -lv t/23-api-dashboard-import-fixture-playwright.t> while iterating, then keep it green under C<prove -lr t> before release. Add or update assertions here before changing the implementation that it covers.
