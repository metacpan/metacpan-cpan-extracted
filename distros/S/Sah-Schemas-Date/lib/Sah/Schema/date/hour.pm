...
This document describes version 0.019 of Sah::Schema::date::hour (from Perl distribution Sah-Schemas-Date), released on 2023-12-09.
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"date::hour*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('date::hour*', name=>'DateHour')
     );
 }
