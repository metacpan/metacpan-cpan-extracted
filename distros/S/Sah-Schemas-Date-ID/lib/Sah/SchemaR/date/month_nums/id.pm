...
our $rschema = ["array",[{of=>["date::month_num::id",{},{}],summary=>"Array of month numbers","x.perl.coerce_rules"=>["str_comma_sep"]}],["array"]];
...
This document describes version 0.002 of Sah::SchemaR::date::month_nums::id (from Perl distribution Sah-Schemas-Date-ID), released on 2019-07-21.
