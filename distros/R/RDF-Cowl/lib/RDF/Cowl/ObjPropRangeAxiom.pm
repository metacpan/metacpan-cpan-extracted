...
$RDF::Cowl::ObjPropRangeAxiom::VERSION = '1.0.0';
...
RDF::Cowl::ObjPropRangeAxiom - Represents an ObjectPropertyRange axiom in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::ObjPropRangeAxiom>
