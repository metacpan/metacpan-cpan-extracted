...
use Contact::Model::GEN::author;

our $AUTHOR = 'Contact::Model::author';

our @EXPORT_OK = ( '$AUTHOR' );

1;

=head1 NAME

Contact::Model::author - model for author table (stub part)
...
=head1 METHODS (mixed in from Contact::Model::GEN::author)
