...
(This example is included as L<F<synopsis.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.14/examples/synopsis.pl> in the distribution.)  

=head1 VERSION

This documents HTML::Make version 0.14 corresponding to git
commit L<0ecc92d13c748282b0d59e8a927871aef36255f8|https://github.com/benkasminbullock/HTML-Make/commit/0ecc92d13c748282b0d59e8a927871aef36255f8>
released on Mon Jan 11 19:52:47 2021 +0900.
...
(This example is included as L<F<li-class-beano.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.14/examples/li-class-beano.pl> in the distribution.)  
...
(This example is included as L<F<p-double-class.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.14/examples/p-double-class.pl> in the distribution.)  
...
Returns an array reference, possibly empty, containing the child
...
(This example is included as L<F<multiply.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.14/examples/multiply.pl> in the distribution.)  
...
(This example is included as L<F<nocheck.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.14/examples/nocheck.pl> in the distribution.)  
...
(This example is included as L<F<table.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.14/examples/table.pl> in the distribution.)  
...
(This example is included as L<F<link-example.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.14/examples/link-example.pl> in the distribution.)  
...
(This example is included as L<F<push-new.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.14/examples/push-new.pl> in the distribution.)  
...
(This example is included as L<F<json-to-html.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.14/examples/json-to-html.pl> in the distribution.)  
...
(This example is included as L<F<push-li-to-tr.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.14/examples/push-li-to-tr.pl> in the distribution.)  
