package Chart::Plotly::Trace::Streamtube::Colorbar::Tickformatstop;
use Moose;
...
Chart::Plotly::Trace::Streamtube::Colorbar::Tickformatstop - This attribute is one of the possible options for the trace streamtube.
