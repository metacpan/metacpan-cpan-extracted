...
asn_dec_rval_t
SETNonce_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SETNonce_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
SETNonce_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SETNonce_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static asn_per_constraints_t asn_PER_type_SETNonce_constr_1 = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  128,  128 }	/* (SIZE(128..128)) */,
	0, 0	/* No PER value map */
};
static ber_tlv_tag_t asn_DEF_SETNonce_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_SETNonce = {
	...
	asn_DEF_SETNonce_tags_1,
	sizeof(asn_DEF_SETNonce_tags_1)
		/sizeof(asn_DEF_SETNonce_tags_1[0]), /* 1 */
	asn_DEF_SETNonce_tags_1,	/* Same as above */
	sizeof(asn_DEF_SETNonce_tags_1)
		/sizeof(asn_DEF_SETNonce_tags_1[0]), /* 1 */
	&asn_PER_type_SETNonce_constr_1,
	0, 0,	/* No members */
	0	/* No specifics */
};
