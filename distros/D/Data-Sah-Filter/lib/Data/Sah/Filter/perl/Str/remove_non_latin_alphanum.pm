...
1;
# ABSTRACT: Remove characters that are not [A-Za-z0-9]
...
Data::Sah::Filter::perl::Str::remove_non_latin_alphanum - Remove characters that are not [A-Za-z0-9]

=head1 VERSION

This document describes version 0.025 of Data::Sah::Filter::perl::Str::remove_non_latin_alphanum (from Perl distribution Data-Sah-Filter), released on 2024-07-17.

=head1 SYNOPSIS

=head2 Using in Sah schema's C<prefilters> (or C<postfilters>) clause

 ["str","prefilters",[["Str::remove_non_latin_alphanum"]]]

=head2 Using with L<Data::Sah>:

 use Data::Sah qw(gen_validator);
 
 my $schema = ["str","prefilters",[["Str::remove_non_latin_alphanum"]]];
