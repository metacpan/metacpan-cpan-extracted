package Chart::Plotly::Trace::Scattersmith::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Scattersmith::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattersmith::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Scattersmith::Hoverlabel - This attribute is one of the possible options for the trace scattersmith.
