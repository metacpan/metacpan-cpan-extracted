...
#
package PDLA::GIS::Proj;

@EXPORT_OK  = qw(   fwd_transform inv_transform get_proj_info  PDLA::PP _fwd_trans  fwd_trans_inplace PDLA::PP _fwd_trans_inplace PDLA::PP _inv_trans  inv_trans_inplace PDLA::PP _inv_trans_inplace   load_projection_descriptions    load_projection_information  );
...
=head2 1.32 (29 March 2006) Judd Taylor
    ...
    - Getting ready to merge this into the PDLA CVS. 
...
*_fwd_trans_inplace = \&PDLA::_fwd_trans_inplace;





*_inv_trans = \&PDLA::_inv_trans;
...
*_inv_trans_inplace = \&PDLA::_inv_trans_inplace;
...
{
    my $descriptions = PDLA::GIS::Proj::load_projection_descriptions();
