package Chart::Plotly::Trace::Histogram::Marker::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Histogram::Marker::Colorbar::Tickfont;
use Chart::Plotly::Trace::Histogram::Marker::Colorbar::Tickformatstop;
use Chart::Plotly::Trace::Histogram::Marker::Colorbar::Titlefont;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram::Marker::Colorbar::Tickfont", );
...
has tickformatstops => ( is  => "rw",
                         isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Histogram::Marker::Colorbar::Tickformatstop]",
);
...
has titlefont => ( is  => "rw",
                   isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram::Marker::Colorbar::Titlefont", );
...
Chart::Plotly::Trace::Histogram::Marker::Colorbar - This attribute is one of the possible options for the trace histogram.
