...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::TTF::Prep;
...
sub out_xml
{
    ...
    $self->read;
    $dat = PDF::API3::Compat::API2::Basic::TTF::Utils::XML_binhint($self->{' dat'});
...
sub XML_end
{
    ...
    if ($tag eq 'code')
    {
        $self->{' dat'} = PDF::API3::Compat::API2::Basic::TTF::Utils::XML_hintbin($context->{'text'});
        return $context;
    } else
