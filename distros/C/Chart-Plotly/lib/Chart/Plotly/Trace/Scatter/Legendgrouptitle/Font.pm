package Chart::Plotly::Trace::Scatter::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Scatter::Legendgrouptitle::Font - This attribute is one of the possible options for the trace scatter.
