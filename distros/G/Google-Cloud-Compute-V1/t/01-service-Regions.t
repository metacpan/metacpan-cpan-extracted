...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Region Google::Cloud::Compute::V1::Compute::RegionList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::RegionsClient->new( credentials => 'dummy' );
