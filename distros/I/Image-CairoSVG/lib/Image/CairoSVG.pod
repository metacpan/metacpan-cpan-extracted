...
<img width="451.271" height="187.542" src='https://api.metacpan.org/source/BKB/Image-CairoSVG-0.07/examples/locust.png'>

=end html

(This example is included as L<F<synopsis.pl>|https://api.metacpan.org/source/BKB/Image-CairoSVG-0.07/examples/synopsis.pl> in the distribution. The L<input|https://api.metacpan.org/source/BKB/Image-CairoSVG-0.07/examples/locust.svg> and L<output files|https://api.metacpan.org/source/BKB/Image-CairoSVG-0.07/examples/locust.png> are also included.)

=head1 VERSION

This documents version 0.07 of Image::CairoSVG corresponding to git
commit 2c5151c9cbc6492190a2c7f8722e7f04bc09ba79 released on Thu Dec 15 11:16:22 2016 +0900.
