...
#
package WebService::Fastly::LoggingCloudfilesApi;
...
# @param string $user The username for your Cloud Files account. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_log_cloudfiles' } = {
        summary => 'Create a Cloud Files log endpoint',
        params => $params,
        returns => 'LoggingCloudfilesResponse',
        };
}
# @return LoggingCloudfilesResponse
#
sub create_log_cloudfiles {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling create_log_cloudfiles");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling create_log_cloudfiles");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/cloudfiles';
    ...
    my $_response_object = $self->{api_client}->deserialize('LoggingCloudfilesResponse', $response);
...
# @param string $logging_cloudfiles_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_log_cloudfiles' } = {
...
#
sub delete_log_cloudfiles {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling delete_log_cloudfiles");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling delete_log_cloudfiles");
    }

    # verify the required parameter 'logging_cloudfiles_name' is set
    unless (exists $args{'logging_cloudfiles_name'}) {
      croak("Missing the required parameter 'logging_cloudfiles_name' when calling delete_log_cloudfiles");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/cloudfiles/{logging_cloudfiles_name}';
    ...
    # path params
    if ( exists $args{'logging_cloudfiles_name'}) {
        my $_base_variable = "{" . "logging_cloudfiles_name" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'logging_cloudfiles_name'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
# @param string $logging_cloudfiles_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_log_cloudfiles' } = {
...
# @return LoggingCloudfilesResponse
#
sub get_log_cloudfiles {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling get_log_cloudfiles");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling get_log_cloudfiles");
    }

    # verify the required parameter 'logging_cloudfiles_name' is set
    unless (exists $args{'logging_cloudfiles_name'}) {
      croak("Missing the required parameter 'logging_cloudfiles_name' when calling get_log_cloudfiles");
    }
...
# @param int $version_id Integer identifying a service version. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_log_cloudfiles' } = {
        summary => 'List Cloud Files log endpoints',
        params => $params,
        returns => 'ARRAY[LoggingCloudfilesResponse]',
        };
}
# @return ARRAY[LoggingCloudfilesResponse]
#
sub list_log_cloudfiles {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling list_log_cloudfiles");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling list_log_cloudfiles");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[LoggingCloudfilesResponse]', $response);
    return $_response_object;
}
...
# @param string $user The username for your Cloud Files account. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_log_cloudfiles' } = {
...
# @return LoggingCloudfilesResponse
#
sub update_log_cloudfiles {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling update_log_cloudfiles");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling update_log_cloudfiles");
    }

    # verify the required parameter 'logging_cloudfiles_name' is set
    unless (exists $args{'logging_cloudfiles_name'}) {
      croak("Missing the required parameter 'logging_cloudfiles_name' when calling update_log_cloudfiles");
    }
