...
asn_dec_rval_t
CUG_Interlock_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
CUG_Interlock_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_CUG_Interlock_constr_1 = {
...
asn_TYPE_descriptor_t asn_DEF_CUG_Interlock = {
	...
	CUG_Interlock_decode_uper,
	CUG_Interlock_encode_uper,
	...
	sizeof(asn_DEF_CUG_Interlock_tags_1)
		/sizeof(asn_DEF_CUG_Interlock_tags_1[0]), /* 1 */
	&asn_PER_type_CUG_Interlock_constr_1,
	0, 0,	/* No members */
	0	/* No specifics */
};
