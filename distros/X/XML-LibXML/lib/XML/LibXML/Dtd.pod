...
=head1 SYNOPSIS
  ...
  $dtd = XML::LibXML::Dtd-E<gt>new($public_id, $system_id);
  $dtd = XML::LibXML::Dtd-E<gt>parse_string($dtd_str);
  $publicId = $dtd-E<gt>getName();
  $publicId = $dtd-E<gt>publicId();
  $systemId = $dtd-E<gt>systemId();
