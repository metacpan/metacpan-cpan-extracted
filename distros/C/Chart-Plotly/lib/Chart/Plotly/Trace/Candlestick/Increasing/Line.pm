package Chart::Plotly::Trace::Candlestick::Increasing::Line;
use Moose;
...
Chart::Plotly::Trace::Candlestick::Increasing::Line - This attribute is one of the possible options for the trace candlestick.
