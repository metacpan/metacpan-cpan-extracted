...
# Big5Plus::eval (omit) has Big5Plus::eval "..."
$_ = <<'END';
...
# Big5Plus::eval (omit) has Big5Plus::eval qq{...}
$_ = <<'END';
...
# Big5Plus::eval (omit) has Big5Plus::eval q{...}
$_ = <<'END';
...
# Big5Plus::eval (omit) has Big5Plus::eval $var
$_ = <<'END';
Big5Plus::eval $var2
END
...
# Big5Plus::eval (omit) has Big5Plus::eval (omit)
$_ = <<'END';
