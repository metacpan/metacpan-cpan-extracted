package blx::xsdsql::schema_repository::sql::oracle::catalog;
...
use constant {
				 DICTIONARY_NAME_MAXSIZE	=> 30
				,DICTIONARY_COMMENT_MAXSIZE	=> 2048
				,BEGIN_COMMENT				=> '/*'
				,END_COMMENT				=> '*/'
				,COMMAND_TERMINATOR			=> ';'
				,MAX_COLUMNS_VIEW			=> 1000
				,MAX_JOINS_VIEW				=> 140  #it's really ? - with 145 left join oracle 11 failed 
				,MAX_COLUMNS_TABLE			=> 1000
...
=head1 SYNOPSIS
  ...
  use blx::xsdsql::schema_repository::sql::oracle::catalog
