...
# eval (omit) has eval "..."
$_ = <<'END';
eval Windows1254::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } "
END
if (eval Windows1254::escape) {
...
$_ = <<'END';
eval Windows1254::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
if (eval Windows1254::escape) {
...
# eval (omit) has eval '...'
$_ = <<'END';
eval Windows1254::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } '
END
if (eval Windows1254::escape) {
...
$_ = <<'END';
eval Windows1254::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
if (eval Windows1254::escape) {
