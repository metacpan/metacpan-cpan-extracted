...
$Shipment::FedEx::WSDL::ShipTypes::ProcessShipmentReply::VERSION = '3.10';
use strict;
use warnings;
...
ProcessShipmentReply from the namespace http://fedex.com/ws/ship/v9.
...
=item * ErrorLabels (min/maxOccurs: 0/unbounded)
