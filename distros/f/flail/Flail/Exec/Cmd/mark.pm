...
Flail::Exec::Cmd::mark - Flail "mark" command

=head1 VERSION

  Time-stamp: <2006-12-03 11:04:36 attila@stalphonsos.com>

=head1 SYNOPSIS

  use Flail::Exec::Cmd::mark;
  blah;
...
package Flail::Exec::Cmd::mark;
use strict;
use Carp;
use Flail::Utils;
use base qw(Exporter);
use vars qw(@EXPORT @EXPORT_OK %EXPORT_TAGS);
@EXPORT_OK = qw(flail_mark);
@EXPORT = ();
