...
# 1
    ...
    sub { $_='あABう123あABう123あABう123'; my $r=mb::index($_,'Bう1');   $r == 2 },
    sub { $_='あABう123あABう123あABう123'; my $r=mb::index($_,'Bう1',6); $r == 9 },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
# 11
    ...
    sub { $_='あABう123あABう123あABう123'; my $r=mb::index($_,'か3Z');   $r == -1 },
    sub { $_='あABう123あABう123あABう123'; my $r=mb::index($_,'か3Z',6); $r == -1 },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
