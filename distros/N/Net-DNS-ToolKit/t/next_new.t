...
($newoff,@dnptrs) = dn_comp(\$buffer,$newoff,\$name,\@dnptrs);
$newoff = put16(\$buffer,$newoff,$type);
$newoff = put16(\$buffer,$newoff,$class);
$newoff = put32(\$buffer,$newoff,$ttl);
$newoff = put16(\$buffer,$newoff,NS_INADDRSZ);
$newoff = putIPv4(\$buffer,$newoff,$netaddr);
...
($newoff,$newname,$newtype,$newclass,$newttl,$rdlength,$newnetaddr) = $get->next(\$buffer,$off);
