...
fixtures_ok [
   ...
   Contraption => [
      ...
      [ '4',  '1',            '2021-02-15 14:00:00', 'Gray', '11', 'Contrapto-Mart'],
   ],
   Doodad => [
      ...
      [ '4',  'Super-Doodad', '2021-02-12 16:00:00', '1', undef, undef ],
   ],
   Doohickey => [
      ...
      [ '3',  'DoohickeyCo', 'Three', '1', '2022-02-06 12:06:00', '2', '2022-03-01 06:15:00' ],
   ],
    ],
    'Installed fixtures';
...
subtest 'Created via direct injection' => sub {
   ...
   subtest 'Test temporal relation via ResultSet' => sub {
      ...
      my $contraptions = $human->most_recent_contraptions_purchased_between( '2021-01-10 00:00:00',
         '2021-01-31 23:59:59' );
...
subtest 'Created via single insert' => sub {
   ...
   subtest 'Test temporal relation via ResultSet' => sub {
      ...
      my $human = Human->find(1);
      my $doodads =
          $human->most_recent_doodads_created_between( '2021-01-10 00:00:00', '2021-01-31 23:59:59' );
...
subtest 'Created via group insert, no overrides' => sub {
   ...
   subtest 'Test temporal relation via ResultSet' => sub {
      ...
      my $human = Human->find(1);
      my $doodads =
          $human->most_recent_doodads_modified_between( '2021-01-13 00:00:00', '2021-01-31 23:59:59' );
      is( ref $doodads, 'DBIx::Class::ResultSet', 'ResultSet is returned in scalar mode.' );
      is( $doodads->count(),            2,        'Test returns correct number of results' );
...
subtest 'Created via group insert, singular noun override' => sub {
   ...
   subtest 'Test temporal relation via ResultSet' => sub {
      ...
      my $doohickies =
          $human->most_recent_doohickies_modified_between( '2021-01-10 00:00:00', '2021-01-31 23:59:59' );
...
subtest 'Created via group insert, singular & plural noun override' => sub {
   ...
   subtest 'Test temporal relation via ResultSet' => sub {
      ...
      my $human = Human->find(2);
      my $doohickies =
          $human->most_recent_doohickees_purchased_between( '2021-01-10 00:00:00', '2021-01-31 23:59:59' );
      is( ref $doohickies, 'DBIx::Class::ResultSet', 'ResultSet is returned in scalar mode.' );
      is( $doohickies->count(),     1,               'Test returns correct number of results' );
