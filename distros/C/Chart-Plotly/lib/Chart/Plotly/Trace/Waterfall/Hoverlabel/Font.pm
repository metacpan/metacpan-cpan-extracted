package Chart::Plotly::Trace::Waterfall::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Waterfall::Hoverlabel::Font - This attribute is one of the possible options for the trace waterfall.
