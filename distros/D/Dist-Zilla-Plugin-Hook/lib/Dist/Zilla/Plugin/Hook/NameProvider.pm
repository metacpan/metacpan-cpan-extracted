...
#pod
#pod This is C<Hook::NameProvider> plugin implementation. Nothing interesting, just using few roles.
#pod
...
#pod = L<Dist::Zilla>
#pod = L<Dist::Zilla::Role::NameProvider>
#pod
#pod =cut

package Dist::Zilla::Plugin::Hook::NameProvider;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::NameProvider> plugin implementation
our $VERSION = 'v0.8.3'; # VERSION

with 'Dist::Zilla::Role::Plugin';
with 'Dist::Zilla::Role::Hooker' => {
    -alias => { hook => 'provide_name' },
};
...
Dist::Zilla::Plugin::Hook::NameProvider - C<Hook::NameProvider> plugin implementation
...
This is C<Hook::NameProvider> plugin implementation. Nothing interesting, just using few roles.
...
=item L<Dist::Zilla::Role::NameProvider>
