...
This document describes version 0.001 of Acme::CPANModules::PortedFrom::Clojure (from Perl distribution Acme-CPANModules-PortedFrom-Clojure), released on 2020-02-07.

=head1 DESCRIPTION

Modules/applications that are ported from (or inspired by) Clojure.
