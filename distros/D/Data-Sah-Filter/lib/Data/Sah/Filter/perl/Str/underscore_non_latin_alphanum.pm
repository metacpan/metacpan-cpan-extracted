...
1;
# ABSTRACT: Replace each character that is not [A-Za-z0-9] with an underscore (_)
...
Data::Sah::Filter::perl::Str::underscore_non_latin_alphanum - Replace each character that is not [A-Za-z0-9] with an underscore (_)

=head1 VERSION

This document describes version 0.024 of Data::Sah::Filter::perl::Str::underscore_non_latin_alphanum (from Perl distribution Data-Sah-Filter), released on 2024-01-17.

=head1 SYNOPSIS

=head2 Using in Sah schema's C<prefilters> (or C<postfilters>) clause

 ["str","prefilters",[["Str::underscore_non_latin_alphanum"]]]

=head2 Using with L<Data::Sah>:

 use Data::Sah qw(gen_validator);
 
 my $schema = ["str","prefilters",[["Str::underscore_non_latin_alphanum"]]];
