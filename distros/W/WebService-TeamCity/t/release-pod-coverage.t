...
my %skip = map { $_ => 1 } qw( WebService::TeamCity::Entity WebService::TeamCity::LocatorSpec WebService::TeamCity::Types );

my @modules;
for my $module ( all_modules() ) {
    next if $skip{$module};
    next if $module =~ qr/^WebService::TeamCity::Entity::Has.+/;
