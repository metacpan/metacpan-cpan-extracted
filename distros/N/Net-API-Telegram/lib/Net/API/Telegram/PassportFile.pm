# -*- perl -*-
##----------------------------------------------------------------------------
## Net/API/Telegram/PassportFile.pm
## Version 0.1
...
##----------------------------------------------------------------------------
package Net::API::Telegram::PassportFile;
BEGIN
{
	use strict;
...
sub file_date { return( shift->_set_get_datetime( 'file_date', @_ ) ); }sub file_id { return( shift->_set_get_scalar( 'file_id', @_ ) ); }
...
Net::API::Telegram::PassportFile - A file uploaded to Telegram Passport

=head1 SYNOPSIS

	my $msg = Net::API::Telegram::PassportFile->new( %data ) || 
	die( Net::API::Telegram::PassportFile->error, "\n" );

=head1 DESCRIPTION

L<Net::API::Telegram::PassportFile> is a Telegram Message Object as defined here L<https://core.telegram.org/bots/api#passportfile>
