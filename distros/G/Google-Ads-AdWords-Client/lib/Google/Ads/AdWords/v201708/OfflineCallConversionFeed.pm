package Google::Ads::AdWords::v201708::OfflineCallConversionFeed;
use strict;
use warnings;
...
Google::Ads::AdWords::v201708::OfflineCallConversionFeed

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OfflineCallConversionFeed from the namespace https://adwords.google.com/api/adwords/cm/v201708.
