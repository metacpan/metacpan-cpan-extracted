package Chart::Plotly::Trace::Histogram2d::Xbins;
use Moose;
...
use Chart::Plotly::Trace::Histogram2d::Xbins::ImpliedEdits;
...
has impliedEdits => ( is  => "rw",
                      isa => "Maybe[HashRef]|Chart::Plotly::Trace::Histogram2d::Xbins::ImpliedEdits", );
