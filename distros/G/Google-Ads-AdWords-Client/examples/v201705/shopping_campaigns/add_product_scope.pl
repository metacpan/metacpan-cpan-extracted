...
use Google::Ads::AdWords::v201705::ProductBiddingCategory;
use Google::Ads::AdWords::v201705::ProductBrand;
use Google::Ads::AdWords::v201705::ProductCanonicalCondition;
use Google::Ads::AdWords::v201705::ProductCustomAttribute;
use Google::Ads::AdWords::v201705::ProductOfferId;
use Google::Ads::AdWords::v201705::ProductScope;
use Google::Ads::AdWords::v201705::ProductType;
...
sub add_product_scope {
  ...
  my $product_scope = Google::Ads::AdWords::v201705::ProductScope->new({
      # This set of dimensions is for demonstration purposes only. It would be
      # extremely unlikely that you want to include so many dimensions in your
      # product scope.
      dimensions => [
        Google::Ads::AdWords::v201705::ProductBrand->new({value => "Nexus"}),
        Google::Ads::AdWords::v201705::ProductCanonicalCondition->new(
          {condition => "NEW"}
        ),
        Google::Ads::AdWords::v201705::ProductCustomAttribute->new({
            type  => "CUSTOM_ATTRIBUTE_0",
            value => "my attribute value"
          }
        ),
        Google::Ads::AdWords::v201705::ProductOfferId->new({value => "book1"}),
        Google::Ads::AdWords::v201705::ProductType->new({
        ...
        # more details.
        Google::Ads::AdWords::v201705::ProductBiddingCategory->new({
            type  => "BIDDING_CATEGORY_L1",
            value => -5914235892932915235
          })]});

  my $campaign_criterion =
    Google::Ads::AdWords::v201705::CampaignCriterion->new({
