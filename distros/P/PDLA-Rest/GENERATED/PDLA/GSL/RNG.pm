...
#
package PDLA::GSL::RNG;

@EXPORT_OK  = qw(  );
%EXPORT_TAGS = (Func=>[@EXPORT_OK]);

use PDLA::Core qw/ zeroes long barf  /;
use PDLA::Exporter;
use DynaLoader;
...
Usage:
   ...
   $blessed_ref = PDLA::GSL::RNG->new($RNG_name);
...
=for usage
   ...
   # or
   $rng = PDLA::GSL::RNG->new('taus')->set_seed($integer);
...
# PDLA::GSL::RNG::nullcreate just creates a null PDLA. Used
#  for the GSL functions that create PDLAs
sub nullcreate{
...
sub get_uniform {
my ($obj,@var) = @_;if (ref($var[0]) eq 'PDLA') {
...
sub get_int {
my ($obj,$n,@var) = @_;if (!($n>0)) {barf("first parameter must be an int >0")};if (ref($var[0]) eq 'PDLA') {
...
*gsl_get_uniform_meat = \&PDLA::GSL::RNG::gsl_get_uniform_meat;





*gsl_get_uniform_pos_meat = \&PDLA::GSL::RNG::gsl_get_uniform_pos_meat;





*gsl_get_meat = \&PDLA::GSL::RNG::gsl_get_meat;





*gsl_get_int_meat = \&PDLA::GSL::RNG::gsl_get_int_meat;





*ran_gaussian_meat = \&PDLA::GSL::RNG::ran_gaussian_meat;
...
*ran_gaussian_var_meat = \&PDLA::GSL::RNG::ran_gaussian_var_meat;
...
*ran_ugaussian_tail_meat = \&PDLA::GSL::RNG::ran_ugaussian_tail_meat;
...
*ran_ugaussian_tail_var_meat = \&PDLA::GSL::RNG::ran_ugaussian_tail_var_meat;
...
*ran_exponential_meat = \&PDLA::GSL::RNG::ran_exponential_meat;
...
*ran_exponential_var_meat = \&PDLA::GSL::RNG::ran_exponential_var_meat;
...
*ran_laplace_meat = \&PDLA::GSL::RNG::ran_laplace_meat;
...
*ran_laplace_var_meat = \&PDLA::GSL::RNG::ran_laplace_var_meat;
...
*ran_exppow_meat = \&PDLA::GSL::RNG::ran_exppow_meat;
...
*ran_exppow_var_meat = \&PDLA::GSL::RNG::ran_exppow_var_meat;
...
*ran_cauchy_meat = \&PDLA::GSL::RNG::ran_cauchy_meat;
...
*ran_cauchy_var_meat = \&PDLA::GSL::RNG::ran_cauchy_var_meat;
...
*ran_rayleigh_meat = \&PDLA::GSL::RNG::ran_rayleigh_meat;
...
*ran_rayleigh_var_meat = \&PDLA::GSL::RNG::ran_rayleigh_var_meat;
...
*ran_rayleigh_tail_meat = \&PDLA::GSL::RNG::ran_rayleigh_tail_meat;
...
*ran_rayleigh_tail_var_meat = \&PDLA::GSL::RNG::ran_rayleigh_tail_var_meat;
...
*ran_levy_meat = \&PDLA::GSL::RNG::ran_levy_meat;
...
*ran_levy_var_meat = \&PDLA::GSL::RNG::ran_levy_var_meat;
...
*ran_gamma_meat = \&PDLA::GSL::RNG::ran_gamma_meat;
...
*ran_gamma_var_meat = \&PDLA::GSL::RNG::ran_gamma_var_meat;
...
*ran_flat_meat = \&PDLA::GSL::RNG::ran_flat_meat;
...
*ran_flat_var_meat = \&PDLA::GSL::RNG::ran_flat_var_meat;
...
*ran_lognormal_meat = \&PDLA::GSL::RNG::ran_lognormal_meat;
...
*ran_lognormal_var_meat = \&PDLA::GSL::RNG::ran_lognormal_var_meat;
...
*ran_chisq_meat = \&PDLA::GSL::RNG::ran_chisq_meat;
...
*ran_chisq_var_meat = \&PDLA::GSL::RNG::ran_chisq_var_meat;
...
*ran_fdist_meat = \&PDLA::GSL::RNG::ran_fdist_meat;
...
*ran_fdist_var_meat = \&PDLA::GSL::RNG::ran_fdist_var_meat;
...
*ran_tdist_meat = \&PDLA::GSL::RNG::ran_tdist_meat;
...
*ran_tdist_var_meat = \&PDLA::GSL::RNG::ran_tdist_var_meat;
...
*ran_beta_meat = \&PDLA::GSL::RNG::ran_beta_meat;
...
*ran_beta_var_meat = \&PDLA::GSL::RNG::ran_beta_var_meat;
...
*ran_logistic_meat = \&PDLA::GSL::RNG::ran_logistic_meat;
...
*ran_logistic_var_meat = \&PDLA::GSL::RNG::ran_logistic_var_meat;
...
*ran_pareto_meat = \&PDLA::GSL::RNG::ran_pareto_meat;
...
*ran_pareto_var_meat = \&PDLA::GSL::RNG::ran_pareto_var_meat;
...
*ran_weibull_meat = \&PDLA::GSL::RNG::ran_weibull_meat;
...
*ran_weibull_var_meat = \&PDLA::GSL::RNG::ran_weibull_var_meat;
...
*ran_gumbel1_meat = \&PDLA::GSL::RNG::ran_gumbel1_meat;
...
*ran_gumbel1_var_meat = \&PDLA::GSL::RNG::ran_gumbel1_var_meat;
...
*ran_gumbel2_meat = \&PDLA::GSL::RNG::ran_gumbel2_meat;
...
*ran_gumbel2_var_meat = \&PDLA::GSL::RNG::ran_gumbel2_var_meat;
...
*ran_poisson_meat = \&PDLA::GSL::RNG::ran_poisson_meat;
...
*ran_poisson_var_meat = \&PDLA::GSL::RNG::ran_poisson_var_meat;
...
*ran_bernoulli_meat = \&PDLA::GSL::RNG::ran_bernoulli_meat;
...
*ran_bernoulli_var_meat = \&PDLA::GSL::RNG::ran_bernoulli_var_meat;
...
*ran_binomial_meat = \&PDLA::GSL::RNG::ran_binomial_meat;
...
*ran_binomial_var_meat = \&PDLA::GSL::RNG::ran_binomial_var_meat;
...
*ran_negative_binomial_meat = \&PDLA::GSL::RNG::ran_negative_binomial_meat;
...
*ran_negative_binomial_var_meat = \&PDLA::GSL::RNG::ran_negative_binomial_var_meat;
...
*ran_pascal_meat = \&PDLA::GSL::RNG::ran_pascal_meat;
...
*ran_pascal_var_meat = \&PDLA::GSL::RNG::ran_pascal_var_meat;
...
*ran_geometric_meat = \&PDLA::GSL::RNG::ran_geometric_meat;
...
*ran_geometric_var_meat = \&PDLA::GSL::RNG::ran_geometric_var_meat;
...
*ran_hypergeometric_meat = \&PDLA::GSL::RNG::ran_hypergeometric_meat;
...
*ran_hypergeometric_var_meat = \&PDLA::GSL::RNG::ran_hypergeometric_var_meat;
...
*ran_logarithmic_meat = \&PDLA::GSL::RNG::ran_logarithmic_meat;
...
*ran_logarithmic_var_meat = \&PDLA::GSL::RNG::ran_logarithmic_var_meat;
...
*ran_additive_gaussian_meat = \&PDLA::GSL::RNG::ran_additive_gaussian_meat;
...
*ran_additive_poisson_meat = \&PDLA::GSL::RNG::ran_additive_poisson_meat;
...
*ran_feed_poisson_meat = \&PDLA::GSL::RNG::ran_feed_poisson_meat;
...
*ran_bivariate_gaussian_meat = \&PDLA::GSL::RNG::ran_bivariate_gaussian_meat;
...
*ran_dir_2d_meat = \&PDLA::GSL::RNG::ran_dir_2d_meat;





*ran_dir_3d_meat = \&PDLA::GSL::RNG::ran_dir_3d_meat;





*ran_dir_nd_meat = \&PDLA::GSL::RNG::ran_dir_nd_meat;
...
*ran_discrete_meat = \&PDLA::GSL::RNG::ran_discrete_meat;
...
*ran_ver_meat = \&PDLA::GSL::RNG::ran_ver_meat;





*ran_caos_meat = \&PDLA::GSL::RNG::ran_caos_meat;
