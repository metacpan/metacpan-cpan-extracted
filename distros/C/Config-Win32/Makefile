# This Makefile is for the Config::Win32 extension to perl.
#
...
PARENT_NAME = Config
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Config/Win32.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/Config/Win32.pm

PM_TO_BLIB = lib/Config/Win32.pm \
	blib\lib\Config\Win32.pm
...
Win32.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Config::Win32\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Config/Win32.pm $(INST_MAN3DIR)\Config.Win32.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "abstract: 'Load and save configuration values on Windows'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "name: Config-Win32" >> META_new.yml
