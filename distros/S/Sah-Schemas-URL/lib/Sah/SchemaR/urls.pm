...
our $rschema = ["array",[{examples=>[{valid=>1,value=>[]},{valid=>0,value=>[""]}],of=>"url*"}],["array"]];
...
This document describes version 0.012 of Sah::SchemaR::urls (from Perl distribution Sah-Schemas-URL), released on 2020-05-27.
