package Google::Ads::AdWords::v201809::NegativeFeedItemCriterionTarget;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201809::FeedItemCriterionTarget);
# Variety: sequence
...
Google::Ads::AdWords::v201809::NegativeFeedItemCriterionTarget

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
NegativeFeedItemCriterionTarget from the namespace https://adwords.google.com/api/adwords/cm/v201809.
