...
SKIP: {
  ...
  isa_ok( $session->mixer('Net::SNMP::Mixin::CiscoDot1qVlanStatic'), 'Net::SNMP' );
  ok(
  ...
  ok( $session->init_ok('Net::SNMP::Mixin::CiscoDot1qVlanStatic'), 'initialization successful completetd' );
