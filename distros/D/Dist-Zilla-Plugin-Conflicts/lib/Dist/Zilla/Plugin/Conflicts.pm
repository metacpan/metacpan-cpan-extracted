...
Bugs may be submitted through L<the RT bug tracker|http://rt.cpan.org/Public/Dist/Display.html?Name=Dist-Zilla-Plugin-Conflicts>
(or L<bug-dist-zilla-plugin-conflicts@rt.cpan.org|mailto:bug-dist-zilla-plugin-conflicts@rt.cpan.org>).

There is a mailing list available for users of this distribution,
L<mailto:http://dzil.org/#mailing-list>.
