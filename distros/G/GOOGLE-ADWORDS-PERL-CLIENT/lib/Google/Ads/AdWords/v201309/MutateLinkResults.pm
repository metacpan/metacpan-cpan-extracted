package Google::Ads::AdWords::v201309::MutateLinkResults;
use strict;
use warnings;
...
Google::Ads::AdWords::v201309::MutateLinkResults

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MutateLinkResults from the namespace https://adwords.google.com/api/adwords/mcm/v201309.
