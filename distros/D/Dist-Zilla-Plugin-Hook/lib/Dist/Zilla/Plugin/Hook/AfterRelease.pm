...
#pod
#pod This is C<Hook::AfterRelease> plugin implementation. Nothing interesting, just using few roles.
#pod
...
#pod = L<Dist::Zilla>
#pod = L<Dist::Zilla::Role::AfterRelease>
#pod
#pod =cut

package Dist::Zilla::Plugin::Hook::AfterRelease;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::AfterRelease> plugin implementation
our $VERSION = 'v0.8.4'; # VERSION

with 'Dist::Zilla::Role::Plugin';
with 'Dist::Zilla::Role::Hooker' => {
    -alias => { hook => 'after_release' },
};
...
Dist::Zilla::Plugin::Hook::AfterRelease - C<Hook::AfterRelease> plugin implementation
...
This is C<Hook::AfterRelease> plugin implementation. Nothing interesting, just using few roles.
