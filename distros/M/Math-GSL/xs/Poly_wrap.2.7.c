...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_Math__GSL__Poly_var::
class _wrap_Math__GSL__Poly_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
static swig_type_info _swigt__p_double = {"_p_double", "double *|gsl_complex_packed_ptr", 0, 0, (void*)0, 0};
