...
package UMMF::MOF_1_3::Model::Constraint;
...
=head2 C<expression> : UMMF::MOF_1_3::Model::String 
...
=head2 C<language> : UMMF::MOF_1_3::Model::String 
...
=head2 C<evaluationPolicy> : UMMF::MOF_1_3::Model::EvaluationKind 
...
=item type = L<UMMF::MOF_1_3::Model::EvaluationKind|UMMF::MOF_1_3::Model::EvaluationKind>
...
=head2 C<constraint> : I<THIS> C<0..*> E<lt>---E<gt>  C<constrainedElement> : UMMF::MOF_1_3::Model::ModelElement C<1..*>
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_3::Model::Constraint->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_3::Model::Constraint|UMMF::MOF_1_3::Model::Constraint>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_3::Model::Constraint')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_3::Model::Constraint->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_3::Model::Constraint->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_3::Model::Constraint' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_3::Model::Constraint|UMMF::MOF_1_3::Model::Constraint>.
...
sub ___initialize
{
  ...
  #  constraint 0..*
  #  <--> 
  #  constrainedElement 1..* UMMF::MOF_1_3::Model::ModelElement.
...
sub __initialize
{
  ...
  $self->UMMF::MOF_1_3::Model::Constraint::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_3::Model::Constraint::___create(@args);
...
Returns the L<UMMF::MOF_1_3::Model::String|UMMF::MOF_1_3::Model::String> value of Attribute C<expression>.
...
Returns the L<UMMF::MOF_1_3::Model::String|UMMF::MOF_1_3::Model::String> value of Attribute C<language>.
...
#################################################################
# Attribute evaluationPolicy
# type = UMMF::MOF_1_3::Model::EvaluationKind
# multiplicity = 1
# ordering = unordered
# ownerScope = instance
# initialValue = 
...
Returns the L<UMMF::MOF_1_3::Model::EvaluationKind|UMMF::MOF_1_3::Model::EvaluationKind> value of Attribute C<evaluationPolicy>.
...
C<$val> must be of type L<UMMF::MOF_1_3::Model::EvaluationKind|UMMF::MOF_1_3::Model::EvaluationKind> or C<undef>.
Returns C<$obj>.
...
sub set_evaluationPolicy ($$)
{
  ...
  if ( defined $val ) {
    $self->__use('UMMF::MOF_1_3::Model::EvaluationKind')->__typecheck($val, "UMMF::MOF_1_3::Model::Constraint.evaluationPolicy");
  }
...
Returns the AssociationEnd C<constrainedElement> values of type L<UMMF::MOF_1_3::Model::ModelElement|UMMF::MOF_1_3::Model::ModelElement>.
...
sub add_constrainedElement ($@)
{
  ...
  for my $val ( @val ) {
    # Recursion lock
        ...
        $self->__use('UMMF::MOF_1_3::Model::ModelElement')->__typecheck($val, "UMMF::MOF_1_3::Model::Constraint.constrainedElement");
...
Clears the AssociationEnd C<constrainedElement> links to L<UMMF::MOF_1_3::Model::ModelElement|UMMF::MOF_1_3::Model::ModelElement>.
Returns C<$obj>.
