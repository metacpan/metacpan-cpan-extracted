...
=head1 The HTTP::Cookies::Omniweb module

This is the I<README> for the L<HTTP::Cookies::Omniweb> Perl module. You're probably
...
To read about L<HTTP::Cookies::Omniweb>, look at the embedded documentation
in the module itself. Inside the distribution, you can format it
with L<perldoc|http://perldoc.perl.org/perldoc.html>:

	% perldoc lib/HTTP/Cookies/Omniweb.pm

If you have already installed the module, you can specify the module
name instead of the file location:

	% perldoc HTTP::Cookies::Omniweb

You can read the documentation and inspect the meta data on one of the
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/HTTP-Cookies-Omniweb> or
L<MetaCPAN|http://www.metacpan.org/module/HTTP::Cookies::Omniweb>:

=over 4

=item *	L<http://search.cpan.org/dist/HTTP-Cookies-Omniweb>

=item *	L<http://www.metacpan.org/module/HTTP::Cookies::Omniweb>
...
and install the dependencies:
	...
	% cpan HTTP::Cookies::Omniweb
	% cpanm HTTP::Cookies::Omniweb
...
=item *	L<https://github.com/CPAN-Adoptable-Modules/http-cookies-icab>

=back

=head2 Getting help

This is an abandoned module. It's looking for a maintainer and that might
be you. Other than that you are on your own.
