...
This document describes Attean::API::Serializer version 0.039
...
package Attean::API::Serializer 0.039 {
	use Moo::Role;
	use Carp qw(confess);
...
package Attean::API::AbbreviatingSerializer 0.039 {
...
package Attean::API::TripleSerializer 0.039 {
	use Moo::Role;
	with 'Attean::API::Serializer';
	sub handled_type {
...
package Attean::API::QuadSerializer 0.039 {
	use Moo::Role;
	with 'Attean::API::Serializer';
...
package Attean::API::MixedStatementSerializer 0.039 {
	use Moo::Role;
	with 'Attean::API::Serializer';
...
package Attean::API::ResultSerializer 0.039 {
	use Moo::Role;
	with 'Attean::API::Serializer';
	sub handled_type {
