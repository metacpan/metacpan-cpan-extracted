...
package WebService::Edgecast::auto::MediaManager::Element::WmsPubPointsGet;
BEGIN {
  $WebService::Edgecast::auto::MediaManager::Element::WmsPubPointsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('WmsPubPointsGet');
...
WebService::Edgecast::auto::MediaManager::Element::WmsPubPointsGet
...
WmsPubPointsGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::MediaManager::Element::WmsPubPointsGet->new($data);
