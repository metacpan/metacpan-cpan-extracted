package Data::Sah::Coerce::perl::To_date::From_str::natural_jakarta;
...
sub meta {
    +{
        v => 4,
        summary => 'Coerce date from string parsed by DateTime::Format::Natural (Asia/Jakarta time zone)',
        might_fail => 1,
...
sub coerce {
    ...
    $res->{expr_coerce} = join(
        "",
        "do { my \$p = DateTime::Format::Natural->new(time_zone => 'Asia/Jakarta'); my \$datetime = \$p->parse_datetime($dt)->set_time_zone('Asia/Jakarta'); ",
...
1;
# ABSTRACT: Coerce date from string parsed by DateTime::Format::Natural (Asia/Jakarta time zone)
...
Data::Sah::Coerce::perl::To_date::From_str::natural_jakarta - Coerce date from string parsed by DateTime::Format::Natural (Asia/Jakarta time zone)

=head1 VERSION

This document describes version 0.014 of Data::Sah::Coerce::perl::To_date::From_str::natural_jakarta (from Perl distribution Data-Sah-Coerce-perl-To_date-From_str-natural), released on 2021-09-07.

=head1 SYNOPSIS

To use in a Sah schema:

 ["date",{"x.perl.coerce_rules"=>["From_str::natural_jakarta"]}]
...
L<Data::Sah::Coerce::perl::To_date::From_str::flexible_jakarta>
