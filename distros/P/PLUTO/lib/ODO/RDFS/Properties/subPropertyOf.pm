package ODO::RDFS::Properties::subPropertyOf;
...
sub new {
	...
	$self->propertyContainerName( 'ODO::RDFS::Properties::subPropertyOf::PropertiesContainer' );
	$self->properties(bless {}, 'ODO::RDFS::Properties::subPropertyOf::PropertiesContainer');
