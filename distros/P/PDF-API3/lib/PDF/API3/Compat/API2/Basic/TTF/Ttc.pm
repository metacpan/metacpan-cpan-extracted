...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::TTF::Ttc;

=head1 NAME

PDF::API3::Compat::API2::Basic::TTF::Ttc - Truetype Collection class
...
An array of directories (PDF::API3::Compat::API2::Basic::TTF::Font objects) for each sub-font in the directory
...
=head2 PDF::API3::Compat::API2::Basic::TTF::Ttc->open($fname)
...
sub read
{
    ...
    for ($i = 0; $i < $num; $i++)
    {
        ...
        $self->{'directs'}[$i] = PDF::API3::Compat::API2::Basic::TTF::Font->new('INFILE' => $fh,
                                                'PARENT' => $self,
