...
=item dbix-migration [ B<-v> ] [ B<-u> I<username> ] [ B<-p> I<password> ] [ B<-s> I<schema> ] [ B<-t> I<schema> ] I<dsn> [ I<directory> [ I<version> ] ]
...
=head1 EXAMPLES
  ...
  dbix-migration -s myapp -t myapp_tracking ':dbi:Pg:service=myapp' ~/Projects/myapp/db/migrations 2
...
configured in a service file and extracted from there using the service name
"myapp".
