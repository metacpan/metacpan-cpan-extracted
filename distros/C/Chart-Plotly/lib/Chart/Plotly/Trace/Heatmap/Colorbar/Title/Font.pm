package Chart::Plotly::Trace::Heatmap::Colorbar::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Heatmap::Colorbar::Title::Font - This attribute is one of the possible options for the trace heatmap.
