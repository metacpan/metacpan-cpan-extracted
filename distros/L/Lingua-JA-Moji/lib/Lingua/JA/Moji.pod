...
This document describes Lingua::JA::Moji version 0.53
corresponding to git commit L<4d331013d110c3c316c352bd2409a6b609e6e214|https://github.com/benkasminbullock/Lingua-JA-Moji/commit/4d331013d110c3c316c352bd2409a6b609e6e214> made on Wed Oct 3 15:41:13 2018 +0900.
...
katakana and hiragana to full width katakana. It also joins dakuten
and handakuten marks to kana where possible, or removes them, using
L</join_sound_marks>.
...
web application|https://www.sljfaq.org/cgi/name-kanji.cgi>.
...
Join dakuten and handakuten (Unicode U+3099-U+309C) to kana where
possible. Where they cannot be joined, strip them out.
...
Split dakuten and handakuten from kana where possible. U+309B and
U+309C are chosen rather than U+3099 and U+309A. (This choice was
...
the module in L</kana2braille> and L</kana2morse>.)
...
exists, they are returned joined with a middle dot. Dakuten and
handakuten are split out of the kana using L</split_sound_marks>
...
left untouched. Dakuten and handakuten are split from the kana
using L</split_sound_marks>.
...
0.47 added a list of the "Yūrei moji" (幽霊文字), false kanji, and
...
0.53 added L</join_sound_marks> and L</split_sound_marks> to the
module.
