...
Acme::CPANModules::PERLANCAR::MagicVariableTechnique - Modules which employ magic variable technique to do stuffs

=head1 VERSION

This document describes version 0.001 of Acme::CPANModules::PERLANCAR::MagicVariableTechnique (from Perl distribution Acme-CPANModulesBundle-PERLANCAR), released on 2018-01-09.
