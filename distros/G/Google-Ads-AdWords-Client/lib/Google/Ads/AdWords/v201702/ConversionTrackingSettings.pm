package Google::Ads::AdWords::v201702::ConversionTrackingSettings;
use strict;
use warnings;
...
ConversionTrackingSettings from the namespace https://adwords.google.com/api/adwords/mcm/v201702.
