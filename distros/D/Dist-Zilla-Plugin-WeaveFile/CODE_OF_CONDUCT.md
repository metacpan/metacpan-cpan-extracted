...
Dist-Zilla-Plugin-WeaveFile project a harassment-free experience for
...
Dist-Zilla-Plugin-WeaveFile project include:
...
This Code of Conduct applies within all Dist-Zilla-Plugin-WeaveFile project
spaces, and also applies when an individual is officially representing the
Dist-Zilla-Plugin-WeaveFile project in public spaces. Examples of
representing the Dist-Zilla-Plugin-WeaveFile project include using an
