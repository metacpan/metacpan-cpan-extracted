...
$Shipment::UPS::WSDL::RateTypes::PhoneType::VERSION = '3.04';
use strict;
use warnings;
...
Shipment::UPS::WSDL::RateTypes::PhoneType
...
PhoneType from the namespace http://www.ups.com/XMLSchema/XOLTWS/Rate/v1.1.
