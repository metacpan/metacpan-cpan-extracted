...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::TTF::Kern::Subtable;

=head1 NAME

PDF::API3::Compat::API2::Basic::TTF::Kern::Subtable
...
require PDF::API3::Compat::API2::Basic::TTF::Kern::OrderedList;
require PDF::API3::Compat::API2::Basic::TTF::Kern::StateTable;
require PDF::API3::Compat::API2::Basic::TTF::Kern::ClassArray;
require PDF::API3::Compat::API2::Basic::TTF::Kern::CompactClassArray;
...
sub create
{
    ...
    my $subclass;
    if ($type == 0) {
        $subclass = 'PDF::API3::Compat::API2::Basic::TTF::Kern::OrderedList';
    }
    elsif ($type == 1) {
        $subclass = 'PDF::API3::Compat::API2::Basic::TTF::Kern::StateTable';
    }
    elsif ($type == 2) {
        $subclass = 'PDF::API3::Compat::API2::Basic::TTF::Kern::ClassArray';
    }
    elsif ($type == 3) {
        $subclass = 'PDF::API3::Compat::API2::Basic::TTF::Kern::CompactClassArray';
    }
