...
Sah::SchemaR::perl::arraydata::modname - Perl ArrayData::* module name without the prefix, e.g. Word::ID::KBBI

=head1 VERSION

This document describes version 0.001 of Sah::SchemaR::perl::arraydata::modname (from Perl distribution Sah-Schemas-ArrayData), released on 2021-06-17.
