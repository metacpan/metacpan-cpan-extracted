...
XS(_wrap_gsl_fit_wlinear) {
  {
    ...
    if (SWIG_IsTmpObj(res12)) {
      /*@SWIG:/usr/share/swig4.0/perl5/perltypemaps.swg,59,%append_output@*/
      if (argvi >= items) EXTEND(sp, argvi+1);
      ST(argvi) = SWIG_From_double  SWIG_PERL_CALL_ARGS_1((*arg12)); argvi++  /*@SWIG@*/;
    } else {
      int new_flags = SWIG_IsNewObj(res12) ? (SWIG_POINTER_OWN | 0) : 0;
      /*@SWIG:/usr/share/swig4.0/perl5/perltypemaps.swg,59,%append_output@*/
      if (argvi >= items) EXTEND(sp, argvi+1);
      ST(argvi) = SWIG_NewPointerObj((void*)(arg12), SWIGTYPE_p_double, new_flags); argvi++  /*@SWIG@*/;
    }
    if (SWIG_IsTmpObj(res13)) {
      /*@SWIG:/usr/share/swig4.0/perl5/perltypemaps.swg,59,%append_output@*/
      if (argvi >= items) EXTEND(sp, argvi+1);
      ST(argvi) = SWIG_From_double  SWIG_PERL_CALL_ARGS_1((*arg13)); argvi++  /*@SWIG@*/;
    } else {
      int new_flags = SWIG_IsNewObj(res13) ? (SWIG_POINTER_OWN | 0) : 0;
      /*@SWIG:/usr/share/swig4.0/perl5/perltypemaps.swg,59,%append_output@*/
      if (argvi >= items) EXTEND(sp, argvi+1);
      ST(argvi) = SWIG_NewPointerObj((void*)(arg13), SWIGTYPE_p_double, new_flags); argvi++  /*@SWIG@*/;
    }
    {
      if (arg1) free(arg1);
    }
