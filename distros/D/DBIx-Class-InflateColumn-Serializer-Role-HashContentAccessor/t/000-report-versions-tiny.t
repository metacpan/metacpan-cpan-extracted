...
eval { $v .= pmver('DBICx::TestDatabase','any version') };
eval { $v .= pmver('DBIx::Class::Core','any version') };
eval { $v .= pmver('DBIx::Class::InflateColumn::Serializer','any version') };
eval { $v .= pmver('DBIx::Class::InflateColumn::Serializer::Hstore','any version') };
eval { $v .= pmver('DBIx::Class::InflateColumn::Serializer::JSON','any version') };
...
eval { $v .= pmver('Pg::hstore','any version') };
