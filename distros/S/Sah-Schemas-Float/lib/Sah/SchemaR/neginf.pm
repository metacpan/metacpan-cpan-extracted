...
our $rschema = ["float",[{examples=>[{valid=>0,value=>0},{valid=>0,value=>1},{valid=>0,value=>"Inf"},{valid=>1,value=>"-Inf"},{valid=>0,value=>"NaN"}],is_neg_inf=>1,summary=>"-Inf"}],["float"]];
...
This document describes version 0.011 of Sah::SchemaR::neginf (from Perl distribution Sah-Schemas-Float), released on 2020-06-04.
