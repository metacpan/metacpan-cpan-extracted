...
package Meta::Projects::Fortune::Edge;
...
Meta::Projects::Fortune::Edge - fortune table edge Class::DBI wrapper.
...
=head1 SYNOPSIS
	...
	my($object)=Meta::Projects::Fortune::Edge->new();
...
This is a testing suite for the Meta::Projects::Fortune::Edge module.
