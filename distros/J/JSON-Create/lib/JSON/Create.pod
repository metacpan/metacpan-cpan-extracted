...
(This example is included as L<F<examples/synopsis.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/synopsis.pl> in the distribution.)


=head1 VERSION

This document describes JSON::Create version 0.33,
corresponding to L<git commit feb6b7ec9f53eb2efed3bb62f77ae271376b0280|https://github.com/benkasminbullock/json-create/commit/feb6b7ec9f53eb2efed3bb62f77ae271376b0280> at Thu Apr 29 06:56:33 2021 +0900.
...
customization, an object created with L</new> and run with L</create>
...
The "strict" option can be set in C<%args> without producing an error,
...
Write the contents of C<%hash> (or an array reference or scalar) to
the file specified in the first argument. This takes all the same
arguments as L</create_json>, L</new> and L</set>.
...
(This example is included as L<F<examples/fatal-errors.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/fatal-errors.pl> in the distribution.)
...
Create a new "JSON::Create" object. Use L</create> to generate JSON with
...
=item downgrade_utf8 option

This corresponds to L</downgrade_utf8>.



=item escape_slash option

This corresponds to L</escape_slash>.



=item fatal_errors option
...
=item no_javascript_safe option

This corresponds to L</no_javascript_safe>.



=item non_finite_handler option

This corresponds to L</non_finite_handler>.



=item object_handler option
...
(This example is included as L<F<examples/boolean.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/boolean.pl> in the distribution.)
...
(This example is included as L<F<examples/cmp.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/cmp.pl> in the distribution.)
...
(This example is included as L<F<examples/escape-slash.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/escape-slash.pl> in the distribution.)
...
(This example is included as L<F<examples/indent.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/indent.pl> in the distribution.)
...
(This example is included as L<F<examples/indent-format.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/indent-format.pl> in the distribution.)
...
(This example is included as L<F<examples/js-safe.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/js-safe.pl> in the distribution.)
...
(This example is included as L<F<examples/non-finite-handler.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/non-finite-handler.pl> in the distribution.)
...
caught by L</create> but passed through to the parent. Please see the
...
(This example is included as L<F<examples/zilog.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/zilog.pl> in the distribution.)
...
(This example is included as L<F<examples/too-many-values.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/too-many-values.pl> in the distribution.)
...
(This example is included as L<F<examples/closure.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/closure.pl> in the distribution.)
...
(This example is included as L<F<examples/exception.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/exception.pl> in the distribution.)
...
(This example is included as L<F<examples/obj-handler.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/obj-handler.pl> in the distribution.)
...
(This example is included as L<F<examples/try-harder.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/try-harder.pl> in the distribution.)
...
(This example is included as L<F<examples/set-fformat.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/set-fformat.pl> in the distribution.)
...
(This example is included as L<F<examples/sort.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/sort.pl> in the distribution.)
...
(This example is included as L<F<examples/type-handler.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/type-handler.pl> in the distribution.)
...
(This example is included as L<F<examples/type-handler-scalar.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/type-handler-scalar.pl> in the distribution.)
...
(This example is included as L<F<examples/escape-all.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/escape-all.pl> in the distribution.)
...
(This example is included as L<F<examples/escape-all-no-utf8.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/escape-all-no-utf8.pl> in the distribution.)
...
(This example is included as L<F<examples/hash.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/hash.pl> in the distribution.)
...
(This example is included as L<F<examples/nested-hash.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/nested-hash.pl> in the distribution.)
...
(This example is included as L<F<examples/array.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/array.pl> in the distribution.)
...
(This example is included as L<F<examples/nested-array.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/nested-array.pl> in the distribution.)
...
(This example is included as L<F<examples/nested.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/nested.pl> in the distribution.)
...
output to be valid JSON. (See L</RFC 8259>.) 
...
(This example is included as L<F<examples/weirdstring.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/weirdstring.pl> in the distribution.)
...
(This example is included as L<F<examples/strict-non-finite.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/strict-non-finite.pl> in the distribution.)
...
(This example is included as L<F<examples/undef.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/undef.pl> in the distribution.)
...
(This example is included as L<F<examples/json-parse-bool.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/json-parse-bool.pl> in the distribution.)
...
(This example is included as L<F<examples/valid-chars.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/valid-chars.pl> in the distribution.)
...
L</create> is valid UTF-8. This does not mean that output strings are
...
(This example is included as L<F<examples/json-unicode.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/json-unicode.pl> in the distribution.)
...
(This example is included as L<F<examples/json-unicode-gzip-bytes.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/json-unicode-gzip-bytes.pl> in the distribution.)
...
(This example is included as L<F<examples/user-bad-utf8.pl>|https://fastapi.metacpan.org/source/BKB/JSON-Create-0.33/examples/user-bad-utf8.pl> in the distribution.)
...
There is a benchmarking script in F<bench/bench.pl> which compares the
performance of the module with L<JSON::XS> and
L<Cpanel::JSON::XS>. Outputs look like this, where the "improve"
column is the improvement in speed of the fastest module compared to
the slowest:
...
Version 0.30 rewrote L</set> and related routines in XS and increased
the speed of the module, and added L</write_json>.

In version 0.31, the method L</run> was renamed L</create>.
...
The method C<run> was renamed L</create> in version 0.31. The old name
is not deprecated and will continue to work indefinitely.
...
L<RFC 8259 "The JavaScript Object Notation (JSON) Data Interchange Format"|https://www.ietf.org/rfc/rfc8259.txt>

=item L<JSON::Parse/SEE ALSO>

Please refer to L<JSON::Parse/SEE ALSO> for information on the
specifications for JSON and a list of other CPAN modules for JSON.

=back

=head2 Installing from the github repository

Experimentally, it is possible to install this module from Github. You
will also need to install L<Template> and possibly some other modules.
...
=item L<Muddled numbers & strings|https://benbullock.substack.com/p/muddled-numbers-and-strings>

This relates to the bug dealing with floating point and integer
numbers found in version 0.33.
