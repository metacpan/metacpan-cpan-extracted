package Benchmark::Perl::Formance::Plugin::Mandelbrot::withthreads;
our $AUTHORITY = 'cpan:SCHWIGON';
# ABSTRACT: benchmark - Generate Mandelbrot set portable bitmap file - using threads
$Benchmark::Perl::Formance::Plugin::Mandelbrot::withthreads::VERSION = '0.001';
# COMMAND LINE:
...
Benchmark::Perl::Formance::Plugin::Mandelbrot::withthreads - benchmark - Generate Mandelbrot set portable bitmap file - using threads
