package Bencher::ScenarioBundle::Graphics::ColorNames;
...
1;
# ABSTRACT: Scenarios to benchmark Graphics::ColorNames and related modules
...
Bencher::ScenarioBundle::Graphics::ColorNames - Scenarios to benchmark Graphics::ColorNames and related modules

=head1 VERSION

This document describes version 0.001 of Bencher::ScenarioBundle::Graphics::ColorNames (from Perl distribution Bencher-ScenarioBundle-Graphics-ColorNames), released on 2024-05-06.
...
=item * L<Bencher::Scenario::Graphics::ColorNames::Startup>
