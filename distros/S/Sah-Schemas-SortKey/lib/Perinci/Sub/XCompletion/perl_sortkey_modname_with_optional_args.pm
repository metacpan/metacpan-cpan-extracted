package Perinci::Sub::XCompletion::perl_sortkey_modname_with_optional_args;
...
1;
# ABSTRACT: Generate completion for SortKey::* module name with optional params
...
Perinci::Sub::XCompletion::perl_sortkey_modname_with_optional_args - Generate completion for SortKey::* module name with optional params

=head1 VERSION

This document describes version 0.001 of Perinci::Sub::XCompletion::perl_sortkey_modname_with_optional_args (from Perl distribution Sah-Schemas-SortKey), released on 2024-01-23.
