...
Sah::Schema::unix::pid - Process identifier (PID)

=head1 VERSION

This document describes version 0.020 of Sah::Schema::unix::pid (from Perl distribution Sah-Schemas-Unix), released on 2022-07-24.
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("unix::pid", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("unix::pid", {return_type=>'str_errmsg+val'});
 ...
 # a sample invalid data
 $data = -1;
 my $res = $validator->($data); # => ["Must be at least 1",-1]
