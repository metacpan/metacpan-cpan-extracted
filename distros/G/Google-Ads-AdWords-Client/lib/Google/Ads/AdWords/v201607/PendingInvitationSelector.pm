package Google::Ads::AdWords::v201607::PendingInvitationSelector;
use strict;
use warnings;
...
PendingInvitationSelector from the namespace https://adwords.google.com/api/adwords/mcm/v201607.
