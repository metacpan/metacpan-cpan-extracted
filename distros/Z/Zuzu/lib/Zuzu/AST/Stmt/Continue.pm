package Zuzu::AST::Stmt::Continue;
...
sub evaluate { $_[1]->eval_continue($_[0]) }

=pod

=head1 NAME

Zuzu::AST::Stmt::Continue - AST node for switch continue statements
...
B<< Zuzu::AST::Stmt::Continue >> is copyright Toby Inkster.
