...
my $range = $generator->number_range(55, 56);
is($range, '55|56');

is('55' =~ m?$range?, 1);


$range = $generator->number_range(55, 56, { capture => 1 });
is($range, '(55|56)');

$range = $generator->number_range(100, 1999);
is($range, '10[0-9]|1[1-9][0-9]|[2-9][0-9]{2}|1[0-9]{3}');
is(655 =~ $range, 1);

$range = $generator->number_range(100, 1999, { capture => 1 });
is($range, '(10[0-9]|1[1-9][0-9]|[2-9][0-9]{2}|1[0-9]{3})');
