...
$RDF::Cowl::NAryBool::VERSION = '1.0.0';
# CowlNAryBool
use strict;
use warnings;
...
RDF::Cowl::NAryBool - Represents ObjectIntersectionOf and ObjectUnionOf in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::NAryBool>
