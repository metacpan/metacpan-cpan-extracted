...
sub evaluate { $_[1]->eval_throw($_[0]) }

=pod

=head1 NAME

Zuzu::AST::Stmt::Throw - AST node for throw statements
...
Expression that evaluates to the thrown value.
...
B<< Zuzu::AST::Stmt::Throw >> is copyright Toby Inkster.
