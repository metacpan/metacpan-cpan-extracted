...
my %pass_numbers = (
    ...
    4 => [
        qw [0 00 000 0000 0,0000 00,0000
          1,2345,6789 12,3456,7890 123,0987,6782,1235]
    ],
    5_7 => [
        qw [0 00 000 0000 00000 000000 0000000
...
my @failures = (
    ...
    [
        "Wrong number of digits in group" => {
            ...
            5_7 => [
                qw [13,4589 1,12345678,98765 87654321,12345 123,4567,12345
                  123,456,123456]
            ],
        }
    ],
    ...
    [
        "Trailing garbage" => {
            ...
            5_7 => [
                qw [00000foo 1,234567,67890,barrr],
                "12,242424 ",
                "12,242424\n"
            ],
        }
