...
sub find_and_remove_criteria_from_shared_set {
  ...
  $paging = Google::Ads::AdWords::v201702::Paging->new({
      startIndex    => 0,
      numberResults => PAGE_SIZE
  });
  ...
  my @remove_criterion_operations =
    ...
    sub {
      ...
      if ($criterion->isa("Google::Ads::AdWords::v201702::Keyword")) {
        printf "Shared negative keyword with ID %d and text '%s' was " .
          "found.\n",
          $criterion->get_id(),
          $criterion->get_text();
      } elsif ($criterion->isa("Google::Ads::AdWords::v201702::Placement")) {
      ...
      my $shared_criterion_operation =
        Google::Ads::AdWords::v201702::SharedCriterionOperation->new({
          operator => 'REMOVE',
          operand  => Google::Ads::AdWords::v201702::SharedCriterion->new({
              criterion => Google::Ads::AdWords::v201702::Criterion->new(
                {id => $criterion->get_id()}
              ),
