...
This document describes version 0.050 of Sah::Schema::perl::pod_or_pm_filename (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
=head1 SAH SCHEMA DEFINITION
 ...
 [
   "str",
   {
     ...
     "x.perl.coerce_rules" => ["From_str::convert_perl_pod_or_pm_to_path"],
   },
 ]

Base type: L<str|Data::Sah::Type::str>

Used completion: L<CODE(0x55f26111ab38)|Perinci::Sub::XCompletion::CODE(0x55f26111ab38)>
