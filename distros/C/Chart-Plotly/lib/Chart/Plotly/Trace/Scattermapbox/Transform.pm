package Chart::Plotly::Trace::Scattermapbox::Transform;
use Moose;
...
Chart::Plotly::Trace::Scattermapbox::Transform - This attribute is one of the possible options for the trace scattermapbox.
