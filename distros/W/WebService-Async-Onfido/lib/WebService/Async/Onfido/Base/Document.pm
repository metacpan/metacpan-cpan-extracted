package WebService::Async::Onfido::Base::Document;
...
WebService::Async::Onfido::Base::Document - represents data for Onfido
...
sub type : method { return shift->{type} }
...
sub side : method { return shift->{side} }

=head2 issuing_country

The issuing country of the document, in 3-letter ISO code, specified when uploading it..

=cut

sub issuing_country : method { return shift->{issuing_country} }
