...
Data::Sah::Filter::perl::Str::uppercase - Convert string to uppercase (synonym for uc)

=head1 VERSION

This document describes version 0.015 of Data::Sah::Filter::perl::Str::uppercase (from Perl distribution Data-Sah-Filter), released on 2022-10-18.

=head1 SYNOPSIS

=head2 Using in Sah schema's C<prefilters> (or C<postfilters>) clause

 ["str","prefilters",[["Str::uppercase"]]]

=head2 Using with L<Data::Sah>:

 use Data::Sah qw(gen_validator);
 
 my $schema = ["str","prefilters",[["Str::uppercase"]]];
...
=head2 Using with L<Data::Sah:Filter> directly:
 ...
 my $filter = gen_filter([["Str::uppercase"]]);
