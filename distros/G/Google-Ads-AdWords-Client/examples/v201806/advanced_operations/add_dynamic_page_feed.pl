...
use Google::Ads::AdWords::v201806::PageFeed;
...
sub _create_feed {
  ...
  #  Create attributes.
  my $url_attribute = Google::Ads::AdWords::v201806::FeedAttribute->new({
    type => "URL_LIST",
    name => "Page URL"
  });

  my $label_attribute = Google::Ads::AdWords::v201806::FeedAttribute->new({
    type => "STRING_LIST",
    name => "Label"
  });

  # Create the feed.
  my $dsa_page_feed = Google::Ads::AdWords::v201806::Feed->new({
...
sub _update_campaign_dsa_setting {
  ...
  # Dynamic Search Ads.
  my $page_feed = Google::Ads::AdWords::v201806::PageFeed->new({
  ...
  my $updated_campaign = Google::Ads::AdWords::v201806::Campaign->new({
      id       => $campaign_id,
...
sub _add_dsa_targeting {
  ...
  my $condition = Google::Ads::AdWords::v201806::WebpageCondition->new({
    operand  => "CUSTOM_LABEL",
    argument => $dsa_page_url_label
  });

  # Create a webpage criterion for special offers.
  my $parameter = Google::Ads::AdWords::v201806::WebpageParameter->new({
