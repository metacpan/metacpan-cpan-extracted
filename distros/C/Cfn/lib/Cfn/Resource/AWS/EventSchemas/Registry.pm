  ...
  from 'HashRef',
   via {
     if (my $f = Cfn::TypeLibrary::try_function($_)) {
       ...
       return Cfn::Resource::Properties::Object::AWS::EventSchemas::Registry::TagsEntry->new( %$_ );
     }
   };

package Cfn::Resource::Properties::Object::AWS::EventSchemas::Registry::TagsEntry {
  use Moose;
