package Google::Ads::AdWords::v201806::DateSpecificRuleUserList;
use strict;
use warnings;
...
Google::Ads::AdWords::v201806::DateSpecificRuleUserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DateSpecificRuleUserList from the namespace https://adwords.google.com/api/adwords/rm/v201806.
