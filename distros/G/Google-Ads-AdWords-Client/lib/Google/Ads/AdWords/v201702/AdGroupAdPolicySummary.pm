package Google::Ads::AdWords::v201702::AdGroupAdPolicySummary;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'reviewState' => 'Google::Ads::AdWords::v201702::PolicySummaryReviewState',
        'denormalizedStatus' => 'Google::Ads::AdWords::v201702::PolicySummaryDenormalizedStatus',
        'combinedApprovalStatus' => 'Google::Ads::AdWords::v201702::PolicyApprovalStatus',
    },
    {
...
AdGroupAdPolicySummary from the namespace https://adwords.google.com/api/adwords/cm/v201702.
