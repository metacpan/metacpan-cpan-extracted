#   - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#
#   file: lib/Software/License/GPL_3/or_later.pm
#
...
#pod =for :this This is C<Software::License::GPL_3::or_later> module documentation. Read this if you
...
#pod     $lic->name;     # 'The GNU General Public License version 3 or later'
#pod
#pod     $lic->notice;
...
#pod
#pod     # …and other methods inherited from Software::License::GPL_3
#pod     # and Software::License.
#pod
#pod =head1 DESCRIPTION
#pod
#pod C<Software::License::GPL_3::or_later> is a subclass of C<Software::License::GPL_3>.
...
# ABSTRACT: GPLv3+ license for Software::License infrastructure
...
sub base {
    ...
    if ( not $self->{ base } ) {
        ...
        $self->{ base } = Software::License::GPL_3->new( \%base );
    };
    return $self->{ base };
};
...
Software::License::GPL_3::or_later - GPLv3+ license for Software::License infrastructure
...
This is C<Software::License::GPL_3::or_later> module documentation. Read this if you
...
=head1 SYNOPSIS
    ...
    $lic->name;     # 'The GNU General Public License version 3 or later'
    ...
    # …and other methods inherited from Software::License::GPL_3
    # and Software::License.

=head1 DESCRIPTION

C<Software::License::GPL_3::or_later> is a subclass of C<Software::License::GPL_3>.
