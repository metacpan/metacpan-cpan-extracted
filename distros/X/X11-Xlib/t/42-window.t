...
subtest properties => sub {
    ...
    is( $win->get_decoded_property($netwmname), "HelloAgain", 'correct title via get_decoded_property' );
    is( $win->get_decoded_property('_NET_WM_NAME'), 'HelloAgain', 'correct title using symbolic atom' );
...
is( $root2,  RootWindow($dpy), 'XQueryTree - root' );
