#
# Test case for WebService::Recruit::Eyeco::Item
#
...
my $service = new WebService::Recruit::Eyeco::Item();

ok( ref $service, 'new WebService::Recruit::Eyeco::Item()' );
...
# Test[0]
{
    ...
    my $res = new WebService::Recruit::Eyeco::Item();
