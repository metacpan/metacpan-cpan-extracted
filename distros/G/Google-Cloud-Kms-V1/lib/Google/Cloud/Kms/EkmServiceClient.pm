package Google::Cloud::Kms::EkmServiceClient;
...
sub list_ekm_connections {
    ...
    my $request_class = 'Google::Cloud::Kms::V1::EkmService::ListEkmConnectionsRequest';
    my $request = eval { $request_class->new(\%params) } || eval { $request_class->new(%params) } || ($request_class->can('encode') ? $request_class->encode(\%params) : \%params);

    my $response_class = 'Google::Cloud::Kms::V1::EkmService::ListEkmConnectionsResponse';
...
1; # End of Google::Cloud::Kms::EkmServiceClient

__END__

=head1 NAME

Google::Cloud::Kms::EkmServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Kms::EkmServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Kms::EkmServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Kms::EkmServiceClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Kms::EkmServiceClient->new(
...
=item * B<list_ekm_connections>

Calls the RPC method C<ListEkmConnections> on the service. Takes a hash of parameters representing the request.
