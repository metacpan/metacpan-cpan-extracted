...
$Search::Elasticsearch::Client::0_90::Async::Bulk::VERSION = '5.02';
use Moo;
...
Search::Elasticsearch::Client::0_90::Async::Bulk - A helper module for the Bulk API and for reindexing
