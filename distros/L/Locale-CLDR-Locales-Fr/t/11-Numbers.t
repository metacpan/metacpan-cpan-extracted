...
is_deeply([$locale->get_digits], [0 .. 9], 'Get digits fr');
...
# RBNF
is($locale->format_number(0, 'spellout-numbering-year'), 'zéro', 'RBNF: Spell out year 0');
is($locale->format_number('-0.0', 'spellout-numbering'), 'moins zéro virgule zéro', 'RBNF: Spell out -0.0');
