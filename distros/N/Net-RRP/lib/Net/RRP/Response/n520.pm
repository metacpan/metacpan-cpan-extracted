package Net::RRP::Response::n520;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n520::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n520::VERSION = '0.1';
...
Net::RRP::Response::n520 - the 520 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
