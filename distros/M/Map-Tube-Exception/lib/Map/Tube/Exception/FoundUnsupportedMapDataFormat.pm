...
$Map::Tube::Exception::FoundUnsupportedMapDataFormat::VERSION = '3.15';
=head1 NAME
...
has status => (is => 'ro', default => sub { 125 });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Map::Tube::Exception::FoundUnsupportedMapDataFormat
...
1; # End of Map::Tube::Exception::FoundUnsupportedMapDataFormat
