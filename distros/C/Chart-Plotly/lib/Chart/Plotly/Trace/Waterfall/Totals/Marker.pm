package Chart::Plotly::Trace::Waterfall::Totals::Marker;
use Moose;
...
has line => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Waterfall::Totals::Marker::Line", );
...
Chart::Plotly::Trace::Waterfall::Totals::Marker - This attribute is one of the possible options for the trace waterfall.
