...
# 1
    ...
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; mb::eval(q{ open FILE,">5006.ƒ\"; print FILE 'A'; close FILE; }) },
    sub { mb::eval(q{ unlink "5006.A";  }) },
    sub {1}, # sub { return 'SKIP' unless $MSWin32_MBCS; mb::eval(q{ unlink "5006.ƒ\"; }) },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
