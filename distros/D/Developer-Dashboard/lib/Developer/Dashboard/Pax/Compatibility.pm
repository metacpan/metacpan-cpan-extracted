...
Developer::Dashboard::Pax::Compatibility - compatibility comparator for native-versus-Perl behavior

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::Compatibility;

  my $obj = Developer::Dashboard::Pax::Compatibility->new(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::Compatibility -e 1
