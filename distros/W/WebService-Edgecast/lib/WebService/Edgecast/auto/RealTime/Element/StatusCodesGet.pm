...
package WebService::Edgecast::auto::RealTime::Element::StatusCodesGet;
BEGIN {
  $WebService::Edgecast::auto::RealTime::Element::StatusCodesGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('StatusCodesGet');
...
WebService::Edgecast::auto::RealTime::Element::StatusCodesGet
...
StatusCodesGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::RealTime::Element::StatusCodesGet->new($data);
