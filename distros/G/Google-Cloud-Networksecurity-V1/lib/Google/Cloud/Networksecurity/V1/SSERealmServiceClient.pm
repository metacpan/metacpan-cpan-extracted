package Google::Cloud::Networksecurity::V1::SSERealmServiceClient;
...
1; # End of Google::Cloud::Networksecurity::V1::SSERealmServiceClient

__END__

=head1 NAME

Google::Cloud::Networksecurity::V1::SSERealmServiceClient - Client library for Google Cloud Services

=head1 SYNOPSIS

    use Google::Cloud::Networksecurity::V1::SSERealmServiceClient;
    use Google::Auth;

    my $auth = Google::Auth->default();

    # 1. High-performance gRPC Transport (Default)
    my $grpc_client = Google::Cloud::Networksecurity::V1::SSERealmServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Networksecurity::V1::SSERealmServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Networksecurity::V1::SSERealmServiceClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Networksecurity::V1::SSERealmServiceClient->new(
