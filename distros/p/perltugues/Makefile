...
#     VERSION_FROM => q[lib/perltugues.pm]
#     clean => { FILES=>q[perltugues-*] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/perltugues.pm \
	lib/perltugues/caracter.pm \
	lib/perltugues/inteiro.pm \
	lib/perltugues/real.pm \
	lib/perltugues/texto.pm \
	lib/perltugues/tipo.pm
...
PM_TO_BLIB = lib/perltugues/inteiro.pm \
	blib/lib/perltugues/inteiro.pm \
	lib/perltugues/texto.pm \
	blib/lib/perltugues/texto.pm \
	lib/perltugues/tipo.pm \
	blib/lib/perltugues/tipo.pm \
	lib/perltugues/real.pm \
	blib/lib/perltugues/real.pm \
	lib/perltugues.pm \
	blib/lib/perltugues.pm \
	lib/perltugues/caracter.pm \
	blib/lib/perltugues/caracter.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/perltugues/inteiro.pm $(INST_MAN3DIR)/perltugues::inteiro.$(MAN3EXT) \
	  lib/perltugues/texto.pm $(INST_MAN3DIR)/perltugues::texto.$(MAN3EXT) \
	  lib/perltugues/tipo.pm $(INST_MAN3DIR)/perltugues::tipo.$(MAN3EXT) \
	  lib/perltugues/real.pm $(INST_MAN3DIR)/perltugues::real.$(MAN3EXT) \
	  lib/perltugues.pm $(INST_MAN3DIR)/perltugues.$(MAN3EXT) \
	  lib/perltugues/caracter.pm $(INST_MAN3DIR)/perltugues::caracter.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '    Filter::Simple:  0' >> META_new.yml
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  lib/perltugues/tipo.pm blib/lib/perltugues/tipo.pm \
	  lib/perltugues/real.pm blib/lib/perltugues/real.pm \
	  lib/perltugues.pm blib/lib/perltugues.pm \
	  lib/perltugues/caracter.pm blib/lib/perltugues/caracter.pm 
