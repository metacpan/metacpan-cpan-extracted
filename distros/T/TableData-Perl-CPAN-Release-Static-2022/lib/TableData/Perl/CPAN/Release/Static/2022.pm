package ## no critic: Modules::RequireFilenameMatchesPackage
    # hide from PAUSE
    TableDataRole::Perl::CPAN::Release::Static::2022;
...
around new => sub {
    ...
    my $filename = File::Basename::dirname(__FILE__) . '/../../../../../../share/2022.csv';
    unless (-f $filename) {
        require File::ShareDir;
        $filename = File::ShareDir::dist_file('TableData-Perl-CPAN-Release-Static-2022', '2022.csv');
    }
    $orig->(@_, filename=>$filename);
};

package TableData::Perl::CPAN::Release::Static::2022;
...
TableDataRole::Perl::CPAN::Release::Static::2022 - CPAN releases for the year 2022
...
To use from Perl code:
 ...
 use TableData::Perl::CPAN::Release::Static::2022;

 my $td = TableData::Perl::CPAN::Release::Static::2022->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Perl::CPAN::Release::Static::2022 --page
...
Please visit the project's homepage at L<https://metacpan.org/release/TableData-Perl-CPAN-Release-Static-2022>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-TableData-Perl-CPAN-Release-Static-2022>.
...
Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=TableData-Perl-CPAN-Release-Static-2022>
