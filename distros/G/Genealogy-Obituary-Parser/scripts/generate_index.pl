...
<html>
	<head>
	<title>Genealogy::Obituary::Parser Coverage Report</title>
	<style>
...
<body>
<div class="badges">
	<a href="https://github.com/nigelhorne/Genealogy-Obituary-Parser">
		<img src="https://img.shields.io/github/stars/nigelhorne/Genealogy-Obituary-Parser?style=social" alt="GitHub stars">
	</a>
	<img src="$coverage_badge_url" alt="Coverage badge">
</div>
<h1>Genealogy::Obituary::Parser</h1><h2>Coverage Report</h2>
...
chomp $commit_sha;
my $github_base = "https://github.com/nigelhorne/Genealogy-Obituary-Parser/blob/$commit_sha/";
...
Readonly my $commit_url => "https://github.com/nigelhorne/Genealogy-Obituary-Parser/commit/$commit_sha";
...
foreach my $file (reverse sort @history_files) {
	...
	my $url = "https://github.com/nigelhorne/Genealogy-Obituary-Parser/commit/$sha";
...
push @html, <<"HTML";
<footer>
	<p>Project: <a href="https://github.com/nigelhorne/Genealogy-Obituary-Parser">Genealogy-Obituary-Parser</a></p>
