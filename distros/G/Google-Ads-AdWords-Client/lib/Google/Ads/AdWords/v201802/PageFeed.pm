package Google::Ads::AdWords::v201802::PageFeed;
use strict;
use warnings;
...
Google::Ads::AdWords::v201802::PageFeed

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PageFeed from the namespace https://adwords.google.com/api/adwords/cm/v201802.
