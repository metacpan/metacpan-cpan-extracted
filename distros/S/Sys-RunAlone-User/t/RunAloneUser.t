...
$ok = 0;
$command = "| SKIP_SYS_RUNALONE_USER=0 $^X -I$INC[-1] script 2>2";
...
$ok = 0;
$command = "| SKIP_SYS_RUNALONE_USER=1 $^X -I$INC[-1] script 2>2";
