...
#
#
#   $Id: OrderedList.pm,v 2.0 2005/11/16 02:16:00 areibens Exp $
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::TTF::Kern::OrderedList;

=head1 NAME

PDF::API3::Compat::API2::Basic::TTF::Kern::OrderedList
...
@ISA = qw(PDF::API3::Compat::API2::Basic::TTF::Kern::Subtable);
