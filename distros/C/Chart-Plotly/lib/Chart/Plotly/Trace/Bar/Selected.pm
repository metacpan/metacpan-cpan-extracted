package Chart::Plotly::Trace::Bar::Selected;
use Moose;
...
has marker => ( is  => "rw",
                isa => "Maybe[HashRef]|Chart::Plotly::Trace::Bar::Selected::Marker", );

has textfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Bar::Selected::Textfont", );
...
Chart::Plotly::Trace::Bar::Selected - This attribute is one of the possible options for the trace bar.
