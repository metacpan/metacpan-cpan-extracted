package Net::Amazon::IAM::Roles;
use Moose;

=head1 NAME

Net::Amazon::IAM::Roles

=head1 DESCRIPTION

A class representing a IAM Roles list.
...
request using the Marker request parameter to retrieve more roles in the list.
...
has 'Roles' => (
   is       => 'ro',
   isa      => 'Maybe[ArrayRef[Net::Amazon::IAM::Role]]',
   required => 0,
);
