...
IO::K8s::ExternalSecrets::V1::BarbicanProviderPasswordRef - BarbicanProviderPasswordRef defines a reference to a secret containing password for the Barbican provider.
