package Bio::VertRes::Config::Recipes::EukaryotesRnaSeqExpressionUsingBowtie2;
...
Bio::VertRes::Config::Recipes::EukaryotesRnaSeqExpressionUsingBowtie2 - Standard snp calling pipeline for bacteria
...
RNA seq expression with Bowtie2
   ...
   my $obj = Bio::VertRes::Config::Recipes::EukaryotesRnaSeqExpressionUsingBowtie2->new( 
     database => 'abc', 
