package Chart::Plotly::Trace::Carpet::Baxis::Title::Font;
use Moose;
...
Chart::Plotly::Trace::Carpet::Baxis::Title::Font - This attribute is one of the possible options for the trace carpet.
