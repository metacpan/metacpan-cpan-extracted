...
$Consul::API::Agent::VERSION = '0.026';
...
$Consul::API::Agent::Check::VERSION = '0.026';
use Moo;
use Types::Standard qw(Str);
...
$Consul::API::Agent::Service::VERSION = '0.026';
use Moo;
...
$Consul::API::Agent::Member::VERSION = '0.026';
use Moo;
...
$Consul::API::Agent::Self::VERSION = '0.026';
use Moo;
