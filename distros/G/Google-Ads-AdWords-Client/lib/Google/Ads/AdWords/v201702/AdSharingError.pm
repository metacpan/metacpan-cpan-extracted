package Google::Ads::AdWords::v201702::AdSharingError;
use strict;
use warnings;
...
my %sharedAdError_of :ATTR(:get<sharedAdError>);
...
__PACKAGE__->_factory(
    ...
    ) ],
    {
        ...
        'reason' => \%reason_of,
        'sharedAdError' => \%sharedAdError_of,
    },
    {
        ...
        'reason' => 'Google::Ads::AdWords::v201702::AdSharingError::Reason',
        'sharedAdError' => 'Google::Ads::AdWords::v201702::ApiError',
    },
    {
...
AdSharingError from the namespace https://adwords.google.com/api/adwords/cm/v201702.

Errors related using the AdGroupAdService to create an AdGroupAd with a reference to an existing AdId. 
