...
IO::K8s::ExternalSecrets::V1alpha1::ClusterPushSecretNamespaceFailure - ClusterPushSecretNamespaceFailure represents a failed namespace deployment and it's reason.
