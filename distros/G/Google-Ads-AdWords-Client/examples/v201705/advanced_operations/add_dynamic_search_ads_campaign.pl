...
use Google::Ads::AdWords::v201705::DynamicSearchAdsSetting;
use Google::Ads::AdWords::v201705::ExpandedDynamicSearchAd;
use Google::Ads::AdWords::v201705::Money;
use Google::Ads::AdWords::v201705::Webpage;
use Google::Ads::AdWords::v201705::WebpageCondition;
use Google::Ads::AdWords::v201705::WebpageParameter;
...
sub _create_budget() {
  ...
  my $shared_budget = Google::Ads::AdWords::v201705::Budget->new({
...
sub _add_web_page_criteria {
  ...
  my $url_condition = Google::Ads::AdWords::v201705::WebpageCondition->new({
    operand  => "URL",
    argument => "/specialoffers"
  });

  my $title_condition = Google::Ads::AdWords::v201705::WebpageCondition->new({
    operand  => "PAGE_TITLE",
    argument => "Special Offer"
  });

  # Create a webpage criterion for special offers.
  my $param = Google::Ads::AdWords::v201705::WebpageParameter->new({
