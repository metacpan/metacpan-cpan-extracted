package Carrot::Continuity::Coordination::Episode::Target::Generic
# /type class
# //parent_classes
...
# /capability ""
{
	...
	$expressiveness->class_names->provide_instance(
		my $source = '[=project_pkg=]::Source::Generic');

	my $default_name = 'evt_generic';
...
# //returns
{
	my ($this, $that, $name) = @ARGUMENTS;

	my $callback = $this->create_callback($that, $default_name, $name);
	@$this = ($that, $callback, IS_UNDEFINED, IS_FALSE, IS_UNDEFINED);
	return;
}
