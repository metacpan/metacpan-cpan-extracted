...
$Shipment::UPS::WSDL::ShipElements::ShipConfirmRequest::VERSION = '3.11';
use strict;
use warnings;
...
ShipConfirmRequest from the namespace http://www.ups.com/XMLSchema/XOLTWS/Ship/v1.0.
...
=head2 new
 ...
 my $element = Shipment::UPS::WSDL::ShipElements::ShipConfirmRequest->new($data);
