package Chart::Plotly::Trace::Histogram2d::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Histogram2d::Legendgrouptitle::Font - This attribute is one of the possible options for the trace histogram2d.
