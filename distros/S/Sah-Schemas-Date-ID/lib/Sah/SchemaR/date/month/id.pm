...
Sah::SchemaR::date::month::id - Month number/name (abbreviated or full, in Indonesian), e.g. 1 or "Jan" or "Maret"

=head1 VERSION

This document describes version 0.008 of Sah::SchemaR::date::month::id (from Perl distribution Sah-Schemas-Date-ID), released on 2022-10-20.
