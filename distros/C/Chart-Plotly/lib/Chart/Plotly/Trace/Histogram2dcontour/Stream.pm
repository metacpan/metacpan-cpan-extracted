package Chart::Plotly::Trace::Histogram2dcontour::Stream;
use Moose;
...
Chart::Plotly::Trace::Histogram2dcontour::Stream - This attribute is one of the possible options for the trace histogram2dcontour.
