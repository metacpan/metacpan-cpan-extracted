...
# ABSTRACT: Perl API for HashiCorp's Vault (PostgreSQL)
...
package WebService::HashiCorp::Vault::Secret::PostgreSQL;
...
has '+mount'  => ( is => 'ro', default => 'postgresql' );
...
The PostgreSQL Secret Backend handling for HashiCorps Vault server software.
