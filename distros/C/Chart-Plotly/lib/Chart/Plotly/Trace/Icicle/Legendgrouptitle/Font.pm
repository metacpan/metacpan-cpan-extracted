package Chart::Plotly::Trace::Icicle::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Icicle::Legendgrouptitle::Font - This attribute is one of the possible options for the trace icicle.
