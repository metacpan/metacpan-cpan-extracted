...
=head1 SYNOPSIS
  ...
  $rngschema = XML::LibXML::RelaxNG-E<gt>new( location =E<gt> $filename_or_url );
  $rngschema = XML::LibXML::RelaxNG-E<gt>new( string =E<gt> $xmlschemastring );
  $rngschema = XML::LibXML::RelaxNG-E<gt>new( DOM =E<gt> $doc );
  eval { $rngschema-E<gt>validate( $doc ); };
