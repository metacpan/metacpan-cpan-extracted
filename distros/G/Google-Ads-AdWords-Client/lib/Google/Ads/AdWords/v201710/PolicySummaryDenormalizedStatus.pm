package Google::Ads::AdWords::v201710::PolicySummaryDenormalizedStatus;
use strict;
use warnings;
...
PolicySummaryDenormalizedStatus from the namespace https://adwords.google.com/api/adwords/cm/v201710.
