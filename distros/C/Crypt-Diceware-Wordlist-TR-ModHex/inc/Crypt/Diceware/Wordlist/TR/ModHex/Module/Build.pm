...
package Crypt::Diceware::Wordlist::TR::ModHex::Module::Build v0.0.2;
...
use parent 'Crypt::Diceware::Wordlist::TR::ModHex::Module::Build::Standard';
...
Crypt::Diceware::Wordlist::TR::ModHex::Module::Build - Customization of
L<Module::Build> for L<Crypt::Diceware::Wordlist::TR::ModHex>.

=head1 DESCRIPTION

This is a custom subclass of L<Module::Build> (actually,
L<Crypt::Diceware::Wordlist::TR::ModHex::Module::Build::Standard>) that enhances
existing functionality and adds more for the benefit of installing and
developing L<Crypt::Diceware::Wordlist::TR::ModHex>.  The following actions have
