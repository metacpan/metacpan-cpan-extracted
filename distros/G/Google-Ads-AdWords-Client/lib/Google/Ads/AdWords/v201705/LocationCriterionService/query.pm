...
package Google::Ads::AdWords::v201705::LocationCriterionService::query;
use strict;
use warnings;
...
query from the namespace https://adwords.google.com/api/adwords/cm/v201705.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::LocationCriterionService::query->new($data);
