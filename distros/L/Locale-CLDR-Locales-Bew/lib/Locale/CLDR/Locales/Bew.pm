	...
	default		=> sub {
		{
			'001' => 'Dunia',
 			...
 			'UA' => 'Ukrain',
 			'UG' => 'Uganda',
 			'UM' => 'Kepuloan Mentil AS Luar',
 			'UN' => 'Peserèkatan Bangsa-Bangsa',
 			'US' => 'Amrik Serèkat',
 			'US@alt=short' => 'AS',
 			'UY' => 'Urugué',
 			'UZ' => 'Usbèkistan',
	...
	default		=> sub {
		{
			'1901' => 'èjaan Dèt Terdisionil',
 			...
 			'1606NICT' => 'Prasman Tenga Akir ampé 1606',
 			'1694ACAD' => 'Prasman Modèren Awal',
 			'1959ACAD' => 'Akademi',
 			'ABL1943' => 'Rancangan èjaan tahon 1943',
 			'AKUAPEM' => 'Akuapèm',
 			'ALALC97' => 'Penglatènan ALA-LC tahon 1997',
 			'ALUKU' => 'logat Aluku',
 			...
 			'FONIPA' => 'Hurup Pengucapan Antérobangsa',
 			'FONKIRSH' => 'Hurup Pengucapan Kirshenbaum',
 			'FONNAPA' => 'Hurup Pengucapan Amrik Lor',
 			'FONUPA' => 'Hurup Pengucapan Ural',
 			'FONXSAMP' => 'Hurup Pengucapan X-SAMPA',
 			'GASCON' => 'Gaskon',
 			'GRCLASS' => 'Èjaan Oksitan Klasik',
 			'GRITAL' => 'Èjaan Oksitan Keitalian',
 			'GRMISTR' => 'Èjaan Oksitan Mistral',
 			'HEPBURN' => 'penglatènan Hepburn',
 			'HOGNORSK' => 'Nor Tinggi',
 			'HSISTEMO' => 'Sistim Èjaan H Sepèranto',
 			'IJEKAVSK' => 'Sèrwi paké lapal Iyèkawia',
 			'IVANCHOV' => 'Èjaan Bulgari tahon 1899',
 			'JAUER' => 'Jawer',
 			'JYUTPING' => 'Penglatènan Jyutping',
 			'KKCOR' => 'Èjaan Umum',
 			'KOCIEWIE' => 'Kociéwié',
 			'KSCOR' => 'Èjaan Pakem',
 			'LEMOSIN' => 'Limosin',
 			...
 			'ULSTER' => 'Èjaan Ulster',
 			'UNIFON' => 'Hurup Pengucapan Unifon',
 			'VAIDIKA' => 'Cara Wéda',
 			'VALENCIA' => 'Balènsi',
 			'VALLADER' => 'Waladèr',
 			'VIVARAUP' => 'Wiwaro-Alpen',
 			'WADEGILE' => 'Penglatènan Wade-Giles',
 			'XSISTEMO' => 'Sistim Èjaan X Sepèranto',
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'Etc/UTC' => {
			long => {
				'standard' => q#Waktu Kabèhan Ragem#,
			},
		},
		'Etc/Unknown' => {
