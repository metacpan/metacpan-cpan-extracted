...
package Google::Ads::AdWords::v201607::CampaignService::mutateLabel;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201607::CampaignLabelOperation',
    },
    {
...
mutateLabel from the namespace https://adwords.google.com/api/adwords/cm/v201607.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201607::CampaignService::mutateLabel->new($data);

Constructor. The following data structure may be passed to new():

 {
   operations =>  $a_reference_to, # see Google::Ads::AdWords::v201607::CampaignLabelOperation
 },
