	...
	default		=> sub {
		{
			'calendar' => {
 			...
 			'collation' => {
 				...
 				'standard' => q{Стандарттуу иргөө тартиби},
 			},
 			'hc' => {
 			...
 			'ms' => {
 				...
 				'ussystem' => q{АКШнын өлчөө тутуму},
 			},
 			'numbers' => {
...
has 'units' => (
	...
	default		=> sub { {
				'long' => {
					...
					'mile-per-hour' => {
						'name' => q(милине саат),
						'one' => q(саатына {0} миль),
						'other' => q(саатына {0} миль),
					},
					'mile-scandinavian' => {
						'name' => q(smi),
						'one' => q({0} smi),
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'Australia_Central' => {
			long => {
				'daylight' => q(Австралия борбордук күндүзгү убактысы),
		...
		'Australia_CentralWestern' => {
			long => {
				'daylight' => q(Австралия борбордук чыгыш күндүзгү убактысы),
		...
		'Australia_Eastern' => {
			long => {
				'daylight' => q(Австралия чыгыш күндүзгү убактысы),
		...
		'Australia_Western' => {
			long => {
				'daylight' => q(Австралия батыш күндүзгү убактысы),
		...
		'Chatham' => {
			long => {
				'daylight' => q(Чатам күндүзгү убактысы),
		...
		'China' => {
			long => {
				'daylight' => q(Кытай күндүзгү убактысы),
		...
		'Europe/Dublin' => {
			...
			long => {
				'daylight' => q(Ирландия стандарттык убакыты),
			},
		},
		'Europe/Gibraltar' => {
		...
		'Hong_Kong' => {
			long => {
				...
				'standard' => q(Гонконг стандарт убактысы),
			},
		},
		'Hovd' => {
			long => {
		...
		'Israel' => {
			long => {
				'daylight' => q(Израил күндүзгү убакыты),
		...
		'Japan' => {
			long => {
				'daylight' => q(Жапан күндүзгү убактысы),
		...
		'Korea' => {
			long => {
				'daylight' => q(Корея күндүзгү убактысы),
		...
		'Lord_Howe' => {
			long => {
				'daylight' => q(Лорд Хау күндүзгү убактысы),
		...
		'New_Zealand' => {
			long => {
				'daylight' => q(Жаңы Зеландия күндүзгү убактысы),
		...
		'Philippines' => {
			long => {
				...
				'standard' => q(Филиппин аралдарынын стандарт убактысы),
			},
		},
		'Phoenix_Islands' => {
			long => {
		...
		'Taipei' => {
			long => {
				'daylight' => q(Тайпей күндүзгү убактысы),
