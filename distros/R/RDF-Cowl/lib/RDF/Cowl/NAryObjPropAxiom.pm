...
$RDF::Cowl::NAryObjPropAxiom::VERSION = '1.0.0';
...
RDF::Cowl::NAryObjPropAxiom - Represents an EquivalentObjectProperties or DisjointObjectProperties axiom in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::NAryObjPropAxiom>
