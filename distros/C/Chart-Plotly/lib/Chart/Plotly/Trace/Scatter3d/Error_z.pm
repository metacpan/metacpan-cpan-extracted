package Chart::Plotly::Trace::Scatter3d::Error_z;
use Moose;
...
Chart::Plotly::Trace::Scatter3d::Error_z - This attribute is one of the possible options for the trace scatter3d.
