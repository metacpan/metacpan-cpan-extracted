...
eval q{
    use maybe 'maybe::Test1' => 123;
};
is( $@, '',                                              'use maybe "maybe::Test1" => 123 succeed' );
