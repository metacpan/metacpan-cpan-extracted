package Chart::Plotly::Trace::Funnelarea::Textfont;
use Moose;
...
Chart::Plotly::Trace::Funnelarea::Textfont - This attribute is one of the possible options for the trace funnelarea.
