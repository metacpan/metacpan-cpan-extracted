# This Makefile is for the Finance::Bank::CreateCard extension to perl.
#
...
#	ABSTRACT_FROM => q[CreateCard.pm]
#	AUTHOR => q[Robert J. McKay <robert@mckay.com>]
#	NAME => q[Finance::Bank::CreateCard]
#	PREREQ_PM => {  }
#	VERSION_FROM => q[CreateCard.pm]
...
DISTNAME = Finance-Bank-CreateCard
NAME_SYM = Finance_Bank_CreateCard
VERSION = 1.03
VERSION_SYM = 1_03
XS_VERSION = 1.03
INST_BIN = blib/bin
...
FULLEXT = Finance/Bank/CreateCard
BASEEXT = CreateCard
PARENT_NAME = Finance::Bank
DLBASE = $(BASEEXT)
VERSION_FROM = CreateCard.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Finance/Bank
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Finance/Bank
...
TO_INST_PM = CreateCard.pm

PM_TO_BLIB = CreateCard.pm \
	$(INST_LIBDIR)/CreateCard.pm
...
manifypods : pure_all CreateCard.pm
	@$(POD2MAN) \
	CreateCard.pm \
	$(INST_MAN3DIR)/Finance::Bank::CreateCard.$(MAN3EXT)
...
Build :: Build.PL
	$(PERL) -I$(INST_ARCHLIB) -I$(INST_LIB) -I$(PERL_ARCHLIB) -I$(PERL_LIB) Build.PL Build
...
realclean purge ::  clean
	...
	rm -f  $(INST_LIBDIR)/CreateCard.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Finance-Bank-CreateCard\" VERSION=\"1,03,0,0\">\n}. qq{\t<TITLE>Finance-Bank-CreateCard</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR>Robert J. McKay &lt;robert\@mckay.com&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Finance-Bank-CreateCard.ppd
