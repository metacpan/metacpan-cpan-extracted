...
IO::K8s::Api::Scheduling::V1alpha3::WorkloadReference - WorkloadReference references the Workload object together with the template that was used to create a particular PodGroup.
