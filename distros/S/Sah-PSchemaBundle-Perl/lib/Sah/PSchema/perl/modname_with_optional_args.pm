...
our $DIST = 'Sah-PSchemaBundle-Perl'; # DIST
...
This document describes version 0.011 of Sah::PSchema::perl::modname_with_optional_args (from Perl distribution Sah-PSchemaBundle-Perl), released on 2024-05-30.
...
Please visit the project's homepage at L<https://metacpan.org/release/Sah-PSchemaBundle-Perl>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Sah-PSchemaBundle-Perl>.
...
Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=Sah-PSchemaBundle-Perl>
