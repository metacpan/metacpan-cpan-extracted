...
is_deeply([$locale->get_digits], [0 .. 9], 'Get digits da');
...
# RBNF
is($locale->format_number(0, 'spellout-numbering-year'), 'nul', 'RBNF: Spell out year 0');
is($locale->format_number('-0.0', 'spellout-numbering'), 'minus nul komma nul', 'RBNF: Spell out -0.0');
