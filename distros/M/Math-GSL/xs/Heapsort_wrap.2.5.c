...
#define SWIGTYPE_p_f_p_q_const__void_p_q_const__void__int swig_types[4]
...
#define SWIG_init    boot_Math__GSL__Heapsort

#define SWIG_name   "Math::GSL::Heapsortc::boot_Math__GSL__Heapsort"
#define SWIG_prefix "Math::GSL::Heapsortc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_Math__GSL__Heapsort_var::
class _wrap_Math__GSL__Heapsort_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_gsl_heapsort) {
  {
    void *arg1 = (void *) 0 ;
    size_t arg2 ;
    size_t arg3 ;
    gsl_comparison_fn_t arg4 = (gsl_comparison_fn_t) 0 ;
    int res1 ;
    size_t val2 ;
    int ecode2 = 0 ;
    size_t val3 ;
    ...
    if ((items < 4) || (items > 4)) {
      SWIG_croak("Usage: gsl_heapsort(array,count,size,compare);");
    }
    res1 = SWIG_ConvertPtr(ST(0),SWIG_as_voidptrptr(&arg1), 0, 0);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "gsl_heapsort" "', argument " "1"" of type '" "void *""'"); 
    }
    ecode2 = SWIG_AsVal_size_t SWIG_PERL_CALL_ARGS_2(ST(1), &val2);
    if (!SWIG_IsOK(ecode2)) {
      SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "gsl_heapsort" "', argument " "2"" of type '" "size_t""'");
    } 
    arg2 = (size_t)(val2);
    ecode3 = SWIG_AsVal_size_t SWIG_PERL_CALL_ARGS_2(ST(2), &val3);
    if (!SWIG_IsOK(ecode3)) {
      SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "gsl_heapsort" "', argument " "3"" of type '" "size_t""'");
    } 
    arg3 = (size_t)(val3);
    {
      int res = SWIG_ConvertFunctionPtr(ST(3), (void**)(&arg4), SWIGTYPE_p_f_p_q_const__void_p_q_const__void__int);
      if (!SWIG_IsOK(res)) {
        SWIG_exception_fail(SWIG_ArgError(res), "in method '" "gsl_heapsort" "', argument " "4"" of type '" "gsl_comparison_fn_t""'"); 
      }
    }
    gsl_heapsort(arg1,arg2,arg3,arg4);
    ST(argvi) = sv_newmortal();
...
XS(_wrap_gsl_heapsort_index) {
  {
    size_t *arg1 = (size_t *) 0 ;
    void *arg2 = (void *) 0 ;
    size_t arg3 ;
    size_t arg4 ;
    gsl_comparison_fn_t arg5 = (gsl_comparison_fn_t) 0 ;
    int res2 ;
    size_t val3 ;
    int ecode3 = 0 ;
    size_t val4 ;
    ...
    if ((items < 5) || (items > 5)) {
      SWIG_croak("Usage: gsl_heapsort_index(p,array,count,size,compare);");
    }
    {
      AV *tempav;
      I32 len;
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "gsl_heapsort_index" "', argument " "2"" of type '" "void const *""'"); 
    }
    ecode3 = SWIG_AsVal_size_t SWIG_PERL_CALL_ARGS_2(ST(2), &val3);
    if (!SWIG_IsOK(ecode3)) {
      SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "gsl_heapsort_index" "', argument " "3"" of type '" "size_t""'");
    } 
    arg3 = (size_t)(val3);
    ecode4 = SWIG_AsVal_size_t SWIG_PERL_CALL_ARGS_2(ST(3), &val4);
    if (!SWIG_IsOK(ecode4)) {
      SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "gsl_heapsort_index" "', argument " "4"" of type '" "size_t""'");
    } 
    arg4 = (size_t)(val4);
    {
      int res = SWIG_ConvertFunctionPtr(ST(4), (void**)(&arg5), SWIGTYPE_p_f_p_q_const__void_p_q_const__void__int);
      if (!SWIG_IsOK(res)) {
        SWIG_exception_fail(SWIG_ArgError(res), "in method '" "gsl_heapsort_index" "', argument " "5"" of type '" "gsl_comparison_fn_t""'"); 
      }
    }
    result = (int)gsl_heapsort_index(arg1,(void const *)arg2,arg3,arg4,arg5);
    ST(argvi) = SWIG_From_int  SWIG_PERL_CALL_ARGS_1((int)(result)); argvi++ ;
    {
      //  if (arg1) free(arg1);
    }
...
static swig_type_info _swigt__p_f_p_q_const__void_p_q_const__void__int = {"_p_f_p_q_const__void_p_q_const__void__int", "gsl_comparison_fn_t|int (*)(void const *,void const *)", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_gsl_permutation_struct = {"_p_gsl_permutation_struct", "gsl_permutation *|struct gsl_permutation_struct *|gsl_permutation_struct *", 0, 0, (void*)"Math::GSL::Heapsort::gsl_permutation_struct", 0};
...
{"Math::GSL::Heapsortc::gsl_error", _wrap_gsl_error},
{"Math::GSL::Heapsortc::gsl_stream_printf", _wrap_gsl_stream_printf},
{"Math::GSL::Heapsortc::gsl_strerror", _wrap_gsl_strerror},
{"Math::GSL::Heapsortc::gsl_set_error_handler", _wrap_gsl_set_error_handler},
{"Math::GSL::Heapsortc::gsl_set_error_handler_off", _wrap_gsl_set_error_handler_off},
{"Math::GSL::Heapsortc::gsl_set_stream_handler", _wrap_gsl_set_stream_handler},
{"Math::GSL::Heapsortc::gsl_set_stream", _wrap_gsl_set_stream},
{"Math::GSL::Heapsortc::gsl_permutation_struct_size_set", _wrap_gsl_permutation_struct_size_set},
{"Math::GSL::Heapsortc::gsl_permutation_struct_size_get", _wrap_gsl_permutation_struct_size_get},
{"Math::GSL::Heapsortc::gsl_permutation_struct_data_set", _wrap_gsl_permutation_struct_data_set},
{"Math::GSL::Heapsortc::gsl_permutation_struct_data_get", _wrap_gsl_permutation_struct_data_get},
{"Math::GSL::Heapsortc::new_gsl_permutation_struct", _wrap_new_gsl_permutation_struct},
{"Math::GSL::Heapsortc::delete_gsl_permutation_struct", _wrap_delete_gsl_permutation_struct},
{"Math::GSL::Heapsortc::gsl_permutation_alloc", _wrap_gsl_permutation_alloc},
{"Math::GSL::Heapsortc::gsl_permutation_calloc", _wrap_gsl_permutation_calloc},
{"Math::GSL::Heapsortc::gsl_permutation_init", _wrap_gsl_permutation_init},
{"Math::GSL::Heapsortc::gsl_permutation_free", _wrap_gsl_permutation_free},
{"Math::GSL::Heapsortc::gsl_permutation_memcpy", _wrap_gsl_permutation_memcpy},
{"Math::GSL::Heapsortc::gsl_permutation_fread", _wrap_gsl_permutation_fread},
{"Math::GSL::Heapsortc::gsl_permutation_fwrite", _wrap_gsl_permutation_fwrite},
{"Math::GSL::Heapsortc::gsl_permutation_fscanf", _wrap_gsl_permutation_fscanf},
{"Math::GSL::Heapsortc::gsl_permutation_fprintf", _wrap_gsl_permutation_fprintf},
{"Math::GSL::Heapsortc::gsl_permutation_size", _wrap_gsl_permutation_size},
{"Math::GSL::Heapsortc::gsl_permutation_data", _wrap_gsl_permutation_data},
{"Math::GSL::Heapsortc::gsl_permutation_swap", _wrap_gsl_permutation_swap},
{"Math::GSL::Heapsortc::gsl_permutation_valid", _wrap_gsl_permutation_valid},
{"Math::GSL::Heapsortc::gsl_permutation_reverse", _wrap_gsl_permutation_reverse},
{"Math::GSL::Heapsortc::gsl_permutation_inverse", _wrap_gsl_permutation_inverse},
{"Math::GSL::Heapsortc::gsl_permutation_next", _wrap_gsl_permutation_next},
{"Math::GSL::Heapsortc::gsl_permutation_prev", _wrap_gsl_permutation_prev},
{"Math::GSL::Heapsortc::gsl_permutation_mul", _wrap_gsl_permutation_mul},
{"Math::GSL::Heapsortc::gsl_permutation_linear_to_canonical", _wrap_gsl_permutation_linear_to_canonical},
{"Math::GSL::Heapsortc::gsl_permutation_canonical_to_linear", _wrap_gsl_permutation_canonical_to_linear},
{"Math::GSL::Heapsortc::gsl_permutation_inversions", _wrap_gsl_permutation_inversions},
{"Math::GSL::Heapsortc::gsl_permutation_linear_cycles", _wrap_gsl_permutation_linear_cycles},
{"Math::GSL::Heapsortc::gsl_permutation_canonical_cycles", _wrap_gsl_permutation_canonical_cycles},
{"Math::GSL::Heapsortc::gsl_permutation_get", _wrap_gsl_permutation_get},
{"Math::GSL::Heapsortc::gsl_heapsort", _wrap_gsl_heapsort},
{"Math::GSL::Heapsortc::gsl_heapsort_index", _wrap_gsl_heapsort_index},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
