...
package Device::BusPirate::Chip::AVR_HVSP::FuseInfo;
...
C<Device::BusPirate::Chip::AVR_HVSP::FuseInfo> - information about device fuses
...
=head2 $fuseinfo = Device::BusPirate::Chip::AVR_HVSP::FuseInfo->for_part( $part )

Returns a new C<Device::BusPirate::Chip::AVR_HVSP::FuseInfo> instance
containing information about the fuses for the given part name.
