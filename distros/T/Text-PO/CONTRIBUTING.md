...
Feel free to clone it from its gitlab repository at <https://git.deguest.jp/jack/Text-PO> and issue a pull request.
...
File [an issue on CPAN bug tracker](https://git.deguest.jp/jack/Text-PO/issues) if you think you've found a bug. Please describe
...
Issues are currently reported using CPAN [bug tracker](https://git.deguest.jp/jack/Text-PO/issues)

## More information

Please refer to the [README](https://metacpan.org/source/JDEGUEST/Text-PO-v0.1.5/README.md)
