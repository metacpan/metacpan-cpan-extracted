package Shipment::FedEx::WSDL::ShipTypes::WeightUnits;
$Shipment::FedEx::WSDL::ShipTypes::WeightUnits::VERSION = '2.03';
use strict;
use warnings;
...
WeightUnits from the namespace http://fedex.com/ws/ship/v9.
