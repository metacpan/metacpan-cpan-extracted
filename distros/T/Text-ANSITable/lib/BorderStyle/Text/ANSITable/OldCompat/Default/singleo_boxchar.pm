...
package BorderStyle::Text::ANSITable::OldCompat::Default::singleo_boxchar;
...
use alias::module 'BorderStyle::BoxChar::SingleLineOuterOnly';

1;
# ABSTRACT: BoxChar::SingleLineOuterOnly border style (with old name)
...
BorderStyle::Text::ANSITable::OldCompat::Default::singleo_boxchar - BoxChar::SingleLineOuterOnly border style (with old name)

=head1 VERSION

This document describes version 0.607 of BorderStyle::Text::ANSITable::OldCompat::Default::singleo_boxchar (from Perl distribution Text-ANSITable), released on 2021-08-27.
