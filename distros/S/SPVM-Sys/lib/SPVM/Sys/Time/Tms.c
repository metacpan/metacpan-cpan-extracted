...
int32_t SPVM__Sys__Time__Tms__new(SPVM_ENV* env, SPVM_VALUE* stack) {
#ifdef _WIN32
  env->die(env, stack, "The new method in the Sys::Time::Tms is not supported on this system", FILE_NAME, __LINE__);
  ...
  void* obj_st_tms = env->new_pointer_by_name(env, stack, "Sys::Time::Tms", st_tms, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
#ifdef _WIN32
  env->die(env, stack, "The DESTROY method in the Sys::Time::Tms is not supported on this system", FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_CLASS_ID_ERROR_NOT_SUPPORTED;
#else
...
#ifdef _WIN32
  env->die(env, stack, "The tms_utime method in the Sys::Time::Tms is not supported on this system", FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_CLASS_ID_ERROR_NOT_SUPPORTED;
#else
...
#ifdef _WIN32
  env->die(env, stack, "The set_tms_utime method in the Sys::Time::Tms is not supported on this system", FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_CLASS_ID_ERROR_NOT_SUPPORTED;
#else
  void* obj_self = stack[0].oval;
...
#ifdef _WIN32
  env->die(env, stack, "The tms_stime method in the Sys::Time::Tms is not supported on this system", FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_CLASS_ID_ERROR_NOT_SUPPORTED;
#else
...
#ifdef _WIN32
  env->die(env, stack, "The set_tms_stime method in the Sys::Time::Tms is not supported on this system", FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_CLASS_ID_ERROR_NOT_SUPPORTED;
#else
  void* obj_self = stack[0].oval;
...
#ifdef _WIN32
  env->die(env, stack, "The tms_cutime method in the Sys::Time::Tms is not supported on this system", FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_CLASS_ID_ERROR_NOT_SUPPORTED;
#else
...
#ifdef _WIN32
  env->die(env, stack, "The set_tms_cutime method in the Sys::Time::Tms is not supported on this system", FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_CLASS_ID_ERROR_NOT_SUPPORTED;
#else
  void* obj_self = stack[0].oval;
...
#ifdef _WIN32
  env->die(env, stack, "The tms_cstime method in the Sys::Time::Tms is not supported on this system", FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_CLASS_ID_ERROR_NOT_SUPPORTED;
#else
...
#ifdef _WIN32
  env->die(env, stack, "The set_tms_cstime method in the Sys::Time::Tms is not supported on this system", FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_CLASS_ID_ERROR_NOT_SUPPORTED;
#else
  void* obj_self = stack[0].oval;
