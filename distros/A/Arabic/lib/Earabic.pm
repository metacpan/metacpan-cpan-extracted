...
sub import {
    ...
    *Char::ord           = \&Arabic::ord;
    *Char::ord_          = \&Arabic::ord_;
    *Char::reverse       = \&Arabic::reverse;
    *Char::getc          = \&Arabic::getc;
    *Char::length        = \&Arabic::length;
    *Char::substr        = \&Arabic::substr;
    *Char::index         = \&Arabic::index;
    *Char::rindex        = \&Arabic::rindex;
    *Char::eval          = \&Arabic::eval;
    *Char::escape        = \&Arabic::escape;
    *Char::escape_token  = \&Arabic::escape_token;
    *Char::escape_script = \&Arabic::escape_script;
}
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Earabic::re_t=%s; while($Earabic::re_t =~ %s){%s local $^W=0; local $Earabic::re_r=%s; %s$Earabic::re_t="$`$Earabic::re_r$'"; pos($Earabic::re_t)=length "$`$Earabic::re_r"; } return $Earabic::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Earabic::re_r=%s; %s"%s$Earabic::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Earabic::re_n=0; while(%s =~ %s){%s local $^W=0; local $Earabic::re_r=%s; %s%s="$`$Earabic::re_r$'"; pos(%s)=length "$`$Earabic::re_r"; $Earabic::re_n++} return %s$Earabic::re_n}>,
