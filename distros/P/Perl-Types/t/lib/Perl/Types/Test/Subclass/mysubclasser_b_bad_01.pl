...
# <<< PARSE_ERROR: 'No such class Perl::Types::Test::Subclass::MySubclasserB_Good_arrayrefd' >>>
...
my Perl::Types::Test::Subclass::MySubclasserB_Good_arrayrefd $more_others = seesaw();
