...
Kubernetes::REST::Call::GetSchedulingAPIGroup - REMOVED -- superseded by Kubernetes::REST's unified v1 API, see Kubernetes::REST::Deprecated
...
C<Kubernetes::REST::Call::GetSchedulingAPIGroup> itself was never functional in the C<1.x> series -- it
...
C<cpanm Kubernetes::REST::Call::GetSchedulingAPIGroup> -- or a cpanfile / code that still references the
...
Kubernetes::REST::Call::GetSchedulingAPIGroup - REMOVED, superseded by Kubernetes::REST's unified v1 API
