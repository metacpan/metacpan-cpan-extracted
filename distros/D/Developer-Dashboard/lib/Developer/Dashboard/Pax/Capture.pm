...
Developer::Dashboard::Pax::Capture - live and hermetic capture engine

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::Capture;

  my $obj = Developer::Dashboard::Pax::Capture->new(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::Capture -e 1
