...
1;
# ABSTRACT: Create Acme::CPANModules::Import::* modules
...
App::CreateAcmeCPANModulesImportModules - Create Acme::CPANModules::Import::* modules

=head1 VERSION

This document describes version 0.001 of App::CreateAcmeCPANModulesImportModules (from Perl distribution App-CreateAcmeCPANModulesImportModules), released on 2018-02-18.

=head1 FUNCTIONS


=head2 create_acme_cpanmodules_import_modules
...
An C<Acme::CPANModules::Import::*> module contains a module list where its
entries (modules) are extracted from a web page. The purpose of creating such
module is to have a POD mentioning the modules, thus adding/improving to the POD
"mentions cloud" on CPAN.
...
Please visit the project's homepage at L<https://metacpan.org/release/App-CreateAcmeCPANModulesImportModules>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-App-CreateAcmeCPANModulesImportModules>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=App-CreateAcmeCPANModulesImportModules>
