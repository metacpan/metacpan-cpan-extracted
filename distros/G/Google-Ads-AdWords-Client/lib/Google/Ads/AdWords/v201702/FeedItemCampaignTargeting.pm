package Google::Ads::AdWords::v201702::FeedItemCampaignTargeting;
use strict;
use warnings;
...
FeedItemCampaignTargeting from the namespace https://adwords.google.com/api/adwords/cm/v201702.
