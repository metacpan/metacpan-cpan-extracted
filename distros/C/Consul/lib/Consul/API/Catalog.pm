...
$Consul::API::Catalog::VERSION = '0.024';
...
$Consul::API::Catalog::ShortNode::VERSION = '0.024';
use Moo;
use Types::Standard qw(Str);
...
$Consul::API::Catalog::Service::VERSION = '0.024';
use Moo;
...
$Consul::API::Catalog::Node::VERSION = '0.024';
use Moo;
