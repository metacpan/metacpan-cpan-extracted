...
# [[[ HEADER ]]]
#use RPerl;  # disabled here & PERL_WARNINGS above & Perl::diag() below, only re-enable for Perl::diag() debugging use
use strict;
use warnings;
...
#Perl::diag('in 03_inline_cpp.t, starting Farmer Bob...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, building Farmer Bob...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, running Farmer Bob...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, finished Farmer Bob!' . "\n");

# class Airplane, AKA "Plane and Simple"
#Perl::diag('in 03_inline_cpp.t, starting Airplane...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, building Airplane...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, running Airplane...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, finished Airplane!' . "\n");

# average() VS avg(), AKA "The Ellipsis Abridged"
#Perl::diag('in 03_inline_cpp.t, starting Elipses Abridged...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, building Elipses Abridged...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, running Elipses Abridged...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, finished Elipses Abridged!' . "\n");

# classes Queue and Stack, AKA "Stacks and Queues"
#Perl::diag('in 03_inline_cpp.t, starting Stacks & Queues...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, building Stacks & Queues...' . "\n");
...
#Perl::diag("There are " . $q->size . " items in the queue\n");
while($q->size) {
#	Perl::diag("About to dequeue: " . $q->peek . "\n");
#	Perl::diag("Actually dequeued: " . $q->dequeue . "\n");
...
$s->push(42);
$s->push("What?");
#Perl::diag("There are " . $s->size . " items on the stack\n");
while($s->size) {
#	Perl::diag("About to pop: " . $s->peek . "\n");
#	Perl::diag("Actually popped: " . $s->pop . "\n");
	$stack_retval .= $s->pop . '  ';
}
return($queue_retval, $stack_retval);
EOF

#Perl::diag('in 03_inline_cpp.t, running Stacks & Queues...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, finished Stacks & Queues!' . "\n");

# multiadd(), AKA "Elipses Revisited (and Overloading or Templates)"
#Perl::diag('in 03_inline_cpp.t, starting Elipses Revisited...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, building Elipses Revisited...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, running Elipses Revisited part 1/4...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, running Elipses Revisited part 2/4...' . "\n");
lives_and(
    sub {
...
#Perl::diag('in 03_inline_cpp.t, running Elipses Revisited part 3/4...' . "\n");
lives_and(
    sub {
...
#    Perl::diag('in 03_inline_cpp.t, skipping Elipses Revisited part 4/4, Windows detected...' . "\n");
    if ( $ENV{PERL_VERBOSE} ) {
...
#    Perl::diag('in 03_inline_cpp.t, running Elipses Revisited part 4/4...' . "\n");
...
#Perl::diag('in 03_inline_cpp.t, finished Elipses Revisited!' . "\n");
