...
TableDataRole::Test::Source::CSVInFile - Some English words with Indonesian equivalents

=head1 VERSION

This document describes version 0.025 of TableDataRole::Test::Source::CSVInFile (from Perl distribution TableDataRoles-Standard), released on 2024-05-14.
...
To use from Perl code:
 ...
 my $td = TableData::Test::Source::CSVInFile->new;
...
To use from command-line (using L<tabledata> CLI):
 ...
 % tabledata Test::Source::CSVInFile --page

 # Get number of rows
 % tabledata --action count_rows Test::Source::CSVInFile
