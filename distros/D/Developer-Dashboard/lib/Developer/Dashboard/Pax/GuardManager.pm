...
sub validate_or_deopt {
    ...
    my $reconstructed = Developer::Dashboard::Pax::DeoptEngine->new->reconstruct(
        ssa_unit => $ssa_unit,
...
Developer::Dashboard::Pax::GuardManager - guard registration and invalidation helper

=head1 SYNOPSIS

  use Developer::Dashboard::Pax::GuardManager;

  my $obj = Developer::Dashboard::Pax::GuardManager->new(...);
...
Example 1:
  ...
  perl -Ilib -MDeveloper::Dashboard::Pax::GuardManager -e 1
