package Chart::Plotly::Trace::Scattercarpet::Marker::Colorbar;
use Moose;
...
use Chart::Plotly::Trace::Scattercarpet::Marker::Colorbar::Tickfont;
use Chart::Plotly::Trace::Scattercarpet::Marker::Colorbar::Tickformatstop;
use Chart::Plotly::Trace::Scattercarpet::Marker::Colorbar::Titlefont;
...
has tickfont => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattercarpet::Marker::Colorbar::Tickfont", );
...
has tickformatstops => (
                      is  => "rw",
                      isa => "ArrayRef|ArrayRef[Chart::Plotly::Trace::Scattercarpet::Marker::Colorbar::Tickformatstop]",
);
...
has titlefont => ( is  => "rw",
                   isa => "Maybe[HashRef]|Chart::Plotly::Trace::Scattercarpet::Marker::Colorbar::Titlefont", );
...
Chart::Plotly::Trace::Scattercarpet::Marker::Colorbar - This attribute is one of the possible options for the trace scattercarpet.
