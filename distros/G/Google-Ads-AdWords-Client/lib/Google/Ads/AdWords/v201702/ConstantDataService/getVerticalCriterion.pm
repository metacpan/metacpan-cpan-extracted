...
package Google::Ads::AdWords::v201702::ConstantDataService::getVerticalCriterion;
use strict;
use warnings;
...
getVerticalCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201702.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::ConstantDataService::getVerticalCriterion->new($data);
