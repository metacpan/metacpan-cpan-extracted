...
$Map::Tube::Exception::MalformedMapData::VERSION = '3.20';
=head1 NAME
...
has status => (is => 'ro', default => sub { 126 });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Map::Tube::Exception::MalformedMapData
...
1; # End of Map::Tube::Exception::MalformedMapData
