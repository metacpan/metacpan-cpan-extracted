...
IO::K8s::CertManager::V1::ACMEChallengeSolverHTTP01IngressTemplate - Optional ingress template used to configure the ACME challenge solver ingress used for HTTP01 challenges.
