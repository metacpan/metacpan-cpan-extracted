...
#pod
#pod This is C<Hook::ReleaseStatusProvider> plugin implementation. Nothing interesting, just using few roles.
#pod
...
#pod = L<Dist::Zilla>
#pod = L<Dist::Zilla::Role::ReleaseStatusProvider>
#pod
#pod =cut

package Dist::Zilla::Plugin::Hook::ReleaseStatusProvider;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::ReleaseStatusProvider> plugin implementation
our $VERSION = 'v0.8.3'; # VERSION

with 'Dist::Zilla::Role::Plugin';
with 'Dist::Zilla::Role::Hooker' => {
    -alias => { hook => 'provide_release_status' },
};
...
Dist::Zilla::Plugin::Hook::ReleaseStatusProvider - C<Hook::ReleaseStatusProvider> plugin implementation
...
This is C<Hook::ReleaseStatusProvider> plugin implementation. Nothing interesting, just using few roles.
...
=item L<Dist::Zilla::Role::ReleaseStatusProvider>
