...
my $DragonDB_AlleleProfile = FAIR::Profile->new(
		...
		identifier => "doi:Mark.Dragon.P3",
                URI => "http://biordf.org/DataFairPort/ProfileSchemas/DragonDB_Allele_ProfileImagesEDAM.rdf",
                );
...
my $AlleleClass = FAIR::Profile::Class->new(
    ...
    URI => "http://biordf.org/DataFairPort/ProfileSchemas/DragonDB_Allele_ProfileImagesEDAM.rdf#DragonAlleleClass",
