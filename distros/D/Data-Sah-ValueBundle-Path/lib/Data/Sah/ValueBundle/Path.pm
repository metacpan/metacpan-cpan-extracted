package Data::Sah::ValueBundle::Path;
...
1;
# ABSTRACT: Default value rules related to paths
...
Data::Sah::ValueBundle::Path - Default value rules related to paths

=head1 VERSION

This document describes version 0.004 of Data::Sah::ValueBundle::Path (from Perl distribution Data-Sah-ValueBundle-Path), released on 2023-03-30.
