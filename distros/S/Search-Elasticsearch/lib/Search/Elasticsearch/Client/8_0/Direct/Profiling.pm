...
$Search::Elasticsearch::Client::8_0::Direct::Profiling::VERSION = '8.12';
use Moo;
...
Search::Elasticsearch::Client::8_0::Direct::Profiling - The Profile API returns basic information about
