...
Both modules are available from CPAN (L<http://search.cpan.org>).

=head2 Detailed instructions
...
on Unix-like systems is as follows:
...
$Id: INSTALL.pod,v 1.2 2008/04/07 03:28:36 tpederse Exp $
