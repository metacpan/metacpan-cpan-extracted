package Text::Statistics::Devanagari;
...
Text::Statistics::Devanagari creates a seven column CSV file output with one line each
...
Example:
    ...
    &devanagari("4"); #3 (4-1) texts will be analised.
    ...
    while ($tempo < 3){                                                             #limita o procedimenento aos ciclos inicial e meta-dado
        ...
        while ($num < $maximo){        
            ...
            while (1) {
                ...
                last unless $line;
                for ($line) {
                    s/[-]|[Ͽ-ँ]|[॰-��]/ /g;                            #separadores exclusivamente de alfabeto devanagari
                }   
...
L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Text-Statistics-Devanagari>.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Text::Statistics::Devanagari
...
L<http://annocpan.org/dist/Text-Statistics-Devanagari>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/Text-Statistics-Devanagari>

=item * RT: CPAN's request tracker

L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=Text-Statistics-Devanagari>

=item * Search CPAN

L<http://search.cpan.org/dist/Text-Statistics-Devanagari>
...
1; # End of Text::Statistics::Devanagari
__END__
