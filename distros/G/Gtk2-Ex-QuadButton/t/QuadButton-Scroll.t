...
{
  my $want_version = 1;
  is ($Gtk2::Ex::QuadButton::Scroll::VERSION, $want_version, 'VERSION variable');
  is (Gtk2::Ex::QuadButton::Scroll->VERSION,  $want_version, 'VERSION class method');

  ok (eval { Gtk2::Ex::QuadButton::Scroll->VERSION($want_version); 1 },
      "VERSION class check $want_version");
  my $check_version = $want_version + 1000;
  ok (! eval { Gtk2::Ex::QuadButton::Scroll->VERSION($check_version); 1 },
...

{
  ...
  my $qb = Gtk2::Ex::QuadButton::Scroll->new (hadjustment => $adj);
  require Scalar::Util;
  Scalar::Util::weaken ($qb);
  is ($qb, undef,
