...
showtable.pl - test the external Data::ShowTable module.
...
This is a test suite for the Data::ShowTable package.
Currently it just prints out a small table.
...
Data::ShowTable(3), Meta::Baseline::Test(3), Meta::Utils::Opts::Opts(3), Meta::Utils::System(3), strict(3)
