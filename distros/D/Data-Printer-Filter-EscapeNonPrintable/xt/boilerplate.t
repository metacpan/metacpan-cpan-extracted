...
\ \ \ \ \#\ Procedural\
\
\ \ \ \ use\ Data\:\:Printer\:\:Filter\:\:EscapeNonPrintable\ qw\<\ function\ \>\;\
\
\ \ \ \ my\ \$foo\ \=\ function\(\.\.\.\)\;\
\ \ \ \ \.\.\.\
\
\ \ \ \ \#\ OOP\
\
\ \ \ \ use\ Data\:\:Printer\:\:Filter\:\:EscapeNonPrintable\;\
\
\ \ \ \ my\ \$foo\ \=\ Data\:\:Printer\:\:Filter\:\:EscapeNonPrintable\-\>new\;\
\ \ \ \ \$foo\-\>method\(\.\.\.\)\;\
\ \ \ \ \.\.\.\
(?{ $desc = "POD SYNOPSIS" })',
...
not_in_file_ok('lib/Data/Printer/Filter/EscapeNonPrintable.pm');
