package Google::Ads::AdWords::v201806::CriterionCustomAffinity;
use strict;
use warnings;
...
Google::Ads::AdWords::v201806::CriterionCustomAffinity

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CriterionCustomAffinity from the namespace https://adwords.google.com/api/adwords/cm/v201806.

A Custom Affinity criterion. <p> <span class="constraint AdxEnabled">This is disabled for AdX when it is contained within Operators: ADD, SET.</span> 
