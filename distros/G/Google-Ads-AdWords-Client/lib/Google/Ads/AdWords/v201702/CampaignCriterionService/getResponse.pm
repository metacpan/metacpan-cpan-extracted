...
package Google::Ads::AdWords::v201702::CampaignCriterionService::getResponse;
use strict;
use warnings;
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201702::CampaignCriterionService::getResponse->new($data);
