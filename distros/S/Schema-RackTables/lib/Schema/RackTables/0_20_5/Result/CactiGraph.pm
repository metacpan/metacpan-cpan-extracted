use utf8;
package Schema::RackTables::0_20_5::Result::CactiGraph;
...
Related object: L<Schema::RackTables::0_20_5::Result::CactiServer>

=cut

__PACKAGE__->belongs_to(
  "server",
  "Schema::RackTables::0_20_5::Result::CactiServer",
  { id => "server_id" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:c/J30WWFUIRlH203+A90Dw
