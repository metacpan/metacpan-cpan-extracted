...
use App::Framework::Lite ':Script +Run +Logging' ;
...
sub app
{
	...
	foreach my $test (sort keys %tests)
	{
		...
		$run->set('log' => $tests{$test}{options}) ;
...
sub feature_check
{
	...
	is($class1, "App::Framework::Lite", "$name feature class check") ;
