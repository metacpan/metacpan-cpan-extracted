package Chart::Plotly::Trace::Scattersmith::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Scattersmith::Hoverlabel::Font - This attribute is one of the possible options for the trace scattersmith.
