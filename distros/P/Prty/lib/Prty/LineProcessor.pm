...
Prty::LineProcessor - Verarbeite Datei als Array von Zeilen
...
der Klasse Prty::LineProcessor::Line). Die Klasse stellt
...
=item -lineClass => $class (Default: 'Prty::LineProcessor::Line')
...
sub new {
    ...
    my $encoding;
    my $lineClass = 'Prty::LineProcessor::Line';
