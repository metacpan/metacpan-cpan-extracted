...
our $DIST = 'Module-Features-PythonTrove'; # DIST
...
Please visit the project's homepage at L<https://metacpan.org/release/Module-Features-PythonTrove>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Module-Features-PythonTrove>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://github.com/perlancar/perl-Module-Features-PythonTrove/issues>
