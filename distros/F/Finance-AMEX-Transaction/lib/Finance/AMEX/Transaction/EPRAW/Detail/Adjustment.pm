...
$Finance::AMEX::Transaction::EPRAW::Detail::Adjustment::VERSION = '0.003';
use strict;
use warnings;
...
Finance::AMEX::Transaction::EPRAW::Detail::Adjustment - Parse AMEX Reconciliation Files (EPRAW) Adjustment Detail Rows
...
Returns a new L<Finance::AMEX::Transaction::EPRAW::Detail::Adjustment> object.

 my $record = Finance::AMEX::Transaction::EPRAW::Detail::Adjustment->new(line => $line);
...
Finance::AMEX::Transaction::EPRAW::Detail::Adjustment - Object methods for AMEX Reconciliation file adjustment detail records.
