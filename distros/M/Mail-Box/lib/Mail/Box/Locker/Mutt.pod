...
=item Fault: failed to remove expired mutt-lock $file: $!

Cast by C<lock()>

=item Warning: folder $name already mutt-locked with $file.

Cast by C<lock()>

=item Fault: folder $name will never get a mutt-lock with $file: $!

Cast by C<lock()>

=item Warning: removed expired mutt-lock file $file.
