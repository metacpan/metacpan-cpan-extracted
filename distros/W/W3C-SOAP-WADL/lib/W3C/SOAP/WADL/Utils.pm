...
sub operation {
    ...
    $meta->add_method(
        $name,
        W3C::SOAP::WADL::Meta::Method->wrap(
...
W3C::SOAP::WADL::Utils - WADL related utilities

=head1 VERSION

This documentation refers to W3C::SOAP::WADL::Utils version 0.007
...
=head1 SYNOPSIS
   ...
   # In a WADL package to generate an operation method:
   operation wsdl_op => (
...
The name of the operation from the WADL
