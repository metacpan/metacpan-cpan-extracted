...
ok( $media );
ok( $media->getValue('description') eq 'The official Slackware web site' );
ok($media->setValue('description','This is only a test') eq 'This is only a test' );
ok( $media->getValue('description') eq 'This is only a test' );
