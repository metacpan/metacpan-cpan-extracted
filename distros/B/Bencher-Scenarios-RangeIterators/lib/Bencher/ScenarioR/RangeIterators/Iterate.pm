package Bencher::ScenarioR::RangeIterators::Iterate;
  ...
  [
    ...
    ],
    {
      "func.bencher_args"              => {
                                            ...
                                            scenario_module => "RangeIterators::Iterate",
                                          },
      ...
      "func.elapsed_time"              => 4.03993010520935,
      "func.module_startup"            => undef,
      "func.module_versions"           => {
                                            "__PACKAGE__"                                => 1.041,
                                            "Bencher::Scenario::RangeIterators::Iterate" => undef,
      ...
      "func.precision"                 => 0,
      "func.scenario_module"           => "Bencher::Scenario::RangeIterators::Iterate",
      "func.scenario_module_md5sum"    => "760eec10922737a9829954f98e2b891a",
      "func.scenario_module_mtime"     => 1555994694,
      "func.scenario_module_sha1sum"   => "30606d41566df5368c3348bb6d379bf41fdb12b7",
      "func.scenario_module_sha256sum" => "073e9b1a722adb34d8668e570adf188eb6e2253ca735d13bf8e3245888ce575a",
      "func.time_end"                  => 1555996959.9488,
      "func.time_factor"               => 1000,
      "func.time_start"                => 1555996955.90887,
