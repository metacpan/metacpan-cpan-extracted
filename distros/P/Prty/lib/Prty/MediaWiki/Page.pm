...
getPage()-Operation des MediaWiki-Client (Klasse
Prty::MediaWiki::Client). Mit den Methoden der Klasse kann
auf bestimmte Information der Antwort zugegriffen werden.
...
Instantiiere ein MediaWiki Seiten-Objekt und liefere eine Referenz
