...
Sah::Schema::perl::identifier::qualified_unicode - Unqualified identifier in Perl, with "use utf8" in effect

=head1 VERSION

This document describes version 0.049 of Sah::Schema::perl::identifier::qualified_unicode (from Perl distribution Sah-Schemas-Perl), released on 2023-10-26.
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("perl::identifier::qualified_unicode*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::identifier::qualified_unicode", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::identifier::qualified_unicode", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::identifier::qualified_unicode*");
     $validator->(\@args);
     ...
 }
 ...
 $SPEC{myfunc} = {
     ...
     args => {
         arg1 => {
             ...
             schema => ['perl::identifier::qualified_unicode*'],
         },
         ...
     },
 };
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::identifier::qualified_unicode*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::identifier::qualified_unicode*', name=>'PerlIdentifierQualifiedUnicode')
     );
 }

 use My::Types qw(PerlIdentifierQualifiedUnicode);
 PerlIdentifierQualifiedUnicode->assert_valid($data);
