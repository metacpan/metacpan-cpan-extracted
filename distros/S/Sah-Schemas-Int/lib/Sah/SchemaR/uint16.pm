...
our $rschema = [
  "int",
  [
    { max => 65535, min => 0, summary => "16-bit unsigned integer" },
  ],
  ["int"],
];
...
This document describes version 0.06 of Sah::SchemaR::uint16 (from Perl distribution Sah-Schemas-Int), released on 2016-07-22.
