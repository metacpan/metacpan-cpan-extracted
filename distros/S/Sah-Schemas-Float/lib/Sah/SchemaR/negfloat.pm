...
our $rschema = ["float",[{summary=>"Negative float",xmax=>0}],["float"]];
...
This document describes version 0.003 of Sah::SchemaR::negfloat (from Perl distribution Sah-Schemas-Float), released on 2019-04-08.
