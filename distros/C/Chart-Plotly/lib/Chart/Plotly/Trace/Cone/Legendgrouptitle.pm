package Chart::Plotly::Trace::Cone::Legendgrouptitle;
use Moose;
...
use Chart::Plotly::Trace::Cone::Legendgrouptitle::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Cone::Legendgrouptitle::Font", );
...
Chart::Plotly::Trace::Cone::Legendgrouptitle - This attribute is one of the possible options for the trace cone.
