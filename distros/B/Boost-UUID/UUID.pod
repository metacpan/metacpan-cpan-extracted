...
SYNOPSYS
    Simple Perl interface for boost::uuid_generators ( look here
    [boost::uuid doc]
...
DESCRIPTION
   ...
   String UUID
    ...
    <https://www.boost.org/doc/libs/1_43_0/libs/uuid/uuid.html#boost/uuid/st
    ring_generator.hpp> )

    Work with boost::uuids::string_generator(), but return nill UUID in
    wrong input string case
...
AUTHOR
    Vladimir Melnichenko <melnichenkovv@gmail.com>, Crazy Panda, CP Decision
    LTD

    <https://github.com/VMELNICHENKO/Boost-UUID>
