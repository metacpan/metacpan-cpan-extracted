...
# {{{ num2word
sub num2por_cardinal :Export { goto &num2word }
...
Lingua::POR::Num2Word - Converts numbers to Portuguese words
...
=head1 SYNOPSIS
  ...
  use Lingua::POR::Num2Word qw/num2word/;
