...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::Policy Google::Cloud::Compute::V1::Compute::ResourcePolicy Google::Cloud::Compute::V1::Compute::ResourcePolicyAggregatedList Google::Cloud::Compute::V1::Compute::ResourcePolicyList Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::ResourcePoliciesClient->new( credentials => 'dummy' );
