...
$Shipment::Temando::WSDL::Types::ManifestNumber::VERSION = '3.10';
use strict;
use warnings;
...
ManifestNumber from the namespace http://' . $Shipment::Temando::WSDL::Interfaces::quoting_Service::quoting_port::ns_url . '/schema/2009_06/common.xsd.
