...
This document describes version 0.022 of Sah::Schema::unix::dirname (from Perl distribution Sah-SchemaBundle-Unix), released on 2024-11-15.

=head1 SAH SCHEMA DEFINITION

 ["dirname::unix", { "x.completion" => ["dirname"] }]
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("unix::dirname", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("unix::dirname", {return_type=>'str_errmsg+val'});
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"unix::dirname*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('unix::dirname*', name=>'UnixDirname')
     );
 }

 use My::Types qw(UnixDirname);
 UnixDirname->assert_valid($data);
