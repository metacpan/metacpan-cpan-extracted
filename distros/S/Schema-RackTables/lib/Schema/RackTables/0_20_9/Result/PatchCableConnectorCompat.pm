use utf8;
package Schema::RackTables::0_20_9::Result::PatchCableConnectorCompat;
...
Related object: L<Schema::RackTables::0_20_9::Result::PatchCableConnector>
...
Related object: L<Schema::RackTables::0_20_9::Result::PatchCableHeap>

=cut

__PACKAGE__->has_many(
  "patch_cable_heap_pctype_id_end1_conns",
  "Schema::RackTables::0_20_9::Result::PatchCableHeap",
  {
...
Related object: L<Schema::RackTables::0_20_9::Result::PatchCableType>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uuDo7+G9GIEpPXSR644Hkg
