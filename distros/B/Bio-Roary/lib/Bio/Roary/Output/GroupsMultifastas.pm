...
$Bio::Roary::Output::GroupsMultifastas::VERSION = '3.10.2';
...
Bio::Roary::Output::GroupsMultifastas - Take in a list of groups and create multifastas files for each group
