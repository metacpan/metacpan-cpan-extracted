...
sub _build_af {
	...
	return AsposeThreeDCloud::ApiFactory->new(%args);
}

=head1 NAME

AsposeThreeDCloud::Role - a Moose role for the Aspose.3D Cloud API Reference

=head2 Aspose.3D Cloud API Reference version: 3.0
...
AsposeThreeDCloud::ApiFactory for non-Moosey usage.
...
The tokens will be placed in a L<AsposeThreeDCloud::Configuration> instance
...
Returns an API factory object. You probably won't need to call this directly.
        ...
        $self->api_factory('Pet'); # returns a AsposeThreeDCloud::PetApi instance
