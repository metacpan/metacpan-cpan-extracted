...
use Google::Ads::AdWords::v201607::AttributeFieldMapping;
use Google::Ads::AdWords::v201607::CampaignFeed;
use Google::Ads::AdWords::v201607::CampaignFeedOperation;
use Google::Ads::AdWords::v201607::Feed;
use Google::Ads::AdWords::v201607::FeedAttribute;
use Google::Ads::AdWords::v201607::FeedItem;
use Google::Ads::AdWords::v201607::FeedItemAttributeValue;
use Google::Ads::AdWords::v201607::FeedItemGeoRestriction;
use Google::Ads::AdWords::v201607::FeedItemOperation;
use Google::Ads::AdWords::v201607::FeedMapping;
use Google::Ads::AdWords::v201607::FeedMappingOperation;
use Google::Ads::AdWords::v201607::FeedOperation;
use Google::Ads::AdWords::v201607::Function;
use Google::Ads::AdWords::v201607::Location;
...
sub create_site_links_feed() {
  ...
  my $text_attribute = Google::Ads::AdWords::v201607::FeedAttribute->new({
    type => "STRING",
    name => "Link Text"
  });
  my $final_url_attribute = Google::Ads::AdWords::v201607::FeedAttribute->new({
    type => "URL_LIST",
    name => "Link Final URLs"
  });
  my $line_2_attribute = Google::Ads::AdWords::v201607::FeedAttribute->new({
    type => "STRING",
    name => "Line 2"
  });
  my $line_3_attribute = Google::Ads::AdWords::v201607::FeedAttribute->new({
    type => "STRING",
    name => "Line 3"
  });
  my $feed = Google::Ads::AdWords::v201607::Feed->new({
      name       => $feed_name,
      attributes => [
  ...
  my $operation = Google::Ads::AdWords::v201607::FeedOperation->new({
    operator => "ADD",
    operand  => $feed
  });
...
sub create_feed_item_add_operation() {
  ...
  my $text_attribute_value =
    Google::Ads::AdWords::v201607::FeedItemAttributeValue->new({
  ...
  my $feed_item = Google::Ads::AdWords::v201607::FeedItem->new({
  ...
  if ($location_id) {
    my $location =
      Google::Ads::AdWords::v201607::Location->new({id => $location_id});
    ...
    my $geo_targeting_restriction =
      Google::Ads::AdWords::v201607::FeedItemGeoRestriction->new({
        geoRestriction => "LOCATION_OF_PRESENCE"
      });
    $feed_item->set_geoTargetingRestriction($geo_targeting_restriction);
  }

  my $operation = Google::Ads::AdWords::v201607::FeedItemOperation->new({
    operand  => $feed_item,
    operator => "ADD"
  });
...
sub create_site_links_feed_mapping() {
  ...
  my $text_field_mapping =
    Google::Ads::AdWords::v201607::AttributeFieldMapping->new({
      feedAttributeId => $site_links_data->{"linkTextFeedAttributeId"},
  ...
  my $feed_mapping = Google::Ads::AdWords::v201607::FeedMapping->new({
  ...
  my $operation = Google::Ads::AdWords::v201607::FeedMappingOperation->new({
...
sub create_site_links_campaign_feed() {
  ...
  my $matching_function = Google::Ads::AdWords::v201607::Function->new(
    {functionString => $matching_function_string});

  my $campaign_feed = Google::Ads::AdWords::v201607::CampaignFeed->new({
      feedId           => $site_links_data->{"siteLinksFeedId"},
