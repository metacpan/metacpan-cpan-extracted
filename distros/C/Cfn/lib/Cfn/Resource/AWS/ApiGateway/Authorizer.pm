...
Cfn::Resource::AWS::ApiGateway::Authorizer - Cfn resource for AWS::ApiGateway::Authorizer

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::ApiGateway::Authorizer.
