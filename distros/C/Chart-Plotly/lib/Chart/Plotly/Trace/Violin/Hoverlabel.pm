package Chart::Plotly::Trace::Violin::Hoverlabel;
use Moose;
...
use Chart::Plotly::Trace::Violin::Hoverlabel::Font;
...
has font => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Violin::Hoverlabel::Font", );
...
Chart::Plotly::Trace::Violin::Hoverlabel - This attribute is one of the possible options for the trace violin.
