...
This document describes version 0.050 of Sah::Schema::perl::modname_with_ver (from Perl distribution Sah-SchemaBundle-Perl), released on 2024-02-16.
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::modname_with_ver", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::modname_with_ver", {return_type=>'str_errmsg+val'});
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::modname_with_ver*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::modname_with_ver*', name=>'PerlModnameWithVer')
     );
 }
