...
Aspose.3D Cloud API Referencerr
...
#
package AsposeThreeDCloud::Object::DracoSaveOption;
...
__PACKAGE__->method_documentation({
    ...
    'position_bits' => {
    	datatype => 'int',
    	base_name => 'PositionBits',
    	description => 'Quantization bits for position, default value is 14',
    	format => '',
    	read_only => '',
    		},
    'texture_coordinate_bits' => {
    	datatype => 'int',
    	base_name => 'TextureCoordinateBits',
    	description => 'Quantization bits for texture coordinate, default value is 12',
    	format => '',
    	read_only => '',
    		},
    'color_bits' => {
