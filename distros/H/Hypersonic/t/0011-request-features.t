...
# Fork a server process to test request features. spawn_server captures
# the child's STDERR so we can diag the real failure when the child
# dies before binding (see OpenBSD smoke reports for 0.13).
