...
# 11
    ...
    sub { $_='‚ ‚¢01abc‚¤‚¦'; my $r=mb::substr($_, 3, 5,'‚¨DE‚©2‚«'); $_ eq '‚ ‚¢0‚¨DE‚©2‚«‚¦' },
    sub { $_='‚ ‚¢01abc‚¤‚¦'; my $r=mb::substr($_, 3, 5,'‚¨DE‚©2‚«'); $r eq '1abc‚¤'           },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
# 21
    ...
    sub { $_='‚ ‚¢01abc‚¤‚¦'; my $r=mb::substr($_, -5, 4,'‚¨DE‚©2‚«'); $_ eq '‚ ‚¢01‚¨DE‚©2‚«‚¦' },
    sub { $_='‚ ‚¢01abc‚¤‚¦'; my $r=mb::substr($_, -5, 4,'‚¨DE‚©2‚«'); $r eq 'abc‚¤'             },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
# 31
    ...
    sub { $_='‚ ‚¢01abc‚¤‚¦'; my $r=mb::substr($_, 1, -5,'‚¨DE‚©2‚«'); $_ eq '‚ ‚¨DE‚©2‚«abc‚¤‚¦' },
    sub { $_='‚ ‚¢01abc‚¤‚¦'; my $r=mb::substr($_, 1, -5,'‚¨DE‚©2‚«'); $r eq '‚¢01'               },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
# 41
    ...
    sub { $_='‚ ‚¢01abc‚¤‚¦'; my $r=mb::substr($_, -6, -3,'‚¨DE‚©2‚«'); $_ eq '‚ ‚¢0‚¨DE‚©2‚«c‚¤‚¦' },
    sub { $_='‚ ‚¢01abc‚¤‚¦'; my $r=mb::substr($_, -6, -3,'‚¨DE‚©2‚«'); $r eq '1ab'                 },
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 111
    ...
    sub { ($] < 5.014) or eval q{ $_='0123456789';    mb::substr($_, 3, 2)='‚³67‚µd'; $_ eq '012‚³67‚µd56789' }},
    sub { ($] < 5.014) or eval q{ $_='‚ ‚¢01abc‚¤‚¦'; mb::substr($_, 3, 5)='‚³67‚µd'; $_ eq '‚ ‚¢0‚³67‚µd‚¦'  }},
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 121
    ...
    sub { ($] < 5.014) or eval q{ $_='0123456789';    mb::substr($_, -4, 2)='‚³67‚µd'; $_ eq '012345‚³67‚µd89' }},
    sub { ($] < 5.014) or eval q{ $_='‚ ‚¢01abc‚¤‚¦'; mb::substr($_, -5, 4)='‚³67‚µd'; $_ eq '‚ ‚¢01‚³67‚µd‚¦' }},
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 131
    ...
    sub { ($] < 5.014) or eval q{ $_='0123456789';    mb::substr($_, 1, -5)='‚³67‚µd'; $_ eq '0‚³67‚µd56789'    }},
    sub { ($] < 5.014) or eval q{ $_='‚ ‚¢01abc‚¤‚¦'; mb::substr($_, 1, -5)='‚³67‚µd'; $_ eq '‚ ‚³67‚µdabc‚¤‚¦' }},
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 141
    ...
    sub { ($] < 5.014) or eval q{ $_='0123456789';    mb::substr($_, -5, -2)='‚³67‚µd'; $_ eq '01234‚³67‚µd89'    }},
    sub { ($] < 5.014) or eval q{ $_='‚ ‚¢01abc‚¤‚¦'; mb::substr($_, -6, -3)='‚³67‚µd'; $_ eq '‚ ‚¢0‚³67‚µdc‚¤‚¦' }},
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 151
    ...
    sub { ($] < 5.014) or eval q{ $_='0123456789';    mb::substr($_, 3)='ef‚·9‚¹'; $_ eq '012ef‚·9‚¹'   }},
    sub { ($] < 5.014) or eval q{ $_='‚ ‚¢01abc‚¤‚¦'; mb::substr($_, 3)='ef‚·9‚¹'; $_ eq '‚ ‚¢0ef‚·9‚¹' }},
    sub {1},
    sub {1},
    sub {1},
    sub {1},
...
# 161
    ...
    sub { ($] < 5.014) or eval q{ $_='0123456789';    mb::substr($_, -4)='ef‚·9‚¹'; $_ eq '012345ef‚·9‚¹' }},
    sub { ($] < 5.014) or eval q{ $_='‚ ‚¢01abc‚¤‚¦'; mb::substr($_, -5)='ef‚·9‚¹'; $_ eq '‚ ‚¢01ef‚·9‚¹' }},
    sub {1},
    sub {1},
    sub {1},
    sub {1},
