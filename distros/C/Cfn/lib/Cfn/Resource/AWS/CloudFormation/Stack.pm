# AWS::CloudFormation::Stack generated from spec 1.11.0
...
package Cfn::Resource::Properties::AWS::CloudFormation::Stack {
  ...
  has NotificationARNs => (isa => 'Cfn::Value::Array|Cfn::Value::Function', is => 'rw', coerce => 1, traits => [ 'CfnMutability' ], mutability => 'Mutable');
