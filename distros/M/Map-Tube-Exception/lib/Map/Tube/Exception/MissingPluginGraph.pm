...
$Map::Tube::Exception::MissingPluginGraph::VERSION = '3.12';
=head1 NAME
...
has status => (is => 'ro', default => sub { 108 });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Map::Tube::Exception::MissingPluginGraph
...
1; # End of Map::Tube::Exception::MissingPluginGraph
