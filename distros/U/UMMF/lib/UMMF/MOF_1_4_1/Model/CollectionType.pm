...
package UMMF::MOF_1_4_1::Model::CollectionType;
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_4_1::Model::CollectionType->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_4_1::Model::CollectionType|UMMF::MOF_1_4_1::Model::CollectionType>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_4_1::Model::CollectionType')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_4_1::Model::CollectionType->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_4_1::Model::CollectionType->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_4_1::Model::CollectionType' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_4_1::Model::CollectionType|UMMF::MOF_1_4_1::Model::CollectionType>.
...
sub __initialize
{
  ...
  $self->UMMF::MOF_1_4_1::Model::CollectionType::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_4_1::Model::CollectionType::___create(@args);
...
sub set_multiplicity ($$)
{
  ...
  if ( defined $val ) {
    $self->__use('UMMF::MOF_1_4_1::Model::MultiplicityType')->__typecheck($val, "UMMF::MOF_1_4_1::Model::CollectionType.multiplicity");
  }
