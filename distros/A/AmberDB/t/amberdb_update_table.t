...
subtest '1. Format Detection and Legacy Decoding' => sub {
    ...
    is( $adb->detect_tsv_format($r_v1), 'v1', 'Detected 2003 format as v1' );
    ...
    is( $adb->detect_tsv_format($r_v2), 'v2', 'Detected 2005 format as v2' );
    ...
    is( $adb->detect_tsv_format($r_v3), 'v3', 'Detected 2021 format as v3' );
    ...
    is( $adb->detect_tsv_format($r_v4), 'v4', 'Detected 2026 format as v4' );
