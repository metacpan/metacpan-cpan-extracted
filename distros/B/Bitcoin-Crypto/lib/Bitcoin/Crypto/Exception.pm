...
$Bitcoin::Crypto::Exception::Transaction::VERSION = '3.001';
...
$Bitcoin::Crypto::Exception::UTXO::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
...
$Bitcoin::Crypto::Exception::Sign::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
...
$Bitcoin::Crypto::Exception::Verify::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::KeyCreate::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::KeyDerive::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::MnemonicGenerate::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::MnemonicCheck::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::Base58::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::Base58InputFormat::VERSION = '3.001';
...
$Bitcoin::Crypto::Exception::Base58InputChecksum::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception::Base58';
}
...
$Bitcoin::Crypto::Exception::Bech32::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::Bech32InputFormat::VERSION = '3.001';
...
$Bitcoin::Crypto::Exception::Bech32InputData::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception::Bech32';
}
...
$Bitcoin::Crypto::Exception::Bech32InputChecksum::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception::Bech32';
}
...
$Bitcoin::Crypto::Exception::SegwitProgram::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::ScriptType::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::ScriptOpcode::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::ScriptPush::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::ScriptSyntax::VERSION = '3.001';
use Moo;
	use Mooish::AttributeBuilder -standard;
...
$Bitcoin::Crypto::Exception::ScriptRuntime::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::TransactionScript::VERSION = '3.001';
...
$Bitcoin::Crypto::Exception::NetworkCheck::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::NetworkConfig::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::Address::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
...
$Bitcoin::Crypto::Exception::AddressGenerate::VERSION = '3.001';
...
$Bitcoin::Crypto::Exception::PSBT::VERSION = '3.001';
use parent -norequire, 'Bitcoin::Crypto::Exception';
}
