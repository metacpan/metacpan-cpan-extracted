package Chart::Plotly::Trace::Splom::Unselected::Marker;
use Moose;
...
Chart::Plotly::Trace::Splom::Unselected::Marker - This attribute is one of the possible options for the trace splom.
