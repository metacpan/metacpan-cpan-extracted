...
released version of L<Neo4j::Bolt> at time of this writing:
...
The following additional issues currently exist with Bolt, but
L<Neo4j::Bolt> S<version 0.5000> is expected to resolve them:
...
Byte arrays are coded as unblessed strings in Jolt results.
...
=item *
Temporal and spatial values are not supported.
...
=item *
Fields in records containing maps or lists may be returned with
