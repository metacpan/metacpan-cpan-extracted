...
perlobj - обзор родной объектной системы Perl (Perl object reference)

=head1 ОПИСАНИЕ

Этот документ содержит полную справочную информацию по особенностям 
объектно-ориентированного программирования в Perl. Если вы ищете введение в объектно-ориентированное
программирование на Perl, пожалуйста, смотрите L<perlootut>.

Для того чтобы понять Perl объекты необходимо сначала понять что такое
ссылки в Perl. Подробней смотрите в разделе L<perlref>.
