...
1;
# ABSTRACT: Filesystem base directory name on a Unix system
...
Sah::Schema::dirname::unix::basename - Filesystem base directory name on a Unix system

=head1 VERSION

This document describes version 0.031 of Sah::Schema::dirname::unix::basename (from Perl distribution Sah-SchemaBundle-Path), released on 2024-02-16.
...
Used completion: L<dirname_curdir|Perinci::Sub::XCompletion::dirname_curdir>
...
=head2 Sample data and validation results against this schema
 ...
 "foo/bar"  # INVALID (Contains parent directory part)
...
To check data against this schema (requires L<Data::Sah>):
 ...
 my $validator = gen_validator("dirname::unix::basename*");
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("dirname::unix::basename", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("dirname::unix::basename", {return_type=>'str_errmsg+val'});
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("dirname::unix::basename*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"dirname::unix::basename*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('dirname::unix::basename*', name=>'DirnameUnixBasename')
     );
 }

 use My::Types qw(DirnameUnixBasename);
 DirnameUnixBasename->assert_valid($data);
