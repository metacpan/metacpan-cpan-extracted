# -*- perl -*-
##----------------------------------------------------------------------------
## Net/API/Telegram/InlineQueryResultCachedDocument.pm
## Version 0.1
...
##----------------------------------------------------------------------------
package Net::API::Telegram::InlineQueryResultCachedDocument;
BEGIN
{
	use strict;
...
sub document_file_id { return( shift->_set_get_scalar( 'document_file_id', @_ ) ); }
...
Net::API::Telegram::InlineQueryResultCachedDocument - A link to a file stored on the Telegram servers

=head1 SYNOPSIS

	my $msg = Net::API::Telegram::InlineQueryResultCachedDocument->new( %data ) || 
	die( Net::API::Telegram::InlineQueryResultCachedDocument->error, "\n" );

=head1 DESCRIPTION

L<Net::API::Telegram::InlineQueryResultCachedDocument> is a Telegram Message Object as defined here L<https://core.telegram.org/bots/api#inlinequeryresultcacheddocument>
