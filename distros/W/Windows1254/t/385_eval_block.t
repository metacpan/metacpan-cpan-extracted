...
# eval {...} has eval "..."
if (eval { eval Windows1254::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } " }) {
...
# eval {...} has eval qq{...}
if (eval { eval Windows1254::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } }) {
...
# eval {...} has eval '...'
if (eval { eval Windows1254::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } ' }) {
...
# eval {...} has eval q{...}
if (eval { eval Windows1254::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } }) {
...
if (eval { eval Windows1254::escape $var }) {
...
if (eval { eval Windows1254::escape }) {
