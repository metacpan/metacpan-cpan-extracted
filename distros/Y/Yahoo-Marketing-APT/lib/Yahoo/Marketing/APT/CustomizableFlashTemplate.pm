package Yahoo::Marketing::APT::CustomizableFlashTemplate;
...
Yahoo::Marketing::APT::CustomizableFlashTemplate - a data object to represent a CustomizableFlashTemplate.
