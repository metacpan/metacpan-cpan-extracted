...
$PMLTQ::PML2BASE::Relation::Treex::TEParentIterator::VERSION = '3.0.1';
...
PMLTQ::PML2BASE::Relation::Treex::TEParentIterator - Effective parent relation iterator on t-nodes for Treex treebanks
