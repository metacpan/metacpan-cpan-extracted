...
This document describes version 0.077 of Sah::Schema::int8 (from Perl distribution Sah-Schemas-Int), released on 2022-10-19.
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("int8", {return_type=>'str_errmsg'});
...
prefiltered) value:
 ...
 my $validator = gen_validator("int8", {return_type=>'str_errmsg+val'});
...
To create a type constraint and type library from a schema:
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('$sch_name*', name=>'Int8')
     );
 }

 use My::Types qw(Int8);
 Int8->assert_valid($data);
...
L<Types::CLike> - Equivalent Type::Tiny constraints: SByte, SOctet, TinyInt, Int8, Signed8

L<Types::XSD> - Equivalent Type::Tiny constraints: Byte
