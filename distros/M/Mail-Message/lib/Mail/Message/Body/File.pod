...
=item Mail::Message::Body::File-E<gt>B<charsetDetectAlgorithm>( [CODE|undef|METHOD] )
...
=item Error: Cannot write to temporary body file $filename: $!
...
=item Error: Unable to read file $filename for message body file: $!
