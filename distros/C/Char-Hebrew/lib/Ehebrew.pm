...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Ehebrew::re_t=%s; while($Ehebrew::re_t =~ %s){%s local $^W=0; local $Ehebrew::re_r=%s; %s$Ehebrew::re_t="$`$Ehebrew::re_r$'"; pos($Ehebrew::re_t)=length "$`$Ehebrew::re_r"; } return $Ehebrew::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Ehebrew::re_r=CORE::eval $Ehebrew::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Ehebrew::re_r=%s; %s"%s$Ehebrew::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Ehebrew::re_n=0; while(%s =~ %s){%s local $^W=0; local $Ehebrew::re_r=%s; %s%s="$`$Ehebrew::re_r$'"; pos(%s)=length "$`$Ehebrew::re_r"; $Ehebrew::re_n++} return %s$Ehebrew::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Ehebrew::re_r=%s; %s%s="%s$Ehebrew::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Ehebrew::re_r=%s; %s%s="%s$Ehebrew::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Ehebrew::re_r=CORE::eval $Ehebrew::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
