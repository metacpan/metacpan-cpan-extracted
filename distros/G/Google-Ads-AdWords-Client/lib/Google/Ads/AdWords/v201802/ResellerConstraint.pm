package Google::Ads::AdWords::v201802::ResellerConstraint;
use strict;
use warnings;
...
Google::Ads::AdWords::v201802::ResellerConstraint

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ResellerConstraint from the namespace https://adwords.google.com/api/adwords/cm/v201802.
