...
Sah::SchemaR::date::month_num::en_or_id - Month number (1-12), coercible from English/Indonesian full/abbreviated name (Dec/Des/DECEMBER/DESEMber), e.g. 1 or "may" or "agu"

=head1 VERSION

This document describes version 0.008 of Sah::SchemaR::date::month_num::en_or_id (from Perl distribution Sah-Schemas-Date-ID), released on 2022-10-20.
