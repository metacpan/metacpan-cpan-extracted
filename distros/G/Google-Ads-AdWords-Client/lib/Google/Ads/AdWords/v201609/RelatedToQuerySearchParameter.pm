package Google::Ads::AdWords::v201609::RelatedToQuerySearchParameter;
use strict;
use warnings;
...
RelatedToQuerySearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201609.
