...
$Search::Elasticsearch::Client::1_0::Async::Bulk::VERSION = '5.02';
use Moo;
...
#===================================
    ...
    elsif ( blessed($src) && $src->isa('Search::Elasticsearch::Client::1_0::Scroll') ) {
        my $scroll = $src;
        $src = sub {
    ...
    # async scroll
    if ( blessed($src) && $src->isa('Search::Elasticsearch::Client::1_0::Async::Scroll') ) {
        $promise = $src->start;
    }
    else {
...
Search::Elasticsearch::Client::1_0::Async::Bulk - A helper module for the Bulk API and for reindexing
...
The L<Search::Elasticsearch::Client::1_0::Async::Bulk> module acts as a queue, buffering up actions
...
This class does L<Search::Elasticsearch::Client::1_0::Role::Bulk> and
...
The C<bulk_helper> method loads L<Search::Elasticsearch::Client::1_0::Async::Bulk>,
...
L<Search::Elasticsearch::Client::1_0::Direct/update()>.
...
combines bulk indexing with L<scrolled searches|Search::Elasticsearch::Client::1_0::Scroll>:
...
L<Search::Elasticsearch::Client::1_0::Async::Scroll/new()> to create a new scrolled search.
