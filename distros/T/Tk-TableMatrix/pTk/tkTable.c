...
static CONST char *selCmdNames[] = {
    "anchor", "clear", "includes", "present", "set",          NULL
};
enum selCommand {
...
Tk_ConfigSpec tableSpecs[] = {
    ...
    {TK_CONFIG_SYNONYM, "-browsecmd", "browseCommand",          NULL,
    ...
    {TK_CONFIG_SYNONYM, "-selcmd", "selectionCommand",          NULL,
              NULL, 0, TK_CONFIG_NULL_OK},
    ...
    {TK_CONFIG_SCALARVAR, "-variable", "variable", "Variable",          NULL,
    ...
    {TK_CONFIG_SYNONYM, "-vcmd", "validateCommand",          NULL,
              NULL, 0, TK_CONFIG_NULL_OK},
...
static CONST char *updateOpts[] = {
    ...
    "-xscrollcommand",	"-yscrollcommand",          NULL
};
    ...
    Tcl_Obj *CONST objv[];	/* Argument objects. */
{
    ...
    *(tablePtr->activeBuf)	= '\0';
	...
	tablePtr->tagPrioNames[offset] =          NULL;
     ...
     Tcl_Obj * CONST objv[];	        /* Argument objects. */
{
	...
	case CMD_VALIDATE:
		...
		i = tablePtr->validate;
		tablePtr->validate = 1;
		result = TableValidateChange(tablePtr, row, col,          NULL,
			         NULL, -1);
		tablePtr->validate = i;
		Tcl_SetBooleanObj(Tcl_GetObjResult(interp),
			(result == TCL_OK));
				 ...
				 * for initial configuration */
{
    ...
    /* objv = StringifyObjects(objc, objv); */ /* Don't Need this because arrays of Args like arrays of Obj?? */
