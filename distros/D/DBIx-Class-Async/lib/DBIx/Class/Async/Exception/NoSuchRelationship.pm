...
$DBIx::Class::Async::Exception::NoSuchRelationship::VERSION   = '0.64';
...
DBIx::Class::Async::Exception::NoSuchRelationship - Exception for undeclared
relationship names used in queries
...
=head1 SYNOPSIS
    ...
    DBIx::Class::Async::Exception::NoSuchRelationship->throw(
        message      => "[DBIx::Class::Async] No relationship 'Widgets' on My::Schema::Result::Operation",
        relationship => 'Widgets',
        source_class => 'My::Schema::Result::Operation',
        hint         => "Check that 'Widgets' is declared with has_many(), belongs_to(), "
                      . "or might_have() on My::Schema::Result::Operation.",
    );

    use Try::Tiny;
    try { ... } catch {
        if ( ref $_ && $_->isa('DBIx::Class::Async::Exception::NoSuchRelationship') ) {
            warn "Unknown relationship '" . $_->relationship . "': " . $_->hint;
        }
    };

=head1 DESCRIPTION

Thrown when a relationship name referenced in a query attribute such as
C<join>, C<prefetch>, or C<has_many> is not declared on the result source.
...
=head2 relationship
    ...
    my $rel = $exception->relationship;

The relationship name that was not found on the source, e.g. C<'Widgets'>.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc DBIx::Class::Async::Exception::NoSuchRelationship
...
1; # End of DBIx::Class::Async::Exception::NoSuchRelationship
