package Shipment::FedEx::WSDL::RateTypes::Localization;
$Shipment::FedEx::WSDL::RateTypes::Localization::VERSION = '3.06';
use strict;
use warnings;
...
Localization from the namespace http://fedex.com/ws/rate/v9.
