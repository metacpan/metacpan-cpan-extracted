package Google::Ads::AdWords::v201705::SeedAdGroupIdSearchParameter;
use strict;
use warnings;
...
SeedAdGroupIdSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201705.
