...
static asn_per_constraints_t asn_PER_type_SubscriberIdentity_constr_1 = {
...
static asn_TYPE_tag2member_t asn_MAP_SubscriberIdentity_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* imsi at 402 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* msisdn at 404 */
};
...
asn_TYPE_descriptor_t asn_DEF_SubscriberIdentity = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_SubscriberIdentity_constr_1,
