# This Makefile is for the Oracle::DDL extension to perl.
#
...
#	ABSTRACT => q[Perl class for Oracle batch DML]
#	AUTHOR => q[geotiger2001@yahoo.com]
#	DISTNAME => q[Oracle-DDL-0.10.tar.gz]
#	NAME => q[Oracle::DDL]
#	PREREQ_PM => { Test::Harness=>q[0.1], Test::More=>q[0.45] }
#	VERSION => q[0.1]
#	test => { TESTS=>q[t/DDL.t] }
...
AR_STATIC_ARGS = cr
NAME = Oracle::DDL
DISTNAME = Oracle-DDL-0.10.tar.gz
NAME_SYM = Oracle_DDL
VERSION = 0.1
VERSION_SYM = 0_1
XS_VERSION = 0.1
...
manifypods : pure_all DDL.pm
	@$(POD2MAN) \
	DDL.pm \
	$(INST_MAN3DIR)/Oracle::DDL.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Oracle-DDL-0.10.tar.gz\" VERSION=\"0,1,0,0\">\n}. qq{\t<TITLE>Oracle-DDL-0.10.tar.gz</TITLE>\n}. qq{\t<ABSTRACT>Perl class for Oracle batch DML</ABSTRACT>\n}. qq{\t<AUTHOR>geotiger2001\@yahoo.com</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"Test-Harness\" VERSION=\"0,1,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Test-More\" VERSION=\"0,45,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"sun4-solaris-64int\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Oracle-DDL-0.10.tar.gz.ppd
