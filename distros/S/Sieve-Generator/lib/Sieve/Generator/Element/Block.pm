...
#pod conditionals, or comments -- each rendered on its own indented line.
#pod
#pod =attr things
#pod
#pod This attribute holds the list of things that make up the block body.  Each
#pod may be an object doing L<Sieve::Generator::Element>.
#pod
#pod =cut
...
Sieve::Generator::Element::Block - a Sieve block (a brace-delimited sequence of statements)
