...
package Meta::Baseline::Lang::Cook;
...
Meta::Baseline::Lang::Cook - language for cook files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Cook::env();

=head1 DESCRIPTION

This package contains stuff specific to Cook in the baseline:
Its mainly here to authorize entries of cook files to the baseline.
