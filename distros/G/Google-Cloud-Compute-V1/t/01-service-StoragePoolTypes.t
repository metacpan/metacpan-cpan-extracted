...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::StoragePoolType Google::Cloud::Compute::V1::Compute::StoragePoolTypeAggregatedList Google::Cloud::Compute::V1::Compute::StoragePoolTypeList )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::StoragePoolTypesClient->new( credentials => 'dummy' );
