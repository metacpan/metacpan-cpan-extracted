package Chart::Plotly::Trace::Histogram2dcontour::Textfont;
use Moose;
...
has description => (
               is      => "ro",
               default => "For this trace it only has an effect if `coloring` is set to *heatmap*. Sets the text font.",
);
...
Chart::Plotly::Trace::Histogram2dcontour::Textfont - This attribute is one of the possible options for the trace histogram2dcontour.
