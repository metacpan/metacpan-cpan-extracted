...
package Prty::Database::Connection::Test;
...
sub test_new_startup : Startup(8) {
    ...
    my $db = Prty::Database::Connection->new($udl,-utf8=>1,-log=>1);
    $self->is(ref($db),'Prty::Database::Connection');
    $self->set(db=>$db);
    ...
    use Prty::Database::Row::Object::Table;
    Prty::Perl->createClass($PersonClass,
        'Prty::Database::Row::Object::Table');
...
sub test_dbExists : Shutdown(1) {
    ...
    my $bool = Prty::Database::Connection->dbExists($udl);
    $self->ok($bool);
...
sub test_select_table : Test(1) {
    ...
    $self->is(ref($tab),'Prty::Database::ResultSet::Object');
}
...
sub test_select_tableClass : Test(3) {
    ...
    Prty::Perl->createClass($personClassTable,
...
sub test_renameColumn : Test(2) {
    ...
    $self->isTest(ref($cur),'Prty::Database::Cursor');
...
package main;
Prty::Database::Connection::Test->runTests;
