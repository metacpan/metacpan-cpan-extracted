...
XAS::Model::Database::Messaging::Result::Alert - A Table for XAS Model
...
Wither the alert has been cleared.

=over 4

=item B<data type> - boolean
 
=item B<default value> - false
...
The date and time that it was cleared.
