...
=item * C<GET> - List assistants


=item * C<POST> - Create assistant
...
=item * C<DELETE> - Delete assistant


=item * C<GET> - Retrieve assistant


=item * C<POST> - Modify assistant
...
=item * C<POST> - Create transcription
...
=item * C<POST> - Create translation
...
=head2 C</audio/voice_consents>

=over

=item * C<GET> - List voice consents


=item * C<POST> - Create voice consent


=back

See L<OpenAPI::Client::OpenAI::Path::audio-voice_consents> for more details.

=head2 C</audio/voice_consents/{consent_id}>

=over

=item * C<DELETE> - Delete voice consent


=item * C<GET> - Retrieve voice consent


=item * C<POST> - Update voice consent


=back

See L<OpenAPI::Client::OpenAI::Path::audio-voice_consents-consent_id> for more details.

=head2 C</audio/voices>

=over

=item * C<POST> - Create voice


=back

See L<OpenAPI::Client::OpenAI::Path::audio-voices> for more details.

=head2 C</batches>

=over

=item * C<GET> - List batch


=item * C<POST> - Create batch
...
=item * C<GET> - List Chat Completions


=item * C<POST> - Create chat completion
...
=item * C<DELETE> - Delete chat completion


=item * C<GET> - Get chat completion


=item * C<POST> - Update chat completion
...
=head2 C</chatkit/sessions>

=over

=item * C<POST> - Create ChatKit session


=back

See L<OpenAPI::Client::OpenAI::Path::chatkit-sessions> for more details.

=head2 C</chatkit/sessions/{session_id}/cancel>

=over

=item * C<POST> - Cancel chat session


=back

See L<OpenAPI::Client::OpenAI::Path::chatkit-sessions-session_id-cancel> for more details.

=head2 C</chatkit/threads>

=over

=item * C<GET> - List ChatKit threads


=back

See L<OpenAPI::Client::OpenAI::Path::chatkit-threads> for more details.

=head2 C</chatkit/threads/{thread_id}>

=over

=item * C<DELETE> - Delete ChatKit thread


=item * C<GET> - Retrieve ChatKit thread


=back

See L<OpenAPI::Client::OpenAI::Path::chatkit-threads-thread_id> for more details.

=head2 C</chatkit/threads/{thread_id}/items>

=over

=item * C<GET> - List ChatKit thread items


=back

See L<OpenAPI::Client::OpenAI::Path::chatkit-threads-thread_id-items> for more details.

=head2 C</completions>

=over

=item * C<POST> - Create completion
...
=item * C<DELETE> - Delete a container
...
=item * C<POST> - Create container file
...
=item * C<DELETE> - Delete a container file
...
=head2 C</conversations>

=over

=item * C<POST> - Create a conversation


=back

See L<OpenAPI::Client::OpenAI::Path::conversations> for more details.

=head2 C</conversations/{conversation_id}>

=over

=item * C<DELETE> - Delete a conversation


=item * C<GET> - Retrieve a conversation


=item * C<POST> - Update a conversation


=back

See L<OpenAPI::Client::OpenAI::Path::conversations-conversation_id> for more details.

=head2 C</conversations/{conversation_id}/items>

=over

=item * C<GET> - List items


=item * C<POST> - Create items


=back

See L<OpenAPI::Client::OpenAI::Path::conversations-conversation_id-items> for more details.

=head2 C</conversations/{conversation_id}/items/{item_id}>

=over

=item * C<DELETE> - Delete an item


=item * C<GET> - Retrieve an item


=back

See L<OpenAPI::Client::OpenAI::Path::conversations-conversation_id-items-item_id> for more details.

=head2 C</embeddings>

=over

=item * C<POST> - Create embeddings
...
=item * C<GET> - List evals


=item * C<POST> - Create eval
...
=item * C<DELETE> - Delete an eval


=item * C<GET> - Get an eval


=item * C<POST> - Update an eval
...
=item * C<GET> - Get eval runs


=item * C<POST> - Create eval run
...
=item * C<DELETE> - Delete eval run


=item * C<GET> - Get an eval run


=item * C<POST> - Cancel eval run
...
=item * C<GET> - Get eval run output items
...
=item * C<GET> - Get an output item of an eval run
...
=item * C<GET> - List files


=item * C<POST> - Upload file
...
=item * C<DELETE> - Delete file


=item * C<GET> - Retrieve file
...
=item * C<GET> - Retrieve file content
...
=item * C<GET> - List checkpoint permissions


=item * C<POST> - Create checkpoint permissions
...
=item * C<DELETE> - Delete checkpoint permission
...
=item * C<GET> - List fine-tuning jobs


=item * C<POST> - Create fine-tuning job
...
=item * C<GET> - Retrieve fine-tuning job
...
=item * C<POST> - Cancel fine-tuning
...
=item * C<GET> - List fine-tuning checkpoints
...
=item * C<GET> - List fine-tuning events
...
=item * C<POST> - Resume fine-tuning
...
=item * C<POST> - Create image variation
...
=item * C<DELETE> - Delete a fine-tuned model


=item * C<GET> - Retrieve model
...
=item * C<GET> - List all organization and project API keys.


=item * C<POST> - Create admin API key
...
=item * C<DELETE> - Delete admin API key


=item * C<GET> - Retrieve admin API key
...
=item * C<GET> - List organization certificates


=item * C<POST> - Upload certificate
...
=item * C<POST> - Activate certificates for organization
...
=item * C<POST> - Deactivate certificates for organization
...
=item * C<DELETE> - Delete certificate


=item * C<GET> - Get certificate


=item * C<POST> - Modify certificate
...
=head2 C</organization/groups>

=over

=item * C<GET> - List groups


=item * C<POST> - Create group


=back

See L<OpenAPI::Client::OpenAI::Path::organization-groups> for more details.

=head2 C</organization/groups/{group_id}>

=over

=item * C<DELETE> - Delete group


=item * C<POST> - Update group


=back

See L<OpenAPI::Client::OpenAI::Path::organization-groups-group_id> for more details.

=head2 C</organization/groups/{group_id}/roles>

=over

=item * C<GET> - List group organization role assignments


=item * C<POST> - Assign organization role to group


=back

See L<OpenAPI::Client::OpenAI::Path::organization-groups-group_id-roles> for more details.

=head2 C</organization/groups/{group_id}/roles/{role_id}>

=over

=item * C<DELETE> - Unassign organization role from group


=back

See L<OpenAPI::Client::OpenAI::Path::organization-groups-group_id-roles-role_id> for more details.

=head2 C</organization/groups/{group_id}/users>

=over

=item * C<GET> - List group users


=item * C<POST> - Add group user


=back

See L<OpenAPI::Client::OpenAI::Path::organization-groups-group_id-users> for more details.

=head2 C</organization/groups/{group_id}/users/{user_id}>

=over

=item * C<DELETE> - Remove group user


=back

See L<OpenAPI::Client::OpenAI::Path::organization-groups-group_id-users-user_id> for more details.

=head2 C</organization/invites>

=over

=item * C<GET> - List invites


=item * C<POST> - Create invite
...
=item * C<DELETE> - Delete invite


=item * C<GET> - Retrieve invite
...
=item * C<GET> - List projects


=item * C<POST> - Create project
...
=item * C<GET> - Retrieve project


=item * C<POST> - Modify project
...
=item * C<GET> - List project API keys
...
=item * C<DELETE> - Delete project API key


=item * C<GET> - Retrieve project API key
...
=item * C<GET> - List project certificates
...
=item * C<POST> - Activate certificates for project
...
=item * C<POST> - Deactivate certificates for project
...
=head2 C</organization/projects/{project_id}/groups>

=over

=item * C<GET> - List project groups


=item * C<POST> - Add project group


=back

See L<OpenAPI::Client::OpenAI::Path::organization-projects-project_id-groups> for more details.

=head2 C</organization/projects/{project_id}/groups/{group_id}>

=over

=item * C<DELETE> - Remove project group


=back

See L<OpenAPI::Client::OpenAI::Path::organization-projects-project_id-groups-group_id> for more details.

=head2 C</organization/projects/{project_id}/rate_limits>

=over

=item * C<GET> - List project rate limits
...
=item * C<POST> - Modify project rate limit
...
=item * C<GET> - List project service accounts


=item * C<POST> - Create project service account
...
=item * C<DELETE> - Delete project service account


=item * C<GET> - Retrieve project service account
...
=item * C<GET> - List project users


=item * C<POST> - Create project user
...
=item * C<DELETE> - Delete project user


=item * C<GET> - Retrieve project user


=item * C<POST> - Modify project user
...
=head2 C</organization/roles>

=over

=item * C<GET> - List organization roles


=item * C<POST> - Create organization role


=back

See L<OpenAPI::Client::OpenAI::Path::organization-roles> for more details.

=head2 C</organization/roles/{role_id}>

=over

=item * C<DELETE> - Delete organization role


=item * C<POST> - Update organization role


=back

See L<OpenAPI::Client::OpenAI::Path::organization-roles-role_id> for more details.

=head2 C</organization/usage/audio_speeches>

=over

=item * C<GET> - Audio speeches
...
=item * C<GET> - Audio transcriptions
...
=item * C<GET> - Code interpreter sessions
...
=item * C<DELETE> - Delete user


=item * C<GET> - Retrieve user


=item * C<POST> - Modify user
...
=head2 C</organization/users/{user_id}/roles>

=over

=item * C<GET> - List user organization role assignments


=item * C<POST> - Assign organization role to user


=back

See L<OpenAPI::Client::OpenAI::Path::organization-users-user_id-roles> for more details.

=head2 C</organization/users/{user_id}/roles/{role_id}>

=over

=item * C<DELETE> - Unassign organization role from user


=back

See L<OpenAPI::Client::OpenAI::Path::organization-users-user_id-roles-role_id> for more details.

=head2 C</projects/{project_id}/groups/{group_id}/roles>

=over

=item * C<GET> - List project group role assignments


=item * C<POST> - Assign project role to group


=back

See L<OpenAPI::Client::OpenAI::Path::projects-project_id-groups-group_id-roles> for more details.

=head2 C</projects/{project_id}/groups/{group_id}/roles/{role_id}>

=over

=item * C<DELETE> - Unassign project role from group


=back

See L<OpenAPI::Client::OpenAI::Path::projects-project_id-groups-group_id-roles-role_id> for more details.

=head2 C</projects/{project_id}/roles>

=over

=item * C<GET> - List project roles


=item * C<POST> - Create project role


=back

See L<OpenAPI::Client::OpenAI::Path::projects-project_id-roles> for more details.

=head2 C</projects/{project_id}/roles/{role_id}>

=over

=item * C<DELETE> - Delete project role


=item * C<POST> - Update project role


=back

See L<OpenAPI::Client::OpenAI::Path::projects-project_id-roles-role_id> for more details.

=head2 C</projects/{project_id}/users/{user_id}/roles>

=over

=item * C<GET> - List project user role assignments


=item * C<POST> - Assign project role to user


=back

See L<OpenAPI::Client::OpenAI::Path::projects-project_id-users-user_id-roles> for more details.

=head2 C</projects/{project_id}/users/{user_id}/roles/{role_id}>

=over

=item * C<DELETE> - Unassign project role from user


=back

See L<OpenAPI::Client::OpenAI::Path::projects-project_id-users-user_id-roles-role_id> for more details.

=head2 C</realtime/calls>

=over

=item * C<POST> - Create call


=back

See L<OpenAPI::Client::OpenAI::Path::realtime-calls> for more details.

=head2 C</realtime/calls/{call_id}/accept>

=over

=item * C<POST> - Accept call


=back

See L<OpenAPI::Client::OpenAI::Path::realtime-calls-call_id-accept> for more details.

=head2 C</realtime/calls/{call_id}/hangup>

=over

=item * C<POST> - Hang up call


=back

See L<OpenAPI::Client::OpenAI::Path::realtime-calls-call_id-hangup> for more details.

=head2 C</realtime/calls/{call_id}/refer>

=over

=item * C<POST> - Refer call


=back

See L<OpenAPI::Client::OpenAI::Path::realtime-calls-call_id-refer> for more details.

=head2 C</realtime/calls/{call_id}/reject>

=over

=item * C<POST> - Reject call


=back

See L<OpenAPI::Client::OpenAI::Path::realtime-calls-call_id-reject> for more details.

=head2 C</realtime/client_secrets>

=over

=item * C<POST> - Create client secret


=back

See L<OpenAPI::Client::OpenAI::Path::realtime-client_secrets> for more details.

=head2 C</realtime/sessions>

=over

=item * C<POST> - Create session
...
=item * C<POST> - Create transcription session
...
=item * C<POST> - Create a model response
...
=head2 C</responses/compact>

=over

=item * C<POST> - Compact a response


=back

See L<OpenAPI::Client::OpenAI::Path::responses-compact> for more details.

=head2 C</responses/input_tokens>

=over

=item * C<POST> - Get input token counts


=back

See L<OpenAPI::Client::OpenAI::Path::responses-input_tokens> for more details.

=head2 C</responses/{response_id}>

=over

=item * C<DELETE> - Delete a model response


=item * C<GET> - Get a model response
...
=item * C<POST> - Create thread and run
...
=item * C<DELETE> - Delete thread


=item * C<GET> - Retrieve thread


=item * C<POST> - Modify thread
...
=item * C<GET> - List messages


=item * C<POST> - Create message
...
=item * C<DELETE> - Delete message


=item * C<GET> - Retrieve message


=item * C<POST> - Modify message
...
=item * C<GET> - List runs


=item * C<POST> - Create run
...
=item * C<GET> - Retrieve run


=item * C<POST> - Modify run
...
=item * C<POST> - Submit tool outputs to run
...
=item * C<GET> - List vector stores


=item * C<POST> - Create vector store
...
=item * C<DELETE> - Delete vector store


=item * C<GET> - Retrieve vector store


=item * C<POST> - Modify vector store
...
=item * C<POST> - Create vector store file batch
...
=item * C<GET> - Retrieve vector store file batch
...
=item * C<POST> - Cancel vector store file batch
...
=item * C<GET> - List vector store files in a batch
...
=item * C<GET> - List vector store files


=item * C<POST> - Create vector store file
...
=item * C<DELETE> - Delete vector store file


=item * C<GET> - Retrieve vector store file


=item * C<POST> - Update vector store file attributes
...
=item * C<GET> - Retrieve vector store file content
...
=item * C<POST> - Search vector store
...
=item * C<GET> - List videos


=item * C<POST> - Create video


=back

See L<OpenAPI::Client::OpenAI::Path::videos> for more details.

=head2 C</videos/{video_id}>

=over

=item * C<DELETE> - Delete video


=item * C<GET> - Retrieve video


=back

See L<OpenAPI::Client::OpenAI::Path::videos-video_id> for more details.

=head2 C</videos/{video_id}/content>

=over

=item * C<GET> - Retrieve video content


=back

See L<OpenAPI::Client::OpenAI::Path::videos-video_id-content> for more details.

=head2 C</videos/{video_id}/remix>

=over

=item * C<POST> - Remix video


=back

See L<OpenAPI::Client::OpenAI::Path::videos-video_id-remix> for more details.
