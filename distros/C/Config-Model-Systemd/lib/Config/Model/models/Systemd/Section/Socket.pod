...
/proc and
/sys. I< Optional. Type list of uniline.  > 
...
Takes a one of C<udplite>
or C<sctp>. Specifies a socket protocol
(C<IPPROTO_UDPLITE>) UDP-Lite
(C<IPPROTO_SCTP>) SCTP socket respectively. I< Optional. Type uniline.  > 

=head2 BindIPv6Only

Takes a one of C<default>,
...
C<both>. I< Optional. Type uniline.  > 
...
For SOCK_RAW, the port is the IP protocol. I< Optional. Type boolean.  > 
...
seconds. I< Optional. Type integer.  > 
...
are understood to the base of 1024. I< Optional. Type uniline.  > 
...
option. See
L<socket(7)>
for details. I< Optional. Type boolean.  > 
...
to stream sockets. I< Optional. Type uniline.  > 
