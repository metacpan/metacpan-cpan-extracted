...
my $color = new_ok 'SFML::Graphics::RenderStates';

can_ok($color, qw(getBlendMode setBlendMode getTransform setTransform getTexture setTexture getShader setShader));
