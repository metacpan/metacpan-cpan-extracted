...
static int asn_MAP_BusySubscriberParam_oms_1[] = { 0, 1, 2 };
static ber_tlv_tag_t asn_DEF_BusySubscriberParam_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_BusySubscriberParam_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 0 }, /* extensionContainer at 282 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 1, 0, 0 }, /* ccbs-Possible at 284 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 2, 0, 0 } /* ccbs-Busy at 285 */
};
static asn_SEQUENCE_specifics_t asn_SPC_BusySubscriberParam_specs_1 = {
	...
	asn_MAP_BusySubscriberParam_oms_1,	/* Optional members */
	1, 2,	/* Root/Additions */
	0,	/* Start extensions */
	4	/* Stop extensions */
};
