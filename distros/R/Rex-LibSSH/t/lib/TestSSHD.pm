...
sub start {
    ...
    # [host]:port form libssh expects for a non-22 port. Tests that want the
    # strict default to succeed point at this file; a test wanting an
    # unknown or changed key builds its own from host_key_pub instead.
    {
