...
# Data sources:
# <https://web.archive.org/web/20160109235411/http://spdx.org:80/licenses>
# <https://web.archive.org/web/20160127115045/https://spdx.org/licenses/exceptions-index.html>

like(
	license_org_metadata( 'spdx', { date => '20160103', rev => '2_3' } ),
	hash {
...
# TODO		field 'Open CASCADE Exception 1.0'      => 'OCCT-exception-1.0';
	...
	'coverage of SPDX 2.3, released 2016-01-03'
);
