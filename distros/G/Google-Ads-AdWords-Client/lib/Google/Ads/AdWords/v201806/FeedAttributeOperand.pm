package Google::Ads::AdWords::v201806::FeedAttributeOperand;
use strict;
use warnings;
...
Google::Ads::AdWords::v201806::FeedAttributeOperand

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedAttributeOperand from the namespace https://adwords.google.com/api/adwords/cm/v201806.
