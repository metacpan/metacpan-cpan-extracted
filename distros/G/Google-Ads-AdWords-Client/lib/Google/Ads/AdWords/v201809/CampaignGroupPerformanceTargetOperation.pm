package Google::Ads::AdWords::v201809::CampaignGroupPerformanceTargetOperation;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'operand' => 'Google::Ads::AdWords::v201809::CampaignGroupPerformanceTarget',
    },
    {
...
Google::Ads::AdWords::v201809::CampaignGroupPerformanceTargetOperation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignGroupPerformanceTargetOperation from the namespace https://adwords.google.com/api/adwords/cm/v201809.
