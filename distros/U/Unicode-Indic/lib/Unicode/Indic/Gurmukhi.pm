...
my $Map = {
  ...
  r	=>	chr(U+0x30),
  s	=>	chr(U+0x38),
  sh	=>	chr(U+0x36), #==> U+0x37 is reserved.
  t	=>	chr(U+0x24),
  th	=>	chr(U+0x25),
  u	=>	chr(U+0x41),
  uu	=>	chr(U+0x42),
  ...
  '~m'	=>	chr(U+0x19),
  '~n'	=>	chr(U+0x1e),
  '~r'	=>	chr(U+0x30), #==> U+0x31 is reserved.
  virama=>	chr(U+0x4d),
  base  =>      chr(U),
};
...
=head1	NAME
	...
	Unicode::Indic::Gurmukhi -Perl module for the Gurmukhi language.

=head1	SYNOPSIS

	use Unicode::Indic::Gurmukhi;

=head1	DESCRIPTION

	This perl module is used for transliteration of text from qwerty keyboard characters to Unicode Gurmukhi font characters and versa.
