...
Sah::Schema::perl::arraydata::modnames - Array of Perl ArrayData::* module names without the prefix, e.g. ["Lingua::Word::ID::KBBI", "Number::Prime::First1000"]

=head1 VERSION

This document describes version 0.005 of Sah::Schema::perl::arraydata::modnames (from Perl distribution Sah-SchemaBundle-ArrayData), released on 2024-02-16.
...
valid, a non-empty error message otherwise):
 ...
 my $validator = gen_validator("perl::arraydata::modnames", {return_type=>'str_errmsg'});
...
(set-as-default, coerced, prefiltered) value:
 ...
 my $validator = gen_validator("perl::arraydata::modnames", {return_type=>'str_errmsg+val'});
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::arraydata::modnames*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::arraydata::modnames*', name=>'PerlArraydataModnames')
     );
 }

 use My::Types qw(PerlArraydataModnames);
 PerlArraydataModnames->assert_valid($data);
