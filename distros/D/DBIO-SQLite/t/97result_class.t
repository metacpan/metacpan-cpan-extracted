...

{
  ...
  $rs->result_class('DBIO::Test::Artist');
  is ($rs->result_class, 'DBIO::Test::Artist', 'resultclass changed');

  my $art = $rs->next;
  is (ref $art, 'DBIO::Test::Artist', 'Correcty blessed output');
  ...
  is( ref $cds->next, 'DBIO::Test::CD', 'Correctly inflated prefetched result');
}
