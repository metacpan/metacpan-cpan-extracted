...
See L<Config::MorePerl> for synopsis of config files.
...
This plugin automatically processes configs via L<Config::MorePerl>'s C<process> passing C<local.conf> as starting config file if
...
This plugin passes C<MyApp->config> as an initial config for L<Config::MorePerl>'s C<process>.
