...
This document describes Attean::API::Plan version 0.039
...
package Attean::API::BindingSubstitutionPlan 0.039 {
	use Moo::Role;
...
package Attean::API::UnionScopeVariablesPlan 0.039 {
	use Moo::Role;
...
package Attean::API::Plan::Join 0.039 {
