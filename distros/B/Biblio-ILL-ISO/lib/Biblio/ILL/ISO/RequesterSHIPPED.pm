package Biblio::ILL::ISO::RequesterSHIPPED;
...
Biblio::ILL::ISO::RequesterSHIPPED is a derivation of Biblio::ILL::ISO::ENUMERATED.
...
=head2 new( $s )
 ...
 Creates a new RequesterSHIPPED object. 
...
sub new {
	...
	if ( exists $self->{"ENUM_LIST"}->{$s} ) {
	    ...
	    croak "invalid RequesterSHIPPED type: [$s]";
	}
    }
