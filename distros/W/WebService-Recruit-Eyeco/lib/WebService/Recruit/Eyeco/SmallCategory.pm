package WebService::Recruit::Eyeco::SmallCategory;
...
sub url { 'http://webservice.recruit.co.jp/eyeco/small_category/v1/'; }

sub query_class { 'WebService::Recruit::Eyeco::SmallCategory::Query'; }
...
sub elem_class { 'WebService::Recruit::Eyeco::SmallCategory::Element'; }
...
@WebService::Recruit::Eyeco::SmallCategory::Query::ISA = qw( Class::Accessor::Fast );
WebService::Recruit::Eyeco::SmallCategory::Query->mk_accessors( @{query_fields()} );

# __PACKAGE__->mk_elem_accessors();

@WebService::Recruit::Eyeco::SmallCategory::Element::ISA = qw( Class::Accessor::Children::Fast );
WebService::Recruit::Eyeco::SmallCategory::Element->mk_ro_accessors( root_elem() );
WebService::Recruit::Eyeco::SmallCategory::Element->mk_child_ro_accessors( %{elem_fields()} );

=head1 NAME

WebService::Recruit::Eyeco::SmallCategory - Eyeco Web Service "small_category" API
