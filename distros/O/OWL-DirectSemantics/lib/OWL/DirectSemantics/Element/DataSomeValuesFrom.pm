package OWL::DirectSemantics::Element::DataSomeValuesFrom;
...
OWL::DirectSemantics::Element::DataSomeValuesFrom - represents an OWL DataSomeValuesFrom

=head1 DESCRIPTION

This class represents the DataSomeValuesFrom element in OWL Direct Semantics.
