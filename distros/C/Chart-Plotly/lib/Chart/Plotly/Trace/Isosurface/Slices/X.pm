package Chart::Plotly::Trace::Isosurface::Slices::X;
use Moose;
...
Chart::Plotly::Trace::Isosurface::Slices::X - This attribute is one of the possible options for the trace isosurface.
