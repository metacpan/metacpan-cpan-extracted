...
# shell program to test leftFisher.pm's output during normal operation (that
...
# now the test!
echo "Test:   statistic.pl leftFisher test-1.out $TESTFILE" 
statistic.pl leftFisher test-1.out $TESTFILE 
...
# now the test!
echo "Test:   statistic.pl --set_freq_combo $FREQCOMBFILE leftFisher test-2.out $TESTFILE" 
statistic.pl --set_freq_combo $FREQCOMBFILE leftFisher test-2.out $TESTFILE
