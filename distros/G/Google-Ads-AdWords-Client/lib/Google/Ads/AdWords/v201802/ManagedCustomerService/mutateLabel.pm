...
package Google::Ads::AdWords::v201802::ManagedCustomerService::mutateLabel;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201802::ManagedCustomerLabelOperation',
    },
    {
...
Google::Ads::AdWords::v201802::ManagedCustomerService::mutateLabel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutateLabel from the namespace https://adwords.google.com/api/adwords/mcm/v201802.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201802::ManagedCustomerService::mutateLabel->new($data);

Constructor. The following data structure may be passed to new():

 {
   operations =>  $a_reference_to, # see Google::Ads::AdWords::v201802::ManagedCustomerLabelOperation
 },
