...
use Google::Ads::AdWords::v201705::CustomerExtensionSetting;
use Google::Ads::AdWords::v201705::CustomerExtensionSettingOperation;
use Google::Ads::AdWords::v201705::FeedItemCampaignTargeting;
use Google::Ads::AdWords::v201705::FeedItemSchedule;
use Google::Ads::AdWords::v201705::FeedItemScheduling;
use Google::Ads::AdWords::v201705::Keyword;
use Google::Ads::AdWords::v201705::Location;
use Google::Ads::AdWords::v201705::Money;
use Google::Ads::AdWords::v201705::MoneyWithCurrency;
use Google::Ads::AdWords::v201705::PriceFeedItem;
use Google::Ads::AdWords::v201705::PriceTableRow;
...
sub add_prices {
  ...
  my $price_feed_item = Google::Ads::AdWords::v201705::PriceFeedItem->new({
      ...
      language            => 'en',
      campaignTargeting =>
        Google::Ads::AdWords::v201705::FeedItemCampaignTargeting->new({
          TargetingCampaignId => $campaign_id
        }
        ),
      scheduling => Google::Ads::AdWords::v201705::FeedItemScheduling->new({
          feedItemSchedules => [
  ...
  my $customer_extension_setting =
    Google::Ads::AdWords::v201705::CustomerExtensionSetting->new({
      extensionType    => 'PRICE',
  ...
  my $mutate_result = $client->CustomerExtensionSettingService()->mutate({
      operations => [
        Google::Ads::AdWords::v201705::CustomerExtensionSettingOperation->new({
...
sub create_price_table_row {
  my ($header, $description, $final_url, $final_mobile_url, $price_in_micros,
    ...
    = @_;
  my $price_table_row = Google::Ads::AdWords::v201705::PriceTableRow->new({
      header      => $header,
      description => $description,
      finalUrls =>
        [Google::Ads::AdWords::v201705::UrlList->new({urls => [$final_url]})],
      price => Google::Ads::AdWords::v201705::MoneyWithCurrency->new({
          money => Google::Ads::AdWords::v201705::Money->new({
