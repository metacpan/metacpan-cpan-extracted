# Transfer this to lib/DBD/mysqlx/GetInfo.pm
...
#   173 => undef,                         # SQL_CONVERT_GUID
  ...
  10001 => 0,                             # SQL_CURSOR_SENSITIVITY
     16 => 'test',                        # SQL_DATABASE_NAME                    FIXME
      2 => \&sql_data_source_name,        # SQL_DATA_SOURCE_NAME
     25 => 'N',                           # SQL_DATA_SOURCE_READ_ONLY            FIXME
    119 => 7,                             # SQL_DATETIME_LITERALS
     17 => 'MySQL',                       # SQL_DBMS_NAME
     18 => '8.0.11',                      # SQL_DBMS_VER                         FIXME
     18 => '8.0.11',                      # SQL_DBMS_VERSION                     FIXME
    170 => 3,                             # SQL_DDL_INDEX
...
# 20002 => undef,                         # SQL_MAXIMUM_STMT_OCTETS_SCHEMA
  ...
  10005 => 192,                           # SQL_MAX_IDENTIFIER_LEN
    ...
    114 => 1,                             # SQL_QUALIFIER_LOCATION
     ...
     13 => '::1 via TCP/IP',              # SQL_SERVER_NAME                      FIXME
