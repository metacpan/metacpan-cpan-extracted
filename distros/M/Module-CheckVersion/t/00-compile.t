...
my @module_files = (
    'Module/CheckVersion.pm',
    'Module/CheckVersion/AuthorityScheme/cpan.pm',
    'Module/CheckVersion/AuthorityScheme/darkpan.pm'
);

my @scripts = (
    'script/_check-module-version',
    'script/check-module-version'
);
