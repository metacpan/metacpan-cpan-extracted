...
is $mtr->parse('E#m7'), 'vi7', 'vi7';
is $mtr->parse('E#m7b5'), 'vi7b5', 'vi7b5';
is $mtr->parse('E#min7'), 'vimin7', 'vimin7';
...
is $mtr->parse('Fm7'), 'vi7', 'vi7';
is $mtr->parse('Fm7b5'), 'vi7b5', 'vi7b5';
is $mtr->parse('Fmin7'), 'vimin7', 'vimin7';
is $mtr->parse('Gbm'), 'bvii', 'bvii';
is $mtr->parse('Gbo'), 'bviio', 'bviio';
