package Google::Ads::AdWords::v201702::ProductAdwordsLabels;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201702::ProductDimension);
# Variety: sequence
...
ProductAdwordsLabels from the namespace https://adwords.google.com/api/adwords/cm/v201702.
