...
$Shipment::FedEx::WSDL::RateTypes::RequestedShipment::VERSION = '3.10';
use strict;
use warnings;
...
RequestedShipment from the namespace http://fedex.com/ws/rate/v9.
...
=item * DropoffType (min/maxOccurs: 0/1)
...
=item * LabelSpecification (min/maxOccurs: 0/1)

=item * ShippingDocumentSpecification (min/maxOccurs: 0/1)

=item * RateRequestTypes (min/maxOccurs: 0/unbounded)
