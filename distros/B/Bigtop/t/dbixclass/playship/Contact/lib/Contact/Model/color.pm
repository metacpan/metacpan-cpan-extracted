...
use Contact::Model::GEN::color;

our $COLOR = 'Contact::Model::color';
...
Contact::Model::color - model for color table (stub part)
...
=head1 METHODS (mixed in from Contact::Model::GEN::color)
