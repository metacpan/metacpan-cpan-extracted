package Solstice::Controller::FormInput::TextInput;

# $Id: TextInput.pm 25 2006-01-14 00:50:12Z jlaney $
...
sub getView {
    ...
    my $view = Solstice::View::FormInput::TextInput->new($self->getModel());
