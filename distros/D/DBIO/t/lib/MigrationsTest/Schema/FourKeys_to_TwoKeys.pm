package # hide from PAUSE
    MigrationsTest::Schema::FourKeys_to_TwoKeys;
...
__PACKAGE__->belongs_to('fourkeys', 'MigrationsTest::Schema::FourKeys', {
...
__PACKAGE__->belongs_to('twokeys', 'MigrationsTest::Schema::TwoKeys', {
