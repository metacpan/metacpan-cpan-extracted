package Chart::Plotly::Trace::Isosurface::Caps::Z;
use Moose;
...
Chart::Plotly::Trace::Isosurface::Caps::Z - This attribute is one of the possible options for the trace isosurface.
