package Google::Ads::AdWords::v201802::FeedItemCriterionTarget;
use strict;
use warnings;
...
Google::Ads::AdWords::v201802::FeedItemCriterionTarget

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItemCriterionTarget from the namespace https://adwords.google.com/api/adwords/cm/v201802.
