package Chart::Plotly::Trace::Funnelarea::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Funnelarea::Legendgrouptitle::Font - This attribute is one of the possible options for the trace funnelarea.
