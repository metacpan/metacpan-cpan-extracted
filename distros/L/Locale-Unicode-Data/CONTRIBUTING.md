...
I welcome any contribution to Locale::Unicode::Data::Boolean, including, but not limited to bug reports, feature requests, general comments, and patches.
...
File [an issue on bug tracker](https://gitlab.com/deguest/Locale-Unicode-Data/issues) if you think you've found a bug. Please describe
...
Issues are currently reported using CPAN [bug tracker](https://gitlab.com/deguest/Locale-Unicode-Data/issues)

## More information

Please refer to the [README](https://metacpan.org/source/JDEGUEST/Locale-Unicode-Data-Boolean-v0.1.0/README.md)
