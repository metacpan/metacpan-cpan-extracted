...
package Dash::Html::Components::Button;
...
has 'disabled'           => ( is => 'rw' );
has 'form'               => ( is => 'rw' );
has 'formAction'         => ( is => 'rw' );
has 'formEncType'        => ( is => 'rw' );
has 'formMethod'         => ( is => 'rw' );
has 'formNoValidate'     => ( is => 'rw' );
has 'formTarget'         => ( is => 'rw' );
has 'name'               => ( is => 'rw' );
has 'type'               => ( is => 'rw' );
has 'value'              => ( is => 'rw' );
has 'accessKey'          => ( is => 'rw' );
