package Chart::Plotly::Trace::Waterfall::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Waterfall::Legendgrouptitle::Font - This attribute is one of the possible options for the trace waterfall.
