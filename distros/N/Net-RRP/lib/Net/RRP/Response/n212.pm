package Net::RRP::Response::n212;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n212::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n212::VERSION = '0.1';
...
Net::RRP::Response::n212 - the 212 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
