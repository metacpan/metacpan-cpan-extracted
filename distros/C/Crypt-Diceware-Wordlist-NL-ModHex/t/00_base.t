...
Test::More::diag(
    q{Testing Crypt::Diceware::Wordlist::NL::ModHex }
## no critic (ProhibitCallsToUnexportedSubs RequireExplicitInclusion)
      . $Crypt::Diceware::Wordlist::NL::ModHex::VERSION,
);

## no critic (RequireExplicitInclusion)
@Crypt::Diceware::Wordlist::NL::ModHex::Sub::ISA =
  qw(Crypt::Diceware::Wordlist::NL::ModHex);
