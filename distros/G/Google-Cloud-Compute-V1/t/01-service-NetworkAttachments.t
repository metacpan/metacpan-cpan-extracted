...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::NetworkAttachment Google::Cloud::Compute::V1::Compute::NetworkAttachmentAggregatedList Google::Cloud::Compute::V1::Compute::NetworkAttachmentList Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::Policy Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::NetworkAttachmentsClient->new( credentials => 'dummy' );
