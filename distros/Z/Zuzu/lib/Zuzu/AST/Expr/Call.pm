...
sub evaluate { $_[1]->eval_call($_[0]) }

=pod

=head1 NAME

Zuzu::AST::Expr::Call - AST node for call expressions
...
Value stored in the C<callee> attribute.
...
B<< Zuzu::AST::Expr::Call >> is copyright Toby Inkster.
