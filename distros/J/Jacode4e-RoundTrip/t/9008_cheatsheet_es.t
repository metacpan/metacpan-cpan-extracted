...
#
# Referencia rápida de Jacode4e::RoundTrip (Español)
...
#
#   Jacode4e              : Conversión unidireccional rápida. Con pérdida para
#                           algunos caracteres (ej. CP932 tiene 398 asignaciones
#                           no reversibles).
#   Jacode4e::RoundTrip   : Garantiza fidelidad de ida y vuelta vía pivote Unicode.
#                           A->B->A es siempre idéntico. Más lento que Jacode4e,
#                           pero usar cuando los datos deben ir y volver.
#
#   mapeo de ida y vuelta).
#   Si no se necesita conversión de ida y vuelta, usar el módulo Jacode4e.
#
# ======================================================================
