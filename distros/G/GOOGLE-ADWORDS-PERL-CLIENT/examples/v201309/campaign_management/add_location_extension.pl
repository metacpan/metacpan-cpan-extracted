...
use Google::Ads::AdWords::v201309::Address;
use Google::Ads::AdWords::v201309::CampaignAdExtension;
use Google::Ads::AdWords::v201309::CampaignAdExtensionOperation;
use Google::Ads::AdWords::v201309::GeoLocationSelector;
use Google::Ads::AdWords::v201309::LocationExtension;
...
sub add_location_extension {
  ...
  # Create address.
  my $address = Google::Ads::AdWords::v201309::Address->new({
  ...
  my $selector = Google::Ads::AdWords::v201309::GeoLocationSelector->new({
    addresses => [$address]
  });
  ...
  my $location_extension =
      Google::Ads::AdWords::v201309::LocationExtension->new({
  ...
  my $campaign_location_ad_extension =
      Google::Ads::AdWords::v201309::CampaignAdExtension->new({
  ...
  # Create operation.
  my $operation =
      Google::Ads::AdWords::v201309::CampaignAdExtensionOperation->new({
