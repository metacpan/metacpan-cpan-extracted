...
Cfn::Resource::AWS::EC2::EIPAssociation - Cfn resource for AWS::EC2::EIPAssociation

=head1 DESCRIPTION

This module implements a Perl module that represents the CloudFormation object AWS::EC2::EIPAssociation.
