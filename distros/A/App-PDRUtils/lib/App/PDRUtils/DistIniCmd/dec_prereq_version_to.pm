...
App::PDRUtils::DistIniCmd::dec_prereq_version_to - Decrease prereq version to a specified version

=head1 VERSION

This document describes version 0.122 of App::PDRUtils::DistIniCmd::dec_prereq_version_to (from Perl distribution App-PDRUtils), released on 2021-05-25.
