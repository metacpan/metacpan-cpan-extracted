...
#
# http://search.cpan.org/dist/Char-Latin3/
#
...
#
# Latin-3 character range per length
#
my %range_tr = ();

#
# Latin-3 case conversion
#
my %lc = ();
...
sub import {
    ...
    *Char::ord           = \&Latin3::ord;
    *Char::ord_          = \&Latin3::ord_;
    *Char::reverse       = \&Latin3::reverse;
    *Char::getc          = \&Latin3::getc;
    *Char::length        = \&Latin3::length;
    *Char::substr        = \&Latin3::substr;
    *Char::index         = \&Latin3::index;
    *Char::rindex        = \&Latin3::rindex;
    *Char::eval          = \&Latin3::eval;
    *Char::escape        = \&Latin3::escape;
    *Char::escape_token  = \&Latin3::escape_token;
    *Char::escape_script = \&Latin3::escape_script;
}
...
sub Elatin3::rindex($$;$);
sub Elatin3::lcfirst(@);
sub Elatin3::lcfirst_();
sub Elatin3::lc(@);
sub Elatin3::lc_();
sub Elatin3::ucfirst(@);
sub Elatin3::ucfirst_();
sub Elatin3::uc(@);
sub Elatin3::uc_();
sub Elatin3::fc(@);
sub Elatin3::fc_();
...
# ${Elatin3::eS}          = qr{(?>[^\x09\x0A    \x0C\x0D\x20])};
# ${Elatin3::eS}          = qr{(?>[^\x09\x0A\x0B\x0C\x0D\x20])};
${Elatin3::eS}            = qr{(?>[^\s])};

${Elatin3::eW}            = qr{(?>[^0-9A-Z_a-z])};
${Elatin3::eH}            = qr{(?>[^\x09\x20])};
${Elatin3::eV}            = qr{(?>[^\x0A\x0B\x0C\x0D])};
${Elatin3::eR}            = qr{(?>\x0D\x0A|[\x0A\x0D])};
${Elatin3::eN}            = qr{(?>[^\x0A])};
${Elatin3::not_alnum}     = qr{(?>[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Elatin3::not_alpha}     = qr{(?>[^\x41-\x5A\x61-\x7A])};
${Elatin3::not_ascii}     = qr{(?>[^\x00-\x7F])};
${Elatin3::not_blank}     = qr{(?>[^\x09\x20])};
${Elatin3::not_cntrl}     = qr{(?>[^\x00-\x1F\x7F])};
${Elatin3::not_digit}     = qr{(?>[^\x30-\x39])};
${Elatin3::not_graph}     = qr{(?>[^\x21-\x7F])};
${Elatin3::not_lower}     = qr{(?>[^\x61-\x7A])};
${Elatin3::not_lower_i}   = qr{(?>[^\x41-\x5A\x61-\x7A])}; # Perl 5.16 compatible
# ${Elatin3::not_lower_i} = qr{(?>[\x00-\xFF])};                   # older Perl compatible
${Elatin3::not_print}     = qr{(?>[^\x20-\x7F])};
${Elatin3::not_punct}     = qr{(?>[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Elatin3::not_space}     = qr{(?>[^\s\x0B])};
${Elatin3::not_upper}     = qr{(?>[^\x41-\x5A])};
${Elatin3::not_upper_i}   = qr{(?>[^\x41-\x5A\x61-\x7A])}; # Perl 5.16 compatible
# ${Elatin3::not_upper_i} = qr{(?>[\x00-\xFF])};                   # older Perl compatible
${Elatin3::not_word}      = qr{(?>[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Elatin3::not_xdigit}    = qr{(?>[^\x30-\x39\x41-\x46\x61-\x66])};
${Elatin3::eb}            = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Elatin3::eB}            = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Elatin3::foo" used only once: possible typo at here.
${Elatin3::dot}         = ${Elatin3::dot};
${Elatin3::dot_s}       = ${Elatin3::dot_s};
${Elatin3::eD}          = ${Elatin3::eD};
${Elatin3::eS}          = ${Elatin3::eS};
${Elatin3::eW}          = ${Elatin3::eW};
${Elatin3::eH}          = ${Elatin3::eH};
${Elatin3::eV}          = ${Elatin3::eV};
${Elatin3::eR}          = ${Elatin3::eR};
${Elatin3::eN}          = ${Elatin3::eN};
${Elatin3::not_alnum}   = ${Elatin3::not_alnum};
${Elatin3::not_alpha}   = ${Elatin3::not_alpha};
${Elatin3::not_ascii}   = ${Elatin3::not_ascii};
${Elatin3::not_blank}   = ${Elatin3::not_blank};
${Elatin3::not_cntrl}   = ${Elatin3::not_cntrl};
${Elatin3::not_digit}   = ${Elatin3::not_digit};
${Elatin3::not_graph}   = ${Elatin3::not_graph};
${Elatin3::not_lower}   = ${Elatin3::not_lower};
${Elatin3::not_lower_i} = ${Elatin3::not_lower_i};
${Elatin3::not_print}   = ${Elatin3::not_print};
${Elatin3::not_punct}   = ${Elatin3::not_punct};
${Elatin3::not_space}   = ${Elatin3::not_space};
${Elatin3::not_upper}   = ${Elatin3::not_upper};
${Elatin3::not_upper_i} = ${Elatin3::not_upper_i};
${Elatin3::not_word}    = ${Elatin3::not_word};
${Elatin3::not_xdigit}  = ${Elatin3::not_xdigit};
${Elatin3::eb}          = ${Elatin3::eb};
${Elatin3::eB}          = ${Elatin3::eB};
...
#
# Latin-3 lower case first with parameter
#
sub Elatin3::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Elatin3::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Elatin3::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Elatin3::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Latin-3 lower case first without parameter
#
sub Elatin3::lcfirst_() {
    return Elatin3::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Latin-3 lower case with parameter
#
sub Elatin3::lc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-3 lower case without parameter
#
sub Elatin3::lc_() {
    my $s = $_;
    return join '', map {defined($lc{$_}) ? $lc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-3 upper case first with parameter
#
sub Elatin3::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Elatin3::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Elatin3::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Elatin3::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Latin-3 upper case first without parameter
#
sub Elatin3::ucfirst_() {
    return Elatin3::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Latin-3 upper case with parameter
#
sub Elatin3::uc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-3 upper case without parameter
#
sub Elatin3::uc_() {
    my $s = $_;
    return join '', map {defined($uc{$_}) ? $uc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-3 fold case with parameter
#
sub Elatin3::fc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-3 fold case without parameter
#
sub Elatin3::fc_() {
    my $s = $_;
    return join '', map {defined($fc{$_}) ? $fc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Elatin3::uc($char[$i]);
                my $fc = Elatin3::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
#
# prepare Latin-3 characters per length
#
...
#
# Latin-3 open character list for tr
#
sub _charlist_tr {
...
#
# Latin-3 open character list for qr and not qr
#
sub _charlist {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Elatin3::not_lower_i}',
                '[:^upper:]'  => '${Elatin3::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Elatin3::not_alnum}',
                '[:^alpha:]'  => '${Elatin3::not_alpha}',
                '[:^ascii:]'  => '${Elatin3::not_ascii}',
                '[:^blank:]'  => '${Elatin3::not_blank}',
                '[:^cntrl:]'  => '${Elatin3::not_cntrl}',
                '[:^digit:]'  => '${Elatin3::not_digit}',
                '[:^graph:]'  => '${Elatin3::not_graph}',
                '[:^lower:]'  => '${Elatin3::not_lower}',
                '[:^print:]'  => '${Elatin3::not_print}',
                '[:^punct:]'  => '${Elatin3::not_punct}',
                '[:^space:]'  => '${Elatin3::not_space}',
                '[:^upper:]'  => '${Elatin3::not_upper}',
                '[:^word:]'   => '${Elatin3::not_word}',
                '[:^xdigit:]' => '${Elatin3::not_xdigit}',
...
#
# Latin-3 hexadecimal escape sequence
#
sub hexchr {
    my($hexdigit) = @_;
...
#
# Latin-3 open character list for qr
#
sub charlist_qr {
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Elatin3::uc($char);
                        my $fc = Elatin3::fc($char);
                        if ($uc eq $fc) {
...
#
# Latin-3 open character list for not qr
#
sub charlist_not_qr {
...
#
# Latin-3 order to character (with parameter)
#
sub Elatin3::chr(;$) {
...
#
# Latin-3 order to character (without parameter)
#
sub Elatin3::chr_() {
...
#
# Latin-3 path globbing (with parameter)
#
sub Elatin3::glob($) {
...
#
# Latin-3 path globbing (without parameter)
#
sub Elatin3::glob_() {
...
#
# Latin-3 path globbing via File::DosGlob 1.10
#
...
#
# Latin-3 path globbing subroutine
#
sub _do_glob {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Elatin3::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Elatin3::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Elatin3::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Elatin3::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
#
sub Elatin3::POSTMATCH {
    return $';
}

#
# Latin-3 character to order (with parameter)
#
sub Latin3::ord(;$) {
...
#
# Latin-3 character to order (without parameter)
#
sub Latin3::ord_() {
...
#
# Latin-3 index by character
#
sub Latin3::index($$;$) {

    my $index;
    if (@_ == 3) {
        $index = Elatin3::index($_[0], $_[1], CORE::length(Latin3::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Elatin3::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Latin3::length(CORE::substr $_[0], 0, $index);
    }
}

#
# Latin-3 rindex by character
#
sub Latin3::rindex($$;$) {

    my $rindex;
    if (@_ == 3) {
        $rindex = Elatin3::rindex($_[0], $_[1], CORE::length(Latin3::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Elatin3::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Latin3::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
# ord() to ord() or Latin3::ord()
my $function_ord = 'ord';

# ord to ord or Latin3::ord_
my $function_ord_ = 'ord';

# reverse to reverse or Latin3::reverse
my $function_reverse = 'reverse';

# getc to getc or Latin3::getc
...
my $qq_substr  = qr{(?> Char::substr | Latin3::substr | CORE::substr | substr ) (?>\s*) \( $qq_paren \)
                 }xms;
...
#
# escape Latin-3 token of script
#
sub Latin3::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Elatin3::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ (?>\s*) PREMATCH  \b | \$ (?>\s*) \{ (?>\s*) PREMATCH  (?>\s*) \} | \$ (?>\s*) \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin3::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Elatin3::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin3::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Elatin3::POSTMATCH()
    elsif (/\G (                 \$ (?>\s*) POSTMATCH \b | \$ (?>\s*) \{ (?>\s*) POSTMATCH (?>\s*) \} | \$ (?>\s*) \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Elatin3::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Elatin3::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob (?>\s*) \) /oxgc) {
        return 'while ($_ = Elatin3::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while (?>\s*) \( (?>\s*) glob \b /oxgc) {
        return 'while ($_ = Elatin3::glob';
    }
...
# subroutines of package Elatin3
    elsif (/\G \b (CORE:: | ->(>?\s*) (?: atan2 | [a-z]{2,})) \b       /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Latin3::eval       (?= (?>\s*) \{ )                    /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Char::escape'; }
    elsif (/\G \b Latin3::eval    \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'eval Latin3::escape'; }
    elsif (/\G \b bytes::substr \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin3::chop';       }
    elsif (/\G \b bytes::index \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::index';       }
    elsif (/\G \b Latin3::index \b   (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Latin3::index';       }
    elsif (/\G \b index \b         (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin3::index';      }
    elsif (/\G \b bytes::rindex \b (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Char::rindex';      }
    elsif (/\G \b Latin3::rindex \b  (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Latin3::rindex';      }
    elsif (/\G \b rindex \b        (?! (?>\s*) => )                    /oxgc) { $slash = 'm//'; return 'Elatin3::rindex';     }
    elsif (/\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin3::lc';         }
    elsif (/\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin3::lcfirst';    }
    elsif (/\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin3::uc';         }
    elsif (/\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin3::ucfirst';    }
    elsif (/\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin3::fc';         }
    ...
    elsif (/\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin3::chr';               }
    elsif (/\G \b bytes::ord    (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Elatin3::glob';              }
    elsif (/\G \b lc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin3::lc_';               }
    elsif (/\G \b lcfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin3::lcfirst_';          }
    elsif (/\G \b uc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin3::uc_';               }
    elsif (/\G \b ucfirst \b       (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin3::ucfirst_';          }
    elsif (/\G \b fc \b            (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin3::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin3::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! (?>\s*) => )                          /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! (?>\s*) => )                          /oxgc) { $slash = 'm//'; return 'Elatin3::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Elatin3::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Elatin3::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq           (\#) [ ] (\#) /oxgc) { return 'Elatin3::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Elatin3::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Elatin3::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Elatin3::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Elatin3::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Elatin3::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q            (\#) [ ] (\#) /oxgc) { return 'Elatin3::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { return 'Elatin3::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { return 'Elatin3::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { return 'Elatin3::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { return 'Elatin3::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { return 'Elatin3::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                    ' [ ] '    /oxgc) { return 'Elatin3::split' . $e . qq     {' '};  }
        elsif (/\G                    " [ ] "    /oxgc) { return 'Elatin3::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Elatin3::PREMATCH()]}
            ...
            $e_string .= q{Elatin3::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Elatin3::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ (?>\s*) MATCH     \b | \$ (?>\s*) \{ (?>\s*) MATCH     (?>\s*) \} | \$ (?>\s*) \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Elatin3::MATCH()};
            $slash = 'div';
        }
...
# subroutines of package Elatin3
        ...
        elsif ($string =~ /\G \b Latin3::eval       (?= (?>\s*) \{ )                    /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::eval \b                                        /oxgc) { $e_string .= 'eval Char::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b Latin3::eval \b                                        /oxgc) { $e_string .= 'eval Latin3::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                                     /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                              /oxgc) { $e_string .= 'Elatin3::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                                      /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::index \b                                       /oxgc) { $e_string .= 'Char::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b Latin3::index \b                                       /oxgc) { $e_string .= 'Latin3::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                             /oxgc) { $e_string .= 'Elatin3::index';      $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b Latin3::rindex \b                                      /oxgc) { $e_string .= 'Latin3::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                            /oxgc) { $e_string .= 'Elatin3::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin3::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin3::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin3::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin3::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin3::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin3::chr';           $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= (?>\s+)[A-Za-z_]|(?>\s*)['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Elatin3::glob';          $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                                      /oxgc) { $e_string .= 'Elatin3::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                                 /oxgc) { $e_string .= 'Elatin3::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                                      /oxgc) { $e_string .= 'Elatin3::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                                 /oxgc) { $e_string .= 'Elatin3::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                                      /oxgc) { $e_string .= 'Elatin3::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                                     /oxgc) { $e_string .= 'Elatin3::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                              /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                                     /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                                    /oxgc) { $e_string .= 'Elatin3::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Elatin3::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Elatin3::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq           (\#) [ ] (\#) /oxgc) { $e_string .= 'Elatin3::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\() [ ] (\)) /oxgc) { $e_string .= 'Elatin3::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\{) [ ] (\}) /oxgc) { $e_string .= 'Elatin3::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\[) [ ] (\]) /oxgc) { $e_string .= 'Elatin3::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\<) [ ] (\>) /oxgc) { $e_string .= 'Elatin3::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq ((?>\s*)) (\S) [ ] (\2) /oxgc) { $e_string .= 'Elatin3::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q            (\#) [ ] (\#) /oxgc) { $e_string .= 'Elatin3::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\() [ ] (\)) /oxgc) { $e_string .= 'Elatin3::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\{) [ ] (\}) /oxgc) { $e_string .= 'Elatin3::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\[) [ ] (\]) /oxgc) { $e_string .= 'Elatin3::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\<) [ ] (\>) /oxgc) { $e_string .= 'Elatin3::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  ((?>\s*)) (\S) [ ] (\2) /oxgc) { $e_string .= 'Elatin3::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                    ' [ ] '    /oxgc) { $e_string .= 'Elatin3::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                    " [ ] "    /oxgc) { $e_string .= 'Elatin3::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        ...
        return Elatin3::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Elatin3::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Elatin3::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Elatin3::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Elatin3::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Elatin3::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Elatin3::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Elatin3::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Elatin3::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Elatin3::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Elatin3::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Elatin3::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Elatin3::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Elatin3::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Elatin3::uc($char[$i]) ne Elatin3::fc($char[$i]))) {
            if (CORE::length(Elatin3::fc($char[$i])) == 1) {
                $char[$i] = '['   . Elatin3::uc($char[$i])       . Elatin3::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Elatin3::uc($char[$i]) . '|' . Elatin3::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin3::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ (?>\s*) 0 (?>\s*) \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Elatin3::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin3::ignorecase(Elatin3::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin3::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Elatin3::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin3::ignorecase(Elatin3::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin3::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Elatin3::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Elatin3::ignorecase(Elatin3::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Elatin3::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                               1                         2   3                                  4   5
                q<CORE::eval{local $Elatin3::re_t=%s; while($Elatin3::re_t =~ %s){%s local $^W=0; local $Elatin3::re_r=%s; %s$Elatin3::re_t="$`$Elatin3::re_r$'"; pos($Elatin3::re_t)=length "$`$Elatin3::re_r"; } return $Elatin3::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Elatin3::re_r=CORE::eval $Elatin3::re_r; ' x $e_modifier,          #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                  4   5  6                     7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Elatin3::re_r=%s; %s"%s$Elatin3::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                        1     2   3                                  4   5 6                          7                                                   8
                q<CORE::eval{local $Elatin3::re_n=0; while(%s =~ %s){%s local $^W=0; local $Elatin3::re_r=%s; %s%s="$`$Elatin3::re_r$'"; pos(%s)=length "$`$Elatin3::re_r"; $Elatin3::re_n++} return %s$Elatin3::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                  5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Elatin3::re_r=%s; %s%s="%s$Elatin3::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                  5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Elatin3::re_r=%s; %s%s="%s$Elatin3::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Elatin3::re_r=CORE::eval $Elatin3::re_r; ' x $e_modifier,          #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Elatin3::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Elatin3::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
This module has run-time routines for use Latin3 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Latin3 software and not
...
This Elatin3 module first appeared in ActivePerl Build 522 Built under
...
=item * Split string
  ...
  @split = Elatin3::split(/pattern/,$string,$limit);
  @split = Elatin3::split(/pattern/,$string);
  @split = Elatin3::split(/pattern/);
  @split = Elatin3::split('',$string,$limit);
  @split = Elatin3::split('',$string);
  @split = Elatin3::split('');
  @split = Elatin3::split();
  @split = Elatin3::split;
  ...
  at all, Elatin3::split returns the original string as a single substring, If it
  ...
  @chars  = Elatin3::split(//,  $word);
  @fields = Elatin3::split(/:/, $line);
  @words  = Elatin3::split(" ", $paragraph);
  @lines  = Elatin3::split(/^/, $buffer);
  ...
  print join(":" => Elatin3::split(/ */, "hi there"));
  ...
  Elatin3::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Elatin3::split(/:/, $_, 3);
  ...
  splits on whitespace just as Elatin3::split with no arguments does. Thus,
  Elatin3::split(" ") can be used to emulate awk's default behavior. In contrast,
  Elatin3::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Elatin3::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Elatin3::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Elatin3::split()) {
          $count{$word}++;
      }
  }

  The inverse of Elatin3::split is join, except that join can only join with the
...
=item * Transliteration
  ...
  $tr = Elatin3::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Elatin3::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  If no Latin-3 string is specified via =~ operator, the $_ variable is translated.
  $modifier are:
  ...
  print Elatin3::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item * Chop string

  $chop = Elatin3::chop(@list);
  $chop = Elatin3::chop();
  $chop = Elatin3::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Elatin3::chop subroutine is used primary to remove the newline
  ...
  since Elatin3::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Elatin3::chop a literal, only a variable. If you Elatin3::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Elatin3::chop(@lines);

  You can Elatin3::chop anything that is an lvalue, including an assignment:

  Elatin3::chop($cwd = `pwd`);
  Elatin3::chop($answer = <STDIN>);

  This is different from:

  $answer = Elatin3::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Elatin3::chop returns the character
  ...
  In the most general case, Elatin3::chop can be expressed using substr:

  $last_code = Elatin3::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Elatin3::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Elatin3::chop;
...
=item * Index string
  ...
  $byte_pos = Elatin3::index($string,$substr,$byte_offset);
  $byte_pos = Elatin3::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Elatin3::index($string, $lookfor, $byte_pos)) > -1) {
...
=item * Reverse index string
  ...
  $byte_pos = Elatin3::rindex($string,$substr,$byte_offset);
  $byte_pos = Elatin3::rindex($string,$substr);

  This subroutine works just like Elatin3::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Elatin3::index).
  ...
  while (($byte_pos = Latin3::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item * Lower case string
  ...
  $lc = Elatin3::lc($string);
  $lc = Elatin3::lc_;

  This subroutine returns a lowercased version of Latin-3 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Elatin3::fc subroutine for case-insensitive comparisons via Latin3
  software.

=item * Lower case first character of string

  $lcfirst = Elatin3::lcfirst($string);
  $lcfirst = Elatin3::lcfirst_;

  This subroutine returns a version of Latin-3 $string with the first character
  lowercased (or $_, if $string is omitted). This is the internal subroutine
  implementing the \l escape in double-quoted strings.

=item * Upper case string

  $uc = Elatin3::uc($string);
  $uc = Elatin3::uc_;

  This subroutine returns an uppercased version of Latin-3 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Elatin3::ucfirst instead.
...
=item * Upper case first character of string
  ...
  $ucfirst = Elatin3::ucfirst($string);
  $ucfirst = Elatin3::ucfirst_;
  ...
  $titlecase = Elatin3::ucfirst(substr($word,0,1)) . Elatin3::lc(substr($word,1));
  ...
  $do_not_use = Elatin3::ucfirst(Elatin3::lc($word));
...
=item * Fold case string
  ...
  $fc = Elatin3::fc($string);
  $fc = Elatin3::fc_;

  New to Latin3 software, this subroutine returns the full Unicode-like casefold of
  Latin-3 $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Elatin3::fc($a) eq Elatin3::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Latin3 software has always used casefolding semantics for
...
=item * Make ignore case string
  ...
  @ignorecase = Elatin3::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item * Make capture number

  $capturenumber = Elatin3::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item * Make character

  $chr = Elatin3::chr($code);
  $chr = Elatin3::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Elatin3::chr(65) is "A" in either
  ASCII or Latin-3, not Unicode. For the reverse of Elatin3::chr, use Latin3::ord.

=item * Filename expansion (globbing)

  @glob = Elatin3::glob($string);
  @glob = Elatin3::glob_;
  ...
  The Elatin3::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Elatin3::glob('"*e f*"');
  @spacies = Elatin3::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Elatin3::glob("'*${var}e f*'");
  @spacies = Elatin3::glob(qq("*${var}e f*"));
