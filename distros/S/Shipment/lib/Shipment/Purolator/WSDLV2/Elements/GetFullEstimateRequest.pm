...
package Shipment::Purolator::WSDLV2::Elements::GetFullEstimateRequest;
$Shipment::Purolator::WSDLV2::Elements::GetFullEstimateRequest::VERSION = '3.08';
use strict;
use warnings;
...
{    # BLOCK to scope variables
    ...
    __PACKAGE__->__set_name('GetFullEstimateRequest');
...
Shipment::Purolator::WSDLV2::Elements::GetFullEstimateRequest
...
GetFullEstimateRequest from the namespace http://purolator.com/pws/datatypes/v2.
...
=head2 new
 ...
 my $element = Shipment::Purolator::WSDLV2::Elements::GetFullEstimateRequest->new($data);
