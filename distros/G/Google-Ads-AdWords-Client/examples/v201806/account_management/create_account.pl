...
use Google::Ads::AdWords::v201806::ManagedCustomer;
use Google::Ads::AdWords::v201806::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201806::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201806::ManagedCustomerOperation->new({
      operator => "ADD",
      operand  => $account
  });
