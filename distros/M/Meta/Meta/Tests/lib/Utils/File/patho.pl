...
Meta::Utils::Output::print("compose is [".$patho->compose("+")."]\n");
...
patho.pl - testing program for the Meta::Utils::File::Patho.pm module.
...
This is a test suite for the Meta::Utils::File::Patho.pm package.
...
Meta::Baseline::Test(3), Meta::Utils::File::Patho(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), strict(3)
