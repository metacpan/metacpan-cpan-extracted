#===============================================
package Banal::Config::General::Extended;
...
our @ISA = qw(Config::General::Extended);
...
Banal::Config::General::Extended - A wrapper around Config::General::Extended with no current additional value other than encapsulation for the moment. 
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Banal::Config::General::Extended
...
1; # End of Banal::Config::General::Extended
