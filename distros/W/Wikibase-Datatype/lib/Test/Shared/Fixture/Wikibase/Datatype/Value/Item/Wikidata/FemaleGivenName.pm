package Test::Shared::Fixture::Wikibase::Datatype::Value::Item::Wikidata::FemaleGivenName;
...
Test::Shared::Fixture::Wikibase::Datatype::Value::Item::Wikidata::FemaleGivenName - Test instance for Wikidata item value.
...
=for comment filename=fixture_create_and_print_value_item_wd_female_given_name.pl
