package Bio::VertRes::Config::Recipes::BacteriaRnaSeqExpressionUsingTophat;
...
Bio::VertRes::Config::Recipes::BacteriaRnaSeqExpressionUsingTophat - Standard snp calling pipeline for bacteria
