...
$RDF::Cowl::DataQuant::VERSION = '1.0.0';
# CowlDataQuant
use strict;
use warnings;
...
RDF::Cowl::DataQuant - Represents DataSomeValuesFrom and DataAllValuesFrom in the OWL 2 specification
...
L<RDF::Cowl::Lib::Gen::Class::DataQuant>
