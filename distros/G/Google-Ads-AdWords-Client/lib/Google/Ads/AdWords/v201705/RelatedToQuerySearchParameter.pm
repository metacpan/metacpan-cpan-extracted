package Google::Ads::AdWords::v201705::RelatedToQuerySearchParameter;
use strict;
use warnings;
...
RelatedToQuerySearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201705.
