package Bencher::ScenarioR::PerinciSubUtil::call_with_its_args;
...
our $results = [
  [
    ...
    [
      {
        errors => 3.3e-09,
        participant => "call_with_its_args",
        rate => 340000,
        samples => 20,
        time => 3,
        vs_slowest => 1,
    ...
    ],
    {
      "func.bencher_args"              => {
                                            ...
                                            scenario_module => "PerinciSubUtil::call_with_its_args",
                                          },
      ...
      "func.elapsed_time"              => 0.0490140914916992,
      "func.module_startup"            => undef,
      "func.module_versions"           => {
                                            "__PACKAGE__" => 1.034,
                                            "Bencher::Scenario::PerinciSubUtil::call_with_its_args" => undef,
                                            "Benchmark::Dumb" => "0.10",
      ...
      "func.precision"                 => 0,
      "func.scenario_module"           => "Bencher::Scenario::PerinciSubUtil::call_with_its_args",
      "func.scenario_module_md5sum"    => "0c3e3a4a1973c7a66988d46445012d55",
      "func.scenario_module_mtime"     => 1485832045,
      "func.scenario_module_sha1sum"   => "7a55ef22b7f1b0a458eb00bba63427f4c713861f",
      "func.scenario_module_sha256sum" => "db87932e609f818b259a1fe6b0576b1e13bd78971f6f1fb22d41175ec11d09ed",
      "func.time_end"                  => 1485832189.82857,
      "func.time_factor"               => 1000000,
      "func.time_start"                => 1485832189.77956,
