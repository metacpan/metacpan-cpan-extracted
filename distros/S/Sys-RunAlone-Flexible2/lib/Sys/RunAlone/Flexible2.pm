...
Sys::RunAlone::Flexible2 - Make sure only one invocation of a script is active at a time
...
Please visit the project's homepage at L<https://metacpan.org/release/Sys-RunAlone-Flexible2>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Sys-RunAlone-Flexible2>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=Sys-RunAlone-Flexible2>
