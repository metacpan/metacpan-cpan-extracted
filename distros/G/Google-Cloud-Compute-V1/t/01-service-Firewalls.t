...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::Firewall Google::Cloud::Compute::V1::Compute::FirewallList Google::Cloud::Compute::V1::Compute::Operation Google::Cloud::Compute::V1::Compute::TestPermissionsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::FirewallsClient->new( credentials => 'dummy' );
