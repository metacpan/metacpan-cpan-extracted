...
App::ALG - Shorter alias for App::BPOMUtils::NutritionLabelRef

=head1 VERSION

This document describes version 0.004 of App::ALG (from Perl distribution App-BPOMUtils-NutritionLabelRef), released on 2024-06-13.

=head1 DESCRIPTION

Keywords: BPOM, acuan label gizi
...
L<App::BPOMUtils::NutritionLabelRef>
