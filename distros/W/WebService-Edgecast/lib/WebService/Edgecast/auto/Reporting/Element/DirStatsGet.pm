...
package WebService::Edgecast::auto::Reporting::Element::DirStatsGet;
BEGIN {
  $WebService::Edgecast::auto::Reporting::Element::DirStatsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->__set_name('DirStatsGet');
...
WebService::Edgecast::auto::Reporting::Element::DirStatsGet
...
DirStatsGet from the namespace EC:WebServices.
...
=head2 new
 ...
 my $element = WebService::Edgecast::auto::Reporting::Element::DirStatsGet->new($data);
