...
package Google::Ads::AdWords::v201705::ManagedCustomerService::get;
use strict;
use warnings;
...
get from the namespace https://adwords.google.com/api/adwords/mcm/v201705.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201705::ManagedCustomerService::get->new($data);
