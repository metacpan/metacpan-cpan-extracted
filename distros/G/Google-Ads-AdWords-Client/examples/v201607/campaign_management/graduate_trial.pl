...
use Google::Ads::AdWords::v201607::Trial;
use Google::Ads::AdWords::v201607::TrialOperation;
...
sub graduate_trial {
  ...
  my $trial = Google::Ads::AdWords::v201607::Trial->new({
      id       => $trial_id,
      budgetId => $budget_id,
      status   => "GRADUATED"
  });
  ...
  # Create operation.
  my $trial_operation = Google::Ads::AdWords::v201607::TrialOperation->new({
      operator => "SET",
      operand  => $trial
  });
