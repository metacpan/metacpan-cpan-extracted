# This Makefile is for the yesssSMS extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/yesssSMS.pm]
#     AUTHOR => [q[Armin Fuerst <armin@>]]
#     BUILD_REQUIRES => {  }
#     NAME => q[yesssSMS]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/yesssSMS.pm]
...
TO_INST_PM = lib/yesssSMS.pm

PM_TO_BLIB = lib/yesssSMS.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/yesssSMS.pm $(INST_MAN3DIR)/yesssSMS.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               yesssSMS' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            1.00' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Send text messages to mobile phones through the website of yesss!' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Armin Fuerst <armin@>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Send text messages to mobile phones through the website of yesss!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Armin Fuerst &lt;armin@&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/yesssSMS.pm blib/lib/yesssSMS.pm 
