...
https://metacpan.org/release/Pg-CLI

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Pg::CLI
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Pg::CLI
...
The code for this distribution is [hosted at GitHub](https://github.com/houseabsolute/Pg-CLI).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Pg-CLI)
or [via email](bug-pg-cli@rt.cpan.org.
