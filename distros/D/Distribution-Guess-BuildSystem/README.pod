...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Distribution-Guess-BuildSystem> or 
L<MetaCPAN|http://www.metacpan.org/module/Distribution::Guess::BuildSystem>:

=over 4

=item *	L<http://search.cpan.org/dist/Distribution-Guess-BuildSystem>

=item *	L<http://www.metacpan.org/module/Distribution::Guess::BuildSystem>
