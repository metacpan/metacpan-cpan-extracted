...
BEGIN {
    for my $pkg (qw( Google::Cloud::Compute::V1::Compute::InstanceSettings Google::Cloud::Compute::V1::Compute::Operation )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Compute::V1::InstanceSettingsServiceClient->new( credentials => 'dummy' );
