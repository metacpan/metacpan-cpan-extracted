...
sub _fixture_bitfield_compact {
  ...
  return {
    ...
    'policy_version'          => 2,
    'tc_string'               => 'CLcVDxRMWfGmWAVAHCENAXCkAKDAADnAABRgA5mdfCKZuYJez-NQm0TBMYA4oCAAGQYIAAAAAAEAIAEgAA',
    'version'                 => 2,
    'consent_language'        => 'EN',
    ...
    'vendor'                  => {
      ...
      'legitimate_interests' => [1, 9, 26, 27, 30, 36, 37, 43, 86, 97, 110, 113],
    },
    'purpose'                => {'consents' => [1, 3, 9, 10], 'legitimate_interests' => [3, 4, 5, 8, 9, 10],},
    'cmp_id'                 => 21,
...
sub _fixture_bitfield_default {
  ...
  return {
    ...
    'consent_language' => 'EN',
    'purpose'          => {
      'consents'             => {'1' => 1, '3' => 1, '9' => 1, '10' => 1,},
      'legitimate_interests' => {'3' => 1, '4' => 1, '5' => 1, '8'  => 1, '9' => 1, '10' => 1,},
    },
    'vendor' => {
      'legitimate_interests' => {
        '1'   => 1,
