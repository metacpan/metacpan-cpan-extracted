...
BEGIN {
    for my $pkg (qw( Google::Cloud::Dataproc::V1::WorkflowTemplates::WorkflowTemplate )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::Dataproc::V1::WorkflowTemplateServiceClient->new( credentials => 'dummy' );
