...
my $c = $crypto_box->encrypt( $msg, $nonce, $bobpk, $alicesk );
is( length($c), length($msg) + $crypto_box->MACBYTES, "ciphertext is of correct length");

my $c_hex = bin2hex($c);

is($c_hex, $expected_hex, "ciphertext is as expected: $expected_hex");
