...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=List-AllUtils) or [via email](bug-list-allutils@rt.cpan.org).


## Continuous Integration

All pull requests for this distribution will be automatically tested
on Linux by [Travis](https://travis-ci.org/houseabsolute/List-AllUtils).
