package Chart::Plotly::Trace::Carpet::Legendgrouptitle::Font;
use Moose;
...
Chart::Plotly::Trace::Carpet::Legendgrouptitle::Font - This attribute is one of the possible options for the trace carpet.
