...
use Test::More import => [qw( done_testing is ok subtest use_ok )];
...
subtest 'EUI-64 MAC normalization' => sub {
...
subtest 'Mixed case, delimiters, and odd formats' => sub {
...
subtest 'Invalid input validation' => sub {
...
subtest 'IPv6-like input handling' => sub {
...
subtest 'Single octet and format output checks' => sub {
