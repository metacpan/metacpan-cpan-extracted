...
$Consul::API::Catalog::VERSION = '0.022';
...
$Consul::API::Catalog::ShortNode::VERSION = '0.022';
use Moo;
use Types::Standard qw(Str);
...
$Consul::API::Catalog::Service::VERSION = '0.022';
use Moo;
...
$Consul::API::Catalog::Node::VERSION = '0.022';
use Moo;
