...
$Shipment::Purolator::WSDL::Types::GetQuickEstimateResponseContainer::VERSION = '3.06';
use strict;
use warnings;
...
GetQuickEstimateResponseContainer from the namespace http://purolator.com/pws/datatypes/v1.
