...
# [[[ PREPROCESSOR ]]]
# <<< EXECUTE_ERROR: 'ERROR EAVRV10, BOUND-CHECKING MISMATCH: Argument $input_vector_2 is not of length 4' >>>
...
my number_arrayref $input_vector_2 = [ -999_999, 3.0, 4.0, -12.0, 0.0 ];
