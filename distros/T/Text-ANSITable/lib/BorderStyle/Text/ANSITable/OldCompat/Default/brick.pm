...
BorderStyle::Text::ANSITable::OldCompat::Default::brick - UTF8::Brick border style (with old name)

=head1 VERSION

This document describes version 0.606 of BorderStyle::Text::ANSITable::OldCompat::Default::brick (from Perl distribution Text-ANSITable), released on 2021-08-27.
