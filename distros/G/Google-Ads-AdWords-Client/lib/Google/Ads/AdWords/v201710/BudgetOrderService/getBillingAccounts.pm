...
package Google::Ads::AdWords::v201710::BudgetOrderService::getBillingAccounts;
use strict;
use warnings;
...
getBillingAccounts from the namespace https://adwords.google.com/api/adwords/billing/v201710.
