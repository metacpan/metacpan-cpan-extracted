...
our %TEL_TABLE = (
    ...
    19   => '(?:(?:6(?:3[124-9]|6[1-79]|7[1-8]|2[1-69]|5[1-4689]|0[13-7]|1[134689]|4[135-8]|[89]\d)|9(?:2[1-46-9]|0[2-8]|1\d))\d{4})',
    ...
    197  => '(?:(?:3[1-9]|4[0-8]|5[124578]|2[1256]|[6-8]\d)\d{4})',
    198  => '(?:(?:[26][02-9]|[37][07-9]|4\d)\d{4})',
