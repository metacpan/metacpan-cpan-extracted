...
#
#  This directory needs to be writeable by the webserver. On a UNIX box I don't suggest
# using /tmp as some UNIX boxes clear /tmp on reboot.
$tempdir = 'c:/temp/'; # [Win32]

# $installdir - the directory containing the installation. This is the directory where 
# the read, admin, etc directories are, as seen by command line users.
#
...
#$cvswebedit_state_url = '/cve'; # TODO - this should map in srm.conf
$cvswebedit_state_url = '/cve';
...
#$cvswebedit_dbg_url = $installurl.'/cve/'; # must match srm.conf
$cvswebedit_dbg_url = $installurl.'/cve/';
