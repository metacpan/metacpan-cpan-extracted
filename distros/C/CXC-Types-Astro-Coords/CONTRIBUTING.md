...
comfortable using that, drop a line to Terry Gaetz <tgaetz@cfa.harvard.edu>.
...
at this website:
  ...
  https://rt.cpan.org/Public/Dist/Display.html?Name=CXC-Types-Astro-Coords

or via email to:

  bug-cxc-types-astro-coords@rt.cpan.org
