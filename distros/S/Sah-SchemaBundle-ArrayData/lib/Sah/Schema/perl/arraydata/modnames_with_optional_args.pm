...
This document describes version 0.005 of Sah::Schema::perl::arraydata::modnames_with_optional_args (from Perl distribution Sah-SchemaBundle-ArrayData), released on 2024-02-16.
...
To validate function parameters against this schema (requires L<Params::Sah>):
 ...
 sub myfunc {
     my @args = @_;
     state $validator = gen_validator("perl::arraydata::modnames_with_optional_args*");
     $validator->(\@args);
     ...
 }
...
to validate as the second argument (encoded in Perl syntax):
 ...
 % validate-with-sah '"perl::arraydata::modnames_with_optional_args*"' '"data..."'
...
L<Type::Tiny> as well as L<Type::FromSah>):
 ...
 package My::Types {
     ...
     __PACKAGE__->add_type(
         sah2type('perl::arraydata::modnames_with_optional_args*', name=>'PerlArraydataModnamesWithOptionalArgs')
     );
 }

 use My::Types qw(PerlArraydataModnamesWithOptionalArgs);
 PerlArraydataModnamesWithOptionalArgs->assert_valid($data);
