...
use lib "t/lib";
use SQLeetTest qw/connect_ok $sqleet_sqlite_call requires_sqleet_sqlite has_sqleet_sqlite/;
use Test::More;

BEGIN { requires_sqleet_sqlite('3.7.4') }
...
my $tests = 25;
$tests += 2 * 2 if has_sqleet_sqlite('3.7.11');
plan tests => $tests;
