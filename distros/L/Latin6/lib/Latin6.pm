...
END
            ...
            if ($list !~ /\A (?>\s*) \z/oxms) {
                ...
                for (@list) {
                    ...
                    $Elatin6::function_ord     = $Elatin6::function_ord;
                    $Elatin6::function_ord_    = $Elatin6::function_ord_;
                    $Elatin6::function_reverse = $Elatin6::function_reverse;
                    $Elatin6::function_getc    = $Elatin6::function_getc;
                }
            }
        }
    }
