...
my @cmds = (
    ...
    },
    {
        cmd => [ 'config', 'add' ],
        error =>
          ['usage: usage.t config add section.subsection.var ["key value"]'],
    ...
    },
    {
        cmd => [ 'alias', 'add' ],
        error =>
          ['usage: usage.t alias add "alias text" "cmd to translate to"'],
        comment => 'alias add usage',
    },
    {
        cmd => [ 'aliases', 'add' ],
        error =>
          ['usage: usage.t aliases add "alias text" "cmd to translate to"'],
    ...
    },
    {
        cmd => [ 'clone', '-h' ],
        error =>
          ['usage: usage.t clone --from <url> [--as <alias>] | --local'],
        comment => 'clone usage',
    },
    {
        cmd => [ 'create', '-h' ],
        error =>
          ['usage: usage.t create <record-type> -- prop1=foo prop2=bar'],
    ...
    },
    {
        cmd => ['mirror'],
        error =>
          [ 'No --from specified!', 'usage: usage.t mirror --from <url>', ],
