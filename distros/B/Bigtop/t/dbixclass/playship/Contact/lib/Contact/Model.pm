...
In your base module:
    ...
    use Contact::Model::tshirt qw( $TSHIRT );
    use Contact::Model::color qw( $COLOR );
    use Contact::Model::tshirt_color qw( $TSHIRT_COLOR );
    use Contact::Model::tshirt_author qw( $TSHIRT_AUTHOR );
