...
Faker::Plugin::JaJp::AddressPostalCode
...
$test->for('synopsis', sub {
  ...
  ok $result->isa('Faker::Plugin::JaJp::AddressPostalCode');
...
$test->for('example', 1, 'execute', sub {
  ...
  is $result->execute, '4081999';
  ok $result->faker->random->make; # reset randomizer
  is $result->execute, '1738707';
  ok $result->faker->random->make; # reset randomizer
  is $result->execute, '5307217';
...
$test->render('lib/Faker/Plugin/JaJp/AddressPostalCode.pod') if $ENV{RENDER};
