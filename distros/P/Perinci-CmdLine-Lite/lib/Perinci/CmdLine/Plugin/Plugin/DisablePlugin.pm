...
Perinci::CmdLine::Plugin::Plugin::DisablePlugin - Prevent the loading (activation) of other plugins

=head1 VERSION

This document describes version 1.912 of Perinci::CmdLine::Plugin::Plugin::DisablePlugin (from Perl distribution Perinci-CmdLine-Lite), released on 2021-12-01.
