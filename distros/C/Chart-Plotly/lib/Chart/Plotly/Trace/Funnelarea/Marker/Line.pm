package Chart::Plotly::Trace::Funnelarea::Marker::Line;
use Moose;
...
Chart::Plotly::Trace::Funnelarea::Marker::Line - This attribute is one of the possible options for the trace funnelarea.
