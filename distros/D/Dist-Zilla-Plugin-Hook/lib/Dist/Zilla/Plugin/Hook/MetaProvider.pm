...
#pod
#pod This is C<Hook::MetaProvider> plugin implementation. Nothing interesting, just using few roles.
#pod
...
#pod = L<Dist::Zilla>
#pod = L<Dist::Zilla::Role::MetaProvider>
#pod
#pod =cut

package Dist::Zilla::Plugin::Hook::MetaProvider;

use Moose;
use namespace::autoclean;
use version 0.77;

# ABSTRACT: C<Hook::MetaProvider> plugin implementation
...
Dist::Zilla::Plugin::Hook::MetaProvider - C<Hook::MetaProvider> plugin implementation
...
This is C<Hook::MetaProvider> plugin implementation. Nothing interesting, just using few roles.
