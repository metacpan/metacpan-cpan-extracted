...
1;
# ABSTRACT: Sah schemas related to the Tables module family
...
Sah::Schemas::Tables - Sah schemas related to the Tables module family

=head1 VERSION

This document describes version 0.001 of Sah::Schemas::Tables (from Perl distribution Sah-Schemas-Tables), released on 2020-11-10.
