...
our $rschema = ["bool",[{is_true=>1,summary=>"A true boolean"}],["bool"]];
...
Sah::SchemaR::true - A true boolean

=head1 VERSION

This document describes version 0.001 of Sah::SchemaR::true (from Perl distribution Sah-Schemas-Bool), released on 2017-11-01.
