...
1;
# ABSTRACT: Run a Getopt::Long::Descriptive-based script but only to dump the spec
...
Getopt::Long::Descriptive::Dump - Run a Getopt::Long::Descriptive-based script but only to dump the spec

=head1 VERSION

This document describes version 0.001 of Getopt::Long::Descriptive::Dump (from Perl distribution Getopt-Long-Descriptive-Dump), released on 2016-10-27.

=head1 FUNCTIONS


=head2 dump_getopt_long_descriptive_script(%args) -> [status, msg, result, meta]

Run a Getopt::Long::Descriptive-based script but only to dump the spec.

This function runs a CLI script that uses C<Getopt::Long::Descriptive> but
monkey-patches beforehand so that C<describe_options()> will dump the object and
then exit. The goal is to get the object without actually running the script.
...
CLI script needs to use C<Getopt::Long::Descriptive>. This is detected currently
by a simple regex. If script is not detected as using
C<Getopt::Long::Descriptive>, status 412 is returned.
...
Please visit the project's homepage at L<https://metacpan.org/release/Getopt-Long-Descriptive-Dump>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-Getopt-Long-Descriptive-Dump>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=Getopt-Long-Descriptive-Dump>
