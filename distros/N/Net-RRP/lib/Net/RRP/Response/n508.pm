package Net::RRP::Response::n508;

use strict;
use Net::RRP::Response;
@Net::RRP::Response::n508::ISA     = qw(Net::RRP::Response);
$Net::RRP::Response::n508::VERSION = '0.1';
...
Net::RRP::Response::n508 - the 508 rrp response representation. See base class L<Net::RRP::Response(3)> for more details.
