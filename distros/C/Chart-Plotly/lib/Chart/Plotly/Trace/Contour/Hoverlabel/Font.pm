package Chart::Plotly::Trace::Contour::Hoverlabel::Font;
use Moose;
...
Chart::Plotly::Trace::Contour::Hoverlabel::Font - This attribute is one of the possible options for the trace contour.
