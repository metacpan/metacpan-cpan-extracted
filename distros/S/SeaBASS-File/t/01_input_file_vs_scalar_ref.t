...
my $sb_file1 = SeaBASS::File->new('t/samples/bats92.txt');
my $sb_file2 = SeaBASS::File->new(\$DATA[0]);

is_deeply(scalar($sb_file1->headers()), scalar($sb_file2->headers()), "headers");
is_deeply(scalar($sb_file1->all()),     scalar($sb_file2->all()),     "data");
