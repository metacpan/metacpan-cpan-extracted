package Google::Ads::AdWords::v201802::CampaignBidModifier;
use strict;
use warnings;
...
Google::Ads::AdWords::v201802::CampaignBidModifier

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignBidModifier from the namespace https://adwords.google.com/api/adwords/cm/v201802.
