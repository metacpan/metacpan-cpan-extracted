...
package PDF::API3::Compat::API2::Resource::Shading;

BEGIN {

    use strict;
    use vars qw(@ISA $VERSION);
    use PDF::API3::Compat::API2::Resource;
    use PDF::API3::Compat::API2::Basic::PDF::Utils;
    use PDF::API3::Compat::API2::Util;
    use Math::Trig;

    @ISA = qw(PDF::API3::Compat::API2::Resource);
...
=item $cs = PDF::API3::Compat::API2::Resource::Shading->new $pdf, $key, %parameters
...
=item $cs = PDF::API3::Compat::API2::Resource::Shading->new_api $api, $name
