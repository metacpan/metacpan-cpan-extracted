#
# Test case for WebService::Recruit::HotPepperBeauty::KodawariSetsubi
#
...
my $service = new WebService::Recruit::HotPepperBeauty::KodawariSetsubi();

ok( ref $service, 'new WebService::Recruit::HotPepperBeauty::KodawariSetsubi()' );
...
# Test[0]
{
    ...
    my $res = new WebService::Recruit::HotPepperBeauty::KodawariSetsubi();
    ...
    ok( eval { $data->kodawari_setsubi }, 'Test[0]: kodawari_setsubi' );
    ok( eval { ref $data->kodawari_setsubi } eq 'ARRAY', 'Test[0]: kodawari_setsubi' );
    can_ok( $data->kodawari_setsubi->[0], 'code' );
    ok( eval { $data->kodawari_setsubi->[0]->code }, 'Test[0]: code' );
    can_ok( $data->kodawari_setsubi->[0], 'name' );
    ok( eval { $data->kodawari_setsubi->[0]->name }, 'Test[0]: name' );
}
