...
$Search::Elasticsearch::Client::5_0::Async::Bulk::VERSION = '6.81';
use Moo;
...
Search::Elasticsearch::Client::5_0::Async::Bulk - A helper module for the Bulk API
...
This module provides an async wrapper for the L<Search::Elasticsearch::Client::5_0::Direct/bulk()>
method which makes it easier to run multiple create, index, update or delete
actions in a single request.

The L<Search::Elasticsearch::Client::5_0::Async::Bulk> module acts as a queue, buffering up actions
...
The C<bulk_helper> method loads L<Search::Elasticsearch::Client::5_0::Async::Bulk>,
...
a L<bulk()|Search::Elasticsearch::Client::5_0::Direct/bulk()> request and returns
