...
our $DIST = 'Acme-CPANModules-ColorEnv'; # DIST
our $VERSION = '0.002'; # VERSION

our $LIST = {
    summary => "List of modules that observe environment variable (other than ".
...
1;
# ABSTRACT: List of modules that observe environment variable (other than NO_COLOR/COLOR) to disable/enable colored output
...
Acme::CPANModules::ColorEnv - List of modules that observe environment variable (other than NO_COLOR/COLOR) to disable/enable colored output

=head1 VERSION

This document describes version 0.002 of Acme::CPANModules::ColorEnv (from Perl distribution Acme-CPANModules-ColorEnv), released on 2023-08-06.
