...
Similar to L</format_sv>, but more helpful on C<SCALAR> and C<REF> SVs. For
C<SCALAR> SVs it will show the value directly by using L</format_value>, and
for C<REF> SVs it will show the referrant SV.
