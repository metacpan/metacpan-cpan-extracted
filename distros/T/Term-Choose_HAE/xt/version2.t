...
open my $fh, '<', 'lib/Term/Choose_HAE.pm' or die $!;
while ( my $line = <$fh> ) {
...
is( $v,            $v_pod,         'Version in POD Term::Choose_HAE OK' );
#is( $v,            $v_linux,       'Version in Term::Choose_HAE::Linux OK' );
#is( $v,            $v_win32,       'Version in Term::Choose_HAE::Win32 OK' );
#is( $v,            $v_const,       'Version in Term::Choose_HAE::Constants OK' );
#is( $v,            $v_pod_linux,   'Version in POD Term::Choose_HAE::Linux OK' );
#is( $v,            $v_pod_win32,   'Version in POD Term::Choose_HAE::Win32 OK' );
