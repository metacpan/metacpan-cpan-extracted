package Google::Ads::AdWords::v201708::BudgetOrder;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'spendingLimit' => 'Google::Ads::AdWords::v201708::Money',
        'totalAdjustments' => 'Google::Ads::AdWords::v201708::Money',
        'startDateTime' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'endDateTime' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'lastRequest' => 'Google::Ads::AdWords::v201708::BudgetOrderRequest',
    },
    {
...
Google::Ads::AdWords::v201708::BudgetOrder

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BudgetOrder from the namespace https://adwords.google.com/api/adwords/billing/v201708.
