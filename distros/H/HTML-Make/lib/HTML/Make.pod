...
(This example is included as L<F<synopsis.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.10/examples/synopsis.pl> in the distribution.)  

=head1 VERSION

This documents HTML::Make version 0.10 corresponding to git
commit L<e0ad4e3ee19618f273cd14e0f1023ea0315296e4|https://github.com/benkasminbullock/HTML-Make/commit/e0ad4e3ee19618f273cd14e0f1023ea0315296e4>
released on Sat Oct 14 16:41:15 2017 +0900.
...
(This example is included as L<F<nocheck.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.10/examples/nocheck.pl> in the distribution.)  
...
(This example is included as L<F<li-class-beano.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.10/examples/li-class-beano.pl> in the distribution.)  
...
(This example is included as L<F<p-double-class.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.10/examples/p-double-class.pl> in the distribution.)  
...
(This example is included as L<F<table.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.10/examples/table.pl> in the distribution.)  
...
(This example is included as L<F<push-new.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.10/examples/push-new.pl> in the distribution.)  
...
(This example is included as L<F<push-li-to-tr.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.10/examples/push-li-to-tr.pl> in the distribution.)  
...
(This example is included as L<F<multiply.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.10/examples/multiply.pl> in the distribution.)  
...
(This example is included as L<F<json-to-html.pl>|https://fastapi.metacpan.org/source/BKB/HTML-Make-0.10/examples/json-to-html.pl> in the distribution.)  
