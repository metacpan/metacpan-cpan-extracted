...
#
#=======================================================================
package PDF::API3::Compat::API2::Basic::TTF::Mort::Chain;

=head1 NAME

PDF::API3::Compat::API2::Basic::TTF::Mort::Chain
...
sub read
{
    ...
    foreach (1 .. $nSubtables) {
        ...
        my $subtable = PDF::API3::Compat::API2::Basic::TTF::Mort::Subtable->create($type, $coverage, $subFeatureFlags, $length);
        $subtable->read($fh);
