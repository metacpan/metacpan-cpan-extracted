...
package UMMF::MOF_1_3::Model::Float;
...
=head2 C<__validate_type>
  ...
  UMMF::MOF_1_3::Model::Float->__validate_type($value);

Returns true if C<$value> is a valid representation of L<UMMF::MOF_1_3::Model::Float|UMMF::MOF_1_3::Model::Float>.
...
sub __validate_type($$)
{
  ...
  UNIVERSAL::isa($x, 'UMMF::MOF_1_3::Model::Float')  ;
}


=head2 C<__typecheck>

  UMMF::MOF_1_3::Model::Float->__typecheck($value, $msg);

Calls C<confess()> with C<$msg> if C<<UMMF::MOF_1_3::Model::Float->__validate_type($value)>> is false.
...
sub __typecheck
{
  ...
  confess("typecheck: $msg: type '" . 'UMMF::MOF_1_3::Model::Float' . ": value '$x'")
...
Returns true if receiver is a L<UMMF::MOF_1_3::Model::Float|UMMF::MOF_1_3::Model::Float>.
...
=head2 C<isaModel__Float>


Returns true if receiver is a L<UMMF::MOF_1_3::Model::Float|UMMF::MOF_1_3::Model::Float>.
Other receivers will return false.
This is the fully qualified version of the C<isaFloat> method.

=cut
sub isaModel__Float { 1 }
...
Returns the UML Model name (C<'Model::Float'>) for an object or package of
this Classifier.

=cut
sub __model_name { 'Model::Float' }
...
sub __initialize
{
  ...
  $self->UMMF::MOF_1_3::Model::Float::___initialize;
...
sub __create
{
  ...
  # $DB::single = 1;
  $self->UMMF::MOF_1_3::Model::Float::___create(@args);
