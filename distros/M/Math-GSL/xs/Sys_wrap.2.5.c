...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_Math__GSL__Sys_var::
class _wrap_Math__GSL__Sys_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_gsl_frexp) {
  {
    ...
    if (SWIG_IsTmpObj(res2)) {
      ...
      if (argvi >= items) EXTEND(sp, argvi+1);  ST(argvi) = SWIG_NewPointerObj((void*)(arg2), SWIGTYPE_p_int, new_flags); argvi++  ;
    }
