...
$Benchmark::Perl::Formance::Plugin::PerlStone2015::dpath::VERSION = '0.002';
use strict;
use warnings;
...
Benchmark::Perl::Formance::Plugin::PerlStone2015::dpath - benchmark - stress lookup, traversing, and copying of data structures
