package Chart::Plotly::Trace::Funnel::Marker;
use Moose;
...
use Chart::Plotly::Trace::Funnel::Marker::Colorbar;
use Chart::Plotly::Trace::Funnel::Marker::Line;
...
has colorbar => ( is  => "rw",
                  isa => "Maybe[HashRef]|Chart::Plotly::Trace::Funnel::Marker::Colorbar", );
...
has line => ( is  => "rw",
              isa => "Maybe[HashRef]|Chart::Plotly::Trace::Funnel::Marker::Line", );
