...
package Acme::PERLANCAR::Test::Require;
...
1;
# ABSTRACT: Modules to test require()
...
Acme::PERLANCAR::Test::Require - Modules to test require()

=head1 VERSION

This document describes version 0.001 of Acme::PERLANCAR::Test::Require (from Perl distribution Acme-PERLANCAR-Test-Require), released on 2023-12-06.
